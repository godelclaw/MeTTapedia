...
* additive evidence used by a world model;
* commitments and goals;
* the bounded view shown to a model;
* executable capabilities.

The separation matters because only the evidence coordinate is required to
obey additive world-model revision.  File updates, instruction precedence,
plans, and protocol state may be ordered and noncommutative.
...
namespace PettaClaw.AgentWorldState
...
/-- WM-PLN extraction sees evidence revision as addition, while the other
...
end PettaClaw.AgentWorldState

#print axioms PettaClaw.AgentWorldState.extract_reviseEvidence
#print axioms PettaClaw.AgentWorldState.queryComplete_injective
#print axioms PettaClaw.AgentWorldState.no_universal_query_complete_compression
