...
namespace YangMills
namespace HypercubicDimension16PhysicalTraceWitnessChunk023

open HypercubicDimension16PhysicalTraceWitnessExecutable

def chunkIndex (localIndex : Fin 256) : Fin 11556 :=
  ⟨5888 + localIndex.1, by change 5888 + localIndex.1 < 11556; omega⟩
...
end HypercubicDimension16PhysicalTraceWitnessChunk023
end YangMills
end QuantumTheory
end Mettapedia
