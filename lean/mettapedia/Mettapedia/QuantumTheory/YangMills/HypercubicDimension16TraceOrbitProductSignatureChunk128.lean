...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk128
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨8192 + localIndex.1, by change 8192 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk128
end YangMills
end QuantumTheory
end Mettapedia
