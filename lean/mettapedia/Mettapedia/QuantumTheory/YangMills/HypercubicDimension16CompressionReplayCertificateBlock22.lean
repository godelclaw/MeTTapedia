...
/-! Kernel-checked compression replay block 22. -/
...
theorem decodedPowerTraceReplayCheckAt_certificate_block22 :
    decodedPowerTraceReplayCheckAt 22 = true := by
...
theorem decodedOrientationReplayCheckAt_certificate_block22 :
    decodedOrientationReplayCheckAt 22 = true := by
...
theorem decodedPowerTraceClassAt_certificate_block22
    (reflectionMask : Fin 16) :
    decodedPowerTraceClassAt 22 reflectionMask =
      expectedPowerTraceClassAt 22 reflectionMask := by
