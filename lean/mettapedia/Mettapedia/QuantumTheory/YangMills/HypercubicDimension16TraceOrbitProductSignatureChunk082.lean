...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk082
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨5248 + localIndex.1, by change 5248 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk082
end YangMills
end QuantumTheory
end Mettapedia
