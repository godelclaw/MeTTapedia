...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk027
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨1728 + localIndex.1, by change 1728 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk027
end YangMills
end QuantumTheory
end Mettapedia
