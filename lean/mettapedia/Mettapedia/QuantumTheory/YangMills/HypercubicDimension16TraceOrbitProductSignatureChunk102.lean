...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk102
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨6528 + localIndex.1, by change 6528 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk102
end YangMills
end QuantumTheory
end Mettapedia
