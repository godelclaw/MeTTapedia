...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk108
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨6912 + localIndex.1, by change 6912 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk108
end YangMills
end QuantumTheory
end Mettapedia
