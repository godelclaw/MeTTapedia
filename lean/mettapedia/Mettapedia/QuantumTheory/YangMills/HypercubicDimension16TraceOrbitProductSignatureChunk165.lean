...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk165
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨10560 + localIndex.1, by change 10560 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk165
end YangMills
end QuantumTheory
end Mettapedia
