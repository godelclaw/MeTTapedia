...
/-! Kernel-checked dimension-sixteen Cartan certificate block 33. -/
...
theorem canonicalOcticData_valid_block33 :
    ∀ entry : Fin 33,
      let index := octicWitnessBlockIndex 1089 (by decide) entry
