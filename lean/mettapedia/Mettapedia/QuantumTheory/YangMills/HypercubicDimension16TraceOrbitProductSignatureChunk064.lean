...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk064
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨4096 + localIndex.1, by change 4096 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk064
end YangMills
end QuantumTheory
end Mettapedia
