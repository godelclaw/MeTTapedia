...
/-! Kernel-checked dimension-sixteen Cartan certificate block 13. -/
...
theorem canonicalOcticData_valid_block13 :
    ∀ entry : Fin 33,
      let index := octicWitnessBlockIndex 429 (by decide) entry
