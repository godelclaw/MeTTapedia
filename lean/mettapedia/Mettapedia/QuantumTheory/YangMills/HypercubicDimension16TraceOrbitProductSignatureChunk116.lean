...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk116
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨7424 + localIndex.1, by change 7424 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk116
end YangMills
end QuantumTheory
end Mettapedia
