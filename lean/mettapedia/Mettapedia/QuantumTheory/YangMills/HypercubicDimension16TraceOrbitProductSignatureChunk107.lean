...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk107
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨6848 + localIndex.1, by change 6848 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk107
end YangMills
end QuantumTheory
end Mettapedia
