...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk062
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨3968 + localIndex.1, by change 3968 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk062
end YangMills
end QuantumTheory
end Mettapedia
