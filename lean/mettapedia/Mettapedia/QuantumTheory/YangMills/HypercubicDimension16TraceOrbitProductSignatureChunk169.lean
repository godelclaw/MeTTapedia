...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk169
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨10816 + localIndex.1, by change 10816 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk169
end YangMills
end QuantumTheory
end Mettapedia
