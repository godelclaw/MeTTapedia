...
/-! Kernel-checked dimension-sixteen Cartan certificate block 23. -/
...
theorem canonicalOcticData_valid_block23 :
    ∀ entry : Fin 33,
      let index := octicWitnessBlockIndex 759 (by decide) entry
