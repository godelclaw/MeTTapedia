...
namespace YangMills
namespace HypercubicDimension16PhysicalTraceWitnessChunk022

open HypercubicDimension16PhysicalTraceWitnessExecutable

def chunkIndex (localIndex : Fin 256) : Fin 11556 :=
  ⟨5632 + localIndex.1, by change 5632 + localIndex.1 < 11556; omega⟩
...
end HypercubicDimension16PhysicalTraceWitnessChunk022
end YangMills
end QuantumTheory
end Mettapedia
