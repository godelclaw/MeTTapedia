...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk040
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨2560 + localIndex.1, by change 2560 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk040
end YangMills
end QuantumTheory
end Mettapedia
