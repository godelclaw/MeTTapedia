...
namespace YangMills
namespace HypercubicDimension16PhysicalTraceWitnessChunk009

open HypercubicDimension16PhysicalTraceWitnessExecutable

def chunkIndex (localIndex : Fin 256) : Fin 11556 :=
  ⟨2304 + localIndex.1, by change 2304 + localIndex.1 < 11556; omega⟩
...
end HypercubicDimension16PhysicalTraceWitnessChunk009
end YangMills
end QuantumTheory
end Mettapedia
