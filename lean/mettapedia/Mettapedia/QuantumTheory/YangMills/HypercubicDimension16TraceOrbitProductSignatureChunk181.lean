...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk181
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨11584 + localIndex.1, by change 11584 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk181
end YangMills
end QuantumTheory
end Mettapedia
