...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk071
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨4544 + localIndex.1, by change 4544 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk071
end YangMills
end QuantumTheory
end Mettapedia
