...
namespace YangMills
namespace HypercubicDimension16PhysicalTraceWitnessChunk003

open HypercubicDimension16PhysicalTraceWitnessExecutable

def chunkIndex (localIndex : Fin 256) : Fin 11556 :=
  ⟨768 + localIndex.1, by change 768 + localIndex.1 < 11556; omega⟩
...
end HypercubicDimension16PhysicalTraceWitnessChunk003
end YangMills
end QuantumTheory
end Mettapedia
