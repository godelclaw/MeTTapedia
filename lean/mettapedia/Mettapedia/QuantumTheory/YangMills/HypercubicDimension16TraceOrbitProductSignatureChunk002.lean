...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk002
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨128 + localIndex.1, by change 128 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk002
end YangMills
end QuantumTheory
end Mettapedia
