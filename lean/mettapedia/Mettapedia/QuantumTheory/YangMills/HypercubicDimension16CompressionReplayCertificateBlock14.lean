...
/-! Kernel-checked compression replay block 14. -/
...
theorem decodedPowerTraceReplayCheckAt_certificate_block14 :
    decodedPowerTraceReplayCheckAt 14 = true := by
...
theorem decodedOrientationReplayCheckAt_certificate_block14 :
    decodedOrientationReplayCheckAt 14 = true := by
...
theorem decodedPowerTraceClassAt_certificate_block14
    (reflectionMask : Fin 16) :
    decodedPowerTraceClassAt 14 reflectionMask =
      expectedPowerTraceClassAt 14 reflectionMask := by
