...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk013
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨832 + localIndex.1, by change 832 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk013
end YangMills
end QuantumTheory
end Mettapedia
