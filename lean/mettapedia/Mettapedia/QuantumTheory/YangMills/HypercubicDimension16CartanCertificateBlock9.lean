...
/-! Kernel-checked dimension-sixteen Cartan certificate block 9. -/
...
theorem canonicalOcticData_valid_block9 :
    ∀ entry : Fin 33,
      let index := octicWitnessBlockIndex 297 (by decide) entry
