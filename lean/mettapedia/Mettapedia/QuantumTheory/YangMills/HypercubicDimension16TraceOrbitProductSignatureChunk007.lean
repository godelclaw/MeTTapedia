...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk007
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨448 + localIndex.1, by change 448 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk007
end YangMills
end QuantumTheory
end Mettapedia
