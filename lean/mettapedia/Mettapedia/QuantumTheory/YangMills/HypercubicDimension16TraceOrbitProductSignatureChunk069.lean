...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk069
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨4416 + localIndex.1, by change 4416 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk069
end YangMills
end QuantumTheory
end Mettapedia
