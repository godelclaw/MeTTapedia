...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk022
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨1408 + localIndex.1, by change 1408 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk022
end YangMills
end QuantumTheory
end Mettapedia
