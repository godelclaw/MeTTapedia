...
/-! Kernel-checked compression replay block 4. -/
...
theorem decodedPowerTraceReplayCheckAt_certificate_block4 :
    decodedPowerTraceReplayCheckAt 4 = true := by
...
theorem decodedOrientationReplayCheckAt_certificate_block4 :
    decodedOrientationReplayCheckAt 4 = true := by
...
theorem decodedPowerTraceClassAt_certificate_block4
    (reflectionMask : Fin 16) :
    decodedPowerTraceClassAt 4 reflectionMask =
      expectedPowerTraceClassAt 4 reflectionMask := by
