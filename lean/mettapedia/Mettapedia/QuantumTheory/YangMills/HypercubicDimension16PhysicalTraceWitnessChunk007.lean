...
namespace YangMills
namespace HypercubicDimension16PhysicalTraceWitnessChunk007

open HypercubicDimension16PhysicalTraceWitnessExecutable

def chunkIndex (localIndex : Fin 256) : Fin 11556 :=
  ⟨1792 + localIndex.1, by change 1792 + localIndex.1 < 11556; omega⟩
...
end HypercubicDimension16PhysicalTraceWitnessChunk007
end YangMills
end QuantumTheory
end Mettapedia
