...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk024
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨1536 + localIndex.1, by change 1536 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk024
end YangMills
end QuantumTheory
end Mettapedia
