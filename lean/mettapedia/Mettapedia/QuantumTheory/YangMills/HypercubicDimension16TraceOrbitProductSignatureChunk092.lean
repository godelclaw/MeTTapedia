...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk092
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨5888 + localIndex.1, by change 5888 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk092
end YangMills
end QuantumTheory
end Mettapedia
