...
/-! Kernel-checked class-compressed sector block 12. -/
...
theorem classCompressedSectorCharacter_certificate_block12
    (fieldIndex : Fin 8) :
    classCompressedSectorCharacter 12 (fieldIndex.1 + 1) =
      expectedClassCompressedSectorCharacter 12
        (fieldIndex.1 + 1) := by
