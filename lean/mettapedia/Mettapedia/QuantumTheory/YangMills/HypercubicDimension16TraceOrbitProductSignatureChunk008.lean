...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk008
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨512 + localIndex.1, by change 512 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk008
end YangMills
end QuantumTheory
end Mettapedia
