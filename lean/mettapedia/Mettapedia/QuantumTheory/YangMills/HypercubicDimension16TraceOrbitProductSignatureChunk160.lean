...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk160
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨10240 + localIndex.1, by change 10240 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk160
end YangMills
end QuantumTheory
end Mettapedia
