...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk175
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨11200 + localIndex.1, by change 11200 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk175
end YangMills
end QuantumTheory
end Mettapedia
