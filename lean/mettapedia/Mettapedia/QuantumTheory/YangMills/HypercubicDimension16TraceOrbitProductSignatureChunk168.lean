...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk168
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨10752 + localIndex.1, by change 10752 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk168
end YangMills
end QuantumTheory
end Mettapedia
