...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk060
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨3840 + localIndex.1, by change 3840 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk060
end YangMills
end QuantumTheory
end Mettapedia
