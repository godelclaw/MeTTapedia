...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk094
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨6016 + localIndex.1, by change 6016 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk094
end YangMills
end QuantumTheory
end Mettapedia
