...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk097
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨6208 + localIndex.1, by change 6208 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk097
end YangMills
end QuantumTheory
end Mettapedia
