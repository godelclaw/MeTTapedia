...
/-! Kernel-checked class-compressed sector block 3. -/
...
theorem classCompressedSectorCharacter_certificate_block3
    (fieldIndex : Fin 8) :
    classCompressedSectorCharacter 3 (fieldIndex.1 + 1) =
      expectedClassCompressedSectorCharacter 3
        (fieldIndex.1 + 1) := by
