...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk149
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨9536 + localIndex.1, by change 9536 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk149
end YangMills
end QuantumTheory
end Mettapedia
