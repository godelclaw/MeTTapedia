...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk130
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨8320 + localIndex.1, by change 8320 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk130
end YangMills
end QuantumTheory
end Mettapedia
