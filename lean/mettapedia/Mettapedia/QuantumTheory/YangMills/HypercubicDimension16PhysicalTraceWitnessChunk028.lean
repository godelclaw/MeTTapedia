...
namespace YangMills
namespace HypercubicDimension16PhysicalTraceWitnessChunk028

open HypercubicDimension16PhysicalTraceWitnessExecutable

def chunkIndex (localIndex : Fin 256) : Fin 11556 :=
  ⟨7168 + localIndex.1, by change 7168 + localIndex.1 < 11556; omega⟩
...
end HypercubicDimension16PhysicalTraceWitnessChunk028
end YangMills
end QuantumTheory
end Mettapedia
