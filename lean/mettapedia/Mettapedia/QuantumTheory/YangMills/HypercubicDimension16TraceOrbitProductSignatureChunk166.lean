...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk166
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨10624 + localIndex.1, by change 10624 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk166
end YangMills
end QuantumTheory
end Mettapedia
