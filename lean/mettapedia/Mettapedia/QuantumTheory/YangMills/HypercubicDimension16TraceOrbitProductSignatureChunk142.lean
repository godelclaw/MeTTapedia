...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk142
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨9088 + localIndex.1, by change 9088 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk142
end YangMills
end QuantumTheory
end Mettapedia
