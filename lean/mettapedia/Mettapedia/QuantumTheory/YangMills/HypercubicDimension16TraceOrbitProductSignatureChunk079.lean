...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk079
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨5056 + localIndex.1, by change 5056 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk079
end YangMills
end QuantumTheory
end Mettapedia
