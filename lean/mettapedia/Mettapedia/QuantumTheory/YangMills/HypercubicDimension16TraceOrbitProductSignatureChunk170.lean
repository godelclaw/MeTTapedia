...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk170
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨10880 + localIndex.1, by change 10880 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk170
end YangMills
end QuantumTheory
end Mettapedia
