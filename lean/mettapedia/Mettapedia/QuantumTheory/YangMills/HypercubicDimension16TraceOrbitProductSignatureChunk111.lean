...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk111
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨7104 + localIndex.1, by change 7104 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk111
end YangMills
end QuantumTheory
end Mettapedia
