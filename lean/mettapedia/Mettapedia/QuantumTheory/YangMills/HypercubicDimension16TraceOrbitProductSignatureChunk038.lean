...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk038
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨2432 + localIndex.1, by change 2432 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk038
end YangMills
end QuantumTheory
end Mettapedia
