...
namespace YangMills
namespace HypercubicDimension16PhysicalTraceWitnessChunk025

open HypercubicDimension16PhysicalTraceWitnessExecutable

def chunkIndex (localIndex : Fin 256) : Fin 11556 :=
  ⟨6400 + localIndex.1, by change 6400 + localIndex.1 < 11556; omega⟩
...
end HypercubicDimension16PhysicalTraceWitnessChunk025
end YangMills
end QuantumTheory
end Mettapedia
