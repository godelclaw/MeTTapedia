...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk113
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨7232 + localIndex.1, by change 7232 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk113
end YangMills
end QuantumTheory
end Mettapedia
