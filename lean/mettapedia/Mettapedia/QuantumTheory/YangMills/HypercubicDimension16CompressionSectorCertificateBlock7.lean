...
/-! Kernel-checked class-compressed sector block 7. -/
...
theorem classCompressedSectorCharacter_certificate_block7
    (fieldIndex : Fin 8) :
    classCompressedSectorCharacter 7 (fieldIndex.1 + 1) =
      expectedClassCompressedSectorCharacter 7
        (fieldIndex.1 + 1) := by
