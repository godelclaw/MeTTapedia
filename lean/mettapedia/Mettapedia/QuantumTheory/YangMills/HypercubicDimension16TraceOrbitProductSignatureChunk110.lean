...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk110
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨7040 + localIndex.1, by change 7040 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk110
end YangMills
end QuantumTheory
end Mettapedia
