...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk011
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨704 + localIndex.1, by change 704 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk011
end YangMills
end QuantumTheory
end Mettapedia
