...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk070
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨4480 + localIndex.1, by change 4480 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk070
end YangMills
end QuantumTheory
end Mettapedia
