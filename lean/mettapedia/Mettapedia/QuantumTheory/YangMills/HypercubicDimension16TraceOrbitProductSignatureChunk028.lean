...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk028
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨1792 + localIndex.1, by change 1792 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk028
end YangMills
end QuantumTheory
end Mettapedia
