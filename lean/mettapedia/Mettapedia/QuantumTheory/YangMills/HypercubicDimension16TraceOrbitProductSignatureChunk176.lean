...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk176
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨11264 + localIndex.1, by change 11264 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk176
end YangMills
end QuantumTheory
end Mettapedia
