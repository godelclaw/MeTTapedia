...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk033
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨2112 + localIndex.1, by change 2112 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk033
end YangMills
end QuantumTheory
end Mettapedia
