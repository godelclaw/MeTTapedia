...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk032
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨2048 + localIndex.1, by change 2048 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk032
end YangMills
end QuantumTheory
end Mettapedia
