...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk036
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨2304 + localIndex.1, by change 2304 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk036
end YangMills
end QuantumTheory
end Mettapedia
