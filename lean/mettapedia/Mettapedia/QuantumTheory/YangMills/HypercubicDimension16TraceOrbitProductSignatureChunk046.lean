...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk046
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨2944 + localIndex.1, by change 2944 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk046
end YangMills
end QuantumTheory
end Mettapedia
