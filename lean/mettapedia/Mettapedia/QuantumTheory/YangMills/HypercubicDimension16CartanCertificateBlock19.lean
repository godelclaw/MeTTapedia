...
/-! Kernel-checked dimension-sixteen Cartan certificate block 19. -/
...
theorem canonicalOcticData_valid_block19 :
    ∀ entry : Fin 33,
      let index := octicWitnessBlockIndex 627 (by decide) entry
