...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk065
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨4160 + localIndex.1, by change 4160 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk065
end YangMills
end QuantumTheory
end Mettapedia
