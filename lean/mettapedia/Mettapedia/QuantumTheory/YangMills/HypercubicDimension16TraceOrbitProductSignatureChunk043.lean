...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk043
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨2752 + localIndex.1, by change 2752 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk043
end YangMills
end QuantumTheory
end Mettapedia
