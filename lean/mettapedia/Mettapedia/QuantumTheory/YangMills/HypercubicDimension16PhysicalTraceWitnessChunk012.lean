...
namespace YangMills
namespace HypercubicDimension16PhysicalTraceWitnessChunk012

open HypercubicDimension16PhysicalTraceWitnessExecutable

def chunkIndex (localIndex : Fin 256) : Fin 11556 :=
  ⟨3072 + localIndex.1, by change 3072 + localIndex.1 < 11556; omega⟩
...
end HypercubicDimension16PhysicalTraceWitnessChunk012
end YangMills
end QuantumTheory
end Mettapedia
