...
/-! Kernel-checked dimension-sixteen Cartan certificate block 30. -/
...
theorem canonicalOcticData_valid_block30 :
    ∀ entry : Fin 33,
      let index := octicWitnessBlockIndex 990 (by decide) entry
