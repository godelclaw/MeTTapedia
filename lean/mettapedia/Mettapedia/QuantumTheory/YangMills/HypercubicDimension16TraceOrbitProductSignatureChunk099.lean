...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk099
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨6336 + localIndex.1, by change 6336 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk099
end YangMills
end QuantumTheory
end Mettapedia
