...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk049
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨3136 + localIndex.1, by change 3136 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk049
end YangMills
end QuantumTheory
end Mettapedia
