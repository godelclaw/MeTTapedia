...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk103
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨6592 + localIndex.1, by change 6592 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk103
end YangMills
end QuantumTheory
end Mettapedia
