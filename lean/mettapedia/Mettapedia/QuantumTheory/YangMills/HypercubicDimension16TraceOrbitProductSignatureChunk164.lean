...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk164
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨10496 + localIndex.1, by change 10496 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk164
end YangMills
end QuantumTheory
end Mettapedia
