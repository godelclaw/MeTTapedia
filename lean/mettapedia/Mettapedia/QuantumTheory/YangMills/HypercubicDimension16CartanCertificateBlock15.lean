...
/-! Kernel-checked dimension-sixteen Cartan certificate block 15. -/
...
theorem canonicalOcticData_valid_block15 :
    ∀ entry : Fin 33,
      let index := octicWitnessBlockIndex 495 (by decide) entry
