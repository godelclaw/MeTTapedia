...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk083
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨5312 + localIndex.1, by change 5312 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk083
end YangMills
end QuantumTheory
end Mettapedia
