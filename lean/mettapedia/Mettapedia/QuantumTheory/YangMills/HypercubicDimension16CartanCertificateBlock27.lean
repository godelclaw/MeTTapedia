...
/-! Kernel-checked dimension-sixteen Cartan certificate block 27. -/
...
theorem canonicalOcticData_valid_block27 :
    ∀ entry : Fin 33,
      let index := octicWitnessBlockIndex 891 (by decide) entry
