...
namespace YangMills
namespace HypercubicDimension16PhysicalTraceWitnessFundamentalChunk059

open HypercubicDimension16PhysicalTraceWitnessExecutable

def chunkIndex (localIndex : Fin 64) : Fin 11556 :=
  ⟨11456 + localIndex.1, by change 11456 + localIndex.1 < 11556; omega⟩
...
end HypercubicDimension16PhysicalTraceWitnessFundamentalChunk059
end YangMills
end QuantumTheory
end Mettapedia
