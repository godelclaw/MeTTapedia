...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk076
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨4864 + localIndex.1, by change 4864 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk076
end YangMills
end QuantumTheory
end Mettapedia
