...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk000
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨0 + localIndex.1, by change 0 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk000
end YangMills
end QuantumTheory
end Mettapedia
