...
/-! Kernel-checked dimension-sixteen Cartan certificate block 7. -/
...
theorem canonicalOcticData_valid_block7 :
    ∀ entry : Fin 33,
      let index := octicWitnessBlockIndex 231 (by decide) entry
