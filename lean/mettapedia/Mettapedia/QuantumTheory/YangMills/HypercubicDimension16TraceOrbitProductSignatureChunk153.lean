...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk153
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨9792 + localIndex.1, by change 9792 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk153
end YangMills
end QuantumTheory
end Mettapedia
