...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk146
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨9344 + localIndex.1, by change 9344 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk146
end YangMills
end QuantumTheory
end Mettapedia
