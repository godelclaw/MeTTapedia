...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk047
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨3008 + localIndex.1, by change 3008 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk047
end YangMills
end QuantumTheory
end Mettapedia
