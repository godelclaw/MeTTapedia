...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk031
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨1984 + localIndex.1, by change 1984 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk031
end YangMills
end QuantumTheory
end Mettapedia
