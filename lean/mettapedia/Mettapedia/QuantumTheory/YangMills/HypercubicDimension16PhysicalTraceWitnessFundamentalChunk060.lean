...
namespace YangMills
namespace HypercubicDimension16PhysicalTraceWitnessFundamentalChunk060

open HypercubicDimension16PhysicalTraceWitnessExecutable

def chunkIndex (localIndex : Fin 36) : Fin 11556 :=
  ⟨11520 + localIndex.1, by change 11520 + localIndex.1 < 11556; omega⟩
...
end HypercubicDimension16PhysicalTraceWitnessFundamentalChunk060
end YangMills
end QuantumTheory
end Mettapedia
