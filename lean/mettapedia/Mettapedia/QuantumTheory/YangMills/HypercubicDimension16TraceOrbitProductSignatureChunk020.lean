...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk020
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨1280 + localIndex.1, by change 1280 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk020
end YangMills
end QuantumTheory
end Mettapedia
