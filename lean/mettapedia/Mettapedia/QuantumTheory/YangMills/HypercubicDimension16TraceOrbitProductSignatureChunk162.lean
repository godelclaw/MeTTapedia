...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk162
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨10368 + localIndex.1, by change 10368 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk162
end YangMills
end QuantumTheory
end Mettapedia
