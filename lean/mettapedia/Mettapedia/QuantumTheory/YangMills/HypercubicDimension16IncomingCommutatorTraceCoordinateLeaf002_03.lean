...
namespace YangMills
namespace HypercubicDimension16IncomingCommutatorTraceCoordinateLeaf002_03
...
theorem replay_first :
    literalIncomingUnsignedEvaluation (⟨20, by decide⟩ : Fin 98) =
      (expectedUnsignedEvaluation (⟨20, by decide⟩ : Fin 98) ⟨6, by decide⟩ -
        expectedUnsignedEvaluation (⟨20, by decide⟩ : Fin 98) ⟨4, by decide⟩) / 4 := by
  set_option maxRecDepth 100000 in
    decide +kernel

#print axioms replay_first

end HypercubicDimension16IncomingCommutatorTraceCoordinateLeaf002_03
end YangMills
end QuantumTheory
end Mettapedia
