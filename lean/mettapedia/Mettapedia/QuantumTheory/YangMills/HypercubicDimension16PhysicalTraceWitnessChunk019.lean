...
namespace YangMills
namespace HypercubicDimension16PhysicalTraceWitnessChunk019

open HypercubicDimension16PhysicalTraceWitnessExecutable

def chunkIndex (localIndex : Fin 256) : Fin 11556 :=
  ⟨4864 + localIndex.1, by change 4864 + localIndex.1 < 11556; omega⟩
...
end HypercubicDimension16PhysicalTraceWitnessChunk019
end YangMills
end QuantumTheory
end Mettapedia
