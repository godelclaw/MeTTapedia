...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk127
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨8128 + localIndex.1, by change 8128 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk127
end YangMills
end QuantumTheory
end Mettapedia
