...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk018
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨1152 + localIndex.1, by change 1152 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk018
end YangMills
end QuantumTheory
end Mettapedia
