...
/-! Kernel-checked dimension-sixteen Cartan certificate block 11. -/
...
theorem canonicalOcticData_valid_block11 :
    ∀ entry : Fin 33,
      let index := octicWitnessBlockIndex 363 (by decide) entry
