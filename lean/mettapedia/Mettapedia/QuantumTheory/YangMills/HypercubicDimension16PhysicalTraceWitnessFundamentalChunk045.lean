...
namespace YangMills
namespace HypercubicDimension16PhysicalTraceWitnessFundamentalChunk045

open HypercubicDimension16PhysicalTraceWitnessExecutable

def chunkIndex (localIndex : Fin 64) : Fin 11556 :=
  ⟨10560 + localIndex.1, by change 10560 + localIndex.1 < 11556; omega⟩
...
end HypercubicDimension16PhysicalTraceWitnessFundamentalChunk045
end YangMills
end QuantumTheory
end Mettapedia
