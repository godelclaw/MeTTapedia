...
namespace YangMills
namespace HypercubicDimension16PhysicalTraceWitnessChunk017

open HypercubicDimension16PhysicalTraceWitnessExecutable

def chunkIndex (localIndex : Fin 256) : Fin 11556 :=
  ⟨4352 + localIndex.1, by change 4352 + localIndex.1 < 11556; omega⟩
...
end HypercubicDimension16PhysicalTraceWitnessChunk017
end YangMills
end QuantumTheory
end Mettapedia
