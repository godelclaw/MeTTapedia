...
/-! Kernel-checked dimension-sixteen Cartan certificate block 26. -/
...
theorem canonicalOcticData_valid_block26 :
    ∀ entry : Fin 33,
      let index := octicWitnessBlockIndex 858 (by decide) entry
