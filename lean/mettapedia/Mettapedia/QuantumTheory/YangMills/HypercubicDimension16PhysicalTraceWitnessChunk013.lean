...
namespace YangMills
namespace HypercubicDimension16PhysicalTraceWitnessChunk013

open HypercubicDimension16PhysicalTraceWitnessExecutable

def chunkIndex (localIndex : Fin 256) : Fin 11556 :=
  ⟨3328 + localIndex.1, by change 3328 + localIndex.1 < 11556; omega⟩
...
end HypercubicDimension16PhysicalTraceWitnessChunk013
end YangMills
end QuantumTheory
end Mettapedia
