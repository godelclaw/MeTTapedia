...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk148
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨9472 + localIndex.1, by change 9472 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk148
end YangMills
end QuantumTheory
end Mettapedia
