...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk158
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨10112 + localIndex.1, by change 10112 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk158
end YangMills
end QuantumTheory
end Mettapedia
