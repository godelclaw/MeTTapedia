...
/-! Kernel-checked dimension-sixteen Cartan certificate block 32. -/
...
theorem canonicalOcticData_valid_block32 :
    ∀ entry : Fin 33,
      let index := octicWitnessBlockIndex 1056 (by decide) entry
