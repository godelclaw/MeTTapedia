...
/-! Kernel-checked dimension-sixteen Cartan certificate block 35. -/
...
theorem canonicalOcticData_valid_block35 :
    ∀ entry : Fin 33,
      let index := octicWitnessBlockIndex 1155 (by decide) entry
