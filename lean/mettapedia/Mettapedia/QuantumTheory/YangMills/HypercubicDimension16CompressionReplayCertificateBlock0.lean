...
/-! Kernel-checked compression replay block 0. -/
...
theorem decodedPowerTraceReplayCheckAt_certificate_block0 :
    decodedPowerTraceReplayCheckAt 0 = true := by
...
theorem decodedOrientationReplayCheckAt_certificate_block0 :
    decodedOrientationReplayCheckAt 0 = true := by
...
theorem decodedPowerTraceClassAt_certificate_block0
    (reflectionMask : Fin 16) :
    decodedPowerTraceClassAt 0 reflectionMask =
      expectedPowerTraceClassAt 0 reflectionMask := by
