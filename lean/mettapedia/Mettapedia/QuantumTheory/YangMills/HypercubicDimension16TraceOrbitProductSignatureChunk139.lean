...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk139
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨8896 + localIndex.1, by change 8896 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk139
end YangMills
end QuantumTheory
end Mettapedia
