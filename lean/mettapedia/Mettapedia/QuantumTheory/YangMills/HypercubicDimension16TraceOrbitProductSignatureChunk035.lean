...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk035
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨2240 + localIndex.1, by change 2240 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk035
end YangMills
end QuantumTheory
end Mettapedia
