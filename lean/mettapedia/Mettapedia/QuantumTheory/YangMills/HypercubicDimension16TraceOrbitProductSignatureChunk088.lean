...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk088
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨5632 + localIndex.1, by change 5632 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk088
end YangMills
end QuantumTheory
end Mettapedia
