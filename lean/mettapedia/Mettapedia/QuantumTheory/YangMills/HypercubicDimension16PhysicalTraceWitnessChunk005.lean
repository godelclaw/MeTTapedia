...
namespace YangMills
namespace HypercubicDimension16PhysicalTraceWitnessChunk005

open HypercubicDimension16PhysicalTraceWitnessExecutable

def chunkIndex (localIndex : Fin 256) : Fin 11556 :=
  ⟨1280 + localIndex.1, by change 1280 + localIndex.1 < 11556; omega⟩
...
end HypercubicDimension16PhysicalTraceWitnessChunk005
end YangMills
end QuantumTheory
end Mettapedia
