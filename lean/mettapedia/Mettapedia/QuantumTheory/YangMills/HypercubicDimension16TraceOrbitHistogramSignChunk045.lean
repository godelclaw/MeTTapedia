...
namespace YangMills
namespace HypercubicDimension16TraceOrbitHistogramSignChunk045
...
def chunkIndex (localIndex : Fin 134) : PositiveRepresentativeIndex :=
  ⟨11520 + localIndex.1, by change 11520 + localIndex.1 < 11654; omega⟩

/-- Every pure reflection has positive tensor sign in this range. -/
theorem chunk_reflection_signs_positive :
    ∀ localIndex : Fin 134, ∀ reflection : Fin 16,
...
theorem chunk_unsigned_histogram_stabilizers_positive :
    ∀ localIndex : Fin 134, ∀ permutation : Fin 24,
...
end HypercubicDimension16TraceOrbitHistogramSignChunk045
end YangMills
end QuantumTheory
end Mettapedia
