...
/-! Kernel-checked dimension-sixteen Cartan certificate block 29. -/
...
theorem canonicalOcticData_valid_block29 :
    ∀ entry : Fin 33,
      let index := octicWitnessBlockIndex 957 (by decide) entry
