...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk163
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨10432 + localIndex.1, by change 10432 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk163
end YangMills
end QuantumTheory
end Mettapedia
