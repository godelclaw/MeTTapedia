...
namespace YangMills
namespace HypercubicDimension16PhysicalTraceWitnessFundamentalChunk047

open HypercubicDimension16PhysicalTraceWitnessExecutable

def chunkIndex (localIndex : Fin 64) : Fin 11556 :=
  ⟨10688 + localIndex.1, by change 10688 + localIndex.1 < 11556; omega⟩
...
end HypercubicDimension16PhysicalTraceWitnessFundamentalChunk047
end YangMills
end QuantumTheory
end Mettapedia
