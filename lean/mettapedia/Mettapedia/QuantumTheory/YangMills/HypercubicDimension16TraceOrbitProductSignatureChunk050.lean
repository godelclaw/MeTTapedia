...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk050
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨3200 + localIndex.1, by change 3200 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk050
end YangMills
end QuantumTheory
end Mettapedia
