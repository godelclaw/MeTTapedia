...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk086
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨5504 + localIndex.1, by change 5504 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk086
end YangMills
end QuantumTheory
end Mettapedia
