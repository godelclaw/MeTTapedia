...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk121
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨7744 + localIndex.1, by change 7744 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk121
end YangMills
end QuantumTheory
end Mettapedia
