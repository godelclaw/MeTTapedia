...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk098
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨6272 + localIndex.1, by change 6272 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk098
end YangMills
end QuantumTheory
end Mettapedia
