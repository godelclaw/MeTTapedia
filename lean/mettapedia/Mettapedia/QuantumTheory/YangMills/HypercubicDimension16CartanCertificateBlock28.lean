...
/-! Kernel-checked dimension-sixteen Cartan certificate block 28. -/
...
theorem canonicalOcticData_valid_block28 :
    ∀ entry : Fin 33,
      let index := octicWitnessBlockIndex 924 (by decide) entry
