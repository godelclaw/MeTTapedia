...
/-! Kernel-checked dimension-sixteen Cartan certificate block 14. -/
...
theorem canonicalOcticData_valid_block14 :
    ∀ entry : Fin 33,
      let index := octicWitnessBlockIndex 462 (by decide) entry
