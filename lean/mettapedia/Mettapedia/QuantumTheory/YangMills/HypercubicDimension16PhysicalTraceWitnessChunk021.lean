...
namespace YangMills
namespace HypercubicDimension16PhysicalTraceWitnessChunk021

open HypercubicDimension16PhysicalTraceWitnessExecutable

def chunkIndex (localIndex : Fin 256) : Fin 11556 :=
  ⟨5376 + localIndex.1, by change 5376 + localIndex.1 < 11556; omega⟩
...
end HypercubicDimension16PhysicalTraceWitnessChunk021
end YangMills
end QuantumTheory
end Mettapedia
