...
/-! Kernel-checked dimension-sixteen Cartan certificate block 37. -/
...
theorem canonicalOcticData_valid_block37 :
    ∀ entry : Fin 33,
      let index := octicWitnessBlockIndex 1221 (by decide) entry
