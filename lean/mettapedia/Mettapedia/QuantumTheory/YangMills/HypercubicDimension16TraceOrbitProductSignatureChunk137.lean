...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk137
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨8768 + localIndex.1, by change 8768 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk137
end YangMills
end QuantumTheory
end Mettapedia
