...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk091
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨5824 + localIndex.1, by change 5824 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk091
end YangMills
end QuantumTheory
end Mettapedia
