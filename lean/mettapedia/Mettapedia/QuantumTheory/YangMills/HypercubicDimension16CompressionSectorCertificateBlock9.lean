...
/-! Kernel-checked class-compressed sector block 9. -/
...
theorem classCompressedSectorCharacter_certificate_block9
    (fieldIndex : Fin 8) :
    classCompressedSectorCharacter 9 (fieldIndex.1 + 1) =
      expectedClassCompressedSectorCharacter 9
        (fieldIndex.1 + 1) := by
