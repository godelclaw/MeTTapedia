...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk085
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨5440 + localIndex.1, by change 5440 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk085
end YangMills
end QuantumTheory
end Mettapedia
