...
/-! Kernel-checked dimension-sixteen Cartan certificate block 24. -/
...
theorem canonicalOcticData_valid_block24 :
    ∀ entry : Fin 33,
      let index := octicWitnessBlockIndex 792 (by decide) entry
