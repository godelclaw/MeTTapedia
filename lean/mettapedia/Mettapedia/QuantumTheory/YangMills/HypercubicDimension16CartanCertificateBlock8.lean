...
/-! Kernel-checked dimension-sixteen Cartan certificate block 8. -/
...
theorem canonicalOcticData_valid_block8 :
    ∀ entry : Fin 33,
      let index := octicWitnessBlockIndex 264 (by decide) entry
