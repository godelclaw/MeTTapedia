...
namespace YangMills
namespace HypercubicDimension16PhysicalTraceWitnessChunk008

open HypercubicDimension16PhysicalTraceWitnessExecutable

def chunkIndex (localIndex : Fin 256) : Fin 11556 :=
  ⟨2048 + localIndex.1, by change 2048 + localIndex.1 < 11556; omega⟩
...
end HypercubicDimension16PhysicalTraceWitnessChunk008
end YangMills
end QuantumTheory
end Mettapedia
