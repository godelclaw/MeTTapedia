...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk154
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨9856 + localIndex.1, by change 9856 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk154
end YangMills
end QuantumTheory
end Mettapedia
