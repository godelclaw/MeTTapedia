...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk051
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨3264 + localIndex.1, by change 3264 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk051
end YangMills
end QuantumTheory
end Mettapedia
