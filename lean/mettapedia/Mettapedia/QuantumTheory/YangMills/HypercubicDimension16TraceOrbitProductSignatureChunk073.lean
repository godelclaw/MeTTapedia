...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk073
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨4672 + localIndex.1, by change 4672 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk073
end YangMills
end QuantumTheory
end Mettapedia
