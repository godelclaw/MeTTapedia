...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk152
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨9728 + localIndex.1, by change 9728 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk152
end YangMills
end QuantumTheory
end Mettapedia
