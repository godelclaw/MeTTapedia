...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk012
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨768 + localIndex.1, by change 768 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk012
end YangMills
end QuantumTheory
end Mettapedia
