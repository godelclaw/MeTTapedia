...
/-! Kernel-checked dimension-sixteen Cartan certificate block 4. -/
...
theorem canonicalOcticData_valid_block4 :
    ∀ entry : Fin 33,
      let index := octicWitnessBlockIndex 132 (by decide) entry
