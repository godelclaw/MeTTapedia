...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk173
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨11072 + localIndex.1, by change 11072 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk173
end YangMills
end QuantumTheory
end Mettapedia
