...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk054
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨3456 + localIndex.1, by change 3456 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk054
end YangMills
end QuantumTheory
end Mettapedia
