...
/-! Kernel-checked class-compressed sector block 0. -/
...
theorem classCompressedSectorCharacter_certificate_block0
    (fieldIndex : Fin 8) :
    classCompressedSectorCharacter 0 (fieldIndex.1 + 1) =
      expectedClassCompressedSectorCharacter 0
        (fieldIndex.1 + 1) := by
