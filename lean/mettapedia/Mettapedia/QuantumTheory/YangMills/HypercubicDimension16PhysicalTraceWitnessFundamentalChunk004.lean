...
namespace YangMills
namespace HypercubicDimension16PhysicalTraceWitnessFundamentalChunk004

open HypercubicDimension16PhysicalTraceWitnessExecutable

def chunkIndex (localIndex : Fin 64) : Fin 11556 :=
  ⟨7936 + localIndex.1, by change 7936 + localIndex.1 < 11556; omega⟩
...
end HypercubicDimension16PhysicalTraceWitnessFundamentalChunk004
end YangMills
end QuantumTheory
end Mettapedia
