...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk037
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨2368 + localIndex.1, by change 2368 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk037
end YangMills
end QuantumTheory
end Mettapedia
