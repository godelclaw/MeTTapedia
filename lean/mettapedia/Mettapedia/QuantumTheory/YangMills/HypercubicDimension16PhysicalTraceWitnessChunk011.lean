...
namespace YangMills
namespace HypercubicDimension16PhysicalTraceWitnessChunk011

open HypercubicDimension16PhysicalTraceWitnessExecutable

def chunkIndex (localIndex : Fin 256) : Fin 11556 :=
  ⟨2816 + localIndex.1, by change 2816 + localIndex.1 < 11556; omega⟩
...
end HypercubicDimension16PhysicalTraceWitnessChunk011
end YangMills
end QuantumTheory
end Mettapedia
