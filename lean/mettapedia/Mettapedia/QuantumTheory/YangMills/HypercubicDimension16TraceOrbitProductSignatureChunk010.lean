...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk010
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨640 + localIndex.1, by change 640 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk010
end YangMills
end QuantumTheory
end Mettapedia
