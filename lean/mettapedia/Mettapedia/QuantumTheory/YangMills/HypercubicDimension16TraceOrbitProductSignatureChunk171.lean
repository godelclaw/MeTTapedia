...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk171
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨10944 + localIndex.1, by change 10944 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk171
end YangMills
end QuantumTheory
end Mettapedia
