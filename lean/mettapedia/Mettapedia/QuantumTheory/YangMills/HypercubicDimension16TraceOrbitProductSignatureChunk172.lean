...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk172
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨11008 + localIndex.1, by change 11008 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk172
end YangMills
end QuantumTheory
end Mettapedia
