...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk133
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨8512 + localIndex.1, by change 8512 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk133
end YangMills
end QuantumTheory
end Mettapedia
