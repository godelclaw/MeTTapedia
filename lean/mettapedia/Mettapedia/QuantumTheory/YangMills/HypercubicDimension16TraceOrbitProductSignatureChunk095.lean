...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk095
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨6080 + localIndex.1, by change 6080 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk095
end YangMills
end QuantumTheory
end Mettapedia
