...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk074
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨4736 + localIndex.1, by change 4736 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk074
end YangMills
end QuantumTheory
end Mettapedia
