...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk125
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨8000 + localIndex.1, by change 8000 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk125
end YangMills
end QuantumTheory
end Mettapedia
