...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk059
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨3776 + localIndex.1, by change 3776 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk059
end YangMills
end QuantumTheory
end Mettapedia
