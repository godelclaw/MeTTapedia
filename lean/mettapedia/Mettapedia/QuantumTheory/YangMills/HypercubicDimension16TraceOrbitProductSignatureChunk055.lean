...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk055
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨3520 + localIndex.1, by change 3520 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk055
end YangMills
end QuantumTheory
end Mettapedia
