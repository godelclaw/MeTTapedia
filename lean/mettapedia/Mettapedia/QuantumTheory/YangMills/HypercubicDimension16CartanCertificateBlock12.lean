...
/-! Kernel-checked dimension-sixteen Cartan certificate block 12. -/
...
theorem canonicalOcticData_valid_block12 :
    ∀ entry : Fin 33,
      let index := octicWitnessBlockIndex 396 (by decide) entry
