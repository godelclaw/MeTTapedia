...
/-! Kernel-checked class-compressed sector block 2. -/
...
theorem classCompressedSectorCharacter_certificate_block2
    (fieldIndex : Fin 8) :
    classCompressedSectorCharacter 2 (fieldIndex.1 + 1) =
      expectedClassCompressedSectorCharacter 2
        (fieldIndex.1 + 1) := by
