...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk090
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨5760 + localIndex.1, by change 5760 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk090
end YangMills
end QuantumTheory
end Mettapedia
