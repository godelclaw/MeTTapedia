...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk044
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨2816 + localIndex.1, by change 2816 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk044
end YangMills
end QuantumTheory
end Mettapedia
