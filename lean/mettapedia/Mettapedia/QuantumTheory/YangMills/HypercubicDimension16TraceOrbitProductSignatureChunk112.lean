...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk112
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨7168 + localIndex.1, by change 7168 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk112
end YangMills
end QuantumTheory
end Mettapedia
