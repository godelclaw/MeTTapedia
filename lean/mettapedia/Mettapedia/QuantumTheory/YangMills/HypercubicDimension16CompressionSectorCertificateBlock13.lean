...
/-! Kernel-checked class-compressed sector block 13. -/
...
theorem classCompressedSectorCharacter_certificate_block13
    (fieldIndex : Fin 8) :
    classCompressedSectorCharacter 13 (fieldIndex.1 + 1) =
      expectedClassCompressedSectorCharacter 13
        (fieldIndex.1 + 1) := by
