...
namespace YangMills
namespace HypercubicDimension16PhysicalTraceWitnessChunk020

open HypercubicDimension16PhysicalTraceWitnessExecutable

def chunkIndex (localIndex : Fin 256) : Fin 11556 :=
  ⟨5120 + localIndex.1, by change 5120 + localIndex.1 < 11556; omega⟩
...
end HypercubicDimension16PhysicalTraceWitnessChunk020
end YangMills
end QuantumTheory
end Mettapedia
