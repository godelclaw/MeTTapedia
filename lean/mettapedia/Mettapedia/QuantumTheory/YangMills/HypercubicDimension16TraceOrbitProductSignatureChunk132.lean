...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk132
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨8448 + localIndex.1, by change 8448 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk132
end YangMills
end QuantumTheory
end Mettapedia
