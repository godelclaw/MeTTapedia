...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk005
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨320 + localIndex.1, by change 320 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk005
end YangMills
end QuantumTheory
end Mettapedia
