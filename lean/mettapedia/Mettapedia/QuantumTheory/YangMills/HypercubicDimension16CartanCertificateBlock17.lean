...
/-! Kernel-checked dimension-sixteen Cartan certificate block 17. -/
...
theorem canonicalOcticData_valid_block17 :
    ∀ entry : Fin 33,
      let index := octicWitnessBlockIndex 561 (by decide) entry
