...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk017
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨1088 + localIndex.1, by change 1088 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk017
end YangMills
end QuantumTheory
end Mettapedia
