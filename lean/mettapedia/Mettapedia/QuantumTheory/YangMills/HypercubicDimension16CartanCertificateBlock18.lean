...
/-! Kernel-checked dimension-sixteen Cartan certificate block 18. -/
...
theorem canonicalOcticData_valid_block18 :
    ∀ entry : Fin 33,
      let index := octicWitnessBlockIndex 594 (by decide) entry
