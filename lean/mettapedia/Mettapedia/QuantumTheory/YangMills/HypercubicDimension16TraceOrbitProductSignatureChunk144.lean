...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk144
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨9216 + localIndex.1, by change 9216 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk144
end YangMills
end QuantumTheory
end Mettapedia
