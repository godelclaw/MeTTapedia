...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk101
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨6464 + localIndex.1, by change 6464 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk101
end YangMills
end QuantumTheory
end Mettapedia
