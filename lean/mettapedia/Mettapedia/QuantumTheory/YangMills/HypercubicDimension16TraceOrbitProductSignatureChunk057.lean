...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk057
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨3648 + localIndex.1, by change 3648 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk057
end YangMills
end QuantumTheory
end Mettapedia
