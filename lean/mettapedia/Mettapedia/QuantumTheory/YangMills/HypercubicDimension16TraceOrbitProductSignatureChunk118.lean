...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk118
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨7552 + localIndex.1, by change 7552 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk118
end YangMills
end QuantumTheory
end Mettapedia
