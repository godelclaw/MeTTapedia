...
namespace YangMills
namespace HypercubicDimension16PhysicalTraceWitnessChunk010

open HypercubicDimension16PhysicalTraceWitnessExecutable

def chunkIndex (localIndex : Fin 256) : Fin 11556 :=
  ⟨2560 + localIndex.1, by change 2560 + localIndex.1 < 11556; omega⟩
...
end HypercubicDimension16PhysicalTraceWitnessChunk010
end YangMills
end QuantumTheory
end Mettapedia
