...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk068
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨4352 + localIndex.1, by change 4352 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk068
end YangMills
end QuantumTheory
end Mettapedia
