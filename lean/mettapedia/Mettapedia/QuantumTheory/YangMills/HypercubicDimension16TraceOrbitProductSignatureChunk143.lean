...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk143
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨9152 + localIndex.1, by change 9152 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk143
end YangMills
end QuantumTheory
end Mettapedia
