...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk048
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨3072 + localIndex.1, by change 3072 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk048
end YangMills
end QuantumTheory
end Mettapedia
