...
/-! Kernel-checked dimension-sixteen Cartan certificate block 20. -/
...
theorem canonicalOcticData_valid_block20 :
    ∀ entry : Fin 33,
      let index := octicWitnessBlockIndex 660 (by decide) entry
