...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk150
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨9600 + localIndex.1, by change 9600 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk150
end YangMills
end QuantumTheory
end Mettapedia
