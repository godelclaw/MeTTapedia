...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk019
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨1216 + localIndex.1, by change 1216 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk019
end YangMills
end QuantumTheory
end Mettapedia
