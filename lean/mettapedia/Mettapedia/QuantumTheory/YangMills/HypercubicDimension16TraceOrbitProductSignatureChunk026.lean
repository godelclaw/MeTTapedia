...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk026
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨1664 + localIndex.1, by change 1664 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk026
end YangMills
end QuantumTheory
end Mettapedia
