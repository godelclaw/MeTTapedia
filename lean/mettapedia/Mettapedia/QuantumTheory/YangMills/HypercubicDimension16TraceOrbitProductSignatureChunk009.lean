...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk009
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨576 + localIndex.1, by change 576 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk009
end YangMills
end QuantumTheory
end Mettapedia
