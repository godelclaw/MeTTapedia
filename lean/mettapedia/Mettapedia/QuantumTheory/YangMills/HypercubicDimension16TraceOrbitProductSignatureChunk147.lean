...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk147
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨9408 + localIndex.1, by change 9408 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk147
end YangMills
end QuantumTheory
end Mettapedia
