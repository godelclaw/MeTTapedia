...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk157
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨10048 + localIndex.1, by change 10048 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk157
end YangMills
end QuantumTheory
end Mettapedia
