...
/-! Kernel-checked class-compressed sector block 6. -/
...
theorem classCompressedSectorCharacter_certificate_block6
    (fieldIndex : Fin 8) :
    classCompressedSectorCharacter 6 (fieldIndex.1 + 1) =
      expectedClassCompressedSectorCharacter 6
        (fieldIndex.1 + 1) := by
