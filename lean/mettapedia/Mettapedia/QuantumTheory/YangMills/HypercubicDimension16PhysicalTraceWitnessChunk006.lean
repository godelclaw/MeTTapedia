...
namespace YangMills
namespace HypercubicDimension16PhysicalTraceWitnessChunk006

open HypercubicDimension16PhysicalTraceWitnessExecutable

def chunkIndex (localIndex : Fin 256) : Fin 11556 :=
  ⟨1536 + localIndex.1, by change 1536 + localIndex.1 < 11556; omega⟩
...
end HypercubicDimension16PhysicalTraceWitnessChunk006
end YangMills
end QuantumTheory
end Mettapedia
