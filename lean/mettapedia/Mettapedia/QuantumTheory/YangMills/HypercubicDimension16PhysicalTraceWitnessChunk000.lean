...
namespace YangMills
namespace HypercubicDimension16PhysicalTraceWitnessChunk000

open HypercubicDimension16PhysicalTraceWitnessExecutable

def chunkIndex (localIndex : Fin 256) : Fin 11556 :=
  ⟨0 + localIndex.1, by change 0 + localIndex.1 < 11556; omega⟩
...
end HypercubicDimension16PhysicalTraceWitnessChunk000
end YangMills
end QuantumTheory
end Mettapedia
