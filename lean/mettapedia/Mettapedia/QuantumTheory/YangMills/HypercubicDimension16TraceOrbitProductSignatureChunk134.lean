...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk134
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨8576 + localIndex.1, by change 8576 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk134
end YangMills
end QuantumTheory
end Mettapedia
