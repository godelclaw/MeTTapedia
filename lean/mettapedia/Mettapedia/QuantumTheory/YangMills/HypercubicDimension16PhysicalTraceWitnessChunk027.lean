...
namespace YangMills
namespace HypercubicDimension16PhysicalTraceWitnessChunk027

open HypercubicDimension16PhysicalTraceWitnessExecutable

def chunkIndex (localIndex : Fin 256) : Fin 11556 :=
  ⟨6912 + localIndex.1, by change 6912 + localIndex.1 < 11556; omega⟩
...
end HypercubicDimension16PhysicalTraceWitnessChunk027
end YangMills
end QuantumTheory
end Mettapedia
