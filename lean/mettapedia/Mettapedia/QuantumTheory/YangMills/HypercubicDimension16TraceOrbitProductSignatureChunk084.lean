...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk084
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨5376 + localIndex.1, by change 5376 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk084
end YangMills
end QuantumTheory
end Mettapedia
