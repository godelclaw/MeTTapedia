...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk075
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨4800 + localIndex.1, by change 4800 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk075
end YangMills
end QuantumTheory
end Mettapedia
