...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk089
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨5696 + localIndex.1, by change 5696 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk089
end YangMills
end QuantumTheory
end Mettapedia
