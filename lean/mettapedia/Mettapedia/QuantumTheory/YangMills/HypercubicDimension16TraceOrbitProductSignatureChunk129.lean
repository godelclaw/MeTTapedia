...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk129
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨8256 + localIndex.1, by change 8256 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk129
end YangMills
end QuantumTheory
end Mettapedia
