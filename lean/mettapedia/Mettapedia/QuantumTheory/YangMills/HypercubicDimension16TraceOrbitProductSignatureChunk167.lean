...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk167
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨10688 + localIndex.1, by change 10688 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk167
end YangMills
end QuantumTheory
end Mettapedia
