...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk120
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨7680 + localIndex.1, by change 7680 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk120
end YangMills
end QuantumTheory
end Mettapedia
