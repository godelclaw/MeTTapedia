...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk014
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨896 + localIndex.1, by change 896 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk014
end YangMills
end QuantumTheory
end Mettapedia
