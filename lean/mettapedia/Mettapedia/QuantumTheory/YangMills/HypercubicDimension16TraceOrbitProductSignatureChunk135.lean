...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk135
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨8640 + localIndex.1, by change 8640 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk135
end YangMills
end QuantumTheory
end Mettapedia
