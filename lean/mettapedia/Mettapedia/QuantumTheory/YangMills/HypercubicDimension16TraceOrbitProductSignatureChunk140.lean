...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk140
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨8960 + localIndex.1, by change 8960 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk140
end YangMills
end QuantumTheory
end Mettapedia
