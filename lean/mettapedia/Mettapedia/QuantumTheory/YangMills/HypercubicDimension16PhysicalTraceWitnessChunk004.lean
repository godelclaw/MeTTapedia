...
namespace YangMills
namespace HypercubicDimension16PhysicalTraceWitnessChunk004

open HypercubicDimension16PhysicalTraceWitnessExecutable

def chunkIndex (localIndex : Fin 256) : Fin 11556 :=
  ⟨1024 + localIndex.1, by change 1024 + localIndex.1 < 11556; omega⟩
...
end HypercubicDimension16PhysicalTraceWitnessChunk004
end YangMills
end QuantumTheory
end Mettapedia
