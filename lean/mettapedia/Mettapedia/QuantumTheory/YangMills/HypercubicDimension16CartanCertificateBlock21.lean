...
/-! Kernel-checked dimension-sixteen Cartan certificate block 21. -/
...
theorem canonicalOcticData_valid_block21 :
    ∀ entry : Fin 33,
      let index := octicWitnessBlockIndex 693 (by decide) entry
