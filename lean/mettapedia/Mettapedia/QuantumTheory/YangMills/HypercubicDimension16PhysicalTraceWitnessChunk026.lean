...
namespace YangMills
namespace HypercubicDimension16PhysicalTraceWitnessChunk026

open HypercubicDimension16PhysicalTraceWitnessExecutable

def chunkIndex (localIndex : Fin 256) : Fin 11556 :=
  ⟨6656 + localIndex.1, by change 6656 + localIndex.1 < 11556; omega⟩
...
end HypercubicDimension16PhysicalTraceWitnessChunk026
end YangMills
end QuantumTheory
end Mettapedia
