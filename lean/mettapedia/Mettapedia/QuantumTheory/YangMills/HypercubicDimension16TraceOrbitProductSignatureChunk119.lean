...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk119
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨7616 + localIndex.1, by change 7616 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk119
end YangMills
end QuantumTheory
end Mettapedia
