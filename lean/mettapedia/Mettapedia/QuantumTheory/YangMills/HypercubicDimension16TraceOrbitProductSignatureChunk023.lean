...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk023
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨1472 + localIndex.1, by change 1472 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk023
end YangMills
end QuantumTheory
end Mettapedia
