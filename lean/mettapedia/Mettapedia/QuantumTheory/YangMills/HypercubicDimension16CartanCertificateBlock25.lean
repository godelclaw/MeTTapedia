...
/-! Kernel-checked dimension-sixteen Cartan certificate block 25. -/
...
theorem canonicalOcticData_valid_block25 :
    ∀ entry : Fin 33,
      let index := octicWitnessBlockIndex 825 (by decide) entry
