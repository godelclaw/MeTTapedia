...
/-! Kernel-checked dimension-sixteen Cartan certificate block 10. -/
...
theorem canonicalOcticData_valid_block10 :
    ∀ entry : Fin 33,
      let index := octicWitnessBlockIndex 330 (by decide) entry
