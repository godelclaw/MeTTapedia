...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk039
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨2496 + localIndex.1, by change 2496 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk039
end YangMills
end QuantumTheory
end Mettapedia
