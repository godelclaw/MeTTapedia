...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk100
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨6400 + localIndex.1, by change 6400 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk100
end YangMills
end QuantumTheory
end Mettapedia
