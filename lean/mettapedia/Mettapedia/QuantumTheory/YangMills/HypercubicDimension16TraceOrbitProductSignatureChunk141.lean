...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk141
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨9024 + localIndex.1, by change 9024 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk141
end YangMills
end QuantumTheory
end Mettapedia
