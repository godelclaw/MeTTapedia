...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk156
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨9984 + localIndex.1, by change 9984 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk156
end YangMills
end QuantumTheory
end Mettapedia
