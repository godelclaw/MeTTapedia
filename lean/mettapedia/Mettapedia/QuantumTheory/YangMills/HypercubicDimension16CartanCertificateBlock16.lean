...
/-! Kernel-checked dimension-sixteen Cartan certificate block 16. -/
...
theorem canonicalOcticData_valid_block16 :
    ∀ entry : Fin 33,
      let index := octicWitnessBlockIndex 528 (by decide) entry
