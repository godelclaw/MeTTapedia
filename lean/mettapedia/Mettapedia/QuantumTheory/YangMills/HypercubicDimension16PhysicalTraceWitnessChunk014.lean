...
namespace YangMills
namespace HypercubicDimension16PhysicalTraceWitnessChunk014

open HypercubicDimension16PhysicalTraceWitnessExecutable

def chunkIndex (localIndex : Fin 256) : Fin 11556 :=
  ⟨3584 + localIndex.1, by change 3584 + localIndex.1 < 11556; omega⟩
...
end HypercubicDimension16PhysicalTraceWitnessChunk014
end YangMills
end QuantumTheory
end Mettapedia
