...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk006
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨384 + localIndex.1, by change 384 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk006
end YangMills
end QuantumTheory
end Mettapedia
