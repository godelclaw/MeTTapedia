...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk122
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨7808 + localIndex.1, by change 7808 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk122
end YangMills
end QuantumTheory
end Mettapedia
