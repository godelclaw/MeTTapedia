...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk015
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨960 + localIndex.1, by change 960 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk015
end YangMills
end QuantumTheory
end Mettapedia
