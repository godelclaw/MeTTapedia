...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk151
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨9664 + localIndex.1, by change 9664 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk151
end YangMills
end QuantumTheory
end Mettapedia
