...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk056
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨3584 + localIndex.1, by change 3584 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk056
end YangMills
end QuantumTheory
end Mettapedia
