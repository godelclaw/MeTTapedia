...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk124
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨7936 + localIndex.1, by change 7936 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk124
end YangMills
end QuantumTheory
end Mettapedia
