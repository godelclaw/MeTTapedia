...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk096
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨6144 + localIndex.1, by change 6144 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk096
end YangMills
end QuantumTheory
end Mettapedia
