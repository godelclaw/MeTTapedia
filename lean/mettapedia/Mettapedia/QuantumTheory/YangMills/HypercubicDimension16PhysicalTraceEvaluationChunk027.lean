import Mettapedia.QuantumTheory.YangMills.HypercubicDimension16PhysicalTraceEvaluationBlock027_000
import Mettapedia.QuantumTheory.YangMills.HypercubicDimension16PhysicalTraceEvaluationBlock027_001
import Mettapedia.QuantumTheory.YangMills.HypercubicDimension16PhysicalTraceEvaluationBlock027_002
import Mettapedia.QuantumTheory.YangMills.HypercubicDimension16PhysicalTraceEvaluationBlock027_003
import Mettapedia.QuantumTheory.YangMills.HypercubicDimension16PhysicalTraceEvaluationBlock027_004
import Mettapedia.QuantumTheory.YangMills.HypercubicDimension16PhysicalTraceEvaluationBlock027_005
import Mettapedia.QuantumTheory.YangMills.HypercubicDimension16PhysicalTraceEvaluationBlock027_006
import Mettapedia.QuantumTheory.YangMills.HypercubicDimension16PhysicalTraceEvaluationBlock027_007
import Mettapedia.QuantumTheory.YangMills.HypercubicDimension16PhysicalTraceEvaluationBlock027_008
import Mettapedia.QuantumTheory.YangMills.HypercubicDimension16PhysicalTraceEvaluationBlock027_009
import Mettapedia.QuantumTheory.YangMills.HypercubicDimension16PhysicalTraceEvaluationBlock027_010
import Mettapedia.QuantumTheory.YangMills.HypercubicDimension16PhysicalTraceEvaluationBlock027_011
import Mettapedia.QuantumTheory.YangMills.HypercubicDimension16PhysicalTraceEvaluationBlock027_012
...
namespace YangMills
namespace HypercubicDimension16PhysicalTraceEvaluationChunk027
...
theorem chunk_unsigned_evaluations :
  ...
  · let columnLocalIndex : Fin 8 := ⟨freeIndex.1 - 0, by omega⟩
    ...
    rw [← hequal]
    exact HypercubicDimension16PhysicalTraceEvaluationBlock027_000.unsigned localIndex columnLocalIndex
  ...
  · let columnLocalIndex : Fin 8 := ⟨freeIndex.1 - 8, by omega⟩
    ...
    rw [← hequal]
    exact HypercubicDimension16PhysicalTraceEvaluationBlock027_001.unsigned localIndex columnLocalIndex
  ...
  · let columnLocalIndex : Fin 8 := ⟨freeIndex.1 - 16, by omega⟩
    ...
    rw [← hequal]
    exact HypercubicDimension16PhysicalTraceEvaluationBlock027_002.unsigned localIndex columnLocalIndex
  ...
  · let columnLocalIndex : Fin 8 := ⟨freeIndex.1 - 24, by omega⟩
    ...
    rw [← hequal]
    exact HypercubicDimension16PhysicalTraceEvaluationBlock027_003.unsigned localIndex columnLocalIndex
  ...
  · let columnLocalIndex : Fin 8 := ⟨freeIndex.1 - 32, by omega⟩
    ...
    rw [← hequal]
    exact HypercubicDimension16PhysicalTraceEvaluationBlock027_004.unsigned localIndex columnLocalIndex
  ...
  · let columnLocalIndex : Fin 8 := ⟨freeIndex.1 - 40, by omega⟩
    ...
    rw [← hequal]
    exact HypercubicDimension16PhysicalTraceEvaluationBlock027_005.unsigned localIndex columnLocalIndex
  ...
  · let columnLocalIndex : Fin 8 := ⟨freeIndex.1 - 48, by omega⟩
    ...
    rw [← hequal]
    exact HypercubicDimension16PhysicalTraceEvaluationBlock027_006.unsigned localIndex columnLocalIndex
  ...
  · let columnLocalIndex : Fin 8 := ⟨freeIndex.1 - 56, by omega⟩
    ...
    rw [← hequal]
    exact HypercubicDimension16PhysicalTraceEvaluationBlock027_007.unsigned localIndex columnLocalIndex
  ...
  · let columnLocalIndex : Fin 8 := ⟨freeIndex.1 - 64, by omega⟩
    ...
    rw [← hequal]
    exact HypercubicDimension16PhysicalTraceEvaluationBlock027_008.unsigned localIndex columnLocalIndex
  ...
  · let columnLocalIndex : Fin 8 := ⟨freeIndex.1 - 72, by omega⟩
    ...
    rw [← hequal]
    exact HypercubicDimension16PhysicalTraceEvaluationBlock027_009.unsigned localIndex columnLocalIndex
  ...
  · let columnLocalIndex : Fin 8 := ⟨freeIndex.1 - 80, by omega⟩
    ...
    rw [← hequal]
    exact HypercubicDimension16PhysicalTraceEvaluationBlock027_010.unsigned localIndex columnLocalIndex
  ...
  · let columnLocalIndex : Fin 8 := ⟨freeIndex.1 - 88, by omega⟩
    ...
    rw [← hequal]
    exact HypercubicDimension16PhysicalTraceEvaluationBlock027_011.unsigned localIndex columnLocalIndex
  ...
  rw [← hequal]
  exact HypercubicDimension16PhysicalTraceEvaluationBlock027_012.unsigned localIndex columnLocalIndex
...
theorem chunk_evaluation_inverse :
  ...
  · let columnLocalIndex : Fin 8 := ⟨column.1 - 0, by omega⟩
    have hequal : columnIndex000 columnLocalIndex = column := by
      ...
      simp [columnIndex000, columnLocalIndex] <;> omega
    rw [← hequal]
    exact HypercubicDimension16PhysicalTraceEvaluationBlock027_000.inverse localIndex columnLocalIndex
  ...
  · let columnLocalIndex : Fin 8 := ⟨column.1 - 8, by omega⟩
    have hequal : columnIndex001 columnLocalIndex = column := by
      ...
      simp [columnIndex001, columnLocalIndex] <;> omega
    rw [← hequal]
    exact HypercubicDimension16PhysicalTraceEvaluationBlock027_001.inverse localIndex columnLocalIndex
  ...
  · let columnLocalIndex : Fin 8 := ⟨column.1 - 16, by omega⟩
    have hequal : columnIndex002 columnLocalIndex = column := by
      ...
      simp [columnIndex002, columnLocalIndex] <;> omega
    rw [← hequal]
    exact HypercubicDimension16PhysicalTraceEvaluationBlock027_002.inverse localIndex columnLocalIndex
  ...
  · let columnLocalIndex : Fin 8 := ⟨column.1 - 24, by omega⟩
    have hequal : columnIndex003 columnLocalIndex = column := by
      ...
      simp [columnIndex003, columnLocalIndex] <;> omega
    rw [← hequal]
    exact HypercubicDimension16PhysicalTraceEvaluationBlock027_003.inverse localIndex columnLocalIndex
  ...
  · let columnLocalIndex : Fin 8 := ⟨column.1 - 32, by omega⟩
    have hequal : columnIndex004 columnLocalIndex = column := by
      ...
      simp [columnIndex004, columnLocalIndex] <;> omega
    rw [← hequal]
    exact HypercubicDimension16PhysicalTraceEvaluationBlock027_004.inverse localIndex columnLocalIndex
  ...
  · let columnLocalIndex : Fin 8 := ⟨column.1 - 40, by omega⟩
    have hequal : columnIndex005 columnLocalIndex = column := by
      ...
      simp [columnIndex005, columnLocalIndex] <;> omega
    rw [← hequal]
    exact HypercubicDimension16PhysicalTraceEvaluationBlock027_005.inverse localIndex columnLocalIndex
  ...
  · let columnLocalIndex : Fin 8 := ⟨column.1 - 48, by omega⟩
    have hequal : columnIndex006 columnLocalIndex = column := by
      ...
      simp [columnIndex006, columnLocalIndex] <;> omega
    rw [← hequal]
    exact HypercubicDimension16PhysicalTraceEvaluationBlock027_006.inverse localIndex columnLocalIndex
  ...
  · let columnLocalIndex : Fin 8 := ⟨column.1 - 56, by omega⟩
    have hequal : columnIndex007 columnLocalIndex = column := by
      ...
      simp [columnIndex007, columnLocalIndex] <;> omega
    rw [← hequal]
    exact HypercubicDimension16PhysicalTraceEvaluationBlock027_007.inverse localIndex columnLocalIndex
  ...
  · let columnLocalIndex : Fin 8 := ⟨column.1 - 64, by omega⟩
    have hequal : columnIndex008 columnLocalIndex = column := by
      ...
      simp [columnIndex008, columnLocalIndex] <;> omega
    rw [← hequal]
    exact HypercubicDimension16PhysicalTraceEvaluationBlock027_008.inverse localIndex columnLocalIndex
  ...
  · let columnLocalIndex : Fin 8 := ⟨column.1 - 72, by omega⟩
    have hequal : columnIndex009 columnLocalIndex = column := by
      ...
      simp [columnIndex009, columnLocalIndex] <;> omega
    rw [← hequal]
    exact HypercubicDimension16PhysicalTraceEvaluationBlock027_009.inverse localIndex columnLocalIndex
  ...
  · let columnLocalIndex : Fin 8 := ⟨column.1 - 80, by omega⟩
    have hequal : columnIndex010 columnLocalIndex = column := by
      ...
      simp [columnIndex010, columnLocalIndex] <;> omega
    rw [← hequal]
    exact HypercubicDimension16PhysicalTraceEvaluationBlock027_010.inverse localIndex columnLocalIndex
  ...
  · let columnLocalIndex : Fin 8 := ⟨column.1 - 88, by omega⟩
    have hequal : columnIndex011 columnLocalIndex = column := by
      ...
      simp [columnIndex011, columnLocalIndex] <;> omega
    rw [← hequal]
    exact HypercubicDimension16PhysicalTraceEvaluationBlock027_011.inverse localIndex columnLocalIndex
  let columnLocalIndex : Fin 2 := ⟨column.1 - 96, by have := column.isLt; omega⟩
  have hequal : columnIndex012 columnLocalIndex = column := by
    apply Fin.ext
    simp [columnIndex012, columnLocalIndex] <;> omega
  rw [← hequal]
  exact HypercubicDimension16PhysicalTraceEvaluationBlock027_012.inverse localIndex columnLocalIndex
...
end HypercubicDimension16PhysicalTraceEvaluationChunk027
end YangMills
end QuantumTheory
end Mettapedia
