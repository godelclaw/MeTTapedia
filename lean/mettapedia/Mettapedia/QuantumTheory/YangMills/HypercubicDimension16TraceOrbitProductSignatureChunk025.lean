...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk025
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨1600 + localIndex.1, by change 1600 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk025
end YangMills
end QuantumTheory
end Mettapedia
