...
/-! Kernel-checked dimension-sixteen Cartan certificate block 34. -/
...
theorem canonicalOcticData_valid_block34 :
    ∀ entry : Fin 33,
      let index := octicWitnessBlockIndex 1122 (by decide) entry
