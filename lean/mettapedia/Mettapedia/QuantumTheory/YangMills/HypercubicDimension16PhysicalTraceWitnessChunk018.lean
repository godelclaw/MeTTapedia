...
namespace YangMills
namespace HypercubicDimension16PhysicalTraceWitnessChunk018

open HypercubicDimension16PhysicalTraceWitnessExecutable

def chunkIndex (localIndex : Fin 256) : Fin 11556 :=
  ⟨4608 + localIndex.1, by change 4608 + localIndex.1 < 11556; omega⟩
...
end HypercubicDimension16PhysicalTraceWitnessChunk018
end YangMills
end QuantumTheory
end Mettapedia
