...
namespace YangMills
namespace HypercubicDimension16PhysicalTraceWitnessFundamentalChunk038

open HypercubicDimension16PhysicalTraceWitnessExecutable

def chunkIndex (localIndex : Fin 64) : Fin 11556 :=
  ⟨10112 + localIndex.1, by change 10112 + localIndex.1 < 11556; omega⟩
...
end HypercubicDimension16PhysicalTraceWitnessFundamentalChunk038
end YangMills
end QuantumTheory
end Mettapedia
