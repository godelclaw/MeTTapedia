...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk078
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨4992 + localIndex.1, by change 4992 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk078
end YangMills
end QuantumTheory
end Mettapedia
