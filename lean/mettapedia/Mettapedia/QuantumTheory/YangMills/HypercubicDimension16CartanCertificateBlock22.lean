...
/-! Kernel-checked dimension-sixteen Cartan certificate block 22. -/
...
theorem canonicalOcticData_valid_block22 :
    ∀ entry : Fin 33,
      let index := octicWitnessBlockIndex 726 (by decide) entry
