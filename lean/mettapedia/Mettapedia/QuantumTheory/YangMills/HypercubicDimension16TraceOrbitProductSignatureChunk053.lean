...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk053
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨3392 + localIndex.1, by change 3392 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk053
end YangMills
end QuantumTheory
end Mettapedia
