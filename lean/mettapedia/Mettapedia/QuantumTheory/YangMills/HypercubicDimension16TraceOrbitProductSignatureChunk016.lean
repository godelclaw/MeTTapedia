...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk016
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨1024 + localIndex.1, by change 1024 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk016
end YangMills
end QuantumTheory
end Mettapedia
