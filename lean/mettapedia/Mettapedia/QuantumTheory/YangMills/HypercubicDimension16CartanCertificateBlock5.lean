...
/-! Kernel-checked dimension-sixteen Cartan certificate block 5. -/
...
theorem canonicalOcticData_valid_block5 :
    ∀ entry : Fin 33,
      let index := octicWitnessBlockIndex 165 (by decide) entry
