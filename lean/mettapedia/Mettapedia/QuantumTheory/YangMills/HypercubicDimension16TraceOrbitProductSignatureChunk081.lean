...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk081
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨5184 + localIndex.1, by change 5184 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk081
end YangMills
end QuantumTheory
end Mettapedia
