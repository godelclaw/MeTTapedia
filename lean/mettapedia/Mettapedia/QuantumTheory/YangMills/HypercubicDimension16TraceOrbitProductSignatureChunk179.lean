...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk179
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨11456 + localIndex.1, by change 11456 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk179
end YangMills
end QuantumTheory
end Mettapedia
