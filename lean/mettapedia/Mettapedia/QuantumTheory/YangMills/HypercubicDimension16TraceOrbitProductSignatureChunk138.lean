...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk138
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨8832 + localIndex.1, by change 8832 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk138
end YangMills
end QuantumTheory
end Mettapedia
