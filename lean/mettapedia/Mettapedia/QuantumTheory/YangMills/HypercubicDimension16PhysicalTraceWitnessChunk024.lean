...
namespace YangMills
namespace HypercubicDimension16PhysicalTraceWitnessChunk024

open HypercubicDimension16PhysicalTraceWitnessExecutable

def chunkIndex (localIndex : Fin 256) : Fin 11556 :=
  ⟨6144 + localIndex.1, by change 6144 + localIndex.1 < 11556; omega⟩
...
end HypercubicDimension16PhysicalTraceWitnessChunk024
end YangMills
end QuantumTheory
end Mettapedia
