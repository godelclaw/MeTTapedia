...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk105
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨6720 + localIndex.1, by change 6720 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk105
end YangMills
end QuantumTheory
end Mettapedia
