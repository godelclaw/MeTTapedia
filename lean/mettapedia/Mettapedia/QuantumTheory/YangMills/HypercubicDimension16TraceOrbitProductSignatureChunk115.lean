...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk115
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨7360 + localIndex.1, by change 7360 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk115
end YangMills
end QuantumTheory
end Mettapedia
