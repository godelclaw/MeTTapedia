...
/-! Kernel-checked dimension-sixteen Cartan certificate block 38. -/
...
theorem canonicalOcticData_valid_block38 :
    ∀ entry : Fin 33,
      let index := octicWitnessBlockIndex 1254 (by decide) entry
