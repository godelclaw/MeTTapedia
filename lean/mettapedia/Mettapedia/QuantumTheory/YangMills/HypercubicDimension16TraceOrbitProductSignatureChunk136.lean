...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk136
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨8704 + localIndex.1, by change 8704 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk136
end YangMills
end QuantumTheory
end Mettapedia
