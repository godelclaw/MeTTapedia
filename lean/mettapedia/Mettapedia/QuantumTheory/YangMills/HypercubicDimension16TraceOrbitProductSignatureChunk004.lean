...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk004
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨256 + localIndex.1, by change 256 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk004
end YangMills
end QuantumTheory
end Mettapedia
