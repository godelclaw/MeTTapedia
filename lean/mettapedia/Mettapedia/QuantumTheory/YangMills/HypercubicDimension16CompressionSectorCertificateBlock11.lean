...
/-! Kernel-checked class-compressed sector block 11. -/
...
theorem classCompressedSectorCharacter_certificate_block11
    (fieldIndex : Fin 8) :
    classCompressedSectorCharacter 11 (fieldIndex.1 + 1) =
      expectedClassCompressedSectorCharacter 11
        (fieldIndex.1 + 1) := by
