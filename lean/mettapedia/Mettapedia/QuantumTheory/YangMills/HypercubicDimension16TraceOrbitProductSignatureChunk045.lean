...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk045
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨2880 + localIndex.1, by change 2880 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk045
end YangMills
end QuantumTheory
end Mettapedia
