...
namespace YangMills
namespace HypercubicDimension16PhysicalTraceWitnessChunk029

open HypercubicDimension16PhysicalTraceWitnessExecutable

def chunkIndex (localIndex : Fin 256) : Fin 11556 :=
  ⟨7424 + localIndex.1, by change 7424 + localIndex.1 < 11556; omega⟩
...
end HypercubicDimension16PhysicalTraceWitnessChunk029
end YangMills
end QuantumTheory
end Mettapedia
