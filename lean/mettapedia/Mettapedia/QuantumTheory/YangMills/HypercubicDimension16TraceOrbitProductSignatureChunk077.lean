...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk077
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨4928 + localIndex.1, by change 4928 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk077
end YangMills
end QuantumTheory
end Mettapedia
