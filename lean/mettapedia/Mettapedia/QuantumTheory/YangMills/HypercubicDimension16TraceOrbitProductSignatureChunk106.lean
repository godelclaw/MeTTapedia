...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk106
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨6784 + localIndex.1, by change 6784 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk106
end YangMills
end QuantumTheory
end Mettapedia
