...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk063
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨4032 + localIndex.1, by change 4032 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk063
end YangMills
end QuantumTheory
end Mettapedia
