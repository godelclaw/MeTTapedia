...
/-! Kernel-checked compression replay block 7. -/
...
theorem decodedPowerTraceReplayCheckAt_certificate_block7 :
    decodedPowerTraceReplayCheckAt 7 = true := by
...
theorem decodedOrientationReplayCheckAt_certificate_block7 :
    decodedOrientationReplayCheckAt 7 = true := by
...
theorem decodedPowerTraceClassAt_certificate_block7
    (reflectionMask : Fin 16) :
    decodedPowerTraceClassAt 7 reflectionMask =
      expectedPowerTraceClassAt 7 reflectionMask := by
