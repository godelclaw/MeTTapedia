...
namespace YangMills
namespace HypercubicDimension16PhysicalTraceWitnessChunk001

open HypercubicDimension16PhysicalTraceWitnessExecutable

def chunkIndex (localIndex : Fin 256) : Fin 11556 :=
  ⟨256 + localIndex.1, by change 256 + localIndex.1 < 11556; omega⟩
...
end HypercubicDimension16PhysicalTraceWitnessChunk001
end YangMills
end QuantumTheory
end Mettapedia
