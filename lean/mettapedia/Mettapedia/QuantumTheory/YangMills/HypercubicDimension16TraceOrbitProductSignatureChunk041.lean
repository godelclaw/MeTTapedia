...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk041
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨2624 + localIndex.1, by change 2624 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk041
end YangMills
end QuantumTheory
end Mettapedia
