...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk177
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨11328 + localIndex.1, by change 11328 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk177
end YangMills
end QuantumTheory
end Mettapedia
