...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk061
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨3904 + localIndex.1, by change 3904 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk061
end YangMills
end QuantumTheory
end Mettapedia
