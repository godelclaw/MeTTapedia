...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk029
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨1856 + localIndex.1, by change 1856 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk029
end YangMills
end QuantumTheory
end Mettapedia
