...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk114
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨7296 + localIndex.1, by change 7296 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk114
end YangMills
end QuantumTheory
end Mettapedia
