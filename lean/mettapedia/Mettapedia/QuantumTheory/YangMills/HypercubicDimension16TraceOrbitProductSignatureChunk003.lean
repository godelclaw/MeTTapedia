...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk003
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨192 + localIndex.1, by change 192 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk003
end YangMills
end QuantumTheory
end Mettapedia
