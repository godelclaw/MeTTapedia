...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk058
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨3712 + localIndex.1, by change 3712 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk058
end YangMills
end QuantumTheory
end Mettapedia
