...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk001
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨64 + localIndex.1, by change 64 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk001
end YangMills
end QuantumTheory
end Mettapedia
