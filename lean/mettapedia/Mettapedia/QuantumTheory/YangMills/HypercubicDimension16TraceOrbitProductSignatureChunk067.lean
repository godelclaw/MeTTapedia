...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk067
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨4288 + localIndex.1, by change 4288 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk067
end YangMills
end QuantumTheory
end Mettapedia
