...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk117
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨7488 + localIndex.1, by change 7488 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk117
end YangMills
end QuantumTheory
end Mettapedia
