...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk161
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨10304 + localIndex.1, by change 10304 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk161
end YangMills
end QuantumTheory
end Mettapedia
