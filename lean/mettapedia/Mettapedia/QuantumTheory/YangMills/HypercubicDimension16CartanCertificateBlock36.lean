...
/-! Kernel-checked dimension-sixteen Cartan certificate block 36. -/
...
theorem canonicalOcticData_valid_block36 :
    ∀ entry : Fin 33,
      let index := octicWitnessBlockIndex 1188 (by decide) entry
