...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk093
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨5952 + localIndex.1, by change 5952 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk093
end YangMills
end QuantumTheory
end Mettapedia
