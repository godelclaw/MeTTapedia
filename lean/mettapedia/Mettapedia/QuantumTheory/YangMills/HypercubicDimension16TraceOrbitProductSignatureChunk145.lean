...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk145
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨9280 + localIndex.1, by change 9280 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk145
end YangMills
end QuantumTheory
end Mettapedia
