...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk080
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨5120 + localIndex.1, by change 5120 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk080
end YangMills
end QuantumTheory
end Mettapedia
