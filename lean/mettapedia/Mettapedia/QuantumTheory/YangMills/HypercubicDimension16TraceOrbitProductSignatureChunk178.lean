...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk178
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨11392 + localIndex.1, by change 11392 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk178
end YangMills
end QuantumTheory
end Mettapedia
