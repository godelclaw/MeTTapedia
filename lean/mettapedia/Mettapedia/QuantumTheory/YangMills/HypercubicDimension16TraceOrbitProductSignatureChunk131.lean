...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk131
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨8384 + localIndex.1, by change 8384 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk131
end YangMills
end QuantumTheory
end Mettapedia
