...
/-! Kernel-checked dimension-sixteen Cartan certificate block 6. -/
...
theorem canonicalOcticData_valid_block6 :
    ∀ entry : Fin 33,
      let index := octicWitnessBlockIndex 198 (by decide) entry
