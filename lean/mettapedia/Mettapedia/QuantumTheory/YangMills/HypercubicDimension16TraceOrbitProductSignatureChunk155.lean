...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk155
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨9920 + localIndex.1, by change 9920 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk155
end YangMills
end QuantumTheory
end Mettapedia
