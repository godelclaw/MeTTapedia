...
/-! Kernel-checked dimension-sixteen Cartan certificate block 31. -/
...
theorem canonicalOcticData_valid_block31 :
    ∀ entry : Fin 33,
      let index := octicWitnessBlockIndex 1023 (by decide) entry
