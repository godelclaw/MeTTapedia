...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk126
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨8064 + localIndex.1, by change 8064 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk126
end YangMills
end QuantumTheory
end Mettapedia
