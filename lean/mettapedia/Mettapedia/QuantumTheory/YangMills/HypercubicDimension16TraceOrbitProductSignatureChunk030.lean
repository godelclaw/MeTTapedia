...
namespace YangMills
namespace HypercubicDimension16TraceOrbitProductSignatureChunk030
...
def chunkIndex (localIndex : Fin 64) : PositiveRepresentativeIndex :=
  ⟨1920 + localIndex.1, by change 1920 + localIndex.1 < 11654; omega⟩
...
end HypercubicDimension16TraceOrbitProductSignatureChunk030
end YangMills
end QuantumTheory
end Mettapedia
