...
theorem threeF2ColumnsFullRankBool_eq_false_iff
    (column : Fin 3 → Fin 3 → F2) :
    threeF2ColumnsFullRankBool column = false ↔
      ¬ threeF2ColumnsFullRank column := by
  constructor
  · intro hfalse hfull
    have htrue := (threeF2ColumnsFullRankBool_eq_true_iff column).2 hfull
    rw [htrue] at hfalse
    contradiction
  · intro hnot
    cases hbool : threeF2ColumnsFullRankBool column
    · rfl
    · exact False.elim
        (hnot ((threeF2ColumnsFullRankBool_eq_true_iff column).1 hbool))
...
def twoBandAnnulusNonFullRankIncreasingOmittedIndexTriples :
    Finset ((Fin 9 × Fin 9) × Fin 9) :=
  (Finset.univ.filter fun t =>
    t.1.1.val < t.1.2.val ∧ t.1.2.val < t.2.val ∧
      threeF2ColumnsFullRankBool
        (twoBandAnnulusOmittedTripleColumns
          (twoBandAnnulusInteriorOmittedTripleByIndex t.1.1 t.1.2 t.2)) = false)

set_option maxRecDepth 10000 in
theorem twoBandAnnulusNonFullRankIncreasingOmittedIndexTriples_card :
    twoBandAnnulusNonFullRankIncreasingOmittedIndexTriples.card = 34 := by
  unfold twoBandAnnulusNonFullRankIncreasingOmittedIndexTriples
    twoBandAnnulusInteriorOmittedTripleByIndex
    twoBandAnnulusInteriorEdgeByIndex
    twoBandAnnulusOmittedTripleColumns
    threeF2ColumnsFullRankBool
...
theorem twoBandAnnulus_mem_nonFullRankIncreasingOmittedIndexTriples_iff
    (a b c : Fin 9) :
  ...
  unfold twoBandAnnulusNonFullRankIncreasingOmittedIndexTriples
    twoBandAnnulusInteriorOmittedIndexTripleFullRank
  simp [threeF2ColumnsFullRankBool_eq_false_iff]
...
set_option maxRecDepth 10000 in
set_option maxHeartbeats 4000000 in
theorem twoBandAnnulusInteriorControlComplementByIndex_omittedInteriorColumnMap_ker_ne_bot_of_not_fullRankBool
    (a b c : Fin 9)
    (hinc : a.val < b.val ∧ b.val < c.val)
    (hbadBool :
      threeF2ColumnsFullRankBool
        (twoBandAnnulusOmittedTripleColumns
          (twoBandAnnulusInteriorOmittedTripleByIndex a b c)) = false) :
    LinearMap.ker
      (twoBandAnnulusOmittedInteriorKirchhoffColumnMap
        (twoBandAnnulusInteriorControlComplementByIndex a b c)) ≠ ⊥ := by
  fin_cases a <;> fin_cases b <;> fin_cases c
  ...
  all_goals
    ...
    | (exfalso
       revert hbadBool
       unfold threeF2ColumnsFullRankBool twoBandAnnulusOmittedTripleColumns
         twoBandAnnulusInteriorOmittedTripleByIndex twoBandAnnulusInteriorEdgeByIndex
         twoBandAnnulusKirchhoffColumn
       decide +revert)
    | (intro hker
       have hinj := LinearMap.ker_eq_bot'.mp hker
       change ∀ y,
          twoBandAnnulusOmittedInteriorKirchhoffColumnMap _ y = 0 →
            y = 0 at hinj
       revert hinj
       decide +revert)

theorem twoBandAnnulusInteriorControlComplementByIndex_omittedInteriorColumnMap_ker_ne_bot_of_not_fullRank
    (a b c : Fin 9)
    (hinc : a.val < b.val ∧ b.val < c.val)
  ...
  have hbadBool :
      threeF2ColumnsFullRankBool
        (twoBandAnnulusOmittedTripleColumns
          (twoBandAnnulusInteriorOmittedTripleByIndex a b c)) = false :=
    (threeF2ColumnsFullRankBool_eq_false_iff _).2 hnotFull
  exact
    twoBandAnnulusInteriorControlComplementByIndex_omittedInteriorColumnMap_ker_ne_bot_of_not_fullRankBool
      a b c hinc hbadBool

theorem twoBandAnnulusInteriorControlComplementByIndex_exists_omittedInteriorColumnKernel_evader_of_not_fullRank
    (a b c : Fin 9)
    (hinc : a.val < b.val ∧ b.val < c.val)
    (hnotFull : ¬ twoBandAnnulusInteriorOmittedIndexTripleFullRank a b c) :
    ∃ y : {e : twoBandAnnulusGraph.edgeSet //
        e ∈ twoBandAnnulusOmittedInteriorEdges
          (twoBandAnnulusInteriorControlComplementByIndex a b c)} → F2,
      twoBandAnnulusOmittedInteriorKirchhoffColumnMap
          (twoBandAnnulusInteriorControlComplementByIndex a b c) y = 0 ∧
      y ≠ 0 := by
  rcases (Submodule.ne_bot_iff _).mp
      (twoBandAnnulusInteriorControlComplementByIndex_omittedInteriorColumnMap_ker_ne_bot_of_not_fullRank
        a b c hinc hnotFull) with
    ⟨y, hyker, hyne⟩
  exact ⟨y, by simpa using hyker, hyne⟩

theorem twoBandAnnulusInteriorControlComplementByIndex_not_boundaryZeroKirchhoff_control_of_not_fullRank
    (a b c : Fin 9)
    (hinc : a.val < b.val ∧ b.val < c.val)
    (hnotFull : ¬ twoBandAnnulusInteriorOmittedIndexTripleFullRank a b c) :
    ¬ ∀ ⦃z : twoBandAnnulusGraph.edgeSet → Color⦄,
...
theorem twoBandAnnulusInteriorControlComplementByIndex_not_boundaryZeroKirchhoff_control_of_nonFullRankIncreasingOmittedIndexTriple
  ...
  have hparts :
    ...
    (twoBandAnnulus_mem_nonFullRankIncreasingOmittedIndexTriples_iff
      a b c).1 hmem
  have hinc : a.val < b.val ∧ b.val < c.val :=
    ⟨hparts.1, hparts.2.1⟩
  have hnotFull : ¬ twoBandAnnulusInteriorOmittedIndexTripleFullRank a b c :=
    hparts.2.2
  exact
    twoBandAnnulusInteriorControlComplementByIndex_not_boundaryZeroKirchhoff_control_of_not_fullRank
      a b c hinc hnotFull
...
/-- Detector-payload consequence of exact shared focus-shell coverage.  The lab-certified
nonzero boundary-zero evader is hit by a CAP5 forced edge, hence emits the one-edge indicator
path-xor payload. -/
theorem sharedInteriorPair_CAP5_forcedEdgeCoverage_forces_indicatorPayload
    {boundaryEdge : Fin 5 → sharedInteriorPairGraph.edgeSet} {n : Nat}
    {data : CAP5TransportedEdgeComponentCoverCore boundaryEdge n}
    (p0Inside p4Inside : Bool) (side : Fin 8 → Prop)
    (hcoverage :
  ...
  rcases sharedInteriorPair_sip12_only_has_boundaryZero_evader with
    ⟨hzBoundary, _, _, hzNonzero⟩
  exact data.forcedEdgeCoverage_forces_indicatorPayload_of_boundaryZeroChain
...
/-- Detector-payload consequence of exact wheel focus-shell coverage.  A lab-certified
singleton-spoke boundary-zero evader is hit by a CAP5 forced edge, hence emits the one-edge
indicator path-xor payload. -/
theorem wheelWithInnerTriangle_CAP5_forcedEdgeCoverage_forces_indicatorPayload
    {boundaryEdge : Fin 5 → wheelWithInnerTriangleGraph.edgeSet} {n : Nat}
    {data : CAP5TransportedEdgeComponentCoverCore boundaryEdge n}
    (p0Inside p4Inside : Bool) (side : Fin 7 → Prop)
    (hcoverage :
        ...
        z ≠ 0 →
          ∃ e : wheelWithInnerTriangleGraph.edgeSet,
            data.EnumeratedExceptionalAnnulusForcedEdge p0Inside p4Inside side e ∧
              z e ≠ 0) :
    data.ForcedEdgeIndicatorPathXorDetectorPayload p0Inside p4Inside side := by
  rcases wheelWithInnerTriangle_wit02_wit03_only_has_boundaryZero_evader with
    ⟨hzBoundary, _, _, _, hzNonzero⟩
  exact data.forcedEdgeCoverage_forces_indicatorPayload_of_boundaryZeroChain
...
/-- Detector-payload consequence of Kirchhoff-repaired shared focus-shell coverage.  The
nonzero no-control Kirchhoff evader is hit by a CAP5 forced edge, hence emits the one-edge
indicator path-xor payload. -/
theorem sharedInteriorPair_CAP5_boundaryZeroKirchhoff_forcedEdgeCoverage_forces_indicatorPayload
    {boundaryEdge : Fin 5 → sharedInteriorPairGraph.edgeSet} {n : Nat}
    {data : CAP5TransportedEdgeComponentCoverCore boundaryEdge n}
    (p0Inside p4Inside : Bool) (side : Fin 8 → Prop)
    (hcoverage :
...
/-- Detector-payload consequence of Kirchhoff-repaired wheel focus-shell coverage.  A nonzero
two-spoke Kirchhoff evader is hit by a CAP5 forced edge, hence emits the one-edge indicator
path-xor payload. -/
theorem wheelWithInnerTriangle_CAP5_boundaryZeroKirchhoff_forcedEdgeCoverage_forces_indicatorPayload
    {boundaryEdge : Fin 5 → wheelWithInnerTriangleGraph.edgeSet} {n : Nat}
    {data : CAP5TransportedEdgeComponentCoverCore boundaryEdge n}
    (p0Inside p4Inside : Bool) (side : Fin 7 → Prop)
    (hcoverage :
...
/--
Trace-residual path-xor handoff for the shared focus shell using the canonical unique certificate
family directly.  Below the two-control F2 threshold, the detector exposes a traced residual
extension edge whose boundary-zero chain pairs nontrivially with one of the unique certificates.
-/
theorem sharedInteriorPair_CAP5_forcedEdgeIndicatorPathXorDetectorPayload_and_extensionControlTraceEdge_boundaryZeroChain_uniqueCertificateFamilyPairing_ne_zero_and_residualProgress_of_emittedFinset_card_lt_two
    {boundaryEdge : Fin 5 → sharedInteriorPairGraph.edgeSet} {n : Nat}
    {data : CAP5TransportedEdgeComponentCoverCore boundaryEdge n}
    (p0Inside p4Inside : Bool) (h : data.IsExceptional)
    (side : Fin 8 → Prop) (hcyclic : CyclicallyFiveEdgeConnected sharedInteriorPairGraph)
                              ...
                              ∃ i : ({e : sharedInteriorPairGraph.edgeSet //
                                ...
                                chainDotBilinForm sharedInteriorPairGraph.edgeSet
                                  (sharedInteriorPairUniqueCertificateRedBlueFamily i :
                                    sharedInteriorPairGraph.edgeSet → Color) z ≠ 0 := by
  rcases
      sharedInteriorPair_CAP5_forcedEdgeIndicatorPathXorDetectorPayload_and_extensionCoordinateSignalWithProgress_of_emittedFinset_card_lt_two
        p0Inside p4Inside h side hcyclic hportal_crosses hcycles classifier hcard with
    ⟨hpayload, hsignal⟩
  ...
  rcases
      data.exists_boundaryZeroChain_extensionControlTraceEdge_familyPairing_ne_zero_and_residualProgress_of_extensionCoordinateSignalWithResidualProgress
        sharedInteriorPairUniqueCertificateRedBlueFamily hresidualSignal
...
/--
Trace-residual path-xor handoff for the wheel focus shell using the canonical unique certificate
family directly.  Below the three-spoke F2 threshold, the detector exposes a traced residual
extension edge whose boundary-zero chain pairs nontrivially with one of the unique certificates.
-/
theorem wheelWithInnerTriangle_CAP5_forcedEdgeIndicatorPathXorDetectorPayload_and_extensionControlTraceEdge_boundaryZeroChain_uniqueCertificateFamilyPairing_ne_zero_and_residualProgress_of_emittedFinset_card_lt_three
    {boundaryEdge : Fin 5 → wheelWithInnerTriangleGraph.edgeSet} {n : Nat}
    {data : CAP5TransportedEdgeComponentCoverCore boundaryEdge n}
    (p0Inside p4Inside : Bool) (h : data.IsExceptional)
    (side : Fin 7 → Prop) (hcyclic : CyclicallyFiveEdgeConnected wheelWithInnerTriangleGraph)
                              ...
                              ∃ i : ({e : wheelWithInnerTriangleGraph.edgeSet //
                                ...
                                chainDotBilinForm wheelWithInnerTriangleGraph.edgeSet
                                  (wheelWithInnerTriangleUniqueCertificateRedBlueFamily i :
                                    wheelWithInnerTriangleGraph.edgeSet → Color) z ≠ 0 := by
  rcases
      wheelWithInnerTriangle_CAP5_forcedEdgeIndicatorPathXorDetectorPayload_and_extensionCoordinateSignalWithProgress_of_emittedFinset_card_lt_three
        p0Inside p4Inside h side hcyclic hportal_crosses hcycles classifier hcard with
    ⟨hpayload, hsignal⟩
  have hresidualSignal :
      data.ExtensionCoordinateSignalWithResidualProgress wheelWithInnerTriangleEmbedding
        p0Inside p4Inside side classifier wheelWithInnerTriangleInteriorControlEdges processed :=
    data.extensionCoordinateSignalWithResidualProgress_of_extensionCoordinateSignalWithProgress
      hsignal hnotProcessed
  rcases
      data.exists_boundaryZeroChain_extensionControlTraceEdge_familyPairing_ne_zero_and_residualProgress_of_extensionCoordinateSignalWithResidualProgress
        wheelWithInnerTriangleUniqueCertificateRedBlueFamily hresidualSignal
...
/-- Shared-shell Kirchhoff refutation with selected-boundary emissions trimmed away: if no
lab-certified shared interior control is emitted, CAP5 cannot cover every nonzero
boundary-zero Kirchhoff chain. -/
theorem sharedInteriorPair_CAP5_boundaryZeroKirchhoff_not_forcedEdgeCoverage_of_emittedInterior_card_lt_one
    {boundaryEdge : Fin 5 → sharedInteriorPairGraph.edgeSet} {n : Nat}
    {data : CAP5TransportedEdgeComponentCoverCore boundaryEdge n}
    (p0Inside p4Inside : Bool) (side : Fin 8 → Prop)
    (classifier :
    ...
    (hcard :
      (classifier.emittedFinset.filter fun e =>
        e ∈ sharedInteriorPairInteriorControlEdges).card < 1) :
    ¬ ∀ ⦃z : sharedInteriorPairGraph.edgeSet → Color⦄,
      z ∈ theorem49BoundaryZeroKirchhoffSubspace
          sharedInteriorPairEmbedding ({(1 : Fin 8)} : Finset (Fin 8)) →
      z ≠ 0 →
...
theorem sharedInteriorPair_CAP5_exists_boundaryZeroKirchhoffChain_vanishingOnForcedEdges_of_emittedInterior_card_lt_one
    {boundaryEdge : Fin 5 → sharedInteriorPairGraph.edgeSet} {n : Nat}
    {data : CAP5TransportedEdgeComponentCoverCore boundaryEdge n}
    (p0Inside p4Inside : Bool) (side : Fin 8 → Prop)
    (classifier :
...
theorem wheelWithInnerTriangle_CAP5_boundaryZeroKirchhoff_not_forcedEdgeCoverage_of_emittedInterior_card_lt_two
    {boundaryEdge : Fin 5 → wheelWithInnerTriangleGraph.edgeSet} {n : Nat}
    {data : CAP5TransportedEdgeComponentCoverCore boundaryEdge n}
    (p0Inside p4Inside : Bool) (side : Fin 7 → Prop)
    (classifier :
    ...
    (hcard :
      (classifier.emittedFinset.filter fun e =>
        e ∈ wheelWithInnerTriangleInteriorControlEdges).card < 2) :
    ¬ ∀ ⦃z : wheelWithInnerTriangleGraph.edgeSet → Color⦄,
      z ∈ theorem49BoundaryZeroKirchhoffSubspace
          wheelWithInnerTriangleEmbedding ({(0 : Fin 7)} : Finset (Fin 7)) →
      z ≠ 0 →
...
theorem wheelWithInnerTriangle_CAP5_exists_boundaryZeroKirchhoffChain_vanishingOnForcedEdges_of_emittedInterior_card_lt_two
    {boundaryEdge : Fin 5 → wheelWithInnerTriangleGraph.edgeSet} {n : Nat}
    {data : CAP5TransportedEdgeComponentCoverCore boundaryEdge n}
    (p0Inside p4Inside : Bool) (side : Fin 7 → Prop)
    (classifier :
...
theorem twoBandAnnulus_CAP5_boundaryZeroKirchhoff_not_forcedEdgeCoverage_of_emittedInterior_subset_nonFullRankInteriorControlComplementByIndex
    {boundaryEdge : Fin 5 → twoBandAnnulusGraph.edgeSet} {n : Nat}
    {data : CAP5TransportedEdgeComponentCoverCore boundaryEdge n}
    (p0Inside p4Inside : Bool) (side : Fin 9 → Prop)
    (classifier :
  ...
  exact
    twoBandAnnulusInteriorControlComplementByIndex_not_boundaryZeroKirchhoff_control_of_not_fullRank
      a b c hinc hnotFull
      (by
        intro z hz hvanishBadControl
        exact
          (data.forcedEdgeKirchhoffCoverage_iff_enumeratedExceptionalAnnulusForcedEdgeClassifierKirchhoffControl
            twoBandAnnulusEmbedding twoBandAnnulusKirchhoffVertices classifier).1
            hcoverage hz (by
              intro e heEmitted
              by_cases heInterior :
                  e ∈ interiorEdgeSupport
...
set_option maxRecDepth 20000 in
theorem twoBandAnnulus_CAP5_boundaryZeroKirchhoff_forcedEdgeCoverage_iff_exists_fullRankIncreasingOmittedIndexTriple_of_emittedInterior_card_le_six
    {boundaryEdge : Fin 5 → twoBandAnnulusGraph.edgeSet} {n : Nat}
    {data : CAP5TransportedEdgeComponentCoverCore boundaryEdge n}
    (p0Inside p4Inside : Bool) (side : Fin 9 → Prop)
    (classifier :
  ...
  · intro hcoverage
    ...
    have hcard :
      ...
      omega
    exact
      (twoBandAnnulus_CAP5_boundaryZeroKirchhoff_forcedEdgeCoverage_iff_exists_fullRankIncreasingOmittedIndexTriple_of_emittedInterior_card_eq_six
        p0Inside p4Inside side classifier hcard).1 hcoverage
  · rintro ⟨a, b, c, hmem, heq⟩
    exact
      twoBandAnnulus_CAP5_boundaryZeroKirchhoff_forcedEdgeCoverage_of_emits_fullRankIncreasingOmittedIndexTriple
        p0Inside p4Inside side classifier a b c hmem
        (by
          intro e heControl
          have heFiltered :
              e ∈ classifier.emittedFinset.filter fun x =>
                x ∈ interiorEdgeSupport
                  twoBandAnnulusEmbedding.faceBoundary
                  twoBandAnnulusEmbedding.faces := by
            simpa [heq] using heControl
          exact (Finset.mem_filter.1 heFiltered).1)

theorem twoBandAnnulus_CAP5_boundaryZeroKirchhoff_not_forcedEdgeCoverage_iff_not_exists_fullRankIncreasingOmittedIndexTriple_of_emittedInterior_card_le_six
    {boundaryEdge : Fin 5 → twoBandAnnulusGraph.edgeSet} {n : Nat}
    {data : CAP5TransportedEdgeComponentCoverCore boundaryEdge n}
    (p0Inside p4Inside : Bool) (side : Fin 9 → Prop)
    (classifier :
  ...
  not_congr
    (twoBandAnnulus_CAP5_boundaryZeroKirchhoff_forcedEdgeCoverage_iff_exists_fullRankIncreasingOmittedIndexTriple_of_emittedInterior_card_le_six
      p0Inside p4Inside side classifier hcardLe)
...
theorem
  ...
  exact
    data.exists_boundaryZeroKirchhoffChain_vanishingOnEnumeratedExceptionalAnnulusForcedEdges_of_not_classifierKirchhoffControl
      twoBandAnnulusEmbedding twoBandAnnulusKirchhoffVertices p0Inside p4Inside side
      classifier
      (by
        intro hcontrol
        exact hnotCoverage
...
theorem
  ...
  twoBandAnnulus_CAP5_exists_boundaryZeroKirchhoffChain_vanishingOnForcedEdges_of_not_forcedEdgeCoverage
    p0Inside p4Inside side classifier
    ((twoBandAnnulus_CAP5_boundaryZeroKirchhoff_not_forcedEdgeCoverage_iff_emittedInterior_card_lt_six_or_mem_nonFullRankInteriorControlComplements_of_emittedInterior_card_le_six
      p0Inside p4Inside side classifier (Nat.le_of_lt hcardLt)).2 (Or.inl hcardLt))

set_option maxRecDepth 20000 in
theorem
    twoBandAnnulus_CAP5_exists_boundaryZeroKirchhoffChain_vanishingOnForcedEdges_of_emittedInterior_mem_nonFullRankInteriorControlComplements_of_emittedInterior_card_le_six
    {boundaryEdge : Fin 5 → twoBandAnnulusGraph.edgeSet} {n : Nat}
    {data : CAP5TransportedEdgeComponentCoverCore boundaryEdge n}
    (p0Inside p4Inside : Bool) (side : Fin 9 → Prop)
    (classifier :
  ...
  twoBandAnnulus_CAP5_exists_boundaryZeroKirchhoffChain_vanishingOnForcedEdges_of_not_forcedEdgeCoverage
    p0Inside p4Inside side classifier
    ((twoBandAnnulus_CAP5_boundaryZeroKirchhoff_not_forcedEdgeCoverage_iff_emittedInterior_card_lt_six_or_mem_nonFullRankInteriorControlComplements_of_emittedInterior_card_le_six
      p0Inside p4Inside side classifier hcardLe).2 (Or.inr hnonFull))
...
/-- Shared focus-shell worklist form of coverage failure.  If CAP5 has not covered every nonzero
selected-boundary-zero chain, then a canonical shared-interior control edge remains unprocessed
and erasing it strictly decreases the remaining worklist. -/
theorem sharedInteriorPair_CAP5_exists_remainingInteriorControlEdge_with_card_erase_lt_of_not_forcedEdgeCoverage
    {boundaryEdge : Fin 5 → sharedInteriorPairGraph.edgeSet} {n : Nat}
    {data : CAP5TransportedEdgeComponentCoverCore boundaryEdge n}
    (p0Inside p4Inside : Bool) (side : Fin 8 → Prop)
    (classifier :
  ...
  simpa [sharedInteriorPairInteriorControlEdges, sharedInteriorPair_interiorEdgeSupport_eq] using
    (data.exists_remainingInteriorEdgeSupportEdge_with_card_erase_lt_of_not_forcedEdgeCoverage
      sharedInteriorPairEmbedding p0Inside p4Inside side classifier hnotCoverage)

/-- Wheel focus-shell worklist form of coverage failure.  If CAP5 has not covered every nonzero
selected-boundary-zero chain, then a canonical spoke control edge remains unprocessed and erasing
it strictly decreases the remaining worklist. -/
theorem wheelWithInnerTriangle_CAP5_exists_remainingInteriorControlEdge_with_card_erase_lt_of_not_forcedEdgeCoverage
    {boundaryEdge : Fin 5 → wheelWithInnerTriangleGraph.edgeSet} {n : Nat}
    {data : CAP5TransportedEdgeComponentCoverCore boundaryEdge n}
    (p0Inside p4Inside : Bool) (side : Fin 7 → Prop)
    (classifier :
  ...
  simpa [wheelWithInnerTriangleInteriorControlEdges,
      wheelWithInnerTriangle_interiorEdgeSupport_eq] using
    (data.exists_remainingInteriorEdgeSupportEdge_with_card_erase_lt_of_not_forcedEdgeCoverage
      wheelWithInnerTriangleEmbedding p0Inside p4Inside side classifier hnotCoverage)
...
/--
Obstruction form of the shared focus-shell fixed-point endpoint.  Once the
unique-certificate route is available, failed synthesis forces the exact finite F₂ obstruction:
a nonzero selected-boundary-zero chain invisible to every enumerated forced edge.
-/
theorem sharedInteriorPair_CAP5_exists_boundaryZeroChain_vanishingOnForcedEdges_of_not_theorem49BoundaryRootSynthesis_uniqueCertificates_boundaryTrimmed
    {boundaryEdge : Fin 5 → sharedInteriorPairGraph.edgeSet} {n : Nat}
    {data : CAP5TransportedEdgeComponentCoverCore boundaryEdge n}
    [FiniteDimensional F2 (sharedInteriorPairGraph.edgeSet → Color)]
    (C₀ : sharedInteriorPairGraph.EdgeColoring Color)
  ...
  (sharedInteriorPair_CAP5_exists_boundaryZeroChain_vanishingOnForcedEdges_iff_emittedInterior_card_lt_two
    ...
    (sharedInteriorPair_CAP5_emittedInterior_card_lt_two_of_not_theorem49BoundaryRootSynthesis_uniqueCertificates_boundaryTrimmed
      C₀ hsubset p0Inside p4Inside side classifier hnotSynthesis)

/--
Closed dichotomy for the shared focus shell after the finite F₂ threshold is codified:
boundary-root synthesis closes, or the classifier leaves a concrete nonzero boundary-zero evader.
-/
theorem sharedInteriorPair_CAP5_theorem49BoundaryRootSynthesis_or_boundaryZeroEvader_uniqueCertificates_boundaryTrimmed
    {boundaryEdge : Fin 5 → sharedInteriorPairGraph.edgeSet} {n : Nat}
    {data : CAP5TransportedEdgeComponentCoverCore boundaryEdge n}
    [FiniteDimensional F2 (sharedInteriorPairGraph.edgeSet → Color)]
    (C₀ : sharedInteriorPairGraph.EdgeColoring Color)
...
/--
Obstruction form of the wheel focus-shell fixed-point endpoint.  Once the
unique-certificate route is available, failed synthesis forces the exact finite F₂ obstruction:
a nonzero selected-boundary-zero chain invisible to every enumerated forced edge.
-/
theorem wheelWithInnerTriangle_CAP5_exists_boundaryZeroChain_vanishingOnForcedEdges_of_not_theorem49BoundaryRootSynthesis_uniqueCertificates_boundaryTrimmed
    {boundaryEdge : Fin 5 → wheelWithInnerTriangleGraph.edgeSet} {n : Nat}
    {data : CAP5TransportedEdgeComponentCoverCore boundaryEdge n}
    [FiniteDimensional F2 (wheelWithInnerTriangleGraph.edgeSet → Color)]
    (C₀ : wheelWithInnerTriangleGraph.EdgeColoring Color)
  ...
  (wheelWithInnerTriangle_CAP5_exists_boundaryZeroChain_vanishingOnForcedEdges_iff_emittedInterior_card_lt_three
    p0Inside p4Inside side classifier).2
    (wheelWithInnerTriangle_CAP5_emittedInterior_card_lt_three_of_not_theorem49BoundaryRootSynthesis_uniqueCertificates_boundaryTrimmed
      C₀ hsubset p0Inside p4Inside side classifier hnotSynthesis)

/--
Closed dichotomy for the wheel focus shell after the finite F₂ threshold is codified:
boundary-root synthesis closes, or the classifier leaves a concrete nonzero boundary-zero evader.
-/
theorem wheelWithInnerTriangle_CAP5_theorem49BoundaryRootSynthesis_or_boundaryZeroEvader_uniqueCertificates_boundaryTrimmed
    {boundaryEdge : Fin 5 → wheelWithInnerTriangleGraph.edgeSet} {n : Nat}
    {data : CAP5TransportedEdgeComponentCoverCore boundaryEdge n}
    [FiniteDimensional F2 (wheelWithInnerTriangleGraph.edgeSet → Color)]
    (C₀ : wheelWithInnerTriangleGraph.EdgeColoring Color)
...
/--
Boundary-trimmed residual coordinate-signal form for the shared focus shell from the scheduler
zero invariant.  Processed edges need not be globally disjoint from the remaining worklist; it is
enough that emitted-edge vanishing already forces every processed edge to zero.
-/
theorem sharedInteriorPair_CAP5_extensionCoordinateSignalWithResidualProgress_of_not_theorem49BoundaryRootSynthesis_of_processedControl_uniqueCertificates_boundaryTrimmed
    {boundaryEdge : Fin 5 → sharedInteriorPairGraph.edgeSet} {n : Nat}
    {data : CAP5TransportedEdgeComponentCoverCore boundaryEdge n}
    [FiniteDimensional F2 (sharedInteriorPairGraph.edgeSet → Color)]
    (C₀ : sharedInteriorPairGraph.EdgeColoring Color)
  ...
  exact
    data.extensionCoordinateSignalWithResidualProgress_of_not_classifierControl_of_finsetControl_of_processedControl
      sharedInteriorPairEmbedding p0Inside p4Inside side classifier
      sharedInteriorPairInteriorControlEdges processed hnotControl
      sharedInteriorPair_boundaryZero_controlEdges_interiorEdges hprocessedControl

/--
Boundary-trimmed residual coordinate-signal form for the wheel focus shell from the scheduler
zero invariant.  Processed spoke-control entries may be present, but emitted-edge vanishing must
already force them to zero before the residual obstruction is selected.
-/
theorem wheelWithInnerTriangle_CAP5_extensionCoordinateSignalWithResidualProgress_of_not_theorem49BoundaryRootSynthesis_of_processedControl_uniqueCertificates_boundaryTrimmed
    {boundaryEdge : Fin 5 → wheelWithInnerTriangleGraph.edgeSet} {n : Nat}
    {data : CAP5TransportedEdgeComponentCoverCore boundaryEdge n}
    [FiniteDimensional F2 (wheelWithInnerTriangleGraph.edgeSet → Color)]
    (C₀ : wheelWithInnerTriangleGraph.EdgeColoring Color)
  ...
  exact
    data.extensionCoordinateSignalWithResidualProgress_of_not_classifierControl_of_finsetControl_of_processedControl
      wheelWithInnerTriangleEmbedding p0Inside p4Inside side classifier
      wheelWithInnerTriangleInteriorControlEdges processed hnotControl
      wheelWithInnerTriangle_boundaryZero_controlEdges_interiorEdges hprocessedControl

/--
Scheduler-facing edge-control obstruction for the shared focus shell.  The positive branch is
boundary-root synthesis; the negative branch names a residual edge that does not satisfy the
edge-control premise required before a processed-edge insertion can be justified for the same
immutable classifier output.
-/
theorem sharedInteriorPair_CAP5_theorem49BoundaryRootSynthesis_or_residualEdge_not_edgeControl_of_processedControl_uniqueCertificates_boundaryTrimmed
    {boundaryEdge : Fin 5 → sharedInteriorPairGraph.edgeSet} {n : Nat}
    {data : CAP5TransportedEdgeComponentCoverCore boundaryEdge n}
    [FiniteDimensional F2 (sharedInteriorPairGraph.edgeSet → Color)]
    (C₀ : sharedInteriorPairGraph.EdgeColoring Color)
    ...
    Theorem49BoundaryRootSynthesis sharedInteriorPairEmbedding C₀ ∨
      ∃ e : sharedInteriorPairGraph.edgeSet,
        e ∈ classifier.residualRemainingControlEdges sharedInteriorPairInteriorControlEdges
            processed ∧
          ¬ (∀ ⦃z : sharedInteriorPairGraph.edgeSet → Color⦄,
            z ∈ planarBoundaryZeroSubmodule sharedInteriorPairEmbedding →
...
/--
Scheduler-facing edge-control obstruction for the wheel focus shell.  The positive branch is
boundary-root synthesis; the negative branch names a residual spoke/control edge that cannot be
marked processed under the immutable classifier output until new edge-control information is
added.
-/
theorem wheelWithInnerTriangle_CAP5_theorem49BoundaryRootSynthesis_or_residualEdge_not_edgeControl_of_processedControl_uniqueCertificates_boundaryTrimmed
    {boundaryEdge : Fin 5 → wheelWithInnerTriangleGraph.edgeSet} {n : Nat}
    {data : CAP5TransportedEdgeComponentCoverCore boundaryEdge n}
    [FiniteDimensional F2 (wheelWithInnerTriangleGraph.edgeSet → Color)]
    (C₀ : wheelWithInnerTriangleGraph.EdgeColoring Color)
    ...
    Theorem49BoundaryRootSynthesis wheelWithInnerTriangleEmbedding C₀ ∨
      ∃ e : wheelWithInnerTriangleGraph.edgeSet,
        e ∈ classifier.residualRemainingControlEdges wheelWithInnerTriangleInteriorControlEdges
            processed ∧
          ¬ (∀ ⦃z : wheelWithInnerTriangleGraph.edgeSet → Color⦄,
            z ∈ planarBoundaryZeroSubmodule wheelWithInnerTriangleEmbedding →
            (∀ f ∈ classifier.emittedFinset, z f = 0) →
...
/--
Scheduler transition for the shared focus shell.  Either boundary-root synthesis closes, or the
next residual shared-interior edge is not controlled by the immutable classifier output while the
one-edge emitted/control update validates processing that edge and strictly decreases the
residual worklist.
-/
theorem sharedInteriorPair_CAP5_theorem49BoundaryRootSynthesis_or_residualEdge_schedulerTransition_of_processedControl_uniqueCertificates_boundaryTrimmed
    {boundaryEdge : Fin 5 → sharedInteriorPairGraph.edgeSet} {n : Nat}
    {data : CAP5TransportedEdgeComponentCoverCore boundaryEdge n}
    [FiniteDimensional F2 (sharedInteriorPairGraph.edgeSet → Color)]
    (C₀ : sharedInteriorPairGraph.EdgeColoring Color)
  ...
  · have hsignal :
    ...
    exact Or.inr
      (data.exists_residualEdge_not_edgeControl_and_processedControl_insert_of_insert_emittedFinset_and_residualProgress_of_extensionCoordinateSignalWithResidualProgress
        hsignal hprocessedControl)

/--
Scheduler transition for the wheel focus shell.  Either boundary-root synthesis closes, or the
next residual spoke is not controlled by the immutable classifier output while the one-edge
emitted/control update validates processing that spoke and strictly decreases the residual
worklist.
-/
theorem wheelWithInnerTriangle_CAP5_theorem49BoundaryRootSynthesis_or_residualEdge_schedulerTransition_of_processedControl_uniqueCertificates_boundaryTrimmed
    {boundaryEdge : Fin 5 → wheelWithInnerTriangleGraph.edgeSet} {n : Nat}
    {data : CAP5TransportedEdgeComponentCoverCore boundaryEdge n}
    [FiniteDimensional F2 (wheelWithInnerTriangleGraph.edgeSet → Color)]
    (C₀ : wheelWithInnerTriangleGraph.EdgeColoring Color)
...
/--
Scheduler transition for the shared focus shell from concrete processed-edge evidence.  If every
processed shared-control edge is already emitted by the immutable classifier, the processed-control
invariant needed to select and insert the next residual edge follows automatically.
-/
theorem sharedInteriorPair_CAP5_theorem49BoundaryRootSynthesis_or_residualEdge_schedulerTransition_of_processed_subset_emittedFinset_uniqueCertificates_boundaryTrimmed
    {boundaryEdge : Fin 5 → sharedInteriorPairGraph.edgeSet} {n : Nat}
    {data : CAP5TransportedEdgeComponentCoverCore boundaryEdge n}
    [FiniteDimensional F2 (sharedInteriorPairGraph.edgeSet → Color)]
    (C₀ : sharedInteriorPairGraph.EdgeColoring Color)
          ...
          ¬ (∀ ⦃z : sharedInteriorPairGraph.edgeSet → Color⦄,
            ...
            (∀ ⦃z : sharedInteriorPairGraph.edgeSet → Color⦄,
              ...
              (classifier.residualRemainingControlEdges sharedInteriorPairInteriorControlEdges
                ...
                (classifier.residualRemainingControlEdges sharedInteriorPairInteriorControlEdges
                  processed).card :=
  sharedInteriorPair_CAP5_theorem49BoundaryRootSynthesis_or_residualEdge_schedulerTransition_of_processedControl_uniqueCertificates_boundaryTrimmed
    C₀ hsubset p0Inside p4Inside side classifier processed
    (data.processedControl_of_subset_emittedFinset
      (emb := sharedInteriorPairEmbedding) classifier hprocessedSubset)

/--
Scheduler transition for the wheel focus shell from concrete processed-edge evidence.  If every
processed spoke is already emitted by the immutable classifier, the processed-control invariant
needed to select and insert the next residual spoke follows automatically.
-/
theorem wheelWithInnerTriangle_CAP5_theorem49BoundaryRootSynthesis_or_residualEdge_schedulerTransition_of_processed_subset_emittedFinset_uniqueCertificates_boundaryTrimmed
    {boundaryEdge : Fin 5 → wheelWithInnerTriangleGraph.edgeSet} {n : Nat}
    {data : CAP5TransportedEdgeComponentCoverCore boundaryEdge n}
    [FiniteDimensional F2 (wheelWithInnerTriangleGraph.edgeSet → Color)]
    (C₀ : wheelWithInnerTriangleGraph.EdgeColoring Color)
          ...
          ¬ (∀ ⦃z : wheelWithInnerTriangleGraph.edgeSet → Color⦄,
            ...
            (∀ ⦃z : wheelWithInnerTriangleGraph.edgeSet → Color⦄,
              ...
              (classifier.residualRemainingControlEdges wheelWithInnerTriangleInteriorControlEdges
                ...
                (classifier.residualRemainingControlEdges wheelWithInnerTriangleInteriorControlEdges
                  processed).card :=
  wheelWithInnerTriangle_CAP5_theorem49BoundaryRootSynthesis_or_residualEdge_schedulerTransition_of_processedControl_uniqueCertificates_boundaryTrimmed
    C₀ hsubset p0Inside p4Inside side classifier processed
    (data.processedControl_of_subset_emittedFinset
      (emb := wheelWithInnerTriangleEmbedding) classifier hprocessedSubset)

/--
Scheduler transition with finite subset-state preservation for the shared focus shell.  From
`processed ⊆ classifier.emittedFinset`, failed synthesis selects a residual shared-control edge
whose one-edge emitted/control update validates both the processed-control invariant and the
updated finite subset invariant.
-/
theorem sharedInteriorPair_CAP5_theorem49BoundaryRootSynthesis_or_residualEdge_schedulerTransition_with_subsetUpdate_of_processed_subset_emittedFinset_uniqueCertificates_boundaryTrimmed
    {boundaryEdge : Fin 5 → sharedInteriorPairGraph.edgeSet} {n : Nat}
    {data : CAP5TransportedEdgeComponentCoverCore boundaryEdge n}
    [FiniteDimensional F2 (sharedInteriorPairGraph.edgeSet → Color)]
    (C₀ : sharedInteriorPairGraph.EdgeColoring Color)
  ...
  · have hprocessedControl :
    ...
    have hsignal :
      ...
      sharedInteriorPair_CAP5_extensionCoordinateSignalWithResidualProgress_of_not_theorem49BoundaryRootSynthesis_of_processedControl_uniqueCertificates_boundaryTrimmed
        C₀ hsubset p0Inside p4Inside side classifier processed hprocessedControl hclosed
    exact Or.inr
      (data.exists_residualEdge_not_edgeControl_and_processedSubset_insert_and_processedControl_insert_of_insert_emittedFinset_and_residualProgress_of_extensionCoordinateSignalWithResidualProgress
        hsignal hprocessedSubset)

/--
Scheduler transition with finite subset-state preservation for the wheel focus shell.  From
`processed ⊆ classifier.emittedFinset`, failed synthesis selects a residual spoke whose one-edge
emitted/control update validates both the processed-control invariant and the updated finite subset
invariant.
-/
theorem wheelWithInnerTriangle_CAP5_theorem49BoundaryRootSynthesis_or_residualEdge_schedulerTransition_with_subsetUpdate_of_processed_subset_emittedFinset_uniqueCertificates_boundaryTrimmed
    {boundaryEdge : Fin 5 → wheelWithInnerTriangleGraph.edgeSet} {n : Nat}
    {data : CAP5TransportedEdgeComponentCoverCore boundaryEdge n}
    [FiniteDimensional F2 (wheelWithInnerTriangleGraph.edgeSet → Color)]
    (C₀ : wheelWithInnerTriangleGraph.EdgeColoring Color)
...
/--
Shared focus-shell detector verdict from concrete processed-edge evidence.  If every processed
shared-control edge is already emitted by the immutable classifier, the processed-control zero
invariant required by the residual detector follows automatically.
-/
theorem sharedInteriorPair_CAP5_theorem49BoundaryRootSynthesis_or_forcedEdgeIndicatorPathXorDetectorPayload_and_extensionControlTraceEdge_boundaryZeroChain_uniqueCertificateFamilyPairing_ne_zero_and_residualProgress_of_processed_subset_emittedFinset_uniqueCertificates_boundaryTrimmed
    {boundaryEdge : Fin 5 → sharedInteriorPairGraph.edgeSet} {n : Nat}
    {data : CAP5TransportedEdgeComponentCoverCore boundaryEdge n}
    [FiniteDimensional F2 (sharedInteriorPairGraph.edgeSet → Color)]
    (C₀ : sharedInteriorPairGraph.EdgeColoring Color)
                            ...
                            z e ≠ 0 ∧
                              ...
                              ((classifier.remainingControlEdges
                                ...
                                ∃ i : ({e : sharedInteriorPairGraph.edgeSet //
                                  ...
                                  chainDotBilinForm sharedInteriorPairGraph.edgeSet
                                    (sharedInteriorPairUniqueCertificateRedBlueFamily i :
                                      sharedInteriorPairGraph.edgeSet → Color) z ≠ 0 :=
  sharedInteriorPair_CAP5_theorem49BoundaryRootSynthesis_or_forcedEdgeIndicatorPathXorDetectorPayload_and_extensionControlTraceEdge_boundaryZeroChain_uniqueCertificateFamilyPairing_ne_zero_and_residualProgress_of_processedControl_uniqueCertificates_boundaryTrimmed
    C₀ hsubset p0Inside p4Inside h side hcyclic hportal_crosses hcycles classifier
    processed
    (data.processedControl_of_subset_emittedFinset
      (emb := sharedInteriorPairEmbedding) classifier hprocessedSubset)

/--
Wheel focus-shell detector verdict from concrete processed-edge evidence.  If every processed spoke
is already emitted by the immutable classifier, the processed-control zero invariant required by
the residual detector follows automatically.
-/
theorem wheelWithInnerTriangle_CAP5_theorem49BoundaryRootSynthesis_or_forcedEdgeIndicatorPathXorDetectorPayload_and_extensionControlTraceEdge_boundaryZeroChain_uniqueCertificateFamilyPairing_ne_zero_and_residualProgress_of_processed_subset_emittedFinset_uniqueCertificates_boundaryTrimmed
    {boundaryEdge : Fin 5 → wheelWithInnerTriangleGraph.edgeSet} {n : Nat}
    {data : CAP5TransportedEdgeComponentCoverCore boundaryEdge n}
    [FiniteDimensional F2 (wheelWithInnerTriangleGraph.edgeSet → Color)]
    (C₀ : wheelWithInnerTriangleGraph.EdgeColoring Color)
                            ...
                            z e ≠ 0 ∧
                              ...
                              ((classifier.remainingControlEdges
                                ...
                                ∃ i : ({e : wheelWithInnerTriangleGraph.edgeSet //
                                  ...
                                  chainDotBilinForm wheelWithInnerTriangleGraph.edgeSet
                                    (wheelWithInnerTriangleUniqueCertificateRedBlueFamily i :
                                      wheelWithInnerTriangleGraph.edgeSet → Color) z ≠ 0 :=
  wheelWithInnerTriangle_CAP5_theorem49BoundaryRootSynthesis_or_forcedEdgeIndicatorPathXorDetectorPayload_and_extensionControlTraceEdge_boundaryZeroChain_uniqueCertificateFamilyPairing_ne_zero_and_residualProgress_of_processedControl_uniqueCertificates_boundaryTrimmed
    C₀ hsubset p0Inside p4Inside h side hcyclic hportal_crosses hcycles classifier
    processed
    (data.processedControl_of_subset_emittedFinset
      (emb := wheelWithInnerTriangleEmbedding) classifier hprocessedSubset)
...
/--
Scheduler-facing progress form for the shared focus shell.  A failed boundary-trimmed
unique-certificate synthesis run names not only a remaining shared-interior edge, but a concrete
next extension bin: crossing or noncrossing, with strict remaining-worklist decrease.
-/
theorem sharedInteriorPair_CAP5_crossingExtensionEdge_or_noncrossingExtensionEdge_with_card_erase_lt_of_not_theorem49BoundaryRootSynthesis_uniqueCertificates_boundaryTrimmed
    {boundaryEdge : Fin 5 → sharedInteriorPairGraph.edgeSet} {n : Nat}
    {data : CAP5TransportedEdgeComponentCoverCore boundaryEdge n}
    [FiniteDimensional F2 (sharedInteriorPairGraph.edgeSet → Color)]
    (C₀ : sharedInteriorPairGraph.EdgeColoring Color)
    ...
    (∃ e : sharedInteriorPairGraph.edgeSet,
      e ∈ classifier.crossingExtensionFinset sharedInteriorPairInteriorControlEdges ∧
        ((classifier.remainingControlEdges sharedInteriorPairInteriorControlEdges).erase e).card <
          (classifier.remainingControlEdges sharedInteriorPairInteriorControlEdges).card) ∨
      ∃ e : sharedInteriorPairGraph.edgeSet,
        e ∈ classifier.noncrossingExtensionFinset sharedInteriorPairInteriorControlEdges ∧
          ((classifier.remainingControlEdges sharedInteriorPairInteriorControlEdges).erase e).card <
            (classifier.remainingControlEdges sharedInteriorPairInteriorControlEdges).card := by
  rcases
      sharedInteriorPair_CAP5_exists_remainingInteriorControlEdge_with_card_erase_lt_of_not_theorem49BoundaryRootSynthesis_uniqueCertificates_boundaryTrimmed
        C₀ hsubset p0Inside p4Inside side classifier hnotSynthesis with
    ⟨e, heRemaining, hprogress⟩
  have heExtension :
      e ∈ classifier.crossingExtensionFinset sharedInteriorPairInteriorControlEdges ∪
        classifier.noncrossingExtensionFinset sharedInteriorPairInteriorControlEdges := by
    simpa [classifier.crossingExtensionFinset_union_noncrossingExtensionFinset_eq_remainingControlEdges
      sharedInteriorPairInteriorControlEdges] using heRemaining
  rcases Finset.mem_union.1 heExtension with hcrossing | hnoncrossing
  · exact Or.inl ⟨e, hcrossing, hprogress⟩
  · exact Or.inr ⟨e, hnoncrossing, hprogress⟩

/--
Scheduler-facing progress form for the wheel focus shell.  A failed boundary-trimmed
unique-certificate synthesis run names a concrete next spoke extension bin, crossing or
noncrossing, with strict remaining-worklist decrease.
-/
theorem wheelWithInnerTriangle_CAP5_crossingExtensionEdge_or_noncrossingExtensionEdge_with_card_erase_lt_of_not_theorem49BoundaryRootSynthesis_uniqueCertificates_boundaryTrimmed
    {boundaryEdge : Fin 5 → wheelWithInnerTriangleGraph.edgeSet} {n : Nat}
    {data : CAP5TransportedEdgeComponentCoverCore boundaryEdge n}
    [FiniteDimensional F2 (wheelWithInnerTriangleGraph.edgeSet → Color)]
    (C₀ : wheelWithInnerTriangleGraph.EdgeColoring Color)
    ...
    (hnotSynthesis : ¬ Theorem49BoundaryRootSynthesis wheelWithInnerTriangleEmbedding C₀) :
    (∃ e : wheelWithInnerTriangleGraph.edgeSet,
      e ∈ classifier.crossingExtensionFinset wheelWithInnerTriangleInteriorControlEdges ∧
        ((classifier.remainingControlEdges wheelWithInnerTriangleInteriorControlEdges).erase e).card <
          (classifier.remainingControlEdges wheelWithInnerTriangleInteriorControlEdges).card) ∨
      ∃ e : wheelWithInnerTriangleGraph.edgeSet,
        e ∈ classifier.noncrossingExtensionFinset wheelWithInnerTriangleInteriorControlEdges ∧
          ((classifier.remainingControlEdges wheelWithInnerTriangleInteriorControlEdges).erase e).card <
            (classifier.remainingControlEdges wheelWithInnerTriangleInteriorControlEdges).card := by
  rcases
      wheelWithInnerTriangle_CAP5_exists_remainingInteriorControlEdge_with_card_erase_lt_of_not_theorem49BoundaryRootSynthesis_uniqueCertificates_boundaryTrimmed
  ...
  have heExtension :
      e ∈ classifier.crossingExtensionFinset wheelWithInnerTriangleInteriorControlEdges ∪
        classifier.noncrossingExtensionFinset wheelWithInnerTriangleInteriorControlEdges := by
    simpa [classifier.crossingExtensionFinset_union_noncrossingExtensionFinset_eq_remainingControlEdges
      wheelWithInnerTriangleInteriorControlEdges] using heRemaining
  rcases Finset.mem_union.1 heExtension with hcrossing | hnoncrossing
  · exact Or.inl ⟨e, hcrossing, hprogress⟩
  · exact Or.inr ⟨e, hnoncrossing, hprogress⟩

/--
Closed scheduler-facing verdict for the shared focus shell.  The boundary-trimmed
unique-certificate route either closes synthesis or exposes the next crossing/noncrossing CAP5
extension candidate with a decreasing remaining-worklist measure.
-/
theorem sharedInteriorPair_CAP5_theorem49BoundaryRootSynthesis_or_crossingExtensionEdge_or_noncrossingExtensionEdge_uniqueCertificates_boundaryTrimmed
    {boundaryEdge : Fin 5 → sharedInteriorPairGraph.edgeSet} {n : Nat}
    {data : CAP5TransportedEdgeComponentCoverCore boundaryEdge n}
    [FiniteDimensional F2 (sharedInteriorPairGraph.edgeSet → Color)]
    (C₀ : sharedInteriorPairGraph.EdgeColoring Color)
  ...
  · exact Or.inl hclosed
  · exact Or.inr
      (sharedInteriorPair_CAP5_crossingExtensionEdge_or_noncrossingExtensionEdge_with_card_erase_lt_of_not_theorem49BoundaryRootSynthesis_uniqueCertificates_boundaryTrimmed
        C₀ hsubset p0Inside p4Inside side classifier hclosed)

/--
Closed scheduler-facing verdict for the wheel focus shell.  The boundary-trimmed
unique-certificate route either closes synthesis or exposes the next crossing/noncrossing spoke
extension candidate with a decreasing remaining-worklist measure.
-/
theorem wheelWithInnerTriangle_CAP5_theorem49BoundaryRootSynthesis_or_crossingExtensionEdge_or_noncrossingExtensionEdge_uniqueCertificates_boundaryTrimmed
    {boundaryEdge : Fin 5 → wheelWithInnerTriangleGraph.edgeSet} {n : Nat}
    {data : CAP5TransportedEdgeComponentCoverCore boundaryEdge n}
    [FiniteDimensional F2 (wheelWithInnerTriangleGraph.edgeSet → Color)]
    (C₀ : wheelWithInnerTriangleGraph.EdgeColoring Color)
  ...
  · exact Or.inl hclosed
  · exact Or.inr
      (wheelWithInnerTriangle_CAP5_crossingExtensionEdge_or_noncrossingExtensionEdge_with_card_erase_lt_of_not_theorem49BoundaryRootSynthesis_uniqueCertificates_boundaryTrimmed
        C₀ hsubset p0Inside p4Inside side classifier hclosed)
...
/--
Total detector verdict for the shared focus shell with a runner-facing frontier branch.  Without
assuming forced-edge coverage, the finite F₂ threshold gives either synthesis, a missing red/blue
single-coordinate witness for an emitted forced edge, or a concrete remaining shared-interior
control edge whose erasure strictly decreases the CAP5 worklist.
-/
theorem sharedInteriorPair_CAP5_theorem49BoundaryRootSynthesis_or_forcedEdge_missing_red_or_blue_singleCoordinateWitness_or_remainingInteriorControlEdge
    {boundaryEdge : Fin 5 → sharedInteriorPairGraph.edgeSet} {n : Nat}
    {data : CAP5TransportedEdgeComponentCoverCore boundaryEdge n}
    [FiniteDimensional F2 (sharedInteriorPairGraph.edgeSet → Color)]
    (C₀ : sharedInteriorPairGraph.EdgeColoring Color)
...
/--
Total detector verdict for the wheel focus shell with a runner-facing frontier branch.  Without
assuming forced-edge coverage, the finite F₂ threshold gives either synthesis, a missing red/blue
single-coordinate witness for an emitted forced edge, or a concrete remaining spoke control edge
whose erasure strictly decreases the CAP5 worklist.
-/
theorem wheelWithInnerTriangle_CAP5_theorem49BoundaryRootSynthesis_or_forcedEdge_missing_red_or_blue_singleCoordinateWitness_or_remainingInteriorControlEdge
    {boundaryEdge : Fin 5 → wheelWithInnerTriangleGraph.edgeSet} {n : Nat}
    {data : CAP5TransportedEdgeComponentCoverCore boundaryEdge n}
    [FiniteDimensional F2 (wheelWithInnerTriangleGraph.edgeSet → Color)]
    (C₀ : wheelWithInnerTriangleGraph.EdgeColoring Color)
