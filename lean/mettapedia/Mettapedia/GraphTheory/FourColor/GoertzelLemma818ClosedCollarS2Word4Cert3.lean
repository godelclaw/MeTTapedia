...
def keyedLast3 : List TauState :=
  [stateAt 38, stateAt 46, stateAt 54, stateAt 62]
...
theorem fiber3_eq :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.normal TauOrient.normal TauOrient.normal [LColor.r, LColor.r, LColor.b, LColor.r]
