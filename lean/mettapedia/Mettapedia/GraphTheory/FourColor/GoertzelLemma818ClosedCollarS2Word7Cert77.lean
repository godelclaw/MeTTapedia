...
def keyedLast77 : List TauState :=
  [stateAt 128, stateAt 136, stateAt 144, stateAt 152]
...
theorem fiber77_eq :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.normal TauOrient.mirror TauOrient.mirror [LColor.p, LColor.p, LColor.b, LColor.p]
