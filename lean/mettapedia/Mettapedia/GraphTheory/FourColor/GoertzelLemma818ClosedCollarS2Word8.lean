...
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word8Cert3
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word8Cert4
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word8Cert6
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word8Cert8
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word8Cert9
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word8Cert10
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word8Cert16
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word8Cert17
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word8Cert18
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word8Cert20
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word8Cert22
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word8Cert23
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word8Cert30
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word8Cert31
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word8Cert33
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word8Cert35
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word8Cert36
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word8Cert37
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word8Cert43
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word8Cert44
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word8Cert45
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word8Cert47
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word8Cert49
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word8Cert50
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word8Cert57
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word8Cert58
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word8Cert60
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word8Cert62
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word8Cert63
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word8Cert64
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word8Cert70
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word8Cert71
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word8Cert72
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word8Cert74
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word8Cert76
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word8Cert77
...
theorem cert0_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.normal TauOrient.normal [LColor.r, LColor.r, LColor.r, LColor.r]
...
theorem cert1_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.normal TauOrient.normal [LColor.r, LColor.r, LColor.r, LColor.b]
...
theorem cert2_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.normal TauOrient.normal [LColor.r, LColor.r, LColor.r, LColor.p]
...
theorem cert5_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.normal TauOrient.normal [LColor.r, LColor.r, LColor.b, LColor.p]
...
theorem cert7_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.normal TauOrient.normal [LColor.r, LColor.r, LColor.p, LColor.b]
...
theorem cert11_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.normal TauOrient.normal [LColor.r, LColor.b, LColor.r, LColor.p]
...
theorem cert12_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.normal TauOrient.normal [LColor.r, LColor.b, LColor.b, LColor.r]
...
theorem cert13_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.normal TauOrient.normal [LColor.r, LColor.b, LColor.b, LColor.b]
...
theorem cert14_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.normal TauOrient.normal [LColor.r, LColor.b, LColor.b, LColor.p]
...
theorem cert15_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.normal TauOrient.normal [LColor.r, LColor.b, LColor.p, LColor.r]
...
theorem cert19_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.normal TauOrient.normal [LColor.r, LColor.p, LColor.r, LColor.b]
...
theorem cert21_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.normal TauOrient.normal [LColor.r, LColor.p, LColor.b, LColor.r]
...
theorem cert24_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.normal TauOrient.normal [LColor.r, LColor.p, LColor.p, LColor.r]
...
theorem cert25_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.normal TauOrient.normal [LColor.r, LColor.p, LColor.p, LColor.b]
...
theorem cert26_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.normal TauOrient.normal [LColor.r, LColor.p, LColor.p, LColor.p]
...
theorem cert27_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.normal TauOrient.normal [LColor.b, LColor.r, LColor.r, LColor.r]
...
theorem cert28_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.normal TauOrient.normal [LColor.b, LColor.r, LColor.r, LColor.b]
...
theorem cert29_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.normal TauOrient.normal [LColor.b, LColor.r, LColor.r, LColor.p]
...
theorem cert32_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.normal TauOrient.normal [LColor.b, LColor.r, LColor.b, LColor.p]
...
theorem cert34_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.normal TauOrient.normal [LColor.b, LColor.r, LColor.p, LColor.b]
...
theorem cert38_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.normal TauOrient.normal [LColor.b, LColor.b, LColor.r, LColor.p]
...
theorem cert39_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.normal TauOrient.normal [LColor.b, LColor.b, LColor.b, LColor.r]
...
theorem cert40_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.normal TauOrient.normal [LColor.b, LColor.b, LColor.b, LColor.b]
...
theorem cert41_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.normal TauOrient.normal [LColor.b, LColor.b, LColor.b, LColor.p]
...
theorem cert42_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.normal TauOrient.normal [LColor.b, LColor.b, LColor.p, LColor.r]
...
theorem cert46_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.normal TauOrient.normal [LColor.b, LColor.p, LColor.r, LColor.b]
...
theorem cert48_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.normal TauOrient.normal [LColor.b, LColor.p, LColor.b, LColor.r]
...
theorem cert51_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.normal TauOrient.normal [LColor.b, LColor.p, LColor.p, LColor.r]
...
theorem cert52_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.normal TauOrient.normal [LColor.b, LColor.p, LColor.p, LColor.b]
...
theorem cert53_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.normal TauOrient.normal [LColor.b, LColor.p, LColor.p, LColor.p]
...
theorem cert54_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.normal TauOrient.normal [LColor.p, LColor.r, LColor.r, LColor.r]
...
theorem cert55_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.normal TauOrient.normal [LColor.p, LColor.r, LColor.r, LColor.b]
...
theorem cert56_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.normal TauOrient.normal [LColor.p, LColor.r, LColor.r, LColor.p]
...
theorem cert59_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.normal TauOrient.normal [LColor.p, LColor.r, LColor.b, LColor.p]
...
theorem cert61_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.normal TauOrient.normal [LColor.p, LColor.r, LColor.p, LColor.b]
...
theorem cert65_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.normal TauOrient.normal [LColor.p, LColor.b, LColor.r, LColor.p]
...
theorem cert66_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.normal TauOrient.normal [LColor.p, LColor.b, LColor.b, LColor.r]
...
theorem cert67_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.normal TauOrient.normal [LColor.p, LColor.b, LColor.b, LColor.b]
...
theorem cert68_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.normal TauOrient.normal [LColor.p, LColor.b, LColor.b, LColor.p]
...
theorem cert69_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.normal TauOrient.normal [LColor.p, LColor.b, LColor.p, LColor.r]
...
theorem cert73_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.normal TauOrient.normal [LColor.p, LColor.p, LColor.r, LColor.b]
...
theorem cert75_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.normal TauOrient.normal [LColor.p, LColor.p, LColor.b, LColor.r]
...
theorem cert78_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.normal TauOrient.normal [LColor.p, LColor.p, LColor.p, LColor.r]
...
theorem cert79_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.normal TauOrient.normal [LColor.p, LColor.p, LColor.p, LColor.b]
...
theorem cert80_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.normal TauOrient.normal [LColor.p, LColor.p, LColor.p, LColor.p]
