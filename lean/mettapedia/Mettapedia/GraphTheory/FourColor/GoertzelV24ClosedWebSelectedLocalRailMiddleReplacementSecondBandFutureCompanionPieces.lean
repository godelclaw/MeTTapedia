...
pieces and their already-proved source-pair disjointness.  It does not yet
join the two companion pieces, prove avoidance of the intervening corridor
centres, rebuild a complete two-rail assembly, iterate the rolling transition,
