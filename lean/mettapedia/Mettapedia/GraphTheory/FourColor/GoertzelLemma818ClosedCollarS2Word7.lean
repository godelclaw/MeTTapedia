...
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word7Cert3
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word7Cert4
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word7Cert5
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word7Cert6
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word7Cert7
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word7Cert8
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word7Cert9
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word7Cert10
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word7Cert11
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word7Cert18
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word7Cert19
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word7Cert20
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word7Cert30
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word7Cert31
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word7Cert32
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word7Cert36
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word7Cert37
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word7Cert38
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word7Cert42
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word7Cert43
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word7Cert44
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word7Cert48
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word7Cert49
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word7Cert50
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word7Cert60
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word7Cert61
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word7Cert62
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word7Cert69
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word7Cert70
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word7Cert71
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word7Cert72
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word7Cert73
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word7Cert74
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word7Cert75
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word7Cert76
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word7Cert77
...
theorem cert0_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.normal TauOrient.mirror TauOrient.mirror [LColor.r, LColor.r, LColor.r, LColor.r]
...
theorem cert1_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.normal TauOrient.mirror TauOrient.mirror [LColor.r, LColor.r, LColor.r, LColor.b]
...
theorem cert2_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.normal TauOrient.mirror TauOrient.mirror [LColor.r, LColor.r, LColor.r, LColor.p]
...
theorem cert12_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.normal TauOrient.mirror TauOrient.mirror [LColor.r, LColor.b, LColor.b, LColor.r]
...
theorem cert13_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.normal TauOrient.mirror TauOrient.mirror [LColor.r, LColor.b, LColor.b, LColor.b]
...
theorem cert14_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.normal TauOrient.mirror TauOrient.mirror [LColor.r, LColor.b, LColor.b, LColor.p]
...
theorem cert15_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.normal TauOrient.mirror TauOrient.mirror [LColor.r, LColor.b, LColor.p, LColor.r]
...
theorem cert16_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.normal TauOrient.mirror TauOrient.mirror [LColor.r, LColor.b, LColor.p, LColor.b]
...
theorem cert17_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.normal TauOrient.mirror TauOrient.mirror [LColor.r, LColor.b, LColor.p, LColor.p]
...
theorem cert21_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.normal TauOrient.mirror TauOrient.mirror [LColor.r, LColor.p, LColor.b, LColor.r]
...
theorem cert22_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.normal TauOrient.mirror TauOrient.mirror [LColor.r, LColor.p, LColor.b, LColor.b]
...
theorem cert23_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.normal TauOrient.mirror TauOrient.mirror [LColor.r, LColor.p, LColor.b, LColor.p]
...
theorem cert24_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.normal TauOrient.mirror TauOrient.mirror [LColor.r, LColor.p, LColor.p, LColor.r]
...
theorem cert25_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.normal TauOrient.mirror TauOrient.mirror [LColor.r, LColor.p, LColor.p, LColor.b]
...
theorem cert26_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.normal TauOrient.mirror TauOrient.mirror [LColor.r, LColor.p, LColor.p, LColor.p]
...
theorem cert27_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.normal TauOrient.mirror TauOrient.mirror [LColor.b, LColor.r, LColor.r, LColor.r]
...
theorem cert28_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.normal TauOrient.mirror TauOrient.mirror [LColor.b, LColor.r, LColor.r, LColor.b]
...
theorem cert29_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.normal TauOrient.mirror TauOrient.mirror [LColor.b, LColor.r, LColor.r, LColor.p]
...
theorem cert33_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.normal TauOrient.mirror TauOrient.mirror [LColor.b, LColor.r, LColor.p, LColor.r]
...
theorem cert34_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.normal TauOrient.mirror TauOrient.mirror [LColor.b, LColor.r, LColor.p, LColor.b]
...
theorem cert35_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.normal TauOrient.mirror TauOrient.mirror [LColor.b, LColor.r, LColor.p, LColor.p]
...
theorem cert39_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.normal TauOrient.mirror TauOrient.mirror [LColor.b, LColor.b, LColor.b, LColor.r]
...
theorem cert40_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.normal TauOrient.mirror TauOrient.mirror [LColor.b, LColor.b, LColor.b, LColor.b]
...
theorem cert41_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.normal TauOrient.mirror TauOrient.mirror [LColor.b, LColor.b, LColor.b, LColor.p]
...
theorem cert45_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.normal TauOrient.mirror TauOrient.mirror [LColor.b, LColor.p, LColor.r, LColor.r]
...
theorem cert46_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.normal TauOrient.mirror TauOrient.mirror [LColor.b, LColor.p, LColor.r, LColor.b]
...
theorem cert47_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.normal TauOrient.mirror TauOrient.mirror [LColor.b, LColor.p, LColor.r, LColor.p]
...
theorem cert51_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.normal TauOrient.mirror TauOrient.mirror [LColor.b, LColor.p, LColor.p, LColor.r]
...
theorem cert52_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.normal TauOrient.mirror TauOrient.mirror [LColor.b, LColor.p, LColor.p, LColor.b]
...
theorem cert53_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.normal TauOrient.mirror TauOrient.mirror [LColor.b, LColor.p, LColor.p, LColor.p]
...
theorem cert54_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.normal TauOrient.mirror TauOrient.mirror [LColor.p, LColor.r, LColor.r, LColor.r]
...
theorem cert55_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.normal TauOrient.mirror TauOrient.mirror [LColor.p, LColor.r, LColor.r, LColor.b]
...
theorem cert56_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.normal TauOrient.mirror TauOrient.mirror [LColor.p, LColor.r, LColor.r, LColor.p]
...
theorem cert57_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.normal TauOrient.mirror TauOrient.mirror [LColor.p, LColor.r, LColor.b, LColor.r]
...
theorem cert58_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.normal TauOrient.mirror TauOrient.mirror [LColor.p, LColor.r, LColor.b, LColor.b]
...
theorem cert59_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.normal TauOrient.mirror TauOrient.mirror [LColor.p, LColor.r, LColor.b, LColor.p]
...
theorem cert63_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.normal TauOrient.mirror TauOrient.mirror [LColor.p, LColor.b, LColor.r, LColor.r]
...
theorem cert64_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.normal TauOrient.mirror TauOrient.mirror [LColor.p, LColor.b, LColor.r, LColor.b]
...
theorem cert65_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.normal TauOrient.mirror TauOrient.mirror [LColor.p, LColor.b, LColor.r, LColor.p]
...
theorem cert66_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.normal TauOrient.mirror TauOrient.mirror [LColor.p, LColor.b, LColor.b, LColor.r]
...
theorem cert67_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.normal TauOrient.mirror TauOrient.mirror [LColor.p, LColor.b, LColor.b, LColor.b]
...
theorem cert68_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.normal TauOrient.mirror TauOrient.mirror [LColor.p, LColor.b, LColor.b, LColor.p]
...
theorem cert78_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.normal TauOrient.mirror TauOrient.mirror [LColor.p, LColor.p, LColor.p, LColor.r]
...
theorem cert79_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.normal TauOrient.mirror TauOrient.mirror [LColor.p, LColor.p, LColor.p, LColor.b]
...
theorem cert80_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.normal TauOrient.mirror TauOrient.mirror [LColor.p, LColor.p, LColor.p, LColor.p]
