...
def keyedLast43 : List TauState :=
  [stateAt 69, stateAt 77, stateAt 85, stateAt 93]
...
theorem fiber43_eq :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.normal TauOrient.mirror [LColor.b, LColor.b, LColor.p, LColor.b]
