...
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word10Cert3
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word10Cert4
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word10Cert6
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word10Cert8
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word10Cert9
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word10Cert10
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word10Cert16
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word10Cert17
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word10Cert18
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word10Cert20
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word10Cert22
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word10Cert23
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word10Cert30
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word10Cert31
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word10Cert33
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word10Cert35
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word10Cert36
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word10Cert37
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word10Cert43
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word10Cert44
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word10Cert45
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word10Cert47
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word10Cert49
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word10Cert50
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word10Cert57
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word10Cert58
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word10Cert60
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word10Cert62
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word10Cert63
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word10Cert64
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word10Cert70
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word10Cert71
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word10Cert72
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word10Cert74
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word10Cert76
import Mettapedia.GraphTheory.FourColor.GoertzelLemma818ClosedCollarS2Word10Cert77
...
theorem cert0_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.mirror TauOrient.normal [LColor.r, LColor.r, LColor.r, LColor.r]
...
theorem cert1_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.mirror TauOrient.normal [LColor.r, LColor.r, LColor.r, LColor.b]
...
theorem cert2_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.mirror TauOrient.normal [LColor.r, LColor.r, LColor.r, LColor.p]
...
theorem cert5_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.mirror TauOrient.normal [LColor.r, LColor.r, LColor.b, LColor.p]
...
theorem cert7_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.mirror TauOrient.normal [LColor.r, LColor.r, LColor.p, LColor.b]
...
theorem cert11_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.mirror TauOrient.normal [LColor.r, LColor.b, LColor.r, LColor.p]
...
theorem cert12_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.mirror TauOrient.normal [LColor.r, LColor.b, LColor.b, LColor.r]
...
theorem cert13_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.mirror TauOrient.normal [LColor.r, LColor.b, LColor.b, LColor.b]
...
theorem cert14_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.mirror TauOrient.normal [LColor.r, LColor.b, LColor.b, LColor.p]
...
theorem cert15_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.mirror TauOrient.normal [LColor.r, LColor.b, LColor.p, LColor.r]
...
theorem cert19_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.mirror TauOrient.normal [LColor.r, LColor.p, LColor.r, LColor.b]
...
theorem cert21_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.mirror TauOrient.normal [LColor.r, LColor.p, LColor.b, LColor.r]
...
theorem cert24_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.mirror TauOrient.normal [LColor.r, LColor.p, LColor.p, LColor.r]
...
theorem cert25_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.mirror TauOrient.normal [LColor.r, LColor.p, LColor.p, LColor.b]
...
theorem cert26_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.mirror TauOrient.normal [LColor.r, LColor.p, LColor.p, LColor.p]
...
theorem cert27_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.mirror TauOrient.normal [LColor.b, LColor.r, LColor.r, LColor.r]
...
theorem cert28_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.mirror TauOrient.normal [LColor.b, LColor.r, LColor.r, LColor.b]
...
theorem cert29_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.mirror TauOrient.normal [LColor.b, LColor.r, LColor.r, LColor.p]
...
theorem cert32_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.mirror TauOrient.normal [LColor.b, LColor.r, LColor.b, LColor.p]
...
theorem cert34_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.mirror TauOrient.normal [LColor.b, LColor.r, LColor.p, LColor.b]
...
theorem cert38_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.mirror TauOrient.normal [LColor.b, LColor.b, LColor.r, LColor.p]
...
theorem cert39_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.mirror TauOrient.normal [LColor.b, LColor.b, LColor.b, LColor.r]
...
theorem cert40_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.mirror TauOrient.normal [LColor.b, LColor.b, LColor.b, LColor.b]
...
theorem cert41_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.mirror TauOrient.normal [LColor.b, LColor.b, LColor.b, LColor.p]
...
theorem cert42_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.mirror TauOrient.normal [LColor.b, LColor.b, LColor.p, LColor.r]
...
theorem cert46_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.mirror TauOrient.normal [LColor.b, LColor.p, LColor.r, LColor.b]
...
theorem cert48_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.mirror TauOrient.normal [LColor.b, LColor.p, LColor.b, LColor.r]
...
theorem cert51_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.mirror TauOrient.normal [LColor.b, LColor.p, LColor.p, LColor.r]
...
theorem cert52_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.mirror TauOrient.normal [LColor.b, LColor.p, LColor.p, LColor.b]
...
theorem cert53_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.mirror TauOrient.normal [LColor.b, LColor.p, LColor.p, LColor.p]
...
theorem cert54_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.mirror TauOrient.normal [LColor.p, LColor.r, LColor.r, LColor.r]
...
theorem cert55_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.mirror TauOrient.normal [LColor.p, LColor.r, LColor.r, LColor.b]
...
theorem cert56_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.mirror TauOrient.normal [LColor.p, LColor.r, LColor.r, LColor.p]
...
theorem cert59_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.mirror TauOrient.normal [LColor.p, LColor.r, LColor.b, LColor.p]
...
theorem cert61_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.mirror TauOrient.normal [LColor.p, LColor.r, LColor.p, LColor.b]
...
theorem cert65_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.mirror TauOrient.normal [LColor.p, LColor.b, LColor.r, LColor.p]
...
theorem cert66_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.mirror TauOrient.normal [LColor.p, LColor.b, LColor.b, LColor.r]
...
theorem cert67_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.mirror TauOrient.normal [LColor.p, LColor.b, LColor.b, LColor.b]
...
theorem cert68_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.mirror TauOrient.normal [LColor.p, LColor.b, LColor.b, LColor.p]
...
theorem cert69_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.mirror TauOrient.normal [LColor.p, LColor.b, LColor.p, LColor.r]
...
theorem cert73_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.mirror TauOrient.normal [LColor.p, LColor.p, LColor.r, LColor.b]
...
theorem cert75_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.mirror TauOrient.normal [LColor.p, LColor.p, LColor.b, LColor.r]
...
theorem cert78_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.mirror TauOrient.normal [LColor.p, LColor.p, LColor.p, LColor.r]
...
theorem cert79_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.mirror TauOrient.normal [LColor.p, LColor.p, LColor.p, LColor.b]
...
theorem cert80_empty :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.mirror TauOrient.mirror TauOrient.normal [LColor.p, LColor.p, LColor.p, LColor.p]
