...
/-!
# Blue-purple certificate for the persistent hexagon adversary
...
/-- The persistent adversary audit succeeds for the blue-purple pair. -/
theorem allPersistentRows_bluePurple :
    allPersistentRows TaitColorPair.bluePurple = true := by
  rfl
