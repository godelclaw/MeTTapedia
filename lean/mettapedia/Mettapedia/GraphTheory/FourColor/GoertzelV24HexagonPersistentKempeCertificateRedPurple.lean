...
/-!
# Red-purple certificate for the persistent hexagon adversary
...
/-- The persistent adversary audit succeeds for the red-purple pair. -/
theorem allPersistentRows_redPurple :
    allPersistentRows TaitColorPair.redPurple = true := by
  rfl
