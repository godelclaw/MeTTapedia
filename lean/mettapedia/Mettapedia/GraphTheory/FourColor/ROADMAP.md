...
`6000..6255`, root `4368`, max parent depth 6, and rows 0 through 31 checked
...
size-512 large fiber, and the first 32 rows of the second large fiber.  The
remaining 480 rows of `[r,r,p,p]`, the other ten large `TTT` fibers, and the
...
`[r,r,b,b]` fiber and the first 32 rows of `[r,r,p,p]` certified, and the
remaining work is the other 480 rows of `[r,r,p,p]`, the other ten large
