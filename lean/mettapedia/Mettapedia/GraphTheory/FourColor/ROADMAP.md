...
the large fixed-input fibers remain open except for the first checked 16-row
chunk of the reversed `[b,b,r,r]` large fiber.
...
`mmmLargeFiber36Block1Chunk0ComponentCertificateAudit_ok` checks one 16-row
chunk of the reversed `[b,b,r,r]` large fiber under the actual mirror-triple
word.
