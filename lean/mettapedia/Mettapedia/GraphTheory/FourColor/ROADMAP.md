...
128 rows of the third size-512 large fiber.  The remaining 384 rows of
...
`[r,r,b,b]` fiber, the second large `[r,r,p,p]` fiber, and rows 0 through 127 of
the third large `[r,b,r,b]` fiber certified, and the remaining work is the other
384 rows of `[r,b,r,b]`, the other nine large `TTT` fibers, plus the thirteen
non-base modes
`mode00/mode01/mode02/mode03/mode05/mode06/mode08/mode12/mode13/mode14/mode15/mode17/mode19`.
