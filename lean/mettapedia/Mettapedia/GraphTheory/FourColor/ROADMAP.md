...
the large fixed-input fibers remain open except for three checked 64-row blocks
...
`mmmLargeFiber36Block3ComponentCertificateAudit_ok` check three 64-row blocks
of the reversed `[b,b,r,r]` large fiber under the actual mirror-triple word.
