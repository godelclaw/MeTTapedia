...
theorem fiber30_eq :
  ...
  have hfast := closedCollarFiber_three_eq_keyed TauOrient.normal TauOrient.normal TauOrient.mirror [LColor.b, LColor.r, LColor.b, LColor.r]
...
theorem cert30_component_2_10_eq :
  ...
  exact closeClosedCollarComponent_eq_self_of_layer_nil word
    (listGetD fiber30 2 []) LColor.r LColor.b
    cert30_seen_2_10_3 cert30_layer_2_10_3_eq 24
...
def cert30_seen_2_26_4 : List ChainEdge :=
...
def cert30_layer_2_26_4 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.B6 }, { occ := 2, edge := TauEdge.F0F2 }]

theorem cert30_layer_2_26_4_eq :
    closedCollarComponentLayer word (listGetD fiber30 2 [])
      LColor.b LColor.p cert30_seen_2_26_4 = cert30_layer_2_26_4 := by
  decide

def cert30_seen_2_26_5 : List ChainEdge :=
...
def cert30_layer_2_26_5 : List ChainEdge :=
  [{ occ := 2, edge := TauEdge.F1F0 }]

theorem cert30_layer_2_26_5_eq :
    closedCollarComponentLayer word (listGetD fiber30 2 [])
      LColor.b LColor.p cert30_seen_2_26_5 = cert30_layer_2_26_5 := by
  decide

def cert30_seen_2_26_6 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F2F3 }, { occ := 0, edge := TauEdge.F2F4 }, { occ := 0, edge := TauEdge.B4 }, { occ := 0, edge := TauEdge.B7 }, { occ := 1, edge := TauEdge.F0F2 }, { occ := 1, edge := TauEdge.F2F4 }, { occ := 1, edge := TauEdge.B4 }, { occ := 1, edge := TauEdge.F4F5 }, { occ := 2, edge := TauEdge.F2F3 }, { occ := 1, edge := TauEdge.B6 }, { occ := 2, edge := TauEdge.F0F2 }, { occ := 2, edge := TauEdge.F1F0 }]

def cert30_layer_2_26_6 : List ChainEdge :=
  []

theorem cert30_layer_2_26_6_eq :
    closedCollarComponentLayer word (listGetD fiber30 2 [])
      LColor.b LColor.p cert30_seen_2_26_6 = cert30_layer_2_26_6 := by
  decide
...
theorem cert30_component_2_26_eq :
  ...
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 2 []) LColor.b LColor.p
    cert30_seen_2_26_3 cert30_layer_2_26_3 23 cert30_layer_2_26_3_eq]
  change closeClosedCollarComponent word (listGetD fiber30 2 [])
      LColor.b LColor.p 23 cert30_seen_2_26_4 = cert30_component_2_26
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 2 []) LColor.b LColor.p
    cert30_seen_2_26_4 cert30_layer_2_26_4 22 cert30_layer_2_26_4_eq]
  change closeClosedCollarComponent word (listGetD fiber30 2 [])
      LColor.b LColor.p 22 cert30_seen_2_26_5 = cert30_component_2_26
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 2 []) LColor.b LColor.p
    cert30_seen_2_26_5 cert30_layer_2_26_5 21 cert30_layer_2_26_5_eq]
  change closeClosedCollarComponent word (listGetD fiber30 2 [])
      LColor.b LColor.p 21 cert30_seen_2_26_6 = cert30_component_2_26
  exact closeClosedCollarComponent_eq_self_of_layer_nil word
    (listGetD fiber30 2 []) LColor.b LColor.p
    cert30_seen_2_26_6 cert30_layer_2_26_6_eq 21
...
theorem cert30_component_3_11_eq :
  ...
  exact closeClosedCollarComponent_eq_self_of_layer_nil word
    (listGetD fiber30 3 []) LColor.r LColor.b
    cert30_seen_3_11_3 cert30_layer_3_11_3_eq 24
...
def cert30_seen_4_16_3 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F4F5 }, { occ := 0, edge := TauEdge.B6 }, { occ := 0, edge := TauEdge.B7 }, { occ := 1, edge := TauEdge.F1F0 }, { occ := 1, edge := TauEdge.F2F3 }, { occ := 1, edge := TauEdge.F0F2 }]

def cert30_layer_4_16_3 : List ChainEdge :=
  []

theorem cert30_layer_4_16_3_eq :
    closedCollarComponentLayer word (listGetD fiber30 4 [])
      LColor.r LColor.b cert30_seen_4_16_3 = cert30_layer_4_16_3 := by
  decide
...
theorem cert30_component_4_16_eq :
  ...
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 4 []) LColor.r LColor.b
    cert30_seen_4_16_2 cert30_layer_4_16_2 24 cert30_layer_4_16_2_eq]
  change closeClosedCollarComponent word (listGetD fiber30 4 [])
      LColor.r LColor.b 24 cert30_seen_4_16_3 = cert30_component_4_16
  exact closeClosedCollarComponent_eq_self_of_layer_nil word
    (listGetD fiber30 4 []) LColor.r LColor.b
    cert30_seen_4_16_3 cert30_layer_4_16_3_eq 24
...
def cert30_seen_5_17_3 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F4F5 }, { occ := 0, edge := TauEdge.B6 }, { occ := 0, edge := TauEdge.B7 }, { occ := 1, edge := TauEdge.F1F0 }, { occ := 1, edge := TauEdge.F2F3 }, { occ := 1, edge := TauEdge.F0F2 }]

def cert30_layer_5_17_3 : List ChainEdge :=
  []

theorem cert30_layer_5_17_3_eq :
    closedCollarComponentLayer word (listGetD fiber30 5 [])
      LColor.r LColor.b cert30_seen_5_17_3 = cert30_layer_5_17_3 := by
  decide
...
theorem cert30_component_5_17_eq :
  ...
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 5 []) LColor.r LColor.b
    cert30_seen_5_17_2 cert30_layer_5_17_2 24 cert30_layer_5_17_2_eq]
  change closeClosedCollarComponent word (listGetD fiber30 5 [])
      LColor.r LColor.b 24 cert30_seen_5_17_3 = cert30_component_5_17
  exact closeClosedCollarComponent_eq_self_of_layer_nil word
    (listGetD fiber30 5 []) LColor.r LColor.b
    cert30_seen_5_17_3 cert30_layer_5_17_3_eq 24
...
def cert30_seen_6_18_3 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F4F5 }, { occ := 0, edge := TauEdge.B6 }, { occ := 0, edge := TauEdge.B7 }, { occ := 1, edge := TauEdge.F1F0 }, { occ := 1, edge := TauEdge.F2F3 }, { occ := 1, edge := TauEdge.F0F2 }]

def cert30_layer_6_18_3 : List ChainEdge :=
  []

theorem cert30_layer_6_18_3_eq :
    closedCollarComponentLayer word (listGetD fiber30 6 [])
      LColor.r LColor.b cert30_seen_6_18_3 = cert30_layer_6_18_3 := by
  decide
...
theorem cert30_component_6_18_eq :
  ...
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 6 []) LColor.r LColor.b
    cert30_seen_6_18_2 cert30_layer_6_18_2 24 cert30_layer_6_18_2_eq]
  change closeClosedCollarComponent word (listGetD fiber30 6 [])
      LColor.r LColor.b 24 cert30_seen_6_18_3 = cert30_component_6_18
  exact closeClosedCollarComponent_eq_self_of_layer_nil word
    (listGetD fiber30 6 []) LColor.r LColor.b
    cert30_seen_6_18_3 cert30_layer_6_18_3_eq 24
...
def cert30_seen_6_30_6 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F2F3 }, { occ := 0, edge := TauEdge.F2F4 }, { occ := 0, edge := TauEdge.B4 }, { occ := 0, edge := TauEdge.B7 }, { occ := 1, edge := TauEdge.F0F2 }, { occ := 1, edge := TauEdge.F2F4 }, { occ := 1, edge := TauEdge.B4 }, { occ := 1, edge := TauEdge.F4F5 }, { occ := 2, edge := TauEdge.F2F3 }, { occ := 1, edge := TauEdge.B6 }, { occ := 2, edge := TauEdge.F0F2 }, { occ := 2, edge := TauEdge.F1F0 }]

def cert30_layer_6_30_6 : List ChainEdge :=
  []

theorem cert30_layer_6_30_6_eq :
    closedCollarComponentLayer word (listGetD fiber30 6 [])
      LColor.b LColor.p cert30_seen_6_30_6 = cert30_layer_6_30_6 := by
  decide
...
theorem cert30_component_6_30_eq :
  ...
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 6 []) LColor.b LColor.p
    cert30_seen_6_30_5 cert30_layer_6_30_5 21 cert30_layer_6_30_5_eq]
  change closeClosedCollarComponent word (listGetD fiber30 6 [])
      LColor.b LColor.p 21 cert30_seen_6_30_6 = cert30_component_6_30
  exact closeClosedCollarComponent_eq_self_of_layer_nil word
    (listGetD fiber30 6 []) LColor.b LColor.p
    cert30_seen_6_30_6 cert30_layer_6_30_6_eq 21
...
def cert30_seen_7_19_3 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F4F5 }, { occ := 0, edge := TauEdge.B6 }, { occ := 0, edge := TauEdge.B7 }, { occ := 1, edge := TauEdge.F1F0 }, { occ := 1, edge := TauEdge.F2F3 }, { occ := 1, edge := TauEdge.F0F2 }]

def cert30_layer_7_19_3 : List ChainEdge :=
  []

theorem cert30_layer_7_19_3_eq :
    closedCollarComponentLayer word (listGetD fiber30 7 [])
      LColor.r LColor.b cert30_seen_7_19_3 = cert30_layer_7_19_3 := by
  decide
...
theorem cert30_component_7_19_eq :
  ...
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 7 []) LColor.r LColor.b
    cert30_seen_7_19_2 cert30_layer_7_19_2 24 cert30_layer_7_19_2_eq]
  change closeClosedCollarComponent word (listGetD fiber30 7 [])
      LColor.r LColor.b 24 cert30_seen_7_19_3 = cert30_component_7_19
  exact closeClosedCollarComponent_eq_self_of_layer_nil word
    (listGetD fiber30 7 []) LColor.r LColor.b
    cert30_seen_7_19_3 cert30_layer_7_19_3_eq 24
...
theorem cert30_component_10_2_eq :
  ...
  exact closeClosedCollarComponent_eq_self_of_layer_nil word
    (listGetD fiber30 10 []) LColor.r LColor.b
    cert30_seen_10_2_3 cert30_layer_10_2_3_eq 24
...
def cert30_move_10_14 : ChainMove :=
  { a := LColor.b, c := LColor.p, seed := { occ := 1, edge := TauEdge.F2F3 } }

def cert30_component_10_14 : List ChainEdge :=
...
def cert30_seen_10_14_0 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F2F3 }]

def cert30_layer_10_14_0 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F2F4 }, { occ := 1, edge := TauEdge.B4 }]

theorem cert30_layer_10_14_0_eq :
    closedCollarComponentLayer word (listGetD fiber30 10 [])
      LColor.b LColor.p cert30_seen_10_14_0 = cert30_layer_10_14_0 := by
  decide

def cert30_seen_10_14_1 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F2F3 }, { occ := 1, edge := TauEdge.F2F4 }, { occ := 1, edge := TauEdge.B4 }]

def cert30_layer_10_14_1 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F4F5 }, { occ := 2, edge := TauEdge.F2F3 }]

theorem cert30_layer_10_14_1_eq :
    closedCollarComponentLayer word (listGetD fiber30 10 [])
      LColor.b LColor.p cert30_seen_10_14_1 = cert30_layer_10_14_1 := by
  decide

def cert30_seen_10_14_2 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F2F3 }, { occ := 1, edge := TauEdge.F2F4 }, { occ := 1, edge := TauEdge.B4 }, { occ := 1, edge := TauEdge.F4F5 }, { occ := 2, edge := TauEdge.F2F3 }]

def cert30_layer_10_14_2 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.B6 }, { occ := 2, edge := TauEdge.F0F2 }]

theorem cert30_layer_10_14_2_eq :
    closedCollarComponentLayer word (listGetD fiber30 10 [])
      LColor.b LColor.p cert30_seen_10_14_2 = cert30_layer_10_14_2 := by
  decide

def cert30_seen_10_14_3 : List ChainEdge :=
...
def cert30_layer_10_14_3 : List ChainEdge :=
  [{ occ := 2, edge := TauEdge.F1F0 }]

theorem cert30_layer_10_14_3_eq :
    closedCollarComponentLayer word (listGetD fiber30 10 [])
      LColor.b LColor.p cert30_seen_10_14_3 = cert30_layer_10_14_3 := by
  decide

def cert30_seen_10_14_4 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F2F3 }, { occ := 1, edge := TauEdge.F2F4 }, { occ := 1, edge := TauEdge.B4 }, { occ := 1, edge := TauEdge.F4F5 }, { occ := 2, edge := TauEdge.F2F3 }, { occ := 1, edge := TauEdge.B6 }, { occ := 2, edge := TauEdge.F0F2 }, { occ := 2, edge := TauEdge.F1F0 }]

def cert30_layer_10_14_4 : List ChainEdge :=
  []

theorem cert30_layer_10_14_4_eq :
    closedCollarComponentLayer word (listGetD fiber30 10 [])
      LColor.b LColor.p cert30_seen_10_14_4 = cert30_layer_10_14_4 := by
  decide

theorem cert30_component_10_14_eq :
    closedCollarComponent word (listGetD fiber30 10 [])
      LColor.b LColor.p { occ := 1, edge := TauEdge.F2F3 } = cert30_component_10_14 := by
  unfold closedCollarComponent
  have hseedColor : chainEdgeInPair (listGetD fiber30 10 [])
      LColor.b LColor.p { occ := 1, edge := TauEdge.F2F3 } = true := by
    decide
  simp [hseedColor]
  change closeClosedCollarComponent word (listGetD fiber30 10 [])
      LColor.b LColor.p 27 cert30_seen_10_14_0 = cert30_component_10_14
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 10 []) LColor.b LColor.p
    cert30_seen_10_14_0 cert30_layer_10_14_0 26 cert30_layer_10_14_0_eq]
  change closeClosedCollarComponent word (listGetD fiber30 10 [])
      LColor.b LColor.p 26 cert30_seen_10_14_1 = cert30_component_10_14
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 10 []) LColor.b LColor.p
    cert30_seen_10_14_1 cert30_layer_10_14_1 25 cert30_layer_10_14_1_eq]
  change closeClosedCollarComponent word (listGetD fiber30 10 [])
      LColor.b LColor.p 25 cert30_seen_10_14_2 = cert30_component_10_14
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 10 []) LColor.b LColor.p
    cert30_seen_10_14_2 cert30_layer_10_14_2 24 cert30_layer_10_14_2_eq]
  change closeClosedCollarComponent word (listGetD fiber30 10 [])
      LColor.b LColor.p 24 cert30_seen_10_14_3 = cert30_component_10_14
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 10 []) LColor.b LColor.p
    cert30_seen_10_14_3 cert30_layer_10_14_3 23 cert30_layer_10_14_3_eq]
  change closeClosedCollarComponent word (listGetD fiber30 10 [])
      LColor.b LColor.p 23 cert30_seen_10_14_4 = cert30_component_10_14
  exact closeClosedCollarComponent_eq_self_of_layer_nil word
    (listGetD fiber30 10 []) LColor.b LColor.p
    cert30_seen_10_14_4 cert30_layer_10_14_4_eq 23

theorem cert30_step_10_14 :
    closedCollarIndexStepBool word fiber30 10 14 = true :=
  closedCollarIndexStepBool_of_component (move := cert30_move_10_14)
    (by decide) (by decide)
    (by simpa [cert30_move_10_14] using cert30_component_10_14_eq)
    (by decide) (by decide) (by decide)
...
theorem cert30_component_11_3_eq :
  ...
  exact closeClosedCollarComponent_eq_self_of_layer_nil word
    (listGetD fiber30 11 []) LColor.r LColor.b
    cert30_seen_11_3_3 cert30_layer_11_3_3_eq 24
...
def cert30_move_12_15 : ChainMove :=
  { a := LColor.r, c := LColor.p, seed := { occ := 1, edge := TauEdge.F4F5 } }

def cert30_component_12_15 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F4F5 }, { occ := 1, edge := TauEdge.B6 }, { occ := 1, edge := TauEdge.B7 }, { occ := 2, edge := TauEdge.F1F0 }]

def cert30_seen_12_15_0 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F4F5 }]

def cert30_layer_12_15_0 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.B6 }, { occ := 1, edge := TauEdge.B7 }]

theorem cert30_layer_12_15_0_eq :
    closedCollarComponentLayer word (listGetD fiber30 12 [])
      LColor.r LColor.p cert30_seen_12_15_0 = cert30_layer_12_15_0 := by
  decide

def cert30_seen_12_15_1 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F4F5 }, { occ := 1, edge := TauEdge.B6 }, { occ := 1, edge := TauEdge.B7 }]

def cert30_layer_12_15_1 : List ChainEdge :=
  [{ occ := 2, edge := TauEdge.F1F0 }]

theorem cert30_layer_12_15_1_eq :
    closedCollarComponentLayer word (listGetD fiber30 12 [])
      LColor.r LColor.p cert30_seen_12_15_1 = cert30_layer_12_15_1 := by
  decide

def cert30_seen_12_15_2 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F4F5 }, { occ := 1, edge := TauEdge.B6 }, { occ := 1, edge := TauEdge.B7 }, { occ := 2, edge := TauEdge.F1F0 }]

def cert30_layer_12_15_2 : List ChainEdge :=
  []

theorem cert30_layer_12_15_2_eq :
    closedCollarComponentLayer word (listGetD fiber30 12 [])
      LColor.r LColor.p cert30_seen_12_15_2 = cert30_layer_12_15_2 := by
  decide

theorem cert30_component_12_15_eq :
    closedCollarComponent word (listGetD fiber30 12 [])
      LColor.r LColor.p { occ := 1, edge := TauEdge.F4F5 } = cert30_component_12_15 := by
  unfold closedCollarComponent
  have hseedColor : chainEdgeInPair (listGetD fiber30 12 [])
  ...
  simp [hseedColor]
  change closeClosedCollarComponent word (listGetD fiber30 12 [])
      LColor.r LColor.p 27 cert30_seen_12_15_0 = cert30_component_12_15
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 12 []) LColor.r LColor.p
    cert30_seen_12_15_0 cert30_layer_12_15_0 26 cert30_layer_12_15_0_eq]
  change closeClosedCollarComponent word (listGetD fiber30 12 [])
      LColor.r LColor.p 26 cert30_seen_12_15_1 = cert30_component_12_15
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 12 []) LColor.r LColor.p
    cert30_seen_12_15_1 cert30_layer_12_15_1 25 cert30_layer_12_15_1_eq]
  change closeClosedCollarComponent word (listGetD fiber30 12 [])
      LColor.r LColor.p 25 cert30_seen_12_15_2 = cert30_component_12_15
  exact closeClosedCollarComponent_eq_self_of_layer_nil word
    (listGetD fiber30 12 []) LColor.r LColor.p
    cert30_seen_12_15_2 cert30_layer_12_15_2_eq 25

theorem cert30_step_12_15 :
    closedCollarIndexStepBool word fiber30 12 15 = true :=
  closedCollarIndexStepBool_of_component (move := cert30_move_12_15)
    (by decide) (by decide)
    (by simpa [cert30_move_12_15] using cert30_component_12_15_eq)
    (by decide) (by decide) (by decide)
...
def cert30_move_14_10 : ChainMove :=
  { a := LColor.b, c := LColor.p, seed := { occ := 1, edge := TauEdge.F2F3 } }

def cert30_component_14_10 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F2F3 }, { occ := 1, edge := TauEdge.F2F4 }, { occ := 1, edge := TauEdge.B4 }, { occ := 1, edge := TauEdge.F4F5 }, { occ := 2, edge := TauEdge.F2F3 }, { occ := 1, edge := TauEdge.B6 }, { occ := 2, edge := TauEdge.F0F2 }, { occ := 2, edge := TauEdge.F1F0 }]

def cert30_seen_14_10_0 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F2F3 }]

def cert30_layer_14_10_0 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F2F4 }, { occ := 1, edge := TauEdge.B4 }]

theorem cert30_layer_14_10_0_eq :
    closedCollarComponentLayer word (listGetD fiber30 14 [])
      LColor.b LColor.p cert30_seen_14_10_0 = cert30_layer_14_10_0 := by
  decide

def cert30_seen_14_10_1 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F2F3 }, { occ := 1, edge := TauEdge.F2F4 }, { occ := 1, edge := TauEdge.B4 }]

def cert30_layer_14_10_1 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F4F5 }, { occ := 2, edge := TauEdge.F2F3 }]

theorem cert30_layer_14_10_1_eq :
    closedCollarComponentLayer word (listGetD fiber30 14 [])
      LColor.b LColor.p cert30_seen_14_10_1 = cert30_layer_14_10_1 := by
  decide

def cert30_seen_14_10_2 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F2F3 }, { occ := 1, edge := TauEdge.F2F4 }, { occ := 1, edge := TauEdge.B4 }, { occ := 1, edge := TauEdge.F4F5 }, { occ := 2, edge := TauEdge.F2F3 }]

def cert30_layer_14_10_2 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.B6 }, { occ := 2, edge := TauEdge.F0F2 }]

theorem cert30_layer_14_10_2_eq :
    closedCollarComponentLayer word (listGetD fiber30 14 [])
      LColor.b LColor.p cert30_seen_14_10_2 = cert30_layer_14_10_2 := by
  decide

def cert30_seen_14_10_3 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F2F3 }, { occ := 1, edge := TauEdge.F2F4 }, { occ := 1, edge := TauEdge.B4 }, { occ := 1, edge := TauEdge.F4F5 }, { occ := 2, edge := TauEdge.F2F3 }, { occ := 1, edge := TauEdge.B6 }, { occ := 2, edge := TauEdge.F0F2 }]

def cert30_layer_14_10_3 : List ChainEdge :=
  [{ occ := 2, edge := TauEdge.F1F0 }]

theorem cert30_layer_14_10_3_eq :
    closedCollarComponentLayer word (listGetD fiber30 14 [])
      LColor.b LColor.p cert30_seen_14_10_3 = cert30_layer_14_10_3 := by
  decide

def cert30_seen_14_10_4 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F2F3 }, { occ := 1, edge := TauEdge.F2F4 }, { occ := 1, edge := TauEdge.B4 }, { occ := 1, edge := TauEdge.F4F5 }, { occ := 2, edge := TauEdge.F2F3 }, { occ := 1, edge := TauEdge.B6 }, { occ := 2, edge := TauEdge.F0F2 }, { occ := 2, edge := TauEdge.F1F0 }]

def cert30_layer_14_10_4 : List ChainEdge :=
  []

theorem cert30_layer_14_10_4_eq :
    closedCollarComponentLayer word (listGetD fiber30 14 [])
      LColor.b LColor.p cert30_seen_14_10_4 = cert30_layer_14_10_4 := by
  decide

theorem cert30_component_14_10_eq :
    closedCollarComponent word (listGetD fiber30 14 [])
      LColor.b LColor.p { occ := 1, edge := TauEdge.F2F3 } = cert30_component_14_10 := by
  unfold closedCollarComponent
  ...
  change closeClosedCollarComponent word (listGetD fiber30 14 [])
      LColor.b LColor.p 27 cert30_seen_14_10_0 = cert30_component_14_10
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 14 []) LColor.b LColor.p
    cert30_seen_14_10_0 cert30_layer_14_10_0 26 cert30_layer_14_10_0_eq]
  change closeClosedCollarComponent word (listGetD fiber30 14 [])
      LColor.b LColor.p 26 cert30_seen_14_10_1 = cert30_component_14_10
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 14 []) LColor.b LColor.p
    cert30_seen_14_10_1 cert30_layer_14_10_1 25 cert30_layer_14_10_1_eq]
  change closeClosedCollarComponent word (listGetD fiber30 14 [])
      LColor.b LColor.p 25 cert30_seen_14_10_2 = cert30_component_14_10
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 14 []) LColor.b LColor.p
    cert30_seen_14_10_2 cert30_layer_14_10_2 24 cert30_layer_14_10_2_eq]
  change closeClosedCollarComponent word (listGetD fiber30 14 [])
      LColor.b LColor.p 24 cert30_seen_14_10_3 = cert30_component_14_10
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 14 []) LColor.b LColor.p
    cert30_seen_14_10_3 cert30_layer_14_10_3 23 cert30_layer_14_10_3_eq]
  change closeClosedCollarComponent word (listGetD fiber30 14 [])
      LColor.b LColor.p 23 cert30_seen_14_10_4 = cert30_component_14_10
  exact closeClosedCollarComponent_eq_self_of_layer_nil word
    (listGetD fiber30 14 []) LColor.b LColor.p
    cert30_seen_14_10_4 cert30_layer_14_10_4_eq 23

theorem cert30_step_14_10 :
    closedCollarIndexStepBool word fiber30 14 10 = true :=
  closedCollarIndexStepBool_of_component (move := cert30_move_14_10)
    (by decide) (by decide)
    (by simpa [cert30_move_14_10] using cert30_component_14_10_eq)
    (by decide) (by decide) (by decide)

def cert30_move_15_12 : ChainMove :=
  { a := LColor.r, c := LColor.p, seed := { occ := 1, edge := TauEdge.F4F5 } }

def cert30_component_15_12 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F4F5 }, { occ := 1, edge := TauEdge.B6 }, { occ := 1, edge := TauEdge.B7 }, { occ := 2, edge := TauEdge.F1F0 }]

def cert30_seen_15_12_0 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F4F5 }]

def cert30_layer_15_12_0 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.B6 }, { occ := 1, edge := TauEdge.B7 }]

theorem cert30_layer_15_12_0_eq :
    closedCollarComponentLayer word (listGetD fiber30 15 [])
      LColor.r LColor.p cert30_seen_15_12_0 = cert30_layer_15_12_0 := by
  decide

def cert30_seen_15_12_1 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F4F5 }, { occ := 1, edge := TauEdge.B6 }, { occ := 1, edge := TauEdge.B7 }]

def cert30_layer_15_12_1 : List ChainEdge :=
  [{ occ := 2, edge := TauEdge.F1F0 }]

theorem cert30_layer_15_12_1_eq :
    closedCollarComponentLayer word (listGetD fiber30 15 [])
      LColor.r LColor.p cert30_seen_15_12_1 = cert30_layer_15_12_1 := by
  decide

def cert30_seen_15_12_2 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F4F5 }, { occ := 1, edge := TauEdge.B6 }, { occ := 1, edge := TauEdge.B7 }, { occ := 2, edge := TauEdge.F1F0 }]

def cert30_layer_15_12_2 : List ChainEdge :=
  []

theorem cert30_layer_15_12_2_eq :
    closedCollarComponentLayer word (listGetD fiber30 15 [])
      LColor.r LColor.p cert30_seen_15_12_2 = cert30_layer_15_12_2 := by
  decide

theorem cert30_component_15_12_eq :
    closedCollarComponent word (listGetD fiber30 15 [])
      LColor.r LColor.p { occ := 1, edge := TauEdge.F4F5 } = cert30_component_15_12 := by
  unfold closedCollarComponent
  ...
  change closeClosedCollarComponent word (listGetD fiber30 15 [])
      LColor.r LColor.p 27 cert30_seen_15_12_0 = cert30_component_15_12
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 15 []) LColor.r LColor.p
    cert30_seen_15_12_0 cert30_layer_15_12_0 26 cert30_layer_15_12_0_eq]
  change closeClosedCollarComponent word (listGetD fiber30 15 [])
      LColor.r LColor.p 26 cert30_seen_15_12_1 = cert30_component_15_12
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 15 []) LColor.r LColor.p
    cert30_seen_15_12_1 cert30_layer_15_12_1 25 cert30_layer_15_12_1_eq]
  change closeClosedCollarComponent word (listGetD fiber30 15 [])
      LColor.r LColor.p 25 cert30_seen_15_12_2 = cert30_component_15_12
  exact closeClosedCollarComponent_eq_self_of_layer_nil word
    (listGetD fiber30 15 []) LColor.r LColor.p
    cert30_seen_15_12_2 cert30_layer_15_12_2_eq 25

theorem cert30_step_15_12 :
    closedCollarIndexStepBool word fiber30 15 12 = true :=
  closedCollarIndexStepBool_of_component (move := cert30_move_15_12)
    (by decide) (by decide)
    (by simpa [cert30_move_15_12] using cert30_component_15_12_eq)
    (by decide) (by decide) (by decide)
...
def cert30_seen_16_4_3 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F4F5 }, { occ := 0, edge := TauEdge.B6 }, { occ := 0, edge := TauEdge.B7 }, { occ := 1, edge := TauEdge.F1F0 }, { occ := 1, edge := TauEdge.F2F3 }, { occ := 1, edge := TauEdge.F0F2 }]

def cert30_layer_16_4_3 : List ChainEdge :=
  []

theorem cert30_layer_16_4_3_eq :
    closedCollarComponentLayer word (listGetD fiber30 16 [])
      LColor.r LColor.b cert30_seen_16_4_3 = cert30_layer_16_4_3 := by
  decide
...
theorem cert30_component_16_4_eq :
  ...
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 16 []) LColor.r LColor.b
    cert30_seen_16_4_2 cert30_layer_16_4_2 24 cert30_layer_16_4_2_eq]
  change closeClosedCollarComponent word (listGetD fiber30 16 [])
      LColor.r LColor.b 24 cert30_seen_16_4_3 = cert30_component_16_4
  exact closeClosedCollarComponent_eq_self_of_layer_nil word
    (listGetD fiber30 16 []) LColor.r LColor.b
    cert30_seen_16_4_3 cert30_layer_16_4_3_eq 24
...
theorem cert30_layer_16_40_0_eq :
    closedCollarComponentLayer word (listGetD fiber30 16 [])
      LColor.b LColor.p cert30_seen_16_40_0 = cert30_layer_16_40_0 := by
  decide
...
theorem cert30_layer_16_40_1_eq :
    closedCollarComponentLayer word (listGetD fiber30 16 [])
      LColor.b LColor.p cert30_seen_16_40_1 = cert30_layer_16_40_1 := by
  decide
...
theorem cert30_layer_16_40_2_eq :
    closedCollarComponentLayer word (listGetD fiber30 16 [])
      LColor.b LColor.p cert30_seen_16_40_2 = cert30_layer_16_40_2 := by
  decide

def cert30_seen_16_40_3 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F2F3 }, { occ := 0, edge := TauEdge.F2F4 }, { occ := 0, edge := TauEdge.B4 }, { occ := 0, edge := TauEdge.F4F5 }, { occ := 1, edge := TauEdge.F1F0 }, { occ := 0, edge := TauEdge.B5 }]

def cert30_layer_16_40_3 : List ChainEdge :=
  []

theorem cert30_layer_16_40_3_eq :
    closedCollarComponentLayer word (listGetD fiber30 16 [])
      LColor.b LColor.p cert30_seen_16_40_3 = cert30_layer_16_40_3 := by
  decide

theorem cert30_component_16_40_eq :
    closedCollarComponent word (listGetD fiber30 16 [])
      LColor.b LColor.p { occ := 0, edge := TauEdge.F2F3 } = cert30_component_16_40 := by
  unfold closedCollarComponent
  have hseedColor : chainEdgeInPair (listGetD fiber30 16 [])
      LColor.b LColor.p { occ := 0, edge := TauEdge.F2F3 } = true := by
    decide
  simp [hseedColor]
  change closeClosedCollarComponent word (listGetD fiber30 16 [])
      LColor.b LColor.p 27 cert30_seen_16_40_0 = cert30_component_16_40
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 16 []) LColor.b LColor.p
    cert30_seen_16_40_0 cert30_layer_16_40_0 26 cert30_layer_16_40_0_eq]
  change closeClosedCollarComponent word (listGetD fiber30 16 [])
      LColor.b LColor.p 26 cert30_seen_16_40_1 = cert30_component_16_40
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 16 []) LColor.b LColor.p
    cert30_seen_16_40_1 cert30_layer_16_40_1 25 cert30_layer_16_40_1_eq]
  change closeClosedCollarComponent word (listGetD fiber30 16 [])
      LColor.b LColor.p 25 cert30_seen_16_40_2 = cert30_component_16_40
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 16 []) LColor.b LColor.p
    cert30_seen_16_40_2 cert30_layer_16_40_2 24 cert30_layer_16_40_2_eq]
  change closeClosedCollarComponent word (listGetD fiber30 16 [])
      LColor.b LColor.p 24 cert30_seen_16_40_3 = cert30_component_16_40
  exact closeClosedCollarComponent_eq_self_of_layer_nil word
    (listGetD fiber30 16 []) LColor.b LColor.p
    cert30_seen_16_40_3 cert30_layer_16_40_3_eq 24
...
def cert30_seen_17_5_3 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F4F5 }, { occ := 0, edge := TauEdge.B6 }, { occ := 0, edge := TauEdge.B7 }, { occ := 1, edge := TauEdge.F1F0 }, { occ := 1, edge := TauEdge.F2F3 }, { occ := 1, edge := TauEdge.F0F2 }]

def cert30_layer_17_5_3 : List ChainEdge :=
  []

theorem cert30_layer_17_5_3_eq :
    closedCollarComponentLayer word (listGetD fiber30 17 [])
      LColor.r LColor.b cert30_seen_17_5_3 = cert30_layer_17_5_3 := by
  decide
...
theorem cert30_component_17_5_eq :
  ...
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 17 []) LColor.r LColor.b
    cert30_seen_17_5_2 cert30_layer_17_5_2 24 cert30_layer_17_5_2_eq]
  change closeClosedCollarComponent word (listGetD fiber30 17 [])
      LColor.r LColor.b 24 cert30_seen_17_5_3 = cert30_component_17_5
  exact closeClosedCollarComponent_eq_self_of_layer_nil word
    (listGetD fiber30 17 []) LColor.r LColor.b
    cert30_seen_17_5_3 cert30_layer_17_5_3_eq 24
...
theorem cert30_layer_17_41_0_eq :
    closedCollarComponentLayer word (listGetD fiber30 17 [])
      LColor.b LColor.p cert30_seen_17_41_0 = cert30_layer_17_41_0 := by
  decide
...
theorem cert30_layer_17_41_1_eq :
    closedCollarComponentLayer word (listGetD fiber30 17 [])
      LColor.b LColor.p cert30_seen_17_41_1 = cert30_layer_17_41_1 := by
  decide
...
theorem cert30_layer_17_41_2_eq :
    closedCollarComponentLayer word (listGetD fiber30 17 [])
      LColor.b LColor.p cert30_seen_17_41_2 = cert30_layer_17_41_2 := by
  decide

def cert30_seen_17_41_3 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F2F3 }, { occ := 0, edge := TauEdge.F2F4 }, { occ := 0, edge := TauEdge.B4 }, { occ := 0, edge := TauEdge.F4F5 }, { occ := 1, edge := TauEdge.F1F0 }, { occ := 0, edge := TauEdge.B5 }]

def cert30_layer_17_41_3 : List ChainEdge :=
  []

theorem cert30_layer_17_41_3_eq :
    closedCollarComponentLayer word (listGetD fiber30 17 [])
      LColor.b LColor.p cert30_seen_17_41_3 = cert30_layer_17_41_3 := by
  decide

theorem cert30_component_17_41_eq :
    closedCollarComponent word (listGetD fiber30 17 [])
      LColor.b LColor.p { occ := 0, edge := TauEdge.F2F3 } = cert30_component_17_41 := by
  unfold closedCollarComponent
  have hseedColor : chainEdgeInPair (listGetD fiber30 17 [])
      LColor.b LColor.p { occ := 0, edge := TauEdge.F2F3 } = true := by
    decide
  simp [hseedColor]
  change closeClosedCollarComponent word (listGetD fiber30 17 [])
      LColor.b LColor.p 27 cert30_seen_17_41_0 = cert30_component_17_41
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 17 []) LColor.b LColor.p
    cert30_seen_17_41_0 cert30_layer_17_41_0 26 cert30_layer_17_41_0_eq]
  change closeClosedCollarComponent word (listGetD fiber30 17 [])
      LColor.b LColor.p 26 cert30_seen_17_41_1 = cert30_component_17_41
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 17 []) LColor.b LColor.p
    cert30_seen_17_41_1 cert30_layer_17_41_1 25 cert30_layer_17_41_1_eq]
  change closeClosedCollarComponent word (listGetD fiber30 17 [])
      LColor.b LColor.p 25 cert30_seen_17_41_2 = cert30_component_17_41
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 17 []) LColor.b LColor.p
    cert30_seen_17_41_2 cert30_layer_17_41_2 24 cert30_layer_17_41_2_eq]
  change closeClosedCollarComponent word (listGetD fiber30 17 [])
      LColor.b LColor.p 24 cert30_seen_17_41_3 = cert30_component_17_41
  exact closeClosedCollarComponent_eq_self_of_layer_nil word
    (listGetD fiber30 17 []) LColor.b LColor.p
    cert30_seen_17_41_3 cert30_layer_17_41_3_eq 24
...
def cert30_seen_18_6_3 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F4F5 }, { occ := 0, edge := TauEdge.B6 }, { occ := 0, edge := TauEdge.B7 }, { occ := 1, edge := TauEdge.F1F0 }, { occ := 1, edge := TauEdge.F2F3 }, { occ := 1, edge := TauEdge.F0F2 }]

def cert30_layer_18_6_3 : List ChainEdge :=
  []

theorem cert30_layer_18_6_3_eq :
    closedCollarComponentLayer word (listGetD fiber30 18 [])
      LColor.r LColor.b cert30_seen_18_6_3 = cert30_layer_18_6_3 := by
  decide
...
theorem cert30_component_18_6_eq :
  ...
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 18 []) LColor.r LColor.b
    cert30_seen_18_6_2 cert30_layer_18_6_2 24 cert30_layer_18_6_2_eq]
  change closeClosedCollarComponent word (listGetD fiber30 18 [])
      LColor.r LColor.b 24 cert30_seen_18_6_3 = cert30_component_18_6
  exact closeClosedCollarComponent_eq_self_of_layer_nil word
    (listGetD fiber30 18 []) LColor.r LColor.b
    cert30_seen_18_6_3 cert30_layer_18_6_3_eq 24
...
def cert30_move_18_22 : ChainMove :=
  { a := LColor.b, c := LColor.p, seed := { occ := 1, edge := TauEdge.F2F3 } }

def cert30_component_18_22 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F2F3 }, { occ := 1, edge := TauEdge.F2F4 }, { occ := 1, edge := TauEdge.B4 }, { occ := 1, edge := TauEdge.F4F5 }, { occ := 2, edge := TauEdge.F2F3 }, { occ := 1, edge := TauEdge.B6 }, { occ := 2, edge := TauEdge.F0F2 }, { occ := 2, edge := TauEdge.F1F0 }]

def cert30_seen_18_22_0 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F2F3 }]

def cert30_layer_18_22_0 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F2F4 }, { occ := 1, edge := TauEdge.B4 }]

theorem cert30_layer_18_22_0_eq :
    closedCollarComponentLayer word (listGetD fiber30 18 [])
      LColor.b LColor.p cert30_seen_18_22_0 = cert30_layer_18_22_0 := by
  decide

def cert30_seen_18_22_1 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F2F3 }, { occ := 1, edge := TauEdge.F2F4 }, { occ := 1, edge := TauEdge.B4 }]

def cert30_layer_18_22_1 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F4F5 }, { occ := 2, edge := TauEdge.F2F3 }]

theorem cert30_layer_18_22_1_eq :
    closedCollarComponentLayer word (listGetD fiber30 18 [])
      LColor.b LColor.p cert30_seen_18_22_1 = cert30_layer_18_22_1 := by
  decide

def cert30_seen_18_22_2 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F2F3 }, { occ := 1, edge := TauEdge.F2F4 }, { occ := 1, edge := TauEdge.B4 }, { occ := 1, edge := TauEdge.F4F5 }, { occ := 2, edge := TauEdge.F2F3 }]

def cert30_layer_18_22_2 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.B6 }, { occ := 2, edge := TauEdge.F0F2 }]

theorem cert30_layer_18_22_2_eq :
    closedCollarComponentLayer word (listGetD fiber30 18 [])
      LColor.b LColor.p cert30_seen_18_22_2 = cert30_layer_18_22_2 := by
  decide

def cert30_seen_18_22_3 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F2F3 }, { occ := 1, edge := TauEdge.F2F4 }, { occ := 1, edge := TauEdge.B4 }, { occ := 1, edge := TauEdge.F4F5 }, { occ := 2, edge := TauEdge.F2F3 }, { occ := 1, edge := TauEdge.B6 }, { occ := 2, edge := TauEdge.F0F2 }]

def cert30_layer_18_22_3 : List ChainEdge :=
  [{ occ := 2, edge := TauEdge.F1F0 }]

theorem cert30_layer_18_22_3_eq :
    closedCollarComponentLayer word (listGetD fiber30 18 [])
      LColor.b LColor.p cert30_seen_18_22_3 = cert30_layer_18_22_3 := by
  decide

def cert30_seen_18_22_4 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F2F3 }, { occ := 1, edge := TauEdge.F2F4 }, { occ := 1, edge := TauEdge.B4 }, { occ := 1, edge := TauEdge.F4F5 }, { occ := 2, edge := TauEdge.F2F3 }, { occ := 1, edge := TauEdge.B6 }, { occ := 2, edge := TauEdge.F0F2 }, { occ := 2, edge := TauEdge.F1F0 }]

def cert30_layer_18_22_4 : List ChainEdge :=
  []

theorem cert30_layer_18_22_4_eq :
    closedCollarComponentLayer word (listGetD fiber30 18 [])
      LColor.b LColor.p cert30_seen_18_22_4 = cert30_layer_18_22_4 := by
  decide

theorem cert30_component_18_22_eq :
    closedCollarComponent word (listGetD fiber30 18 [])
      LColor.b LColor.p { occ := 1, edge := TauEdge.F2F3 } = cert30_component_18_22 := by
  unfold closedCollarComponent
  have hseedColor : chainEdgeInPair (listGetD fiber30 18 [])
      LColor.b LColor.p { occ := 1, edge := TauEdge.F2F3 } = true := by
    decide
  simp [hseedColor]
  change closeClosedCollarComponent word (listGetD fiber30 18 [])
      LColor.b LColor.p 27 cert30_seen_18_22_0 = cert30_component_18_22
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 18 []) LColor.b LColor.p
    cert30_seen_18_22_0 cert30_layer_18_22_0 26 cert30_layer_18_22_0_eq]
  change closeClosedCollarComponent word (listGetD fiber30 18 [])
      LColor.b LColor.p 26 cert30_seen_18_22_1 = cert30_component_18_22
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 18 []) LColor.b LColor.p
    cert30_seen_18_22_1 cert30_layer_18_22_1 25 cert30_layer_18_22_1_eq]
  change closeClosedCollarComponent word (listGetD fiber30 18 [])
      LColor.b LColor.p 25 cert30_seen_18_22_2 = cert30_component_18_22
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 18 []) LColor.b LColor.p
    cert30_seen_18_22_2 cert30_layer_18_22_2 24 cert30_layer_18_22_2_eq]
  change closeClosedCollarComponent word (listGetD fiber30 18 [])
      LColor.b LColor.p 24 cert30_seen_18_22_3 = cert30_component_18_22
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 18 []) LColor.b LColor.p
    cert30_seen_18_22_3 cert30_layer_18_22_3 23 cert30_layer_18_22_3_eq]
  change closeClosedCollarComponent word (listGetD fiber30 18 [])
      LColor.b LColor.p 23 cert30_seen_18_22_4 = cert30_component_18_22
  exact closeClosedCollarComponent_eq_self_of_layer_nil word
    (listGetD fiber30 18 []) LColor.b LColor.p
    cert30_seen_18_22_4 cert30_layer_18_22_4_eq 23

theorem cert30_step_18_22 :
    closedCollarIndexStepBool word fiber30 18 22 = true :=
  closedCollarIndexStepBool_of_component (move := cert30_move_18_22)
    (by decide) (by decide)
    (by simpa [cert30_move_18_22] using cert30_component_18_22_eq)
    (by decide) (by decide) (by decide)
...
theorem cert30_layer_18_42_0_eq :
    closedCollarComponentLayer word (listGetD fiber30 18 [])
      LColor.b LColor.p cert30_seen_18_42_0 = cert30_layer_18_42_0 := by
  decide
...
theorem cert30_layer_18_42_1_eq :
    closedCollarComponentLayer word (listGetD fiber30 18 [])
      LColor.b LColor.p cert30_seen_18_42_1 = cert30_layer_18_42_1 := by
  decide
...
theorem cert30_layer_18_42_2_eq :
    closedCollarComponentLayer word (listGetD fiber30 18 [])
      LColor.b LColor.p cert30_seen_18_42_2 = cert30_layer_18_42_2 := by
  decide

def cert30_seen_18_42_3 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F2F3 }, { occ := 0, edge := TauEdge.F2F4 }, { occ := 0, edge := TauEdge.B4 }, { occ := 0, edge := TauEdge.F4F5 }, { occ := 1, edge := TauEdge.F1F0 }, { occ := 0, edge := TauEdge.B5 }]

def cert30_layer_18_42_3 : List ChainEdge :=
  []

theorem cert30_layer_18_42_3_eq :
    closedCollarComponentLayer word (listGetD fiber30 18 [])
      LColor.b LColor.p cert30_seen_18_42_3 = cert30_layer_18_42_3 := by
  decide

theorem cert30_component_18_42_eq :
    closedCollarComponent word (listGetD fiber30 18 [])
      LColor.b LColor.p { occ := 0, edge := TauEdge.F2F3 } = cert30_component_18_42 := by
  unfold closedCollarComponent
  have hseedColor : chainEdgeInPair (listGetD fiber30 18 [])
      LColor.b LColor.p { occ := 0, edge := TauEdge.F2F3 } = true := by
    decide
  simp [hseedColor]
  change closeClosedCollarComponent word (listGetD fiber30 18 [])
      LColor.b LColor.p 27 cert30_seen_18_42_0 = cert30_component_18_42
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 18 []) LColor.b LColor.p
    cert30_seen_18_42_0 cert30_layer_18_42_0 26 cert30_layer_18_42_0_eq]
  change closeClosedCollarComponent word (listGetD fiber30 18 [])
      LColor.b LColor.p 26 cert30_seen_18_42_1 = cert30_component_18_42
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 18 []) LColor.b LColor.p
    cert30_seen_18_42_1 cert30_layer_18_42_1 25 cert30_layer_18_42_1_eq]
  change closeClosedCollarComponent word (listGetD fiber30 18 [])
      LColor.b LColor.p 25 cert30_seen_18_42_2 = cert30_component_18_42
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 18 []) LColor.b LColor.p
    cert30_seen_18_42_2 cert30_layer_18_42_2 24 cert30_layer_18_42_2_eq]
  change closeClosedCollarComponent word (listGetD fiber30 18 [])
      LColor.b LColor.p 24 cert30_seen_18_42_3 = cert30_component_18_42
  exact closeClosedCollarComponent_eq_self_of_layer_nil word
    (listGetD fiber30 18 []) LColor.b LColor.p
    cert30_seen_18_42_3 cert30_layer_18_42_3_eq 24
...
def cert30_seen_19_7_3 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F4F5 }, { occ := 0, edge := TauEdge.B6 }, { occ := 0, edge := TauEdge.B7 }, { occ := 1, edge := TauEdge.F1F0 }, { occ := 1, edge := TauEdge.F2F3 }, { occ := 1, edge := TauEdge.F0F2 }]

def cert30_layer_19_7_3 : List ChainEdge :=
  []

theorem cert30_layer_19_7_3_eq :
    closedCollarComponentLayer word (listGetD fiber30 19 [])
      LColor.r LColor.b cert30_seen_19_7_3 = cert30_layer_19_7_3 := by
  decide
...
theorem cert30_component_19_7_eq :
  ...
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 19 []) LColor.r LColor.b
    cert30_seen_19_7_2 cert30_layer_19_7_2 24 cert30_layer_19_7_2_eq]
  change closeClosedCollarComponent word (listGetD fiber30 19 [])
      LColor.r LColor.b 24 cert30_seen_19_7_3 = cert30_component_19_7
  exact closeClosedCollarComponent_eq_self_of_layer_nil word
    (listGetD fiber30 19 []) LColor.r LColor.b
    cert30_seen_19_7_3 cert30_layer_19_7_3_eq 24
...
theorem cert30_component_20_23_eq :
  ...
  exact closeClosedCollarComponent_eq_self_of_layer_nil word
    (listGetD fiber30 20 []) LColor.r LColor.p
    cert30_seen_20_23_2 cert30_layer_20_23_2_eq 25
...
def cert30_move_22_18 : ChainMove :=
  { a := LColor.b, c := LColor.p, seed := { occ := 1, edge := TauEdge.F2F3 } }

def cert30_component_22_18 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F2F3 }, { occ := 1, edge := TauEdge.F2F4 }, { occ := 1, edge := TauEdge.B4 }, { occ := 1, edge := TauEdge.F4F5 }, { occ := 2, edge := TauEdge.F2F3 }, { occ := 1, edge := TauEdge.B6 }, { occ := 2, edge := TauEdge.F0F2 }, { occ := 2, edge := TauEdge.F1F0 }]

def cert30_seen_22_18_0 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F2F3 }]

def cert30_layer_22_18_0 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F2F4 }, { occ := 1, edge := TauEdge.B4 }]

theorem cert30_layer_22_18_0_eq :
    closedCollarComponentLayer word (listGetD fiber30 22 [])
      LColor.b LColor.p cert30_seen_22_18_0 = cert30_layer_22_18_0 := by
  decide

def cert30_seen_22_18_1 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F2F3 }, { occ := 1, edge := TauEdge.F2F4 }, { occ := 1, edge := TauEdge.B4 }]

def cert30_layer_22_18_1 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F4F5 }, { occ := 2, edge := TauEdge.F2F3 }]

theorem cert30_layer_22_18_1_eq :
    closedCollarComponentLayer word (listGetD fiber30 22 [])
      LColor.b LColor.p cert30_seen_22_18_1 = cert30_layer_22_18_1 := by
  decide

def cert30_seen_22_18_2 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F2F3 }, { occ := 1, edge := TauEdge.F2F4 }, { occ := 1, edge := TauEdge.B4 }, { occ := 1, edge := TauEdge.F4F5 }, { occ := 2, edge := TauEdge.F2F3 }]

def cert30_layer_22_18_2 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.B6 }, { occ := 2, edge := TauEdge.F0F2 }]

theorem cert30_layer_22_18_2_eq :
    closedCollarComponentLayer word (listGetD fiber30 22 [])
      LColor.b LColor.p cert30_seen_22_18_2 = cert30_layer_22_18_2 := by
  decide

def cert30_seen_22_18_3 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F2F3 }, { occ := 1, edge := TauEdge.F2F4 }, { occ := 1, edge := TauEdge.B4 }, { occ := 1, edge := TauEdge.F4F5 }, { occ := 2, edge := TauEdge.F2F3 }, { occ := 1, edge := TauEdge.B6 }, { occ := 2, edge := TauEdge.F0F2 }]

def cert30_layer_22_18_3 : List ChainEdge :=
  [{ occ := 2, edge := TauEdge.F1F0 }]

theorem cert30_layer_22_18_3_eq :
    closedCollarComponentLayer word (listGetD fiber30 22 [])
      LColor.b LColor.p cert30_seen_22_18_3 = cert30_layer_22_18_3 := by
  decide

def cert30_seen_22_18_4 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F2F3 }, { occ := 1, edge := TauEdge.F2F4 }, { occ := 1, edge := TauEdge.B4 }, { occ := 1, edge := TauEdge.F4F5 }, { occ := 2, edge := TauEdge.F2F3 }, { occ := 1, edge := TauEdge.B6 }, { occ := 2, edge := TauEdge.F0F2 }, { occ := 2, edge := TauEdge.F1F0 }]

def cert30_layer_22_18_4 : List ChainEdge :=
  []

theorem cert30_layer_22_18_4_eq :
    closedCollarComponentLayer word (listGetD fiber30 22 [])
      LColor.b LColor.p cert30_seen_22_18_4 = cert30_layer_22_18_4 := by
  decide

theorem cert30_component_22_18_eq :
    closedCollarComponent word (listGetD fiber30 22 [])
      LColor.b LColor.p { occ := 1, edge := TauEdge.F2F3 } = cert30_component_22_18 := by
  unfold closedCollarComponent
  ...
  change closeClosedCollarComponent word (listGetD fiber30 22 [])
      LColor.b LColor.p 27 cert30_seen_22_18_0 = cert30_component_22_18
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 22 []) LColor.b LColor.p
    cert30_seen_22_18_0 cert30_layer_22_18_0 26 cert30_layer_22_18_0_eq]
  change closeClosedCollarComponent word (listGetD fiber30 22 [])
      LColor.b LColor.p 26 cert30_seen_22_18_1 = cert30_component_22_18
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 22 []) LColor.b LColor.p
    cert30_seen_22_18_1 cert30_layer_22_18_1 25 cert30_layer_22_18_1_eq]
  change closeClosedCollarComponent word (listGetD fiber30 22 [])
      LColor.b LColor.p 25 cert30_seen_22_18_2 = cert30_component_22_18
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 22 []) LColor.b LColor.p
    cert30_seen_22_18_2 cert30_layer_22_18_2 24 cert30_layer_22_18_2_eq]
  change closeClosedCollarComponent word (listGetD fiber30 22 [])
      LColor.b LColor.p 24 cert30_seen_22_18_3 = cert30_component_22_18
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 22 []) LColor.b LColor.p
    cert30_seen_22_18_3 cert30_layer_22_18_3 23 cert30_layer_22_18_3_eq]
  change closeClosedCollarComponent word (listGetD fiber30 22 [])
      LColor.b LColor.p 23 cert30_seen_22_18_4 = cert30_component_22_18
  exact closeClosedCollarComponent_eq_self_of_layer_nil word
    (listGetD fiber30 22 []) LColor.b LColor.p
    cert30_seen_22_18_4 cert30_layer_22_18_4_eq 23

theorem cert30_step_22_18 :
    closedCollarIndexStepBool word fiber30 22 18 = true :=
  closedCollarIndexStepBool_of_component (move := cert30_move_22_18)
    (by decide) (by decide)
    (by simpa [cert30_move_22_18] using cert30_component_22_18_eq)
    (by decide) (by decide) (by decide)
...
theorem cert30_component_23_20_eq :
  ...
  exact closeClosedCollarComponent_eq_self_of_layer_nil word
    (listGetD fiber30 23 []) LColor.r LColor.p
    cert30_seen_23_20_2 cert30_layer_23_20_2_eq 25
...
def cert30_move_24_27 : ChainMove :=
  { a := LColor.r, c := LColor.p, seed := { occ := 1, edge := TauEdge.F4F5 } }

def cert30_component_24_27 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F4F5 }, { occ := 1, edge := TauEdge.B6 }, { occ := 1, edge := TauEdge.B7 }, { occ := 2, edge := TauEdge.F1F0 }]

def cert30_seen_24_27_0 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F4F5 }]

def cert30_layer_24_27_0 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.B6 }, { occ := 1, edge := TauEdge.B7 }]

theorem cert30_layer_24_27_0_eq :
    closedCollarComponentLayer word (listGetD fiber30 24 [])
      LColor.r LColor.p cert30_seen_24_27_0 = cert30_layer_24_27_0 := by
  decide

def cert30_seen_24_27_1 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F4F5 }, { occ := 1, edge := TauEdge.B6 }, { occ := 1, edge := TauEdge.B7 }]

def cert30_layer_24_27_1 : List ChainEdge :=
  [{ occ := 2, edge := TauEdge.F1F0 }]

theorem cert30_layer_24_27_1_eq :
    closedCollarComponentLayer word (listGetD fiber30 24 [])
      LColor.r LColor.p cert30_seen_24_27_1 = cert30_layer_24_27_1 := by
  decide

def cert30_seen_24_27_2 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F4F5 }, { occ := 1, edge := TauEdge.B6 }, { occ := 1, edge := TauEdge.B7 }, { occ := 2, edge := TauEdge.F1F0 }]

def cert30_layer_24_27_2 : List ChainEdge :=
  []

theorem cert30_layer_24_27_2_eq :
    closedCollarComponentLayer word (listGetD fiber30 24 [])
      LColor.r LColor.p cert30_seen_24_27_2 = cert30_layer_24_27_2 := by
  decide

theorem cert30_component_24_27_eq :
    closedCollarComponent word (listGetD fiber30 24 [])
      LColor.r LColor.p { occ := 1, edge := TauEdge.F4F5 } = cert30_component_24_27 := by
  unfold closedCollarComponent
  have hseedColor : chainEdgeInPair (listGetD fiber30 24 [])
      LColor.r LColor.p { occ := 1, edge := TauEdge.F4F5 } = true := by
    decide
  simp [hseedColor]
  change closeClosedCollarComponent word (listGetD fiber30 24 [])
      LColor.r LColor.p 27 cert30_seen_24_27_0 = cert30_component_24_27
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 24 []) LColor.r LColor.p
    cert30_seen_24_27_0 cert30_layer_24_27_0 26 cert30_layer_24_27_0_eq]
  change closeClosedCollarComponent word (listGetD fiber30 24 [])
      LColor.r LColor.p 26 cert30_seen_24_27_1 = cert30_component_24_27
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 24 []) LColor.r LColor.p
    cert30_seen_24_27_1 cert30_layer_24_27_1 25 cert30_layer_24_27_1_eq]
  change closeClosedCollarComponent word (listGetD fiber30 24 [])
      LColor.r LColor.p 25 cert30_seen_24_27_2 = cert30_component_24_27
  exact closeClosedCollarComponent_eq_self_of_layer_nil word
    (listGetD fiber30 24 []) LColor.r LColor.p
    cert30_seen_24_27_2 cert30_layer_24_27_2_eq 25

theorem cert30_step_24_27 :
    closedCollarIndexStepBool word fiber30 24 27 = true :=
  closedCollarIndexStepBool_of_component (move := cert30_move_24_27)
    (by decide) (by decide)
    (by simpa [cert30_move_24_27] using cert30_component_24_27_eq)
    (by decide) (by decide) (by decide)

def cert30_move_24_44 : ChainMove :=
  { a := LColor.r, c := LColor.p, seed := { occ := 0, edge := TauEdge.F4F5 } }

def cert30_component_24_44 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F4F5 }, { occ := 0, edge := TauEdge.B6 }, { occ := 0, edge := TauEdge.B7 }, { occ := 1, edge := TauEdge.F1F0 }, { occ := 1, edge := TauEdge.F2F3 }, { occ := 1, edge := TauEdge.F0F2 }]

def cert30_seen_24_44_0 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F4F5 }]

def cert30_layer_24_44_0 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.B6 }, { occ := 0, edge := TauEdge.B7 }]

theorem cert30_layer_24_44_0_eq :
    closedCollarComponentLayer word (listGetD fiber30 24 [])
      LColor.r LColor.p cert30_seen_24_44_0 = cert30_layer_24_44_0 := by
  decide

def cert30_seen_24_44_1 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F4F5 }, { occ := 0, edge := TauEdge.B6 }, { occ := 0, edge := TauEdge.B7 }]

def cert30_layer_24_44_1 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F1F0 }, { occ := 1, edge := TauEdge.F2F3 }]

theorem cert30_layer_24_44_1_eq :
    closedCollarComponentLayer word (listGetD fiber30 24 [])
      LColor.r LColor.p cert30_seen_24_44_1 = cert30_layer_24_44_1 := by
  decide

def cert30_seen_24_44_2 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F4F5 }, { occ := 0, edge := TauEdge.B6 }, { occ := 0, edge := TauEdge.B7 }, { occ := 1, edge := TauEdge.F1F0 }, { occ := 1, edge := TauEdge.F2F3 }]

def cert30_layer_24_44_2 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F0F2 }]

theorem cert30_layer_24_44_2_eq :
    closedCollarComponentLayer word (listGetD fiber30 24 [])
      LColor.r LColor.p cert30_seen_24_44_2 = cert30_layer_24_44_2 := by
  decide

def cert30_seen_24_44_3 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F4F5 }, { occ := 0, edge := TauEdge.B6 }, { occ := 0, edge := TauEdge.B7 }, { occ := 1, edge := TauEdge.F1F0 }, { occ := 1, edge := TauEdge.F2F3 }, { occ := 1, edge := TauEdge.F0F2 }]

def cert30_layer_24_44_3 : List ChainEdge :=
  []

theorem cert30_layer_24_44_3_eq :
    closedCollarComponentLayer word (listGetD fiber30 24 [])
      LColor.r LColor.p cert30_seen_24_44_3 = cert30_layer_24_44_3 := by
  decide

theorem cert30_component_24_44_eq :
    closedCollarComponent word (listGetD fiber30 24 [])
      LColor.r LColor.p { occ := 0, edge := TauEdge.F4F5 } = cert30_component_24_44 := by
  unfold closedCollarComponent
  have hseedColor : chainEdgeInPair (listGetD fiber30 24 [])
  ...
  simp [hseedColor]
  change closeClosedCollarComponent word (listGetD fiber30 24 [])
      LColor.r LColor.p 27 cert30_seen_24_44_0 = cert30_component_24_44
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 24 []) LColor.r LColor.p
    cert30_seen_24_44_0 cert30_layer_24_44_0 26 cert30_layer_24_44_0_eq]
  change closeClosedCollarComponent word (listGetD fiber30 24 [])
      LColor.r LColor.p 26 cert30_seen_24_44_1 = cert30_component_24_44
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 24 []) LColor.r LColor.p
    cert30_seen_24_44_1 cert30_layer_24_44_1 25 cert30_layer_24_44_1_eq]
  change closeClosedCollarComponent word (listGetD fiber30 24 [])
      LColor.r LColor.p 25 cert30_seen_24_44_2 = cert30_component_24_44
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 24 []) LColor.r LColor.p
    cert30_seen_24_44_2 cert30_layer_24_44_2 24 cert30_layer_24_44_2_eq]
  change closeClosedCollarComponent word (listGetD fiber30 24 [])
      LColor.r LColor.p 24 cert30_seen_24_44_3 = cert30_component_24_44
  exact closeClosedCollarComponent_eq_self_of_layer_nil word
    (listGetD fiber30 24 []) LColor.r LColor.p
    cert30_seen_24_44_3 cert30_layer_24_44_3_eq 24

theorem cert30_step_24_44 :
    closedCollarIndexStepBool word fiber30 24 44 = true :=
  closedCollarIndexStepBool_of_component (move := cert30_move_24_44)
    (by decide) (by decide)
    (by simpa [cert30_move_24_44] using cert30_component_24_44_eq)
    (by decide) (by decide) (by decide)
...
def cert30_move_25_45 : ChainMove :=
  { a := LColor.r, c := LColor.p, seed := { occ := 0, edge := TauEdge.F4F5 } }

def cert30_component_25_45 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F4F5 }, { occ := 0, edge := TauEdge.B6 }, { occ := 0, edge := TauEdge.B7 }, { occ := 1, edge := TauEdge.F1F0 }, { occ := 1, edge := TauEdge.F2F3 }, { occ := 1, edge := TauEdge.F0F2 }]

def cert30_seen_25_45_0 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F4F5 }]

def cert30_layer_25_45_0 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.B6 }, { occ := 0, edge := TauEdge.B7 }]

theorem cert30_layer_25_45_0_eq :
    closedCollarComponentLayer word (listGetD fiber30 25 [])
      LColor.r LColor.p cert30_seen_25_45_0 = cert30_layer_25_45_0 := by
  decide

def cert30_seen_25_45_1 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F4F5 }, { occ := 0, edge := TauEdge.B6 }, { occ := 0, edge := TauEdge.B7 }]

def cert30_layer_25_45_1 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F1F0 }, { occ := 1, edge := TauEdge.F2F3 }]

theorem cert30_layer_25_45_1_eq :
    closedCollarComponentLayer word (listGetD fiber30 25 [])
      LColor.r LColor.p cert30_seen_25_45_1 = cert30_layer_25_45_1 := by
  decide

def cert30_seen_25_45_2 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F4F5 }, { occ := 0, edge := TauEdge.B6 }, { occ := 0, edge := TauEdge.B7 }, { occ := 1, edge := TauEdge.F1F0 }, { occ := 1, edge := TauEdge.F2F3 }]

def cert30_layer_25_45_2 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F0F2 }]

theorem cert30_layer_25_45_2_eq :
    closedCollarComponentLayer word (listGetD fiber30 25 [])
      LColor.r LColor.p cert30_seen_25_45_2 = cert30_layer_25_45_2 := by
  decide

def cert30_seen_25_45_3 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F4F5 }, { occ := 0, edge := TauEdge.B6 }, { occ := 0, edge := TauEdge.B7 }, { occ := 1, edge := TauEdge.F1F0 }, { occ := 1, edge := TauEdge.F2F3 }, { occ := 1, edge := TauEdge.F0F2 }]

def cert30_layer_25_45_3 : List ChainEdge :=
  []

theorem cert30_layer_25_45_3_eq :
    closedCollarComponentLayer word (listGetD fiber30 25 [])
      LColor.r LColor.p cert30_seen_25_45_3 = cert30_layer_25_45_3 := by
  decide

theorem cert30_component_25_45_eq :
    closedCollarComponent word (listGetD fiber30 25 [])
      LColor.r LColor.p { occ := 0, edge := TauEdge.F4F5 } = cert30_component_25_45 := by
  unfold closedCollarComponent
  have hseedColor : chainEdgeInPair (listGetD fiber30 25 [])
      LColor.r LColor.p { occ := 0, edge := TauEdge.F4F5 } = true := by
    decide
  simp [hseedColor]
  change closeClosedCollarComponent word (listGetD fiber30 25 [])
      LColor.r LColor.p 27 cert30_seen_25_45_0 = cert30_component_25_45
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 25 []) LColor.r LColor.p
    cert30_seen_25_45_0 cert30_layer_25_45_0 26 cert30_layer_25_45_0_eq]
  change closeClosedCollarComponent word (listGetD fiber30 25 [])
      LColor.r LColor.p 26 cert30_seen_25_45_1 = cert30_component_25_45
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 25 []) LColor.r LColor.p
    cert30_seen_25_45_1 cert30_layer_25_45_1 25 cert30_layer_25_45_1_eq]
  change closeClosedCollarComponent word (listGetD fiber30 25 [])
      LColor.r LColor.p 25 cert30_seen_25_45_2 = cert30_component_25_45
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 25 []) LColor.r LColor.p
    cert30_seen_25_45_2 cert30_layer_25_45_2 24 cert30_layer_25_45_2_eq]
  change closeClosedCollarComponent word (listGetD fiber30 25 [])
      LColor.r LColor.p 24 cert30_seen_25_45_3 = cert30_component_25_45
  exact closeClosedCollarComponent_eq_self_of_layer_nil word
    (listGetD fiber30 25 []) LColor.r LColor.p
    cert30_seen_25_45_3 cert30_layer_25_45_3_eq 24

theorem cert30_step_25_45 :
    closedCollarIndexStepBool word fiber30 25 45 = true :=
  closedCollarIndexStepBool_of_component (move := cert30_move_25_45)
    (by decide) (by decide)
    (by simpa [cert30_move_25_45] using cert30_component_25_45_eq)
    (by decide) (by decide) (by decide)
...
def cert30_seen_26_2_4 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F2F3 }, { occ := 0, edge := TauEdge.F2F4 }, { occ := 0, edge := TauEdge.B4 }, { occ := 0, edge := TauEdge.B7 }, { occ := 1, edge := TauEdge.F0F2 }, { occ := 1, edge := TauEdge.F2F4 }, { occ := 1, edge := TauEdge.B4 }, { occ := 1, edge := TauEdge.F4F5 }, { occ := 2, edge := TauEdge.F2F3 }]

def cert30_layer_26_2_4 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.B6 }, { occ := 2, edge := TauEdge.F0F2 }]

theorem cert30_layer_26_2_4_eq :
    closedCollarComponentLayer word (listGetD fiber30 26 [])
      LColor.b LColor.p cert30_seen_26_2_4 = cert30_layer_26_2_4 := by
  decide

def cert30_seen_26_2_5 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F2F3 }, { occ := 0, edge := TauEdge.F2F4 }, { occ := 0, edge := TauEdge.B4 }, { occ := 0, edge := TauEdge.B7 }, { occ := 1, edge := TauEdge.F0F2 }, { occ := 1, edge := TauEdge.F2F4 }, { occ := 1, edge := TauEdge.B4 }, { occ := 1, edge := TauEdge.F4F5 }, { occ := 2, edge := TauEdge.F2F3 }, { occ := 1, edge := TauEdge.B6 }, { occ := 2, edge := TauEdge.F0F2 }]

def cert30_layer_26_2_5 : List ChainEdge :=
  [{ occ := 2, edge := TauEdge.F1F0 }]

theorem cert30_layer_26_2_5_eq :
    closedCollarComponentLayer word (listGetD fiber30 26 [])
      LColor.b LColor.p cert30_seen_26_2_5 = cert30_layer_26_2_5 := by
  decide

def cert30_seen_26_2_6 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F2F3 }, { occ := 0, edge := TauEdge.F2F4 }, { occ := 0, edge := TauEdge.B4 }, { occ := 0, edge := TauEdge.B7 }, { occ := 1, edge := TauEdge.F0F2 }, { occ := 1, edge := TauEdge.F2F4 }, { occ := 1, edge := TauEdge.B4 }, { occ := 1, edge := TauEdge.F4F5 }, { occ := 2, edge := TauEdge.F2F3 }, { occ := 1, edge := TauEdge.B6 }, { occ := 2, edge := TauEdge.F0F2 }, { occ := 2, edge := TauEdge.F1F0 }]

def cert30_layer_26_2_6 : List ChainEdge :=
  []

theorem cert30_layer_26_2_6_eq :
    closedCollarComponentLayer word (listGetD fiber30 26 [])
      LColor.b LColor.p cert30_seen_26_2_6 = cert30_layer_26_2_6 := by
  decide
...
theorem cert30_component_26_2_eq :
  ...
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 26 []) LColor.b LColor.p
    cert30_seen_26_2_3 cert30_layer_26_2_3 23 cert30_layer_26_2_3_eq]
  change closeClosedCollarComponent word (listGetD fiber30 26 [])
      LColor.b LColor.p 23 cert30_seen_26_2_4 = cert30_component_26_2
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 26 []) LColor.b LColor.p
    cert30_seen_26_2_4 cert30_layer_26_2_4 22 cert30_layer_26_2_4_eq]
  change closeClosedCollarComponent word (listGetD fiber30 26 [])
      LColor.b LColor.p 22 cert30_seen_26_2_5 = cert30_component_26_2
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 26 []) LColor.b LColor.p
    cert30_seen_26_2_5 cert30_layer_26_2_5 21 cert30_layer_26_2_5_eq]
  change closeClosedCollarComponent word (listGetD fiber30 26 [])
      LColor.b LColor.p 21 cert30_seen_26_2_6 = cert30_component_26_2
  exact closeClosedCollarComponent_eq_self_of_layer_nil word
    (listGetD fiber30 26 []) LColor.b LColor.p
    cert30_seen_26_2_6 cert30_layer_26_2_6_eq 21
...
def cert30_move_26_46 : ChainMove :=
  { a := LColor.r, c := LColor.p, seed := { occ := 0, edge := TauEdge.F4F5 } }

def cert30_component_26_46 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F4F5 }, { occ := 0, edge := TauEdge.B6 }, { occ := 0, edge := TauEdge.B7 }, { occ := 1, edge := TauEdge.F1F0 }, { occ := 1, edge := TauEdge.F2F3 }, { occ := 1, edge := TauEdge.F0F2 }]

def cert30_seen_26_46_0 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F4F5 }]

def cert30_layer_26_46_0 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.B6 }, { occ := 0, edge := TauEdge.B7 }]

theorem cert30_layer_26_46_0_eq :
    closedCollarComponentLayer word (listGetD fiber30 26 [])
      LColor.r LColor.p cert30_seen_26_46_0 = cert30_layer_26_46_0 := by
  decide

def cert30_seen_26_46_1 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F4F5 }, { occ := 0, edge := TauEdge.B6 }, { occ := 0, edge := TauEdge.B7 }]

def cert30_layer_26_46_1 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F1F0 }, { occ := 1, edge := TauEdge.F2F3 }]

theorem cert30_layer_26_46_1_eq :
    closedCollarComponentLayer word (listGetD fiber30 26 [])
      LColor.r LColor.p cert30_seen_26_46_1 = cert30_layer_26_46_1 := by
  decide

def cert30_seen_26_46_2 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F4F5 }, { occ := 0, edge := TauEdge.B6 }, { occ := 0, edge := TauEdge.B7 }, { occ := 1, edge := TauEdge.F1F0 }, { occ := 1, edge := TauEdge.F2F3 }]

def cert30_layer_26_46_2 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F0F2 }]

theorem cert30_layer_26_46_2_eq :
    closedCollarComponentLayer word (listGetD fiber30 26 [])
      LColor.r LColor.p cert30_seen_26_46_2 = cert30_layer_26_46_2 := by
  decide

def cert30_seen_26_46_3 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F4F5 }, { occ := 0, edge := TauEdge.B6 }, { occ := 0, edge := TauEdge.B7 }, { occ := 1, edge := TauEdge.F1F0 }, { occ := 1, edge := TauEdge.F2F3 }, { occ := 1, edge := TauEdge.F0F2 }]

def cert30_layer_26_46_3 : List ChainEdge :=
  []

theorem cert30_layer_26_46_3_eq :
    closedCollarComponentLayer word (listGetD fiber30 26 [])
      LColor.r LColor.p cert30_seen_26_46_3 = cert30_layer_26_46_3 := by
  decide

theorem cert30_component_26_46_eq :
    closedCollarComponent word (listGetD fiber30 26 [])
      LColor.r LColor.p { occ := 0, edge := TauEdge.F4F5 } = cert30_component_26_46 := by
  unfold closedCollarComponent
  have hseedColor : chainEdgeInPair (listGetD fiber30 26 [])
      LColor.r LColor.p { occ := 0, edge := TauEdge.F4F5 } = true := by
    decide
  simp [hseedColor]
  change closeClosedCollarComponent word (listGetD fiber30 26 [])
      LColor.r LColor.p 27 cert30_seen_26_46_0 = cert30_component_26_46
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 26 []) LColor.r LColor.p
    cert30_seen_26_46_0 cert30_layer_26_46_0 26 cert30_layer_26_46_0_eq]
  change closeClosedCollarComponent word (listGetD fiber30 26 [])
      LColor.r LColor.p 26 cert30_seen_26_46_1 = cert30_component_26_46
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 26 []) LColor.r LColor.p
    cert30_seen_26_46_1 cert30_layer_26_46_1 25 cert30_layer_26_46_1_eq]
  change closeClosedCollarComponent word (listGetD fiber30 26 [])
      LColor.r LColor.p 25 cert30_seen_26_46_2 = cert30_component_26_46
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 26 []) LColor.r LColor.p
    cert30_seen_26_46_2 cert30_layer_26_46_2 24 cert30_layer_26_46_2_eq]
  change closeClosedCollarComponent word (listGetD fiber30 26 [])
      LColor.r LColor.p 24 cert30_seen_26_46_3 = cert30_component_26_46
  exact closeClosedCollarComponent_eq_self_of_layer_nil word
    (listGetD fiber30 26 []) LColor.r LColor.p
    cert30_seen_26_46_3 cert30_layer_26_46_3_eq 24

theorem cert30_step_26_46 :
    closedCollarIndexStepBool word fiber30 26 46 = true :=
  closedCollarIndexStepBool_of_component (move := cert30_move_26_46)
    (by decide) (by decide)
    (by simpa [cert30_move_26_46] using cert30_component_26_46_eq)
    (by decide) (by decide) (by decide)

def cert30_move_27_24 : ChainMove :=
  { a := LColor.r, c := LColor.p, seed := { occ := 1, edge := TauEdge.F4F5 } }

def cert30_component_27_24 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F4F5 }, { occ := 1, edge := TauEdge.B6 }, { occ := 1, edge := TauEdge.B7 }, { occ := 2, edge := TauEdge.F1F0 }]

def cert30_seen_27_24_0 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F4F5 }]

def cert30_layer_27_24_0 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.B6 }, { occ := 1, edge := TauEdge.B7 }]

theorem cert30_layer_27_24_0_eq :
    closedCollarComponentLayer word (listGetD fiber30 27 [])
      LColor.r LColor.p cert30_seen_27_24_0 = cert30_layer_27_24_0 := by
  decide

def cert30_seen_27_24_1 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F4F5 }, { occ := 1, edge := TauEdge.B6 }, { occ := 1, edge := TauEdge.B7 }]

def cert30_layer_27_24_1 : List ChainEdge :=
  [{ occ := 2, edge := TauEdge.F1F0 }]

theorem cert30_layer_27_24_1_eq :
    closedCollarComponentLayer word (listGetD fiber30 27 [])
      LColor.r LColor.p cert30_seen_27_24_1 = cert30_layer_27_24_1 := by
  decide

def cert30_seen_27_24_2 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F4F5 }, { occ := 1, edge := TauEdge.B6 }, { occ := 1, edge := TauEdge.B7 }, { occ := 2, edge := TauEdge.F1F0 }]

def cert30_layer_27_24_2 : List ChainEdge :=
  []

theorem cert30_layer_27_24_2_eq :
    closedCollarComponentLayer word (listGetD fiber30 27 [])
      LColor.r LColor.p cert30_seen_27_24_2 = cert30_layer_27_24_2 := by
  decide

theorem cert30_component_27_24_eq :
    closedCollarComponent word (listGetD fiber30 27 [])
      LColor.r LColor.p { occ := 1, edge := TauEdge.F4F5 } = cert30_component_27_24 := by
  unfold closedCollarComponent
  ...
  change closeClosedCollarComponent word (listGetD fiber30 27 [])
      LColor.r LColor.p 27 cert30_seen_27_24_0 = cert30_component_27_24
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 27 []) LColor.r LColor.p
    cert30_seen_27_24_0 cert30_layer_27_24_0 26 cert30_layer_27_24_0_eq]
  change closeClosedCollarComponent word (listGetD fiber30 27 [])
      LColor.r LColor.p 26 cert30_seen_27_24_1 = cert30_component_27_24
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 27 []) LColor.r LColor.p
    cert30_seen_27_24_1 cert30_layer_27_24_1 25 cert30_layer_27_24_1_eq]
  change closeClosedCollarComponent word (listGetD fiber30 27 [])
      LColor.r LColor.p 25 cert30_seen_27_24_2 = cert30_component_27_24
  exact closeClosedCollarComponent_eq_self_of_layer_nil word
    (listGetD fiber30 27 []) LColor.r LColor.p
    cert30_seen_27_24_2 cert30_layer_27_24_2_eq 25

theorem cert30_step_27_24 :
    closedCollarIndexStepBool word fiber30 27 24 = true :=
  closedCollarIndexStepBool_of_component (move := cert30_move_27_24)
    (by decide) (by decide)
    (by simpa [cert30_move_27_24] using cert30_component_27_24_eq)
    (by decide) (by decide) (by decide)

def cert30_move_27_47 : ChainMove :=
  { a := LColor.r, c := LColor.p, seed := { occ := 0, edge := TauEdge.F4F5 } }

def cert30_component_27_47 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F4F5 }, { occ := 0, edge := TauEdge.B6 }, { occ := 0, edge := TauEdge.B7 }, { occ := 1, edge := TauEdge.F1F0 }, { occ := 1, edge := TauEdge.F2F3 }, { occ := 1, edge := TauEdge.F0F2 }]

def cert30_seen_27_47_0 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F4F5 }]

def cert30_layer_27_47_0 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.B6 }, { occ := 0, edge := TauEdge.B7 }]

theorem cert30_layer_27_47_0_eq :
    closedCollarComponentLayer word (listGetD fiber30 27 [])
      LColor.r LColor.p cert30_seen_27_47_0 = cert30_layer_27_47_0 := by
  decide

def cert30_seen_27_47_1 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F4F5 }, { occ := 0, edge := TauEdge.B6 }, { occ := 0, edge := TauEdge.B7 }]

def cert30_layer_27_47_1 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F1F0 }, { occ := 1, edge := TauEdge.F2F3 }]

theorem cert30_layer_27_47_1_eq :
    closedCollarComponentLayer word (listGetD fiber30 27 [])
      LColor.r LColor.p cert30_seen_27_47_1 = cert30_layer_27_47_1 := by
  decide

def cert30_seen_27_47_2 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F4F5 }, { occ := 0, edge := TauEdge.B6 }, { occ := 0, edge := TauEdge.B7 }, { occ := 1, edge := TauEdge.F1F0 }, { occ := 1, edge := TauEdge.F2F3 }]

def cert30_layer_27_47_2 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F0F2 }]

theorem cert30_layer_27_47_2_eq :
    closedCollarComponentLayer word (listGetD fiber30 27 [])
      LColor.r LColor.p cert30_seen_27_47_2 = cert30_layer_27_47_2 := by
  decide

def cert30_seen_27_47_3 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F4F5 }, { occ := 0, edge := TauEdge.B6 }, { occ := 0, edge := TauEdge.B7 }, { occ := 1, edge := TauEdge.F1F0 }, { occ := 1, edge := TauEdge.F2F3 }, { occ := 1, edge := TauEdge.F0F2 }]

def cert30_layer_27_47_3 : List ChainEdge :=
  []

theorem cert30_layer_27_47_3_eq :
    closedCollarComponentLayer word (listGetD fiber30 27 [])
      LColor.r LColor.p cert30_seen_27_47_3 = cert30_layer_27_47_3 := by
  decide

theorem cert30_component_27_47_eq :
    closedCollarComponent word (listGetD fiber30 27 [])
      LColor.r LColor.p { occ := 0, edge := TauEdge.F4F5 } = cert30_component_27_47 := by
  unfold closedCollarComponent
  have hseedColor : chainEdgeInPair (listGetD fiber30 27 [])
      LColor.r LColor.p { occ := 0, edge := TauEdge.F4F5 } = true := by
    decide
  simp [hseedColor]
  change closeClosedCollarComponent word (listGetD fiber30 27 [])
      LColor.r LColor.p 27 cert30_seen_27_47_0 = cert30_component_27_47
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 27 []) LColor.r LColor.p
    cert30_seen_27_47_0 cert30_layer_27_47_0 26 cert30_layer_27_47_0_eq]
  change closeClosedCollarComponent word (listGetD fiber30 27 [])
      LColor.r LColor.p 26 cert30_seen_27_47_1 = cert30_component_27_47
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 27 []) LColor.r LColor.p
    cert30_seen_27_47_1 cert30_layer_27_47_1 25 cert30_layer_27_47_1_eq]
  change closeClosedCollarComponent word (listGetD fiber30 27 [])
      LColor.r LColor.p 25 cert30_seen_27_47_2 = cert30_component_27_47
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 27 []) LColor.r LColor.p
    cert30_seen_27_47_2 cert30_layer_27_47_2 24 cert30_layer_27_47_2_eq]
  change closeClosedCollarComponent word (listGetD fiber30 27 [])
      LColor.r LColor.p 24 cert30_seen_27_47_3 = cert30_component_27_47
  exact closeClosedCollarComponent_eq_self_of_layer_nil word
    (listGetD fiber30 27 []) LColor.r LColor.p
    cert30_seen_27_47_3 cert30_layer_27_47_3_eq 24

theorem cert30_step_27_47 :
    closedCollarIndexStepBool word fiber30 27 47 = true :=
  closedCollarIndexStepBool_of_component (move := cert30_move_27_47)
    (by decide) (by decide)
    (by simpa [cert30_move_27_47] using cert30_component_27_47_eq)
    (by decide) (by decide) (by decide)
...
def cert30_move_28_31 : ChainMove :=
  { a := LColor.r, c := LColor.p, seed := { occ := 1, edge := TauEdge.F4F5 } }

def cert30_component_28_31 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F4F5 }, { occ := 1, edge := TauEdge.B6 }, { occ := 1, edge := TauEdge.B7 }, { occ := 2, edge := TauEdge.F1F0 }]

def cert30_seen_28_31_0 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F4F5 }]

def cert30_layer_28_31_0 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.B6 }, { occ := 1, edge := TauEdge.B7 }]

theorem cert30_layer_28_31_0_eq :
    closedCollarComponentLayer word (listGetD fiber30 28 [])
      LColor.r LColor.p cert30_seen_28_31_0 = cert30_layer_28_31_0 := by
  decide

def cert30_seen_28_31_1 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F4F5 }, { occ := 1, edge := TauEdge.B6 }, { occ := 1, edge := TauEdge.B7 }]

def cert30_layer_28_31_1 : List ChainEdge :=
  [{ occ := 2, edge := TauEdge.F1F0 }]

theorem cert30_layer_28_31_1_eq :
    closedCollarComponentLayer word (listGetD fiber30 28 [])
      LColor.r LColor.p cert30_seen_28_31_1 = cert30_layer_28_31_1 := by
  decide

def cert30_seen_28_31_2 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F4F5 }, { occ := 1, edge := TauEdge.B6 }, { occ := 1, edge := TauEdge.B7 }, { occ := 2, edge := TauEdge.F1F0 }]

def cert30_layer_28_31_2 : List ChainEdge :=
  []

theorem cert30_layer_28_31_2_eq :
    closedCollarComponentLayer word (listGetD fiber30 28 [])
      LColor.r LColor.p cert30_seen_28_31_2 = cert30_layer_28_31_2 := by
  decide

theorem cert30_component_28_31_eq :
    closedCollarComponent word (listGetD fiber30 28 [])
      LColor.r LColor.p { occ := 1, edge := TauEdge.F4F5 } = cert30_component_28_31 := by
  unfold closedCollarComponent
  have hseedColor : chainEdgeInPair (listGetD fiber30 28 [])
      LColor.r LColor.p { occ := 1, edge := TauEdge.F4F5 } = true := by
    decide
  simp [hseedColor]
  change closeClosedCollarComponent word (listGetD fiber30 28 [])
      LColor.r LColor.p 27 cert30_seen_28_31_0 = cert30_component_28_31
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 28 []) LColor.r LColor.p
    cert30_seen_28_31_0 cert30_layer_28_31_0 26 cert30_layer_28_31_0_eq]
  change closeClosedCollarComponent word (listGetD fiber30 28 [])
      LColor.r LColor.p 26 cert30_seen_28_31_1 = cert30_component_28_31
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 28 []) LColor.r LColor.p
    cert30_seen_28_31_1 cert30_layer_28_31_1 25 cert30_layer_28_31_1_eq]
  change closeClosedCollarComponent word (listGetD fiber30 28 [])
      LColor.r LColor.p 25 cert30_seen_28_31_2 = cert30_component_28_31
  exact closeClosedCollarComponent_eq_self_of_layer_nil word
    (listGetD fiber30 28 []) LColor.r LColor.p
    cert30_seen_28_31_2 cert30_layer_28_31_2_eq 25

theorem cert30_step_28_31 :
    closedCollarIndexStepBool word fiber30 28 31 = true :=
  closedCollarIndexStepBool_of_component (move := cert30_move_28_31)
    (by decide) (by decide)
    (by simpa [cert30_move_28_31] using cert30_component_28_31_eq)
    (by decide) (by decide) (by decide)
...
def cert30_seen_30_6_6 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F2F3 }, { occ := 0, edge := TauEdge.F2F4 }, { occ := 0, edge := TauEdge.B4 }, { occ := 0, edge := TauEdge.B7 }, { occ := 1, edge := TauEdge.F0F2 }, { occ := 1, edge := TauEdge.F2F4 }, { occ := 1, edge := TauEdge.B4 }, { occ := 1, edge := TauEdge.F4F5 }, { occ := 2, edge := TauEdge.F2F3 }, { occ := 1, edge := TauEdge.B6 }, { occ := 2, edge := TauEdge.F0F2 }, { occ := 2, edge := TauEdge.F1F0 }]

def cert30_layer_30_6_6 : List ChainEdge :=
  []

theorem cert30_layer_30_6_6_eq :
    closedCollarComponentLayer word (listGetD fiber30 30 [])
      LColor.b LColor.p cert30_seen_30_6_6 = cert30_layer_30_6_6 := by
  decide
...
theorem cert30_component_30_6_eq :
  ...
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 30 []) LColor.b LColor.p
    cert30_seen_30_6_5 cert30_layer_30_6_5 21 cert30_layer_30_6_5_eq]
  change closeClosedCollarComponent word (listGetD fiber30 30 [])
      LColor.b LColor.p 21 cert30_seen_30_6_6 = cert30_component_30_6
  exact closeClosedCollarComponent_eq_self_of_layer_nil word
    (listGetD fiber30 30 []) LColor.b LColor.p
    cert30_seen_30_6_6 cert30_layer_30_6_6_eq 21
...
def cert30_move_30_38 : ChainMove :=
  { a := LColor.r, c := LColor.p, seed := { occ := 0, edge := TauEdge.F4F5 } }

def cert30_component_30_38 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F4F5 }, { occ := 0, edge := TauEdge.B5 }, { occ := 0, edge := TauEdge.B7 }, { occ := 1, edge := TauEdge.F1F0 }, { occ := 1, edge := TauEdge.F2F3 }, { occ := 1, edge := TauEdge.F0F2 }]

def cert30_seen_30_38_0 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F4F5 }]

def cert30_layer_30_38_0 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.B5 }, { occ := 0, edge := TauEdge.B7 }]

theorem cert30_layer_30_38_0_eq :
    closedCollarComponentLayer word (listGetD fiber30 30 [])
      LColor.r LColor.p cert30_seen_30_38_0 = cert30_layer_30_38_0 := by
  decide

def cert30_seen_30_38_1 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F4F5 }, { occ := 0, edge := TauEdge.B5 }, { occ := 0, edge := TauEdge.B7 }]

def cert30_layer_30_38_1 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F1F0 }, { occ := 1, edge := TauEdge.F2F3 }]

theorem cert30_layer_30_38_1_eq :
    closedCollarComponentLayer word (listGetD fiber30 30 [])
      LColor.r LColor.p cert30_seen_30_38_1 = cert30_layer_30_38_1 := by
  decide

def cert30_seen_30_38_2 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F4F5 }, { occ := 0, edge := TauEdge.B5 }, { occ := 0, edge := TauEdge.B7 }, { occ := 1, edge := TauEdge.F1F0 }, { occ := 1, edge := TauEdge.F2F3 }]

def cert30_layer_30_38_2 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F0F2 }]

theorem cert30_layer_30_38_2_eq :
    closedCollarComponentLayer word (listGetD fiber30 30 [])
      LColor.r LColor.p cert30_seen_30_38_2 = cert30_layer_30_38_2 := by
  decide

def cert30_seen_30_38_3 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F4F5 }, { occ := 0, edge := TauEdge.B5 }, { occ := 0, edge := TauEdge.B7 }, { occ := 1, edge := TauEdge.F1F0 }, { occ := 1, edge := TauEdge.F2F3 }, { occ := 1, edge := TauEdge.F0F2 }]

def cert30_layer_30_38_3 : List ChainEdge :=
  []

theorem cert30_layer_30_38_3_eq :
    closedCollarComponentLayer word (listGetD fiber30 30 [])
      LColor.r LColor.p cert30_seen_30_38_3 = cert30_layer_30_38_3 := by
  decide

theorem cert30_component_30_38_eq :
    closedCollarComponent word (listGetD fiber30 30 [])
      LColor.r LColor.p { occ := 0, edge := TauEdge.F4F5 } = cert30_component_30_38 := by
  unfold closedCollarComponent
  have hseedColor : chainEdgeInPair (listGetD fiber30 30 [])
      LColor.r LColor.p { occ := 0, edge := TauEdge.F4F5 } = true := by
    decide
  simp [hseedColor]
  change closeClosedCollarComponent word (listGetD fiber30 30 [])
      LColor.r LColor.p 27 cert30_seen_30_38_0 = cert30_component_30_38
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 30 []) LColor.r LColor.p
    cert30_seen_30_38_0 cert30_layer_30_38_0 26 cert30_layer_30_38_0_eq]
  change closeClosedCollarComponent word (listGetD fiber30 30 [])
      LColor.r LColor.p 26 cert30_seen_30_38_1 = cert30_component_30_38
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 30 []) LColor.r LColor.p
    cert30_seen_30_38_1 cert30_layer_30_38_1 25 cert30_layer_30_38_1_eq]
  change closeClosedCollarComponent word (listGetD fiber30 30 [])
      LColor.r LColor.p 25 cert30_seen_30_38_2 = cert30_component_30_38
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 30 []) LColor.r LColor.p
    cert30_seen_30_38_2 cert30_layer_30_38_2 24 cert30_layer_30_38_2_eq]
  change closeClosedCollarComponent word (listGetD fiber30 30 [])
      LColor.r LColor.p 24 cert30_seen_30_38_3 = cert30_component_30_38
  exact closeClosedCollarComponent_eq_self_of_layer_nil word
    (listGetD fiber30 30 []) LColor.r LColor.p
    cert30_seen_30_38_3 cert30_layer_30_38_3_eq 24

theorem cert30_step_30_38 :
    closedCollarIndexStepBool word fiber30 30 38 = true :=
  closedCollarIndexStepBool_of_component (move := cert30_move_30_38)
    (by decide) (by decide)
    (by simpa [cert30_move_30_38] using cert30_component_30_38_eq)
    (by decide) (by decide) (by decide)

def cert30_move_31_28 : ChainMove :=
  { a := LColor.r, c := LColor.p, seed := { occ := 1, edge := TauEdge.F4F5 } }

def cert30_component_31_28 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F4F5 }, { occ := 1, edge := TauEdge.B6 }, { occ := 1, edge := TauEdge.B7 }, { occ := 2, edge := TauEdge.F1F0 }]

def cert30_seen_31_28_0 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F4F5 }]

def cert30_layer_31_28_0 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.B6 }, { occ := 1, edge := TauEdge.B7 }]

theorem cert30_layer_31_28_0_eq :
    closedCollarComponentLayer word (listGetD fiber30 31 [])
      LColor.r LColor.p cert30_seen_31_28_0 = cert30_layer_31_28_0 := by
  decide

def cert30_seen_31_28_1 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F4F5 }, { occ := 1, edge := TauEdge.B6 }, { occ := 1, edge := TauEdge.B7 }]

def cert30_layer_31_28_1 : List ChainEdge :=
  [{ occ := 2, edge := TauEdge.F1F0 }]

theorem cert30_layer_31_28_1_eq :
    closedCollarComponentLayer word (listGetD fiber30 31 [])
      LColor.r LColor.p cert30_seen_31_28_1 = cert30_layer_31_28_1 := by
  decide

def cert30_seen_31_28_2 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F4F5 }, { occ := 1, edge := TauEdge.B6 }, { occ := 1, edge := TauEdge.B7 }, { occ := 2, edge := TauEdge.F1F0 }]

def cert30_layer_31_28_2 : List ChainEdge :=
  []

theorem cert30_layer_31_28_2_eq :
    closedCollarComponentLayer word (listGetD fiber30 31 [])
      LColor.r LColor.p cert30_seen_31_28_2 = cert30_layer_31_28_2 := by
  decide

theorem cert30_component_31_28_eq :
    closedCollarComponent word (listGetD fiber30 31 [])
      LColor.r LColor.p { occ := 1, edge := TauEdge.F4F5 } = cert30_component_31_28 := by
  unfold closedCollarComponent
  ...
  change closeClosedCollarComponent word (listGetD fiber30 31 [])
      LColor.r LColor.p 27 cert30_seen_31_28_0 = cert30_component_31_28
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 31 []) LColor.r LColor.p
    cert30_seen_31_28_0 cert30_layer_31_28_0 26 cert30_layer_31_28_0_eq]
  change closeClosedCollarComponent word (listGetD fiber30 31 [])
      LColor.r LColor.p 26 cert30_seen_31_28_1 = cert30_component_31_28
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 31 []) LColor.r LColor.p
    cert30_seen_31_28_1 cert30_layer_31_28_1 25 cert30_layer_31_28_1_eq]
  change closeClosedCollarComponent word (listGetD fiber30 31 [])
      LColor.r LColor.p 25 cert30_seen_31_28_2 = cert30_component_31_28
  exact closeClosedCollarComponent_eq_self_of_layer_nil word
    (listGetD fiber30 31 []) LColor.r LColor.p
    cert30_seen_31_28_2 cert30_layer_31_28_2_eq 25

theorem cert30_step_31_28 :
    closedCollarIndexStepBool word fiber30 31 28 = true :=
  closedCollarIndexStepBool_of_component (move := cert30_move_31_28)
    (by decide) (by decide)
    (by simpa [cert30_move_31_28] using cert30_component_31_28_eq)
    (by decide) (by decide) (by decide)

def cert30_move_31_39 : ChainMove :=
  { a := LColor.r, c := LColor.p, seed := { occ := 0, edge := TauEdge.F4F5 } }

def cert30_component_31_39 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F4F5 }, { occ := 0, edge := TauEdge.B5 }, { occ := 0, edge := TauEdge.B7 }, { occ := 1, edge := TauEdge.F1F0 }, { occ := 1, edge := TauEdge.F2F3 }, { occ := 1, edge := TauEdge.F0F2 }]

def cert30_seen_31_39_0 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F4F5 }]

def cert30_layer_31_39_0 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.B5 }, { occ := 0, edge := TauEdge.B7 }]

theorem cert30_layer_31_39_0_eq :
    closedCollarComponentLayer word (listGetD fiber30 31 [])
      LColor.r LColor.p cert30_seen_31_39_0 = cert30_layer_31_39_0 := by
  decide

def cert30_seen_31_39_1 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F4F5 }, { occ := 0, edge := TauEdge.B5 }, { occ := 0, edge := TauEdge.B7 }]

def cert30_layer_31_39_1 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F1F0 }, { occ := 1, edge := TauEdge.F2F3 }]

theorem cert30_layer_31_39_1_eq :
    closedCollarComponentLayer word (listGetD fiber30 31 [])
      LColor.r LColor.p cert30_seen_31_39_1 = cert30_layer_31_39_1 := by
  decide

def cert30_seen_31_39_2 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F4F5 }, { occ := 0, edge := TauEdge.B5 }, { occ := 0, edge := TauEdge.B7 }, { occ := 1, edge := TauEdge.F1F0 }, { occ := 1, edge := TauEdge.F2F3 }]

def cert30_layer_31_39_2 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F0F2 }]

theorem cert30_layer_31_39_2_eq :
    closedCollarComponentLayer word (listGetD fiber30 31 [])
      LColor.r LColor.p cert30_seen_31_39_2 = cert30_layer_31_39_2 := by
  decide

def cert30_seen_31_39_3 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F4F5 }, { occ := 0, edge := TauEdge.B5 }, { occ := 0, edge := TauEdge.B7 }, { occ := 1, edge := TauEdge.F1F0 }, { occ := 1, edge := TauEdge.F2F3 }, { occ := 1, edge := TauEdge.F0F2 }]

def cert30_layer_31_39_3 : List ChainEdge :=
  []

theorem cert30_layer_31_39_3_eq :
    closedCollarComponentLayer word (listGetD fiber30 31 [])
      LColor.r LColor.p cert30_seen_31_39_3 = cert30_layer_31_39_3 := by
  decide

theorem cert30_component_31_39_eq :
    closedCollarComponent word (listGetD fiber30 31 [])
      LColor.r LColor.p { occ := 0, edge := TauEdge.F4F5 } = cert30_component_31_39 := by
  unfold closedCollarComponent
  have hseedColor : chainEdgeInPair (listGetD fiber30 31 [])
      LColor.r LColor.p { occ := 0, edge := TauEdge.F4F5 } = true := by
    decide
  simp [hseedColor]
  change closeClosedCollarComponent word (listGetD fiber30 31 [])
      LColor.r LColor.p 27 cert30_seen_31_39_0 = cert30_component_31_39
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 31 []) LColor.r LColor.p
    cert30_seen_31_39_0 cert30_layer_31_39_0 26 cert30_layer_31_39_0_eq]
  change closeClosedCollarComponent word (listGetD fiber30 31 [])
      LColor.r LColor.p 26 cert30_seen_31_39_1 = cert30_component_31_39
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 31 []) LColor.r LColor.p
    cert30_seen_31_39_1 cert30_layer_31_39_1 25 cert30_layer_31_39_1_eq]
  change closeClosedCollarComponent word (listGetD fiber30 31 [])
      LColor.r LColor.p 25 cert30_seen_31_39_2 = cert30_component_31_39
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 31 []) LColor.r LColor.p
    cert30_seen_31_39_2 cert30_layer_31_39_2 24 cert30_layer_31_39_2_eq]
  change closeClosedCollarComponent word (listGetD fiber30 31 [])
      LColor.r LColor.p 24 cert30_seen_31_39_3 = cert30_component_31_39
  exact closeClosedCollarComponent_eq_self_of_layer_nil word
    (listGetD fiber30 31 []) LColor.r LColor.p
    cert30_seen_31_39_3 cert30_layer_31_39_3_eq 24

theorem cert30_step_31_39 :
    closedCollarIndexStepBool word fiber30 31 39 = true :=
  closedCollarIndexStepBool_of_component (move := cert30_move_31_39)
    (by decide) (by decide)
    (by simpa [cert30_move_31_39] using cert30_component_31_39_eq)
    (by decide) (by decide) (by decide)
...
def cert30_move_38_30 : ChainMove :=
  { a := LColor.r, c := LColor.p, seed := { occ := 0, edge := TauEdge.F4F5 } }

def cert30_component_38_30 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F4F5 }, { occ := 0, edge := TauEdge.B5 }, { occ := 0, edge := TauEdge.B7 }, { occ := 1, edge := TauEdge.F1F0 }, { occ := 1, edge := TauEdge.F2F3 }, { occ := 1, edge := TauEdge.F0F2 }]

def cert30_seen_38_30_0 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F4F5 }]

def cert30_layer_38_30_0 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.B5 }, { occ := 0, edge := TauEdge.B7 }]

theorem cert30_layer_38_30_0_eq :
    closedCollarComponentLayer word (listGetD fiber30 38 [])
      LColor.r LColor.p cert30_seen_38_30_0 = cert30_layer_38_30_0 := by
  decide

def cert30_seen_38_30_1 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F4F5 }, { occ := 0, edge := TauEdge.B5 }, { occ := 0, edge := TauEdge.B7 }]

def cert30_layer_38_30_1 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F1F0 }, { occ := 1, edge := TauEdge.F2F3 }]

theorem cert30_layer_38_30_1_eq :
    closedCollarComponentLayer word (listGetD fiber30 38 [])
      LColor.r LColor.p cert30_seen_38_30_1 = cert30_layer_38_30_1 := by
  decide

def cert30_seen_38_30_2 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F4F5 }, { occ := 0, edge := TauEdge.B5 }, { occ := 0, edge := TauEdge.B7 }, { occ := 1, edge := TauEdge.F1F0 }, { occ := 1, edge := TauEdge.F2F3 }]

def cert30_layer_38_30_2 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F0F2 }]

theorem cert30_layer_38_30_2_eq :
    closedCollarComponentLayer word (listGetD fiber30 38 [])
      LColor.r LColor.p cert30_seen_38_30_2 = cert30_layer_38_30_2 := by
  decide

def cert30_seen_38_30_3 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F4F5 }, { occ := 0, edge := TauEdge.B5 }, { occ := 0, edge := TauEdge.B7 }, { occ := 1, edge := TauEdge.F1F0 }, { occ := 1, edge := TauEdge.F2F3 }, { occ := 1, edge := TauEdge.F0F2 }]

def cert30_layer_38_30_3 : List ChainEdge :=
  []

theorem cert30_layer_38_30_3_eq :
    closedCollarComponentLayer word (listGetD fiber30 38 [])
      LColor.r LColor.p cert30_seen_38_30_3 = cert30_layer_38_30_3 := by
  decide

theorem cert30_component_38_30_eq :
    closedCollarComponent word (listGetD fiber30 38 [])
      LColor.r LColor.p { occ := 0, edge := TauEdge.F4F5 } = cert30_component_38_30 := by
  unfold closedCollarComponent
  ...
  change closeClosedCollarComponent word (listGetD fiber30 38 [])
      LColor.r LColor.p 27 cert30_seen_38_30_0 = cert30_component_38_30
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 38 []) LColor.r LColor.p
    cert30_seen_38_30_0 cert30_layer_38_30_0 26 cert30_layer_38_30_0_eq]
  change closeClosedCollarComponent word (listGetD fiber30 38 [])
      LColor.r LColor.p 26 cert30_seen_38_30_1 = cert30_component_38_30
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 38 []) LColor.r LColor.p
    cert30_seen_38_30_1 cert30_layer_38_30_1 25 cert30_layer_38_30_1_eq]
  change closeClosedCollarComponent word (listGetD fiber30 38 [])
      LColor.r LColor.p 25 cert30_seen_38_30_2 = cert30_component_38_30
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 38 []) LColor.r LColor.p
    cert30_seen_38_30_2 cert30_layer_38_30_2 24 cert30_layer_38_30_2_eq]
  change closeClosedCollarComponent word (listGetD fiber30 38 [])
      LColor.r LColor.p 24 cert30_seen_38_30_3 = cert30_component_38_30
  exact closeClosedCollarComponent_eq_self_of_layer_nil word
    (listGetD fiber30 38 []) LColor.r LColor.p
    cert30_seen_38_30_3 cert30_layer_38_30_3_eq 24

theorem cert30_step_38_30 :
    closedCollarIndexStepBool word fiber30 38 30 = true :=
  closedCollarIndexStepBool_of_component (move := cert30_move_38_30)
    (by decide) (by decide)
    (by simpa [cert30_move_38_30] using cert30_component_38_30_eq)
    (by decide) (by decide) (by decide)

def cert30_move_39_31 : ChainMove :=
  { a := LColor.r, c := LColor.p, seed := { occ := 0, edge := TauEdge.F4F5 } }

def cert30_component_39_31 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F4F5 }, { occ := 0, edge := TauEdge.B5 }, { occ := 0, edge := TauEdge.B7 }, { occ := 1, edge := TauEdge.F1F0 }, { occ := 1, edge := TauEdge.F2F3 }, { occ := 1, edge := TauEdge.F0F2 }]

def cert30_seen_39_31_0 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F4F5 }]

def cert30_layer_39_31_0 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.B5 }, { occ := 0, edge := TauEdge.B7 }]

theorem cert30_layer_39_31_0_eq :
    closedCollarComponentLayer word (listGetD fiber30 39 [])
      LColor.r LColor.p cert30_seen_39_31_0 = cert30_layer_39_31_0 := by
  decide

def cert30_seen_39_31_1 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F4F5 }, { occ := 0, edge := TauEdge.B5 }, { occ := 0, edge := TauEdge.B7 }]

def cert30_layer_39_31_1 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F1F0 }, { occ := 1, edge := TauEdge.F2F3 }]

theorem cert30_layer_39_31_1_eq :
    closedCollarComponentLayer word (listGetD fiber30 39 [])
      LColor.r LColor.p cert30_seen_39_31_1 = cert30_layer_39_31_1 := by
  decide

def cert30_seen_39_31_2 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F4F5 }, { occ := 0, edge := TauEdge.B5 }, { occ := 0, edge := TauEdge.B7 }, { occ := 1, edge := TauEdge.F1F0 }, { occ := 1, edge := TauEdge.F2F3 }]

def cert30_layer_39_31_2 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F0F2 }]

theorem cert30_layer_39_31_2_eq :
    closedCollarComponentLayer word (listGetD fiber30 39 [])
      LColor.r LColor.p cert30_seen_39_31_2 = cert30_layer_39_31_2 := by
  decide

def cert30_seen_39_31_3 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F4F5 }, { occ := 0, edge := TauEdge.B5 }, { occ := 0, edge := TauEdge.B7 }, { occ := 1, edge := TauEdge.F1F0 }, { occ := 1, edge := TauEdge.F2F3 }, { occ := 1, edge := TauEdge.F0F2 }]

def cert30_layer_39_31_3 : List ChainEdge :=
  []

theorem cert30_layer_39_31_3_eq :
    closedCollarComponentLayer word (listGetD fiber30 39 [])
      LColor.r LColor.p cert30_seen_39_31_3 = cert30_layer_39_31_3 := by
  decide

theorem cert30_component_39_31_eq :
    closedCollarComponent word (listGetD fiber30 39 [])
      LColor.r LColor.p { occ := 0, edge := TauEdge.F4F5 } = cert30_component_39_31 := by
  unfold closedCollarComponent
  ...
  change closeClosedCollarComponent word (listGetD fiber30 39 [])
      LColor.r LColor.p 27 cert30_seen_39_31_0 = cert30_component_39_31
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 39 []) LColor.r LColor.p
    cert30_seen_39_31_0 cert30_layer_39_31_0 26 cert30_layer_39_31_0_eq]
  change closeClosedCollarComponent word (listGetD fiber30 39 [])
      LColor.r LColor.p 26 cert30_seen_39_31_1 = cert30_component_39_31
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 39 []) LColor.r LColor.p
    cert30_seen_39_31_1 cert30_layer_39_31_1 25 cert30_layer_39_31_1_eq]
  change closeClosedCollarComponent word (listGetD fiber30 39 [])
      LColor.r LColor.p 25 cert30_seen_39_31_2 = cert30_component_39_31
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 39 []) LColor.r LColor.p
    cert30_seen_39_31_2 cert30_layer_39_31_2 24 cert30_layer_39_31_2_eq]
  change closeClosedCollarComponent word (listGetD fiber30 39 [])
      LColor.r LColor.p 24 cert30_seen_39_31_3 = cert30_component_39_31
  exact closeClosedCollarComponent_eq_self_of_layer_nil word
    (listGetD fiber30 39 []) LColor.r LColor.p
    cert30_seen_39_31_3 cert30_layer_39_31_3_eq 24

theorem cert30_step_39_31 :
    closedCollarIndexStepBool word fiber30 39 31 = true :=
  closedCollarIndexStepBool_of_component (move := cert30_move_39_31)
    (by decide) (by decide)
    (by simpa [cert30_move_39_31] using cert30_component_39_31_eq)
    (by decide) (by decide) (by decide)
...
theorem cert30_layer_40_16_0_eq :
    closedCollarComponentLayer word (listGetD fiber30 40 [])
      LColor.b LColor.p cert30_seen_40_16_0 = cert30_layer_40_16_0 := by
  decide
...
theorem cert30_layer_40_16_1_eq :
    closedCollarComponentLayer word (listGetD fiber30 40 [])
      LColor.b LColor.p cert30_seen_40_16_1 = cert30_layer_40_16_1 := by
  decide
...
theorem cert30_layer_40_16_2_eq :
    closedCollarComponentLayer word (listGetD fiber30 40 [])
      LColor.b LColor.p cert30_seen_40_16_2 = cert30_layer_40_16_2 := by
  decide

def cert30_seen_40_16_3 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F2F3 }, { occ := 0, edge := TauEdge.F2F4 }, { occ := 0, edge := TauEdge.B4 }, { occ := 0, edge := TauEdge.F4F5 }, { occ := 1, edge := TauEdge.F1F0 }, { occ := 0, edge := TauEdge.B5 }]

def cert30_layer_40_16_3 : List ChainEdge :=
  []

theorem cert30_layer_40_16_3_eq :
    closedCollarComponentLayer word (listGetD fiber30 40 [])
      LColor.b LColor.p cert30_seen_40_16_3 = cert30_layer_40_16_3 := by
  decide

theorem cert30_component_40_16_eq :
    closedCollarComponent word (listGetD fiber30 40 [])
      LColor.b LColor.p { occ := 0, edge := TauEdge.F2F3 } = cert30_component_40_16 := by
  unfold closedCollarComponent
  ...
  change closeClosedCollarComponent word (listGetD fiber30 40 [])
      LColor.b LColor.p 27 cert30_seen_40_16_0 = cert30_component_40_16
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 40 []) LColor.b LColor.p
    cert30_seen_40_16_0 cert30_layer_40_16_0 26 cert30_layer_40_16_0_eq]
  change closeClosedCollarComponent word (listGetD fiber30 40 [])
      LColor.b LColor.p 26 cert30_seen_40_16_1 = cert30_component_40_16
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 40 []) LColor.b LColor.p
    cert30_seen_40_16_1 cert30_layer_40_16_1 25 cert30_layer_40_16_1_eq]
  change closeClosedCollarComponent word (listGetD fiber30 40 [])
      LColor.b LColor.p 25 cert30_seen_40_16_2 = cert30_component_40_16
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 40 []) LColor.b LColor.p
    cert30_seen_40_16_2 cert30_layer_40_16_2 24 cert30_layer_40_16_2_eq]
  change closeClosedCollarComponent word (listGetD fiber30 40 [])
      LColor.b LColor.p 24 cert30_seen_40_16_3 = cert30_component_40_16
  exact closeClosedCollarComponent_eq_self_of_layer_nil word
    (listGetD fiber30 40 []) LColor.b LColor.p
    cert30_seen_40_16_3 cert30_layer_40_16_3_eq 24
...
theorem cert30_layer_41_17_0_eq :
    closedCollarComponentLayer word (listGetD fiber30 41 [])
      LColor.b LColor.p cert30_seen_41_17_0 = cert30_layer_41_17_0 := by
  decide
...
theorem cert30_layer_41_17_1_eq :
    closedCollarComponentLayer word (listGetD fiber30 41 [])
      LColor.b LColor.p cert30_seen_41_17_1 = cert30_layer_41_17_1 := by
  decide
...
theorem cert30_layer_41_17_2_eq :
    closedCollarComponentLayer word (listGetD fiber30 41 [])
      LColor.b LColor.p cert30_seen_41_17_2 = cert30_layer_41_17_2 := by
  decide

def cert30_seen_41_17_3 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F2F3 }, { occ := 0, edge := TauEdge.F2F4 }, { occ := 0, edge := TauEdge.B4 }, { occ := 0, edge := TauEdge.F4F5 }, { occ := 1, edge := TauEdge.F1F0 }, { occ := 0, edge := TauEdge.B5 }]

def cert30_layer_41_17_3 : List ChainEdge :=
  []

theorem cert30_layer_41_17_3_eq :
    closedCollarComponentLayer word (listGetD fiber30 41 [])
      LColor.b LColor.p cert30_seen_41_17_3 = cert30_layer_41_17_3 := by
  decide

theorem cert30_component_41_17_eq :
    closedCollarComponent word (listGetD fiber30 41 [])
      LColor.b LColor.p { occ := 0, edge := TauEdge.F2F3 } = cert30_component_41_17 := by
  unfold closedCollarComponent
  ...
  change closeClosedCollarComponent word (listGetD fiber30 41 [])
      LColor.b LColor.p 27 cert30_seen_41_17_0 = cert30_component_41_17
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 41 []) LColor.b LColor.p
    cert30_seen_41_17_0 cert30_layer_41_17_0 26 cert30_layer_41_17_0_eq]
  change closeClosedCollarComponent word (listGetD fiber30 41 [])
      LColor.b LColor.p 26 cert30_seen_41_17_1 = cert30_component_41_17
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 41 []) LColor.b LColor.p
    cert30_seen_41_17_1 cert30_layer_41_17_1 25 cert30_layer_41_17_1_eq]
  change closeClosedCollarComponent word (listGetD fiber30 41 [])
      LColor.b LColor.p 25 cert30_seen_41_17_2 = cert30_component_41_17
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 41 []) LColor.b LColor.p
    cert30_seen_41_17_2 cert30_layer_41_17_2 24 cert30_layer_41_17_2_eq]
  change closeClosedCollarComponent word (listGetD fiber30 41 [])
      LColor.b LColor.p 24 cert30_seen_41_17_3 = cert30_component_41_17
  exact closeClosedCollarComponent_eq_self_of_layer_nil word
    (listGetD fiber30 41 []) LColor.b LColor.p
    cert30_seen_41_17_3 cert30_layer_41_17_3_eq 24
...
theorem cert30_layer_42_18_0_eq :
    closedCollarComponentLayer word (listGetD fiber30 42 [])
      LColor.b LColor.p cert30_seen_42_18_0 = cert30_layer_42_18_0 := by
  decide
...
theorem cert30_layer_42_18_1_eq :
    closedCollarComponentLayer word (listGetD fiber30 42 [])
      LColor.b LColor.p cert30_seen_42_18_1 = cert30_layer_42_18_1 := by
  decide
...
theorem cert30_layer_42_18_2_eq :
    closedCollarComponentLayer word (listGetD fiber30 42 [])
      LColor.b LColor.p cert30_seen_42_18_2 = cert30_layer_42_18_2 := by
  decide

def cert30_seen_42_18_3 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F2F3 }, { occ := 0, edge := TauEdge.F2F4 }, { occ := 0, edge := TauEdge.B4 }, { occ := 0, edge := TauEdge.F4F5 }, { occ := 1, edge := TauEdge.F1F0 }, { occ := 0, edge := TauEdge.B5 }]

def cert30_layer_42_18_3 : List ChainEdge :=
  []

theorem cert30_layer_42_18_3_eq :
    closedCollarComponentLayer word (listGetD fiber30 42 [])
      LColor.b LColor.p cert30_seen_42_18_3 = cert30_layer_42_18_3 := by
  decide

theorem cert30_component_42_18_eq :
    closedCollarComponent word (listGetD fiber30 42 [])
      LColor.b LColor.p { occ := 0, edge := TauEdge.F2F3 } = cert30_component_42_18 := by
  unfold closedCollarComponent
  ...
  change closeClosedCollarComponent word (listGetD fiber30 42 [])
      LColor.b LColor.p 27 cert30_seen_42_18_0 = cert30_component_42_18
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 42 []) LColor.b LColor.p
    cert30_seen_42_18_0 cert30_layer_42_18_0 26 cert30_layer_42_18_0_eq]
  change closeClosedCollarComponent word (listGetD fiber30 42 [])
      LColor.b LColor.p 26 cert30_seen_42_18_1 = cert30_component_42_18
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 42 []) LColor.b LColor.p
    cert30_seen_42_18_1 cert30_layer_42_18_1 25 cert30_layer_42_18_1_eq]
  change closeClosedCollarComponent word (listGetD fiber30 42 [])
      LColor.b LColor.p 25 cert30_seen_42_18_2 = cert30_component_42_18
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 42 []) LColor.b LColor.p
    cert30_seen_42_18_2 cert30_layer_42_18_2 24 cert30_layer_42_18_2_eq]
  change closeClosedCollarComponent word (listGetD fiber30 42 [])
      LColor.b LColor.p 24 cert30_seen_42_18_3 = cert30_component_42_18
  exact closeClosedCollarComponent_eq_self_of_layer_nil word
    (listGetD fiber30 42 []) LColor.b LColor.p
    cert30_seen_42_18_3 cert30_layer_42_18_3_eq 24
...
def cert30_move_44_24 : ChainMove :=
  { a := LColor.r, c := LColor.p, seed := { occ := 0, edge := TauEdge.F4F5 } }

def cert30_component_44_24 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F4F5 }, { occ := 0, edge := TauEdge.B6 }, { occ := 0, edge := TauEdge.B7 }, { occ := 1, edge := TauEdge.F1F0 }, { occ := 1, edge := TauEdge.F2F3 }, { occ := 1, edge := TauEdge.F0F2 }]

def cert30_seen_44_24_0 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F4F5 }]

def cert30_layer_44_24_0 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.B6 }, { occ := 0, edge := TauEdge.B7 }]

theorem cert30_layer_44_24_0_eq :
    closedCollarComponentLayer word (listGetD fiber30 44 [])
      LColor.r LColor.p cert30_seen_44_24_0 = cert30_layer_44_24_0 := by
  decide

def cert30_seen_44_24_1 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F4F5 }, { occ := 0, edge := TauEdge.B6 }, { occ := 0, edge := TauEdge.B7 }]

def cert30_layer_44_24_1 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F1F0 }, { occ := 1, edge := TauEdge.F2F3 }]

theorem cert30_layer_44_24_1_eq :
    closedCollarComponentLayer word (listGetD fiber30 44 [])
      LColor.r LColor.p cert30_seen_44_24_1 = cert30_layer_44_24_1 := by
  decide

def cert30_seen_44_24_2 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F4F5 }, { occ := 0, edge := TauEdge.B6 }, { occ := 0, edge := TauEdge.B7 }, { occ := 1, edge := TauEdge.F1F0 }, { occ := 1, edge := TauEdge.F2F3 }]

def cert30_layer_44_24_2 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F0F2 }]

theorem cert30_layer_44_24_2_eq :
    closedCollarComponentLayer word (listGetD fiber30 44 [])
      LColor.r LColor.p cert30_seen_44_24_2 = cert30_layer_44_24_2 := by
  decide

def cert30_seen_44_24_3 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F4F5 }, { occ := 0, edge := TauEdge.B6 }, { occ := 0, edge := TauEdge.B7 }, { occ := 1, edge := TauEdge.F1F0 }, { occ := 1, edge := TauEdge.F2F3 }, { occ := 1, edge := TauEdge.F0F2 }]

def cert30_layer_44_24_3 : List ChainEdge :=
  []

theorem cert30_layer_44_24_3_eq :
    closedCollarComponentLayer word (listGetD fiber30 44 [])
      LColor.r LColor.p cert30_seen_44_24_3 = cert30_layer_44_24_3 := by
  decide

theorem cert30_component_44_24_eq :
    closedCollarComponent word (listGetD fiber30 44 [])
      LColor.r LColor.p { occ := 0, edge := TauEdge.F4F5 } = cert30_component_44_24 := by
  unfold closedCollarComponent
  ...
  change closeClosedCollarComponent word (listGetD fiber30 44 [])
      LColor.r LColor.p 27 cert30_seen_44_24_0 = cert30_component_44_24
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 44 []) LColor.r LColor.p
    cert30_seen_44_24_0 cert30_layer_44_24_0 26 cert30_layer_44_24_0_eq]
  change closeClosedCollarComponent word (listGetD fiber30 44 [])
      LColor.r LColor.p 26 cert30_seen_44_24_1 = cert30_component_44_24
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 44 []) LColor.r LColor.p
    cert30_seen_44_24_1 cert30_layer_44_24_1 25 cert30_layer_44_24_1_eq]
  change closeClosedCollarComponent word (listGetD fiber30 44 [])
      LColor.r LColor.p 25 cert30_seen_44_24_2 = cert30_component_44_24
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 44 []) LColor.r LColor.p
    cert30_seen_44_24_2 cert30_layer_44_24_2 24 cert30_layer_44_24_2_eq]
  change closeClosedCollarComponent word (listGetD fiber30 44 [])
      LColor.r LColor.p 24 cert30_seen_44_24_3 = cert30_component_44_24
  exact closeClosedCollarComponent_eq_self_of_layer_nil word
    (listGetD fiber30 44 []) LColor.r LColor.p
    cert30_seen_44_24_3 cert30_layer_44_24_3_eq 24

theorem cert30_step_44_24 :
    closedCollarIndexStepBool word fiber30 44 24 = true :=
  closedCollarIndexStepBool_of_component (move := cert30_move_44_24)
    (by decide) (by decide)
    (by simpa [cert30_move_44_24] using cert30_component_44_24_eq)
    (by decide) (by decide) (by decide)

def cert30_move_45_25 : ChainMove :=
  { a := LColor.r, c := LColor.p, seed := { occ := 0, edge := TauEdge.F4F5 } }

def cert30_component_45_25 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F4F5 }, { occ := 0, edge := TauEdge.B6 }, { occ := 0, edge := TauEdge.B7 }, { occ := 1, edge := TauEdge.F1F0 }, { occ := 1, edge := TauEdge.F2F3 }, { occ := 1, edge := TauEdge.F0F2 }]

def cert30_seen_45_25_0 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F4F5 }]

def cert30_layer_45_25_0 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.B6 }, { occ := 0, edge := TauEdge.B7 }]

theorem cert30_layer_45_25_0_eq :
    closedCollarComponentLayer word (listGetD fiber30 45 [])
      LColor.r LColor.p cert30_seen_45_25_0 = cert30_layer_45_25_0 := by
  decide

def cert30_seen_45_25_1 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F4F5 }, { occ := 0, edge := TauEdge.B6 }, { occ := 0, edge := TauEdge.B7 }]

def cert30_layer_45_25_1 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F1F0 }, { occ := 1, edge := TauEdge.F2F3 }]

theorem cert30_layer_45_25_1_eq :
    closedCollarComponentLayer word (listGetD fiber30 45 [])
      LColor.r LColor.p cert30_seen_45_25_1 = cert30_layer_45_25_1 := by
  decide

def cert30_seen_45_25_2 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F4F5 }, { occ := 0, edge := TauEdge.B6 }, { occ := 0, edge := TauEdge.B7 }, { occ := 1, edge := TauEdge.F1F0 }, { occ := 1, edge := TauEdge.F2F3 }]

def cert30_layer_45_25_2 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F0F2 }]

theorem cert30_layer_45_25_2_eq :
    closedCollarComponentLayer word (listGetD fiber30 45 [])
      LColor.r LColor.p cert30_seen_45_25_2 = cert30_layer_45_25_2 := by
  decide

def cert30_seen_45_25_3 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F4F5 }, { occ := 0, edge := TauEdge.B6 }, { occ := 0, edge := TauEdge.B7 }, { occ := 1, edge := TauEdge.F1F0 }, { occ := 1, edge := TauEdge.F2F3 }, { occ := 1, edge := TauEdge.F0F2 }]

def cert30_layer_45_25_3 : List ChainEdge :=
  []

theorem cert30_layer_45_25_3_eq :
    closedCollarComponentLayer word (listGetD fiber30 45 [])
      LColor.r LColor.p cert30_seen_45_25_3 = cert30_layer_45_25_3 := by
  decide

theorem cert30_component_45_25_eq :
    closedCollarComponent word (listGetD fiber30 45 [])
      LColor.r LColor.p { occ := 0, edge := TauEdge.F4F5 } = cert30_component_45_25 := by
  unfold closedCollarComponent
  ...
  change closeClosedCollarComponent word (listGetD fiber30 45 [])
      LColor.r LColor.p 27 cert30_seen_45_25_0 = cert30_component_45_25
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 45 []) LColor.r LColor.p
    cert30_seen_45_25_0 cert30_layer_45_25_0 26 cert30_layer_45_25_0_eq]
  change closeClosedCollarComponent word (listGetD fiber30 45 [])
      LColor.r LColor.p 26 cert30_seen_45_25_1 = cert30_component_45_25
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 45 []) LColor.r LColor.p
    cert30_seen_45_25_1 cert30_layer_45_25_1 25 cert30_layer_45_25_1_eq]
  change closeClosedCollarComponent word (listGetD fiber30 45 [])
      LColor.r LColor.p 25 cert30_seen_45_25_2 = cert30_component_45_25
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 45 []) LColor.r LColor.p
    cert30_seen_45_25_2 cert30_layer_45_25_2 24 cert30_layer_45_25_2_eq]
  change closeClosedCollarComponent word (listGetD fiber30 45 [])
      LColor.r LColor.p 24 cert30_seen_45_25_3 = cert30_component_45_25
  exact closeClosedCollarComponent_eq_self_of_layer_nil word
    (listGetD fiber30 45 []) LColor.r LColor.p
    cert30_seen_45_25_3 cert30_layer_45_25_3_eq 24

theorem cert30_step_45_25 :
    closedCollarIndexStepBool word fiber30 45 25 = true :=
  closedCollarIndexStepBool_of_component (move := cert30_move_45_25)
    (by decide) (by decide)
    (by simpa [cert30_move_45_25] using cert30_component_45_25_eq)
    (by decide) (by decide) (by decide)

def cert30_move_46_26 : ChainMove :=
  { a := LColor.r, c := LColor.p, seed := { occ := 0, edge := TauEdge.F4F5 } }

def cert30_component_46_26 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F4F5 }, { occ := 0, edge := TauEdge.B6 }, { occ := 0, edge := TauEdge.B7 }, { occ := 1, edge := TauEdge.F1F0 }, { occ := 1, edge := TauEdge.F2F3 }, { occ := 1, edge := TauEdge.F0F2 }]

def cert30_seen_46_26_0 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F4F5 }]

def cert30_layer_46_26_0 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.B6 }, { occ := 0, edge := TauEdge.B7 }]

theorem cert30_layer_46_26_0_eq :
    closedCollarComponentLayer word (listGetD fiber30 46 [])
      LColor.r LColor.p cert30_seen_46_26_0 = cert30_layer_46_26_0 := by
  decide

def cert30_seen_46_26_1 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F4F5 }, { occ := 0, edge := TauEdge.B6 }, { occ := 0, edge := TauEdge.B7 }]

def cert30_layer_46_26_1 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F1F0 }, { occ := 1, edge := TauEdge.F2F3 }]

theorem cert30_layer_46_26_1_eq :
    closedCollarComponentLayer word (listGetD fiber30 46 [])
      LColor.r LColor.p cert30_seen_46_26_1 = cert30_layer_46_26_1 := by
  decide

def cert30_seen_46_26_2 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F4F5 }, { occ := 0, edge := TauEdge.B6 }, { occ := 0, edge := TauEdge.B7 }, { occ := 1, edge := TauEdge.F1F0 }, { occ := 1, edge := TauEdge.F2F3 }]

def cert30_layer_46_26_2 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F0F2 }]

theorem cert30_layer_46_26_2_eq :
    closedCollarComponentLayer word (listGetD fiber30 46 [])
      LColor.r LColor.p cert30_seen_46_26_2 = cert30_layer_46_26_2 := by
  decide

def cert30_seen_46_26_3 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F4F5 }, { occ := 0, edge := TauEdge.B6 }, { occ := 0, edge := TauEdge.B7 }, { occ := 1, edge := TauEdge.F1F0 }, { occ := 1, edge := TauEdge.F2F3 }, { occ := 1, edge := TauEdge.F0F2 }]

def cert30_layer_46_26_3 : List ChainEdge :=
  []

theorem cert30_layer_46_26_3_eq :
    closedCollarComponentLayer word (listGetD fiber30 46 [])
      LColor.r LColor.p cert30_seen_46_26_3 = cert30_layer_46_26_3 := by
  decide

theorem cert30_component_46_26_eq :
    closedCollarComponent word (listGetD fiber30 46 [])
      LColor.r LColor.p { occ := 0, edge := TauEdge.F4F5 } = cert30_component_46_26 := by
  unfold closedCollarComponent
  ...
  change closeClosedCollarComponent word (listGetD fiber30 46 [])
      LColor.r LColor.p 27 cert30_seen_46_26_0 = cert30_component_46_26
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 46 []) LColor.r LColor.p
    cert30_seen_46_26_0 cert30_layer_46_26_0 26 cert30_layer_46_26_0_eq]
  change closeClosedCollarComponent word (listGetD fiber30 46 [])
      LColor.r LColor.p 26 cert30_seen_46_26_1 = cert30_component_46_26
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 46 []) LColor.r LColor.p
    cert30_seen_46_26_1 cert30_layer_46_26_1 25 cert30_layer_46_26_1_eq]
  change closeClosedCollarComponent word (listGetD fiber30 46 [])
      LColor.r LColor.p 25 cert30_seen_46_26_2 = cert30_component_46_26
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 46 []) LColor.r LColor.p
    cert30_seen_46_26_2 cert30_layer_46_26_2 24 cert30_layer_46_26_2_eq]
  change closeClosedCollarComponent word (listGetD fiber30 46 [])
      LColor.r LColor.p 24 cert30_seen_46_26_3 = cert30_component_46_26
  exact closeClosedCollarComponent_eq_self_of_layer_nil word
    (listGetD fiber30 46 []) LColor.r LColor.p
    cert30_seen_46_26_3 cert30_layer_46_26_3_eq 24

theorem cert30_step_46_26 :
    closedCollarIndexStepBool word fiber30 46 26 = true :=
  closedCollarIndexStepBool_of_component (move := cert30_move_46_26)
    (by decide) (by decide)
    (by simpa [cert30_move_46_26] using cert30_component_46_26_eq)
    (by decide) (by decide) (by decide)

def cert30_move_47_27 : ChainMove :=
  { a := LColor.r, c := LColor.p, seed := { occ := 0, edge := TauEdge.F4F5 } }

def cert30_component_47_27 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F4F5 }, { occ := 0, edge := TauEdge.B6 }, { occ := 0, edge := TauEdge.B7 }, { occ := 1, edge := TauEdge.F1F0 }, { occ := 1, edge := TauEdge.F2F3 }, { occ := 1, edge := TauEdge.F0F2 }]

def cert30_seen_47_27_0 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F4F5 }]

def cert30_layer_47_27_0 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.B6 }, { occ := 0, edge := TauEdge.B7 }]

theorem cert30_layer_47_27_0_eq :
    closedCollarComponentLayer word (listGetD fiber30 47 [])
      LColor.r LColor.p cert30_seen_47_27_0 = cert30_layer_47_27_0 := by
  decide

def cert30_seen_47_27_1 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F4F5 }, { occ := 0, edge := TauEdge.B6 }, { occ := 0, edge := TauEdge.B7 }]

def cert30_layer_47_27_1 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F1F0 }, { occ := 1, edge := TauEdge.F2F3 }]

theorem cert30_layer_47_27_1_eq :
    closedCollarComponentLayer word (listGetD fiber30 47 [])
      LColor.r LColor.p cert30_seen_47_27_1 = cert30_layer_47_27_1 := by
  decide

def cert30_seen_47_27_2 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F4F5 }, { occ := 0, edge := TauEdge.B6 }, { occ := 0, edge := TauEdge.B7 }, { occ := 1, edge := TauEdge.F1F0 }, { occ := 1, edge := TauEdge.F2F3 }]

def cert30_layer_47_27_2 : List ChainEdge :=
  [{ occ := 1, edge := TauEdge.F0F2 }]

theorem cert30_layer_47_27_2_eq :
    closedCollarComponentLayer word (listGetD fiber30 47 [])
      LColor.r LColor.p cert30_seen_47_27_2 = cert30_layer_47_27_2 := by
  decide

def cert30_seen_47_27_3 : List ChainEdge :=
  [{ occ := 0, edge := TauEdge.F4F5 }, { occ := 0, edge := TauEdge.B6 }, { occ := 0, edge := TauEdge.B7 }, { occ := 1, edge := TauEdge.F1F0 }, { occ := 1, edge := TauEdge.F2F3 }, { occ := 1, edge := TauEdge.F0F2 }]

def cert30_layer_47_27_3 : List ChainEdge :=
  []

theorem cert30_layer_47_27_3_eq :
    closedCollarComponentLayer word (listGetD fiber30 47 [])
      LColor.r LColor.p cert30_seen_47_27_3 = cert30_layer_47_27_3 := by
  decide

theorem cert30_component_47_27_eq :
    closedCollarComponent word (listGetD fiber30 47 [])
      LColor.r LColor.p { occ := 0, edge := TauEdge.F4F5 } = cert30_component_47_27 := by
  unfold closedCollarComponent
  ...
  change closeClosedCollarComponent word (listGetD fiber30 47 [])
      LColor.r LColor.p 27 cert30_seen_47_27_0 = cert30_component_47_27
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 47 []) LColor.r LColor.p
    cert30_seen_47_27_0 cert30_layer_47_27_0 26 cert30_layer_47_27_0_eq]
  change closeClosedCollarComponent word (listGetD fiber30 47 [])
      LColor.r LColor.p 26 cert30_seen_47_27_1 = cert30_component_47_27
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 47 []) LColor.r LColor.p
    cert30_seen_47_27_1 cert30_layer_47_27_1 25 cert30_layer_47_27_1_eq]
  change closeClosedCollarComponent word (listGetD fiber30 47 [])
      LColor.r LColor.p 25 cert30_seen_47_27_2 = cert30_component_47_27
  rw [closeClosedCollarComponent_succ_eq word
    (listGetD fiber30 47 []) LColor.r LColor.p
    cert30_seen_47_27_2 cert30_layer_47_27_2 24 cert30_layer_47_27_2_eq]
  change closeClosedCollarComponent word (listGetD fiber30 47 [])
      LColor.r LColor.p 24 cert30_seen_47_27_3 = cert30_component_47_27
  exact closeClosedCollarComponent_eq_self_of_layer_nil word
    (listGetD fiber30 47 []) LColor.r LColor.p
    cert30_seen_47_27_3 cert30_layer_47_27_3_eq 24

theorem cert30_step_47_27 :
    closedCollarIndexStepBool word fiber30 47 27 = true :=
  closedCollarIndexStepBool_of_component (move := cert30_move_47_27)
    (by decide) (by decide)
    (by simpa [cert30_move_47_27] using cert30_component_47_27_eq)
    (by decide) (by decide) (by decide)
...
theorem cert30_row_14 :
  ...
  have cert30_fiber_length : fiber30.length = 48 := by decide
  unfold closedCollarParentIndexValid closedCollarParentAt
  simp [cert30, listGetD, cert30_fiber_length, cert30_step_14_10, cert30_step_10_14]

theorem cert30_row_15 :
    closedCollarParentIndexValid word fiber30 cert30.parents 15 = true := by
  have cert30_fiber_length : fiber30.length = 48 := by decide
  unfold closedCollarParentIndexValid closedCollarParentAt
  simp [cert30, listGetD, cert30_fiber_length, cert30_step_15_12, cert30_step_12_15]
...
theorem cert30_row_20 :
  ...
  have cert30_fiber_length : fiber30.length = 48 := by decide
  unfold closedCollarParentIndexValid closedCollarParentAt
  simp [cert30, listGetD, cert30_fiber_length, cert30_step_20_16, cert30_step_16_20]

theorem cert30_row_21 :
    closedCollarParentIndexValid word fiber30 cert30.parents 21 = true := by
  have cert30_fiber_length : fiber30.length = 48 := by decide
  unfold closedCollarParentIndexValid closedCollarParentAt
  simp [cert30, listGetD, cert30_fiber_length, cert30_step_21_17, cert30_step_17_21]

theorem cert30_row_22 :
    closedCollarParentIndexValid word fiber30 cert30.parents 22 = true := by
  have cert30_fiber_length : fiber30.length = 48 := by decide
  unfold closedCollarParentIndexValid closedCollarParentAt
  simp [cert30, listGetD, cert30_fiber_length, cert30_step_22_18, cert30_step_18_22]

theorem cert30_row_23 :
    closedCollarParentIndexValid word fiber30 cert30.parents 23 = true := by
  have cert30_fiber_length : fiber30.length = 48 := by decide
  unfold closedCollarParentIndexValid closedCollarParentAt
  simp [cert30, listGetD, cert30_fiber_length, cert30_step_23_20, cert30_step_20_23]
...
theorem cert30_row_27 :
  ...
  have cert30_fiber_length : fiber30.length = 48 := by decide
  unfold closedCollarParentIndexValid closedCollarParentAt
  simp [cert30, listGetD, cert30_fiber_length, cert30_step_27_24, cert30_step_24_27]
...
theorem cert30_row_31 :
  ...
  have cert30_fiber_length : fiber30.length = 48 := by decide
  unfold closedCollarParentIndexValid closedCollarParentAt
  simp [cert30, listGetD, cert30_fiber_length, cert30_step_31_28, cert30_step_28_31]
...
theorem cert30_row_38 :
  ...
  have cert30_fiber_length : fiber30.length = 48 := by decide
  unfold closedCollarParentIndexValid closedCollarParentAt
  simp [cert30, listGetD, cert30_fiber_length, cert30_step_38_30, cert30_step_30_38]

theorem cert30_row_39 :
    closedCollarParentIndexValid word fiber30 cert30.parents 39 = true := by
  have cert30_fiber_length : fiber30.length = 48 := by decide
  unfold closedCollarParentIndexValid closedCollarParentAt
  simp [cert30, listGetD, cert30_fiber_length, cert30_step_39_31, cert30_step_31_39]
...
theorem cert30_row_44 :
  ...
  have cert30_fiber_length : fiber30.length = 48 := by decide
  unfold closedCollarParentIndexValid closedCollarParentAt
  simp [cert30, listGetD, cert30_fiber_length, cert30_step_44_24, cert30_step_24_44]

theorem cert30_row_45 :
    closedCollarParentIndexValid word fiber30 cert30.parents 45 = true := by
  have cert30_fiber_length : fiber30.length = 48 := by decide
  unfold closedCollarParentIndexValid closedCollarParentAt
  simp [cert30, listGetD, cert30_fiber_length, cert30_step_45_25, cert30_step_25_45]

theorem cert30_row_46 :
    closedCollarParentIndexValid word fiber30 cert30.parents 46 = true := by
  have cert30_fiber_length : fiber30.length = 48 := by decide
  unfold closedCollarParentIndexValid closedCollarParentAt
  simp [cert30, listGetD, cert30_fiber_length, cert30_step_46_26, cert30_step_26_46]

theorem cert30_row_47 :
    closedCollarParentIndexValid word fiber30 cert30.parents 47 = true := by
  have cert30_fiber_length : fiber30.length = 48 := by decide
  unfold closedCollarParentIndexValid closedCollarParentAt
  simp [cert30, listGetD, cert30_fiber_length, cert30_step_47_27, cert30_step_27_47]
