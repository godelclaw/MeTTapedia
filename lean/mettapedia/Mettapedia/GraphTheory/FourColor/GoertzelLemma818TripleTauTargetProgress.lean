...
fixed-input fibers, and the first six blocks of a fourth large fiber are certified
...
large fibers and the first six 64-row blocks of the next large fiber are
certified.
