...
fixed-input fibers, and the first three blocks of a fourth large fiber are certified
...
large fibers and the first three 64-row blocks of the next large fiber are
certified.
