...
theorem twentiethCatalogueProofDagContractTraceMapPurplePurple_checker :
    Tree.checkAt twentiethCatalogueProofDagContractTraceTarget 10
      (twentiethCatalogueProofDagContractTraceMapBranch .purple .purple)
      [.purple, .purple] = true := by
  rfl
