...
- Move 2: derive the no-evader/subset certificate from the uniform CAP5 shell
  ...
  residual scheduler transition to either promote each selected edge with new
  certified control information or formalize the genuine vertex-Kirchhoff/path-xor
  evader produced by failure of that certificate.
