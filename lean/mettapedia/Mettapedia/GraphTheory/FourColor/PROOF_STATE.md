...
the first 64 rows of the third large `TTT` fiber certified, but not the
...
first two large `TTT` fibers certified plus the first 64 rows of the third
large `TTT` fiber; and the remaining semantic certificates are still open for
the other 448 rows of `[r,b,r,b]`, the other nine large `TTT` fibers, and for
...
certified, the second large `[r,r,p,p]` fiber certified, and rows 0 through 63
of the third large `[r,b,r,b]` fiber certified.  The remaining semantic work is
the other 448 rows of `[r,b,r,b]`, the other nine large `TTT` fibers, plus
`mode00/mode01/mode02/mode03/mode05/mode06/mode08/mode12/mode13/mode14/mode15/mode17/mode19`.
