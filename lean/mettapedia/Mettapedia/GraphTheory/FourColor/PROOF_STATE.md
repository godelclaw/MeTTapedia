...
- Move 2: derive the no-evader/subset certificate from the uniform CAP5 shell
  data, or run the residual scheduler fork to exhibit and formalize the
  genuine vertex-Kirchhoff/path-xor evader produced by failure of that
  certificate.
