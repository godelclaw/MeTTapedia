...
light fibers certified and nine of its twelve large `TTT` fibers fully certified,
...
first nine large `TTT` fibers certified; and the remaining semantic
certificates are still open for the other three large `TTT` fibers and for
...
`[p,r,p,r]` fiber certified.  The remaining semantic work is the other three
...
and the nine completed large-fiber theorems, and verifies the current split of
4,992 certified states versus 1,536 states still in named large fibers.
The ninth large fiber `[p,r,p,r]` is now closed by
`tttLargeFiber60ClosedProgressAudit_ok` and
`tttLargeFiber60ComponentCertificateAudit_ok`.  This is a structured partial
