...
- Projected-generator edge-40/color-1M lab rerun archived locally as
  ...
  Algebraic-F2 estimate is PLN STV `<0.90,0.95>`, ITV `[0.86,0.91]`,
  progress `99%`.
