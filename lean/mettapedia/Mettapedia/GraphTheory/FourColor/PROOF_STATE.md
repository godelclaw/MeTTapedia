...
fibers, and now also checks the first four 64-row blocks of the next large fiber
`[r,p,r,p]` by `tttLargeFiber20Block3ProgressAudit_ok`.  With those blocks,
2,176 `TTT` states have explicit target-surface certificates and 4,352 states
