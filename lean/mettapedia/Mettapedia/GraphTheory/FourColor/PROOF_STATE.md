...
first 384 rows of the second large `TTT` fiber certified, but not the
...
first large `TTT` fiber certified plus the first 384 rows of the second
large `TTT` fiber; and the remaining semantic certificates are still open for
the remaining 128 rows of `[r,r,p,p]`, the other ten large `TTT` fibers, and for
...
certified, and the first 384 rows of the second large `[r,r,p,p]` fiber
certified.  The remaining semantic work is the other 128 rows of `[r,r,p,p]`,
