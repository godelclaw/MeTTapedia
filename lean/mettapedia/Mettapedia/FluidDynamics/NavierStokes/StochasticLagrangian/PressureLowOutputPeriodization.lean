...
/-!
# Periodic low-output pressure kernels
...
namespace Mettapedia.FluidDynamics.NavierStokes.PressureLowOutputPeriodization

open MeasureTheory PeriodicFourierTriad FourierPressureCommutator PancakeBilinearPeriodization
open FrequencyPairPeriodization PressureLowOutputOperatorKernel PressureBilinearOperator
open PressureLowOutputCutoff PressureLowOutputSymbol PressureLowOutputPhysicalKernel
...
theorem exists_uniform_mass :
  ...
  obtain ⟨C, hC, hb⟩ := PressureLowOutputOperatorKernel.exists_uniform_mass
  refine ⟨C, hC, ?_⟩
...
theorem exists_uniform_firstMoment :
  ...
  obtain ⟨C, hC, hb⟩ := PressureLowOutputOperatorKernel.exists_uniform_firstMoment
  refine ⟨C, hC, ?_⟩
  intro N hN t ht e he
...
theorem exists_uniform_mass_budget :
  ...
  obtain ⟨C, hC, hb⟩ := PressureLowOutputOperatorBudget.exists_uniform_mass_budget
  refine ⟨C, hC, ?_⟩
  intro N hN e he
...
theorem exists_uniform_firstMoment_budget :
  ...
  obtain ⟨C, hC, hb⟩ := PressureLowOutputOperatorBudget.exists_uniform_firstMoment_budget
  refine ⟨C, hC, ?_⟩
  intro N hN e he
  obtain ⟨hsum, hbound⟩ := hb N hN e he
...
end Mettapedia.FluidDynamics.NavierStokes.PressureLowOutputPeriodization
