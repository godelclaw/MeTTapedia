...
/-!
# Complex-bilinear low-output pressure kernels
...
namespace Mettapedia.FluidDynamics.NavierStokes.PressureLowOutputOperatorKernel
...
open PressureLowOutputScaledKernel PressureOperatorCoordinates PressureBilinearOperator
...
theorem exists_uniform_mass :
  ...
  obtain ⟨C, hC, hb⟩ := PressureLowOutputScaledKernel.exists_uniform_basis_mass
...
theorem exists_uniform_firstMoment :
  ...
  obtain ⟨C, hC, hb⟩ := PressureLowOutputScaledKernel.exists_uniform_basis_firstMoment
  refine ⟨27 * C, mul_nonneg (by norm_num) hC, ?_⟩
  intro N hN t ht e he
...
end Mettapedia.FluidDynamics.NavierStokes.PressureLowOutputOperatorKernel
