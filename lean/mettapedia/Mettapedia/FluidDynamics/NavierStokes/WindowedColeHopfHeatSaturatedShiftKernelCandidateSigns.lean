...
/-!
# Windowed Cole-Hopf Saturated Shift-Kernel: CandidateSigns

Candidate-equality coefficient identity, zero-mass, and sign obstructions for invariant shift kernels.
-/
