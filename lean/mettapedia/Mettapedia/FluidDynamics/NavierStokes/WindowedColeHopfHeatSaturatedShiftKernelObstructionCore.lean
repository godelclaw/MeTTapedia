...
/-!
# Saturated obstruction for finite shift kernels: core zero-anchor surfaces

Main finite shift-kernel obstruction lemmas using zero seeded anchors,
nonzero live anchors, and zero-anchor coefficient sums.
-/
