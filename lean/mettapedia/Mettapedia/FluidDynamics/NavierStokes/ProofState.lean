...
def navierBKMVorticityGrowthNode : NavierProofNode where
  ...
  blocker := "This closes the pointwise density derivative, pointwise transport algebra, Schwartz-vorticity-slice diffusion IBP, the witness-level Schwartz-slice a-priori enstrophy estimate, the integrated stretching-growth inequality under explicit integrability/gradient-bound hypotheses, and standard-equation-to-raw-enstrophy algebra once the time-pairing derivative and scalar-pairing integrability are supplied. The remaining analytic work is lifting the pointwise time derivative through the spatial integral, proving the transported half-enstrophy density has zero integral from incompressibility and boundary/decay, proving the finite-energy witness vorticity-slice decay/approximation needed for diffusion IBP, and proving the genuine Biot-Savart/log-Sobolev pointwise inequality."
