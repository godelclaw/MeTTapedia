...
theorem currentNavierBKMResidualCurlDifferentialIdentities_node
  ...
  exact
    ⟨residualCurlExpansionClosedOn_of_differentialIdentitiesClosedOn hIds,
      ...
      BKMVorticityFiniteTimeWitnessResidualCurlAprioriClosed_proved,
      BKMVorticityFiniteTimeWitnessResidualCurlAffineLogGrowthClosed_proved,
      (BKMContinuation_reduced_to_affineLogHighNorm_after_residualCurl).2.2.2,
