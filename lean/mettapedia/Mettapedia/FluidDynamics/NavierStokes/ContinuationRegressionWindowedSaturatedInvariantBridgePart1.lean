...
/-!
# Saturated shift-kernel invariant bridge regression checks

Top-down bridge regressions for the windowed saturated shift-kernel invariant
route, separated from the candidate-only surface.
-/
