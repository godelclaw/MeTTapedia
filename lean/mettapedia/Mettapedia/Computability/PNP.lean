...
This is the public Lean entrypoint for the current PNP route-audit work.  It
imports the live route-audit surface, proof-state summary, and roadmap, not the
broad regression archive.
-/
