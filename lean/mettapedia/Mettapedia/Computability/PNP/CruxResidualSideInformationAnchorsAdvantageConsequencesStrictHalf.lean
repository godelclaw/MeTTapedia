...
/-!
# P vs NP crux: residual side-information strict half-advantage consequences

Strict half-accuracy route-coverage consequences for residual side information.
-/
