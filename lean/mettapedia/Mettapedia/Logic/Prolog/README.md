...
| [SourceRuntime.lean](SourceRuntime.lean) | concrete source-signature services for the shared runtime, including meta-call, term inspection, `=../2`, exceptions, collections, and the persistent database |
