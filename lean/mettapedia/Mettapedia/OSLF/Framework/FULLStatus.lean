...
def tracker : List Milestone :=
  ...
  , { area := "Literature Alignment"
      ...
      status := .done
      codeRef := "Mettapedia/OSLF/Framework/CategoryBridge.lean: languageSortPredNaturality_and / languageSortPredNaturality_or / languageSortFiber_ofPatternPred_mem_iff_and / languageSortFiber_ofPatternPred_mem_iff_or / languageSort_conj_disj_topos_package; Rho and OSLF/oslf.pdf (\"Conjunction. TBD\" / \"Disjunction. TBD\")"
...
def strictTracker : List Milestone :=
  ...
  [ { area := "OSLF Paper Section 12"
      ...
      status := .done
      codeRef := "Mettapedia/OSLF/Framework/PaperSection12Examples.lean: compile_time_firewall_worked_example; Rho and OSLF/oslf.pdf §12.1 (TBD)"
  ...
  , { area := "OSLF Paper Section 12"
      ...
      status := .done
      codeRef := "Mettapedia/OSLF/Framework/PaperSection12Examples.lean: race_detection_worked_example; Rho and OSLF/oslf.pdf §12.2 (TBD)"
  ...
  , { area := "OSLF Paper Section 12"
      ...
      status := .done
      codeRef := "Mettapedia/OSLF/Framework/PaperSection12Examples.lean: secrecy_worked_example; Rho and OSLF/oslf.pdf §12.3 (TBD)"
  ...
  , { area := "OSLF Paper Future Work"
      ...
      status := .done
      codeRef := "Mettapedia/OSLF/Framework/GeneratedTyping.lean: depDiamond/depBox/paramDiamond/paramBox, dep_quote/dep_drop/param_quote/param_drop, dependent_parametric_generated_type_system_extension, rhoCalc_dependent_parametric_generated_type_system_extension; Rho and OSLF/oslf.pdf §13.1"
  ...
  , { area := "Native Type Theory Future Work"
      ...
      status := .done
      codeRef := "Mettapedia/OSLF/NativeType/Construction.lean: TheoryMorphism.colax_piType/lax_piType, TheoryMorphism.colax_sigmaType/lax_sigmaType, TheoryMorphism.colax_propImp/lax_propImp, TheoryMorphism.colax_pi_elim/colax_pi_intro, TheoryMorphism.colax_sigma_intro/colax_sigma_elim, TheoryMorphism.colax_prop_mp/colax_prop_intro, TheoryMorphism.PiPropColaxRuleSet, TheoryMorphism.PiSigmaPropColaxRuleSet, TheoryMorphism.piProp_colax_rules, TheoryMorphism.piSigmaProp_colax_rules, TheoryMorphism.comp, TheoryMorphism.comp_piProp_colax_rules, TheoryMorphism.comp_piSigmaProp_colax_rules; Rho and OSLF/Native_Type_Theory.pdf lines ~514, ~676"
...
- `Rho and OSLF/oslf.pdf`
- `Rho and OSLF/Native_Type_Theory.pdf`
- `Rho and OSLF/togl.pdf`
