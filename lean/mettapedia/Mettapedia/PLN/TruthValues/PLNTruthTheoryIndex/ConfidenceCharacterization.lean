...
def plnITVIDMRuntimeParityManifest : RuntimeParityManifest where
  projectionTowerPeTTaPath :=
    "PeTTa/examples/pln_projection_tower_bool_canary.metta"
  projectionTowerCeTTaPath :=
    "CeTTa/tests/test_wmpln_projection_tower_bool_canary.metta"
  projectionTowerExpectedChecks := 15
  itvIDMPeTTaPath :=
    "PeTTa/examples/pln_itv_idm_parity_golden.metta"
  itvIDMCeTTaPath :=
    "CeTTa/tests/test_wmpln_itv_idm_parity_golden.metta"
  itvIDMExpectedChecks := 26
  truthFunctionPeTTaPath :=
    "PeTTa/examples/pln_truth_parity_golden.metta"
  truthFunctionCeTTaPath :=
    "CeTTa/tests/test_wmpln_truth_parity_golden.metta"
  truthFunctionExpectedChecks := 11
  strengthPriorPeTTaPath :=
    "PeTTa/examples/pln_strength_prior_canary.metta"
  strengthPriorCeTTaPath :=
    "CeTTa/tests/test_wmpln_strength_prior_canary.metta"
