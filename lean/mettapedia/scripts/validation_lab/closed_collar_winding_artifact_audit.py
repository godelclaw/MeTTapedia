...
def audit_n8_frontier(prefix_results_dir: Path, stratified_results_dir: Path) -> dict[str, object]:
    ...
    assert_equal("n8 prefix end", prefix_ranges[-1]["next_patch_start_index"], 4_000_000)
    assert_equal("n8 prefix processed count", prefix_totals["processed_patch_topology_count"], 4_000_000)
    assert_equal("n8 prefix radial-order count", prefix_totals["radial_order_case_count"], 8_000_000)
    ...
    return {
        ...
        "prefix": {
            **dict(prefix_totals),
            "verdict": "n8_first_4000000_found_no_profile_preserving_patch",
        },
