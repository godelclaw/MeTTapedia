...
namespace Krenn.X5Case64Tree.LeafB5_5

open Krenn.SparseCertificate
open MvPolynomial

def sourceSystemFileSHA256 : String := "f738256d6f2ce9b4ab8aac6cff67b0700f469616af44c73670ea01a22d2878c9"
def sourceSystemSemanticSHA256 : String := "a4a34cb21a0e15191abca06ae71990d7270dd89c3b8a3fce8449bc0debf87073"
...
def multipliers : Fin 25 → SparsePoly (Fin 74) := ![
  [{ coefficient := -1, powers := [(1, 1), (11, 1), (17, 1), (32, 1), (42, 1), (54, 1), (59, 1), (73, 1)] }, { coefficient := 1, powers := [(1, 1), (19, 1), (32, 1), (42, 1), (54, 1), (59, 1), (73, 1)] }, { coefficient := -1, powers := [(9, 1), (33, 1), (42, 1), (53, 1), (73, 1)] }, { coefficient := -1, powers := [(11, 1), (17, 1), (32, 1), (42, 1), (50, 1), (54, 1), (73, 1)] }, { coefficient := 1, powers := [(12, 1), (32, 1), (42, 1), (50, 1), (53, 1), (73, 1)] }, { coefficient := 1, powers := [(19, 1), (32, 1), (42, 1), (50, 1), (54, 1), (73, 1)] }],
  [{ coefficient := -1, powers := [(11, 1), (17, 1), (26, 1), (32, 1), (42, 1), (54, 1), (73, 1)] }, { coefficient := 1, powers := [(19, 1), (26, 1), (32, 1), (42, 1), (54, 1), (73, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (33, 1), (36, 1), (62, 1), (72, 1)] }],
  [{ coefficient := 1, powers := [(11, 1), (17, 1), (40, 1), (68, 1), (72, 1)] }],
  [{ coefficient := -1, powers := [(11, 1), (17, 1), (42, 1), (72, 1)] }, { coefficient := 1, powers := [(11, 1), (62, 1), (72, 1)] }],
  [{ coefficient := 1, powers := [(11, 1), (26, 1), (32, 1), (42, 1), (54, 1), (73, 1)] }, { coefficient := -1, powers := [(29, 1), (32, 1), (42, 1), (54, 1), (73, 1)] }],
  [{ coefficient := 1, powers := [(29, 1), (32, 1), (42, 1), (53, 1), (73, 1)] }],
  [{ coefficient := 1, powers := [(20, 1), (24, 1), (36, 1), (58, 1), (62, 1), (72, 2)] }, { coefficient := 1, powers := [(20, 1), (32, 1), (36, 1), (62, 1), (72, 1)] }, { coefficient := 1, powers := [(20, 1), (32, 1), (42, 1), (53, 1), (57, 1), (72, 1), (73, 1)] }],
  [{ coefficient := -1, powers := [(33, 1), (42, 1), (54, 1), (73, 1)] }],
  [{ coefficient := 1, powers := [(11, 1), (42, 1), (72, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (36, 1), (58, 1), (62, 1), (72, 2)] }, { coefficient := -1, powers := [(32, 1), (36, 1), (62, 1), (72, 1)] }],
  ...
  [{ coefficient := 1, powers := [(11, 1), (39, 1), (68, 1), (72, 1)] }, { coefficient := 1, powers := [(33, 1), (36, 1), (62, 1), (72, 1)] }],
  ...
  [{ coefficient := -1, powers := [(11, 1), (39, 1), (68, 1)] }, { coefficient := -1, powers := [(11, 1), (42, 1), (65, 1)] }, { coefficient := -1, powers := [(11, 1), (48, 1), (62, 1)] }, { coefficient := -1, powers := [(20, 1), (32, 1), (42, 1), (50, 1), (53, 1), (57, 1), (73, 1)] }, { coefficient := 1, powers := [(24, 1), (33, 1), (36, 1), (40, 1), (58, 1), (62, 1), (72, 1)] }, { coefficient := -1, powers := [(33, 1), (36, 1), (62, 1)] }],
...
#print axioms Krenn.X5Case64Tree.LeafB5_5.selectedHasNoCommonZero

end Krenn.X5Case64Tree.LeafB5_5
