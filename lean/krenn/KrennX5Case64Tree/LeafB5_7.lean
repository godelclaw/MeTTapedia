...
namespace Krenn.X5Case64Tree.LeafB5_7

open Krenn.SparseCertificate
open MvPolynomial

def sourceSystemFileSHA256 : String := "629cec39435beb297b2fed41492ab75e105f550ddf6404b482220ab1bffa59be"
def sourceSystemSemanticSHA256 : String := "3208145365a5a66aedf56ef487d32fde43d3b632daacb6bf7b956e2bf9e0448e"
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedEquations : Fin 17 → SparsePoly (Fin 75) := ![
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def multipliers : Fin 17 → SparsePoly (Fin 75) := ![
  [{ coefficient := 1, powers := [(11, 1), (40, 1), (47, 1), (68, 1), (74, 1)] }],
  [{ coefficient := 1, powers := [(24, 1), (55, 1), (72, 1), (73, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (72, 1)] }, { coefficient := 1, powers := [(13, 1), (24, 1), (72, 1)] }],
  [{ coefficient := 1, powers := [(11, 1), (17, 1), (32, 1), (40, 1), (42, 1), (72, 1)] }, { coefficient := -1, powers := [(11, 1), (32, 1), (40, 1), (62, 1), (72, 1)] }],
  [{ coefficient := -1, powers := [(11, 1), (40, 1), (68, 1), (74, 1)] }],
  [{ coefficient := -1, powers := [(11, 1), (32, 1), (40, 1), (42, 1), (72, 1)] }],
  [{ coefficient := 1, powers := [(33, 1), (40, 1), (47, 1)] }],
  [{ coefficient := -1, powers := [(28, 1), (32, 1), (40, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (32, 1), (40, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (72, 1)] }],
  ...
  [{ coefficient := -1, powers := [(23, 1), (24, 1), (55, 1), (72, 1)] }],
...
#print axioms Krenn.X5Case64Tree.LeafB5_7.selectedHasNoCommonZero

end Krenn.X5Case64Tree.LeafB5_7
