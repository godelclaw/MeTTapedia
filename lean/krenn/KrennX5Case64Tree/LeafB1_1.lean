...
namespace Krenn.X5Case64Tree.LeafB1_1

open Krenn.SparseCertificate
open MvPolynomial

def sourceSystemFileSHA256 : String := "a5c1b74e6beb410c6f0bd677a1c360612d9f7430d65d41b4b1cbce5fced79aac"
def sourceSystemSemanticSHA256 : String := "be20b0abf04633fca2c5dd66af1acff7906076169df94b7c6c7428d6f6bd035a"
def certificateSHA256 : String := "f592839bbf7919f1f34136e8bdc7a5a5f5a87d19ed205ee9ad2512661271e342"
...
def multipliers : Fin 18 → SparsePoly (Fin 72) := ![
  [{ coefficient := -1, powers := [(0, 1), (25, 1), (33, 1), (36, 1), (53, 1), (58, 1)] }, { coefficient := 1, powers := [(0, 1), (33, 1), (42, 1), (53, 1), (58, 1)] }, { coefficient := 1, powers := [(5, 1), (24, 1), (25, 1), (33, 1), (36, 1), (53, 1), (58, 1)] }, { coefficient := -1, powers := [(5, 1), (24, 1), (33, 1), (42, 1), (53, 1), (58, 1)] }, { coefficient := -1, powers := [(25, 1), (32, 1), (33, 1), (35, 1), (36, 1), (53, 1)] }, { coefficient := 1, powers := [(32, 1), (33, 1), (35, 1), (42, 1), (53, 1)] }],
  [{ coefficient := -1, powers := [(11, 1), (14, 1), (25, 1), (70, 1)] }, { coefficient := 1, powers := [(11, 1), (30, 1), (70, 1)] }],
  [{ coefficient := 1, powers := [(24, 1), (25, 1), (33, 1), (36, 1), (52, 1)] }, { coefficient := -1, powers := [(24, 1), (33, 1), (42, 1), (52, 1)] }],
  [{ coefficient := 1, powers := [(11, 1), (14, 1), (50, 1), (70, 1)] }, { coefficient := 1, powers := [(33, 1), (36, 1)] }],
  [{ coefficient := -1, powers := [(16, 1), (25, 1), (33, 1), (36, 1), (53, 1)] }, { coefficient := 1, powers := [(16, 1), (33, 1), (42, 1), (53, 1)] }, { coefficient := 1, powers := [(21, 1), (24, 1), (25, 1), (33, 1), (36, 1), (53, 1)] }, { coefficient := -1, powers := [(21, 1), (24, 1), (33, 1), (42, 1), (53, 1)] }],
  [{ coefficient := -1, powers := [(11, 1), (25, 1)] }, { coefficient := 1, powers := [(28, 1)] }],
  [{ coefficient := -1, powers := [(11, 1), (17, 1)] }, { coefficient := 1, powers := [(19, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (25, 1), (33, 1), (36, 1), (53, 1)] }, { coefficient := 1, powers := [(8, 1), (33, 1), (42, 1), (53, 1)] }, { coefficient := 1, powers := [(13, 1), (24, 1), (25, 1), (33, 1), (36, 1), (53, 1)] }, { coefficient := -1, powers := [(13, 1), (24, 1), (33, 1), (42, 1), (53, 1)] }],
  [{ coefficient := -1, powers := [(25, 1), (33, 1), (36, 1), (52, 1)] }, { coefficient := 1, powers := [(33, 1), (42, 1), (52, 1)] }],
  [{ coefficient := -1, powers := [(11, 1), (70, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (25, 1), (33, 1), (36, 1), (53, 1)] }, { coefficient := 1, powers := [(24, 1), (33, 1), (42, 1), (53, 1)] }],
  ...
  [{ coefficient := -1, powers := [(0, 1), (25, 1), (33, 1), (36, 1), (53, 1), (64, 1)] }, { coefficient := 1, powers := [(0, 1), (33, 1), (42, 1), (53, 1), (64, 1)] }, { coefficient := 1, powers := [(5, 1), (24, 1), (25, 1), (33, 1), (36, 1), (53, 1), (64, 1)] }, { coefficient := -1, powers := [(5, 1), (24, 1), (33, 1), (42, 1), (53, 1), (64, 1)] }, { coefficient := -1, powers := [(25, 1), (32, 1), (33, 1), (36, 1), (38, 1), (53, 1)] }, { coefficient := 1, powers := [(32, 1), (33, 1), (38, 1), (42, 1), (53, 1)] }],
  [{ coefficient := 1, powers := [(3, 1), (65, 1)] }, { coefficient := 1, powers := [(7, 1), (11, 1), (65, 1), (70, 1)] }, { coefficient := -1, powers := [(11, 1), (14, 1), (17, 1), (50, 1), (70, 1)] }, { coefficient := 1, powers := [(11, 1), (22, 1), (50, 1), (70, 1)] }, { coefficient := -1, powers := [(11, 1), (65, 1)] }, { coefficient := -1, powers := [(17, 1), (33, 1), (36, 1)] }, { coefficient := 1, powers := [(33, 1), (39, 1)] }]
]
...
#print axioms Krenn.X5Case64Tree.LeafB1_1.selectedHasNoCommonZero

end Krenn.X5Case64Tree.LeafB1_1
