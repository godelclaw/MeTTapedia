...
namespace Krenn.X5Case64Tree.LeafB5_3

open Krenn.SparseCertificate
open MvPolynomial

def sourceSystemFileSHA256 : String := "5fc35f0e35002bbbb1acf2f56b597e71bb51922c9b48b204c7a88cc89c022ac4"
def sourceSystemSemanticSHA256 : String := "31d4ca0a526e78d64df831c179c5bf87c6ae0fb8c2101a81f4b0384576310764"
def certificateSHA256 : String := "771539535a627bee867034563adc9a76f25ab233255f69cde82ac10598b909fc"
def sourceEquationCount : Nat := 681

set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedIndices : Fin 11 → Fin 681 := ![
  412,
  420,
  422,
  423,
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedEquations : Fin 11 → SparsePoly (Fin 74) := ![
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def multipliers : Fin 11 → SparsePoly (Fin 74) := ![
  [{ coefficient := 1, powers := [(72, 1)] }],
  [{ coefficient := -1, powers := [(11, 1), (32, 1), (40, 1), (45, 1), (70, 1)] }, { coefficient := 1, powers := [(33, 1), (40, 1), (47, 1)] }],
  ...
  [{ coefficient := 1, powers := [(11, 1), (32, 1), (40, 1), (70, 1)] }],
  [{ coefficient := -1, powers := [(33, 1), (40, 1)] }],
  [{ coefficient := -1, powers := [(11, 1), (32, 1), (40, 1)] }],
  [{ coefficient := 1, powers := [(32, 1), (40, 1)] }],
  [{ coefficient := -1, powers := [(11, 1), (32, 1), (40, 1), (53, 1), (68, 1)] }, { coefficient := -1, powers := [(11, 1), (32, 1), (40, 1), (56, 1), (65, 1)] }, { coefficient := -1, powers := [(11, 1), (32, 1), (40, 1), (59, 1), (62, 1)] }],
...
#print axioms Krenn.X5Case64Tree.LeafB5_3.selectedHasNoCommonZero

end Krenn.X5Case64Tree.LeafB5_3
