...
import KrennFrozenCase0NoncollapseType01Chart3BothLiveSumNonzeroB1W05B3Certificate

/-!
Semantic reflection of the strict B1 `w_05` B3 certificate.

This is the `w_05_00 = 0`, `w_05_02 ≠ 0`, `w_05_22 ≠ 0` face of the
frozen W05 split.  The selected identity consists of seventeen canonical
rows and nine explicit branch/inverse rows; each is reconstructed below
from the chart geometry and the named face assumptions.
-/

namespace Krenn.FrozenCase0NoncollapseType01Chart3BothLiveSumNonzeroB1W05Zero00Live02Live22Bridge
...
def selectedSourceIndex : Fin 17 → Fin 747 := ![
  394, 362, 182, 32, 40, 605, 556, 660, 162,
  644, 663, 354, 301, 488, 743, 336, 746
]

theorem selected_source_not_determinant (index : Fin 17) (slot : Fin 18) :
...
theorem refutes_chart3_b1_w05_00_zero_w05_02_w05_22_live
    ...
    (h12_12 : values 29 = 0)
    (h05_00 : values 17 = 0) (h05_02 : values 18 ≠ 0)
  ...
  apply Krenn.FrozenCase0NoncollapseType01Chart3BothLiveSumNonzeroB1W05B3Certificate.selectedHasNoCommonZero (leafValues values)
  intro index
  fin_cases index
  · simp [Krenn.FrozenCase0NoncollapseType01Chart3BothLiveSumNonzeroB1W05B3Certificate.selectedEquations, leafValues, selectedSourceIndex, sourceValue, Krenn.FrozenCase0System.equations, SparsePoly.toPoly, SparseTerm.toPoly, slotDeterminant, slotA1, slotB1, slotA2, slotB2, factorL, factorGa, factorGb, h23, h12, h13, h13_10, h13_12, h12_10, h12_12, h25_12, h25_21, h25_22, h34_12, h34_20, h34_21, h34_22, h05_00, h05_02, h05_22] at source0 ⊢ <;> ring_nf at source0 ⊢ <;> exact source0
  · simp [Krenn.FrozenCase0NoncollapseType01Chart3BothLiveSumNonzeroB1W05B3Certificate.selectedEquations, leafValues, selectedSourceIndex, sourceValue, Krenn.FrozenCase0System.equations, SparsePoly.toPoly, SparseTerm.toPoly, slotDeterminant, slotA1, slotB1, slotA2, slotB2, factorL, factorGa, factorGb, h23, h12, h13, h13_10, h13_12, h12_10, h12_12, h25_12, h25_21, h25_22, h34_12, h34_20, h34_21, h34_22, h05_00, h05_02, h05_22] at source1 ⊢ <;> ring_nf at source1 ⊢ <;> exact source1
  · simp [Krenn.FrozenCase0NoncollapseType01Chart3BothLiveSumNonzeroB1W05B3Certificate.selectedEquations, leafValues, selectedSourceIndex, sourceValue, Krenn.FrozenCase0System.equations, SparsePoly.toPoly, SparseTerm.toPoly, slotDeterminant, slotA1, slotB1, slotA2, slotB2, factorL, factorGa, factorGb, h23, h12, h13, h13_10, h13_12, h12_10, h12_12, h25_12, h25_21, h25_22, h34_12, h34_20, h34_21, h34_22, h05_00, h05_02, h05_22] at source2 ⊢
    exact source2
  · simp [Krenn.FrozenCase0NoncollapseType01Chart3BothLiveSumNonzeroB1W05B3Certificate.selectedEquations, leafValues, selectedSourceIndex, sourceValue, Krenn.FrozenCase0System.equations, SparsePoly.toPoly, SparseTerm.toPoly, slotDeterminant, slotA1, slotB1, slotA2, slotB2, factorL, factorGa, factorGb, h23, h12, h13, h13_10, h13_12, h12_10, h12_12, h25_12, h25_21, h25_22, h34_12, h34_20, h34_21, h34_22, h05_00, h05_02, h05_22] at source3 ⊢ <;> ring_nf at source3 ⊢ <;> exact source3
  · simp [Krenn.FrozenCase0NoncollapseType01Chart3BothLiveSumNonzeroB1W05B3Certificate.selectedEquations, leafValues, selectedSourceIndex, sourceValue, Krenn.FrozenCase0System.equations, SparsePoly.toPoly, SparseTerm.toPoly, slotDeterminant, slotA1, slotB1, slotA2, slotB2, factorL, factorGa, factorGb, h23, h12, h13, h13_10, h13_12, h12_10, h12_12, h25_12, h25_21, h25_22, h34_12, h34_20, h34_21, h34_22, h05_00, h05_02, h05_22] at source4 ⊢
  · simp [Krenn.FrozenCase0NoncollapseType01Chart3BothLiveSumNonzeroB1W05B3Certificate.selectedEquations, leafValues, selectedSourceIndex, sourceValue, Krenn.FrozenCase0System.equations, SparsePoly.toPoly, SparseTerm.toPoly, slotDeterminant, slotA1, slotB1, slotA2, slotB2, factorL, factorGa, factorGb, h23, h12, h13, h13_10, h13_12, h12_10, h12_12, h25_12, h25_21, h25_22, h34_12, h34_20, h34_21, h34_22, h05_00, h05_02, h05_22] at source5 ⊢ <;> ring_nf at source5 ⊢ <;> exact source5
  · simp [Krenn.FrozenCase0NoncollapseType01Chart3BothLiveSumNonzeroB1W05B3Certificate.selectedEquations, leafValues, selectedSourceIndex, sourceValue, Krenn.FrozenCase0System.equations, SparsePoly.toPoly, SparseTerm.toPoly, slotDeterminant, slotA1, slotB1, slotA2, slotB2, factorL, factorGa, factorGb, h23, h12, h13, h13_10, h13_12, h12_10, h12_12, h25_12, h25_21, h25_22, h34_12, h34_20, h34_21, h34_22, h05_00, h05_02, h05_22] at source6 ⊢ <;> ring_nf at source6 ⊢ <;> exact source6
  · simp [Krenn.FrozenCase0NoncollapseType01Chart3BothLiveSumNonzeroB1W05B3Certificate.selectedEquations, leafValues, selectedSourceIndex, sourceValue, Krenn.FrozenCase0System.equations, SparsePoly.toPoly, SparseTerm.toPoly, slotDeterminant, slotA1, slotB1, slotA2, slotB2, factorL, factorGa, factorGb, h23, h12, h13, h13_10, h13_12, h12_10, h12_12, h25_12, h25_21, h25_22, h34_12, h34_20, h34_21, h34_22, h05_00, h05_02, h05_22] at source7 ⊢ <;> ring_nf at source7 ⊢ <;> exact source7
  · simp [Krenn.FrozenCase0NoncollapseType01Chart3BothLiveSumNonzeroB1W05B3Certificate.selectedEquations, leafValues, selectedSourceIndex, sourceValue, Krenn.FrozenCase0System.equations, SparsePoly.toPoly, SparseTerm.toPoly, slotDeterminant, slotA1, slotB1, slotA2, slotB2, factorL, factorGa, factorGb, h23, h12, h13, h13_10, h13_12, h12_10, h12_12, h25_12, h25_21, h25_22, h34_12, h34_20, h34_21, h34_22, h05_00, h05_02, h05_22] at source8 ⊢
  · simp [Krenn.FrozenCase0NoncollapseType01Chart3BothLiveSumNonzeroB1W05B3Certificate.selectedEquations, leafValues, selectedSourceIndex, sourceValue, Krenn.FrozenCase0System.equations, SparsePoly.toPoly, SparseTerm.toPoly, slotDeterminant, slotA1, slotB1, slotA2, slotB2, factorL, factorGa, factorGb, h23, h12, h13, h13_10, h13_12, h12_10, h12_12, h25_12, h25_21, h25_22, h34_12, h34_20, h34_21, h34_22, h05_00, h05_02, h05_22] at source9 ⊢ <;> ring_nf at source9 ⊢ <;> exact source9
  · simp [Krenn.FrozenCase0NoncollapseType01Chart3BothLiveSumNonzeroB1W05B3Certificate.selectedEquations, leafValues, selectedSourceIndex, sourceValue, Krenn.FrozenCase0System.equations, SparsePoly.toPoly, SparseTerm.toPoly, slotDeterminant, slotA1, slotB1, slotA2, slotB2, factorL, factorGa, factorGb, h23, h12, h13, h13_10, h13_12, h12_10, h12_12, h25_12, h25_21, h25_22, h34_12, h34_20, h34_21, h34_22, h05_00, h05_02, h05_22] at source10 ⊢ <;> ring_nf at source10 ⊢ <;> exact source10
  · simp [Krenn.FrozenCase0NoncollapseType01Chart3BothLiveSumNonzeroB1W05B3Certificate.selectedEquations, leafValues, selectedSourceIndex, sourceValue, Krenn.FrozenCase0System.equations, SparsePoly.toPoly, SparseTerm.toPoly, slotDeterminant, slotA1, slotB1, slotA2, slotB2, factorL, factorGa, factorGb, h23, h12, h13, h13_10, h13_12, h12_10, h12_12, h25_12, h25_21, h25_22, h34_12, h34_20, h34_21, h34_22, h05_00, h05_02, h05_22] at source11 ⊢ <;> ring_nf at source11 ⊢ <;> exact source11
  · simp [Krenn.FrozenCase0NoncollapseType01Chart3BothLiveSumNonzeroB1W05B3Certificate.selectedEquations, leafValues, selectedSourceIndex, sourceValue, Krenn.FrozenCase0System.equations, SparsePoly.toPoly, SparseTerm.toPoly, slotDeterminant, slotA1, slotB1, slotA2, slotB2, factorL, factorGa, factorGb, h23, h12, h13, h13_10, h13_12, h12_10, h12_12, h25_12, h25_21, h25_22, h34_12, h34_20, h34_21, h34_22, h05_00, h05_02, h05_22] at source12 ⊢ <;> ring_nf at source12 ⊢ <;> exact source12
  · simp [Krenn.FrozenCase0NoncollapseType01Chart3BothLiveSumNonzeroB1W05B3Certificate.selectedEquations, leafValues, selectedSourceIndex, sourceValue, Krenn.FrozenCase0System.equations, SparsePoly.toPoly, SparseTerm.toPoly, slotDeterminant, slotA1, slotB1, slotA2, slotB2, factorL, factorGa, factorGb, h23, h12, h13, h13_10, h13_12, h12_10, h12_12, h25_12, h25_21, h25_22, h34_12, h34_20, h34_21, h34_22, h05_00, h05_02, h05_22] at source13 ⊢ <;> ring_nf at source13 ⊢ <;> exact source13
  · simp [Krenn.FrozenCase0NoncollapseType01Chart3BothLiveSumNonzeroB1W05B3Certificate.selectedEquations, leafValues, selectedSourceIndex, sourceValue, Krenn.FrozenCase0System.equations, SparsePoly.toPoly, SparseTerm.toPoly, slotDeterminant, slotA1, slotB1, slotA2, slotB2, factorL, factorGa, factorGb, h23, h12, h13, h13_10, h13_12, h12_10, h12_12, h25_12, h25_21, h25_22, h34_12, h34_20, h34_21, h34_22, h05_00, h05_02, h05_22] at source14 ⊢ <;> ring_nf at source14 ⊢ <;> exact source14
  · simp [Krenn.FrozenCase0NoncollapseType01Chart3BothLiveSumNonzeroB1W05B3Certificate.selectedEquations, leafValues, selectedSourceIndex, sourceValue, Krenn.FrozenCase0System.equations, SparsePoly.toPoly, SparseTerm.toPoly, slotDeterminant, slotA1, slotB1, slotA2, slotB2, factorL, factorGa, factorGb, h23, h12, h13, h13_10, h13_12, h12_10, h12_12, h25_12, h25_21, h25_22, h34_12, h34_20, h34_21, h34_22, h05_00, h05_02, h05_22] at source15 ⊢ <;> ring_nf at source15 ⊢ <;> exact source15
  · simp [Krenn.FrozenCase0NoncollapseType01Chart3BothLiveSumNonzeroB1W05B3Certificate.selectedEquations, leafValues, selectedSourceIndex, sourceValue, Krenn.FrozenCase0System.equations, SparsePoly.toPoly, SparseTerm.toPoly, slotDeterminant, slotA1, slotB1, slotA2, slotB2, factorL, factorGa, factorGb, h23, h12, h13, h13_10, h13_12, h12_10, h12_12, h25_12, h25_21, h25_22, h34_12, h34_20, h34_21, h34_22, h05_00, h05_02, h05_22] at source16 ⊢ <;> ring_nf at source16 ⊢ <;> exact source16
  · simp [Krenn.FrozenCase0NoncollapseType01Chart3BothLiveSumNonzeroB1W05B3Certificate.selectedEquations, leafValues, SparsePoly.toPoly, SparseTerm.toPoly,
      mul_inv_cancel₀ hdet, inv_mul_cancel₀ hdet]
  · simp [Krenn.FrozenCase0NoncollapseType01Chart3BothLiveSumNonzeroB1W05B3Certificate.selectedEquations, leafValues, SparsePoly.toPoly, SparseTerm.toPoly,
      mul_inv_cancel₀ h25, inv_mul_cancel₀ h25]
  · simp [Krenn.FrozenCase0NoncollapseType01Chart3BothLiveSumNonzeroB1W05B3Certificate.selectedEquations,
      leafValues, SparsePoly.toPoly, SparseTerm.toPoly,
      mul_inv_cancel₀ hsum, inv_mul_cancel₀ hsum]
    calc
  ...
  · simp [Krenn.FrozenCase0NoncollapseType01Chart3BothLiveSumNonzeroB1W05B3Certificate.selectedEquations, leafValues, SparsePoly.toPoly, SparseTerm.toPoly, h12_10]
  · simp [Krenn.FrozenCase0NoncollapseType01Chart3BothLiveSumNonzeroB1W05B3Certificate.selectedEquations, leafValues, SparsePoly.toPoly, SparseTerm.toPoly, h12_12]
  · simp [Krenn.FrozenCase0NoncollapseType01Chart3BothLiveSumNonzeroB1W05B3Certificate.selectedEquations, leafValues, SparsePoly.toPoly, SparseTerm.toPoly,
      mul_inv_cancel₀ h01, inv_mul_cancel₀ h01]
  · simp [Krenn.FrozenCase0NoncollapseType01Chart3BothLiveSumNonzeroB1W05B3Certificate.selectedEquations, leafValues, SparsePoly.toPoly, SparseTerm.toPoly, h34_12]
  · simp [Krenn.FrozenCase0NoncollapseType01Chart3BothLiveSumNonzeroB1W05B3Certificate.selectedEquations, leafValues, SparsePoly.toPoly, SparseTerm.toPoly,
      mul_inv_cancel₀ h05_02, inv_mul_cancel₀ h05_02]
  · simp [Krenn.FrozenCase0NoncollapseType01Chart3BothLiveSumNonzeroB1W05B3Certificate.selectedEquations, leafValues, SparsePoly.toPoly, SparseTerm.toPoly,
      mul_inv_cancel₀ h05_22, inv_mul_cancel₀ h05_22]

#print axioms Krenn.FrozenCase0NoncollapseType01Chart3BothLiveSumNonzeroB1W05Zero00Live02Live22Bridge.refutes_chart3_b1_w05_00_zero_w05_02_w05_22_live

end Krenn.FrozenCase0NoncollapseType01Chart3BothLiveSumNonzeroB1W05Zero00Live02Live22Bridge
