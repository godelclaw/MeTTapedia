...
namespace Krenn.X5Case100Selected

open Krenn.SparseCertificate
open MvPolynomial

def sourceSystemFileSHA256 : String := "f64fc2b083e4896ceac0fcc3635cb08a68ced56d6aa989dabe2e849519b56b10"
def sourceSystemSemanticSHA256 : String := "570be3373a98ce92322b7879259c4fb7e41e9a847fd8bb9caa82769183cb00f5"
def certificateSHA256 : String := "72cac32ee03bc73d6fac5680535cee6cb9ea559928eb99c322106138a18ef54c"
...
def multipliers : Fin 25 → SparsePoly (Fin 70) := ![
  [{ coefficient := -1, powers := [(3, 1), (7, 1), (9, 1), (49, 1), (53, 1), (68, 1)] }, { coefficient := -1, powers := [(3, 1), (7, 1), (9, 1), (49, 1), (56, 1), (65, 1)] }, { coefficient := -1, powers := [(3, 1), (7, 1), (9, 1), (49, 1), (59, 1), (62, 1)] }, { coefficient := 1, powers := [(3, 1), (34, 1), (37, 1), (53, 1), (68, 1)] }, { coefficient := 1, powers := [(3, 1), (34, 1), (37, 1), (56, 1), (65, 1)] }, { coefficient := 1, powers := [(3, 1), (34, 1), (37, 1), (59, 1), (62, 1)] }, { coefficient := 1, powers := [(7, 1), (9, 1), (11, 1), (49, 1), (53, 1), (68, 1)] }, { coefficient := 1, powers := [(7, 1), (9, 1), (11, 1), (49, 1), (56, 1), (65, 1)] }, { coefficient := 1, powers := [(7, 1), (9, 1), (11, 1), (49, 1), (59, 1), (62, 1)] }, { coefficient := -1, powers := [(7, 1), (9, 1), (33, 1), (36, 1), (49, 1), (62, 1)] }, { coefficient := -1, powers := [(7, 1), (9, 1), (33, 1), (39, 1), (49, 1), (56, 1)] }, { coefficient := -1, powers := [(7, 1), (9, 1), (33, 1), (42, 1), (49, 1), (53, 1)] }, { coefficient := -1, powers := [(11, 1), (34, 1), (37, 1), (53, 1), (68, 1)] }, { coefficient := -1, powers := [(11, 1), (34, 1), (37, 1), (56, 1), (65, 1)] }, { coefficient := -1, powers := [(11, 1), (34, 1), (37, 1), (59, 1), (62, 1)] }, { coefficient := -1, powers := [(12, 1), (34, 1), (36, 1), (50, 1), (62, 1)] }, { coefficient := -1, powers := [(12, 1), (34, 1), (39, 1), (50, 1), (56, 1)] }, { coefficient := -1, powers := [(12, 1), (34, 1), (42, 1), (50, 1), (53, 1)] }],
...
#print axioms Krenn.X5Case100Selected.selectedHasNoCommonZero

end Krenn.X5Case100Selected
