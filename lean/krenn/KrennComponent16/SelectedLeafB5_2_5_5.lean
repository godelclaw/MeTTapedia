...
namespace Krenn.Component16.SelectedLeafB5_2_5_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "a726f210c71ceca31686ce8c16db93853bbcd80d917bea940ad4fd1faaa9a2d5"
...
def multipliers : Fin 32 → SparsePoly (Fin 69) := ![
  ...
  [{ coefficient := 1, powers := [(5, 1), (16, 1), (23, 1), (37, 1), (55, 1), (68, 1)] }, { coefficient := -1, powers := [(20, 1), (25, 1), (26, 1), (55, 1), (68, 1)] }],
  ...
  [{ coefficient := -1, powers := [(5, 1), (23, 1), (37, 1), (55, 1), (68, 1)] }],
  [{ coefficient := 1, powers := [(20, 1), (25, 1), (55, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (23, 1), (31, 1), (37, 1), (55, 1), (68, 1)] }],
  ...
  [{ coefficient := 1, powers := [(4, 1), (5, 1), (33, 1), (34, 1), (58, 1)] }, { coefficient := 1, powers := [(4, 1), (5, 1), (33, 1), (37, 1), (55, 1)] }, { coefficient := 1, powers := [(4, 1), (8, 1), (33, 1), (34, 1), (50, 1)] }, { coefficient := -1, powers := [(5, 1), (11, 1), (23, 1), (31, 1), (37, 1), (55, 1), (68, 1)] }, { coefficient := 1, powers := [(5, 1), (11, 1), (23, 1), (34, 1), (58, 1)] }, { coefficient := 1, powers := [(5, 1), (11, 1), (23, 1), (37, 1), (55, 1)] }, { coefficient := -1, powers := [(5, 1), (16, 1), (23, 1), (37, 1), (55, 1)] }, { coefficient := 1, powers := [(8, 1), (11, 1), (23, 1), (34, 1), (50, 1)] }, { coefficient := -1, powers := [(20, 1), (22, 1), (29, 1), (55, 1)] }],
...
#print axioms Krenn.Component16.SelectedLeafB5_2_5_5.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB5_2_5_5
