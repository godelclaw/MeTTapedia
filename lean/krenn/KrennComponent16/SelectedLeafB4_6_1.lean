...
namespace Krenn.Component16.SelectedLeafB4_6_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "40d7cf57edbb5a2dcf1098356113094b2b4c6c194bacaa56f1a6cb7ac35363cf"
...
def multipliers : Fin 36 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := -1, powers := [(5, 1), (7, 1), (34, 1), (45, 1), (58, 1), (60, 1), (65, 1)] }, { coefficient := -2, powers := [(7, 1), (19, 1), (25, 1), (61, 1)] }, { coefficient := 2, powers := [(8, 1), (11, 1), (25, 1), (45, 1), (53, 1), (61, 1), (65, 1)] }],
  ...
  [{ coefficient := 1, powers := [(5, 1), (7, 1), (34, 1), (58, 1), (60, 1), (65, 1)] }, { coefficient := -2, powers := [(8, 1), (11, 1), (25, 1), (53, 1), (61, 1), (65, 1)] }],
...
#print axioms Krenn.Component16.SelectedLeafB4_6_1.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB4_6_1
