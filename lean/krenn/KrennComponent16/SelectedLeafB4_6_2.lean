...
namespace Krenn.Component16.SelectedLeafB4_6_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "8168816a425f0c7faf10a54f84cbeb3cb59550bd603b840a9e64701e696bd129"
def certificateSHA256 : String := "31ffb80e3d9d0145d56a43fb209fb532cddb0086208f252f67364beb7464797a"
...
def multipliers : Fin 25 → SparsePoly (Fin 66) := ![
  [{ coefficient := -2, powers := [(31, 1), (50, 1), (53, 1)] }],
  [{ coefficient := 2, powers := [(25, 1), (27, 1), (47, 1)] }, { coefficient := -1, powers := [(25, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [(25, 1), (27, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (50, 1)] }],
  [{ coefficient := 1, powers := [(20, 1), (22, 1)] }],
  [{ coefficient := 2, powers := [(20, 1), (25, 1), (47, 1)] }],
  [{ coefficient := -2, powers := [(25, 1), (45, 1), (47, 1)] }],
  [{ coefficient := 2, powers := [(25, 1), (45, 1), (47, 1), (55, 1)] }],
  [{ coefficient := -1, powers := [(29, 1), (55, 1)] }],
  [{ coefficient := -2, powers := [(20, 1), (25, 1)] }],
  [{ coefficient := -2, powers := [(25, 1), (47, 1), (55, 1)] }],
  [{ coefficient := 2, powers := [(13, 1), (31, 1), (53, 1)] }],
...
#print axioms Krenn.Component16.SelectedLeafB4_6_2.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB4_6_2
