...
namespace Krenn.Component16.SelectedLeafB4_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "3ccc6dc8141fb63e51631e1973663f74cbc310bfca42d97573e657f5432787b2"
...
def multipliers : Fin 34 → SparsePoly (Fin 64) := ![
  ...
  [{ coefficient := 2, powers := [(8, 1), (33, 1), (37, 1), (39, 1), (43, 1), (63, 1)] }],
  [{ coefficient := -2, powers := [(6, 1), (11, 1), (19, 1), (37, 1), (43, 1), (53, 1)] }, { coefficient := -2, powers := [(7, 1), (19, 1), (37, 1), (43, 1)] }],
  [{ coefficient := -2, powers := [(5, 1), (27, 1), (34, 1), (48, 1), (57, 1), (63, 1)] }, { coefficient := 2, powers := [(5, 1), (34, 1), (48, 1), (54, 1), (63, 1)] }, { coefficient := 2, powers := [(8, 1), (34, 1), (50, 1), (57, 1), (63, 1)] }, { coefficient := 2, powers := [(13, 1), (31, 1), (47, 1), (50, 1), (63, 1)] }],
  [{ coefficient := 2, powers := [(4, 1), (8, 1), (37, 1), (43, 1), (60, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (8, 1), (49, 1), (61, 1), (63, 1)] }, { coefficient := 1, powers := [(8, 1), (21, 1), (49, 1), (61, 1), (63, 1)] }],
  [{ coefficient := -2, powers := [(5, 1), (27, 1), (34, 1), (57, 1), (63, 1)] }, { coefficient := 2, powers := [(8, 1), (22, 1), (34, 1), (57, 1), (63, 1)] }, { coefficient := 2, powers := [(13, 1), (22, 1), (31, 1), (47, 1), (63, 1)] }, { coefficient := -2, powers := [(13, 1), (25, 1), (54, 1), (63, 1)] }, { coefficient := -2, powers := [(19, 1), (31, 1), (43, 1), (63, 1)] }],
  ...
  [{ coefficient := -2, powers := [(5, 1), (27, 1), (34, 1), (48, 1), (63, 1)] }, { coefficient := 2, powers := [(5, 1), (31, 1), (61, 1), (63, 1)] }, { coefficient := 1, powers := [(8, 1), (25, 1), (61, 1), (63, 1)] }, { coefficient := 2, powers := [(8, 1), (34, 1), (50, 1), (63, 1)] }, { coefficient := 2, powers := [(20, 1), (31, 1)] }],
...
#print axioms Krenn.Component16.SelectedLeafB4_1.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB4_1
