...
namespace Krenn.Component16.SelectedLeafB5_0_6_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "e11f0f293b0026822a92709e31ea227b5af9f077041abfa4174202c8d06e6c72"
def certificateSHA256 : String := "811ec58158230b7a95be027156cda4c3fae1f263b336e1b65d25ab4ce7ac24d9"
...
def multipliers : Fin 25 → SparsePoly (Fin 68) := ![
  ...
  [{ coefficient := 1, powers := [(22, 1), (31, 1), (38, 1), (47, 1), (61, 1), (66, 1)] }, { coefficient := -1, powers := [(24, 1), (40, 1), (61, 1), (66, 1)] }, { coefficient := -1, powers := [(25, 1), (27, 1), (38, 1), (47, 1), (61, 1), (66, 1)] }, { coefficient := -1, powers := [(25, 1), (38, 1), (54, 1), (61, 1), (66, 1)] }, { coefficient := 1, powers := [(25, 1), (45, 1), (55, 1), (66, 1)] }, { coefficient := -1, powers := [(29, 1), (40, 1), (61, 1), (66, 1)] }, { coefficient := -1, powers := [(31, 1), (38, 1), (49, 1), (61, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (50, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (38, 1), (54, 1), (61, 1), (66, 1)] }],
  ...
  [{ coefficient := -1, powers := [(2, 1), (38, 1), (49, 1), (54, 1), (61, 1)] }, { coefficient := 1, powers := [(2, 1), (50, 1), (55, 1)] }, { coefficient := 1, powers := [(13, 1), (31, 1), (50, 1)] }, { coefficient := -1, powers := [(13, 1), (37, 1), (40, 1)] }, { coefficient := -1, powers := [(19, 1), (22, 1), (31, 1), (38, 1), (47, 1), (61, 1)] }, { coefficient := 1, powers := [(19, 1), (24, 1), (40, 1), (61, 1)] }, { coefficient := 1, powers := [(19, 1), (25, 1), (27, 1), (38, 1), (47, 1), (61, 1)] }, { coefficient := 1, powers := [(19, 1), (25, 1), (38, 1), (54, 1), (61, 1)] }, { coefficient := -1, powers := [(19, 1), (25, 1), (45, 1), (55, 1)] }, { coefficient := 1, powers := [(19, 1), (29, 1), (40, 1), (61, 1)] }, { coefficient := 1, powers := [(19, 1), (31, 1), (38, 1), (49, 1), (61, 1)] }]
]
...
#print axioms Krenn.Component16.SelectedLeafB5_0_6_3.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB5_0_6_3
