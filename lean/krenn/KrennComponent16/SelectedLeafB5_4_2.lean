...
namespace Krenn.Component16.SelectedLeafB5_4_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "efe04394615e71170976c157fac2425c4270613710a6731c9a095831148408ec"
def certificateSHA256 : String := "d36a8f94ffd7cfab4182f3d9ccb4a4f3f6a3f819404a46962a49840cfe2e23a5"

set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedSourceIndices : Fin 44 → Fin 671 := ![
  4,
  6,
  9,
  12,
...
def multipliers : Fin 44 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := -1, powers := [(30, 1), (47, 1), (50, 1), (54, 1), (65, 1)] }, { coefficient := 1, powers := [(31, 1), (50, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(22, 1), (31, 1), (62, 1)] }, { coefficient := -1, powers := [(25, 1), (27, 1), (57, 1)] }, { coefficient := -1, powers := [(25, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [(25, 1), (27, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (50, 1), (53, 1), (65, 1)] }, { coefficient := -2, powers := [(19, 1), (50, 1), (57, 1), (65, 1)] }],
  [{ coefficient := -3, powers := [(19, 1), (50, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(27, 1), (50, 1), (53, 1), (65, 1)] }, { coefficient := -1, powers := [(27, 1), (50, 1), (57, 1), (65, 1)] }, { coefficient := 1, powers := [(50, 1), (54, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(25, 1), (27, 1), (45, 1)] }, { coefficient := -1, powers := [(31, 1), (50, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (40, 1), (53, 1), (61, 1)] }, { coefficient := -1, powers := [(24, 1), (40, 1), (57, 1), (61, 1)] }, { coefficient := 2, powers := [(25, 1), (48, 1), (55, 1)] }, { coefficient := -1, powers := [(30, 1), (40, 1), (61, 1)] }],
  [{ coefficient := 2, powers := [(25, 1), (55, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (55, 1)] }],
  [{ coefficient := -1, powers := [(25, 1), (45, 1)] }, { coefficient := 1, powers := [(29, 1), (50, 1), (53, 1), (65, 1)] }, { coefficient := 1, powers := [(29, 1), (50, 1), (57, 1), (65, 1)] }, { coefficient := 1, powers := [(30, 1), (50, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (31, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (31, 1), (62, 1)] }],
  [{ coefficient := -2, powers := [(21, 1), (25, 1), (55, 1)] }],
  [{ coefficient := 1, powers := [(20, 1)] }],
  [{ coefficient := 1, powers := [(13, 1), (50, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (30, 1), (40, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(24, 1), (40, 1), (61, 1)] }],
  [{ coefficient := -2, powers := [(25, 1), (55, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (40, 1), (61, 1)] }, { coefficient := -1, powers := [(26, 1), (40, 1), (61, 1)] }, { coefficient := 1, powers := [(50, 1), (55, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(55, 1)] }],
  [{ coefficient := 1, powers := [(50, 1), (55, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(50, 1), (57, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(25, 1)] }],
  [{ coefficient := -1, powers := [(29, 1), (50, 1), (55, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (2, 1), (19, 1), (50, 1), (55, 1), (63, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (30, 1), (50, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (40, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(19, 1), (26, 1), (40, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (50, 1), (54, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(13, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (40, 1), (61, 1)] }, { coefficient := 1, powers := [(13, 1), (30, 1), (50, 1), (54, 1), (65, 1)] }, { coefficient := 1, powers := [(19, 1), (29, 1), (40, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(19, 1), (30, 1), (40, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (50, 1), (55, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (2, 1), (50, 1), (55, 1), (63, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := -1, powers := [(5, 1), (31, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (2, 1), (39, 1), (50, 1), (55, 1), (60, 1), (65, 1)] }, { coefficient := -1, powers := [(0, 1), (2, 1), (47, 1), (50, 1), (53, 1), (55, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (2, 2), (50, 1), (55, 1), (57, 1), (63, 1), (65, 1)] }, { coefficient := 1, powers := [(0, 1), (2, 1), (50, 1), (55, 1), (57, 1), (65, 1)] }, { coefficient := 1, powers := [(0, 1), (19, 1), (29, 1), (40, 1), (61, 1)] }, { coefficient := -1, powers := [(2, 1), (26, 1), (40, 1), (61, 1)] }, { coefficient := 1, powers := [(2, 1), (50, 1), (55, 1), (65, 1)] }, { coefficient := -1, powers := [(13, 1), (26, 1), (30, 1), (50, 1), (54, 1), (65, 1)] }, { coefficient := 1, powers := [(13, 1), (27, 1), (30, 1), (50, 1), (65, 1)] }, { coefficient := 1, powers := [(13, 1), (29, 1), (50, 1), (54, 1), (65, 1)] }, { coefficient := -1, powers := [(13, 1), (31, 1), (50, 1), (65, 1)] }, { coefficient := 2, powers := [(20, 1), (21, 1), (25, 1), (55, 1)] }, { coefficient := 2, powers := [(20, 1), (25, 1), (26, 1), (55, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (20, 1), (31, 1), (62, 1)] }, { coefficient := 1, powers := [(8, 1), (37, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (34, 1), (50, 1)] }],
...
#print axioms Krenn.Component16.SelectedLeafB5_4_2.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB5_4_2
