...
namespace Krenn.Component16.SelectedLeafB1_6_7_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "600b270bbd0c14d5b0d20a8a7decf79da433403fc68ef8b3bc361cc3dbc6608d"
...
def multipliers : Fin 27 → SparsePoly (Fin 70) := ![
  [{ coefficient := 1, powers := [(2, 1), (31, 1), (38, 1), (40, 1), (50, 1), (60, 1), (61, 1), (68, 1)] }, { coefficient := 1, powers := [(14, 1), (25, 1), (58, 1), (65, 1), (68, 1)] }, { coefficient := -1, powers := [(31, 1), (50, 1), (68, 1)] }, { coefficient := 1, powers := [(37, 1), (40, 1), (68, 1)] }],
  ...
  [{ coefficient := -1, powers := [(2, 2), (38, 1), (40, 1), (58, 1), (60, 1), (61, 1)] }, { coefficient := 1, powers := [(2, 1), (5, 1), (31, 1), (38, 1), (58, 1), (60, 1), (61, 1)] }, { coefficient := -1, powers := [(2, 1), (8, 1), (37, 1), (38, 1), (40, 1), (60, 1), (61, 1)] }, { coefficient := -1, powers := [(2, 1), (56, 1), (58, 1), (65, 1)] }, { coefficient := 1, powers := [(2, 1), (58, 1)] }, { coefficient := 1, powers := [(8, 1), (37, 1)] }, { coefficient := -1, powers := [(18, 1), (29, 1), (58, 1), (65, 1)] }, { coefficient := -1, powers := [(20, 1), (31, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (34, 1), (58, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (13, 1), (31, 1), (38, 1), (40, 1), (50, 1), (60, 1), (61, 1)] }, { coefficient := -1, powers := [(13, 1), (14, 1), (25, 1), (58, 1), (65, 1)] }, { coefficient := 1, powers := [(13, 1), (31, 1), (50, 1)] }, { coefficient := -1, powers := [(13, 1), (37, 1), (40, 1)] }]
]
...
#print axioms Krenn.Component16.SelectedLeafB1_6_7_5.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB1_6_7_5
