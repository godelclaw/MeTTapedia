...
namespace Krenn.Component16.SelectedLeafB5_4_0_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "3d400fbefc45057ba0772fce7f03dc7b6a7cce4d8e68d4e84ac25c4826c0b616"
def certificateSHA256 : String := "58a33f49f49d34b5adf55b5ce850dc927696ebbc83ab821715249f030f2edb2c"
...
def multipliers : Fin 25 → SparsePoly (Fin 67) := ![
  ...
  [{ coefficient := -1, powers := [(22, 1), (31, 1), (38, 1), (53, 1), (61, 1), (65, 1)] }, { coefficient := -1, powers := [(24, 1), (40, 1), (61, 1), (65, 1)] }, { coefficient := 1, powers := [(25, 1), (27, 1), (38, 1), (53, 1), (61, 1), (65, 1)] }, { coefficient := -1, powers := [(25, 1), (38, 1), (54, 1), (61, 1), (65, 1)] }, { coefficient := 1, powers := [(25, 1), (45, 1), (55, 1), (65, 1)] }, { coefficient := -1, powers := [(29, 1), (40, 1), (61, 1), (65, 1)] }, { coefficient := -1, powers := [(31, 1), (38, 1), (49, 1), (61, 1), (65, 1)] }],
...
#print axioms Krenn.Component16.SelectedLeafB5_4_0_3.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB5_4_0_3
