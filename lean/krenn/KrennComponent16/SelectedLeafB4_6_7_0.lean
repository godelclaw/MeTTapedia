...
namespace Krenn.Component16.SelectedLeafB4_6_7_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "c910ed44dacd7cd7a4b7bece67016fb1da821c2a797886955c1d24ec8c4f1e55"
def certificateSHA256 : String := "a300d66d2b975c658527318da20e57c9da97777605989e52bf44a20a28a1270e"

set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedSourceIndices : Fin 33 → Fin 674 := ![
  8,
  13,
  21,
  23,
...
def multipliers : Fin 33 → SparsePoly (Fin 68) := ![
  ...
  [{ coefficient := -1, powers := [(7, 1), (45, 1), (60, 1), (67, 1)] }, { coefficient := 1, powers := [(11, 1), (45, 1), (53, 1), (67, 1)] }, { coefficient := 1, powers := [(11, 1), (45, 1), (57, 1), (67, 1)] }, { coefficient := -1, powers := [(17, 1), (57, 1), (67, 1)] }],
  [{ coefficient := 1, powers := [(11, 1), (19, 1), (33, 1), (39, 1), (50, 1)] }],
  [{ coefficient := 1, powers := [(11, 1), (19, 1), (33, 1), (39, 1), (55, 1)] }],
  [{ coefficient := 1, powers := [(11, 1), (13, 1), (33, 1), (39, 1), (45, 1)] }],
  [{ coefficient := 1, powers := [(11, 1), (25, 1), (33, 1), (39, 1), (58, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(7, 1), (60, 1), (67, 1)] }, { coefficient := -1, powers := [(11, 1), (53, 1), (67, 1)] }, { coefficient := -1, powers := [(11, 1), (57, 1), (67, 1)] }],
  ...
  [{ coefficient := -1, powers := [(11, 1), (13, 1), (33, 1), (39, 1)] }],
  ...
  [{ coefficient := -1, powers := [(2, 1), (11, 1), (33, 1), (39, 1), (58, 1)] }, { coefficient := -1, powers := [(8, 1), (11, 1), (33, 1), (37, 1), (39, 1)] }],
  [{ coefficient := -1, powers := [(11, 1), (13, 1), (25, 1), (33, 1), (39, 1), (58, 1)] }],
  [{ coefficient := -1, powers := [(4, 1), (33, 1), (57, 1)] }, { coefficient := -1, powers := [(7, 1), (23, 1), (60, 1)] }, { coefficient := 1, powers := [(11, 1), (23, 1), (53, 1)] }],
  [{ coefficient := -1, powers := [(4, 1), (33, 1), (39, 1), (60, 1)] }, { coefficient := -1, powers := [(11, 1), (13, 1), (25, 1), (33, 1), (39, 1), (46, 1), (58, 1), (65, 1)] }, { coefficient := 1, powers := [(11, 1), (19, 1), (25, 1), (33, 1), (39, 1), (42, 1), (45, 1), (55, 1)] }, { coefficient := 1, powers := [(11, 1), (19, 1), (25, 1), (33, 1), (39, 1), (45, 1), (47, 1), (55, 1)] }, { coefficient := -2, powers := [(11, 1), (19, 1), (25, 1), (33, 1), (39, 1), (48, 1), (55, 1)] }, { coefficient := -1, powers := [(11, 1), (19, 1), (33, 1), (34, 1), (39, 1), (40, 1), (48, 1)] }, { coefficient := -2, powers := [(11, 1), (20, 1), (25, 1), (33, 1), (39, 1), (42, 1), (55, 1)] }, { coefficient := -1, powers := [(11, 1), (20, 1), (33, 1), (34, 1), (39, 1), (40, 1), (42, 1)] }, { coefficient := -1, powers := [(11, 1), (33, 1), (39, 1), (47, 1)] }, { coefficient := -1, powers := [(16, 1), (33, 1), (39, 1), (42, 1)] }],
  ...
  [{ coefficient := -1, powers := [(5, 1), (11, 1), (33, 1), (39, 1), (61, 1)] }, { coefficient := -1, powers := [(11, 1), (13, 1), (33, 1), (39, 1), (45, 1), (49, 1)] }, { coefficient := 1, powers := [(11, 1), (13, 1), (33, 1), (39, 1), (50, 1)] }]
]
...
#print axioms Krenn.Component16.SelectedLeafB4_6_7_0.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB4_6_7_0
