...
namespace Krenn.Component16.SelectedLeafB5_2_2_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "b8c647047829bd8823ba0ccb26b90d71c36e1b2e213466466a1cf1af13ef9e71"
...
def multipliers : Fin 24 → SparsePoly (Fin 68) := ![
  ...
  [{ coefficient := 1, powers := [(22, 1), (31, 1), (38, 1), (42, 1), (61, 1), (66, 1)] }, { coefficient := 1, powers := [(22, 1), (31, 1), (38, 1), (47, 1), (61, 1), (66, 1)] }, { coefficient := -1, powers := [(24, 1), (40, 1), (61, 1), (66, 1)] }, { coefficient := -1, powers := [(25, 1), (27, 1), (38, 1), (42, 1), (61, 1), (66, 1)] }, { coefficient := -1, powers := [(25, 1), (27, 1), (38, 1), (47, 1), (61, 1), (66, 1)] }, { coefficient := -1, powers := [(25, 1), (38, 1), (54, 1), (61, 1), (66, 1)] }, { coefficient := 1, powers := [(25, 1), (45, 1), (55, 1), (66, 1)] }, { coefficient := -1, powers := [(29, 1), (40, 1), (61, 1), (66, 1)] }, { coefficient := -1, powers := [(31, 1), (38, 1), (49, 1), (61, 1), (66, 1)] }],
...
#print axioms Krenn.Component16.SelectedLeafB5_2_2_3.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB5_2_2_3
