...
namespace Krenn.Component16.SelectedLeafB5_6_3_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "1a1ace817b4fa4db8ed927dfa9ba2c697545f1dce1e7c1f73c9ba9ddf47697d0"
...
def multipliers : Fin 24 → SparsePoly (Fin 70) := ![
  [{ coefficient := -1, powers := [(7, 1), (24, 1), (36, 1), (42, 1), (63, 1), (68, 1)] }, { coefficient := -1, powers := [(7, 1), (29, 1), (36, 1), (42, 1), (63, 1), (68, 1)] }],
  [{ coefficient := 1, powers := [(11, 1), (45, 1), (53, 1), (67, 1)] }, { coefficient := 2, powers := [(11, 1), (45, 1), (57, 1), (67, 1)] }, { coefficient := -1, powers := [(17, 1), (57, 1), (67, 1)] }],
  [{ coefficient := 1, powers := [(28, 1), (30, 1), (42, 1), (54, 1), (69, 1)] }, { coefficient := 2, powers := [(28, 1), (30, 1), (47, 1), (54, 1), (69, 1)] }, { coefficient := 1, powers := [(30, 1), (33, 1), (39, 1), (54, 1), (69, 1)] }, { coefficient := -1, powers := [(30, 1), (36, 1), (38, 1), (42, 1), (54, 1), (57, 1), (69, 1)] }],
  [{ coefficient := -1, powers := [(28, 1), (30, 1), (42, 1), (69, 1)] }, { coefficient := -2, powers := [(28, 1), (30, 1), (47, 1), (69, 1)] }, { coefficient := -1, powers := [(30, 1), (33, 1), (39, 1), (69, 1)] }, { coefficient := 1, powers := [(30, 1), (36, 1), (38, 1), (42, 1), (57, 1), (69, 1)] }],
  [{ coefficient := -1, powers := [(28, 1), (42, 1), (69, 1)] }, { coefficient := -2, powers := [(28, 1), (47, 1), (69, 1)] }, { coefficient := -1, powers := [(33, 1), (39, 1), (69, 1)] }, { coefficient := 1, powers := [(36, 1), (38, 1), (42, 1), (57, 1), (69, 1)] }],
  [{ coefficient := -1, powers := [(11, 1), (53, 1), (67, 1)] }, { coefficient := -2, powers := [(11, 1), (57, 1), (67, 1)] }],
  [{ coefficient := 1, powers := [(53, 1)] }],
  [{ coefficient := 1, powers := [(47, 1)] }],
  [{ coefficient := 1, powers := [(16, 1), (23, 1), (69, 1)] }, { coefficient := -1, powers := [(16, 1), (28, 1), (69, 1)] }, { coefficient := -1, powers := [(16, 1), (36, 1), (38, 1), (42, 1), (69, 1)] }],
  ...
  [{ coefficient := 1, powers := [(24, 1), (28, 1), (42, 1), (69, 1)] }, { coefficient := 2, powers := [(24, 1), (28, 1), (47, 1), (69, 1)] }, { coefficient := 1, powers := [(24, 1), (33, 1), (39, 1), (69, 1)] }, { coefficient := -1, powers := [(24, 1), (36, 1), (38, 1), (42, 1), (57, 1), (69, 1)] }],
  [{ coefficient := -1, powers := [(23, 1), (69, 1)] }, { coefficient := 1, powers := [(28, 1), (69, 1)] }, { coefficient := 1, powers := [(36, 1), (38, 1), (42, 1), (69, 1)] }],
  [{ coefficient := 1, powers := [(27, 1), (28, 1), (42, 1), (69, 1)] }, { coefficient := 2, powers := [(27, 1), (28, 1), (47, 1), (69, 1)] }, { coefficient := 1, powers := [(27, 1), (33, 1), (39, 1), (69, 1)] }, { coefficient := -1, powers := [(27, 1), (36, 1), (38, 1), (42, 1), (57, 1), (69, 1)] }],
  [{ coefficient := 1, powers := [(57, 1), (67, 1)] }],
  [{ coefficient := 1, powers := [(23, 1), (31, 1), (69, 1)] }, { coefficient := -1, powers := [(24, 1), (27, 1), (28, 1), (42, 1), (69, 1)] }, { coefficient := -2, powers := [(24, 1), (27, 1), (28, 1), (47, 1), (69, 1)] }, { coefficient := -1, powers := [(24, 1), (27, 1), (33, 1), (39, 1), (69, 1)] }, { coefficient := 1, powers := [(24, 1), (27, 1), (36, 1), (38, 1), (42, 1), (57, 1), (69, 1)] }, { coefficient := -1, powers := [(28, 1), (31, 1), (69, 1)] }, { coefficient := 1, powers := [(28, 1)] }, { coefficient := -1, powers := [(31, 1), (36, 1), (38, 1), (42, 1), (69, 1)] }],
  ...
  [{ coefficient := 1, powers := [(4, 1), (23, 1), (42, 1), (60, 1)] }, { coefficient := 1, powers := [(4, 1), (23, 1), (47, 1), (60, 1)] }, { coefficient := 1, powers := [(4, 1), (23, 1), (53, 1), (60, 1)] }, { coefficient := -1, powers := [(4, 1), (28, 1), (42, 1), (60, 1)] }, { coefficient := -1, powers := [(4, 1), (28, 1), (47, 1), (60, 1)] }, { coefficient := -1, powers := [(4, 1), (33, 1), (39, 1), (60, 1)] }, { coefficient := -1, powers := [(4, 1), (36, 1), (38, 1), (42, 2), (60, 1)] }, { coefficient := -1, powers := [(4, 1), (36, 1), (38, 1), (42, 1), (47, 1), (60, 1)] }, { coefficient := -1, powers := [(4, 1), (36, 1), (38, 1), (42, 1), (53, 1), (60, 1)] }, { coefficient := 1, powers := [(11, 1), (23, 1), (42, 1), (47, 1)] }, { coefficient := 1, powers := [(11, 1), (23, 1), (47, 2)] }, { coefficient := 1, powers := [(11, 1), (23, 1), (47, 1), (53, 1)] }, { coefficient := -1, powers := [(11, 1), (28, 1), (30, 1), (42, 1), (54, 1), (69, 1)] }, { coefficient := -2, powers := [(11, 1), (28, 1), (30, 1), (47, 1), (54, 1), (69, 1)] }, { coefficient := -1, powers := [(11, 1), (28, 1), (42, 1), (47, 1)] }, { coefficient := -1, powers := [(11, 1), (28, 1), (47, 2)] }, { coefficient := -1, powers := [(11, 1), (30, 1), (33, 1), (39, 1), (54, 1), (69, 1)] }, { coefficient := 1, powers := [(11, 1), (30, 1), (36, 1), (38, 1), (42, 1), (54, 1), (57, 1), (69, 1)] }, { coefficient := -1, powers := [(11, 1), (33, 1), (39, 1), (47, 1)] }, { coefficient := -1, powers := [(11, 1), (36, 1), (38, 1), (42, 2), (47, 1)] }, { coefficient := -1, powers := [(11, 1), (36, 1), (38, 1), (42, 1), (47, 2)] }, { coefficient := -1, powers := [(11, 1), (36, 1), (38, 1), (42, 1), (47, 1), (53, 1)] }, { coefficient := 1, powers := [(16, 1), (23, 1), (42, 2)] }, { coefficient := 1, powers := [(16, 1), (23, 1), (42, 1), (47, 1)] }, { coefficient := 1, powers := [(16, 1), (23, 1), (42, 1), (53, 1)] }, { coefficient := -1, powers := [(16, 1), (28, 1), (42, 2)] }, { coefficient := -1, powers := [(16, 1), (28, 1), (42, 1), (47, 1)] }, { coefficient := -1, powers := [(16, 1), (33, 1), (39, 1), (42, 1)] }, { coefficient := -1, powers := [(16, 1), (36, 1), (38, 1), (42, 3)] }, { coefficient := -1, powers := [(16, 1), (36, 1), (38, 1), (42, 2), (47, 1)] }, { coefficient := -1, powers := [(16, 1), (36, 1), (38, 1), (42, 2), (53, 1)] }],
...
#print axioms Krenn.Component16.SelectedLeafB5_6_3_3.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB5_6_3_3
