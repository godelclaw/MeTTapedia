...
namespace Krenn.Component16.SelectedLeafB4_4_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "9d75f932ddc81461cb6d0b7b59552597989db9ee415374d36e32f924684ed91d"
def certificateSHA256 : String := "c2c638ea0098f5fd8e1b11521949f18b49cef76194884a46183d9735b57ae70a"
...
def multipliers : Fin 26 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := -1, powers := [(25, 1), (27, 1), (58, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (50, 1), (58, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(25, 1), (45, 1), (55, 1), (58, 1), (62, 1), (65, 1)] }, { coefficient := 2, powers := [(25, 1), (48, 1), (55, 1), (58, 1), (65, 1)] }],
  [{ coefficient := 2, powers := [(25, 1), (55, 1), (58, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (55, 1), (58, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(31, 1), (50, 1), (58, 1), (65, 1)] }, { coefficient := 1, powers := [(37, 1), (40, 1), (58, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(29, 1), (58, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(25, 1), (58, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (25, 1), (55, 1), (58, 1), (62, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(31, 1), (58, 1), (65, 1)] }],
  [{ coefficient := -2, powers := [(21, 1), (25, 1), (55, 1), (58, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(20, 1), (58, 1), (65, 1)] }],
  [{ coefficient := -2, powers := [(25, 1), (55, 1), (58, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(55, 1), (58, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(50, 1), (58, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(25, 1), (58, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(58, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(58, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(19, 1), (25, 1), (45, 1), (55, 1), (58, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(40, 1), (58, 1), (61, 1), (65, 1)] }, { coefficient := -1, powers := [(50, 1), (55, 1), (58, 1), (65, 1)] }],
  [{ coefficient := 2, powers := [(20, 1), (21, 1), (25, 1), (55, 1), (58, 1), (65, 1)] }, { coefficient := 2, powers := [(20, 1), (25, 1), (26, 1), (55, 1), (58, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (56, 1), (58, 1), (64, 1)] }, { coefficient := 1, powers := [(2, 1), (58, 2), (65, 1)] }, { coefficient := 1, powers := [(8, 1), (37, 1), (58, 1), (65, 1)] }, { coefficient := -1, powers := [(20, 1), (31, 1), (58, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (34, 1), (58, 1)] }],
  [{ coefficient := 1, powers := [(13, 1), (21, 1), (31, 1), (50, 1), (58, 1), (65, 1)] }, { coefficient := -1, powers := [(13, 1), (21, 1), (37, 1), (40, 1), (58, 1), (65, 1)] }],
...
#print axioms Krenn.Component16.SelectedLeafB4_4_5.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB4_4_5
