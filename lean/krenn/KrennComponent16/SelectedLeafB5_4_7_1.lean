...
namespace Krenn.Component16.SelectedLeafB5_4_7_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "9c3166f092564ef63219fd53e34dca4bc077ad7da72501cd81ac43411ac94673"
def certificateSHA256 : String := "fc5d787380c5df6e322d26d7a747e39e72c147d280091cfa839ffefedb084f04"
...
def multipliers : Fin 6 → SparsePoly (Fin 69) := ![
  ...
  [{ coefficient := -1, powers := [(27, 1), (42, 1), (45, 1), (53, 1), (67, 1)] }, { coefficient := -1, powers := [(27, 1), (48, 1), (53, 1), (67, 1)] }, { coefficient := 1, powers := [(42, 1), (45, 1), (54, 1), (67, 1)] }, { coefficient := 1, powers := [(48, 1), (54, 1), (67, 1)] }]
]
...
#print axioms Krenn.Component16.SelectedLeafB5_4_7_1.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB5_4_7_1
