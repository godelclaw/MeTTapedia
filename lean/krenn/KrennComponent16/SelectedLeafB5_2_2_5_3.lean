...
namespace Krenn.Component16.SelectedLeafB5_2_2_5_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "7a6091a01d760268303ed03f5de684674a5b353d3e4d781831a5a72882230d98"
...
def multipliers : Fin 18 → SparsePoly (Fin 70) := ![
  [{ coefficient := -1, powers := [(11, 1), (23, 1), (42, 1), (60, 1), (69, 1)] }, { coefficient := 1, powers := [(11, 1), (23, 1), (53, 1), (60, 1), (69, 1)] }, { coefficient := 1, powers := [(11, 1), (23, 1), (57, 1), (60, 1), (69, 1)] }, { coefficient := 1, powers := [(16, 1), (23, 1), (53, 1), (60, 1), (69, 1)] }],
  [{ coefficient := -1, powers := [(11, 1), (24, 1), (42, 1), (67, 1)] }, { coefficient := 1, powers := [(11, 1), (24, 1), (53, 1), (67, 1)] }, { coefficient := 1, powers := [(11, 1), (24, 1), (57, 1), (67, 1)] }, { coefficient := 1, powers := [(11, 1), (30, 1), (67, 1)] }, { coefficient := 1, powers := [(16, 1), (24, 1), (53, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(11, 1), (33, 1), (62, 1), (69, 1)] }, { coefficient := 1, powers := [(16, 1), (33, 1), (62, 1), (69, 1)] }],
  [{ coefficient := -1, powers := [(23, 1), (60, 1), (69, 1)] }, { coefficient := 1, powers := [(33, 1), (57, 1), (69, 1)] }, { coefficient := 1, powers := [(36, 1), (42, 1), (69, 1)] }],
  [{ coefficient := -1, powers := [(42, 1)] }, { coefficient := 1, powers := [(53, 1)] }],
  [{ coefficient := 1, powers := [(47, 1)] }, { coefficient := -1, powers := [(57, 1)] }],
  [{ coefficient := -1, powers := [(11, 1), (23, 1), (67, 1)] }],
  [{ coefficient := 1, powers := [(60, 1), (69, 1)] }],
  [{ coefficient := 1, powers := [(11, 1), (23, 1), (42, 1), (67, 1)] }, { coefficient := -1, powers := [(11, 1), (23, 1), (53, 1), (67, 1)] }, { coefficient := -1, powers := [(11, 1), (23, 1), (57, 1), (67, 1)] }, { coefficient := -1, powers := [(16, 1), (23, 1), (53, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(11, 1), (23, 1), (31, 1), (42, 1), (67, 1)] }, { coefficient := 1, powers := [(11, 1), (23, 1), (31, 1), (53, 1), (67, 1)] }, { coefficient := 1, powers := [(11, 1), (23, 1), (31, 1), (57, 1), (67, 1)] }, { coefficient := 1, powers := [(11, 1), (23, 1), (42, 1)] }, { coefficient := -1, powers := [(11, 1), (23, 1), (53, 1)] }, { coefficient := -1, powers := [(11, 1), (23, 1), (57, 1)] }, { coefficient := 1, powers := [(16, 1), (23, 1), (31, 1), (53, 1), (67, 1)] }, { coefficient := -1, powers := [(16, 1), (23, 1), (53, 1)] }],
  [{ coefficient := 1, powers := [(23, 1)] }],
  [{ coefficient := 1, powers := [(11, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := 1, powers := [(11, 1), (33, 1), (39, 1)] }, { coefficient := -1, powers := [(16, 1), (33, 1), (39, 1)] }],
  [{ coefficient := -1, powers := [(39, 1), (60, 1), (61, 1), (69, 1)] }, { coefficient := 1, powers := [(39, 1), (60, 1)] }, { coefficient := 1, powers := [(42, 1), (47, 1)] }, { coefficient := 1, powers := [(42, 1), (57, 1)] }, { coefficient := -1, powers := [(47, 1), (53, 1)] }, { coefficient := 1, powers := [(53, 1), (57, 1)] }],
  [{ coefficient := -1, powers := [(4, 1), (60, 1), (61, 1), (69, 1)] }, { coefficient := 1, powers := [(4, 1), (60, 1)] }, { coefficient := -1, powers := [(11, 1), (42, 1)] }, { coefficient := -1, powers := [(11, 1), (47, 1)] }, { coefficient := 1, powers := [(11, 1), (57, 1)] }, { coefficient := 1, powers := [(16, 1), (42, 1)] }],
...
#print axioms Krenn.Component16.SelectedLeafB5_2_2_5_3.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB5_2_2_5_3
