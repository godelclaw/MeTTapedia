...
namespace Krenn.Component16.SelectedLeafB4_6_7_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "d5b9664da18e54f878b58dbfad16ad11659a529c8a89ee668258432c6a05ad89"
def certificateSHA256 : String := "0eaa2c8a980cd2e27a9e36b929af8e4720ee66037227fbaafe463833cc987e14"
...
def multipliers : Fin 30 → SparsePoly (Fin 70) := ![
  [{ coefficient := 1, powers := [(11, 1), (34, 1), (39, 1), (50, 1)] }, { coefficient := -1, powers := [(16, 1), (34, 1), (39, 1), (50, 1)] }],
  [{ coefficient := 1, powers := [(11, 1), (31, 1), (33, 1), (39, 1), (50, 1), (68, 1)] }, { coefficient := -1, powers := [(11, 1), (33, 1), (37, 1), (39, 1), (40, 1), (68, 1)] }, { coefficient := -1, powers := [(16, 1), (31, 1), (33, 1), (39, 1), (50, 1), (68, 1)] }, { coefficient := 1, powers := [(16, 1), (33, 1), (37, 1), (39, 1), (40, 1), (68, 1)] }],
  ...
  [{ coefficient := -1, powers := [(11, 1), (37, 1), (39, 1), (55, 1), (65, 1)] }, { coefficient := 1, powers := [(16, 1), (37, 1), (39, 1), (55, 1), (65, 1)] }],
  ...
  [{ coefficient := -1, powers := [(11, 1), (33, 1), (39, 1), (40, 1), (61, 1)] }, { coefficient := 1, powers := [(16, 1), (33, 1), (39, 1), (40, 1), (61, 1)] }],
  ...
  [{ coefficient := -1, powers := [(11, 1), (13, 1), (31, 1), (33, 1), (39, 1), (50, 1)] }, { coefficient := 1, powers := [(11, 1), (13, 1), (33, 1), (37, 1), (39, 1), (40, 1)] }, { coefficient := 1, powers := [(13, 1), (16, 1), (31, 1), (33, 1), (39, 1), (50, 1)] }, { coefficient := -1, powers := [(13, 1), (16, 1), (33, 1), (37, 1), (39, 1), (40, 1)] }],
...
#print axioms Krenn.Component16.SelectedLeafB4_6_7_5.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB4_6_7_5
