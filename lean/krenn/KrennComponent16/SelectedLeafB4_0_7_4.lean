...
namespace Krenn.Component16.SelectedLeafB4_0_7_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "ce0517e7df1023c99284a016f4e8721e235b5fc0d75d26ecd692aa54c6d1a5c9"
def certificateSHA256 : String := "6a4a17bd529f2ee0545c62bc61e11234cef5a0414cd1d963ed1a0c25a90f1fdf"
...
def multipliers : Fin 25 → SparsePoly (Fin 67) := ![
  [{ coefficient := 1, powers := [(25, 1), (47, 1), (58, 1), (64, 1), (66, 1)] }, { coefficient := -1, powers := [(25, 1), (58, 1), (66, 1)] }, { coefficient := -1, powers := [(30, 1), (49, 1), (58, 1), (64, 1), (66, 1)] }],
  ...
  [{ coefficient := -1, powers := [(2, 1), (57, 1), (58, 1), (64, 1)] }, { coefficient := 1, powers := [(2, 1), (58, 1)] }, { coefficient := 1, powers := [(8, 1), (37, 1)] }, { coefficient := -1, powers := [(19, 1), (30, 1), (58, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (34, 1), (58, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (25, 1), (47, 1), (58, 1), (64, 1)] }, { coefficient := 1, powers := [(13, 1), (25, 1), (58, 1)] }, { coefficient := 1, powers := [(13, 1), (30, 1), (49, 1), (58, 1), (64, 1)] }],
...
#print axioms Krenn.Component16.SelectedLeafB4_0_7_4.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB4_0_7_4
