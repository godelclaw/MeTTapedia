...
namespace Krenn.Component16.SelectedLeafB5_2_1_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "fe5bfa9fb7f0824ced9aa3610f2a3776bf62fab2ec128d4f8c6e6bbbae5ce845"
...
def multipliers : Fin 44 → SparsePoly (Fin 69) := ![
  ...
  [{ coefficient := -1, powers := [(7, 1), (31, 1), (36, 1), (42, 1), (50, 1), (66, 1)] }, { coefficient := 1, powers := [(7, 1), (36, 1), (37, 1), (40, 1), (42, 1), (66, 1)] }, { coefficient := -1, powers := [(11, 1), (31, 1), (33, 1), (39, 1), (50, 1), (66, 1)] }, { coefficient := -2, powers := [(11, 1), (31, 1), (36, 1), (39, 1), (50, 1), (66, 1)] }, { coefficient := 1, powers := [(16, 1), (31, 1), (36, 1), (39, 1), (50, 1), (66, 1)] }],
  ...
  [{ coefficient := 1, powers := [(7, 1), (25, 1), (36, 1), (42, 1), (45, 1), (55, 1), (67, 1)] }, { coefficient := 1, powers := [(11, 1), (25, 1), (33, 1), (39, 1), (45, 1), (55, 1), (67, 1)] }, { coefficient := 2, powers := [(11, 1), (25, 1), (36, 1), (39, 1), (45, 1), (55, 1), (67, 1)] }, { coefficient := -1, powers := [(16, 1), (25, 1), (36, 1), (39, 1), (45, 1), (55, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(11, 1), (45, 1), (53, 1), (65, 1)] }, { coefficient := 1, powers := [(16, 1), (42, 1), (45, 1), (65, 1)] }, { coefficient := 1, powers := [(16, 1), (45, 1), (47, 1), (65, 1)] }, { coefficient := 2, powers := [(16, 1), (45, 1), (53, 1), (65, 1)] }],
  ...
  [{ coefficient := 2, powers := [(11, 1), (26, 1), (28, 1), (42, 2), (54, 1), (65, 1), (67, 1)] }, { coefficient := -2, powers := [(11, 1), (27, 1), (28, 1), (42, 2), (65, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (7, 1), (36, 1), (42, 1), (55, 1), (67, 1)] }, { coefficient := -1, powers := [(2, 1), (11, 1), (33, 1), (39, 1), (55, 1), (67, 1)] }, { coefficient := -2, powers := [(2, 1), (11, 1), (36, 1), (39, 1), (55, 1), (67, 1)] }, { coefficient := 1, powers := [(2, 1), (16, 1), (36, 1), (39, 1), (55, 1), (67, 1)] }],
  ...
  [{ coefficient := -1, powers := [(2, 1), (36, 1), (40, 1), (42, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (26, 1), (36, 1), (40, 1), (42, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(28, 1), (42, 1), (48, 1), (54, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(28, 1), (42, 1), (48, 1), (65, 1)] }],
  ...
  [{ coefficient := 1, powers := [(11, 1), (53, 1), (65, 1)] }, { coefficient := -1, powers := [(16, 1), (42, 1), (65, 1)] }, { coefficient := -1, powers := [(16, 1), (47, 1), (65, 1)] }, { coefficient := -2, powers := [(16, 1), (53, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(11, 1), (28, 1), (42, 2), (54, 1), (65, 1)] }],
  ...
  [{ coefficient := 1, powers := [(0, 1), (27, 1), (28, 1), (42, 2), (65, 1)] }, { coefficient := 1, powers := [(21, 1), (27, 1), (28, 1), (42, 2), (65, 1)] }],
  ...
  [{ coefficient := 1, powers := [(16, 1), (23, 1), (68, 1)] }, { coefficient := -1, powers := [(16, 1), (28, 1), (68, 1)] }],
  [{ coefficient := -1, powers := [(11, 1), (28, 1), (42, 1), (54, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(17, 1), (28, 1), (42, 2), (65, 1)] }],
  ...
  [{ coefficient := 1, powers := [(11, 1), (28, 1), (42, 2), (65, 1)] }],
  [{ coefficient := 1, powers := [(11, 1), (33, 1), (40, 1)] }, { coefficient := 2, powers := [(11, 1), (36, 1), (40, 1)] }, { coefficient := -1, powers := [(16, 1), (36, 1), (40, 1)] }],
  [{ coefficient := -1, powers := [(23, 1), (68, 1)] }, { coefficient := 1, powers := [(28, 1), (68, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (28, 1), (42, 2), (65, 1)] }, { coefficient := -1, powers := [(21, 1), (28, 1), (42, 2), (65, 1)] }],
  [{ coefficient := -1, powers := [(17, 1), (27, 1), (28, 1), (42, 2), (65, 1)] }],
  [{ coefficient := 1, powers := [(23, 1), (31, 1), (68, 1)] }, { coefficient := -1, powers := [(28, 1), (31, 1), (68, 1)] }, { coefficient := 1, powers := [(28, 1)] }],
  [{ coefficient := -1, powers := [(11, 1)] }, { coefficient := 1, powers := [(16, 1)] }],
  [{ coefficient := 1, powers := [(11, 1), (28, 1), (42, 1), (65, 1)] }],
  ...
  [{ coefficient := 1, powers := [(4, 1), (33, 1)] }, { coefficient := -1, powers := [(11, 1), (23, 1), (31, 1), (68, 1)] }, { coefficient := 2, powers := [(11, 1), (23, 1)] }, { coefficient := 1, powers := [(11, 1), (28, 1), (31, 1), (68, 1)] }, { coefficient := -1, powers := [(11, 1), (28, 1)] }, { coefficient := -1, powers := [(16, 1), (23, 1)] }, { coefficient := 1, powers := [(17, 1), (21, 1), (27, 1), (28, 1), (42, 2), (65, 1)] }],
...
#print axioms Krenn.Component16.SelectedLeafB5_2_1_7.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB5_2_1_7
