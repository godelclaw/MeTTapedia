...
namespace Krenn.Component16.SelectedLeafB1_2_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "7d4cae2e5715952caa4ffb0e82df321a16dea510360b11ca8c73676730334180"
...
def multipliers : Fin 15 → SparsePoly (Fin 64) := ![
  [{ coefficient := 1, powers := [(30, 1), (53, 1), (62, 1), (63, 1)] }],
  [{ coefficient := 2, powers := [(30, 1), (62, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(62, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(62, 1), (63, 1)] }],
  [{ coefficient := -2, powers := [(26, 1), (30, 1), (62, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(19, 1), (26, 1), (62, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(19, 1), (62, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(19, 1), (62, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (30, 1), (62, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (30, 1), (62, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (62, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (39, 1), (60, 1), (62, 1), (63, 1)] }, { coefficient := -1, powers := [(2, 1), (42, 1), (57, 1), (62, 1), (63, 1)] }, { coefficient := -1, powers := [(2, 1), (47, 1), (53, 1), (62, 1), (63, 1)] }, { coefficient := 1, powers := [(19, 1), (30, 1), (47, 1), (62, 1), (63, 1)] }, { coefficient := 1, powers := [(19, 1), (30, 1), (53, 1), (62, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := -1, powers := [(2, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (62, 1), (63, 1)] }, { coefficient := 1, powers := [(19, 1), (21, 1), (30, 1), (62, 1), (63, 1)] }, { coefficient := 1, powers := [(19, 1), (26, 1), (30, 1), (62, 1), (63, 1)] }]
]
...
#print axioms Krenn.Component16.SelectedLeafB1_2_0.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB1_2_0
