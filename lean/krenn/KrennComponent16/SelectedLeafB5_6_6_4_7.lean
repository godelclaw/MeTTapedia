...
namespace Krenn.Component16.SelectedLeafB5_6_6_4_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "3200c2dfb1a3144e8300ac9c08f05874037443885536cf38c5fd54aa8c5d2883"
...
def multipliers : Fin 16 → SparsePoly (Fin 72) := ![
  [{ coefficient := 1, powers := [(11, 1), (23, 1), (47, 1), (60, 1), (71, 1)] }, { coefficient := 1, powers := [(11, 1), (23, 1), (53, 1), (60, 1), (71, 1)] }, { coefficient := 1, powers := [(11, 1), (23, 1), (57, 1), (60, 1), (71, 1)] }, { coefficient := 1, powers := [(11, 1), (33, 1), (47, 2), (71, 1)] }, { coefficient := 1, powers := [(11, 1), (33, 1), (47, 1), (53, 1), (71, 1)] }, { coefficient := 1, powers := [(11, 1), (33, 1), (47, 1), (57, 1), (71, 1)] }, { coefficient := 1, powers := [(11, 1), (36, 1), (42, 1), (47, 1), (71, 1)] }, { coefficient := 1, powers := [(11, 1), (36, 1), (42, 1), (53, 1), (71, 1)] }, { coefficient := 1, powers := [(11, 1), (36, 1), (42, 1), (57, 1), (71, 1)] }],
...
#print axioms Krenn.Component16.SelectedLeafB5_6_6_4_7.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB5_6_6_4_7
