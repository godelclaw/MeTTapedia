...
namespace Krenn.Component16.SelectedLeafB7_2_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "4d9d78c280874e020c74a5c17c8caf2111abe332b61c211578b220e23597c853"
def certificateSHA256 : String := "0d79a05b0762c70a62d2ce86f6cc183fcbd91eabc4e2e4a1512c6f0d494ae271"
...
def multipliers : Fin 17 → SparsePoly (Fin 68) := ![
  ...
  [{ coefficient := -1, powers := [(2, 1), (21, 1), (50, 1), (55, 1), (62, 1)] }, { coefficient := 1, powers := [(2, 1), (22, 1), (45, 1), (55, 1), (62, 1)] }, { coefficient := -1, powers := [(5, 1), (37, 1), (55, 1)] }, { coefficient := 1, powers := [(13, 1), (25, 1), (45, 1), (54, 1)] }, { coefficient := 2, powers := [(13, 1), (31, 1), (50, 1)] }, { coefficient := 1, powers := [(20, 1), (25, 1), (55, 1)] }],
...
#print axioms Krenn.Component16.SelectedLeafB7_2_6.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB7_2_6
