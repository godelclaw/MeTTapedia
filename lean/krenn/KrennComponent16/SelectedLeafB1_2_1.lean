...
namespace Krenn.Component16.SelectedLeafB1_2_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "381e4d87e2245fcce601651ebd7a6e292dbcdafb1738d6dcca7c6f7993f41965"
...
def multipliers : Fin 21 → SparsePoly (Fin 65) := ![
  ...
  [{ coefficient := 1, powers := [(45, 1), (53, 1), (64, 1)] }],
  ...
  [{ coefficient := -1, powers := [(27, 1), (45, 1), (53, 1), (64, 1)] }, { coefficient := 1, powers := [] }],
  ...
  [{ coefficient := -1, powers := [(3, 1), (13, 1), (21, 1), (31, 1), (50, 1), (60, 1)] }, { coefficient := 1, powers := [(3, 1), (13, 1), (21, 1), (37, 1), (40, 1), (60, 1)] }, { coefficient := 1, powers := [(21, 1), (27, 1), (45, 1), (53, 1), (64, 1)] }, { coefficient := -1, powers := [(21, 1)] }],
...
#print axioms Krenn.Component16.SelectedLeafB1_2_1.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB1_2_1
