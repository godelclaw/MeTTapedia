...
namespace Krenn.Component16.SelectedLeafB5_2_2_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "a8153145ead956623929a4e12ab42deb2b3159a109b014fd4d52ce6cd5004d1f"
def certificateSHA256 : String := "e7a0840a991ac44a72701ce4aa2af68afa5444894b9ab000e39d9e691476f2d2"
...
def multipliers : Fin 29 → SparsePoly (Fin 69) := ![
  ...
  [{ coefficient := 1, powers := [(22, 1), (31, 1), (38, 1), (42, 1), (61, 1), (67, 1)] }, { coefficient := 1, powers := [(22, 1), (31, 1), (38, 1), (47, 1), (61, 1), (67, 1)] }, { coefficient := -1, powers := [(24, 1), (40, 1), (61, 1), (67, 1)] }, { coefficient := -1, powers := [(25, 1), (27, 1), (38, 1), (42, 1), (61, 1), (67, 1)] }, { coefficient := -1, powers := [(25, 1), (27, 1), (38, 1), (47, 1), (61, 1), (67, 1)] }, { coefficient := -1, powers := [(25, 1), (38, 1), (54, 1), (61, 1), (67, 1)] }, { coefficient := 1, powers := [(25, 1), (45, 1), (55, 1), (67, 1)] }, { coefficient := -1, powers := [(29, 1), (40, 1), (61, 1), (67, 1)] }, { coefficient := -1, powers := [(31, 1), (38, 1), (49, 1), (61, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (50, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (38, 1), (54, 1), (61, 1), (67, 1)] }, { coefficient := 2, powers := [(20, 1), (29, 1), (55, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (55, 1), (67, 1)] }],
  [{ coefficient := 2, powers := [(20, 1), (25, 1), (26, 1), (54, 1), (68, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (55, 1)] }],
  [{ coefficient := 1, powers := [(19, 1), (38, 1), (61, 1)] }],
  [{ coefficient := -2, powers := [(20, 1), (25, 1)] }],
  [{ coefficient := 1, powers := [(31, 1)] }],
  [{ coefficient := 1, powers := [(20, 1)] }],
  [{ coefficient := -2, powers := [(20, 1), (25, 1), (26, 1), (55, 1), (68, 1)] }],
...
#print axioms Krenn.Component16.SelectedLeafB5_2_2_7.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB5_2_2_7
