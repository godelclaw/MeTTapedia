...
namespace Krenn.Component16.SelectedLeafB5_6_7_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "8c232bf87869ebb4f06678951cf7e6857f5144e06b560f3fe6603ca4e3e60a75"
...
def multipliers : Fin 31 → SparsePoly (Fin 70) := ![
  [{ coefficient := 1, powers := [(25, 1), (47, 1), (58, 1), (67, 1), (69, 1)] }, { coefficient := -1, powers := [(25, 1), (58, 1), (69, 1)] }, { coefficient := -2, powers := [(27, 1), (29, 1), (47, 1), (50, 1), (69, 1)] }, { coefficient := -1, powers := [(30, 1), (49, 1), (58, 1), (67, 1), (69, 1)] }],
  ...
  [{ coefficient := 2, powers := [(19, 1), (26, 1), (45, 1), (50, 1), (55, 1), (68, 1)] }],
  ...
  [{ coefficient := -2, powers := [(19, 1), (26, 1), (50, 1), (55, 1), (68, 1)] }],
  ...
  [{ coefficient := -1, powers := [(0, 1), (2, 1), (58, 1), (62, 1)] }, { coefficient := -1, powers := [(2, 1), (27, 1), (45, 1), (62, 1)] }, { coefficient := -1, powers := [(2, 1), (57, 1), (58, 1), (67, 1)] }, { coefficient := 1, powers := [(2, 1), (58, 1)] }, { coefficient := 1, powers := [(8, 1), (37, 1)] }, { coefficient := -1, powers := [(19, 1), (30, 1), (58, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (34, 1), (58, 1)] }],
  [{ coefficient := 2, powers := [(19, 1), (26, 1), (30, 1), (50, 1), (55, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (25, 1), (47, 1), (58, 1), (67, 1)] }, { coefficient := 1, powers := [(13, 1), (25, 1), (58, 1)] }, { coefficient := 2, powers := [(13, 1), (27, 1), (29, 1), (47, 1), (50, 1)] }, { coefficient := 1, powers := [(13, 1), (30, 1), (49, 1), (58, 1), (67, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (61, 1)] }, { coefficient := 1, powers := [(13, 1), (45, 1), (49, 1)] }, { coefficient := -1, powers := [(13, 1), (50, 1)] }, { coefficient := -2, powers := [(19, 1), (26, 1), (45, 1), (47, 1), (50, 1), (55, 1), (68, 1)] }, { coefficient := 2, powers := [(19, 1), (26, 1), (48, 1), (50, 1), (55, 1), (68, 1)] }]
]
...
#print axioms Krenn.Component16.SelectedLeafB5_6_7_4.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB5_6_7_4
