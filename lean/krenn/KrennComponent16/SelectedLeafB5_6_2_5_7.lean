...
namespace Krenn.Component16.SelectedLeafB5_6_2_5_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "234e1b55a71fe03f4ee82f372885a2f52a02cd8ee152b52bc1c09724f8f277c4"
...
def multipliers : Fin 20 → SparsePoly (Fin 72) := ![
  [{ coefficient := -1, powers := [(11, 1), (23, 1), (42, 1), (60, 1), (71, 1)] }, { coefficient := 1, powers := [(11, 1), (23, 1), (53, 1), (60, 1), (71, 1)] }, { coefficient := 1, powers := [(11, 1), (23, 1), (57, 1), (60, 1), (71, 1)] }],
  [{ coefficient := -1, powers := [(11, 1), (24, 1), (42, 1), (68, 1)] }, { coefficient := 1, powers := [(11, 1), (24, 1), (53, 1), (68, 1)] }, { coefficient := 1, powers := [(11, 1), (24, 1), (57, 1), (68, 1)] }, { coefficient := 1, powers := [(11, 1), (30, 1), (68, 1)] }],
  [{ coefficient := -1, powers := [(11, 1), (33, 1), (62, 1), (71, 1)] }, { coefficient := 1, powers := [(16, 1), (33, 1), (62, 1), (71, 1)] }],
  [{ coefficient := -1, powers := [(23, 1), (60, 1), (71, 1)] }, { coefficient := 1, powers := [(33, 1), (57, 1), (71, 1)] }, { coefficient := 1, powers := [(36, 1), (42, 1), (71, 1)] }, { coefficient := 1, powers := [(36, 1), (53, 1), (71, 1)] }],
  ...
  [{ coefficient := 1, powers := [(11, 1), (23, 1), (42, 1), (68, 1)] }, { coefficient := -1, powers := [(11, 1), (23, 1), (53, 1), (68, 1)] }, { coefficient := -1, powers := [(11, 1), (23, 1), (57, 1), (68, 1)] }],
  [{ coefficient := -1, powers := [(11, 1), (23, 1), (31, 1), (42, 1), (68, 1)] }, { coefficient := 1, powers := [(11, 1), (23, 1), (31, 1), (53, 1), (68, 1)] }, { coefficient := 1, powers := [(11, 1), (23, 1), (31, 1), (57, 1), (68, 1)] }, { coefficient := 1, powers := [(11, 1), (23, 1), (42, 1)] }, { coefficient := -1, powers := [(11, 1), (23, 1), (53, 1)] }, { coefficient := -1, powers := [(11, 1), (23, 1), (57, 1)] }],
  ...
  [{ coefficient := -1, powers := [(39, 1), (60, 1), (61, 1), (71, 1)] }, { coefficient := 1, powers := [(39, 1), (60, 1)] }, { coefficient := 1, powers := [(41, 1), (53, 1), (57, 1), (64, 1)] }, { coefficient := 1, powers := [(42, 1), (47, 1)] }, { coefficient := 1, powers := [(42, 1), (57, 1)] }, { coefficient := 1, powers := [(52, 1), (53, 1), (64, 1)] }, { coefficient := 1, powers := [(53, 1), (57, 1)] }],
  [{ coefficient := 1, powers := [(7, 1), (36, 1), (53, 1)] }],
  [{ coefficient := -1, powers := [(4, 1), (60, 1), (61, 1), (71, 1)] }, { coefficient := 1, powers := [(4, 1), (60, 1)] }, { coefficient := 1, powers := [(10, 1), (53, 1), (64, 1)] }, { coefficient := -1, powers := [(11, 1), (42, 1)] }, { coefficient := -1, powers := [(11, 1), (47, 1)] }, { coefficient := 1, powers := [(11, 1), (57, 1)] }, { coefficient := 1, powers := [(16, 1), (41, 1), (53, 1), (64, 1)] }, { coefficient := 1, powers := [(16, 1), (42, 1)] }],
...
#print axioms Krenn.Component16.SelectedLeafB5_6_2_5_7.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB5_6_2_5_7
