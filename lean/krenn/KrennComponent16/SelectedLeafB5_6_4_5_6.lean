...
namespace Krenn.Component16.SelectedLeafB5_6_4_5_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "e2b21969d3d5ee5b5564687e906c7d1ee877c80d354c46027fb8d3be83672cc1"
def certificateSHA256 : String := "295799c24c2e8e38a02808154709c086d4f480af28887b17e8b3d09d819cbcec"
...
def multipliers : Fin 14 → SparsePoly (Fin 71) := ![
  ...
  [{ coefficient := 1, powers := [(3, 1), (5, 1), (34, 1), (60, 1)] }, { coefficient := 1, powers := [(5, 1), (34, 1)] }, { coefficient := 1, powers := [(13, 1), (25, 1)] }],
  [{ coefficient := 1, powers := [(13, 1), (31, 1), (50, 1)] }, { coefficient := -1, powers := [(13, 1), (37, 1), (40, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (40, 1)] }, { coefficient := 1, powers := [(3, 1), (5, 1), (31, 1), (60, 1)] }, { coefficient := 1, powers := [(8, 1), (25, 1)] }]
]
...
#print axioms Krenn.Component16.SelectedLeafB5_6_4_5_6.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB5_6_4_5_6
