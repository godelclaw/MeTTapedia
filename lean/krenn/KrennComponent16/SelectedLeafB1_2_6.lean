...
namespace Krenn.Component16.SelectedLeafB1_2_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "22d474a320335564a40cf29ec177b3e05d7fbb99934661915462295fbd44b396"
...
def multipliers : Fin 23 → SparsePoly (Fin 66) := ![
  [{ coefficient := -1, powers := [(31, 1), (38, 1), (46, 1), (50, 1), (60, 1), (64, 1)] }],
  ...
  [{ coefficient := 1, powers := [(31, 1), (38, 1), (50, 1), (60, 1), (64, 1)] }],
...
#print axioms Krenn.Component16.SelectedLeafB1_2_6.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB1_2_6
