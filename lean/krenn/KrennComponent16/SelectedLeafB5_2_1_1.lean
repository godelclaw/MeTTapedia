...
namespace Krenn.Component16.SelectedLeafB5_2_1_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "38b3c3b0b8405d239d4165c1acac8f1654c54f39284869a1efa64f01c4bc8e0a"
def certificateSHA256 : String := "666ebdd5a29e2095f03c91792c4d819ece3e05dafd99162c871a7bcdd8f991c8"
...
def multipliers : Fin 27 → SparsePoly (Fin 67) := ![
  ...
  [{ coefficient := 1, powers := [(3, 1), (19, 1), (55, 1), (60, 1)] }, { coefficient := 1, powers := [(19, 1), (38, 1), (55, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(3, 1), (31, 1), (50, 1), (60, 1)] }, { coefficient := -1, powers := [(3, 1), (37, 1), (40, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (29, 1), (53, 1), (55, 1), (60, 1)] }, { coefficient := -1, powers := [(27, 1), (53, 2), (65, 1)] }, { coefficient := 1, powers := [(53, 1), (54, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (3, 1), (53, 1), (55, 1), (60, 1)] }, { coefficient := -1, powers := [(2, 1), (38, 1), (53, 1), (55, 1), (60, 1)] }],
  [{ coefficient := -1, powers := [(3, 1), (31, 1), (60, 1)] }],
  [{ coefficient := -1, powers := [(3, 1), (20, 1), (60, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (29, 1), (55, 1), (60, 1)] }, { coefficient := 1, powers := [(27, 1), (53, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (3, 1), (55, 1), (60, 1)] }, { coefficient := 1, powers := [(2, 1), (38, 1), (55, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (24, 1), (53, 1), (63, 1)] }, { coefficient := 1, powers := [(0, 1), (30, 1), (63, 1)] }, { coefficient := -1, powers := [(3, 1), (25, 1), (45, 1), (55, 1), (60, 1)] }, { coefficient := -1, powers := [(25, 1), (38, 1), (45, 1), (55, 1), (60, 1)] }],
  [{ coefficient := 2, powers := [(3, 1), (25, 1), (55, 1), (60, 1)] }, { coefficient := 1, powers := [(25, 1), (38, 1), (55, 1), (60, 1)] }],
  [{ coefficient := -1, powers := [(3, 1), (55, 1), (60, 1)] }, { coefficient := -1, powers := [(38, 1), (55, 1), (60, 1)] }],
  ...
  [{ coefficient := 1, powers := [(0, 1), (19, 1), (24, 1), (63, 1)] }, { coefficient := -1, powers := [(3, 1), (13, 1), (21, 1), (31, 1), (50, 1), (60, 1)] }, { coefficient := 1, powers := [(3, 1), (13, 1), (21, 1), (37, 1), (40, 1), (60, 1)] }, { coefficient := -1, powers := [(21, 1)] }],
  [{ coefficient := 1, powers := [(21, 1), (53, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (19, 1), (24, 1), (42, 1), (53, 1), (63, 1)] }, { coefficient := -1, powers := [(0, 1), (19, 1), (24, 1), (47, 1), (53, 1), (63, 1)] }, { coefficient := -1, powers := [(0, 1), (19, 1), (30, 1), (42, 1), (63, 1)] }, { coefficient := -1, powers := [(0, 1), (19, 1), (30, 1), (47, 1), (63, 1)] }, { coefficient := 1, powers := [(2, 1), (3, 1), (50, 1), (53, 1), (55, 1), (60, 1)] }, { coefficient := 1, powers := [(2, 1), (38, 1), (50, 1), (53, 1), (55, 1), (60, 1)] }, { coefficient := 1, powers := [(3, 1), (19, 1), (25, 1), (42, 1), (45, 1), (55, 1), (60, 1)] }, { coefficient := 1, powers := [(3, 1), (19, 1), (25, 1), (45, 1), (47, 1), (55, 1), (60, 1)] }, { coefficient := -2, powers := [(3, 1), (19, 1), (25, 1), (48, 1), (55, 1), (60, 1)] }, { coefficient := -2, powers := [(3, 1), (20, 1), (25, 1), (42, 1), (55, 1), (60, 1)] }, { coefficient := -1, powers := [(5, 1), (29, 1), (45, 1), (53, 1), (55, 1), (60, 1)] }, { coefficient := 1, powers := [(19, 1), (25, 1), (38, 1), (42, 1), (45, 1), (55, 1), (60, 1)] }, { coefficient := 1, powers := [(19, 1), (25, 1), (38, 1), (45, 1), (47, 1), (55, 1), (60, 1)] }, { coefficient := -1, powers := [(19, 1), (25, 1), (38, 1), (48, 1), (55, 1), (60, 1)] }, { coefficient := -1, powers := [(20, 1), (25, 1), (38, 1), (42, 1), (55, 1), (60, 1)] }, { coefficient := 1, powers := [(27, 1), (45, 1), (53, 2), (65, 1)] }, { coefficient := -1, powers := [(45, 1), (53, 1), (54, 1), (65, 1)] }]
]
...
#print axioms Krenn.Component16.SelectedLeafB5_2_1_1.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB5_2_1_1
