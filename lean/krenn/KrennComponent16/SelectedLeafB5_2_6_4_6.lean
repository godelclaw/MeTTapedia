...
namespace Krenn.Component16.SelectedLeafB5_2_6_4_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "7bfa8fa9196498a74fae9a9d55a7cc918a4a0a390fa86f6a2a56827e9f73fcf4"
...
def multipliers : Fin 20 → SparsePoly (Fin 70) := ![
  ...
  [{ coefficient := -1, powers := [(0, 1), (2, 1), (58, 1), (67, 1)] }, { coefficient := -1, powers := [(2, 1), (20, 1), (25, 1), (55, 1), (58, 1)] }, { coefficient := -1, powers := [(2, 1), (27, 1), (45, 1), (67, 1)] }, { coefficient := 1, powers := [(2, 1), (58, 1)] }, { coefficient := -1, powers := [(8, 1), (20, 1), (25, 1), (37, 1), (55, 1)] }, { coefficient := 1, powers := [(8, 1), (37, 1)] }],
  ...
  [{ coefficient := -1, powers := [(0, 1), (2, 1), (40, 1), (67, 1)] }, { coefficient := -1, powers := [(2, 1), (20, 1), (25, 1), (40, 1), (55, 1)] }, { coefficient := 1, powers := [(2, 1), (40, 1)] }, { coefficient := 1, powers := [(5, 1), (8, 1), (25, 1), (37, 1), (55, 1)] }, { coefficient := -1, powers := [(8, 1), (20, 1), (25, 2), (55, 1)] }, { coefficient := 1, powers := [(8, 1), (25, 1)] }]
]
...
#print axioms Krenn.Component16.SelectedLeafB5_2_6_4_6.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB5_2_6_4_6
