...
namespace Krenn.Component16.SelectedLeafB5_2_2_5_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "d033973494f42a81b6e0aa009da3aa7ce8e04649d3da58e9c551c1e9deea0211"
...
def multipliers : Fin 18 → SparsePoly (Fin 71) := ![
  [{ coefficient := -1, powers := [(11, 1), (23, 1), (42, 1), (60, 1), (70, 1)] }, { coefficient := 1, powers := [(11, 1), (23, 1), (53, 1), (60, 1), (70, 1)] }, { coefficient := 1, powers := [(11, 1), (23, 1), (57, 1), (60, 1), (70, 1)] }, { coefficient := 1, powers := [(16, 1), (23, 1), (53, 1), (60, 1), (70, 1)] }],
  ...
  [{ coefficient := -1, powers := [(39, 1), (60, 1), (61, 1), (70, 1)] }, { coefficient := 1, powers := [(39, 1), (60, 1)] }, { coefficient := 1, powers := [(42, 1), (47, 1)] }, { coefficient := 1, powers := [(42, 1), (57, 1)] }, { coefficient := -1, powers := [(47, 1), (53, 1)] }, { coefficient := 1, powers := [(53, 1), (57, 1)] }],
...
#print axioms Krenn.Component16.SelectedLeafB5_2_2_5_7.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB5_2_2_5_7
