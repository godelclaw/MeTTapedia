...
namespace Krenn.Component16.SelectedLeafB5_2_3_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "e543f079af7c148d36c15b1db55d76aa579a31077c631ad85ab8628c198f89d8"
def certificateSHA256 : String := "63563e9fc34584f042ef40881591c8acdd6af9d58484728e9dc46992bbbbe2ce"
...
def multipliers : Fin 29 → SparsePoly (Fin 69) := ![
  ...
  [{ coefficient := 1, powers := [(20, 1), (24, 1), (25, 1), (55, 1), (63, 1), (68, 1)] }, { coefficient := 1, powers := [(20, 1), (25, 1), (29, 1), (55, 1), (63, 1), (68, 1)] }, { coefficient := 1, powers := [(25, 1), (45, 1), (55, 1), (68, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (50, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (22, 1), (55, 1), (62, 1), (68, 1)] }],
  [{ coefficient := 1, powers := [(20, 1), (29, 1), (55, 1), (68, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (21, 1), (55, 1), (62, 1), (68, 1)] }, { coefficient := -1, powers := [(2, 1), (55, 1), (68, 1)] }],
  ...
  [{ coefficient := -1, powers := [(20, 1), (25, 1), (55, 1), (63, 1)] }],
  ...
  [{ coefficient := -1, powers := [(0, 1), (2, 1), (58, 1), (62, 1)] }, { coefficient := -1, powers := [(2, 1), (27, 1), (45, 1), (62, 1)] }, { coefficient := -1, powers := [(2, 1), (57, 1), (58, 1), (65, 1)] }, { coefficient := 1, powers := [(2, 1), (58, 1)] }, { coefficient := 1, powers := [(8, 1), (37, 1)] }, { coefficient := -1, powers := [(19, 1), (30, 1), (58, 1), (65, 1)] }],
  ...
  [{ coefficient := -1, powers := [(2, 1), (21, 1), (50, 1), (55, 1), (62, 1)] }, { coefficient := 1, powers := [(2, 1), (22, 1), (45, 1), (55, 1), (62, 1)] }, { coefficient := 1, powers := [(2, 1), (50, 1), (55, 1)] }, { coefficient := -1, powers := [(19, 1), (20, 1), (24, 1), (25, 1), (55, 1), (63, 1)] }, { coefficient := -1, powers := [(19, 1), (20, 1), (25, 1), (29, 1), (55, 1), (63, 1)] }, { coefficient := -1, powers := [(19, 1), (25, 1), (45, 1), (55, 1)] }, { coefficient := -1, powers := [(20, 1), (29, 1), (49, 1), (55, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (61, 1)] }, { coefficient := -1, powers := [(6, 1), (20, 1), (43, 1), (60, 1)] }, { coefficient := 1, powers := [(13, 1), (45, 1), (49, 1)] }, { coefficient := -1, powers := [(13, 1), (50, 1)] }, { coefficient := -1, powers := [(20, 1), (38, 1), (43, 1), (60, 1)] }]
]
...
#print axioms Krenn.Component16.SelectedLeafB5_2_3_6.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB5_2_3_6
