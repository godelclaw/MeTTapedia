...
namespace Krenn.Component16.SelectedLeafB1_2_7_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "a660d651d9fab32fcfeb71933fb7fa4e35f54a9cc10a6895c764d0dfa1cfbcb1"
...
def multipliers : Fin 6 → SparsePoly (Fin 69) := ![
  [{ coefficient := 1, powers := [(27, 1), (53, 1), (66, 1), (68, 1)] }, { coefficient := -1, powers := [(54, 1), (66, 1), (68, 1)] }],
  [{ coefficient := -1, powers := [(27, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(66, 1)] }],
  [{ coefficient := 1, powers := [(27, 1), (48, 1), (53, 1), (66, 1)] }, { coefficient := -1, powers := [(42, 1), (58, 1), (66, 1)] }, { coefficient := -1, powers := [(48, 1), (54, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := -1, powers := [(27, 1), (45, 1), (53, 1), (66, 1)] }, { coefficient := 1, powers := [(45, 1), (54, 1), (66, 1)] }]
]
...
#print axioms Krenn.Component16.SelectedLeafB1_2_7_6.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB1_2_7_6
