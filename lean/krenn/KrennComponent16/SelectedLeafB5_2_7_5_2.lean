...
namespace Krenn.Component16.SelectedLeafB5_2_7_5_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "53633326a023ffc470d8dbedcdd76ffe5a43481c9efc57852028ecd56c16c7c5"
def certificateSHA256 : String := "605f9110917bc347764b3d3035a6f0d8b8065adae20802cbd59227fe6c8313c9"

set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedSourceIndices : Fin 21 → Fin 677 := ![
  9,
  13,
  23,
  162,
...
def multipliers : Fin 21 → SparsePoly (Fin 71) := ![
  [{ coefficient := 1, powers := [(25, 1), (47, 1), (58, 1), (66, 1), (68, 1)] }, { coefficient := 2, powers := [(25, 1), (58, 1), (68, 1)] }, { coefficient := -1, powers := [(30, 1), (49, 1), (58, 1), (66, 1), (68, 1)] }, { coefficient := -1, powers := [(31, 1), (50, 1), (68, 1)] }, { coefficient := 1, powers := [(37, 1), (40, 1), (68, 1)] }],
  ...
  [{ coefficient := -1, powers := [(0, 1), (2, 1), (58, 1), (68, 1)] }, { coefficient := -1, powers := [(2, 1), (27, 1), (45, 1), (68, 1)] }, { coefficient := -1, powers := [(2, 1), (57, 1), (58, 1), (66, 1)] }, { coefficient := 1, powers := [(2, 1), (58, 1)] }, { coefficient := 1, powers := [(8, 1), (37, 1)] }, { coefficient := -1, powers := [(19, 1), (30, 1), (58, 1), (66, 1)] }, { coefficient := -1, powers := [(20, 1), (31, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (34, 1), (58, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (50, 1), (55, 1)] }, { coefficient := -1, powers := [(13, 1), (25, 1), (47, 1), (58, 1), (66, 1)] }, { coefficient := -2, powers := [(13, 1), (25, 1), (58, 1)] }, { coefficient := 1, powers := [(13, 1), (30, 1), (49, 1), (58, 1), (66, 1)] }, { coefficient := 1, powers := [(13, 1), (31, 1), (50, 1)] }, { coefficient := -1, powers := [(13, 1), (37, 1), (40, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (2, 1), (40, 1), (68, 1)] }, { coefficient := 1, powers := [(2, 1), (40, 1)] }, { coefficient := 2, powers := [(8, 1), (25, 1)] }]
]
...
#print axioms Krenn.Component16.SelectedLeafB5_2_7_5_2.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB5_2_7_5_2
