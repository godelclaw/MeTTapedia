...
namespace Krenn.Component16.SelectedLeafB5_0_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "a1cf47ea4ad656c5dc33caf003d1bb01d78a0e97f8273834b85a74f45bd562bc"
def certificateSHA256 : String := "2a18da5d701d811ca404d41ed80ef0a329ee8e53b5449345fcb4900055fa8848"
...
def multipliers : Fin 31 → SparsePoly (Fin 67) := ![
  [{ coefficient := 1, powers := [(25, 1), (46, 1), (58, 1), (64, 1)] }, { coefficient := 1, powers := [(30, 1), (46, 1), (49, 1), (58, 1), (64, 1), (65, 1)] }, { coefficient := 1, powers := [(31, 1), (46, 1), (50, 1), (64, 1)] }, { coefficient := -1, powers := [(37, 1), (40, 1), (46, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(25, 1), (27, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (50, 1)] }],
  [{ coefficient := 2, powers := [(0, 1), (19, 1), (21, 1), (47, 1), (50, 1)] }, { coefficient := 2, powers := [(19, 1), (21, 1), (26, 1), (47, 1), (50, 1)] }, { coefficient := -2, powers := [(19, 1), (26, 1), (50, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (22, 1), (45, 1), (53, 1), (62, 1)] }, { coefficient := 2, powers := [(2, 1), (47, 1), (50, 1)] }, { coefficient := -2, powers := [(19, 1), (29, 1), (47, 1), (50, 1)] }],
  [{ coefficient := 1, powers := [(25, 1), (45, 1), (55, 1), (62, 1)] }, { coefficient := 2, powers := [(25, 1), (48, 1), (55, 1)] }, { coefficient := 2, powers := [(29, 1), (47, 1), (50, 1), (55, 1)] }, { coefficient := 2, powers := [(30, 1), (50, 1), (55, 1)] }],
  [{ coefficient := 2, powers := [(25, 1), (55, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (55, 1)] }],
  [{ coefficient := -2, powers := [(2, 1), (50, 1)] }, { coefficient := 2, powers := [(19, 1), (29, 1), (50, 1)] }],
  [{ coefficient := -1, powers := [(25, 1), (58, 1), (64, 1)] }, { coefficient := -1, powers := [(30, 1), (49, 1), (58, 1), (64, 1), (65, 1)] }, { coefficient := -1, powers := [(31, 1), (50, 1), (64, 1)] }, { coefficient := 1, powers := [(37, 1), (40, 1), (64, 1)] }],
  ...
  [{ coefficient := 2, powers := [(19, 1), (21, 1), (50, 1), (55, 1)] }],
  [{ coefficient := -2, powers := [(19, 1), (21, 1), (30, 1), (50, 1), (55, 1)] }],
  ...
  [{ coefficient := 2, powers := [(19, 1), (21, 1), (26, 1), (30, 1), (50, 1), (55, 1)] }, { coefficient := 2, powers := [(19, 1), (26, 1), (29, 1), (50, 1), (55, 1)] }, { coefficient := 2, powers := [(20, 1), (21, 1), (25, 1), (55, 1)] }, { coefficient := 2, powers := [(20, 1), (25, 1), (26, 1), (55, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (2, 1), (58, 1), (62, 1)] }, { coefficient := -1, powers := [(2, 1), (27, 1), (45, 1), (62, 1)] }, { coefficient := -1, powers := [(2, 1), (57, 1), (58, 1), (65, 1)] }, { coefficient := 1, powers := [(2, 1), (58, 1)] }, { coefficient := 1, powers := [(8, 1), (37, 1)] }, { coefficient := -1, powers := [(19, 1), (30, 1), (58, 1), (65, 1)] }, { coefficient := -1, powers := [(20, 1), (31, 1)] }],
  [{ coefficient := 1, powers := [(13, 1), (25, 1), (58, 1)] }, { coefficient := 1, powers := [(13, 1), (30, 1), (49, 1), (58, 1), (65, 1)] }, { coefficient := 1, powers := [(13, 1), (31, 1), (50, 1)] }, { coefficient := -1, powers := [(13, 1), (37, 1), (40, 1)] }],
...
#print axioms Krenn.Component16.SelectedLeafB5_0_7.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB5_0_7
