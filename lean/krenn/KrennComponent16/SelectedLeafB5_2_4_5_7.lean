...
namespace Krenn.Component16.SelectedLeafB5_2_4_5_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "743e50f3bf58ccee59b75010d15223a801800d340fffee88362b0fe97d46675f"
...
def multipliers : Fin 25 → SparsePoly (Fin 71) := ![
  [{ coefficient := -1, powers := [(2, 1), (60, 1), (63, 1), (70, 1)] }, { coefficient := 2, powers := [(7, 1), (36, 1), (42, 1), (60, 1), (70, 1)] }, { coefficient := 2, powers := [(19, 1), (29, 1), (60, 1), (63, 1), (70, 1)] }, { coefficient := 2, powers := [(60, 1), (70, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (60, 1), (63, 1), (70, 1)] }, { coefficient := 2, powers := [(7, 1), (33, 1), (42, 1), (60, 1), (70, 1)] }, { coefficient := 2, powers := [(19, 1), (24, 1), (60, 1), (63, 1), (70, 1)] }],
  ...
  [{ coefficient := -1, powers := [(2, 1), (42, 1), (60, 1), (63, 1), (70, 1)] }, { coefficient := -2, powers := [(53, 1), (60, 1), (70, 1)] }],
  [{ coefficient := -2, powers := [(38, 1), (60, 2), (70, 1)] }],
  ...
  [{ coefficient := 2, powers := [(38, 1), (39, 1), (60, 2), (61, 1), (70, 1)] }, { coefficient := -2, powers := [(38, 1), (42, 1), (53, 1), (60, 1)] }, { coefficient := -2, powers := [(38, 1), (42, 1), (57, 1), (60, 1)] }, { coefficient := 2, powers := [(38, 1), (47, 1), (53, 1), (60, 1)] }, { coefficient := 2, powers := [(39, 1), (60, 1)] }],
  ...
  [{ coefficient := 2, powers := [(4, 1), (38, 1), (60, 2), (61, 1), (70, 1)] }, { coefficient := -2, powers := [(4, 1), (38, 1), (60, 2)] }, { coefficient := -2, powers := [(11, 1), (38, 1), (42, 1), (60, 1)] }, { coefficient := -2, powers := [(16, 1), (38, 1), (42, 1), (60, 1)] }],
...
#print axioms Krenn.Component16.SelectedLeafB5_2_4_5_7.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB5_2_4_5_7
