...
namespace Krenn.Component16.SelectedLeafB6_6_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "1b23b944cdf5d011c97fd79f0d1ed4fadf70c1f277f5953db8293f5772638bb3"
def certificateSHA256 : String := "f88703822a0be6de986d53fe5e55ab23aeb858e38693751465eff782ee738ec8"
...
def multipliers : Fin 15 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := -1, powers := [(5, 1), (37, 1), (55, 1)] }, { coefficient := 1, powers := [(13, 1), (31, 1), (50, 1)] }, { coefficient := 1, powers := [(20, 1), (25, 1), (55, 1)] }],
...
#print axioms Krenn.Component16.SelectedLeafB6_6_0.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB6_6_0
