...
namespace Krenn.Component16.SelectedLeafB1_2_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "5b40c460ee41e0155dc0f05db85c3ee06f146a4953fa2fd4618aa563dd982d54"
...
def multipliers : Fin 15 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := 1, powers := [(2, 1), (62, 1)] }, { coefficient := 1, powers := [(19, 1), (29, 1), (62, 1)] }, { coefficient := -1, powers := [(58, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(65, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (53, 1), (62, 1)] }, { coefficient := 1, powers := [(19, 1), (21, 1), (30, 1), (47, 1), (62, 1)] }, { coefficient := -1, powers := [(19, 1), (24, 1), (47, 1), (62, 1)] }, { coefficient := -1, powers := [(19, 1), (29, 1), (53, 1), (62, 1)] }, { coefficient := 1, powers := [(27, 1), (48, 1), (53, 1), (65, 1)] }, { coefficient := -1, powers := [(42, 1), (58, 1), (65, 1)] }, { coefficient := -1, powers := [(48, 1), (54, 1), (65, 1)] }, { coefficient := 1, powers := [(53, 1), (58, 1), (65, 1)] }],
...
#print axioms Krenn.Component16.SelectedLeafB1_2_3.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB1_2_3
