...
namespace Krenn.Component16.SelectedLeafB5_2_2_4_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "8326606270eab54be2338cec612c0780959735df3f00ec225f1b8c419003c2a5"
...
def multipliers : Fin 20 → SparsePoly (Fin 68) := ![
  ...
  [{ coefficient := 1, powers := [(2, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(20, 1), (25, 1), (55, 1)] }, { coefficient := -1, powers := [] }],
  [{ coefficient := -1, powers := [(19, 1), (25, 1), (45, 1), (55, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (2, 1), (58, 1), (66, 1)] }, { coefficient := -1, powers := [(2, 1), (20, 1), (25, 1), (55, 1), (58, 1)] }, { coefficient := -1, powers := [(2, 1), (27, 1), (45, 1), (66, 1)] }, { coefficient := 1, powers := [(2, 1), (58, 1)] }, { coefficient := -1, powers := [(8, 1), (20, 1), (25, 1), (37, 1), (55, 1)] }, { coefficient := 1, powers := [(8, 1), (37, 1)] }],
  ...
  [{ coefficient := -1, powers := [(0, 1), (2, 1), (40, 1), (66, 1)] }, { coefficient := -1, powers := [(2, 1), (20, 1), (25, 1), (40, 1), (55, 1)] }, { coefficient := 1, powers := [(2, 1), (40, 1)] }, { coefficient := 1, powers := [(5, 1), (8, 1), (25, 1), (37, 1), (55, 1)] }, { coefficient := -1, powers := [(8, 1), (20, 1), (25, 2), (55, 1)] }, { coefficient := 1, powers := [(8, 1), (25, 1)] }]
]
...
#print axioms Krenn.Component16.SelectedLeafB5_2_2_4_2.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB5_2_2_4_2
