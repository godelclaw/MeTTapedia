...
namespace Krenn.Component16.SelectedLeafB5_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "e729e1cf013527a29e6decc1bc683360e9cd80006496fb5c38b997965be1d294"
...
def multipliers : Fin 34 → SparsePoly (Fin 65) := ![
  ...
  [{ coefficient := 1, powers := [(8, 1), (33, 1), (37, 1), (39, 1), (43, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(6, 1), (11, 1), (37, 1), (43, 1), (53, 1), (54, 1)] }, { coefficient := -1, powers := [(7, 1), (37, 1), (43, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (50, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (2, 1), (27, 1), (43, 1), (48, 1), (53, 1), (62, 1), (64, 1)] }, { coefficient := -1, powers := [(0, 1), (2, 1), (43, 1), (48, 1), (54, 1), (62, 1), (64, 1)] }, { coefficient := -1, powers := [(2, 1), (27, 1), (43, 1), (48, 1), (53, 1), (64, 1)] }, { coefficient := 1, powers := [(2, 1), (43, 1), (48, 1), (54, 1), (64, 1)] }, { coefficient := -1, powers := [(2, 1), (50, 1), (53, 1), (55, 1), (64, 1)] }, { coefficient := 1, powers := [(2, 1), (50, 1), (55, 1), (62, 1), (64, 1)] }, { coefficient := -1, powers := [(5, 1), (27, 1), (34, 1), (48, 1), (53, 1), (64, 1)] }, { coefficient := 1, powers := [(5, 1), (34, 1), (48, 1), (54, 1), (64, 1)] }, { coefficient := 1, powers := [(13, 1), (25, 1), (27, 1), (48, 1), (53, 1), (64, 1)] }, { coefficient := -1, powers := [(13, 1), (25, 1), (48, 1), (54, 1), (64, 1)] }, { coefficient := -2, powers := [(13, 1), (31, 1), (50, 1), (53, 1), (64, 1)] }, { coefficient := 2, powers := [(19, 1), (25, 1), (48, 1), (55, 1), (64, 1)] }, { coefficient := 1, powers := [(19, 1), (31, 1), (43, 1), (48, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(7, 1), (8, 1), (37, 1), (43, 1), (60, 1), (64, 1)] }, { coefficient := -2, powers := [(8, 1), (11, 1), (37, 1), (43, 1), (47, 1), (64, 1)] }, { coefficient := -1, powers := [(8, 1), (11, 1), (37, 1), (43, 1), (57, 1), (64, 1)] }, { coefficient := -1, powers := [(8, 1), (16, 1), (37, 1), (43, 1), (53, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (27, 1), (62, 1)] }, { coefficient := -1, powers := [(13, 1), (25, 1), (54, 1), (64, 1)] }, { coefficient := 1, powers := [(19, 1), (25, 1), (55, 1), (64, 1)] }],
...
#print axioms Krenn.Component16.SelectedLeafB5_1.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB5_1
