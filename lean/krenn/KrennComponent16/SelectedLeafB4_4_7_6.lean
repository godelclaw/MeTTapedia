...
namespace Krenn.Component16.SelectedLeafB4_4_7_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "f445327e39971bccea8144c998d756d3a0e1ba02407ae961902908fa6dd06b5d"
def certificateSHA256 : String := "45e6d2fccbf92b7467655c44f65c48bd2bbfbd2a3671e7812093b66853e502ee"

set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedSourceIndices : Fin 22 → Fin 674 := ![
  9,
  13,
  18,
  23,
...
def multipliers : Fin 22 → SparsePoly (Fin 69) := ![
  [{ coefficient := 1, powers := [(25, 1), (47, 1), (58, 1), (65, 1), (67, 1)] }, { coefficient := -1, powers := [(25, 1), (57, 1), (58, 1), (65, 1), (67, 1)] }, { coefficient := -1, powers := [(30, 1), (49, 1), (58, 1), (65, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(25, 1), (27, 1), (57, 1), (65, 1)] }],
  [{ coefficient := 2, powers := [(25, 1), (26, 1), (48, 1), (55, 1), (57, 1), (65, 1), (68, 1)] }, { coefficient := 1, powers := [(25, 1), (45, 1), (55, 1), (57, 1), (65, 1), (68, 1)] }],
  ...
  [{ coefficient := 2, powers := [(20, 1), (25, 1), (26, 1), (55, 1), (57, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (37, 1), (57, 1), (65, 1)] }, { coefficient := -1, powers := [(19, 1), (30, 1), (58, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := -1, powers := [(13, 1), (25, 1), (47, 1), (58, 1), (65, 1)] }, { coefficient := 1, powers := [(13, 1), (25, 1), (57, 1), (58, 1), (65, 1)] }, { coefficient := 1, powers := [(13, 1), (30, 1), (49, 1), (58, 1), (65, 1)] }],
  [{ coefficient := -2, powers := [(19, 1), (25, 1), (26, 1), (48, 1), (55, 1), (57, 1), (65, 1)] }, { coefficient := -1, powers := [(19, 1), (25, 1), (45, 1), (55, 1), (57, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (57, 1), (61, 1), (65, 1)] }, { coefficient := 1, powers := [(13, 1), (45, 1), (49, 1), (57, 1), (65, 1)] }, { coefficient := -1, powers := [(13, 1), (50, 1), (57, 1), (65, 1)] }]
]
...
#print axioms Krenn.Component16.SelectedLeafB4_4_7_6.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB4_4_7_6
