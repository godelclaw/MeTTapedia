...
namespace Krenn.Component16.SelectedLeafB7_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "57f142abe09a6bebbbee35a57b7ce110d7b99b788f1fb0f23b35333271c5917b"
def certificateSHA256 : String := "df1e4e275c6b31aa305ea8ada79e6bb880ee371b1f705807aaab7e5c97b7d695"
...
def multipliers : Fin 34 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := -1, powers := [(0, 1), (8, 1), (23, 1), (25, 1), (61, 1), (63, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (50, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (2, 1), (27, 1), (43, 1), (48, 1), (53, 1), (62, 1), (65, 1)] }, { coefficient := -1, powers := [(0, 1), (2, 1), (43, 1), (48, 1), (54, 1), (62, 1), (65, 1)] }, { coefficient := -1, powers := [(2, 1), (27, 1), (43, 1), (48, 1), (53, 1), (65, 1)] }, { coefficient := 1, powers := [(2, 1), (43, 1), (48, 1), (54, 1), (65, 1)] }, { coefficient := -1, powers := [(5, 1), (27, 1), (34, 1), (48, 1), (53, 1), (65, 1)] }, { coefficient := 1, powers := [(5, 1), (34, 1), (48, 1), (54, 1), (65, 1)] }, { coefficient := 1, powers := [(13, 1), (25, 1), (27, 1), (48, 1), (53, 1), (65, 1)] }, { coefficient := -1, powers := [(13, 1), (25, 1), (48, 1), (54, 1), (65, 1)] }, { coefficient := 1, powers := [(19, 1), (31, 1), (43, 1), (48, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (8, 1), (16, 1), (37, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (8, 1), (17, 1), (36, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (22, 1), (55, 1), (62, 1), (65, 1)] }, { coefficient := -1, powers := [(2, 1), (27, 1), (62, 1)] }, { coefficient := -1, powers := [(13, 1), (25, 1), (54, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (50, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (8, 1), (25, 1), (36, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (37, 1), (43, 1), (65, 1)] }],
...
#print axioms Krenn.Component16.SelectedLeafB7_1.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB7_1
