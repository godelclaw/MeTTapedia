...
namespace Krenn.Component16.SelectedLeafB1_6_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "d6c893a033b988473ab6e30fe90d393b54327379774fe2a91513d3e0a3011424"
...
def multipliers : Fin 21 → SparsePoly (Fin 67) := ![
  ...
  [{ coefficient := 1, powers := [(45, 1), (53, 1), (66, 1)] }],
  ...
  [{ coefficient := -1, powers := [(27, 1), (45, 1), (53, 1), (66, 1)] }, { coefficient := 1, powers := [] }],
  ...
  [{ coefficient := -1, powers := [(3, 1), (13, 1), (21, 1), (31, 1), (50, 1), (60, 1)] }, { coefficient := 1, powers := [(3, 1), (13, 1), (21, 1), (37, 1), (40, 1), (60, 1)] }, { coefficient := 1, powers := [(21, 1), (27, 1), (45, 1), (53, 1), (66, 1)] }, { coefficient := -1, powers := [(21, 1)] }],
...
#print axioms Krenn.Component16.SelectedLeafB1_6_5.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB1_6_5
