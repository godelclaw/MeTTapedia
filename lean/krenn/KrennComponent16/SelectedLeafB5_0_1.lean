...
namespace Krenn.Component16.SelectedLeafB5_0_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "bf13151e3e2fa9cc38ce48fb9c07d50eb6fe0dde12dcda5481001404a8673dff"
def certificateSHA256 : String := "6d5c1c0b9f52f222aee4d7b29ad1b62c7df098ea0a18adb344d6f6f7c8bc9541"
...
def multipliers : Fin 35 → SparsePoly (Fin 65) := ![
  ...
  [{ coefficient := 2, powers := [(0, 1), (27, 1), (47, 1), (53, 1), (64, 1)] }, { coefficient := 2, powers := [(27, 1), (53, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (24, 1), (53, 1), (63, 1)] }, { coefficient := -1, powers := [(0, 1), (29, 1), (53, 1), (63, 1)] }],
  [{ coefficient := 2, powers := [(3, 1), (25, 1), (55, 1), (60, 1)] }],
  [{ coefficient := 2, powers := [(0, 1), (45, 1), (47, 1), (53, 1), (64, 1)] }, { coefficient := 2, powers := [(45, 1), (53, 1), (64, 1)] }],
  ...
  [{ coefficient := -2, powers := [(0, 1), (47, 1), (53, 1), (64, 1)] }, { coefficient := -2, powers := [(53, 1), (64, 1)] }],
  [{ coefficient := 2, powers := [(0, 1), (53, 1), (63, 1)] }],
  [{ coefficient := -2, powers := [(5, 1), (60, 1)] }],
  [{ coefficient := 2, powers := [(0, 1), (21, 1), (53, 1), (62, 1)] }],
  [{ coefficient := 2, powers := [(0, 1), (26, 1), (53, 1), (62, 1)] }, { coefficient := -2, powers := [(0, 1), (27, 1), (45, 1), (47, 1), (53, 1), (64, 1)] }, { coefficient := -2, powers := [(27, 1), (45, 1), (53, 1), (64, 1)] }, { coefficient := 2, powers := [] }],
  ...
  [{ coefficient := 1, powers := [(0, 1), (2, 1), (26, 1), (53, 1), (63, 1)] }, { coefficient := 1, powers := [(0, 1), (19, 1), (24, 1), (63, 1)] }, { coefficient := 1, powers := [(0, 1), (19, 1), (29, 1), (63, 1)] }, { coefficient := 2, powers := [(0, 1), (21, 1), (27, 1), (45, 1), (47, 1), (53, 1), (64, 1)] }, { coefficient := 1, powers := [(0, 1)] }, { coefficient := -2, powers := [(3, 1), (13, 1), (21, 1), (31, 1), (50, 1), (60, 1)] }, { coefficient := 2, powers := [(3, 1), (13, 1), (21, 1), (37, 1), (40, 1), (60, 1)] }, { coefficient := 2, powers := [(21, 1), (27, 1), (45, 1), (53, 1), (64, 1)] }, { coefficient := -2, powers := [(21, 1)] }],
...
#print axioms Krenn.Component16.SelectedLeafB5_0_1.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB5_0_1
