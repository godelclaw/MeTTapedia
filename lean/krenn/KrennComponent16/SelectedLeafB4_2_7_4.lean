...
namespace Krenn.Component16.SelectedLeafB4_2_7_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "ab88fe44a9b2d0bd9f0d5bd9e2eaaa29ad387b19740076b5d69237978e27d1da"
...
def multipliers : Fin 27 → SparsePoly (Fin 68) := ![
  ...
  [{ coefficient := -1, powers := [(20, 1), (22, 1), (45, 1), (55, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(22, 1), (55, 1)] }],
  [{ coefficient := 1, powers := [(55, 1)] }],
  [{ coefficient := 1, powers := [(50, 1)] }],
  [{ coefficient := 1, powers := [(25, 1)] }],
  [{ coefficient := 1, powers := [(13, 1)] }],
  [{ coefficient := 1, powers := [(20, 1), (22, 1), (55, 1), (66, 1)] }],
  ...
  [{ coefficient := 1, powers := [(5, 1), (61, 1)] }, { coefficient := 1, powers := [(13, 1), (45, 1), (49, 1)] }, { coefficient := -1, powers := [(13, 1), (50, 1)] }, { coefficient := 1, powers := [(20, 1), (22, 1), (45, 1), (47, 1), (55, 1), (66, 1)] }, { coefficient := -1, powers := [(20, 1), (22, 1), (48, 1), (55, 1), (66, 1)] }]
]
...
#print axioms Krenn.Component16.SelectedLeafB4_2_7_4.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB4_2_7_4
