...
namespace Krenn.Component16.SelectedLeafB7_6_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "4249a1b242558dea87afbf1d528c777193531f2c31a0b51ea85fb25c758bfa68"
...
def multipliers : Fin 35 → SparsePoly (Fin 69) := ![
  ...
  [{ coefficient := -1, powers := [(7, 1), (45, 1), (60, 1), (68, 1)] }, { coefficient := 1, powers := [(11, 1), (45, 1), (53, 1), (68, 1)] }],
  ...
  [{ coefficient := 1, powers := [(7, 1), (60, 1), (68, 1)] }, { coefficient := -1, powers := [(11, 1), (53, 1), (68, 1)] }],
...
#print axioms Krenn.Component16.SelectedLeafB7_6_5.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB7_6_5
