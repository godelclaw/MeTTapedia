...
namespace Krenn.Component16.SelectedLeafB5_6_7_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "59e49b2118b6922702beff0e91aaa2ca8f4915838d4d4bbcb66764f70f23d372"
...
def multipliers : Fin 24 → SparsePoly (Fin 72) := ![
  ...
  [{ coefficient := 1, powers := [(25, 1), (45, 1), (55, 1), (70, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (50, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (22, 1), (55, 1), (62, 1), (70, 1)] }, { coefficient := 2, powers := [(12, 1), (25, 1), (55, 1), (64, 1), (70, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (21, 1), (55, 1), (62, 1), (70, 1)] }, { coefficient := -1, powers := [(2, 1), (55, 1), (70, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (50, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(25, 1), (58, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (55, 1)] }],
  [{ coefficient := -2, powers := [(25, 1), (55, 1), (64, 1), (70, 1)] }],
  ...
  [{ coefficient := 2, powers := [(20, 1), (25, 1), (28, 1), (55, 1), (70, 1)] }],
  ...
  [{ coefficient := -1, powers := [(13, 1), (25, 1), (47, 1), (58, 1), (67, 1)] }, { coefficient := 1, powers := [(13, 1), (30, 1), (49, 1), (58, 1), (67, 1)] }, { coefficient := 1, powers := [(13, 1), (31, 1), (50, 1)] }, { coefficient := -1, powers := [(13, 1), (37, 1), (40, 1)] }],
...
#print axioms Krenn.Component16.SelectedLeafB5_6_7_7.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB5_6_7_7
