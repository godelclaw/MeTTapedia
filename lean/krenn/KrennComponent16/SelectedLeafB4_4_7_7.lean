...
namespace Krenn.Component16.SelectedLeafB4_4_7_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "a3ea90dc13bbc789a1a46c47e5470aec9a762da94bf4e5fe3954a485498ad401"
def certificateSHA256 : String := "ea85d01485b1e2552772b5c7c7488e75f3ca013165fdc2822c0cc2c37182b63a"
...
def multipliers : Fin 20 → SparsePoly (Fin 70) := ![
  ...
  [{ coefficient := -1, powers := [(13, 1), (25, 1), (47, 1), (58, 1), (65, 1)] }, { coefficient := 1, powers := [(13, 1), (30, 1), (49, 1), (58, 1), (65, 1)] }, { coefficient := 1, powers := [(13, 1), (31, 1), (50, 1), (57, 1), (65, 1)] }, { coefficient := -1, powers := [(13, 1), (37, 1), (40, 1), (57, 1), (65, 1)] }],
...
#print axioms Krenn.Component16.SelectedLeafB4_4_7_7.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB4_4_7_7
