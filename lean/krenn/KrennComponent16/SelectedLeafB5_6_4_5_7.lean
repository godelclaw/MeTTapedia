...
namespace Krenn.Component16.SelectedLeafB5_6_4_5_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "f42e5c9247dc91e9db4197997a312ab528ec452b1103fa195a4508587d4cddf0"
def certificateSHA256 : String := "84062be45bdeb1c7ef71d18aec98f5cc71cf1fdda8a0ffbb49a98f902e955eed"
...
def multipliers : Fin 25 → SparsePoly (Fin 72) := ![
  [{ coefficient := -1, powers := [(2, 1), (60, 1), (63, 1), (71, 1)] }, { coefficient := 2, powers := [(7, 1), (36, 1), (42, 1), (60, 1), (71, 1)] }, { coefficient := 2, powers := [(19, 1), (29, 1), (60, 1), (63, 1), (71, 1)] }, { coefficient := 2, powers := [(60, 1), (71, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (60, 1), (63, 1), (71, 1)] }, { coefficient := 2, powers := [(7, 1), (33, 1), (42, 1), (60, 1), (71, 1)] }, { coefficient := 2, powers := [(19, 1), (24, 1), (60, 1), (63, 1), (71, 1)] }],
  ...
  [{ coefficient := -1, powers := [(2, 1), (42, 1), (60, 1), (63, 1), (71, 1)] }, { coefficient := -2, powers := [(53, 1), (60, 1), (71, 1)] }],
  [{ coefficient := -2, powers := [(38, 1), (60, 2), (71, 1)] }],
  ...
  [{ coefficient := 2, powers := [(38, 1), (39, 1), (60, 2), (61, 1), (71, 1)] }, { coefficient := -2, powers := [(38, 1), (42, 1), (53, 1), (60, 1)] }, { coefficient := -2, powers := [(38, 1), (42, 1), (57, 1), (60, 1)] }, { coefficient := 2, powers := [(38, 1), (47, 1), (53, 1), (60, 1)] }, { coefficient := 2, powers := [(39, 1), (60, 1)] }],
  ...
  [{ coefficient := 2, powers := [(4, 1), (38, 1), (60, 2), (61, 1), (71, 1)] }, { coefficient := -2, powers := [(4, 1), (38, 1), (60, 2)] }, { coefficient := -2, powers := [(11, 1), (38, 1), (42, 1), (60, 1)] }, { coefficient := -2, powers := [(16, 1), (38, 1), (42, 1), (60, 1)] }],
...
#print axioms Krenn.Component16.SelectedLeafB5_6_4_5_7.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB5_6_4_5_7
