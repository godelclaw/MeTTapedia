...
namespace Krenn.Component16.SelectedLeafB5_2_0_5_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "6f8e9ebef6aa6851a7be4bc6411cf531ffdcb2538b1a27915ad27e31d2566c71"
...
def multipliers : Fin 25 → SparsePoly (Fin 69) := ![
  [{ coefficient := -1, powers := [(2, 1), (60, 1), (63, 1), (68, 1)] }, { coefficient := 2, powers := [(7, 1), (36, 1), (42, 1), (60, 1), (68, 1)] }, { coefficient := 2, powers := [(19, 1), (29, 1), (60, 1), (63, 1), (68, 1)] }, { coefficient := 2, powers := [(60, 1), (68, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (60, 1), (63, 1), (68, 1)] }, { coefficient := 2, powers := [(7, 1), (33, 1), (42, 1), (60, 1), (68, 1)] }, { coefficient := 2, powers := [(19, 1), (24, 1), (60, 1), (63, 1), (68, 1)] }],
  ...
  [{ coefficient := -1, powers := [(2, 1), (42, 1), (60, 1), (63, 1), (68, 1)] }, { coefficient := -2, powers := [(53, 1), (60, 1), (68, 1)] }],
  [{ coefficient := -2, powers := [(38, 1), (60, 2), (68, 1)] }],
  ...
  [{ coefficient := 2, powers := [(38, 1), (39, 1), (60, 2), (61, 1), (68, 1)] }, { coefficient := -2, powers := [(38, 1), (42, 1), (53, 1), (60, 1)] }, { coefficient := -2, powers := [(38, 1), (42, 1), (57, 1), (60, 1)] }, { coefficient := 2, powers := [(38, 1), (47, 1), (53, 1), (60, 1)] }, { coefficient := 2, powers := [(39, 1), (60, 1)] }],
  ...
  [{ coefficient := 2, powers := [(4, 1), (38, 1), (60, 2), (61, 1), (68, 1)] }, { coefficient := -2, powers := [(4, 1), (38, 1), (60, 2)] }, { coefficient := -2, powers := [(11, 1), (38, 1), (42, 1), (60, 1)] }, { coefficient := -2, powers := [(16, 1), (38, 1), (42, 1), (60, 1)] }],
...
#print axioms Krenn.Component16.SelectedLeafB5_2_0_5_3.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB5_2_0_5_3
