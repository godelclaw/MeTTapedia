...
namespace Krenn.Component16.SelectedLeafB5_6_5_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "6806ce44bddf050cc7ffc7e87be0156538255d86201f1e3e878278864584a5f1"
...
def multipliers : Fin 36 → SparsePoly (Fin 70) := ![
  ...
  [{ coefficient := -1, powers := [(2, 1), (21, 1), (33, 1), (39, 1), (50, 1), (68, 1)] }, { coefficient := -1, powers := [(2, 1), (33, 1), (39, 1), (50, 1)] }, { coefficient := 1, powers := [(5, 1), (21, 1), (33, 1), (37, 1), (39, 1), (68, 1)] }, { coefficient := 1, powers := [(5, 1), (33, 1), (37, 1), (39, 1)] }],
  ...
  [{ coefficient := 1, powers := [(20, 1), (25, 1), (26, 1), (54, 1), (69, 1)] }],
  ...
  [{ coefficient := 1, powers := [(2, 1), (33, 1), (39, 1), (50, 1), (55, 1), (68, 1)] }, { coefficient := -1, powers := [(5, 1), (33, 1), (37, 1), (39, 1), (55, 1), (68, 1)] }],
  ...
  [{ coefficient := -1, powers := [(20, 1), (25, 1), (26, 1), (55, 1), (69, 1)] }],
...
#print axioms Krenn.Component16.SelectedLeafB5_6_5_5.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB5_6_5_5
