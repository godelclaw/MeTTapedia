...
namespace Krenn.Component16.SelectedLeafB1_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "38cfdc241180d6cc7a9a5850698aea206ea781cca32b31768044f8288e37c8c9"
def certificateSHA256 : String := "726c607376e931cf464a511d6f64375f66b637f981b068b5826f6130950bb8f7"
...
def multipliers : Fin 19 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := -1, powers := [(2, 1), (40, 1), (42, 1), (61, 1), (65, 1)] }, { coefficient := -1, powers := [(2, 1), (40, 1), (47, 1), (61, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (27, 1), (34, 1), (53, 1), (65, 1)] }, { coefficient := -1, powers := [(5, 1), (34, 1), (54, 1), (65, 1)] }, { coefficient := 2, powers := [(13, 1), (22, 1), (31, 1), (53, 1), (65, 1)] }, { coefficient := -1, powers := [(13, 1), (25, 1), (27, 1), (53, 1), (65, 1)] }],
  ...
  [{ coefficient := -1, powers := [(2, 1), (40, 1), (47, 1), (61, 1)] }, { coefficient := -1, powers := [(2, 1), (43, 1), (57, 1), (58, 1)] }, { coefficient := 1, powers := [(5, 1), (27, 1), (34, 1), (48, 1), (53, 1)] }, { coefficient := -1, powers := [(5, 1), (34, 1), (42, 1), (58, 1)] }, { coefficient := -1, powers := [(5, 1), (34, 1), (48, 1), (54, 1)] }, { coefficient := -1, powers := [(5, 1), (37, 1), (47, 1), (55, 1)] }, { coefficient := -1, powers := [(8, 1), (37, 1), (43, 1), (57, 1)] }, { coefficient := -1, powers := [(13, 1), (25, 1), (27, 1), (48, 1), (53, 1)] }, { coefficient := 1, powers := [(13, 1), (25, 1), (42, 1), (58, 1)] }, { coefficient := 1, powers := [(13, 1), (25, 1), (48, 1), (54, 1)] }, { coefficient := 2, powers := [(13, 1), (31, 1), (50, 1), (53, 1)] }, { coefficient := 1, powers := [(20, 1), (25, 1), (47, 1), (55, 1)] }, { coefficient := 1, powers := [(20, 1), (31, 1), (43, 1), (57, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (26, 1), (40, 1), (42, 1), (61, 1)] }, { coefficient := 1, powers := [(2, 1), (26, 1), (40, 1), (47, 1), (61, 1)] }, { coefficient := -1, powers := [(5, 1), (27, 1), (34, 1), (45, 1), (53, 1)] }, { coefficient := 1, powers := [(5, 1), (34, 1), (45, 1), (54, 1)] }, { coefficient := -2, powers := [(13, 1), (22, 1), (31, 1), (45, 1), (53, 1)] }, { coefficient := 1, powers := [(13, 1), (25, 1), (27, 1), (45, 1), (53, 1)] }]
]
...
#print axioms Krenn.Component16.SelectedLeafB1_7.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB1_7
