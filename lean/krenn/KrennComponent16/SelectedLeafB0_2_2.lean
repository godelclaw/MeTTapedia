...
namespace Krenn.Component16.SelectedLeafB0_2_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "ed65524eff18da21cd42bd763765f64707a0593950b51a8500d4ff01f7c6628f"
def certificateSHA256 : String := "ebea35c03f8baab27e2855b622d86f6c61891f3961b4d68131d8a5fb02975d9c"
...
def multipliers : Fin 15 → SparsePoly (Fin 64) := ![
  [{ coefficient := 2, powers := [(22, 1), (31, 1), (53, 1)] }, { coefficient := -1, powers := [(25, 1), (54, 1)] }],
  ...
  [{ coefficient := -1, powers := [(5, 1), (37, 1), (47, 1), (55, 1)] }, { coefficient := 2, powers := [(13, 1), (31, 1), (50, 1), (53, 1)] }, { coefficient := 1, powers := [(20, 1), (25, 1), (47, 1), (55, 1)] }],
...
#print axioms Krenn.Component16.SelectedLeafB0_2_2.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB0_2_2
