...
namespace Krenn.Component16.SelectedLeafB1_2_7_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "d4592270cf59553ed26432545066e9fe26bc5c067df091495d3d074924393a8d"
...
def multipliers : Fin 16 → SparsePoly (Fin 69) := ![
  ...
  [{ coefficient := 1, powers := [(25, 1), (58, 1), (67, 1)] }, { coefficient := -1, powers := [(31, 1), (50, 1), (67, 1)] }, { coefficient := 1, powers := [(37, 1), (40, 1), (67, 1)] }],
...
#print axioms Krenn.Component16.SelectedLeafB1_2_7_3.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB1_2_7_3
