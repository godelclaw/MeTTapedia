...
namespace Krenn.Component16.SelectedLeafB5_2_4_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "6d59c41983d7baf25b85b36eb9b662b0948697b3e0189c3c26780c78752256b3"
def certificateSHA256 : String := "936761e2ee045d82485d6ffbc8f9749ebceee9a5cc591e051b27bfa89a66e8b1"
...
def multipliers : Fin 44 → SparsePoly (Fin 67) := ![
  ...
  [{ coefficient := -1, powers := [(19, 1), (26, 1), (50, 1), (53, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (26, 1), (50, 1)] }, { coefficient := 1, powers := [(20, 1), (22, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (45, 1), (49, 1), (53, 1)] }, { coefficient := 1, powers := [(2, 1), (47, 1), (50, 1)] }],
  [{ coefficient := -1, powers := [(27, 1), (29, 1), (50, 1)] }],
  [{ coefficient := 1, powers := [(24, 1), (40, 1), (53, 1), (61, 1)] }, { coefficient := 1, powers := [(24, 1), (50, 1), (53, 1), (55, 1)] }, { coefficient := 1, powers := [(30, 1), (50, 1), (55, 1)] }],
  ...
  [{ coefficient := -1, powers := [(24, 1), (40, 1), (61, 1)] }, { coefficient := -1, powers := [(24, 1), (50, 1), (55, 1)] }, { coefficient := -1, powers := [(29, 1), (50, 1), (55, 1)] }],
  ...
  [{ coefficient := 1, powers := [(21, 1), (29, 1), (50, 1), (55, 1)] }],
  ...
  [{ coefficient := 2, powers := [(8, 1), (25, 1), (39, 1), (60, 1), (61, 1)] }, { coefficient := -2, powers := [(8, 1), (25, 1), (47, 1), (53, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (27, 1), (48, 1)] }, { coefficient := 1, powers := [(8, 1), (37, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (19, 1), (24, 1), (40, 1), (61, 1)] }, { coefficient := 2, powers := [(1, 1), (8, 1), (25, 1), (42, 1), (61, 1)] }, { coefficient := -1, powers := [(2, 1), (21, 1), (40, 1), (61, 1)] }, { coefficient := 2, powers := [(4, 1), (8, 1), (25, 1), (33, 1), (61, 1)] }, { coefficient := 1, powers := [(13, 1), (27, 1), (29, 1), (50, 1)] }, { coefficient := 1, powers := [(19, 1), (21, 1), (24, 1), (40, 1), (61, 1)] }, { coefficient := 1, powers := [(19, 1), (21, 1), (24, 1), (50, 1), (55, 1)] }, { coefficient := 1, powers := [(19, 1), (24, 1), (26, 1), (40, 1), (61, 1)] }],
...
#print axioms Krenn.Component16.SelectedLeafB5_2_4_4.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB5_2_4_4
