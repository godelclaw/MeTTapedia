...
namespace Krenn.Component16.SelectedLeafB5_2_4_5_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "6c3722612299e793b23495dd452a0edaa57be8981a51961f6a631609554cba52"
def certificateSHA256 : String := "b005235c31f8e070bfef2168a310259116b0322e70e543d9f18f5086b354fc83"
...
def multipliers : Fin 17 → SparsePoly (Fin 70) := ![
  ...
  [{ coefficient := 1, powers := [(5, 1), (37, 1), (55, 1)] }, { coefficient := -1, powers := [(20, 1), (25, 1), (55, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := 1, powers := [(2, 1), (58, 1)] }, { coefficient := 1, powers := [(8, 1), (37, 1)] }, { coefficient := -1, powers := [(20, 1), (31, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (21, 1), (37, 1), (55, 1)] }, { coefficient := 1, powers := [(20, 1), (21, 1), (25, 1), (55, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (34, 1)] }],
  [{ coefficient := 1, powers := [(13, 1), (31, 1), (50, 1)] }, { coefficient := -1, powers := [(13, 1), (37, 1), (40, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (38, 1), (40, 1), (61, 1)] }, { coefficient := -1, powers := [(3, 1), (5, 1), (37, 1), (55, 1)] }, { coefficient := 1, powers := [(3, 1), (19, 1), (29, 1), (40, 1), (61, 1)] }, { coefficient := 1, powers := [(3, 1), (20, 1), (25, 1), (55, 1)] }, { coefficient := 1, powers := [(6, 1), (19, 1), (24, 1), (40, 1), (61, 1)] }]
]
...
#print axioms Krenn.Component16.SelectedLeafB5_2_4_5_5.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB5_2_4_5_5
