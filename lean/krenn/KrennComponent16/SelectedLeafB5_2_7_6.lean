...
namespace Krenn.Component16.SelectedLeafB5_2_7_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "d8f81cae622ebb2c5712a5760612578e4efcaf47a62c5dbd1761e8b654ed8a75"
...
def multipliers : Fin 29 → SparsePoly (Fin 70) := ![
  ...
  [{ coefficient := 1, powers := [(20, 1), (24, 1), (25, 1), (55, 1), (63, 1), (69, 1)] }, { coefficient := 1, powers := [(20, 1), (25, 1), (29, 1), (55, 1), (63, 1), (69, 1)] }, { coefficient := 1, powers := [(25, 1), (45, 1), (55, 1), (69, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (50, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (22, 1), (55, 1), (62, 1), (69, 1)] }],
  [{ coefficient := 1, powers := [(20, 1), (29, 1), (55, 1), (69, 1)] }],
...
#print axioms Krenn.Component16.SelectedLeafB5_2_7_6.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB5_2_7_6
