...
namespace Krenn.Component16.SelectedLeafB5_0_6_5_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "1c9620889e852bc699d6467723549e8c2df2e834157a47962d012d10fe0ced31"
def certificateSHA256 : String := "8ffbe34889658febf898fa9af467064237ce9c66a36221e60e7d465d9cbeb833"
...
def multipliers : Fin 17 → SparsePoly (Fin 70) := ![
  [{ coefficient := 1, powers := [(11, 1), (23, 1), (53, 1), (60, 1), (69, 1)] }],
  [{ coefficient := 1, powers := [(11, 1), (24, 1), (53, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(11, 1), (33, 1), (62, 1), (69, 1)] }, { coefficient := 1, powers := [(16, 1), (33, 1), (62, 1), (69, 1)] }],
  [{ coefficient := 1, powers := [(33, 1), (57, 1), (69, 1)] }],
  [{ coefficient := 1, powers := [(53, 1)] }],
  [{ coefficient := 1, powers := [(47, 1)] }, { coefficient := -1, powers := [(57, 1)] }],
  [{ coefficient := 1, powers := [(60, 1), (69, 1)] }],
  [{ coefficient := -1, powers := [(11, 1), (23, 1), (53, 1), (67, 1)] }],
  [{ coefficient := 1, powers := [(11, 1), (23, 1), (31, 1), (53, 1), (67, 1)] }, { coefficient := -1, powers := [(11, 1), (23, 1), (53, 1)] }],
  [{ coefficient := 1, powers := [(11, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := 1, powers := [(11, 1), (33, 1), (39, 1)] }, { coefficient := -1, powers := [(16, 1), (33, 1), (39, 1)] }],
  [{ coefficient := -1, powers := [(39, 1), (60, 1), (61, 1), (69, 1)] }, { coefficient := 1, powers := [(39, 1), (60, 1)] }, { coefficient := -1, powers := [(47, 1), (53, 1)] }, { coefficient := 1, powers := [(53, 1), (57, 1)] }],
...
#print axioms Krenn.Component16.SelectedLeafB5_0_6_5_3.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB5_0_6_5_3
