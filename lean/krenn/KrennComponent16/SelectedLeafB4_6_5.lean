...
namespace Krenn.Component16.SelectedLeafB4_6_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "7f251cb99d025ce9146b2f753325e058d23373ec243bfb698455e0bea8d3f0d7"
def certificateSHA256 : String := "7df346799db4d90ab9bc9643cd32c01110bd442b6175ea56c946326af884be87"
...
def multipliers : Fin 36 → SparsePoly (Fin 67) := ![
  [{ coefficient := 1, powers := [(7, 1), (34, 1), (42, 1), (58, 1)] }, { coefficient := 1, powers := [(11, 1), (34, 1), (39, 1), (58, 1)] }, { coefficient := -1, powers := [(16, 1), (34, 1), (39, 1), (58, 1)] }],
  [{ coefficient := -2, powers := [(6, 1), (16, 1), (25, 1), (53, 2), (61, 1)] }, { coefficient := 2, powers := [(7, 1), (25, 1), (42, 1), (61, 1)] }, { coefficient := 2, powers := [(7, 1), (25, 1), (47, 1), (61, 1)] }, { coefficient := -2, powers := [(11, 1), (25, 1), (39, 1), (61, 1)] }, { coefficient := -2, powers := [(16, 1), (25, 1), (38, 1), (53, 2), (61, 1)] }, { coefficient := 2, powers := [(16, 1), (25, 1), (39, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(25, 1), (27, 1)] }],
  [{ coefficient := 2, powers := [(3, 1), (16, 1), (25, 1), (27, 1), (53, 2), (61, 1)] }, { coefficient := -2, powers := [(3, 1), (16, 1), (25, 1), (53, 1), (54, 1), (61, 1)] }, { coefficient := -1, powers := [(3, 1), (16, 1), (34, 1), (47, 1), (49, 1), (58, 1)] }, { coefficient := -1, powers := [(4, 1), (34, 1), (49, 1), (58, 1)] }, { coefficient := -2, powers := [(7, 1), (25, 1), (27, 1), (53, 1), (61, 1)] }, { coefficient := 2, powers := [(7, 1), (25, 1), (54, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (7, 1), (34, 1), (45, 1), (58, 1), (60, 1), (66, 1)] }, { coefficient := -2, powers := [(7, 1), (19, 1), (25, 1), (61, 1)] }, { coefficient := 2, powers := [(8, 1), (11, 1), (25, 1), (45, 1), (53, 1), (61, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (50, 1)] }],
  [{ coefficient := 1, powers := [(20, 1), (22, 1)] }],
  [{ coefficient := -2, powers := [(16, 1), (25, 1), (38, 1), (53, 2), (61, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(29, 1), (55, 1)] }],
  [{ coefficient := 2, powers := [(25, 1), (58, 1)] }, { coefficient := -1, powers := [(31, 1), (50, 1)] }, { coefficient := 1, powers := [(37, 1), (40, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (7, 1), (34, 1), (58, 1), (60, 1), (66, 1)] }, { coefficient := -2, powers := [(8, 1), (11, 1), (25, 1), (53, 1), (61, 1), (66, 1)] }],
  [{ coefficient := 2, powers := [(8, 1), (25, 1), (53, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (34, 1), (47, 1), (58, 1)] }, { coefficient := -2, powers := [(8, 1), (25, 1), (42, 1), (61, 1)] }, { coefficient := -2, powers := [(8, 1), (25, 1), (47, 1), (61, 1)] }],
  ...
  [{ coefficient := 2, powers := [(8, 1), (16, 1), (25, 1), (53, 2), (61, 1)] }],
  [{ coefficient := 2, powers := [(3, 1), (16, 1), (25, 1), (28, 1), (53, 1), (61, 1)] }, { coefficient := -2, powers := [(7, 1), (25, 1), (28, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(25, 1)] }],
  [{ coefficient := -2, powers := [(3, 1), (16, 1), (25, 1), (27, 1), (28, 1), (53, 1), (61, 1)] }, { coefficient := 2, powers := [(7, 1), (25, 1), (27, 1), (28, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (16, 1), (34, 1), (47, 1), (58, 1)] }, { coefficient := -2, powers := [(8, 1), (16, 1), (25, 1), (53, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(3, 1), (16, 1), (34, 1), (47, 1), (58, 1)] }, { coefficient := 1, powers := [(4, 1), (34, 1), (58, 1)] }],
  [{ coefficient := 2, powers := [(7, 1), (25, 1), (61, 1)] }],
  [{ coefficient := 2, powers := [(8, 1), (25, 1), (28, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (16, 1), (34, 1), (58, 1)] }, { coefficient := 2, powers := [(8, 1), (11, 1), (25, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (34, 1), (58, 1)] }, { coefficient := -2, powers := [(8, 1), (25, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := 1, powers := [(5, 1), (34, 1), (39, 1), (58, 1), (60, 1)] }, { coefficient := 2, powers := [(8, 1), (25, 1), (39, 1), (60, 1), (61, 1)] }, { coefficient := 2, powers := [(8, 1), (25, 1), (42, 1), (53, 1), (61, 1)] }, { coefficient := 2, powers := [(8, 1), (25, 1), (47, 1), (53, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(22, 1), (48, 1), (55, 1)] }, { coefficient := 1, powers := [(40, 1), (61, 1)] }, { coefficient := -1, powers := [(50, 1), (55, 1)] }],
  [{ coefficient := 2, powers := [(8, 1), (16, 1), (25, 1), (36, 1), (38, 1), (53, 2), (61, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (58, 1)] }, { coefficient := 1, powers := [(8, 1), (37, 1)] }, { coefficient := -1, powers := [(20, 1), (31, 1)] }],
  [{ coefficient := 1, powers := [(1, 1), (5, 1), (34, 1), (42, 1), (58, 1)] }, { coefficient := 2, powers := [(1, 1), (8, 1), (25, 1), (42, 1), (61, 1)] }, { coefficient := 2, powers := [(3, 1), (8, 1), (16, 1), (25, 1), (33, 1), (53, 1), (61, 1)] }, { coefficient := 2, powers := [(3, 1), (16, 1), (19, 1), (25, 1), (27, 1), (28, 1), (53, 1), (61, 1)] }, { coefficient := 2, powers := [(4, 1), (8, 1), (25, 1), (33, 1), (61, 1)] }, { coefficient := 1, powers := [(5, 1), (11, 1), (23, 1), (34, 1), (58, 1)] }, { coefficient := -1, powers := [(5, 1), (16, 1), (23, 1), (34, 1), (58, 1)] }, { coefficient := -2, powers := [(7, 1), (19, 1), (25, 1), (27, 1), (28, 1), (61, 1)] }, { coefficient := -2, powers := [(8, 1), (11, 1), (25, 1), (28, 1), (61, 1)] }, { coefficient := -2, powers := [(13, 1), (21, 1), (25, 1), (58, 1)] }, { coefficient := 1, powers := [(13, 1), (21, 1), (31, 1), (50, 1)] }, { coefficient := -1, powers := [(13, 1), (21, 1), (37, 1), (40, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (7, 1), (23, 1), (34, 1), (58, 1), (60, 1)] }, { coefficient := 2, powers := [(8, 1), (11, 1), (23, 1), (25, 1), (53, 1), (61, 1)] }]
]
...
#print axioms Krenn.Component16.SelectedLeafB4_6_5.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB4_6_5
