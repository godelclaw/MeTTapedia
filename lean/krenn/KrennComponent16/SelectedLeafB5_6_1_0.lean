...
namespace Krenn.Component16.SelectedLeafB5_6_1_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "8fbaa288079958cbbca40df3f43af1c9d59e091656cab9913479ceb42e0b5c19"
...
def multipliers : Fin 16 → SparsePoly (Fin 67) := ![
  [{ coefficient := -1, powers := [(7, 1), (45, 1), (60, 1), (66, 1)] }, { coefficient := 1, powers := [(11, 1), (45, 1), (53, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(33, 1), (39, 1), (53, 1)] }],
  [{ coefficient := 1, powers := [(7, 1), (60, 1), (66, 1)] }, { coefficient := -1, powers := [(11, 1), (53, 1), (66, 1)] }],
...
#print axioms Krenn.Component16.SelectedLeafB5_6_1_0.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB5_6_1_0
