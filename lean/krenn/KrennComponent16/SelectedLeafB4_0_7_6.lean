...
namespace Krenn.Component16.SelectedLeafB4_0_7_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "5ab00c1e4c0e29780068d5ee0896f0e8ab9fa2aa7eef2ffba71ae2a87c0728c5"
def certificateSHA256 : String := "cd18266b3393437281c574ff458feb221597bb4f40fa61ee45ffe3dc5e4aa00e"
...
def multipliers : Fin 22 → SparsePoly (Fin 68) := ![
  [{ coefficient := 1, powers := [(25, 1), (47, 1), (58, 1), (64, 1), (66, 1)] }, { coefficient := -1, powers := [(25, 1), (57, 1), (58, 1), (64, 1), (66, 1)] }, { coefficient := -1, powers := [(30, 1), (49, 1), (58, 1), (64, 1), (66, 1)] }],
  ...
  [{ coefficient := 1, powers := [(8, 1), (37, 1), (57, 1), (64, 1)] }, { coefficient := -1, powers := [(19, 1), (30, 1), (58, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := -1, powers := [(13, 1), (25, 1), (47, 1), (58, 1), (64, 1)] }, { coefficient := 1, powers := [(13, 1), (25, 1), (57, 1), (58, 1), (64, 1)] }, { coefficient := 1, powers := [(13, 1), (30, 1), (49, 1), (58, 1), (64, 1)] }],
  [{ coefficient := -2, powers := [(19, 1), (25, 1), (26, 1), (48, 1), (55, 1), (57, 1), (64, 1)] }, { coefficient := -1, powers := [(19, 1), (25, 1), (45, 1), (55, 1), (57, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (57, 1), (61, 1), (64, 1)] }, { coefficient := 1, powers := [(13, 1), (45, 1), (49, 1), (57, 1), (64, 1)] }, { coefficient := -1, powers := [(13, 1), (50, 1), (57, 1), (64, 1)] }]
]
...
#print axioms Krenn.Component16.SelectedLeafB4_0_7_6.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB4_0_7_6
