...
namespace Krenn.Component16.SelectedLeafB4_2_6_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "e8ab96925969e0d08eb68e6710f920d4dd9408ae843d7b0de0ab3e23c522e436"
def certificateSHA256 : String := "801cd330da5303d4e1276ff16f6b8d003f61e6e04886c0569009b9a2115d28ec"
...
def multipliers : Fin 17 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := -1, powers := [(19, 1), (25, 1), (42, 1), (45, 1), (55, 1)] }, { coefficient := -1, powers := [(19, 1), (25, 1), (45, 1), (47, 1), (55, 1)] }, { coefficient := 2, powers := [(19, 1), (25, 1), (48, 1), (55, 1)] }, { coefficient := 2, powers := [(20, 1), (25, 1), (42, 1), (55, 1)] }],
...
#print axioms Krenn.Component16.SelectedLeafB4_2_6_0.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB4_2_6_0
