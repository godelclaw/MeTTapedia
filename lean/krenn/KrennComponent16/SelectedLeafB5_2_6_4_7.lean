...
namespace Krenn.Component16.SelectedLeafB5_2_6_4_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "d75ddb5b7e83af600175c5d16ee6fc2cdbeeb1ded733fcc99c36bbfa26a84b67"
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedEquations : Fin 14 → SparsePoly (Fin 71) := ![
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def multipliers : Fin 14 → SparsePoly (Fin 71) := ![
  [{ coefficient := 1, powers := [(11, 1), (23, 1), (47, 1), (60, 1), (70, 1)] }, { coefficient := 1, powers := [(11, 1), (23, 1), (53, 1), (60, 1), (70, 1)] }, { coefficient := 1, powers := [(11, 1), (23, 1), (57, 1), (60, 1), (70, 1)] }, { coefficient := 1, powers := [(11, 1), (33, 1), (47, 2), (70, 1)] }, { coefficient := 1, powers := [(11, 1), (33, 1), (47, 1), (53, 1), (70, 1)] }, { coefficient := 1, powers := [(11, 1), (33, 1), (47, 1), (57, 1), (70, 1)] }, { coefficient := 1, powers := [(11, 1), (36, 1), (42, 1), (47, 1), (70, 1)] }, { coefficient := 1, powers := [(11, 1), (36, 1), (42, 1), (53, 1), (70, 1)] }, { coefficient := 1, powers := [(11, 1), (36, 1), (42, 1), (57, 1), (70, 1)] }, { coefficient := 1, powers := [(16, 1), (23, 1), (53, 1), (60, 1), (70, 1)] }, { coefficient := 1, powers := [(16, 1), (33, 1), (47, 1), (53, 1), (70, 1)] }, { coefficient := 1, powers := [(16, 1), (36, 1), (42, 1), (53, 1), (70, 1)] }],
...
#print axioms Krenn.Component16.SelectedLeafB5_2_6_4_7.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB5_2_6_4_7
