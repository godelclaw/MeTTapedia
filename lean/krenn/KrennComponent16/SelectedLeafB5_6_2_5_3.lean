...
namespace Krenn.Component16.SelectedLeafB5_6_2_5_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "cf02f63252adff5cf38ae86862b5b073004912d792b5a0f75307fc405c20fc40"
...
def multipliers : Fin 20 → SparsePoly (Fin 71) := ![
  [{ coefficient := -1, powers := [(11, 1), (23, 1), (42, 1), (60, 1), (70, 1)] }, { coefficient := 1, powers := [(11, 1), (23, 1), (53, 1), (60, 1), (70, 1)] }, { coefficient := 1, powers := [(11, 1), (23, 1), (57, 1), (60, 1), (70, 1)] }],
  ...
  [{ coefficient := -1, powers := [(23, 1), (60, 1), (70, 1)] }, { coefficient := 1, powers := [(33, 1), (57, 1), (70, 1)] }, { coefficient := 1, powers := [(36, 1), (42, 1), (70, 1)] }, { coefficient := 1, powers := [(36, 1), (53, 1), (70, 1)] }],
  ...
  [{ coefficient := -1, powers := [(39, 1), (60, 1), (61, 1), (70, 1)] }, { coefficient := 1, powers := [(39, 1), (60, 1)] }, { coefficient := 1, powers := [(41, 1), (53, 1), (57, 1), (64, 1)] }, { coefficient := 1, powers := [(42, 1), (47, 1)] }, { coefficient := 1, powers := [(42, 1), (57, 1)] }, { coefficient := 1, powers := [(52, 1), (53, 1), (64, 1)] }, { coefficient := 1, powers := [(53, 1), (57, 1)] }],
  [{ coefficient := 1, powers := [(7, 1), (36, 1), (53, 1)] }],
  [{ coefficient := -1, powers := [(4, 1), (60, 1), (61, 1), (70, 1)] }, { coefficient := 1, powers := [(4, 1), (60, 1)] }, { coefficient := 1, powers := [(10, 1), (53, 1), (64, 1)] }, { coefficient := -1, powers := [(11, 1), (42, 1)] }, { coefficient := -1, powers := [(11, 1), (47, 1)] }, { coefficient := 1, powers := [(11, 1), (57, 1)] }, { coefficient := 1, powers := [(16, 1), (41, 1), (53, 1), (64, 1)] }, { coefficient := 1, powers := [(16, 1), (42, 1)] }],
...
#print axioms Krenn.Component16.SelectedLeafB5_6_2_5_3.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB5_6_2_5_3
