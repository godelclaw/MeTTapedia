...
namespace Krenn.Component16.SelectedLeafB5_2_6_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "0aea17471409098ec8363aee4fca6947e81c4d8a48462d6c7c292bae20b777cf"
def certificateSHA256 : String := "cf1cdd25562dec7b39454119988c2561dce0061c99970a5ae5caa69559cfa416"
...
def multipliers : Fin 20 → SparsePoly (Fin 68) := ![
  ...
  [{ coefficient := -1, powers := [(2, 1), (50, 1), (53, 1), (55, 1)] }, { coefficient := 1, powers := [(2, 1), (50, 1), (55, 1), (62, 1)] }, { coefficient := -1, powers := [(13, 1), (31, 1), (50, 1), (53, 1)] }, { coefficient := -1, powers := [(13, 1), (37, 1), (40, 1), (46, 1), (65, 1)] }, { coefficient := -1, powers := [(19, 1), (25, 1), (42, 1), (45, 1), (55, 1)] }, { coefficient := -1, powers := [(19, 1), (25, 1), (45, 1), (47, 1), (55, 1)] }, { coefficient := 2, powers := [(19, 1), (25, 1), (48, 1), (55, 1)] }, { coefficient := 2, powers := [(20, 1), (25, 1), (42, 1), (55, 1)] }]
]
...
#print axioms Krenn.Component16.SelectedLeafB5_2_6_1.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB5_2_6_1
