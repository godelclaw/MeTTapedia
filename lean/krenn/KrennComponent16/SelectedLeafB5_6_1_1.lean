...
namespace Krenn.Component16.SelectedLeafB5_6_1_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "62bedb11263557b0a7f4bbeca3486c5e3534a6c56d085f23c22527ede087caa0"
...
def multipliers : Fin 20 → SparsePoly (Fin 68) := ![
  [{ coefficient := 1, powers := [(11, 1), (45, 1), (53, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(33, 1), (39, 1), (53, 1)] }],
  [{ coefficient := -1, powers := [(11, 1), (53, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(53, 1)] }],
  [{ coefficient := 1, powers := [(21, 1), (39, 1), (60, 1)] }, { coefficient := 1, powers := [(47, 1)] }],
  [{ coefficient := 1, powers := [(16, 1), (23, 1), (67, 1)] }],
  ...
  [{ coefficient := 1, powers := [(23, 1), (31, 1), (67, 1)] }],
  ...
  [{ coefficient := 1, powers := [(4, 1), (33, 1)] }, { coefficient := 1, powers := [(11, 1), (21, 1), (33, 1), (39, 1)] }, { coefficient := -1, powers := [(11, 1), (23, 1), (31, 1), (67, 1)] }],
...
#print axioms Krenn.Component16.SelectedLeafB5_6_1_1.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB5_6_1_1
