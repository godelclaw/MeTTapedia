...
namespace Krenn.Component16.SelectedLeafB5_6_4_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "79e206dcdf4ca68cb1de6de7b6599cad33f826d89641d44a3bd8e314c0ef0dba"
def certificateSHA256 : String := "4accd1a0fe7bf5328c01a53d714bd59b9415ce140f42b9bfea58920608292cbe"
...
def multipliers : Fin 30 → SparsePoly (Fin 70) := ![
  ...
  [{ coefficient := -1, powers := [(22, 1), (31, 1), (38, 1), (53, 1), (61, 1), (68, 1)] }, { coefficient := -1, powers := [(24, 1), (40, 1), (61, 1), (68, 1)] }, { coefficient := 1, powers := [(25, 1), (27, 1), (38, 1), (53, 1), (61, 1), (68, 1)] }, { coefficient := -1, powers := [(25, 1), (38, 1), (54, 1), (61, 1), (68, 1)] }, { coefficient := 1, powers := [(25, 1), (45, 1), (55, 1), (68, 1)] }, { coefficient := -1, powers := [(29, 1), (40, 1), (61, 1), (68, 1)] }, { coefficient := -1, powers := [(31, 1), (38, 1), (49, 1), (61, 1), (68, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (50, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (38, 1), (54, 1), (61, 1), (68, 1)] }, { coefficient := 2, powers := [(20, 1), (29, 1), (55, 1), (68, 1)] }],
...
#print axioms Krenn.Component16.SelectedLeafB5_6_4_7.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB5_6_4_7
