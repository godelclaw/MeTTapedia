...
namespace Krenn.Component16.SelectedLeafB5_6_7_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "2fa813e609c72dfb0a3981426c15d01b671303c869c3cef1088479b9d45c7c4d"
...
def multipliers : Fin 24 → SparsePoly (Fin 69) := ![
  [{ coefficient := 1, powers := [(0, 1), (4, 1), (45, 1), (53, 1), (60, 1), (68, 1)] }, { coefficient := -1, powers := [(3, 1), (11, 1), (45, 1), (47, 1), (60, 1), (68, 1)] }, { coefficient := -1, powers := [(3, 1), (11, 1), (45, 1), (53, 1), (60, 1), (68, 1)] }, { coefficient := -1, powers := [(3, 1), (11, 1), (45, 1), (57, 1), (60, 1), (68, 1)] }, { coefficient := 1, powers := [(4, 1), (21, 1), (45, 1), (53, 1), (60, 1), (68, 1)] }, { coefficient := 1, powers := [(4, 1), (21, 1), (45, 1), (57, 1), (60, 1), (68, 1)] }, { coefficient := 1, powers := [(4, 1), (45, 1), (60, 1), (68, 1)] }],
  [{ coefficient := 1, powers := [(11, 1), (39, 1), (60, 1), (68, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (4, 1), (53, 1), (60, 1), (68, 1)] }, { coefficient := 1, powers := [(3, 1), (11, 1), (47, 1), (60, 1), (68, 1)] }, { coefficient := 1, powers := [(3, 1), (11, 1), (53, 1), (60, 1), (68, 1)] }, { coefficient := 1, powers := [(3, 1), (11, 1), (57, 1), (60, 1), (68, 1)] }, { coefficient := -1, powers := [(4, 1), (21, 1), (53, 1), (60, 1), (68, 1)] }, { coefficient := -1, powers := [(4, 1), (21, 1), (57, 1), (60, 1), (68, 1)] }, { coefficient := -1, powers := [(4, 1), (60, 1), (68, 1)] }],
  [{ coefficient := -1, powers := [(27, 1), (53, 2), (68, 1)] }, { coefficient := -1, powers := [(27, 1), (53, 1), (57, 1), (68, 1)] }, { coefficient := 1, powers := [(53, 1), (54, 1), (68, 1)] }, { coefficient := 1, powers := [(54, 1), (57, 1), (68, 1)] }],
  [{ coefficient := -1, powers := [(3, 1), (47, 1), (60, 1)] }, { coefficient := 1, powers := [(6, 1), (42, 1), (60, 1)] }, { coefficient := 1, powers := [(38, 1), (42, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(27, 1), (53, 1), (68, 1)] }, { coefficient := 1, powers := [(27, 1), (57, 1), (68, 1)] }],
  ...
  [{ coefficient := -1, powers := [(53, 1), (68, 1)] }, { coefficient := -1, powers := [(57, 1), (68, 1)] }],
...
#print axioms Krenn.Component16.SelectedLeafB5_6_7_0.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB5_6_7_0
