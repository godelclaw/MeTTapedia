...
namespace Krenn.Component16.SelectedLeafB5_6_7_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "c5cbe4d4ebdfbcf8c8d600e208b5783925cf457557fb3c811193b5ad9c6d1a6f"
def certificateSHA256 : String := "03ad49c9b774c59cd3025bbf932d1da2d0887089f93a2fe304ffbf43cbbbae5d"
...
def multipliers : Fin 26 → SparsePoly (Fin 71) := ![
  [{ coefficient := 1, powers := [(25, 1), (47, 1), (58, 1), (67, 1), (69, 1)] }, { coefficient := -1, powers := [(25, 1), (58, 1), (69, 1)] }, { coefficient := -1, powers := [(30, 1), (49, 1), (58, 1), (67, 1), (69, 1)] }],
  ...
  [{ coefficient := -1, powers := [(13, 1), (25, 1), (47, 1), (58, 1), (67, 1)] }, { coefficient := 1, powers := [(13, 1), (25, 1), (58, 1)] }, { coefficient := 1, powers := [(13, 1), (30, 1), (49, 1), (58, 1), (67, 1)] }],
...
#print axioms Krenn.Component16.SelectedLeafB5_6_7_6.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB5_6_7_6
