...
namespace Krenn.Component16.SelectedLeafB5_2_7_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "ef021de88c42b699670c327dca1f5ceb0ff092f646b12c030ada8515409520dd"
...
def multipliers : Fin 18 → SparsePoly (Fin 68) := ![
  [{ coefficient := 1, powers := [(0, 1), (7, 1), (45, 1), (47, 1), (60, 1), (67, 1)] }, { coefficient := -1, powers := [(3, 1), (11, 1), (45, 1), (53, 1), (60, 1), (67, 1)] }, { coefficient := -1, powers := [(3, 1), (11, 1), (45, 1), (57, 1), (60, 1), (67, 1)] }, { coefficient := 1, powers := [(6, 1), (7, 1), (45, 1), (60, 2), (67, 1)] }, { coefficient := -1, powers := [(6, 1), (11, 1), (45, 1), (53, 1), (60, 1), (67, 1)] }, { coefficient := -1, powers := [(6, 1), (11, 1), (45, 1), (57, 1), (60, 1), (67, 1)] }, { coefficient := 1, powers := [(6, 1), (17, 1), (57, 1), (60, 1), (67, 1)] }, { coefficient := -1, powers := [(11, 1), (38, 1), (45, 1), (53, 1), (60, 1), (67, 1)] }, { coefficient := -1, powers := [(11, 1), (38, 1), (45, 1), (57, 1), (60, 1), (67, 1)] }],
  [{ coefficient := 1, powers := [(11, 1), (39, 1), (60, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (7, 1), (47, 1), (60, 1), (67, 1)] }, { coefficient := 1, powers := [(3, 1), (11, 1), (53, 1), (60, 1), (67, 1)] }, { coefficient := 1, powers := [(3, 1), (11, 1), (57, 1), (60, 1), (67, 1)] }, { coefficient := -1, powers := [(6, 1), (7, 1), (60, 2), (67, 1)] }, { coefficient := 1, powers := [(6, 1), (11, 1), (53, 1), (60, 1), (67, 1)] }, { coefficient := 1, powers := [(6, 1), (11, 1), (57, 1), (60, 1), (67, 1)] }, { coefficient := 1, powers := [(11, 1), (38, 1), (53, 1), (60, 1), (67, 1)] }, { coefficient := 1, powers := [(11, 1), (38, 1), (57, 1), (60, 1), (67, 1)] }],
  ...
  [{ coefficient := -1, powers := [(6, 1), (57, 1), (60, 1), (67, 1)] }],
  ...
  [{ coefficient := -1, powers := [(6, 1), (39, 1), (60, 2)] }, { coefficient := 1, powers := [(6, 1), (42, 1), (57, 1), (58, 1), (60, 1), (67, 1)] }, { coefficient := -1, powers := [(6, 1), (42, 1), (57, 1), (60, 1)] }, { coefficient := 1, powers := [(6, 1), (48, 1), (54, 1), (57, 1), (60, 1), (67, 1)] }],
...
#print axioms Krenn.Component16.SelectedLeafB5_2_7_0.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB5_2_7_0
