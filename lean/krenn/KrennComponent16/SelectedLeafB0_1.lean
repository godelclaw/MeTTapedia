...
namespace Krenn.Component16.SelectedLeafB0_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "50320b0cfe9e93049b8181ea56a26f55ff9774452eac53460a89954b73ad2c28"
def certificateSHA256 : String := "a874b1160fce3c0a7ba2f6f413acacf255fba9927d1d9517a26628fe5ae349b5"
...
def multipliers : Fin 18 → SparsePoly (Fin 63) := ![
  ...
  [{ coefficient := 1, powers := [(5, 1), (27, 1), (34, 1), (53, 1), (62, 1)] }, { coefficient := -1, powers := [(5, 1), (34, 1), (54, 1), (62, 1)] }, { coefficient := 2, powers := [(13, 1), (22, 1), (31, 1), (53, 1), (62, 1)] }, { coefficient := -1, powers := [(13, 1), (25, 1), (27, 1), (53, 1), (62, 1)] }],
  ...
  [{ coefficient := 1, powers := [(5, 1), (27, 1), (34, 1), (48, 1), (53, 1)] }, { coefficient := -1, powers := [(5, 1), (34, 1), (48, 1), (54, 1)] }, { coefficient := -1, powers := [(5, 1), (37, 1), (47, 1), (55, 1)] }, { coefficient := -1, powers := [(8, 1), (37, 1), (43, 1), (57, 1)] }, { coefficient := -1, powers := [(13, 1), (25, 1), (27, 1), (48, 1), (53, 1)] }, { coefficient := 1, powers := [(13, 1), (25, 1), (48, 1), (54, 1)] }, { coefficient := 2, powers := [(13, 1), (31, 1), (50, 1), (53, 1)] }, { coefficient := 1, powers := [(20, 1), (25, 1), (47, 1), (55, 1)] }, { coefficient := 1, powers := [(20, 1), (31, 1), (43, 1), (57, 1)] }],
...
#print axioms Krenn.Component16.SelectedLeafB0_1.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB0_1
