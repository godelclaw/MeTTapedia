...
namespace Krenn.Component16.SelectedLeafB5_0_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "9db6d2417c1ca8c1726cddc182e16af71e6e95bd4369d651d5fdd7be422f23b2"
def certificateSHA256 : String := "51770103ecf4e4c4cbd980b3cf527e64c30f762da4c3cac4ca57b6b3c32e1bab"
...
def multipliers : Fin 44 → SparsePoly (Fin 65) := ![
  ...
  [{ coefficient := -1, powers := [(30, 1), (47, 1), (50, 1), (54, 1), (64, 1)] }, { coefficient := 1, powers := [(31, 1), (50, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(22, 1), (31, 1), (62, 1)] }, { coefficient := -1, powers := [(25, 1), (27, 1), (57, 1)] }, { coefficient := -1, powers := [(25, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [(25, 1), (27, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (50, 1), (53, 1), (64, 1)] }, { coefficient := -2, powers := [(19, 1), (50, 1), (57, 1), (64, 1)] }],
  [{ coefficient := -3, powers := [(19, 1), (50, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(27, 1), (50, 1), (53, 1), (64, 1)] }, { coefficient := -1, powers := [(27, 1), (50, 1), (57, 1), (64, 1)] }, { coefficient := 1, powers := [(50, 1), (54, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(25, 1), (27, 1), (45, 1)] }, { coefficient := -1, powers := [(31, 1), (50, 1), (64, 1)] }],
  ...
  [{ coefficient := -1, powers := [(25, 1), (45, 1)] }, { coefficient := 1, powers := [(29, 1), (50, 1), (53, 1), (64, 1)] }, { coefficient := 1, powers := [(29, 1), (50, 1), (57, 1), (64, 1)] }, { coefficient := 1, powers := [(30, 1), (50, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (31, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (31, 1), (62, 1)] }],
  [{ coefficient := -2, powers := [(21, 1), (25, 1), (55, 1)] }],
  [{ coefficient := 1, powers := [(20, 1)] }],
  [{ coefficient := 1, powers := [(13, 1), (50, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (30, 1), (40, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(24, 1), (40, 1), (61, 1)] }],
  [{ coefficient := -2, powers := [(25, 1), (55, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (40, 1), (61, 1)] }, { coefficient := -1, powers := [(26, 1), (40, 1), (61, 1)] }, { coefficient := 1, powers := [(50, 1), (55, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(55, 1)] }],
  [{ coefficient := 1, powers := [(50, 1), (55, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(50, 1), (57, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(25, 1)] }],
  [{ coefficient := -1, powers := [(29, 1), (50, 1), (55, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (2, 1), (19, 1), (50, 1), (55, 1), (63, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (30, 1), (50, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (40, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(19, 1), (26, 1), (40, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (50, 1), (54, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(13, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (40, 1), (61, 1)] }, { coefficient := 1, powers := [(13, 1), (30, 1), (50, 1), (54, 1), (64, 1)] }, { coefficient := 1, powers := [(19, 1), (29, 1), (40, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(19, 1), (30, 1), (40, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (50, 1), (55, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (2, 1), (50, 1), (55, 1), (63, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := -1, powers := [(5, 1), (31, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (2, 1), (39, 1), (50, 1), (55, 1), (60, 1), (64, 1)] }, { coefficient := -1, powers := [(0, 1), (2, 1), (47, 1), (50, 1), (53, 1), (55, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (2, 2), (50, 1), (55, 1), (57, 1), (63, 1), (64, 1)] }, { coefficient := 1, powers := [(0, 1), (2, 1), (50, 1), (55, 1), (57, 1), (64, 1)] }, { coefficient := 1, powers := [(0, 1), (19, 1), (29, 1), (40, 1), (61, 1)] }, { coefficient := -1, powers := [(2, 1), (26, 1), (40, 1), (61, 1)] }, { coefficient := 1, powers := [(2, 1), (50, 1), (55, 1), (64, 1)] }, { coefficient := -1, powers := [(13, 1), (26, 1), (30, 1), (50, 1), (54, 1), (64, 1)] }, { coefficient := 1, powers := [(13, 1), (27, 1), (30, 1), (50, 1), (64, 1)] }, { coefficient := 1, powers := [(13, 1), (29, 1), (50, 1), (54, 1), (64, 1)] }, { coefficient := -1, powers := [(13, 1), (31, 1), (50, 1), (64, 1)] }, { coefficient := 2, powers := [(20, 1), (21, 1), (25, 1), (55, 1)] }, { coefficient := 2, powers := [(20, 1), (25, 1), (26, 1), (55, 1)] }],
...
#print axioms Krenn.Component16.SelectedLeafB5_0_2.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB5_0_2
