...
namespace Krenn.Component16.SelectedLeafB5_6_3_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "606c1508277f64c77e84569f6b202e55371e1da9bf0f3ce9367c6440feae8ff9"
...
def multipliers : Fin 23 → SparsePoly (Fin 69) := ![
  ...
  [{ coefficient := 1, powers := [(30, 1), (33, 1), (39, 1), (54, 1), (68, 1)] }],
  [{ coefficient := -1, powers := [(30, 1), (33, 1), (39, 1), (68, 1)] }],
  [{ coefficient := -1, powers := [(33, 1), (39, 1), (68, 1)] }],
  ...
  [{ coefficient := 1, powers := [(24, 1), (33, 1), (39, 1), (68, 1)] }],
  [{ coefficient := -1, powers := [(23, 1), (68, 1)] }],
  [{ coefficient := 1, powers := [(27, 1), (33, 1), (39, 1), (68, 1)] }],
  [{ coefficient := 1, powers := [(42, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(57, 1), (67, 1)] }],
  [{ coefficient := 1, powers := [(23, 1), (31, 1), (68, 1)] }, { coefficient := -1, powers := [(24, 1), (27, 1), (33, 1), (39, 1), (68, 1)] }],
  ...
  [{ coefficient := 1, powers := [(4, 1), (23, 1), (42, 1), (60, 1)] }, { coefficient := 1, powers := [(4, 1), (23, 1), (47, 1), (60, 1)] }, { coefficient := 1, powers := [(4, 1), (23, 1), (53, 1), (60, 1)] }, { coefficient := -1, powers := [(4, 1), (33, 1), (39, 1), (60, 1)] }, { coefficient := 1, powers := [(11, 1), (23, 1), (42, 1), (47, 1)] }, { coefficient := 1, powers := [(11, 1), (23, 1), (47, 2)] }, { coefficient := 1, powers := [(11, 1), (23, 1), (47, 1), (53, 1)] }, { coefficient := -1, powers := [(11, 1), (30, 1), (33, 1), (39, 1), (54, 1), (68, 1)] }, { coefficient := -1, powers := [(11, 1), (33, 1), (39, 1), (47, 1)] }, { coefficient := 1, powers := [(16, 1), (23, 1), (42, 2)] }, { coefficient := 1, powers := [(16, 1), (23, 1), (42, 1), (47, 1)] }, { coefficient := 1, powers := [(16, 1), (23, 1), (42, 1), (53, 1)] }, { coefficient := -1, powers := [(16, 1), (33, 1), (39, 1), (42, 1)] }],
...
#print axioms Krenn.Component16.SelectedLeafB5_6_3_1.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB5_6_3_1
