...
namespace Krenn.Component16.SelectedLeafB4_6_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "1abb93857f580e07bf9cfa054988fe6e62371db531da376314ee82fdf69d4257"
...
def multipliers : Fin 32 → SparsePoly (Fin 67) := ![
  ...
  [{ coefficient := 1, powers := [(4, 1), (5, 1), (34, 1), (45, 1), (58, 1), (60, 1), (66, 1)] }, { coefficient := 2, powers := [(4, 1), (5, 1), (37, 1), (45, 1), (55, 1), (60, 1), (66, 1)] }, { coefficient := 1, powers := [(5, 1), (11, 1), (34, 1), (45, 1), (47, 1), (58, 1), (66, 1)] }, { coefficient := 2, powers := [(5, 1), (11, 1), (37, 1), (45, 1), (47, 1), (55, 1), (66, 1)] }],
  [{ coefficient := -2, powers := [(19, 1), (50, 1)] }],
  [{ coefficient := 1, powers := [(21, 1), (25, 1), (58, 1)] }],
  [{ coefficient := -1, powers := [(25, 1), (58, 1)] }],
  [{ coefficient := -1, powers := [(4, 1), (5, 1), (34, 1), (58, 1), (60, 1), (66, 1)] }, { coefficient := -2, powers := [(4, 1), (5, 1), (37, 1), (55, 1), (60, 1), (66, 1)] }, { coefficient := -1, powers := [(5, 1), (11, 1), (34, 1), (47, 1), (58, 1), (66, 1)] }, { coefficient := -2, powers := [(5, 1), (11, 1), (37, 1), (47, 1), (55, 1), (66, 1)] }],
...
#print axioms Krenn.Component16.SelectedLeafB4_6_3.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB4_6_3
