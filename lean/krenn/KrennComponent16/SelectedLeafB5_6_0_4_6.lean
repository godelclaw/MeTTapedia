...
namespace Krenn.Component16.SelectedLeafB5_6_0_4_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "730b1cd0fb19b5d590d88740bb3f483fb8a987e875452707cdad4bd6e09ad7c8"
def certificateSHA256 : String := "53e748f407c4ef859d66a7ec53a0f781f6a90833425a632335a37af9a46afe2b"
...
def multipliers : Fin 14 → SparsePoly (Fin 69) := ![
  ...
  [{ coefficient := 1, powers := [(3, 1), (5, 1), (60, 1), (61, 1)] }, { coefficient := 1, powers := [(5, 1), (61, 1)] }, { coefficient := 1, powers := [(13, 1), (45, 1), (49, 1)] }, { coefficient := -1, powers := [(13, 1), (50, 1)] }],
...
#print axioms Krenn.Component16.SelectedLeafB5_6_0_4_6.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB5_6_0_4_6
