...
namespace Krenn.Component16.SelectedLeafB5_0_6_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "c957f7950d1124b7cdfd119973f4d1b8604a831e163b98bf64a3346a1544a634"
def certificateSHA256 : String := "2e7b20010705309b7bfbbee5e7d585e7116293e2a342446bfa3c8693de41f2b4"
...
def multipliers : Fin 22 → SparsePoly (Fin 68) := ![
  ...
  [{ coefficient := -1, powers := [(24, 1), (40, 1), (61, 1), (67, 1)] }, { coefficient := 2, powers := [(25, 1), (26, 1), (48, 1), (55, 1), (67, 1)] }, { coefficient := -1, powers := [(25, 1), (27, 1), (38, 1), (47, 1), (61, 1), (67, 1)] }, { coefficient := -1, powers := [(25, 1), (38, 1), (54, 1), (61, 1), (67, 1)] }, { coefficient := 1, powers := [(25, 1), (45, 1), (55, 1), (67, 1)] }, { coefficient := -1, powers := [(29, 1), (40, 1), (61, 1), (67, 1)] }],
...
#print axioms Krenn.Component16.SelectedLeafB5_0_6_6.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB5_0_6_6
