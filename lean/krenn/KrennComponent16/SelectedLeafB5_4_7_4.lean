...
namespace Krenn.Component16.SelectedLeafB5_4_7_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "70bbf9264f6af6777eb925842fd62dbec0b1290fa52ea6120f1395aceb76a6e0"
def certificateSHA256 : String := "3b135e10335638c951e0d74fc934e4dc03ddbbfb8d80ccb12a5cb25ea50e4f71"

set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedSourceIndices : Fin 34 → Fin 674 := ![
  9,
  13,
  23,
  142,
...
def multipliers : Fin 34 → SparsePoly (Fin 69) := ![
  ...
  [{ coefficient := 1, powers := [(2, 1), (22, 1), (45, 1), (53, 1), (62, 1)] }, { coefficient := 2, powers := [(2, 1), (47, 1), (50, 1)] }],
  ...
  [{ coefficient := 2, powers := [(19, 1), (21, 1), (29, 1), (50, 1), (55, 1)] }, { coefficient := 2, powers := [(19, 1), (26, 1), (29, 1), (50, 1), (55, 1)] }, { coefficient := 2, powers := [(20, 1), (21, 1), (25, 1), (55, 1)] }, { coefficient := 2, powers := [(20, 1), (25, 1), (26, 1), (55, 1)] }],
...
#print axioms Krenn.Component16.SelectedLeafB5_4_7_4.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB5_4_7_4
