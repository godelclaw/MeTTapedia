...
namespace Krenn.Component16.SelectedLeafB5_2_3_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "26d64e9fdd423691159c67e6241da515b2f7d044ba01287ffc560824605e6fd6"
def certificateSHA256 : String := "49b77b94f14b18842b1e7d8250d864f999cddd3f6cab36655e2c3c21e039425c"
...
def multipliers : Fin 29 → SparsePoly (Fin 70) := ![
  ...
  [{ coefficient := -1, powers := [(2, 1), (21, 1), (50, 1), (55, 1), (62, 1)] }, { coefficient := 1, powers := [(2, 1), (22, 1), (45, 1), (55, 1), (62, 1)] }, { coefficient := 1, powers := [(2, 1), (50, 1), (55, 1)] }, { coefficient := -1, powers := [(19, 1), (25, 1), (45, 1), (55, 1)] }, { coefficient := -2, powers := [(20, 1), (29, 1), (49, 1), (55, 1)] }],
...
#print axioms Krenn.Component16.SelectedLeafB5_2_3_7.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB5_2_3_7
