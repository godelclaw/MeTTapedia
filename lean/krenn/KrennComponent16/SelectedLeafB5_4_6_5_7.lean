...
namespace Krenn.Component16.SelectedLeafB5_4_6_5_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "0c1a93bab34209e16848b84440e8f149e03fa153ace4252d6d70b0cbd456e761"
...
def multipliers : Fin 17 → SparsePoly (Fin 72) := ![
  [{ coefficient := 1, powers := [(11, 1), (23, 1), (53, 1), (60, 1), (71, 1)] }],
  ...
  [{ coefficient := 1, powers := [(33, 1), (57, 1), (71, 1)] }],
  ...
  [{ coefficient := -1, powers := [(39, 1), (60, 1), (61, 1), (71, 1)] }, { coefficient := 1, powers := [(39, 1), (60, 1)] }, { coefficient := -1, powers := [(47, 1), (53, 1)] }, { coefficient := 1, powers := [(53, 1), (57, 1)] }],
...
#print axioms Krenn.Component16.SelectedLeafB5_4_6_5_7.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB5_4_6_5_7
