...
namespace Krenn.Component16.SelectedLeafB5_6_6_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "5af5f0985f42b0b9ee10b0fd303c2f5ef9f50c499b9c33a8113ebff8e6c067b3"
def certificateSHA256 : String := "6e4eee9f6862379c9961a24117cb2ba447331c55d02b69abee67b49123098fd2"
...
def multipliers : Fin 26 → SparsePoly (Fin 71) := ![
  ...
  [{ coefficient := 1, powers := [(22, 1), (31, 1), (38, 1), (42, 1), (61, 1), (69, 1)] }, { coefficient := 1, powers := [(22, 1), (31, 1), (38, 1), (47, 1), (61, 1), (69, 1)] }, { coefficient := -1, powers := [(24, 1), (40, 1), (61, 1), (69, 1)] }, { coefficient := -1, powers := [(25, 1), (27, 1), (38, 1), (42, 1), (61, 1), (69, 1)] }, { coefficient := -1, powers := [(25, 1), (27, 1), (38, 1), (47, 1), (61, 1), (69, 1)] }, { coefficient := -1, powers := [(25, 1), (38, 1), (54, 1), (61, 1), (69, 1)] }, { coefficient := 1, powers := [(25, 1), (45, 1), (55, 1), (69, 1)] }, { coefficient := -1, powers := [(29, 1), (40, 1), (61, 1), (69, 1)] }, { coefficient := -1, powers := [(31, 1), (38, 1), (49, 1), (61, 1), (69, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (50, 1)] }],
  [{ coefficient := 2, powers := [(12, 1), (25, 1), (55, 1), (64, 1), (69, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (38, 1), (54, 1), (61, 1), (69, 1)] }],
  ...
  [{ coefficient := -1, powers := [(2, 1), (38, 1), (49, 1), (54, 1), (61, 1)] }, { coefficient := 1, powers := [(2, 1), (50, 1), (55, 1)] }, { coefficient := -1, powers := [(19, 1), (22, 1), (31, 1), (38, 1), (42, 1), (61, 1)] }, { coefficient := -1, powers := [(19, 1), (22, 1), (31, 1), (38, 1), (47, 1), (61, 1)] }, { coefficient := 1, powers := [(19, 1), (24, 1), (40, 1), (61, 1)] }, { coefficient := 1, powers := [(19, 1), (25, 1), (27, 1), (38, 1), (42, 1), (61, 1)] }, { coefficient := 1, powers := [(19, 1), (25, 1), (27, 1), (38, 1), (47, 1), (61, 1)] }, { coefficient := 1, powers := [(19, 1), (25, 1), (38, 1), (54, 1), (61, 1)] }, { coefficient := -1, powers := [(19, 1), (25, 1), (45, 1), (55, 1)] }, { coefficient := 1, powers := [(19, 1), (29, 1), (40, 1), (61, 1)] }, { coefficient := 1, powers := [(19, 1), (31, 1), (38, 1), (49, 1), (61, 1)] }, { coefficient := 2, powers := [(20, 1), (25, 1), (55, 1)] }]
]
...
#print axioms Krenn.Component16.SelectedLeafB5_6_6_7.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB5_6_6_7
