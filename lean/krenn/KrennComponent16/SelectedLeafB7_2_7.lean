...
namespace Krenn.Component16.SelectedLeafB7_2_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "2d1e2aefbfaeb1ee2651b05fa2c72c1a951ed8ae40afd41967aca8c4ec76827f"
...
def multipliers : Fin 22 → SparsePoly (Fin 69) := ![
  [{ coefficient := -1, powers := [(13, 1), (30, 1), (58, 1), (63, 1), (67, 1)] }],
  ...
  [{ coefficient := 2, powers := [(25, 1), (46, 1), (58, 1), (66, 1)] }],
  ...
  [{ coefficient := -1, powers := [(2, 1), (21, 1), (50, 1), (55, 1), (62, 1)] }, { coefficient := 1, powers := [(2, 1), (22, 1), (45, 1), (55, 1), (62, 1)] }, { coefficient := -1, powers := [(5, 1), (37, 1), (55, 1)] }, { coefficient := 1, powers := [(13, 1), (25, 1), (45, 1), (54, 1)] }, { coefficient := 1, powers := [(13, 1), (30, 1), (49, 1), (58, 1), (67, 1)] }, { coefficient := 2, powers := [(13, 1), (31, 1), (50, 1)] }, { coefficient := 1, powers := [(20, 1), (25, 1), (55, 1)] }],
...
#print axioms Krenn.Component16.SelectedLeafB7_2_7.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB7_2_7
