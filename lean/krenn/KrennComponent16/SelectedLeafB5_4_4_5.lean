...
namespace Krenn.Component16.SelectedLeafB5_4_4_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "d9f0492ce86db90097c99c4252bf8b7aea02e6aacc5a26ceccd41876cfdb98ca"
def certificateSHA256 : String := "2713b53aa915055d0c39c5c2e863444815baeb810868cba597a557822bcfbc5b"
...
def multipliers : Fin 30 → SparsePoly (Fin 68) := ![
  ...
  [{ coefficient := 1, powers := [(2, 1), (26, 1), (50, 1), (54, 1), (67, 1)] }],
  ...
  [{ coefficient := -1, powers := [(2, 1), (26, 1), (50, 1), (55, 1), (67, 1)] }],
  ...
  [{ coefficient := 1, powers := [(2, 1), (26, 1), (31, 1), (50, 1), (55, 1), (67, 1)] }, { coefficient := 1, powers := [(20, 1), (21, 1), (25, 1), (55, 1)] }, { coefficient := 1, powers := [(20, 1), (25, 1), (26, 1), (55, 1)] }],
...
#print axioms Krenn.Component16.SelectedLeafB5_4_4_5.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB5_4_4_5
