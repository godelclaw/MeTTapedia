...
namespace Krenn.Component16.SelectedLeafB4_2_7_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "3a00378b819a3c84812fa7914ff1d21ada0d72a68f3ecd4f5b3c0af0bda13588"
...
def multipliers : Fin 21 → SparsePoly (Fin 68) := ![
  ...
  [{ coefficient := -1, powers := [(13, 1), (25, 1), (47, 1), (58, 1), (65, 1)] }, { coefficient := 1, powers := [(13, 1), (25, 1), (57, 1), (58, 1), (65, 1)] }, { coefficient := 1, powers := [(13, 1), (30, 1), (49, 1), (58, 1), (65, 1)] }, { coefficient := -1, powers := [(19, 1), (25, 1), (45, 1), (55, 1), (57, 1), (65, 1)] }],
...
#print axioms Krenn.Component16.SelectedLeafB4_2_7_2.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB4_2_7_2
