...
namespace Krenn.Component16.SelectedLeafB1_2_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "d9f8fc86751f245325b417861187fa22471cd11449b2299bccd1e1babb5fcddb"
def certificateSHA256 : String := "d4885abea656537f4de4e1454d5ea82732a6947f235f43da4e6b17a96e7210af"
...
def multipliers : Fin 21 → SparsePoly (Fin 65) := ![
  [{ coefficient := -1, powers := [(22, 1), (31, 1), (38, 1), (53, 1), (60, 1)] }, { coefficient := 1, powers := [(29, 1), (40, 1), (60, 1)] }],
  ...
  [{ coefficient := 1, powers := [(13, 1), (31, 1), (38, 1), (60, 1)] }],
  ...
  [{ coefficient := 1, powers := [(5, 1), (37, 1), (38, 1), (47, 1), (55, 1), (60, 1)] }, { coefficient := -1, powers := [(13, 1), (31, 1), (38, 1), (50, 1), (53, 1), (60, 1)] }, { coefficient := -1, powers := [(19, 1), (24, 1), (47, 1), (62, 1)] }, { coefficient := -1, powers := [(19, 1), (29, 1), (53, 1), (62, 1)] }],
...
#print axioms Krenn.Component16.SelectedLeafB1_2_2.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB1_2_2
