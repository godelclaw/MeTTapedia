...
namespace Krenn.Component16.SelectedLeafB6_6_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "57bae9199b6ce2e3fc7500634bd1a441ad9ee0740feba945cb5a697ea6896cd5"
def certificateSHA256 : String := "3214162793cc6a264ab564d3a0fa425af21017d983b2ca4fb72449551dfa3f2d"
...
def multipliers : Fin 20 → SparsePoly (Fin 68) := ![
  ...
  [{ coefficient := 1, powers := [(5, 1), (37, 1), (58, 1), (63, 1), (67, 1)] }, { coefficient := -1, powers := [(20, 1), (25, 1), (58, 1), (63, 1), (67, 1)] }, { coefficient := 2, powers := [(20, 1), (25, 1), (63, 1)] }],
  ...
  [{ coefficient := -1, powers := [(5, 1), (37, 1), (55, 1), (58, 1), (67, 1)] }, { coefficient := 2, powers := [(8, 1), (29, 1), (49, 1), (61, 1)] }, { coefficient := 1, powers := [(13, 1), (25, 1), (45, 1), (54, 1), (58, 1), (67, 1)] }, { coefficient := 1, powers := [(13, 1), (30, 1), (49, 1), (58, 1), (66, 1)] }, { coefficient := 2, powers := [(13, 1), (31, 1), (50, 1), (58, 1), (67, 1)] }, { coefficient := 1, powers := [(20, 1), (25, 1), (55, 1), (58, 1), (67, 1)] }, { coefficient := -2, powers := [(20, 1), (25, 1), (55, 1)] }],
  [{ coefficient := 1, powers := [(40, 1), (58, 1), (61, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (57, 1), (58, 1), (66, 1)] }, { coefficient := 1, powers := [(2, 1), (58, 2), (67, 1)] }, { coefficient := 1, powers := [(8, 1), (37, 1), (58, 1), (67, 1)] }, { coefficient := -1, powers := [(19, 1), (30, 1), (58, 1), (66, 1)] }, { coefficient := -1, powers := [(20, 1), (31, 1), (58, 1), (67, 1)] }],
...
#print axioms Krenn.Component16.SelectedLeafB6_6_3.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB6_6_3
