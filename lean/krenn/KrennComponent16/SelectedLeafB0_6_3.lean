...
namespace Krenn.Component16.SelectedLeafB0_6_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "71b9f0d4db7208d0ded9acef042ff08ed49a2ec5fd7acad3df5e86347a52a660"
...
def multipliers : Fin 34 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := 1, powers := [(4, 1), (5, 1), (34, 1), (45, 1), (58, 1), (60, 1), (65, 1)] }, { coefficient := 1, powers := [(5, 1), (11, 1), (34, 1), (45, 1), (47, 1), (58, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (50, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (16, 1), (34, 1), (42, 1), (47, 1), (58, 1), (65, 1)] }, { coefficient := -1, powers := [(5, 1), (16, 1), (34, 1), (47, 2), (58, 1), (65, 1)] }, { coefficient := -1, powers := [(5, 1), (16, 1), (34, 1), (47, 1), (53, 1), (58, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (37, 1)] }, { coefficient := -1, powers := [(20, 1), (25, 1)] }],
  [{ coefficient := -1, powers := [(4, 1), (5, 1), (34, 1), (58, 1), (60, 1), (65, 1)] }, { coefficient := -1, powers := [(5, 1), (11, 1), (34, 1), (47, 1), (58, 1), (65, 1)] }],
...
#print axioms Krenn.Component16.SelectedLeafB0_6_3.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB0_6_3
