...
namespace Krenn.Component16.SelectedLeafB5_2_0_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "59942cd0a195d0643eb30d34a008dc701dceaaa6aa3f6d4afc12a1b6bfae0b60"
def certificateSHA256 : String := "4182ae6ff7f2de633104036ad48fd64cb0e186b6a0a472574bc82bf6bcfbfe1e"
...
def multipliers : Fin 30 → SparsePoly (Fin 68) := ![
  ...
  [{ coefficient := -1, powers := [(22, 1), (31, 1), (38, 1), (53, 1), (61, 1), (66, 1)] }, { coefficient := -1, powers := [(24, 1), (40, 1), (61, 1), (66, 1)] }, { coefficient := 1, powers := [(25, 1), (27, 1), (38, 1), (53, 1), (61, 1), (66, 1)] }, { coefficient := -1, powers := [(25, 1), (38, 1), (54, 1), (61, 1), (66, 1)] }, { coefficient := 1, powers := [(25, 1), (45, 1), (55, 1), (66, 1)] }, { coefficient := -1, powers := [(29, 1), (40, 1), (61, 1), (66, 1)] }, { coefficient := -1, powers := [(31, 1), (38, 1), (49, 1), (61, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (50, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (38, 1), (54, 1), (61, 1), (66, 1)] }, { coefficient := 2, powers := [(20, 1), (29, 1), (55, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (55, 1), (66, 1)] }],
  [{ coefficient := 2, powers := [(20, 1), (25, 1), (26, 1), (54, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (55, 1)] }],
  [{ coefficient := 1, powers := [(19, 1), (38, 1), (61, 1)] }],
  [{ coefficient := -2, powers := [(20, 1), (25, 1)] }],
  [{ coefficient := 1, powers := [(31, 1)] }],
  [{ coefficient := 1, powers := [(20, 1)] }],
  [{ coefficient := -2, powers := [(20, 1), (25, 1), (26, 1), (55, 1), (67, 1)] }],
  ...
  [{ coefficient := -1, powers := [(2, 1), (38, 1), (49, 1), (54, 1), (61, 1)] }, { coefficient := 1, powers := [(2, 1), (50, 1), (55, 1)] }, { coefficient := 1, powers := [(19, 1), (22, 1), (31, 1), (38, 1), (53, 1), (61, 1)] }, { coefficient := 1, powers := [(19, 1), (24, 1), (40, 1), (61, 1)] }, { coefficient := -1, powers := [(19, 1), (25, 1), (27, 1), (38, 1), (53, 1), (61, 1)] }, { coefficient := 1, powers := [(19, 1), (25, 1), (38, 1), (54, 1), (61, 1)] }, { coefficient := -1, powers := [(19, 1), (25, 1), (45, 1), (55, 1)] }, { coefficient := 1, powers := [(19, 1), (29, 1), (40, 1), (61, 1)] }, { coefficient := 1, powers := [(19, 1), (31, 1), (38, 1), (49, 1), (61, 1)] }, { coefficient := -2, powers := [(20, 1), (29, 1), (49, 1), (55, 1)] }],
...
#print axioms Krenn.Component16.SelectedLeafB5_2_0_7.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB5_2_0_7
