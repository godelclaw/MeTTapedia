...
namespace Krenn.Component16.SelectedLeafB5_4_7_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "df4fb49041d246241b4ca805b1449ca69ecf595580d0247b90b698e15bcf5c2b"
def certificateSHA256 : String := "0449ec3a428c5f2f9e73943931f62d137b288fa5a14a17e7610d76ba17c032f1"
...
def multipliers : Fin 24 → SparsePoly (Fin 71) := ![
  ...
  [{ coefficient := 2, powers := [(25, 1), (26, 1), (48, 1), (55, 1), (69, 1)] }, { coefficient := 1, powers := [(25, 1), (45, 1), (55, 1), (69, 1)] }],
  ...
  [{ coefficient := -1, powers := [(2, 1), (21, 1), (50, 1), (55, 1), (62, 1)] }, { coefficient := 1, powers := [(2, 1), (22, 1), (45, 1), (55, 1), (62, 1)] }, { coefficient := 1, powers := [(2, 1), (50, 1), (55, 1)] }, { coefficient := -2, powers := [(19, 1), (25, 1), (26, 1), (48, 1), (55, 1)] }, { coefficient := -1, powers := [(19, 1), (25, 1), (45, 1), (55, 1)] }]
]
...
#print axioms Krenn.Component16.SelectedLeafB5_4_7_7.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB5_4_7_7
