...
namespace Krenn.Component16.SelectedLeafB5_0_6_5_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "a88586abb8f7a0910956dbb9b0647f776f9d76c8632b7abb30cf12abdb29162e"
def certificateSHA256 : String := "b1c5bb0ad0d5d382678be1dee068a8ef690be96cc941afaf9894070703ef3f4c"
...
def multipliers : Fin 19 → SparsePoly (Fin 69) := ![
  ...
  [{ coefficient := -1, powers := [(0, 1), (2, 1), (58, 1), (66, 1)] }, { coefficient := -1, powers := [(2, 1), (27, 1), (45, 1), (66, 1)] }, { coefficient := 1, powers := [(2, 1), (58, 1)] }, { coefficient := 1, powers := [(8, 1), (37, 1)] }, { coefficient := -1, powers := [(20, 1), (31, 1)] }],
  ...
  [{ coefficient := -1, powers := [(0, 1), (2, 1), (40, 1), (66, 1)] }, { coefficient := 1, powers := [(2, 1), (40, 1)] }, { coefficient := 1, powers := [(8, 1), (25, 1)] }]
]
...
#print axioms Krenn.Component16.SelectedLeafB5_0_6_5_2.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB5_0_6_5_2
