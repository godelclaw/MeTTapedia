...
namespace Krenn.Component16.SelectedLeafB4_6_6_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "9ecec85367ac37d2edd26d9df60a7596947bd643143560deb20d8761ddec2507"
def certificateSHA256 : String := "09442f6d1c8ccedf3a450ddd01ca7ca5a00946a9864018085fcb63bfdab5ce3c"
...
def multipliers : Fin 19 → SparsePoly (Fin 68) := ![
  ...
  [{ coefficient := 1, powers := [(37, 1), (40, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(13, 1), (31, 1), (53, 1)] }],
  [{ coefficient := 1, powers := [(31, 1)] }],
  [{ coefficient := 1, powers := [(20, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (31, 1)] }],
  ...
  [{ coefficient := -1, powers := [(13, 1), (31, 1), (50, 1), (53, 1)] }, { coefficient := -1, powers := [(13, 1), (37, 1), (40, 1), (46, 1), (65, 1)] }, { coefficient := -1, powers := [(19, 1), (25, 1), (42, 1), (45, 1), (55, 1)] }, { coefficient := -1, powers := [(19, 1), (25, 1), (45, 1), (47, 1), (55, 1)] }, { coefficient := 2, powers := [(19, 1), (25, 1), (48, 1), (55, 1)] }, { coefficient := 2, powers := [(20, 1), (25, 1), (42, 1), (55, 1)] }]
]
...
#print axioms Krenn.Component16.SelectedLeafB4_6_6_1.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB4_6_6_1
