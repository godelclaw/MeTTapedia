...
namespace Krenn.Component16.SelectedLeafB4_2_7_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "b669136882779500875ffdc0749d01cad28bee1db54e5adfccbde035491316b1"
def certificateSHA256 : String := "8d200be6150bedb7963e1320cc831d301ea18808f0a1c4ac24033a205561c808"
...
def multipliers : Fin 21 → SparsePoly (Fin 67) := ![
  ...
  [{ coefficient := -2, powers := [(25, 1), (58, 1), (64, 1)] }, { coefficient := -1, powers := [(30, 1), (49, 1), (58, 1), (64, 1), (65, 1)] }],
  ...
  [{ coefficient := 1, powers := [(40, 1), (58, 1), (61, 1), (66, 1)] }, { coefficient := -1, powers := [(50, 1), (55, 1), (58, 1), (66, 1)] }],
  ...
  [{ coefficient := 2, powers := [(13, 1), (25, 1), (58, 1)] }, { coefficient := 1, powers := [(13, 1), (30, 1), (49, 1), (58, 1), (65, 1)] }],
  ...
  [{ coefficient := 2, powers := [(13, 1), (25, 1), (46, 1), (58, 1), (64, 1)] }, { coefficient := 1, powers := [(13, 1), (30, 1), (46, 1), (49, 1), (58, 1), (64, 1), (65, 1)] }, { coefficient := -1, powers := [(19, 1), (25, 1), (42, 1), (45, 1), (55, 1), (58, 1), (66, 1)] }, { coefficient := -1, powers := [(19, 1), (25, 1), (45, 1), (47, 1), (55, 1), (58, 1), (66, 1)] }, { coefficient := 2, powers := [(19, 1), (25, 1), (48, 1), (55, 1), (58, 1), (66, 1)] }, { coefficient := 2, powers := [(20, 1), (25, 1), (42, 1), (55, 1), (58, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (58, 1), (61, 1), (66, 1)] }, { coefficient := 1, powers := [(13, 1), (45, 1), (49, 1), (58, 1), (66, 1)] }, { coefficient := -1, powers := [(13, 1), (50, 1), (58, 1), (66, 1)] }]
]
...
#print axioms Krenn.Component16.SelectedLeafB4_2_7_0.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB4_2_7_0
