...
namespace Krenn.Component16.SelectedLeafB5_4_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "4dc52a1a95098fce72445ebe0fdac1c8ba6de5dd880e4643edf370eb2f257b51"
...
def multipliers : Fin 35 → SparsePoly (Fin 67) := ![
  ...
  [{ coefficient := 2, powers := [(0, 1), (27, 1), (47, 1), (53, 1), (66, 1)] }, { coefficient := 2, powers := [(27, 1), (53, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (24, 1), (53, 1), (63, 1)] }, { coefficient := -1, powers := [(0, 1), (29, 1), (53, 1), (63, 1)] }],
  [{ coefficient := 2, powers := [(3, 1), (25, 1), (55, 1), (60, 1)] }],
  [{ coefficient := 2, powers := [(0, 1), (45, 1), (47, 1), (53, 1), (66, 1)] }, { coefficient := 2, powers := [(45, 1), (53, 1), (66, 1)] }],
  ...
  [{ coefficient := -2, powers := [(0, 1), (47, 1), (53, 1), (66, 1)] }, { coefficient := -2, powers := [(53, 1), (66, 1)] }],
  [{ coefficient := 2, powers := [(0, 1), (53, 1), (63, 1)] }],
  [{ coefficient := -2, powers := [(5, 1), (60, 1)] }],
  [{ coefficient := 2, powers := [(0, 1), (21, 1), (53, 1), (62, 1)] }],
  [{ coefficient := 2, powers := [(0, 1), (26, 1), (53, 1), (62, 1)] }, { coefficient := -2, powers := [(0, 1), (27, 1), (45, 1), (47, 1), (53, 1), (66, 1)] }, { coefficient := -2, powers := [(27, 1), (45, 1), (53, 1), (66, 1)] }, { coefficient := 2, powers := [] }],
  ...
  [{ coefficient := 1, powers := [(0, 1), (2, 1), (26, 1), (53, 1), (63, 1)] }, { coefficient := 1, powers := [(0, 1), (19, 1), (24, 1), (63, 1)] }, { coefficient := 1, powers := [(0, 1), (19, 1), (29, 1), (63, 1)] }, { coefficient := 2, powers := [(0, 1), (21, 1), (27, 1), (45, 1), (47, 1), (53, 1), (66, 1)] }, { coefficient := 1, powers := [(0, 1)] }, { coefficient := -2, powers := [(3, 1), (13, 1), (21, 1), (31, 1), (50, 1), (60, 1)] }, { coefficient := 2, powers := [(3, 1), (13, 1), (21, 1), (37, 1), (40, 1), (60, 1)] }, { coefficient := 2, powers := [(21, 1), (27, 1), (45, 1), (53, 1), (66, 1)] }, { coefficient := -2, powers := [(21, 1)] }],
...
#print axioms Krenn.Component16.SelectedLeafB5_4_5.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB5_4_5
