...
namespace Krenn.Component16.SelectedLeafB5_6_7_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "f31f3111180fe283c4bcdf73db13869088715fadc7e6cbcf1682a00f0a78873b"
def certificateSHA256 : String := "d931ed8df0d243fa1931abcd34f1afd5124a527d38abf3fa8a6a5c7b3fed9163"
...
def multipliers : Fin 23 → SparsePoly (Fin 71) := ![
  [{ coefficient := 1, powers := [(25, 1), (47, 1), (58, 1), (67, 1), (69, 1)] }, { coefficient := -1, powers := [(30, 1), (49, 1), (58, 1), (67, 1), (69, 1)] }, { coefficient := -1, powers := [(31, 1), (50, 1), (69, 1)] }, { coefficient := 1, powers := [(37, 1), (40, 1), (69, 1)] }],
  ...
  [{ coefficient := -1, powers := [(0, 1), (2, 1), (58, 1), (62, 1)] }, { coefficient := -1, powers := [(2, 1), (27, 1), (45, 1), (62, 1)] }, { coefficient := -1, powers := [(2, 1), (57, 1), (58, 1), (67, 1)] }, { coefficient := 1, powers := [(2, 1), (58, 1)] }, { coefficient := 1, powers := [(8, 1), (37, 1)] }, { coefficient := -1, powers := [(19, 1), (30, 1), (58, 1), (67, 1)] }, { coefficient := -1, powers := [(20, 1), (31, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (34, 1), (58, 1)] }],
  [{ coefficient := 2, powers := [(19, 1), (25, 1), (48, 1), (55, 1)] }, { coefficient := 2, powers := [(20, 1), (25, 1), (42, 1), (55, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (21, 1), (50, 1), (55, 1), (62, 1)] }, { coefficient := 1, powers := [(2, 1), (22, 1), (45, 1), (55, 1), (62, 1)] }, { coefficient := 1, powers := [(2, 1), (50, 1), (55, 1)] }, { coefficient := -1, powers := [(13, 1), (25, 1), (47, 1), (58, 1), (67, 1)] }, { coefficient := 1, powers := [(13, 1), (30, 1), (49, 1), (58, 1), (67, 1)] }, { coefficient := 1, powers := [(13, 1), (31, 1), (50, 1)] }, { coefficient := -1, powers := [(13, 1), (37, 1), (40, 1)] }, { coefficient := -1, powers := [(19, 1), (25, 1), (45, 1), (55, 1)] }]
]
...
#print axioms Krenn.Component16.SelectedLeafB5_6_7_3.selectedHasNoCommonZero

end Krenn.Component16.SelectedLeafB5_6_7_3
