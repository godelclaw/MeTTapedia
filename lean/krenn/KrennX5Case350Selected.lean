...
namespace Krenn.X5Case350Selected

open Krenn.SparseCertificate
open MvPolynomial

def sourceSystemFileSHA256 : String := "3e68e35034471e2a2546616faf77ba98270b0c84105be296ae4d9aa7c864c469"
def sourceSystemSemanticSHA256 : String := "825b28c9d5a2453873470ee9d2d1fa392551c668b0a87e0205aa54c7b120f8cc"
...
def selectedEquations : Fin 19 → SparsePoly (Fin 70) := ![
  ...
  [{ coefficient := 1, powers := [(10, 1), (42, 1), (64, 1)] }, { coefficient := 1, powers := [(19, 1), (42, 1), (58, 1)] }, { coefficient := 1, powers := [(28, 1), (52, 1)] }],
...
#print axioms Krenn.X5Case350Selected.selectedHasNoCommonZero

end Krenn.X5Case350Selected
