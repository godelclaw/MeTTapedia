...
namespace Krenn.Component51RootCommonZero.Chunk13
...
theorem rootBlock_of_base_and_component {R : Type*} [CommRing R]
    ...
    ∀ offset : Fin 40, eval₂Hom (Int.castRingHom R) (rootValues full)
      (Krenn.Component51.Tree.rootEquations ⟨520 + offset.val, by omega⟩).toPoly = 0 := by
...
end Krenn.Component51RootCommonZero.Chunk13
