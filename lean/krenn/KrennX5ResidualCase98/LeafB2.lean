...
namespace Krenn.X5ResidualCase98.LeafB2

open Krenn.SparseCertificate
open MvPolynomial

def sourceSystemFileSHA256 : String := "75e1e973efce038cabe09716fe3d6ce7a46afb61389d32ce6646cf2f4b2d4a8e"
def sourceSystemSemanticSHA256 : String := "4d93a83b3225005e8a7e943d6ce93b94005419bcd5d80327420b3dea512ef2f9"
def certificateSHA256 : String := "741e23276f1efd4b0cecc86f66959e8846d894b98b8e6663a968e2b399d9a8ee"
...
def multipliers : Fin 22 → SparsePoly (Fin 71) := ![
  [{ coefficient := -1, powers := [(3, 1), (32, 1), (37, 1), (48, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(3, 1), (7, 1), (48, 1), (57, 1), (64, 1), (70, 1)] }],
  [{ coefficient := 1, powers := [(3, 1), (51, 1), (57, 1), (64, 1), (70, 1)] }],
  [{ coefficient := -1, powers := [(3, 1), (7, 1), (9, 1), (26, 1), (64, 1)] }, { coefficient := -1, powers := [(3, 1), (31, 1), (32, 1), (37, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(3, 1), (7, 1), (9, 1), (18, 1), (64, 1)] }, { coefficient := -1, powers := [(3, 1), (23, 1), (32, 1), (37, 1), (64, 1)] }],
  ...
  [{ coefficient := -1, powers := [(3, 1), (34, 1), (37, 1), (64, 1)] }],
...
#print axioms Krenn.X5ResidualCase98.LeafB2.selectedHasNoCommonZero

end Krenn.X5ResidualCase98.LeafB2
