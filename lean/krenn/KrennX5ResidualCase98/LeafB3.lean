...
namespace Krenn.X5ResidualCase98.LeafB3

open Krenn.SparseCertificate
open MvPolynomial

def sourceSystemFileSHA256 : String := "8a836f4f15086e874e2f4c3865cc2fe480e778f3cec8fc6cef06707c8b7b84be"
def sourceSystemSemanticSHA256 : String := "284faff9d9a61b70fe8dade76ed9cf02ce6a99238484275a04566356cda1e651"
...
def multipliers : Fin 32 → SparsePoly (Fin 72) := ![
  ...
  [{ coefficient := -1, powers := [(3, 1), (7, 1), (9, 1), (53, 1), (63, 1), (68, 1), (71, 1)] }, { coefficient := -1, powers := [(3, 1), (7, 1), (9, 1), (56, 1), (63, 1), (65, 1), (71, 1)] }, { coefficient := 1, powers := [(7, 1), (9, 1), (11, 1), (53, 1), (63, 1), (68, 1), (71, 1)] }, { coefficient := 1, powers := [(7, 1), (9, 1), (11, 1), (56, 1), (63, 1), (65, 1), (71, 1)] }, { coefficient := -1, powers := [(7, 1), (9, 1), (33, 1), (36, 1), (62, 1), (63, 1), (71, 1)] }, { coefficient := -1, powers := [(7, 1), (9, 1), (33, 1), (39, 1), (56, 1), (63, 1), (71, 1)] }, { coefficient := -1, powers := [(7, 1), (9, 1), (33, 1), (42, 1), (53, 1), (63, 1), (71, 1)] }],
  ...
  [{ coefficient := -1, powers := [(3, 1), (15, 1), (59, 1), (62, 1), (63, 1), (71, 1)] }, { coefficient := 1, powers := [(11, 1), (15, 1), (59, 1), (62, 1), (63, 1), (71, 1)] }],
  [{ coefficient := -1, powers := [(3, 1), (7, 1), (59, 1), (62, 1), (63, 1), (71, 1)] }, { coefficient := 1, powers := [(7, 1), (11, 1), (59, 1), (62, 1), (63, 1), (71, 1)] }],
  ...
  [{ coefficient := 1, powers := [(3, 1), (59, 1), (62, 1), (63, 1), (71, 1)] }, { coefficient := -1, powers := [(11, 1), (59, 1), (62, 1), (63, 1), (71, 1)] }],
...
#print axioms Krenn.X5ResidualCase98.LeafB3.selectedHasNoCommonZero

end Krenn.X5ResidualCase98.LeafB3
