...
namespace Krenn.Component20.SelectedLeafB4_2_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "557379171a084b4c6bce35b6edb5f21809878b4d389f4a5fed5f7e9f36fd9eb0"
...
def multipliers : Fin 26 → SparsePoly (Fin 64) := ![
  ...
  [{ coefficient := 1, powers := [(14, 1), (24, 1), (56, 1), (62, 1)] }, { coefficient := 1, powers := [(24, 1), (56, 1)] }, { coefficient := -1, powers := [(29, 1), (47, 1)] }, { coefficient := 1, powers := [(35, 1), (38, 1)] }],
  [{ coefficient := 1, powers := [(28, 1), (47, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (53, 1)] }],
  [{ coefficient := -1, powers := [(17, 1), (24, 1), (56, 1), (62, 1)] }, { coefficient := 1, powers := [(19, 1), (24, 1), (52, 1)] }],
  ...
  [{ coefficient := -1, powers := [(21, 1), (44, 1), (49, 1), (56, 1), (62, 1)] }, { coefficient := 1, powers := [(36, 1), (47, 1), (53, 1), (58, 1)] }, { coefficient := 1, powers := [(38, 1), (59, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (54, 1), (56, 1), (62, 1)] }, { coefficient := 1, powers := [(2, 1), (56, 1)] }, { coefficient := 1, powers := [(8, 1), (28, 1), (43, 1), (58, 1)] }, { coefficient := 1, powers := [(8, 1), (35, 1)] }, { coefficient := -1, powers := [(17, 1), (28, 1), (56, 1), (62, 1)] }, { coefficient := -1, powers := [(19, 1), (29, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (32, 1), (56, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (8, 1), (24, 1), (59, 1)] }, { coefficient := -1, powers := [(13, 1), (14, 1), (20, 1), (24, 1), (56, 1), (62, 1)] }, { coefficient := -1, powers := [(13, 1), (20, 1), (24, 1), (56, 1)] }, { coefficient := 1, powers := [(13, 1), (20, 1), (29, 1), (47, 1)] }, { coefficient := -1, powers := [(13, 1), (20, 1), (35, 1), (38, 1)] }, { coefficient := 1, powers := [(13, 1), (26, 1), (28, 1), (47, 1)] }, { coefficient := 1, powers := [(17, 1), (20, 1), (24, 1), (49, 1), (56, 1), (62, 1)] }, { coefficient := -1, powers := [(19, 1), (20, 1), (24, 1), (49, 1), (52, 1)] }, { coefficient := 1, powers := [(19, 1), (24, 1), (25, 1), (53, 1)] }]
]
...
#print axioms Krenn.Component20.SelectedLeafB4_2_5.selectedHasNoCommonZero

end Krenn.Component20.SelectedLeafB4_2_5
