...
namespace Krenn.Component20.SelectedLeafB4_6_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "374dc9ec1500b48dca160b05b2f91fb182b6e39049ae875d7813baa2c23ff6bb"
def certificateSHA256 : String := "26d9d801a37fa565435947090516bcce891e8718713d42f4ebc9856b92f7f5b1"

set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedSourceIndices : Fin 41 → Fin 645 := ![
  15,
  23,
  97,
  133,
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedEquations : Fin 41 → SparsePoly (Fin 64) := ![
  ...
  [{ coefficient := 1, powers := [(2, 1), (43, 1), (53, 1)] }, { coefficient := 1, powers := [(8, 1), (23, 1), (59, 1)] }, { coefficient := 1, powers := [(8, 1), (32, 1), (43, 1)] }, { coefficient := 1, powers := [(13, 1), (23, 1), (56, 1)] }, { coefficient := 1, powers := [(13, 1), (29, 1), (43, 1)] }, { coefficient := 1, powers := [(19, 1), (23, 1), (53, 1)] }],
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def multipliers : Fin 41 → SparsePoly (Fin 64) := ![
  [{ coefficient := 2, powers := [(21, 1), (29, 1), (60, 1)] }],
  [{ coefficient := 2, powers := [(24, 1), (26, 1), (55, 1)] }],
  [{ coefficient := 1, powers := [(20, 1), (26, 1), (47, 1), (60, 1)] }],
  [{ coefficient := -1, powers := [(21, 1), (53, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (26, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (21, 1)] }],
  [{ coefficient := 2, powers := [(29, 1), (47, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(23, 1), (47, 1), (60, 1)] }],
  [{ coefficient := -1, powers := [(23, 1), (47, 1), (53, 1), (60, 1)] }, { coefficient := -2, powers := [(29, 1), (47, 1), (49, 1), (60, 1)] }],
  [{ coefficient := -1, powers := [(28, 1), (53, 1)] }],
  [{ coefficient := 1, powers := [(21, 1), (28, 1), (53, 1)] }, { coefficient := -2, powers := [(24, 1), (53, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(18, 1), (25, 1), (47, 1), (60, 1)] }],
  [{ coefficient := -2, powers := [(8, 1), (59, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(13, 1), (24, 1), (26, 1)] }],
  [{ coefficient := 1, powers := [(18, 1), (25, 1), (29, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(19, 1), (21, 1), (29, 1)] }],
  [{ coefficient := 1, powers := [(25, 1), (26, 1), (47, 1), (60, 1)] }],
  [{ coefficient := -1, powers := [(23, 1), (26, 1), (47, 1), (60, 1)] }],
  [{ coefficient := -1, powers := [(25, 1), (28, 1), (47, 1), (60, 1)] }],
  [{ coefficient := -2, powers := [(24, 1), (53, 1), (55, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (32, 1), (60, 1)] }, { coefficient := -1, powers := [(13, 1), (29, 1), (60, 1)] }],
  [{ coefficient := -2, powers := [(8, 1), (24, 1), (43, 1), (55, 1), (58, 1)] }],
  [{ coefficient := -2, powers := [(19, 1), (24, 1), (55, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (29, 1), (60, 1)] }],
  [{ coefficient := 2, powers := [(0, 1), (24, 1), (55, 1)] }, { coefficient := 2, powers := [(20, 1), (24, 1), (55, 1)] }, { coefficient := 1, powers := [(21, 1), (23, 1), (60, 1)] }, { coefficient := 2, powers := [(24, 1), (25, 1), (55, 1)] }, { coefficient := 2, powers := [(24, 1), (40, 1), (62, 1)] }, { coefficient := 2, powers := [(24, 1), (51, 1), (62, 1)] }, { coefficient := 2, powers := [(24, 1), (55, 1), (62, 1)] }, { coefficient := -1, powers := [(24, 1)] }],
  [{ coefficient := 1, powers := [(53, 1)] }],
  [{ coefficient := -1, powers := [(25, 1), (47, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(19, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (24, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (29, 1)] }],
  [{ coefficient := 1, powers := [(25, 1), (47, 1), (53, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(13, 1)] }],
  [{ coefficient := -2, powers := [(8, 1), (24, 1), (55, 1), (59, 1)] }],
  [{ coefficient := 2, powers := [(8, 1), (24, 1), (55, 1), (58, 1)] }],
  [{ coefficient := -1, powers := [(21, 1), (60, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := -1, powers := [(5, 1), (29, 1), (59, 1)] }, { coefficient := -1, powers := [(8, 1), (32, 1), (47, 1)] }],
  [{ coefficient := 1, powers := [(21, 1), (43, 1), (53, 1), (60, 1)] }, { coefficient := -1, powers := [(25, 1), (26, 1), (45, 1), (47, 1), (49, 1), (60, 1)] }, { coefficient := -1, powers := [(25, 1), (36, 1), (47, 1), (53, 1), (58, 1), (60, 1)] }, { coefficient := 1, powers := [(38, 1), (59, 1)] }],
  [{ coefficient := -2, powers := [(8, 1), (24, 1), (59, 1)] }, { coefficient := 2, powers := [(19, 1), (24, 1), (25, 1), (53, 1), (55, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (19, 1), (29, 1), (55, 1)] }, { coefficient := -1, powers := [(0, 1), (19, 1), (29, 1), (60, 1)] }, { coefficient := 1, powers := [(8, 1), (35, 1)] }, { coefficient := -1, powers := [(18, 1), (25, 1), (29, 1), (43, 1), (60, 1)] }, { coefficient := 1, powers := [(19, 1), (29, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (13, 1), (24, 1), (40, 1)] }, { coefficient := -2, powers := [(0, 1), (13, 1), (24, 1), (55, 1)] }, { coefficient := 1, powers := [(2, 1), (41, 1)] }, { coefficient := 1, powers := [(5, 1), (32, 1)] }, { coefficient := -2, powers := [(13, 1), (20, 1), (24, 1), (55, 1)] }, { coefficient := -2, powers := [(13, 1), (24, 1), (25, 1), (55, 1)] }, { coefficient := -2, powers := [(13, 1), (24, 1), (40, 1), (62, 1)] }, { coefficient := -2, powers := [(13, 1), (24, 1), (51, 1), (62, 1)] }, { coefficient := -2, powers := [(13, 1), (24, 1), (55, 1), (62, 1)] }, { coefficient := 2, powers := [(13, 1), (24, 1)] }]
]
...
#print axioms Krenn.Component20.SelectedLeafB4_6_2.selectedHasNoCommonZero

end Krenn.Component20.SelectedLeafB4_6_2
