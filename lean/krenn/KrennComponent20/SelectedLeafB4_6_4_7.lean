...
namespace Krenn.Component20.SelectedLeafB4_6_4_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "af2b27a90feb83517954915bc042ea4b8cd0cb7da61293e13877a7a615b53629"
def certificateSHA256 : String := "0ea1b93b4f29bee9520508b4c242dabd2a0c918e3fe315663a098e9be34b3cbb"
...
def multipliers : Fin 19 → SparsePoly (Fin 67) := ![
  [{ coefficient := -1, powers := [(27, 1), (45, 1), (61, 1), (62, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (16, 1), (27, 1), (60, 1), (66, 1)] }, { coefficient := 1, powers := [(7, 1), (34, 1), (66, 1)] }, { coefficient := 1, powers := [(10, 1), (27, 1), (45, 1), (61, 1), (62, 1), (66, 1)] }, { coefficient := 1, powers := [(11, 1), (25, 1), (27, 1), (60, 1), (66, 1)] }, { coefficient := -1, powers := [(16, 1), (25, 1), (27, 1), (60, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(51, 1)] }],
  [{ coefficient := 1, powers := [(45, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (27, 1), (60, 1), (66, 1)] }, { coefficient := 1, powers := [(6, 1), (20, 1), (27, 1), (58, 1), (60, 1), (66, 1)] }, { coefficient := 1, powers := [(6, 1), (25, 1), (27, 1), (58, 1), (60, 1), (66, 1)] }, { coefficient := 1, powers := [(20, 1), (27, 1), (60, 1), (66, 1)] }, { coefficient := 1, powers := [(20, 1), (34, 1), (37, 1), (66, 1)] }, { coefficient := 2, powers := [(22, 1), (25, 1), (51, 1), (66, 1)] }, { coefficient := -1, powers := [(22, 1), (66, 1)] }, { coefficient := 1, powers := [(25, 1), (27, 1), (60, 1), (66, 1)] }, { coefficient := 1, powers := [(25, 1), (34, 1), (37, 1), (66, 1)] }],
  ...
  [{ coefficient := -1, powers := [(27, 1), (45, 1), (61, 1), (65, 1)] }],
  ...
  [{ coefficient := 1, powers := [(27, 1), (45, 1), (50, 1), (61, 1), (65, 1)] }, { coefficient := 1, powers := [(37, 1), (58, 1)] }, { coefficient := -1, powers := [(45, 1), (51, 1)] }],
  [{ coefficient := 1, powers := [(7, 1), (27, 1), (34, 1), (45, 1), (65, 1)] }, { coefficient := 1, powers := [(16, 1), (27, 1), (45, 1)] }],
  [{ coefficient := -1, powers := [(10, 1), (27, 1), (45, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(1, 1), (27, 1), (39, 1), (45, 1), (61, 1), (65, 1)] }, { coefficient := 1, powers := [(1, 1), (40, 1)] }, { coefficient := 1, powers := [(4, 1), (31, 1)] }, { coefficient := -1, powers := [(16, 1), (22, 1)] }],
...
#print axioms Krenn.Component20.SelectedLeafB4_6_4_7.selectedHasNoCommonZero

end Krenn.Component20.SelectedLeafB4_6_4_7
