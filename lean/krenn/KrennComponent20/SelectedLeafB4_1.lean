...
namespace Krenn.Component20.SelectedLeafB4_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "eac4c69d43011a199db4ba26dd628918860e5e7c104209509ba924eccad03aa7"
def certificateSHA256 : String := "7963fb917bad005b2eecf590f8349a73da62cafa788dba6555f481e8ebb37d60"

set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedSourceIndices : Fin 32 → Fin 642 := ![
  9,
  16,
  27,
  33,
...
def multipliers : Fin 32 → SparsePoly (Fin 62) := ![
  ...
  [{ coefficient := -1, powers := [(8, 1), (22, 1), (35, 1), (41, 1), (51, 1), (61, 1)] }, { coefficient := -1, powers := [(8, 1), (22, 1), (35, 1), (41, 1), (55, 1), (61, 1)] }, { coefficient := -1, powers := [(8, 1), (27, 1), (35, 1), (41, 1), (45, 1), (61, 1)] }, { coefficient := -1, powers := [(8, 1), (34, 1), (35, 1), (37, 1), (41, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(6, 1), (11, 1), (18, 1), (35, 1), (41, 1), (51, 1)] }, { coefficient := -1, powers := [(7, 1), (18, 1), (35, 1), (41, 1)] }],
  [{ coefficient := -1, powers := [(4, 1), (8, 1), (35, 1), (41, 1), (46, 1), (58, 1), (61, 1)] }],
  [{ coefficient := 2, powers := [(20, 1), (29, 1), (47, 1)] }],
  [{ coefficient := -1, powers := [(28, 1), (53, 1)] }],
  [{ coefficient := 1, powers := [(21, 1), (28, 1), (53, 1)] }],
  [{ coefficient := 1, powers := [(4, 1), (8, 1), (35, 1), (41, 1), (58, 1), (61, 1)] }],
  ...
  [{ coefficient := -1, powers := [(0, 1), (5, 1), (32, 1), (43, 1), (52, 1)] }, { coefficient := -1, powers := [(0, 1), (5, 1), (32, 1), (56, 1)] }, { coefficient := 1, powers := [(0, 1), (13, 1), (24, 1), (56, 1)] }, { coefficient := 1, powers := [(1, 1), (8, 1), (35, 1), (41, 1), (55, 1)] }, { coefficient := -1, powers := [(5, 1), (20, 1), (32, 1), (43, 1), (52, 1)] }, { coefficient := -1, powers := [(5, 1), (26, 1), (32, 1), (43, 1)] }, { coefficient := -1, powers := [(8, 1), (11, 1), (27, 1), (35, 1), (41, 1)] }, { coefficient := 2, powers := [(13, 1), (20, 1), (29, 1), (47, 1)] }, { coefficient := 1, powers := [(13, 1), (24, 1), (26, 1), (43, 1)] }, { coefficient := 1, powers := [(13, 1), (26, 1), (28, 1), (47, 1)] }, { coefficient := -1, powers := [(19, 1), (21, 1), (28, 1), (53, 1)] }, { coefficient := 1, powers := [(19, 1), (24, 1), (25, 1), (53, 1)] }, { coefficient := -1, powers := [(19, 1), (25, 1), (32, 1), (38, 1)] }],
  [{ coefficient := -1, powers := [(4, 1), (8, 1), (27, 1), (35, 1), (41, 1), (58, 1)] }, { coefficient := 1, powers := [(8, 1), (16, 1), (22, 1), (35, 1), (41, 1), (51, 1)] }, { coefficient := 1, powers := [(8, 1), (16, 1), (22, 1), (35, 1), (41, 1), (55, 1)] }, { coefficient := 1, powers := [(8, 1), (16, 1), (27, 1), (35, 1), (41, 1), (45, 1)] }, { coefficient := 1, powers := [(8, 1), (16, 1), (34, 1), (35, 1), (37, 1), (41, 1)] }]
]
...
#print axioms Krenn.Component20.SelectedLeafB4_1.selectedHasNoCommonZero

end Krenn.Component20.SelectedLeafB4_1
