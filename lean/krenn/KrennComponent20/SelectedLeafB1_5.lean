...
namespace Krenn.Component20.SelectedLeafB1_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "033ac70a642cbc8f2b65a7e5a069d3079e69ec22d9d8d437eba4aa36a1e39048"
...
def multipliers : Fin 9 → SparsePoly (Fin 63) := ![
  [{ coefficient := -1, powers := [(21, 1), (25, 1), (55, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(21, 1), (55, 1), (62, 1)] }, { coefficient := -1, powers := [(46, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(21, 1), (55, 2), (62, 1)] }, { coefficient := 1, powers := [(46, 1), (55, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(49, 1), (55, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(62, 1)] }],
  [{ coefficient := 1, powers := [(21, 1), (49, 1), (55, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(21, 1), (45, 1), (49, 1), (55, 1), (62, 1)] }, { coefficient := -1, powers := [(21, 1), (49, 1), (55, 2), (62, 1)] }, { coefficient := -1, powers := [(41, 1), (55, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(21, 1), (25, 1), (49, 1), (55, 1), (62, 1)] }],
...
#print axioms Krenn.Component20.SelectedLeafB1_5.selectedHasNoCommonZero

end Krenn.Component20.SelectedLeafB1_5
