...
namespace Krenn.Component20.SelectedLeafB4_2_0_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "f080ba2095aba5bbac5737163096e7ec9a28f23222045c57e70bce8d1f48f8cf"
def certificateSHA256 : String := "c6f4cb20bcd0b80188726c4407978707859a6bb3a2dd3c008518aee2c821de42"
...
def multipliers : Fin 19 → SparsePoly (Fin 65) := ![
  ...
  [{ coefficient := -2, powers := [(6, 1), (21, 1), (29, 1), (51, 1), (59, 1), (63, 1)] }],
  [{ coefficient := -2, powers := [(6, 1), (18, 1), (29, 1), (59, 1), (63, 1)] }, { coefficient := -2, powers := [(8, 1), (28, 1), (59, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (32, 1), (63, 1)] }, { coefficient := -1, powers := [(18, 1), (28, 1), (53, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(19, 1), (24, 1), (52, 1), (63, 1)] }],
...
#print axioms Krenn.Component20.SelectedLeafB4_2_0_7.selectedHasNoCommonZero

end Krenn.Component20.SelectedLeafB4_2_0_7
