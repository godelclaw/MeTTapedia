...
namespace Krenn.Component20.SelectedLeafB4_0_2_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "db7869a160233e4e0021d33d6bd65aabda53594875e2d9a079a09918819d4503"
...
def multipliers : Fin 25 → SparsePoly (Fin 65) := ![
  ...
  [{ coefficient := 1, powers := [(4, 1), (21, 1), (27, 1), (35, 1), (51, 1), (53, 1), (63, 1)] }, { coefficient := 1, powers := [(4, 1), (21, 1), (27, 1), (35, 1), (53, 1), (55, 1), (63, 1)] }, { coefficient := -1, powers := [(7, 1), (21, 1), (22, 1), (35, 1), (51, 1), (53, 1), (63, 1)] }, { coefficient := -1, powers := [(7, 1), (21, 1), (22, 1), (35, 1), (53, 1), (55, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (11, 1), (35, 1), (55, 1)] }],
  [{ coefficient := 1, powers := [(4, 1), (18, 1), (27, 1), (35, 1), (53, 1), (63, 1)] }, { coefficient := -1, powers := [(4, 1), (18, 1), (35, 1), (53, 1)] }, { coefficient := -1, powers := [(7, 1), (18, 1), (22, 1), (35, 1), (53, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (32, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (11, 1), (27, 1), (35, 1), (53, 1), (64, 1)] }, { coefficient := -1, powers := [(5, 1), (16, 1), (27, 1), (35, 1), (53, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(32, 1), (38, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (35, 1), (53, 1), (55, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (35, 1), (45, 1), (53, 1)] }],
  [{ coefficient := 1, powers := [(29, 1)] }],
  [{ coefficient := 1, powers := [(24, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (27, 1), (35, 1), (53, 1), (64, 1)] }],
  ...
  [{ coefficient := 1, powers := [(1, 1), (5, 1), (35, 1), (53, 1), (55, 1)] }, { coefficient := 1, powers := [(5, 1), (7, 1), (34, 1), (35, 1), (53, 1)] }, { coefficient := 1, powers := [(5, 1), (11, 1), (27, 1), (29, 1), (35, 1), (53, 1), (64, 1)] }, { coefficient := -1, powers := [(19, 1), (25, 1), (32, 1), (38, 1)] }],
...
#print axioms Krenn.Component20.SelectedLeafB4_0_2_7.selectedHasNoCommonZero

end Krenn.Component20.SelectedLeafB4_0_2_7
