...
namespace Krenn.Component20.SelectedLeafB1_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "3ca9e66f2ff808720e713b6d4c347ebea8f471b0de4a8f8783b66022b2b20fce"
...
def multipliers : Fin 10 → SparsePoly (Fin 63) := ![
  [{ coefficient := 1, powers := [(18, 1), (25, 1), (41, 1), (60, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(21, 1), (62, 1)] }, { coefficient := -1, powers := [(25, 1), (46, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(46, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(46, 1), (55, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(25, 1), (41, 1), (60, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(62, 1)] }],
  [{ coefficient := 1, powers := [(45, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(41, 1), (55, 1), (62, 1)] }, { coefficient := -1, powers := [(45, 1), (46, 1), (49, 1), (62, 1)] }, { coefficient := -1, powers := [(46, 1), (49, 1), (55, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(25, 1), (41, 1), (45, 1), (62, 1)] }],
...
#print axioms Krenn.Component20.SelectedLeafB1_3.selectedHasNoCommonZero

end Krenn.Component20.SelectedLeafB1_3
