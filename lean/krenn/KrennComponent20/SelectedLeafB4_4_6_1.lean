...
namespace Krenn.Component20.SelectedLeafB4_4_6_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "5545d447cee73da24a6a9cd45913bf1c1d1651101ce1912a35b6c03760eb501d"
...
def multipliers : Fin 17 → SparsePoly (Fin 65) := ![
  ...
  [{ coefficient := -1, powers := [(0, 1), (4, 1), (31, 1), (55, 1), (64, 1)] }, { coefficient := 1, powers := [(6, 1), (11, 1), (31, 1), (55, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(51, 1)] }],
  [{ coefficient := 1, powers := [(45, 1)] }],
  [{ coefficient := -1, powers := [(6, 1), (31, 1), (55, 1), (64, 1)] }, { coefficient := 1, powers := [(20, 1), (34, 1), (37, 1), (64, 1)] }, { coefficient := -1, powers := [(22, 1), (64, 1)] }],
  ...
  [{ coefficient := -1, powers := [(0, 1), (4, 1), (25, 1), (31, 1), (55, 1), (60, 1)] }, { coefficient := 1, powers := [(0, 1), (4, 1), (29, 1), (31, 1), (55, 1), (64, 1)] }, { coefficient := 1, powers := [(1, 1), (55, 1)] }, { coefficient := -1, powers := [(6, 1), (11, 1), (29, 1), (31, 1), (55, 1), (64, 1)] }, { coefficient := 1, powers := [(6, 1), (16, 1), (29, 1), (31, 1), (55, 1), (64, 1)] }, { coefficient := 1, powers := [(7, 1), (34, 1)] }, { coefficient := -1, powers := [(16, 1), (20, 1), (25, 1), (34, 1), (37, 1), (51, 1)] }, { coefficient := -1, powers := [(16, 1), (20, 1), (29, 1), (34, 1), (37, 1), (64, 1)] }, { coefficient := 1, powers := [(16, 1), (20, 1), (34, 1), (37, 1)] }, { coefficient := 2, powers := [(16, 1), (22, 1), (25, 1), (51, 1)] }, { coefficient := 1, powers := [(16, 1), (22, 1), (25, 1), (55, 1)] }, { coefficient := 1, powers := [(16, 1), (22, 1), (29, 1), (64, 1)] }, { coefficient := -1, powers := [(16, 1), (22, 1)] }, { coefficient := 1, powers := [(16, 1), (25, 1), (34, 1), (37, 1)] }],
...
#print axioms Krenn.Component20.SelectedLeafB4_4_6_1.selectedHasNoCommonZero

end Krenn.Component20.SelectedLeafB4_4_6_1
