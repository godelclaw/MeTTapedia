...
namespace Krenn.Component20.SelectedLeafB4_2_4_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "47f96cecfe7ee1c52f0928820db8fc3fa414ffc7a269f7dd3b05be5a9cbe2046"
...
def multipliers : Fin 19 → SparsePoly (Fin 65) := ![
  ...
  [{ coefficient := -1, powers := [(0, 1), (16, 1), (27, 1), (60, 1), (64, 1)] }, { coefficient := 1, powers := [(7, 1), (20, 1), (34, 1), (60, 1), (64, 1)] }, { coefficient := 1, powers := [(7, 1), (34, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(51, 1)] }],
  [{ coefficient := 1, powers := [(45, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (27, 1), (60, 1), (64, 1)] }, { coefficient := 1, powers := [(3, 1), (34, 1), (60, 1), (64, 1)] }, { coefficient := 1, powers := [(6, 1), (20, 1), (27, 1), (58, 1), (60, 1), (64, 1)] }, { coefficient := -1, powers := [(6, 1), (34, 1), (60, 1), (64, 1)] }, { coefficient := 1, powers := [(20, 1), (27, 1), (60, 1), (64, 1)] }, { coefficient := -1, powers := [(22, 1), (64, 1)] }, { coefficient := -1, powers := [(34, 1), (36, 1), (51, 1), (64, 1)] }],
...
#print axioms Krenn.Component20.SelectedLeafB4_2_4_3.selectedHasNoCommonZero

end Krenn.Component20.SelectedLeafB4_2_4_3
