...
namespace Krenn.Component20.SelectedLeafB4_0_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "b3e54cdb31f10aa786779c3a503adcd97bbc47847261c82135769e02ac02c989"
...
def multipliers : Fin 5 → SparsePoly (Fin 62) := ![
  [{ coefficient := 1, powers := [(0, 1), (52, 1), (61, 1)] }, { coefficient := 1, powers := [(20, 1), (52, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(52, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(61, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (43, 1), (52, 1), (61, 1)] }, { coefficient := -1, powers := [(0, 1), (56, 1), (61, 1)] }, { coefficient := -1, powers := [(20, 1), (43, 1), (52, 1), (61, 1)] }, { coefficient := -1, powers := [(26, 1), (43, 1), (61, 1)] }],
...
#print axioms Krenn.Component20.SelectedLeafB4_0_1.selectedHasNoCommonZero

end Krenn.Component20.SelectedLeafB4_0_1
