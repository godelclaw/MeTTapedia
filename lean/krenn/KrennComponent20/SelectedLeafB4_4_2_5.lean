...
namespace Krenn.Component20.SelectedLeafB4_4_2_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "581a499e62e18ad5ffc7824156bbe6d78c9dc003f5a26a8cd566692e29f2e520"
def certificateSHA256 : String := "eb4ab5eb06d95d26274bc86bcb1bbe4d9e038982475a46769ed55977d0012581"
...
def selectedEquations : Fin 27 → SparsePoly (Fin 65) := ![
  ...
  [{ coefficient := 1, powers := [(25, 1), (63, 1)] }, { coefficient := -1, powers := [] }],
...
def multipliers : Fin 27 → SparsePoly (Fin 65) := ![
  ...
  [{ coefficient := -1, powers := [(35, 1), (38, 1), (49, 1), (60, 1)] }, { coefficient := -1, powers := [(35, 1), (38, 1), (49, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (20, 1), (35, 1), (53, 1), (64, 1)] }],
  ...
  [{ coefficient := 1, powers := [(1, 1), (8, 1), (32, 1), (47, 1), (55, 1)] }, { coefficient := -1, powers := [(5, 1), (20, 1), (29, 1), (35, 1), (53, 1), (64, 1)] }, { coefficient := -1, powers := [(8, 1), (11, 1), (27, 1), (32, 1), (47, 1)] }, { coefficient := 1, powers := [(8, 1), (16, 1), (27, 1), (32, 1), (47, 1)] }, { coefficient := -1, powers := [(19, 1), (25, 1), (32, 1), (38, 1)] }],
...
#print axioms Krenn.Component20.SelectedLeafB4_4_2_5.selectedHasNoCommonZero

end Krenn.Component20.SelectedLeafB4_4_2_5
