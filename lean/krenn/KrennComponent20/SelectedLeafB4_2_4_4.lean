...
namespace Krenn.Component20.SelectedLeafB4_2_4_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "e3bcaa62875e411535fff2221f23e54e35d6392c01fcb7ccf1646b1be8f59a72"
def certificateSHA256 : String := "38b232fdab954391e57f3d597c87336d173f510e047e1ba0bfa4d609efadd107"

set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedSourceIndices : Fin 18 → Fin 648 := ![
  184,
  186,
  188,
  189,
...
def multipliers : Fin 18 → SparsePoly (Fin 64) := ![
  ...
  [{ coefficient := -2, powers := [(24, 1), (53, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(18, 1), (47, 1)] }],
  [{ coefficient := -1, powers := [(18, 1), (53, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (20, 1), (53, 1)] }, { coefficient := 2, powers := [(19, 1), (53, 1), (61, 1)] }],
  ...
  [{ coefficient := 1, powers := [(19, 1), (20, 1), (24, 1), (53, 1)] }, { coefficient := -2, powers := [(19, 1), (24, 1), (53, 1), (61, 1)] }],
...
#print axioms Krenn.Component20.SelectedLeafB4_2_4_4.selectedHasNoCommonZero

end Krenn.Component20.SelectedLeafB4_2_4_4
