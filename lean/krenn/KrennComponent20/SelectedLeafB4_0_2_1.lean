...
namespace Krenn.Component20.SelectedLeafB4_0_2_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "d8718632db37b4727b45c24ff897a90d8aedb05debec3956320b77f37b6fce9b"
def certificateSHA256 : String := "edbfc5547984ada3b34d04011daa7d2825eb4c652dc78aa4eea040203d83b67b"
...
def multipliers : Fin 17 → SparsePoly (Fin 63) := ![
  ...
  [{ coefficient := -1, powers := [(0, 1), (4, 1), (31, 1), (55, 1), (62, 1)] }, { coefficient := 1, powers := [(6, 1), (11, 1), (31, 1), (55, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(51, 1)] }],
  [{ coefficient := 1, powers := [(45, 1)] }],
  [{ coefficient := -1, powers := [(6, 1), (31, 1), (55, 1), (62, 1)] }, { coefficient := 1, powers := [(20, 1), (34, 1), (37, 1), (62, 1)] }, { coefficient := -1, powers := [(22, 1), (62, 1)] }],
  ...
  [{ coefficient := -1, powers := [(0, 1), (4, 1), (25, 1), (31, 1), (55, 1), (60, 1)] }, { coefficient := 1, powers := [(0, 1), (4, 1), (29, 1), (31, 1), (55, 1), (62, 1)] }, { coefficient := 1, powers := [(1, 1), (55, 1)] }, { coefficient := -1, powers := [(6, 1), (11, 1), (29, 1), (31, 1), (55, 1), (62, 1)] }, { coefficient := 1, powers := [(6, 1), (16, 1), (29, 1), (31, 1), (55, 1), (62, 1)] }, { coefficient := 1, powers := [(7, 1), (34, 1)] }, { coefficient := -1, powers := [(16, 1), (20, 1), (25, 1), (34, 1), (37, 1), (51, 1)] }, { coefficient := -1, powers := [(16, 1), (20, 1), (29, 1), (34, 1), (37, 1), (62, 1)] }, { coefficient := 1, powers := [(16, 1), (20, 1), (34, 1), (37, 1)] }, { coefficient := 2, powers := [(16, 1), (22, 1), (25, 1), (51, 1)] }, { coefficient := 1, powers := [(16, 1), (22, 1), (25, 1), (55, 1)] }, { coefficient := 1, powers := [(16, 1), (22, 1), (29, 1), (62, 1)] }, { coefficient := -1, powers := [(16, 1), (22, 1)] }, { coefficient := 1, powers := [(16, 1), (25, 1), (34, 1), (37, 1)] }],
...
#print axioms Krenn.Component20.SelectedLeafB4_0_2_1.selectedHasNoCommonZero

end Krenn.Component20.SelectedLeafB4_0_2_1
