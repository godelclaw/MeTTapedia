...
namespace Krenn.Component20.SelectedLeafB4_2_4_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "c9748af3d1bbaf6030e98d50e5800f865bae1ab7c6966143198e69c5643e0059"
def certificateSHA256 : String := "d015e037d794e4ea96201b6fa1cd9f2024708d0f2216f82891bca6251c976fc5"
...
def multipliers : Fin 23 → SparsePoly (Fin 64) := ![
  [{ coefficient := -1, powers := [(21, 1), (35, 1), (36, 1), (51, 1), (53, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (23, 1), (53, 1), (58, 1), (63, 1)] }, { coefficient := 1, powers := [(5, 1), (28, 1), (53, 1), (58, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(18, 1), (35, 1), (36, 1), (53, 1), (63, 1)] }],
...
#print axioms Krenn.Component20.SelectedLeafB4_2_4_2.selectedHasNoCommonZero

end Krenn.Component20.SelectedLeafB4_2_4_2
