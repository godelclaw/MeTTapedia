...
namespace Krenn.Component20.SelectedLeafB4_4_6_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "42b0d137c81e81b9f963bde4d231b665f22c7097a74f3b44346769a42a404785"
...
def multipliers : Fin 27 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := -1, powers := [(35, 1), (38, 1), (49, 1), (60, 1)] }, { coefficient := -1, powers := [(35, 1), (38, 1), (49, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (20, 1), (35, 1), (53, 1), (65, 1)] }],
  ...
  [{ coefficient := 1, powers := [(1, 1), (8, 1), (32, 1), (47, 1), (55, 1)] }, { coefficient := -1, powers := [(5, 1), (20, 1), (29, 1), (35, 1), (53, 1), (65, 1)] }, { coefficient := -1, powers := [(8, 1), (11, 1), (27, 1), (32, 1), (47, 1)] }, { coefficient := 1, powers := [(8, 1), (16, 1), (27, 1), (32, 1), (47, 1)] }, { coefficient := -1, powers := [(19, 1), (25, 1), (32, 1), (38, 1)] }],
...
#print axioms Krenn.Component20.SelectedLeafB4_4_6_5.selectedHasNoCommonZero

end Krenn.Component20.SelectedLeafB4_4_6_5
