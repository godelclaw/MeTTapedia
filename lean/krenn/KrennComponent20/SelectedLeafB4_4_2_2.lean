...
namespace Krenn.Component20.SelectedLeafB4_4_2_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "a6d3ea49a63ca2eba3114cfd3eec78dea7fdbf0b986f42be68b5d966644b13bb"
def certificateSHA256 : String := "f3ff8c8fdf50c5b4c2fa626230d4d98e3c98b4c9219111b3e65f9d7933b555bf"
...
def multipliers : Fin 26 → SparsePoly (Fin 64) := ![
  [{ coefficient := 2, powers := [(5, 1), (27, 1), (53, 1), (58, 1)] }, { coefficient := 1, powers := [(5, 1), (31, 1), (53, 1), (55, 1)] }, { coefficient := 1, powers := [(5, 1), (34, 1), (51, 1), (53, 1)] }, { coefficient := 1, powers := [(5, 1), (34, 1), (53, 1), (55, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (11, 1), (35, 1), (51, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (11, 1), (31, 1), (53, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (22, 1), (53, 1), (58, 1), (61, 1)] }, { coefficient := 1, powers := [(5, 1), (27, 1), (53, 1), (58, 1), (61, 1)] }, { coefficient := -1, powers := [(5, 1), (31, 1), (53, 1), (55, 1), (61, 1)] }],
  ...
  [{ coefficient := 1, powers := [(5, 1), (35, 1), (45, 1), (53, 1)] }, { coefficient := 1, powers := [(5, 1), (35, 1), (53, 1), (55, 1)] }],
  [{ coefficient := 1, powers := [(24, 1)] }],
  [{ coefficient := 1, powers := [(47, 1)] }],
  [{ coefficient := 1, powers := [(19, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (27, 1), (35, 1), (45, 1), (53, 1)] }, { coefficient := 1, powers := [(5, 1), (27, 1), (35, 1), (51, 1), (53, 1)] }, { coefficient := -1, powers := [(5, 1), (34, 1), (35, 1), (37, 1), (53, 1)] }],
  [{ coefficient := 1, powers := [(13, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (27, 1), (35, 1), (53, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (11, 1), (35, 1), (53, 1)] }, { coefficient := 1, powers := [(5, 1), (16, 1), (35, 1), (53, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (35, 1), (53, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := 1, powers := [(5, 1), (35, 1), (37, 1), (53, 1), (58, 1)] }, { coefficient := 1, powers := [(5, 1), (35, 1), (45, 1), (53, 1), (55, 1)] }, { coefficient := -1, powers := [(5, 1), (35, 1), (51, 1), (53, 1), (55, 1)] }],
  [{ coefficient := 1, powers := [(38, 1), (59, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (7, 1), (22, 1), (35, 1), (53, 1), (58, 1)] }, { coefficient := -1, powers := [(5, 1), (7, 1), (27, 1), (35, 1), (53, 1), (58, 1)] }, { coefficient := 1, powers := [(5, 1), (7, 1), (31, 1), (35, 1), (53, 1), (55, 1)] }],
  [{ coefficient := 1, powers := [(1, 1), (5, 1), (35, 1), (53, 1), (55, 1)] }, { coefficient := 1, powers := [(5, 1), (7, 1), (34, 1), (35, 1), (53, 1)] }, { coefficient := -1, powers := [(5, 1), (11, 1), (27, 1), (35, 1), (53, 1)] }, { coefficient := 1, powers := [(5, 1), (16, 1), (25, 1), (27, 1), (35, 1), (45, 1), (53, 1)] }, { coefficient := -1, powers := [(5, 1), (16, 1), (25, 1), (27, 1), (35, 1), (51, 1), (53, 1)] }, { coefficient := 1, powers := [(5, 1), (16, 1), (25, 1), (34, 1), (35, 1), (37, 1), (53, 1)] }, { coefficient := 1, powers := [(5, 1), (16, 1), (27, 1), (35, 1), (53, 1)] }, { coefficient := 1, powers := [(19, 1), (24, 1), (25, 1), (53, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (35, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (41, 1)] }, { coefficient := 1, powers := [(5, 1), (32, 1)] }, { coefficient := -1, powers := [(13, 1), (24, 1)] }],
  [{ coefficient := 1, powers := [(4, 1), (5, 1), (27, 1), (35, 1), (45, 1), (53, 1), (58, 1)] }, { coefficient := -1, powers := [(4, 1), (5, 1), (27, 1), (35, 1), (51, 1), (53, 1), (58, 1)] }, { coefficient := 1, powers := [(4, 1), (5, 1), (34, 1), (35, 1), (37, 1), (53, 1), (58, 1)] }, { coefficient := 1, powers := [(5, 1), (11, 1), (27, 1), (35, 1), (45, 2), (53, 1)] }, { coefficient := -1, powers := [(5, 1), (11, 1), (27, 1), (35, 1), (45, 1), (51, 1), (53, 1)] }, { coefficient := 1, powers := [(5, 1), (11, 1), (34, 1), (35, 1), (37, 1), (45, 1), (53, 1)] }],
...
#print axioms Krenn.Component20.SelectedLeafB4_4_2_2.selectedHasNoCommonZero

end Krenn.Component20.SelectedLeafB4_4_2_2
