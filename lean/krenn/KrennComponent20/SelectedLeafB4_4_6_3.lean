...
namespace Krenn.Component20.SelectedLeafB4_4_6_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "2469ec744aa0a709f1e2c88e16481593ba7729c4bb8ef6de050ef2cb0e3e56d7"
def certificateSHA256 : String := "01ad20f008a231bf33d3662c46c0c254dd41de2a65c214bb507cfa4fea890575"
...
def multipliers : Fin 16 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := -1, powers := [(0, 1), (4, 1), (31, 1), (55, 1), (65, 1)] }, { coefficient := 1, powers := [(6, 1), (11, 1), (31, 1), (55, 1), (65, 1)] }, { coefficient := -1, powers := [(11, 1), (27, 1), (65, 1)] }, { coefficient := -1, powers := [(16, 1), (27, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(51, 1)] }],
  [{ coefficient := 1, powers := [(45, 1)] }],
  [{ coefficient := -1, powers := [(6, 1), (31, 1), (55, 1), (65, 1)] }, { coefficient := 1, powers := [(20, 1), (34, 1), (37, 1), (65, 1)] }, { coefficient := -1, powers := [(22, 1), (65, 1)] }, { coefficient := 1, powers := [(27, 1), (65, 1)] }],
  ...
  [{ coefficient := -1, powers := [(0, 1), (4, 1), (25, 1), (31, 1), (55, 1), (60, 1)] }, { coefficient := 1, powers := [(0, 1), (4, 1), (29, 1), (31, 1), (55, 1), (65, 1)] }, { coefficient := 1, powers := [(1, 1), (55, 1)] }, { coefficient := -1, powers := [(6, 1), (11, 1), (29, 1), (31, 1), (55, 1), (65, 1)] }, { coefficient := 1, powers := [(6, 1), (16, 1), (29, 1), (31, 1), (55, 1), (65, 1)] }, { coefficient := 1, powers := [(7, 1), (34, 1)] }, { coefficient := 1, powers := [(11, 1), (27, 1), (29, 1), (65, 1)] }, { coefficient := -1, powers := [(16, 1), (20, 1), (25, 1), (34, 1), (37, 1), (51, 1)] }, { coefficient := -1, powers := [(16, 1), (20, 1), (29, 1), (34, 1), (37, 1), (65, 1)] }, { coefficient := 1, powers := [(16, 1), (20, 1), (34, 1), (37, 1)] }, { coefficient := 2, powers := [(16, 1), (22, 1), (25, 1), (51, 1)] }, { coefficient := 1, powers := [(16, 1), (22, 1), (25, 1), (55, 1)] }, { coefficient := 1, powers := [(16, 1), (22, 1), (29, 1), (65, 1)] }, { coefficient := -1, powers := [(16, 1), (22, 1)] }, { coefficient := 1, powers := [(16, 1), (25, 1), (34, 1), (37, 1)] }],
...
#print axioms Krenn.Component20.SelectedLeafB4_4_6_3.selectedHasNoCommonZero

end Krenn.Component20.SelectedLeafB4_4_6_3
