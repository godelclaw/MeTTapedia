...
namespace Krenn.Component20.SelectedLeafB5_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "16fffab919d7beacde50d90b1f202e1345d6dc679cf327442d6b430f6718aa24"
def certificateSHA256 : String := "f29e4a9c5925364a755127f68348b13388109ed0bbbd76fe38204b707a4b237d"
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedEquations : Fin 54 → SparsePoly (Fin 63) := ![
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def multipliers : Fin 54 → SparsePoly (Fin 63) := ![
  [{ coefficient := -1, powers := [(13, 1), (22, 1), (38, 1), (51, 1), (58, 1), (62, 1)] }, { coefficient := 1, powers := [(13, 1), (27, 1), (38, 1), (58, 1)] }, { coefficient := 1, powers := [(13, 1), (31, 1), (38, 1), (55, 1)] }, { coefficient := 1, powers := [(13, 1), (34, 1), (38, 1), (55, 1)] }],
  ...
  [{ coefficient := 1, powers := [(11, 1), (13, 1), (28, 1), (38, 1), (55, 1), (58, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (11, 1), (31, 1), (56, 1)] }],
  [{ coefficient := -1, powers := [(11, 1), (13, 1), (22, 1), (38, 1), (58, 1), (62, 1)] }, { coefficient := -1, powers := [(13, 1), (16, 1), (34, 1), (38, 1)] }],
  [{ coefficient := 1, powers := [(18, 1), (20, 1), (56, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (21, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (29, 1), (58, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (29, 1), (40, 1), (58, 1), (62, 1)] }, { coefficient := 1, powers := [(5, 1), (29, 1), (51, 1), (58, 1), (62, 1)] }, { coefficient := -1, powers := [(5, 1), (29, 1), (58, 1)] }],
  [{ coefficient := -2, powers := [(24, 1), (53, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (6, 1), (18, 1), (29, 1), (58, 1), (59, 1), (61, 1), (62, 1)] }, { coefficient := 1, powers := [(5, 1), (11, 1), (18, 1), (22, 1), (32, 1), (56, 1), (61, 1)] }, { coefficient := 1, powers := [(5, 1), (16, 1), (18, 1), (27, 1), (32, 1), (56, 1), (61, 1)] }, { coefficient := -1, powers := [(5, 1), (18, 1), (20, 1), (29, 1), (59, 1), (61, 1)] }, { coefficient := 2, powers := [(8, 1), (18, 1), (24, 1), (59, 1), (61, 1), (62, 1)] }, { coefficient := 2, powers := [(11, 1), (13, 1), (18, 1), (28, 1), (34, 1), (38, 1), (43, 1), (55, 1), (61, 1)] }, { coefficient := 2, powers := [(13, 1), (18, 1), (24, 1), (56, 1), (61, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(18, 1), (47, 1)] }],
  [{ coefficient := -1, powers := [(18, 1), (53, 1)] }],
  [{ coefficient := -2, powers := [(2, 1), (18, 1), (20, 1), (38, 1), (59, 1), (61, 1)] }, { coefficient := -2, powers := [(2, 1), (18, 1), (25, 1), (38, 1), (59, 1), (61, 1)] }, { coefficient := 1, powers := [(11, 1), (13, 1), (18, 1), (23, 1), (34, 1), (38, 1), (43, 1), (55, 1), (61, 1)] }, { coefficient := -1, powers := [(11, 1), (13, 1), (18, 1), (31, 1), (35, 1), (36, 1), (38, 1), (55, 1), (61, 1)] }, { coefficient := -1, powers := [(11, 1), (13, 1), (34, 1), (38, 1), (43, 1), (55, 1)] }, { coefficient := 1, powers := [(13, 1), (16, 1), (18, 1), (27, 1), (35, 1), (38, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (29, 1), (49, 1), (58, 1), (62, 1)] }, { coefficient := 2, powers := [(11, 1), (13, 1), (28, 1), (34, 1), (38, 1), (55, 1)] }, { coefficient := 1, powers := [(13, 1), (21, 1), (29, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (26, 1), (60, 1)] }, { coefficient := 1, powers := [(18, 1), (29, 1)] }],
  [{ coefficient := -2, powers := [(2, 1), (21, 1), (45, 1)] }, { coefficient := -1, powers := [(2, 1), (21, 1), (60, 1)] }, { coefficient := 1, powers := [(18, 1), (24, 1)] }],
  [{ coefficient := 1, powers := [(19, 1), (21, 1), (29, 1)] }],
  [{ coefficient := -1, powers := [(11, 1), (13, 1), (22, 1), (38, 1), (55, 1), (58, 1), (62, 1)] }, { coefficient := -1, powers := [(11, 1), (13, 1), (34, 1), (38, 1), (55, 1)] }],
  [{ coefficient := -1, powers := [(29, 1), (47, 1)] }],
  [{ coefficient := -1, powers := [(18, 1), (24, 1), (56, 1)] }],
  [{ coefficient := -2, powers := [(2, 1), (38, 1), (43, 1), (45, 1), (58, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (32, 1), (51, 1), (56, 1)] }, { coefficient := -1, powers := [(13, 1), (35, 1), (38, 1), (55, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (32, 1), (40, 1), (56, 1)] }, { coefficient := -1, powers := [(5, 1), (32, 1), (45, 1), (56, 1)] }, { coefficient := -1, powers := [(5, 1), (32, 1), (55, 1), (56, 1)] }, { coefficient := 1, powers := [(13, 1), (35, 1), (38, 1), (45, 1)] }],
  [{ coefficient := 2, powers := [(2, 1), (20, 1), (38, 1), (59, 1), (61, 1)] }, { coefficient := 2, powers := [(2, 1), (25, 1), (38, 1), (59, 1), (61, 1)] }, { coefficient := -1, powers := [(11, 1), (13, 1), (23, 1), (34, 1), (38, 1), (43, 1), (55, 1), (61, 1)] }, { coefficient := 1, powers := [(11, 1), (13, 1), (31, 1), (35, 1), (36, 1), (38, 1), (55, 1), (61, 1)] }, { coefficient := -1, powers := [(13, 1), (16, 1), (27, 1), (35, 1), (38, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (6, 1), (29, 1), (58, 1), (59, 1), (61, 1), (62, 1)] }, { coefficient := -1, powers := [(5, 1), (11, 1), (22, 1), (32, 1), (56, 1), (61, 1)] }, { coefficient := -1, powers := [(5, 1), (16, 1), (27, 1), (32, 1), (56, 1), (61, 1)] }, { coefficient := 1, powers := [(5, 1), (20, 1), (29, 1), (59, 1), (61, 1)] }, { coefficient := -2, powers := [(8, 1), (24, 1), (59, 1), (61, 1), (62, 1)] }, { coefficient := -2, powers := [(11, 1), (13, 1), (28, 1), (34, 1), (38, 1), (43, 1), (55, 1), (61, 1)] }, { coefficient := -2, powers := [(13, 1), (24, 1), (56, 1), (61, 1), (62, 1)] }],
  ...
  [{ coefficient := 2, powers := [(24, 1), (40, 1), (62, 1)] }, { coefficient := 2, powers := [(24, 1), (51, 1), (62, 1)] }, { coefficient := -1, powers := [(24, 1)] }],
  [{ coefficient := -2, powers := [(2, 1), (47, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (29, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (31, 1), (56, 1)] }],
  [{ coefficient := 1, powers := [(13, 1), (22, 1), (38, 1), (58, 1), (62, 1)] }, { coefficient := 1, powers := [(13, 1), (34, 1), (38, 1)] }],
  [{ coefficient := 1, powers := [(53, 1)] }],
  [{ coefficient := 1, powers := [(47, 1)] }],
  [{ coefficient := -1, powers := [(11, 1), (13, 1), (35, 1), (38, 1), (45, 1), (55, 1)] }],
  [{ coefficient := 1, powers := [(11, 1), (13, 1), (34, 1), (38, 1), (45, 1), (55, 1)] }],
  [{ coefficient := 1, powers := [(19, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (29, 1)] }],
  [{ coefficient := 1, powers := [(11, 1), (13, 1), (35, 1), (38, 1), (55, 1)] }],
  ...
  [{ coefficient := 1, powers := [(5, 1), (11, 1), (32, 1), (56, 1)] }, { coefficient := 1, powers := [(13, 1), (16, 1), (35, 1), (38, 1)] }],
  [{ coefficient := -2, powers := [(2, 1), (38, 1), (45, 1), (59, 1)] }],
  [{ coefficient := 2, powers := [(2, 1), (38, 1), (45, 1), (58, 1)] }],
  [{ coefficient := 2, powers := [(2, 1), (45, 1)] }, { coefficient := 1, powers := [(2, 1), (60, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (32, 1), (56, 1)] }, { coefficient := -1, powers := [(13, 1), (35, 1), (38, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := -1, powers := [(2, 1), (38, 1), (59, 1)] }, { coefficient := -1, powers := [(2, 1), (47, 1), (53, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (32, 1), (37, 1), (56, 1), (58, 1)] }, { coefficient := 1, powers := [(5, 1), (32, 1), (40, 1), (51, 1), (56, 1)] }, { coefficient := 1, powers := [(5, 1), (32, 1), (40, 1), (55, 1), (56, 1)] }, { coefficient := 1, powers := [(5, 1), (32, 1), (45, 1), (51, 1), (56, 1)] }, { coefficient := 1, powers := [(5, 1), (32, 1), (51, 1), (55, 1), (56, 1)] }, { coefficient := 1, powers := [(13, 1), (35, 1), (37, 1), (38, 1), (58, 1)] }, { coefficient := 1, powers := [(13, 1), (35, 1), (38, 1), (40, 1), (55, 1)] }, { coefficient := 1, powers := [(13, 1), (35, 1), (38, 1), (45, 1), (55, 1)] }],
  [{ coefficient := -2, powers := [(2, 1), (20, 1), (38, 1), (45, 1), (59, 1)] }, { coefficient := -2, powers := [(2, 1), (25, 1), (38, 1), (45, 1), (59, 1)] }, { coefficient := 1, powers := [(5, 1), (6, 1), (29, 1), (51, 1), (58, 1), (59, 1), (62, 1)] }, { coefficient := 1, powers := [(5, 1), (11, 1), (22, 1), (32, 1), (51, 1), (56, 1)] }, { coefficient := 1, powers := [(5, 1), (16, 1), (27, 1), (32, 1), (51, 1), (56, 1)] }, { coefficient := -1, powers := [(5, 1), (20, 1), (29, 1), (51, 1), (59, 1)] }, { coefficient := 2, powers := [(8, 1), (24, 1), (51, 1), (59, 1), (62, 1)] }, { coefficient := 1, powers := [(11, 1), (13, 1), (23, 1), (34, 1), (38, 1), (43, 1), (45, 1), (55, 1)] }, { coefficient := 2, powers := [(11, 1), (13, 1), (28, 1), (34, 1), (38, 1), (43, 1), (51, 1), (55, 1)] }, { coefficient := -1, powers := [(11, 1), (13, 1), (31, 1), (35, 1), (36, 1), (38, 1), (45, 1), (55, 1)] }, { coefficient := 1, powers := [(13, 1), (16, 1), (27, 1), (35, 1), (38, 1), (45, 1)] }, { coefficient := 2, powers := [(13, 1), (24, 1), (51, 1), (56, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (6, 1), (29, 1), (58, 1), (59, 1)] }, { coefficient := 1, powers := [(6, 1), (11, 1), (13, 1), (22, 1), (35, 1), (38, 1), (55, 1), (58, 1)] }, { coefficient := -1, powers := [(7, 1), (13, 1), (22, 1), (35, 1), (38, 1), (58, 1)] }, { coefficient := -2, powers := [(8, 1), (24, 1), (59, 1)] }, { coefficient := 1, powers := [(11, 1), (13, 1), (22, 1), (28, 1), (38, 1), (43, 1), (55, 1), (58, 1)] }, { coefficient := -2, powers := [(13, 1), (24, 1), (56, 1)] }],
  [{ coefficient := -2, powers := [(0, 1), (2, 1), (45, 1), (56, 1)] }, { coefficient := -1, powers := [(0, 1), (2, 1), (56, 1), (60, 1)] }, { coefficient := 1, powers := [(0, 1), (19, 1), (29, 1), (45, 1)] }, { coefficient := 1, powers := [(0, 1), (19, 1), (29, 1), (55, 1)] }, { coefficient := -2, powers := [(2, 1), (26, 1), (43, 1), (45, 1)] }, { coefficient := 1, powers := [(2, 1), (56, 1)] }, { coefficient := 1, powers := [(3, 1), (19, 1), (29, 1), (58, 1)] }, { coefficient := 1, powers := [(6, 1), (19, 1), (29, 1), (58, 1)] }, { coefficient := 1, powers := [(8, 1), (35, 1)] }, { coefficient := -1, powers := [(18, 1), (29, 1), (43, 1)] }, { coefficient := 1, powers := [(19, 1), (20, 1), (29, 1), (51, 1)] }, { coefficient := 1, powers := [(19, 1), (25, 1), (29, 1), (40, 1)] }, { coefficient := 1, powers := [(19, 1), (25, 1), (29, 1), (45, 1)] }, { coefficient := 1, powers := [(19, 1), (29, 1)] }]
]
...
#print axioms Krenn.Component20.SelectedLeafB5_2.selectedHasNoCommonZero

end Krenn.Component20.SelectedLeafB5_2
