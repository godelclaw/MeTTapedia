...
namespace Krenn.Component20.SelectedLeafB4_2_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "c97eac8f48972f68bd7db643816631f401ba3740ac11269acd50eb2b8f1c0f25"
...
def multipliers : Fin 38 → SparsePoly (Fin 64) := ![
  ...
  [{ coefficient := -1, powers := [(21, 1), (53, 1)] }, { coefficient := 2, powers := [(46, 1), (53, 1), (61, 1)] }],
  [{ coefficient := -2, powers := [(18, 1), (56, 1), (62, 1)] }],
  ...
  [{ coefficient := 2, powers := [(25, 1), (29, 1), (40, 1), (47, 1), (62, 1)] }],
  [{ coefficient := 2, powers := [(21, 1), (29, 1), (43, 1), (49, 1), (51, 1), (60, 1)] }, { coefficient := -2, powers := [(29, 1), (40, 1), (47, 1), (49, 1), (60, 1), (62, 1)] }],
  ...
  [{ coefficient := -2, powers := [(29, 1), (40, 1), (47, 1), (62, 1)] }],
  [{ coefficient := 2, powers := [(13, 1), (29, 1), (45, 1)] }],
  [{ coefficient := -2, powers := [(18, 1), (21, 1), (29, 1), (43, 1), (51, 1), (60, 1)] }, { coefficient := 2, powers := [(18, 1), (29, 1), (40, 1), (47, 1), (60, 1), (62, 1)] }],
  ...
  [{ coefficient := 2, powers := [(18, 1), (21, 1), (29, 1), (43, 1), (49, 1), (51, 1)] }, { coefficient := -2, powers := [(18, 1), (29, 1), (40, 1), (47, 1), (49, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(36, 1), (47, 1), (53, 1), (58, 1)] }, { coefficient := 1, powers := [(38, 1), (59, 1)] }, { coefficient := -1, powers := [(41, 1), (55, 1), (56, 1), (62, 1)] }, { coefficient := 1, powers := [(41, 1), (56, 1)] }, { coefficient := -2, powers := [(46, 1), (49, 1), (56, 1)] }],
...
#print axioms Krenn.Component20.SelectedLeafB4_2_3.selectedHasNoCommonZero

end Krenn.Component20.SelectedLeafB4_2_3
