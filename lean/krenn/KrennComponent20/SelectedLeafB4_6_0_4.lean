...
namespace Krenn.Component20.SelectedLeafB4_6_0_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "c4cc100a069a39bce340479bbf5c36d57449efdce56fbcb7baa346f52130726a"
...
def multipliers : Fin 18 → SparsePoly (Fin 64) := ![
  ...
  [{ coefficient := -1, powers := [(19, 1), (20, 1), (53, 1)] }, { coefficient := 2, powers := [(19, 1), (53, 1), (62, 1)] }],
  ...
  [{ coefficient := 1, powers := [(19, 1), (20, 1), (24, 1), (53, 1)] }, { coefficient := -2, powers := [(19, 1), (24, 1), (53, 1), (62, 1)] }],
...
#print axioms Krenn.Component20.SelectedLeafB4_6_0_4.selectedHasNoCommonZero

end Krenn.Component20.SelectedLeafB4_6_0_4
