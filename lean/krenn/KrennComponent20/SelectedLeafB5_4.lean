...
namespace Krenn.Component20.SelectedLeafB5_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "3dddee2930bc32ae941acb2d892358a04346b5f301ae74b4963f2a8443768253"
def certificateSHA256 : String := "2e21f755604f25af29048b8c266ff1c59899f7c58360aa5bfc0f4c2703571842"

set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedSourceIndices : Fin 27 → Fin 642 := ![
  97,
  165,
  179,
  185,
...
def multipliers : Fin 27 → SparsePoly (Fin 63) := ![
  ...
  [{ coefficient := 2, powers := [(0, 1), (2, 1), (18, 1), (38, 1), (59, 1), (61, 1)] }, { coefficient := 1, powers := [(2, 1), (18, 1), (25, 1), (38, 1), (59, 1), (61, 1)] }],
  [{ coefficient := -2, powers := [(13, 1), (20, 1), (47, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (2, 1), (38, 1), (49, 1), (58, 1)] }, { coefficient := 1, powers := [(0, 1), (5, 1), (32, 1), (52, 1)] }, { coefficient := -1, powers := [(2, 1), (20, 1), (38, 1), (49, 1), (58, 1)] }, { coefficient := 1, powers := [(5, 1), (20, 1), (32, 1), (52, 1)] }],
  ...
  [{ coefficient := -2, powers := [(0, 1), (2, 1), (38, 1), (59, 1), (61, 1)] }, { coefficient := -1, powers := [(2, 1), (25, 1), (38, 1), (59, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(29, 1)] }],
  [{ coefficient := 1, powers := [(24, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (38, 1), (49, 1), (58, 1)] }, { coefficient := -1, powers := [(5, 1), (32, 1), (52, 1)] }],
  ...
  [{ coefficient := 2, powers := [(0, 1), (2, 1), (38, 1), (45, 1), (59, 1)] }, { coefficient := 1, powers := [(2, 1), (25, 1), (38, 1), (45, 1), (59, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (2, 1), (38, 1), (43, 1), (49, 1), (58, 1)] }, { coefficient := -1, powers := [(0, 1), (5, 1), (32, 1), (43, 1), (52, 1)] }, { coefficient := -1, powers := [(0, 1), (5, 1), (32, 1), (56, 1)] }, { coefficient := 1, powers := [(0, 1), (13, 1), (24, 1), (56, 1)] }, { coefficient := 1, powers := [(2, 1), (20, 1), (38, 1), (43, 1), (49, 1), (58, 1)] }, { coefficient := -1, powers := [(2, 1), (25, 1), (38, 1), (59, 1)] }, { coefficient := -1, powers := [(5, 1), (20, 1), (32, 1), (43, 1), (52, 1)] }, { coefficient := -1, powers := [(5, 1), (26, 1), (32, 1), (43, 1)] }, { coefficient := 2, powers := [(13, 1), (20, 1), (29, 1), (47, 1)] }, { coefficient := 1, powers := [(13, 1), (24, 1), (26, 1), (43, 1)] }, { coefficient := -1, powers := [(19, 1), (21, 1), (28, 1), (53, 1)] }, { coefficient := 1, powers := [(19, 1), (24, 1), (25, 1), (53, 1)] }, { coefficient := -1, powers := [(19, 1), (25, 1), (32, 1), (38, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (2, 1), (45, 1), (56, 1)] }, { coefficient := -1, powers := [(2, 1), (26, 1), (43, 1), (45, 1)] }, { coefficient := 1, powers := [(2, 1), (56, 1)] }, { coefficient := 1, powers := [(8, 1), (35, 1)] }]
]
...
#print axioms Krenn.Component20.SelectedLeafB5_4.selectedHasNoCommonZero

end Krenn.Component20.SelectedLeafB5_4
