...
namespace Krenn.Component20.SelectedLeafB5_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "df7548402f99241a3d77958df1761f819bf4da8f4935e082f5ce313e14e46bfb"
def certificateSHA256 : String := "840696ba44f790d28734cb22e0ad88dc1b68e339623aa5898fd30cc0b46fb2f2"

set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedSourceIndices : Fin 44 → Fin 642 := ![
  9,
  16,
  27,
  33,
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedEquations : Fin 44 → SparsePoly (Fin 64) := ![
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def multipliers : Fin 44 → SparsePoly (Fin 64) := ![
  [{ coefficient := 1, powers := [(4, 1), (35, 1), (41, 1), (55, 1)] }, { coefficient := -1, powers := [(11, 1), (35, 1), (37, 1), (41, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (27, 1), (35, 1), (41, 1), (45, 1), (63, 1)] }, { coefficient := -1, powers := [(8, 1), (34, 1), (35, 1), (37, 1), (41, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(6, 1), (11, 1), (18, 1), (35, 1), (41, 1), (51, 1)] }, { coefficient := -1, powers := [(7, 1), (18, 1), (35, 1), (41, 1)] }],
  [{ coefficient := -1, powers := [(4, 1), (8, 1), (35, 1), (41, 1), (46, 1), (58, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(4, 1), (35, 1), (41, 1), (51, 1), (62, 1)] }, { coefficient := 1, powers := [(4, 1), (35, 1), (41, 1), (55, 1), (62, 1)] }],
  ...
  [{ coefficient := 1, powers := [(4, 1), (8, 1), (35, 1), (41, 1), (58, 1), (63, 1)] }],
  ...
  [{ coefficient := 1, powers := [(0, 1), (2, 1), (21, 1), (47, 1), (53, 1), (55, 1), (63, 1)] }, { coefficient := 1, powers := [(2, 1), (21, 1), (25, 1), (47, 1), (53, 1), (55, 1), (63, 1)] }, { coefficient := 1, powers := [(2, 1), (26, 1), (47, 1)] }],
  ...
  [{ coefficient := 1, powers := [(2, 1), (21, 1), (47, 1), (53, 1), (55, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (21, 1), (47, 1), (53, 1), (55, 2), (63, 1)] }, { coefficient := -1, powers := [(2, 1), (46, 1), (47, 1), (53, 1), (55, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (41, 1), (47, 1), (55, 1), (63, 1)] }, { coefficient := 1, powers := [(2, 1), (46, 1), (47, 1), (49, 1), (55, 1), (63, 1)] }, { coefficient := -1, powers := [(2, 1), (47, 1), (55, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (35, 1), (41, 1), (55, 1)] }],
  ...
  [{ coefficient := -1, powers := [(2, 1), (21, 1), (47, 1), (49, 1), (53, 1), (55, 1), (63, 1)] }, { coefficient := 1, powers := [(2, 1), (38, 1), (59, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (11, 1), (35, 1), (41, 1)] }, { coefficient := 1, powers := [(8, 1), (16, 1), (35, 1), (41, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (35, 1), (41, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := 1, powers := [(8, 1), (35, 1), (37, 1), (41, 1), (58, 1)] }, { coefficient := 1, powers := [(8, 1), (35, 1), (41, 1), (45, 1), (51, 1)] }, { coefficient := 1, powers := [(8, 1), (35, 1), (41, 1), (45, 1), (55, 1)] }],
  ...
  [{ coefficient := 1, powers := [(0, 1), (2, 1), (38, 1), (43, 1), (49, 1), (58, 1)] }, { coefficient := -1, powers := [(0, 1), (2, 1), (41, 1), (43, 1), (52, 1)] }, { coefficient := -1, powers := [(0, 1), (2, 1), (41, 1), (56, 1)] }, { coefficient := -1, powers := [(0, 1), (5, 1), (32, 1), (43, 1), (52, 1)] }, { coefficient := -1, powers := [(0, 1), (5, 1), (32, 1), (56, 1)] }, { coefficient := 1, powers := [(0, 1), (13, 1), (24, 1), (56, 1)] }, { coefficient := 1, powers := [(1, 1), (8, 1), (35, 1), (41, 1), (55, 1)] }, { coefficient := 1, powers := [(2, 1), (20, 1), (38, 1), (43, 1), (49, 1), (58, 1)] }, { coefficient := -1, powers := [(2, 1), (20, 1), (41, 1), (43, 1), (52, 1)] }, { coefficient := 1, powers := [(2, 1), (21, 1), (25, 1), (47, 1), (49, 1), (53, 1), (55, 1), (63, 1)] }, { coefficient := -1, powers := [(2, 1), (25, 1), (38, 1), (59, 1)] }, { coefficient := -1, powers := [(2, 1), (26, 1), (41, 1), (43, 1)] }, { coefficient := -1, powers := [(5, 1), (20, 1), (32, 1), (43, 1), (52, 1)] }, { coefficient := -1, powers := [(5, 1), (26, 1), (32, 1), (43, 1)] }, { coefficient := -1, powers := [(8, 1), (11, 1), (27, 1), (35, 1), (41, 1)] }, { coefficient := 2, powers := [(13, 1), (20, 1), (29, 1), (47, 1)] }, { coefficient := 1, powers := [(13, 1), (24, 1), (26, 1), (43, 1)] }, { coefficient := -1, powers := [(19, 1), (21, 1), (28, 1), (53, 1)] }, { coefficient := 1, powers := [(19, 1), (24, 1), (25, 1), (53, 1)] }, { coefficient := -1, powers := [(19, 1), (25, 1), (32, 1), (38, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (2, 1), (47, 1), (53, 1), (55, 1)] }, { coefficient := -1, powers := [(2, 1), (20, 1), (47, 1), (53, 1), (55, 1)] }, { coefficient := -1, powers := [(4, 1), (8, 1), (27, 1), (35, 1), (41, 1), (58, 1)] }, { coefficient := 1, powers := [(8, 1), (16, 1), (27, 1), (35, 1), (41, 1), (45, 1)] }, { coefficient := 1, powers := [(8, 1), (16, 1), (34, 1), (35, 1), (37, 1), (41, 1)] }]
]
...
#print axioms Krenn.Component20.SelectedLeafB5_5.selectedHasNoCommonZero

end Krenn.Component20.SelectedLeafB5_5
