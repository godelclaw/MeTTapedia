...
namespace Krenn.Component20.SelectedLeafB4_4_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "c711d030a1f5316bb5bd2af68767a44ec31ea36686fad40d6d8302387562fed4"
...
def multipliers : Fin 5 → SparsePoly (Fin 64) := ![
  [{ coefficient := 1, powers := [(0, 1), (52, 1), (63, 1)] }, { coefficient := 1, powers := [(20, 1), (52, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(52, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(63, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (43, 1), (52, 1), (63, 1)] }, { coefficient := -1, powers := [(0, 1), (56, 1), (63, 1)] }, { coefficient := -1, powers := [(20, 1), (43, 1), (52, 1), (63, 1)] }, { coefficient := -1, powers := [(26, 1), (43, 1), (63, 1)] }],
...
#print axioms Krenn.Component20.SelectedLeafB4_4_3.selectedHasNoCommonZero

end Krenn.Component20.SelectedLeafB4_4_3
