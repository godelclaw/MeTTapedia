...
namespace Krenn.Component20.SelectedLeafB4_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "51d8db88568fa779e4b42ec1c657c9d13c6e59f981447c7e417aaa47bbca6a1c"
def certificateSHA256 : String := "2cc7004f38561c518775acf7f7b8f028e082b00d7a4c5c3725e72c6ded49ab13"

set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedSourceIndices : Fin 49 → Fin 642 := ![
  6,
  7,
  9,
  12,
...
def multipliers : Fin 49 → SparsePoly (Fin 63) := ![
  [{ coefficient := -1, powers := [(5, 1), (22, 1), (51, 1), (53, 1), (58, 1), (61, 1)] }, { coefficient := 1, powers := [(5, 1), (27, 1), (53, 1), (58, 1)] }, { coefficient := 1, powers := [(5, 1), (31, 1), (53, 1), (55, 1)] }, { coefficient := 1, powers := [(5, 1), (34, 1), (53, 1), (55, 1)] }, { coefficient := -1, powers := [(13, 1), (22, 1), (38, 1), (51, 1), (58, 1), (61, 1)] }, { coefficient := 1, powers := [(13, 1), (27, 1), (38, 1), (58, 1)] }, { coefficient := 1, powers := [(13, 1), (31, 1), (38, 1), (55, 1)] }, { coefficient := 1, powers := [(13, 1), (34, 1), (38, 1), (55, 1)] }],
  ...
  [{ coefficient := -1, powers := [(5, 1), (22, 1), (32, 1), (51, 1), (56, 1), (62, 1)] }, { coefficient := -1, powers := [(5, 1), (22, 1), (32, 1), (55, 1), (56, 1), (62, 1)] }, { coefficient := -1, powers := [(5, 1), (27, 1), (29, 1), (45, 1), (59, 1), (62, 1)] }, { coefficient := -1, powers := [(5, 1), (27, 1), (32, 1), (40, 1), (56, 1), (62, 1)] }, { coefficient := -1, powers := [(5, 1), (27, 1), (32, 1), (45, 1), (56, 1), (62, 1)] }, { coefficient := -1, powers := [(5, 1), (27, 1), (35, 1), (45, 1), (53, 1), (62, 1)] }, { coefficient := -1, powers := [(5, 1), (29, 1), (34, 1), (37, 1), (59, 1), (62, 1)] }, { coefficient := -1, powers := [(5, 1), (32, 1), (34, 1), (37, 1), (56, 1), (62, 1)] }, { coefficient := -1, powers := [(5, 1), (34, 1), (35, 1), (37, 1), (53, 1), (62, 1)] }, { coefficient := -1, powers := [(8, 1), (22, 1), (35, 1), (41, 1), (51, 1), (62, 1)] }, { coefficient := -1, powers := [(8, 1), (22, 1), (35, 1), (41, 1), (55, 1), (62, 1)] }, { coefficient := -1, powers := [(8, 1), (27, 1), (35, 1), (41, 1), (45, 1), (62, 1)] }, { coefficient := -1, powers := [(8, 1), (34, 1), (35, 1), (37, 1), (41, 1), (62, 1)] }, { coefficient := -1, powers := [(13, 1), (27, 1), (35, 1), (38, 1), (45, 1), (62, 1)] }, { coefficient := -1, powers := [(13, 1), (34, 1), (35, 1), (37, 1), (38, 1), (62, 1)] }],
  ...
  [{ coefficient := -1, powers := [(4, 1), (5, 1), (32, 1), (46, 1), (56, 1), (58, 1), (62, 1)] }, { coefficient := -1, powers := [(4, 1), (8, 1), (35, 1), (41, 1), (46, 1), (58, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (11, 1), (22, 1), (53, 1), (58, 1), (61, 1)] }, { coefficient := -1, powers := [(11, 1), (13, 1), (22, 1), (38, 1), (58, 1), (61, 1)] }, { coefficient := -1, powers := [(11, 1), (13, 1), (34, 1), (38, 1)] }],
  [{ coefficient := 1, powers := [(19, 1), (46, 1), (61, 1)] }],
  ...
  [{ coefficient := 1, powers := [(19, 1), (40, 1), (46, 1), (61, 1)] }, { coefficient := -1, powers := [(19, 1), (46, 1)] }],
  [{ coefficient := 1, powers := [(4, 1), (5, 1), (32, 1), (56, 1), (58, 1), (62, 1)] }, { coefficient := 1, powers := [(4, 1), (8, 1), (35, 1), (41, 1), (58, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (46, 1), (49, 1), (61, 1)] }],
  ...
  [{ coefficient := -1, powers := [(5, 1), (29, 1), (55, 1), (59, 1)] }, { coefficient := 1, powers := [(5, 1), (32, 1), (51, 1), (56, 1)] }, { coefficient := -1, powers := [(5, 1), (35, 1), (53, 1), (55, 1)] }, { coefficient := 1, powers := [(8, 1), (35, 1), (41, 1), (51, 1)] }, { coefficient := -1, powers := [(13, 1), (35, 1), (38, 1), (55, 1)] }],
  ...
  [{ coefficient := 1, powers := [(5, 1), (32, 1), (40, 1), (56, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (22, 1), (53, 1), (58, 1), (61, 1)] }, { coefficient := 1, powers := [(5, 1), (34, 1), (53, 1)] }, { coefficient := 1, powers := [(13, 1), (22, 1), (38, 1), (58, 1), (61, 1)] }, { coefficient := 1, powers := [(13, 1), (34, 1), (38, 1)] }],
  ...
  [{ coefficient := 1, powers := [(5, 1), (29, 1), (37, 1), (58, 1), (59, 1)] }, { coefficient := 1, powers := [(5, 1), (29, 1), (40, 1), (55, 1), (59, 1)] }, { coefficient := 1, powers := [(5, 1), (29, 1), (45, 1), (55, 1), (59, 1)] }, { coefficient := 1, powers := [(5, 1), (32, 1), (37, 1), (56, 1), (58, 1)] }, { coefficient := -1, powers := [(5, 1), (32, 1), (40, 1), (41, 1), (55, 1), (56, 1), (62, 1)] }, { coefficient := -1, powers := [(5, 1), (32, 1), (45, 1), (51, 1), (56, 1)] }, { coefficient := 1, powers := [(5, 1), (35, 1), (37, 1), (53, 1), (58, 1)] }, { coefficient := 1, powers := [(5, 1), (35, 1), (40, 1), (53, 1), (55, 1)] }, { coefficient := 1, powers := [(5, 1), (35, 1), (45, 1), (53, 1), (55, 1)] }, { coefficient := 1, powers := [(8, 1), (35, 1), (37, 1), (41, 1), (58, 1)] }, { coefficient := 1, powers := [(8, 1), (35, 1), (40, 1), (41, 1), (51, 1)] }, { coefficient := 1, powers := [(8, 1), (35, 1), (40, 1), (41, 1), (55, 1)] }, { coefficient := 1, powers := [(13, 1), (35, 1), (37, 1), (38, 1), (58, 1)] }, { coefficient := 1, powers := [(13, 1), (35, 1), (38, 1), (40, 1), (55, 1)] }, { coefficient := 1, powers := [(13, 1), (35, 1), (38, 1), (45, 1), (55, 1)] }],
...
#print axioms Krenn.Component20.SelectedLeafB4_3.selectedHasNoCommonZero

end Krenn.Component20.SelectedLeafB4_3
