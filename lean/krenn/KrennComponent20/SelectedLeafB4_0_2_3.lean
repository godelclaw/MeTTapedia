...
namespace Krenn.Component20.SelectedLeafB4_0_2_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "1118f97d059624795eb65b03053c23c350f397de2d30e18eb40b3b21541695c4"
...
def multipliers : Fin 16 → SparsePoly (Fin 64) := ![
  ...
  [{ coefficient := -1, powers := [(0, 1), (4, 1), (31, 1), (55, 1), (63, 1)] }, { coefficient := 1, powers := [(6, 1), (11, 1), (31, 1), (55, 1), (63, 1)] }, { coefficient := -1, powers := [(11, 1), (27, 1), (63, 1)] }, { coefficient := -1, powers := [(16, 1), (27, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(51, 1)] }],
  [{ coefficient := 1, powers := [(45, 1)] }],
  [{ coefficient := -1, powers := [(6, 1), (31, 1), (55, 1), (63, 1)] }, { coefficient := 1, powers := [(20, 1), (34, 1), (37, 1), (63, 1)] }, { coefficient := -1, powers := [(22, 1), (63, 1)] }, { coefficient := 1, powers := [(27, 1), (63, 1)] }],
  ...
  [{ coefficient := -1, powers := [(0, 1), (4, 1), (25, 1), (31, 1), (55, 1), (60, 1)] }, { coefficient := 1, powers := [(0, 1), (4, 1), (29, 1), (31, 1), (55, 1), (63, 1)] }, { coefficient := 1, powers := [(1, 1), (55, 1)] }, { coefficient := -1, powers := [(6, 1), (11, 1), (29, 1), (31, 1), (55, 1), (63, 1)] }, { coefficient := 1, powers := [(6, 1), (16, 1), (29, 1), (31, 1), (55, 1), (63, 1)] }, { coefficient := 1, powers := [(7, 1), (34, 1)] }, { coefficient := 1, powers := [(11, 1), (27, 1), (29, 1), (63, 1)] }, { coefficient := -1, powers := [(16, 1), (20, 1), (25, 1), (34, 1), (37, 1), (51, 1)] }, { coefficient := -1, powers := [(16, 1), (20, 1), (29, 1), (34, 1), (37, 1), (63, 1)] }, { coefficient := 1, powers := [(16, 1), (20, 1), (34, 1), (37, 1)] }, { coefficient := 2, powers := [(16, 1), (22, 1), (25, 1), (51, 1)] }, { coefficient := 1, powers := [(16, 1), (22, 1), (25, 1), (55, 1)] }, { coefficient := 1, powers := [(16, 1), (22, 1), (29, 1), (63, 1)] }, { coefficient := -1, powers := [(16, 1), (22, 1)] }, { coefficient := 1, powers := [(16, 1), (25, 1), (34, 1), (37, 1)] }],
...
#print axioms Krenn.Component20.SelectedLeafB4_0_2_3.selectedHasNoCommonZero

end Krenn.Component20.SelectedLeafB4_0_2_3
