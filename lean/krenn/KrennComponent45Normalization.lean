...
/-!
Exact normalization of external minimal-prime component 45 into
zero-based Lean component row 44.  All exponent-map equalities are
rechecked by Lean below; this source is generated only for serialization.
-/

namespace Krenn.Component45Normalization
...
theorem selectedIndices_exact : componentGenerators 44 = selectedIndices := by decide
...
theorem rawPositiveMap02 :
    Finsupp.mapDomain rawToReduced (rawPositive 2) = generatorPositive 3 := by
  ext coordinate
  fin_cases coordinate <;>
    simp [rawPositive, rawToReduced, Finsupp.mapDomain_add, Finsupp.mapDomain_single, generatorPositive, generatorPositiveSupport, generatorNegative, generatorNegativeSupport, squarefreeExponent, Nat.testBit, Nat.shiftRight_eq_div_pow]
...
set_option maxRecDepth 100000 in
theorem rawComponent45_vanishes {R : Type*} [CommRing R]
...
end Krenn.Component45Normalization

#print axioms Krenn.Component45Normalization.rawComponent45_vanishes
