...
namespace Krenn.X5Case52Tree.LeafB7

open Krenn.SparseCertificate
open MvPolynomial

def sourceSystemFileSHA256 : String := "6dfb45d050074fec8aded50263d9df0a5e5b089d0481c3dc9b1dac982c69d3a6"
def sourceSystemSemanticSHA256 : String := "22ef517d6bcd417c0eee17006ce9cea83518f08db59c9c184922909cbaf0ab32"
...
def multipliers : Fin 16 → SparsePoly (Fin 73) := ![
  [{ coefficient := 1, powers := [(1, 1), (3, 1), (23, 1), (60, 1), (71, 1)] }, { coefficient := -1, powers := [(1, 1), (23, 1), (60, 1)] }, { coefficient := -1, powers := [(3, 1), (7, 1), (60, 1), (71, 1)] }, { coefficient := 1, powers := [(7, 1), (60, 1)] }, { coefficient := 1, powers := [(34, 1), (37, 1)] }],
  [{ coefficient := 1, powers := [(1, 1), (23, 1), (49, 1), (71, 1)] }, { coefficient := -1, powers := [(7, 1), (49, 1), (71, 1)] }],
  [{ coefficient := -1, powers := [(3, 1), (34, 1), (40, 1), (50, 1), (57, 1), (72, 1)] }, { coefficient := -1, powers := [(3, 1), (34, 1), (43, 1), (50, 1), (54, 1), (72, 1)] }, { coefficient := 1, powers := [(11, 1), (34, 1), (40, 1), (50, 1), (57, 1), (72, 1)] }, { coefficient := 1, powers := [(11, 1), (34, 1), (43, 1), (50, 1), (54, 1), (72, 1)] }, { coefficient := -1, powers := [(33, 1), (40, 1), (49, 1), (57, 1)] }, { coefficient := -1, powers := [(33, 1), (43, 1), (49, 1), (54, 1)] }],
  ...
  [{ coefficient := -1, powers := [(1, 1), (23, 1), (71, 1)] }, { coefficient := 1, powers := [(7, 1), (71, 1)] }],
  [{ coefficient := 1, powers := [(3, 1), (34, 1), (40, 1), (57, 1), (72, 1)] }, { coefficient := 1, powers := [(3, 1), (34, 1), (43, 1), (54, 1), (72, 1)] }, { coefficient := -1, powers := [(11, 1), (34, 1), (40, 1), (57, 1), (72, 1)] }, { coefficient := -1, powers := [(11, 1), (34, 1), (43, 1), (54, 1), (72, 1)] }],
...
#print axioms Krenn.X5Case52Tree.LeafB7.selectedHasNoCommonZero

end Krenn.X5Case52Tree.LeafB7
