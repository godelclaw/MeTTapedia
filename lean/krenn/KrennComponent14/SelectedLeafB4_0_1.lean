...
namespace Krenn.Component14.SelectedLeafB4_0_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "417128dc514d78d310bad7d18a6378d9cf821fabf283e1e42d91a88a65eca674"
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedEquations : Fin 6 → SparsePoly (Fin 61) := ![
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def multipliers : Fin 6 → SparsePoly (Fin 61) := ![
  [{ coefficient := -1, powers := [(23, 1), (51, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(50, 1), (51, 1), (60, 1)] }],
  [{ coefficient := -1, powers := [(51, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(60, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (55, 1), (60, 1)] }, { coefficient := 1, powers := [(23, 1), (42, 1), (51, 1), (60, 1)] }, { coefficient := -1, powers := [(24, 1), (42, 1), (60, 1)] }],
...
#print axioms Krenn.Component14.SelectedLeafB4_0_1.selectedHasNoCommonZero

end Krenn.Component14.SelectedLeafB4_0_1
