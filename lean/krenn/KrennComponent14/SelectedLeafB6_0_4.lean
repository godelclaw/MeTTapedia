...
namespace Krenn.Component14.SelectedLeafB6_0_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "aa00d0de3c048dcfe707a31cffe41dbf30d36897e96e90fbef567d810a6c37dd"
def certificateSHA256 : String := "12ea6f53b8c1a20818373ff6574266b6e692dfa987fc1bdb4c46db1b42682b5d"

set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedSourceIndices : Fin 12 → Fin 643 := ![
  282,
  313,
  348,
  349,
...
def multipliers : Fin 12 → SparsePoly (Fin 62) := ![
  ...
  [{ coefficient := 1, powers := [(12, 1), (17, 1), (28, 1), (46, 1)] }, { coefficient := -1, powers := [(12, 1), (17, 1), (34, 1), (37, 1)] }],
...
#print axioms Krenn.Component14.SelectedLeafB6_0_4.selectedHasNoCommonZero

end Krenn.Component14.SelectedLeafB6_0_4
