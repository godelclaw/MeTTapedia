...
namespace Krenn.Component14.SelectedLeafB6_0_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "2f5843243465f83603c57ce4a548146c02d630b83210a8391132c1e954da1ebd"
def certificateSHA256 : String := "ec25e2efeaccf4ffea42b2f31c905bbf351951b7d23cc0250146f2d9420b9b41"
...
def multipliers : Fin 15 → SparsePoly (Fin 63) := ![
  [{ coefficient := -1, powers := [(6, 1), (28, 1), (58, 1)] }],
  [{ coefficient := -1, powers := [(34, 1), (37, 1), (43, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (5, 1), (58, 1)] }, { coefficient := -1, powers := [(5, 1), (23, 1), (58, 1)] }],
  ...
  [{ coefficient := 1, powers := [(0, 1), (5, 1), (28, 1), (58, 1)] }, { coefficient := 1, powers := [(16, 1), (22, 1), (23, 1), (52, 1)] }, { coefficient := -1, powers := [(16, 1), (23, 1), (31, 1), (37, 1)] }],
...
#print axioms Krenn.Component14.SelectedLeafB6_0_6.selectedHasNoCommonZero

end Krenn.Component14.SelectedLeafB6_0_6
