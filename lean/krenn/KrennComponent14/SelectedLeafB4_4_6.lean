...
namespace Krenn.Component14.SelectedLeafB4_4_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "3e12e92ebb5c2e68f4d4a5c2ff9388de9f6132284d15aed73effc5138f5bc6ec"
...
def multipliers : Fin 13 → SparsePoly (Fin 63) := ![
  [{ coefficient := 1, powers := [(28, 1), (43, 1), (46, 1), (61, 1)] }, { coefficient := -1, powers := [(34, 1), (37, 1), (43, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(28, 1), (46, 1), (61, 1)] }, { coefficient := 1, powers := [(34, 1), (37, 1), (61, 1)] }],
...
#print axioms Krenn.Component14.SelectedLeafB4_4_6.selectedHasNoCommonZero

end Krenn.Component14.SelectedLeafB4_4_6
