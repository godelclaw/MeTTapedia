...
namespace Krenn.Component14.SelectedLeafB6_1_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "2a93dc2458b01fe175df7e535e1583d895796816f5183246d475688fde7aa11f"
...
def multipliers : Fin 6 → SparsePoly (Fin 64) := ![
  [{ coefficient := -1, powers := [(23, 1), (51, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(50, 1), (51, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(51, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(63, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (55, 1), (63, 1)] }, { coefficient := 1, powers := [(23, 1), (42, 1), (51, 1), (63, 1)] }, { coefficient := -1, powers := [(24, 1), (42, 1), (63, 1)] }],
...
#print axioms Krenn.Component14.SelectedLeafB6_1_5.selectedHasNoCommonZero

end Krenn.Component14.SelectedLeafB6_1_5
