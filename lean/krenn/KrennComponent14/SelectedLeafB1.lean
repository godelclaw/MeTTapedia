...
namespace Krenn.Component14.SelectedLeafB1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "ed0b8251c1077bf0311ec4b16ba9cb75f3f9c62e8b6471f03d27fb2a385740c8"
...
def multipliers : Fin 25 → SparsePoly (Fin 60) := ![
  [{ coefficient := 1, powers := [(12, 1), (17, 1), (34, 1), (37, 1), (59, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (23, 1), (40, 1), (42, 1), (51, 1), (59, 1)] }, { coefficient := 1, powers := [(2, 1), (24, 1), (40, 1), (42, 1), (59, 1)] }, { coefficient := -1, powers := [(5, 1), (23, 1), (31, 1), (42, 1), (51, 1), (59, 1)] }, { coefficient := 1, powers := [(5, 1), (24, 1), (31, 1), (42, 1), (59, 1)] }, { coefficient := 1, powers := [(8, 1), (23, 1), (31, 1), (46, 1), (59, 1)] }, { coefficient := -1, powers := [(12, 1), (22, 1), (23, 1), (42, 1), (51, 1), (59, 1)] }, { coefficient := 1, powers := [(12, 1), (22, 1), (24, 1), (42, 1), (59, 1)] }, { coefficient := 1, powers := [(16, 1), (23, 1), (31, 1), (37, 1), (59, 1)] }],
  ...
  [{ coefficient := 1, powers := [(8, 1), (34, 1), (40, 1), (59, 1)] }, { coefficient := 1, powers := [(37, 1), (58, 1)] }],
...
#print axioms Krenn.Component14.SelectedLeafB1.selectedHasNoCommonZero

end Krenn.Component14.SelectedLeafB1
