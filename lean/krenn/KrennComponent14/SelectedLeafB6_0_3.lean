...
namespace Krenn.Component14.SelectedLeafB6_0_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "c9850775c36bab6945025a6849158457dd39979d8fed022e86e89945c6b89844"
...
def multipliers : Fin 5 → SparsePoly (Fin 63) := ![
  [{ coefficient := 1, powers := [(0, 1), (51, 1), (62, 1)] }, { coefficient := 1, powers := [(17, 1), (51, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(51, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(62, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (42, 1), (51, 1), (62, 1)] }, { coefficient := -1, powers := [(0, 1), (55, 1), (62, 1)] }, { coefficient := -1, powers := [(17, 1), (42, 1), (51, 1), (62, 1)] }, { coefficient := -1, powers := [(24, 1), (42, 1), (62, 1)] }],
...
#print axioms Krenn.Component14.SelectedLeafB6_0_3.selectedHasNoCommonZero

end Krenn.Component14.SelectedLeafB6_0_3
