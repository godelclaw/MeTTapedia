...
namespace Krenn.Component14.SelectedLeafB6_2_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "dc9e8a77ac9b930a9edd951ac494052de75b24536e895179265a6e7bf62845b2"
def certificateSHA256 : String := "5baa813bc6491e1e0c60eb97d7be132160d3574f5894810ee4a841f2ef444dab"
...
def multipliers : Fin 25 → SparsePoly (Fin 65) := ![
  ...
  [{ coefficient := 1, powers := [(22, 1), (43, 1), (55, 1), (62, 1)] }, { coefficient := 1, powers := [(28, 1), (43, 1), (46, 1), (62, 1)] }, { coefficient := -1, powers := [(34, 1), (37, 1), (43, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(16, 1), (19, 1), (22, 1), (39, 1), (60, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(23, 1), (45, 1), (52, 1)] }],
  ...
  [{ coefficient := -1, powers := [(22, 1), (55, 1), (62, 1)] }, { coefficient := -1, powers := [(28, 1), (46, 1), (62, 1)] }, { coefficient := 1, powers := [(34, 1), (37, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(27, 1), (45, 1), (52, 1)] }],
  ...
  [{ coefficient := 1, powers := [(16, 1), (22, 1), (39, 1), (52, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(6, 1), (46, 1), (52, 1), (57, 1)] }, { coefficient := 1, powers := [(37, 1), (58, 1)] }, { coefficient := -1, powers := [(40, 1), (54, 1), (55, 1), (63, 1)] }, { coefficient := 1, powers := [(40, 1), (55, 1)] }, { coefficient := -1, powers := [(46, 1), (52, 1)] }],
  [{ coefficient := -1, powers := [(16, 1), (31, 1), (37, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (34, 1)] }, { coefficient := -1, powers := [(16, 1), (28, 1), (39, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(12, 1), (22, 1), (55, 1)] }, { coefficient := 1, powers := [(12, 1), (28, 1), (46, 1)] }, { coefficient := -1, powers := [(12, 1), (34, 1), (37, 1)] }],
...
#print axioms Krenn.Component14.SelectedLeafB6_2_7.selectedHasNoCommonZero

end Krenn.Component14.SelectedLeafB6_2_7
