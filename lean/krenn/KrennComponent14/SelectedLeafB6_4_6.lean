...
namespace Krenn.Component14.SelectedLeafB6_4_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "b474b06af3efb2403f45625796b776e7671e36de512523b3d467a89155f7d27b"
def certificateSHA256 : String := "0384afce2ca2658cdacd623282f3879b2080b65f8184d8dd7c9ba9a4dd0f99e2"

set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedSourceIndices : Fin 13 → Fin 643 := ![
  13,
  288,
  313,
  348,
...
def multipliers : Fin 13 → SparsePoly (Fin 64) := ![
  [{ coefficient := 1, powers := [(28, 1), (43, 1), (46, 1), (62, 1)] }, { coefficient := -1, powers := [(34, 1), (37, 1), (43, 1), (62, 1)] }],
...
#print axioms Krenn.Component14.SelectedLeafB6_4_6.selectedHasNoCommonZero

end Krenn.Component14.SelectedLeafB6_4_6
