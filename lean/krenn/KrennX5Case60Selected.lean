...
namespace Krenn.X5Case60Selected

open Krenn.SparseCertificate
open MvPolynomial

def sourceSystemFileSHA256 : String := "0abf6ba5791947ab03467329e90c96ffcb36b06c9d0129eb6761d47f7d41a604"
def sourceSystemSemanticSHA256 : String := "8db691dd5661d54a7172abdcb66632920d7af030b1c62665473fa9cab861939f"
def certificateSHA256 : String := "a6b6cd214c0cc6560994aed8e04aaff7711651bdb04c56c683311b45c01dd125"
...
def multipliers : Fin 17 → SparsePoly (Fin 70) := ![
  [{ coefficient := -1, powers := [(0, 1), (26, 1), (34, 1), (40, 1), (59, 1)] }, { coefficient := -1, powers := [(26, 1), (34, 1), (40, 1)] }, { coefficient := 1, powers := [(34, 1), (43, 1)] }],
  ...
  [{ coefficient := 1, powers := [(0, 1), (34, 1), (40, 1), (59, 1)] }, { coefficient := 1, powers := [(1, 1), (23, 1), (48, 1)] }, { coefficient := -1, powers := [(7, 1), (48, 1)] }, { coefficient := 1, powers := [(34, 1), (40, 1)] }],
...
#print axioms Krenn.X5Case60Selected.selectedHasNoCommonZero

end Krenn.X5Case60Selected
