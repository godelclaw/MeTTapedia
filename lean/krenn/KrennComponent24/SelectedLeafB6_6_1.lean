...
namespace Krenn.Component24.SelectedLeafB6_6_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "1180b3564ded44aaa15ab11d6c4f53abdc63599a7ab4e2ddefefbb61a194aef8"
def certificateSHA256 : String := "c0ac11cb9bdf4f256906dd073880c612cd59199c7f71a590ca575e3306ce7238"
...
def multipliers : Fin 27 → SparsePoly (Fin 67) := ![
  ...
  [{ coefficient := -1, powers := [(25, 1), (26, 1), (54, 1), (58, 1), (66, 1)] }, { coefficient := 1, powers := [(25, 1), (45, 1), (55, 1), (66, 1)] }, { coefficient := -2, powers := [(26, 1), (31, 1), (49, 1), (54, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (9, 1), (34, 1), (62, 1), (64, 1)] }, { coefficient := -2, powers := [(19, 1), (25, 1), (46, 1), (55, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(3, 1), (13, 1), (34, 1), (62, 1), (64, 1)] }, { coefficient := -1, powers := [(19, 1), (31, 1), (54, 1), (66, 1)] }],
  ...
  [{ coefficient := 1, powers := [(18, 1), (25, 1), (26, 1), (54, 1), (58, 1)] }, { coefficient := -1, powers := [(18, 1), (25, 1), (45, 1), (55, 1)] }, { coefficient := 2, powers := [(18, 1), (26, 1), (31, 1), (49, 1), (54, 1)] }, { coefficient := 2, powers := [(19, 1), (20, 1), (25, 1), (46, 1), (55, 1)] }, { coefficient := 1, powers := [(19, 1), (21, 1), (31, 1), (54, 1)] }]
]
...
#print axioms Krenn.Component24.SelectedLeafB6_6_1.selectedHasNoCommonZero

end Krenn.Component24.SelectedLeafB6_6_1
