...
namespace Krenn.Component24.SelectedLeafB1_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "b57a66db41f13ba0d52d46d86843171268e51549bc1342ca070ceb3ac89ce7ee"
def certificateSHA256 : String := "d1ba0b1486c7b8d9c4bb691e38e89c784d8dd6c2b15bdf81f756ae992ea6408e"
...
def multipliers : Fin 21 → SparsePoly (Fin 64) := ![
  ...
  [{ coefficient := 1, powers := [(2, 1), (38, 1), (46, 1), (49, 1), (55, 1), (60, 1)] }, { coefficient := 1, powers := [(5, 1), (34, 1), (38, 1), (42, 1), (58, 1), (60, 1)] }, { coefficient := 1, powers := [(5, 1), (37, 1), (38, 1), (46, 1), (55, 1), (60, 1)] }, { coefficient := -1, powers := [(14, 1), (25, 1), (38, 1), (42, 1), (58, 1), (60, 1)] }, { coefficient := 1, powers := [(18, 1), (20, 1), (30, 1), (53, 1), (62, 1)] }, { coefficient := 1, powers := [(18, 1), (26, 1), (30, 1), (46, 1), (62, 1)] }, { coefficient := -1, powers := [(19, 1), (25, 1), (38, 1), (46, 1), (55, 1), (60, 1)] }],
...
#print axioms Krenn.Component24.SelectedLeafB1_2.selectedHasNoCommonZero

end Krenn.Component24.SelectedLeafB1_2
