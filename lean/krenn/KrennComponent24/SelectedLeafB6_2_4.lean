...
namespace Krenn.Component24.SelectedLeafB6_2_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "fac8e3f071b59c4733ab9374dc80693a233d85c9d36774a95769e6b59da9758f"
def certificateSHA256 : String := "56d316735256c610120a0a8d41f6906c58b209a388950517596e49f8e71f37ca"
...
def multipliers : Fin 21 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := 1, powers := [(21, 1), (31, 1), (47, 1), (65, 1)] }, { coefficient := -2, powers := [(31, 1), (49, 1), (65, 1)] }],
  ...
  [{ coefficient := -1, powers := [(14, 1), (21, 1), (31, 1), (47, 1)] }, { coefficient := 2, powers := [(14, 1), (31, 1), (49, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (20, 1), (25, 1), (61, 1)] }],
...
#print axioms Krenn.Component24.SelectedLeafB6_2_4.selectedHasNoCommonZero

end Krenn.Component24.SelectedLeafB6_2_4
