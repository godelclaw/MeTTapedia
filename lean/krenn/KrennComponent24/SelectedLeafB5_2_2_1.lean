...
namespace Krenn.Component24.SelectedLeafB5_2_2_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "ce334628c60e9f83158c27d4275b599581a46903041e071dc26a12bcd78d3c2b"
...
def multipliers : Fin 21 → SparsePoly (Fin 67) := ![
  ...
  [{ coefficient := 1, powers := [(0, 1), (2, 1), (21, 1), (55, 1), (62, 2), (66, 1)] }, { coefficient := 2, powers := [(0, 1), (14, 1), (21, 1), (31, 1), (62, 2), (66, 1)] }, { coefficient := 1, powers := [(0, 1), (18, 1), (25, 1), (55, 1), (62, 1), (66, 1)] }, { coefficient := -1, powers := [(2, 1), (20, 1), (21, 1), (55, 1), (62, 2), (66, 1)] }, { coefficient := -1, powers := [(2, 1), (21, 1), (55, 1), (62, 1), (66, 1)] }],
  ...
  [{ coefficient := -1, powers := [(0, 1), (2, 1), (21, 1), (24, 1), (55, 1), (62, 2), (66, 1)] }, { coefficient := 1, powers := [(0, 1), (5, 1), (34, 1), (62, 1)] }, { coefficient := -2, powers := [(0, 1), (14, 1), (21, 1), (24, 1), (31, 1), (62, 2), (66, 1)] }, { coefficient := -1, powers := [(0, 1), (14, 1), (25, 1), (62, 1)] }, { coefficient := -1, powers := [(0, 1), (18, 1), (24, 1), (25, 1), (55, 1), (62, 1), (66, 1)] }, { coefficient := 1, powers := [(2, 1), (20, 1), (21, 1), (24, 1), (55, 1), (62, 2), (66, 1)] }, { coefficient := 1, powers := [(2, 1), (21, 1), (24, 1), (55, 1), (62, 1), (66, 1)] }, { coefficient := -1, powers := [(2, 1), (21, 1), (51, 1), (62, 1)] }],
...
#print axioms Krenn.Component24.SelectedLeafB5_2_2_1.selectedHasNoCommonZero

end Krenn.Component24.SelectedLeafB5_2_2_1
