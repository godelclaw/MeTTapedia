...
namespace Krenn.Component24.SelectedLeafB6_3_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "fc25794dcbadfa170b3254c06533a98054728ba59b6ca77ffa6292ef01693f2e"
def certificateSHA256 : String := "3a53e78fbb4e9ea49381a1dce5246825a2205145c8e644b99aa7d13d458fb210"
...
def multipliers : Fin 30 → SparsePoly (Fin 68) := ![
  ...
  [{ coefficient := 2, powers := [(0, 1), (31, 1), (43, 1), (46, 1), (47, 1), (64, 1), (66, 1)] }, { coefficient := 1, powers := [(25, 1), (45, 1), (55, 1), (66, 1)] }, { coefficient := 2, powers := [(26, 1), (31, 1), (43, 1), (45, 1), (53, 1), (66, 1)] }, { coefficient := 2, powers := [(26, 1), (31, 1), (43, 1), (45, 1), (57, 1), (66, 1)] }, { coefficient := 2, powers := [(26, 1), (31, 1), (43, 1), (46, 1), (47, 1), (64, 1), (66, 1)] }, { coefficient := 1, powers := [(26, 1), (31, 1), (49, 1), (54, 1), (66, 1)] }, { coefficient := 1, powers := [(31, 1), (43, 1), (47, 1), (64, 1), (66, 1)] }],
...
#print axioms Krenn.Component24.SelectedLeafB6_3_6.selectedHasNoCommonZero

end Krenn.Component24.SelectedLeafB6_3_6
