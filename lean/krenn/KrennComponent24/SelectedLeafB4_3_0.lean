...
namespace Krenn.Component24.SelectedLeafB4_3_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "dd46b298027e41e5250d520a311989a70205eda4f3f58cf9c72d55bbcd762319"
def certificateSHA256 : String := "838720ec0b68b78f06aebc83097c5fa6d21ae63d98effbbd60661059d2b73d95"
...
def multipliers : Fin 23 → SparsePoly (Fin 65) := ![
  [{ coefficient := 1, powers := [(24, 1), (43, 1), (47, 1), (63, 1)] }, { coefficient := 1, powers := [(24, 1), (49, 1), (51, 1)] }],
  ...
  [{ coefficient := -1, powers := [(43, 1), (47, 1), (63, 1)] }, { coefficient := -1, powers := [(49, 1), (51, 1)] }],
  ...
  [{ coefficient := 1, powers := [(14, 1), (26, 1), (31, 1), (49, 1)] }, { coefficient := 2, powers := [(19, 1), (20, 1), (25, 1), (55, 1)] }],
...
#print axioms Krenn.Component24.SelectedLeafB4_3_0.selectedHasNoCommonZero

end Krenn.Component24.SelectedLeafB4_3_0
