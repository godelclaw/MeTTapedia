...
namespace Krenn.Component24.SelectedLeafB1_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "906882156019f5975d14a9052c08d1064a1723dd237bea3bbc73ede5988e239d"
def certificateSHA256 : String := "8906fff873e932de8e9a58d2f96994c61c36447721b41acea04c39e8a5c96055"
...
def multipliers : Fin 19 → SparsePoly (Fin 65) := ![
  ...
  [{ coefficient := -1, powers := [(24, 1), (42, 1), (62, 1)] }, { coefficient := -1, powers := [(24, 1), (46, 1), (62, 1)] }],
  ...
  [{ coefficient := 1, powers := [(20, 1), (24, 1), (62, 1)] }],
  ...
  [{ coefficient := 1, powers := [(18, 1), (29, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(38, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (38, 1), (46, 1), (49, 1), (55, 1), (60, 1)] }, { coefficient := 1, powers := [(5, 1), (34, 1), (38, 1), (42, 1), (58, 1), (60, 1)] }, { coefficient := 1, powers := [(5, 1), (37, 1), (38, 1), (46, 1), (55, 1), (60, 1)] }, { coefficient := -1, powers := [(14, 1), (25, 1), (38, 1), (42, 1), (58, 1), (60, 1)] }, { coefficient := -1, powers := [(18, 1), (24, 1), (46, 1), (62, 1)] }, { coefficient := -1, powers := [(18, 1), (29, 1), (53, 1), (62, 1)] }, { coefficient := -1, powers := [(19, 1), (25, 1), (38, 1), (46, 1), (55, 1), (60, 1)] }],
...
#print axioms Krenn.Component24.SelectedLeafB1_6.selectedHasNoCommonZero

end Krenn.Component24.SelectedLeafB1_6
