...
namespace Krenn.Component24.SelectedLeafB5_4_2_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "5efa46bafd4d24cd2307330483978ac1638276ef187490bb45bfe356fc253865"
def certificateSHA256 : String := "a96f19f20da84fe8c2d505e4984cacf23bfae20dee1179487530ca6a0c15ec5a"
...
def multipliers : Fin 24 → SparsePoly (Fin 68) := ![
  ...
  [{ coefficient := -1, powers := [(2, 1), (20, 1), (46, 1), (49, 1), (62, 1)] }, { coefficient := -1, powers := [(2, 1), (49, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (2, 1), (21, 1), (55, 1), (62, 2), (67, 1)] }, { coefficient := 2, powers := [(0, 1), (14, 1), (21, 1), (31, 1), (62, 2), (67, 1)] }, { coefficient := 1, powers := [(0, 1), (18, 1), (25, 1), (55, 1), (62, 1), (67, 1)] }, { coefficient := -1, powers := [(2, 1), (21, 1), (55, 1), (62, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (18, 1), (55, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (20, 2), (49, 1), (55, 1), (62, 1), (67, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (20, 1), (49, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (31, 1), (54, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (2, 1), (55, 1), (62, 2)] }, { coefficient := -2, powers := [(0, 1), (14, 1), (31, 1), (62, 2)] }],
  ...
  [{ coefficient := 1, powers := [(0, 1), (2, 1), (49, 1), (55, 1), (62, 1)] }, { coefficient := 2, powers := [(0, 1), (14, 1), (31, 1), (49, 1), (62, 1)] }, { coefficient := -1, powers := [] }],
  [{ coefficient := -1, powers := [(2, 1), (20, 2), (31, 1), (49, 1), (55, 1), (62, 1), (67, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (8, 1), (37, 1), (62, 1)] }, { coefficient := -1, powers := [(0, 1), (19, 1), (31, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (2, 1), (21, 1), (24, 1), (55, 1), (62, 2), (67, 1)] }, { coefficient := 1, powers := [(0, 1), (5, 1), (34, 1), (62, 1)] }, { coefficient := -2, powers := [(0, 1), (14, 1), (21, 1), (24, 1), (31, 1), (62, 2), (67, 1)] }, { coefficient := -1, powers := [(0, 1), (14, 1), (25, 1), (62, 1)] }, { coefficient := -1, powers := [(0, 1), (18, 1), (24, 1), (25, 1), (55, 1), (62, 1), (67, 1)] }, { coefficient := 1, powers := [(2, 1), (21, 1), (24, 1), (55, 1), (62, 1), (67, 1)] }, { coefficient := -1, powers := [(2, 1), (21, 1), (51, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (2, 1), (49, 1), (55, 1), (62, 2)] }, { coefficient := 2, powers := [(0, 1), (14, 1), (31, 1), (49, 1), (62, 2)] }, { coefficient := 2, powers := [(0, 1), (18, 1), (25, 1), (47, 1), (55, 1), (62, 1)] }, { coefficient := 1, powers := [(0, 1), (18, 1), (31, 1), (49, 1), (54, 1), (62, 1)] }, { coefficient := 2, powers := [(0, 1), (19, 1), (25, 1), (42, 1), (55, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (2, 1), (21, 1), (45, 1), (55, 1), (62, 2)] }, { coefficient := -2, powers := [(0, 1), (14, 1), (21, 1), (31, 1), (45, 1), (62, 2)] }, { coefficient := -1, powers := [(0, 1), (18, 1), (25, 1), (45, 1), (55, 1), (62, 1)] }, { coefficient := -1, powers := [(2, 1), (20, 2), (46, 1), (49, 1), (55, 1), (62, 1)] }, { coefficient := 1, powers := [(2, 1), (21, 1), (45, 1), (55, 1), (62, 1)] }]
]
...
#print axioms Krenn.Component24.SelectedLeafB5_4_2_3.selectedHasNoCommonZero

end Krenn.Component24.SelectedLeafB5_4_2_3
