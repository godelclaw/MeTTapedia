...
namespace Krenn.Component24.SelectedLeafB4_3_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "ab602d8038447f3b15c8515c563f7d3440d80121e36b154fa2de7d8be68dd77d"
def certificateSHA256 : String := "00f22b6c02e3ea0def5ea503d3b2a37c36b25834d7fb2c9aad8fffd8961e6dbc"
...
def multipliers : Fin 30 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := 2, powers := [(0, 1), (31, 1), (43, 1), (46, 1), (47, 1), (63, 1), (65, 1)] }, { coefficient := 1, powers := [(25, 1), (45, 1), (55, 1), (65, 1)] }, { coefficient := 2, powers := [(26, 1), (31, 1), (43, 1), (45, 1), (53, 1), (65, 1)] }, { coefficient := 2, powers := [(26, 1), (31, 1), (43, 1), (46, 1), (47, 1), (63, 1), (65, 1)] }, { coefficient := 1, powers := [(26, 1), (31, 1), (49, 1), (54, 1), (65, 1)] }, { coefficient := 1, powers := [(31, 1), (43, 1), (47, 1), (63, 1), (65, 1)] }],
  ...
  [{ coefficient := -2, powers := [(0, 1), (18, 1), (31, 1), (43, 1), (46, 1), (47, 1), (63, 1)] }, { coefficient := 2, powers := [(14, 1), (31, 1), (49, 1)] }, { coefficient := -1, powers := [(18, 1), (25, 1), (45, 1), (55, 1)] }, { coefficient := -2, powers := [(18, 1), (26, 1), (31, 1), (43, 1), (45, 1), (53, 1)] }, { coefficient := -2, powers := [(18, 1), (26, 1), (31, 1), (43, 1), (46, 1), (47, 1), (63, 1)] }, { coefficient := -1, powers := [(18, 1), (26, 1), (31, 1), (49, 1), (54, 1)] }, { coefficient := -1, powers := [(18, 1), (31, 1), (43, 1), (47, 1), (63, 1)] }, { coefficient := 2, powers := [(19, 1), (25, 1), (55, 1)] }],
...
#print axioms Krenn.Component24.SelectedLeafB4_3_4.selectedHasNoCommonZero

end Krenn.Component24.SelectedLeafB4_3_4
