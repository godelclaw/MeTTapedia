...
namespace Krenn.Component24.SelectedLeafB7_3_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "07f37b1d0b13239ed76a4b432d4929939998534a6e7be95c9229aa142e6f966d"
...
def multipliers : Fin 14 → SparsePoly (Fin 67) := ![
  [{ coefficient := -1, powers := [(22, 1), (48, 1), (54, 1), (63, 1), (66, 1)] }, { coefficient := 1, powers := [(28, 1), (43, 1), (63, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(22, 1), (54, 1), (63, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(11, 1), (28, 1), (48, 1), (63, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(21, 1), (28, 1), (63, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(1, 1), (48, 1), (63, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(20, 1), (48, 1), (63, 1), (66, 1)] }, { coefficient := -1, powers := [(21, 1), (63, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(11, 1), (28, 1), (63, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(21, 1), (28, 1), (51, 1), (63, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(20, 1), (28, 1), (51, 1), (63, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(20, 1), (28, 1), (63, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(1, 1), (63, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(43, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := -1, powers := [(0, 1), (1, 1), (43, 1), (63, 1), (66, 1)] }, { coefficient := 1, powers := [(1, 1), (20, 1), (48, 1), (51, 1), (63, 1), (66, 1)] }, { coefficient := -1, powers := [(1, 1), (21, 1), (51, 1), (63, 1), (66, 1)] }, { coefficient := -1, powers := [(12, 1), (20, 1), (22, 1), (48, 1), (63, 1), (66, 1)] }, { coefficient := 1, powers := [(12, 1), (21, 1), (22, 1), (63, 1), (66, 1)] }]
]
...
#print axioms Krenn.Component24.SelectedLeafB7_3_0.selectedHasNoCommonZero

end Krenn.Component24.SelectedLeafB7_3_0
