...
namespace Krenn.Component24.SelectedLeafB4_2_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "00ec12f14aefff747b5c732c6d6d1792c94d10ffa7fae5fe3e56a9f4932981e2"
def certificateSHA256 : String := "cc797561e30c09b456e5f2c554eef4a81e42f074b382ba29a6e9be7dab46bf97"
...
def multipliers : Fin 19 → SparsePoly (Fin 65) := ![
  ...
  [{ coefficient := -1, powers := [(31, 1), (49, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (49, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (51, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (37, 1), (53, 1)] }, { coefficient := 1, powers := [(19, 1), (25, 1), (53, 1)] }],
  ...
  [{ coefficient := -1, powers := [(5, 1), (20, 1), (37, 1), (55, 1)] }, { coefficient := -1, powers := [(8, 1), (20, 1), (25, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (14, 1), (25, 1), (53, 1)] }, { coefficient := 1, powers := [(3, 1), (5, 1), (34, 1), (60, 1)] }, { coefficient := 1, powers := [(5, 1), (24, 1), (51, 1), (60, 1)] }, { coefficient := 1, powers := [(5, 1), (34, 1)] }, { coefficient := 1, powers := [(14, 1), (20, 1), (25, 1), (53, 1)] }]
]
...
#print axioms Krenn.Component24.SelectedLeafB4_2_4.selectedHasNoCommonZero

end Krenn.Component24.SelectedLeafB4_2_4
