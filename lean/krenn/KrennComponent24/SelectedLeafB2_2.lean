...
namespace Krenn.Component24.SelectedLeafB2_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "347c280380635544c4ce26d30ba933241dc29515dad3751a975f10f20418f2f6"
def certificateSHA256 : String := "9ccd744109debc35a3089e53f170ab2c120cd2aa8f2a6e6f533580904afd2928"
...
def multipliers : Fin 20 → SparsePoly (Fin 64) := ![
  ...
  [{ coefficient := 2, powers := [(14, 1), (17, 1), (22, 1), (62, 1)] }, { coefficient := -1, powers := [(19, 1), (51, 1)] }],
  ...
  [{ coefficient := -1, powers := [(5, 1), (34, 1), (42, 1), (58, 1)] }, { coefficient := -1, powers := [(5, 1), (37, 1), (46, 1), (55, 1)] }, { coefficient := 1, powers := [(14, 1), (25, 1), (42, 1), (58, 1)] }, { coefficient := -1, powers := [(18, 1), (31, 1), (49, 1), (54, 1)] }, { coefficient := 1, powers := [(19, 1), (25, 1), (46, 1), (55, 1)] }],
...
#print axioms Krenn.Component24.SelectedLeafB2_2.selectedHasNoCommonZero

end Krenn.Component24.SelectedLeafB2_2
