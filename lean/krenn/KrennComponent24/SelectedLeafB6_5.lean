...
namespace Krenn.Component24.SelectedLeafB6_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "f0af4e9f118a0c1753df5f30ca298801064be3b75b1a0cab28fe03bef90864e0"
def certificateSHA256 : String := "cd1e3038e4be5e8d9af50918fc2dce7f0e5efb2c961e9caface2b1cb86f02499"
...
def multipliers : Fin 30 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := 1, powers := [(19, 1), (22, 1), (25, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (49, 1)] }],
  [{ coefficient := 1, powers := [(3, 1), (18, 1), (61, 1)] }, { coefficient := -1, powers := [(19, 1), (51, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (25, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(25, 1), (47, 1), (55, 1)] }, { coefficient := 1, powers := [(31, 1), (43, 1), (45, 1), (62, 1)] }, { coefficient := 1, powers := [(31, 1), (43, 1), (47, 1)] }],
  [{ coefficient := 1, powers := [(25, 1), (55, 1)] }, { coefficient := 1, powers := [(31, 1), (43, 1)] }],
  ...
  [{ coefficient := -1, powers := [(18, 1), (31, 1), (43, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(25, 1)] }],
  [{ coefficient := 1, powers := [(20, 1), (31, 1), (49, 1)] }],
  [{ coefficient := -1, powers := [(20, 1), (25, 1), (55, 1)] }, { coefficient := -1, powers := [(20, 1), (31, 1), (43, 1)] }],
  ...
  [{ coefficient := 1, powers := [(18, 1), (31, 1), (43, 1), (45, 1)] }],
  [{ coefficient := 1, powers := [(19, 1), (25, 1), (55, 1)] }],
  [{ coefficient := 1, powers := [(3, 1), (40, 1), (60, 1), (61, 1)] }, { coefficient := 1, powers := [(40, 1), (61, 1)] }, { coefficient := -1, powers := [(41, 1), (43, 1), (58, 1), (64, 1)] }, { coefficient := 1, powers := [(43, 1), (58, 1)] }, { coefficient := -1, powers := [(49, 1), (55, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (37, 1), (43, 1)] }, { coefficient := -1, powers := [(19, 1), (31, 1), (43, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (5, 1), (34, 1), (58, 1)] }, { coefficient := 1, powers := [(0, 1), (14, 1), (25, 1), (58, 1)] }, { coefficient := 1, powers := [(14, 1), (20, 1), (31, 1), (49, 1)] }, { coefficient := 1, powers := [(19, 1), (20, 1), (25, 1), (55, 1)] }, { coefficient := 1, powers := [(19, 1), (20, 1), (31, 1), (43, 1)] }, { coefficient := 1, powers := [(19, 1), (25, 1), (26, 1), (55, 1)] }, { coefficient := 1, powers := [(19, 1), (26, 1), (31, 1), (43, 1)] }]
]
...
#print axioms Krenn.Component24.SelectedLeafB6_5.selectedHasNoCommonZero

end Krenn.Component24.SelectedLeafB6_5
