...
namespace Krenn.Component24.SelectedLeafB7_6_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "9badecaaf45de201c6f3efd2967ec724db5f7d4e4f3a29fd9566fd8c4a778927"
def certificateSHA256 : String := "425997e14ae079bee9f3a8bc02c5860fba52840cb2de5d97d372570646bd1d58"
...
def multipliers : Fin 24 → SparsePoly (Fin 68) := ![
  ...
  [{ coefficient := -1, powers := [(21, 1), (31, 1), (38, 1), (53, 1), (61, 1), (67, 1)] }, { coefficient := -1, powers := [(24, 1), (40, 1), (61, 1), (67, 1)] }, { coefficient := 1, powers := [(25, 1), (45, 1), (55, 1), (67, 1)] }, { coefficient := 1, powers := [(26, 1), (31, 1), (49, 1), (54, 1), (67, 1)] }, { coefficient := -1, powers := [(29, 1), (40, 1), (61, 1), (67, 1)] }, { coefficient := -1, powers := [(31, 1), (38, 1), (48, 1), (61, 1), (67, 1)] }],
...
#print axioms Krenn.Component24.SelectedLeafB7_6_4.selectedHasNoCommonZero

end Krenn.Component24.SelectedLeafB7_6_4
