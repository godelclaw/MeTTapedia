...
namespace Krenn.Component24.SelectedLeafB7_6_2_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "c25e1899265a326f89c61e3d2efbcc782062e63622f8c21e536c25f526d590c8"
...
def multipliers : Fin 21 → SparsePoly (Fin 70) := ![
  ...
  [{ coefficient := 1, powers := [(0, 1), (2, 1), (21, 1), (55, 1), (62, 2), (69, 1)] }, { coefficient := 2, powers := [(0, 1), (14, 1), (21, 1), (31, 1), (62, 2), (69, 1)] }, { coefficient := 1, powers := [(0, 1), (18, 1), (25, 1), (55, 1), (62, 1), (69, 1)] }, { coefficient := -1, powers := [(2, 1), (20, 1), (21, 1), (55, 1), (62, 2), (69, 1)] }, { coefficient := -1, powers := [(2, 1), (21, 1), (55, 1), (62, 1), (69, 1)] }],
  ...
  [{ coefficient := -1, powers := [(0, 1), (2, 1), (21, 1), (24, 1), (55, 1), (62, 2), (69, 1)] }, { coefficient := 1, powers := [(0, 1), (5, 1), (34, 1), (62, 1)] }, { coefficient := -2, powers := [(0, 1), (14, 1), (21, 1), (24, 1), (31, 1), (62, 2), (69, 1)] }, { coefficient := -1, powers := [(0, 1), (14, 1), (25, 1), (62, 1)] }, { coefficient := -1, powers := [(0, 1), (18, 1), (24, 1), (25, 1), (55, 1), (62, 1), (69, 1)] }, { coefficient := 1, powers := [(2, 1), (20, 1), (21, 1), (24, 1), (55, 1), (62, 2), (69, 1)] }, { coefficient := 1, powers := [(2, 1), (21, 1), (24, 1), (55, 1), (62, 1), (69, 1)] }, { coefficient := -1, powers := [(2, 1), (21, 1), (51, 1), (62, 1)] }],
...
#print axioms Krenn.Component24.SelectedLeafB7_6_2_3.selectedHasNoCommonZero

end Krenn.Component24.SelectedLeafB7_6_2_3
