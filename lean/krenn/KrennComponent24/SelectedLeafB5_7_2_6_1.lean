...
namespace Krenn.Component24.SelectedLeafB5_7_2_6_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "1a899fd1418b5fcfb78ca012625e0b96306f4b57b9aade123547b42b706ceadf"
...
def multipliers : Fin 4 → SparsePoly (Fin 71) := ![
  ...
  [{ coefficient := -1, powers := [(2, 1), (38, 1), (63, 1)] }, { coefficient := 1, powers := [(3, 1), (18, 1), (29, 1), (63, 1)] }, { coefficient := 1, powers := [(6, 1), (18, 1), (24, 1), (63, 1)] }]
]
...
#print axioms Krenn.Component24.SelectedLeafB5_7_2_6_1.selectedHasNoCommonZero

end Krenn.Component24.SelectedLeafB5_7_2_6_1
