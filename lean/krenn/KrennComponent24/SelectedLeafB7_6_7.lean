...
namespace Krenn.Component24.SelectedLeafB7_6_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "b2bab49d3677c3610675a91b3c3552e704e98c64ea36adea9187e1b241942206"
...
def multipliers : Fin 24 → SparsePoly (Fin 70) := ![
  ...
  [{ coefficient := -1, powers := [(21, 1), (31, 1), (38, 1), (53, 1), (61, 1), (67, 1)] }, { coefficient := -1, powers := [(21, 1), (31, 1), (38, 1), (57, 1), (61, 1), (67, 1)] }, { coefficient := -1, powers := [(24, 1), (40, 1), (61, 1), (67, 1)] }, { coefficient := 1, powers := [(25, 1), (45, 1), (55, 1), (67, 1)] }, { coefficient := -1, powers := [(29, 1), (40, 1), (61, 1), (67, 1)] }, { coefficient := -1, powers := [(31, 1), (38, 1), (48, 1), (61, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (46, 1), (49, 1), (55, 1), (69, 1)] }, { coefficient := -2, powers := [(19, 1), (25, 1), (46, 1), (55, 1), (69, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (31, 1), (54, 1), (69, 1)] }],
...
#print axioms Krenn.Component24.SelectedLeafB7_6_7.selectedHasNoCommonZero

end Krenn.Component24.SelectedLeafB7_6_7
