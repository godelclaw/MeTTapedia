...
namespace Krenn.Component24.SelectedLeafB0_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "1318a6311154d2ebca0d739d68b2aa41efd8affc57102a3e9f9d730bad0545e0"
def certificateSHA256 : String := "e096cbecd93410912b8d405fee26c8a996387707e892e190c740c7c260cbfee9"
...
def multipliers : Fin 20 → SparsePoly (Fin 63) := ![
  ...
  [{ coefficient := -2, powers := [(14, 1), (45, 1)] }, { coefficient := -1, powers := [(19, 1), (51, 1)] }],
  ...
  [{ coefficient := 2, powers := [(14, 1), (31, 1), (45, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := -1, powers := [(5, 1), (34, 1), (42, 1), (58, 1)] }, { coefficient := -1, powers := [(5, 1), (37, 1), (46, 1), (55, 1)] }, { coefficient := 1, powers := [(14, 1), (25, 1), (42, 1), (58, 1)] }, { coefficient := -2, powers := [(14, 1), (31, 1), (45, 1), (48, 1), (53, 1)] }, { coefficient := 2, powers := [(14, 1), (31, 1), (49, 1), (53, 1)] }, { coefficient := -1, powers := [(18, 1), (31, 1), (49, 1), (54, 1)] }, { coefficient := 1, powers := [(19, 1), (25, 1), (46, 1), (55, 1)] }],
...
#print axioms Krenn.Component24.SelectedLeafB0_2.selectedHasNoCommonZero

end Krenn.Component24.SelectedLeafB0_2
