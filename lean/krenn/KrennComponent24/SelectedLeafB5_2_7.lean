...
namespace Krenn.Component24.SelectedLeafB5_2_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "ff214c79fac17c17a6524697d32ca87a304b5cbdc826ee82a26f92e99e68ba66"
def certificateSHA256 : String := "dc5af9528aa07320db6dca5b3598b439ccd9aa35936361314710c221cd37bf0b"
...
def multipliers : Fin 24 → SparsePoly (Fin 68) := ![
  ...
  [{ coefficient := -2, powers := [(25, 1), (58, 1), (65, 1)] }, { coefficient := -2, powers := [(31, 1), (49, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (49, 1)] }],
  [{ coefficient := -1, powers := [(21, 1), (31, 1), (38, 1), (53, 1), (61, 1), (65, 1)] }, { coefficient := -1, powers := [(21, 1), (31, 1), (38, 1), (57, 1), (61, 1), (65, 1)] }, { coefficient := -1, powers := [(24, 1), (40, 1), (61, 1), (65, 1)] }, { coefficient := 1, powers := [(25, 1), (45, 1), (55, 1), (65, 1)] }, { coefficient := -1, powers := [(29, 1), (40, 1), (61, 1), (65, 1)] }, { coefficient := -1, powers := [(31, 1), (38, 1), (48, 1), (61, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (46, 1), (49, 1), (55, 1), (67, 1)] }, { coefficient := -2, powers := [(19, 1), (25, 1), (46, 1), (55, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (31, 1), (54, 1), (67, 1)] }],
  ...
  [{ coefficient := -1, powers := [(2, 1), (56, 1), (58, 1), (65, 1)] }, { coefficient := 1, powers := [(2, 1), (58, 1)] }, { coefficient := 1, powers := [(8, 1), (37, 1)] }, { coefficient := -1, powers := [(19, 1), (31, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (34, 1), (58, 1)] }, { coefficient := 1, powers := [(14, 1), (25, 1), (58, 1)] }, { coefficient := 2, powers := [(14, 1), (31, 1), (49, 1)] }, { coefficient := 1, powers := [(18, 1), (21, 1), (31, 1), (38, 1), (53, 1), (61, 1)] }, { coefficient := 1, powers := [(18, 1), (21, 1), (31, 1), (38, 1), (57, 1), (61, 1)] }, { coefficient := 1, powers := [(18, 1), (24, 1), (40, 1), (61, 1)] }, { coefficient := -1, powers := [(18, 1), (25, 1), (45, 1), (55, 1)] }, { coefficient := 1, powers := [(18, 1), (29, 1), (40, 1), (61, 1)] }, { coefficient := 1, powers := [(18, 1), (31, 1), (38, 1), (48, 1), (61, 1)] }],
...
#print axioms Krenn.Component24.SelectedLeafB5_2_7.selectedHasNoCommonZero

end Krenn.Component24.SelectedLeafB5_2_7
