...
namespace Krenn.Component24.SelectedLeafB6_6_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "fd112efe12f41d99781bfb9af13d80f9b8bec08d02f8e89834d7b7a9b730687d"
...
def multipliers : Fin 21 → SparsePoly (Fin 67) := ![
  ...
  [{ coefficient := 1, powers := [(21, 1), (31, 1), (47, 1), (66, 1)] }, { coefficient := -2, powers := [(31, 1), (49, 1), (66, 1)] }],
...
#print axioms Krenn.Component24.SelectedLeafB6_6_4.selectedHasNoCommonZero

end Krenn.Component24.SelectedLeafB6_6_4
