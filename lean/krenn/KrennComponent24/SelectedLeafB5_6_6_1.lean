...
namespace Krenn.Component24.SelectedLeafB5_6_6_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "767c57d59d37d61e9d50784a9be51e5345ae9d3dc65ffbbd2a73c843146762a2"
def certificateSHA256 : String := "ba69419dfc4d3d2d99692f641534266f47b7101d72ee99e8c64ce1ccf4cde36d"
...
def multipliers : Fin 23 → SparsePoly (Fin 69) := ![
  [{ coefficient := -2, powers := [(0, 1), (31, 1), (49, 1), (62, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (24, 1), (49, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (19, 1), (51, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (49, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (2, 1), (21, 1), (55, 1), (62, 2), (68, 1)] }, { coefficient := 1, powers := [(0, 1), (18, 1), (25, 1), (55, 1), (62, 1), (68, 1)] }, { coefficient := -1, powers := [(2, 1), (20, 1), (21, 1), (55, 1), (62, 2), (68, 1)] }, { coefficient := -1, powers := [(2, 1), (21, 1), (55, 1), (62, 1), (68, 1)] }],
  ...
  [{ coefficient := 2, powers := [(0, 1), (14, 1), (31, 1), (49, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (2, 1), (21, 1), (24, 1), (55, 1), (62, 2), (68, 1)] }, { coefficient := 1, powers := [(0, 1), (5, 1), (34, 1), (62, 1)] }, { coefficient := -1, powers := [(0, 1), (14, 1), (25, 1), (62, 1)] }, { coefficient := -1, powers := [(0, 1), (18, 1), (24, 1), (25, 1), (55, 1), (62, 1), (68, 1)] }, { coefficient := 1, powers := [(2, 1), (20, 1), (21, 1), (24, 1), (55, 1), (62, 2), (68, 1)] }, { coefficient := 1, powers := [(2, 1), (21, 1), (24, 1), (55, 1), (62, 1), (68, 1)] }, { coefficient := -1, powers := [(2, 1), (21, 1), (51, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (2, 1), (49, 1), (55, 1), (62, 2)] }, { coefficient := 2, powers := [(0, 1), (18, 1), (25, 1), (47, 1), (55, 1), (62, 1)] }, { coefficient := 1, powers := [(0, 1), (18, 1), (31, 1), (49, 1), (54, 1), (62, 1)] }, { coefficient := 2, powers := [(0, 1), (19, 1), (25, 1), (42, 1), (55, 1), (62, 1)] }, { coefficient := -1, powers := [(2, 1), (20, 1), (49, 1), (55, 1), (62, 2)] }],
  [{ coefficient := -1, powers := [(0, 1), (2, 1), (21, 1), (45, 1), (55, 1), (62, 2)] }, { coefficient := -1, powers := [(0, 1), (18, 1), (25, 1), (45, 1), (55, 1), (62, 1)] }, { coefficient := 1, powers := [(2, 1), (20, 1), (21, 1), (45, 1), (55, 1), (62, 2)] }, { coefficient := 1, powers := [(2, 1), (21, 1), (45, 1), (55, 1), (62, 1)] }]
]
...
#print axioms Krenn.Component24.SelectedLeafB5_6_6_1.selectedHasNoCommonZero

end Krenn.Component24.SelectedLeafB5_6_6_1
