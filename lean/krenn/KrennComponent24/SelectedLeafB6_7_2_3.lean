...
namespace Krenn.Component24.SelectedLeafB6_7_2_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "8a9c61bc9fab6703d0c6fe44ea21da6dd8cc20e2693a775f8fd599007d6b9a2c"
...
def multipliers : Fin 22 → SparsePoly (Fin 70) := ![
  ...
  [{ coefficient := -2, powers := [(3, 1), (14, 1), (21, 1), (31, 1), (60, 1), (62, 1), (69, 1)] }, { coefficient := -1, powers := [(3, 1), (18, 1), (25, 1), (55, 1), (60, 1), (69, 1)] }],
  ...
  [{ coefficient := -1, powers := [(2, 1), (3, 1), (43, 1), (60, 1)] }, { coefficient := -1, powers := [(3, 1), (5, 1), (34, 1), (60, 1)] }, { coefficient := 2, powers := [(3, 1), (14, 1), (21, 1), (24, 1), (31, 1), (60, 1), (62, 1), (69, 1)] }, { coefficient := 1, powers := [(3, 1), (14, 1), (25, 1), (60, 1)] }, { coefficient := 1, powers := [(3, 1), (18, 1), (24, 1), (25, 1), (55, 1), (60, 1), (69, 1)] }],
...
#print axioms Krenn.Component24.SelectedLeafB6_7_2_3.selectedHasNoCommonZero

end Krenn.Component24.SelectedLeafB6_7_2_3
