...
namespace Krenn.Component24.SelectedLeafB5_3_2_4_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "18cce3b87306f4a5471ac3f8164aa1cc898bb0908f66101fc67239ef684147c4"
...
def multipliers : Fin 15 → SparsePoly (Fin 70) := ![
  [{ coefficient := 1, powers := [(25, 1), (61, 1), (68, 1)] }, { coefficient := 1, powers := [(34, 1), (49, 1), (68, 1)] }, { coefficient := 1, powers := [(37, 1), (43, 1), (68, 1)] }],
  [{ coefficient := -1, powers := [(25, 1), (45, 1), (55, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(18, 1), (55, 1)] }],
  [{ coefficient := 1, powers := [(18, 1), (25, 1), (55, 1), (62, 1)] }],
  [{ coefficient := -2, powers := [(25, 1), (61, 1), (69, 1)] }, { coefficient := 1, powers := [(25, 1)] }],
  ...
  [{ coefficient := 1, powers := [(2, 1), (43, 1)] }, { coefficient := 1, powers := [(5, 1), (34, 1)] }, { coefficient := 2, powers := [(14, 1), (25, 1), (61, 1), (69, 1)] }, { coefficient := -1, powers := [(14, 1), (25, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (60, 1), (61, 1), (68, 1)] }, { coefficient := 1, powers := [(5, 1), (61, 1)] }, { coefficient := -1, powers := [(18, 1), (48, 1), (61, 1), (68, 1)] }, { coefficient := -1, powers := [(19, 1), (48, 1), (51, 1)] }],
...
#print axioms Krenn.Component24.SelectedLeafB5_3_2_4_3.selectedHasNoCommonZero

end Krenn.Component24.SelectedLeafB5_3_2_4_3
