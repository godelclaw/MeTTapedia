...
namespace Krenn.Component24.SelectedLeafB4_3_2_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "65f4f031135fe032828ea24b2ab291549a669da2dbee57e7c73a4c75f890a518"
...
def multipliers : Fin 22 → SparsePoly (Fin 67) := ![
  ...
  [{ coefficient := -2, powers := [(3, 1), (14, 1), (21, 1), (31, 1), (60, 1), (62, 1), (66, 1)] }, { coefficient := -1, powers := [(3, 1), (18, 1), (25, 1), (55, 1), (60, 1), (66, 1)] }],
  ...
  [{ coefficient := -1, powers := [(2, 1), (3, 1), (43, 1), (60, 1)] }, { coefficient := -1, powers := [(3, 1), (5, 1), (34, 1), (60, 1)] }, { coefficient := 2, powers := [(3, 1), (14, 1), (21, 1), (24, 1), (31, 1), (60, 1), (62, 1), (66, 1)] }, { coefficient := 1, powers := [(3, 1), (14, 1), (25, 1), (60, 1)] }, { coefficient := 1, powers := [(3, 1), (18, 1), (24, 1), (25, 1), (55, 1), (60, 1), (66, 1)] }],
...
#print axioms Krenn.Component24.SelectedLeafB4_3_2_1.selectedHasNoCommonZero

end Krenn.Component24.SelectedLeafB4_3_2_1
