...
namespace Krenn.Component24.SelectedLeafB7_7_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "3ea9d5b44563dad4049a2d32f5989a7f8ffe18dbf7e520b13fff5535b446cdaf"
def certificateSHA256 : String := "4bde82b8382ead4e1a4ba69ceebd16b61c6aff146adfead95fe3f6ea574c7bb9"
...
def multipliers : Fin 29 → SparsePoly (Fin 69) := ![
  ...
  [{ coefficient := -2, powers := [(31, 1), (49, 1), (68, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (22, 1), (49, 1), (63, 1)] }, { coefficient := 2, powers := [(19, 1), (22, 1), (25, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (49, 1)] }],
  [{ coefficient := -1, powers := [(21, 1), (31, 1), (38, 1), (53, 1), (61, 1), (68, 1)] }, { coefficient := -1, powers := [(24, 1), (40, 1), (61, 1), (68, 1)] }, { coefficient := 1, powers := [(25, 1), (45, 1), (55, 1), (68, 1)] }, { coefficient := 1, powers := [(26, 1), (31, 1), (49, 1), (54, 1), (68, 1)] }, { coefficient := -1, powers := [(29, 1), (40, 1), (61, 1), (68, 1)] }, { coefficient := -1, powers := [(31, 1), (38, 1), (48, 1), (61, 1), (68, 1)] }, { coefficient := -1, powers := [(31, 1), (43, 1), (47, 1), (66, 1), (68, 1)] }],
  [{ coefficient := 1, powers := [(18, 1), (38, 1), (61, 1)] }, { coefficient := -1, powers := [(19, 1), (51, 1)] }],
  [{ coefficient := -2, powers := [(19, 1), (43, 1), (65, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (49, 1), (63, 1)] }, { coefficient := -2, powers := [(19, 1), (25, 1), (63, 1)] }],
  [{ coefficient := 2, powers := [(19, 1), (43, 1), (46, 1), (65, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(18, 1), (55, 1)] }],
  [{ coefficient := -2, powers := [(19, 1), (43, 1), (66, 1)] }],
  ...
  [{ coefficient := -2, powers := [(19, 1), (31, 1), (43, 1), (46, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (37, 1), (43, 1)] }, { coefficient := 1, powers := [(19, 1), (31, 1), (43, 1)] }],
  [{ coefficient := 2, powers := [(14, 1), (31, 1), (49, 1)] }, { coefficient := 1, powers := [(18, 1), (21, 1), (31, 1), (38, 1), (53, 1), (61, 1)] }, { coefficient := 1, powers := [(18, 1), (24, 1), (40, 1), (61, 1)] }, { coefficient := -1, powers := [(18, 1), (25, 1), (45, 1), (55, 1)] }, { coefficient := -1, powers := [(18, 1), (26, 1), (31, 1), (49, 1), (54, 1)] }, { coefficient := 1, powers := [(18, 1), (29, 1), (40, 1), (61, 1)] }, { coefficient := 1, powers := [(18, 1), (31, 1), (38, 1), (48, 1), (61, 1)] }, { coefficient := 1, powers := [(18, 1), (31, 1), (43, 1), (47, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(18, 1), (21, 1), (31, 1), (38, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (42, 1), (43, 1), (66, 1)] }, { coefficient := 1, powers := [(2, 1), (43, 1)] }, { coefficient := 1, powers := [(5, 1), (34, 1)] }, { coefficient := -1, powers := [(14, 1), (25, 1)] }, { coefficient := -1, powers := [(18, 1), (30, 1), (43, 1), (66, 1)] }]
]
...
#print axioms Krenn.Component24.SelectedLeafB7_7_4.selectedHasNoCommonZero

end Krenn.Component24.SelectedLeafB7_7_4
