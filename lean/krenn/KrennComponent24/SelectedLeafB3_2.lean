...
namespace Krenn.Component24.SelectedLeafB3_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "a94a05a6577b003e41d1b718181c043e987aa536e103ed7d6d6d6ff888ca2b74"
def certificateSHA256 : String := "b70f620d1ad6c2b85ff66badc61a576e22c31ad9cc8a521c933f692fe6fe62c1"
...
def multipliers : Fin 33 → SparsePoly (Fin 65) := ![
  [{ coefficient := 1, powers := [(2, 1), (20, 1), (29, 1), (40, 1), (50, 1), (61, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (49, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (20, 1), (24, 1), (40, 1), (50, 1), (61, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(14, 1), (24, 1), (53, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (51, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (3, 1), (56, 1), (61, 1)] }, { coefficient := 1, powers := [(2, 1), (15, 1), (38, 1), (61, 1)] }, { coefficient := -1, powers := [(2, 1), (38, 1), (44, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (3, 1), (50, 1), (61, 1)] }, { coefficient := 1, powers := [(2, 1), (9, 1), (38, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (3, 1), (26, 1), (61, 1), (62, 1)] }],
  ...
  [{ coefficient := -1, powers := [(2, 1), (20, 1), (40, 1), (50, 1), (61, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (20, 1), (40, 1), (61, 1)] }],
  ...
  [{ coefficient := 1, powers := [(2, 1), (38, 1), (40, 1), (59, 1), (61, 1)] }, { coefficient := -1, powers := [(5, 1), (34, 1), (42, 1), (58, 1)] }, { coefficient := -1, powers := [(5, 1), (37, 1), (46, 1), (55, 1)] }, { coefficient := 1, powers := [(14, 1), (25, 1), (42, 1), (58, 1)] }, { coefficient := 1, powers := [(14, 1), (31, 1), (49, 1), (53, 1)] }, { coefficient := 1, powers := [(19, 1), (25, 1), (46, 1), (55, 1)] }, { coefficient := -1, powers := [(19, 1), (31, 1), (48, 1), (51, 1), (53, 1)] }, { coefficient := 1, powers := [(19, 1), (31, 1), (48, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (3, 1), (26, 1), (40, 1), (59, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (20, 1), (40, 1), (44, 1), (50, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (2, 1), (40, 1), (56, 1), (61, 1)] }, { coefficient := 1, powers := [(2, 1), (6, 1), (35, 1), (40, 1), (61, 1)] }, { coefficient := 1, powers := [(2, 1), (15, 1), (26, 1), (40, 1), (61, 1)] }, { coefficient := -1, powers := [(2, 1), (26, 1), (40, 1), (44, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (19, 1), (31, 1), (57, 1)] }, { coefficient := 1, powers := [(2, 1), (58, 1)] }, { coefficient := 1, powers := [(8, 1), (37, 1)] }]
]
...
#print axioms Krenn.Component24.SelectedLeafB3_2.selectedHasNoCommonZero

end Krenn.Component24.SelectedLeafB3_2
