...
namespace Krenn.Component24.SelectedLeafB7_2_2_4_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "259b99efc0f74dba9d7ee857da2ea303e9c10266b4ee398dc3b0d747ac26fd86"
...
def multipliers : Fin 15 → SparsePoly (Fin 70) := ![
  [{ coefficient := -1, powers := [(25, 1), (61, 1), (68, 1)] }],
  ...
  [{ coefficient := -1, powers := [(5, 1), (60, 1), (61, 1), (68, 1)] }, { coefficient := 1, powers := [(5, 1), (61, 1)] }, { coefficient := -1, powers := [(14, 1), (49, 1)] }, { coefficient := -1, powers := [(18, 1), (48, 1), (61, 1), (68, 1)] }, { coefficient := -1, powers := [(19, 1), (48, 1), (51, 1)] }],
...
#print axioms Krenn.Component24.SelectedLeafB7_2_2_4_3.selectedHasNoCommonZero

end Krenn.Component24.SelectedLeafB7_2_2_4_3
