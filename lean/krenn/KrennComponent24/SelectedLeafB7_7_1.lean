...
namespace Krenn.Component24.SelectedLeafB7_7_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "a28709269c685220a0d249b271093a462ca544057920c836029bb91f051a4f18"
...
def multipliers : Fin 7 → SparsePoly (Fin 69) := ![
  [{ coefficient := 1, powers := [(48, 1), (54, 1), (67, 1), (68, 1)] }],
  [{ coefficient := -1, powers := [(54, 1), (67, 1), (68, 1)] }],
  [{ coefficient := -1, powers := [(48, 1), (67, 1)] }],
  [{ coefficient := 1, powers := [(67, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := -1, powers := [(0, 1), (43, 1), (67, 1)] }, { coefficient := 1, powers := [(20, 1), (48, 1), (51, 1), (67, 1)] }, { coefficient := -1, powers := [(21, 1), (51, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(20, 1), (48, 1), (54, 1), (67, 1)] }, { coefficient := 1, powers := [(21, 1), (54, 1), (67, 1)] }]
]
...
#print axioms Krenn.Component24.SelectedLeafB7_7_1.selectedHasNoCommonZero

end Krenn.Component24.SelectedLeafB7_7_1
