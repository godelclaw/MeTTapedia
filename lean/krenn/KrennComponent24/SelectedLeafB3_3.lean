...
namespace Krenn.Component24.SelectedLeafB3_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "96025d589c755c717a7794f6a4c0193f27e9db5caf7d99c6000990e8802c1a76"
...
def multipliers : Fin 15 → SparsePoly (Fin 66) := ![
  [{ coefficient := -1, powers := [(25, 1), (51, 1), (53, 1), (63, 1), (65, 1)] }, { coefficient := -1, powers := [(25, 1), (51, 1), (57, 1), (63, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(21, 1), (29, 1), (63, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(18, 1), (26, 1), (51, 1), (63, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(21, 1), (63, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(30, 1), (51, 1), (63, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(25, 1), (51, 1), (63, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(26, 1), (30, 1), (51, 1), (63, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (21, 1), (63, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(18, 1), (26, 1), (30, 1), (51, 1), (63, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(63, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(29, 1), (63, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (63, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (21, 1), (46, 1), (54, 1), (63, 1), (65, 1)] }, { coefficient := -1, powers := [(2, 1), (43, 1), (57, 1), (63, 1), (65, 1)] }, { coefficient := -1, powers := [(2, 1), (48, 1), (54, 1), (63, 1), (65, 1)] }, { coefficient := 1, powers := [(18, 1), (26, 1), (30, 1), (48, 1), (51, 1), (53, 1), (63, 1), (65, 1)] }],
...
#print axioms Krenn.Component24.SelectedLeafB3_3.selectedHasNoCommonZero

end Krenn.Component24.SelectedLeafB3_3
