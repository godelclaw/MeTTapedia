...
namespace Krenn.Component24.SelectedLeafB4_2_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "26f8997c354e75dd665ac6b8d55d4176fd0c70fb9613eadc063a6469bd3d163f"
def certificateSHA256 : String := "090630a00a472c2ef5f14ab833cfeb140f76f5f31bedae19a73288be476f0520"
...
def multipliers : Fin 21 → SparsePoly (Fin 66) := ![
  [{ coefficient := -2, powers := [(25, 1), (58, 1), (64, 1)] }, { coefficient := -2, powers := [(31, 1), (49, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(25, 1), (45, 1), (55, 1), (64, 1)] }, { coefficient := 1, powers := [(31, 1), (49, 1), (51, 1), (64, 1)] }],
  [{ coefficient := -2, powers := [(19, 1), (25, 1), (46, 1), (55, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (31, 1), (54, 1), (65, 1)] }],
  ...
  [{ coefficient := -1, powers := [(2, 1), (56, 1), (58, 1), (64, 1)] }, { coefficient := 1, powers := [(2, 1), (58, 1)] }, { coefficient := 1, powers := [(8, 1), (37, 1)] }, { coefficient := -1, powers := [(19, 1), (31, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (34, 1), (58, 1)] }, { coefficient := 1, powers := [(14, 1), (25, 1), (58, 1)] }, { coefficient := 2, powers := [(14, 1), (31, 1), (49, 1)] }, { coefficient := -1, powers := [(18, 1), (25, 1), (45, 1), (55, 1)] }, { coefficient := -1, powers := [(18, 1), (31, 1), (49, 1), (51, 1)] }],
  [{ coefficient := 2, powers := [(19, 1), (20, 1), (25, 1), (46, 1), (55, 1)] }, { coefficient := 1, powers := [(19, 1), (21, 1), (31, 1), (54, 1)] }]
]
...
#print axioms Krenn.Component24.SelectedLeafB4_2_5.selectedHasNoCommonZero

end Krenn.Component24.SelectedLeafB4_2_5
