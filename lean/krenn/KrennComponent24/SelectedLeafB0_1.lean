...
namespace Krenn.Component24.SelectedLeafB0_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "dad1c31efdcad49cb498ae7504adb52756fbda1c680639876d95ad99e911116a"
def certificateSHA256 : String := "582500156ad71a5ca44a762389687a085d81dc5094538bd3d879e5b87c9cb9cb"
...
def multipliers : Fin 7 → SparsePoly (Fin 63) := ![
  ...
  [{ coefficient := 1, powers := [(21, 1), (51, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(21, 1), (39, 1), (51, 1), (60, 1), (62, 1)] }, { coefficient := -1, powers := [(21, 1), (46, 1), (51, 1), (53, 1), (62, 1)] }, { coefficient := 1, powers := [(21, 1), (46, 1), (54, 1), (62, 1)] }, { coefficient := -1, powers := [(43, 1), (57, 1), (62, 1)] }, { coefficient := 1, powers := [(48, 1), (51, 1), (53, 1), (62, 1)] }, { coefficient := -1, powers := [(48, 1), (54, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (21, 1), (51, 1), (57, 1), (62, 1)] }, { coefficient := -1, powers := [(21, 1), (51, 1), (62, 1)] }],
...
#print axioms Krenn.Component24.SelectedLeafB0_1.selectedHasNoCommonZero

end Krenn.Component24.SelectedLeafB0_1
