...
namespace Krenn.Component24.SelectedLeafB5_2_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "851ac9b584fb94354a917126994c768eeed4b636018e757fe5666397d4e7a806"
...
def multipliers : Fin 25 → SparsePoly (Fin 67) := ![
  ...
  [{ coefficient := -1, powers := [(21, 1), (31, 1), (38, 1), (53, 1), (61, 1), (65, 1)] }, { coefficient := -1, powers := [(24, 1), (40, 1), (61, 1), (65, 1)] }, { coefficient := 1, powers := [(25, 1), (45, 1), (55, 1), (65, 1)] }, { coefficient := -1, powers := [(29, 1), (40, 1), (61, 1), (65, 1)] }, { coefficient := -1, powers := [(31, 1), (38, 1), (48, 1), (61, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (46, 1), (49, 1), (55, 1), (66, 1)] }, { coefficient := -2, powers := [(19, 1), (25, 1), (46, 1), (55, 1), (66, 1)] }],
...
#print axioms Krenn.Component24.SelectedLeafB5_2_5.selectedHasNoCommonZero

end Krenn.Component24.SelectedLeafB5_2_5
