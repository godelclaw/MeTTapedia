...
namespace Krenn.Component24.SelectedLeafB7_2_2_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "b911cff1cf3b181c43cbfcf817340374e3887deb2cb3e94132faf353a942b3e1"
...
def multipliers : Fin 21 → SparsePoly (Fin 69) := ![
  ...
  [{ coefficient := 1, powers := [(0, 1), (2, 1), (21, 1), (55, 1), (62, 2), (68, 1)] }, { coefficient := 2, powers := [(0, 1), (14, 1), (21, 1), (31, 1), (62, 2), (68, 1)] }, { coefficient := 1, powers := [(0, 1), (18, 1), (25, 1), (55, 1), (62, 1), (68, 1)] }, { coefficient := -1, powers := [(2, 1), (20, 1), (21, 1), (55, 1), (62, 2), (68, 1)] }, { coefficient := -1, powers := [(2, 1), (21, 1), (55, 1), (62, 1), (68, 1)] }],
  ...
  [{ coefficient := -1, powers := [(0, 1), (2, 1), (21, 1), (24, 1), (55, 1), (62, 2), (68, 1)] }, { coefficient := 1, powers := [(0, 1), (5, 1), (34, 1), (62, 1)] }, { coefficient := -2, powers := [(0, 1), (14, 1), (21, 1), (24, 1), (31, 1), (62, 2), (68, 1)] }, { coefficient := -1, powers := [(0, 1), (14, 1), (25, 1), (62, 1)] }, { coefficient := -1, powers := [(0, 1), (18, 1), (24, 1), (25, 1), (55, 1), (62, 1), (68, 1)] }, { coefficient := 1, powers := [(2, 1), (20, 1), (21, 1), (24, 1), (55, 1), (62, 2), (68, 1)] }, { coefficient := 1, powers := [(2, 1), (21, 1), (24, 1), (55, 1), (62, 1), (68, 1)] }, { coefficient := -1, powers := [(2, 1), (21, 1), (51, 1), (62, 1)] }],
...
#print axioms Krenn.Component24.SelectedLeafB7_2_2_3.selectedHasNoCommonZero

end Krenn.Component24.SelectedLeafB7_2_2_3
