...
namespace Krenn.Component24.SelectedLeafB4_2_2_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "d0292b52ede88987f9c361c84c28ceb9737634948e2f6613fb0eb35a434cdca8"
...
def multipliers : Fin 20 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := 2, powers := [(14, 1), (21, 1), (31, 1), (62, 1), (65, 1)] }, { coefficient := 1, powers := [(18, 1), (25, 1), (55, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(18, 1), (55, 1)] }],
  ...
  [{ coefficient := 1, powers := [(2, 1), (43, 1)] }, { coefficient := 1, powers := [(5, 1), (34, 1)] }, { coefficient := -2, powers := [(14, 1), (21, 1), (24, 1), (31, 1), (62, 1), (65, 1)] }, { coefficient := -1, powers := [(14, 1), (25, 1)] }, { coefficient := -1, powers := [(18, 1), (24, 1), (25, 1), (55, 1), (65, 1)] }],
...
#print axioms Krenn.Component24.SelectedLeafB4_2_2_1.selectedHasNoCommonZero

end Krenn.Component24.SelectedLeafB4_2_2_1
