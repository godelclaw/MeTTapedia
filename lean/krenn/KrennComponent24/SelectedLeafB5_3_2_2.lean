...
namespace Krenn.Component24.SelectedLeafB5_3_2_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "9ecea76e88fb17666685bece4bbfd809b07e339bdedcb392faabfad8c86073e6"
def certificateSHA256 : String := "61da00a0f8587a647db2dcfa15c2e4fbc6ccec4346f3ae3b0814bf6e06c13be0"
...
def multipliers : Fin 22 → SparsePoly (Fin 68) := ![
  ...
  [{ coefficient := 1, powers := [(5, 1), (38, 1), (60, 1), (61, 1)] }, { coefficient := 1, powers := [(5, 1), (61, 1)] }, { coefficient := -1, powers := [(14, 1), (49, 1)] }, { coefficient := 1, powers := [(18, 1), (38, 1), (48, 1), (61, 1)] }, { coefficient := -1, powers := [(18, 1), (43, 1), (47, 1), (64, 1)] }, { coefficient := -1, powers := [(19, 1), (42, 1), (43, 1), (64, 1)] }, { coefficient := -1, powers := [(19, 1), (48, 1), (51, 1)] }]
]
...
#print axioms Krenn.Component24.SelectedLeafB5_3_2_2.selectedHasNoCommonZero

end Krenn.Component24.SelectedLeafB5_3_2_2
