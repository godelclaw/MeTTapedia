...
namespace Krenn.Component24.SelectedLeafB5_7_2_4_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "ecb96b6414a023edd912e3f6f106c9f8bfd5a10e106df557988b2db1d2fae499"
...
def multipliers : Fin 15 → SparsePoly (Fin 72) := ![
  [{ coefficient := 1, powers := [(37, 1), (43, 1), (69, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (49, 1)] }],
  [{ coefficient := -1, powers := [(37, 1), (52, 1), (55, 1), (69, 1)] }],
  [{ coefficient := 1, powers := [(37, 1), (55, 1), (69, 1)] }],
  [{ coefficient := -1, powers := [(25, 1), (61, 1), (71, 1)] }, { coefficient := 1, powers := [(25, 1)] }],
  [{ coefficient := 1, powers := [(14, 1)] }],
  [{ coefficient := 1, powers := [(61, 1), (69, 1)] }],
  [{ coefficient := 1, powers := [(49, 1)] }],
  [{ coefficient := 1, powers := [(19, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := 1, powers := [(18, 1), (21, 1), (37, 1), (52, 1), (55, 1), (69, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (43, 1)] }, { coefficient := 1, powers := [(5, 1), (34, 1)] }, { coefficient := 1, powers := [(14, 1), (25, 1), (61, 1), (71, 1)] }, { coefficient := -1, powers := [(14, 1), (25, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (59, 1), (61, 1), (69, 1)] }, { coefficient := 1, powers := [(5, 1), (61, 1)] }, { coefficient := -1, powers := [(14, 1), (49, 1)] }, { coefficient := -1, powers := [(19, 1), (48, 1), (51, 1)] }],
...
#print axioms Krenn.Component24.SelectedLeafB5_7_2_4_7.selectedHasNoCommonZero

end Krenn.Component24.SelectedLeafB5_7_2_4_7
