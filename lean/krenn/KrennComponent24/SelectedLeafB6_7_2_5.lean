...
namespace Krenn.Component24.SelectedLeafB6_7_2_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "bd208697a47e8f0c66aa220d4380a3982b2d4d7fff69a69d49a619a668428a73"
...
def multipliers : Fin 33 → SparsePoly (Fin 70) := ![
  ...
  [{ coefficient := -1, powers := [(0, 1), (1, 1), (50, 1), (63, 1), (69, 1)] }, { coefficient := -1, powers := [(0, 1), (10, 1), (27, 1), (63, 1), (69, 1)] }, { coefficient := -1, powers := [(0, 1), (50, 1), (69, 1)] }, { coefficient := -1, powers := [(20, 1), (50, 1), (69, 1)] }, { coefficient := -1, powers := [(26, 1), (41, 1), (69, 1)] }, { coefficient := -1, powers := [(26, 1), (50, 1), (69, 1)] }, { coefficient := -1, powers := [(32, 1), (38, 1), (69, 1)] }],
  ...
  [{ coefficient := 1, powers := [(6, 1), (35, 1), (69, 1)] }, { coefficient := 1, powers := [(15, 1), (26, 1), (69, 1)] }],
  [{ coefficient := 1, powers := [(20, 1), (50, 1), (54, 1), (66, 1)] }, { coefficient := -1, powers := [(32, 1), (38, 1), (54, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(9, 1), (21, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(3, 1), (18, 1), (25, 1), (26, 1), (55, 1), (59, 1), (69, 1)] }, { coefficient := 1, powers := [(9, 1), (18, 1), (25, 1), (35, 1), (38, 1), (55, 1), (69, 1)] }, { coefficient := -1, powers := [(18, 1), (25, 1), (35, 1), (38, 1), (50, 1), (55, 1), (69, 1)] }],
  ...
  [{ coefficient := 1, powers := [(2, 1), (3, 1), (26, 1), (43, 1), (59, 1)] }, { coefficient := 1, powers := [(2, 1), (9, 1), (35, 1), (38, 1), (43, 1)] }, { coefficient := -1, powers := [(2, 1), (35, 1), (38, 1), (43, 1), (50, 1)] }, { coefficient := 1, powers := [(3, 1), (5, 1), (26, 1), (34, 1), (59, 1)] }, { coefficient := 1, powers := [(3, 1), (14, 1), (25, 1), (26, 1), (59, 1)] }, { coefficient := -1, powers := [(3, 1), (18, 1), (24, 1), (25, 1), (26, 1), (55, 1), (59, 1), (69, 1)] }, { coefficient := 1, powers := [(5, 1), (9, 1), (34, 1), (35, 1), (38, 1)] }, { coefficient := -1, powers := [(5, 1), (34, 1), (35, 1), (38, 1), (50, 1)] }, { coefficient := -1, powers := [(9, 1), (18, 1), (24, 1), (25, 1), (35, 1), (38, 1), (55, 1), (69, 1)] }, { coefficient := 1, powers := [(18, 1), (24, 1), (25, 1), (35, 1), (38, 1), (50, 1), (55, 1), (69, 1)] }],
...
#print axioms Krenn.Component24.SelectedLeafB6_7_2_5.selectedHasNoCommonZero

end Krenn.Component24.SelectedLeafB6_7_2_5
