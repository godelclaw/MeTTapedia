...
namespace Krenn.Component24.SelectedLeafB4_6_2_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "a988c84f8d7c66fe4ca2ea9c5daaad5ec09c477aad1c37b02601d836fc36f731"
...
def multipliers : Fin 20 → SparsePoly (Fin 68) := ![
  ...
  [{ coefficient := 2, powers := [(14, 1), (21, 1), (31, 1), (62, 1), (67, 1)] }, { coefficient := 1, powers := [(18, 1), (25, 1), (55, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(18, 1), (55, 1)] }],
  ...
  [{ coefficient := 1, powers := [(2, 1), (43, 1)] }, { coefficient := 1, powers := [(5, 1), (34, 1)] }, { coefficient := -2, powers := [(14, 1), (21, 1), (24, 1), (31, 1), (62, 1), (67, 1)] }, { coefficient := -1, powers := [(14, 1), (25, 1)] }, { coefficient := -1, powers := [(18, 1), (24, 1), (25, 1), (55, 1), (67, 1)] }],
...
#print axioms Krenn.Component24.SelectedLeafB4_6_2_3.selectedHasNoCommonZero

end Krenn.Component24.SelectedLeafB4_6_2_3
