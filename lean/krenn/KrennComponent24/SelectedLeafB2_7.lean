...
namespace Krenn.Component24.SelectedLeafB2_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "1d5fc0f093d81f2163b90d68b4a5af982ca004b70df168624b4bae59467b7c46"
def certificateSHA256 : String := "9587d2a9fb2871149e61f5a35c21466194bee58e79ddb8db6a38879635c1631a"
...
def multipliers : Fin 28 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := 1, powers := [(5, 1), (61, 1), (63, 1), (64, 1)] }, { coefficient := -1, powers := [(19, 1), (43, 1), (63, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (46, 1), (61, 1), (63, 1), (64, 1)] }, { coefficient := 1, powers := [(19, 1), (43, 1), (46, 1), (63, 1), (64, 1)] }],
  ...
  [{ coefficient := 1, powers := [(5, 1), (61, 1), (64, 1)] }, { coefficient := -1, powers := [(19, 1), (43, 1), (64, 1)] }],
  ...
  [{ coefficient := -1, powers := [(26, 1), (49, 1), (53, 1), (55, 1)] }, { coefficient := -1, powers := [(26, 1), (49, 1), (55, 1), (57, 1)] }, { coefficient := 1, powers := [(40, 1), (61, 1)] }, { coefficient := -1, powers := [(41, 1), (43, 1), (58, 1), (63, 1)] }, { coefficient := 1, powers := [(43, 1), (58, 1)] }, { coefficient := 1, powers := [(49, 1), (55, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (31, 1), (46, 1), (61, 1), (64, 1)] }, { coefficient := -1, powers := [(8, 1), (37, 1), (43, 1)] }, { coefficient := -1, powers := [(19, 1), (31, 1), (43, 1), (46, 1), (64, 1)] }, { coefficient := -1, powers := [(19, 1), (31, 1), (43, 1)] }],
...
#print axioms Krenn.Component24.SelectedLeafB2_7.selectedHasNoCommonZero

end Krenn.Component24.SelectedLeafB2_7
