...
namespace Krenn.Component24.SelectedLeafB7_3_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "de9a9cd1aba9e0ca0f096ba5ee63753769aa543dd4915c067f492e23fe0db40b"
def certificateSHA256 : String := "4d51db36b678ddc94237e33b5459f8082e5b5e13a06084f87319117d47c2a69e"
...
def selectedEquations : Fin 25 → SparsePoly (Fin 68) := ![
  ...
  [{ coefficient := 1, powers := [(0, 1), (40, 1), (60, 1)] }],
...
def multipliers : Fin 25 → SparsePoly (Fin 68) := ![
  [{ coefficient := 2, powers := [(3, 1), (25, 1), (61, 1)] }, { coefficient := 1, powers := [(24, 1), (43, 1), (47, 1), (65, 1)] }],
  ...
  [{ coefficient := 2, powers := [(2, 1), (3, 1), (61, 1), (62, 1)] }],
  ...
  [{ coefficient := -1, powers := [(43, 1), (47, 1), (65, 1)] }],
  ...
  [{ coefficient := -2, powers := [(2, 1), (3, 1), (40, 1), (60, 1), (61, 1)] }],
  ...
  [{ coefficient := -1, powers := [(1, 1), (2, 1), (43, 1), (63, 1)] }, { coefficient := -1, powers := [(2, 1), (42, 1), (43, 1), (65, 1)] }, { coefficient := 1, powers := [(2, 1), (43, 1)] }, { coefficient := 1, powers := [(5, 1), (34, 1)] }, { coefficient := -1, powers := [(14, 1), (21, 1), (24, 1), (42, 1)] }, { coefficient := 1, powers := [(14, 1), (21, 1), (30, 1)] }, { coefficient := -1, powers := [(14, 1), (25, 1)] }, { coefficient := -1, powers := [(18, 1), (30, 1), (43, 1), (65, 1)] }]
]
...
#print axioms Krenn.Component24.SelectedLeafB7_3_2.selectedHasNoCommonZero

end Krenn.Component24.SelectedLeafB7_3_2
