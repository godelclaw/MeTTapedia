...
namespace Krenn.Component24.SelectedLeafB5_7_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "a233227a8b265c5c5f5baf812da854f61ab4495d423b838e9d1b6d4366d8e68b"
...
def multipliers : Fin 5 → SparsePoly (Fin 68) := ![
  [{ coefficient := -1, powers := [(30, 1), (63, 1), (65, 1), (67, 1)] }],
  [{ coefficient := 1, powers := [(63, 1), (65, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(42, 1), (56, 1), (65, 1), (67, 1)] }],
...
#print axioms Krenn.Component24.SelectedLeafB5_7_4.selectedHasNoCommonZero

end Krenn.Component24.SelectedLeafB5_7_4
