...
namespace Krenn.Component24.SelectedLeafB2_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "30fa641ff0228d9c02b761ab9da6be5b5442142d75a2373bce500e3feb56e72b"
def certificateSHA256 : String := "784f46931d0a738d32ce7f661fbd2f46d29555e92718627a4a1dcea7354b4111"
...
def multipliers : Fin 27 → SparsePoly (Fin 65) := ![
  [{ coefficient := -2, powers := [(24, 1), (26, 1), (49, 1), (54, 1)] }, { coefficient := 2, powers := [(24, 1), (49, 1), (51, 1)] }, { coefficient := 2, powers := [(29, 1), (49, 1), (51, 1)] }, { coefficient := 2, powers := [(34, 1), (38, 1), (49, 1)] }],
  [{ coefficient := -2, powers := [(24, 1), (26, 1), (49, 1), (57, 1)] }, { coefficient := 3, powers := [(24, 1), (49, 1)] }],
  [{ coefficient := 1, powers := [(21, 1), (24, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (51, 1)] }],
  [{ coefficient := -2, powers := [(31, 1), (49, 1), (53, 1)] }],
  [{ coefficient := 2, powers := [(31, 1), (49, 1), (51, 1), (53, 1)] }],
  [{ coefficient := -2, powers := [(18, 1), (26, 1), (49, 1), (53, 1)] }, { coefficient := -2, powers := [(18, 1), (49, 1)] }],
  ...
  [{ coefficient := 2, powers := [(26, 1), (49, 1), (54, 1)] }],
  [{ coefficient := 2, powers := [(31, 1), (49, 1)] }],
  [{ coefficient := -1, powers := [(31, 1), (54, 1)] }],
  [{ coefficient := 1, powers := [(18, 1), (31, 1), (54, 1)] }],
  [{ coefficient := 1, powers := [(25, 1)] }],
  [{ coefficient := -2, powers := [(26, 1), (31, 1), (49, 1)] }],
  [{ coefficient := 1, powers := [(14, 1)] }],
  [{ coefficient := 2, powers := [(26, 1), (49, 1), (53, 1)] }, { coefficient := 2, powers := [(26, 1), (49, 1), (57, 1)] }, { coefficient := -1, powers := [(49, 1)] }],
  [{ coefficient := 1, powers := [(31, 1)] }],
  [{ coefficient := -2, powers := [(8, 1), (49, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(19, 1)] }],
  [{ coefficient := 2, powers := [(8, 1), (34, 1), (49, 1)] }],
  [{ coefficient := -2, powers := [(8, 1), (26, 1), (34, 1), (49, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := -1, powers := [(5, 1), (34, 1), (42, 1), (58, 1)] }, { coefficient := -1, powers := [(5, 1), (37, 1), (46, 1), (55, 1)] }, { coefficient := 2, powers := [(8, 1), (26, 1), (34, 1), (39, 1), (49, 1), (60, 1)] }, { coefficient := 2, powers := [(8, 1), (26, 1), (34, 1), (42, 1), (49, 1), (57, 1)] }, { coefficient := 2, powers := [(8, 1), (26, 1), (34, 1), (46, 1), (49, 1), (53, 1)] }, { coefficient := -2, powers := [(8, 1), (34, 1), (46, 1), (49, 1)] }, { coefficient := 1, powers := [(14, 1), (25, 1), (42, 1), (58, 1)] }, { coefficient := -1, powers := [(18, 1), (31, 1), (49, 1), (54, 1)] }, { coefficient := 1, powers := [(19, 1), (25, 1), (46, 1), (55, 1)] }],
  [{ coefficient := -2, powers := [(26, 1), (49, 1), (53, 1), (55, 1)] }, { coefficient := -2, powers := [(26, 1), (49, 1), (55, 1), (57, 1)] }, { coefficient := 1, powers := [(40, 1), (61, 1)] }, { coefficient := 2, powers := [(49, 1), (55, 1)] }],
...
#print axioms Krenn.Component24.SelectedLeafB2_6.selectedHasNoCommonZero

end Krenn.Component24.SelectedLeafB2_6
