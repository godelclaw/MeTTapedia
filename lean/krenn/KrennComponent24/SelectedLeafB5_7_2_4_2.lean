...
namespace Krenn.Component24.SelectedLeafB5_7_2_4_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "13acfc71d79b44cee1cd09f06ccffc63615456f8c88910eabfa3457ac7ea6e1e"
...
def multipliers : Fin 25 → SparsePoly (Fin 70) := ![
  [{ coefficient := -1, powers := [(3, 1), (9, 1), (35, 1), (37, 1), (43, 1), (69, 1)] }, { coefficient := 1, powers := [(3, 1), (35, 1), (37, 1), (43, 1), (50, 1), (69, 1)] }, { coefficient := 1, powers := [(6, 1), (35, 1), (37, 1), (41, 1), (43, 1), (69, 1)] }],
...
#print axioms Krenn.Component24.SelectedLeafB5_7_2_4_2.selectedHasNoCommonZero

end Krenn.Component24.SelectedLeafB5_7_2_4_2
