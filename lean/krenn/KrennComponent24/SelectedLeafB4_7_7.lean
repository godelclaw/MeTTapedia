...
namespace Krenn.Component24.SelectedLeafB4_7_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "9f35a33a5f39ea1e1b8f48d09862b0ccd86bbb23195cfe8f993f5e7ad4a0c0a3"
...
def multipliers : Fin 25 → SparsePoly (Fin 69) := ![
  [{ coefficient := 2, powers := [(19, 1), (31, 1), (43, 1), (63, 1), (68, 1)] }],
  ...
  [{ coefficient := 1, powers := [(40, 1), (61, 1)] }, { coefficient := -1, powers := [(41, 1), (43, 1), (58, 1), (63, 1)] }, { coefficient := -1, powers := [(43, 1), (56, 1), (58, 1), (66, 1)] }, { coefficient := 1, powers := [(43, 1), (58, 1)] }, { coefficient := -1, powers := [(49, 1), (55, 1)] }],
  ...
  [{ coefficient := -2, powers := [(9, 1), (19, 1), (31, 1), (43, 1), (63, 1)] }, { coefficient := 2, powers := [(19, 1), (20, 1), (25, 1), (46, 1), (55, 1)] }, { coefficient := 1, powers := [(19, 1), (21, 1), (31, 1), (54, 1)] }]
]
...
#print axioms Krenn.Component24.SelectedLeafB4_7_7.selectedHasNoCommonZero

end Krenn.Component24.SelectedLeafB4_7_7
