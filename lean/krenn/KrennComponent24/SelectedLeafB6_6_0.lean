...
namespace Krenn.Component24.SelectedLeafB6_6_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "1f2f9471de067fd1d947acaafed9fc55df612a37207054454baa4101281c2676"
def certificateSHA256 : String := "e60fac240869c4e9875837e51a6467fd891d22d88c9cc36e0e6e97498cfb5bbd"
...
def multipliers : Fin 22 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := 1, powers := [(31, 1), (49, 1), (51, 1), (62, 1)] }, { coefficient := 2, powers := [(31, 1), (49, 1), (54, 1)] }],
  ...
  [{ coefficient := 2, powers := [(14, 1), (20, 1), (31, 1), (49, 1)] }, { coefficient := 1, powers := [(14, 1), (26, 1), (31, 1), (49, 1)] }],
...
#print axioms Krenn.Component24.SelectedLeafB6_6_0.selectedHasNoCommonZero

end Krenn.Component24.SelectedLeafB6_6_0
