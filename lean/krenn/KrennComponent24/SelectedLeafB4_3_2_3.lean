...
namespace Krenn.Component24.SelectedLeafB4_3_2_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "0a4a28ea3dc83a8d66828aa4caf475b5c32ba0e1058b5825b4ea14fb4b6fb959"
...
def multipliers : Fin 22 → SparsePoly (Fin 68) := ![
  ...
  [{ coefficient := -2, powers := [(3, 1), (14, 1), (21, 1), (31, 1), (60, 1), (62, 1), (67, 1)] }, { coefficient := -1, powers := [(3, 1), (18, 1), (25, 1), (55, 1), (60, 1), (67, 1)] }],
  ...
  [{ coefficient := -1, powers := [(2, 1), (3, 1), (43, 1), (60, 1)] }, { coefficient := -1, powers := [(3, 1), (5, 1), (34, 1), (60, 1)] }, { coefficient := 2, powers := [(3, 1), (14, 1), (21, 1), (24, 1), (31, 1), (60, 1), (62, 1), (67, 1)] }, { coefficient := 1, powers := [(3, 1), (14, 1), (25, 1), (60, 1)] }, { coefficient := 1, powers := [(3, 1), (18, 1), (24, 1), (25, 1), (55, 1), (60, 1), (67, 1)] }],
...
#print axioms Krenn.Component24.SelectedLeafB4_3_2_3.selectedHasNoCommonZero

end Krenn.Component24.SelectedLeafB4_3_2_3
