...
namespace Krenn.Component24.SelectedLeafB2_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "5c9c0572ef21a1a982cbfaa821b5adc18bf926329b9f4b7cfd0a273164671111"
def certificateSHA256 : String := "23af3159347040b2d3ae1f40612316907b9bad6862840b1709fe9cf7fc01e712"
...
def multipliers : Fin 34 → SparsePoly (Fin 65) := ![
  ...
  [{ coefficient := 1, powers := [(40, 1), (61, 1)] }, { coefficient := -1, powers := [(41, 1), (43, 1), (58, 1), (63, 1)] }, { coefficient := 1, powers := [(43, 1), (58, 1)] }],
...
#print axioms Krenn.Component24.SelectedLeafB2_5.selectedHasNoCommonZero

end Krenn.Component24.SelectedLeafB2_5
