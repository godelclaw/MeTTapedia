...
namespace Krenn.Component24.SelectedLeafB1_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "9262ea36ae5b851d10de38617fb10c2d4b1ad8b1df5cb5a2c1d3c0c86af1ea74"
...
def multipliers : Fin 7 → SparsePoly (Fin 65) := ![
  ...
  [{ coefficient := 1, powers := [(21, 1), (51, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(21, 1), (39, 1), (51, 1), (60, 1), (64, 1)] }, { coefficient := -1, powers := [(21, 1), (46, 1), (51, 1), (53, 1), (64, 1)] }, { coefficient := 1, powers := [(21, 1), (46, 1), (54, 1), (64, 1)] }, { coefficient := -1, powers := [(43, 1), (57, 1), (64, 1)] }, { coefficient := 1, powers := [(48, 1), (51, 1), (53, 1), (64, 1)] }, { coefficient := -1, powers := [(48, 1), (54, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (21, 1), (51, 1), (57, 1), (64, 1)] }, { coefficient := -1, powers := [(21, 1), (51, 1), (64, 1)] }],
...
#print axioms Krenn.Component24.SelectedLeafB1_5.selectedHasNoCommonZero

end Krenn.Component24.SelectedLeafB1_5
