...
namespace Krenn.Component24.SelectedLeafB0_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "6b4042041ce08ec71c01d2022e0dd7d9b0eb2059db2934774b62eaf78a138589"
def certificateSHA256 : String := "71a2ec2e8363b98bfec7d5fbfb2307bbaff26d6644e4294f2d9aa0da7bd7a0e3"
...
def multipliers : Fin 19 → SparsePoly (Fin 63) := ![
  ...
  [{ coefficient := 1, powers := [(5, 1), (34, 1)] }, { coefficient := -1, powers := [(14, 1), (21, 1), (30, 1)] }, { coefficient := -1, powers := [(14, 1), (25, 1)] }],
  ...
  [{ coefficient := -1, powers := [(5, 1), (37, 1), (46, 1), (55, 1)] }, { coefficient := 1, powers := [(19, 1), (25, 1), (46, 1), (55, 1)] }],
  [{ coefficient := 1, powers := [(40, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (5, 1), (34, 1), (58, 1)] }, { coefficient := 1, powers := [(0, 1), (14, 1), (21, 1), (30, 1), (58, 1)] }, { coefficient := 1, powers := [(0, 1), (14, 1), (25, 1), (58, 1)] }, { coefficient := 2, powers := [(14, 1), (20, 1), (31, 1), (49, 1)] }, { coefficient := -1, powers := [(14, 1), (21, 1), (31, 1), (45, 1)] }],
...
#print axioms Krenn.Component24.SelectedLeafB0_4.selectedHasNoCommonZero

end Krenn.Component24.SelectedLeafB0_4
