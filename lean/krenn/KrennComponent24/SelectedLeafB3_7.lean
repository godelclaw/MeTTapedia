...
namespace Krenn.Component24.SelectedLeafB3_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "4f5ecc139320564fd8be84a821edeb89767d92302ad0079edbe63b9e7fdfc669"
...
def multipliers : Fin 15 → SparsePoly (Fin 67) := ![
  [{ coefficient := -1, powers := [(25, 1), (51, 1), (53, 1), (63, 1), (66, 1)] }, { coefficient := -1, powers := [(25, 1), (51, 1), (57, 1), (63, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(21, 1), (29, 1), (63, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(18, 1), (26, 1), (51, 1), (63, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(21, 1), (63, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(30, 1), (51, 1), (63, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(25, 1), (51, 1), (63, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(26, 1), (30, 1), (51, 1), (63, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (21, 1), (63, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(18, 1), (26, 1), (30, 1), (51, 1), (63, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(63, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(29, 1), (63, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (63, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (21, 1), (46, 1), (54, 1), (63, 1), (66, 1)] }, { coefficient := -1, powers := [(2, 1), (43, 1), (57, 1), (63, 1), (66, 1)] }, { coefficient := -1, powers := [(2, 1), (48, 1), (54, 1), (63, 1), (66, 1)] }, { coefficient := 1, powers := [(18, 1), (26, 1), (30, 1), (48, 1), (51, 1), (53, 1), (63, 1), (66, 1)] }],
...
#print axioms Krenn.Component24.SelectedLeafB3_7.selectedHasNoCommonZero

end Krenn.Component24.SelectedLeafB3_7
