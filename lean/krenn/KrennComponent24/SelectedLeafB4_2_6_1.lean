...
namespace Krenn.Component24.SelectedLeafB4_2_6_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "df89b7ec642b3c6d7f19f9aed1555afb19369e37315d0257324a37dd095b8705"
def certificateSHA256 : String := "71d2a7f6cd35a535b01c634f296ce21057b19df0db7839be62b89e141b4bafe4"
...
def multipliers : Fin 20 → SparsePoly (Fin 67) := ![
  [{ coefficient := -2, powers := [(31, 1), (49, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (49, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (51, 1)] }],
  [{ coefficient := 1, powers := [(18, 1), (25, 1), (55, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(18, 1), (55, 1)] }],
  ...
  [{ coefficient := 1, powers := [(2, 1), (43, 1)] }, { coefficient := 1, powers := [(5, 1), (34, 1)] }, { coefficient := -1, powers := [(14, 1), (25, 1)] }, { coefficient := -1, powers := [(18, 1), (24, 1), (25, 1), (55, 1), (66, 1)] }],
  [{ coefficient := 2, powers := [(18, 1), (25, 1), (47, 1), (55, 1)] }, { coefficient := 1, powers := [(18, 1), (31, 1), (49, 1), (54, 1)] }, { coefficient := 2, powers := [(19, 1), (25, 1), (42, 1), (55, 1)] }],
...
#print axioms Krenn.Component24.SelectedLeafB4_2_6_1.selectedHasNoCommonZero

end Krenn.Component24.SelectedLeafB4_2_6_1
