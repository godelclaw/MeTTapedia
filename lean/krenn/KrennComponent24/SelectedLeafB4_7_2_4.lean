...
namespace Krenn.Component24.SelectedLeafB4_7_2_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "c43138689b8fd3fecd2def855c0015501d5c96183b626483dc89936c6470443d"
def certificateSHA256 : String := "b7df7bae37e8973af9554bbd85b883902be85dbcad89fd4476f00533350c2db7"
...
def multipliers : Fin 26 → SparsePoly (Fin 68) := ![
  ...
  [{ coefficient := -1, powers := [(2, 1), (41, 1), (43, 1), (63, 1)] }, { coefficient := 1, powers := [(2, 1), (43, 1)] }, { coefficient := -2, powers := [(3, 1), (14, 1), (25, 1), (60, 1)] }, { coefficient := 1, powers := [(5, 1), (34, 1)] }, { coefficient := -1, powers := [(13, 1), (24, 1), (43, 1), (63, 1)] }, { coefficient := -1, powers := [(14, 1), (25, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (61, 1)] }, { coefficient := -1, powers := [(13, 1), (43, 1), (45, 1), (63, 1)] }, { coefficient := -1, powers := [(14, 1), (49, 1)] }, { coefficient := -1, powers := [(19, 1), (41, 1), (43, 1), (63, 1)] }, { coefficient := -1, powers := [(19, 1), (48, 1), (51, 1)] }]
]
...
#print axioms Krenn.Component24.SelectedLeafB4_7_2_4.selectedHasNoCommonZero

end Krenn.Component24.SelectedLeafB4_7_2_4
