...
namespace Krenn.Component24.SelectedLeafB7_2_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "6270b0407b184ae4a8fa1f9ed6b93de1d919ddedb6c5ea4a0131380ece1a1a9c"
...
def multipliers : Fin 24 → SparsePoly (Fin 67) := ![
  ...
  [{ coefficient := -1, powers := [(21, 1), (31, 1), (38, 1), (53, 1), (61, 1), (66, 1)] }, { coefficient := -1, powers := [(24, 1), (40, 1), (61, 1), (66, 1)] }, { coefficient := 1, powers := [(25, 1), (45, 1), (55, 1), (66, 1)] }, { coefficient := 1, powers := [(26, 1), (31, 1), (49, 1), (54, 1), (66, 1)] }, { coefficient := -1, powers := [(29, 1), (40, 1), (61, 1), (66, 1)] }, { coefficient := -1, powers := [(31, 1), (38, 1), (48, 1), (61, 1), (66, 1)] }],
...
#print axioms Krenn.Component24.SelectedLeafB7_2_4.selectedHasNoCommonZero

end Krenn.Component24.SelectedLeafB7_2_4
