...
namespace Krenn.Component24.SelectedLeafB3_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "d10e60c9299c8532147f71ead58066604fbc4d858f39f3131fd13e04920f0e86"
...
def multipliers : Fin 7 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := -1, powers := [(21, 1), (39, 1), (51, 1), (60, 1), (65, 1)] }, { coefficient := -1, powers := [(21, 1), (46, 1), (51, 1), (53, 1), (65, 1)] }, { coefficient := 1, powers := [(21, 1), (46, 1), (54, 1), (65, 1)] }, { coefficient := -1, powers := [(43, 1), (57, 1), (65, 1)] }, { coefficient := 1, powers := [(48, 1), (51, 1), (53, 1), (65, 1)] }, { coefficient := -1, powers := [(48, 1), (54, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (21, 1), (51, 1), (57, 1), (65, 1)] }, { coefficient := -1, powers := [(21, 1), (51, 1), (65, 1)] }],
...
#print axioms Krenn.Component24.SelectedLeafB3_5.selectedHasNoCommonZero

end Krenn.Component24.SelectedLeafB3_5
