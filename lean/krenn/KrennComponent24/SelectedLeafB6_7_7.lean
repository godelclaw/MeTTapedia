...
namespace Krenn.Component24.SelectedLeafB6_7_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "7c08afee43efa6e2a750d9630c35a00cbc9ff59d70def6f7bb51724750b22841"
def certificateSHA256 : String := "073a49daf907bec1b19e7770a72f6393725ab01615a45b68e56f2275473cbcbe"
...
def multipliers : Fin 25 → SparsePoly (Fin 70) := ![
  [{ coefficient := 2, powers := [(19, 1), (31, 1), (43, 1), (64, 1), (69, 1)] }],
  ...
  [{ coefficient := 1, powers := [(40, 1), (61, 1)] }, { coefficient := -1, powers := [(41, 1), (43, 1), (58, 1), (64, 1)] }, { coefficient := -1, powers := [(43, 1), (56, 1), (58, 1), (67, 1)] }, { coefficient := 1, powers := [(43, 1), (58, 1)] }, { coefficient := -1, powers := [(49, 1), (55, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (37, 1), (43, 1)] }, { coefficient := 1, powers := [(19, 1), (31, 1), (43, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (34, 1), (58, 1)] }, { coefficient := 1, powers := [(14, 1), (25, 1), (58, 1)] }, { coefficient := 2, powers := [(14, 1), (31, 1), (49, 1)] }, { coefficient := -1, powers := [(18, 1), (25, 1), (45, 1), (55, 1)] }],
  [{ coefficient := -2, powers := [(9, 1), (19, 1), (31, 1), (43, 1), (64, 1)] }, { coefficient := 2, powers := [(19, 1), (20, 1), (25, 1), (46, 1), (55, 1)] }, { coefficient := 1, powers := [(19, 1), (21, 1), (31, 1), (54, 1)] }]
]
...
#print axioms Krenn.Component24.SelectedLeafB6_7_7.selectedHasNoCommonZero

end Krenn.Component24.SelectedLeafB6_7_7
