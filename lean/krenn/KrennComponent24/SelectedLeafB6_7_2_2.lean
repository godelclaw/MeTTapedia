...
namespace Krenn.Component24.SelectedLeafB6_7_2_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "b9c6e17ecbce6a0f9424e96b98168ebf9c9dc3a656fa462493fd4b4185e3727a"
...
def multipliers : Fin 17 → SparsePoly (Fin 69) := ![
  ...
  [{ coefficient := -1, powers := [(18, 1), (25, 1), (41, 1), (53, 1), (55, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(25, 1), (41, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(14, 1), (41, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(18, 1), (25, 1), (41, 1), (55, 1), (64, 1)] }],
  [{ coefficient := -2, powers := [(25, 1), (41, 1), (55, 1), (64, 1)] }],
  ...
  [{ coefficient := 1, powers := [(40, 1), (41, 1), (61, 1), (64, 1)] }, { coefficient := -1, powers := [(41, 1), (49, 1), (55, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := 1, powers := [(5, 1), (34, 1), (41, 1), (64, 1)] }, { coefficient := -1, powers := [(13, 1), (24, 1), (43, 1), (64, 1)] }, { coefficient := -1, powers := [(14, 1), (25, 1), (41, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(18, 1), (25, 1), (41, 1), (45, 1), (53, 1), (55, 1), (64, 1)] }, { coefficient := 2, powers := [(18, 1), (25, 1), (41, 1), (47, 1), (55, 1), (64, 1)] }, { coefficient := 2, powers := [(19, 1), (25, 1), (41, 1), (42, 1), (55, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (41, 1), (61, 1), (64, 1)] }, { coefficient := -1, powers := [(13, 1), (43, 1), (45, 1), (64, 1)] }, { coefficient := -1, powers := [(14, 1), (41, 1), (49, 1), (64, 1)] }, { coefficient := -1, powers := [(19, 1), (41, 1), (43, 1), (64, 1)] }, { coefficient := -1, powers := [(19, 1), (41, 1), (48, 1), (51, 1), (64, 1)] }]
]
...
#print axioms Krenn.Component24.SelectedLeafB6_7_2_2.selectedHasNoCommonZero

end Krenn.Component24.SelectedLeafB6_7_2_2
