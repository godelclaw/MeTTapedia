...
namespace Krenn.Component24.SelectedLeafB4_3_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "5d7dec15e0489c8dae15dc8a38ba32768edb53aa982293082cf47dcf66f071b0"
...
def multipliers : Fin 27 → SparsePoly (Fin 68) := ![
  [{ coefficient := 2, powers := [(0, 1), (25, 1), (42, 1), (58, 1), (65, 1)] }, { coefficient := 2, powers := [(0, 1), (31, 1), (42, 1), (49, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (24, 1), (42, 1), (49, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (25, 1), (42, 1), (45, 1), (55, 1), (65, 1)] }, { coefficient := -1, powers := [(0, 1), (31, 1), (43, 1), (47, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (30, 1), (43, 1)] }],
  [{ coefficient := 2, powers := [(0, 1), (19, 1), (25, 1), (42, 1), (46, 1), (55, 1), (67, 1)] }, { coefficient := 2, powers := [(0, 1), (19, 1), (31, 1), (43, 1), (53, 1), (62, 1), (67, 1)] }, { coefficient := 2, powers := [(0, 1), (19, 1), (31, 1), (43, 1), (57, 1), (62, 1), (67, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (19, 1), (31, 1), (42, 1), (54, 1), (67, 1)] }],
  ...
  [{ coefficient := -1, powers := [(0, 1), (40, 1), (42, 1), (61, 1)] }, { coefficient := 1, powers := [(0, 1), (42, 1), (43, 1), (56, 1), (58, 1), (65, 1)] }, { coefficient := 1, powers := [(0, 1), (42, 1), (49, 1), (55, 1)] }],
...
#print axioms Krenn.Component24.SelectedLeafB4_3_7.selectedHasNoCommonZero

end Krenn.Component24.SelectedLeafB4_3_7
