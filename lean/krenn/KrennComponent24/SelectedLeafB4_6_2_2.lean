...
namespace Krenn.Component24.SelectedLeafB4_6_2_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "fb2aaa3e8f8393d4c6dcf7c08f72648b63b39b8ebfe2a1b48825497adcbbc245"
def certificateSHA256 : String := "3f39bff07423783bdd40181b3d34131930d422240dd8de2d737791ce0ccf791c"
...
def multipliers : Fin 16 → SparsePoly (Fin 67) := ![
  ...
  [{ coefficient := -1, powers := [(18, 1), (55, 1)] }],
  [{ coefficient := -1, powers := [(18, 1), (25, 1), (53, 1), (55, 1)] }],
  ...
  [{ coefficient := 1, powers := [(18, 1), (25, 1), (45, 1), (53, 1), (55, 1)] }, { coefficient := 2, powers := [(18, 1), (25, 1), (47, 1), (55, 1)] }, { coefficient := 2, powers := [(19, 1), (25, 1), (42, 1), (55, 1)] }],
...
#print axioms Krenn.Component24.SelectedLeafB4_6_2_2.selectedHasNoCommonZero

end Krenn.Component24.SelectedLeafB4_6_2_2
