...
namespace Krenn.Component24.SelectedLeafB7_6_2_6_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "547b9093300b51280f044681964cb51bcc389c5d8cbf1aae308a34454bd85a33"
...
def multipliers : Fin 15 → SparsePoly (Fin 72) := ![
  [{ coefficient := -1, powers := [(25, 1), (61, 1), (70, 1)] }],
  ...
  [{ coefficient := -1, powers := [(5, 1), (60, 1), (61, 1), (70, 1)] }, { coefficient := 1, powers := [(5, 1), (61, 1)] }, { coefficient := -1, powers := [(14, 1), (49, 1)] }, { coefficient := -1, powers := [(18, 1), (48, 1), (61, 1), (70, 1)] }, { coefficient := -1, powers := [(19, 1), (48, 1), (51, 1)] }],
...
#print axioms Krenn.Component24.SelectedLeafB7_6_2_6_3.selectedHasNoCommonZero

end Krenn.Component24.SelectedLeafB7_6_2_6_3
