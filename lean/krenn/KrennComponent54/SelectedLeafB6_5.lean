...
namespace Krenn.Component54.SelectedLeafB6_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "b6db1299bc77031009ec4e0a6f4417c66d47fe01682da28582781856b76ae2f5"
...
def multipliers : Fin 21 → SparsePoly (Fin 65) := ![
  ...
  [{ coefficient := 1, powers := [(30, 1), (42, 1), (51, 1), (63, 1)] }],
  ...
  [{ coefficient := -1, powers := [(5, 1), (6, 1), (33, 1), (39, 1), (57, 1), (59, 1), (60, 1)] }, { coefficient := -1, powers := [(5, 1), (6, 1), (33, 1), (42, 1), (57, 2), (59, 1)] }, { coefficient := -1, powers := [(5, 1), (6, 1), (33, 1), (48, 1), (54, 1), (57, 1), (59, 1)] }, { coefficient := -1, powers := [(27, 1), (42, 1), (44, 1), (51, 1), (63, 1)] }, { coefficient := 1, powers := [(39, 1), (60, 1)] }, { coefficient := -1, powers := [(40, 1), (42, 1), (57, 1), (63, 1)] }, { coefficient := 1, powers := [(42, 1), (57, 1)] }, { coefficient := -1, powers := [(48, 1), (54, 1)] }],
...
#print axioms Krenn.Component54.SelectedLeafB6_5.selectedHasNoCommonZero

end Krenn.Component54.SelectedLeafB6_5
