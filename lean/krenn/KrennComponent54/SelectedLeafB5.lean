...
namespace Krenn.Component54.SelectedLeafB5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "37ace6a40cecbc39545f75ebcafbf84d76dec06eee90498c50684ac02e3b2b8b"
...
def multipliers : Fin 21 → SparsePoly (Fin 63) := ![
  [{ coefficient := 1, powers := [(0, 1), (2, 1), (21, 1), (37, 1), (42, 1), (57, 1), (59, 1), (61, 1), (62, 1)] }, { coefficient := -1, powers := [(0, 1), (5, 1), (21, 1), (36, 1), (37, 1), (54, 1), (59, 1), (61, 1), (62, 1)] }, { coefficient := 1, powers := [(0, 1), (20, 1), (30, 1), (37, 1), (42, 1), (59, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (2, 1), (27, 1), (37, 1), (42, 1), (59, 1), (61, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (2, 1), (26, 1), (37, 1), (48, 1), (54, 1), (59, 1), (61, 1), (62, 1)] }, { coefficient := -1, powers := [(0, 1), (8, 1), (26, 1), (33, 1), (37, 1), (48, 1), (59, 1), (61, 1), (62, 1)] }],
  ...
  [{ coefficient := 1, powers := [(0, 1), (61, 1), (62, 1)] }],
...
#print axioms Krenn.Component54.SelectedLeafB5.selectedHasNoCommonZero

end Krenn.Component54.SelectedLeafB5
