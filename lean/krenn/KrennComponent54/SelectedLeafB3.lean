...
namespace Krenn.Component54.SelectedLeafB3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "fed7cff671295b1fcd60d45a0855e19152a82a80198036cc4a746beaa4d80215"
...
def multipliers : Fin 26 → SparsePoly (Fin 63) := ![
  [{ coefficient := -1, powers := [(5, 1), (21, 1), (33, 1), (57, 1), (62, 1)] }, { coefficient := 1, powers := [(5, 1), (21, 1), (36, 1), (54, 1), (62, 1)] }, { coefficient := -1, powers := [(20, 1), (21, 1), (25, 1), (54, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (27, 1), (33, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (22, 1), (56, 1), (57, 1), (62, 1)] }, { coefficient := -1, powers := [(8, 1), (22, 1), (36, 1), (56, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (26, 1), (48, 1), (54, 1), (62, 1)] }, { coefficient := 1, powers := [(8, 1), (26, 1), (33, 1), (48, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (22, 1), (57, 1), (62, 1)] }, { coefficient := -1, powers := [(8, 1), (22, 1), (36, 1), (62, 1)] }],
...
#print axioms Krenn.Component54.SelectedLeafB3.selectedHasNoCommonZero

end Krenn.Component54.SelectedLeafB3
