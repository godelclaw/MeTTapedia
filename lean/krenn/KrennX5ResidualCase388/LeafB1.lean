...
namespace Krenn.X5ResidualCase388.LeafB1

open Krenn.SparseCertificate
open MvPolynomial

def sourceSystemFileSHA256 : String := "4ef96c65cc4c52805948d760657c4fbeee645b409581e671e7802fc4fbfb6d78"
def sourceSystemSemanticSHA256 : String := "ae2647f8cbe88073e3d3ec186b6969874bfbbbcdd97e39523bbd0d1da29fccbe"
...
def multipliers : Fin 29 → SparsePoly (Fin 71) := ![
  ...
  [{ coefficient := 1, powers := [(15, 1), (20, 1), (32, 1), (36, 1), (51, 1), (63, 1)] }],
...
#print axioms Krenn.X5ResidualCase388.LeafB1.selectedHasNoCommonZero

end Krenn.X5ResidualCase388.LeafB1
