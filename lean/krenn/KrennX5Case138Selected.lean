...
namespace Krenn.X5Case138Selected

open Krenn.SparseCertificate
open MvPolynomial

def sourceSystemFileSHA256 : String := "53bbb78956b6f88148acbd380870fe73181e4ba2c4f940e7716fa451d066b21a"
def sourceSystemSemanticSHA256 : String := "a3cc0276b48e492779017e5ce8371fed7d847d06c706a043f4786bbdbba0fe06"
def certificateSHA256 : String := "032ae42b2ee24999c961206184804b06f5a83b919a74e51d24e8c5f1f1334792"
def sourceEquationCount : Nat := 675

set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedIndices : Fin 14 → Fin 675 := ![
  414,
  416,
  418,
  422,
...
def multipliers : Fin 14 → SparsePoly (Fin 70) := ![
  ...
  [{ coefficient := -1, powers := [(32, 1), (37, 1), (45, 1), (63, 1)] }, { coefficient := -1, powers := [(32, 1), (40, 1), (45, 1), (57, 1)] }, { coefficient := -1, powers := [(32, 1), (43, 1), (45, 1), (54, 1)] }],
...
#print axioms Krenn.X5Case138Selected.selectedHasNoCommonZero

end Krenn.X5Case138Selected
