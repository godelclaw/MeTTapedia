...
/-!
Exact normalization of external minimal-prime component 17 into
zero-based Lean component row 16.  All exponent-map equalities are
rechecked by Lean below; this source is generated only for serialization.
-/

namespace Krenn.Component17Normalization
...
theorem selectedIndices_exact : componentGenerators 16 = selectedIndices := by decide
...
theorem rawPositiveMap03 :
    Finsupp.mapDomain rawToReduced (rawPositive 3) = generatorPositive 2 := by
  ext coordinate
  fin_cases coordinate <;>
    simp [rawPositive, rawToReduced, Finsupp.mapDomain_add, Finsupp.mapDomain_single, generatorPositive, generatorPositiveSupport, generatorNegative, generatorNegativeSupport, squarefreeExponent, Nat.testBit, Nat.shiftRight_eq_div_pow]
...
set_option maxRecDepth 100000 in
theorem rawComponent17_vanishes {R : Type*} [CommRing R]
...
end Krenn.Component17Normalization

#print axioms Krenn.Component17Normalization.rawComponent17_vanishes
