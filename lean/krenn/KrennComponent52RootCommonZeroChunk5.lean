...
namespace Krenn.Component52RootCommonZero.Chunk5
...
theorem rootBlock_of_base_and_component {R : Type*} [CommRing R]
    ...
    ∀ offset : Fin 40, eval₂Hom (Int.castRingHom R) (rootValues full)
      (Krenn.Component52.Tree.rootEquations ⟨200 + offset.val, by omega⟩).toPoly = 0 := by
...
end Krenn.Component52RootCommonZero.Chunk5
