...
namespace Krenn.Component52.SelectedLeafB4_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "8962393ddde883adba4e6439dfd11fc7e3785c3a26a5e126d4c8263b7ba6c945"
...
def multipliers : Fin 22 → SparsePoly (Fin 63) := ![
  ...
  [{ coefficient := 1, powers := [(3, 1), (5, 1), (32, 1), (44, 1), (56, 1), (58, 1), (62, 1)] }, { coefficient := -1, powers := [(5, 1), (32, 1), (40, 1), (56, 1), (62, 1)] }, { coefficient := -1, powers := [(8, 1), (32, 1), (47, 1), (60, 1), (62, 1)] }, { coefficient := -1, powers := [(18, 1), (29, 1), (41, 1), (50, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (32, 1), (60, 1)] }],
  [{ coefficient := -1, powers := [(41, 1), (52, 1), (61, 1)] }],
  ...
  [{ coefficient := -1, powers := [(6, 1), (47, 1), (53, 1), (58, 1)] }, { coefficient := 1, powers := [(38, 1), (59, 1)] }, { coefficient := -1, powers := [(40, 1), (41, 1), (56, 1), (61, 1)] }, { coefficient := 1, powers := [(41, 1), (56, 1)] }],
...
#print axioms Krenn.Component52.SelectedLeafB4_3.selectedHasNoCommonZero

end Krenn.Component52.SelectedLeafB4_3
