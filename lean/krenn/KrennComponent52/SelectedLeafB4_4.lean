...
namespace Krenn.Component52.SelectedLeafB4_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "8ba624ece27fe99bad30a237370a2e5b11f4d49925889e1cb5a35800788376ed"
...
def multipliers : Fin 24 → SparsePoly (Fin 62) := ![
  ...
  [{ coefficient := -1, powers := [(5, 1), (32, 1), (49, 1), (61, 1)] }, { coefficient := -1, powers := [(13, 1), (23, 1), (44, 1)] }],
  [{ coefficient := 2, powers := [(13, 1), (29, 1), (50, 1)] }],
  [{ coefficient := 1, powers := [(19, 1), (23, 1), (56, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (5, 1), (32, 1), (52, 1), (61, 1)] }, { coefficient := 1, powers := [(5, 1), (25, 1), (32, 1), (61, 1)] }],
  ...
  [{ coefficient := -1, powers := [(5, 1), (32, 1), (55, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(29, 1)] }],
  [{ coefficient := 1, powers := [(23, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (5, 1), (32, 1), (49, 1), (61, 1)] }, { coefficient := -1, powers := [(5, 1), (9, 1), (32, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (32, 1), (56, 1), (61, 1)] }],
  ...
  [{ coefficient := 1, powers := [(0, 2), (5, 1), (32, 1), (49, 1), (56, 1), (61, 1)] }, { coefficient := 1, powers := [(0, 1), (5, 1), (9, 1), (32, 1), (56, 1), (61, 1)] }, { coefficient := 2, powers := [(18, 1), (23, 1), (24, 1), (53, 1)] }],
...
#print axioms Krenn.Component52.SelectedLeafB4_4.selectedHasNoCommonZero

end Krenn.Component52.SelectedLeafB4_4
