...
namespace Krenn.Component52.SelectedLeafB6_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "dd193c450fb2b20e6b05c555f034a3e9df643272fcb521db4217766eaa846cbd"
...
def multipliers : Fin 21 → SparsePoly (Fin 64) := ![
  [{ coefficient := -1, powers := [(5, 1), (29, 1), (41, 1), (58, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (23, 1), (41, 1), (58, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(29, 1), (41, 1), (49, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (25, 1), (32, 1), (41, 1), (45, 1), (60, 1), (63, 2)] }, { coefficient := 1, powers := [(5, 1), (32, 1), (41, 1), (45, 1), (52, 1), (63, 2)] }, { coefficient := -1, powers := [(8, 1), (32, 1), (41, 1), (47, 1), (60, 1), (63, 2)] }],
  [{ coefficient := -1, powers := [(5, 1), (25, 1), (32, 1), (41, 1), (60, 1), (63, 1)] }, { coefficient := -1, powers := [(5, 1), (32, 1), (41, 1), (52, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (32, 1), (41, 1), (60, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (41, 1), (59, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (41, 1), (59, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(29, 1), (41, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(23, 1), (41, 1), (53, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(41, 1), (53, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(18, 1), (41, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(13, 1), (41, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(41, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (32, 1), (41, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(41, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (25, 1), (32, 1), (41, 1), (45, 1), (63, 1)] }, { coefficient := -1, powers := [(8, 1), (32, 1), (41, 1), (47, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(38, 1), (41, 1), (59, 1), (63, 1)] }, { coefficient := -1, powers := [(39, 1), (41, 1), (56, 1), (62, 1)] }, { coefficient := 1, powers := [(41, 2), (56, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (35, 1), (41, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (5, 1), (32, 1), (41, 1), (56, 1), (63, 1)] }, { coefficient := 1, powers := [(18, 1), (23, 1), (24, 1), (41, 1), (53, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (24, 1), (25, 1), (32, 1), (41, 1), (45, 1), (60, 1), (63, 1)] }, { coefficient := -1, powers := [(5, 1), (24, 1), (32, 1), (41, 1), (45, 1), (52, 1), (63, 1)] }, { coefficient := 1, powers := [(8, 1), (24, 1), (32, 1), (41, 1), (47, 1), (60, 1), (63, 1)] }, { coefficient := 1, powers := [(8, 1), (35, 1), (41, 1)] }, { coefficient := -1, powers := [] }]
]
...
#print axioms Krenn.Component52.SelectedLeafB6_5.selectedHasNoCommonZero

end Krenn.Component52.SelectedLeafB6_5
