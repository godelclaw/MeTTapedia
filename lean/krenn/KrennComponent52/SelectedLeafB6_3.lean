...
namespace Krenn.Component52.SelectedLeafB6_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "a6873ffa48a4c12b68fc948ee5623d5e7e09d7fb096c46522e5dabc5b3f0ce2f"
...
def multipliers : Fin 21 → SparsePoly (Fin 64) := ![
  ...
  [{ coefficient := -1, powers := [(3, 1), (5, 1), (32, 1), (56, 1), (58, 1), (60, 1), (63, 1)] }, { coefficient := -1, powers := [(5, 1), (32, 1), (56, 1), (60, 1), (63, 1)] }, { coefficient := -1, powers := [(8, 1), (32, 1), (47, 1), (60, 1), (63, 1)] }, { coefficient := -1, powers := [(18, 1), (29, 1), (41, 1), (50, 1), (63, 1)] }],
...
#print axioms Krenn.Component52.SelectedLeafB6_3.selectedHasNoCommonZero

end Krenn.Component52.SelectedLeafB6_3
