...
namespace Krenn.Component52.SelectedLeafB4_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "76fc3859328bf05be46726daaa9dbb331c49fcd0aec9c4f9aa9f5a17f8d01301"
def certificateSHA256 : String := "f68e9ec3c282ee1d6f9feda44cb6e17dfdf8844119d28a4a5543bf6c12452438"
...
def multipliers : Fin 22 → SparsePoly (Fin 64) := ![
  ...
  [{ coefficient := 1, powers := [(0, 1), (32, 1), (36, 1), (44, 1), (56, 1)] }, { coefficient := 1, powers := [(6, 1), (19, 1), (32, 1), (44, 1), (56, 1)] }, { coefficient := -1, powers := [(6, 1), (32, 1), (56, 1)] }, { coefficient := -1, powers := [(6, 1), (35, 1), (53, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (23, 1), (58, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (32, 1), (44, 1)] }],
  [{ coefficient := 1, powers := [(3, 1), (5, 1), (32, 1), (44, 1), (56, 1), (58, 1), (63, 1)] }, { coefficient := -1, powers := [(5, 1), (32, 1), (40, 1), (56, 1), (63, 1)] }, { coefficient := -1, powers := [(8, 1), (32, 1), (47, 1), (60, 1), (63, 1)] }, { coefficient := -1, powers := [(18, 1), (29, 1), (41, 1), (50, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (32, 1), (60, 1)] }],
  [{ coefficient := -1, powers := [(41, 1), (52, 1), (62, 1)] }],
  ...
  [{ coefficient := -1, powers := [(5, 1), (32, 1), (44, 1), (56, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := -1, powers := [(8, 1), (32, 1), (47, 1)] }],
  [{ coefficient := -1, powers := [(6, 1), (47, 1), (53, 1), (58, 1)] }, { coefficient := 1, powers := [(38, 1), (59, 1)] }, { coefficient := -1, powers := [(40, 1), (41, 1), (56, 1), (62, 1)] }, { coefficient := 1, powers := [(41, 1), (56, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (35, 1), (41, 1)] }, { coefficient := -1, powers := [(18, 1), (29, 1), (41, 1)] }],
  [{ coefficient := -1, powers := [(3, 1), (5, 1), (24, 1), (32, 1), (44, 1), (56, 1), (58, 1)] }, { coefficient := 1, powers := [(5, 1), (24, 1), (32, 1), (40, 1), (56, 1)] }, { coefficient := 1, powers := [(8, 1), (24, 1), (32, 1), (47, 1), (60, 1)] }, { coefficient := 1, powers := [(18, 1), (24, 1), (29, 1), (41, 1), (50, 1)] }]
]
...
#print axioms Krenn.Component52.SelectedLeafB4_7.selectedHasNoCommonZero

end Krenn.Component52.SelectedLeafB4_7
