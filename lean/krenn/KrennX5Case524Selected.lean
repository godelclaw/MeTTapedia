...
namespace Krenn.X5Case524Selected

open Krenn.SparseCertificate
open MvPolynomial

def sourceSystemFileSHA256 : String := "3536308d5ddf6001e84297ceafa57227ff6824eecb215e8f2fbedee4bbfa6cb2"
def sourceSystemSemanticSHA256 : String := "1e6d18c7347192a9e6c0138bca055bef4a57ca7aaea5b63a8fb6fd088e25bb45"
def certificateSHA256 : String := "78ba1c91e7ba85c0db3424bbd01704553d5638908097662d30733ad8731605e3"
...
def multipliers : Fin 15 → SparsePoly (Fin 70) := ![
  [{ coefficient := -1, powers := [(30, 1), (33, 1), (37, 1), (48, 1), (63, 1)] }, { coefficient := -1, powers := [(30, 1), (33, 1), (40, 1), (48, 1), (57, 1)] }, { coefficient := -1, powers := [(30, 1), (33, 1), (43, 1), (48, 1), (54, 1)] }],
...
#print axioms Krenn.X5Case524Selected.selectedHasNoCommonZero

end Krenn.X5Case524Selected
