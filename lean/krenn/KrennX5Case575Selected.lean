...
namespace Krenn.X5Case575Selected

open Krenn.SparseCertificate
open MvPolynomial

def sourceSystemFileSHA256 : String := "88bbe061f5b60d4927ca94345121628ca273ef782ba9a055994c70145591bb32"
def sourceSystemSemanticSHA256 : String := "4e2528cb5f47de6fd4ad70700fe9bf30b6939bce69c56de841871c46ce83378c"
def certificateSHA256 : String := "6013ecc12de3cdaa702e576d9570b6d6470ce76d4e53ec4ba4e507313aad159e"
...
def selectedEquations : Fin 15 → SparsePoly (Fin 70) := ![
  ...
  [{ coefficient := 1, powers := [(13, 1), (61, 1)] }, { coefficient := 1, powers := [(21, 1), (55, 1)] }, { coefficient := 1, powers := [(30, 1), (52, 1)] }],
...
def multipliers : Fin 15 → SparsePoly (Fin 70) := ![
  ...
  [{ coefficient := 1, powers := [(4, 1), (23, 1), (49, 1)] }, { coefficient := -1, powers := [(7, 1), (49, 1)] }],
...
#print axioms Krenn.X5Case575Selected.selectedHasNoCommonZero

end Krenn.X5Case575Selected
