...
namespace Krenn.FrozenCase0NoncollapseType01Chart3BothLiveSumNonzeroB1W34_10W34_11ZeroCertificate

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "58d15d60ce07ce1ae9729f750eb57dd9436f7210760531480251871e17ce2c93"
def certificateSHA256 : String := "126ed7108f05558c0b381246d5b11d40e6da31b02a976bbc5513e1cab2fd30f2"

set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedSourceIndices : Fin 23 → Fin 686 := ![
  205,
  214,
  215,
  217,
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedEquations : Fin 23 → SparsePoly (Fin 74) := ![
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def multipliers : Fin 23 → SparsePoly (Fin 74) := ![
  ...
  [{ coefficient := 1, powers := [(0, 1), (36, 1), (39, 1), (53, 1)] }, { coefficient := -1, powers := [(0, 1), (37, 1), (66, 1)] }, { coefficient := -2, powers := [(0, 1), (42, 1), (53, 1)] }],
  ...
  [{ coefficient := -1, powers := [(9, 1), (53, 1), (69, 1)] }, { coefficient := -1, powers := [(15, 1), (48, 1), (53, 1)] }, { coefficient := 1, powers := [(30, 1), (37, 1), (66, 1)] }, { coefficient := 1, powers := [(30, 1), (42, 1), (53, 1)] }],
  ...
  [{ coefficient := -1, powers := [(0, 1), (30, 1), (36, 1), (39, 1), (53, 1)] }, { coefficient := 1, powers := [(0, 1), (30, 1), (37, 1), (66, 1)] }, { coefficient := 2, powers := [(0, 1), (30, 1), (42, 1), (53, 1)] }, { coefficient := -1, powers := [(2, 1), (3, 1), (15, 1), (37, 1), (72, 1)] }]
]
...
#print axioms Krenn.FrozenCase0NoncollapseType01Chart3BothLiveSumNonzeroB1W34_10W34_11ZeroCertificate.selectedHasNoCommonZero

end Krenn.FrozenCase0NoncollapseType01Chart3BothLiveSumNonzeroB1W34_10W34_11ZeroCertificate
