...
namespace Krenn.Component62.SelectedLeafB4_7_3_6_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "0d7e3379ca259e26fb3a9cd96b2dc6321aaeccb9c11a07dc54dde8726b5771aa"
def certificateSHA256 : String := "e2168d84c8212c56225a558ebe5acf820244459053ebc0950de16fa418fde788"
...
def multipliers : Fin 17 → SparsePoly (Fin 68) := ![
  ...
  [{ coefficient := 1, powers := [(12, 1), (50, 1), (56, 1), (64, 1)] }, { coefficient := -1, powers := [(17, 1), (53, 1)] }],
  ...
  [{ coefficient := 1, powers := [(36, 1), (59, 1)] }, { coefficient := -1, powers := [(38, 1), (39, 1), (56, 1), (62, 1)] }, { coefficient := -1, powers := [(39, 1), (44, 1), (52, 1), (62, 1)] }, { coefficient := -1, powers := [(39, 1), (55, 1), (56, 1), (64, 1)] }, { coefficient := 1, powers := [(39, 1), (56, 1)] }, { coefficient := -1, powers := [(46, 1), (53, 1)] }],
  ...
  [{ coefficient := -1, powers := [(6, 1), (12, 1), (22, 1), (50, 1), (56, 1), (64, 1)] }, { coefficient := 1, powers := [(6, 1), (17, 1), (22, 1), (53, 1)] }],
...
#print axioms Krenn.Component62.SelectedLeafB4_7_3_6_0.selectedHasNoCommonZero

end Krenn.Component62.SelectedLeafB4_7_3_6_0
