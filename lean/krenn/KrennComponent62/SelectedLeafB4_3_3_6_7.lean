...
namespace Krenn.Component62.SelectedLeafB4_3_3_6_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "ceea6ebf4f786d9e79a40fa6e0c7dd46a076a19f746e94a31f806156f82a03c0"
def certificateSHA256 : String := "b9b38ec6cea21e43b9b4487a478ef44fec9a7ae6bd46d72b744bc06b30f25008"
...
def multipliers : Fin 25 → SparsePoly (Fin 70) := ![
  ...
  [{ coefficient := -1, powers := [(13, 1), (17, 1), (53, 1), (58, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(51, 1), (56, 1), (63, 1)] }, { coefficient := -1, powers := [(52, 1), (59, 1), (68, 1)] }],
  [{ coefficient := -1, powers := [(22, 1), (56, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(22, 1), (48, 1), (56, 1), (60, 1)] }, { coefficient := 1, powers := [(22, 1), (48, 1), (56, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(17, 1), (53, 1), (58, 1), (68, 1)] }],
  [{ coefficient := -1, powers := [(16, 1), (22, 1), (56, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(53, 1)] }],
  [{ coefficient := 1, powers := [(46, 1)] }],
  [{ coefficient := 1, powers := [(17, 1), (53, 1), (58, 1), (67, 1)] }],
  ...
  [{ coefficient := -1, powers := [(36, 1), (58, 1), (59, 1), (68, 1)] }, { coefficient := 1, powers := [(36, 1), (59, 1)] }, { coefficient := -1, powers := [(38, 1), (39, 1), (56, 1), (61, 1)] }, { coefficient := -1, powers := [(39, 1), (44, 1), (52, 1), (61, 1)] }, { coefficient := -1, powers := [(39, 1), (55, 1), (56, 1), (63, 1)] }, { coefficient := 1, powers := [(39, 1), (56, 1)] }, { coefficient := -1, powers := [(46, 1), (53, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (33, 1), (39, 1)] }],
  [{ coefficient := -1, powers := [(9, 1), (17, 1), (22, 1), (53, 1), (58, 1), (67, 1)] }],
  ...
  [{ coefficient := -1, powers := [(5, 1), (58, 1), (59, 1), (68, 1)] }, { coefficient := 1, powers := [(5, 1), (59, 1)] }, { coefficient := -1, powers := [(12, 1), (46, 1)] }, { coefficient := -1, powers := [(16, 1), (39, 1), (44, 1), (61, 1)] }, { coefficient := -1, powers := [(16, 1), (45, 1), (59, 1), (68, 1)] }, { coefficient := -1, powers := [(17, 1), (38, 1), (39, 1), (61, 1)] }, { coefficient := -1, powers := [(17, 1), (45, 1), (48, 1)] }],
...
#print axioms Krenn.Component62.SelectedLeafB4_3_3_6_7.selectedHasNoCommonZero

end Krenn.Component62.SelectedLeafB4_3_3_6_7
