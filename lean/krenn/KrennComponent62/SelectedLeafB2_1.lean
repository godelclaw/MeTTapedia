...
namespace Krenn.Component62.SelectedLeafB2_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "cead506fbcdfceec264cd123eeb331ffd5f2ce460d8d8db14f878d153a28e303"
...
def multipliers : Fin 9 → SparsePoly (Fin 62) := ![
  [{ coefficient := -1, powers := [(19, 1), (20, 1), (50, 1), (60, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(19, 1), (20, 1), (60, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(19, 1), (50, 1), (60, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (60, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(48, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(61, 1)] }],
  [{ coefficient := -1, powers := [(39, 1), (55, 1), (61, 1)] }, { coefficient := 1, powers := [(45, 1), (48, 1), (50, 1), (61, 1)] }, { coefficient := -1, powers := [(45, 1), (51, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (48, 1), (50, 1), (61, 1)] }, { coefficient := 1, powers := [(19, 1), (51, 1), (61, 1)] }],
...
#print axioms Krenn.Component62.SelectedLeafB2_1.selectedHasNoCommonZero

end Krenn.Component62.SelectedLeafB2_1
