...
namespace Krenn.Component62.SelectedLeafB4_7_2_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "72688465d1873a508e7d8fbf571a8c6aa97ea7a39b958cb27b4b09be68bce8af"
def certificateSHA256 : String := "95b5f4022ecea5233e29dbdf43cae316334f5883902922b0175995e9acf5087a"
...
def multipliers : Fin 16 → SparsePoly (Fin 65) := ![
  ...
  [{ coefficient := 1, powers := [(36, 1), (59, 1)] }, { coefficient := -1, powers := [(38, 1), (39, 1), (56, 1), (62, 1)] }, { coefficient := -1, powers := [(39, 1), (44, 1), (52, 1), (62, 1)] }, { coefficient := 1, powers := [(39, 1), (56, 1)] }, { coefficient := -1, powers := [(46, 1), (53, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (33, 1), (39, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (30, 1)] }, { coefficient := -1, powers := [(12, 1), (22, 1)] }],
  [{ coefficient := 1, powers := [(16, 1), (22, 1), (44, 1), (53, 1)] }, { coefficient := 2, powers := [(17, 1), (22, 1), (38, 1), (53, 1)] }],
...
#print axioms Krenn.Component62.SelectedLeafB4_7_2_0.selectedHasNoCommonZero

end Krenn.Component62.SelectedLeafB4_7_2_0
