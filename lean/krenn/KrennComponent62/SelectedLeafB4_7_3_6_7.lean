...
namespace Krenn.Component62.SelectedLeafB4_7_3_6_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "7f482739c192e503f367215b4d98d3d833d8b1ff761616ce85fbe050d005002f"
...
def multipliers : Fin 25 → SparsePoly (Fin 71) := ![
  ...
  [{ coefficient := -1, powers := [(13, 1), (17, 1), (53, 1), (58, 1), (68, 1)] }],
  [{ coefficient := -1, powers := [(51, 1), (56, 1), (64, 1)] }, { coefficient := -1, powers := [(52, 1), (59, 1), (69, 1)] }],
  [{ coefficient := -1, powers := [(22, 1), (56, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(22, 1), (48, 1), (56, 1), (60, 1)] }, { coefficient := 1, powers := [(22, 1), (48, 1), (56, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(17, 1), (53, 1), (58, 1), (69, 1)] }],
  ...
  [{ coefficient := -1, powers := [(36, 1), (58, 1), (59, 1), (69, 1)] }, { coefficient := 1, powers := [(36, 1), (59, 1)] }, { coefficient := -1, powers := [(38, 1), (39, 1), (56, 1), (62, 1)] }, { coefficient := -1, powers := [(39, 1), (44, 1), (52, 1), (62, 1)] }, { coefficient := -1, powers := [(39, 1), (55, 1), (56, 1), (64, 1)] }, { coefficient := 1, powers := [(39, 1), (56, 1)] }, { coefficient := -1, powers := [(46, 1), (53, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (33, 1), (39, 1)] }],
  [{ coefficient := -1, powers := [(9, 1), (17, 1), (22, 1), (53, 1), (58, 1), (68, 1)] }],
  ...
  [{ coefficient := -1, powers := [(5, 1), (58, 1), (59, 1), (69, 1)] }, { coefficient := 1, powers := [(5, 1), (59, 1)] }, { coefficient := -1, powers := [(12, 1), (46, 1)] }, { coefficient := -1, powers := [(16, 1), (39, 1), (44, 1), (62, 1)] }, { coefficient := -1, powers := [(16, 1), (45, 1), (59, 1), (69, 1)] }, { coefficient := -1, powers := [(17, 1), (38, 1), (39, 1), (62, 1)] }, { coefficient := -1, powers := [(17, 1), (45, 1), (48, 1)] }],
...
#print axioms Krenn.Component62.SelectedLeafB4_7_3_6_7.selectedHasNoCommonZero

end Krenn.Component62.SelectedLeafB4_7_3_6_7
