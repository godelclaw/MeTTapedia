...
namespace Krenn.Component62.SelectedLeafB0_6_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "d4d6029e60c235d9955a9ced8b6beebd4c629119578d99fc7655682c267a41c8"
...
def multipliers : Fin 7 → SparsePoly (Fin 64) := ![
  ...
  [{ coefficient := 1, powers := [(24, 1), (41, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (35, 1), (41, 1), (58, 1), (63, 1)] }, { coefficient := -1, powers := [(24, 1), (38, 1), (41, 1), (55, 1), (63, 1)] }, { coefficient := -1, powers := [(24, 1), (41, 1), (43, 1), (50, 1), (63, 1)] }, { coefficient := 1, powers := [(24, 1), (44, 1), (50, 1), (63, 1)] }, { coefficient := -1, powers := [(38, 1), (56, 1), (63, 1)] }, { coefficient := 1, powers := [(41, 1), (43, 1), (52, 1), (63, 1)] }, { coefficient := -1, powers := [(44, 1), (52, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (41, 1), (63, 1)] }],
...
#print axioms Krenn.Component62.SelectedLeafB0_6_5.selectedHasNoCommonZero

end Krenn.Component62.SelectedLeafB0_6_5
