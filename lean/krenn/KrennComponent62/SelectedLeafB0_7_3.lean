...
namespace Krenn.Component62.SelectedLeafB0_7_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "a10987e96954b196777cea0aba84e467b8e81ece51277b801709ffeae5c3bffa"
def certificateSHA256 : String := "73bd10b6b3d1e5427fd5975d3b6c97fea3ac63e96ccb92950ca2459a3543a4f1"
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedEquations : Fin 59 → SparsePoly (Fin 65) := ![
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def multipliers : Fin 59 → SparsePoly (Fin 65) := ![
  ...
  [{ coefficient := 1, powers := [(16, 1), (22, 1), (41, 1)] }, { coefficient := -2, powers := [(17, 1), (22, 1)] }],
  ...
  [{ coefficient := 3, powers := [(12, 1), (22, 1), (41, 1)] }],
  ...
  [{ coefficient := -1, powers := [(12, 1), (22, 1), (24, 1), (44, 1), (50, 1)] }, { coefficient := 2, powers := [(12, 1), (22, 1), (38, 1), (56, 1)] }, { coefficient := -3, powers := [(12, 1), (22, 1), (41, 1), (43, 1), (52, 1)] }, { coefficient := 2, powers := [(12, 1), (22, 1), (44, 1), (52, 1)] }, { coefficient := 2, powers := [(12, 1), (27, 1), (46, 1), (50, 1)] }, { coefficient := 1, powers := [(16, 1), (22, 1), (23, 1), (35, 1), (52, 1), (59, 1)] }, { coefficient := -1, powers := [(16, 1), (22, 1), (23, 1), (43, 1), (51, 1), (56, 1)] }, { coefficient := 1, powers := [(16, 1), (22, 1), (23, 1), (44, 1), (51, 1), (52, 1)] }, { coefficient := -1, powers := [(16, 1), (22, 1), (38, 1), (41, 1), (53, 1)] }, { coefficient := -1, powers := [(16, 1), (22, 1), (41, 1), (43, 1), (53, 1)] }, { coefficient := -1, powers := [(16, 1), (22, 1), (41, 1), (50, 1), (53, 1)] }, { coefficient := -1, powers := [(16, 1), (22, 1), (41, 1), (53, 1), (55, 1)] }, { coefficient := 1, powers := [(16, 1), (22, 1), (43, 1), (48, 1), (56, 1)] }, { coefficient := -1, powers := [(16, 1), (22, 1), (44, 1), (53, 1)] }, { coefficient := 1, powers := [(16, 1), (22, 1), (48, 1), (55, 1), (56, 1)] }, { coefficient := -1, powers := [(16, 1), (22, 1), (51, 1), (56, 1)] }, { coefficient := -1, powers := [(16, 1), (27, 1), (46, 1), (51, 1)] }, { coefficient := 2, powers := [(17, 1), (22, 1), (43, 1), (53, 1)] }, { coefficient := 1, powers := [(17, 1), (22, 1), (50, 1), (53, 1)] }, { coefficient := 1, powers := [(17, 1), (27, 1), (39, 1), (55, 1)] }, { coefficient := -1, powers := [(17, 1), (27, 1), (45, 1), (48, 1), (50, 1)] }, { coefficient := 1, powers := [(17, 1), (27, 1), (45, 1), (51, 1)] }],
  [{ coefficient := 1, powers := [(36, 1), (59, 1)] }, { coefficient := -1, powers := [(37, 1), (39, 1), (41, 1), (52, 1), (60, 1)] }, { coefficient := -1, powers := [(37, 1), (39, 1), (56, 1), (60, 1)] }, { coefficient := -1, powers := [(39, 1), (55, 1), (56, 1), (63, 1)] }, { coefficient := 1, powers := [(39, 1), (56, 1)] }, { coefficient := -1, powers := [(46, 1), (53, 1)] }],
...
#print axioms Krenn.Component62.SelectedLeafB0_7_3.selectedHasNoCommonZero

end Krenn.Component62.SelectedLeafB0_7_3
