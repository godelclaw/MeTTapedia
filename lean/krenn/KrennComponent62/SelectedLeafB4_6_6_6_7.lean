...
namespace Krenn.Component62.SelectedLeafB4_6_6_6_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "35ccb784b374ae572275740b5463a1c609d888dcb1772f08d4ed3339d2ef45cd"
...
def multipliers : Fin 18 → SparsePoly (Fin 70) := ![
  ...
  [{ coefficient := -1, powers := [(52, 1), (59, 1), (68, 1)] }],
  ...
  [{ coefficient := -1, powers := [(36, 1), (58, 1), (59, 1), (68, 1)] }, { coefficient := 1, powers := [(36, 1), (59, 1)] }, { coefficient := 1, powers := [(39, 1), (56, 1)] }, { coefficient := -1, powers := [(46, 1), (53, 1)] }],
...
#print axioms Krenn.Component62.SelectedLeafB4_6_6_6_7.selectedHasNoCommonZero

end Krenn.Component62.SelectedLeafB4_6_6_6_7
