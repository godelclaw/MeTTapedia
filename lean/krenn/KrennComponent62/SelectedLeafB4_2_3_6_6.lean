...
namespace Krenn.Component62.SelectedLeafB4_2_3_6_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "5defa1e68ae7f472847082e5f2b18c19bc8c5d009cc3c9cd79109e3f239e6773"
...
def multipliers : Fin 32 → SparsePoly (Fin 68) := ![
  [{ coefficient := -1, powers := [(12, 1), (52, 1), (58, 1), (67, 1)] }, { coefficient := 1, powers := [(16, 1), (48, 1), (52, 1), (58, 1), (67, 1)] }],
  [{ coefficient := 1, powers := [(22, 1), (56, 1), (58, 1), (64, 1), (67, 1)] }],
  [{ coefficient := 1, powers := [(22, 1), (44, 1), (58, 1), (67, 1)] }],
  [{ coefficient := 1, powers := [(22, 1), (41, 1), (53, 1), (58, 1), (60, 1), (67, 1)] }, { coefficient := -1, powers := [(22, 1), (48, 1), (56, 1), (58, 1), (64, 1), (67, 1)] }, { coefficient := 1, powers := [(24, 1), (30, 1), (41, 1), (45, 1), (50, 1), (60, 1), (67, 1)] }, { coefficient := -1, powers := [(30, 1), (41, 1), (45, 1), (52, 1), (60, 1), (67, 1)] }, { coefficient := -1, powers := [(30, 1), (45, 1), (50, 1), (56, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(30, 1), (45, 1), (52, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(16, 1), (22, 1), (53, 1), (58, 1), (60, 1), (67, 1)] }, { coefficient := -1, powers := [(16, 1), (24, 1), (30, 1), (45, 1), (50, 1), (60, 1), (67, 1)] }, { coefficient := 1, powers := [(16, 1), (30, 1), (45, 1), (52, 1), (60, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(16, 1), (30, 1), (38, 1), (52, 1), (67, 1)] }, { coefficient := -1, powers := [(16, 1), (30, 1), (43, 1), (52, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(16, 1), (22, 1), (44, 1), (58, 1), (67, 1)] }],
  [{ coefficient := 1, powers := [(53, 1), (58, 1), (67, 1)] }],
  [{ coefficient := 1, powers := [(46, 1), (58, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(23, 1), (30, 1), (45, 1), (52, 1), (67, 1)] }, { coefficient := 1, powers := [(24, 1), (30, 1), (45, 1), (67, 1)] }],
  [{ coefficient := 1, powers := [(30, 1), (45, 1), (50, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (30, 1), (45, 1), (50, 1), (67, 1)] }, { coefficient := 1, powers := [(30, 1), (45, 1), (52, 1), (67, 1)] }],
  [{ coefficient := 1, powers := [(30, 1), (56, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(22, 1), (58, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (30, 1), (56, 1), (67, 1)] }],
  [{ coefficient := 1, powers := [(17, 1), (58, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(16, 1), (30, 1), (46, 1), (67, 1)] }],
  [{ coefficient := 1, powers := [(16, 1), (22, 1), (58, 1), (67, 1)] }],
  [{ coefficient := 1, powers := [(16, 1), (30, 1), (38, 1), (67, 1)] }, { coefficient := 1, powers := [(16, 1), (30, 1), (43, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(16, 1), (52, 1), (58, 1), (67, 1)] }],
  [{ coefficient := 1, powers := [(23, 1), (30, 1), (45, 1), (50, 1), (67, 1)] }, { coefficient := -1, powers := [(30, 1), (45, 1), (67, 1)] }],
  [{ coefficient := 1, powers := [(12, 1), (58, 1), (67, 1)] }],
  [{ coefficient := 1, powers := [(16, 1), (30, 1), (46, 1), (52, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(58, 1), (67, 1)] }],
  [{ coefficient := 1, powers := [(16, 1), (22, 1), (41, 1), (53, 1), (58, 1), (67, 1)] }, { coefficient := 1, powers := [(16, 1), (24, 1), (30, 1), (41, 1), (45, 1), (50, 1), (67, 1)] }, { coefficient := -1, powers := [(16, 1), (30, 1), (41, 1), (45, 1), (52, 1), (67, 1)] }],
  [{ coefficient := 1, powers := [(36, 1), (58, 1), (59, 1), (67, 1)] }, { coefficient := 1, powers := [(39, 1), (56, 1), (58, 1), (67, 1)] }, { coefficient := -1, powers := [(46, 1), (53, 1), (58, 1), (67, 1)] }],
  [{ coefficient := 1, powers := [(6, 1), (16, 1), (33, 1), (52, 1), (58, 1), (67, 1)] }, { coefficient := 1, powers := [(8, 1), (33, 1), (58, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(12, 1), (22, 1), (56, 1), (58, 1), (67, 1)] }, { coefficient := 1, powers := [(16, 1), (22, 1), (48, 1), (56, 1), (58, 1), (67, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (58, 1), (59, 1), (67, 1)] }, { coefficient := -1, powers := [(12, 1), (46, 1), (58, 1), (67, 1)] }, { coefficient := -1, powers := [(17, 1), (45, 1), (48, 1), (58, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := 1, powers := [(6, 1), (16, 1), (22, 1), (52, 1), (58, 1), (67, 1)] }, { coefficient := 2, powers := [(8, 1), (22, 1), (58, 1), (67, 1)] }]
]
...
#print axioms Krenn.Component62.SelectedLeafB4_2_3_6_6.selectedHasNoCommonZero

end Krenn.Component62.SelectedLeafB4_2_3_6_6
