...
namespace Krenn.Component62.SelectedLeafB4_3_2_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "1873e98bf9a7ac0bbd5d3c44a71c7de915bd83ffdb37b593080875346ea38454"
...
def multipliers : Fin 15 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := -1, powers := [(5, 1), (53, 1), (58, 1), (61, 1)] }],
  ...
  [{ coefficient := 1, powers := [(6, 1), (36, 1), (58, 1), (59, 1)] }, { coefficient := 1, powers := [(6, 1), (45, 1), (52, 1), (59, 1)] }, { coefficient := -1, powers := [(6, 1), (46, 1), (53, 1), (58, 1)] }, { coefficient := 1, powers := [(36, 1), (59, 1)] }, { coefficient := -1, powers := [(39, 1), (44, 1), (52, 1), (61, 1)] }, { coefficient := -1, powers := [(46, 1), (53, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (6, 1), (33, 1), (53, 1), (58, 1)] }, { coefficient := -1, powers := [(8, 1), (33, 1), (39, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (38, 1), (39, 1), (61, 1)] }, { coefficient := 1, powers := [(2, 1), (39, 1)] }, { coefficient := 1, powers := [(5, 1), (30, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (6, 1), (58, 1), (59, 1)] }, { coefficient := 1, powers := [(5, 1), (59, 1)] }, { coefficient := -1, powers := [(12, 1), (46, 1)] }, { coefficient := -1, powers := [(16, 1), (39, 1), (44, 1), (61, 1)] }, { coefficient := -1, powers := [(17, 1), (38, 1), (39, 1), (61, 1)] }, { coefficient := -1, powers := [(17, 1), (45, 1), (48, 1)] }]
]
...
#print axioms Krenn.Component62.SelectedLeafB4_3_2_6.selectedHasNoCommonZero

end Krenn.Component62.SelectedLeafB4_3_2_6
