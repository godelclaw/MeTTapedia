...
namespace Krenn.Component62.SelectedLeafB0_2_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "20230e32273b88547324b6f6d741b45324f38fa0e0076fbbbacd11560aba43a0"
def certificateSHA256 : String := "0d14b14ead2d65062e2d546e9c847d28481e019822340d8f32b32cb5496c5a15"
...
def multipliers : Fin 29 → SparsePoly (Fin 63) := ![
  ...
  [{ coefficient := -2, powers := [(17, 1), (53, 1), (61, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(41, 1), (53, 1)] }],
  [{ coefficient := 1, powers := [(46, 1), (48, 1)] }],
  [{ coefficient := -1, powers := [(22, 1), (44, 1)] }],
  [{ coefficient := -2, powers := [(17, 1), (53, 1), (61, 1)] }],
  [{ coefficient := 2, powers := [(13, 1), (17, 1), (53, 1), (61, 1), (62, 1)] }],
  ...
  [{ coefficient := -2, powers := [(13, 1), (17, 1), (22, 1), (53, 1), (61, 1)] }],
...
#print axioms Krenn.Component62.SelectedLeafB0_2_6.selectedHasNoCommonZero

end Krenn.Component62.SelectedLeafB0_2_6
