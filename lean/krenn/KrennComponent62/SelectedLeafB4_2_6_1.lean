...
namespace Krenn.Component62.SelectedLeafB4_2_6_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "1a33cc71b57b4184068f01f3f32cb34ab6dc0b4c6a077fcdad2c44a7016de419"
...
def multipliers : Fin 30 → SparsePoly (Fin 65) := ![
  ...
  [{ coefficient := 1, powers := [(0, 1), (8, 1), (22, 1), (47, 1), (59, 1), (64, 1)] }, { coefficient := 1, powers := [(6, 1), (8, 1), (22, 1), (28, 1), (59, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(17, 1), (45, 1)] }],
  [{ coefficient := 1, powers := [(3, 1), (8, 1), (28, 1), (59, 1), (63, 1)] }, { coefficient := 1, powers := [(6, 1), (8, 1), (28, 1), (59, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (8, 1), (13, 1), (22, 1), (34, 1), (58, 1), (59, 1), (64, 1)] }, { coefficient := -1, powers := [(0, 1), (8, 1), (22, 1), (40, 1), (59, 1), (64, 1)] }, { coefficient := -1, powers := [(3, 1), (8, 1), (22, 1), (31, 1), (59, 1), (64, 1)] }],
  ...
  [{ coefficient := 1, powers := [(0, 1), (8, 1), (13, 1), (22, 1), (27, 1), (34, 1), (58, 1), (59, 1), (64, 1)] }, { coefficient := 1, powers := [(0, 1), (8, 1), (22, 1), (27, 1), (40, 1), (59, 1), (64, 1)] }, { coefficient := 1, powers := [(0, 1), (8, 1), (22, 1), (54, 1), (59, 1)] }, { coefficient := 1, powers := [(3, 1), (8, 1), (22, 1), (27, 1), (31, 1), (59, 1), (64, 1)] }, { coefficient := 1, powers := [(6, 1), (8, 1), (22, 1), (31, 1), (59, 1)] }],
...
#print axioms Krenn.Component62.SelectedLeafB4_2_6_1.selectedHasNoCommonZero

end Krenn.Component62.SelectedLeafB4_2_6_1
