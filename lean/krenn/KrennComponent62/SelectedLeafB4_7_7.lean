...
namespace Krenn.Component62.SelectedLeafB4_7_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "f0682f75b3cff096dded096ba6674c8135a908913d01fee100f67a862f230180"
def certificateSHA256 : String := "ce1a63d88b806b20878e11f4418b1442846fa60a8157d44df02b712c7e1eabeb"
...
def multipliers : Fin 34 → SparsePoly (Fin 67) := ![
  ...
  [{ coefficient := -2, powers := [(12, 1), (46, 1), (61, 1), (62, 1)] }, { coefficient := -2, powers := [(17, 1), (39, 1), (61, 1), (62, 1)] }],
  [{ coefficient := -2, powers := [(12, 1), (56, 1), (64, 1), (65, 1)] }, { coefficient := -2, powers := [(17, 1), (53, 1), (64, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(51, 1), (56, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(39, 1), (44, 1), (62, 1)] }],
  [{ coefficient := -2, powers := [(12, 1), (46, 1), (61, 1)] }, { coefficient := -2, powers := [(17, 1), (39, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(22, 1), (44, 1)] }],
  [{ coefficient := -2, powers := [(12, 1), (56, 1), (64, 1)] }, { coefficient := -2, powers := [(17, 1), (53, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(22, 1), (41, 1), (53, 1), (60, 1)] }, { coefficient := -1, powers := [(22, 1), (48, 1), (56, 1), (60, 1)] }, { coefficient := -1, powers := [(27, 1), (39, 1), (41, 1), (60, 1)] }, { coefficient := -1, powers := [(27, 1), (46, 1), (48, 1), (60, 1)] }],
  [{ coefficient := 2, powers := [(12, 1), (13, 1), (56, 1), (64, 1), (65, 1)] }, { coefficient := 2, powers := [(13, 1), (17, 1), (53, 1), (64, 1), (65, 1)] }],
  [{ coefficient := 2, powers := [(9, 1), (12, 1), (46, 1), (61, 1), (62, 1)] }, { coefficient := 2, powers := [(9, 1), (17, 1), (39, 1), (61, 1), (62, 1)] }],
  ...
  [{ coefficient := 1, powers := [(16, 1), (22, 1), (56, 1), (60, 1)] }, { coefficient := 1, powers := [(16, 1), (27, 1), (46, 1), (60, 1)] }],
  ...
  [{ coefficient := -1, powers := [(16, 1), (22, 1), (41, 1), (53, 1)] }, { coefficient := -1, powers := [(16, 1), (22, 1), (48, 1), (56, 1)] }, { coefficient := -1, powers := [(16, 1), (27, 1), (39, 1), (41, 1)] }, { coefficient := -1, powers := [(16, 1), (27, 1), (46, 1), (48, 1)] }],
  [{ coefficient := 1, powers := [(36, 1), (59, 1)] }, { coefficient := -1, powers := [(38, 1), (39, 1), (56, 1), (62, 1)] }, { coefficient := -1, powers := [(39, 1), (55, 1), (56, 1), (65, 1)] }, { coefficient := 1, powers := [(39, 1), (56, 1)] }, { coefficient := -1, powers := [(46, 1), (53, 1)] }],
  [{ coefficient := 2, powers := [(12, 1), (27, 1), (46, 1)] }, { coefficient := 2, powers := [(17, 1), (27, 1), (39, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (33, 1), (39, 1)] }, { coefficient := -2, powers := [(9, 1), (12, 1), (27, 1), (46, 1), (61, 1)] }, { coefficient := -2, powers := [(9, 1), (17, 1), (27, 1), (39, 1), (61, 1)] }, { coefficient := -1, powers := [(17, 1), (27, 1), (39, 1)] }],
  [{ coefficient := 2, powers := [(12, 1), (22, 1), (56, 1)] }, { coefficient := 2, powers := [(17, 1), (22, 1), (53, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (30, 1), (56, 1)] }, { coefficient := -2, powers := [(12, 1), (13, 1), (22, 1), (56, 1), (64, 1)] }, { coefficient := -1, powers := [(12, 1), (22, 1), (56, 1)] }, { coefficient := -2, powers := [(13, 1), (17, 1), (22, 1), (53, 1), (64, 1)] }]
]
...
#print axioms Krenn.Component62.SelectedLeafB4_7_7.selectedHasNoCommonZero

end Krenn.Component62.SelectedLeafB4_7_7
