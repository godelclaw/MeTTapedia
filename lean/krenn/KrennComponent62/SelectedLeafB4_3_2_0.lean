...
namespace Krenn.Component62.SelectedLeafB4_3_2_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "2941b06e016191bff9220e221cae49142bac7c6ce31fdf973ea07264e931ae6b"
...
def multipliers : Fin 16 → SparsePoly (Fin 64) := ![
  ...
  [{ coefficient := 1, powers := [(36, 1), (59, 1)] }, { coefficient := -1, powers := [(38, 1), (39, 1), (56, 1), (61, 1)] }, { coefficient := -1, powers := [(39, 1), (44, 1), (52, 1), (61, 1)] }, { coefficient := 1, powers := [(39, 1), (56, 1)] }, { coefficient := -1, powers := [(46, 1), (53, 1)] }],
...
#print axioms Krenn.Component62.SelectedLeafB4_3_2_0.selectedHasNoCommonZero

end Krenn.Component62.SelectedLeafB4_3_2_0
