...
namespace Krenn.Component62.SelectedLeafB4_7_3_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "95fe9cb1cfddd9b4df035f76460d27400dc3d54c3db5a66135aa5c5d174f1e5e"
...
def multipliers : Fin 6 → SparsePoly (Fin 69) := ![
  [{ coefficient := 1, powers := [(61, 1), (62, 1), (68, 1)] }],
  [{ coefficient := 1, powers := [(61, 1), (68, 1)] }],
  [{ coefficient := -1, powers := [(9, 1), (61, 1), (62, 1), (68, 1)] }],
...
#print axioms Krenn.Component62.SelectedLeafB4_7_3_7.selectedHasNoCommonZero

end Krenn.Component62.SelectedLeafB4_7_3_7
