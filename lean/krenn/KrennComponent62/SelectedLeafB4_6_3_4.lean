...
namespace Krenn.Component62.SelectedLeafB4_6_3_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "7aa857528b830e7e467d76d6126d04ccb1461f04b122a6302d4b7289209131ee"
def certificateSHA256 : String := "bc1c67efefcd6fe211fd75aea5a98aaf4b4b620e7e663a61fbe6b0368ed5c234"
...
def multipliers : Fin 22 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := 2, powers := [(6, 1), (52, 1), (59, 1)] }, { coefficient := -1, powers := [(51, 1), (56, 1), (63, 1)] }],
  ...
  [{ coefficient := 2, powers := [(6, 1), (36, 1), (58, 1), (59, 1)] }, { coefficient := 1, powers := [(36, 1), (59, 1)] }, { coefficient := -1, powers := [(39, 1), (55, 1), (56, 1), (63, 1)] }, { coefficient := 1, powers := [(39, 1), (56, 1)] }, { coefficient := -1, powers := [(46, 1), (53, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (33, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (30, 1), (56, 1)] }, { coefficient := -1, powers := [(12, 1), (22, 1), (56, 1)] }],
  [{ coefficient := 2, powers := [(5, 1), (6, 1), (58, 1), (59, 1)] }, { coefficient := 1, powers := [(5, 1), (59, 1)] }, { coefficient := 2, powers := [(6, 1), (16, 1), (45, 1), (59, 1)] }, { coefficient := -1, powers := [(12, 1), (46, 1)] }, { coefficient := -1, powers := [(17, 1), (45, 1), (48, 1)] }]
]
...
#print axioms Krenn.Component62.SelectedLeafB4_6_3_4.selectedHasNoCommonZero

end Krenn.Component62.SelectedLeafB4_6_3_4
