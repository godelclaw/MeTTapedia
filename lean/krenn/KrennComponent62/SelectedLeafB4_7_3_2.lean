...
namespace Krenn.Component62.SelectedLeafB4_7_3_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "4b02bb3cf3508078e178d6ad65479c93f99d73f4c31ff00f3e430e4167e39768"
def certificateSHA256 : String := "86ebc57165b88bb1907406b4b96edf5a73755fad26a740ff305f569e5fbbb822"
...
def multipliers : Fin 24 → SparsePoly (Fin 67) := ![
  ...
  [{ coefficient := 2, powers := [(18, 1), (51, 1), (56, 1)] }, { coefficient := -1, powers := [(51, 1), (56, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(22, 1), (44, 1)] }],
  [{ coefficient := 1, powers := [(22, 1), (44, 1), (53, 1)] }],
  [{ coefficient := 2, powers := [(12, 1), (18, 1), (56, 1)] }],
  [{ coefficient := -2, powers := [(12, 1), (22, 1), (24, 1), (50, 2), (56, 1), (65, 1)] }, { coefficient := 2, powers := [(12, 1), (22, 1), (50, 1), (52, 1), (56, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(53, 1)] }],
  [{ coefficient := 1, powers := [(46, 1)] }],
  [{ coefficient := 2, powers := [(12, 1), (22, 1), (24, 1), (50, 1), (56, 1), (65, 1)] }],
  [{ coefficient := -2, powers := [(22, 1), (56, 1)] }],
  [{ coefficient := -2, powers := [(22, 1), (53, 1)] }],
  [{ coefficient := 1, powers := [(22, 1)] }],
  [{ coefficient := 1, powers := [(17, 1)] }],
  [{ coefficient := -2, powers := [(12, 1), (22, 1), (50, 1), (56, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(12, 1)] }],
  [{ coefficient := 1, powers := [(39, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(56, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := -2, powers := [(18, 1), (45, 1), (51, 1), (56, 1)] }, { coefficient := 1, powers := [(36, 1), (59, 1)] }, { coefficient := -1, powers := [(38, 1), (39, 1), (56, 1), (62, 1)] }, { coefficient := -1, powers := [(39, 1), (44, 1), (52, 1), (62, 1)] }, { coefficient := -1, powers := [(39, 1), (55, 1), (56, 1), (64, 1)] }, { coefficient := 1, powers := [(39, 1), (56, 1)] }, { coefficient := -1, powers := [(46, 1), (53, 1)] }],
  ...
  [{ coefficient := 2, powers := [(12, 1), (22, 1), (24, 1), (41, 1), (50, 2), (56, 1), (65, 1)] }, { coefficient := -2, powers := [(12, 1), (22, 1), (41, 1), (50, 1), (52, 1), (56, 1), (65, 1)] }, { coefficient := 1, powers := [(16, 1), (22, 1), (44, 1), (53, 1)] }, { coefficient := 2, powers := [(17, 1), (22, 1), (38, 1), (53, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (59, 1)] }, { coefficient := -1, powers := [(12, 1), (46, 1)] }, { coefficient := -1, powers := [(16, 1), (39, 1), (44, 1), (62, 1)] }, { coefficient := -1, powers := [(17, 1), (38, 1), (39, 1), (62, 1)] }, { coefficient := -1, powers := [(17, 1), (45, 1), (48, 1)] }]
]
...
#print axioms Krenn.Component62.SelectedLeafB4_7_3_2.selectedHasNoCommonZero

end Krenn.Component62.SelectedLeafB4_7_3_2
