...
namespace Krenn.Component62.SelectedLeafB0_6_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "67eeb275ad6171ef26c4d9119b1af9f1ca6b3768ee7d64ef76147d3dabfe1a6c"
def certificateSHA256 : String := "4ee57d0628ca14e1857330e85094d8993d9f2546a3a924a025941aa7bc05ba09"
...
def multipliers : Fin 29 → SparsePoly (Fin 64) := ![
  ...
  [{ coefficient := -2, powers := [(17, 1), (53, 1), (62, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(41, 1), (53, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (43, 1), (59, 1), (60, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(22, 1), (44, 1)] }],
  [{ coefficient := -2, powers := [(17, 1), (53, 1), (62, 1)] }],
  [{ coefficient := 2, powers := [(13, 1), (17, 1), (53, 1), (62, 1), (63, 1)] }],
  ...
  [{ coefficient := -2, powers := [(13, 1), (17, 1), (22, 1), (53, 1), (62, 1)] }],
...
#print axioms Krenn.Component62.SelectedLeafB0_6_6.selectedHasNoCommonZero

end Krenn.Component62.SelectedLeafB0_6_6
