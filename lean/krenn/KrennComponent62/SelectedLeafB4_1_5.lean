...
namespace Krenn.Component62.SelectedLeafB4_1_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "e156d3b507310d765e9c6cddee347bdc29fcfe833cb1616c6b2a54e5b62f3d44"
...
def multipliers : Fin 10 → SparsePoly (Fin 64) := ![
  [{ coefficient := -1, powers := [(24, 1), (39, 1), (43, 1), (61, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(19, 1), (43, 1), (61, 1)] }, { coefficient := -1, powers := [(45, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(39, 1), (41, 1), (43, 1), (61, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(39, 1), (43, 1), (61, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(18, 1), (45, 1), (61, 1)] }, { coefficient := -1, powers := [(19, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(24, 1), (39, 1), (41, 1), (43, 1), (61, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(18, 1), (43, 1), (61, 1)] }, { coefficient := 1, powers := [(61, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := 1, powers := [(0, 1), (18, 1), (39, 1), (43, 1), (61, 1)] }, { coefficient := -1, powers := [(0, 1), (39, 1), (61, 1)] }, { coefficient := -1, powers := [(18, 1), (24, 1), (39, 1), (41, 1), (43, 1), (61, 1), (63, 1)] }],
...
#print axioms Krenn.Component62.SelectedLeafB4_1_5.selectedHasNoCommonZero

end Krenn.Component62.SelectedLeafB4_1_5
