...
namespace Krenn.Component62.SelectedLeafB4_3_3_4_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "343d102b66f5e601e0b9bfe549a466adda1182cf48416a58008f9155625a788d"
...
def multipliers : Fin 17 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := 1, powers := [(12, 1), (50, 1), (56, 1), (63, 1)] }, { coefficient := -1, powers := [(17, 1), (53, 1)] }],
  ...
  [{ coefficient := -1, powers := [(6, 1), (12, 1), (22, 1), (50, 1), (56, 1), (63, 1)] }, { coefficient := 1, powers := [(6, 1), (17, 1), (22, 1), (53, 1)] }],
...
#print axioms Krenn.Component62.SelectedLeafB4_3_3_4_0.selectedHasNoCommonZero

end Krenn.Component62.SelectedLeafB4_3_3_4_0
