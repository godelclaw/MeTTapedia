...
namespace Krenn.Component62.SelectedLeafB4_3_3_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "9d262c7d5afe1f9ac59dcb443ba271e36fa1846022e888f42c628099ba7efe0f"
...
def multipliers : Fin 36 → SparsePoly (Fin 67) := ![
  ...
  [{ coefficient := -1, powers := [(0, 1), (8, 1), (22, 1), (44, 1), (58, 1), (66, 1)] }, { coefficient := 1, powers := [(6, 1), (17, 1), (45, 1), (58, 1)] }, { coefficient := -1, powers := [(8, 1), (22, 1), (41, 1), (58, 1), (66, 1)] }],
  ...
  [{ coefficient := -1, powers := [(0, 1), (56, 1), (64, 1), (66, 1)] }],
...
#print axioms Krenn.Component62.SelectedLeafB4_3_3_3.selectedHasNoCommonZero

end Krenn.Component62.SelectedLeafB4_3_3_3
