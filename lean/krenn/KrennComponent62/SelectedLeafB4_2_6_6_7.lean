...
namespace Krenn.Component62.SelectedLeafB4_2_6_6_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "221d5579d51a253b956f997851db750c3b8925f5afabbc955379b6b0bcb41931"
def certificateSHA256 : String := "1d6c3d73694e330f6b78ecb7ca57fe9583179f61ee792b0bb70a4dfaff517b18"
...
def multipliers : Fin 18 → SparsePoly (Fin 69) := ![
  ...
  [{ coefficient := -1, powers := [(52, 1), (59, 1), (67, 1)] }],
  ...
  [{ coefficient := -1, powers := [(36, 1), (58, 1), (59, 1), (67, 1)] }, { coefficient := 1, powers := [(36, 1), (59, 1)] }, { coefficient := 1, powers := [(39, 1), (56, 1)] }, { coefficient := -1, powers := [(46, 1), (53, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (33, 1)] }],
  [{ coefficient := 1, powers := [(17, 1), (22, 1), (53, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (17, 1), (22, 1), (53, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (30, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (58, 1), (59, 1), (67, 1)] }, { coefficient := 1, powers := [(5, 1), (59, 1)] }, { coefficient := -1, powers := [(12, 1), (46, 1)] }, { coefficient := -1, powers := [(16, 1), (45, 1), (59, 1), (67, 1)] }, { coefficient := -1, powers := [(17, 1), (45, 1), (48, 1)] }],
...
#print axioms Krenn.Component62.SelectedLeafB4_2_6_6_7.selectedHasNoCommonZero

end Krenn.Component62.SelectedLeafB4_2_6_6_7
