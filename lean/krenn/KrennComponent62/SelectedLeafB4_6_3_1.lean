...
namespace Krenn.Component62.SelectedLeafB4_6_3_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "e2c643d7bc3e2f092b5a9114b1dc46dfe0bde0d2a7de883446fc770d44f28a1a"
...
def multipliers : Fin 33 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := 1, powers := [(18, 1), (51, 1), (56, 1)] }, { coefficient := -1, powers := [(51, 1), (56, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(22, 1), (44, 1)] }],
  [{ coefficient := 1, powers := [(22, 1), (44, 1), (53, 1)] }],
  [{ coefficient := 1, powers := [(12, 1), (18, 1), (56, 1)] }],
  [{ coefficient := -1, powers := [(12, 1), (22, 1), (56, 1), (62, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(12, 1), (56, 1), (60, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(27, 1), (51, 1)] }],
  [{ coefficient := -1, powers := [(12, 1), (22, 1), (24, 1), (50, 2), (56, 1), (64, 1)] }, { coefficient := 1, powers := [(12, 1), (22, 1), (50, 1), (52, 1), (56, 1), (64, 1)] }],
  [{ coefficient := 2, powers := [(12, 1), (27, 1), (50, 1)] }],
  [{ coefficient := 1, powers := [(53, 1)] }],
  [{ coefficient := 1, powers := [(46, 1)] }],
  [{ coefficient := 1, powers := [(12, 1), (22, 1), (24, 1), (50, 1), (56, 1), (64, 1)] }],
  ...
  [{ coefficient := -1, powers := [(12, 1), (22, 1), (50, 1), (56, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(12, 1)] }],
  [{ coefficient := 1, powers := [(12, 1), (22, 1), (56, 1), (60, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(56, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := -1, powers := [(12, 1), (22, 1), (43, 1), (56, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(18, 1), (45, 1), (51, 1), (56, 1)] }, { coefficient := 1, powers := [(36, 1), (59, 1)] }, { coefficient := -1, powers := [(39, 1), (55, 1), (56, 1), (63, 1)] }, { coefficient := 1, powers := [(39, 1), (56, 1)] }, { coefficient := -1, powers := [(46, 1), (53, 1)] }],
  ...
  [{ coefficient := 1, powers := [(12, 1), (22, 1), (24, 1), (41, 1), (50, 2), (56, 1), (64, 1)] }, { coefficient := -1, powers := [(12, 1), (22, 1), (38, 1), (56, 1), (60, 1), (62, 1)] }, { coefficient := -1, powers := [(12, 1), (22, 1), (41, 1), (50, 1), (52, 1), (56, 1), (64, 1)] }, { coefficient := -1, powers := [(12, 1), (22, 1), (43, 1), (56, 1), (60, 1), (62, 1)] }, { coefficient := -2, powers := [(12, 1), (27, 1), (46, 1), (50, 1)] }, { coefficient := 1, powers := [(16, 1), (22, 1), (44, 1), (53, 1)] }, { coefficient := 1, powers := [(16, 1), (27, 1), (46, 1), (51, 1)] }, { coefficient := 2, powers := [(17, 1), (22, 1), (38, 1), (53, 1)] }],
  [{ coefficient := 1, powers := [(12, 1), (22, 1), (38, 1), (56, 1), (62, 1)] }, { coefficient := 1, powers := [(12, 1), (22, 1), (43, 1), (56, 1), (62, 1)] }]
]
...
#print axioms Krenn.Component62.SelectedLeafB4_6_3_1.selectedHasNoCommonZero

end Krenn.Component62.SelectedLeafB4_6_3_1
