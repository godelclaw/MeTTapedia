...
namespace Krenn.Component62.SelectedLeafB0_7_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "bb75e2eb6a0729855345e3c066d84a10bf504cea64c777fd2c95ce6602027cc7"
...
def multipliers : Fin 13 → SparsePoly (Fin 65) := ![
  [{ coefficient := 1, powers := [(43, 1), (45, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (43, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(45, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(19, 1), (43, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(41, 1), (43, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(43, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(24, 1), (41, 1), (43, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(18, 1), (43, 1), (62, 1)] }, { coefficient := 1, powers := [(62, 1)] }],
  [{ coefficient := 1, powers := [(18, 1), (39, 1), (43, 1), (55, 1), (62, 1)] }, { coefficient := 1, powers := [(18, 1), (43, 1), (45, 1), (51, 1), (62, 1)] }, { coefficient := -1, powers := [(39, 1), (55, 1), (62, 1)] }, { coefficient := -1, powers := [(45, 1), (51, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(18, 1), (43, 1)] }, { coefficient := -1, powers := [] }],
  [{ coefficient := -1, powers := [(18, 1), (24, 1), (41, 1), (43, 1), (64, 1)] }],
...
#print axioms Krenn.Component62.SelectedLeafB0_7_5.selectedHasNoCommonZero

end Krenn.Component62.SelectedLeafB0_7_5
