...
namespace Krenn.Component62.SelectedLeafB4_6_2_6_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "e1523b3bb95ff642370580116ad0c5853995fbbc1398e9e5415596bf56790682"
def certificateSHA256 : String := "acfbfbd68deb1c973ff167358e1633c2e4e248cc1f503dec45f44dc276a4704b"
...
def multipliers : Fin 20 → SparsePoly (Fin 68) := ![
  ...
  [{ coefficient := -2, powers := [(52, 1), (59, 1), (66, 1)] }],
  ...
  [{ coefficient := 2, powers := [(59, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := 1, powers := [(16, 1), (22, 1), (41, 1), (53, 1)] }],
  [{ coefficient := -2, powers := [(36, 1), (58, 1), (59, 1), (66, 1)] }, { coefficient := 1, powers := [(36, 1), (59, 1)] }, { coefficient := 1, powers := [(39, 1), (56, 1)] }, { coefficient := -1, powers := [(46, 1), (53, 1)] }],
  ...
  [{ coefficient := -2, powers := [(5, 1), (58, 1), (59, 1), (66, 1)] }, { coefficient := 1, powers := [(5, 1), (59, 1)] }, { coefficient := -1, powers := [(12, 1), (46, 1)] }, { coefficient := -2, powers := [(16, 1), (45, 1), (59, 1), (66, 1)] }, { coefficient := -1, powers := [(17, 1), (45, 1), (48, 1)] }],
...
#print axioms Krenn.Component62.SelectedLeafB4_6_2_6_3.selectedHasNoCommonZero

end Krenn.Component62.SelectedLeafB4_6_2_6_3
