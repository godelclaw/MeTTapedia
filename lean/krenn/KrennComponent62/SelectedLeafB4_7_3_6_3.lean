...
namespace Krenn.Component62.SelectedLeafB4_7_3_6_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "d46bfdf6348699bef8fa500ce19b29ede6faa138a018a13889b474068c5fc952"
...
def multipliers : Fin 26 → SparsePoly (Fin 70) := ![
  [{ coefficient := -1, powers := [(12, 1), (52, 1), (58, 1), (68, 1)] }],
  [{ coefficient := 1, powers := [(45, 1), (53, 1), (58, 1), (68, 1)] }],
  [{ coefficient := -1, powers := [(51, 1), (56, 1), (58, 1), (64, 1), (68, 1)] }, { coefficient := -1, powers := [(52, 1), (58, 1), (59, 1), (68, 2)] }],
  [{ coefficient := -1, powers := [(16, 1), (45, 1), (53, 1), (58, 1), (68, 1)] }],
  [{ coefficient := -1, powers := [(22, 1), (56, 1), (58, 1), (66, 1), (68, 1)] }],
  [{ coefficient := 1, powers := [(22, 1), (48, 1), (56, 1), (58, 1), (60, 1), (68, 1)] }, { coefficient := 1, powers := [(22, 1), (48, 1), (56, 1), (58, 1), (66, 1), (68, 1)] }, { coefficient := -1, powers := [(33, 1), (45, 1), (50, 1), (53, 1), (68, 1)] }, { coefficient := -1, powers := [(33, 1), (45, 1), (53, 1), (55, 1), (68, 1)] }],
  [{ coefficient := -1, powers := [(16, 1), (22, 1), (56, 1), (58, 1), (60, 1), (68, 1)] }],
  [{ coefficient := 1, powers := [(46, 1), (58, 1), (68, 1)] }],
  [{ coefficient := -1, powers := [(33, 1), (45, 1), (53, 1), (68, 1)] }],
  [{ coefficient := 1, powers := [(33, 1), (53, 1), (68, 1)] }],
  [{ coefficient := 1, powers := [(23, 1), (33, 1), (45, 1), (53, 1), (68, 1)] }],
  [{ coefficient := 1, powers := [(17, 1), (58, 1), (68, 1)] }],
  [{ coefficient := -1, powers := [(16, 1), (33, 1), (53, 1), (68, 1)] }],
  [{ coefficient := 1, powers := [(12, 1), (58, 1), (68, 1)] }],
  [{ coefficient := 1, powers := [(16, 1), (33, 1), (45, 1), (53, 1), (68, 1)] }],
  [{ coefficient := 1, powers := [(39, 1), (58, 1), (62, 1), (68, 1)] }],
  [{ coefficient := 1, powers := [(56, 1), (58, 1), (64, 1), (68, 1)] }],
  [{ coefficient := 1, powers := [(58, 1), (59, 1), (68, 2)] }],
  [{ coefficient := -1, powers := [(58, 1), (68, 1)] }],
  [{ coefficient := 1, powers := [(16, 1), (22, 1), (48, 1), (56, 1), (58, 1), (68, 1)] }],
  [{ coefficient := -1, powers := [(36, 1), (58, 2), (59, 1), (68, 2)] }, { coefficient := 1, powers := [(36, 1), (58, 1), (59, 1), (68, 1)] }, { coefficient := -1, powers := [(38, 1), (39, 1), (56, 1), (58, 1), (62, 1), (68, 1)] }, { coefficient := -1, powers := [(39, 1), (44, 1), (52, 1), (58, 1), (62, 1), (68, 1)] }, { coefficient := -1, powers := [(39, 1), (55, 1), (56, 1), (58, 1), (64, 1), (68, 1)] }, { coefficient := 1, powers := [(39, 1), (56, 1), (58, 1), (68, 1)] }, { coefficient := -1, powers := [(41, 1), (45, 1), (53, 1), (58, 1), (68, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (33, 1), (39, 1), (58, 1), (68, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (30, 1), (56, 1), (58, 1), (68, 1)] }, { coefficient := -1, powers := [(12, 1), (22, 1), (56, 1), (58, 1), (68, 1)] }],
  [{ coefficient := 1, powers := [(12, 1), (22, 1), (56, 1), (58, 1), (68, 1)] }, { coefficient := -1, powers := [(16, 1), (22, 1), (48, 1), (56, 1), (58, 1), (68, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (58, 2), (59, 1), (68, 2)] }, { coefficient := 1, powers := [(5, 1), (58, 1), (59, 1), (68, 1)] }, { coefficient := -1, powers := [(12, 1), (46, 1), (58, 1), (68, 1)] }, { coefficient := -1, powers := [(16, 1), (39, 1), (44, 1), (58, 1), (62, 1), (68, 1)] }, { coefficient := -1, powers := [(16, 1), (45, 1), (58, 1), (59, 1), (68, 2)] }, { coefficient := -1, powers := [(17, 1), (38, 1), (39, 1), (58, 1), (62, 1), (68, 1)] }, { coefficient := -1, powers := [(17, 1), (45, 1), (48, 1), (58, 1), (68, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (22, 1), (58, 1), (59, 1), (68, 1)] }, { coefficient := -1, powers := [] }]
]
...
#print axioms Krenn.Component62.SelectedLeafB4_7_3_6_3.selectedHasNoCommonZero

end Krenn.Component62.SelectedLeafB4_7_3_6_3
