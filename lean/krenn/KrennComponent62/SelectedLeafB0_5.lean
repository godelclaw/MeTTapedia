...
namespace Krenn.Component62.SelectedLeafB0_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "20db0177e3083c1c90eaaa4e0e7946ab62ee8b5b95bf5983f111e96aa65f55d6"
...
def multipliers : Fin 7 → SparsePoly (Fin 62) := ![
  ...
  [{ coefficient := 1, powers := [(19, 1), (48, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (35, 1), (48, 1), (58, 1), (61, 1)] }, { coefficient := -1, powers := [(19, 1), (38, 1), (48, 1), (55, 1), (61, 1)] }, { coefficient := -1, powers := [(19, 1), (43, 1), (48, 1), (50, 1), (61, 1)] }, { coefficient := 1, powers := [(19, 1), (43, 1), (51, 1), (61, 1)] }, { coefficient := -1, powers := [(39, 1), (55, 1), (61, 1)] }, { coefficient := 1, powers := [(45, 1), (48, 1), (50, 1), (61, 1)] }, { coefficient := -1, powers := [(45, 1), (51, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (48, 1), (61, 1)] }],
...
#print axioms Krenn.Component62.SelectedLeafB0_5.selectedHasNoCommonZero

end Krenn.Component62.SelectedLeafB0_5
