...
namespace Krenn.Component62.SelectedLeafB4_3_3_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "d3f20ea7a11be96d72265f935c06cd063fa81cfb11fa39b5c8feeebebeb38477"
...
def multipliers : Fin 24 → SparsePoly (Fin 65) := ![
  ...
  [{ coefficient := -2, powers := [(18, 1), (45, 1), (51, 1), (56, 1)] }, { coefficient := 1, powers := [(36, 1), (59, 1)] }, { coefficient := -1, powers := [(38, 1), (39, 1), (56, 1), (61, 1)] }, { coefficient := -1, powers := [(39, 1), (44, 1), (52, 1), (61, 1)] }, { coefficient := -1, powers := [(39, 1), (55, 1), (56, 1), (63, 1)] }, { coefficient := 1, powers := [(39, 1), (56, 1)] }, { coefficient := -1, powers := [(46, 1), (53, 1)] }],
...
#print axioms Krenn.Component62.SelectedLeafB4_3_3_0.selectedHasNoCommonZero

end Krenn.Component62.SelectedLeafB4_3_3_0
