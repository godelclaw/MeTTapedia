...
namespace Krenn.Component62.SelectedLeafB4_2_3_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "611445098a1cf3764f0729f9aef45aadf725f5e5fb6607913e176c6d63cf83d3"
...
def multipliers : Fin 23 → SparsePoly (Fin 64) := ![
  ...
  [{ coefficient := 2, powers := [(18, 1), (51, 1), (56, 1)] }, { coefficient := -1, powers := [(51, 1), (56, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(22, 1), (44, 1)] }],
  [{ coefficient := 1, powers := [(22, 1), (44, 1), (53, 1)] }],
  [{ coefficient := 2, powers := [(12, 1), (18, 1), (56, 1)] }],
  [{ coefficient := -2, powers := [(12, 1), (22, 1), (24, 1), (50, 2), (56, 1), (63, 1)] }, { coefficient := 2, powers := [(12, 1), (22, 1), (50, 1), (52, 1), (56, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(53, 1)] }],
  [{ coefficient := 1, powers := [(46, 1)] }],
  [{ coefficient := 2, powers := [(12, 1), (22, 1), (24, 1), (50, 1), (56, 1), (63, 1)] }],
  [{ coefficient := -2, powers := [(22, 1), (56, 1)] }],
  [{ coefficient := -2, powers := [(22, 1), (53, 1)] }],
  [{ coefficient := 1, powers := [(22, 1)] }],
  [{ coefficient := 1, powers := [(17, 1)] }],
  [{ coefficient := -2, powers := [(12, 1), (22, 1), (50, 1), (56, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(12, 1)] }],
  [{ coefficient := 1, powers := [(56, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := -2, powers := [(18, 1), (45, 1), (51, 1), (56, 1)] }, { coefficient := 1, powers := [(36, 1), (59, 1)] }, { coefficient := -1, powers := [(39, 1), (55, 1), (56, 1), (62, 1)] }, { coefficient := 1, powers := [(39, 1), (56, 1)] }, { coefficient := -1, powers := [(46, 1), (53, 1)] }],
  ...
  [{ coefficient := 2, powers := [(12, 1), (22, 1), (24, 1), (41, 1), (50, 2), (56, 1), (63, 1)] }, { coefficient := -2, powers := [(12, 1), (22, 1), (41, 1), (50, 1), (52, 1), (56, 1), (63, 1)] }, { coefficient := 1, powers := [(16, 1), (22, 1), (44, 1), (53, 1)] }, { coefficient := 2, powers := [(17, 1), (22, 1), (38, 1), (53, 1)] }],
...
#print axioms Krenn.Component62.SelectedLeafB4_2_3_0.selectedHasNoCommonZero

end Krenn.Component62.SelectedLeafB4_2_3_0
