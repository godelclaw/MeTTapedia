...
namespace Krenn.Component62.SelectedLeafB4_2_7_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "4a6df9a86d5fccc74dd56481c3248a752eaa16b664d800bd8025cab5a31143ca"
def certificateSHA256 : String := "64ba665d74c896a3e274ac1466994c8e6eecdf5993999b157c25701ac7a6622e"
...
def multipliers : Fin 23 → SparsePoly (Fin 67) := ![
  ...
  [{ coefficient := 2, powers := [(15, 1), (22, 1), (56, 1), (62, 1), (66, 1)] }, { coefficient := -1, powers := [(17, 1), (45, 1)] }],
  ...
  [{ coefficient := -2, powers := [(22, 1), (56, 1), (62, 1)] }],
  ...
  [{ coefficient := 2, powers := [(12, 1), (22, 1), (42, 1), (56, 1), (62, 1)] }, { coefficient := -2, powers := [(12, 1), (27, 1), (46, 1), (50, 1)] }, { coefficient := -1, powers := [(16, 1), (22, 1), (24, 1), (44, 1), (51, 1)] }, { coefficient := 2, powers := [(16, 1), (22, 1), (44, 1), (53, 1)] }, { coefficient := 1, powers := [(16, 1), (27, 1), (46, 1), (51, 1)] }, { coefficient := -1, powers := [(17, 1), (22, 1), (24, 1), (38, 1), (51, 1)] }, { coefficient := 2, powers := [(17, 1), (22, 1), (38, 1), (53, 1)] }],
  [{ coefficient := -2, powers := [(15, 1), (22, 1), (48, 1), (56, 1), (62, 1)] }]
]
...
#print axioms Krenn.Component62.SelectedLeafB4_2_7_3.selectedHasNoCommonZero

end Krenn.Component62.SelectedLeafB4_2_7_3
