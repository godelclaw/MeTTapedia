...
namespace Krenn.Component62.SelectedLeafB0_2_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "70b11cd7117e52ec2bb944a16a572ce08623081b8b2d5b82e40c78f0102272ed"
def certificateSHA256 : String := "cf6c3b8d3c5c3300fa419199575abf3d3c3fce1b663c133d06f8b7d8f6a2493e"
...
def multipliers : Fin 25 → SparsePoly (Fin 64) := ![
  ...
  [{ coefficient := -2, powers := [(12, 1), (19, 1), (52, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (59, 1), (61, 1), (62, 1)] }, { coefficient := -1, powers := [(12, 1), (56, 1), (61, 1), (62, 1)] }, { coefficient := -1, powers := [(17, 1), (53, 1), (61, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(51, 1), (56, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(46, 1), (48, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (59, 1), (61, 1)] }, { coefficient := -1, powers := [(12, 1), (56, 1), (61, 1)] }, { coefficient := -1, powers := [(17, 1), (53, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (13, 1), (59, 1), (61, 1), (62, 1)] }, { coefficient := 1, powers := [(12, 1), (13, 1), (56, 1), (61, 1), (62, 1)] }, { coefficient := 1, powers := [(13, 1), (17, 1), (53, 1), (61, 1), (62, 1)] }],
  [{ coefficient := 2, powers := [(12, 1), (19, 1), (50, 1)] }],
  ...
  [{ coefficient := 2, powers := [(12, 1), (27, 1), (46, 1), (50, 1)] }],
  [{ coefficient := 1, powers := [(36, 1), (59, 1)] }, { coefficient := -1, powers := [(39, 1), (55, 1), (56, 1), (62, 1)] }, { coefficient := 1, powers := [(39, 1), (56, 1)] }, { coefficient := -1, powers := [(46, 1), (48, 1), (52, 1)] }, { coefficient := -1, powers := [(46, 1), (53, 1)] }],
  ...
  [{ coefficient := -1, powers := [(5, 1), (30, 1), (56, 1)] }, { coefficient := 1, powers := [(8, 1), (13, 1), (22, 1), (59, 1), (61, 1)] }, { coefficient := -1, powers := [(12, 1), (13, 1), (22, 1), (56, 1), (61, 1)] }, { coefficient := -1, powers := [(12, 1), (22, 1), (56, 1)] }, { coefficient := -1, powers := [(13, 1), (17, 1), (22, 1), (53, 1), (61, 1)] }]
]
...
#print axioms Krenn.Component62.SelectedLeafB0_2_7.selectedHasNoCommonZero

end Krenn.Component62.SelectedLeafB0_2_7
