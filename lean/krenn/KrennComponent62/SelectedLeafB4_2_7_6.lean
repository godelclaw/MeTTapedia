...
namespace Krenn.Component62.SelectedLeafB4_2_7_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "65eebd34ebd7db6d71610e2c714950a9df3caa662a59798d4a4a0cea9090cf1a"
def certificateSHA256 : String := "62c0c7bb73d4c79fb8f8f2acb3e5f0da8cc78c66cde9de4f93dfa0d59d3b6e10"
...
def multipliers : Fin 23 → SparsePoly (Fin 67) := ![
  ...
  [{ coefficient := -1, powers := [(17, 1), (53, 1), (62, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(6, 1), (52, 1), (59, 1)] }, { coefficient := -1, powers := [(51, 1), (56, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(22, 1), (56, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(17, 1), (53, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(22, 1), (48, 1), (56, 1), (60, 1)] }, { coefficient := 1, powers := [(22, 1), (48, 1), (56, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(13, 1), (17, 1), (53, 1), (62, 1), (63, 1)] }],
  ...
  [{ coefficient := 1, powers := [(6, 1), (36, 1), (58, 1), (59, 1)] }, { coefficient := 1, powers := [(36, 1), (59, 1)] }, { coefficient := -1, powers := [(39, 1), (55, 1), (56, 1), (63, 1)] }, { coefficient := 1, powers := [(39, 1), (56, 1)] }, { coefficient := -1, powers := [(46, 1), (53, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (33, 1)] }],
  [{ coefficient := 1, powers := [(17, 1), (22, 1), (53, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (30, 1), (56, 1)] }, { coefficient := -1, powers := [(12, 1), (22, 1), (56, 1)] }, { coefficient := -1, powers := [(13, 1), (17, 1), (22, 1), (53, 1), (62, 1)] }],
...
#print axioms Krenn.Component62.SelectedLeafB4_2_7_6.selectedHasNoCommonZero

end Krenn.Component62.SelectedLeafB4_2_7_6
