...
namespace Krenn.Component62.SelectedLeafB4_7_3_6_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "93253f3379b1ceeb77860880a8059735f4bc3a57b07cd7570828012c08346e06"
...
def multipliers : Fin 16 → SparsePoly (Fin 70) := ![
  ...
  [{ coefficient := 1, powers := [(8, 1), (59, 1)] }, { coefficient := 1, powers := [(12, 1), (50, 1), (56, 1), (64, 1)] }, { coefficient := -1, powers := [(17, 1), (53, 1)] }],
  ...
  [{ coefficient := -1, powers := [(6, 1), (8, 1), (22, 1), (59, 1)] }, { coefficient := -1, powers := [(6, 1), (12, 1), (22, 1), (50, 1), (56, 1), (64, 1)] }, { coefficient := 1, powers := [(6, 1), (17, 1), (22, 1), (53, 1)] }]
]
...
#print axioms Krenn.Component62.SelectedLeafB4_7_3_6_5.selectedHasNoCommonZero

end Krenn.Component62.SelectedLeafB4_7_3_6_5
