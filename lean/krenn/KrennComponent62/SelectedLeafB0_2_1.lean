...
namespace Krenn.Component62.SelectedLeafB0_2_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "d9832733b78e13912ed3f1ba8cc6e9eb62f79990888cf2e5ae064ae4a05ea941"
...
def multipliers : Fin 7 → SparsePoly (Fin 62) := ![
  ...
  [{ coefficient := -1, powers := [(24, 1), (35, 1), (41, 1), (58, 1), (61, 1)] }, { coefficient := -1, powers := [(24, 1), (38, 1), (41, 1), (55, 1), (61, 1)] }, { coefficient := -1, powers := [(24, 1), (41, 1), (43, 1), (50, 1), (61, 1)] }, { coefficient := 1, powers := [(24, 1), (44, 1), (50, 1), (61, 1)] }, { coefficient := -1, powers := [(38, 1), (56, 1), (61, 1)] }, { coefficient := 1, powers := [(41, 1), (43, 1), (52, 1), (61, 1)] }, { coefficient := -1, powers := [(44, 1), (52, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (41, 1), (61, 1)] }],
...
#print axioms Krenn.Component62.SelectedLeafB0_2_1.selectedHasNoCommonZero

end Krenn.Component62.SelectedLeafB0_2_1
