...
namespace Krenn.Component62.SelectedLeafB4_1_2_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "e05b6f459e8fe57f6f86e6754dbea2e3d8f9edc2aefc483501103813aabaa324"
...
def multipliers : Fin 5 → SparsePoly (Fin 66) := ![
  [{ coefficient := -1, powers := [(0, 1), (45, 1), (61, 1), (63, 1), (65, 1)] }, { coefficient := -1, powers := [(19, 1), (61, 1), (63, 1), (65, 1)] }, { coefficient := -1, powers := [(23, 1), (45, 1), (61, 1), (63, 1), (65, 1)] }],
...
#print axioms Krenn.Component62.SelectedLeafB4_1_2_7.selectedHasNoCommonZero

end Krenn.Component62.SelectedLeafB4_1_2_7
