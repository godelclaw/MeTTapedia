...
namespace Krenn.Component62.SelectedLeafB6_6_6_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "94eb8a0ab8b4143e2b3bf557bd364b14a34eda921bf4364245dfda089097207e"
...
def multipliers : Fin 6 → SparsePoly (Fin 69) := ![
  [{ coefficient := 1, powers := [(62, 1), (63, 1), (68, 1)] }],
  [{ coefficient := 1, powers := [(62, 1), (68, 1)] }],
  [{ coefficient := -1, powers := [(9, 1), (62, 1), (63, 1), (68, 1)] }],
...
#print axioms Krenn.Component62.SelectedLeafB6_6_6_7.selectedHasNoCommonZero

end Krenn.Component62.SelectedLeafB6_6_6_7
