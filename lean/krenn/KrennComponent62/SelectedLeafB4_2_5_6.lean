...
namespace Krenn.Component62.SelectedLeafB4_2_5_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "1fe8a0366c86f976d219ad8d4e35fd8b964f39c69ddb2d92d519deff7b83ce81"
...
def multipliers : Fin 27 → SparsePoly (Fin 66) := ![
  [{ coefficient := -1, powers := [(12, 1), (52, 1), (56, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(6, 1), (52, 1), (56, 1), (59, 1), (63, 1)] }, { coefficient := 1, powers := [(48, 1), (54, 1), (56, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(12, 1), (56, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (22, 1), (48, 1), (56, 1), (60, 1), (62, 1)] }, { coefficient := -1, powers := [(13, 1), (22, 1), (51, 1), (56, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(17, 1), (23, 1), (53, 1), (56, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (56, 1), (59, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (22, 1), (56, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(13, 1), (16, 1), (22, 1), (56, 1), (60, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(53, 1), (56, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(46, 1), (56, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(13, 1), (22, 1), (23, 1), (56, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(22, 1), (23, 1), (53, 1), (56, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(48, 1), (56, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(13, 1), (22, 1), (56, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(22, 1), (53, 1), (56, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(17, 1), (56, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(12, 1), (56, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(56, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(6, 1), (56, 1), (59, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(56, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (16, 1), (22, 1), (48, 1), (56, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(6, 1), (36, 1), (56, 1), (58, 1), (59, 1), (63, 1)] }, { coefficient := 1, powers := [(36, 1), (56, 1), (59, 1), (63, 1)] }, { coefficient := -1, powers := [(39, 1), (54, 1), (56, 1), (62, 1)] }, { coefficient := 1, powers := [(39, 1), (56, 2), (63, 1)] }, { coefficient := -1, powers := [(45, 1), (48, 1), (54, 1), (56, 1), (62, 1)] }, { coefficient := -1, powers := [(46, 1), (53, 1), (56, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (33, 1), (56, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (30, 1), (56, 1)] }],
  [{ coefficient := -1, powers := [(12, 1), (13, 1), (18, 1), (22, 1), (56, 1), (62, 1)] }, { coefficient := -1, powers := [(12, 1), (13, 1), (22, 1), (23, 1), (56, 1), (62, 1)] }, { coefficient := 1, powers := [(17, 1), (22, 1), (23, 1), (53, 1), (56, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (30, 1), (56, 1)] }, { coefficient := -1, powers := [] }],
  [{ coefficient := 1, powers := [(5, 1), (6, 1), (56, 1), (58, 1), (59, 1), (63, 1)] }, { coefficient := 1, powers := [(5, 1), (56, 1), (59, 1), (63, 1)] }, { coefficient := 1, powers := [(6, 1), (16, 1), (45, 1), (56, 1), (59, 1), (63, 1)] }, { coefficient := -1, powers := [(12, 1), (46, 1), (56, 1), (63, 1)] }, { coefficient := -1, powers := [(17, 1), (45, 1), (48, 1), (56, 1), (63, 1)] }]
]
...
#print axioms Krenn.Component62.SelectedLeafB4_2_5_6.selectedHasNoCommonZero

end Krenn.Component62.SelectedLeafB4_2_5_6
