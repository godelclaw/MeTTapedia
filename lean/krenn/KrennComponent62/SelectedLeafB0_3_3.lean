...
namespace Krenn.Component62.SelectedLeafB0_3_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "6f1c211bab930838cab6e771b4885ba545f2c8a93f9e0fa04edf67934a5baf78"
def certificateSHA256 : String := "fe7cd247052b1142520d76abff1d9559b0478396ba6299e9496e1b22ff3d8a47"

set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedSourceIndices : Fin 52 → Fin 667 := ![
  18,
  21,
  54,
  68,
...
def multipliers : Fin 52 → SparsePoly (Fin 64) := ![
  ...
  [{ coefficient := -1, powers := [(5, 1), (27, 1), (43, 1), (59, 1)] }, { coefficient := 1, powers := [(5, 1), (27, 1), (44, 1), (48, 1), (58, 1)] }, { coefficient := -1, powers := [(12, 1), (22, 1), (24, 1), (44, 1), (50, 1)] }, { coefficient := 2, powers := [(12, 1), (22, 1), (38, 1), (56, 1)] }, { coefficient := -3, powers := [(12, 1), (22, 1), (41, 1), (43, 1), (52, 1)] }, { coefficient := 2, powers := [(12, 1), (22, 1), (44, 1), (52, 1)] }, { coefficient := 1, powers := [(12, 1), (27, 1), (46, 1), (50, 1)] }, { coefficient := 1, powers := [(16, 1), (22, 1), (23, 1), (35, 1), (52, 1), (59, 1)] }, { coefficient := -1, powers := [(16, 1), (22, 1), (23, 1), (43, 1), (51, 1), (56, 1)] }, { coefficient := 1, powers := [(16, 1), (22, 1), (23, 1), (44, 1), (51, 1), (52, 1)] }, { coefficient := -1, powers := [(16, 1), (22, 1), (38, 1), (41, 1), (53, 1)] }, { coefficient := -1, powers := [(16, 1), (22, 1), (41, 1), (43, 1), (53, 1)] }, { coefficient := -1, powers := [(16, 1), (22, 1), (41, 1), (50, 1), (53, 1)] }, { coefficient := -1, powers := [(16, 1), (22, 1), (41, 1), (53, 1), (55, 1)] }, { coefficient := 1, powers := [(16, 1), (22, 1), (43, 1), (48, 1), (56, 1)] }, { coefficient := -1, powers := [(16, 1), (22, 1), (44, 1), (53, 1)] }, { coefficient := 1, powers := [(16, 1), (22, 1), (48, 1), (55, 1), (56, 1)] }, { coefficient := -1, powers := [(16, 1), (22, 1), (51, 1), (56, 1)] }, { coefficient := -1, powers := [(17, 1), (19, 1), (27, 1), (39, 1), (43, 1), (51, 1), (61, 1)] }, { coefficient := 2, powers := [(17, 1), (22, 1), (43, 1), (53, 1)] }, { coefficient := 1, powers := [(17, 1), (22, 1), (50, 1), (53, 1)] }, { coefficient := 1, powers := [(17, 1), (27, 1), (39, 2), (55, 1), (61, 1)] }, { coefficient := -1, powers := [(17, 1), (27, 1), (39, 1), (43, 1), (45, 1), (48, 1), (61, 1)] }, { coefficient := 1, powers := [(17, 1), (27, 1), (39, 1), (45, 1), (51, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(36, 1), (59, 1)] }, { coefficient := -1, powers := [(38, 1), (39, 1), (56, 1), (60, 1)] }, { coefficient := -1, powers := [(39, 1), (55, 1), (56, 1), (62, 1)] }, { coefficient := 1, powers := [(39, 1), (56, 1)] }, { coefficient := -1, powers := [(46, 1), (53, 1)] }],
...
#print axioms Krenn.Component62.SelectedLeafB0_3_3.selectedHasNoCommonZero

end Krenn.Component62.SelectedLeafB0_3_3
