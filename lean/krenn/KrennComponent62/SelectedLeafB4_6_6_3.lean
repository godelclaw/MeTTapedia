...
namespace Krenn.Component62.SelectedLeafB4_6_6_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "302e93de5fffda7999f618e70d3ac55a08b2a5f4ed446ea6cbf145f435af1fff"
...
def multipliers : Fin 6 → SparsePoly (Fin 67) := ![
  [{ coefficient := 1, powers := [(61, 1), (62, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(61, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(9, 1), (61, 1), (62, 1), (66, 1)] }],
...
#print axioms Krenn.Component62.SelectedLeafB4_6_6_3.selectedHasNoCommonZero

end Krenn.Component62.SelectedLeafB4_6_6_3
