...
namespace Krenn.Component62.SelectedLeafB0_6_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "0ab6988464a4e3f381fb99bc62d0406cbee9570a62c1d16ce1d3339a5363e556"
...
def multipliers : Fin 28 → SparsePoly (Fin 64) := ![
  ...
  [{ coefficient := 1, powers := [(6, 1), (52, 1), (59, 1)] }, { coefficient := -1, powers := [(51, 1), (56, 1), (62, 1)] }],
  ...
  [{ coefficient := 1, powers := [(6, 1), (36, 1), (58, 1), (59, 1)] }, { coefficient := -1, powers := [(6, 1), (45, 1), (52, 1), (59, 1)] }, { coefficient := 1, powers := [(36, 1), (59, 1)] }, { coefficient := -1, powers := [(39, 1), (55, 1), (56, 1), (62, 1)] }, { coefficient := 1, powers := [(39, 1), (56, 1)] }, { coefficient := -1, powers := [(46, 1), (53, 1)] }],
...
#print axioms Krenn.Component62.SelectedLeafB0_6_3.selectedHasNoCommonZero

end Krenn.Component62.SelectedLeafB0_6_3
