...
namespace Krenn.Component62.SelectedLeafB0_3_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "9ddf17c7808b36862748aa0f2d2a90445b896dc273b6b1c3158698f488eaae68"
def certificateSHA256 : String := "39ffd5ef7bf260b2046bf76b5c3684034f9ced9feeb225d337e2583f658d3788"
...
def multipliers : Fin 40 → SparsePoly (Fin 64) := ![
  ...
  [{ coefficient := 2, powers := [(12, 1), (27, 1), (46, 1), (50, 1)] }, { coefficient := -1, powers := [(16, 1), (22, 1), (44, 1), (53, 1)] }, { coefficient := -1, powers := [(16, 1), (27, 1), (46, 1), (51, 1)] }, { coefficient := -1, powers := [(17, 1), (19, 1), (27, 1), (39, 1), (43, 1), (51, 1), (61, 1)] }, { coefficient := 1, powers := [(17, 1), (22, 1), (43, 1), (53, 1)] }, { coefficient := 1, powers := [(17, 1), (27, 1), (39, 2), (55, 1), (61, 1)] }, { coefficient := -1, powers := [(17, 1), (27, 1), (39, 1), (43, 1), (45, 1), (48, 1), (61, 1)] }, { coefficient := 1, powers := [(17, 1), (27, 1), (39, 1), (45, 1), (51, 1), (61, 1)] }, { coefficient := 1, powers := [(17, 1), (27, 1), (39, 1), (55, 1)] }, { coefficient := -1, powers := [(17, 1), (27, 1), (45, 1), (48, 1), (50, 1)] }, { coefficient := 1, powers := [(17, 1), (27, 1), (45, 1), (51, 1)] }],
...
#print axioms Krenn.Component62.SelectedLeafB0_3_6.selectedHasNoCommonZero

end Krenn.Component62.SelectedLeafB0_3_6
