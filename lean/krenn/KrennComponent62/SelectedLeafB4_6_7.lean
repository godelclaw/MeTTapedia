...
namespace Krenn.Component62.SelectedLeafB4_6_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "99d526181c638a0a68afa7a86167c42a29bcc2afa78db5168cc4290c9775508a"
def certificateSHA256 : String := "27166f6013e83a6acb3d2094225b6bab8aa45c837b79225d3d9ebdf468be9019"
...
def multipliers : Fin 33 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := -2, powers := [(12, 1), (46, 1), (61, 1), (62, 1)] }],
  [{ coefficient := -2, powers := [(12, 1), (56, 1), (63, 1), (64, 1)] }, { coefficient := -2, powers := [(17, 1), (53, 1), (63, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(51, 1), (56, 1), (64, 1)] }],
  [{ coefficient := -2, powers := [(12, 1), (46, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(22, 1), (44, 1)] }],
  [{ coefficient := -2, powers := [(12, 1), (56, 1), (63, 1)] }, { coefficient := -2, powers := [(17, 1), (53, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(22, 1), (41, 1), (53, 1), (60, 1)] }, { coefficient := -1, powers := [(22, 1), (48, 1), (56, 1), (60, 1)] }, { coefficient := -1, powers := [(27, 1), (46, 1), (48, 1), (60, 1)] }],
  [{ coefficient := 2, powers := [(12, 1), (13, 1), (56, 1), (63, 1), (64, 1)] }, { coefficient := 2, powers := [(13, 1), (17, 1), (53, 1), (63, 1), (64, 1)] }],
  [{ coefficient := 2, powers := [(9, 1), (12, 1), (46, 1), (61, 1), (62, 1)] }],
  ...
  [{ coefficient := -1, powers := [(16, 1), (22, 1), (41, 1), (53, 1)] }, { coefficient := -1, powers := [(16, 1), (22, 1), (48, 1), (56, 1)] }, { coefficient := -1, powers := [(16, 1), (27, 1), (46, 1), (48, 1)] }],
  [{ coefficient := 1, powers := [(36, 1), (59, 1)] }, { coefficient := -1, powers := [(39, 1), (55, 1), (56, 1), (64, 1)] }, { coefficient := 1, powers := [(39, 1), (56, 1)] }, { coefficient := -1, powers := [(46, 1), (53, 1)] }],
  [{ coefficient := 2, powers := [(12, 1), (27, 1), (46, 1)] }],
  [{ coefficient := -2, powers := [(9, 1), (12, 1), (27, 1), (46, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (33, 1)] }, { coefficient := 1, powers := [(16, 1), (27, 1), (41, 1)] }, { coefficient := -1, powers := [(17, 1), (27, 1)] }],
  [{ coefficient := 2, powers := [(12, 1), (22, 1), (56, 1)] }, { coefficient := 2, powers := [(17, 1), (22, 1), (53, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (30, 1), (56, 1)] }, { coefficient := -2, powers := [(12, 1), (13, 1), (22, 1), (56, 1), (63, 1)] }, { coefficient := -1, powers := [(12, 1), (22, 1), (56, 1)] }, { coefficient := -2, powers := [(13, 1), (17, 1), (22, 1), (53, 1), (63, 1)] }]
]
...
#print axioms Krenn.Component62.SelectedLeafB4_6_7.selectedHasNoCommonZero

end Krenn.Component62.SelectedLeafB4_6_7
