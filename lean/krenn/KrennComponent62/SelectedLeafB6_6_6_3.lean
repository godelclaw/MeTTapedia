...
namespace Krenn.Component62.SelectedLeafB6_6_6_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "76f37df0f673be6c98eea05e2e9ffacd7d178a09a8d2c0ef6d91b977beb5c814"
...
def multipliers : Fin 6 → SparsePoly (Fin 68) := ![
  ...
  [{ coefficient := 1, powers := [(62, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(9, 1), (62, 1), (63, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := 1, powers := [(9, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(9, 1), (38, 1), (62, 1), (63, 1)] }, { coefficient := -1, powers := [(9, 1), (62, 1)] }, { coefficient := -1, powers := [(37, 1), (62, 1)] }]
]
...
#print axioms Krenn.Component62.SelectedLeafB6_6_6_3.selectedHasNoCommonZero

end Krenn.Component62.SelectedLeafB6_6_6_3
