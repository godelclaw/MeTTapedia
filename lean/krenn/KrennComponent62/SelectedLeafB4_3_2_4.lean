...
namespace Krenn.Component62.SelectedLeafB4_3_2_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "59dc2034c1ff7a1d1bdc42e27092b03bf61863394d5752f196acb74dabe8566b"
...
def multipliers : Fin 21 → SparsePoly (Fin 65) := ![
  ...
  [{ coefficient := 2, powers := [(6, 1), (36, 1), (58, 1), (59, 1)] }, { coefficient := 1, powers := [(36, 1), (59, 1)] }, { coefficient := -1, powers := [(38, 1), (39, 1), (56, 1), (61, 1)] }, { coefficient := -1, powers := [(39, 1), (44, 1), (52, 1), (61, 1)] }, { coefficient := 1, powers := [(39, 1), (56, 1)] }, { coefficient := -1, powers := [(46, 1), (53, 1)] }],
  ...
  [{ coefficient := 2, powers := [(5, 1), (6, 1), (58, 1), (59, 1)] }, { coefficient := 1, powers := [(5, 1), (59, 1)] }, { coefficient := 2, powers := [(6, 1), (16, 1), (45, 1), (59, 1)] }, { coefficient := -1, powers := [(12, 1), (46, 1)] }, { coefficient := -1, powers := [(16, 1), (39, 1), (44, 1), (61, 1)] }, { coefficient := -1, powers := [(17, 1), (38, 1), (39, 1), (61, 1)] }, { coefficient := -1, powers := [(17, 1), (45, 1), (48, 1)] }]
]
...
#print axioms Krenn.Component62.SelectedLeafB4_3_2_4.selectedHasNoCommonZero

end Krenn.Component62.SelectedLeafB4_3_2_4
