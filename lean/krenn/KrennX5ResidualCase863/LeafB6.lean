...
namespace Krenn.X5ResidualCase863.LeafB6

open Krenn.SparseCertificate
open MvPolynomial

def sourceSystemFileSHA256 : String := "03b66c8ce37daa0097616bf409b5ca0df1a01b274ffe45c2b4bb0981a2e0c348"
def sourceSystemSemanticSHA256 : String := "9269c929cb1955f2854f6e02c59010902649dc5e685d171f40de3c0c7410066d"
def certificateSHA256 : String := "8001308e85eb0b0234a0fd286e434088a942834e481b8e12bc773a9b9631acf0"
...
def multipliers : Fin 22 → SparsePoly (Fin 72) := ![
  ...
  [{ coefficient := -1, powers := [(15, 1), (40, 1), (69, 1)] }, { coefficient := -1, powers := [(15, 1), (51, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(15, 1), (43, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (32, 1), (37, 1), (46, 1), (63, 1)] }, { coefficient := -1, powers := [(13, 1), (32, 1), (40, 1), (46, 1), (57, 1)] }, { coefficient := -1, powers := [(13, 1), (32, 1), (43, 1), (46, 1), (54, 1)] }]
]
...
#print axioms Krenn.X5ResidualCase863.LeafB6.selectedHasNoCommonZero

end Krenn.X5ResidualCase863.LeafB6
