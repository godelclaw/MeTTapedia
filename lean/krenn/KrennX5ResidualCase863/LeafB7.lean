...
namespace Krenn.X5ResidualCase863.LeafB7

open Krenn.SparseCertificate
open MvPolynomial

def sourceSystemFileSHA256 : String := "aac232a38beba52b2cc0dd27d0f93f233ec2351e1e3277a259bc783313df2b9b"
def sourceSystemSemanticSHA256 : String := "eaf28133e027af6c4c5e8e4a9045518083d3616069a0c6429866a1bfd3768b61"
def certificateSHA256 : String := "f01f678f0d8f2678ac934561dbbfbdeaa88caa47aa8dd3d81e0108f684341f2d"
...
def multipliers : Fin 18 → SparsePoly (Fin 73) := ![
  [{ coefficient := 1, powers := [(40, 1), (69, 1), (72, 1)] }, { coefficient := 1, powers := [(43, 1), (66, 1), (72, 1)] }],
  ...
  [{ coefficient := -1, powers := [(15, 1), (40, 1), (69, 1)] }, { coefficient := -1, powers := [(15, 1), (43, 1), (66, 1)] }]
]
...
#print axioms Krenn.X5ResidualCase863.LeafB7.selectedHasNoCommonZero

end Krenn.X5ResidualCase863.LeafB7
