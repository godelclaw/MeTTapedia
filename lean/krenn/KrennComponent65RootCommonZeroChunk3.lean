...
namespace Krenn.Component65RootCommonZero.Chunk3
...
theorem rootBlock_of_base_and_component {R : Type*} [CommRing R]
    ...
    ∀ offset : Fin 40, eval₂Hom (Int.castRingHom R) (rootValues full)
      (Krenn.Component65.Tree.rootEquations ⟨120 + offset.val, by omega⟩).toPoly = 0 := by
...
end Krenn.Component65RootCommonZero.Chunk3
