...
namespace Krenn.X5ResidualCase304.LeafB3

open Krenn.SparseCertificate
open MvPolynomial

def sourceSystemFileSHA256 : String := "8e09c622ee192c10ea704f0f2a38fbbb2d2e2cbf156917dc9fb91c467fbd0b26"
def sourceSystemSemanticSHA256 : String := "621f2b59e3d8512ae9e681e183a168b72d79e19722c2eacf6a08ecf67fb00783"
def certificateSHA256 : String := "a276327b6ed47b0949b78d1892b3db28216b6eb6dc259f790878ecd27a896ea9"
...
def multipliers : Fin 34 → SparsePoly (Fin 72) := ![
  ...
  [{ coefficient := 1, powers := [(7, 1), (32, 1), (36, 1), (50, 1), (60, 1), (63, 1)] }, { coefficient := -1, powers := [(15, 1), (32, 1), (36, 1), (43, 1), (50, 1), (66, 1)] }, { coefficient := 1, powers := [(15, 1), (32, 1), (36, 1), (50, 1), (51, 1), (63, 1)] }],
  ...
  [{ coefficient := 1, powers := [(7, 1), (27, 1), (32, 1), (36, 1), (60, 1), (63, 1)] }, { coefficient := -1, powers := [(15, 1), (27, 1), (32, 1), (36, 1), (43, 1), (66, 1)] }, { coefficient := 1, powers := [(15, 1), (27, 1), (32, 1), (36, 1), (51, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(7, 1), (19, 1), (32, 1), (36, 1), (60, 1), (63, 1)] }, { coefficient := -1, powers := [(15, 1), (19, 1), (32, 1), (36, 1), (43, 1), (66, 1)] }, { coefficient := 1, powers := [(15, 1), (19, 1), (32, 1), (36, 1), (51, 1), (63, 1)] }],
  ...
  [{ coefficient := 1, powers := [(1, 1), (15, 1), (26, 1)] }, { coefficient := -1, powers := [(7, 1), (26, 1)] }, { coefficient := -1, powers := [(15, 1), (25, 1), (33, 1), (43, 1), (53, 1)] }],
  ...
  [{ coefficient := 1, powers := [(1, 1), (15, 1), (18, 1)] }, { coefficient := -1, powers := [(7, 1), (18, 1)] }],
  [{ coefficient := 1, powers := [(15, 1), (28, 1), (42, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(15, 1), (33, 1), (42, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(15, 1), (33, 1), (39, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(1, 1), (15, 1), (63, 1), (71, 1)] }, { coefficient := -1, powers := [(7, 1), (63, 1), (71, 1)] }],
  [{ coefficient := -1, powers := [(15, 1), (63, 1), (71, 1)] }],
  [{ coefficient := 1, powers := [(7, 1), (33, 1), (36, 1), (60, 1), (63, 1)] }, { coefficient := -1, powers := [(15, 1), (33, 1), (36, 1), (43, 1), (66, 1)] }, { coefficient := 1, powers := [(15, 1), (33, 1), (36, 1), (51, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(3, 1), (7, 1), (25, 1), (60, 1), (63, 1)] }, { coefficient := -1, powers := [(3, 1), (15, 1), (25, 1), (51, 1), (63, 1)] }, { coefficient := -1, powers := [(3, 1), (25, 1), (34, 1), (37, 1), (63, 1)] }, { coefficient := -1, powers := [(3, 1), (25, 1), (34, 1), (40, 1), (57, 1)] }, { coefficient := -1, powers := [(3, 1), (25, 1), (34, 1), (43, 1), (54, 1)] }, { coefficient := 1, powers := [(7, 1), (27, 1), (60, 1), (63, 1)] }, { coefficient := 1, powers := [(15, 1), (27, 1), (51, 1), (63, 1)] }, { coefficient := 1, powers := [(27, 1), (34, 1), (37, 1), (63, 1)] }, { coefficient := 1, powers := [(27, 1), (34, 1), (40, 1), (57, 1)] }, { coefficient := 1, powers := [(27, 1), (34, 1), (43, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [(3, 1), (7, 1), (17, 1), (60, 1), (63, 1)] }, { coefficient := -1, powers := [(3, 1), (15, 1), (17, 1), (51, 1), (63, 1)] }, { coefficient := -1, powers := [(3, 1), (17, 1), (34, 1), (37, 1), (63, 1)] }, { coefficient := -1, powers := [(3, 1), (17, 1), (34, 1), (40, 1), (57, 1)] }, { coefficient := -1, powers := [(3, 1), (17, 1), (34, 1), (43, 1), (54, 1)] }, { coefficient := 1, powers := [(7, 1), (19, 1), (60, 1), (63, 1)] }, { coefficient := 1, powers := [(15, 1), (19, 1), (51, 1), (63, 1)] }, { coefficient := 1, powers := [(19, 1), (34, 1), (37, 1), (63, 1)] }, { coefficient := 1, powers := [(19, 1), (34, 1), (40, 1), (57, 1)] }, { coefficient := 1, powers := [(19, 1), (34, 1), (43, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [(15, 1), (26, 1)] }, { coefficient := 1, powers := [(31, 1)] }],
  [{ coefficient := -1, powers := [(15, 1), (18, 1)] }, { coefficient := 1, powers := [(23, 1)] }],
  [{ coefficient := -1, powers := [(3, 1), (7, 1), (9, 1), (60, 1), (63, 1)] }, { coefficient := -1, powers := [(3, 1), (9, 1), (15, 1), (51, 1), (63, 1)] }, { coefficient := -1, powers := [(3, 1), (9, 1), (34, 1), (37, 1), (63, 1)] }, { coefficient := -1, powers := [(3, 1), (9, 1), (34, 1), (40, 1), (57, 1)] }, { coefficient := -1, powers := [(3, 1), (9, 1), (34, 1), (43, 1), (54, 1)] }, { coefficient := 1, powers := [(7, 1), (11, 1), (60, 1), (63, 1)] }, { coefficient := 1, powers := [(11, 1), (15, 1), (51, 1), (63, 1)] }, { coefficient := 1, powers := [(11, 1), (34, 1), (37, 1), (63, 1)] }, { coefficient := 1, powers := [(11, 1), (34, 1), (40, 1), (57, 1)] }, { coefficient := 1, powers := [(11, 1), (34, 1), (43, 1), (54, 1)] }],
  [{ coefficient := 1, powers := [(15, 1), (33, 1), (43, 1), (53, 1)] }],
  [{ coefficient := -1, powers := [(15, 1), (42, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(7, 1), (32, 1), (36, 1), (60, 1), (63, 1)] }, { coefficient := 1, powers := [(15, 1), (32, 1), (36, 1), (43, 1), (66, 1)] }, { coefficient := -1, powers := [(15, 1), (32, 1), (36, 1), (51, 1), (63, 1)] }],
  ...
  [{ coefficient := 1, powers := [(3, 1), (7, 1), (60, 1), (63, 1)] }, { coefficient := 1, powers := [(3, 1), (15, 1), (51, 1), (63, 1)] }, { coefficient := 1, powers := [(3, 1), (34, 1), (37, 1), (63, 1)] }, { coefficient := 1, powers := [(3, 1), (34, 1), (40, 1), (57, 1)] }, { coefficient := 1, powers := [(3, 1), (34, 1), (43, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [(7, 1), (60, 1), (63, 1)] }, { coefficient := -1, powers := [(15, 1), (51, 1), (63, 1)] }, { coefficient := -1, powers := [(34, 1), (37, 1), (63, 1)] }, { coefficient := -1, powers := [(34, 1), (40, 1), (57, 1)] }, { coefficient := -1, powers := [(34, 1), (43, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := -1, powers := [(1, 1), (15, 1), (49, 1), (63, 1)] }, { coefficient := 1, powers := [(7, 1), (49, 1), (63, 1)] }, { coefficient := 1, powers := [(7, 1), (60, 1), (63, 1)] }, { coefficient := -1, powers := [(11, 1), (15, 1), (42, 1), (43, 1), (65, 1), (66, 1)] }, { coefficient := 1, powers := [(14, 1), (33, 1), (37, 1), (49, 1), (62, 1), (63, 1)] }, { coefficient := 1, powers := [(14, 1), (33, 1), (40, 1), (49, 1), (57, 1), (62, 1)] }, { coefficient := 1, powers := [(14, 1), (33, 1), (43, 1), (49, 1), (54, 1), (62, 1)] }, { coefficient := 1, powers := [(15, 1), (51, 1), (63, 1)] }]
]
...
#print axioms Krenn.X5ResidualCase304.LeafB3.selectedHasNoCommonZero

end Krenn.X5ResidualCase304.LeafB3
