...
namespace Krenn.X5Case783Selected

open Krenn.SparseCertificate
open MvPolynomial

def sourceSystemFileSHA256 : String := "e911246708aa9426b91c7d93cbbdef75e80315c9e92d979ad5932ac4801394b4"
def sourceSystemSemanticSHA256 : String := "8ff81c54fd0907782924c9b1eebde26ad77778a262fd9046648dc266e4635f07"
...
def multipliers : Fin 15 → SparsePoly (Fin 70) := ![
  ...
  [{ coefficient := -1, powers := [(3, 1), (9, 1), (32, 1), (35, 1), (61, 1)] }, { coefficient := -1, powers := [(3, 1), (9, 1), (32, 1), (38, 1), (55, 1)] }, { coefficient := -1, powers := [(3, 1), (9, 1), (32, 1), (41, 1), (52, 1)] }, { coefficient := 1, powers := [(12, 1), (32, 1), (35, 1), (61, 1)] }, { coefficient := 1, powers := [(12, 1), (32, 1), (38, 1), (55, 1)] }, { coefficient := 1, powers := [(12, 1), (32, 1), (41, 1), (52, 1)] }],
...
#print axioms Krenn.X5Case783Selected.selectedHasNoCommonZero

end Krenn.X5Case783Selected
