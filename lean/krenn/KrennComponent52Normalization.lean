...
/-!
Exact normalization of external minimal-prime component 52 into
zero-based Lean component row 51.  All exponent-map equalities are
rechecked by Lean below; this source is generated only for serialization.
-/

namespace Krenn.Component52Normalization
...
theorem selectedIndices_exact : componentGenerators 51 = selectedIndices := by decide
...
set_option maxRecDepth 100000 in
theorem rawComponent52_vanishes {R : Type*} [CommRing R]
...
end Krenn.Component52Normalization

#print axioms Krenn.Component52Normalization.rawComponent52_vanishes
