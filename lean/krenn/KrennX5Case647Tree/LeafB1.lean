...
namespace Krenn.X5Case647Tree.LeafB1

open Krenn.SparseCertificate
open MvPolynomial

def sourceSystemFileSHA256 : String := "f5178d87a60ff7614ebf5c73432f22788e5ee45c321d48a15ecea51d38aeb50c"
def sourceSystemSemanticSHA256 : String := "075c4e23df198408bccd165e7bd859411604f7f350f69d09b8755863d612e0ca"
def certificateSHA256 : String := "7336ed93b3bbd38471d7d7463e54c566e37b2e7c05b5a58a7fd6db6f8d8bbfc0"
...
def multipliers : Fin 16 → SparsePoly (Fin 71) := ![
  ...
  [{ coefficient := 1, powers := [(2, 1), (8, 1), (34, 1), (40, 1), (47, 1), (57, 1)] }, { coefficient := 1, powers := [(2, 1), (8, 1), (34, 1), (43, 1), (47, 1), (54, 1)] }],
  ...
  [{ coefficient := -1, powers := [(2, 1), (8, 1), (34, 1), (40, 1), (57, 1)] }, { coefficient := -1, powers := [(2, 1), (8, 1), (34, 1), (43, 1), (54, 1)] }],
...
#print axioms Krenn.X5Case647Tree.LeafB1.selectedHasNoCommonZero

end Krenn.X5Case647Tree.LeafB1
