...
namespace Krenn.X5Case647Tree.LeafB7

open Krenn.SparseCertificate
open MvPolynomial

def sourceSystemFileSHA256 : String := "3ee9f80503d77f753677acc1ab6d286bb89a041152f8458430de88a8b97d345f"
def sourceSystemSemanticSHA256 : String := "6a8d44ea8ac128a4d25c417238a59cd60938dad3f3756c5d02e5f1e21ad10341"
def certificateSHA256 : String := "42eb7ff2c46eb68402845e0a0b149343018763f1b68fabd1151ca102ff51c9ad"
...
def multipliers : Fin 15 → SparsePoly (Fin 73) := ![
  ...
  [{ coefficient := -1, powers := [(0, 1), (34, 1), (40, 1), (47, 1), (57, 1)] }, { coefficient := -1, powers := [(0, 1), (34, 1), (43, 1), (47, 1), (54, 1)] }, { coefficient := 1, powers := [(2, 1), (8, 1), (34, 1), (40, 1), (47, 1), (57, 1)] }, { coefficient := 1, powers := [(2, 1), (8, 1), (34, 1), (43, 1), (47, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [(7, 1), (49, 1)] }],
  [{ coefficient := -1, powers := [(32, 1), (40, 1), (46, 1), (57, 1)] }, { coefficient := -1, powers := [(32, 1), (43, 1), (46, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (27, 1), (34, 1), (40, 1), (57, 1)] }, { coefficient := -1, powers := [(8, 1), (27, 1), (34, 1), (43, 1), (54, 1)] }, { coefficient := 1, powers := [(24, 1), (34, 1), (40, 1), (57, 1)] }, { coefficient := 1, powers := [(24, 1), (34, 1), (43, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (19, 1), (34, 1), (40, 1), (57, 1)] }, { coefficient := -1, powers := [(8, 1), (19, 1), (34, 1), (43, 1), (54, 1)] }, { coefficient := 1, powers := [(16, 1), (34, 1), (40, 1), (57, 1)] }, { coefficient := 1, powers := [(16, 1), (34, 1), (43, 1), (54, 1)] }],
  [{ coefficient := 1, powers := [(31, 1)] }],
  [{ coefficient := 1, powers := [(23, 1)] }],
  [{ coefficient := 1, powers := [(15, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (34, 1), (40, 1), (57, 1)] }, { coefficient := 1, powers := [(0, 1), (34, 1), (43, 1), (54, 1)] }, { coefficient := -1, powers := [(2, 1), (8, 1), (34, 1), (40, 1), (57, 1)] }, { coefficient := -1, powers := [(2, 1), (8, 1), (34, 1), (43, 1), (54, 1)] }],
...
#print axioms Krenn.X5Case647Tree.LeafB7.selectedHasNoCommonZero

end Krenn.X5Case647Tree.LeafB7
