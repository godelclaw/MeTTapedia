...
namespace Krenn.Component56.SelectedLeafB3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "4c2a1fb888b54b0307a629b17dcb39b3bc04ab33833d9b8b3c1837df5b4582e3"
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedEquations : Fin 26 → SparsePoly (Fin 59) := ![
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def multipliers : Fin 26 → SparsePoly (Fin 59) := ![
  [{ coefficient := -1, powers := [(5, 1), (17, 1), (29, 1), (53, 1), (58, 1)] }, { coefficient := 1, powers := [(5, 1), (17, 1), (32, 1), (50, 1), (58, 1)] }, { coefficient := -1, powers := [(16, 1), (17, 1), (21, 1), (50, 1), (58, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (23, 1), (29, 1), (58, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (18, 1), (52, 1), (53, 1), (58, 1)] }, { coefficient := -1, powers := [(8, 1), (18, 1), (32, 1), (52, 1), (58, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (22, 1), (44, 1), (50, 1), (58, 1)] }, { coefficient := 1, powers := [(8, 1), (22, 1), (29, 1), (44, 1), (58, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (18, 1), (53, 1), (58, 1)] }, { coefficient := -1, powers := [(8, 1), (18, 1), (32, 1), (58, 1)] }],
...
#print axioms Krenn.Component56.SelectedLeafB3.selectedHasNoCommonZero

end Krenn.Component56.SelectedLeafB3
