...
namespace Krenn.Component15RootCommonZero.Chunk14
...
theorem rootBlock_of_base_and_component {R : Type*} [CommRing R]
    ...
    ∀ offset : Fin 26, eval₂Hom (Int.castRingHom R) (rootValues full)
      (Krenn.Component15.Tree.rootEquations ⟨560 + offset.val, by omega⟩).toPoly = 0 := by
...
end Krenn.Component15RootCommonZero.Chunk14
