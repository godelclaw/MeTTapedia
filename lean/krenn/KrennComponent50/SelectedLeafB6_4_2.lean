...
namespace Krenn.Component50.SelectedLeafB6_4_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "3b820031c22c679d9a76db81a9cc7e5f738b27b20be11c61ec1d1d519b6e0051"
...
def multipliers : Fin 22 → SparsePoly (Fin 64) := ![
  ...
  [{ coefficient := 1, powers := [(39, 1), (59, 1)] }, { coefficient := -1, powers := [(47, 1), (53, 1), (55, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(14, 1), (30, 1), (47, 1), (63, 1)] }, { coefficient := 1, powers := [(19, 1), (20, 1), (24, 1), (53, 1)] }, { coefficient := 1, powers := [(19, 1), (24, 1), (25, 1), (53, 1)] }],
...
#print axioms Krenn.Component50.SelectedLeafB6_4_2.selectedHasNoCommonZero

end Krenn.Component50.SelectedLeafB6_4_2
