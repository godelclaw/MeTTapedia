...
namespace Krenn.Component50.SelectedLeafB4_4_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "9fad3b3e23c51c67737daa1301cc375d589569efaef79db8d6d2ddfe4751a6c2"
...
def multipliers : Fin 20 → SparsePoly (Fin 64) := ![
  ...
  [{ coefficient := 1, powers := [(5, 1), (36, 1), (53, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := 1, powers := [(39, 1), (59, 1)] }, { coefficient := -1, powers := [(47, 1), (53, 1), (55, 1), (63, 1)] }, { coefficient := 1, powers := [(47, 1), (53, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (5, 1), (36, 1), (53, 1), (54, 1), (62, 1)] }, { coefficient := -1, powers := [(5, 1), (6, 1), (34, 1), (36, 1), (53, 1), (62, 1)] }, { coefficient := -1, powers := [(5, 1), (15, 1), (25, 1), (36, 1), (53, 1), (62, 1)] }, { coefficient := -1, powers := [(14, 1), (30, 1), (47, 1), (63, 1)] }],
...
#print axioms Krenn.Component50.SelectedLeafB4_4_6.selectedHasNoCommonZero

end Krenn.Component50.SelectedLeafB4_4_6
