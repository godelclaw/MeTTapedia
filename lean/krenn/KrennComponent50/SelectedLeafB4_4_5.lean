...
namespace Krenn.Component50.SelectedLeafB4_4_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "569e9d06c06aff9415e6edde95524f175d0ad9f244cfd3ef8600a093eb517a36"
...
def multipliers : Fin 17 → SparsePoly (Fin 64) := ![
  [{ coefficient := -2, powers := [(24, 1), (56, 1), (62, 1)] }, { coefficient := -2, powers := [(30, 1), (47, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (36, 1), (53, 1), (60, 1), (63, 1)] }, { coefficient := 1, powers := [(19, 1), (21, 1), (30, 1), (51, 1), (60, 1), (63, 1)] }, { coefficient := -1, powers := [(19, 1), (24, 1), (26, 1), (51, 1), (60, 1), (63, 1)] }, { coefficient := 1, powers := [(19, 1), (24, 1), (53, 1), (60, 1), (63, 1)] }],
...
#print axioms Krenn.Component50.SelectedLeafB4_4_5.selectedHasNoCommonZero

end Krenn.Component50.SelectedLeafB4_4_5
