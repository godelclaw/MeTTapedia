...
namespace Krenn.Component50.SelectedLeafB6_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "c8415eaeddec52a7c07c7000164d8bdc3be11114bb9424b5aa98fad8aba00eac"
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedEquations : Fin 46 → SparsePoly (Fin 62) := ![
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def multipliers : Fin 46 → SparsePoly (Fin 62) := ![
...
#print axioms Krenn.Component50.SelectedLeafB6_0.selectedHasNoCommonZero

end Krenn.Component50.SelectedLeafB6_0
