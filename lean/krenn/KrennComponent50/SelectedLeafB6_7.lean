...
namespace Krenn.Component50.SelectedLeafB6_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "4d104dbda0d02c31d7ab6c57b3258fc41ebf1cb308b2e6eda870bd3485f27678"
def certificateSHA256 : String := "765dbc4ec7dce6b4eca786b29855795cc15a3d8c4d51efd71657da13a73f4eb4"
...
def multipliers : Fin 32 → SparsePoly (Fin 65) := ![
  ...
  [{ coefficient := 2, powers := [(0, 1), (5, 1), (9, 1), (21, 1), (33, 1), (56, 1), (64, 1)] }, { coefficient := -1, powers := [(0, 1), (5, 1), (21, 1), (33, 1), (48, 1), (56, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(3, 1), (5, 1), (33, 1), (56, 1), (57, 1), (64, 1)] }, { coefficient := 1, powers := [(5, 1), (9, 1), (15, 1), (33, 1), (56, 1), (64, 1)] }, { coefficient := 1, powers := [(5, 1), (9, 1), (33, 1), (43, 1), (56, 1), (64, 1)] }, { coefficient := -1, powers := [(5, 1), (33, 1), (34, 1), (37, 1), (40, 1), (44, 1), (56, 1), (64, 1)] }, { coefficient := -1, powers := [(5, 1), (33, 1), (43, 1), (48, 1), (56, 1), (64, 1)] }, { coefficient := -1, powers := [(8, 1), (33, 1), (47, 1), (60, 1), (64, 1)] }, { coefficient := 1, powers := [(19, 1), (30, 1), (42, 1), (50, 2), (63, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (20, 1), (34, 1), (48, 1), (56, 1)] }, { coefficient := 1, powers := [(5, 1), (31, 1), (34, 1), (37, 1), (56, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (53, 1), (58, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (33, 1), (60, 1)] }],
  [{ coefficient := -1, powers := [(42, 1), (52, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(42, 1), (56, 1), (63, 1)] }],
  ...
  [{ coefficient := -2, powers := [(0, 1), (5, 1), (9, 1), (33, 1), (56, 1), (64, 1)] }, { coefficient := 1, powers := [(0, 1), (5, 1), (33, 1), (48, 1), (56, 1), (64, 1)] }],
  ...
  [{ coefficient := -1, powers := [(25, 1), (30, 1), (42, 1), (50, 1), (63, 1)] }, { coefficient := -1, powers := [(30, 1), (42, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(19, 1)] }],
  [{ coefficient := 1, powers := [(14, 1)] }],
  [{ coefficient := -2, powers := [(0, 1), (5, 1), (9, 1), (33, 1), (41, 1), (56, 1), (64, 1)] }, { coefficient := -1, powers := [(5, 1), (9, 1), (33, 1), (56, 1), (64, 1)] }, { coefficient := 1, powers := [(5, 1), (20, 1), (33, 1), (41, 1), (48, 1), (56, 1), (64, 1)] }, { coefficient := 1, powers := [(5, 1), (33, 1), (40, 1), (56, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (31, 1), (56, 1)] }],
  [{ coefficient := 1, powers := [(30, 1), (42, 1), (50, 1), (63, 1)] }],
  ...
  [{ coefficient := -1, powers := [(6, 1), (47, 1), (53, 1), (58, 1)] }, { coefficient := 1, powers := [(39, 1), (59, 1)] }, { coefficient := -1, powers := [(41, 1), (42, 1), (56, 1), (63, 1)] }, { coefficient := 1, powers := [(42, 1), (50, 1), (56, 1), (63, 1)] }, { coefficient := 1, powers := [(42, 1), (56, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (6, 1), (36, 1), (53, 1), (58, 1)] }, { coefficient := -1, powers := [(8, 1), (36, 1), (42, 1)] }],
  [{ coefficient := 2, powers := [(0, 2), (5, 1), (9, 1), (33, 1), (41, 1), (54, 1), (56, 1)] }, { coefficient := 2, powers := [(0, 1), (5, 1), (6, 1), (9, 1), (33, 1), (34, 1), (41, 1), (56, 1)] }, { coefficient := 2, powers := [(0, 1), (5, 1), (9, 1), (15, 1), (25, 1), (33, 1), (41, 1), (56, 1)] }, { coefficient := 2, powers := [(0, 1), (5, 1), (9, 1), (15, 1), (33, 1), (56, 1)] }, { coefficient := 1, powers := [(0, 1), (5, 1), (9, 1), (33, 1), (54, 1), (56, 1)] }, { coefficient := -1, powers := [(0, 1), (5, 1), (15, 1), (33, 1), (48, 1), (56, 1)] }, { coefficient := -1, powers := [(0, 1), (5, 1), (20, 1), (33, 1), (41, 1), (48, 1), (54, 1), (56, 1)] }, { coefficient := -1, powers := [(0, 1), (5, 1), (33, 1), (40, 1), (54, 1), (56, 1)] }, { coefficient := -1, powers := [(3, 1), (5, 1), (25, 1), (33, 1), (56, 1), (57, 1)] }, { coefficient := 1, powers := [(5, 1), (6, 1), (9, 1), (33, 1), (34, 1), (56, 1)] }, { coefficient := -1, powers := [(5, 1), (6, 1), (20, 1), (33, 1), (34, 1), (41, 1), (48, 1), (56, 1)] }, { coefficient := -1, powers := [(5, 1), (6, 1), (33, 1), (34, 1), (40, 1), (56, 1)] }, { coefficient := -1, powers := [(5, 1), (9, 1), (25, 1), (33, 1), (43, 1), (56, 1)] }, { coefficient := -1, powers := [(5, 1), (15, 1), (20, 1), (25, 1), (33, 1), (41, 1), (48, 1), (56, 1)] }, { coefficient := -1, powers := [(5, 1), (15, 1), (25, 1), (33, 1), (40, 1), (56, 1)] }, { coefficient := 1, powers := [(5, 1), (25, 1), (33, 1), (34, 1), (37, 1), (40, 1), (44, 1), (56, 1)] }, { coefficient := 1, powers := [(5, 1), (25, 1), (33, 1), (43, 1), (48, 1), (56, 1)] }, { coefficient := 1, powers := [(8, 1), (25, 1), (33, 1), (47, 1), (60, 1)] }, { coefficient := -1, powers := [(19, 1), (25, 1), (30, 1), (42, 1), (50, 2), (63, 1)] }]
]
...
#print axioms Krenn.Component50.SelectedLeafB6_7.selectedHasNoCommonZero

end Krenn.Component50.SelectedLeafB6_7
