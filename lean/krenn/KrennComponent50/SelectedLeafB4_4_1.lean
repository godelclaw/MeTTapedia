...
namespace Krenn.Component50.SelectedLeafB4_4_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "961d734888f4f729f0e1283d80c53d4559794f5cd81ca38b194df67dad7880cc"
...
def multipliers : Fin 8 → SparsePoly (Fin 63) := ![
  [{ coefficient := -1, powers := [(26, 1), (45, 1), (50, 1), (62, 2)] }, { coefficient := 1, powers := [(45, 1), (52, 1), (62, 2)] }],
  [{ coefficient := -1, powers := [(26, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(45, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(62, 1)] }],
  [{ coefficient := 1, powers := [(26, 1), (45, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (56, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(20, 1), (26, 1), (45, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(20, 1), (26, 1), (45, 1), (50, 1), (62, 1)] }, { coefficient := -1, powers := [(20, 1), (45, 1), (52, 1), (62, 1)] }, { coefficient := -1, powers := [] }]
]
...
#print axioms Krenn.Component50.SelectedLeafB4_4_1.selectedHasNoCommonZero

end Krenn.Component50.SelectedLeafB4_4_1
