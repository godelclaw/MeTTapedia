...
namespace Krenn.Component50.SelectedLeafB6_4_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "5acbe5a00ffcb75addb30463da88ffb56461db8715b7e666a0966aafdfcfac2d"
def certificateSHA256 : String := "ec417496dc413b162c3ce3f90acde3937e7e218a6a66367a6ea8a65c8d9e4cc4"
...
def multipliers : Fin 18 → SparsePoly (Fin 63) := ![
  ...
  [{ coefficient := -1, powers := [(5, 1), (20, 1), (36, 1), (53, 1)] }, { coefficient := 1, powers := [(14, 1), (20, 1), (30, 1), (47, 1)] }, { coefficient := 1, powers := [(14, 1), (25, 1), (30, 1), (47, 1)] }],
...
#print axioms Krenn.Component50.SelectedLeafB6_4_0.selectedHasNoCommonZero

end Krenn.Component50.SelectedLeafB6_4_0
