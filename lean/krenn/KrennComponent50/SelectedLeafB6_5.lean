...
namespace Krenn.Component50.SelectedLeafB6_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "4326417139d0014198c350cb1b2251a27875304170bdaa16963de126e3ee4d8c"
...
def multipliers : Fin 22 → SparsePoly (Fin 64) := ![
  ...
  [{ coefficient := 1, powers := [(5, 1), (24, 1), (53, 1), (58, 1), (63, 1)] }, { coefficient := -1, powers := [(8, 1), (24, 1), (58, 1)] }],
  [{ coefficient := 1, powers := [(30, 1), (42, 1), (49, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (26, 1), (33, 1), (45, 1), (60, 1), (63, 1)] }, { coefficient := 1, powers := [(5, 1), (33, 1), (37, 1), (47, 1), (53, 1), (58, 1), (60, 1), (63, 2)] }, { coefficient := 1, powers := [(5, 1), (33, 1), (45, 1), (52, 1), (63, 1)] }, { coefficient := -1, powers := [(8, 1), (33, 1), (47, 1), (60, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (26, 1), (33, 1), (60, 1)] }, { coefficient := -1, powers := [(5, 1), (33, 1), (52, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (33, 1), (37, 1), (53, 1), (58, 1), (60, 1), (63, 1)] }, { coefficient := 1, powers := [(8, 1), (33, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (47, 1), (53, 1), (58, 1), (63, 1)] }],
  ...
  [{ coefficient := 1, powers := [(5, 1), (26, 1), (33, 1), (45, 1)] }, { coefficient := 1, powers := [(5, 1), (33, 1), (37, 1), (47, 1), (53, 1), (58, 1), (63, 1)] }, { coefficient := -1, powers := [(8, 1), (33, 1), (47, 1)] }],
  [{ coefficient := -1, powers := [(6, 1), (47, 1), (53, 1), (58, 1)] }, { coefficient := 1, powers := [(39, 1), (59, 1)] }, { coefficient := -1, powers := [(40, 1), (42, 1), (56, 1), (62, 1)] }, { coefficient := 1, powers := [(42, 1), (56, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (36, 1), (42, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (5, 1), (33, 1), (56, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (6, 1), (36, 1), (53, 1), (58, 1)] }, { coefficient := -1, powers := [(5, 1), (25, 1), (26, 1), (33, 1), (45, 1), (60, 1)] }, { coefficient := -1, powers := [(5, 1), (25, 1), (33, 1), (37, 1), (47, 1), (53, 1), (58, 1), (60, 1), (63, 1)] }, { coefficient := -1, powers := [(5, 1), (25, 1), (33, 1), (45, 1), (52, 1)] }, { coefficient := 1, powers := [(8, 1), (25, 1), (33, 1), (47, 1), (60, 1)] }]
]
...
#print axioms Krenn.Component50.SelectedLeafB6_5.selectedHasNoCommonZero

end Krenn.Component50.SelectedLeafB6_5
