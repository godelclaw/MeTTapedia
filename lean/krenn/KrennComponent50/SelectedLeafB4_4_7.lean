...
namespace Krenn.Component50.SelectedLeafB4_4_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "488cb3020e58b16daef7478e2b1db7a647139da6720763b86436abdf5642a1e4"
...
def multipliers : Fin 23 → SparsePoly (Fin 65) := ![
  [{ coefficient := -2, powers := [(24, 1), (56, 1), (62, 1)] }, { coefficient := -1, powers := [(30, 1), (47, 1), (62, 1)] }],
  ...
  [{ coefficient := -1, powers := [(47, 1), (52, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(47, 1), (51, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (26, 1)] }],
  [{ coefficient := 1, powers := [(47, 1), (55, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(30, 1), (47, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(19, 1)] }],
  [{ coefficient := 1, powers := [(14, 1)] }],
  [{ coefficient := 1, powers := [(14, 1), (47, 1), (63, 1)] }],
  ...
  [{ coefficient := 1, powers := [(39, 1), (59, 1)] }, { coefficient := -1, powers := [(47, 1), (53, 1), (55, 1), (63, 1)] }, { coefficient := 1, powers := [(47, 1), (53, 1)] }],
  [{ coefficient := -1, powers := [(14, 1), (30, 1), (47, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (54, 1), (56, 1), (62, 1)] }, { coefficient := 1, powers := [(2, 1), (56, 1)] }, { coefficient := 1, powers := [(8, 1), (36, 1)] }, { coefficient := -1, powers := [(19, 1), (30, 1)] }],
...
#print axioms Krenn.Component50.SelectedLeafB4_4_7.selectedHasNoCommonZero

end Krenn.Component50.SelectedLeafB4_4_7
