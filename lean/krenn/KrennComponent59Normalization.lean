...
/-!
Exact normalization of external minimal-prime component 59 into
zero-based Lean component row 58.  All exponent-map equalities are
rechecked by Lean below; this source is generated only for serialization.
-/

namespace Krenn.Component59Normalization
...
theorem selectedIndices_exact : componentGenerators 58 = selectedIndices := by decide
...
theorem rawPositiveMap09 :
    Finsupp.mapDomain rawToReduced (rawPositive 9) = generatorPositive 9 := by
  ext coordinate
  fin_cases coordinate <;>
    simp [rawPositive, rawToReduced, Finsupp.mapDomain_add, Finsupp.mapDomain_single, generatorPositive, generatorPositiveSupport, generatorNegative, generatorNegativeSupport, squarefreeExponent, Nat.testBit, Nat.shiftRight_eq_div_pow]
...
set_option maxRecDepth 100000 in
theorem rawComponent59_vanishes {R : Type*} [CommRing R]
...
end Krenn.Component59Normalization

#print axioms Krenn.Component59Normalization.rawComponent59_vanishes
