...
namespace Krenn.X5Case18Selected

open Krenn.SparseCertificate
open MvPolynomial

def sourceSystemFileSHA256 : String := "4a4ec10d33c6f5b57c6ca75433765766c08cc191b871927426db4b9e37639393"
def sourceSystemSemanticSHA256 : String := "e35c66e1e75072df7ef1c26c3c3d5a89e3fed3281f9ae23c52cd0a9bb7227daa"
def certificateSHA256 : String := "68cd1b468f3f246283b7f2675b521518a46032620a5a8a85b269f8e56597a2c6"
...
def selectedEquations : Fin 16 → SparsePoly (Fin 70) := ![
  ...
  [{ coefficient := 1, powers := [(13, 1), (45, 1), (61, 1)] }, { coefficient := 1, powers := [(21, 1), (45, 1), (55, 1)] }, { coefficient := 1, powers := [(29, 1), (45, 1), (52, 1)] }, { coefficient := 1, powers := [(34, 1), (35, 1), (61, 1)] }, { coefficient := 1, powers := [(34, 1), (38, 1), (55, 1)] }, { coefficient := 1, powers := [(34, 1), (41, 1), (52, 1)] }],
...
def multipliers : Fin 16 → SparsePoly (Fin 70) := ![
  [{ coefficient := -1, powers := [(29, 1), (32, 1), (37, 1), (45, 1), (63, 1)] }, { coefficient := -1, powers := [(29, 1), (32, 1), (40, 1), (45, 1), (57, 1)] }, { coefficient := -1, powers := [(29, 1), (32, 1), (43, 1), (45, 1), (54, 1)] }],
  ...
  [{ coefficient := -1, powers := [(0, 1), (34, 1), (37, 1), (46, 1), (63, 1)] }, { coefficient := -1, powers := [(0, 1), (34, 1), (40, 1), (46, 1), (57, 1)] }, { coefficient := -1, powers := [(0, 1), (34, 1), (43, 1), (46, 1), (54, 1)] }],
  [{ coefficient := 1, powers := [(4, 1), (31, 1), (48, 1)] }, { coefficient := -1, powers := [(7, 1), (48, 1)] }],
...
#print axioms Krenn.X5Case18Selected.selectedHasNoCommonZero

end Krenn.X5Case18Selected
