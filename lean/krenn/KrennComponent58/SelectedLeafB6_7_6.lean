...
namespace Krenn.Component58.SelectedLeafB6_7_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "d4bb9a87f4ff6b18ba81be77e044ee9283c329b70b4e9aeca0898837d3b51168"
def certificateSHA256 : String := "4c9c04deec37dbf46e9f6594aedbad002c2c186d4fc04c0760ea59d50512936a"
...
def multipliers : Fin 23 → SparsePoly (Fin 66) := ![
  [{ coefficient := -2, powers := [(28, 1), (46, 1), (64, 1)] }],
  [{ coefficient := 2, powers := [(19, 1), (22, 1), (24, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(25, 1), (28, 1), (46, 1), (51, 1), (64, 1)] }, { coefficient := -1, powers := [(28, 1), (40, 1), (44, 1), (62, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (48, 1)] }],
  [{ coefficient := -2, powers := [(19, 1), (40, 1), (61, 1), (62, 1)] }],
  [{ coefficient := -2, powers := [(19, 1), (24, 1), (60, 1)] }],
  [{ coefficient := 2, powers := [(19, 1), (40, 1), (43, 1), (61, 1), (62, 1)] }],
  [{ coefficient := -2, powers := [(19, 1), (40, 1), (62, 1)] }],
  ...
  [{ coefficient := -2, powers := [(19, 1), (28, 1), (40, 1), (43, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (34, 1), (40, 1)] }, { coefficient := 1, powers := [(19, 1), (28, 1), (40, 1)] }],
  [{ coefficient := 2, powers := [(14, 1), (28, 1), (46, 1)] }, { coefficient := -1, powers := [(18, 1), (25, 1), (28, 1), (46, 1), (51, 1)] }, { coefficient := 1, powers := [(18, 1), (28, 1), (40, 1), (44, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (39, 1), (40, 1), (62, 1)] }, { coefficient := 1, powers := [(2, 1), (40, 1)] }, { coefficient := 1, powers := [(5, 1), (31, 1)] }, { coefficient := -1, powers := [(14, 1), (24, 1)] }]
]
...
#print axioms Krenn.Component58.SelectedLeafB6_7_6.selectedHasNoCommonZero

end Krenn.Component58.SelectedLeafB6_7_6
