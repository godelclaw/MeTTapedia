...
namespace Krenn.Component58.SelectedLeafB4_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "7449f37efc99cd7bd4acc6bf1257a79ddf1002e7b8dd6de1f0949e42400435b6"
...
def multipliers : Fin 21 → SparsePoly (Fin 61) := ![
  ...
  [{ coefficient := -1, powers := [(21, 1), (50, 1), (60, 1)] }, { coefficient := 1, powers := [(21, 1), (59, 1), (60, 1)] }],
  [{ coefficient := -1, powers := [(48, 1), (50, 1), (60, 1)] }, { coefficient := -1, powers := [(51, 1), (60, 1)] }],
  ...
  [{ coefficient := -1, powers := [(21, 1), (25, 1), (59, 1), (60, 1)] }, { coefficient := -1, powers := [(21, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(50, 1), (60, 1)] }, { coefficient := -1, powers := [(59, 1), (60, 1)] }],
  ...
  [{ coefficient := 1, powers := [(21, 1), (48, 1), (50, 1), (60, 1)] }, { coefficient := 1, powers := [(21, 1), (51, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [] }],
  [{ coefficient := -1, powers := [(50, 1)] }, { coefficient := -1, powers := [(54, 1)] }],
  [{ coefficient := 1, powers := [(25, 1), (59, 1), (60, 1)] }, { coefficient := 1, powers := [(60, 1)] }],
  ...
  [{ coefficient := 1, powers := [(21, 1), (25, 1), (43, 1), (51, 1), (60, 1)] }, { coefficient := -1, powers := [(21, 1), (43, 1), (48, 1), (60, 1)] }, { coefficient := -1, powers := [(25, 1), (40, 1), (54, 1), (60, 1)] }, { coefficient := -1, powers := [(25, 1), (45, 1), (51, 1), (60, 1)] }, { coefficient := 1, powers := [(45, 1), (48, 1), (60, 1)] }],
...
#print axioms Krenn.Component58.SelectedLeafB4_1.selectedHasNoCommonZero

end Krenn.Component58.SelectedLeafB4_1
