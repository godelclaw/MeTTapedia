...
namespace Krenn.Component58.SelectedLeafB6_3_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "03a7f61875f0af0450c974c998f663435e28ce237679ad3f9b6b3048c7081cff"
def certificateSHA256 : String := "183d472a6b252fd522e57ba0f5eb28f2dcadc1ca0e664d3dd9e7c777223bd980"
...
def multipliers : Fin 28 → SparsePoly (Fin 64) := ![
  [{ coefficient := -2, powers := [(3, 1), (24, 1), (39, 1), (58, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(28, 1), (39, 1), (42, 1), (45, 1), (61, 1), (63, 1)] }, { coefficient := -1, powers := [(28, 1), (39, 1), (46, 1), (61, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(39, 1), (46, 1), (51, 1), (61, 2)] }],
  [{ coefficient := 1, powers := [(25, 1), (28, 1), (39, 1), (40, 1), (44, 1), (61, 1), (63, 1)] }, { coefficient := -1, powers := [(28, 1), (39, 1), (40, 1), (44, 1), (61, 2), (63, 1)] }],
  [{ coefficient := 1, powers := [(19, 1), (20, 1), (39, 1), (45, 1)] }, { coefficient := -1, powers := [(19, 1), (21, 1), (39, 1)] }, { coefficient := -1, powers := [(19, 1), (39, 1), (45, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(28, 1), (39, 1), (45, 1), (61, 1)] }],
  [{ coefficient := -2, powers := [(0, 1), (8, 1), (39, 1), (58, 1), (61, 1)] }, { coefficient := -2, powers := [(8, 1), (20, 1), (39, 1), (58, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(14, 1), (39, 1), (46, 1), (61, 2)] }],
  [{ coefficient := -1, powers := [(19, 1), (28, 1), (39, 1), (45, 1)] }],
  [{ coefficient := 1, powers := [(39, 1), (52, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(39, 2), (46, 1), (61, 2)] }],
  [{ coefficient := -1, powers := [(24, 1), (39, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(28, 1), (39, 1), (46, 1), (61, 2)] }],
  [{ coefficient := 1, powers := [(14, 1), (39, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(28, 1), (39, 1), (40, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(19, 1), (28, 1), (39, 1), (45, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(28, 1), (39, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(19, 1), (39, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(19, 1), (28, 1), (39, 1)] }],
  [{ coefficient := 1, powers := [(39, 1), (40, 1), (61, 2)] }],
  [{ coefficient := 2, powers := [(8, 1), (24, 1), (39, 1), (58, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (28, 1), (39, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(39, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(37, 1), (39, 1), (58, 1), (61, 1)] }, { coefficient := -1, powers := [(39, 2), (46, 1), (52, 1), (61, 2)] }],
  [{ coefficient := -1, powers := [(8, 1), (31, 1), (39, 1), (46, 1), (61, 1)] }, { coefficient := -1, powers := [(8, 1), (34, 1), (39, 1), (40, 1), (61, 1)] }, { coefficient := 1, powers := [(19, 1), (25, 1), (28, 1), (39, 1), (40, 1)] }, { coefficient := -1, powers := [(19, 1), (28, 1), (39, 1), (40, 1), (61, 1)] }, { coefficient := -1, powers := [] }],
  [{ coefficient := -1, powers := [(14, 1), (28, 1), (39, 1), (42, 1), (45, 1), (61, 1)] }, { coefficient := 1, powers := [(14, 1), (28, 1), (39, 1), (46, 1), (61, 1)] }, { coefficient := -1, powers := [(18, 1), (25, 1), (28, 1), (39, 1), (40, 1), (44, 1), (61, 1)] }, { coefficient := 1, powers := [(18, 1), (28, 1), (39, 1), (40, 1), (44, 1), (61, 2)] }],
  [{ coefficient := 2, powers := [(0, 1), (8, 1), (24, 1), (39, 1), (58, 1), (61, 1)] }, { coefficient := 1, powers := [(0, 1), (19, 1), (28, 1), (39, 1), (40, 1), (61, 1)] }, { coefficient := -1, powers := [(14, 1), (28, 1), (39, 1), (46, 1), (61, 2)] }, { coefficient := -1, powers := [(19, 1), (20, 1), (28, 1), (39, 1), (45, 1), (48, 1), (61, 1)] }, { coefficient := 1, powers := [(19, 1), (21, 1), (28, 1), (39, 1), (48, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (39, 2), (40, 1), (61, 2)] }, { coefficient := 1, powers := [(2, 1), (39, 1), (40, 1), (61, 1)] }, { coefficient := 1, powers := [(5, 1), (31, 1), (39, 1), (61, 1)] }, { coefficient := 1, powers := [(14, 1), (24, 1), (39, 1), (61, 1)] }]
]
...
#print axioms Krenn.Component58.SelectedLeafB6_3_4.selectedHasNoCommonZero

end Krenn.Component58.SelectedLeafB6_3_4
