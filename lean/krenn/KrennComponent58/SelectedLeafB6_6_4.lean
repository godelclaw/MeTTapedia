...
namespace Krenn.Component58.SelectedLeafB6_6_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "fc8dab27385cb772f380007d5f7c7169ddda3534181294a4f4b675211633f3b8"
def certificateSHA256 : String := "1ba98608de9e5e4eb1e8c759375f3f3dcc5e4eb55a77a48bd44268c1e5e96966"
...
def multipliers : Fin 21 → SparsePoly (Fin 64) := ![
  ...
  [{ coefficient := 1, powers := [(5, 1), (58, 1), (62, 1)] }, { coefficient := -1, powers := [(14, 1), (46, 1), (62, 1)] }],
  ...
  [{ coefficient := 1, powers := [(37, 1), (58, 1)] }, { coefficient := -1, powers := [(39, 1), (46, 1), (52, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (28, 1), (43, 1), (58, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (28, 1), (58, 1)] }, { coefficient := -1, powers := [(8, 1), (31, 1), (46, 1)] }],
...
#print axioms Krenn.Component58.SelectedLeafB6_6_4.selectedHasNoCommonZero

end Krenn.Component58.SelectedLeafB6_6_4
