...
namespace Krenn.Component58.SelectedLeafB6_7_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "48abea75228cec404326eca48d6b687b3462d7643ae8876e90eb227ab377abb7"
...
def multipliers : Fin 23 → SparsePoly (Fin 64) := ![
  [{ coefficient := 2, powers := [(3, 1), (45, 1), (58, 1)] }, { coefficient := -1, powers := [(40, 1), (44, 1), (62, 1)] }, { coefficient := -1, powers := [(46, 1), (51, 1), (62, 1)] }],
  ...
  [{ coefficient := 2, powers := [(3, 1), (37, 1), (57, 1), (58, 1)] }, { coefficient := 1, powers := [(37, 1), (58, 1)] }, { coefficient := -1, powers := [(39, 1), (46, 1), (52, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (31, 1), (46, 1)] }, { coefficient := -1, powers := [(8, 1), (34, 1), (40, 1)] }, { coefficient := -1, powers := [(19, 1), (28, 1), (40, 1)] }],
  [{ coefficient := 2, powers := [(0, 1), (8, 1), (24, 1), (58, 1)] }, { coefficient := -1, powers := [(14, 1), (20, 1), (28, 1), (46, 1)] }, { coefficient := -1, powers := [(14, 1), (28, 1), (46, 1), (62, 1)] }],
...
#print axioms Krenn.Component58.SelectedLeafB6_7_0.selectedHasNoCommonZero

end Krenn.Component58.SelectedLeafB6_7_0
