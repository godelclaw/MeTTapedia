...
namespace Krenn.Component58.SelectedLeafB4_7_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "b93ec40cfbd174c65c3c2b56bb7953ffa490e3d393731a7eab4be8d09fec0bf4"
...
def multipliers : Fin 7 → SparsePoly (Fin 65) := ![
  [{ coefficient := 1, powers := [(45, 1), (51, 1), (62, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(51, 1), (62, 1), (64, 1)] }],
...
#print axioms Krenn.Component58.SelectedLeafB4_7_5.selectedHasNoCommonZero

end Krenn.Component58.SelectedLeafB4_7_5
