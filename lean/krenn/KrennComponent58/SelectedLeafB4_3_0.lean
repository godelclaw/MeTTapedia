...
namespace Krenn.Component58.SelectedLeafB4_3_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "596e3e322c413fc6b75bc2418e2250d9d147585c40f0b437ba9c02e023c85a35"
...
def multipliers : Fin 23 → SparsePoly (Fin 62) := ![
  [{ coefficient := 2, powers := [(3, 1), (45, 1), (58, 1)] }, { coefficient := -1, powers := [(40, 1), (44, 1), (60, 1)] }, { coefficient := -1, powers := [(46, 1), (51, 1), (60, 1)] }],
  ...
  [{ coefficient := 2, powers := [(3, 1), (37, 1), (57, 1), (58, 1)] }, { coefficient := 1, powers := [(37, 1), (58, 1)] }, { coefficient := -1, powers := [(39, 1), (46, 1), (52, 1), (60, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (31, 1), (46, 1)] }, { coefficient := -1, powers := [(8, 1), (34, 1), (40, 1)] }, { coefficient := -1, powers := [(19, 1), (28, 1), (40, 1)] }],
  [{ coefficient := 2, powers := [(0, 1), (8, 1), (24, 1), (58, 1)] }, { coefficient := -1, powers := [(14, 1), (20, 1), (28, 1), (46, 1)] }, { coefficient := -1, powers := [(14, 1), (28, 1), (46, 1), (60, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (39, 1), (40, 1), (60, 1)] }, { coefficient := 1, powers := [(2, 1), (40, 1)] }, { coefficient := 1, powers := [(5, 1), (31, 1)] }, { coefficient := 1, powers := [(14, 1), (24, 1)] }]
]
...
#print axioms Krenn.Component58.SelectedLeafB4_3_0.selectedHasNoCommonZero

end Krenn.Component58.SelectedLeafB4_3_0
