...
namespace Krenn.X5Case8Tree.LeafB6_7

open Krenn.SparseCertificate
open MvPolynomial

def sourceSystemFileSHA256 : String := "f3bf5e2bea90d9d17d3cb3397f7c823b436b4e06c40c03c227ed18f3195b5351"
def sourceSystemSemanticSHA256 : String := "08e6825713152de969f29a4908ff0c774f114335ee0738822e1eb7d028e5c3cb"
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedEquations : Fin 24 → SparsePoly (Fin 75) := ![
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def multipliers : Fin 24 → SparsePoly (Fin 75) := ![
  [{ coefficient := 1, powers := [(0, 1), (67, 1)] }, { coefficient := 1, powers := [(32, 1), (41, 1)] }],
  [{ coefficient := -1, powers := [(15, 1), (35, 1), (49, 1), (61, 1), (69, 1), (73, 1)] }, { coefficient := -1, powers := [(31, 1), (35, 1), (49, 1), (60, 1), (61, 1), (73, 1)] }],
  [{ coefficient := 1, powers := [(32, 1), (35, 1), (37, 1), (61, 1), (69, 1), (72, 1)] }, { coefficient := 1, powers := [(32, 1), (35, 1), (43, 1), (60, 1), (61, 1), (72, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (32, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(16, 1), (55, 1), (74, 1)] }],
  [{ coefficient := -1, powers := [(15, 1), (17, 1), (32, 1), (35, 1), (43, 1), (61, 1), (72, 1)] }, { coefficient := -1, powers := [(17, 1), (31, 1), (32, 1), (35, 1), (37, 1), (61, 1), (72, 1)] }],
  [{ coefficient := -1, powers := [(34, 1), (35, 1), (54, 1), (61, 1), (72, 1)] }],
  [{ coefficient := -1, powers := [(17, 1), (34, 1), (35, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(9, 1), (34, 1), (35, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(15, 1), (32, 1), (35, 1), (43, 1), (61, 1), (72, 1)] }, { coefficient := 1, powers := [(31, 1), (32, 1), (35, 1), (37, 1), (61, 1), (72, 1)] }],
  [{ coefficient := 1, powers := [(15, 1), (35, 1), (61, 1), (69, 1), (73, 1)] }, { coefficient := 1, powers := [(31, 1), (35, 1), (60, 1), (61, 1), (73, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (58, 1), (61, 1), (74, 1)] }],
...
#print axioms Krenn.X5Case8Tree.LeafB6_7.selectedHasNoCommonZero

end Krenn.X5Case8Tree.LeafB6_7
