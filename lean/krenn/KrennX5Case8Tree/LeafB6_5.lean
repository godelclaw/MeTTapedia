...
namespace Krenn.X5Case8Tree.LeafB6_5

open Krenn.SparseCertificate
open MvPolynomial

def sourceSystemFileSHA256 : String := "5f248ec86094b90d7d735219d1776f21b6b9665babd0a9772d2986635a62a2f4"
def sourceSystemSemanticSHA256 : String := "ef127413db2402e3f2e64169f14fdb26e04f6616fc6c5680a060fa9afd826f73"
...
def multipliers : Fin 25 → SparsePoly (Fin 74) := ![
  ...
  [{ coefficient := -1, powers := [(15, 1), (32, 1), (35, 1), (61, 1), (63, 1), (72, 1)] }, { coefficient := -1, powers := [(31, 1), (32, 1), (35, 1), (54, 1), (61, 1), (72, 1)] }],
...
#print axioms Krenn.X5Case8Tree.LeafB6_5.selectedHasNoCommonZero

end Krenn.X5Case8Tree.LeafB6_5
