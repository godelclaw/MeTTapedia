...
/-!
Exact normalization of external minimal-prime component 16 into
zero-based Lean component row 15.  All exponent-map equalities are
rechecked by Lean below; this source is generated only for serialization.
-/

namespace Krenn.Component16Normalization
...
noncomputable def rawPositive : Fin 25 → Fin 30 →₀ Nat := ![
  Finsupp.single 13 1 + Finsupp.single 22 1,
  Finsupp.single 8 1 + Finsupp.single 24 1,
  Finsupp.single 6 1 + Finsupp.single 22 1,
  Finsupp.single 6 1 + Finsupp.single 19 1 + Finsupp.single 20 1,
  Finsupp.single 3 1 + Finsupp.single 29 1,
  Finsupp.single 1 1 + Finsupp.single 10 1 + Finsupp.single 22 1 + Finsupp.single 29 1,
  Finsupp.single 1 1 + Finsupp.single 10 1 + Finsupp.single 21 1 + Finsupp.single 29 1,
  Finsupp.single 1 1 + Finsupp.single 10 1 + Finsupp.single 19 1 + Finsupp.single 20 1 + Finsupp.single 29 1,
  ...
  Finsupp.single 1 1 + Finsupp.single 9 1 + Finsupp.single 10 1 + Finsupp.single 19 1 + Finsupp.single 20 1,
...
noncomputable def rawNegative : Fin 25 → Option (Fin 30 →₀ Nat) := ![
  ...
  some (Finsupp.single 7 1 + Finsupp.single 13 1 + Finsupp.single 21 1),
  some (Finsupp.single 9 1 + Finsupp.single 15 1 + Finsupp.single 26 1),
  some (Finsupp.single 7 1 + Finsupp.single 15 1 + Finsupp.single 24 1 + Finsupp.single 26 1),
  some (Finsupp.single 6 1 + Finsupp.single 15 1 + Finsupp.single 24 1 + Finsupp.single 26 1),
  some (Finsupp.single 7 1 + Finsupp.single 13 1 + Finsupp.single 15 1 + Finsupp.single 24 1 + Finsupp.single 26 1),
  ...
  some (Finsupp.single 3 1 + Finsupp.single 7 1 + Finsupp.single 13 1 + Finsupp.single 24 1),
...
def normalizedIndex : Fin 25 → Option (Fin 78) := ![
  some 16,
  some 24,
  some 18,
  some 19,
...
theorem selectedIndices_exact : componentGenerators 15 = selectedIndices := by decide

noncomputable def rawGeneratorEval {R : Type*} [CommRing R]
    (values : Fin 30 → R) (index : Fin 25) : R :=
...
theorem rawPositiveMap00 :
    Finsupp.mapDomain rawToReduced (rawPositive 0) = generatorPositive 16 := by
  ext coordinate
...
theorem rawPositiveMap01 :
    Finsupp.mapDomain rawToReduced (rawPositive 1) = generatorPositive 24 := by
  ext coordinate
  fin_cases coordinate <;>
    simp [rawPositive, rawToReduced, Finsupp.mapDomain_add, Finsupp.mapDomain_single, generatorPositive, generatorPositiveSupport, generatorNegative, generatorNegativeSupport, squarefreeExponent, Nat.testBit, Nat.shiftRight_eq_div_pow]
...
theorem rawPositiveMap02 :
    Finsupp.mapDomain rawToReduced (rawPositive 2) = generatorPositive 18 := by
  ext coordinate
  fin_cases coordinate <;>
    simp [rawPositive, rawToReduced, Finsupp.mapDomain_add, Finsupp.mapDomain_single, generatorPositive, generatorPositiveSupport, generatorNegative, generatorNegativeSupport, squarefreeExponent, Nat.testBit, Nat.shiftRight_eq_div_pow]
...
theorem rawPositiveMap03 :
    Finsupp.mapDomain rawToReduced (rawPositive 3) = generatorPositive 19 := by
  ext coordinate
  fin_cases coordinate <;>
    simp [rawPositive, rawToReduced, Finsupp.mapDomain_add, Finsupp.mapDomain_single, generatorPositive, generatorPositiveSupport, generatorNegative, generatorNegativeSupport, squarefreeExponent, Nat.testBit, Nat.shiftRight_eq_div_pow]
...
theorem rawNegativeMap03 :
    Finsupp.mapDomain rawToReduced ((rawNegative 3).getD 0) =
      (generatorNegative 19).getD 0 := by
  ext coordinate
  fin_cases coordinate <;>
    simp [rawNegative, rawToReduced, Finsupp.mapDomain_add, Finsupp.mapDomain_single, generatorPositive, generatorPositiveSupport, generatorNegative, generatorNegativeSupport, squarefreeExponent, Nat.testBit, Nat.shiftRight_eq_div_pow]
...
theorem rawPositiveMap04 :
    Finsupp.mapDomain rawToReduced (rawPositive 4) = generatorPositive 36 := by
  ext coordinate
  fin_cases coordinate <;>
    simp [rawPositive, rawToReduced, Finsupp.mapDomain_add, Finsupp.mapDomain_single, generatorPositive, generatorPositiveSupport, generatorNegative, generatorNegativeSupport, squarefreeExponent, Nat.testBit, Nat.shiftRight_eq_div_pow]
...
theorem rawPositiveMap05 :
    Finsupp.mapDomain rawToReduced (rawPositive 5) = generatorPositive 37 := by
  ext coordinate
  fin_cases coordinate <;>
    simp [rawPositive, rawToReduced, Finsupp.mapDomain_add, Finsupp.mapDomain_single, generatorPositive, generatorPositiveSupport, generatorNegative, generatorNegativeSupport, squarefreeExponent, Nat.testBit, Nat.shiftRight_eq_div_pow]
...
theorem rawNegativeMap05 :
    Finsupp.mapDomain rawToReduced ((rawNegative 5).getD 0) =
      (generatorNegative 37).getD 0 := by
  ext coordinate
  fin_cases coordinate <;>
    simp [rawNegative, rawToReduced, Finsupp.mapDomain_add, Finsupp.mapDomain_single, generatorPositive, generatorPositiveSupport, generatorNegative, generatorNegativeSupport, squarefreeExponent, Nat.testBit, Nat.shiftRight_eq_div_pow]
...
theorem rawPositiveMap06 :
    Finsupp.mapDomain rawToReduced (rawPositive 6) = generatorPositive 38 := by
  ext coordinate
  fin_cases coordinate <;>
    simp [rawPositive, rawToReduced, Finsupp.mapDomain_add, Finsupp.mapDomain_single, generatorPositive, generatorPositiveSupport, generatorNegative, generatorNegativeSupport, squarefreeExponent, Nat.testBit, Nat.shiftRight_eq_div_pow]
...
theorem rawNegativeMap06 :
    Finsupp.mapDomain rawToReduced ((rawNegative 6).getD 0) =
      (generatorNegative 38).getD 0 := by
  ext coordinate
  fin_cases coordinate <;>
    simp [rawNegative, rawToReduced, Finsupp.mapDomain_add, Finsupp.mapDomain_single, generatorPositive, generatorPositiveSupport, generatorNegative, generatorNegativeSupport, squarefreeExponent, Nat.testBit, Nat.shiftRight_eq_div_pow]
...
theorem rawPositiveMap07 :
    Finsupp.mapDomain rawToReduced (rawPositive 7) = generatorPositive 39 := by
  ext coordinate
  fin_cases coordinate <;>
    simp [rawPositive, rawToReduced, Finsupp.mapDomain_add, Finsupp.mapDomain_single, generatorPositive, generatorPositiveSupport, generatorNegative, generatorNegativeSupport, squarefreeExponent, Nat.testBit, Nat.shiftRight_eq_div_pow]
...
theorem rawNegativeMap07 :
    Finsupp.mapDomain rawToReduced ((rawNegative 7).getD 0) =
      (generatorNegative 39).getD 0 := by
  ext coordinate
  fin_cases coordinate <;>
    simp [rawNegative, rawToReduced, Finsupp.mapDomain_add, Finsupp.mapDomain_single, generatorPositive, generatorPositiveSupport, generatorNegative, generatorNegativeSupport, squarefreeExponent, Nat.testBit, Nat.shiftRight_eq_div_pow]
...
theorem rawPositiveMap08 :
    Finsupp.mapDomain rawToReduced (rawPositive 8) = generatorPositive 25 := by
  ext coordinate
  fin_cases coordinate <;>
    simp [rawPositive, rawToReduced, Finsupp.mapDomain_add, Finsupp.mapDomain_single, generatorPositive, generatorPositiveSupport, generatorNegative, generatorNegativeSupport, squarefreeExponent, Nat.testBit, Nat.shiftRight_eq_div_pow]
...
theorem rawPositiveMap09 :
    Finsupp.mapDomain rawToReduced (rawPositive 9) = generatorPositive 26 := by
  ext coordinate
  fin_cases coordinate <;>
    simp [rawPositive, rawToReduced, Finsupp.mapDomain_add, Finsupp.mapDomain_single, generatorPositive, generatorPositiveSupport, generatorNegative, generatorNegativeSupport, squarefreeExponent, Nat.testBit, Nat.shiftRight_eq_div_pow]
...
theorem rawPositiveMap10 :
    Finsupp.mapDomain rawToReduced (rawPositive 10) = generatorPositive 27 := by
  ext coordinate
  fin_cases coordinate <;>
    simp [rawPositive, rawToReduced, Finsupp.mapDomain_add, Finsupp.mapDomain_single, generatorPositive, generatorPositiveSupport, generatorNegative, generatorNegativeSupport, squarefreeExponent, Nat.testBit, Nat.shiftRight_eq_div_pow]
...
theorem rawNegativeMap10 :
    Finsupp.mapDomain rawToReduced ((rawNegative 10).getD 0) =
      (generatorNegative 27).getD 0 := by
  ext coordinate
  fin_cases coordinate <;>
    simp [rawNegative, rawToReduced, Finsupp.mapDomain_add, Finsupp.mapDomain_single, generatorPositive, generatorPositiveSupport, generatorNegative, generatorNegativeSupport, squarefreeExponent, Nat.testBit, Nat.shiftRight_eq_div_pow]
...
theorem rawPositiveMap11 :
    Finsupp.mapDomain rawToReduced (rawPositive 11) = generatorPositive 20 := by
  ext coordinate
  fin_cases coordinate <;>
    simp [rawPositive, rawToReduced, Finsupp.mapDomain_add, Finsupp.mapDomain_single, generatorPositive, generatorPositiveSupport, generatorNegative, generatorNegativeSupport, squarefreeExponent, Nat.testBit, Nat.shiftRight_eq_div_pow]
...
theorem rawPositiveMap12 :
    Finsupp.mapDomain rawToReduced (rawPositive 12) = generatorPositive 1 := by
  ext coordinate
  fin_cases coordinate <;>
    simp [rawPositive, rawToReduced, Finsupp.mapDomain_add, Finsupp.mapDomain_single, generatorPositive, generatorPositiveSupport, generatorNegative, generatorNegativeSupport, squarefreeExponent, Nat.testBit, Nat.shiftRight_eq_div_pow]
...
theorem rawPositiveMap13 :
    Finsupp.mapDomain rawToReduced (rawPositive 13) = generatorPositive 2 := by
  ext coordinate
  fin_cases coordinate <;>
    simp [rawPositive, rawToReduced, Finsupp.mapDomain_add, Finsupp.mapDomain_single, generatorPositive, generatorPositiveSupport, generatorNegative, generatorNegativeSupport, squarefreeExponent, Nat.testBit, Nat.shiftRight_eq_div_pow]
...
theorem rawPositiveMap14 :
    Finsupp.mapDomain rawToReduced (rawPositive 14) = generatorPositive 4 := by
  ext coordinate
  fin_cases coordinate <;>
    simp [rawPositive, rawToReduced, Finsupp.mapDomain_add, Finsupp.mapDomain_single, generatorPositive, generatorPositiveSupport, generatorNegative, generatorNegativeSupport, squarefreeExponent, Nat.testBit, Nat.shiftRight_eq_div_pow]
...
theorem rawPositiveMap16 :
    Finsupp.mapDomain rawToReduced (rawPositive 16) = generatorPositive 8 := by
  ext coordinate
  fin_cases coordinate <;>
    simp [rawPositive, rawToReduced, Finsupp.mapDomain_add, Finsupp.mapDomain_single, generatorPositive, generatorPositiveSupport, generatorNegative, generatorNegativeSupport, squarefreeExponent, Nat.testBit, Nat.shiftRight_eq_div_pow]

set_option maxRecDepth 100000 in
theorem rawNegativeMap16 :
    Finsupp.mapDomain rawToReduced ((rawNegative 16).getD 0) =
...
theorem rawPositiveMap17 :
    Finsupp.mapDomain rawToReduced (rawPositive 17) = generatorPositive 31 := by
  ext coordinate
  fin_cases coordinate <;>
    simp [rawPositive, rawToReduced, Finsupp.mapDomain_add, Finsupp.mapDomain_single, generatorPositive, generatorPositiveSupport, generatorNegative, generatorNegativeSupport, squarefreeExponent, Nat.testBit, Nat.shiftRight_eq_div_pow]
...
theorem rawPositiveMap19 :
    Finsupp.mapDomain rawToReduced (rawPositive 19) = generatorPositive 10 := by
  ext coordinate
  fin_cases coordinate <;>
    simp [rawPositive, rawToReduced, Finsupp.mapDomain_add, Finsupp.mapDomain_single, generatorPositive, generatorPositiveSupport, generatorNegative, generatorNegativeSupport, squarefreeExponent, Nat.testBit, Nat.shiftRight_eq_div_pow]

set_option maxRecDepth 100000 in
theorem rawNegativeMap19 :
    Finsupp.mapDomain rawToReduced ((rawNegative 19).getD 0) =
...
set_option maxRecDepth 100000 in
theorem rawPositiveMap20 :
    Finsupp.mapDomain rawToReduced (rawPositive 20) = generatorPositive 11 := by
  ext coordinate
  fin_cases coordinate <;>
    simp [rawPositive, rawToReduced, Finsupp.mapDomain_add, Finsupp.mapDomain_single, generatorPositive, generatorPositiveSupport, generatorNegative, generatorNegativeSupport, squarefreeExponent, Nat.testBit, Nat.shiftRight_eq_div_pow]

set_option maxRecDepth 100000 in
theorem rawZeroMap21 :
    Finsupp.mapDomain rawToReduced (rawPositive 21) =
      Finsupp.mapDomain rawToReduced ((rawNegative 21).getD 0) := by
  ext coordinate
  fin_cases coordinate <;>
    simp [rawPositive, rawNegative, rawToReduced, Finsupp.mapDomain_add, Finsupp.mapDomain_single, generatorPositive, generatorPositiveSupport, generatorNegative, generatorNegativeSupport, squarefreeExponent, Nat.testBit, Nat.shiftRight_eq_div_pow]

set_option maxRecDepth 100000 in
theorem rawZeroMap22 :
    Finsupp.mapDomain rawToReduced (rawPositive 22) =
      Finsupp.mapDomain rawToReduced ((rawNegative 22).getD 0) := by
  ext coordinate
  fin_cases coordinate <;>
    simp [rawPositive, rawNegative, rawToReduced, Finsupp.mapDomain_add, Finsupp.mapDomain_single, generatorPositive, generatorPositiveSupport, generatorNegative, generatorNegativeSupport, squarefreeExponent, Nat.testBit, Nat.shiftRight_eq_div_pow]

set_option maxRecDepth 100000 in
theorem rawPositiveMap23 :
    Finsupp.mapDomain rawToReduced (rawPositive 23) = generatorPositive 23 := by
  ext coordinate
  fin_cases coordinate <;>
    simp [rawPositive, rawToReduced, Finsupp.mapDomain_add, Finsupp.mapDomain_single, generatorPositive, generatorPositiveSupport, generatorNegative, generatorNegativeSupport, squarefreeExponent, Nat.testBit, Nat.shiftRight_eq_div_pow]
...
theorem rawGeneratorNormalizes {R : Type*} [CommRing R]
  ...
  · change monomial (fun coordinate => values (rawToReduced coordinate)) (rawPositive 16) -
      monomial (fun coordinate => values (rawToReduced coordinate)) ((rawNegative 16).getD 0) =
        generatorEval values 8
    rw [monomial_mapDomain rawToReduced values (rawPositive 16),
      monomial_mapDomain rawToReduced values ((rawNegative 16).getD 0), rawPositiveMap16,
      rawNegativeMap16]
    simp [generatorEval, generatorNegative, generatorNegativeSupport]
  ...
  · change monomial (fun coordinate => values (rawToReduced coordinate)) (rawPositive 19) -
      monomial (fun coordinate => values (rawToReduced coordinate)) ((rawNegative 19).getD 0) =
        generatorEval values 10
    rw [monomial_mapDomain rawToReduced values (rawPositive 19),
      monomial_mapDomain rawToReduced values ((rawNegative 19).getD 0), rawPositiveMap19,
      rawNegativeMap19]
    simp [generatorEval, generatorNegative, generatorNegativeSupport]
  · change monomial (fun coordinate => values (rawToReduced coordinate)) (rawPositive 20) - 0 =
        generatorEval values 11
    rw [monomial_mapDomain rawToReduced values (rawPositive 20), rawPositiveMap20]
    simp [generatorEval, generatorNegative, generatorNegativeSupport]
  · change monomial (fun coordinate => values (rawToReduced coordinate)) (rawPositive 21) -
      monomial (fun coordinate => values (rawToReduced coordinate)) ((rawNegative 21).getD 0) = 0
    rw [monomial_mapDomain rawToReduced values (rawPositive 21),
      monomial_mapDomain rawToReduced values ((rawNegative 21).getD 0), rawZeroMap21]
    ring
  · change monomial (fun coordinate => values (rawToReduced coordinate)) (rawPositive 22) -
      monomial (fun coordinate => values (rawToReduced coordinate)) ((rawNegative 22).getD 0) = 0
    rw [monomial_mapDomain rawToReduced values (rawPositive 22),
      monomial_mapDomain rawToReduced values ((rawNegative 22).getD 0), rawZeroMap22]
    ring
  · change monomial (fun coordinate => values (rawToReduced coordinate)) (rawPositive 23) - 0 =
        generatorEval values 23
    rw [monomial_mapDomain rawToReduced values (rawPositive 23), rawPositiveMap23]
    simp [generatorEval, generatorNegative, generatorNegativeSupport]
...
set_option maxRecDepth 100000 in
theorem rawComponent16_vanishes {R : Type*} [CommRing R]
  ...
  · exact selectedVanish 19 (by decide)
  · exact selectedVanish 36 (by decide)
  · exact selectedVanish 37 (by decide)
  · exact selectedVanish 38 (by decide)
  · exact selectedVanish 39 (by decide)
  · exact selectedVanish 25 (by decide)
  · exact selectedVanish 26 (by decide)
  · exact selectedVanish 27 (by decide)
...
end Krenn.Component16Normalization

#print axioms Krenn.Component16Normalization.rawComponent16_vanishes
