...
namespace Krenn.X5Case558Selected

open Krenn.SparseCertificate
open MvPolynomial

def sourceSystemFileSHA256 : String := "4f2cdf6cb6c21c5e09d67c198d8fa5d11fd339469500e8091aa11f808da6d0f1"
def sourceSystemSemanticSHA256 : String := "d8d8d6971dad82f52c975cdcd2c4424176a0f54bd2fd681dfa80ccf2077d39cb"
def certificateSHA256 : String := "a1ed56d3a5ac473ed24542c57e51b3c6861c361928760b59896d3ae983c41f70"
...
def selectedEquations : Fin 17 → SparsePoly (Fin 70) := ![
  ...
  [{ coefficient := 1, powers := [(8, 1), (62, 1)] }, { coefficient := 1, powers := [(17, 1), (35, 1), (68, 1)] }, { coefficient := 1, powers := [(25, 1), (35, 1), (65, 1)] }],
...
def multipliers : Fin 17 → SparsePoly (Fin 70) := ![
  [{ coefficient := 1, powers := [(0, 1), (33, 1), (36, 1), (62, 1), (67, 1)] }, { coefficient := -1, powers := [(24, 1), (33, 1), (36, 1), (44, 1), (62, 1)] }, { coefficient := 1, powers := [(32, 1), (33, 1), (36, 1), (41, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(33, 1), (42, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (33, 1), (36, 1), (62, 1), (64, 1)] }, { coefficient := -1, powers := [(16, 1), (33, 1), (36, 1), (44, 1), (62, 1)] }, { coefficient := 1, powers := [(32, 1), (33, 1), (36, 1), (38, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(33, 1), (39, 1)] }],
  [{ coefficient := -1, powers := [(25, 1), (33, 1), (36, 1), (38, 1), (67, 1)] }, { coefficient := -1, powers := [(25, 1), (33, 1), (36, 1), (41, 1), (64, 1)] }, { coefficient := 1, powers := [(25, 1), (33, 1), (36, 1), (44, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(17, 1), (33, 1), (36, 1), (38, 1), (67, 1)] }, { coefficient := -1, powers := [(17, 1), (33, 1), (36, 1), (41, 1), (64, 1)] }, { coefficient := 1, powers := [(17, 1), (33, 1), (36, 1), (44, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(33, 1), (36, 1), (44, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(33, 1), (36, 1), (38, 1), (67, 1)] }, { coefficient := 1, powers := [(33, 1), (36, 1), (41, 1), (64, 1)] }, { coefficient := -1, powers := [(33, 1), (36, 1), (44, 1), (61, 1)] }],
...
#print axioms Krenn.X5Case558Selected.selectedHasNoCommonZero

end Krenn.X5Case558Selected
