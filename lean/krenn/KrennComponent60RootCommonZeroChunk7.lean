...
namespace Krenn.Component60RootCommonZero.Chunk7
...
theorem rootBlock_of_base_and_component {R : Type*} [CommRing R]
    ...
    ∀ offset : Fin 40, eval₂Hom (Int.castRingHom R) (rootValues full)
      (Krenn.Component60.Tree.rootEquations ⟨280 + offset.val, by omega⟩).toPoly = 0 := by
...
end Krenn.Component60RootCommonZero.Chunk7
