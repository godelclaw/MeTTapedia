...
/-!
Exact normalization of external minimal-prime component 48 into
zero-based Lean component row 47.  All exponent-map equalities are
rechecked by Lean below; this source is generated only for serialization.
-/

namespace Krenn.Component48Normalization
...
theorem selectedIndices_exact : componentGenerators 47 = selectedIndices := by decide
...
theorem rawPositiveMap05 :
    Finsupp.mapDomain rawToReduced (rawPositive 5) = generatorPositive 3 := by
  ext coordinate
  fin_cases coordinate <;>
    simp [rawPositive, rawToReduced, Finsupp.mapDomain_add, Finsupp.mapDomain_single, generatorPositive, generatorPositiveSupport, generatorNegative, generatorNegativeSupport, squarefreeExponent, Nat.testBit, Nat.shiftRight_eq_div_pow]
...
set_option maxRecDepth 100000 in
theorem rawComponent48_vanishes {R : Type*} [CommRing R]
...
end Krenn.Component48Normalization

#print axioms Krenn.Component48Normalization.rawComponent48_vanishes
