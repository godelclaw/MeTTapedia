...
namespace Krenn.X5Case267Selected

open Krenn.SparseCertificate
open MvPolynomial

def sourceSystemFileSHA256 : String := "6377ab3c48ba9736e9580b70e62f3f3552cc88fd32bc43de5bb20b2dcc052d3d"
def sourceSystemSemanticSHA256 : String := "c642d8c8cdfd69778246f9109ad833305917a11726194c31b01559ed64fd99fc"
def certificateSHA256 : String := "99ba41b1cc778f22bdbd03bbca5abe6326116a9dc8911b7f5a1ebb40273abd1f"
...
def multipliers : Fin 15 → SparsePoly (Fin 70) := ![
  ...
  [{ coefficient := -1, powers := [(3, 1), (25, 1), (32, 1), (35, 1), (61, 1)] }, { coefficient := -1, powers := [(3, 1), (25, 1), (32, 1), (38, 1), (55, 1)] }, { coefficient := -1, powers := [(3, 1), (25, 1), (32, 1), (41, 1), (52, 1)] }, { coefficient := 1, powers := [(27, 1), (32, 1), (35, 1), (61, 1)] }, { coefficient := 1, powers := [(27, 1), (32, 1), (38, 1), (55, 1)] }, { coefficient := 1, powers := [(27, 1), (32, 1), (41, 1), (52, 1)] }],
...
#print axioms Krenn.X5Case267Selected.selectedHasNoCommonZero

end Krenn.X5Case267Selected
