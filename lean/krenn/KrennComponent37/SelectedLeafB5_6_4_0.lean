...
namespace Krenn.Component37.SelectedLeafB5_6_4_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "77f11d3bb4a42569e47496a0572c3ee0edda0b453379a901558cc99bee028988"
def certificateSHA256 : String := "e24c7c1801e951c21c826fc98b198355c74ae3b8fa021bf43766d3fb9fdf736a"
...
def multipliers : Fin 26 → SparsePoly (Fin 67) := ![
  ...
  [{ coefficient := -1, powers := [(18, 1), (21, 1), (28, 1), (37, 1), (52, 1), (54, 1), (61, 1)] }, { coefficient := 1, powers := [(18, 1), (23, 1), (39, 1), (61, 1)] }, { coefficient := -1, powers := [(18, 1), (24, 1), (26, 1), (37, 1), (52, 1), (61, 1)] }, { coefficient := 2, powers := [(18, 1), (24, 1), (37, 1), (54, 1), (61, 1)] }, { coefficient := -1, powers := [(18, 1), (24, 1), (44, 1), (55, 1)] }, { coefficient := 1, powers := [(18, 1), (28, 1), (39, 1), (61, 1)] }, { coefficient := -1, powers := [(19, 1), (24, 1), (26, 1), (53, 1)] }, { coefficient := 2, powers := [(19, 1), (24, 1), (55, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (58, 1)] }, { coefficient := 1, powers := [(8, 1), (36, 1)] }],
  [{ coefficient := 1, powers := [(18, 1), (21, 1), (28, 1), (37, 1), (54, 1), (61, 1)] }, { coefficient := 1, powers := [(18, 1), (24, 1), (26, 1), (37, 1), (61, 1)] }],
...
#print axioms Krenn.Component37.SelectedLeafB5_6_4_0.selectedHasNoCommonZero

end Krenn.Component37.SelectedLeafB5_6_4_0
