...
namespace Krenn.Component37.SelectedLeafB1_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "04689271341f7fcdb83ed245d4b39c74c1b5606925c1d5cefa98593ba5b591c2"
def certificateSHA256 : String := "f0e297efd949076a56a25bcd5228584e0dad7d7bd5cceb4c04afc97d094c9aa0"
...
def multipliers : Fin 8 → SparsePoly (Fin 65) := ![
  [{ coefficient := 1, powers := [(21, 1), (46, 1), (64, 1)] }, { coefficient := -1, powers := [(48, 1), (64, 1)] }],
  ...
  [{ coefficient := 1, powers := [(21, 1), (46, 1), (53, 1), (64, 1)] }, { coefficient := -1, powers := [(42, 1), (57, 1), (64, 1)] }, { coefficient := -1, powers := [(48, 1), (53, 1), (64, 1)] }],
...
#print axioms Krenn.Component37.SelectedLeafB1_5.selectedHasNoCommonZero

end Krenn.Component37.SelectedLeafB1_5
