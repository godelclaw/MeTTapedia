...
namespace Krenn.Component37.SelectedLeafB5_2_7_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "07a87020a77858bf200a5d4dccbf1d526cf7bcfdf25a2a88036b4ae52736aea3"
def certificateSHA256 : String := "574d47970b8d975c1d828357660befdfe5da02d8f1ac89ca93c34857e8c4986c"
...
def multipliers : Fin 23 → SparsePoly (Fin 70) := ![
  [{ coefficient := 1, powers := [(24, 1), (52, 1), (58, 1), (66, 1), (68, 1)] }, { coefficient := 1, powers := [(36, 1), (39, 1), (68, 1)] }],
  ...
  [{ coefficient := 1, powers := [(2, 1), (20, 1), (55, 1), (62, 1), (68, 1)] }, { coefficient := 1, powers := [(2, 1), (26, 1), (51, 1), (62, 1), (68, 1)] }, { coefficient := 1, powers := [(8, 1), (33, 1), (68, 1)] }],
  ...
  [{ coefficient := -1, powers := [(0, 1), (2, 1), (58, 1), (62, 1)] }, { coefficient := -1, powers := [(2, 1), (26, 1), (44, 1), (62, 1)] }, { coefficient := -1, powers := [(2, 1), (57, 1), (58, 1), (66, 1)] }, { coefficient := 1, powers := [(2, 1), (58, 1)] }, { coefficient := 1, powers := [(8, 1), (36, 1)] }, { coefficient := -1, powers := [(18, 1), (29, 1), (58, 1), (66, 1)] }, { coefficient := -1, powers := [(19, 1), (27, 1), (30, 1), (68, 1)] }, { coefficient := 1, powers := [(19, 1), (30, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (33, 1), (58, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (49, 1), (51, 1), (54, 1), (62, 1)] }, { coefficient := -1, powers := [(18, 1), (24, 1), (26, 1), (47, 1), (53, 1)] }, { coefficient := 1, powers := [(18, 1), (24, 1), (47, 1), (55, 1)] }, { coefficient := -1, powers := [(18, 1), (33, 1), (39, 1), (47, 1)] }, { coefficient := -1, powers := [(19, 1), (24, 1), (26, 1), (41, 1), (53, 1)] }, { coefficient := 1, powers := [(19, 1), (24, 1), (41, 1), (55, 1)] }, { coefficient := -1, powers := [(19, 1), (33, 1), (39, 1), (41, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (20, 1), (49, 1), (55, 1), (62, 1)] }, { coefficient := 1, powers := [(2, 1), (21, 1), (44, 1), (55, 1), (62, 1)] }, { coefficient := -1, powers := [(2, 1), (26, 1), (49, 1), (51, 1), (62, 1)] }, { coefficient := 1, powers := [(2, 1), (48, 1), (53, 1), (58, 1), (66, 1)] }, { coefficient := -1, powers := [(5, 1), (30, 1), (61, 1)] }, { coefficient := -1, powers := [(8, 1), (33, 1), (49, 1)] }, { coefficient := -1, powers := [(12, 1), (24, 1), (52, 1), (58, 1), (66, 1)] }, { coefficient := -1, powers := [(12, 1), (30, 1), (49, 1)] }, { coefficient := -1, powers := [(12, 1), (36, 1), (39, 1)] }, { coefficient := -1, powers := [(18, 1), (24, 1), (44, 1), (55, 1)] }, { coefficient := 1, powers := [(18, 1), (24, 1), (53, 1), (58, 1), (66, 1)] }]
]
...
#print axioms Krenn.Component37.SelectedLeafB5_2_7_3.selectedHasNoCommonZero

end Krenn.Component37.SelectedLeafB5_2_7_3
