...
namespace Krenn.Component37.SelectedLeafB5_7_6_4_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "199385f0c766cb2d99311e6015cb26ee258b56dea88423b6e697dc95e605aa5f"
def certificateSHA256 : String := "7e98b03a58c16970970f52989cb4173a9d053b09d48fdad9df53c5dddc98f9cf"
...
def multipliers : Fin 20 → SparsePoly (Fin 73) := ![
  [{ coefficient := -1, powers := [(28, 1), (37, 1), (54, 1), (60, 1), (61, 1), (70, 1)] }, { coefficient := 1, powers := [(36, 1), (55, 1), (70, 1)] }],
  ...
  [{ coefficient := -1, powers := [(8, 1), (36, 1), (42, 1)] }, { coefficient := 1, powers := [(18, 1), (23, 1), (39, 1), (61, 1)] }, { coefficient := 1, powers := [(18, 1), (24, 1), (26, 1), (37, 1), (41, 1), (61, 1)] }, { coefficient := 1, powers := [(18, 1), (24, 1), (26, 1), (37, 1), (46, 1), (61, 1)] }, { coefficient := 2, powers := [(18, 1), (24, 1), (37, 1), (54, 1), (61, 1)] }, { coefficient := 1, powers := [(18, 1), (28, 1), (37, 1), (48, 1), (54, 1), (61, 1)] }, { coefficient := 1, powers := [(18, 1), (28, 1), (39, 1), (61, 1)] }, { coefficient := -1, powers := [(19, 1), (24, 1), (26, 1), (53, 1)] }, { coefficient := 1, powers := [(19, 1), (24, 1), (55, 1)] }],
...
#print axioms Krenn.Component37.SelectedLeafB5_7_6_4_7.selectedHasNoCommonZero

end Krenn.Component37.SelectedLeafB5_7_6_4_7
