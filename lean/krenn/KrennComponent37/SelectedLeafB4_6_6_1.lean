...
namespace Krenn.Component37.SelectedLeafB4_6_6_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "5b974d5442e979947156efc551d6499baa49dac2c663a6856e930ecd4a09cefe"
...
def multipliers : Fin 18 → SparsePoly (Fin 68) := ![
  [{ coefficient := -1, powers := [(36, 1), (39, 1), (51, 1), (63, 1), (65, 1)] }],
  ...
  [{ coefficient := 1, powers := [(17, 1), (36, 1), (39, 1), (51, 1), (65, 1)] }, { coefficient := -1, powers := [(18, 1), (24, 1), (44, 1), (55, 1)] }, { coefficient := 1, powers := [(19, 1), (21, 1), (30, 1), (53, 1)] }, { coefficient := -1, powers := [(19, 1), (24, 1), (26, 1), (53, 1)] }, { coefficient := 1, powers := [(19, 1), (24, 1), (55, 1)] }, { coefficient := -1, powers := [(19, 1), (33, 1), (39, 1)] }],
...
#print axioms Krenn.Component37.SelectedLeafB4_6_6_1.selectedHasNoCommonZero

end Krenn.Component37.SelectedLeafB4_6_6_1
