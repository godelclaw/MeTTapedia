...
namespace Krenn.Component37.SelectedLeafB4_0_6_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "8680636c8dd274ad9cb9dd34e8e5680500bb9a021acd9f4189910bc07294dadd"
def certificateSHA256 : String := "fcc74c0da5ef027ef9bf911c2a71b50873f87ef7aa0cfaaa9d93c7a7b78544f4"
...
def multipliers : Fin 18 → SparsePoly (Fin 67) := ![
  ...
  [{ coefficient := 1, powers := [(18, 1), (24, 1), (25, 1), (26, 1), (47, 1), (53, 1)] }, { coefficient := -2, powers := [(18, 1), (24, 1), (25, 1), (47, 1), (55, 1)] }, { coefficient := -1, powers := [(18, 1), (24, 1), (44, 1), (55, 1)] }],
...
#print axioms Krenn.Component37.SelectedLeafB4_0_6_6.selectedHasNoCommonZero

end Krenn.Component37.SelectedLeafB4_0_6_6
