...
namespace Krenn.Component37.SelectedLeafB4_1_6_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "7ce990a83588305cd0b8047389f3e8f850c2044f42e7d4592e55c78d13090c13"
def certificateSHA256 : String := "7ddfdd5461a47b801a55b7251d8be573b2e7fc10e1692404d0ca9d39ba597460"
...
def multipliers : Fin 7 → SparsePoly (Fin 68) := ![
  ...
  [{ coefficient := 1, powers := [(21, 1), (51, 1), (63, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(21, 1), (25, 1), (51, 1), (63, 1), (66, 1)] }],
...
#print axioms Krenn.Component37.SelectedLeafB4_1_6_5.selectedHasNoCommonZero

end Krenn.Component37.SelectedLeafB4_1_6_5
