...
namespace Krenn.Component37.SelectedLeafB4_5_6_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "fc2ac6cc88e476a539fa85cd82d5bd41d83209482df62f712d21d7f79974454f"
...
def multipliers : Fin 7 → SparsePoly (Fin 69) := ![
  [{ coefficient := -1, powers := [(21, 1), (64, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(51, 1), (64, 1), (67, 1)] }],
  [{ coefficient := 1, powers := [(64, 1), (67, 1)] }],
  [{ coefficient := 1, powers := [(21, 1), (51, 1), (64, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(21, 1), (25, 1), (51, 1), (64, 1), (67, 1)] }],
...
#print axioms Krenn.Component37.SelectedLeafB4_5_6_5.selectedHasNoCommonZero

end Krenn.Component37.SelectedLeafB4_5_6_5
