...
namespace Krenn.Component37.SelectedLeafB1_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "9fcd65063f54bcfbda26e5fb59607b0267818f04329b10be21e5bc279fafb73d"
...
def multipliers : Fin 8 → SparsePoly (Fin 64) := ![
  [{ coefficient := 1, powers := [(21, 1), (46, 1), (63, 1)] }, { coefficient := -1, powers := [(48, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(46, 1), (51, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(21, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(21, 1), (46, 1), (51, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(63, 1)] }],
  [{ coefficient := 1, powers := [(21, 1), (46, 1), (53, 1), (63, 1)] }, { coefficient := -1, powers := [(42, 1), (57, 1), (63, 1)] }, { coefficient := -1, powers := [(48, 1), (53, 1), (63, 1)] }],
...
#print axioms Krenn.Component37.SelectedLeafB1_1.selectedHasNoCommonZero

end Krenn.Component37.SelectedLeafB1_1
