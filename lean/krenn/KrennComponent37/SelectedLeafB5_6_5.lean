...
namespace Krenn.Component37.SelectedLeafB5_6_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "ad33ea0d3a0dc48da83604d5640b0561318c4f2fe583a00219e4b604d4b889c1"
...
def multipliers : Fin 8 → SparsePoly (Fin 68) := ![
  [{ coefficient := 1, powers := [(44, 1), (64, 1), (67, 1)] }],
  [{ coefficient := 1, powers := [(26, 1), (64, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(64, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(26, 1), (44, 1), (64, 1), (67, 1)] }],
  [{ coefficient := 1, powers := [(64, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := -1, powers := [(0, 1), (40, 1), (64, 1)] }, { coefficient := -1, powers := [(3, 1), (31, 1), (64, 1)] }, { coefficient := -1, powers := [(9, 1), (20, 1), (64, 1)] }, { coefficient := 1, powers := [(9, 1), (26, 1), (44, 1), (64, 1), (67, 1)] }],
...
#print axioms Krenn.Component37.SelectedLeafB5_6_5.selectedHasNoCommonZero

end Krenn.Component37.SelectedLeafB5_6_5
