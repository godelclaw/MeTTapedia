...
namespace Krenn.Component37.SelectedLeafB3_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "048f2a5fe89879f4556e723a0d0d1f03ec2d24f5f8a27dc6f280e227cdbcd09c"
...
def multipliers : Fin 10 → SparsePoly (Fin 65) := ![
  [{ coefficient := -1, powers := [(25, 1), (46, 1), (51, 1), (62, 1), (64, 1)] }, { coefficient := -1, powers := [(51, 1), (62, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(21, 1), (46, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(46, 1), (51, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(21, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(21, 1), (46, 1), (51, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(64, 1)] }],
  [{ coefficient := 1, powers := [(21, 1), (46, 1), (53, 1), (64, 1)] }, { coefficient := -1, powers := [(42, 1), (57, 1), (64, 1)] }, { coefficient := -1, powers := [(46, 1), (48, 1), (51, 1), (64, 1)] }, { coefficient := -1, powers := [(48, 1), (53, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(25, 1), (46, 1), (48, 1), (51, 1), (64, 1)] }, { coefficient := 1, powers := [(48, 1), (51, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(21, 1), (25, 1), (46, 1), (51, 1), (64, 1)] }],
...
#print axioms Krenn.Component37.SelectedLeafB3_1.selectedHasNoCommonZero

end Krenn.Component37.SelectedLeafB3_1
