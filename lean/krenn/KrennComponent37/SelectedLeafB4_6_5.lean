...
namespace Krenn.Component37.SelectedLeafB4_6_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "258420491a8d4afa9897397d3839f6501d63df294b3e63c04252706ead640ace"
...
def multipliers : Fin 8 → SparsePoly (Fin 67) := ![
  ...
  [{ coefficient := -1, powers := [(0, 1), (40, 1), (63, 1)] }, { coefficient := -1, powers := [(3, 1), (31, 1), (63, 1)] }, { coefficient := -1, powers := [(9, 1), (20, 1), (63, 1)] }, { coefficient := 1, powers := [(9, 1), (26, 1), (44, 1), (63, 1), (66, 1)] }],
...
#print axioms Krenn.Component37.SelectedLeafB4_6_5.selectedHasNoCommonZero

end Krenn.Component37.SelectedLeafB4_6_5
