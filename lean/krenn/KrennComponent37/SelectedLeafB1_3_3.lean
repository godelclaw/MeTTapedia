...
namespace Krenn.Component37.SelectedLeafB1_3_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "f8e2b4c78897f0aeb984e1c38689daed0cad68199b8a6c358aeedc9c49c1e071"
...
def multipliers : Fin 13 → SparsePoly (Fin 67) := ![
  [{ coefficient := -1, powers := [(20, 1), (29, 1), (41, 1), (58, 1), (62, 1), (66, 1)] }, { coefficient := -1, powers := [(20, 1), (29, 1), (46, 1), (58, 1), (62, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(54, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(20, 1), (29, 1), (58, 1), (62, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(20, 1), (58, 1), (62, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(18, 1), (20, 2), (58, 1), (62, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(52, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(26, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(18, 1), (20, 1), (58, 1), (62, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(18, 1), (20, 1), (29, 1), (58, 1), (62, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(66, 1)] }],
  [{ coefficient := 1, powers := [(18, 1), (20, 1), (29, 1), (52, 1), (58, 1), (62, 1), (66, 1)] }, { coefficient := 1, powers := [(26, 1), (47, 1), (52, 1), (66, 1)] }, { coefficient := -1, powers := [(41, 1), (58, 1), (66, 1)] }, { coefficient := -1, powers := [(47, 1), (54, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(20, 1), (52, 1), (58, 1), (66, 1)] }],
...
#print axioms Krenn.Component37.SelectedLeafB1_3_3.selectedHasNoCommonZero

end Krenn.Component37.SelectedLeafB1_3_3
