...
namespace Krenn.Component37.SelectedLeafB4_3_2_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "f4c443bb472d1edb7eaddceb0d5fc7a04c75b98b98cc80d63f27526f6e361737"
...
def multipliers : Fin 26 → SparsePoly (Fin 67) := ![
  [{ coefficient := 2, powers := [(24, 1), (26, 1), (44, 1), (46, 1), (66, 1)] }],
  [{ coefficient := -2, powers := [(24, 1), (44, 1), (46, 1)] }, { coefficient := -1, powers := [(24, 1), (47, 1)] }],
  [{ coefficient := -2, powers := [(24, 1), (26, 1), (44, 1), (46, 1), (51, 1), (62, 1)] }, { coefficient := -2, powers := [(24, 1), (26, 1), (44, 1), (46, 1), (51, 1), (66, 1)] }, { coefficient := 2, powers := [(24, 1), (44, 1), (46, 1), (55, 1)] }, { coefficient := -2, powers := [(24, 1), (44, 1), (55, 1), (62, 1)] }],
...
#print axioms Krenn.Component37.SelectedLeafB4_3_2_4.selectedHasNoCommonZero

end Krenn.Component37.SelectedLeafB4_3_2_4
