...
namespace Krenn.Component37.SelectedLeafB7_2_2_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "9577ed65d385ad1387460df4c1d0c3820a10ebe1012a484aad5a2ddf62a07240"
...
def multipliers : Fin 21 → SparsePoly (Fin 68) := ![
  ...
  [{ coefficient := -1, powers := [(23, 1), (39, 1), (61, 1), (67, 1)] }, { coefficient := -1, powers := [(24, 1), (26, 1), (37, 1), (41, 1), (61, 1), (67, 1)] }, { coefficient := -1, powers := [(24, 1), (26, 1), (37, 1), (46, 1), (61, 1), (67, 1)] }, { coefficient := -1, powers := [(24, 1), (37, 1), (54, 1), (61, 1), (67, 1)] }, { coefficient := -1, powers := [(28, 1), (39, 1), (61, 1), (67, 1)] }],
...
#print axioms Krenn.Component37.SelectedLeafB7_2_2_2.selectedHasNoCommonZero

end Krenn.Component37.SelectedLeafB7_2_2_2
