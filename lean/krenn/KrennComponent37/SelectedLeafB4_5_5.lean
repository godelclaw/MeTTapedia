...
namespace Krenn.Component37.SelectedLeafB4_5_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "e618d044f4758ea817e4ae8850222e1d44cec0aa681233eb7e6d10bc1d559e51"
...
def multipliers : Fin 21 → SparsePoly (Fin 67) := ![
  ...
  [{ coefficient := -1, powers := [(32, 1), (38, 1), (47, 1), (54, 1), (66, 1)] }, { coefficient := 1, powers := [(32, 1), (38, 1), (48, 1), (53, 1), (64, 1)] }],
  ...
  [{ coefficient := 1, powers := [(1, 1), (57, 1)] }, { coefficient := 1, powers := [(7, 1), (35, 1)] }, { coefficient := -1, powers := [(10, 1), (27, 1)] }, { coefficient := -1, powers := [(16, 1), (25, 1), (32, 1), (38, 1), (54, 1), (66, 1)] }, { coefficient := 1, powers := [(16, 1), (26, 1), (32, 1), (38, 1), (66, 1)] }],
...
#print axioms Krenn.Component37.SelectedLeafB4_5_5.selectedHasNoCommonZero

end Krenn.Component37.SelectedLeafB4_5_5
