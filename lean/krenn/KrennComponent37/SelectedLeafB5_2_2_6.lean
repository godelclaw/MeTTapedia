...
namespace Krenn.Component37.SelectedLeafB5_2_2_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "0dd869946db14199d4486af78aaf74d1627f9e8c9da6a13bef8d6092ee5fe1d8"
...
def multipliers : Fin 26 → SparsePoly (Fin 68) := ![
  [{ coefficient := 1, powers := [(36, 1), (37, 1), (39, 1), (60, 1), (67, 1)] }],
  [{ coefficient := 1, powers := [(6, 1), (24, 1), (25, 1), (44, 1), (55, 1), (60, 1), (62, 1), (67, 1)] }, { coefficient := -1, powers := [(23, 1), (63, 1), (67, 1)] }, { coefficient := -1, powers := [(24, 1), (37, 1), (44, 1), (55, 1), (60, 1), (67, 1)] }, { coefficient := -1, powers := [(28, 1), (39, 1), (44, 1), (51, 1), (60, 1), (67, 1)] }, { coefficient := -1, powers := [(28, 1), (63, 1), (67, 1)] }, { coefficient := -1, powers := [(36, 1), (37, 1), (39, 1), (51, 1), (60, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(6, 1), (12, 1), (24, 1), (26, 1), (60, 1), (62, 1), (67, 1)] }, { coefficient := 1, powers := [(8, 1), (24, 1), (25, 2), (53, 1), (60, 1), (62, 1), (67, 1)] }, { coefficient := -1, powers := [(8, 1), (24, 1), (25, 1), (51, 1), (60, 1), (62, 1), (67, 1)] }, { coefficient := 1, powers := [(12, 1), (28, 1), (39, 1), (60, 1), (67, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (37, 1), (55, 1), (60, 1), (67, 1)] }],
...
#print axioms Krenn.Component37.SelectedLeafB5_2_2_6.selectedHasNoCommonZero

end Krenn.Component37.SelectedLeafB5_2_2_6
