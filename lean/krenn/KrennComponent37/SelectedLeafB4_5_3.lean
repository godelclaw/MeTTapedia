...
namespace Krenn.Component37.SelectedLeafB4_5_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "38c004c16cde2c98fe52f8a182b10c921f742b8d93f77e89f970e2b4d65f12f1"
...
def multipliers : Fin 20 → SparsePoly (Fin 67) := ![
  ...
  [{ coefficient := 1, powers := [(31, 1), (38, 1), (52, 1), (63, 1)] }, { coefficient := 1, powers := [(38, 1), (60, 1)] }, { coefficient := -1, powers := [(46, 1), (52, 1)] }, { coefficient := -1, powers := [(47, 1), (54, 1), (57, 1), (66, 1)] }],
...
#print axioms Krenn.Component37.SelectedLeafB4_5_3.selectedHasNoCommonZero

end Krenn.Component37.SelectedLeafB4_5_3
