...
namespace Krenn.Component37.SelectedLeafB1_6_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "1633e500744c99933d211cd589b27ef9e07deee5234719793022e156d653d58e"
def certificateSHA256 : String := "264935fb0633d4b3bb5499783fae598de960f45534b79176230426a8b2521b28"
...
def multipliers : Fin 8 → SparsePoly (Fin 67) := ![
  [{ coefficient := 1, powers := [(26, 1), (52, 1), (66, 1)] }, { coefficient := -1, powers := [(54, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(44, 1), (52, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(26, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(26, 1), (44, 1), (52, 1), (66, 1)] }],
  ...
  [{ coefficient := 1, powers := [(20, 1), (26, 1), (44, 1), (52, 1), (66, 1)] }],
...
#print axioms Krenn.Component37.SelectedLeafB1_6_5.selectedHasNoCommonZero

end Krenn.Component37.SelectedLeafB1_6_5
