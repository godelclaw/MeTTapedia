...
namespace Krenn.Component37.SelectedLeafB0_6_6_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "794de85de714cae710f40f222cd28b2c91eb15b0dab29517449ec7af36eb6c30"
def certificateSHA256 : String := "a657cfc58a5346cf11e6289900ed031ea2058d8f41d2f035e52c9fb37e9e473d"
...
def multipliers : Fin 17 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := 1, powers := [(24, 1), (26, 1), (53, 1), (62, 1)] }, { coefficient := -2, powers := [(24, 1), (55, 1), (62, 1)] }],
...
#print axioms Krenn.Component37.SelectedLeafB0_6_6_0.selectedHasNoCommonZero

end Krenn.Component37.SelectedLeafB0_6_6_0
