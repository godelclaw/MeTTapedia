...
namespace Krenn.Component37.SelectedLeafB6_3_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "e42d7db86f72ebc1020425fb7946aea5f80b9d9867c0c5ed0ad8214286974946"
def certificateSHA256 : String := "9b4c9de4b2352b927b1d3d0cae4a5ea4e6dd7de76b729f5f55afcd667f3a39c2"
...
def multipliers : Fin 36 → SparsePoly (Fin 69) := ![
  [{ coefficient := -1, powers := [(3, 1), (18, 1), (26, 1), (29, 1), (61, 1), (63, 1)] }, { coefficient := -2, powers := [(12, 1), (13, 1), (29, 1), (58, 1), (63, 1), (66, 1), (67, 1)] }, { coefficient := -1, powers := [(12, 1), (29, 1), (58, 1), (63, 1), (67, 1)] }, { coefficient := 1, powers := [(18, 1), (29, 1), (51, 1), (58, 1), (63, 1), (67, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (33, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(3, 1), (18, 1), (24, 1), (61, 1), (63, 1)] }, { coefficient := -1, powers := [(5, 1), (23, 1), (61, 1), (63, 1)] }, { coefficient := -1, powers := [(12, 1), (24, 1), (44, 1), (63, 1)] }, { coefficient := 1, powers := [(18, 1), (29, 1), (42, 1), (44, 1), (63, 1), (64, 1)] }, { coefficient := 2, powers := [(19, 1), (24, 1), (51, 1), (63, 1)] }, { coefficient := -1, powers := [(19, 1), (29, 1), (42, 1), (63, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (36, 1), (63, 1)] }, { coefficient := -1, powers := [(19, 1), (24, 1), (63, 1)] }],
  [{ coefficient := 2, powers := [(12, 1), (28, 1), (58, 1), (63, 1), (66, 1)] }, { coefficient := 2, powers := [(12, 1), (29, 1), (58, 1), (63, 1), (66, 1), (67, 1)] }, { coefficient := 1, powers := [(19, 1), (30, 1), (51, 1), (63, 1), (66, 1)] }],
  ...
  [{ coefficient := 1, powers := [(3, 1), (18, 1), (24, 1), (54, 1), (61, 1)] }, { coefficient := 1, powers := [(3, 1), (18, 1), (26, 1), (29, 1), (48, 1), (61, 1)] }, { coefficient := 1, powers := [(5, 1), (23, 1), (54, 1), (61, 1)] }, { coefficient := -1, powers := [(5, 1), (36, 1), (55, 1)] }, { coefficient := -1, powers := [(8, 1), (33, 1), (49, 1)] }, { coefficient := 2, powers := [(12, 1), (13, 1), (29, 1), (48, 1), (58, 1), (66, 1), (67, 1)] }, { coefficient := -2, powers := [(12, 1), (21, 1), (28, 1), (45, 1), (58, 1), (66, 1)] }, { coefficient := -2, powers := [(12, 1), (21, 1), (29, 1), (45, 1), (58, 1), (66, 1), (67, 1)] }, { coefficient := 1, powers := [(12, 1), (24, 1), (44, 1), (54, 1)] }, { coefficient := 1, powers := [(12, 1), (29, 1), (48, 1), (58, 1), (67, 1)] }, { coefficient := -1, powers := [(18, 1), (29, 1), (42, 1), (44, 1), (54, 1), (64, 1)] }, { coefficient := -1, powers := [(18, 1), (29, 1), (48, 1), (51, 1), (58, 1), (67, 1)] }, { coefficient := -2, powers := [(19, 1), (24, 1), (51, 1), (54, 1)] }, { coefficient := 1, powers := [(19, 1), (24, 1), (55, 1)] }, { coefficient := 1, powers := [(19, 1), (29, 1), (42, 1), (54, 1), (64, 1)] }, { coefficient := 1, powers := [(19, 1), (30, 1), (42, 1)] }],
  [{ coefficient := 1, powers := [(3, 1), (39, 1), (60, 1), (61, 1)] }, { coefficient := 1, powers := [(3, 1), (48, 1), (54, 1), (61, 1)] }, { coefficient := 1, powers := [(39, 1), (61, 1)] }, { coefficient := -1, powers := [(41, 1), (42, 1), (58, 1), (64, 1)] }, { coefficient := -1, powers := [(42, 1), (47, 1), (54, 1), (64, 1)] }, { coefficient := -1, powers := [(42, 1), (57, 1), (58, 1), (67, 1)] }, { coefficient := 1, powers := [(42, 1), (58, 1)] }, { coefficient := -1, powers := [(48, 1), (53, 1), (58, 1), (67, 1)] }, { coefficient := 1, powers := [(49, 1), (55, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (36, 1), (42, 1)] }, { coefficient := 1, powers := [(18, 1), (30, 1), (42, 1), (44, 1)] }, { coefficient := -1, powers := [(19, 1), (30, 1), (42, 1)] }],
  [{ coefficient := 1, powers := [(1, 1), (19, 1), (30, 1), (42, 1), (63, 1)] }, { coefficient := 2, powers := [(12, 1), (24, 1), (58, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (33, 1), (58, 1)] }, { coefficient := -2, powers := [(12, 1), (13, 1), (24, 1), (58, 1), (66, 1)] }, { coefficient := -1, powers := [(12, 1), (24, 1), (58, 1)] }, { coefficient := 1, powers := [(18, 1), (24, 1), (51, 1), (58, 1)] }]
]
...
#print axioms Krenn.Component37.SelectedLeafB6_3_7.selectedHasNoCommonZero

end Krenn.Component37.SelectedLeafB6_3_7
