...
namespace Krenn.Component37.SelectedLeafB4_2_7_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "022aa71eeda517596e96c53d7c0679755004c443c5cc215e49b2de69482fa5f9"
...
def multipliers : Fin 17 → SparsePoly (Fin 69) := ![
  [{ coefficient := 1, powers := [(24, 1), (52, 1), (58, 1), (65, 1), (67, 1)] }, { coefficient := 1, powers := [(36, 1), (39, 1), (67, 1)] }],
  [{ coefficient := 1, powers := [(24, 1), (44, 1), (55, 1), (67, 1)] }, { coefficient := -1, powers := [(24, 1), (53, 1), (58, 1), (65, 1), (67, 1)] }],
  ...
  [{ coefficient := -1, powers := [(2, 1), (57, 1), (58, 1), (65, 1)] }, { coefficient := 1, powers := [(2, 1), (58, 1)] }, { coefficient := 1, powers := [(8, 1), (36, 1)] }, { coefficient := -1, powers := [(18, 1), (29, 1), (58, 1), (65, 1)] }, { coefficient := -1, powers := [(19, 1), (27, 1), (30, 1), (67, 1)] }, { coefficient := 1, powers := [(19, 1), (30, 1)] }],
  ...
  [{ coefficient := -1, powers := [(5, 1), (30, 1), (61, 1)] }, { coefficient := -1, powers := [(8, 1), (33, 1), (49, 1)] }, { coefficient := -1, powers := [(12, 1), (24, 1), (52, 1), (58, 1), (65, 1)] }, { coefficient := -1, powers := [(12, 1), (30, 1), (49, 1)] }, { coefficient := -1, powers := [(12, 1), (36, 1), (39, 1)] }, { coefficient := -1, powers := [(18, 1), (24, 1), (44, 1), (55, 1)] }, { coefficient := 1, powers := [(18, 1), (24, 1), (53, 1), (58, 1), (65, 1)] }]
]
...
#print axioms Krenn.Component37.SelectedLeafB4_2_7_3.selectedHasNoCommonZero

end Krenn.Component37.SelectedLeafB4_2_7_3
