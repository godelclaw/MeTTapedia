...
namespace Krenn.Component37.SelectedLeafB1_3_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "a1b9e342c88d7404ea73308d5cbff40b46752581a356547183c63975a3ad16c8"
def certificateSHA256 : String := "8e8af7a084663d44cff677432627c81db59e28cd81c77a3eead6ba82c8b35d28"
...
def multipliers : Fin 14 → SparsePoly (Fin 66) := ![
  [{ coefficient := -1, powers := [(21, 1), (28, 1), (62, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(18, 1), (25, 1), (51, 1), (62, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(21, 1), (62, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(21, 1), (29, 1), (51, 1), (62, 1), (64, 1)] }, { coefficient := 1, powers := [(24, 1), (51, 1), (62, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(18, 1), (29, 1), (51, 1), (62, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (25, 1), (51, 1), (62, 1), (64, 1)] }],
  ...
  [{ coefficient := 1, powers := [(2, 1), (21, 1), (46, 1), (53, 1), (62, 1), (64, 1)] }, { coefficient := -1, powers := [(2, 1), (42, 1), (57, 1), (62, 1), (64, 1)] }, { coefficient := -1, powers := [(2, 1), (48, 1), (53, 1), (62, 1), (64, 1)] }, { coefficient := -1, powers := [(18, 1), (21, 1), (29, 1), (46, 1), (51, 1), (62, 1), (64, 1)] }, { coefficient := 1, powers := [(18, 1), (29, 1), (48, 1), (51, 1), (62, 1), (64, 1)] }],
...
#print axioms Krenn.Component37.SelectedLeafB1_3_2.selectedHasNoCommonZero

end Krenn.Component37.SelectedLeafB1_3_2
