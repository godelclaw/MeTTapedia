...
namespace Krenn.Component37.SelectedLeafB0_2_2_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "a102384e8d16537c6c7dc3f118a046741bfaacbd4c0315d0cac8e299490b69df"
def certificateSHA256 : String := "fd9a288f1eb65d039641cb4612280e91b9394f162ab04da7f0c89bf000baba21"
...
def multipliers : Fin 28 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := -2, powers := [(19, 1), (24, 1), (37, 1), (55, 1), (59, 1)] }, { coefficient := 2, powers := [(19, 1), (24, 1), (43, 1), (50, 1), (55, 1)] }],
  ...
  [{ coefficient := -2, powers := [(9, 1), (19, 1), (24, 1), (25, 1), (43, 1), (55, 1)] }, { coefficient := 2, powers := [(9, 1), (19, 1), (24, 1), (34, 1), (37, 1), (55, 1)] }, { coefficient := 1, powers := [(12, 1), (24, 1), (26, 1), (47, 1)] }, { coefficient := -1, powers := [(18, 1), (24, 1), (44, 1), (55, 1)] }, { coefficient := -2, powers := [(19, 1), (20, 1), (24, 1), (43, 1), (50, 1), (55, 1)] }, { coefficient := -2, powers := [(19, 1), (24, 1), (25, 1), (43, 1), (50, 1), (55, 1)] }, { coefficient := -2, powers := [(19, 1), (24, 1), (31, 1), (37, 1), (43, 1), (55, 1)] }],
...
#print axioms Krenn.Component37.SelectedLeafB0_2_2_6.selectedHasNoCommonZero

end Krenn.Component37.SelectedLeafB0_2_2_6
