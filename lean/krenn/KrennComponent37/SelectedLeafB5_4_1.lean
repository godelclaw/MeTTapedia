...
namespace Krenn.Component37.SelectedLeafB5_4_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "de2b32069c5366fca8957ea930643d10cd6518146266e7a2b995953cfbdf6d57"
...
def multipliers : Fin 8 → SparsePoly (Fin 66) := ![
  [{ coefficient := 1, powers := [(44, 1), (64, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(26, 1), (64, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(64, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(26, 1), (44, 1), (64, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(64, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := -1, powers := [(0, 1), (40, 1), (64, 1)] }, { coefficient := -1, powers := [(3, 1), (31, 1), (64, 1)] }, { coefficient := -1, powers := [(9, 1), (20, 1), (64, 1)] }, { coefficient := 1, powers := [(9, 1), (26, 1), (44, 1), (64, 1), (65, 1)] }],
...
#print axioms Krenn.Component37.SelectedLeafB5_4_1.selectedHasNoCommonZero

end Krenn.Component37.SelectedLeafB5_4_1
