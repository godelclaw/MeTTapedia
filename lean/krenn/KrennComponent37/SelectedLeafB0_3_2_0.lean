...
namespace Krenn.Component37.SelectedLeafB0_3_2_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "5781be797bea0bd60590d37ce2e3dca2611317ad922fe42034daf2e13d9f97dc"
def certificateSHA256 : String := "1a98b5bc968a3cf3f59be94a3ae23af5b98d9add7c1369c099d69685c36fd5d7"
...
def multipliers : Fin 20 → SparsePoly (Fin 65) := ![
  ...
  [{ coefficient := -1, powers := [(5, 1), (26, 1), (36, 1), (46, 1)] }, { coefficient := 1, powers := [(8, 1), (21, 1), (36, 1), (46, 1)] }, { coefficient := 1, powers := [(8, 1), (21, 1), (36, 1), (57, 1)] }],
  ...
  [{ coefficient := 1, powers := [(8, 1), (36, 1), (52, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (36, 1), (51, 1)] }],
  [{ coefficient := 1, powers := [(12, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (36, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := 1, powers := [(5, 1), (26, 1), (36, 1), (46, 2), (51, 1)] }, { coefficient := -1, powers := [(5, 1), (36, 1), (46, 1), (55, 1)] }, { coefficient := -1, powers := [(8, 1), (21, 1), (36, 1), (46, 2), (51, 1)] }, { coefficient := -1, powers := [(8, 1), (21, 1), (36, 1), (46, 1), (51, 1), (57, 1)] }, { coefficient := 1, powers := [(8, 1), (21, 1), (36, 1), (46, 1), (53, 1)] }, { coefficient := -1, powers := [(8, 1), (36, 1), (42, 1), (57, 1)] }, { coefficient := -1, powers := [(8, 1), (36, 1), (48, 1), (53, 1)] }],
  ...
  [{ coefficient := 1, powers := [(5, 1), (26, 1), (36, 1), (46, 2), (51, 1)] }, { coefficient := -1, powers := [(8, 1), (21, 1), (36, 1), (46, 2), (51, 1)] }, { coefficient := -1, powers := [(8, 1), (21, 1), (36, 1), (46, 1), (51, 1), (57, 1)] }, { coefficient := -1, powers := [(8, 1), (36, 1), (42, 1), (52, 1)] }, { coefficient := -1, powers := [(8, 1), (36, 1), (48, 1), (51, 1), (52, 1)] }, { coefficient := -1, powers := [(18, 1), (24, 1), (26, 1), (47, 1), (53, 1)] }, { coefficient := 1, powers := [(18, 1), (24, 1), (47, 1), (55, 1)] }, { coefficient := -1, powers := [(19, 1), (24, 1), (26, 1), (41, 1), (53, 1)] }, { coefficient := 1, powers := [(19, 1), (24, 1), (41, 1), (55, 1)] }],
...
#print axioms Krenn.Component37.SelectedLeafB0_3_2_0.selectedHasNoCommonZero

end Krenn.Component37.SelectedLeafB0_3_2_0
