...
namespace Krenn.Component37.SelectedLeafB0_0_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "c1d8304269f1d4acbdddd1c55dc6c454bd26632fe3864f3b0bde8a7cd8719e2d"
def certificateSHA256 : String := "bfb9f74a67dd34a4965ab8388e5f1c2be4815c21ee539d924d6824ee0326d62a"
...
def selectedEquations : Fin 44 → SparsePoly (Fin 63) := ![
  ...
  [{ coefficient := 1, powers := [(13, 1), (23, 1), (55, 1)] }, { coefficient := 1, powers := [(30, 1), (43, 1), (51, 1)] }],
  ...
  [{ coefficient := 1, powers := [(0, 1), (43, 1), (55, 1)] }, { coefficient := 1, powers := [(3, 1), (34, 1), (55, 1)] }, { coefficient := 1, powers := [(13, 1), (20, 1), (55, 1)] }, { coefficient := 1, powers := [(26, 1), (43, 1), (51, 1)] }],
...
def multipliers : Fin 44 → SparsePoly (Fin 63) := ![
  [{ coefficient := -1, powers := [(13, 1), (19, 1), (25, 1), (48, 1), (51, 1)] }, { coefficient := 1, powers := [(19, 1), (25, 1), (43, 1), (48, 1), (51, 1)] }, { coefficient := -1, powers := [(19, 1), (34, 1), (37, 1), (48, 1), (51, 1)] }],
  [{ coefficient := -1, powers := [(21, 1), (30, 1)] }],
  [{ coefficient := 1, powers := [(6, 1), (19, 1), (25, 1), (48, 1), (59, 1)] }, { coefficient := 1, powers := [(9, 1), (13, 1), (19, 1), (25, 1), (48, 1)] }, { coefficient := -1, powers := [(13, 1), (19, 1), (31, 1), (37, 1), (48, 1)] }, { coefficient := 1, powers := [(19, 1), (20, 1), (43, 1), (48, 1), (50, 1)] }, { coefficient := 1, powers := [(19, 1), (34, 1), (37, 1), (48, 1), (50, 1)] }],
  [{ coefficient := -1, powers := [(18, 1), (55, 1)] }],
  [{ coefficient := -1, powers := [(18, 1), (49, 1), (54, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (44, 1)] }, { coefficient := 1, powers := [(28, 1), (49, 1)] }],
  [{ coefficient := 1, powers := [(19, 1), (25, 1), (48, 1), (50, 1)] }, { coefficient := 1, powers := [(19, 1), (31, 1), (37, 1), (48, 1)] }],
  [{ coefficient := -1, powers := [(12, 1), (26, 1)] }],
  [{ coefficient := -1, powers := [(6, 1), (19, 1), (30, 1), (48, 1), (59, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (23, 1), (43, 1), (48, 1), (50, 1)] }],
  [{ coefficient := 1, powers := [(19, 1), (25, 1), (28, 1), (48, 1), (55, 1)] }, { coefficient := -1, powers := [(19, 1), (25, 1), (30, 1), (48, 1), (51, 1)] }],
  [{ coefficient := 1, powers := [(19, 1), (25, 1), (43, 1), (48, 1), (55, 1)] }],
  [{ coefficient := 1, powers := [(28, 1), (49, 1), (54, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(9, 1), (19, 1), (25, 1), (48, 1), (55, 1)] }],
  [{ coefficient := -2, powers := [(12, 1), (30, 1)] }],
  [{ coefficient := -1, powers := [(49, 1), (54, 1), (62, 1)] }],
  ...
  [{ coefficient := 1, powers := [(19, 1), (23, 1), (48, 1), (50, 1)] }],
  [{ coefficient := 1, powers := [(12, 1), (24, 1), (44, 1)] }, { coefficient := -1, powers := [(12, 1), (28, 1), (49, 1)] }],
  [{ coefficient := 2, powers := [(12, 1), (21, 1), (30, 1)] }, { coefficient := 1, powers := [(12, 1), (24, 1), (26, 1)] }],
  [{ coefficient := 1, powers := [(12, 1), (29, 1)] }],
  [{ coefficient := -1, powers := [(49, 1), (55, 1)] }],
  [{ coefficient := 1, powers := [(12, 1)] }],
  [{ coefficient := -1, powers := [(12, 1), (21, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (23, 1), (48, 1), (50, 1), (55, 1)] }, { coefficient := -1, powers := [(19, 1), (30, 1), (48, 1), (50, 1), (51, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (30, 1), (43, 1), (48, 1), (51, 1)] }],
  [{ coefficient := -2, powers := [(12, 1), (24, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (25, 1), (48, 1), (55, 1)] }],
  [{ coefficient := 1, powers := [(19, 1), (30, 1), (48, 1), (51, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := 1, powers := [(6, 1), (19, 1), (30, 1), (48, 1), (51, 1), (59, 1)] }, { coefficient := -2, powers := [(12, 1), (21, 1), (30, 1), (47, 1), (52, 1)] }, { coefficient := -1, powers := [(12, 1), (24, 1), (26, 1), (47, 1), (52, 1)] }, { coefficient := -1, powers := [(12, 1), (24, 1), (44, 1), (46, 1), (54, 1)] }, { coefficient := 2, powers := [(12, 1), (24, 1), (47, 1), (54, 1)] }, { coefficient := 1, powers := [(12, 1), (28, 1), (46, 1), (49, 1), (54, 1)] }, { coefficient := -1, powers := [(12, 1), (29, 1), (49, 1), (54, 1)] }, { coefficient := 2, powers := [(12, 1), (30, 1), (49, 1), (52, 1)] }, { coefficient := -2, powers := [(18, 1), (24, 1), (47, 1), (55, 1)] }, { coefficient := 1, powers := [(19, 1), (23, 1), (43, 1), (48, 1), (50, 1), (55, 1)] }, { coefficient := -1, powers := [(19, 1), (30, 1), (37, 1), (48, 1), (51, 1), (59, 1)] }, { coefficient := 1, powers := [(19, 1), (30, 1), (43, 1), (48, 1), (50, 1), (51, 1)] }],
  [{ coefficient := 1, powers := [(37, 1), (49, 1), (55, 1), (60, 1)] }, { coefficient := 1, powers := [(39, 1), (61, 1)] }, { coefficient := 1, powers := [(46, 1), (49, 1), (51, 1), (54, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (19, 1), (30, 1), (48, 1), (51, 1), (56, 1)] }, { coefficient := -1, powers := [(6, 1), (19, 1), (30, 1), (34, 1), (48, 1), (51, 1)] }, { coefficient := 1, powers := [(13, 1), (19, 1), (25, 1), (30, 1), (48, 1), (51, 1)] }, { coefficient := -1, powers := [(19, 1), (25, 1), (28, 1), (43, 1), (48, 1), (55, 1)] }, { coefficient := 1, powers := [(19, 1), (30, 1), (34, 1), (37, 1), (48, 1), (51, 1)] }],
  [{ coefficient := 2, powers := [(0, 1), (12, 1), (24, 1), (58, 1)] }, { coefficient := -1, powers := [(12, 1), (21, 1), (30, 1), (44, 1)] }, { coefficient := 1, powers := [(12, 1), (26, 1), (28, 1), (49, 1)] }, { coefficient := -2, powers := [(18, 1), (24, 1), (25, 1), (44, 1), (55, 1)] }, { coefficient := 2, powers := [(19, 1), (24, 1), (25, 1), (55, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (58, 1)] }, { coefficient := 1, powers := [(8, 1), (36, 1)] }, { coefficient := -1, powers := [(19, 1), (30, 1)] }],
  [{ coefficient := -1, powers := [(3, 1), (19, 1), (30, 1), (31, 1), (48, 1), (51, 1)] }, { coefficient := -1, powers := [(9, 1), (19, 1), (20, 1), (30, 1), (48, 1), (51, 1)] }, { coefficient := 2, powers := [(9, 1), (19, 1), (23, 1), (25, 1), (48, 1), (55, 1)] }, { coefficient := 1, powers := [(19, 1), (20, 1), (23, 1), (48, 1), (50, 1), (55, 1)] }, { coefficient := 1, powers := [(19, 1), (20, 1), (30, 1), (48, 1), (50, 1), (51, 1)] }],
  [{ coefficient := -1, powers := [(12, 1), (28, 1), (49, 1), (54, 1)] }],
...
#print axioms Krenn.Component37.SelectedLeafB0_0_2.selectedHasNoCommonZero

end Krenn.Component37.SelectedLeafB0_0_2
