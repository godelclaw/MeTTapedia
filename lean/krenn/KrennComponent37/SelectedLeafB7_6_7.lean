...
namespace Krenn.Component37.SelectedLeafB7_6_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "7283050e8fa78321a3bdb3cf97a4bb3fc91f0e84e56f60e24e6ee89fada44feb"
...
def multipliers : Fin 4 → SparsePoly (Fin 70) := ![
  [{ coefficient := 1, powers := [(63, 1), (65, 1), (69, 1)] }],
  [{ coefficient := -1, powers := [(40, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := -1, powers := [(1, 1), (40, 1), (63, 1), (65, 1)] }]
]
...
#print axioms Krenn.Component37.SelectedLeafB7_6_7.selectedHasNoCommonZero

end Krenn.Component37.SelectedLeafB7_6_7
