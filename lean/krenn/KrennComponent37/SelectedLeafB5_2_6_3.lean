...
namespace Krenn.Component37.SelectedLeafB5_2_6_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "6a8f15ebbf41855780944a234de6740374fdafa7a51a2dd85b290afe8f812550"
...
def multipliers : Fin 21 → SparsePoly (Fin 69) := ![
  ...
  [{ coefficient := 1, powers := [(2, 1), (58, 1)] }, { coefficient := 1, powers := [(8, 1), (36, 1)] }, { coefficient := -1, powers := [(19, 1), (27, 1), (30, 1), (67, 1)] }, { coefficient := 1, powers := [(19, 1), (30, 1)] }],
...
#print axioms Krenn.Component37.SelectedLeafB5_2_6_3.selectedHasNoCommonZero

end Krenn.Component37.SelectedLeafB5_2_6_3
