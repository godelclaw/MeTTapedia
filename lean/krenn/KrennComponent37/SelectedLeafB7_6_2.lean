...
namespace Krenn.Component37.SelectedLeafB7_6_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "ff39eaa5bb18e7d47d60542dde447beca8b0fce264ced86ea369f5c529e2fe76"
def certificateSHA256 : String := "b363421ff9c5d566fca666b49f5935c1b3ccf8ff556b93e8fc08ebdb59b4752f"
...
def multipliers : Fin 20 → SparsePoly (Fin 68) := ![
  ...
  [{ coefficient := 1, powers := [(21, 1), (30, 1), (37, 1), (41, 1), (61, 1), (65, 1)] }, { coefficient := 1, powers := [(21, 1), (30, 1), (37, 1), (46, 1), (61, 1), (65, 1)] }, { coefficient := -1, powers := [(23, 1), (39, 1), (61, 1), (65, 1)] }, { coefficient := -1, powers := [(24, 1), (26, 1), (37, 1), (41, 1), (61, 1), (65, 1)] }, { coefficient := -1, powers := [(24, 1), (26, 1), (37, 1), (46, 1), (61, 1), (65, 1)] }, { coefficient := -1, powers := [(24, 1), (37, 1), (54, 1), (61, 1), (65, 1)] }, { coefficient := -1, powers := [(28, 1), (39, 1), (61, 1), (65, 1)] }, { coefficient := -1, powers := [(30, 1), (37, 1), (48, 1), (61, 1), (65, 1)] }],
  ...
  [{ coefficient := -1, powers := [(18, 1), (21, 1), (30, 1), (37, 1), (41, 1), (61, 1)] }, { coefficient := -1, powers := [(18, 1), (21, 1), (30, 1), (37, 1), (46, 1), (61, 1)] }, { coefficient := 1, powers := [(18, 1), (23, 1), (39, 1), (61, 1)] }, { coefficient := 1, powers := [(18, 1), (24, 1), (26, 1), (37, 1), (41, 1), (61, 1)] }, { coefficient := 1, powers := [(18, 1), (24, 1), (26, 1), (37, 1), (46, 1), (61, 1)] }, { coefficient := 1, powers := [(18, 1), (24, 1), (37, 1), (54, 1), (61, 1)] }, { coefficient := 1, powers := [(18, 1), (28, 1), (39, 1), (61, 1)] }, { coefficient := 1, powers := [(18, 1), (30, 1), (37, 1), (48, 1), (61, 1)] }, { coefficient := 1, powers := [(19, 1), (21, 1), (30, 1), (53, 1)] }, { coefficient := -1, powers := [(19, 1), (24, 1), (26, 1), (53, 1)] }, { coefficient := -1, powers := [(19, 1), (33, 1), (39, 1)] }],
...
#print axioms Krenn.Component37.SelectedLeafB7_6_2.selectedHasNoCommonZero

end Krenn.Component37.SelectedLeafB7_6_2
