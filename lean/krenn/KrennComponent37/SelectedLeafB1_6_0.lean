...
namespace Krenn.Component37.SelectedLeafB1_6_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "3242320468f98246d087793e8422be5f0ced42e72c4a39d6f50be7ba4ddb6a2c"
def certificateSHA256 : String := "f647863243daf4718943697911e16af0c94ad613ef9ed3b47d90569ccde6e74f"
...
def multipliers : Fin 30 → SparsePoly (Fin 65) := ![
  ...
  [{ coefficient := 1, powers := [(2, 1), (18, 1), (26, 1), (49, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (26, 1), (28, 1), (49, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (49, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (26, 1), (49, 1), (62, 1)] }],
  ...
  [{ coefficient := -1, powers := [(2, 2), (26, 1), (49, 1), (62, 1)] }, { coefficient := 1, powers := [(2, 1), (26, 1), (49, 1)] }],
  [{ coefficient := 1, powers := [(39, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(37, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := 1, powers := [(2, 2), (26, 1), (46, 1), (49, 1), (53, 1), (62, 1)] }, { coefficient := -1, powers := [(2, 1), (26, 1), (46, 1), (49, 1), (53, 1)] }, { coefficient := 1, powers := [(2, 1), (46, 1), (49, 1), (55, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (26, 1), (49, 1), (53, 1)] }],
  [{ coefficient := -1, powers := [(18, 1), (21, 1), (28, 1), (37, 1), (52, 1), (54, 1), (61, 1)] }, { coefficient := 1, powers := [(18, 1), (21, 1), (30, 1), (37, 1), (52, 1), (61, 1)] }, { coefficient := 1, powers := [(18, 1), (23, 1), (39, 1), (61, 1)] }, { coefficient := -1, powers := [(18, 1), (24, 1), (26, 1), (37, 1), (52, 1), (61, 1)] }, { coefficient := 2, powers := [(18, 1), (24, 1), (37, 1), (54, 1), (61, 1)] }, { coefficient := -1, powers := [(18, 1), (24, 1), (44, 1), (55, 1)] }, { coefficient := 1, powers := [(18, 1), (25, 1), (30, 1), (49, 1), (53, 1)] }, { coefficient := -1, powers := [(18, 1), (25, 1), (36, 1), (39, 1), (53, 1)] }, { coefficient := 1, powers := [(18, 1), (28, 1), (39, 1), (61, 1)] }, { coefficient := 1, powers := [(18, 1), (30, 1), (37, 1), (48, 1), (61, 1)] }, { coefficient := -1, powers := [(18, 1), (30, 1), (49, 1), (51, 1)] }, { coefficient := 1, powers := [(19, 1), (21, 1), (30, 1), (53, 1)] }, { coefficient := -1, powers := [(19, 1), (24, 1), (26, 1), (53, 1)] }, { coefficient := 1, powers := [(19, 1), (24, 1), (55, 1)] }, { coefficient := -1, powers := [(19, 1), (33, 1), (39, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (58, 1)] }, { coefficient := 1, powers := [(8, 1), (36, 1)] }],
  [{ coefficient := 1, powers := [(2, 2), (26, 1), (49, 1), (51, 1), (62, 1)] }, { coefficient := 1, powers := [(2, 1), (12, 1), (26, 1), (28, 1), (49, 1), (62, 1)] }, { coefficient := -1, powers := [(2, 1), (26, 1), (49, 1), (51, 1)] }, { coefficient := 1, powers := [(12, 1), (20, 1), (30, 1), (49, 1)] }, { coefficient := -1, powers := [(12, 1), (20, 1), (36, 1), (39, 1)] }, { coefficient := 1, powers := [(18, 1), (21, 1), (28, 1), (37, 1), (54, 1), (61, 1)] }, { coefficient := -1, powers := [(18, 1), (21, 1), (30, 1), (37, 1), (61, 1)] }, { coefficient := 1, powers := [(18, 1), (24, 1), (26, 1), (37, 1), (61, 1)] }],
...
#print axioms Krenn.Component37.SelectedLeafB1_6_0.selectedHasNoCommonZero

end Krenn.Component37.SelectedLeafB1_6_0
