...
namespace Krenn.Component37.SelectedLeafB4_3_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "ae1cdae331071a10d75d6a0bfd3227786045fc099c3d08fc573971d469982edf"
...
def multipliers : Fin 26 → SparsePoly (Fin 67) := ![
  ...
  [{ coefficient := 1, powers := [(32, 1), (38, 1), (44, 1), (54, 1), (62, 1), (66, 1)] }, { coefficient := 1, powers := [(32, 1), (38, 1), (48, 1), (53, 1), (64, 1)] }],
  ...
  [{ coefficient := 1, powers := [(4, 1), (32, 1)] }, { coefficient := -1, powers := [(10, 1), (27, 1)] }, { coefficient := 1, powers := [(11, 1), (20, 1), (32, 1), (38, 1), (48, 1), (64, 1)] }, { coefficient := -1, powers := [(11, 1), (21, 1), (32, 1), (38, 1), (64, 1)] }, { coefficient := 1, powers := [(16, 1), (20, 1), (26, 1), (32, 1), (38, 1), (62, 1), (66, 1)] }],
...
#print axioms Krenn.Component37.SelectedLeafB4_3_5.selectedHasNoCommonZero

end Krenn.Component37.SelectedLeafB4_3_5
