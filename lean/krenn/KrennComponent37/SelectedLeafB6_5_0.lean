...
namespace Krenn.Component37.SelectedLeafB6_5_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "2a7dcf14d8ff53f0736a4e78d98a1195d37581c87eecd5db96686812c448d770"
...
def multipliers : Fin 12 → SparsePoly (Fin 66) := ![
  [{ coefficient := 1, powers := [(0, 1), (53, 1), (63, 1), (65, 1)] }, { coefficient := -1, powers := [(20, 1), (25, 1), (46, 1), (53, 1), (63, 1), (65, 1)] }, { coefficient := 1, powers := [(20, 1), (46, 1), (51, 1), (63, 1), (65, 1)] }, { coefficient := 1, powers := [(20, 1), (53, 1), (63, 1), (65, 1)] }, { coefficient := 1, powers := [(25, 1), (53, 1), (63, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(46, 1), (48, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(53, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(25, 1), (46, 1), (48, 1), (65, 1)] }, { coefficient := -1, powers := [(48, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(21, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(46, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(21, 1), (53, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(25, 1), (46, 1), (65, 1)] }, { coefficient := 1, powers := [(65, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (48, 1), (53, 1), (65, 1)] }, { coefficient := 1, powers := [(20, 1), (25, 1), (46, 1), (48, 1), (53, 1), (65, 1)] }, { coefficient := -1, powers := [(20, 1), (46, 1), (48, 1), (51, 1), (65, 1)] }, { coefficient := -1, powers := [(20, 1), (48, 1), (53, 1), (65, 1)] }, { coefficient := -1, powers := [(25, 1), (48, 1), (53, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(21, 1), (25, 1), (53, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := 1, powers := [(0, 1), (25, 1), (42, 1), (46, 1), (65, 1)] }, { coefficient := -1, powers := [(0, 1), (42, 1), (65, 1)] }, { coefficient := -1, powers := [(20, 1), (25, 1), (46, 1), (48, 1), (51, 1), (65, 1)] }, { coefficient := 1, powers := [(20, 1), (48, 1), (51, 1), (65, 1)] }, { coefficient := 1, powers := [(21, 1), (25, 1), (46, 1), (51, 1), (65, 1)] }]
]
...
#print axioms Krenn.Component37.SelectedLeafB6_5_0.selectedHasNoCommonZero

end Krenn.Component37.SelectedLeafB6_5_0
