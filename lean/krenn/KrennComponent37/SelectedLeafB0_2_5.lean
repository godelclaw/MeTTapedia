...
namespace Krenn.Component37.SelectedLeafB0_2_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "52eb89cde92b155adf6d8a4f42a6202f230251f06d41c0c101d2f276a8d4e8a3"
...
def multipliers : Fin 8 → SparsePoly (Fin 65) := ![
  [{ coefficient := 1, powers := [(26, 1), (52, 1), (64, 1)] }, { coefficient := -1, powers := [(54, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(44, 1), (52, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(26, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(26, 1), (44, 1), (52, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(64, 1)] }],
  [{ coefficient := 1, powers := [(26, 1), (47, 1), (52, 1), (64, 1)] }, { coefficient := -1, powers := [(41, 1), (58, 1), (64, 1)] }, { coefficient := -1, powers := [(47, 1), (54, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(20, 1), (26, 1), (44, 1), (52, 1), (64, 1)] }],
...
#print axioms Krenn.Component37.SelectedLeafB0_2_5.selectedHasNoCommonZero

end Krenn.Component37.SelectedLeafB0_2_5
