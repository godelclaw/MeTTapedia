...
namespace Krenn.Component37.SelectedLeafB0_2_2_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "b8487db0cc575c52fc0079ad2ed820c021a792b7b48b900d1256085667ce2c4e"
def certificateSHA256 : String := "82e785a107ff0b5b736fb64d6241829c6f2f37a6970214e75b326789bec2df3a"
...
def multipliers : Fin 17 → SparsePoly (Fin 64) := ![
  ...
  [{ coefficient := 1, powers := [(5, 1), (26, 1), (36, 1), (46, 2), (51, 1)] }, { coefficient := -1, powers := [(18, 1), (24, 1), (26, 1), (47, 1), (53, 1)] }, { coefficient := 1, powers := [(18, 1), (24, 1), (47, 1), (55, 1)] }, { coefficient := -1, powers := [(19, 1), (24, 1), (26, 1), (41, 1), (53, 1)] }, { coefficient := 1, powers := [(19, 1), (24, 1), (41, 1), (55, 1)] }],
...
#print axioms Krenn.Component37.SelectedLeafB0_2_2_0.selectedHasNoCommonZero

end Krenn.Component37.SelectedLeafB0_2_2_0
