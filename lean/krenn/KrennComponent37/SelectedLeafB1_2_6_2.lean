...
namespace Krenn.Component37.SelectedLeafB1_2_6_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "2d1bbc0e3627d72b1df6563ed09dc1ceaf74fe61978548a86f4501819953a931"
def certificateSHA256 : String := "c1694d5c29807ae5bb6aa2434d6603646f19f888d1fc3caed830ca077b3752d2"
...
def multipliers : Fin 22 → SparsePoly (Fin 67) := ![
  ...
  [{ coefficient := 1, powers := [(2, 1), (39, 1), (51, 1), (60, 1), (66, 1)] }],
  ...
  [{ coefficient := -1, powers := [(2, 1), (39, 1), (46, 1), (61, 1)] }, { coefficient := 1, powers := [(2, 1), (39, 1), (47, 1), (51, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (58, 1)] }, { coefficient := 1, powers := [(8, 1), (36, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (33, 1)] }, { coefficient := -1, powers := [(12, 1), (24, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (39, 1), (41, 1), (61, 1)] }, { coefficient := -1, powers := [(2, 1), (39, 1), (46, 1), (61, 1)] }, { coefficient := 1, powers := [(2, 1), (39, 1), (47, 1), (51, 1), (60, 1)] }, { coefficient := -1, powers := [(18, 1), (24, 1), (26, 1), (47, 1), (53, 1)] }, { coefficient := 2, powers := [(18, 1), (24, 1), (47, 1), (55, 1)] }, { coefficient := -1, powers := [(19, 1), (24, 1), (26, 1), (41, 1), (53, 1)] }, { coefficient := 2, powers := [(19, 1), (24, 1), (41, 1), (55, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (39, 1), (44, 1), (51, 1), (60, 1)] }, { coefficient := 1, powers := [(2, 1), (49, 1), (55, 1)] }, { coefficient := -1, powers := [(18, 1), (24, 1), (44, 1), (55, 1)] }],
...
#print axioms Krenn.Component37.SelectedLeafB1_2_6_2.selectedHasNoCommonZero

end Krenn.Component37.SelectedLeafB1_2_6_2
