...
namespace Krenn.Component37.SelectedLeafB4_4_6_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "30c4e3783c042d49095ff1033ecbe8754332fe5264462e2a9bca6b8163d6e84c"
def certificateSHA256 : String := "f9ddb0488b561f25046bd5d48653947feff39188e064e4dbc6b8ca26f0815eec"
...
def multipliers : Fin 18 → SparsePoly (Fin 67) := ![
  [{ coefficient := -1, powers := [(36, 1), (39, 1), (51, 1), (63, 1), (64, 1)] }],
  ...
  [{ coefficient := 1, powers := [(17, 1), (36, 1), (39, 1), (51, 1), (64, 1)] }, { coefficient := -1, powers := [(18, 1), (24, 1), (44, 1), (55, 1)] }, { coefficient := 1, powers := [(19, 1), (21, 1), (30, 1), (53, 1)] }, { coefficient := -1, powers := [(19, 1), (24, 1), (26, 1), (53, 1)] }, { coefficient := 1, powers := [(19, 1), (24, 1), (55, 1)] }, { coefficient := -1, powers := [(19, 1), (33, 1), (39, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (58, 1)] }, { coefficient := 1, powers := [(8, 1), (36, 1)] }],
  [{ coefficient := -1, powers := [(12, 1), (36, 1), (39, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (33, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (33, 1), (49, 1), (52, 1)] }, { coefficient := -1, powers := [(12, 1), (36, 1), (39, 1), (45, 1), (64, 1)] }]
]
...
#print axioms Krenn.Component37.SelectedLeafB4_4_6_1.selectedHasNoCommonZero

end Krenn.Component37.SelectedLeafB4_4_6_1
