...
namespace Krenn.Component37.SelectedLeafB4_7_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "25c5efaf6d52296cf2075e187a2257ffb6a7238f1bf3cd6f740828c1a3072a65"
def certificateSHA256 : String := "4ec05cba075845394d3c6c109c8c1d400bf916992b7902f3738f2ac53f7738b9"
...
def multipliers : Fin 19 → SparsePoly (Fin 67) := ![
  [{ coefficient := 1, powers := [(24, 1), (44, 1), (55, 1), (63, 1)] }, { coefficient := -1, powers := [(25, 1), (30, 1), (49, 1), (53, 1), (63, 1)] }, { coefficient := 1, powers := [(25, 1), (36, 1), (39, 1), (53, 1), (63, 1)] }, { coefficient := 1, powers := [(30, 1), (49, 1), (51, 1), (63, 1)] }],
  ...
  [{ coefficient := -1, powers := [(18, 1), (24, 1), (44, 1), (55, 1)] }, { coefficient := 1, powers := [(18, 1), (25, 1), (30, 1), (49, 1), (53, 1)] }, { coefficient := -1, powers := [(18, 1), (25, 1), (36, 1), (39, 1), (53, 1)] }, { coefficient := -1, powers := [(18, 1), (30, 1), (49, 1), (51, 1)] }, { coefficient := 1, powers := [(19, 1), (21, 1), (30, 1), (53, 1)] }, { coefficient := -1, powers := [(19, 1), (24, 1), (26, 1), (53, 1)] }, { coefficient := 1, powers := [(19, 1), (24, 1), (55, 1)] }, { coefficient := 1, powers := [(19, 1), (29, 1), (42, 1), (54, 1), (64, 1)] }, { coefficient := -1, powers := [(19, 1), (30, 1), (42, 1), (52, 1), (64, 1)] }, { coefficient := -1, powers := [(19, 1), (33, 1), (39, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (36, 1), (42, 1)] }],
  [{ coefficient := 1, powers := [(12, 1), (20, 1), (30, 1), (49, 1)] }, { coefficient := -1, powers := [(12, 1), (20, 1), (36, 1), (39, 1)] }],
...
#print axioms Krenn.Component37.SelectedLeafB4_7_4.selectedHasNoCommonZero

end Krenn.Component37.SelectedLeafB4_7_4
