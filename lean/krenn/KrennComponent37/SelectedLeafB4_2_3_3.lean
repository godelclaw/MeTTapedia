...
namespace Krenn.Component37.SelectedLeafB4_2_3_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "5b080005ec51b62e2f1cada875d75a78e0557764d3457bf783837c57ca9640df"
def certificateSHA256 : String := "a6e3f6b2882cd4107e171dc8f046ca6206e766da6a01da3f47e23753563ccc8e"
...
def multipliers : Fin 17 → SparsePoly (Fin 68) := ![
  [{ coefficient := 1, powers := [(24, 1), (52, 1), (58, 1), (64, 1), (66, 1)] }, { coefficient := 1, powers := [(36, 1), (39, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(24, 1), (44, 1), (55, 1), (66, 1)] }, { coefficient := -1, powers := [(24, 1), (53, 1), (58, 1), (64, 1), (66, 1)] }],
  ...
  [{ coefficient := -1, powers := [(2, 1), (57, 1), (58, 1), (64, 1)] }, { coefficient := 1, powers := [(2, 1), (58, 1)] }, { coefficient := 1, powers := [(8, 1), (36, 1)] }, { coefficient := -1, powers := [(18, 1), (29, 1), (58, 1), (64, 1)] }, { coefficient := -1, powers := [(19, 1), (27, 1), (30, 1), (66, 1)] }, { coefficient := 1, powers := [(19, 1), (30, 1)] }],
  ...
  [{ coefficient := -1, powers := [(5, 1), (30, 1), (61, 1)] }, { coefficient := -1, powers := [(8, 1), (33, 1), (49, 1)] }, { coefficient := -1, powers := [(12, 1), (24, 1), (52, 1), (58, 1), (64, 1)] }, { coefficient := -1, powers := [(12, 1), (30, 1), (49, 1)] }, { coefficient := -1, powers := [(12, 1), (36, 1), (39, 1)] }, { coefficient := -1, powers := [(18, 1), (24, 1), (44, 1), (55, 1)] }, { coefficient := 1, powers := [(18, 1), (24, 1), (53, 1), (58, 1), (64, 1)] }]
]
...
#print axioms Krenn.Component37.SelectedLeafB4_2_3_3.selectedHasNoCommonZero

end Krenn.Component37.SelectedLeafB4_2_3_3
