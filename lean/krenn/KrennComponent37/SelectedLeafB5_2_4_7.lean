...
namespace Krenn.Component37.SelectedLeafB5_2_4_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "688b1ad35a865993e8b7bda7b211a2d77446018952ddc565f8adbc76bdf99765"
def certificateSHA256 : String := "e1af71a788c65a5dcc502452503ed905d253ba4a59eb3847bed88ed3a888677b"
...
def multipliers : Fin 26 → SparsePoly (Fin 69) := ![
  ...
  [{ coefficient := -1, powers := [(21, 1), (30, 1), (37, 1), (52, 1), (61, 1), (67, 1)] }, { coefficient := -1, powers := [(23, 1), (39, 1), (61, 1), (67, 1)] }, { coefficient := 1, powers := [(24, 1), (26, 1), (37, 1), (52, 1), (61, 1), (67, 1)] }, { coefficient := -1, powers := [(24, 1), (37, 1), (54, 1), (61, 1), (67, 1)] }, { coefficient := 1, powers := [(24, 1), (44, 1), (55, 1), (67, 1)] }, { coefficient := -1, powers := [(28, 1), (39, 1), (61, 1), (67, 1)] }, { coefficient := -1, powers := [(30, 1), (37, 1), (48, 1), (61, 1), (67, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (37, 1), (54, 1), (61, 1), (67, 1)] }, { coefficient := -1, powers := [(19, 1), (20, 1), (30, 1), (51, 1), (66, 1), (67, 1)] }, { coefficient := 2, powers := [(19, 1), (25, 1), (29, 1), (55, 1), (67, 1)] }, { coefficient := -1, powers := [(19, 1), (30, 1), (51, 1), (67, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (33, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(18, 1), (55, 1)] }],
  [{ coefficient := 1, powers := [(18, 1), (37, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(19, 1), (30, 1), (48, 1), (66, 1)] }],
  [{ coefficient := 2, powers := [(24, 1), (25, 1), (55, 1)] }],
  ...
  [{ coefficient := -1, powers := [(18, 1), (21, 1), (30, 1), (37, 1), (61, 1)] }, { coefficient := 1, powers := [(18, 1), (24, 1), (26, 1), (37, 1), (61, 1)] }, { coefficient := 2, powers := [(19, 1), (24, 1), (25, 1), (55, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (33, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (30, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (37, 1), (48, 1), (54, 1), (61, 1)] }, { coefficient := -1, powers := [(8, 1), (33, 1), (49, 1)] }, { coefficient := 1, powers := [(12, 1), (24, 1), (26, 1), (47, 1)] }, { coefficient := 1, powers := [(12, 1), (25, 1), (30, 1), (49, 1), (66, 1)] }, { coefficient := -1, powers := [(12, 1), (30, 1), (49, 1)] }, { coefficient := -1, powers := [(12, 1), (36, 1), (39, 1)] }, { coefficient := 1, powers := [(18, 1), (21, 1), (30, 1), (37, 1), (52, 1), (61, 1)] }, { coefficient := 1, powers := [(18, 1), (23, 1), (39, 1), (61, 1)] }, { coefficient := -1, powers := [(18, 1), (24, 1), (26, 1), (37, 1), (52, 1), (61, 1)] }, { coefficient := 1, powers := [(18, 1), (24, 1), (37, 1), (54, 1), (61, 1)] }, { coefficient := -1, powers := [(18, 1), (24, 1), (44, 1), (55, 1)] }, { coefficient := 1, powers := [(18, 1), (28, 1), (39, 1), (61, 1)] }, { coefficient := 1, powers := [(18, 1), (30, 1), (37, 1), (48, 1), (61, 1)] }, { coefficient := 1, powers := [(19, 1), (20, 1), (30, 1), (48, 1), (51, 1), (66, 1)] }, { coefficient := -2, powers := [(19, 1), (25, 1), (29, 1), (48, 1), (55, 1)] }, { coefficient := 1, powers := [(19, 1), (30, 1), (48, 1), (51, 1)] }]
]
...
#print axioms Krenn.Component37.SelectedLeafB5_2_4_7.selectedHasNoCommonZero

end Krenn.Component37.SelectedLeafB5_2_4_7
