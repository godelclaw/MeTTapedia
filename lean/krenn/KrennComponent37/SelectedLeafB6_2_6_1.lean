...
namespace Krenn.Component37.SelectedLeafB6_2_6_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "1f159da010c66b32cc978583aa5802f34f7fe1b7a223e21643230e91b38dc04e"
def certificateSHA256 : String := "11910d6a3059a7b1daa4944b80714f6b42d97de8b24ff9e6b25dc554b8896faa"
...
def multipliers : Fin 17 → SparsePoly (Fin 68) := ![
  ...
  [{ coefficient := -1, powers := [(5, 1), (36, 1), (55, 1)] }, { coefficient := -1, powers := [(8, 1), (33, 1), (49, 1)] }, { coefficient := -1, powers := [(12, 1), (30, 1), (44, 1), (48, 1)] }, { coefficient := 1, powers := [(12, 1), (30, 1), (49, 1)] }, { coefficient := 1, powers := [(19, 1), (21, 1), (30, 1), (53, 1)] }, { coefficient := -1, powers := [(19, 1), (24, 1), (26, 1), (53, 1)] }],
...
#print axioms Krenn.Component37.SelectedLeafB6_2_6_1.selectedHasNoCommonZero

end Krenn.Component37.SelectedLeafB6_2_6_1
