...
namespace Krenn.Component37.SelectedLeafB7_2_6_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "3180726437f0911a176979a251f855104ef16b0635310517acc4ac6b7ff903ba"
def certificateSHA256 : String := "287d512c3d0146c1ff94c2095e6729bc0a9eced8021db94265a52ff7d9dd9df4"
...
def multipliers : Fin 21 → SparsePoly (Fin 69) := ![
  ...
  [{ coefficient := -1, powers := [(23, 1), (39, 1), (61, 1), (68, 1)] }, { coefficient := -1, powers := [(24, 1), (26, 1), (37, 1), (41, 1), (61, 1), (68, 1)] }, { coefficient := -1, powers := [(24, 1), (26, 1), (37, 1), (46, 1), (61, 1), (68, 1)] }, { coefficient := -1, powers := [(24, 1), (37, 1), (54, 1), (61, 1), (68, 1)] }, { coefficient := -1, powers := [(28, 1), (39, 1), (61, 1), (68, 1)] }],
  ...
  [{ coefficient := -1, powers := [(2, 1), (37, 1), (48, 1), (54, 1), (61, 1)] }, { coefficient := -1, powers := [(5, 1), (36, 1), (55, 1)] }, { coefficient := 1, powers := [(19, 1), (24, 1), (55, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (58, 1)] }, { coefficient := 1, powers := [(8, 1), (36, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (33, 1)] }, { coefficient := -1, powers := [(12, 1), (24, 1)] }],
  [{ coefficient := -1, powers := [(18, 1), (24, 1), (26, 1), (47, 1), (53, 1)] }, { coefficient := -1, powers := [(19, 1), (24, 1), (26, 1), (41, 1), (53, 1)] }],
  [{ coefficient := 1, powers := [(18, 1), (23, 1), (39, 1), (61, 1)] }, { coefficient := 1, powers := [(18, 1), (24, 1), (26, 1), (37, 1), (41, 1), (61, 1)] }, { coefficient := 1, powers := [(18, 1), (24, 1), (26, 1), (37, 1), (46, 1), (61, 1)] }, { coefficient := 1, powers := [(18, 1), (24, 1), (37, 1), (54, 1), (61, 1)] }, { coefficient := 1, powers := [(18, 1), (28, 1), (39, 1), (61, 1)] }],
...
#print axioms Krenn.Component37.SelectedLeafB7_2_6_2.selectedHasNoCommonZero

end Krenn.Component37.SelectedLeafB7_2_6_2
