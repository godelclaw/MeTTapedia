...
namespace Krenn.Component37.SelectedLeafB4_2_6_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "c57fa2b1687fd896126d2817469beaf946d2704efbbed8838991eb68ee1a496f"
def certificateSHA256 : String := "794f0216925937906caadd0e2e9ea7ea8e5a1344e6428ba8e7021b32ec1353ff"
...
def multipliers : Fin 23 → SparsePoly (Fin 68) := ![
  ...
  [{ coefficient := -2, powers := [(13, 1), (19, 1), (29, 1), (55, 1), (64, 1), (65, 1), (67, 1)] }],
  ...
  [{ coefficient := 1, powers := [(12, 1), (24, 1), (26, 1), (47, 1)] }, { coefficient := 2, powers := [(13, 1), (19, 1), (29, 1), (48, 1), (55, 1), (64, 1), (65, 1)] }, { coefficient := -1, powers := [(18, 1), (24, 1), (44, 1), (55, 1)] }, { coefficient := -2, powers := [(19, 1), (21, 1), (28, 1), (45, 1), (55, 1), (64, 1)] }, { coefficient := -2, powers := [(19, 1), (21, 1), (29, 1), (45, 1), (55, 1), (64, 1), (65, 1)] }],
...
#print axioms Krenn.Component37.SelectedLeafB4_2_6_6.selectedHasNoCommonZero

end Krenn.Component37.SelectedLeafB4_2_6_6
