...
namespace Krenn.Component37.SelectedLeafB5_6_6_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "abfcacb91bc372fa7d8ff5aa45b851753dff18c431ac41fbeb339c327e3b0f3b"
def certificateSHA256 : String := "a6ebaef728828d143eb1342fee76bc648e370d195f99fd050edb3731c1dfe394"
...
def multipliers : Fin 25 → SparsePoly (Fin 68) := ![
  ...
  [{ coefficient := 1, powers := [(18, 1), (21, 1), (28, 1), (37, 1), (41, 1), (54, 1), (61, 1)] }, { coefficient := 1, powers := [(18, 1), (21, 1), (28, 1), (37, 1), (46, 1), (54, 1), (61, 1)] }, { coefficient := 1, powers := [(18, 1), (23, 1), (39, 1), (61, 1)] }, { coefficient := 1, powers := [(18, 1), (24, 1), (26, 1), (37, 1), (41, 1), (61, 1)] }, { coefficient := 1, powers := [(18, 1), (24, 1), (26, 1), (37, 1), (46, 1), (61, 1)] }, { coefficient := 2, powers := [(18, 1), (24, 1), (37, 1), (54, 1), (61, 1)] }, { coefficient := -1, powers := [(18, 1), (24, 1), (44, 1), (55, 1)] }, { coefficient := 1, powers := [(18, 1), (28, 1), (39, 1), (61, 1)] }, { coefficient := -1, powers := [(19, 1), (24, 1), (26, 1), (53, 1)] }, { coefficient := 2, powers := [(19, 1), (24, 1), (55, 1)] }],
...
#print axioms Krenn.Component37.SelectedLeafB5_6_6_0.selectedHasNoCommonZero

end Krenn.Component37.SelectedLeafB5_6_6_0
