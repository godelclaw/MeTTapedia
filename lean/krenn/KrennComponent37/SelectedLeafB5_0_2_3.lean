...
namespace Krenn.Component37.SelectedLeafB5_0_2_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "44c100a82c100e67acb68d7c831b2ea7601fd2bde2f75a4e464d98e1815e268e"
def certificateSHA256 : String := "9b1d3ed717716b02b8b245f85face6994d672498418226e12693ad2cfccec1c5"
...
def multipliers : Fin 22 → SparsePoly (Fin 67) := ![
  ...
  [{ coefficient := 1, powers := [(21, 1), (30, 1), (37, 1), (46, 1), (61, 1), (65, 1)] }, { coefficient := -1, powers := [(23, 1), (39, 1), (61, 1), (65, 1)] }, { coefficient := -1, powers := [(24, 1), (26, 1), (37, 1), (46, 1), (61, 1), (65, 1)] }, { coefficient := -1, powers := [(24, 1), (37, 1), (54, 1), (61, 1), (65, 1)] }, { coefficient := 1, powers := [(24, 1), (44, 1), (55, 1), (65, 1)] }, { coefficient := -1, powers := [(28, 1), (39, 1), (61, 1), (65, 1)] }, { coefficient := -1, powers := [(30, 1), (37, 1), (48, 1), (61, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (37, 1), (54, 1), (61, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (33, 1), (65, 1)] }, { coefficient := -1, powers := [(12, 1), (30, 1), (65, 1)] }],
  ...
  [{ coefficient := -1, powers := [(2, 1), (37, 1), (48, 1), (54, 1), (61, 1)] }, { coefficient := -1, powers := [(5, 1), (30, 1), (61, 1)] }, { coefficient := -1, powers := [(8, 1), (33, 1), (49, 1)] }, { coefficient := -1, powers := [(12, 1), (30, 1), (49, 1)] }, { coefficient := -1, powers := [(12, 1), (36, 1), (39, 1)] }, { coefficient := -1, powers := [(18, 1), (21, 1), (30, 1), (37, 1), (46, 1), (61, 1)] }, { coefficient := 1, powers := [(18, 1), (23, 1), (39, 1), (61, 1)] }, { coefficient := 1, powers := [(18, 1), (24, 1), (26, 1), (37, 1), (46, 1), (61, 1)] }, { coefficient := 1, powers := [(18, 1), (24, 1), (37, 1), (54, 1), (61, 1)] }, { coefficient := -1, powers := [(18, 1), (24, 1), (44, 1), (55, 1)] }, { coefficient := 1, powers := [(18, 1), (28, 1), (39, 1), (61, 1)] }, { coefficient := 1, powers := [(18, 1), (30, 1), (37, 1), (48, 1), (61, 1)] }]
]
...
#print axioms Krenn.Component37.SelectedLeafB5_0_2_3.selectedHasNoCommonZero

end Krenn.Component37.SelectedLeafB5_0_2_3
