...
namespace Krenn.Component37.SelectedLeafB4_2_7_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "8155c6b6c3bf158c26434905f58d146c8e8981c0958cfb97b392dd2147f694f3"
...
def multipliers : Fin 27 → SparsePoly (Fin 70) := ![
  [{ coefficient := -1, powers := [(24, 1), (26, 1), (47, 1), (68, 1)] }, { coefficient := 1, powers := [(24, 1), (52, 1), (58, 1), (65, 1), (68, 1)] }, { coefficient := -1, powers := [(25, 1), (30, 1), (49, 1), (67, 1), (68, 1)] }, { coefficient := 1, powers := [(30, 1), (49, 1), (68, 1)] }, { coefficient := 1, powers := [(36, 1), (39, 1), (68, 1)] }],
  [{ coefficient := 1, powers := [(24, 1), (44, 1), (55, 1), (68, 1)] }, { coefficient := -1, powers := [(24, 1), (53, 1), (58, 1), (65, 1), (68, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (20, 1), (30, 1), (51, 1), (67, 1), (68, 1)] }, { coefficient := -2, powers := [(19, 1), (23, 1), (26, 1), (41, 1), (51, 1), (68, 1)] }, { coefficient := -2, powers := [(19, 1), (25, 1), (29, 1), (55, 1), (68, 1)] }, { coefficient := 2, powers := [(19, 1), (26, 1), (29, 1), (51, 1), (68, 1)] }, { coefficient := -2, powers := [(19, 1), (26, 1), (33, 1), (37, 1), (41, 1), (68, 1)] }, { coefficient := 2, powers := [(19, 1), (28, 1), (55, 1), (68, 1)] }, { coefficient := -1, powers := [(19, 1), (30, 1), (51, 1), (68, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (33, 1), (68, 1)] }],
  [{ coefficient := -1, powers := [(18, 1), (55, 1)] }],
  [{ coefficient := 2, powers := [(19, 1), (25, 1), (29, 1), (55, 1), (69, 1)] }, { coefficient := -2, powers := [(19, 1), (26, 1), (29, 1), (51, 1), (69, 1)] }],
  [{ coefficient := 1, powers := [(19, 1), (30, 1), (48, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(12, 1), (58, 1), (65, 1)] }],
  [{ coefficient := -2, powers := [(19, 1), (24, 1), (25, 1), (55, 1), (69, 1)] }, { coefficient := 2, powers := [(19, 1), (24, 1), (26, 1), (51, 1), (69, 1)] }],
  ...
  [{ coefficient := 1, powers := [(39, 1), (61, 1)] }, { coefficient := -1, powers := [(48, 1), (53, 1), (58, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (57, 1), (58, 1), (65, 1)] }, { coefficient := 1, powers := [(2, 1), (58, 1)] }, { coefficient := 1, powers := [(8, 1), (36, 1)] }, { coefficient := -1, powers := [(18, 1), (29, 1), (58, 1), (65, 1)] }, { coefficient := 2, powers := [(19, 1), (26, 1), (28, 1), (41, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (33, 1), (58, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (30, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (33, 1), (49, 1)] }, { coefficient := 1, powers := [(12, 1), (24, 1), (26, 1), (47, 1)] }, { coefficient := -1, powers := [(12, 1), (24, 1), (52, 1), (58, 1), (65, 1)] }, { coefficient := 1, powers := [(12, 1), (25, 1), (30, 1), (49, 1), (67, 1)] }, { coefficient := -1, powers := [(12, 1), (30, 1), (49, 1)] }, { coefficient := -1, powers := [(12, 1), (36, 1), (39, 1)] }, { coefficient := -1, powers := [(18, 1), (24, 1), (44, 1), (55, 1)] }, { coefficient := 1, powers := [(18, 1), (24, 1), (53, 1), (58, 1), (65, 1)] }, { coefficient := 1, powers := [(19, 1), (20, 1), (30, 1), (48, 1), (51, 1), (67, 1)] }, { coefficient := 2, powers := [(19, 1), (23, 1), (26, 1), (41, 1), (48, 1), (51, 1)] }, { coefficient := 2, powers := [(19, 1), (25, 1), (29, 1), (48, 1), (55, 1)] }, { coefficient := -2, powers := [(19, 1), (26, 1), (29, 1), (48, 1), (51, 1)] }, { coefficient := 2, powers := [(19, 1), (26, 1), (33, 1), (37, 1), (41, 1), (48, 1)] }, { coefficient := -2, powers := [(19, 1), (28, 1), (48, 1), (55, 1)] }, { coefficient := 1, powers := [(19, 1), (30, 1), (48, 1), (51, 1)] }],
...
#print axioms Krenn.Component37.SelectedLeafB4_2_7_7.selectedHasNoCommonZero

end Krenn.Component37.SelectedLeafB4_2_7_7
