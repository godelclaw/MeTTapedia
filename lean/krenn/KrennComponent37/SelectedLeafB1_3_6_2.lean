...
namespace Krenn.Component37.SelectedLeafB1_3_6_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "78dab0422914067d7f163de0cab801b2d9cbad2fcc0223c0e6e96db9d4b1640b"
def certificateSHA256 : String := "71d090ffe2b409b7535f4604b3f1dc72908715d82f76955711f4d32e0aec52b7"
...
def multipliers : Fin 26 → SparsePoly (Fin 68) := ![
  ...
  [{ coefficient := 1, powers := [(2, 1), (39, 1), (51, 1), (60, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (36, 1), (51, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (55, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (26, 1)] }],
  [{ coefficient := -1, powers := [(18, 1), (49, 1)] }],
  [{ coefficient := -1, powers := [(18, 1), (55, 1)] }],
  [{ coefficient := -1, powers := [(12, 1), (44, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (21, 1), (36, 1), (46, 1)] }, { coefficient := 1, powers := [(8, 1), (21, 1), (36, 1), (57, 1)] }],
  ...
  [{ coefficient := -1, powers := [(2, 1), (39, 1), (46, 1), (61, 1)] }, { coefficient := 1, powers := [(2, 1), (39, 1), (47, 1), (51, 1), (60, 1)] }, { coefficient := -1, powers := [(8, 1), (21, 1), (36, 1), (46, 2), (51, 1)] }, { coefficient := -1, powers := [(8, 1), (21, 1), (36, 1), (46, 1), (51, 1), (57, 1)] }, { coefficient := 1, powers := [(8, 1), (21, 1), (36, 1), (46, 1), (53, 1)] }, { coefficient := -1, powers := [(8, 1), (36, 1), (42, 1), (57, 1)] }, { coefficient := 1, powers := [(8, 1), (36, 1), (48, 1), (51, 1), (57, 1)] }, { coefficient := -1, powers := [(8, 1), (36, 1), (48, 1), (53, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (42, 1)] }, { coefficient := 1, powers := [(5, 1), (33, 1)] }, { coefficient := -1, powers := [(12, 1), (24, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (39, 1), (41, 1), (61, 1)] }, { coefficient := -1, powers := [(2, 1), (39, 1), (46, 1), (61, 1)] }, { coefficient := 1, powers := [(2, 1), (39, 1), (47, 1), (51, 1), (60, 1)] }, { coefficient := -1, powers := [(8, 1), (21, 1), (36, 1), (46, 2), (51, 1)] }, { coefficient := -1, powers := [(8, 1), (21, 1), (36, 1), (46, 1), (51, 1), (57, 1)] }, { coefficient := 1, powers := [(8, 1), (36, 1), (42, 1), (57, 1)] }, { coefficient := 1, powers := [(8, 1), (36, 1), (48, 1), (51, 1), (57, 1)] }, { coefficient := -1, powers := [(18, 1), (24, 1), (26, 1), (47, 1), (53, 1)] }, { coefficient := 2, powers := [(18, 1), (24, 1), (47, 1), (55, 1)] }, { coefficient := -1, powers := [(19, 1), (24, 1), (26, 1), (41, 1), (53, 1)] }, { coefficient := 2, powers := [(19, 1), (24, 1), (41, 1), (55, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (39, 1), (44, 1), (51, 1), (60, 1)] }, { coefficient := 1, powers := [(2, 1), (49, 1), (55, 1)] }, { coefficient := 1, powers := [(8, 1), (36, 1), (48, 1), (51, 1)] }, { coefficient := -1, powers := [(18, 1), (24, 1), (44, 1), (55, 1)] }],
...
#print axioms Krenn.Component37.SelectedLeafB1_3_6_2.selectedHasNoCommonZero

end Krenn.Component37.SelectedLeafB1_3_6_2
