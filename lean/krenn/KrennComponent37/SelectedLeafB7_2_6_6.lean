...
namespace Krenn.Component37.SelectedLeafB7_2_6_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "ca3846e9db8432262f8d43f9ac4b483848b8a1e9830a1eb179a3a31826f62f1b"
...
def multipliers : Fin 20 → SparsePoly (Fin 70) := ![
  ...
  [{ coefficient := -1, powers := [(8, 1), (23, 1), (24, 1), (61, 1), (64, 1), (69, 1)] }, { coefficient := -1, powers := [(8, 1), (24, 1), (28, 1), (61, 1), (64, 1), (69, 1)] }, { coefficient := -1, powers := [(23, 1), (39, 1), (61, 1), (69, 1)] }, { coefficient := -1, powers := [(24, 1), (26, 1), (37, 1), (41, 1), (61, 1), (69, 1)] }, { coefficient := -1, powers := [(24, 1), (26, 1), (37, 1), (46, 1), (61, 1), (69, 1)] }, { coefficient := -1, powers := [(24, 1), (37, 1), (54, 1), (61, 1), (69, 1)] }, { coefficient := -1, powers := [(28, 1), (39, 1), (61, 1), (69, 1)] }],
  [{ coefficient := 1, powers := [(1, 1), (8, 1), (24, 1), (51, 1), (60, 1), (63, 1), (69, 1)] }],
...
#print axioms Krenn.Component37.SelectedLeafB7_2_6_6.selectedHasNoCommonZero

end Krenn.Component37.SelectedLeafB7_2_6_6
