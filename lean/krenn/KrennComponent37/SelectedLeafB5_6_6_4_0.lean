...
namespace Krenn.Component37.SelectedLeafB5_6_6_4_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "c1ee18f8b4d3bd7e4333818d086cb03524dd78baae796cd262b7642f6a6eef2d"
def certificateSHA256 : String := "90299cefbb8ca337287e1c3d2ab555aa21503c408f09329d05942680aeea0342"
...
def multipliers : Fin 17 → SparsePoly (Fin 69) := ![
  ...
  [{ coefficient := -1, powers := [(18, 1), (23, 1), (49, 1), (55, 1)] }, { coefficient := -1, powers := [(18, 1), (24, 1), (44, 1), (55, 1)] }, { coefficient := -1, powers := [(18, 1), (28, 1), (49, 1), (55, 1)] }, { coefficient := 1, powers := [(19, 1), (24, 1), (55, 1)] }],
...
#print axioms Krenn.Component37.SelectedLeafB5_6_6_4_0.selectedHasNoCommonZero

end Krenn.Component37.SelectedLeafB5_6_6_4_0
