...
namespace Krenn.Component37.SelectedLeafB7_3_2_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "6bc9cb16cbfe5d378d30028e392692eb99d4f3b728921b83240ef4a35aa6a8df"
def certificateSHA256 : String := "5f2513573c3414099cab3ad6824e672cb37d72c124e2bff104554c0f27834bfa"
...
def multipliers : Fin 24 → SparsePoly (Fin 69) := ![
  ...
  [{ coefficient := -1, powers := [(2, 1), (42, 1), (47, 1), (63, 1), (65, 1)] }, { coefficient := -1, powers := [(19, 1), (29, 1), (42, 1), (63, 1), (65, 1)] }],
  ...
  [{ coefficient := 1, powers := [(30, 1), (42, 1), (52, 1), (65, 1)] }, { coefficient := 1, powers := [(33, 1), (39, 1)] }],
  ...
  [{ coefficient := -1, powers := [(2, 1), (20, 1), (49, 1), (55, 1), (62, 1)] }, { coefficient := 1, powers := [(2, 1), (21, 1), (44, 1), (55, 1), (62, 1)] }, { coefficient := 1, powers := [(2, 1), (42, 1), (47, 1), (54, 1), (65, 1)] }, { coefficient := -1, powers := [(2, 1), (49, 1), (55, 1)] }, { coefficient := -1, powers := [(5, 1), (36, 1), (55, 1)] }, { coefficient := -1, powers := [(8, 1), (33, 1), (49, 1)] }, { coefficient := -1, powers := [(12, 1), (30, 1), (44, 1), (48, 1)] }, { coefficient := 1, powers := [(12, 1), (30, 1), (49, 1)] }, { coefficient := 1, powers := [(19, 1), (21, 1), (30, 1), (53, 1)] }, { coefficient := -1, powers := [(19, 1), (24, 1), (26, 1), (53, 1)] }, { coefficient := 1, powers := [(19, 1), (29, 1), (42, 1), (54, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (36, 1), (42, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (2, 1), (42, 1), (62, 1)] }, { coefficient := 1, powers := [(2, 1), (20, 1), (42, 1), (62, 1)] }, { coefficient := -1, powers := [(2, 1), (21, 1), (51, 1), (62, 1)] }, { coefficient := -1, powers := [(2, 1), (41, 1), (42, 1), (65, 1)] }, { coefficient := 1, powers := [(2, 1), (42, 1)] }, { coefficient := 1, powers := [(5, 1), (33, 1)] }, { coefficient := -1, powers := [(12, 1), (24, 1)] }, { coefficient := -1, powers := [(18, 1), (29, 1), (42, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (42, 1), (44, 1), (54, 1), (62, 1)] }, { coefficient := -1, powers := [(18, 1), (30, 1), (42, 1), (47, 1), (52, 1), (65, 1)] }, { coefficient := -1, powers := [(18, 1), (33, 1), (39, 1), (47, 1)] }, { coefficient := -1, powers := [(19, 1), (30, 1), (41, 1), (42, 1), (52, 1), (65, 1)] }, { coefficient := -1, powers := [(19, 1), (33, 1), (39, 1), (41, 1)] }],
...
#print axioms Krenn.Component37.SelectedLeafB7_3_2_1.selectedHasNoCommonZero

end Krenn.Component37.SelectedLeafB7_3_2_1
