...
namespace Krenn.Component37.SelectedLeafB1_3_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "ba9c6b8f61904fa213ca09c113495239af7e2d0f73ba8f8f8c7dfafedacca05d"
def certificateSHA256 : String := "4243837bd399578343a10535b320cb9c598bbf33b7d881d638c477618b1a2032"
...
def multipliers : Fin 33 → SparsePoly (Fin 67) := ![
  ...
  [{ coefficient := 1, powers := [(7, 1), (13, 1), (31, 1), (37, 1), (51, 1), (60, 1), (64, 1)] }, { coefficient := -1, powers := [(7, 1), (31, 1), (37, 1), (43, 1), (51, 1), (60, 1), (64, 1)] }, { coefficient := -1, powers := [(10, 1), (13, 1), (31, 1), (37, 1), (41, 1), (51, 1), (64, 1)] }, { coefficient := -1, powers := [(10, 1), (13, 1), (31, 1), (37, 1), (51, 1), (52, 1), (64, 1)] }, { coefficient := 1, powers := [(10, 1), (31, 1), (37, 1), (41, 1), (43, 1), (51, 1), (64, 1)] }, { coefficient := 1, powers := [(10, 1), (31, 1), (37, 1), (43, 1), (51, 1), (52, 1), (64, 1)] }, { coefficient := -1, powers := [(11, 1), (13, 1), (31, 1), (37, 1), (41, 1), (64, 1)] }, { coefficient := 1, powers := [(11, 1), (31, 1), (37, 1), (41, 1), (43, 1), (64, 1)] }, { coefficient := 1, powers := [(13, 1), (15, 1), (31, 1), (37, 1), (41, 1), (51, 1), (64, 1)] }, { coefficient := 1, powers := [(13, 1), (15, 1), (31, 1), (37, 1), (51, 1), (52, 1), (64, 1)] }, { coefficient := -1, powers := [(15, 1), (31, 1), (37, 1), (41, 1), (43, 1), (51, 1), (64, 1)] }, { coefficient := -1, powers := [(15, 1), (31, 1), (37, 1), (43, 1), (51, 1), (52, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(20, 1), (47, 1), (56, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(26, 1), (56, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(7, 1), (13, 1), (31, 1), (37, 1), (60, 1), (64, 1)] }, { coefficient := 1, powers := [(7, 1), (31, 1), (37, 1), (43, 1), (60, 1), (64, 1)] }, { coefficient := 1, powers := [(10, 1), (13, 1), (31, 1), (37, 1), (41, 1), (64, 1)] }, { coefficient := 1, powers := [(10, 1), (13, 1), (31, 1), (37, 1), (52, 1), (64, 1)] }, { coefficient := -1, powers := [(10, 1), (31, 1), (37, 1), (41, 1), (43, 1), (64, 1)] }, { coefficient := -1, powers := [(10, 1), (31, 1), (37, 1), (43, 1), (52, 1), (64, 1)] }, { coefficient := -1, powers := [(13, 1), (15, 1), (31, 1), (37, 1), (41, 1), (64, 1)] }, { coefficient := -1, powers := [(13, 1), (15, 1), (31, 1), (37, 1), (52, 1), (64, 1)] }, { coefficient := 1, powers := [(15, 1), (31, 1), (37, 1), (41, 1), (43, 1), (64, 1)] }, { coefficient := 1, powers := [(15, 1), (31, 1), (37, 1), (43, 1), (52, 1), (64, 1)] }],
  ...
  [{ coefficient := 1, powers := [(13, 1), (31, 1), (37, 1), (41, 1), (64, 1)] }, { coefficient := -1, powers := [(31, 1), (37, 1), (41, 1), (43, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(50, 1)] }],
  [{ coefficient := 1, powers := [(43, 1)] }],
  [{ coefficient := 1, powers := [(13, 1), (27, 1), (31, 1), (37, 1)] }, { coefficient := -1, powers := [(27, 1), (31, 1), (37, 1), (43, 1)] }],
  [{ coefficient := -1, powers := [(10, 1), (13, 1), (27, 1), (31, 1), (37, 1)] }, { coefficient := 1, powers := [(10, 1), (27, 1), (31, 1), (37, 1), (43, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := -1, powers := [(13, 1), (31, 1), (37, 1)] }, { coefficient := 1, powers := [(31, 1), (37, 1), (43, 1)] }],
  [{ coefficient := 1, powers := [(10, 1), (13, 1), (27, 1), (31, 1), (37, 1), (38, 1), (60, 1)] }, { coefficient := 1, powers := [(10, 1), (13, 1), (27, 1), (31, 1), (37, 1), (41, 1), (57, 1)] }, { coefficient := 1, powers := [(10, 1), (13, 1), (27, 1), (31, 1), (37, 1), (46, 1), (52, 1)] }, { coefficient := -1, powers := [(10, 1), (27, 1), (31, 1), (37, 1), (38, 1), (43, 1), (60, 1)] }, { coefficient := -1, powers := [(10, 1), (27, 1), (31, 1), (37, 1), (41, 1), (43, 1), (57, 1)] }, { coefficient := -1, powers := [(10, 1), (27, 1), (31, 1), (37, 1), (43, 1), (46, 1), (52, 1)] }, { coefficient := 1, powers := [(37, 1), (59, 1)] }, { coefficient := -1, powers := [(43, 1), (50, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (31, 1), (37, 1), (41, 1), (42, 1), (57, 1), (64, 1)] }, { coefficient := -1, powers := [(13, 1), (31, 1), (37, 1), (41, 1), (48, 1), (53, 1), (64, 1)] }, { coefficient := 1, powers := [(13, 1), (31, 1), (37, 1), (41, 1), (57, 1)] }, { coefficient := -1, powers := [(13, 1), (31, 1), (37, 1), (46, 1), (52, 1)] }, { coefficient := -1, powers := [(13, 1), (31, 1), (38, 1)] }, { coefficient := 1, powers := [(31, 1), (37, 1), (41, 1), (42, 1), (43, 1), (57, 1), (64, 1)] }, { coefficient := 1, powers := [(31, 1), (37, 1), (41, 1), (43, 1), (48, 1), (53, 1), (64, 1)] }, { coefficient := -1, powers := [(31, 1), (37, 1), (41, 1), (43, 1), (57, 1)] }, { coefficient := 1, powers := [(31, 1), (37, 1), (43, 1), (46, 1), (52, 1)] }, { coefficient := 1, powers := [(31, 1), (38, 1), (43, 1)] }],
  ...
  [{ coefficient := -1, powers := [(0, 1), (20, 1), (56, 1), (57, 1)] }, { coefficient := 1, powers := [(0, 1), (25, 1), (43, 1), (57, 1)] }, { coefficient := -1, powers := [(0, 1), (34, 1), (37, 1), (57, 1)] }, { coefficient := -1, powers := [(0, 1), (56, 1), (58, 1), (66, 1)] }, { coefficient := 1, powers := [(0, 1), (56, 1)] }, { coefficient := 1, powers := [(6, 1), (34, 1)] }, { coefficient := 1, powers := [(18, 1), (20, 1), (28, 1), (43, 1), (62, 1)] }, { coefficient := 1, powers := [(18, 1), (20, 1), (28, 1), (56, 1), (62, 1)] }, { coefficient := 1, powers := [(18, 1), (25, 1), (28, 1), (43, 1), (62, 1)] }, { coefficient := 1, powers := [(18, 1), (28, 1), (34, 1), (37, 1), (62, 1)] }, { coefficient := -1, powers := [(20, 1), (26, 1), (47, 1), (56, 1), (66, 1)] }, { coefficient := -1, powers := [(20, 1), (56, 1)] }, { coefficient := -1, powers := [(34, 1), (37, 1)] }],
  [{ coefficient := 1, powers := [(7, 1), (13, 1), (27, 1), (31, 1), (37, 1), (60, 1)] }, { coefficient := -1, powers := [(7, 1), (13, 1), (31, 1), (35, 1), (37, 1), (41, 1)] }, { coefficient := -1, powers := [(7, 1), (27, 1), (31, 1), (37, 1), (43, 1), (60, 1)] }, { coefficient := 1, powers := [(7, 1), (31, 1), (35, 1), (37, 1), (41, 1), (43, 1)] }, { coefficient := -1, powers := [(10, 1), (13, 1), (27, 1), (31, 1), (37, 1), (41, 1)] }, { coefficient := -1, powers := [(10, 1), (13, 1), (27, 1), (31, 1), (37, 1), (52, 1)] }, { coefficient := 1, powers := [(10, 1), (27, 1), (31, 1), (37, 1), (41, 1), (43, 1)] }, { coefficient := 1, powers := [(10, 1), (27, 1), (31, 1), (37, 1), (43, 1), (52, 1)] }, { coefficient := 1, powers := [(13, 1), (15, 1), (27, 1), (31, 1), (37, 1), (52, 1)] }, { coefficient := -1, powers := [(15, 1), (27, 1), (31, 1), (37, 1), (43, 1), (52, 1)] }],
  [{ coefficient := -1, powers := [(3, 1), (20, 1), (31, 1), (56, 1)] }, { coefficient := 1, powers := [(3, 1), (25, 1), (31, 1), (43, 1)] }, { coefficient := -1, powers := [(3, 1), (31, 1), (34, 1), (37, 1)] }, { coefficient := 1, powers := [(4, 1), (13, 1), (31, 1), (32, 1), (37, 1)] }, { coefficient := -1, powers := [(4, 1), (31, 1), (32, 1), (37, 1), (43, 1)] }, { coefficient := -1, powers := [(6, 1), (20, 1), (26, 1), (44, 1), (59, 1), (66, 1)] }, { coefficient := -1, powers := [(9, 1), (20, 2), (56, 1)] }, { coefficient := 1, powers := [(9, 1), (20, 1), (25, 1), (43, 1)] }, { coefficient := -1, powers := [(9, 1), (20, 1), (34, 1), (37, 1)] }, { coefficient := 1, powers := [(10, 1), (13, 1), (22, 1), (31, 1), (37, 1)] }, { coefficient := -1, powers := [(10, 1), (22, 1), (31, 1), (37, 1), (43, 1)] }],
...
#print axioms Krenn.Component37.SelectedLeafB1_3_5.selectedHasNoCommonZero

end Krenn.Component37.SelectedLeafB1_3_5
