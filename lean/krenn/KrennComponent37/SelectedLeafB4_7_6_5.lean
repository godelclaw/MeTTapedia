...
namespace Krenn.Component37.SelectedLeafB4_7_6_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "df9f9383ff00a397731223c1a03ff3a96e715ff15c1e3e3583293b402753c4f9"
def certificateSHA256 : String := "70a0e6805a2c915062c35205bf1acd12fc7ae1c96f92e7f74410e895d5b02ec2"
...
def multipliers : Fin 21 → SparsePoly (Fin 70) := ![
  [{ coefficient := -1, powers := [(12, 1), (28, 1), (54, 1), (63, 1)] }, { coefficient := 2, powers := [(12, 1), (30, 1), (63, 1)] }],
  ...
  [{ coefficient := -2, powers := [(12, 1), (30, 1), (49, 1), (63, 1), (69, 1)] }],
  [{ coefficient := -1, powers := [(12, 1), (24, 1), (54, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (26, 1)] }],
  [{ coefficient := -1, powers := [(18, 1), (49, 1)] }],
  [{ coefficient := 1, powers := [(9, 1), (12, 1), (54, 1), (63, 1)] }, { coefficient := -1, powers := [(18, 1), (55, 1)] }],
  ...
  [{ coefficient := 1, powers := [(12, 1), (24, 1), (44, 1), (54, 1)] }, { coefficient := 2, powers := [(12, 1), (30, 1), (49, 1)] }, { coefficient := -1, powers := [(18, 1), (24, 1), (44, 1), (55, 1)] }, { coefficient := -1, powers := [(18, 1), (30, 1), (49, 1), (51, 1)] }, { coefficient := 1, powers := [(19, 1), (21, 1), (30, 1), (53, 1)] }, { coefficient := -1, powers := [(19, 1), (24, 1), (26, 1), (53, 1)] }, { coefficient := 1, powers := [(19, 1), (24, 1), (55, 1)] }, { coefficient := 1, powers := [(19, 1), (29, 1), (42, 1), (54, 1), (64, 1)] }, { coefficient := -1, powers := [(19, 1), (30, 1), (42, 1), (52, 1), (64, 1)] }, { coefficient := -1, powers := [(19, 1), (33, 1), (39, 1)] }],
...
#print axioms Krenn.Component37.SelectedLeafB4_7_6_5.selectedHasNoCommonZero

end Krenn.Component37.SelectedLeafB4_7_6_5
