...
namespace Krenn.Component37.SelectedLeafB5_3_6_4_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "68afc631028c94a9fb42fc05f774123cfffc6e1cd8fc40c3daf480d843b2a6a2"
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedEquations : Fin 38 → SparsePoly (Fin 72) := ![
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def multipliers : Fin 38 → SparsePoly (Fin 72) := ![
  ...
  [{ coefficient := 1, powers := [(10, 1), (19, 1), (36, 1), (42, 1), (52, 1), (71, 1)] }],
  [{ coefficient := 1, powers := [(24, 1), (45, 1), (61, 1), (69, 1)] }],
  [{ coefficient := 1, powers := [(24, 1), (26, 1), (44, 1), (46, 1), (68, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (44, 1), (46, 1)] }, { coefficient := -1, powers := [(24, 1), (47, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (26, 1), (44, 1), (46, 1), (51, 1), (62, 1)] }, { coefficient := -1, powers := [(24, 1), (26, 1), (44, 1), (46, 1), (51, 1), (68, 1)] }, { coefficient := 1, powers := [(24, 1), (44, 1), (46, 1), (55, 1)] }, { coefficient := -1, powers := [(24, 1), (44, 1), (55, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(18, 1), (49, 1)] }],
  [{ coefficient := -1, powers := [(12, 1), (44, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (61, 1), (69, 1)] }],
  ...
  [{ coefficient := 1, powers := [(61, 1), (69, 1)] }],
  [{ coefficient := -1, powers := [(10, 1), (36, 1), (42, 1), (52, 1), (71, 1)] }],
  ...
  [{ coefficient := -1, powers := [(18, 1), (24, 1), (26, 1), (45, 1), (61, 1), (69, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (42, 1)] }, { coefficient := 1, powers := [(5, 1), (33, 1)] }, { coefficient := 1, powers := [(10, 1), (12, 1), (22, 1), (36, 1), (42, 1), (52, 1), (71, 1)] }, { coefficient := -1, powers := [(12, 1), (24, 1)] }, { coefficient := 1, powers := [(18, 1), (24, 1), (51, 1)] }],
  ...
  [{ coefficient := -1, powers := [(5, 1), (59, 1), (61, 1), (69, 1)] }, { coefficient := 1, powers := [(5, 1), (61, 1)] }, { coefficient := 1, powers := [(12, 1), (44, 1), (48, 1)] }, { coefficient := -1, powers := [(12, 1), (49, 1)] }, { coefficient := 1, powers := [(18, 1), (49, 1), (51, 1)] }, { coefficient := -1, powers := [(19, 1), (48, 1), (51, 1)] }],
...
#print axioms Krenn.Component37.SelectedLeafB5_3_6_4_7.selectedHasNoCommonZero

end Krenn.Component37.SelectedLeafB5_3_6_4_7
