...
namespace Krenn.Component37.SelectedLeafB5_7_2_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "dadb10805c639c5048d04667f4c33c0801602d9c3847fc6c6e057af2545b9c6f"
...
def multipliers : Fin 4 → SparsePoly (Fin 70) := ![
  [{ coefficient := -1, powers := [(51, 1), (66, 1), (68, 1)] }],
  [{ coefficient := 1, powers := [(66, 1), (68, 1)] }],
  [{ coefficient := -1, powers := [(27, 1), (68, 1)] }],
...
#print axioms Krenn.Component37.SelectedLeafB5_7_2_3.selectedHasNoCommonZero

end Krenn.Component37.SelectedLeafB5_7_2_3
