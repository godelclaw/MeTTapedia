...
namespace Krenn.Component37.SelectedLeafB5_0_2_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "ddcfecb66a292b6058e6949d1ab7fde2df8fac7103adff5f1f593b6b4747835f"
...
def multipliers : Fin 22 → SparsePoly (Fin 67) := ![
  [{ coefficient := -1, powers := [(23, 1), (39, 1), (61, 1), (66, 1)] }, { coefficient := -1, powers := [(24, 1), (25, 1), (26, 1), (47, 1), (53, 1), (66, 1)] }, { coefficient := 2, powers := [(24, 1), (25, 1), (47, 1), (55, 1), (66, 1)] }, { coefficient := -1, powers := [(24, 1), (26, 1), (37, 1), (46, 1), (61, 1), (66, 1)] }, { coefficient := -1, powers := [(24, 1), (37, 1), (54, 1), (61, 1), (66, 1)] }, { coefficient := 1, powers := [(24, 1), (44, 1), (55, 1), (66, 1)] }, { coefficient := -1, powers := [(28, 1), (39, 1), (61, 1), (66, 1)] }],
...
#print axioms Krenn.Component37.SelectedLeafB5_0_2_6.selectedHasNoCommonZero

end Krenn.Component37.SelectedLeafB5_0_2_6
