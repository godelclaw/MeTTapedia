...
namespace Krenn.Component37.SelectedLeafB5_2_2_4_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "5e8f078b3ff80f63e2ed31f9539420dcbf4af1eefe92258c0f0e94e6ea98ea43"
...
def multipliers : Fin 27 → SparsePoly (Fin 70) := ![
  [{ coefficient := 1, powers := [(36, 1), (55, 1), (67, 1)] }],
  [{ coefficient := 1, powers := [(24, 1), (45, 1), (61, 1), (67, 1)] }],
  [{ coefficient := 1, powers := [(24, 1), (26, 1), (44, 1), (46, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (44, 1), (46, 1)] }, { coefficient := -1, powers := [(24, 1), (47, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (26, 1), (44, 1), (46, 1), (51, 1), (62, 1)] }, { coefficient := -1, powers := [(24, 1), (26, 1), (44, 1), (46, 1), (51, 1), (66, 1)] }, { coefficient := 1, powers := [(24, 1), (44, 1), (46, 1), (55, 1)] }, { coefficient := -1, powers := [(24, 1), (44, 1), (55, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(18, 1), (49, 1)] }],
  [{ coefficient := -1, powers := [(12, 1), (44, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (61, 1), (67, 1)] }],
  ...
  [{ coefficient := 1, powers := [(61, 1), (67, 1)] }],
  ...
  [{ coefficient := -1, powers := [(18, 1), (24, 1), (26, 1), (45, 1), (61, 1), (67, 1)] }],
  ...
  [{ coefficient := -1, powers := [(5, 1), (59, 1), (61, 1), (67, 1)] }, { coefficient := 1, powers := [(5, 1), (61, 1)] }, { coefficient := 1, powers := [(12, 1), (44, 1), (48, 1)] }, { coefficient := -1, powers := [(12, 1), (49, 1)] }, { coefficient := 1, powers := [(18, 1), (49, 1), (51, 1)] }, { coefficient := -1, powers := [(19, 1), (48, 1), (51, 1)] }],
...
#print axioms Krenn.Component37.SelectedLeafB5_2_2_4_7.selectedHasNoCommonZero

end Krenn.Component37.SelectedLeafB5_2_2_4_7
