...
namespace Krenn.Component37.SelectedLeafB4_7_2_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "1fb21a1674dc99f9415e5c97aca6ad08eff8b3db665c52aeb060c2ad0dd36628"
def certificateSHA256 : String := "719f96dea7aaeea8a76f69402cdcee9e0f47c6192086857165884fb95de392cc"
...
def multipliers : Fin 19 → SparsePoly (Fin 69) := ![
  ...
  [{ coefficient := -1, powers := [(18, 1), (24, 1), (44, 1), (55, 1)] }, { coefficient := -1, powers := [(19, 1), (24, 1), (26, 1), (53, 1)] }, { coefficient := 2, powers := [(19, 1), (24, 1), (55, 1)] }],
  ...
  [{ coefficient := 1, powers := [(5, 1), (61, 1)] }, { coefficient := 1, powers := [(12, 1), (44, 1), (48, 1)] }, { coefficient := -1, powers := [(12, 1), (49, 1)] }, { coefficient := -1, powers := [(18, 1), (42, 1), (47, 1), (64, 1)] }, { coefficient := 1, powers := [(18, 1), (49, 1), (51, 1)] }, { coefficient := 1, powers := [(19, 1), (42, 1), (46, 1), (64, 1)] }, { coefficient := -1, powers := [(19, 1), (48, 1), (51, 1)] }]
]
...
#print axioms Krenn.Component37.SelectedLeafB4_7_2_6.selectedHasNoCommonZero

end Krenn.Component37.SelectedLeafB4_7_2_6
