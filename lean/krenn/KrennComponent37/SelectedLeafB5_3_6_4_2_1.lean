...
namespace Krenn.Component37.SelectedLeafB5_3_6_4_2_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "8759e7604336b623a0193433f7e8b943453cc0554634f66e77df2170d5acf5c1"
...
def selectedEquations : Fin 12 → SparsePoly (Fin 71) := ![
  ...
  [{ coefficient := 1, powers := [(5, 1), (70, 1)] }, { coefficient := -1, powers := [] }]
]

set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def multipliers : Fin 12 → SparsePoly (Fin 71) := ![
  [{ coefficient := 1, powers := [(7, 1), (41, 1), (70, 1)] }, { coefficient := 1, powers := [(10, 1), (38, 1), (70, 1)] }, { coefficient := -1, powers := [(15, 1), (38, 1), (70, 1)] }],
...
#print axioms Krenn.Component37.SelectedLeafB5_3_6_4_2_1.selectedHasNoCommonZero

end Krenn.Component37.SelectedLeafB5_3_6_4_2_1
