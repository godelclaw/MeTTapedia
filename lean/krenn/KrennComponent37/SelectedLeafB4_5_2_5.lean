...
namespace Krenn.Component37.SelectedLeafB4_5_2_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "df8a8c01bc18265a31061e41aa8f5e663c9e238a8d12518434ee3032433fcf90"
...
def multipliers : Fin 7 → SparsePoly (Fin 68) := ![
  ...
  [{ coefficient := -1, powers := [(51, 1), (64, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(64, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(21, 1), (51, 1), (64, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(21, 1), (25, 1), (51, 1), (64, 1), (66, 1)] }],
...
#print axioms Krenn.Component37.SelectedLeafB4_5_2_5.selectedHasNoCommonZero

end Krenn.Component37.SelectedLeafB4_5_2_5
