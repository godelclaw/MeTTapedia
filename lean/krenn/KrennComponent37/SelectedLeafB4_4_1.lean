...
namespace Krenn.Component37.SelectedLeafB4_4_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "a7ee3d84cefb5ce4e7629d016f8a63dc72342bf54334c333149fd26d284dff8f"
...
def multipliers : Fin 8 → SparsePoly (Fin 65) := ![
  [{ coefficient := 1, powers := [(44, 1), (63, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(26, 1), (63, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(63, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(26, 1), (44, 1), (63, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(63, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := -1, powers := [(0, 1), (40, 1), (63, 1)] }, { coefficient := -1, powers := [(3, 1), (31, 1), (63, 1)] }, { coefficient := -1, powers := [(9, 1), (20, 1), (63, 1)] }, { coefficient := 1, powers := [(9, 1), (26, 1), (44, 1), (63, 1), (64, 1)] }],
...
#print axioms Krenn.Component37.SelectedLeafB4_4_1.selectedHasNoCommonZero

end Krenn.Component37.SelectedLeafB4_4_1
