...
namespace Krenn.Component37.SelectedLeafB4_1_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "9b140ca1ea9ad6cba04f527414268e0a02478f39df1695d0a47a61733b3991a2"
...
def multipliers : Fin 21 → SparsePoly (Fin 65) := ![
  [{ coefficient := -1, powers := [(7, 1), (44, 1), (60, 1), (64, 1)] }, { coefficient := 1, powers := [(10, 1), (44, 1), (52, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(7, 1), (51, 1), (60, 1), (63, 1)] }, { coefficient := 2, powers := [(10, 1), (46, 1), (51, 1), (63, 1)] }, { coefficient := 1, powers := [(15, 1), (51, 1), (52, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(32, 1), (38, 1), (47, 1), (54, 1), (64, 1)] }, { coefficient := 1, powers := [(32, 1), (38, 1), (48, 1), (53, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(32, 1), (38, 1), (47, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(7, 1), (60, 1), (63, 1)] }, { coefficient := -2, powers := [(10, 1), (46, 1), (63, 1)] }, { coefficient := -1, powers := [(15, 1), (52, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(32, 1), (38, 1), (53, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(7, 1), (60, 1), (64, 1)] }, { coefficient := -1, powers := [(10, 1), (52, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(52, 1)] }],
  [{ coefficient := 1, powers := [(46, 1)] }],
  [{ coefficient := 1, powers := [(32, 1), (38, 1), (54, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(32, 1), (38, 1), (48, 1), (63, 1)] }],
  ...
  [{ coefficient := 1, powers := [(1, 1), (57, 1)] }, { coefficient := 1, powers := [(7, 1), (35, 1)] }, { coefficient := -1, powers := [(10, 1), (27, 1)] }, { coefficient := -1, powers := [(16, 1), (25, 1), (32, 1), (38, 1), (54, 1), (64, 1)] }, { coefficient := 1, powers := [(16, 1), (26, 1), (32, 1), (38, 1), (64, 1)] }],
  ...
  [{ coefficient := 1, powers := [(4, 1), (32, 1)] }, { coefficient := -1, powers := [(10, 1), (27, 1)] }, { coefficient := 1, powers := [(11, 1), (20, 1), (32, 1), (38, 1), (48, 1), (63, 1)] }, { coefficient := -1, powers := [(11, 1), (21, 1), (32, 1), (38, 1), (63, 1)] }],
...
#print axioms Krenn.Component37.SelectedLeafB4_1_1.selectedHasNoCommonZero

end Krenn.Component37.SelectedLeafB4_1_1
