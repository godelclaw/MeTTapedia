...
namespace Krenn.Component37.SelectedLeafB5_4_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "1550c9a076cb53ed9eb18bf10db85b879cb47be021bf049926d96e46b6adfb84"
...
def multipliers : Fin 8 → SparsePoly (Fin 67) := ![
  [{ coefficient := 1, powers := [(44, 1), (64, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(26, 1), (64, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(64, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(26, 1), (44, 1), (64, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(64, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := -1, powers := [(0, 1), (40, 1), (64, 1)] }, { coefficient := -1, powers := [(3, 1), (31, 1), (64, 1)] }, { coefficient := -1, powers := [(9, 1), (20, 1), (64, 1)] }, { coefficient := 1, powers := [(9, 1), (26, 1), (44, 1), (64, 1), (66, 1)] }],
...
#print axioms Krenn.Component37.SelectedLeafB5_4_5.selectedHasNoCommonZero

end Krenn.Component37.SelectedLeafB5_4_5
