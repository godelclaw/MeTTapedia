...
namespace Krenn.Component37.SelectedLeafB7_2_6_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "48839169fa3a2a9570fab447fbec36fb81ae6b55c5b047ceaeeb18b33064af80"
...
def multipliers : Fin 17 → SparsePoly (Fin 71) := ![
  ...
  [{ coefficient := -1, powers := [(31, 1), (37, 1), (69, 1)] }],
  ...
  [{ coefficient := -1, powers := [(0, 1), (37, 1), (59, 1)] }, { coefficient := 1, powers := [(0, 1), (43, 1), (50, 1)] }, { coefficient := 1, powers := [(6, 1), (20, 1), (23, 1), (54, 1), (59, 1), (70, 1)] }, { coefficient := 1, powers := [(13, 1), (23, 1), (31, 1), (37, 1), (54, 1), (70, 1)] }, { coefficient := 1, powers := [(20, 1), (43, 1), (50, 1)] }, { coefficient := 1, powers := [(20, 1), (50, 1), (56, 1)] }, { coefficient := 1, powers := [(25, 1), (43, 1), (50, 1)] }, { coefficient := 1, powers := [(34, 1), (37, 1), (50, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (1, 1), (56, 1), (63, 1)] }, { coefficient := 1, powers := [(0, 1), (13, 1), (37, 1), (57, 1), (60, 1), (67, 1)] }, { coefficient := -1, powers := [(0, 1), (56, 1), (57, 1), (67, 1)] }, { coefficient := 1, powers := [(0, 1), (56, 1)] }, { coefficient := 1, powers := [(6, 1), (13, 1), (20, 1), (60, 1)] }, { coefficient := -1, powers := [(6, 1), (20, 1), (27, 1), (43, 1), (60, 1), (69, 1)] }, { coefficient := 1, powers := [(6, 1), (34, 1)] }, { coefficient := -1, powers := [(13, 1), (20, 1), (27, 1), (37, 1), (57, 1), (60, 1), (67, 1), (69, 1)] }, { coefficient := -1, powers := [(13, 1), (27, 1), (37, 1), (60, 1), (67, 1), (69, 1)] }, { coefficient := 1, powers := [(13, 1), (37, 1), (60, 1), (67, 1)] }, { coefficient := 1, powers := [(20, 1), (27, 1), (56, 1), (57, 1), (67, 1), (69, 1)] }, { coefficient := -1, powers := [(20, 1), (27, 1), (56, 1), (69, 1)] }, { coefficient := 1, powers := [(25, 1), (27, 1), (43, 1), (69, 1)] }, { coefficient := -1, powers := [(25, 1), (43, 1)] }, { coefficient := -1, powers := [(27, 1), (34, 1), (37, 1), (69, 1)] }, { coefficient := 1, powers := [(27, 1), (56, 1), (67, 1), (69, 1)] }, { coefficient := -1, powers := [(56, 1), (67, 1)] }],
  [{ coefficient := 1, powers := [(3, 1), (13, 1), (31, 1), (37, 1), (60, 1)] }, { coefficient := -1, powers := [(3, 1), (31, 1), (56, 1)] }],
  [{ coefficient := -1, powers := [(6, 1), (9, 1), (20, 1), (43, 1), (60, 1)] }, { coefficient := -1, powers := [(9, 1), (13, 1), (20, 1), (37, 1), (57, 1), (60, 1), (67, 1)] }, { coefficient := -1, powers := [(9, 1), (13, 1), (37, 1), (60, 1), (67, 1)] }, { coefficient := 1, powers := [(9, 1), (20, 1), (56, 1), (57, 1), (67, 1)] }, { coefficient := -1, powers := [(9, 1), (20, 1), (56, 1)] }, { coefficient := 1, powers := [(9, 1), (25, 1), (43, 1)] }, { coefficient := -1, powers := [(9, 1), (34, 1), (37, 1)] }, { coefficient := 1, powers := [(9, 1), (56, 1), (67, 1)] }, { coefficient := 1, powers := [(31, 1), (37, 1), (43, 1)] }],
...
#print axioms Krenn.Component37.SelectedLeafB7_2_6_7.selectedHasNoCommonZero

end Krenn.Component37.SelectedLeafB7_2_6_7
