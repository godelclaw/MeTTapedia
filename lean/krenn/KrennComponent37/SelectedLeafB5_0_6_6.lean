...
namespace Krenn.Component37.SelectedLeafB5_0_6_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "95b990598d0a504fa4ca07fdc6dfd59b47fba6dcb943563297509e6174ce4fde"
def certificateSHA256 : String := "8623f6af80d8e93dedd45f8ade024a2acdf3f0814b2b4dd0b71956448939ef9e"
...
def multipliers : Fin 22 → SparsePoly (Fin 68) := ![
  [{ coefficient := -1, powers := [(23, 1), (39, 1), (61, 1), (67, 1)] }, { coefficient := -1, powers := [(24, 1), (25, 1), (26, 1), (47, 1), (53, 1), (67, 1)] }, { coefficient := 2, powers := [(24, 1), (25, 1), (47, 1), (55, 1), (67, 1)] }, { coefficient := -1, powers := [(24, 1), (26, 1), (37, 1), (46, 1), (61, 1), (67, 1)] }, { coefficient := -1, powers := [(24, 1), (37, 1), (54, 1), (61, 1), (67, 1)] }, { coefficient := 1, powers := [(24, 1), (44, 1), (55, 1), (67, 1)] }, { coefficient := -1, powers := [(28, 1), (39, 1), (61, 1), (67, 1)] }],
  ...
  [{ coefficient := -1, powers := [(18, 1), (24, 1), (26, 1), (37, 1), (61, 1)] }, { coefficient := -1, powers := [(19, 1), (24, 1), (25, 1), (26, 1), (53, 1)] }, { coefficient := 2, powers := [(19, 1), (24, 1), (25, 1), (55, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (58, 1)] }, { coefficient := 1, powers := [(8, 1), (36, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (33, 1)] }, { coefficient := -1, powers := [(12, 1), (24, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (37, 1), (48, 1), (54, 1), (61, 1)] }, { coefficient := 1, powers := [(2, 1), (49, 1), (55, 1)] }, { coefficient := 1, powers := [(18, 1), (23, 1), (39, 1), (61, 1)] }, { coefficient := 1, powers := [(18, 1), (24, 1), (25, 1), (26, 1), (47, 1), (53, 1)] }, { coefficient := -2, powers := [(18, 1), (24, 1), (25, 1), (47, 1), (55, 1)] }, { coefficient := 1, powers := [(18, 1), (24, 1), (26, 1), (37, 1), (46, 1), (61, 1)] }, { coefficient := 1, powers := [(18, 1), (24, 1), (37, 1), (54, 1), (61, 1)] }, { coefficient := -1, powers := [(18, 1), (24, 1), (44, 1), (55, 1)] }, { coefficient := 1, powers := [(18, 1), (28, 1), (39, 1), (61, 1)] }],
...
#print axioms Krenn.Component37.SelectedLeafB5_0_6_6.selectedHasNoCommonZero

end Krenn.Component37.SelectedLeafB5_0_6_6
