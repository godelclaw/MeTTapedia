...
namespace Krenn.Component37.SelectedLeafB5_6_4_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "89272b3425cf0333fdada373beb880a829f7b886bbdbbb534c814fbebe749183"
def certificateSHA256 : String := "4d7402761b85081a7c6ed11c510be4ca99dce22fce6a9e4ebfd99122ee71e273"
...
def multipliers : Fin 36 → SparsePoly (Fin 69) := ![
  ...
  [{ coefficient := 1, powers := [(2, 1), (25, 1), (49, 1), (54, 1), (68, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (26, 1), (49, 1), (52, 1), (62, 1)] }, { coefficient := 1, powers := [(2, 1), (49, 1), (54, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (25, 1), (41, 1), (49, 1), (62, 1)] }, { coefficient := 1, powers := [(2, 1), (25, 1), (46, 1), (49, 1), (62, 1)] }, { coefficient := 1, powers := [(2, 1), (25, 1), (49, 1), (52, 1), (62, 1)] }, { coefficient := 1, powers := [(2, 1), (46, 1), (49, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (25, 1), (49, 1), (55, 1), (68, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (49, 1)] }],
  [{ coefficient := -1, powers := [(30, 1), (49, 1)] }, { coefficient := 1, powers := [(36, 1), (39, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (49, 1), (51, 1), (62, 1)] }],
  ...
  [{ coefficient := -1, powers := [(2, 1), (25, 1), (49, 1), (51, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (49, 1), (55, 1), (63, 1)] }, { coefficient := 1, powers := [(39, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (20, 1), (49, 1), (55, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (25, 1), (49, 1), (55, 1), (62, 1)] }, { coefficient := 1, powers := [(2, 1), (26, 1), (49, 1), (51, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (49, 1), (55, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(37, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := 1, powers := [(2, 1), (20, 1), (46, 1), (49, 1), (55, 1)] }, { coefficient := -1, powers := [(2, 1), (25, 1), (41, 1), (49, 1), (55, 1)] }, { coefficient := 1, powers := [(2, 1), (25, 1), (46, 1), (49, 1), (51, 1), (54, 1)] }, { coefficient := -1, powers := [(2, 1), (25, 1), (46, 1), (49, 1), (55, 1)] }, { coefficient := -1, powers := [(2, 1), (37, 1), (49, 1), (55, 1), (60, 1)] }, { coefficient := -1, powers := [(2, 1), (49, 1), (55, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (37, 1), (49, 1), (55, 1), (60, 1)] }, { coefficient := 1, powers := [(2, 1), (49, 1), (55, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (18, 1), (23, 1), (49, 1), (55, 1), (63, 1)] }, { coefficient := -1, powers := [(2, 1), (18, 1), (28, 1), (49, 1), (55, 1), (63, 1)] }, { coefficient := -1, powers := [(18, 1), (21, 1), (28, 1), (37, 1), (52, 1), (54, 1), (61, 1)] }, { coefficient := 1, powers := [(18, 1), (21, 1), (30, 1), (37, 1), (52, 1), (61, 1)] }, { coefficient := 1, powers := [(18, 1), (23, 1), (39, 1), (61, 1)] }, { coefficient := -1, powers := [(18, 1), (24, 1), (26, 1), (37, 1), (52, 1), (61, 1)] }, { coefficient := 2, powers := [(18, 1), (24, 1), (37, 1), (54, 1), (61, 1)] }, { coefficient := -1, powers := [(18, 1), (24, 1), (44, 1), (55, 1)] }, { coefficient := 1, powers := [(18, 1), (25, 1), (30, 1), (49, 1), (53, 1)] }, { coefficient := -1, powers := [(18, 1), (25, 1), (36, 1), (39, 1), (53, 1)] }, { coefficient := 1, powers := [(18, 1), (28, 1), (39, 1), (61, 1)] }, { coefficient := 1, powers := [(18, 1), (30, 1), (37, 1), (48, 1), (61, 1)] }, { coefficient := -1, powers := [(18, 1), (30, 1), (49, 1), (51, 1)] }, { coefficient := 1, powers := [(19, 1), (21, 1), (30, 1), (53, 1)] }, { coefficient := -1, powers := [(19, 1), (24, 1), (26, 1), (53, 1)] }, { coefficient := 1, powers := [(19, 1), (24, 1), (55, 1)] }, { coefficient := -1, powers := [(19, 1), (33, 1), (39, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (58, 1)] }, { coefficient := 1, powers := [(8, 1), (36, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (20, 1), (25, 1), (49, 1), (55, 1), (62, 1)] }, { coefficient := -1, powers := [(2, 1), (20, 1), (26, 1), (49, 1), (51, 1), (62, 1)] }, { coefficient := 1, powers := [(12, 1), (20, 1), (30, 1), (49, 1)] }, { coefficient := -1, powers := [(12, 1), (20, 1), (36, 1), (39, 1)] }, { coefficient := 1, powers := [(18, 1), (21, 1), (28, 1), (37, 1), (54, 1), (61, 1)] }, { coefficient := -1, powers := [(18, 1), (21, 1), (30, 1), (37, 1), (61, 1)] }, { coefficient := 1, powers := [(18, 1), (24, 1), (26, 1), (37, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (33, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (25, 1), (41, 1), (49, 1), (55, 1)] }, { coefficient := -1, powers := [(2, 1), (25, 1), (46, 1), (49, 1), (51, 1), (54, 1)] }, { coefficient := 1, powers := [(2, 1), (25, 1), (46, 1), (49, 1), (55, 1)] }]
]
...
#print axioms Krenn.Component37.SelectedLeafB5_6_4_5.selectedHasNoCommonZero

end Krenn.Component37.SelectedLeafB5_6_4_5
