...
namespace Krenn.Component37.SelectedLeafB2_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "8939ae3770701f73ab9f1dc83258bea85d390ac17ebd5768e8b1f60aa8bc2ca1"
...
def multipliers : Fin 10 → SparsePoly (Fin 64) := ![
  [{ coefficient := -1, powers := [(25, 1), (46, 1), (51, 1), (62, 1), (63, 1)] }, { coefficient := -1, powers := [(51, 1), (62, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(21, 1), (46, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(46, 1), (51, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(21, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(21, 1), (46, 1), (51, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(63, 1)] }],
  [{ coefficient := 1, powers := [(21, 1), (46, 1), (53, 1), (63, 1)] }, { coefficient := -1, powers := [(42, 1), (57, 1), (63, 1)] }, { coefficient := -1, powers := [(46, 1), (48, 1), (51, 1), (63, 1)] }, { coefficient := -1, powers := [(48, 1), (53, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(25, 1), (46, 1), (48, 1), (51, 1), (63, 1)] }, { coefficient := 1, powers := [(48, 1), (51, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(21, 1), (25, 1), (46, 1), (51, 1), (63, 1)] }],
...
#print axioms Krenn.Component37.SelectedLeafB2_1.selectedHasNoCommonZero

end Krenn.Component37.SelectedLeafB2_1
