...
namespace Krenn.Component37.SelectedLeafB6_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "31fceef82d9ef352b320d0f42856a3dd9b72654410387d919d36b70cc6339f1b"
def certificateSHA256 : String := "2c81cb9cfc56b47f0938593d58bd0e3e0df962df647758d505409294f7e3a968"
...
def multipliers : Fin 31 → SparsePoly (Fin 64) := ![
  [{ coefficient := -1, powers := [(8, 1), (28, 1), (61, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (33, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (5, 1), (33, 1), (43, 1), (58, 1), (63, 1)] }, { coefficient := -1, powers := [(3, 1), (5, 1), (33, 1), (34, 1), (58, 1), (63, 1)] }, { coefficient := -1, powers := [(5, 1), (20, 1), (33, 1), (43, 1), (58, 1), (63, 1)] }, { coefficient := -1, powers := [(5, 1), (20, 1), (33, 1), (56, 1), (58, 1), (63, 1)] }, { coefficient := -1, powers := [(5, 1), (25, 1), (33, 1), (43, 1), (58, 1), (63, 1)] }, { coefficient := -1, powers := [(5, 1), (33, 1), (34, 1), (37, 1), (58, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (5, 1), (29, 1), (61, 1), (63, 1)] }, { coefficient := 1, powers := [(5, 1), (25, 1), (29, 1), (61, 1), (63, 1)] }, { coefficient := -1, powers := [(12, 1), (24, 1), (44, 1), (63, 1)] }, { coefficient := 1, powers := [(19, 1), (24, 1), (51, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (36, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (33, 1), (37, 1), (58, 1)] }, { coefficient := 1, powers := [(6, 1), (20, 1), (33, 1), (58, 1)] }],
  [{ coefficient := -1, powers := [(3, 1), (21, 1), (33, 1), (58, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (33, 1), (37, 1), (49, 1)] }, { coefficient := 1, powers := [(33, 1), (37, 1), (43, 1), (49, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (20, 1), (33, 1), (47, 1), (56, 1)] }, { coefficient := 1, powers := [(13, 1), (19, 1), (33, 1), (37, 1), (48, 1)] }, { coefficient := -1, powers := [(19, 1), (33, 1), (37, 1), (43, 1), (48, 1)] }],
  [{ coefficient := 1, powers := [(6, 1), (18, 1), (61, 1)] }, { coefficient := -1, powers := [(19, 1), (51, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (20, 1), (33, 1), (56, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (19, 1), (33, 1), (37, 1)] }, { coefficient := 1, powers := [(19, 1), (33, 1), (37, 1), (43, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (5, 1), (61, 1)] }, { coefficient := -1, powers := [(5, 1), (25, 1), (61, 1)] }],
  ...
  [{ coefficient := -1, powers := [(9, 1), (21, 1), (33, 1), (37, 1), (58, 1)] }],
  ...
  [{ coefficient := -1, powers := [(0, 1), (5, 1), (29, 1), (54, 1), (61, 1)] }, { coefficient := 1, powers := [(0, 1), (5, 1), (33, 1), (43, 1), (50, 1), (58, 1)] }, { coefficient := 1, powers := [(3, 1), (5, 1), (33, 1), (34, 1), (50, 1), (58, 1)] }, { coefficient := 1, powers := [(5, 1), (20, 1), (33, 1), (43, 1), (50, 1), (58, 1)] }, { coefficient := 1, powers := [(5, 1), (20, 1), (33, 1), (50, 1), (56, 1), (58, 1)] }, { coefficient := -1, powers := [(5, 1), (25, 1), (29, 1), (54, 1), (61, 1)] }, { coefficient := 1, powers := [(5, 1), (25, 1), (33, 1), (43, 1), (50, 1), (58, 1)] }, { coefficient := 1, powers := [(5, 1), (33, 1), (34, 1), (37, 1), (50, 1), (58, 1)] }, { coefficient := -1, powers := [(5, 1), (36, 1), (55, 1)] }, { coefficient := 1, powers := [(8, 1), (28, 1), (48, 1), (61, 1)] }, { coefficient := -1, powers := [(8, 1), (33, 1), (49, 1)] }, { coefficient := 1, powers := [(12, 1), (24, 1), (44, 1), (54, 1)] }, { coefficient := -1, powers := [(19, 1), (24, 1), (51, 1), (54, 1)] }],
  ...
  [{ coefficient := 1, powers := [(0, 1), (5, 1), (33, 1), (56, 1), (58, 1)] }, { coefficient := 1, powers := [(5, 1), (6, 1), (33, 1), (34, 1), (58, 1)] }, { coefficient := 1, powers := [(5, 1), (13, 1), (25, 1), (33, 1), (58, 1)] }, { coefficient := 1, powers := [(5, 1), (20, 1), (26, 1), (33, 1), (47, 1), (56, 1)] }, { coefficient := -1, powers := [(5, 1), (25, 1), (33, 1), (43, 1), (58, 1)] }, { coefficient := 1, powers := [(13, 1), (18, 1), (26, 1), (33, 1), (37, 1), (49, 1)] }, { coefficient := -1, powers := [(13, 1), (19, 1), (26, 1), (33, 1), (37, 1), (48, 1)] }, { coefficient := -1, powers := [(18, 1), (26, 1), (33, 1), (37, 1), (43, 1), (49, 1)] }, { coefficient := 1, powers := [(19, 1), (26, 1), (33, 1), (37, 1), (43, 1), (48, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (5, 1), (30, 1), (61, 1)] }, { coefficient := 1, powers := [(9, 1), (17, 1), (21, 1), (25, 1), (33, 1), (37, 1), (58, 1)] }],
...
#print axioms Krenn.Component37.SelectedLeafB6_0.selectedHasNoCommonZero

end Krenn.Component37.SelectedLeafB6_0
