...
namespace Krenn.Component37.SelectedLeafB5_2_4_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "ffad3ad7c268b48b807467cab5b698aa247964e69fb079942c228ae7a8148b3a"
def certificateSHA256 : String := "44f463a7f4f6fbba95f7ed415202aca359f2c54432b6e6102f46c7572e04a574"
...
def multipliers : Fin 22 → SparsePoly (Fin 68) := ![
  ...
  [{ coefficient := -1, powers := [(21, 1), (30, 1), (37, 1), (52, 1), (61, 1), (66, 1)] }, { coefficient := -1, powers := [(23, 1), (39, 1), (61, 1), (66, 1)] }, { coefficient := 1, powers := [(24, 1), (26, 1), (37, 1), (52, 1), (61, 1), (66, 1)] }, { coefficient := -1, powers := [(24, 1), (37, 1), (54, 1), (61, 1), (66, 1)] }, { coefficient := 1, powers := [(24, 1), (44, 1), (55, 1), (66, 1)] }, { coefficient := -1, powers := [(28, 1), (39, 1), (61, 1), (66, 1)] }, { coefficient := -1, powers := [(30, 1), (37, 1), (48, 1), (61, 1), (66, 1)] }],
  ...
  [{ coefficient := -1, powers := [(2, 1), (37, 1), (48, 1), (54, 1), (61, 1)] }, { coefficient := -1, powers := [(5, 1), (30, 1), (61, 1)] }, { coefficient := -1, powers := [(8, 1), (33, 1), (49, 1)] }, { coefficient := -1, powers := [(12, 1), (30, 1), (49, 1)] }, { coefficient := -1, powers := [(12, 1), (36, 1), (39, 1)] }, { coefficient := 1, powers := [(18, 1), (21, 1), (30, 1), (37, 1), (52, 1), (61, 1)] }, { coefficient := 1, powers := [(18, 1), (23, 1), (39, 1), (61, 1)] }, { coefficient := -1, powers := [(18, 1), (24, 1), (26, 1), (37, 1), (52, 1), (61, 1)] }, { coefficient := 1, powers := [(18, 1), (24, 1), (37, 1), (54, 1), (61, 1)] }, { coefficient := -1, powers := [(18, 1), (24, 1), (44, 1), (55, 1)] }, { coefficient := 1, powers := [(18, 1), (28, 1), (39, 1), (61, 1)] }, { coefficient := 1, powers := [(18, 1), (30, 1), (37, 1), (48, 1), (61, 1)] }]
]
...
#print axioms Krenn.Component37.SelectedLeafB5_2_4_3.selectedHasNoCommonZero

end Krenn.Component37.SelectedLeafB5_2_4_3
