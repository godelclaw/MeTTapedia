...
namespace Krenn.Component37.SelectedLeafB0_3_2_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "a6a624069cf23021d4f6edab96656fa846e529f538cf5b6a9d9fdc92f7e1a48d"
def certificateSHA256 : String := "4be6086c580e3e14efbbeb06634ec90ffb3a5dc36c9fe77310c7f30efa9618d5"
...
def multipliers : Fin 23 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := -1, powers := [(8, 1), (36, 1), (51, 1), (65, 1)] }],
  ...
  [{ coefficient := -1, powers := [(8, 1), (21, 1), (36, 1), (46, 2), (51, 1)] }, { coefficient := -1, powers := [(8, 1), (21, 1), (36, 1), (46, 1), (51, 1), (57, 1)] }, { coefficient := 1, powers := [(8, 1), (21, 1), (36, 1), (46, 1), (53, 1)] }, { coefficient := -1, powers := [(8, 1), (36, 1), (42, 1), (57, 1)] }, { coefficient := 1, powers := [(8, 1), (36, 1), (48, 1), (51, 1), (57, 1)] }, { coefficient := -1, powers := [(8, 1), (36, 1), (48, 1), (53, 1)] }],
  ...
  [{ coefficient := -1, powers := [(8, 1), (21, 1), (36, 1), (46, 2), (51, 1)] }, { coefficient := -1, powers := [(8, 1), (21, 1), (36, 1), (46, 1), (51, 1), (57, 1)] }, { coefficient := 1, powers := [(8, 1), (36, 1), (42, 1), (57, 1)] }, { coefficient := 1, powers := [(8, 1), (36, 1), (48, 1), (51, 1), (57, 1)] }, { coefficient := -1, powers := [(18, 1), (24, 1), (26, 1), (47, 1), (53, 1)] }, { coefficient := 2, powers := [(18, 1), (24, 1), (47, 1), (55, 1)] }, { coefficient := -1, powers := [(19, 1), (24, 1), (26, 1), (41, 1), (53, 1)] }, { coefficient := 2, powers := [(19, 1), (24, 1), (41, 1), (55, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (36, 1), (48, 1), (51, 1)] }, { coefficient := -1, powers := [(18, 1), (24, 1), (44, 1), (55, 1)] }],
...
#print axioms Krenn.Component37.SelectedLeafB0_3_2_2.selectedHasNoCommonZero

end Krenn.Component37.SelectedLeafB0_3_2_2
