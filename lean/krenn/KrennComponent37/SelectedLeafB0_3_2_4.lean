...
namespace Krenn.Component37.SelectedLeafB0_3_2_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "9faab44eafe57e9e7180d8e2eac56aaed2ef248daf50c3bb12f1114ac00ace7b"
...
def multipliers : Fin 28 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := -2, powers := [(24, 1), (26, 1), (65, 1)] }],
  ...
  [{ coefficient := 2, powers := [(19, 1), (24, 1), (26, 1), (65, 1)] }],
  [{ coefficient := -2, powers := [(19, 1), (24, 1), (25, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(21, 1), (55, 1)] }],
  [{ coefficient := 1, powers := [(55, 1)] }],
  [{ coefficient := 1, powers := [(49, 1)] }],
  [{ coefficient := 2, powers := [(24, 1), (25, 1), (65, 1)] }, { coefficient := -1, powers := [(24, 1)] }],
  ...
  [{ coefficient := 2, powers := [(19, 1), (24, 1), (25, 1), (46, 1), (55, 1), (65, 1)] }, { coefficient := -2, powers := [(19, 1), (24, 1), (26, 1), (46, 1), (51, 1), (65, 1)] }, { coefficient := -1, powers := [(19, 1), (24, 1), (52, 1), (55, 1)] }],
  ...
  [{ coefficient := 1, powers := [(5, 1), (33, 1)] }, { coefficient := -2, powers := [(12, 1), (24, 1), (25, 1), (65, 1)] }, { coefficient := 1, powers := [(12, 1), (24, 1)] }, { coefficient := -2, powers := [(18, 1), (24, 1), (51, 1)] }, { coefficient := -1, powers := [(18, 1), (29, 1), (42, 1), (62, 1)] }],
...
#print axioms Krenn.Component37.SelectedLeafB0_3_2_4.selectedHasNoCommonZero

end Krenn.Component37.SelectedLeafB0_3_2_4
