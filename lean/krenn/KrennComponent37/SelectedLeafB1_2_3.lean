...
namespace Krenn.Component37.SelectedLeafB1_2_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "8261beb399e17a9d828b7af74da500e28bdafae25b0bee1ebf97559bc449bbd0"
...
def multipliers : Fin 13 → SparsePoly (Fin 66) := ![
  [{ coefficient := -1, powers := [(20, 1), (29, 1), (41, 1), (58, 1), (62, 1), (65, 1)] }, { coefficient := -1, powers := [(20, 1), (29, 1), (46, 1), (58, 1), (62, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(54, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(20, 1), (29, 1), (58, 1), (62, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(20, 1), (58, 1), (62, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(18, 1), (20, 2), (58, 1), (62, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(52, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(26, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(18, 1), (20, 1), (58, 1), (62, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(18, 1), (20, 1), (29, 1), (58, 1), (62, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(65, 1)] }],
  [{ coefficient := 1, powers := [(18, 1), (20, 1), (29, 1), (52, 1), (58, 1), (62, 1), (65, 1)] }, { coefficient := 1, powers := [(26, 1), (47, 1), (52, 1), (65, 1)] }, { coefficient := -1, powers := [(41, 1), (58, 1), (65, 1)] }, { coefficient := -1, powers := [(47, 1), (54, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(20, 1), (52, 1), (58, 1), (65, 1)] }],
...
#print axioms Krenn.Component37.SelectedLeafB1_2_3.selectedHasNoCommonZero

end Krenn.Component37.SelectedLeafB1_2_3
