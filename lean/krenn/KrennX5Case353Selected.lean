...
namespace Krenn.X5Case353Selected

open Krenn.SparseCertificate
open MvPolynomial

def sourceSystemFileSHA256 : String := "b4e7f06be149dd5263a42866f617d75aaa2803fe2f693c4031087aea111ec9c1"
def sourceSystemSemanticSHA256 : String := "af5ee5753f18c08c994386a5da3f12d6c23ab28e445270105a48e036a56bf386"
def certificateSHA256 : String := "5dc33d38828e47811de4a084648e4e38aea558d59810421a9a8637d199d0ac26"
...
def selectedEquations : Fin 30 → SparsePoly (Fin 70) := ![
  ...
  [{ coefficient := 1, powers := [(13, 1), (39, 1), (67, 1)] }, { coefficient := 1, powers := [(22, 1), (47, 1), (55, 1)] }, { coefficient := 1, powers := [(39, 1), (58, 1)] }],
...
def multipliers : Fin 30 → SparsePoly (Fin 70) := ![
  [{ coefficient := -1, powers := [(16, 1), (33, 1), (42, 1), (44, 1), (55, 1)] }, { coefficient := -1, powers := [(24, 1), (33, 1), (42, 1), (44, 1), (52, 1)] }, { coefficient := -1, powers := [(25, 1), (33, 1), (38, 1), (47, 1), (55, 1)] }, { coefficient := -1, powers := [(25, 1), (33, 1), (41, 1), (47, 1), (52, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (24, 1), (28, 1), (39, 1), (58, 1), (59, 1)] }, { coefficient := -1, powers := [(8, 1), (44, 1)] }, { coefficient := -1, powers := [(14, 1), (24, 1), (28, 1), (39, 1), (45, 1), (58, 1)] }, { coefficient := 1, powers := [(32, 1), (35, 1)] }],
  [{ coefficient := 1, powers := [(24, 1), (25, 1), (33, 1), (36, 1), (38, 1), (58, 1)] }],
  [{ coefficient := 1, powers := [(11, 1), (24, 1), (39, 1), (58, 1)] }, { coefficient := 1, powers := [(17, 1), (24, 1), (33, 1), (36, 1), (37, 1), (58, 1)] }],
  [{ coefficient := 1, powers := [(13, 1), (24, 1), (25, 1), (33, 1), (36, 1), (38, 1)] }, { coefficient := -1, powers := [(13, 1), (24, 1), (33, 1), (38, 1), (56, 1)] }],
  [{ coefficient := -1, powers := [(21, 1), (24, 1), (28, 1), (39, 1), (58, 1)] }],
  [{ coefficient := -1, powers := [(17, 1), (24, 1), (33, 1), (36, 1), (38, 1)] }],
  [{ coefficient := -1, powers := [(16, 1), (33, 1), (39, 1), (55, 1)] }, { coefficient := -1, powers := [(24, 1), (33, 1), (39, 1), (52, 1)] }],
  [{ coefficient := -1, powers := [(16, 1), (33, 1), (36, 1), (55, 1)] }, { coefficient := -1, powers := [(24, 1), (33, 1), (36, 1), (52, 1)] }],
  [{ coefficient := 1, powers := [(19, 1), (24, 1), (39, 1), (58, 1)] }],
  [{ coefficient := 1, powers := [(22, 1), (24, 1), (25, 1), (33, 1), (36, 1), (38, 1)] }, { coefficient := -1, powers := [(22, 1), (24, 1), (33, 1), (38, 1), (56, 1)] }],
  [{ coefficient := -1, powers := [(17, 1), (33, 1), (38, 1), (55, 1)] }, { coefficient := -1, powers := [(17, 1), (33, 1), (41, 1), (52, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (24, 1), (33, 1), (36, 1), (38, 1)] }, { coefficient := -1, powers := [(9, 1), (33, 1), (38, 1), (55, 1)] }, { coefficient := -1, powers := [(9, 1), (33, 1), (41, 1), (52, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (47, 1)] }, { coefficient := 1, powers := [(5, 1), (24, 1), (47, 1)] }, { coefficient := 1, powers := [(44, 1)] }],
  ...
  [{ coefficient := 1, powers := [(3, 1), (16, 1), (17, 1), (44, 1), (55, 1)] }, { coefficient := 1, powers := [(3, 1), (17, 1), (24, 1), (44, 1), (52, 1)] }, { coefficient := -1, powers := [(3, 1), (17, 1), (32, 1), (38, 1), (55, 1)] }, { coefficient := -1, powers := [(3, 1), (17, 1), (32, 1), (41, 1), (52, 1)] }, { coefficient := -1, powers := [(16, 1), (20, 1), (44, 1), (55, 1)] }, { coefficient := -1, powers := [(20, 1), (24, 1), (44, 1), (52, 1)] }, { coefficient := 1, powers := [(20, 1), (32, 1), (38, 1), (55, 1)] }, { coefficient := 1, powers := [(20, 1), (32, 1), (41, 1), (52, 1)] }],
  ...
  [{ coefficient := -1, powers := [(24, 1), (25, 1), (33, 1), (36, 1), (38, 1)] }, { coefficient := 1, powers := [(24, 1), (33, 1), (38, 1), (56, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (33, 1), (36, 1), (38, 1), (58, 1)] }],
  [{ coefficient := 1, powers := [(24, 1), (28, 1), (39, 1), (58, 1)] }],
  [{ coefficient := 1, powers := [(24, 1), (33, 1), (36, 1), (38, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (39, 1), (58, 1)] }],
...
#print axioms Krenn.X5Case353Selected.selectedHasNoCommonZero

end Krenn.X5Case353Selected
