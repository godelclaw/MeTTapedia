...
namespace Krenn.Component47.SelectedLeafB0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "abf0e04b1628e39781a841922eda9ab17497080520f256c277d2fa9ebaccabbb"
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedEquations : Fin 14 → SparsePoly (Fin 58) := ![
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def multipliers : Fin 14 → SparsePoly (Fin 58) := ![
...
#print axioms Krenn.Component47.SelectedLeafB0.selectedHasNoCommonZero

end Krenn.Component47.SelectedLeafB0
