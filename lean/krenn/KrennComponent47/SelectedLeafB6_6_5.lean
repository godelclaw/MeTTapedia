...
namespace Krenn.Component47.SelectedLeafB6_6_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "752597aba2ae827e352f02d3eea57c59d09a238f48d96d44fff9afd4238e402c"
...
def selectedEquations : Fin 22 → SparsePoly (Fin 64) := ![
  ...
  [{ coefficient := 1, powers := [(52, 1), (62, 1)] }, { coefficient := -1, powers := [] }],
...
def multipliers : Fin 22 → SparsePoly (Fin 64) := ![
  [{ coefficient := -2, powers := [(24, 1), (54, 1), (62, 1)] }, { coefficient := -1, powers := [(29, 1), (46, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(46, 1), (50, 1), (61, 1)] }],
  ...
  [{ coefficient := 1, powers := [(40, 1), (46, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(24, 1)] }],
  [{ coefficient := 1, powers := [(29, 1), (46, 1), (61, 1)] }],
  ...
  [{ coefficient := 1, powers := [(38, 1), (57, 1)] }, { coefficient := -1, powers := [(40, 1), (46, 1), (51, 1), (61, 1)] }, { coefficient := 2, powers := [(46, 1), (51, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (32, 1), (46, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (52, 1), (54, 1), (62, 1)] }, { coefficient := 1, powers := [(2, 1), (54, 1)] }, { coefficient := 1, powers := [(8, 1), (35, 1)] }, { coefficient := -1, powers := [(19, 1), (29, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (32, 1), (54, 1)] }, { coefficient := 1, powers := [(14, 1), (24, 1), (54, 1)] }, { coefficient := 1, powers := [(14, 1), (29, 1), (46, 1)] }],
  [{ coefficient := -1, powers := [(14, 1), (29, 1), (46, 1), (61, 1)] }],
...
#print axioms Krenn.Component47.SelectedLeafB6_6_5.selectedHasNoCommonZero

end Krenn.Component47.SelectedLeafB6_6_5
