...
namespace Krenn.Component47.SelectedLeafB4_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "17307042a78ac59f469abdfc8163e33338e092abed6b6a770ed7252252115bbf"
...
def multipliers : Fin 20 → SparsePoly (Fin 61) := ![
  [{ coefficient := -1, powers := [(5, 1), (29, 1), (41, 1), (56, 1), (60, 1)] }, { coefficient := -2, powers := [(8, 1), (24, 1), (41, 1), (56, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(29, 1), (41, 1), (48, 1), (59, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (32, 1), (41, 1), (46, 1), (58, 1), (60, 2)] }],
  [{ coefficient := 1, powers := [(8, 1), (32, 1), (41, 1), (58, 1), (60, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (5, 1), (41, 1), (57, 1), (60, 1)] }, { coefficient := -1, powers := [(5, 1), (25, 1), (41, 1), (57, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (32, 1), (41, 1), (60, 1)] }, { coefficient := 1, powers := [(14, 1), (24, 1), (41, 1), (60, 1)] }],
  [{ coefficient := 2, powers := [(8, 1), (41, 1), (57, 1), (60, 1)] }],
  [{ coefficient := -1, powers := [(29, 1), (41, 1), (59, 1)] }],
  [{ coefficient := 1, powers := [(41, 1), (51, 1), (60, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (41, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(19, 1), (41, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(14, 1), (41, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(41, 1), (59, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (29, 1), (41, 1), (57, 1), (60, 1)] }],
  [{ coefficient := -1, powers := [(41, 1), (60, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (32, 1), (41, 1), (46, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(38, 1), (41, 1), (57, 1), (60, 1)] }, { coefficient := -1, powers := [(39, 1), (41, 1), (54, 1), (59, 1)] }, { coefficient := 1, powers := [(41, 2), (54, 1), (60, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (35, 1), (41, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (5, 1), (29, 1), (41, 1), (57, 1), (60, 1)] }, { coefficient := -1, powers := [(0, 1), (5, 1), (32, 1), (41, 1), (54, 1), (60, 1)] }, { coefficient := -1, powers := [(0, 1), (14, 1), (24, 1), (41, 1), (54, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (25, 1), (32, 1), (41, 1), (46, 1), (58, 1), (60, 1)] }, { coefficient := 1, powers := [(8, 1), (35, 1), (41, 1)] }, { coefficient := -1, powers := [] }]
]
...
#print axioms Krenn.Component47.SelectedLeafB4_5.selectedHasNoCommonZero

end Krenn.Component47.SelectedLeafB4_5
