...
namespace Krenn.Component47.SelectedLeafB4_2_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "da8d94f375df80862c9d95d08991addd4ece5f2f9b874130de6641dc13f02070"
...
def multipliers : Fin 22 → SparsePoly (Fin 62) := ![
  [{ coefficient := -2, powers := [(24, 1), (54, 1), (60, 1)] }, { coefficient := -1, powers := [(29, 1), (46, 1), (60, 1)] }],
  [{ coefficient := -1, powers := [(46, 1), (50, 1), (59, 1)] }],
  [{ coefficient := -2, powers := [(5, 1), (35, 1), (51, 1), (58, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (29, 1), (50, 1), (61, 1)] }],
  [{ coefficient := 2, powers := [(5, 1), (35, 1), (58, 1)] }],
  [{ coefficient := -1, powers := [(14, 1), (46, 1), (59, 1)] }],
  [{ coefficient := -1, powers := [(51, 1)] }],
  [{ coefficient := 1, powers := [(40, 1), (46, 1), (59, 1)] }],
  [{ coefficient := 1, powers := [(24, 1)] }],
  [{ coefficient := 1, powers := [(29, 1), (46, 1), (59, 1)] }],
  ...
  [{ coefficient := 1, powers := [(38, 1), (57, 1)] }, { coefficient := -1, powers := [(40, 1), (46, 1), (51, 1), (59, 1)] }, { coefficient := 2, powers := [(46, 1), (51, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (32, 1), (46, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (52, 1), (54, 1), (60, 1)] }, { coefficient := 1, powers := [(2, 1), (54, 1)] }, { coefficient := 1, powers := [(8, 1), (35, 1)] }, { coefficient := -1, powers := [(19, 1), (29, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (32, 1), (54, 1)] }, { coefficient := 1, powers := [(14, 1), (24, 1), (54, 1)] }, { coefficient := 1, powers := [(14, 1), (29, 1), (46, 1)] }],
  [{ coefficient := -1, powers := [(14, 1), (29, 1), (46, 1), (59, 1)] }],
...
#print axioms Krenn.Component47.SelectedLeafB4_2_5.selectedHasNoCommonZero

end Krenn.Component47.SelectedLeafB4_2_5
