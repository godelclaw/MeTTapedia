...
namespace Krenn.Component47.SelectedLeafB6_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "e6c4dec4a45a3d42ffa3098541b4fa01fe43b86b7c340be0fb2a4256bbcbfb9f"
def certificateSHA256 : String := "92bcb1e03ca9abd2a64f251fa77a92bb4acd3e0983058da31b61de456c3c978e"
...
def multipliers : Fin 28 → SparsePoly (Fin 63) := ![
  [{ coefficient := -1, powers := [(5, 1), (29, 1), (41, 1), (56, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (24, 1), (41, 1), (56, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(3, 1), (32, 1), (41, 1), (46, 1), (58, 1), (60, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(28, 1), (41, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(24, 1), (41, 1), (51, 1), (58, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (9, 1), (32, 1), (41, 1), (58, 1), (60, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(3, 1), (13, 1), (32, 1), (41, 1), (58, 1), (60, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (32, 1), (41, 1), (46, 1), (58, 1), (62, 2)] }, { coefficient := 1, powers := [(19, 1), (29, 1), (41, 1), (49, 2), (61, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(3, 1), (19, 1), (32, 1), (41, 1), (58, 1), (60, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (32, 1), (41, 1), (58, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (24, 1), (41, 1), (58, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (41, 1), (57, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (41, 1), (57, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(41, 1), (51, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (24, 1), (41, 1), (58, 1), (62, 1)] }, { coefficient := -1, powers := [(24, 1), (41, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(25, 1), (29, 1), (41, 1), (49, 1), (61, 1)] }, { coefficient := -1, powers := [(29, 1), (41, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(19, 1), (41, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(14, 1), (41, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (32, 1), (41, 1), (58, 1), (60, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(29, 1), (41, 1), (49, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(3, 1), (32, 1), (41, 1), (58, 1), (60, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(41, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(41, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (32, 1), (39, 1), (41, 1), (54, 1), (60, 1), (62, 1)] }, { coefficient := -1, powers := [(8, 1), (24, 1), (41, 1), (57, 1), (62, 1)] }, { coefficient := -1, powers := [(8, 1), (32, 1), (41, 1), (46, 1), (62, 1)] }, { coefficient := -1, powers := [(14, 1), (24, 1), (41, 1), (54, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(38, 1), (41, 1), (57, 1), (62, 1)] }, { coefficient := -1, powers := [(40, 1), (41, 1), (54, 1), (61, 1)] }, { coefficient := 1, powers := [(41, 2), (54, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (32, 1), (41, 1), (54, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (35, 1), (41, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (25, 1), (32, 1), (41, 1), (46, 1), (58, 1), (62, 1)] }, { coefficient := 1, powers := [(8, 1), (35, 1), (41, 1)] }, { coefficient := -1, powers := [(19, 1), (25, 1), (29, 1), (41, 1), (49, 2), (61, 1)] }, { coefficient := -1, powers := [] }]
]
...
#print axioms Krenn.Component47.SelectedLeafB6_7.selectedHasNoCommonZero

end Krenn.Component47.SelectedLeafB6_7
