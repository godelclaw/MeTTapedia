...
namespace Krenn.Component47.SelectedLeafB1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "a794d93e0e5d93b4b5f02915d1522cdd7f3d885ffa61bd90a445e10bb3a875fb"
def certificateSHA256 : String := "bf05c6ef7ba9fbe79bc4c4f4d15592e7292006abf9e8e3c425768e01a864c5e5"

set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedSourceIndices : Fin 19 → Fin 590 := ![
  2,
  6,
  48,
  250,
...
def selectedEquations : Fin 19 → SparsePoly (Fin 59) := ![
  ...
  [{ coefficient := 1, powers := [(0, 1), (45, 1), (49, 1)] }, { coefficient := 1, powers := [(21, 1), (49, 1)] }, { coefficient := 1, powers := [(21, 1), (53, 1)] }, { coefficient := 1, powers := [(45, 1)] }],
...
def multipliers : Fin 19 → SparsePoly (Fin 59) := ![
  ...
  [{ coefficient := 1, powers := [(24, 1), (36, 1), (57, 1)] }],
...
#print axioms Krenn.Component47.SelectedLeafB1.selectedHasNoCommonZero

end Krenn.Component47.SelectedLeafB1
