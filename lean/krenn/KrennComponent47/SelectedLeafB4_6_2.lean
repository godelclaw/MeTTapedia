...
namespace Krenn.Component47.SelectedLeafB4_6_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "f7a4919351c7c4a51ca343aa8ba994a0c3867d5e0b4883afae2b80886460e55e"
def certificateSHA256 : String := "42a74610dc2f7699b23b838c3891e9e1a4d6a8dbf9215c498323cbff99ac2a2b"

set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedSourceIndices : Fin 16 → Fin 596 := ![
  2,
  3,
  18,
  208,
...
def multipliers : Fin 16 → SparsePoly (Fin 62) := ![
  ...
  [{ coefficient := -1, powers := [(29, 1), (46, 1), (49, 1)] }],
  [{ coefficient := 1, powers := [(14, 1), (29, 1), (49, 1)] }],
...
#print axioms Krenn.Component47.SelectedLeafB4_6_2.selectedHasNoCommonZero

end Krenn.Component47.SelectedLeafB4_6_2
