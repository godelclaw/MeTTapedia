...
namespace Krenn.Component47.SelectedLeafB6_6_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "94ba2069603afd11447d47286c85cfeb8d03f4320188e980d6efd330f70f32e5"
def certificateSHA256 : String := "444c8113965baf59e47d0b189ac6863897889f708324ba2a1351fca4399dd770"

set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedSourceIndices : Fin 15 → Fin 596 := ![
  2,
  3,
  20,
  272,
...
def multipliers : Fin 15 → SparsePoly (Fin 64) := ![
  ...
  [{ coefficient := -1, powers := [(29, 1), (46, 1), (62, 1)] }],
  ...
  [{ coefficient := 1, powers := [(14, 1), (29, 1), (46, 1)] }],
...
#print axioms Krenn.Component47.SelectedLeafB6_6_6.selectedHasNoCommonZero

end Krenn.Component47.SelectedLeafB6_6_6
