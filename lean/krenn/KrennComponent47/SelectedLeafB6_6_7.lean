...
namespace Krenn.Component47.SelectedLeafB6_6_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "229ecbb319c283092de3433952154efd51b277b2549c4d49029c4fea7ef655ee"
...
def multipliers : Fin 17 → SparsePoly (Fin 65) := ![
  [{ coefficient := -2, powers := [(24, 1), (54, 1), (62, 1)] }, { coefficient := -2, powers := [(29, 1), (46, 1), (62, 1)] }],
  [{ coefficient := -2, powers := [(5, 1), (35, 1), (51, 1), (58, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (29, 1), (50, 1), (64, 1)] }],
...
#print axioms Krenn.Component47.SelectedLeafB6_6_7.selectedHasNoCommonZero

end Krenn.Component47.SelectedLeafB6_6_7
