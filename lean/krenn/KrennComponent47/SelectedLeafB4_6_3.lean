...
namespace Krenn.Component47.SelectedLeafB4_6_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "09fe9793685e8d833e39af2cf1af4a354ef3e383ef21a91ede3fc7107dbeea4c"
...
def multipliers : Fin 22 → SparsePoly (Fin 63) := ![
  ...
  [{ coefficient := 1, powers := [(3, 1), (32, 1), (46, 1), (58, 1), (59, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (32, 1), (46, 1), (59, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (9, 1), (32, 1), (58, 1), (59, 1)] }, { coefficient := -1, powers := [(5, 1), (35, 1), (51, 1), (58, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(3, 1), (13, 1), (32, 1), (58, 1), (59, 1)] }],
  [{ coefficient := 1, powers := [(3, 1), (19, 1), (32, 1), (58, 1), (59, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (35, 1), (58, 1)] }],
  [{ coefficient := -1, powers := [(14, 1), (46, 1), (59, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (57, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (57, 1)] }],
  [{ coefficient := 1, powers := [(9, 1), (46, 1), (59, 1)] }, { coefficient := 1, powers := [(39, 1), (46, 1), (59, 1)] }],
  [{ coefficient := 1, powers := [(19, 1)] }],
  [{ coefficient := 1, powers := [(14, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (32, 1), (58, 1), (59, 1)] }],
  [{ coefficient := -1, powers := [(3, 1), (32, 1), (58, 1), (59, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := -1, powers := [(5, 1), (32, 1), (39, 1), (54, 1), (59, 1)] }, { coefficient := -1, powers := [(5, 1), (35, 1), (51, 1)] }],
  [{ coefficient := -1, powers := [(9, 1), (46, 1), (51, 1), (59, 1)] }, { coefficient := 1, powers := [(38, 1), (57, 1)] }, { coefficient := -1, powers := [(39, 1), (46, 1), (51, 1), (59, 1)] }, { coefficient := 1, powers := [(46, 1), (51, 1)] }],
  ...
  [{ coefficient := 1, powers := [(5, 1), (20, 1), (35, 1), (51, 1), (58, 1)] }, { coefficient := 1, powers := [(8, 1), (9, 1), (32, 1), (46, 1), (59, 1)] }]
]
...
#print axioms Krenn.Component47.SelectedLeafB4_6_3.selectedHasNoCommonZero

end Krenn.Component47.SelectedLeafB4_6_3
