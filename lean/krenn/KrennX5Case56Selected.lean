...
namespace Krenn.X5Case56Selected

open Krenn.SparseCertificate
open MvPolynomial

def sourceSystemFileSHA256 : String := "9041cfdf8288086ccd138011fc943777de931211fbc56f2822261888b335a4ad"
def sourceSystemSemanticSHA256 : String := "483eb78d4c23cc471f478734fcff4f4370f2369d99160cf316ed4ef2980edb6d"
...
def selectedEquations : Fin 17 → SparsePoly (Fin 70) := ![
  ...
  [{ coefficient := 1, powers := [(11, 1), (61, 1)] }, { coefficient := 1, powers := [(18, 1), (36, 1), (67, 1)] }, { coefficient := 1, powers := [(27, 1), (36, 1), (64, 1)] }],
...
#print axioms Krenn.X5Case56Selected.selectedHasNoCommonZero

end Krenn.X5Case56Selected
