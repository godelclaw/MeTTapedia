...
/-!
Exact normalization of external minimal-prime component 60 into
zero-based Lean component row 59.  All exponent-map equalities are
rechecked by Lean below; this source is generated only for serialization.
-/

namespace Krenn.Component60Normalization
...
theorem selectedIndices_exact : componentGenerators 59 = selectedIndices := by decide
...
theorem rawPositiveMap06 :
    Finsupp.mapDomain rawToReduced (rawPositive 6) = generatorPositive 3 := by
  ext coordinate
  fin_cases coordinate <;>
    simp [rawPositive, rawToReduced, Finsupp.mapDomain_add, Finsupp.mapDomain_single, generatorPositive, generatorPositiveSupport, generatorNegative, generatorNegativeSupport, squarefreeExponent, Nat.testBit, Nat.shiftRight_eq_div_pow]
...
theorem rawPositiveMap17 :
    Finsupp.mapDomain rawToReduced (rawPositive 17) = generatorPositive 46 := by
  ext coordinate
  fin_cases coordinate <;>
    simp [rawPositive, rawToReduced, Finsupp.mapDomain_add, Finsupp.mapDomain_single, generatorPositive, generatorPositiveSupport, generatorNegative, generatorNegativeSupport, squarefreeExponent, Nat.testBit, Nat.shiftRight_eq_div_pow]
...
set_option maxRecDepth 100000 in
theorem rawComponent60_vanishes {R : Type*} [CommRing R]
...
end Krenn.Component60Normalization

#print axioms Krenn.Component60Normalization.rawComponent60_vanishes
