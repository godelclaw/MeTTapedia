...
namespace Krenn.X5Case101Selected

open Krenn.SparseCertificate
open MvPolynomial

def sourceSystemFileSHA256 : String := "35c560b69548dbcb454ddd1a1f47f98d3412355620e5f59787e9213f8d91ba6a"
def sourceSystemSemanticSHA256 : String := "75707546d7e47ce4925e04d3def6e20f62aeadb885f6409ad73f10335db57324"
...
def multipliers : Fin 16 → SparsePoly (Fin 70) := ![
  ...
  [{ coefficient := -1, powers := [(11, 1), (17, 1), (34, 1), (37, 1), (63, 1)] }, { coefficient := 1, powers := [(19, 1), (34, 1), (37, 1), (63, 1)] }],
...
#print axioms Krenn.X5Case101Selected.selectedHasNoCommonZero

end Krenn.X5Case101Selected
