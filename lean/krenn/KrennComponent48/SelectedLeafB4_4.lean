...
namespace Krenn.Component48.SelectedLeafB4_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "40004917127e8f65056cdf5c1dbf0a4f6992d48756bee3e4fa85a347defd1115"
def certificateSHA256 : String := "a29ce888ef1c0a33b3c5b27c2bdc3db590759108f7773b13d87eba8f5c0741e7"
...
def multipliers : Fin 26 → SparsePoly (Fin 62) := ![
  [{ coefficient := 1, powers := [(5, 1), (25, 1), (29, 1), (52, 1), (58, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (26, 1), (33, 1), (61, 1)] }],
  [{ coefficient := 2, powers := [(30, 1), (48, 1), (60, 1)] }],
  [{ coefficient := -1, powers := [(21, 1), (30, 1), (51, 1), (61, 1)] }, { coefficient := 1, powers := [(24, 1), (26, 1), (51, 1), (61, 1)] }, { coefficient := -2, powers := [(24, 1), (53, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(12, 1), (24, 1), (45, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (25, 1), (33, 1), (45, 1), (52, 1)] }, { coefficient := -1, powers := [(5, 1), (33, 1), (52, 1)] }],
  [{ coefficient := -2, powers := [(12, 1), (30, 1), (60, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (33, 1), (46, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (26, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (25, 1), (52, 1), (58, 1)] }],
  ...
  [{ coefficient := 1, powers := [(5, 1), (25, 1), (33, 1), (46, 1), (52, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := 2, powers := [(12, 1), (30, 1), (48, 1)] }],
  [{ coefficient := 1, powers := [(39, 1), (59, 1)] }, { coefficient := -1, powers := [(48, 1), (53, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (26, 1), (33, 1), (46, 1)] }, { coefficient := 1, powers := [(19, 1), (21, 1), (30, 1), (51, 1)] }, { coefficient := -1, powers := [(19, 1), (24, 1), (26, 1), (51, 1)] }, { coefficient := 2, powers := [(19, 1), (24, 1), (53, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (5, 1), (33, 1), (56, 1)] }, { coefficient := -1, powers := [(5, 1), (25, 2), (33, 1), (46, 1), (52, 1)] }],
...
#print axioms Krenn.Component48.SelectedLeafB4_4.selectedHasNoCommonZero

end Krenn.Component48.SelectedLeafB4_4
