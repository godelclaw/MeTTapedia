...
namespace Krenn.Component48.SelectedLeafB4_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "60f880f770eb2decc48aec97c65302faf5f653f5c28ef01a924f949e10443e99"
...
def multipliers : Fin 19 → SparsePoly (Fin 64) := ![
  ...
  [{ coefficient := -1, powers := [(21, 1), (30, 1), (51, 1), (61, 1)] }, { coefficient := -1, powers := [(24, 1), (53, 1), (61, 1)] }, { coefficient := -2, powers := [(30, 1), (42, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (33, 1), (48, 1), (60, 1), (63, 1)] }, { coefficient := 1, powers := [(12, 1), (30, 1), (48, 1), (60, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (33, 1), (60, 1)] }, { coefficient := -1, powers := [(12, 1), (30, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (59, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (33, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(53, 1)] }],
  [{ coefficient := 1, powers := [(19, 1)] }],
  [{ coefficient := 1, powers := [(12, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (33, 1), (55, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(42, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(30, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (33, 1), (56, 1), (61, 1)] }],
...
#print axioms Krenn.Component48.SelectedLeafB4_7.selectedHasNoCommonZero

end Krenn.Component48.SelectedLeafB4_7
