...
namespace Krenn.Component48.SelectedLeafB4_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "7ed1d6f397ac146c71d2f0b1ee456212c8fc51bc11485620486e54c7144bc09b"
...
def multipliers : Fin 18 → SparsePoly (Fin 63) := ![
  [{ coefficient := -1, powers := [(21, 1), (30, 1), (51, 1), (61, 1)] }, { coefficient := 1, powers := [(24, 1), (26, 1), (51, 1), (61, 1)] }, { coefficient := -2, powers := [(24, 1), (53, 1), (61, 1)] }, { coefficient := -2, powers := [(30, 1), (42, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (26, 1), (33, 1), (46, 1), (60, 1), (62, 1)] }, { coefficient := 1, powers := [(5, 1), (33, 1), (46, 1), (52, 1), (62, 1)] }, { coefficient := -1, powers := [(8, 1), (33, 1), (48, 1), (60, 1), (62, 1)] }, { coefficient := -1, powers := [(12, 1), (24, 1), (26, 1), (46, 1), (60, 1), (62, 1)] }, { coefficient := -1, powers := [(12, 1), (24, 1), (46, 1), (52, 1), (62, 1)] }, { coefficient := 1, powers := [(12, 1), (30, 1), (48, 1), (60, 1), (62, 1)] }],
  ...
  [{ coefficient := 1, powers := [(39, 1), (59, 1)] }, { coefficient := -1, powers := [(40, 1), (42, 1), (56, 1), (61, 1)] }, { coefficient := 1, powers := [(42, 1), (56, 1)] }],
...
#print axioms Krenn.Component48.SelectedLeafB4_5.selectedHasNoCommonZero

end Krenn.Component48.SelectedLeafB4_5
