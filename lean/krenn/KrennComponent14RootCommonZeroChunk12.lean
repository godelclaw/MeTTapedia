...
namespace Krenn.Component14RootCommonZero.Chunk12
...
theorem rootBlock_of_base_and_component {R : Type*} [CommRing R]
    ...
    ∀ offset : Fin 40, eval₂Hom (Int.castRingHom R) (rootValues full)
      (Krenn.Component14.Tree.rootEquations ⟨480 + offset.val, by omega⟩).toPoly = 0 := by
...
end Krenn.Component14RootCommonZero.Chunk12
