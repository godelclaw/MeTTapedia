...
namespace Krenn.Component65.SelectedLeafB0_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "39ef16321c999e8a181e49993ddaa75c15270a7c3ac17c2151eea61445a50417"
def certificateSHA256 : String := "faf2fe8ddce2e91e6e345250aadef1b1bee448b27061d6fb25161e1c1b576d86"
...
def multipliers : Fin 28 → SparsePoly (Fin 62) := ![
  ...
  [{ coefficient := 2, powers := [(28, 1), (39, 1), (47, 1)] }, { coefficient := 2, powers := [(28, 1), (44, 1), (47, 1)] }],
...
#print axioms Krenn.Component65.SelectedLeafB0_2.selectedHasNoCommonZero

end Krenn.Component65.SelectedLeafB0_2
