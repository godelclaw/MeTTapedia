...
namespace Krenn.Component65.SelectedLeafB4_1_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "ca62fc8da8cfedb6b39e489e89a21eea31a9972612ed654667c80a00954ebf6d"
...
def multipliers : Fin 9 → SparsePoly (Fin 63) := ![
  ...
  [{ coefficient := -1, powers := [(20, 1), (62, 1)] }, { coefficient := 1, powers := [(24, 1), (46, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(44, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(20, 1), (52, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (44, 1), (62, 1)] }, { coefficient := 1, powers := [(62, 1)] }],
  [{ coefficient := -1, powers := [(20, 1), (24, 1), (52, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := 1, powers := [(0, 1), (24, 1), (40, 1), (44, 1), (62, 1)] }, { coefficient := -1, powers := [(0, 1), (40, 1), (62, 1)] }, { coefficient := 1, powers := [(20, 1), (24, 1), (44, 1), (49, 1), (62, 1)] }, { coefficient := -1, powers := [(24, 1), (46, 1), (49, 1), (62, 1)] }]
]
...
#print axioms Krenn.Component65.SelectedLeafB4_1_0.selectedHasNoCommonZero

end Krenn.Component65.SelectedLeafB4_1_0
