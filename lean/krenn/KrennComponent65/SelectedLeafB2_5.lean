...
namespace Krenn.Component65.SelectedLeafB2_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "bd0d30c78d7dc0815d7a4450ce02cc816a672a56fe648b0919235d997ed6db29"
...
def multipliers : Fin 7 → SparsePoly (Fin 64) := ![
  ...
  [{ coefficient := -1, powers := [(20, 1), (36, 1), (49, 1), (59, 1), (63, 1)] }, { coefficient := -1, powers := [(20, 1), (39, 1), (49, 1), (56, 1), (63, 1)] }, { coefficient := -1, powers := [(20, 1), (44, 1), (49, 1), (51, 1), (63, 1)] }, { coefficient := 1, powers := [(20, 1), (44, 1), (52, 1), (63, 1)] }, { coefficient := -1, powers := [(40, 1), (56, 1), (63, 1)] }, { coefficient := 1, powers := [(46, 1), (49, 1), (51, 1), (63, 1)] }, { coefficient := -1, powers := [(46, 1), (52, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(20, 1), (49, 1), (63, 1)] }],
...
#print axioms Krenn.Component65.SelectedLeafB2_5.selectedHasNoCommonZero

end Krenn.Component65.SelectedLeafB2_5
