...
namespace Krenn.Component65.SelectedLeafB0_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "54cc672b8e76585f74b4901f2083154b0b2604dacd6a7a7e0ced29e3612058e9"
def certificateSHA256 : String := "71816762f54922f6fc71b06d35f3d0b65e3aa7411a912519f5961bd03072ecd0"
...
def multipliers : Fin 28 → SparsePoly (Fin 63) := ![
  ...
  [{ coefficient := -1, powers := [(23, 1), (42, 1), (51, 1)] }, { coefficient := -1, powers := [(23, 1), (45, 1)] }],
  [{ coefficient := 2, powers := [(23, 1), (50, 1), (54, 1), (61, 1)] }],
  ...
  [{ coefficient := -2, powers := [(23, 1), (54, 1), (61, 1)] }],
  ...
  [{ coefficient := 1, powers := [(25, 1), (40, 1), (42, 1), (56, 1)] }, { coefficient := 1, powers := [(25, 1), (42, 1), (46, 1), (52, 1)] }, { coefficient := 1, powers := [(37, 1), (60, 1)] }, { coefficient := 1, powers := [(40, 1), (57, 1)] }, { coefficient := -1, powers := [(47, 1), (54, 1)] }],
...
#print axioms Krenn.Component65.SelectedLeafB0_6.selectedHasNoCommonZero

end Krenn.Component65.SelectedLeafB0_6
