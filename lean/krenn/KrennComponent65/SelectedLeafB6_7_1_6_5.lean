...
namespace Krenn.Component65.SelectedLeafB6_7_1_6_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "6ad2ae59404d1828a36f8734480b2d1ef0b342174964869ebcdb43ece37669e0"
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedEquations : Fin 7 → SparsePoly (Fin 71) := ![
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def multipliers : Fin 7 → SparsePoly (Fin 71) := ![
  [{ coefficient := -1, powers := [(49, 1), (51, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(51, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [] }],
  [{ coefficient := -1, powers := [(51, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (51, 1)] }],
  [{ coefficient := -1, powers := [(19, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (35, 1), (51, 1)] }, { coefficient := 1, powers := [(3, 1), (24, 1), (51, 1)] }, { coefficient := -1, powers := [(3, 1)] }, { coefficient := 1, powers := [(6, 1), (19, 1), (51, 1)] }, { coefficient := 1, powers := [(6, 1), (20, 1), (49, 1), (51, 1), (65, 1)] }]
]
...
#print axioms Krenn.Component65.SelectedLeafB6_7_1_6_5.selectedHasNoCommonZero

end Krenn.Component65.SelectedLeafB6_7_1_6_5
