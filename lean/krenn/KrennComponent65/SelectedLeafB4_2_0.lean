...
namespace Krenn.Component65.SelectedLeafB4_2_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "22c8eb9342d4868b9dd63772fee42e8821f616e1a40e38fd7512c42a5a67a9f5"
def certificateSHA256 : String := "243912a63cc5e6bf84b09c52bcfe54778e5f5e4383cf083071755aefa86353d5"
...
def multipliers : Fin 19 → SparsePoly (Fin 63) := ![
  ...
  [{ coefficient := 2, powers := [(18, 1), (54, 1), (62, 1)] }],
  ...
  [{ coefficient := 2, powers := [(13, 1), (19, 1), (28, 1), (47, 1)] }, { coefficient := -2, powers := [(18, 1), (23, 1), (54, 1), (62, 1)] }],
...
#print axioms Krenn.Component65.SelectedLeafB4_2_0.selectedHasNoCommonZero

end Krenn.Component65.SelectedLeafB4_2_0
