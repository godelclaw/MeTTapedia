...
namespace Krenn.Component65.SelectedLeafB3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "20051163470d20a2851fd3d91c1a1ead15865af263ed0004bdbe8de57a56828f"
...
def multipliers : Fin 26 → SparsePoly (Fin 63) := ![
  [{ coefficient := 1, powers := [(2, 1), (25, 1), (40, 1), (42, 1), (62, 1)] }, { coefficient := 1, powers := [(5, 1), (19, 1), (34, 1), (54, 1), (62, 1)] }, { coefficient := 1, powers := [(5, 1), (25, 1), (31, 1), (42, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (25, 1), (40, 1), (62, 1)] }, { coefficient := -1, powers := [(5, 1), (25, 1), (31, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (20, 1), (34, 1), (56, 1), (62, 1)] }, { coefficient := -1, powers := [(8, 1), (34, 1), (46, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (24, 1), (47, 1), (54, 1), (62, 1)] }, { coefficient := 1, powers := [(8, 1), (24, 1), (31, 1), (47, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (20, 1), (34, 1), (62, 1)] }],
...
#print axioms Krenn.Component65.SelectedLeafB3.selectedHasNoCommonZero

end Krenn.Component65.SelectedLeafB3
