...
namespace Krenn.Component65.SelectedLeafB6_1_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "d8aa39835c9064ce43f75f8cacb508bad66e52f606a9d41702d610d6c594bc75"
...
def multipliers : Fin 10 → SparsePoly (Fin 67) := ![
  [{ coefficient := -1, powers := [(20, 1), (51, 1), (57, 1), (63, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(25, 1), (51, 1), (66, 1)] }, { coefficient := -1, powers := [(53, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(49, 1), (51, 1), (57, 1), (63, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(24, 1), (53, 1), (66, 1)] }, { coefficient := -1, powers := [(25, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(51, 1), (57, 1), (63, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(20, 1), (49, 1), (51, 1), (57, 1), (63, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (51, 1), (66, 1)] }, { coefficient := 1, powers := [(66, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (24, 1), (51, 1), (57, 1), (66, 1)] }, { coefficient := -1, powers := [(0, 1), (57, 1), (66, 1)] }, { coefficient := -1, powers := [(20, 1), (24, 1), (49, 1), (51, 1), (57, 1), (63, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (51, 1), (57, 1), (66, 1)] }],
...
#print axioms Krenn.Component65.SelectedLeafB6_1_7.selectedHasNoCommonZero

end Krenn.Component65.SelectedLeafB6_1_7
