...
namespace Krenn.Component65.SelectedLeafB4_2_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "864cdd6da5e77d9aca86056afb8d687ebe69e145149129ea0de9aaa5926d7ad2"
...
def multipliers : Fin 22 → SparsePoly (Fin 65) := ![
  ...
  [{ coefficient := -2, powers := [(23, 1), (54, 1), (57, 1), (62, 1), (64, 1)] }],
  [{ coefficient := 2, powers := [(18, 1), (54, 1), (57, 1), (62, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(14, 1), (23, 1), (57, 1), (63, 1)] }, { coefficient := -1, powers := [(23, 1), (57, 2), (64, 1)] }, { coefficient := -2, powers := [(28, 1), (47, 1), (57, 1), (64, 1)] }],
  ...
  [{ coefficient := -1, powers := [(20, 1), (43, 1), (49, 1), (57, 1), (63, 1)] }, { coefficient := 1, powers := [(37, 1), (57, 1), (60, 1), (64, 1)] }, { coefficient := -1, powers := [(40, 1), (55, 1), (57, 1), (63, 1)] }, { coefficient := 1, powers := [(40, 1), (57, 2), (64, 1)] }, { coefficient := -1, powers := [(47, 1), (54, 1), (57, 1), (64, 1)] }],
  [{ coefficient := 2, powers := [(18, 1), (23, 1), (54, 1), (57, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (34, 1), (57, 1), (64, 1)] }, { coefficient := -1, powers := [(18, 1), (28, 1), (57, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (31, 1), (57, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (14, 1), (19, 1), (23, 1), (57, 1), (63, 1)] }, { coefficient := 1, powers := [(13, 1), (19, 1), (23, 1), (57, 2), (64, 1)] }, { coefficient := 2, powers := [(13, 1), (19, 1), (28, 1), (47, 1), (57, 1), (64, 1)] }, { coefficient := -2, powers := [(18, 1), (23, 1), (54, 1), (57, 1), (62, 1), (64, 1)] }],
...
#print axioms Krenn.Component65.SelectedLeafB4_2_5.selectedHasNoCommonZero

end Krenn.Component65.SelectedLeafB4_2_5
