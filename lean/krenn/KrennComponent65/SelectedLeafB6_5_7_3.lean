...
namespace Krenn.Component65.SelectedLeafB6_5_7_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "48a22ef6a6ae39e8709dde3269b90ccd625878366f14097fc6e63b2dec0ec417"
...
def multipliers : Fin 24 → SparsePoly (Fin 70) := ![
  ...
  [{ coefficient := -1, powers := [(0, 1), (5, 1), (31, 1), (57, 1), (69, 1)] }, { coefficient := -1, powers := [(0, 1), (8, 1), (34, 1), (40, 1), (69, 1)] }, { coefficient := -1, powers := [(13, 1), (19, 1), (23, 1), (57, 1), (69, 1)] }],
  ...
  [{ coefficient := 1, powers := [(0, 1), (5, 1), (28, 1), (31, 1), (57, 1), (69, 1)] }, { coefficient := 1, powers := [(0, 1), (8, 1), (28, 1), (34, 1), (40, 1), (69, 1)] }, { coefficient := 1, powers := [(13, 1), (19, 1), (23, 1), (28, 1), (57, 1), (69, 1)] }],
...
#print axioms Krenn.Component65.SelectedLeafB6_5_7_3.selectedHasNoCommonZero

end Krenn.Component65.SelectedLeafB6_5_7_3
