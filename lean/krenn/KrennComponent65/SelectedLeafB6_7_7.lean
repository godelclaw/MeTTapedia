...
namespace Krenn.Component65.SelectedLeafB6_7_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "4d34b11de6e1c2761765fd50770e193ccf1dba05417e17dde7f181099aa14912"
def certificateSHA256 : String := "9603d9c8eab10de174a2cc3e0ef1220283b04fec20609a994837fb2bfdfed34a"
...
def multipliers : Fin 22 → SparsePoly (Fin 69) := ![
  [{ coefficient := 2, powers := [(23, 1), (43, 1), (57, 1), (66, 1)] }, { coefficient := 2, powers := [(28, 1), (43, 1), (47, 1), (66, 1)] }],
  ...
  [{ coefficient := -2, powers := [(23, 1), (57, 1), (66, 1)] }, { coefficient := -2, powers := [(28, 1), (47, 1), (66, 1)] }],
  ...
  [{ coefficient := 1, powers := [(37, 1), (60, 1)] }, { coefficient := -1, powers := [(39, 1), (40, 1), (57, 1), (64, 1)] }, { coefficient := -1, powers := [(40, 1), (45, 1), (53, 1), (64, 1)] }, { coefficient := -1, powers := [(40, 1), (56, 1), (57, 1), (67, 1)] }, { coefficient := 1, powers := [(40, 1), (57, 1)] }, { coefficient := -1, powers := [(46, 1), (52, 1), (57, 1), (67, 1)] }, { coefficient := -1, powers := [(47, 1), (54, 1)] }],
...
#print axioms Krenn.Component65.SelectedLeafB6_7_7.selectedHasNoCommonZero

end Krenn.Component65.SelectedLeafB6_7_7
