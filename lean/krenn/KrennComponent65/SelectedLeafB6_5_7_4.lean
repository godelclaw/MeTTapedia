...
namespace Krenn.Component65.SelectedLeafB6_5_7_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "7cb90c36cfc8966b96d50770cce733ed2388a625f9dafacfc1368990285af28d"
...
def multipliers : Fin 7 → SparsePoly (Fin 69) := ![
  [{ coefficient := -1, powers := [(20, 1), (64, 1), (68, 1)] }],
  [{ coefficient := -1, powers := [(49, 1), (64, 1), (68, 1)] }],
  [{ coefficient := 1, powers := [(64, 1), (68, 1)] }],
  [{ coefficient := 1, powers := [(20, 1), (49, 1), (64, 1), (68, 1)] }],
  [{ coefficient := -1, powers := [(20, 1), (24, 1), (49, 1), (64, 1), (68, 1)] }],
...
#print axioms Krenn.Component65.SelectedLeafB6_5_7_4.selectedHasNoCommonZero

end Krenn.Component65.SelectedLeafB6_5_7_4
