...
namespace Krenn.Component65.SelectedLeafB4_1_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "8da71d995878fb0898ccf67ac51b45a6dbff47de13fb6fcb3ae0ab1cd6d25992"
...
def multipliers : Fin 10 → SparsePoly (Fin 66) := ![
  [{ coefficient := -1, powers := [(20, 1), (51, 1), (57, 1), (62, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(25, 1), (51, 1), (65, 1)] }, { coefficient := -1, powers := [(53, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(49, 1), (51, 1), (57, 1), (62, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(24, 1), (53, 1), (65, 1)] }, { coefficient := -1, powers := [(25, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(51, 1), (57, 1), (62, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(20, 1), (49, 1), (51, 1), (57, 1), (62, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (51, 1), (65, 1)] }, { coefficient := 1, powers := [(65, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (24, 1), (51, 1), (57, 1), (65, 1)] }, { coefficient := -1, powers := [(0, 1), (57, 1), (65, 1)] }, { coefficient := -1, powers := [(20, 1), (24, 1), (49, 1), (51, 1), (57, 1), (62, 1), (65, 1)] }],
...
#print axioms Krenn.Component65.SelectedLeafB4_1_7.selectedHasNoCommonZero

end Krenn.Component65.SelectedLeafB4_1_7
