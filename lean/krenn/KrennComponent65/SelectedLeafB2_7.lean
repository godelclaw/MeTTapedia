...
namespace Krenn.Component65.SelectedLeafB2_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "02eae335e7fa0fe6d76a3fa4792081406dd79ae2fc14c25e70e31f8c08df5ff4"
def certificateSHA256 : String := "d8d3dc5d5431d77973157be18b3619ea3684fad461c3f53f0b0e95727587b841"
...
def multipliers : Fin 33 → SparsePoly (Fin 65) := ![
  [{ coefficient := 1, powers := [(6, 1), (20, 1), (31, 1), (49, 1), (51, 1), (57, 1), (64, 1)] }, { coefficient := -1, powers := [(6, 1), (31, 1), (57, 1)] }],
  ...
  [{ coefficient := -1, powers := [(24, 1), (40, 1), (56, 1), (57, 1)] }, { coefficient := -1, powers := [(24, 1), (46, 1), (52, 1), (57, 1)] }, { coefficient := 1, powers := [(37, 1), (60, 1)] }, { coefficient := -1, powers := [(39, 1), (40, 1), (57, 1), (63, 1)] }, { coefficient := -1, powers := [(40, 1), (45, 1), (53, 1), (63, 1)] }, { coefficient := 1, powers := [(40, 1), (57, 1)] }, { coefficient := -1, powers := [(47, 1), (54, 1)] }],
...
#print axioms Krenn.Component65.SelectedLeafB2_7.selectedHasNoCommonZero

end Krenn.Component65.SelectedLeafB2_7
