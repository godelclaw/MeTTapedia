...
namespace Krenn.Component65.SelectedLeafB0_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "f87e415c15eacb3050e6be2af232e45e9982babdf58239ee4c8e27ac35089662"
def certificateSHA256 : String := "b054ec6a4bf2507fe1341d37baa5d9d5c99c53c972adb85fb7bd6a4820d7d216"
...
def multipliers : Fin 25 → SparsePoly (Fin 62) := ![
  ...
  [{ coefficient := 1, powers := [(5, 1), (25, 1), (59, 1)] }],
  ...
  [{ coefficient := 1, powers := [(5, 1), (25, 1), (31, 1), (44, 1)] }],
  [{ coefficient := 1, powers := [(28, 1)] }],
  [{ coefficient := 1, powers := [(23, 1)] }],
  [{ coefficient := 1, powers := [(18, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (31, 1), (42, 1)] }],
  [{ coefficient := 1, powers := [(13, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (25, 1), (31, 1), (45, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (31, 1)] }, { coefficient := -1, powers := [(13, 1), (23, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := -1, powers := [(5, 1), (31, 1), (39, 1), (57, 1)] }, { coefficient := 1, powers := [(5, 1), (31, 1), (42, 1), (44, 1), (53, 1)] }, { coefficient := -1, powers := [(5, 1), (31, 1), (45, 1), (53, 1)] }, { coefficient := 1, powers := [(13, 1), (23, 1), (39, 1), (57, 1)] }, { coefficient := 1, powers := [(13, 1), (23, 1), (45, 1), (53, 1)] }],
  [{ coefficient := 1, powers := [(37, 1), (60, 1)] }, { coefficient := 1, powers := [(40, 1), (57, 1)] }, { coefficient := -1, powers := [(47, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (24, 1), (25, 1), (31, 1), (42, 1), (44, 1)] }, { coefficient := 1, powers := [(5, 1), (24, 1), (25, 1), (31, 1), (45, 1)] }, { coefficient := 2, powers := [(13, 1), (19, 1), (28, 1), (47, 1)] }, { coefficient := 1, powers := [(13, 1), (23, 1), (25, 1), (42, 1)] }, { coefficient := 2, powers := [(18, 1), (23, 1), (24, 1), (54, 1)] }],
...
#print axioms Krenn.Component65.SelectedLeafB0_4.selectedHasNoCommonZero

end Krenn.Component65.SelectedLeafB0_4
