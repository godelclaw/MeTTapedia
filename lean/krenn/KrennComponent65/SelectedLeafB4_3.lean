...
namespace Krenn.Component65.SelectedLeafB4_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "04989c20ed3e0a052ec4a0dc8d5e8a9ea2f4ac4e30e7cf6320bd9a5e7f202baf"
def certificateSHA256 : String := "8ca24f97c2dcdb8fdf47986aaa52b018a9eee5e83884cf395db1e20667987dd3"
...
def multipliers : Fin 37 → SparsePoly (Fin 64) := ![
  [{ coefficient := 1, powers := [(0, 1), (31, 1), (35, 1), (42, 1), (53, 1), (61, 1)] }, { coefficient := -1, powers := [(0, 1), (31, 1), (35, 1), (57, 1), (61, 1)] }, { coefficient := 1, powers := [(3, 1), (24, 1), (31, 1), (42, 1), (53, 1), (61, 1)] }, { coefficient := -1, powers := [(3, 1), (24, 1), (31, 1), (57, 1), (61, 1)] }, { coefficient := -1, powers := [(3, 1), (25, 1), (31, 1), (42, 1), (61, 1)] }, { coefficient := 1, powers := [(6, 1), (19, 1), (31, 1), (42, 1), (53, 1), (61, 1)] }, { coefficient := -1, powers := [(6, 1), (19, 1), (31, 1), (57, 1), (61, 1)] }, { coefficient := -1, powers := [(6, 1), (20, 1), (31, 1), (49, 1), (57, 1), (61, 1), (63, 1)] }],
  ...
  [{ coefficient := -2, powers := [(23, 1), (44, 1), (54, 1)] }, { coefficient := -2, powers := [(28, 1), (40, 1), (51, 1)] }, { coefficient := -2, powers := [(28, 1), (40, 1), (56, 1)] }],
  ...
  [{ coefficient := 1, powers := [(5, 1), (31, 1), (53, 1), (61, 1)] }, { coefficient := 1, powers := [(13, 1), (23, 1), (44, 1), (53, 1)] }],
  [{ coefficient := 2, powers := [(13, 1), (28, 1), (51, 1)] }],
  [{ coefficient := 2, powers := [(18, 1), (23, 1), (44, 1)] }],
  [{ coefficient := 1, powers := [(54, 1)] }],
  [{ coefficient := 1, powers := [(47, 1)] }],
  [{ coefficient := -2, powers := [(18, 1), (23, 1)] }],
  [{ coefficient := -2, powers := [(13, 1), (28, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (31, 1), (49, 1), (57, 1), (61, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (31, 1), (42, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(28, 1)] }],
  [{ coefficient := 1, powers := [(23, 1)] }],
  [{ coefficient := 1, powers := [(18, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (31, 1), (61, 1)] }, { coefficient := -1, powers := [(13, 1), (23, 1), (44, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (31, 1), (57, 1), (61, 1), (63, 1)] }],
  [{ coefficient := -2, powers := [(0, 1), (40, 1), (44, 1), (62, 1)] }, { coefficient := -2, powers := [(24, 1), (40, 1), (44, 1), (62, 1)] }, { coefficient := -2, powers := [(24, 1), (40, 1)] }, { coefficient := -1, powers := [(40, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(13, 1)] }],
  [{ coefficient := 2, powers := [(8, 1), (34, 1), (40, 1)] }],
  [{ coefficient := 2, powers := [(18, 1), (28, 1), (40, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (31, 1), (42, 1), (53, 1), (61, 1)] }, { coefficient := 1, powers := [(5, 1), (31, 1), (57, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := -1, powers := [(5, 1), (31, 1), (57, 1)] }],
  [{ coefficient := 2, powers := [(0, 1), (39, 1), (40, 1), (44, 1), (57, 1), (62, 1)] }, { coefficient := 2, powers := [(0, 1), (40, 1), (44, 1), (45, 1), (53, 1), (62, 1)] }, { coefficient := 2, powers := [(24, 1), (39, 1), (40, 1), (44, 1), (57, 1), (62, 1)] }, { coefficient := 2, powers := [(24, 1), (39, 1), (40, 1), (57, 1)] }, { coefficient := 2, powers := [(24, 1), (40, 1), (44, 1), (45, 1), (53, 1), (62, 1)] }, { coefficient := 2, powers := [(24, 1), (40, 1), (45, 1), (53, 1)] }, { coefficient := 1, powers := [(37, 1), (60, 1)] }, { coefficient := 1, powers := [(39, 1), (40, 1), (57, 1), (62, 1)] }, { coefficient := 1, powers := [(40, 1), (45, 1), (53, 1), (62, 1)] }, { coefficient := 1, powers := [(40, 1), (57, 1)] }, { coefficient := -1, powers := [(47, 1), (54, 1)] }],
  ...
  [{ coefficient := 1, powers := [(5, 1), (24, 1), (31, 1), (57, 1), (61, 1)] }]
]
...
#print axioms Krenn.Component65.SelectedLeafB4_3.selectedHasNoCommonZero

end Krenn.Component65.SelectedLeafB4_3
