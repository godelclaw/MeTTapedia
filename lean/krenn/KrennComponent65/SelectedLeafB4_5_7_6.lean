...
namespace Krenn.Component65.SelectedLeafB4_5_7_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "2a71bc8bc223e515aaace60de644469273660a31ea258f9695450053edd2a0cc"
...
def multipliers : Fin 7 → SparsePoly (Fin 69) := ![
  [{ coefficient := -1, powers := [(20, 1), (63, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(49, 1), (63, 1), (67, 1)] }],
  [{ coefficient := 1, powers := [(63, 1), (67, 1)] }],
  [{ coefficient := 1, powers := [(20, 1), (49, 1), (63, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(20, 1), (24, 1), (49, 1), (63, 1), (67, 1)] }],
...
#print axioms Krenn.Component65.SelectedLeafB4_5_7_6.selectedHasNoCommonZero

end Krenn.Component65.SelectedLeafB4_5_7_6
