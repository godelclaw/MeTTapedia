...
namespace Krenn.Component65.SelectedLeafB4_5_7_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "d828c0dfd99fe62e642c326d5788d344f19bcbe929ab0b1143ea5bf0851ed696"
...
def multipliers : Fin 6 → SparsePoly (Fin 67) := ![
  ...
  [{ coefficient := -1, powers := [(25, 1), (39, 1), (42, 1), (51, 1), (66, 1)] }, { coefficient := -1, powers := [(25, 1), (45, 1), (51, 1), (66, 1)] }, { coefficient := 1, powers := [(39, 1), (42, 1), (53, 1), (66, 1)] }, { coefficient := 1, powers := [(45, 1), (53, 1), (66, 1)] }]
]
...
#print axioms Krenn.Component65.SelectedLeafB4_5_7_0.selectedHasNoCommonZero

end Krenn.Component65.SelectedLeafB4_5_7_0
