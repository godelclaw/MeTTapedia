...
namespace Krenn.Component65.SelectedLeafB6_5_6_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "860980b252ea0025ac392ad64f2f1b21f68ffb67757321dfb199f3eb5400d848"
def certificateSHA256 : String := "f6482f6c2564a557c2515183ebd759a19d7f04536a28265781cf941082f29eca"
...
def multipliers : Fin 22 → SparsePoly (Fin 69) := ![
  ...
  [{ coefficient := -1, powers := [(0, 1), (8, 1), (34, 1), (40, 1), (68, 1)] }],
  ...
  [{ coefficient := 1, powers := [(0, 1), (8, 1), (28, 1), (34, 1), (40, 1), (68, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (31, 1)] }, { coefficient := -1, powers := [(13, 1), (23, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (34, 1), (39, 1), (40, 1)] }, { coefficient := -1, powers := [(8, 1), (34, 1), (40, 1), (44, 1)] }, { coefficient := -2, powers := [(13, 1), (28, 1), (47, 1), (51, 1)] }, { coefficient := 2, powers := [(18, 1), (23, 1), (39, 1), (54, 1)] }, { coefficient := 1, powers := [(18, 1), (28, 1), (39, 1), (40, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (8, 1), (34, 1), (40, 1), (44, 1)] }]
]
...
#print axioms Krenn.Component65.SelectedLeafB6_5_6_3.selectedHasNoCommonZero

end Krenn.Component65.SelectedLeafB6_5_6_3
