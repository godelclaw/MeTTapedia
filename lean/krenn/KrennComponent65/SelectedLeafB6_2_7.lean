...
namespace Krenn.Component65.SelectedLeafB6_2_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "f6dbfa8126f00062e33354129a303dfa74c4673e5c35a2346ad49f00fdb56504"
...
def multipliers : Fin 21 → SparsePoly (Fin 67) := ![
  [{ coefficient := 2, powers := [(23, 1), (43, 1), (57, 1), (64, 1)] }, { coefficient := 2, powers := [(28, 1), (43, 1), (47, 1), (64, 1)] }],
  ...
  [{ coefficient := -2, powers := [(23, 1), (57, 1), (64, 1)] }, { coefficient := -2, powers := [(28, 1), (47, 1), (64, 1)] }],
...
#print axioms Krenn.Component65.SelectedLeafB6_2_7.selectedHasNoCommonZero

end Krenn.Component65.SelectedLeafB6_2_7
