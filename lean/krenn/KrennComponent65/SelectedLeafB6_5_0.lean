...
namespace Krenn.Component65.SelectedLeafB6_5_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "52d73e99d1c3bcdec8352064ef040c74f5c76c03acf67336266c48fae77459f5"
...
def multipliers : Fin 9 → SparsePoly (Fin 65) := ![
  ...
  [{ coefficient := -1, powers := [(20, 1), (64, 1)] }, { coefficient := 1, powers := [(24, 1), (46, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(44, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(20, 1), (52, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (44, 1), (64, 1)] }, { coefficient := 1, powers := [(64, 1)] }],
  [{ coefficient := -1, powers := [(20, 1), (24, 1), (52, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := 1, powers := [(0, 1), (24, 1), (40, 1), (44, 1), (64, 1)] }, { coefficient := -1, powers := [(0, 1), (40, 1), (64, 1)] }, { coefficient := 1, powers := [(20, 1), (24, 1), (44, 1), (49, 1), (64, 1)] }, { coefficient := -1, powers := [(24, 1), (46, 1), (49, 1), (64, 1)] }]
]
...
#print axioms Krenn.Component65.SelectedLeafB6_5_0.selectedHasNoCommonZero

end Krenn.Component65.SelectedLeafB6_5_0
