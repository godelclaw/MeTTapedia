...
namespace Krenn.Component65.SelectedLeafB4_2_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "5072e827fd500b2bd77efe91bbaf71cc33bd5db04de7f5c22ec10d391de53dc0"
def certificateSHA256 : String := "7db85101f06051437769bd091d73695deb5d3aa78867221f1a37eb51929549d6"
...
def multipliers : Fin 24 → SparsePoly (Fin 65) := ![
  ...
  [{ coefficient := -2, powers := [(28, 1), (47, 1), (51, 1), (57, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(23, 1), (45, 1), (57, 1), (64, 1)] }, { coefficient := 2, powers := [(23, 1), (45, 1)] }],
  [{ coefficient := -2, powers := [(23, 1), (44, 1), (54, 1), (57, 1), (64, 1)] }, { coefficient := 2, powers := [(23, 1), (44, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [(28, 1), (52, 1), (57, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (53, 1), (57, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(18, 1), (46, 1), (57, 1), (64, 1)] }],
  [{ coefficient := 2, powers := [(8, 1), (60, 1)] }],
  [{ coefficient := 2, powers := [(13, 1), (28, 1), (51, 1), (57, 1), (64, 1)] }],
  [{ coefficient := 2, powers := [(18, 1), (23, 1), (44, 1), (57, 1), (64, 1)] }, { coefficient := -2, powers := [(18, 1), (23, 1), (44, 1)] }],
  [{ coefficient := 1, powers := [(54, 1), (57, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(47, 1), (57, 1), (64, 1)] }],
  [{ coefficient := -2, powers := [(18, 1), (23, 1), (57, 1), (64, 1)] }, { coefficient := 2, powers := [(18, 1), (23, 1)] }],
  [{ coefficient := -2, powers := [(13, 1), (28, 1), (57, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(28, 1), (57, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(23, 1), (57, 1), (64, 1)] }, { coefficient := -2, powers := [(23, 1)] }],
  ...
  [{ coefficient := 1, powers := [(37, 1), (57, 1), (60, 1), (64, 1)] }, { coefficient := -1, powers := [(40, 1), (56, 1), (57, 1), (63, 1)] }, { coefficient := 1, powers := [(40, 1), (57, 2), (64, 1)] }, { coefficient := -1, powers := [(46, 1), (52, 1), (57, 1), (63, 1)] }, { coefficient := -1, powers := [(47, 1), (54, 1), (57, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (34, 1), (57, 1), (64, 1)] }, { coefficient := -1, powers := [(18, 1), (28, 1), (57, 1), (64, 1)] }],
...
#print axioms Krenn.Component65.SelectedLeafB4_2_3.selectedHasNoCommonZero

end Krenn.Component65.SelectedLeafB4_2_3
