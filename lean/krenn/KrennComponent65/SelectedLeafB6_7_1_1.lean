...
namespace Krenn.Component65.SelectedLeafB6_7_1_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "2465926bd42618cbedf8b6bfff429e401a42405cc92f4b2206776237140eac27"
...
def multipliers : Fin 9 → SparsePoly (Fin 68) := ![
  [{ coefficient := 1, powers := [(20, 1), (44, 1), (65, 1), (67, 1)] }, { coefficient := -1, powers := [(46, 1), (65, 1), (67, 1)] }],
...
#print axioms Krenn.Component65.SelectedLeafB6_7_1_1.selectedHasNoCommonZero

end Krenn.Component65.SelectedLeafB6_7_1_1
