...
namespace Krenn.Component65.SelectedLeafB4_2_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "43da04567ffed90ab700ffc1a7518cc42c9ecd1e9a311fa776031016702fa536"
def certificateSHA256 : String := "94aa1fe4a9e0f8f48c6ab14c4ceb5c2e295c515252c3f410f916c90d27baf32a"
...
def multipliers : Fin 21 → SparsePoly (Fin 66) := ![
  [{ coefficient := 2, powers := [(23, 1), (43, 1), (57, 1), (63, 1)] }, { coefficient := 2, powers := [(28, 1), (43, 1), (47, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(23, 1), (45, 1)] }],
  [{ coefficient := -2, powers := [(23, 1), (44, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [(28, 1), (52, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (53, 1)] }],
  [{ coefficient := -1, powers := [(18, 1), (46, 1)] }],
  [{ coefficient := -2, powers := [(23, 1), (57, 1), (63, 1)] }, { coefficient := -2, powers := [(28, 1), (47, 1), (63, 1)] }],
...
#print axioms Krenn.Component65.SelectedLeafB4_2_7.selectedHasNoCommonZero

end Krenn.Component65.SelectedLeafB4_2_7
