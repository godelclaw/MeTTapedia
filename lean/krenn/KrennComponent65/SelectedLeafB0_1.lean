...
namespace Krenn.Component65.SelectedLeafB0_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "0f0e81919681c4c4600258e77dc39419e918fdb29bf1f21ed67b98b0c44d0f17"
...
def multipliers : Fin 7 → SparsePoly (Fin 62) := ![
  [{ coefficient := -1, powers := [(20, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(49, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(61, 1)] }],
  [{ coefficient := 1, powers := [(20, 1), (49, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(20, 1), (36, 1), (49, 1), (59, 1), (61, 1)] }, { coefficient := -1, powers := [(20, 1), (39, 1), (49, 1), (56, 1), (61, 1)] }, { coefficient := -1, powers := [(20, 1), (44, 1), (49, 1), (51, 1), (61, 1)] }, { coefficient := 1, powers := [(20, 1), (44, 1), (52, 1), (61, 1)] }, { coefficient := -1, powers := [(40, 1), (56, 1), (61, 1)] }, { coefficient := 1, powers := [(46, 1), (49, 1), (51, 1), (61, 1)] }, { coefficient := -1, powers := [(46, 1), (52, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(20, 1), (49, 1), (61, 1)] }],
...
#print axioms Krenn.Component65.SelectedLeafB0_1.selectedHasNoCommonZero

end Krenn.Component65.SelectedLeafB0_1
