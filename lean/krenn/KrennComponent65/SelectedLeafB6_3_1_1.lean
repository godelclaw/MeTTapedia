...
namespace Krenn.Component65.SelectedLeafB6_3_1_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "67022a50e4224d216adc296fef2e3bd0a11a63d8e8186d948602d550e59a514c"
...
def multipliers : Fin 9 → SparsePoly (Fin 67) := ![
  [{ coefficient := 1, powers := [(20, 1), (44, 1), (64, 1), (66, 1)] }, { coefficient := -1, powers := [(46, 1), (64, 1), (66, 1)] }],
  ...
  [{ coefficient := -1, powers := [(20, 1), (39, 1), (52, 1), (64, 1)] }, { coefficient := -1, powers := [(20, 1), (44, 1), (52, 1), (64, 1)] }, { coefficient := 1, powers := [(46, 1), (52, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(20, 1), (44, 1), (49, 1), (64, 1)] }, { coefficient := 1, powers := [(46, 1), (49, 1), (64, 1)] }]
]
...
#print axioms Krenn.Component65.SelectedLeafB6_3_1_1.selectedHasNoCommonZero

end Krenn.Component65.SelectedLeafB6_3_1_1
