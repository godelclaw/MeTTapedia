...
namespace Krenn.Component65.SelectedLeafB4_6_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "c25962fe44ee5ba5d95d040564efbe496e4b2c6d5023a46f65c22192063b7f9f"
...
def multipliers : Fin 22 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := 2, powers := [(23, 1), (50, 1), (54, 1), (57, 1), (62, 1), (65, 1)] }],
  ...
  [{ coefficient := -1, powers := [(13, 1), (14, 1), (19, 1), (23, 1), (57, 1), (64, 1)] }, { coefficient := 1, powers := [(13, 1), (19, 1), (23, 1), (57, 2), (65, 1)] }, { coefficient := 2, powers := [(13, 1), (19, 1), (28, 1), (47, 1), (57, 1), (65, 1)] }],
...
#print axioms Krenn.Component65.SelectedLeafB4_6_5.selectedHasNoCommonZero

end Krenn.Component65.SelectedLeafB4_6_5
