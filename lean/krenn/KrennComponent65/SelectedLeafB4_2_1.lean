...
namespace Krenn.Component65.SelectedLeafB4_2_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "3206885bae3fe8215c3f0c65aa61a8e9584c283a0510ec2de053d50e2814451e"
def certificateSHA256 : String := "493bd072fcfe92eaad54ede6acc295ce011df7c952f2e0aac67817a2f715b0e5"
...
def multipliers : Fin 32 → SparsePoly (Fin 64) := ![
  ...
  [{ coefficient := -2, powers := [(0, 1), (23, 1), (54, 1)] }, { coefficient := -2, powers := [(23, 1), (54, 1), (62, 1)] }],
  [{ coefficient := 2, powers := [(0, 1), (18, 1), (54, 1)] }, { coefficient := 2, powers := [(18, 1), (54, 1), (62, 1)] }],
  ...
  [{ coefficient := 1, powers := [(0, 1), (25, 1), (44, 1), (51, 1), (63, 1)] }, { coefficient := 1, powers := [(5, 1), (25, 1), (31, 1), (44, 1)] }, { coefficient := 1, powers := [(25, 1), (51, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (31, 1), (53, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (42, 1), (44, 1), (51, 1), (63, 1)] }, { coefficient := 1, powers := [(5, 1), (31, 1), (42, 1), (44, 1)] }, { coefficient := -1, powers := [(5, 1), (31, 1), (45, 1)] }, { coefficient := 1, powers := [(42, 1), (51, 1), (63, 1)] }],
  ...
  [{ coefficient := -1, powers := [(0, 1), (44, 1), (51, 1), (63, 1)] }, { coefficient := -1, powers := [(51, 1), (63, 1)] }],
  ...
  [{ coefficient := -1, powers := [(0, 1), (25, 1), (42, 1), (44, 1), (51, 1), (63, 1)] }, { coefficient := 1, powers := [(0, 1), (44, 1)] }, { coefficient := -1, powers := [(5, 1), (25, 1), (31, 1), (42, 1), (44, 1)] }, { coefficient := -1, powers := [(25, 1), (42, 1), (51, 1), (63, 1)] }, { coefficient := 1, powers := [] }],
  ...
  [{ coefficient := 1, powers := [(0, 3), (39, 1), (61, 1)] }, { coefficient := 1, powers := [(0, 2), (13, 1), (19, 1), (23, 1), (36, 1), (57, 1), (59, 1)] }, { coefficient := 2, powers := [(0, 2), (13, 1), (19, 1), (28, 1), (36, 1), (47, 1), (59, 1)] }, { coefficient := 1, powers := [(0, 2), (61, 1)] }, { coefficient := -1, powers := [(0, 1), (3, 1), (13, 1), (19, 1), (23, 1), (44, 1), (57, 1), (59, 1)] }, { coefficient := -2, powers := [(0, 1), (3, 1), (13, 1), (19, 1), (28, 1), (44, 1), (47, 1), (59, 1)] }, { coefficient := 1, powers := [(0, 1), (13, 1), (19, 1), (23, 1), (39, 1), (57, 1)] }, { coefficient := 2, powers := [(0, 1), (13, 1), (19, 1), (28, 1), (39, 1), (47, 1)] }, { coefficient := -2, powers := [(0, 1), (18, 1), (23, 1), (54, 1)] }, { coefficient := 1, powers := [(0, 1), (19, 1), (25, 1), (42, 1), (44, 1), (51, 1), (63, 1)] }, { coefficient := -1, powers := [(0, 1), (19, 1), (44, 1)] }, { coefficient := -1, powers := [(3, 1), (13, 1), (19, 1), (23, 1), (57, 1), (59, 1)] }, { coefficient := -2, powers := [(3, 1), (13, 1), (19, 1), (28, 1), (47, 1), (59, 1)] }, { coefficient := 1, powers := [(5, 1), (19, 1), (25, 1), (31, 1), (42, 1), (44, 1)] }, { coefficient := 1, powers := [(13, 1), (19, 1), (23, 1), (57, 1)] }, { coefficient := 2, powers := [(13, 1), (19, 1), (28, 1), (47, 1)] }, { coefficient := -2, powers := [(18, 1), (23, 1), (54, 1), (62, 1)] }, { coefficient := 1, powers := [(19, 1), (25, 1), (42, 1), (51, 1), (63, 1)] }, { coefficient := -1, powers := [(19, 1)] }],
...
#print axioms Krenn.Component65.SelectedLeafB4_2_1.selectedHasNoCommonZero

end Krenn.Component65.SelectedLeafB4_2_1
