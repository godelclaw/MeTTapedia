...
namespace Krenn.Component65.SelectedLeafB6_3_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "f3939d4317904a8bfd533c61225f6e8570d597c4613007eba94292f4abf0181f"
def certificateSHA256 : String := "c203db63af4d361a3e0181723508d4668c2fba5489430946a7ad08f35f8a3d6c"
...
def multipliers : Fin 28 → SparsePoly (Fin 68) := ![
  ...
  [{ coefficient := 2, powers := [(23, 1), (43, 1), (57, 1), (65, 1)] }, { coefficient := 2, powers := [(28, 1), (43, 1), (47, 1), (65, 1)] }],
  ...
  [{ coefficient := -2, powers := [(23, 1), (57, 1), (65, 1)] }, { coefficient := -2, powers := [(28, 1), (47, 1), (65, 1)] }],
  ...
  [{ coefficient := 2, powers := [(13, 1), (23, 1), (57, 1)] }, { coefficient := 2, powers := [(13, 1), (28, 1), (47, 1)] }],
...
#print axioms Krenn.Component65.SelectedLeafB6_3_7.selectedHasNoCommonZero

end Krenn.Component65.SelectedLeafB6_3_7
