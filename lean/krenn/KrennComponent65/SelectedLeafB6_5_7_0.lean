...
namespace Krenn.Component65.SelectedLeafB6_5_7_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "6ba15d79976b2ea4175503424cf09787e67c614aa0fa1e13bdfd23a62b58c462"
...
def multipliers : Fin 6 → SparsePoly (Fin 68) := ![
  [{ coefficient := 1, powers := [(25, 1), (51, 1), (67, 1)] }, { coefficient := -1, powers := [(53, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(25, 1), (67, 1)] }],
  [{ coefficient := 1, powers := [(67, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (57, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := -1, powers := [(25, 1), (39, 1), (42, 1), (51, 1), (67, 1)] }, { coefficient := -1, powers := [(25, 1), (45, 1), (51, 1), (67, 1)] }, { coefficient := 1, powers := [(39, 1), (42, 1), (53, 1), (67, 1)] }, { coefficient := 1, powers := [(45, 1), (53, 1), (67, 1)] }]
]
...
#print axioms Krenn.Component65.SelectedLeafB6_5_7_0.selectedHasNoCommonZero

end Krenn.Component65.SelectedLeafB6_5_7_0
