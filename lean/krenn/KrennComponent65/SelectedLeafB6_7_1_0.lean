...
namespace Krenn.Component65.SelectedLeafB6_7_1_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "e8c6b56651e873f614796889109dc6e6d3b4fc64177e2bf62904a21779e2b93c"
...
def multipliers : Fin 9 → SparsePoly (Fin 67) := ![
  ...
  [{ coefficient := -1, powers := [(20, 1), (39, 1), (52, 1), (65, 1)] }, { coefficient := -1, powers := [(20, 1), (44, 1), (52, 1), (65, 1)] }, { coefficient := -1, powers := [(40, 1), (44, 1), (65, 1)] }, { coefficient := 1, powers := [(46, 1), (52, 1), (65, 1)] }]
]
...
#print axioms Krenn.Component65.SelectedLeafB6_7_1_0.selectedHasNoCommonZero

end Krenn.Component65.SelectedLeafB6_7_1_0
