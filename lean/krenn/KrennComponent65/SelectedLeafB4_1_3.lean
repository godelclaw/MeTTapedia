...
namespace Krenn.Component65.SelectedLeafB4_1_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "ed181f154a8cb49c2d7e7db568f6f90863d5883c09b1a13c245a68bf30cf36e6"
...
def multipliers : Fin 10 → SparsePoly (Fin 65) := ![
  [{ coefficient := -1, powers := [(20, 1), (51, 1), (57, 1), (62, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(25, 1), (51, 1), (64, 1)] }, { coefficient := -1, powers := [(53, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(49, 1), (51, 1), (57, 1), (62, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(24, 1), (53, 1), (64, 1)] }, { coefficient := -1, powers := [(25, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(51, 1), (57, 1), (62, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(20, 1), (49, 1), (51, 1), (57, 1), (62, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (51, 1), (64, 1)] }, { coefficient := 1, powers := [(64, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (24, 1), (51, 1), (57, 1), (64, 1)] }, { coefficient := -1, powers := [(0, 1), (57, 1), (64, 1)] }, { coefficient := -1, powers := [(20, 1), (24, 1), (49, 1), (51, 1), (57, 1), (62, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (51, 1), (57, 1), (64, 1)] }],
...
#print axioms Krenn.Component65.SelectedLeafB4_1_3.selectedHasNoCommonZero

end Krenn.Component65.SelectedLeafB4_1_3
