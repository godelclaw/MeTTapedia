...
namespace Krenn.Component65.SelectedLeafB4_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "8138762b17737f2cf0bde8917ec24c6129db8e4ab0e48cf95935b0bb5da3d63f"
def certificateSHA256 : String := "a7eec272c16ab51d022937513c99e7b9369252f033d3c286903fbb5166ec33f8"
...
def selectedEquations : Fin 28 → SparsePoly (Fin 62) := ![
  ...
  [{ coefficient := 1, powers := [(23, 1), (53, 1)] }, { coefficient := 1, powers := [(28, 1), (46, 1)] }],
  ...
  [{ coefficient := 1, powers := [(28, 1), (39, 1), (42, 1)] }, { coefficient := 1, powers := [(28, 1), (45, 1)] }],
...
def multipliers : Fin 28 → SparsePoly (Fin 62) := ![
  ...
  [{ coefficient := -1, powers := [(13, 1), (25, 1), (51, 1)] }],
  [{ coefficient := -1, powers := [(18, 1), (46, 1)] }],
  [{ coefficient := 2, powers := [(19, 1), (28, 1), (47, 1)] }],
  [{ coefficient := 1, powers := [(13, 1), (19, 1), (25, 1), (45, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (19, 1), (45, 1)] }],
  [{ coefficient := -2, powers := [(13, 1), (19, 1), (47, 1)] }],
  [{ coefficient := -2, powers := [(28, 1), (47, 1)] }],
  [{ coefficient := -2, powers := [(23, 1), (54, 1)] }],
  [{ coefficient := 1, powers := [(13, 1), (19, 1), (46, 1)] }],
  [{ coefficient := 1, powers := [(54, 1)] }],
  [{ coefficient := 1, powers := [(47, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (31, 1), (53, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (31, 1), (45, 1)] }, { coefficient := 1, powers := [(13, 1), (23, 1), (45, 1)] }],
  ...
  [{ coefficient := -1, powers := [(0, 1), (5, 1), (31, 1), (57, 1)] }, { coefficient := 1, powers := [(0, 1), (13, 1), (23, 1), (57, 1)] }, { coefficient := 1, powers := [(5, 1), (24, 1), (31, 1), (42, 1), (53, 1)] }, { coefficient := -1, powers := [(5, 1), (25, 1), (31, 1), (42, 1)] }, { coefficient := -1, powers := [(13, 1), (19, 1), (28, 1), (42, 1), (46, 1)] }, { coefficient := 2, powers := [(13, 1), (19, 1), (28, 1), (47, 1)] }, { coefficient := 2, powers := [(18, 1), (23, 1), (24, 1), (54, 1)] }],
...
#print axioms Krenn.Component65.SelectedLeafB4_0.selectedHasNoCommonZero

end Krenn.Component65.SelectedLeafB4_0
