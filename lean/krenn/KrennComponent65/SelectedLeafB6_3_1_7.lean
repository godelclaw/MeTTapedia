...
namespace Krenn.Component65.SelectedLeafB6_3_1_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "ff3b620e1390ddd13dc493c32e8ab7612d2fb56a3b53ec825c7b8b8c8d233d0a"
...
def multipliers : Fin 25 → SparsePoly (Fin 69) := ![
  ...
  [{ coefficient := -1, powers := [(19, 1), (24, 1), (44, 1), (68, 1)] }, { coefficient := -1, powers := [(24, 1), (68, 1)] }],
  [{ coefficient := 1, powers := [(24, 1), (44, 1), (68, 1)] }],
  ...
  [{ coefficient := -1, powers := [(0, 1), (25, 1), (42, 1), (44, 2), (65, 1)] }, { coefficient := -1, powers := [(24, 1), (28, 1), (44, 1), (68, 1)] }, { coefficient := 1, powers := [(24, 1), (44, 1)] }],
  ...
  [{ coefficient := 1, powers := [(0, 1), (19, 1), (25, 1), (42, 1), (44, 2), (65, 1)] }, { coefficient := 1, powers := [(19, 1), (24, 1), (28, 1), (44, 1), (68, 1)] }, { coefficient := -1, powers := [(19, 1), (24, 1), (44, 1)] }],
...
#print axioms Krenn.Component65.SelectedLeafB6_3_1_7.selectedHasNoCommonZero

end Krenn.Component65.SelectedLeafB6_3_1_7
