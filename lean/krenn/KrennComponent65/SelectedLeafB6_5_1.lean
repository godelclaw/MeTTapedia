...
namespace Krenn.Component65.SelectedLeafB6_5_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "adec20515635b7b7a6e43bff5ac4deb8b4a91b5e692b555d58f3afd5a7521e81"
...
def multipliers : Fin 27 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := -1, powers := [(5, 1), (20, 1), (31, 1), (51, 1), (57, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (31, 1), (49, 1), (51, 1), (57, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(28, 1)] }],
  [{ coefficient := 1, powers := [(23, 1)] }],
  [{ coefficient := 1, powers := [(18, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (31, 1), (51, 1), (57, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(13, 1)] }],
  [{ coefficient := 1, powers := [(40, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (20, 1), (31, 1), (49, 1), (51, 1), (57, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (31, 1), (57, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (31, 1), (51, 1), (57, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := -1, powers := [(25, 1), (40, 1), (42, 1), (50, 1), (63, 1)] }, { coefficient := 1, powers := [(37, 1), (60, 1)] }, { coefficient := -1, powers := [(38, 1), (40, 1), (57, 1), (63, 1)] }, { coefficient := 1, powers := [(40, 1), (57, 1)] }, { coefficient := -1, powers := [(47, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (34, 1), (40, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (20, 1), (24, 1), (31, 1), (49, 1), (51, 1), (57, 1), (64, 1)] }, { coefficient := -1, powers := [(9, 1), (18, 1), (24, 1), (28, 1), (40, 1), (63, 1)] }, { coefficient := 2, powers := [(18, 1), (23, 1), (24, 1), (54, 1)] }, { coefficient := 1, powers := [(18, 1), (24, 1), (28, 1), (40, 1)] }],
...
#print axioms Krenn.Component65.SelectedLeafB6_5_1.selectedHasNoCommonZero

end Krenn.Component65.SelectedLeafB6_5_1
