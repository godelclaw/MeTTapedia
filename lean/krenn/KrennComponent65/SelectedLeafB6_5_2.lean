...
namespace Krenn.Component65.SelectedLeafB6_5_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "0e61b44482445ab3c688e8e9ce799ef275ce47f2cd4046fa4ae9fc44d0a9a8cb"
...
def multipliers : Fin 22 → SparsePoly (Fin 66) := ![
  [{ coefficient := -1, powers := [(23, 1), (40, 1), (45, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(28, 1), (40, 1), (52, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (40, 1), (53, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(18, 1), (40, 1), (46, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(18, 1), (40, 1), (63, 1)] }],
  [{ coefficient := -2, powers := [(28, 1), (40, 1), (47, 1), (64, 1), (65, 1)] }],
  [{ coefficient := 2, powers := [(13, 1), (40, 1), (47, 1), (64, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(9, 1), (28, 1), (40, 1), (63, 1)] }, { coefficient := -2, powers := [(23, 1), (40, 1), (54, 1), (64, 1)] }, { coefficient := -1, powers := [(28, 1), (40, 2), (64, 1)] }],
  [{ coefficient := 1, powers := [(40, 1), (54, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(40, 1), (47, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(28, 1), (40, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(23, 1), (40, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(18, 1), (40, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(13, 1), (40, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(40, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(40, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(25, 1), (40, 1), (42, 1), (50, 1), (63, 1)] }, { coefficient := 1, powers := [(37, 1), (40, 1), (60, 1), (64, 1)] }, { coefficient := -1, powers := [(38, 1), (40, 1), (57, 1), (63, 1)] }, { coefficient := 1, powers := [(40, 2), (57, 1), (64, 1)] }, { coefficient := -1, powers := [(40, 1), (47, 1), (54, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (34, 1), (40, 1)] }],
  [{ coefficient := -1, powers := [(9, 1), (18, 1), (24, 1), (28, 1), (40, 1), (63, 1)] }, { coefficient := -2, powers := [(13, 1), (28, 1), (40, 1), (47, 1), (64, 1), (65, 1)] }, { coefficient := 2, powers := [(18, 1), (23, 1), (24, 1), (40, 1), (54, 1), (64, 1)] }, { coefficient := 1, powers := [(18, 1), (24, 1), (28, 1), (40, 2), (64, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (34, 1), (40, 1)] }, { coefficient := -1, powers := [] }],
  [{ coefficient := 2, powers := [(13, 1), (28, 1), (40, 1), (47, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (31, 1), (40, 1), (64, 1)] }, { coefficient := -1, powers := [(13, 1), (23, 1), (40, 1), (64, 1)] }]
]
...
#print axioms Krenn.Component65.SelectedLeafB6_5_2.selectedHasNoCommonZero

end Krenn.Component65.SelectedLeafB6_5_2
