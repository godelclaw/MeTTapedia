...
namespace Krenn.Component65.SelectedLeafB6_6_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "95ceaeb52ba5906683a64094c700cd228a7ff2b3997adcc2beca3bbb7a51091e"
...
def multipliers : Fin 24 → SparsePoly (Fin 67) := ![
  ...
  [{ coefficient := -2, powers := [(28, 1), (47, 1), (51, 1), (57, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(23, 1), (45, 1), (57, 1), (66, 1)] }, { coefficient := 2, powers := [(23, 1), (45, 1)] }],
  [{ coefficient := 2, powers := [(23, 1), (50, 1), (54, 1), (57, 1), (63, 1), (66, 1)] }, { coefficient := -2, powers := [(23, 1), (50, 1), (54, 1), (63, 1)] }],
  ...
  [{ coefficient := -2, powers := [(23, 1), (54, 1), (57, 1), (63, 1), (66, 1)] }, { coefficient := 2, powers := [(23, 1), (54, 1), (63, 1)] }],
  [{ coefficient := 2, powers := [(13, 1), (28, 1), (51, 1), (57, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(54, 1), (57, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(47, 1), (57, 1), (66, 1)] }],
  [{ coefficient := -2, powers := [(13, 1), (28, 1), (57, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(28, 1), (57, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(23, 1), (57, 1), (66, 1)] }, { coefficient := -2, powers := [(23, 1)] }],
  ...
  [{ coefficient := 1, powers := [(37, 1), (57, 1), (60, 1), (66, 1)] }, { coefficient := -1, powers := [(40, 1), (56, 1), (57, 1), (65, 1)] }, { coefficient := 1, powers := [(40, 1), (57, 2), (66, 1)] }, { coefficient := -1, powers := [(46, 1), (52, 1), (57, 1), (65, 1)] }, { coefficient := -1, powers := [(47, 1), (54, 1), (57, 1), (66, 1)] }],
  [{ coefficient := 2, powers := [(18, 1), (23, 1), (54, 1), (57, 1), (66, 1)] }, { coefficient := -2, powers := [(18, 1), (23, 1), (54, 1)] }],
...
#print axioms Krenn.Component65.SelectedLeafB6_6_3.selectedHasNoCommonZero

end Krenn.Component65.SelectedLeafB6_6_3
