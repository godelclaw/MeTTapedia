...
namespace Krenn.Component65.SelectedLeafB4_5_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "fed5b0a465e5ed3808810ee30ca93ccf9bfd01a2cb0145678d10cdfce7df6854"
...
def multipliers : Fin 22 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := 1, powers := [(14, 1), (23, 1), (57, 1), (64, 1)] }, { coefficient := -1, powers := [(23, 1), (57, 1)] }, { coefficient := -2, powers := [(28, 1), (47, 1)] }],
  ...
  [{ coefficient := -1, powers := [(20, 1), (43, 1), (49, 1), (57, 1), (64, 1)] }, { coefficient := -1, powers := [(25, 1), (40, 1), (42, 1), (50, 1), (62, 1)] }, { coefficient := 1, powers := [(37, 1), (60, 1)] }, { coefficient := -1, powers := [(38, 1), (40, 1), (57, 1), (62, 1)] }, { coefficient := -1, powers := [(40, 1), (55, 1), (57, 1), (64, 1)] }, { coefficient := 1, powers := [(40, 1), (57, 1)] }, { coefficient := -1, powers := [(47, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (34, 1), (40, 1)] }],
  [{ coefficient := -1, powers := [(9, 1), (18, 1), (24, 1), (28, 1), (40, 1), (62, 1)] }, { coefficient := 2, powers := [(18, 1), (23, 1), (24, 1), (54, 1)] }, { coefficient := 1, powers := [(18, 1), (24, 1), (28, 1), (40, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (31, 1), (57, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (14, 1), (19, 1), (23, 1), (57, 1), (64, 1)] }, { coefficient := 1, powers := [(13, 1), (19, 1), (23, 1), (57, 1)] }, { coefficient := 2, powers := [(13, 1), (19, 1), (28, 1), (47, 1)] }]
]
...
#print axioms Krenn.Component65.SelectedLeafB4_5_5.selectedHasNoCommonZero

end Krenn.Component65.SelectedLeafB4_5_5
