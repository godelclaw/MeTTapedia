...
namespace Krenn.X5Case1079Tree.LeafB7

open Krenn.SparseCertificate
open MvPolynomial

def sourceSystemFileSHA256 : String := "a9dfb44822bdf18755550ca01918e3bcbdae1411625cee32b2c44102e2e50820"
def sourceSystemSemanticSHA256 : String := "f95324dd923bb2941db6d041ea82894949214646c35a316b3fca9ecf62f6da91"
def certificateSHA256 : String := "c9e4a4cfbee8f9f10bf2ca7ebb6feb34ad3a89306561ea11d6e21c64c44771a1"
...
def multipliers : Fin 15 → SparsePoly (Fin 73) := ![
  ...
  [{ coefficient := -1, powers := [(0, 1), (34, 1), (40, 1), (47, 1), (57, 1)] }, { coefficient := -1, powers := [(0, 1), (34, 1), (43, 1), (47, 1), (54, 1)] }, { coefficient := 1, powers := [(5, 1), (8, 1), (34, 1), (40, 1), (47, 1), (57, 1)] }, { coefficient := 1, powers := [(5, 1), (8, 1), (34, 1), (43, 1), (47, 1), (54, 1)] }],
  ...
  [{ coefficient := 1, powers := [(0, 1), (34, 1), (40, 1), (57, 1)] }, { coefficient := 1, powers := [(0, 1), (34, 1), (43, 1), (54, 1)] }, { coefficient := -1, powers := [(5, 1), (8, 1), (34, 1), (40, 1), (57, 1)] }, { coefficient := -1, powers := [(5, 1), (8, 1), (34, 1), (43, 1), (54, 1)] }],
...
#print axioms Krenn.X5Case1079Tree.LeafB7.selectedHasNoCommonZero

end Krenn.X5Case1079Tree.LeafB7
