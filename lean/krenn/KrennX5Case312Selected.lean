...
namespace Krenn.X5Case312Selected

open Krenn.SparseCertificate
open MvPolynomial

def sourceSystemFileSHA256 : String := "b07e4e6d99c34358704fccd13b6d348428ae6881588e1984ff525a41c0f4c2d8"
def sourceSystemSemanticSHA256 : String := "6593a1247dd0f587b47c0399309d8f611b0585bdc65ec48066c9175043473c8e"
def certificateSHA256 : String := "ae5f70509254343b262e6e09120f7ee8858d5af5ff327533971e9ae868a6c6f9"
...
def multipliers : Fin 16 → SparsePoly (Fin 70) := ![
  ...
  [{ coefficient := -1, powers := [(14, 1), (33, 1), (37, 1), (48, 1), (63, 1)] }, { coefficient := -1, powers := [(14, 1), (33, 1), (40, 1), (48, 1), (57, 1)] }],
  [{ coefficient := -1, powers := [(30, 1), (33, 1), (37, 1), (63, 1)] }, { coefficient := -1, powers := [(30, 1), (33, 1), (40, 1), (57, 1)] }],
  [{ coefficient := -1, powers := [(22, 1), (33, 1), (37, 1), (63, 1)] }, { coefficient := -1, powers := [(22, 1), (33, 1), (40, 1), (57, 1)] }],
  [{ coefficient := 1, powers := [(1, 1), (15, 1), (48, 1)] }, { coefficient := -1, powers := [(7, 1), (48, 1)] }],
  [{ coefficient := -1, powers := [(3, 1), (25, 1), (34, 1), (37, 1), (63, 1)] }, { coefficient := -1, powers := [(3, 1), (25, 1), (34, 1), (40, 1), (57, 1)] }, { coefficient := 1, powers := [(28, 1), (34, 1), (37, 1), (63, 1)] }, { coefficient := 1, powers := [(28, 1), (34, 1), (40, 1), (57, 1)] }],
  [{ coefficient := -1, powers := [(3, 1), (17, 1), (34, 1), (37, 1), (63, 1)] }, { coefficient := -1, powers := [(3, 1), (17, 1), (34, 1), (40, 1), (57, 1)] }, { coefficient := 1, powers := [(19, 1), (34, 1), (37, 1), (63, 1)] }, { coefficient := 1, powers := [(19, 1), (34, 1), (40, 1), (57, 1)] }],
  [{ coefficient := -1, powers := [(15, 1), (26, 1)] }, { coefficient := 1, powers := [(31, 1)] }],
  [{ coefficient := -1, powers := [(15, 1), (18, 1)] }, { coefficient := 1, powers := [(23, 1)] }],
  [{ coefficient := -1, powers := [(3, 1), (9, 1), (34, 1), (37, 1), (63, 1)] }, { coefficient := -1, powers := [(3, 1), (9, 1), (34, 1), (40, 1), (57, 1)] }, { coefficient := 1, powers := [(11, 1), (34, 1), (37, 1), (63, 1)] }, { coefficient := 1, powers := [(11, 1), (34, 1), (40, 1), (57, 1)] }],
  ...
  [{ coefficient := 1, powers := [(3, 1), (34, 1), (37, 1), (63, 1)] }, { coefficient := 1, powers := [(3, 1), (34, 1), (40, 1), (57, 1)] }],
  [{ coefficient := -1, powers := [(34, 1), (37, 1), (63, 1)] }, { coefficient := -1, powers := [(34, 1), (40, 1), (57, 1)] }],
...
#print axioms Krenn.X5Case312Selected.selectedHasNoCommonZero

end Krenn.X5Case312Selected
