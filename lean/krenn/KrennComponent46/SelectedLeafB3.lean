...
namespace Krenn.Component46.SelectedLeafB3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "e8f90a8562060e84affe627667fbf668ab1054c84389641b1ca46d47fc8c93c7"
def certificateSHA256 : String := "d06ccc815bcf26570554d8203013127c66e211c83fc903888e926b870dbc234c"
...
def multipliers : Fin 17 → SparsePoly (Fin 63) := ![
  ...
  [{ coefficient := -1, powers := [(2, 1), (42, 1), (43, 1), (57, 1)] }, { coefficient := -2, powers := [(2, 1), (46, 1), (49, 1), (54, 1)] }, { coefficient := -1, powers := [(5, 1), (34, 1), (42, 1), (57, 1)] }, { coefficient := -2, powers := [(5, 1), (37, 1), (46, 1), (54, 1)] }, { coefficient := 1, powers := [(8, 1), (23, 1), (37, 1), (46, 1), (53, 1)] }, { coefficient := -1, powers := [(8, 1), (34, 1), (49, 1), (52, 1)] }, { coefficient := -1, powers := [(8, 1), (37, 1), (43, 1), (56, 1)] }, { coefficient := -1, powers := [(8, 1), (37, 1), (48, 1), (53, 1)] }, { coefficient := 1, powers := [(14, 1), (26, 1), (42, 1), (57, 1)] }],
...
#print axioms Krenn.Component46.SelectedLeafB3.selectedHasNoCommonZero

end Krenn.Component46.SelectedLeafB3
