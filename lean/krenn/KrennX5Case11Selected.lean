...
namespace Krenn.X5Case11Selected

open Krenn.SparseCertificate
open MvPolynomial

def sourceSystemFileSHA256 : String := "5fa5918247509dcea00762c5a963d905c3332786601d6dbd1afea25646aec5c6"
def sourceSystemSemanticSHA256 : String := "df5b3cdd32fbf0b1cb1070b0fa7f01b684c03b40e9d640b5e29c41df27220046"
def certificateSHA256 : String := "6ad472bd0e1dbe8e9380714dd008a5b19b70fdc9a38e6d3c0f65b84a8e22ba4a"
...
def selectedEquations : Fin 16 → SparsePoly (Fin 70) := ![
  ...
  [{ coefficient := 1, powers := [(9, 1), (49, 1), (63, 1)] }, { coefficient := 1, powers := [(17, 1), (49, 1), (57, 1)] }, { coefficient := 1, powers := [(49, 1), (54, 1)] }, { coefficient := 1, powers := [(54, 1), (69, 1)] }, { coefficient := 1, powers := [(57, 1), (66, 1)] }, { coefficient := 1, powers := [(60, 1), (63, 1)] }],
...
def multipliers : Fin 16 → SparsePoly (Fin 70) := ![
  [{ coefficient := -1, powers := [(29, 1), (32, 1), (37, 1), (46, 1), (63, 1)] }, { coefficient := -1, powers := [(29, 1), (32, 1), (40, 1), (46, 1), (57, 1)] }, { coefficient := -1, powers := [(29, 1), (32, 1), (43, 1), (46, 1), (54, 1)] }],
  ...
  [{ coefficient := 1, powers := [(1, 1), (31, 1), (49, 1)] }, { coefficient := -1, powers := [(7, 1), (49, 1)] }],
...
#print axioms Krenn.X5Case11Selected.selectedHasNoCommonZero

end Krenn.X5Case11Selected
