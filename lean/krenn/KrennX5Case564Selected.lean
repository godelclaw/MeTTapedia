...
namespace Krenn.X5Case564Selected

open Krenn.SparseCertificate
open MvPolynomial

def sourceSystemFileSHA256 : String := "5bdb64762509f057def72e2d5d730dfd309ea5b885d58ee05cfbcacbf313623f"
def sourceSystemSemanticSHA256 : String := "e346fa46397df1b397fd70c8717cb3fb6083424dc674a5dbab2a6bf57c05db4a"
def certificateSHA256 : String := "c419effd0e71d620f672aaa078b7170ed01f1e34751fefd4afb047af721bac58"
...
def multipliers : Fin 19 → SparsePoly (Fin 70) := ![
  [{ coefficient := -1, powers := [(31, 1), (51, 1)] }, { coefficient := 1, powers := [(34, 1), (43, 1)] }],
  [{ coefficient := -1, powers := [(15, 1), (33, 1), (39, 1), (51, 1), (63, 1)] }, { coefficient := -1, powers := [(22, 1), (33, 1), (37, 1), (48, 1), (63, 1)] }, { coefficient := -1, powers := [(22, 1), (33, 1), (40, 1), (48, 1), (57, 1)] }, { coefficient := -1, powers := [(23, 1), (33, 1), (39, 1), (51, 1), (57, 1)] }],
  [{ coefficient := -1, powers := [(30, 1), (33, 1), (37, 1), (63, 1)] }, { coefficient := -1, powers := [(30, 1), (33, 1), (40, 1), (57, 1)] }],
  [{ coefficient := -1, powers := [(14, 1), (33, 1), (37, 1), (63, 1)] }, { coefficient := -1, powers := [(14, 1), (33, 1), (40, 1), (57, 1)] }],
  [{ coefficient := -1, powers := [(15, 1), (33, 1), (42, 1), (63, 1)] }, { coefficient := -1, powers := [(23, 1), (33, 1), (42, 1), (57, 1)] }],
  [{ coefficient := -1, powers := [(15, 1), (33, 1), (36, 1), (63, 1)] }, { coefficient := -1, powers := [(23, 1), (33, 1), (36, 1), (57, 1)] }],
  [{ coefficient := 1, powers := [(4, 1), (23, 1), (48, 1)] }, { coefficient := -1, powers := [(7, 1), (48, 1)] }],
  [{ coefficient := 1, powers := [(51, 1)] }],
  [{ coefficient := 1, powers := [(3, 1), (15, 1), (25, 1), (51, 1), (63, 1)] }, { coefficient := 1, powers := [(3, 1), (23, 1), (25, 1), (51, 1), (57, 1)] }, { coefficient := -1, powers := [(3, 1), (25, 1), (34, 1), (37, 1), (63, 1)] }, { coefficient := -1, powers := [(3, 1), (25, 1), (34, 1), (40, 1), (57, 1)] }, { coefficient := -1, powers := [(15, 1), (28, 1), (51, 1), (63, 1)] }, { coefficient := -1, powers := [(23, 1), (28, 1), (51, 1), (57, 1)] }, { coefficient := 1, powers := [(28, 1), (34, 1), (37, 1), (63, 1)] }, { coefficient := 1, powers := [(28, 1), (34, 1), (40, 1), (57, 1)] }],
  [{ coefficient := 1, powers := [(3, 1), (15, 1), (17, 1), (51, 1), (63, 1)] }, { coefficient := 1, powers := [(3, 1), (17, 1), (23, 1), (51, 1), (57, 1)] }, { coefficient := -1, powers := [(3, 1), (17, 1), (34, 1), (37, 1), (63, 1)] }, { coefficient := -1, powers := [(3, 1), (17, 1), (34, 1), (40, 1), (57, 1)] }, { coefficient := -1, powers := [(15, 1), (20, 1), (51, 1), (63, 1)] }, { coefficient := -1, powers := [(20, 1), (23, 1), (51, 1), (57, 1)] }, { coefficient := 1, powers := [(20, 1), (34, 1), (37, 1), (63, 1)] }, { coefficient := 1, powers := [(20, 1), (34, 1), (40, 1), (57, 1)] }],
  [{ coefficient := -1, powers := [(23, 1), (29, 1)] }, { coefficient := 1, powers := [(31, 1)] }],
  [{ coefficient := 1, powers := [(3, 1), (9, 1), (15, 1), (51, 1), (63, 1)] }, { coefficient := 1, powers := [(3, 1), (9, 1), (23, 1), (51, 1), (57, 1)] }, { coefficient := -1, powers := [(3, 1), (9, 1), (34, 1), (37, 1), (63, 1)] }, { coefficient := -1, powers := [(3, 1), (9, 1), (34, 1), (40, 1), (57, 1)] }, { coefficient := -1, powers := [(11, 1), (15, 1), (51, 1), (63, 1)] }, { coefficient := -1, powers := [(11, 1), (23, 1), (51, 1), (57, 1)] }, { coefficient := 1, powers := [(11, 1), (34, 1), (37, 1), (63, 1)] }, { coefficient := 1, powers := [(11, 1), (34, 1), (40, 1), (57, 1)] }],
  [{ coefficient := -1, powers := [(12, 1), (23, 1)] }, { coefficient := 1, powers := [(15, 1)] }],
  [{ coefficient := -1, powers := [(4, 1), (23, 1)] }, { coefficient := 1, powers := [(7, 1)] }],
  [{ coefficient := 1, powers := [(33, 1), (37, 1), (63, 1)] }, { coefficient := 1, powers := [(33, 1), (40, 1), (57, 1)] }],
  [{ coefficient := 1, powers := [(23, 1)] }],
  [{ coefficient := -1, powers := [(3, 1), (15, 1), (51, 1), (63, 1)] }, { coefficient := -1, powers := [(3, 1), (23, 1), (51, 1), (57, 1)] }, { coefficient := 1, powers := [(3, 1), (34, 1), (37, 1), (63, 1)] }, { coefficient := 1, powers := [(3, 1), (34, 1), (40, 1), (57, 1)] }],
  [{ coefficient := 1, powers := [(15, 1), (51, 1), (63, 1)] }, { coefficient := 1, powers := [(23, 1), (51, 1), (57, 1)] }, { coefficient := -1, powers := [(34, 1), (37, 1), (63, 1)] }, { coefficient := -1, powers := [(34, 1), (40, 1), (57, 1)] }],
...
#print axioms Krenn.X5Case564Selected.selectedHasNoCommonZero

end Krenn.X5Case564Selected
