...
namespace Krenn.Component19RootCommonZero.Chunk16
...
theorem rootBlock_of_base_and_component {R : Type*} [CommRing R]
    ...
    ∀ offset : Fin 23, eval₂Hom (Int.castRingHom R) (rootValues full)
      (Krenn.Component19.Tree.rootEquations ⟨640 + offset.val, by omega⟩).toPoly = 0 := by
...
end Krenn.Component19RootCommonZero.Chunk16
