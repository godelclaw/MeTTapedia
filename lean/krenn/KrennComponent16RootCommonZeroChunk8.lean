...
namespace Krenn.Component16RootCommonZero.Chunk8
...
theorem rootBlock_of_base_and_component {R : Type*} [CommRing R]
    ...
    ∀ offset : Fin 40, eval₂Hom (Int.castRingHom R) (rootValues full)
      (Krenn.Component16.Tree.rootEquations ⟨320 + offset.val, by omega⟩).toPoly = 0 := by
...
end Krenn.Component16RootCommonZero.Chunk8
