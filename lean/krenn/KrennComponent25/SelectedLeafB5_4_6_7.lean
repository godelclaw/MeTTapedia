...
namespace Krenn.Component25.SelectedLeafB5_4_6_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "d9ec7db3d56a1836f5d54c0247fc2843edb6ed9897d4227a48fc4a6265cf496f"
def certificateSHA256 : String := "4f41e0cd1488ff84f5603d0b48ccb104543b3bc7fe979add11c85907f2e2609f"
...
def multipliers : Fin 31 → SparsePoly (Fin 69) := ![
  [{ coefficient := -2, powers := [(22, 1), (29, 1), (48, 1), (53, 1), (65, 1), (68, 1)] }],
  ...
  [{ coefficient := -1, powers := [(16, 1), (23, 1), (54, 1), (68, 1)] }],
  [{ coefficient := -1, powers := [(16, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (2, 1), (24, 1), (48, 1), (54, 1), (61, 1), (68, 1)] }, { coefficient := 1, powers := [(0, 1), (2, 1), (48, 1), (54, 1), (68, 1)] }, { coefficient := -1, powers := [(0, 1), (16, 1), (29, 1), (48, 1), (50, 1), (68, 1)] }, { coefficient := 2, powers := [(12, 1), (29, 1), (48, 1), (65, 1), (68, 1)] }, { coefficient := -1, powers := [(16, 1), (24, 1), (29, 1), (48, 1), (50, 1), (68, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (24, 1), (48, 1), (61, 1)] }, { coefficient := -1, powers := [(2, 1), (48, 1)] }],
  [{ coefficient := 2, powers := [(29, 1), (48, 1), (53, 1), (65, 1), (68, 1)] }],
  ...
  [{ coefficient := 1, powers := [(0, 1), (2, 1), (24, 1), (29, 1), (48, 1), (54, 1), (61, 1), (68, 1)] }, { coefficient := -1, powers := [(0, 1), (2, 1), (29, 1), (48, 1), (54, 1), (68, 1)] }, { coefficient := 1, powers := [(0, 1), (16, 1), (29, 2), (48, 1), (50, 1), (68, 1)] }, { coefficient := -2, powers := [(12, 1), (29, 2), (48, 1), (65, 1), (68, 1)] }, { coefficient := 1, powers := [(16, 1), (24, 1), (29, 2), (48, 1), (50, 1), (68, 1)] }, { coefficient := 2, powers := [(17, 1), (18, 1), (23, 1), (54, 1)] }, { coefficient := 2, powers := [(17, 1), (23, 1), (24, 1), (54, 1)] }],
  ...
  [{ coefficient := -1, powers := [(0, 1), (2, 1), (41, 1), (61, 1)] }, { coefficient := -1, powers := [(2, 1), (19, 1), (50, 1), (61, 1)] }, { coefficient := 1, powers := [(2, 1), (41, 1)] }, { coefficient := 1, powers := [(5, 1), (32, 1)] }, { coefficient := -1, powers := [(12, 1), (23, 1)] }, { coefficient := 1, powers := [(16, 1), (22, 1), (23, 1), (54, 1), (68, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (2, 1), (24, 1), (45, 1), (48, 1), (54, 1), (61, 1)] }, { coefficient := -1, powers := [(0, 1), (2, 1), (45, 1), (48, 1), (54, 1)] }, { coefficient := 1, powers := [(0, 1), (16, 1), (29, 1), (45, 1), (48, 1), (50, 1)] }, { coefficient := -2, powers := [(12, 1), (29, 1), (45, 1), (48, 1), (65, 1)] }, { coefficient := 1, powers := [(16, 1), (23, 1), (43, 1), (54, 1)] }, { coefficient := 1, powers := [(16, 1), (24, 1), (29, 1), (45, 1), (48, 1), (50, 1)] }, { coefficient := -2, powers := [(16, 1), (29, 1), (48, 1), (53, 1), (65, 1)] }]
]
...
#print axioms Krenn.Component25.SelectedLeafB5_4_6_7.selectedHasNoCommonZero

end Krenn.Component25.SelectedLeafB5_4_6_7
