...
namespace Krenn.Component25.SelectedLeafB5_2_2_4_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "e364ad827ae5a1ee5cf7b4b0eb0248c83170a9ce970bf52ee8209024c81b77b5"
...
def multipliers : Fin 16 → SparsePoly (Fin 69) := ![
  [{ coefficient := 1, powers := [(23, 1), (60, 1), (67, 1)] }, { coefficient := 1, powers := [(32, 1), (48, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(23, 1), (43, 1), (54, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(16, 1), (54, 1)] }],
  [{ coefficient := 1, powers := [(16, 1), (23, 1), (54, 1), (61, 1)] }],
  [{ coefficient := -2, powers := [(23, 1), (60, 1), (68, 1)] }, { coefficient := 1, powers := [(23, 1)] }],
  ...
  [{ coefficient := 1, powers := [(2, 1), (41, 1)] }, { coefficient := 1, powers := [(5, 1), (32, 1)] }, { coefficient := 2, powers := [(12, 1), (23, 1), (60, 1), (68, 1)] }, { coefficient := -1, powers := [(12, 1), (23, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (59, 1), (60, 1), (67, 1)] }, { coefficient := 1, powers := [(5, 1), (60, 1)] }, { coefficient := -1, powers := [(16, 1), (47, 1), (60, 1), (67, 1)] }, { coefficient := -1, powers := [(17, 1), (47, 1), (50, 1)] }],
...
#print axioms Krenn.Component25.SelectedLeafB5_2_2_4_7.selectedHasNoCommonZero

end Krenn.Component25.SelectedLeafB5_2_2_4_7
