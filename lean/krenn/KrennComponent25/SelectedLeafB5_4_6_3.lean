...
namespace Krenn.Component25.SelectedLeafB5_4_6_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "1d84817d5ffa9a9b03eb1addb7b23e72e3febedef57045a61b0fe83e5689127e"
...
def multipliers : Fin 20 → SparsePoly (Fin 68) := ![
  [{ coefficient := 1, powers := [(6, 1), (34, 1), (45, 1), (52, 1), (67, 1)] }, { coefficient := 1, powers := [(6, 1), (34, 1), (52, 1), (56, 1), (67, 1)] }, { coefficient := -1, powers := [(21, 1), (52, 1), (67, 1)] }, { coefficient := -1, powers := [(21, 1), (56, 1), (67, 1)] }, { coefficient := -1, powers := [(26, 1), (45, 1), (67, 1)] }, { coefficient := -1, powers := [(31, 1), (37, 1), (67, 1)] }, { coefficient := -1, powers := [(34, 1), (36, 1), (52, 1), (56, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (4, 1), (34, 1), (52, 1), (67, 1)] }, { coefficient := -1, powers := [(0, 1), (7, 1), (18, 1), (34, 1), (52, 1), (61, 1), (67, 1)] }, { coefficient := -1, powers := [(0, 1), (7, 1), (34, 1), (52, 1), (67, 1)] }, { coefficient := -1, powers := [(2, 1), (4, 1), (31, 1), (62, 1), (67, 1)] }, { coefficient := 1, powers := [(7, 1), (31, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(21, 1), (67, 1)] }, { coefficient := 1, powers := [(26, 1), (67, 1)] }, { coefficient := -1, powers := [(34, 1), (36, 1), (52, 1), (67, 1)] }],
  ...
  [{ coefficient := -1, powers := [(6, 1), (34, 1), (52, 1)] }, { coefficient := 1, powers := [(21, 1), (29, 1), (67, 1)] }, { coefficient := -1, powers := [(26, 1), (29, 1), (67, 1)] }, { coefficient := 1, powers := [(26, 1)] }, { coefficient := 1, powers := [(29, 1), (34, 1), (36, 1), (52, 1), (67, 1)] }],
  ...
  [{ coefficient := 1, powers := [(0, 1), (4, 1), (29, 1), (34, 1), (52, 1), (67, 1)] }, { coefficient := 1, powers := [(0, 1), (7, 1), (18, 1), (29, 1), (34, 1), (52, 1), (61, 1), (67, 1)] }, { coefficient := 1, powers := [(0, 1), (7, 1), (29, 1), (34, 1), (52, 1), (67, 1)] }, { coefficient := 1, powers := [(2, 1), (4, 1), (29, 1), (31, 1), (62, 1), (67, 1)] }, { coefficient := -1, powers := [(2, 1), (4, 1), (31, 1), (62, 1)] }, { coefficient := 1, powers := [(6, 1), (14, 1), (34, 1), (52, 1)] }, { coefficient := -1, powers := [(7, 1), (29, 1), (31, 1), (67, 1)] }, { coefficient := 1, powers := [(7, 1), (34, 1)] }, { coefficient := -1, powers := [(10, 1), (26, 1)] }],
...
#print axioms Krenn.Component25.SelectedLeafB5_4_6_3.selectedHasNoCommonZero

end Krenn.Component25.SelectedLeafB5_4_6_3
