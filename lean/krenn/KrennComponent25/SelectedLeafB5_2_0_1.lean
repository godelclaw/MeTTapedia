...
namespace Krenn.Component25.SelectedLeafB5_2_0_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "488a3d3193cec25e5d8c374fb5880eac2131ff092d0065bc6a589d6e19a72504"
...
def multipliers : Fin 27 → SparsePoly (Fin 65) := ![
  ...
  [{ coefficient := 1, powers := [(2, 1), (19, 1), (54, 1), (61, 1), (64, 1)] }, { coefficient := 1, powers := [(2, 1), (38, 1), (50, 1), (59, 1), (64, 1)] }, { coefficient := 1, powers := [(12, 1), (19, 1), (29, 1), (61, 1), (64, 1)] }, { coefficient := 1, powers := [(12, 1), (27, 1), (38, 1), (59, 1), (64, 1)] }, { coefficient := 1, powers := [(16, 1), (23, 1), (54, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(16, 1), (54, 1)] }],
  ...
  [{ coefficient := -1, powers := [(2, 1), (19, 1), (22, 1), (54, 1), (61, 1), (64, 1)] }, { coefficient := -1, powers := [(2, 1), (22, 1), (38, 1), (50, 1), (59, 1), (64, 1)] }, { coefficient := 1, powers := [(2, 1), (41, 1)] }, { coefficient := 1, powers := [(5, 1), (32, 1)] }, { coefficient := -1, powers := [(12, 1), (19, 1), (22, 1), (29, 1), (61, 1), (64, 1)] }, { coefficient := -1, powers := [(12, 1), (22, 1), (27, 1), (38, 1), (59, 1), (64, 1)] }, { coefficient := -1, powers := [(12, 1), (23, 1)] }, { coefficient := -1, powers := [(16, 1), (22, 1), (23, 1), (54, 1), (64, 1)] }],
...
#print axioms Krenn.Component25.SelectedLeafB5_2_0_1.selectedHasNoCommonZero

end Krenn.Component25.SelectedLeafB5_2_0_1
