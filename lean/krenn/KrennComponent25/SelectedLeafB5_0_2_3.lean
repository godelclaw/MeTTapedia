...
namespace Krenn.Component25.SelectedLeafB5_0_2_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "8f48ffbe4d340ea8d4be2bce5036d34c4f7af5e4b3a8ccf8b6cf57b98931e5a0"
def certificateSHA256 : String := "4c91d5843f9f4abcb4c2c19f977e37cdb7ef280259479cb3b517c16f7b06f822"
...
def multipliers : Fin 20 → SparsePoly (Fin 66) := ![
  [{ coefficient := 1, powers := [(6, 1), (34, 1), (45, 1), (52, 1), (65, 1)] }, { coefficient := 1, powers := [(6, 1), (34, 1), (52, 1), (56, 1), (65, 1)] }, { coefficient := -1, powers := [(21, 1), (52, 1), (65, 1)] }, { coefficient := -1, powers := [(21, 1), (56, 1), (65, 1)] }, { coefficient := -1, powers := [(26, 1), (45, 1), (65, 1)] }, { coefficient := -1, powers := [(31, 1), (37, 1), (65, 1)] }, { coefficient := -1, powers := [(34, 1), (36, 1), (52, 1), (56, 1), (65, 1)] }],
  ...
  [{ coefficient := -1, powers := [(21, 1), (65, 1)] }, { coefficient := 1, powers := [(26, 1), (65, 1)] }, { coefficient := -1, powers := [(34, 1), (36, 1), (52, 1), (65, 1)] }],
  ...
  [{ coefficient := -1, powers := [(6, 1), (34, 1), (52, 1)] }, { coefficient := 1, powers := [(21, 1), (29, 1), (65, 1)] }, { coefficient := -1, powers := [(26, 1), (29, 1), (65, 1)] }, { coefficient := 1, powers := [(26, 1)] }, { coefficient := 1, powers := [(29, 1), (34, 1), (36, 1), (52, 1), (65, 1)] }],
  ...
  [{ coefficient := 1, powers := [(0, 1), (4, 1), (29, 1), (34, 1), (52, 1), (65, 1)] }, { coefficient := 1, powers := [(0, 1), (7, 1), (18, 1), (29, 1), (34, 1), (52, 1), (61, 1), (65, 1)] }, { coefficient := 1, powers := [(0, 1), (7, 1), (29, 1), (34, 1), (52, 1), (65, 1)] }, { coefficient := 1, powers := [(2, 1), (4, 1), (29, 1), (31, 1), (62, 1), (65, 1)] }, { coefficient := -1, powers := [(2, 1), (4, 1), (31, 1), (62, 1)] }, { coefficient := 1, powers := [(6, 1), (14, 1), (34, 1), (52, 1)] }, { coefficient := -1, powers := [(7, 1), (29, 1), (31, 1), (65, 1)] }, { coefficient := 1, powers := [(7, 1), (34, 1)] }, { coefficient := -1, powers := [(10, 1), (26, 1)] }],
...
#print axioms Krenn.Component25.SelectedLeafB5_0_2_3.selectedHasNoCommonZero

end Krenn.Component25.SelectedLeafB5_0_2_3
