...
namespace Krenn.Component25.SelectedLeafB6_6_6_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "9218e965b98a9a739b006f4cb7a559b92e8b55866a63ba0f69d1557f18072829"
...
def multipliers : Fin 22 → SparsePoly (Fin 69) := ![
  ...
  [{ coefficient := 1, powers := [(0, 1), (17, 1), (29, 1), (50, 1), (67, 1), (68, 1)] }, { coefficient := 1, powers := [(17, 1), (24, 1), (29, 1), (50, 1), (67, 1), (68, 1)] }, { coefficient := -1, powers := [(17, 1), (50, 1)] }],
...
#print axioms Krenn.Component25.SelectedLeafB6_6_6_5.selectedHasNoCommonZero

end Krenn.Component25.SelectedLeafB6_6_6_5
