...
namespace Krenn.Component25.SelectedLeafB5_6_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "6db71bcc17291b4ab54467876c937e2fd66e376d2a06dd439b7dffe0c8b308a6"
...
def multipliers : Fin 12 → SparsePoly (Fin 67) := ![
  [{ coefficient := -1, powers := [(0, 1), (16, 1), (28, 1), (62, 1), (63, 1), (66, 1)] }, { coefficient := -1, powers := [(63, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (24, 1), (28, 1), (51, 1), (62, 1), (63, 1), (66, 1)] }, { coefficient := -1, powers := [(0, 1), (28, 1), (39, 1), (62, 1), (63, 1), (66, 1)] }],
...
#print axioms Krenn.Component25.SelectedLeafB5_6_5.selectedHasNoCommonZero

end Krenn.Component25.SelectedLeafB5_6_5
