...
namespace Krenn.Component25.SelectedLeafB5_7_2_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "7a96b0178abf51938c0cb812c98ad7ba9d6619c1354583e05e4a4b3ecffe4699"
...
def multipliers : Fin 33 → SparsePoly (Fin 69) := ![
  [{ coefficient := 1, powers := [(3, 1), (31, 1), (45, 1), (56, 1), (68, 1)] }, { coefficient := 1, powers := [(3, 1), (31, 1), (56, 2), (68, 1)] }, { coefficient := -1, powers := [(21, 1), (52, 1), (68, 1)] }, { coefficient := -1, powers := [(21, 1), (56, 1), (68, 1)] }, { coefficient := -1, powers := [(31, 1), (37, 1), (68, 1)] }],
  ...
  [{ coefficient := -1, powers := [(3, 1), (31, 1), (56, 1)] }, { coefficient := 1, powers := [(21, 1), (29, 1), (68, 1)] }],
...
#print axioms Krenn.Component25.SelectedLeafB5_7_2_5.selectedHasNoCommonZero

end Krenn.Component25.SelectedLeafB5_7_2_5
