...
namespace Krenn.Component25.SelectedLeafB5_6_4_6_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "28629d4d11d6b73d930b671e1e33592321dcb16873d73a2d05406e4831a35d19"
...
def multipliers : Fin 17 → SparsePoly (Fin 70) := ![
  ...
  [{ coefficient := -1, powers := [(23, 1), (60, 1), (69, 1)] }, { coefficient := 1, powers := [(23, 1)] }],
  ...
  [{ coefficient := 1, powers := [(2, 1), (41, 1)] }, { coefficient := 1, powers := [(3, 1), (5, 1), (32, 1), (59, 1)] }, { coefficient := 1, powers := [(5, 1), (22, 1), (50, 1), (59, 1)] }, { coefficient := 1, powers := [(5, 1), (32, 1)] }, { coefficient := 1, powers := [(12, 1), (23, 1), (60, 1), (69, 1)] }, { coefficient := -1, powers := [(12, 1), (23, 1)] }],
  [{ coefficient := 1, powers := [(3, 1), (5, 1), (59, 1), (60, 1)] }, { coefficient := -1, powers := [(5, 1), (59, 1), (60, 1), (68, 1)] }, { coefficient := 1, powers := [(5, 1), (60, 1)] }, { coefficient := -1, powers := [(12, 1), (48, 1)] }, { coefficient := -1, powers := [(16, 1), (47, 1), (60, 1), (68, 1)] }, { coefficient := -1, powers := [(17, 1), (47, 1), (50, 1)] }],
...
#print axioms Krenn.Component25.SelectedLeafB5_6_4_6_3.selectedHasNoCommonZero

end Krenn.Component25.SelectedLeafB5_6_4_6_3
