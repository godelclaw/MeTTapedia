...
namespace Krenn.Component25.SelectedLeafB5_2_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "667ac3248d790a31d5682e7af12c980b41dca2424db2ddc44913046bf182042c"
def certificateSHA256 : String := "be6faf72df1895ae2de780d30d81ba37c8eedc99038a09f34195edd624c3b462"
...
def multipliers : Fin 33 → SparsePoly (Fin 65) := ![
  [{ coefficient := 1, powers := [(2, 1), (33, 1), (36, 1), (38, 1), (60, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(22, 1), (48, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (22, 1), (29, 1), (60, 1), (62, 1), (64, 1)] }, { coefficient := -1, powers := [(5, 1), (22, 1), (32, 1), (57, 1), (62, 1), (64, 1)] }, { coefficient := -1, powers := [(5, 1), (27, 1), (29, 1), (60, 1), (62, 1), (64, 1)] }, { coefficient := -1, powers := [(5, 1), (27, 1), (32, 1), (57, 1), (62, 1), (64, 1)] }, { coefficient := -1, powers := [(23, 1), (24, 1), (53, 1), (57, 1), (64, 1)] }, { coefficient := 1, powers := [(29, 1), (36, 1), (47, 1), (60, 1), (64, 1)] }, { coefficient := -1, powers := [(29, 1), (48, 1), (53, 1), (63, 1), (64, 1)] }, { coefficient := 1, powers := [(32, 1), (36, 1), (47, 1), (57, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (2, 1), (38, 1), (42, 1), (45, 1), (49, 1), (60, 1), (64, 1)] }, { coefficient := 1, powers := [(2, 1), (6, 1), (38, 1), (58, 1), (60, 1), (64, 1)] }, { coefficient := -1, powers := [(2, 1), (24, 1), (38, 1), (42, 1), (45, 1), (49, 1), (60, 1), (64, 1)] }, { coefficient := -1, powers := [(2, 1), (38, 1), (42, 1), (49, 1), (60, 1), (64, 1)] }, { coefficient := -1, powers := [(5, 1), (35, 1), (54, 1), (61, 1), (64, 1)] }, { coefficient := 1, powers := [(17, 1), (23, 1), (54, 1), (61, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(16, 1), (29, 1), (36, 1), (52, 1), (60, 1), (64, 1)] }, { coefficient := 1, powers := [(16, 1), (32, 1), (36, 1), (52, 1), (57, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(17, 1), (50, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (2, 1), (36, 1), (42, 1), (45, 1), (60, 1)] }, { coefficient := -1, powers := [(2, 1), (3, 1), (13, 1), (24, 1), (60, 1), (61, 1)] }, { coefficient := -1, powers := [(2, 1), (24, 1), (36, 1), (42, 1), (45, 1), (60, 1)] }, { coefficient := -1, powers := [(2, 1), (36, 1), (42, 1), (60, 1)] }],
  ...
  [{ coefficient := -1, powers := [(0, 1), (2, 1), (24, 1), (38, 1), (42, 1), (45, 1), (60, 1)] }, { coefficient := 1, powers := [(2, 1), (6, 1), (33, 1), (38, 1), (60, 1)] }, { coefficient := 1, powers := [(2, 1), (13, 1), (24, 1), (38, 1), (60, 1)] }, { coefficient := -1, powers := [(2, 1), (24, 2), (38, 1), (42, 1), (45, 1), (60, 1)] }, { coefficient := -1, powers := [(2, 1), (24, 1), (38, 1), (42, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(12, 1), (29, 1), (48, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (57, 1)] }, { coefficient := 1, powers := [(8, 1), (35, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (2, 1), (38, 1), (39, 1), (60, 1)] }, { coefficient := 1, powers := [(2, 1), (3, 1), (30, 1), (38, 1), (60, 1)] }, { coefficient := 1, powers := [(2, 1), (9, 1), (18, 1), (38, 1), (60, 1)] }, { coefficient := -1, powers := [(2, 1), (18, 1), (38, 1), (49, 1), (60, 1)] }],
  ...
  [{ coefficient := 1, powers := [(0, 1), (2, 1), (18, 1), (38, 1), (42, 1), (45, 1), (49, 1), (60, 1)] }, { coefficient := -1, powers := [(2, 1), (6, 1), (18, 1), (38, 1), (58, 1), (60, 1)] }, { coefficient := -1, powers := [(2, 1), (9, 1), (33, 1), (36, 1), (38, 1), (60, 1)] }, { coefficient := 1, powers := [(2, 1), (18, 1), (24, 1), (38, 1), (42, 1), (45, 1), (49, 1), (60, 1)] }, { coefficient := 1, powers := [(2, 1), (18, 1), (38, 1), (42, 1), (49, 1), (60, 1)] }, { coefficient := 1, powers := [(5, 1), (16, 1), (22, 1), (29, 1), (60, 1), (62, 1)] }, { coefficient := 1, powers := [(5, 1), (16, 1), (22, 1), (32, 1), (57, 1), (62, 1)] }, { coefficient := 1, powers := [(5, 1), (16, 1), (27, 1), (29, 1), (60, 1), (62, 1)] }, { coefficient := 1, powers := [(5, 1), (16, 1), (27, 1), (32, 1), (57, 1), (62, 1)] }, { coefficient := 1, powers := [(5, 1), (18, 1), (35, 1), (54, 1), (61, 1)] }, { coefficient := -1, powers := [(16, 1), (19, 1), (29, 1), (36, 1), (52, 1), (60, 1)] }, { coefficient := -1, powers := [(16, 1), (19, 1), (32, 1), (36, 1), (52, 1), (57, 1)] }, { coefficient := 1, powers := [(16, 1), (23, 1), (24, 1), (53, 1), (57, 1)] }, { coefficient := -1, powers := [(16, 1), (29, 1), (36, 1), (47, 1), (60, 1)] }, { coefficient := 1, powers := [(16, 1), (29, 1), (48, 1), (53, 1), (63, 1)] }, { coefficient := -1, powers := [(16, 1), (32, 1), (36, 1), (47, 1), (57, 1)] }, { coefficient := -1, powers := [(17, 1), (18, 1), (23, 1), (54, 1), (61, 1)] }]
]
...
#print axioms Krenn.Component25.SelectedLeafB5_2_1.selectedHasNoCommonZero

end Krenn.Component25.SelectedLeafB5_2_1
