...
namespace Krenn.Component25.SelectedLeafB6_6_2_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "12a5e2b447777fbf627acfd04a2695cc92bb71e746841c23fc9dee10a51b0bd0"
...
def multipliers : Fin 22 → SparsePoly (Fin 68) := ![
  ...
  [{ coefficient := 1, powers := [(0, 1), (17, 1), (29, 1), (50, 1), (66, 1), (67, 1)] }, { coefficient := 1, powers := [(17, 1), (24, 1), (29, 1), (50, 1), (66, 1), (67, 1)] }, { coefficient := -1, powers := [(17, 1), (50, 1)] }],
  ...
  [{ coefficient := 1, powers := [(2, 1), (41, 1)] }, { coefficient := 1, powers := [(5, 1), (32, 1)] }, { coefficient := -1, powers := [(12, 1), (23, 1)] }, { coefficient := -1, powers := [(16, 1), (22, 1), (23, 1), (54, 1), (67, 1)] }],
...
#print axioms Krenn.Component25.SelectedLeafB6_6_2_5.selectedHasNoCommonZero

end Krenn.Component25.SelectedLeafB6_6_2_5
