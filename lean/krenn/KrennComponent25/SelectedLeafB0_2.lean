...
namespace Krenn.Component25.SelectedLeafB0_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "52bff0228c2eb2996a74e9fdf0529f00aceba1568b1b8418f7542ac8a0ddf20e"
def certificateSHA256 : String := "36134fdf086bb3b4ccd51354c6ef648f2066c76dc747255b24fcae814e466b56"
...
def multipliers : Fin 22 → SparsePoly (Fin 62) := ![
  ...
  [{ coefficient := 1, powers := [(29, 1), (48, 1), (50, 1), (52, 1)] }],
  ...
  [{ coefficient := -1, powers := [(29, 1), (50, 1), (52, 1)] }],
  ...
  [{ coefficient := -1, powers := [(5, 1), (32, 1), (40, 1), (57, 1)] }, { coefficient := -1, powers := [(5, 1), (35, 1), (45, 1), (54, 1)] }, { coefficient := 1, powers := [(12, 1), (23, 1), (40, 1), (57, 1)] }, { coefficient := 1, powers := [(12, 1), (29, 1), (48, 1), (52, 1)] }, { coefficient := 1, powers := [(17, 1), (23, 1), (45, 1), (54, 1)] }, { coefficient := -1, powers := [(17, 1), (29, 1), (47, 1), (50, 1), (52, 1)] }, { coefficient := 1, powers := [(17, 1), (29, 1), (47, 1), (53, 1)] }],
  [{ coefficient := 1, powers := [(38, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (17, 1), (29, 1), (56, 1)] }, { coefficient := 1, powers := [(2, 1), (57, 1)] }, { coefficient := 1, powers := [(8, 1), (35, 1)] }]
]
...
#print axioms Krenn.Component25.SelectedLeafB0_2.selectedHasNoCommonZero

end Krenn.Component25.SelectedLeafB0_2
