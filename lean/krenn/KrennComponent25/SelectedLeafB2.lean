...
namespace Krenn.Component25.SelectedLeafB2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "d885042d7f9947216fbdda3e50f9fd72f19a3fcb653740d02e96c33000a54bdd"
def certificateSHA256 : String := "780d27acbb39251615e8e1ec90197ef58db5187ff47e94b65eb881b435a01520"

set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedSourceIndices : Fin 20 → Fin 659 := ![
  7,
  10,
  11,
  21,
...
def multipliers : Fin 20 → SparsePoly (Fin 62) := ![
  [{ coefficient := -1, powers := [(8, 1), (25, 1), (32, 1), (61, 1)] }, { coefficient := 1, powers := [(12, 1), (25, 1), (29, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (19, 1), (20, 1), (35, 1), (56, 1), (61, 1)] }, { coefficient := 1, powers := [(8, 1), (20, 1), (35, 1), (47, 1), (61, 1)] }, { coefficient := -1, powers := [(16, 1), (20, 1), (29, 1), (48, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (19, 1), (20, 1), (35, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(17, 1), (50, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (32, 1), (61, 1)] }, { coefficient := -1, powers := [(12, 1), (29, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (19, 1), (35, 1), (56, 1), (61, 1)] }, { coefficient := -1, powers := [(8, 1), (35, 1), (47, 1), (61, 1)] }, { coefficient := 1, powers := [(16, 1), (29, 1), (48, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (19, 1), (35, 1), (61, 1)] }],
  ...
  [{ coefficient := -1, powers := [(5, 1), (32, 1), (40, 1), (57, 1)] }, { coefficient := -1, powers := [(5, 1), (35, 1), (45, 1), (54, 1)] }, { coefficient := -1, powers := [(8, 1), (35, 1), (41, 1), (56, 1)] }, { coefficient := -1, powers := [(8, 1), (35, 1), (47, 1), (53, 1)] }, { coefficient := 1, powers := [(12, 1), (23, 1), (40, 1), (57, 1)] }, { coefficient := 1, powers := [(17, 1), (23, 1), (45, 1), (54, 1)] }, { coefficient := 1, powers := [(17, 1), (29, 1), (41, 1), (56, 1)] }, { coefficient := -1, powers := [(17, 1), (29, 1), (47, 1), (50, 1), (52, 1)] }, { coefficient := 1, powers := [(17, 1), (29, 1), (47, 1), (53, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (19, 1), (35, 1), (50, 1), (56, 1)] }, { coefficient := 1, powers := [(8, 1), (19, 1), (35, 1), (53, 1)] }, { coefficient := -1, powers := [(8, 1), (32, 1), (48, 1)] }, { coefficient := 1, powers := [(8, 1), (35, 1), (47, 1), (50, 1)] }, { coefficient := 1, powers := [(12, 1), (29, 1), (48, 1)] }, { coefficient := -1, powers := [(16, 1), (29, 1), (48, 1), (50, 1)] }],
  [{ coefficient := 1, powers := [(38, 1), (60, 1)] }, { coefficient := 1, powers := [(41, 1), (57, 1)] }, { coefficient := 1, powers := [(48, 1), (54, 1)] }]
]
...
#print axioms Krenn.Component25.SelectedLeafB2.selectedHasNoCommonZero

end Krenn.Component25.SelectedLeafB2
