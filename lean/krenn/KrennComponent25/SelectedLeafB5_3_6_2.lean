...
namespace Krenn.Component25.SelectedLeafB5_3_6_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "9120ae3d2d597ea7438de103ac6c848ae80ad0f01e1fb00491f54499bcf1a252"
def certificateSHA256 : String := "f0eb1c0cdabbfe1bc31e3b252c314e624de847cfe0444ff847c023529064715b"
...
def multipliers : Fin 19 → SparsePoly (Fin 68) := ![
  ...
  [{ coefficient := 1, powers := [(5, 1), (60, 1)] }, { coefficient := -1, powers := [(12, 1), (48, 1)] }, { coefficient := -1, powers := [(16, 1), (41, 1), (46, 1), (63, 1)] }, { coefficient := -1, powers := [(17, 1), (40, 1), (41, 1), (63, 1)] }, { coefficient := -1, powers := [(17, 1), (47, 1), (50, 1)] }]
]
...
#print axioms Krenn.Component25.SelectedLeafB5_3_6_2.selectedHasNoCommonZero

end Krenn.Component25.SelectedLeafB5_3_6_2
