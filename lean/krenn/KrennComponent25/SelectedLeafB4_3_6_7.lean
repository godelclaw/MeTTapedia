...
namespace Krenn.Component25.SelectedLeafB4_3_6_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "5804a94ca28eb6b10f19f1a9dbb355b2ba84c6dc789316f22ad1e17dba08db3e"
def certificateSHA256 : String := "1c1d8227d0b99666a8d170b7fb31716083c6637aeb38283cde3e1dc2dad6847f"
...
def multipliers : Fin 33 → SparsePoly (Fin 69) := ![
  [{ coefficient := -1, powers := [(21, 1), (52, 1), (68, 1)] }, { coefficient := -1, powers := [(21, 1), (55, 1), (56, 1), (64, 1), (68, 1)] }, { coefficient := -1, powers := [(21, 1), (56, 1), (68, 1)] }, { coefficient := -1, powers := [(25, 1), (44, 1), (56, 1), (64, 1), (68, 1)] }, { coefficient := -1, powers := [(26, 1), (40, 1), (68, 1)] }, { coefficient := -1, powers := [(26, 1), (45, 1), (68, 1)] }, { coefficient := -1, powers := [(31, 1), (37, 1), (68, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (27, 1), (31, 1), (45, 1), (54, 1)] }, { coefficient := 1, powers := [(5, 1), (27, 1), (34, 1), (45, 1), (54, 1)] }],
  [{ coefficient := 1, powers := [(19, 1), (21, 1), (24, 1), (52, 1), (63, 1), (66, 1)] }, { coefficient := -1, powers := [(19, 1), (25, 1), (52, 1), (63, 1), (66, 1)] }, { coefficient := -1, powers := [(19, 1), (31, 1), (37, 1), (63, 1)] }],
  ...
  [{ coefficient := -1, powers := [(21, 1), (24, 1), (52, 1), (63, 1), (66, 1)] }, { coefficient := 1, powers := [(25, 1), (52, 1), (63, 1), (66, 1)] }, { coefficient := 1, powers := [(31, 1), (37, 1), (63, 1)] }],
  ...
  [{ coefficient := -1, powers := [(24, 1), (45, 1), (52, 1), (66, 1)] }, { coefficient := 1, powers := [(37, 1), (59, 1)] }, { coefficient := -1, powers := [(40, 1), (55, 1), (56, 1), (64, 1)] }, { coefficient := 1, powers := [(40, 1), (56, 1)] }, { coefficient := -1, powers := [(44, 1), (56, 1), (64, 1)] }, { coefficient := 1, powers := [(45, 1), (52, 1)] }],
  [{ coefficient := 1, powers := [(7, 1), (31, 1), (38, 1), (45, 1), (60, 1)] }, { coefficient := -1, powers := [(7, 1), (34, 1), (38, 1), (45, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(14, 1), (21, 1), (24, 1), (52, 1), (66, 1)] }, { coefficient := -1, powers := [(14, 1), (25, 1), (52, 1), (66, 1)] }, { coefficient := -1, powers := [(14, 1), (31, 1), (37, 1)] }],
...
#print axioms Krenn.Component25.SelectedLeafB4_3_6_7.selectedHasNoCommonZero

end Krenn.Component25.SelectedLeafB4_3_6_7
