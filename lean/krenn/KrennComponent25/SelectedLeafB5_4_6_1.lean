...
namespace Krenn.Component25.SelectedLeafB5_4_6_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "f822ce251d8cb10a15f4fd55971e33714c350fb29c2b06c9aaeef519ffec105a"
...
def multipliers : Fin 21 → SparsePoly (Fin 67) := ![
  [{ coefficient := 1, powers := [(6, 1), (34, 1), (45, 1), (52, 1), (66, 1)] }, { coefficient := 1, powers := [(6, 1), (34, 1), (52, 1), (56, 1), (66, 1)] }, { coefficient := -1, powers := [(21, 1), (52, 1), (66, 1)] }, { coefficient := -1, powers := [(21, 1), (56, 1), (66, 1)] }, { coefficient := -1, powers := [(31, 1), (37, 1), (66, 1)] }, { coefficient := -1, powers := [(34, 1), (36, 1), (52, 1), (56, 1), (66, 1)] }],
  ...
  [{ coefficient := -1, powers := [(21, 1), (66, 1)] }, { coefficient := -1, powers := [(34, 1), (36, 1), (52, 1), (66, 1)] }],
  ...
  [{ coefficient := -1, powers := [(6, 1), (34, 1), (52, 1)] }, { coefficient := 1, powers := [(21, 1), (29, 1), (66, 1)] }, { coefficient := 1, powers := [(29, 1), (34, 1), (36, 1), (52, 1), (66, 1)] }],
  ...
  [{ coefficient := 1, powers := [(0, 1), (4, 1), (29, 1), (34, 1), (52, 1), (66, 1)] }, { coefficient := 1, powers := [(0, 1), (7, 1), (18, 1), (29, 1), (34, 1), (52, 1), (61, 1), (66, 1)] }, { coefficient := 1, powers := [(0, 1), (7, 1), (29, 1), (34, 1), (52, 1), (66, 1)] }, { coefficient := 1, powers := [(2, 1), (4, 1), (29, 1), (31, 1), (62, 1), (66, 1)] }, { coefficient := -1, powers := [(2, 1), (4, 1), (31, 1), (62, 1)] }, { coefficient := 1, powers := [(6, 1), (14, 1), (34, 1), (52, 1)] }, { coefficient := -1, powers := [(7, 1), (29, 1), (31, 1), (66, 1)] }, { coefficient := 1, powers := [(7, 1), (34, 1)] }],
...
#print axioms Krenn.Component25.SelectedLeafB5_4_6_1.selectedHasNoCommonZero

end Krenn.Component25.SelectedLeafB5_4_6_1
