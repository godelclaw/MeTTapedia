...
namespace Krenn.Component25.SelectedLeafB5_4_2_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "887a2942808d5f6dea5ea5bd4ba0fa3ceecfb6fbf20c0f8ae299cc4f320fdd84"
...
def multipliers : Fin 31 → SparsePoly (Fin 67) := ![
  [{ coefficient := -2, powers := [(22, 1), (29, 1), (48, 1), (53, 1), (64, 1), (66, 1)] }],
  ...
  [{ coefficient := -1, powers := [(16, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (2, 1), (24, 1), (48, 1), (54, 1), (61, 1), (66, 1)] }, { coefficient := 1, powers := [(0, 1), (2, 1), (48, 1), (54, 1), (66, 1)] }, { coefficient := -1, powers := [(0, 1), (16, 1), (29, 1), (48, 1), (50, 1), (66, 1)] }, { coefficient := 2, powers := [(12, 1), (29, 1), (48, 1), (64, 1), (66, 1)] }, { coefficient := -1, powers := [(16, 1), (24, 1), (29, 1), (48, 1), (50, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (24, 1), (48, 1), (61, 1)] }, { coefficient := -1, powers := [(2, 1), (48, 1)] }],
  [{ coefficient := 2, powers := [(29, 1), (48, 1), (53, 1), (64, 1), (66, 1)] }],
  ...
  [{ coefficient := 1, powers := [(0, 1), (2, 1), (24, 1), (29, 1), (48, 1), (54, 1), (61, 1), (66, 1)] }, { coefficient := -1, powers := [(0, 1), (2, 1), (29, 1), (48, 1), (54, 1), (66, 1)] }, { coefficient := 1, powers := [(0, 1), (16, 1), (29, 2), (48, 1), (50, 1), (66, 1)] }, { coefficient := -2, powers := [(12, 1), (29, 2), (48, 1), (64, 1), (66, 1)] }, { coefficient := 1, powers := [(16, 1), (24, 1), (29, 2), (48, 1), (50, 1), (66, 1)] }, { coefficient := 2, powers := [(17, 1), (18, 1), (23, 1), (54, 1)] }, { coefficient := 2, powers := [(17, 1), (23, 1), (24, 1), (54, 1)] }],
...
#print axioms Krenn.Component25.SelectedLeafB5_4_2_5.selectedHasNoCommonZero

end Krenn.Component25.SelectedLeafB5_4_2_5
