...
namespace Krenn.Component25.SelectedLeafB4_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "5dcb072b604e896d6506a35e9b2bf1d2a852e31b6dbccdd3c2c11829a437be87"
def certificateSHA256 : String := "431af4354664027e3c9f443ebd749ace92df42263f1b20372bdb908b43b15260"

set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedSourceIndices : Fin 27 → Fin 662 := ![
  1,
  14,
  21,
  162,
...
def multipliers : Fin 27 → SparsePoly (Fin 64) := ![
  ...
  [{ coefficient := 1, powers := [(23, 1), (43, 1), (54, 1), (61, 1)] }, { coefficient := 2, powers := [(23, 1), (46, 1), (54, 1)] }, { coefficient := 1, powers := [(29, 1), (41, 1), (43, 1), (61, 1)] }, { coefficient := 1, powers := [(29, 1), (41, 1), (46, 1)] }],
  [{ coefficient := 2, powers := [(23, 1), (54, 1)] }, { coefficient := 1, powers := [(29, 1), (41, 1)] }],
  [{ coefficient := -1, powers := [(11, 1), (41, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(16, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (5, 1), (60, 1)] }, { coefficient := -1, powers := [(5, 1), (24, 1), (60, 1)] }, { coefficient := -1, powers := [(12, 1), (18, 1), (48, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (32, 1)] }, { coefficient := -1, powers := [(12, 1), (23, 1)] }],
  [{ coefficient := -1, powers := [(16, 1), (23, 1), (54, 1), (61, 1)] }, { coefficient := -1, powers := [(16, 1), (29, 1), (41, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(23, 1)] }],
  [{ coefficient := 1, powers := [(18, 1), (29, 1), (48, 1)] }],
  [{ coefficient := -2, powers := [(18, 1), (23, 1), (54, 1)] }, { coefficient := -1, powers := [(18, 1), (29, 1), (41, 1)] }],
  ...
  [{ coefficient := 1, powers := [(16, 1), (23, 1), (43, 1), (54, 1)] }, { coefficient := 1, powers := [(16, 1), (29, 1), (41, 1), (43, 1)] }],
  [{ coefficient := 1, powers := [(6, 1), (38, 1), (59, 1), (60, 1)] }, { coefficient := 1, powers := [(38, 1), (60, 1)] }, { coefficient := -1, powers := [(39, 1), (41, 1), (57, 1), (62, 1)] }, { coefficient := 1, powers := [(41, 1), (57, 1)] }, { coefficient := -1, powers := [(48, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (35, 1), (41, 1)] }, { coefficient := -1, powers := [(17, 1), (29, 1), (41, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (5, 1), (29, 1), (60, 1)] }, { coefficient := -1, powers := [(0, 1), (5, 1), (32, 1), (57, 1)] }, { coefficient := 1, powers := [(0, 1), (12, 1), (23, 1), (57, 1)] }, { coefficient := 1, powers := [(12, 1), (18, 1), (29, 1), (48, 1)] }, { coefficient := 2, powers := [(17, 1), (18, 1), (23, 1), (54, 1)] }, { coefficient := 1, powers := [(17, 1), (18, 1), (29, 1), (41, 1)] }, { coefficient := 2, powers := [(17, 1), (23, 1), (24, 1), (54, 1)] }, { coefficient := 1, powers := [(17, 1), (24, 1), (29, 1), (41, 1)] }]
]
...
#print axioms Krenn.Component25.SelectedLeafB4_5.selectedHasNoCommonZero

end Krenn.Component25.SelectedLeafB4_5
