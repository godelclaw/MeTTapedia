...
namespace Krenn.Component25.SelectedLeafB5_6_0_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "761463d996b1e005b7a7ae8a1a8de27019f281b9d6708c534ca670da9d8a7015"
def certificateSHA256 : String := "7a817fa9758e4bce1a263633701e8ee324135fc6ee8c7e37b93d34f0b725ecf5"
...
def multipliers : Fin 20 → SparsePoly (Fin 67) := ![
  [{ coefficient := -1, powers := [(21, 1), (52, 1), (66, 1)] }, { coefficient := -1, powers := [(31, 1), (37, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (3, 1), (14, 1), (34, 1), (45, 1), (62, 1), (66, 1)] }, { coefficient := 1, powers := [(7, 1), (34, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(7, 1), (34, 1), (45, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(3, 1), (34, 1), (45, 1), (66, 1)] }, { coefficient := 1, powers := [(20, 1), (45, 1), (66, 1)] }, { coefficient := 1, powers := [(21, 1), (24, 1), (52, 1), (66, 1)] }, { coefficient := -1, powers := [(21, 1), (66, 1)] }, { coefficient := -1, powers := [(24, 1), (31, 1), (37, 1), (66, 1)] }, { coefficient := -1, powers := [(25, 1), (52, 1), (66, 1)] }],
  ...
  [{ coefficient := 1, powers := [(1, 1), (40, 1)] }, { coefficient := 1, powers := [(2, 1), (3, 1), (14, 1), (34, 1), (45, 1), (62, 1)] }, { coefficient := -1, powers := [(3, 1), (10, 1), (29, 1), (34, 1), (45, 1), (66, 1)] }, { coefficient := 1, powers := [(4, 1), (31, 1)] }, { coefficient := -1, powers := [(7, 1), (18, 1), (29, 1), (34, 1), (45, 1), (66, 1)] }, { coefficient := 1, powers := [(7, 1), (18, 1), (34, 1), (45, 1)] }, { coefficient := 1, powers := [(10, 1), (20, 1), (29, 1), (45, 1), (66, 1)] }, { coefficient := -1, powers := [(10, 1), (20, 1), (45, 1)] }, { coefficient := -1, powers := [(10, 1), (21, 1), (24, 2), (52, 1), (65, 1)] }, { coefficient := 1, powers := [(10, 1), (21, 1), (24, 1), (29, 1), (52, 1), (66, 1)] }, { coefficient := -1, powers := [(10, 1), (21, 1), (29, 1), (66, 1)] }, { coefficient := 1, powers := [(10, 1), (24, 2), (31, 1), (37, 1), (65, 1)] }, { coefficient := -1, powers := [(10, 1), (24, 1), (29, 1), (31, 1), (37, 1), (66, 1)] }, { coefficient := -1, powers := [(10, 1), (25, 1), (29, 1), (52, 1), (66, 1)] }, { coefficient := 1, powers := [(10, 1), (25, 1), (52, 1)] }],
...
#print axioms Krenn.Component25.SelectedLeafB5_6_0_5.selectedHasNoCommonZero

end Krenn.Component25.SelectedLeafB5_6_0_5
