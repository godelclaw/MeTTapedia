...
namespace Krenn.Component25.SelectedLeafB5_0_2_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "bf6dc97b9c3c142761174a2cb28df0a4a95b8524387020bbf84f1b716de80fc9"
...
def multipliers : Fin 21 → SparsePoly (Fin 65) := ![
  [{ coefficient := 1, powers := [(6, 1), (34, 1), (45, 1), (52, 1), (64, 1)] }, { coefficient := 1, powers := [(6, 1), (34, 1), (52, 1), (56, 1), (64, 1)] }, { coefficient := -1, powers := [(21, 1), (52, 1), (64, 1)] }, { coefficient := -1, powers := [(21, 1), (56, 1), (64, 1)] }, { coefficient := -1, powers := [(31, 1), (37, 1), (64, 1)] }, { coefficient := -1, powers := [(34, 1), (36, 1), (52, 1), (56, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (4, 1), (34, 1), (52, 1), (64, 1)] }, { coefficient := -1, powers := [(0, 1), (7, 1), (18, 1), (34, 1), (52, 1), (61, 1), (64, 1)] }, { coefficient := -1, powers := [(0, 1), (7, 1), (34, 1), (52, 1), (64, 1)] }, { coefficient := -1, powers := [(2, 1), (4, 1), (31, 1), (62, 1), (64, 1)] }, { coefficient := 1, powers := [(7, 1), (31, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(21, 1), (64, 1)] }, { coefficient := -1, powers := [(34, 1), (36, 1), (52, 1), (64, 1)] }],
  ...
  [{ coefficient := -1, powers := [(6, 1), (34, 1), (52, 1)] }, { coefficient := 1, powers := [(21, 1), (29, 1), (64, 1)] }, { coefficient := 1, powers := [(29, 1), (34, 1), (36, 1), (52, 1), (64, 1)] }],
  ...
  [{ coefficient := 1, powers := [(0, 1), (4, 1), (29, 1), (34, 1), (52, 1), (64, 1)] }, { coefficient := 1, powers := [(0, 1), (7, 1), (18, 1), (29, 1), (34, 1), (52, 1), (61, 1), (64, 1)] }, { coefficient := 1, powers := [(0, 1), (7, 1), (29, 1), (34, 1), (52, 1), (64, 1)] }, { coefficient := 1, powers := [(2, 1), (4, 1), (29, 1), (31, 1), (62, 1), (64, 1)] }, { coefficient := -1, powers := [(2, 1), (4, 1), (31, 1), (62, 1)] }, { coefficient := 1, powers := [(6, 1), (14, 1), (34, 1), (52, 1)] }, { coefficient := -1, powers := [(7, 1), (29, 1), (31, 1), (64, 1)] }, { coefficient := 1, powers := [(7, 1), (34, 1)] }],
...
#print axioms Krenn.Component25.SelectedLeafB5_0_2_1.selectedHasNoCommonZero

end Krenn.Component25.SelectedLeafB5_0_2_1
