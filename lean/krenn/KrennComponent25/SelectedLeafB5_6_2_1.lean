...
namespace Krenn.Component25.SelectedLeafB5_6_2_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "0d86240d017f3035caeba17561c8d2a42d0990385c2ec0dc34e45e7260655e25"
def certificateSHA256 : String := "c18fa3caadf1f90ae98fde51ffe670140a7f5711da130b878538f3ec1436c3c1"
...
def multipliers : Fin 20 → SparsePoly (Fin 67) := ![
  ...
  [{ coefficient := 1, powers := [(2, 1), (19, 1), (54, 1), (61, 1), (66, 1)] }, { coefficient := 2, powers := [(12, 1), (19, 1), (29, 1), (61, 1), (66, 1)] }, { coefficient := 1, powers := [(16, 1), (23, 1), (54, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(16, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [(29, 1), (53, 1)] }],
  [{ coefficient := -2, powers := [(2, 1), (54, 1), (61, 1)] }, { coefficient := -2, powers := [(12, 1), (29, 1), (61, 1)] }],
  ...
  [{ coefficient := -1, powers := [(2, 1), (38, 1), (60, 1)] }, { coefficient := 1, powers := [(2, 1), (48, 1), (54, 1)] }, { coefficient := 2, powers := [(12, 1), (29, 1), (48, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (35, 1)] }, { coefficient := -1, powers := [(17, 1), (29, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (2, 1), (41, 1), (61, 1)] }, { coefficient := -1, powers := [(2, 1), (19, 1), (22, 1), (54, 1), (61, 1), (66, 1)] }, { coefficient := -1, powers := [(2, 1), (19, 1), (50, 1), (61, 1)] }, { coefficient := 1, powers := [(2, 1), (41, 1)] }, { coefficient := 1, powers := [(5, 1), (32, 1)] }, { coefficient := -2, powers := [(12, 1), (19, 1), (22, 1), (29, 1), (61, 1), (66, 1)] }, { coefficient := -1, powers := [(12, 1), (23, 1)] }, { coefficient := -1, powers := [(16, 1), (22, 1), (23, 1), (54, 1), (66, 1)] }],
  [{ coefficient := 2, powers := [(2, 1), (48, 1), (54, 1), (61, 1)] }, { coefficient := 2, powers := [(12, 1), (29, 1), (48, 1), (61, 1)] }, { coefficient := 2, powers := [(16, 1), (23, 1), (46, 1), (54, 1)] }, { coefficient := 1, powers := [(16, 1), (29, 1), (48, 1), (53, 1)] }, { coefficient := 2, powers := [(17, 1), (23, 1), (40, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (19, 1), (43, 1), (54, 1), (61, 1)] }, { coefficient := -2, powers := [(12, 1), (19, 1), (29, 1), (43, 1), (61, 1)] }, { coefficient := -1, powers := [(16, 1), (23, 1), (43, 1), (54, 1)] }]
]
...
#print axioms Krenn.Component25.SelectedLeafB5_6_2_1.selectedHasNoCommonZero

end Krenn.Component25.SelectedLeafB5_6_2_1
