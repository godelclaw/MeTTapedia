...
namespace Krenn.Component25.SelectedLeafB5_6_2_6_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "d0556abc2187a182a084e1c1ab59ceeef1ab97ede1c110a9233c48de4fe99b6b"
...
def multipliers : Fin 16 → SparsePoly (Fin 71) := ![
  ...
  [{ coefficient := -2, powers := [(23, 1), (60, 1), (70, 1)] }, { coefficient := 1, powers := [(23, 1)] }],
  ...
  [{ coefficient := 1, powers := [(2, 1), (41, 1)] }, { coefficient := 1, powers := [(5, 1), (32, 1)] }, { coefficient := 2, powers := [(12, 1), (23, 1), (60, 1), (70, 1)] }, { coefficient := -1, powers := [(12, 1), (23, 1)] }],
...
#print axioms Krenn.Component25.SelectedLeafB5_6_2_6_7.selectedHasNoCommonZero

end Krenn.Component25.SelectedLeafB5_6_2_6_7
