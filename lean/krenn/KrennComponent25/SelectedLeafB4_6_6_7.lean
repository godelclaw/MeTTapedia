...
namespace Krenn.Component25.SelectedLeafB4_6_6_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "189445820d6a25b11735ad6caf70c9a77b9758d251df66f79b9790e9b2d1ee8c"
def certificateSHA256 : String := "9cb6ac17cad2e8c6332da2b3f5e02f748e7eac750e41886820d46ded66abbf2c"
...
def multipliers : Fin 16 → SparsePoly (Fin 69) := ![
  [{ coefficient := -1, powers := [(3, 1), (24, 2), (34, 1), (45, 1), (52, 1), (56, 1), (66, 1), (68, 1)] }, { coefficient := 1, powers := [(3, 1), (24, 1), (34, 1), (45, 1), (52, 1), (56, 1), (68, 1)] }, { coefficient := -1, powers := [(3, 1), (34, 1), (45, 1), (56, 1), (68, 1)] }, { coefficient := -1, powers := [(21, 1), (24, 2), (52, 1), (56, 1), (66, 1), (68, 1)] }, { coefficient := 1, powers := [(21, 1), (24, 1), (52, 1), (56, 1), (68, 1)] }, { coefficient := -1, powers := [(21, 1), (52, 1), (68, 1)] }, { coefficient := -1, powers := [(21, 1), (55, 1), (56, 1), (64, 1), (68, 1)] }, { coefficient := -1, powers := [(21, 1), (56, 1), (68, 1)] }, { coefficient := 1, powers := [(24, 2), (31, 1), (37, 1), (56, 1), (66, 1), (68, 1)] }, { coefficient := -1, powers := [(24, 1), (31, 1), (37, 1), (56, 1), (68, 1)] }, { coefficient := -1, powers := [(25, 1), (44, 1), (56, 1), (64, 1), (68, 1)] }, { coefficient := -1, powers := [(26, 1), (40, 1), (68, 1)] }, { coefficient := -2, powers := [(26, 1), (45, 1), (68, 1)] }, { coefficient := -1, powers := [(31, 1), (37, 1), (68, 1)] }],
  [{ coefficient := 1, powers := [(7, 1), (34, 1), (68, 1)] }],
  [{ coefficient := -1, powers := [(7, 1), (34, 1), (45, 1), (68, 1)] }],
  [{ coefficient := 1, powers := [(3, 1), (24, 1), (34, 1), (45, 1), (52, 1), (68, 1)] }, { coefficient := -1, powers := [(3, 1), (34, 1), (45, 1), (68, 1)] }, { coefficient := 1, powers := [(20, 1), (45, 1), (68, 1)] }, { coefficient := 1, powers := [(21, 1), (24, 1), (52, 1), (68, 1)] }, { coefficient := -1, powers := [(21, 1), (68, 1)] }, { coefficient := -1, powers := [(24, 1), (31, 1), (37, 1), (68, 1)] }, { coefficient := -1, powers := [(25, 1), (52, 1), (68, 1)] }, { coefficient := 1, powers := [(26, 1), (68, 1)] }],
  [{ coefficient := -1, powers := [(3, 1), (24, 1), (34, 1), (45, 1), (52, 1), (66, 1)] }, { coefficient := -1, powers := [(21, 1), (24, 1), (52, 1), (66, 1)] }, { coefficient := 1, powers := [(24, 1), (31, 1), (37, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(7, 1), (29, 1), (34, 1), (45, 1), (68, 1)] }, { coefficient := -1, powers := [(7, 1), (34, 1), (45, 1)] }],
  [{ coefficient := 1, powers := [(56, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(52, 1)] }],
  [{ coefficient := 1, powers := [(45, 1)] }],
  [{ coefficient := 1, powers := [(3, 1), (24, 2), (34, 1), (45, 1), (52, 1), (66, 1)] }, { coefficient := -1, powers := [(3, 1), (24, 1), (29, 1), (34, 1), (45, 1), (52, 1), (68, 1)] }, { coefficient := 1, powers := [(3, 1), (29, 1), (34, 1), (45, 1), (68, 1)] }, { coefficient := -1, powers := [(20, 1), (29, 1), (45, 1), (68, 1)] }, { coefficient := 1, powers := [(21, 1), (24, 2), (52, 1), (66, 1)] }, { coefficient := -1, powers := [(21, 1), (24, 1), (29, 1), (52, 1), (68, 1)] }, { coefficient := 1, powers := [(21, 1), (29, 1), (68, 1)] }, { coefficient := -1, powers := [(24, 2), (31, 1), (37, 1), (66, 1)] }, { coefficient := 1, powers := [(24, 1), (29, 1), (31, 1), (37, 1), (68, 1)] }, { coefficient := 1, powers := [(25, 1), (29, 1), (52, 1), (68, 1)] }, { coefficient := -1, powers := [(25, 1), (52, 1)] }, { coefficient := -1, powers := [(26, 1), (29, 1), (68, 1)] }, { coefficient := 1, powers := [(26, 1)] }],
  [{ coefficient := 1, powers := [(10, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := 1, powers := [(37, 1), (59, 1)] }, { coefficient := -1, powers := [(40, 1), (55, 1), (56, 1), (64, 1)] }, { coefficient := 1, powers := [(40, 1), (56, 1)] }, { coefficient := -1, powers := [(44, 1), (56, 1), (64, 1)] }, { coefficient := -1, powers := [(45, 1), (52, 1)] }],
  ...
  [{ coefficient := -1, powers := [(0, 1), (7, 1), (34, 1), (45, 1), (52, 1)] }, { coefficient := 1, powers := [(3, 1), (7, 1), (24, 1), (34, 1), (45, 1), (52, 1), (59, 1)] }, { coefficient := -1, powers := [(3, 1), (7, 1), (34, 1), (45, 1), (59, 1)] }, { coefficient := 1, powers := [(3, 1), (10, 1), (24, 2), (34, 1), (45, 1), (52, 1), (56, 1), (66, 1)] }, { coefficient := 1, powers := [(3, 1), (14, 1), (24, 1), (34, 1), (45, 1), (52, 2)] }, { coefficient := -1, powers := [(3, 1), (14, 1), (34, 1), (45, 1), (52, 1)] }, { coefficient := -1, powers := [(7, 1), (18, 1), (34, 1), (45, 1), (52, 1)] }, { coefficient := -1, powers := [(7, 1), (18, 1), (34, 1), (45, 1), (56, 1)] }, { coefficient := 1, powers := [(7, 1), (20, 1), (45, 1), (59, 1)] }, { coefficient := 1, powers := [(7, 1), (21, 1), (24, 1), (52, 1), (59, 1)] }, { coefficient := -1, powers := [(7, 1), (21, 1), (59, 1)] }, { coefficient := -1, powers := [(7, 1), (24, 1), (31, 1), (37, 1), (59, 1)] }, { coefficient := -1, powers := [(7, 1), (25, 1), (52, 1), (59, 1)] }, { coefficient := 1, powers := [(7, 1), (26, 1), (59, 1)] }, { coefficient := -1, powers := [(7, 1), (34, 1), (40, 1)] }, { coefficient := -1, powers := [(7, 1), (34, 1), (45, 1)] }, { coefficient := 1, powers := [(10, 1), (20, 1), (45, 1), (56, 1)] }, { coefficient := 1, powers := [(10, 1), (21, 1), (24, 2), (52, 1), (56, 1), (66, 1)] }, { coefficient := 1, powers := [(10, 1), (21, 1), (52, 1)] }, { coefficient := 1, powers := [(10, 1), (21, 1), (55, 1), (56, 1), (64, 1)] }, { coefficient := -1, powers := [(10, 1), (24, 2), (31, 1), (37, 1), (56, 1), (66, 1)] }, { coefficient := 1, powers := [(10, 1), (25, 1), (44, 1), (56, 1), (64, 1)] }, { coefficient := -1, powers := [(10, 1), (25, 1), (52, 1), (56, 1)] }, { coefficient := 1, powers := [(10, 1), (26, 1), (40, 1)] }, { coefficient := 2, powers := [(10, 1), (26, 1), (45, 1)] }, { coefficient := 1, powers := [(10, 1), (26, 1), (56, 1)] }, { coefficient := 1, powers := [(10, 1), (31, 1), (37, 1)] }, { coefficient := 1, powers := [(14, 1), (20, 1), (45, 1), (52, 1)] }, { coefficient := 1, powers := [(14, 1), (21, 1), (24, 1), (52, 2)] }, { coefficient := -1, powers := [(14, 1), (21, 1), (52, 1)] }, { coefficient := -1, powers := [(14, 1), (24, 1), (31, 1), (37, 1), (52, 1)] }, { coefficient := -1, powers := [(14, 1), (25, 1), (52, 2)] }, { coefficient := 1, powers := [(14, 1), (26, 1), (52, 1)] }]
]
...
#print axioms Krenn.Component25.SelectedLeafB4_6_6_7.selectedHasNoCommonZero

end Krenn.Component25.SelectedLeafB4_6_6_7
