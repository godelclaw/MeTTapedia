...
namespace Krenn.Component25.SelectedLeafB7_6_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "209c16fe45652b92f750fbbc8bc044c6bb05a08280534ed6f193b729dba059c7"
def certificateSHA256 : String := "cbc54982b98a2ec0a22da6f082570ed5dc9ed052b99543a17f28d3fe99118b49"
...
def multipliers : Fin 27 → SparsePoly (Fin 67) := ![
  ...
  [{ coefficient := 1, powers := [(29, 1), (48, 1), (53, 1)] }],
  ...
  [{ coefficient := -1, powers := [(2, 1), (38, 1), (60, 1)] }, { coefficient := -1, powers := [(5, 1), (35, 1), (54, 1)] }, { coefficient := 1, powers := [(17, 1), (23, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (29, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (9, 1), (29, 1), (60, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (35, 1)] }],
  [{ coefficient := 1, powers := [(12, 1), (18, 1), (29, 1), (48, 1)] }, { coefficient := 1, powers := [(12, 1), (24, 1), (29, 1), (48, 1)] }],
...
#print axioms Krenn.Component25.SelectedLeafB7_6_4.selectedHasNoCommonZero

end Krenn.Component25.SelectedLeafB7_6_4
