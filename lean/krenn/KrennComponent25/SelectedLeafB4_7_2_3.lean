...
namespace Krenn.Component25.SelectedLeafB4_7_2_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "0c81bd2004415b7407d9863390ee16555e8bb4ab08a0e7249b4e6ebe72452b21"
...
def multipliers : Fin 22 → SparsePoly (Fin 68) := ![
  ...
  [{ coefficient := -2, powers := [(3, 1), (12, 1), (19, 1), (29, 1), (59, 1), (61, 1), (67, 1)] }, { coefficient := -1, powers := [(3, 1), (16, 1), (23, 1), (54, 1), (59, 1), (67, 1)] }],
  ...
  [{ coefficient := -1, powers := [(2, 1), (3, 1), (41, 1), (59, 1)] }, { coefficient := -1, powers := [(3, 1), (5, 1), (32, 1), (59, 1)] }, { coefficient := 2, powers := [(3, 1), (12, 1), (19, 1), (22, 1), (29, 1), (59, 1), (61, 1), (67, 1)] }, { coefficient := 1, powers := [(3, 1), (12, 1), (23, 1), (59, 1)] }, { coefficient := 1, powers := [(3, 1), (16, 1), (22, 1), (23, 1), (54, 1), (59, 1), (67, 1)] }],
...
#print axioms Krenn.Component25.SelectedLeafB4_7_2_3.selectedHasNoCommonZero

end Krenn.Component25.SelectedLeafB4_7_2_3
