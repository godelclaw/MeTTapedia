...
namespace Krenn.Component25.SelectedLeafB5_4_4_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "8d710749fd3d678505edf59355ad9f80ae2a838baf3a47c077bb89bb8564b69b"
def certificateSHA256 : String := "91f159675bd46acda3be3a6aaceca04fbf41d3db46bf7ca911aecc20de3cb1f7"
...
def multipliers : Fin 29 → SparsePoly (Fin 67) := ![
  ...
  [{ coefficient := 1, powers := [(2, 1), (38, 1), (50, 1), (59, 1), (66, 1)] }, { coefficient := 1, powers := [(12, 1), (19, 1), (29, 1), (61, 1), (66, 1)] }, { coefficient := 1, powers := [(12, 1), (27, 1), (38, 1), (59, 1), (66, 1)] }, { coefficient := 1, powers := [(16, 1), (23, 1), (54, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(16, 1), (54, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (2, 1), (48, 1), (54, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (48, 1)] }],
  [{ coefficient := -1, powers := [(29, 1), (53, 1)] }],
  [{ coefficient := -1, powers := [(12, 1), (29, 1), (61, 1)] }],
  ...
  [{ coefficient := -1, powers := [(6, 1), (32, 1), (38, 1), (59, 1)] }, { coefficient := -2, powers := [(23, 1), (54, 1)] }, { coefficient := -1, powers := [(27, 1), (38, 1), (50, 1), (59, 1)] }],
  ...
  [{ coefficient := -1, powers := [(0, 1), (2, 1), (29, 1), (48, 1), (54, 1), (66, 1)] }],
  ...
  [{ coefficient := -1, powers := [(2, 1), (22, 1), (38, 1), (50, 1), (59, 1), (66, 1)] }, { coefficient := 1, powers := [(2, 1), (41, 1)] }, { coefficient := 1, powers := [(5, 1), (32, 1)] }, { coefficient := -1, powers := [(12, 1), (19, 1), (22, 1), (29, 1), (61, 1), (66, 1)] }, { coefficient := -1, powers := [(12, 1), (22, 1), (27, 1), (38, 1), (59, 1), (66, 1)] }, { coefficient := -1, powers := [(12, 1), (23, 1)] }, { coefficient := -1, powers := [(16, 1), (22, 1), (23, 1), (54, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(6, 1), (16, 1), (32, 1), (38, 1), (46, 1), (59, 1)] }, { coefficient := 1, powers := [(6, 1), (17, 1), (32, 1), (38, 1), (40, 1), (59, 1)] }, { coefficient := 1, powers := [(12, 1), (29, 1), (48, 1), (61, 1)] }, { coefficient := 1, powers := [(16, 1), (22, 1), (38, 1), (40, 1), (60, 1)] }, { coefficient := 1, powers := [(16, 1), (22, 1), (38, 1), (45, 1), (60, 1)] }, { coefficient := 2, powers := [(16, 1), (23, 1), (46, 1), (54, 1)] }, { coefficient := 1, powers := [(16, 1), (27, 1), (38, 1), (40, 1), (60, 1)] }, { coefficient := 1, powers := [(16, 1), (27, 1), (38, 1), (45, 1), (60, 1)] }, { coefficient := 1, powers := [(16, 1), (27, 1), (38, 1), (46, 1), (50, 1), (59, 1)] }, { coefficient := 1, powers := [(16, 1), (35, 1), (36, 1), (38, 1), (53, 1), (59, 1)] }, { coefficient := 2, powers := [(17, 1), (23, 1), (40, 1), (54, 1)] }, { coefficient := 1, powers := [(17, 1), (27, 1), (38, 1), (40, 1), (50, 1), (59, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (2, 1), (45, 1), (48, 1), (54, 1)] }, { coefficient := -1, powers := [(2, 1), (38, 1), (43, 1), (50, 1), (59, 1)] }, { coefficient := -1, powers := [(12, 1), (19, 1), (29, 1), (43, 1), (61, 1)] }, { coefficient := -1, powers := [(12, 1), (27, 1), (38, 1), (43, 1), (59, 1)] }, { coefficient := -1, powers := [(16, 1), (23, 1), (43, 1), (54, 1)] }]
]
...
#print axioms Krenn.Component25.SelectedLeafB5_4_4_3.selectedHasNoCommonZero

end Krenn.Component25.SelectedLeafB5_4_4_3
