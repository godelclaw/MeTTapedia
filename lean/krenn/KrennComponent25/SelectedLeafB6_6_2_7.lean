...
namespace Krenn.Component25.SelectedLeafB6_6_2_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "aa62eb2924a7687f903c32d2cc58c70f417d1e07872d61547ba0f8f3efd90ed1"
def certificateSHA256 : String := "e9a3ac85a61953c394734eff40b40679055e5da61dd4cb2e75a138348237bc2d"
...
def multipliers : Fin 22 → SparsePoly (Fin 69) := ![
  [{ coefficient := 2, powers := [(12, 1), (25, 1), (29, 1), (62, 1)] }],
  [{ coefficient := 2, powers := [(17, 1), (20, 1), (23, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(22, 1), (48, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (17, 1), (29, 1), (50, 1), (66, 1), (68, 1)] }, { coefficient := 1, powers := [(17, 1), (24, 1), (29, 1), (50, 1), (66, 1), (68, 1)] }, { coefficient := -1, powers := [(17, 1), (50, 1)] }],
  ...
  [{ coefficient := -1, powers := [(17, 1), (29, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(29, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := 2, powers := [(12, 1), (29, 1), (48, 1)] }, { coefficient := 2, powers := [(17, 1), (23, 1), (54, 1)] }],
  [{ coefficient := 1, powers := [(38, 1), (60, 1)] }, { coefficient := -1, powers := [(48, 1), (54, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (35, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (41, 1)] }, { coefficient := 1, powers := [(5, 1), (32, 1)] }, { coefficient := -1, powers := [(12, 1), (23, 1)] }, { coefficient := -1, powers := [(16, 1), (22, 1), (23, 1), (54, 1), (68, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (29, 1), (60, 1)] }, { coefficient := -1, powers := [(12, 1), (29, 1), (48, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (17, 1), (29, 1), (47, 1), (50, 1), (66, 1)] }, { coefficient := -1, powers := [(16, 1), (23, 1), (43, 1), (54, 1)] }, { coefficient := -1, powers := [(17, 1), (24, 1), (29, 1), (47, 1), (50, 1), (66, 1)] }]
]
...
#print axioms Krenn.Component25.SelectedLeafB6_6_2_7.selectedHasNoCommonZero

end Krenn.Component25.SelectedLeafB6_6_2_7
