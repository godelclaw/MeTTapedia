...
namespace Krenn.Component25.SelectedLeafB4_2_6_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "7dbdc237e2aec3a35165c3c3fc5b22c9bf1a57815c29725497ab0233b81b054e"
...
def multipliers : Fin 16 → SparsePoly (Fin 68) := ![
  [{ coefficient := -1, powers := [(3, 1), (24, 2), (34, 1), (45, 1), (52, 1), (56, 1), (65, 1), (67, 1)] }, { coefficient := 1, powers := [(3, 1), (24, 1), (34, 1), (45, 1), (52, 1), (56, 1), (67, 1)] }, { coefficient := -1, powers := [(3, 1), (34, 1), (45, 1), (56, 1), (67, 1)] }, { coefficient := -1, powers := [(21, 1), (24, 2), (52, 1), (56, 1), (65, 1), (67, 1)] }, { coefficient := 1, powers := [(21, 1), (24, 1), (52, 1), (56, 1), (67, 1)] }, { coefficient := -1, powers := [(21, 1), (52, 1), (67, 1)] }, { coefficient := -1, powers := [(21, 1), (55, 1), (56, 1), (63, 1), (67, 1)] }, { coefficient := -1, powers := [(21, 1), (56, 1), (67, 1)] }, { coefficient := 1, powers := [(24, 2), (31, 1), (37, 1), (56, 1), (65, 1), (67, 1)] }, { coefficient := -1, powers := [(24, 1), (31, 1), (37, 1), (56, 1), (67, 1)] }, { coefficient := -1, powers := [(25, 1), (44, 1), (56, 1), (63, 1), (67, 1)] }, { coefficient := -1, powers := [(26, 1), (40, 1), (67, 1)] }, { coefficient := -2, powers := [(26, 1), (45, 1), (67, 1)] }, { coefficient := -1, powers := [(31, 1), (37, 1), (67, 1)] }],
...
#print axioms Krenn.Component25.SelectedLeafB4_2_6_7.selectedHasNoCommonZero

end Krenn.Component25.SelectedLeafB4_2_6_7
