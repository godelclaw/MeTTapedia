...
namespace Krenn.Component25.SelectedLeafB7_6_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "c748ba3a2f2710d0c6db7d16e47ffe84f422870eb2ceba45df6b5423f3fa4424"
...
def multipliers : Fin 30 → SparsePoly (Fin 68) := ![
  ...
  [{ coefficient := -1, powers := [(19, 1), (29, 1), (36, 1), (52, 1), (60, 1), (67, 1)] }, { coefficient := -1, powers := [(22, 1), (38, 1), (60, 1), (67, 1)] }, { coefficient := -1, powers := [(23, 1), (24, 1), (53, 1), (57, 1), (67, 1)] }, { coefficient := 1, powers := [(23, 1), (43, 1), (54, 1), (67, 1)] }, { coefficient := -1, powers := [(27, 1), (38, 1), (60, 1), (67, 1)] }, { coefficient := -1, powers := [(29, 1), (36, 1), (47, 1), (60, 1), (67, 1)] }],
...
#print axioms Krenn.Component25.SelectedLeafB7_6_5.selectedHasNoCommonZero

end Krenn.Component25.SelectedLeafB7_6_5
