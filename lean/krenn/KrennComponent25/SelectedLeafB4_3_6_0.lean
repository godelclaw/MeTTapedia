...
namespace Krenn.Component25.SelectedLeafB4_3_6_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "5e8a431632efd19477720e8cae3281e280808c035e9d56c90888eafab60526e1"
def certificateSHA256 : String := "f1c3c026c4ec4d58562d17e2745e270270f6cd8afc181b595e3bc415cf47a34a"
...
def multipliers : Fin 16 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := -1, powers := [(2, 1), (40, 1), (41, 1), (62, 1)] }, { coefficient := 1, powers := [(2, 1), (41, 1)] }, { coefficient := 1, powers := [(5, 1), (32, 1)] }, { coefficient := -1, powers := [(12, 1), (23, 1)] }, { coefficient := -1, powers := [(16, 1), (28, 1), (41, 1), (62, 1)] }],
  ...
  [{ coefficient := 1, powers := [(5, 1), (60, 1)] }, { coefficient := -1, powers := [(12, 1), (48, 1)] }, { coefficient := -1, powers := [(16, 1), (41, 1), (46, 1), (62, 1)] }, { coefficient := 1, powers := [(16, 1), (48, 1), (50, 1)] }, { coefficient := -1, powers := [(17, 1), (40, 1), (41, 1), (62, 1)] }, { coefficient := -1, powers := [(17, 1), (47, 1), (50, 1)] }]
]
...
#print axioms Krenn.Component25.SelectedLeafB4_3_6_0.selectedHasNoCommonZero

end Krenn.Component25.SelectedLeafB4_3_6_0
