...
namespace Krenn.Component25.SelectedLeafB7_6_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "c13fbf176d4870ddfdfb891779276ec9071a2a2cf8cf2b3242b267257e40eb64"
def certificateSHA256 : String := "812ada9e43ee5b98de6b947926c97ae5a1ac8be56aec1532d48c9fca2d932e5e"
...
def multipliers : Fin 20 → SparsePoly (Fin 68) := ![
  [{ coefficient := 1, powers := [(12, 1), (25, 1), (29, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (20, 1), (48, 1), (62, 1)] }, { coefficient := -1, powers := [(5, 1), (20, 1), (35, 1), (62, 1)] }, { coefficient := 1, powers := [(17, 1), (20, 1), (23, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(22, 1), (48, 1)] }],
  [{ coefficient := -1, powers := [(17, 1), (50, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (60, 1), (64, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(12, 1), (29, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (48, 1), (62, 1)] }, { coefficient := 1, powers := [(5, 1), (35, 1), (62, 1)] }, { coefficient := -1, powers := [(17, 1), (23, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (60, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (9, 1), (60, 1), (64, 1), (65, 1)] }],
  ...
  [{ coefficient := -1, powers := [(2, 1), (38, 1), (60, 1)] }, { coefficient := -1, powers := [(5, 1), (35, 1), (54, 1)] }, { coefficient := 1, powers := [(12, 1), (29, 1), (48, 1)] }, { coefficient := 1, powers := [(17, 1), (23, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (29, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (9, 1), (29, 1), (60, 1), (64, 1)] }],
...
#print axioms Krenn.Component25.SelectedLeafB7_6_6.selectedHasNoCommonZero

end Krenn.Component25.SelectedLeafB7_6_6
