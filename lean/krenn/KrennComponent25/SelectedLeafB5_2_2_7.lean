...
namespace Krenn.Component25.SelectedLeafB5_2_2_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "50d23065c85333a98b783470fe5b637a6ee8ed22726fdb48c00bf4316ccb4b97"
...
def multipliers : Fin 38 → SparsePoly (Fin 68) := ![
  [{ coefficient := 2, powers := [(0, 1), (22, 1), (28, 1), (48, 1), (52, 1), (54, 1), (64, 1), (67, 1)] }, { coefficient := 2, powers := [(22, 1), (29, 1), (48, 1), (50, 1), (63, 1), (65, 1), (67, 1)] }, { coefficient := -1, powers := [(22, 1), (29, 1), (48, 1), (50, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(22, 1), (48, 1)] }],
  [{ coefficient := 2, powers := [(17, 1), (27, 1), (54, 1), (67, 1)] }, { coefficient := -1, powers := [(17, 1), (50, 1)] }],
  [{ coefficient := -2, powers := [(28, 1), (48, 1), (52, 1), (54, 1), (64, 1)] }, { coefficient := -2, powers := [(28, 1), (48, 1), (54, 1), (56, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (19, 1), (54, 1), (61, 1), (67, 1)] }, { coefficient := 1, powers := [(16, 1), (23, 1), (54, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(16, 1), (54, 1)] }],
  [{ coefficient := 2, powers := [(2, 1), (48, 1), (54, 1), (64, 1), (67, 1)] }, { coefficient := -2, powers := [(12, 1), (29, 1), (48, 1), (63, 1), (67, 1)] }, { coefficient := -2, powers := [(17, 1), (23, 1), (24, 1), (54, 1), (67, 1)] }],
  [{ coefficient := -2, powers := [(17, 1), (23, 1)] }],
  [{ coefficient := -2, powers := [(0, 1), (28, 1), (48, 1), (52, 1), (54, 1), (64, 1), (67, 1)] }, { coefficient := -2, powers := [(29, 1), (48, 1), (50, 1), (63, 1), (65, 1), (67, 1)] }, { coefficient := 1, powers := [(29, 1), (48, 1), (50, 1), (67, 1)] }],
  [{ coefficient := 2, powers := [(29, 1), (48, 1), (63, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(29, 1), (53, 1)] }],
  [{ coefficient := 1, powers := [(16, 1), (29, 1), (53, 1)] }],
  [{ coefficient := 1, powers := [(23, 1)] }],
  [{ coefficient := -2, powers := [(24, 1), (29, 1), (48, 1), (63, 1), (65, 1)] }, { coefficient := 2, powers := [(29, 1), (48, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(12, 1)] }],
  [{ coefficient := -2, powers := [(17, 1), (54, 1)] }],
  [{ coefficient := -2, powers := [(28, 1), (48, 1), (54, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(54, 1)] }],
  [{ coefficient := 2, powers := [(48, 1), (54, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(48, 1)] }],
  [{ coefficient := 1, powers := [(29, 1)] }],
  [{ coefficient := -2, powers := [(0, 1), (28, 1), (48, 1), (54, 1), (64, 1)] }, { coefficient := 2, powers := [(24, 1), (28, 1), (48, 1), (54, 1), (64, 1)] }],
  ...
  [{ coefficient := 2, powers := [(0, 1), (16, 1), (28, 1), (48, 1), (52, 1), (54, 1), (64, 1)] }, { coefficient := 1, powers := [(2, 1), (19, 1), (43, 1), (54, 1), (61, 1)] }, { coefficient := -2, powers := [(2, 1), (40, 1), (48, 1), (54, 1), (64, 1)] }, { coefficient := -2, powers := [(2, 1), (45, 1), (48, 1), (54, 1), (64, 1)] }, { coefficient := 2, powers := [(12, 1), (29, 1), (40, 1), (48, 1), (63, 1)] }, { coefficient := 2, powers := [(12, 1), (29, 1), (45, 1), (48, 1), (63, 1)] }, { coefficient := -1, powers := [(16, 1), (23, 1), (43, 1), (54, 1)] }, { coefficient := 2, powers := [(16, 1), (29, 1), (48, 1), (50, 1), (63, 1), (65, 1)] }, { coefficient := -1, powers := [(16, 1), (29, 1), (48, 1), (50, 1)] }, { coefficient := 2, powers := [(17, 1), (23, 1), (24, 1), (40, 1), (54, 1)] }, { coefficient := 2, powers := [(17, 1), (23, 1), (24, 1), (45, 1), (54, 1)] }, { coefficient := -2, powers := [(17, 1), (27, 1), (47, 1), (54, 1)] }]
]
...
#print axioms Krenn.Component25.SelectedLeafB5_2_2_7.selectedHasNoCommonZero

end Krenn.Component25.SelectedLeafB5_2_2_7
