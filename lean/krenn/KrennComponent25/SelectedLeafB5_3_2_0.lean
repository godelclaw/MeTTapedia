...
namespace Krenn.Component25.SelectedLeafB5_3_2_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "463ff81636545dabf54f4d99449b4f0a0cd6b63502d497f05c3abeff797d8677"
def certificateSHA256 : String := "7ee7f71b41bb55636818446a6197046d27ec6de7d77821017c380f35b764859a"
...
def multipliers : Fin 19 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := -1, powers := [(0, 1), (2, 1), (41, 1), (61, 1)] }, { coefficient := -1, powers := [(2, 1), (19, 1), (50, 1), (61, 1)] }, { coefficient := -1, powers := [(2, 1), (40, 1), (41, 1), (63, 1)] }, { coefficient := 1, powers := [(2, 1), (41, 1)] }, { coefficient := 1, powers := [(5, 1), (32, 1)] }, { coefficient := -1, powers := [(12, 1), (23, 1)] }, { coefficient := -1, powers := [(16, 1), (28, 1), (41, 1), (63, 1)] }],
  ...
  [{ coefficient := 1, powers := [(5, 1), (60, 1)] }, { coefficient := -1, powers := [(12, 1), (48, 1)] }, { coefficient := -1, powers := [(16, 1), (41, 1), (46, 1), (63, 1)] }, { coefficient := 1, powers := [(16, 1), (48, 1), (50, 1)] }, { coefficient := -1, powers := [(17, 1), (40, 1), (41, 1), (63, 1)] }, { coefficient := -1, powers := [(17, 1), (47, 1), (50, 1)] }]
]
...
#print axioms Krenn.Component25.SelectedLeafB5_3_2_0.selectedHasNoCommonZero

end Krenn.Component25.SelectedLeafB5_3_2_0
