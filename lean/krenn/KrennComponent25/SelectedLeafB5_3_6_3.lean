...
namespace Krenn.Component25.SelectedLeafB5_3_6_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "1b2f4b238bd0add4c3abc5165c0038008a517a6083a98dc9eb32aff999bdfb2f"
...
def multipliers : Fin 35 → SparsePoly (Fin 69) := ![
  [{ coefficient := -1, powers := [(21, 1), (52, 1), (68, 1)] }, { coefficient := -1, powers := [(21, 1), (55, 1), (56, 1), (65, 1), (68, 1)] }, { coefficient := -1, powers := [(21, 1), (56, 1), (68, 1)] }, { coefficient := 1, powers := [(25, 1), (29, 1), (52, 1), (56, 1), (68, 2)] }, { coefficient := -1, powers := [(25, 1), (44, 1), (56, 1), (65, 1), (68, 1)] }, { coefficient := -1, powers := [(25, 1), (52, 1), (56, 1), (68, 1)] }, { coefficient := -1, powers := [(26, 1), (40, 1), (68, 1)] }, { coefficient := -1, powers := [(26, 1), (45, 1), (68, 1)] }, { coefficient := -1, powers := [(31, 1), (37, 1), (68, 1)] }],
  ...
  [{ coefficient := 1, powers := [(21, 1), (29, 1), (68, 1)] }, { coefficient := -1, powers := [(26, 1), (29, 1), (68, 1)] }, { coefficient := 1, powers := [(26, 1)] }],
  ...
  [{ coefficient := -1, powers := [(29, 1), (45, 1), (52, 1), (68, 1)] }, { coefficient := 1, powers := [(37, 1), (59, 1)] }, { coefficient := -1, powers := [(40, 1), (55, 1), (56, 1), (65, 1)] }, { coefficient := 1, powers := [(40, 1), (56, 1)] }, { coefficient := -1, powers := [(44, 1), (56, 1), (65, 1)] }, { coefficient := 1, powers := [(45, 1), (52, 1)] }],
...
#print axioms Krenn.Component25.SelectedLeafB5_3_6_3.selectedHasNoCommonZero

end Krenn.Component25.SelectedLeafB5_3_6_3
