...
namespace Krenn.Component25.SelectedLeafB0_3_6_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "8a50caf4884e6b6a5d53487514e6c6a8327317f74141e5cdf38fc95ecf475027"
def certificateSHA256 : String := "5bca10ea04a76414045000387734152915cc911255f38283fdce0f1c613bdd66"
...
def multipliers : Fin 14 → SparsePoly (Fin 65) := ![
  [{ coefficient := -1, powers := [(6, 1), (35, 1), (41, 1)] }],
  ...
  [{ coefficient := -1, powers := [(5, 1), (35, 1), (45, 1), (54, 1)] }, { coefficient := -1, powers := [(8, 1), (35, 1), (41, 1), (45, 1)] }, { coefficient := 1, powers := [(17, 1), (23, 1), (45, 1), (54, 1)] }],
  ...
  [{ coefficient := 1, powers := [(8, 1), (32, 1), (48, 1), (52, 1)] }, { coefficient := -1, powers := [(8, 1), (35, 1), (40, 1), (41, 1)] }, { coefficient := -1, powers := [(8, 1), (35, 1), (41, 1), (45, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (60, 1)] }, { coefficient := -1, powers := [(17, 1), (47, 1), (50, 1)] }]
]
...
#print axioms Krenn.Component25.SelectedLeafB0_3_6_0.selectedHasNoCommonZero

end Krenn.Component25.SelectedLeafB0_3_6_0
