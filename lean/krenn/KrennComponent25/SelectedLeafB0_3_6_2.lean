...
namespace Krenn.Component25.SelectedLeafB0_3_6_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "21c71531e03f384fbeca677f108c9ebe59179f6a4005003ed96ddab0ea701665"
def certificateSHA256 : String := "1bc0c60d9086f2a76b6d67ccd9013b8a8973f3f9cd510c43f6f2131f1bea9dbc"
...
def multipliers : Fin 12 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := -1, powers := [(8, 1), (32, 1), (40, 1), (48, 1)] }, { coefficient := -1, powers := [(8, 1), (32, 1), (45, 1), (48, 1)] }, { coefficient := -1, powers := [(8, 1), (35, 1), (40, 1), (41, 1)] }, { coefficient := -1, powers := [(8, 1), (35, 1), (41, 1), (45, 1)] }],
...
#print axioms Krenn.Component25.SelectedLeafB0_3_6_2.selectedHasNoCommonZero

end Krenn.Component25.SelectedLeafB0_3_6_2
