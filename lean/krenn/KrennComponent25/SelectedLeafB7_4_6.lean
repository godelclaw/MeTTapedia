...
namespace Krenn.Component25.SelectedLeafB7_4_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "13449dadee51455803eeb7ba5b55d2c087367e05067e42b81263554193b1d4f6"
def certificateSHA256 : String := "333b60c4a1a5f878acd70c1addc3b19ea2bb1b84cc5da3257d65d25540568c32"
...
def multipliers : Fin 32 → SparsePoly (Fin 67) := ![
  [{ coefficient := 1, powers := [(2, 1), (25, 1), (54, 1), (62, 1)] }, { coefficient := 1, powers := [(12, 1), (25, 1), (29, 1), (56, 1), (62, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(16, 1), (20, 1), (29, 1), (48, 1), (62, 1), (66, 1)] }, { coefficient := -1, powers := [(17, 1), (20, 1), (29, 1), (47, 1), (62, 1), (66, 1)] }],
  ...
  [{ coefficient := -1, powers := [(2, 1), (54, 1), (62, 1)] }, { coefficient := -1, powers := [(12, 1), (29, 1), (56, 1), (62, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(16, 1), (29, 1), (48, 1), (62, 1), (66, 1)] }, { coefficient := 1, powers := [(17, 1), (29, 1), (47, 1), (62, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (48, 1), (62, 1)] }, { coefficient := -1, powers := [(17, 1), (23, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (29, 1), (56, 1), (66, 1)] }, { coefficient := -1, powers := [(29, 1), (47, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(23, 1), (46, 1), (54, 1)] }],
  [{ coefficient := 1, powers := [(23, 1), (54, 1)] }],
  [{ coefficient := 1, powers := [(29, 1), (53, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(16, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [(12, 1), (18, 1), (48, 1)] }],
  [{ coefficient := 1, powers := [(23, 1)] }],
  [{ coefficient := 1, powers := [(18, 1), (29, 1), (48, 1)] }],
  [{ coefficient := -1, powers := [(18, 1), (23, 1), (54, 1)] }, { coefficient := -1, powers := [(19, 1), (29, 1), (53, 1), (66, 1)] }],
  ...
  [{ coefficient := 1, powers := [(29, 1), (56, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(17, 1)] }],
  [{ coefficient := 1, powers := [(29, 1), (46, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := -1, powers := [(2, 1), (38, 1), (60, 1)] }, { coefficient := 1, powers := [(2, 1), (48, 1), (54, 1)] }, { coefficient := 1, powers := [(12, 1), (29, 1), (48, 1), (56, 1), (66, 1)] }, { coefficient := 1, powers := [(16, 1), (29, 1), (48, 1), (53, 1), (66, 1)] }, { coefficient := 1, powers := [(17, 1), (23, 1), (54, 1)] }, { coefficient := -1, powers := [(17, 1), (29, 1), (47, 1), (53, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(12, 1), (18, 1), (29, 1), (48, 1)] }, { coefficient := 1, powers := [(17, 1), (18, 1), (23, 1), (54, 1)] }, { coefficient := 1, powers := [(17, 1), (19, 1), (29, 1), (53, 1), (66, 1)] }, { coefficient := 1, powers := [(17, 1), (23, 1), (24, 1), (54, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (35, 1)] }, { coefficient := -1, powers := [(16, 1), (29, 1), (46, 1), (66, 1)] }, { coefficient := -1, powers := [(17, 1), (29, 1), (56, 1), (66, 1)] }],
...
#print axioms Krenn.Component25.SelectedLeafB7_4_6.selectedHasNoCommonZero

end Krenn.Component25.SelectedLeafB7_4_6
