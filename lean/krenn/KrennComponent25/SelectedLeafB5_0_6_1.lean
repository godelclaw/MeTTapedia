...
namespace Krenn.Component25.SelectedLeafB5_0_6_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "d290aadbd212936fd76971bc4717eb83a08ed244b3e72249122bdf46190a78de"
def certificateSHA256 : String := "48de3a6e2eff906381985084e5090aa68382684d5accbd24a406f478faf235cc"
...
def multipliers : Fin 21 → SparsePoly (Fin 66) := ![
  [{ coefficient := 1, powers := [(6, 1), (34, 1), (45, 1), (52, 1), (65, 1)] }, { coefficient := 1, powers := [(6, 1), (34, 1), (52, 1), (56, 1), (65, 1)] }, { coefficient := -1, powers := [(21, 1), (52, 1), (65, 1)] }, { coefficient := -1, powers := [(21, 1), (56, 1), (65, 1)] }, { coefficient := -1, powers := [(31, 1), (37, 1), (65, 1)] }, { coefficient := -1, powers := [(34, 1), (36, 1), (52, 1), (56, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (4, 1), (34, 1), (52, 1), (65, 1)] }, { coefficient := -1, powers := [(0, 1), (7, 1), (18, 1), (34, 1), (52, 1), (61, 1), (65, 1)] }, { coefficient := -1, powers := [(0, 1), (7, 1), (34, 1), (52, 1), (65, 1)] }, { coefficient := -1, powers := [(2, 1), (4, 1), (31, 1), (62, 1), (65, 1)] }, { coefficient := 1, powers := [(7, 1), (31, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(21, 1), (65, 1)] }, { coefficient := -1, powers := [(34, 1), (36, 1), (52, 1), (65, 1)] }],
  ...
  [{ coefficient := -1, powers := [(6, 1), (34, 1), (52, 1)] }, { coefficient := 1, powers := [(21, 1), (29, 1), (65, 1)] }, { coefficient := 1, powers := [(29, 1), (34, 1), (36, 1), (52, 1), (65, 1)] }],
  ...
  [{ coefficient := 1, powers := [(0, 1), (4, 1), (29, 1), (34, 1), (52, 1), (65, 1)] }, { coefficient := 1, powers := [(0, 1), (7, 1), (18, 1), (29, 1), (34, 1), (52, 1), (61, 1), (65, 1)] }, { coefficient := 1, powers := [(0, 1), (7, 1), (29, 1), (34, 1), (52, 1), (65, 1)] }, { coefficient := 1, powers := [(2, 1), (4, 1), (29, 1), (31, 1), (62, 1), (65, 1)] }, { coefficient := -1, powers := [(2, 1), (4, 1), (31, 1), (62, 1)] }, { coefficient := 1, powers := [(6, 1), (14, 1), (34, 1), (52, 1)] }, { coefficient := -1, powers := [(7, 1), (29, 1), (31, 1), (65, 1)] }, { coefficient := 1, powers := [(7, 1), (34, 1)] }],
  ...
  [{ coefficient := 1, powers := [(0, 1), (4, 1), (34, 1), (45, 1), (52, 1)] }, { coefficient := 1, powers := [(0, 1), (7, 1), (18, 1), (34, 1), (45, 1), (52, 1), (61, 1)] }, { coefficient := 1, powers := [(0, 1), (7, 1), (34, 1), (45, 1), (52, 1)] }, { coefficient := 1, powers := [(2, 1), (4, 1), (31, 1), (45, 1), (62, 1)] }, { coefficient := -1, powers := [(6, 1), (10, 1), (34, 1), (45, 1), (52, 1)] }, { coefficient := -1, powers := [(6, 1), (10, 1), (34, 1), (52, 1), (56, 1)] }, { coefficient := -1, powers := [(7, 1), (21, 1), (59, 1)] }, { coefficient := -1, powers := [(7, 1), (31, 1), (45, 1)] }, { coefficient := -1, powers := [(7, 1), (34, 1), (36, 1), (52, 1), (59, 1)] }, { coefficient := 1, powers := [(10, 1), (21, 1), (52, 1)] }, { coefficient := 1, powers := [(10, 1), (31, 1), (37, 1)] }, { coefficient := -1, powers := [(14, 1), (21, 1), (52, 1)] }, { coefficient := -1, powers := [(14, 1), (34, 1), (36, 1), (52, 2)] }]
]
...
#print axioms Krenn.Component25.SelectedLeafB5_0_6_1.selectedHasNoCommonZero

end Krenn.Component25.SelectedLeafB5_0_6_1
