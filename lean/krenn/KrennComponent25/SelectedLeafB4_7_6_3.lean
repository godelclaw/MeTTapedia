...
namespace Krenn.Component25.SelectedLeafB4_7_6_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "9cb49d01361a6a4b529dfab7c238691702c8b6fe617a39786b7a92ed9291a2d5"
...
def multipliers : Fin 22 → SparsePoly (Fin 69) := ![
  ...
  [{ coefficient := -2, powers := [(3, 1), (12, 1), (19, 1), (29, 1), (59, 1), (61, 1), (68, 1)] }, { coefficient := -1, powers := [(3, 1), (16, 1), (23, 1), (54, 1), (59, 1), (68, 1)] }],
  ...
  [{ coefficient := -1, powers := [(2, 1), (3, 1), (41, 1), (59, 1)] }, { coefficient := -1, powers := [(3, 1), (5, 1), (32, 1), (59, 1)] }, { coefficient := 2, powers := [(3, 1), (12, 1), (19, 1), (22, 1), (29, 1), (59, 1), (61, 1), (68, 1)] }, { coefficient := 1, powers := [(3, 1), (12, 1), (23, 1), (59, 1)] }, { coefficient := 1, powers := [(3, 1), (16, 1), (22, 1), (23, 1), (54, 1), (59, 1), (68, 1)] }],
...
#print axioms Krenn.Component25.SelectedLeafB4_7_6_3.selectedHasNoCommonZero

end Krenn.Component25.SelectedLeafB4_7_6_3
