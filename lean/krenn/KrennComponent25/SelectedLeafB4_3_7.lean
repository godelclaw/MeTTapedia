...
namespace Krenn.Component25.SelectedLeafB4_3_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "b79adb8d318997019acad4a26814efebb4062bb800ea271310700b90e4728713"
def certificateSHA256 : String := "fb29b30e28565fc189d35e0701ee6fcd24cacc3238ac297d02f1950f84158b2d"
...
def multipliers : Fin 41 → SparsePoly (Fin 67) := ![
  ...
  [{ coefficient := 2, powers := [(17, 1), (20, 1), (29, 1), (41, 1), (45, 1), (56, 1), (66, 1)] }, { coefficient := 2, powers := [(17, 1), (21, 1), (29, 1), (41, 1), (52, 1), (66, 1)] }, { coefficient := 2, powers := [(17, 1), (21, 1), (29, 1), (41, 1), (55, 1), (56, 1), (64, 1), (66, 1)] }, { coefficient := 2, powers := [(17, 1), (25, 1), (29, 1), (41, 1), (44, 1), (56, 1), (64, 1), (66, 1)] }, { coefficient := -2, powers := [(17, 1), (25, 1), (29, 1), (41, 1), (52, 1), (56, 1), (66, 1)] }, { coefficient := 2, powers := [(17, 1), (26, 1), (29, 1), (40, 1), (41, 1), (66, 1)] }, { coefficient := 4, powers := [(17, 1), (26, 1), (29, 1), (41, 1), (45, 1), (66, 1)] }, { coefficient := 2, powers := [(17, 1), (26, 1), (29, 1), (41, 1), (56, 1), (66, 1)] }, { coefficient := 2, powers := [(17, 1), (29, 1), (31, 1), (37, 1), (41, 1), (66, 1)] }],
  ...
  [{ coefficient := 1, powers := [(23, 1), (24, 1), (52, 1), (53, 1), (57, 1), (65, 1), (66, 1)] }, { coefficient := -1, powers := [(23, 1), (24, 1), (53, 1), (57, 1), (66, 1)] }, { coefficient := 1, powers := [(23, 1), (43, 1), (54, 1), (66, 1)] }, { coefficient := -1, powers := [(23, 1), (53, 1), (57, 1), (65, 1), (66, 1)] }, { coefficient := -2, powers := [(24, 1), (29, 1), (48, 1), (53, 1), (66, 1)] }, { coefficient := -1, powers := [(28, 1), (41, 1), (57, 1), (65, 1), (66, 1)] }, { coefficient := -1, powers := [(28, 1), (41, 1), (62, 1)] }, { coefficient := -1, powers := [(29, 1), (41, 1), (46, 1), (62, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(12, 1), (23, 1), (52, 1), (56, 1), (57, 1), (65, 1), (66, 1)] }, { coefficient := 1, powers := [(12, 1), (23, 1), (56, 1), (57, 1), (66, 1)] }, { coefficient := 2, powers := [(12, 1), (29, 1), (48, 1), (56, 1), (66, 1)] }, { coefficient := -2, powers := [(17, 1), (23, 1), (40, 1), (54, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(17, 1), (29, 1), (53, 1), (66, 1)] }],
  [{ coefficient := -2, powers := [(7, 1), (17, 1), (29, 1), (41, 1), (59, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(17, 1), (50, 1)] }],
  [{ coefficient := 2, powers := [(17, 1), (23, 1), (40, 1)] }],
  [{ coefficient := -1, powers := [(23, 1), (52, 1), (53, 1), (57, 1), (65, 1)] }, { coefficient := 1, powers := [(23, 1), (53, 1), (57, 1)] }, { coefficient := 2, powers := [(29, 1), (48, 1), (53, 1)] }],
  [{ coefficient := -1, powers := [(16, 1), (54, 1)] }],
  [{ coefficient := -2, powers := [(7, 1), (17, 1), (34, 1), (41, 1)] }],
  [{ coefficient := -2, powers := [(17, 1), (23, 1), (54, 1), (66, 1)] }],
  ...
  [{ coefficient := 1, powers := [(23, 1), (52, 1), (57, 1), (65, 1)] }, { coefficient := -1, powers := [(23, 1), (57, 1)] }, { coefficient := -2, powers := [(29, 1), (48, 1)] }],
  [{ coefficient := 1, powers := [(54, 1)] }],
  [{ coefficient := 1, powers := [(48, 1)] }],
  [{ coefficient := 1, powers := [(29, 1)] }],
  [{ coefficient := 1, powers := [(17, 1)] }],
  [{ coefficient := -2, powers := [(17, 1), (29, 1), (41, 1), (56, 1), (64, 1)] }],
  ...
  [{ coefficient := -2, powers := [(17, 1), (29, 1), (37, 1), (41, 1), (59, 1)] }, { coefficient := 2, powers := [(17, 1), (29, 1), (40, 1), (41, 1), (55, 1), (56, 1), (64, 1)] }, { coefficient := -2, powers := [(17, 1), (29, 1), (40, 1), (41, 1), (56, 1)] }, { coefficient := 2, powers := [(17, 1), (29, 1), (41, 1), (44, 1), (56, 1), (64, 1)] }, { coefficient := 2, powers := [(17, 1), (29, 1), (41, 1), (45, 1), (52, 1)] }],
  [{ coefficient := 1, powers := [(38, 1), (60, 1)] }, { coefficient := -1, powers := [(40, 1), (41, 1), (57, 1), (62, 1)] }, { coefficient := -1, powers := [(41, 1), (56, 1), (57, 1), (65, 1)] }, { coefficient := 1, powers := [(41, 1), (57, 1)] }, { coefficient := -1, powers := [(47, 1), (53, 1), (57, 1), (65, 1)] }, { coefficient := -1, powers := [(48, 1), (54, 1)] }],
  ...
  [{ coefficient := 2, powers := [(4, 1), (17, 1), (29, 1), (31, 1), (41, 1), (56, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (32, 1), (57, 1)] }],
  [{ coefficient := 2, powers := [(0, 1), (17, 1), (23, 1), (40, 1), (54, 1)] }, { coefficient := 2, powers := [(7, 1), (17, 1), (21, 1), (29, 1), (41, 1), (59, 1)] }, { coefficient := -2, powers := [(10, 1), (17, 1), (20, 1), (29, 1), (41, 1), (45, 1), (56, 1)] }, { coefficient := -2, powers := [(10, 1), (17, 1), (21, 1), (29, 1), (41, 1), (52, 1)] }, { coefficient := -2, powers := [(10, 1), (17, 1), (21, 1), (29, 1), (41, 1), (55, 1), (56, 1), (64, 1)] }, { coefficient := -2, powers := [(10, 1), (17, 1), (25, 1), (29, 1), (41, 1), (44, 1), (56, 1), (64, 1)] }, { coefficient := 2, powers := [(10, 1), (17, 1), (25, 1), (29, 1), (41, 1), (52, 1), (56, 1)] }, { coefficient := -2, powers := [(10, 1), (17, 1), (26, 1), (29, 1), (40, 1), (41, 1)] }, { coefficient := -4, powers := [(10, 1), (17, 1), (26, 1), (29, 1), (41, 1), (45, 1)] }, { coefficient := -2, powers := [(10, 1), (17, 1), (26, 1), (29, 1), (41, 1), (56, 1)] }, { coefficient := -2, powers := [(10, 1), (17, 1), (29, 1), (31, 1), (37, 1), (41, 1)] }, { coefficient := 1, powers := [(12, 1), (18, 1), (23, 1), (52, 1), (56, 1), (57, 1), (65, 1)] }, { coefficient := -1, powers := [(12, 1), (18, 1), (23, 1), (56, 1), (57, 1)] }, { coefficient := -2, powers := [(12, 1), (18, 1), (29, 1), (48, 1), (56, 1)] }, { coefficient := -1, powers := [(16, 1), (23, 1), (24, 1), (52, 1), (53, 1), (57, 1), (65, 1)] }, { coefficient := 1, powers := [(16, 1), (23, 1), (24, 1), (53, 1), (57, 1)] }, { coefficient := -1, powers := [(16, 1), (23, 1), (43, 1), (54, 1)] }, { coefficient := 1, powers := [(16, 1), (23, 1), (53, 1), (57, 1), (65, 1)] }, { coefficient := 2, powers := [(16, 1), (24, 1), (29, 1), (48, 1), (53, 1)] }, { coefficient := 1, powers := [(16, 1), (28, 1), (41, 1), (57, 1), (65, 1)] }, { coefficient := 1, powers := [(16, 1), (29, 1), (41, 1), (46, 1), (62, 1)] }, { coefficient := 2, powers := [(17, 1), (18, 1), (23, 1), (40, 1), (54, 1)] }, { coefficient := 1, powers := [(17, 1), (19, 1), (29, 1), (53, 1)] }, { coefficient := 2, powers := [(17, 1), (23, 1), (54, 1)] }]
]
...
#print axioms Krenn.Component25.SelectedLeafB4_3_7.selectedHasNoCommonZero

end Krenn.Component25.SelectedLeafB4_3_7
