...
namespace Krenn.Component25.SelectedLeafB0_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "6c97c950249bd68993123ea9a8d20e45eeb1273dfd5e9b649a8475c6e24ea130"
def certificateSHA256 : String := "30b1c7d775b2659ea2eaf30d2f061c7a708eca06bbde5649028b4d3fcf9d5e11"
...
def multipliers : Fin 22 → SparsePoly (Fin 63) := ![
  ...
  [{ coefficient := 2, powers := [(29, 1), (48, 1), (50, 1), (52, 1)] }],
  [{ coefficient := 1, powers := [(16, 1), (19, 1), (53, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (32, 1)] }, { coefficient := -1, powers := [(12, 1), (23, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (35, 1)] }, { coefficient := -1, powers := [(17, 1), (23, 1)] }],
  [{ coefficient := -2, powers := [(29, 1), (50, 1), (52, 1)] }, { coefficient := 1, powers := [(29, 1), (53, 1)] }],
  ...
  [{ coefficient := 2, powers := [(17, 1), (29, 1), (50, 1)] }],
  [{ coefficient := -2, powers := [(17, 1), (29, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := -1, powers := [(5, 1), (32, 1), (40, 1), (57, 1)] }, { coefficient := -1, powers := [(5, 1), (35, 1), (45, 1), (54, 1)] }, { coefficient := 1, powers := [(12, 1), (23, 1), (40, 1), (57, 1)] }, { coefficient := 1, powers := [(16, 1), (29, 1), (48, 1), (53, 1)] }, { coefficient := 1, powers := [(17, 1), (23, 1), (45, 1), (54, 1)] }, { coefficient := -2, powers := [(17, 1), (29, 1), (47, 1), (50, 1), (52, 1)] }, { coefficient := 2, powers := [(17, 1), (29, 1), (47, 1), (53, 1)] }],
  [{ coefficient := 1, powers := [(38, 1), (60, 1)] }],
  [{ coefficient := 2, powers := [(0, 1), (17, 1), (29, 1), (56, 1)] }, { coefficient := 1, powers := [(2, 1), (57, 1)] }, { coefficient := 1, powers := [(8, 1), (35, 1)] }, { coefficient := 1, powers := [(17, 1), (29, 1)] }]
]
...
#print axioms Krenn.Component25.SelectedLeafB0_6.selectedHasNoCommonZero

end Krenn.Component25.SelectedLeafB0_6
