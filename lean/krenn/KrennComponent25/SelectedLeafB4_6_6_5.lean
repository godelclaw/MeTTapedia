...
namespace Krenn.Component25.SelectedLeafB4_6_6_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "8323a57cc7ff1f03543a6a3227868cc79a3dc8383ac8ea46e6ef189e9d7eeeff"
...
def multipliers : Fin 17 → SparsePoly (Fin 68) := ![
  [{ coefficient := -1, powers := [(3, 1), (24, 2), (34, 1), (45, 1), (52, 1), (56, 1), (66, 1), (67, 1)] }, { coefficient := 1, powers := [(3, 1), (24, 1), (34, 1), (45, 1), (52, 1), (56, 1), (67, 1)] }, { coefficient := -1, powers := [(3, 1), (34, 1), (45, 1), (56, 1), (67, 1)] }, { coefficient := -1, powers := [(21, 1), (24, 2), (52, 1), (56, 1), (66, 1), (67, 1)] }, { coefficient := 1, powers := [(21, 1), (24, 1), (52, 1), (56, 1), (67, 1)] }, { coefficient := -1, powers := [(21, 1), (52, 1), (67, 1)] }, { coefficient := -1, powers := [(21, 1), (55, 1), (56, 1), (64, 1), (67, 1)] }, { coefficient := -1, powers := [(21, 1), (56, 1), (67, 1)] }, { coefficient := 1, powers := [(24, 2), (31, 1), (37, 1), (56, 1), (66, 1), (67, 1)] }, { coefficient := -1, powers := [(24, 1), (31, 1), (37, 1), (56, 1), (67, 1)] }, { coefficient := -1, powers := [(25, 1), (44, 1), (56, 1), (64, 1), (67, 1)] }, { coefficient := -1, powers := [(31, 1), (37, 1), (67, 1)] }],
  [{ coefficient := 1, powers := [(7, 1), (34, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(7, 1), (34, 1), (45, 1), (67, 1)] }],
  [{ coefficient := 1, powers := [(3, 1), (24, 1), (34, 1), (45, 1), (52, 1), (67, 1)] }, { coefficient := -1, powers := [(3, 1), (34, 1), (45, 1), (67, 1)] }, { coefficient := 1, powers := [(20, 1), (45, 1), (67, 1)] }, { coefficient := 1, powers := [(21, 1), (24, 1), (52, 1), (67, 1)] }, { coefficient := -1, powers := [(21, 1), (67, 1)] }, { coefficient := -1, powers := [(24, 1), (31, 1), (37, 1), (67, 1)] }, { coefficient := -1, powers := [(25, 1), (52, 1), (67, 1)] }],
...
#print axioms Krenn.Component25.SelectedLeafB4_6_6_5.selectedHasNoCommonZero

end Krenn.Component25.SelectedLeafB4_6_6_5
