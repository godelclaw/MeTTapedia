...
namespace Krenn.Component25.SelectedLeafB5_3_6_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "a42aab3ff927064273206eba6699bb82edd6744fe27534023238508f0f3649d6"
def certificateSHA256 : String := "5e20a6a165ef7df3f70434fc28ae2c7bf1b51f2d5ea4a40ae3b92d1582f30d0f"
...
def multipliers : Fin 33 → SparsePoly (Fin 69) := ![
  [{ coefficient := -1, powers := [(21, 1), (52, 1), (68, 1)] }, { coefficient := -1, powers := [(21, 1), (55, 1), (56, 1), (65, 1), (68, 1)] }, { coefficient := -1, powers := [(21, 1), (56, 1), (68, 1)] }, { coefficient := -1, powers := [(25, 1), (44, 1), (56, 1), (65, 1), (68, 1)] }, { coefficient := -1, powers := [(31, 1), (37, 1), (68, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (27, 1), (31, 1), (38, 1), (45, 1), (54, 1), (68, 1)] }, { coefficient := 1, powers := [(2, 1), (27, 1), (34, 1), (38, 1), (45, 1), (54, 1), (68, 1)] }, { coefficient := -1, powers := [(5, 1), (27, 1), (31, 1), (45, 1), (54, 1)] }, { coefficient := 1, powers := [(5, 1), (27, 1), (34, 1), (45, 1), (54, 1)] }],
  [{ coefficient := 1, powers := [(19, 1), (21, 1), (24, 1), (52, 1), (64, 1), (67, 1)] }, { coefficient := -1, powers := [(19, 1), (25, 1), (52, 1), (64, 1), (67, 1)] }, { coefficient := -1, powers := [(19, 1), (31, 1), (37, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(7, 1), (17, 1), (27, 1), (31, 1), (45, 1), (54, 1), (68, 1)] }, { coefficient := -1, powers := [(7, 1), (17, 1), (27, 1), (34, 1), (45, 1), (54, 1), (68, 1)] }, { coefficient := -1, powers := [(7, 1), (17, 1), (31, 1), (45, 1), (50, 1)] }, { coefficient := 1, powers := [(7, 1), (17, 1), (34, 1), (45, 1), (50, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (31, 1), (38, 1), (45, 1), (54, 1), (68, 1)] }, { coefficient := -1, powers := [(2, 1), (34, 1), (38, 1), (45, 1), (54, 1), (68, 1)] }, { coefficient := 1, powers := [(5, 1), (31, 1), (45, 1), (54, 1)] }, { coefficient := -1, powers := [(5, 1), (34, 1), (45, 1), (54, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (29, 1), (31, 1), (38, 1), (45, 1), (68, 1)] }, { coefficient := -1, powers := [(2, 1), (29, 1), (34, 1), (38, 1), (45, 1), (68, 1)] }, { coefficient := 1, powers := [(5, 1), (29, 1), (31, 1), (45, 1)] }, { coefficient := -1, powers := [(5, 1), (29, 1), (34, 1), (45, 1)] }],
  [{ coefficient := 1, powers := [(7, 1), (16, 1), (23, 1), (31, 1), (45, 1), (54, 1), (68, 1)] }, { coefficient := -1, powers := [(7, 1), (16, 1), (23, 1), (34, 1), (45, 1), (54, 1), (68, 1)] }],
  [{ coefficient := -1, powers := [(7, 1), (16, 1), (31, 1), (45, 1), (54, 1)] }, { coefficient := 1, powers := [(7, 1), (16, 1), (34, 1), (45, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [(7, 1), (17, 1), (23, 1), (24, 1), (31, 1), (45, 1), (54, 1), (68, 1)] }, { coefficient := 1, powers := [(7, 1), (17, 1), (23, 1), (24, 1), (34, 1), (45, 1), (54, 1), (68, 1)] }, { coefficient := 1, powers := [(7, 1), (34, 1), (68, 1)] }],
  [{ coefficient := -1, powers := [(7, 1), (17, 1), (23, 1), (31, 1), (45, 1)] }, { coefficient := 1, powers := [(7, 1), (17, 1), (23, 1), (34, 1), (45, 1)] }],
  [{ coefficient := -1, powers := [(21, 1), (24, 1), (52, 1), (64, 1), (67, 1)] }, { coefficient := 1, powers := [(25, 1), (52, 1), (64, 1), (67, 1)] }, { coefficient := 1, powers := [(31, 1), (37, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(7, 1), (12, 1), (31, 1), (45, 1)] }, { coefficient := -1, powers := [(7, 1), (12, 1), (34, 1), (45, 1)] }],
  [{ coefficient := -1, powers := [(21, 1), (68, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (31, 1), (38, 1), (45, 1), (68, 1)] }, { coefficient := 1, powers := [(2, 1), (34, 1), (38, 1), (45, 1), (68, 1)] }, { coefficient := -1, powers := [(5, 1), (31, 1), (45, 1)] }, { coefficient := 1, powers := [(5, 1), (34, 1), (45, 1)] }],
  ...
  [{ coefficient := -1, powers := [(24, 1), (45, 1), (52, 1), (67, 1)] }, { coefficient := 1, powers := [(37, 1), (59, 1)] }, { coefficient := -1, powers := [(40, 1), (55, 1), (56, 1), (65, 1)] }, { coefficient := 1, powers := [(40, 1), (56, 1)] }, { coefficient := -1, powers := [(44, 1), (56, 1), (65, 1)] }, { coefficient := 1, powers := [(45, 1), (52, 1)] }],
  [{ coefficient := 1, powers := [(14, 1), (21, 1), (24, 1), (52, 1), (67, 1)] }, { coefficient := -1, powers := [(14, 1), (25, 1), (52, 1), (67, 1)] }, { coefficient := -1, powers := [(14, 1), (31, 1), (37, 1)] }],
...
#print axioms Krenn.Component25.SelectedLeafB5_3_6_5.selectedHasNoCommonZero

end Krenn.Component25.SelectedLeafB5_3_6_5
