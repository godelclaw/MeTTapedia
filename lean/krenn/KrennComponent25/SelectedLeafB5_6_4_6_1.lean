...
namespace Krenn.Component25.SelectedLeafB5_6_4_6_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "b3c1261e8f328eb84927923ad5485553ba17a91c3ae6d73c0f924dfdeb44508b"
def certificateSHA256 : String := "88ff416f2031403e9c03814cc4c7d55b1492e9f6e3f9f60bc9b76d0e2d77720d"
...
def multipliers : Fin 15 → SparsePoly (Fin 69) := ![
  ...
  [{ coefficient := -1, powers := [(16, 1), (38, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (35, 1), (54, 1)] }, { coefficient := -1, powers := [(17, 1), (23, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := 1, powers := [(8, 1), (35, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (18, 1), (35, 1), (54, 1)] }, { coefficient := 1, powers := [(17, 1), (18, 1), (23, 1), (54, 1)] }],
  ...
  [{ coefficient := -1, powers := [(2, 1), (36, 1), (38, 1), (60, 1)] }, { coefficient := -1, powers := [(3, 1), (5, 1), (35, 1), (54, 1)] }, { coefficient := 1, powers := [(3, 1), (16, 1), (27, 1), (38, 1), (60, 1)] }, { coefficient := 1, powers := [(3, 1), (17, 1), (23, 1), (54, 1)] }, { coefficient := 1, powers := [(6, 1), (16, 1), (22, 1), (38, 1), (60, 1)] }]
]
...
#print axioms Krenn.Component25.SelectedLeafB5_6_4_6_1.selectedHasNoCommonZero

end Krenn.Component25.SelectedLeafB5_6_4_6_1
