...
namespace Krenn.Component25.SelectedLeafB5_6_0_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "7b80d4dee2011e09f8aaa59123377274b47922d2b6c705fedbdd96a7fece36a7"
def certificateSHA256 : String := "5c2a19f78e085d694d1ba014c325defafe54c5c675668a41643ed81fb40d81e9"
...
def multipliers : Fin 27 → SparsePoly (Fin 67) := ![
  ...
  [{ coefficient := 1, powers := [(2, 1), (19, 1), (54, 1), (61, 1), (66, 1)] }, { coefficient := 1, powers := [(2, 1), (38, 1), (50, 1), (59, 1), (66, 1)] }, { coefficient := 1, powers := [(12, 1), (19, 1), (29, 1), (61, 1), (66, 1)] }, { coefficient := 1, powers := [(12, 1), (27, 1), (38, 1), (59, 1), (66, 1)] }, { coefficient := 1, powers := [(16, 1), (23, 1), (54, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(16, 1), (54, 1)] }],
  ...
  [{ coefficient := -1, powers := [(2, 1), (19, 1), (22, 1), (54, 1), (61, 1), (66, 1)] }, { coefficient := -1, powers := [(2, 1), (22, 1), (38, 1), (50, 1), (59, 1), (66, 1)] }, { coefficient := 1, powers := [(2, 1), (41, 1)] }, { coefficient := 1, powers := [(5, 1), (32, 1)] }, { coefficient := -1, powers := [(12, 1), (19, 1), (22, 1), (29, 1), (61, 1), (66, 1)] }, { coefficient := -1, powers := [(12, 1), (22, 1), (27, 1), (38, 1), (59, 1), (66, 1)] }, { coefficient := -1, powers := [(12, 1), (23, 1)] }, { coefficient := -1, powers := [(16, 1), (22, 1), (23, 1), (54, 1), (66, 1)] }],
...
#print axioms Krenn.Component25.SelectedLeafB5_6_0_3.selectedHasNoCommonZero

end Krenn.Component25.SelectedLeafB5_6_0_3
