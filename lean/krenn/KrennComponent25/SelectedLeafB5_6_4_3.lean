...
namespace Krenn.Component25.SelectedLeafB5_6_4_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "780f72c57fe779e4161f6193a1db263d0eace78424ad83def65f16527bc8bbd3"
...
def multipliers : Fin 27 → SparsePoly (Fin 68) := ![
  ...
  [{ coefficient := 1, powers := [(2, 1), (19, 1), (54, 1), (61, 1), (67, 1)] }, { coefficient := 1, powers := [(2, 1), (38, 1), (50, 1), (59, 1), (67, 1)] }, { coefficient := 1, powers := [(12, 1), (19, 1), (29, 1), (61, 1), (67, 1)] }, { coefficient := 1, powers := [(12, 1), (27, 1), (38, 1), (59, 1), (67, 1)] }, { coefficient := 1, powers := [(16, 1), (23, 1), (54, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(16, 1), (54, 1)] }],
  ...
  [{ coefficient := -1, powers := [(2, 1), (19, 1), (22, 1), (54, 1), (61, 1), (67, 1)] }, { coefficient := -1, powers := [(2, 1), (22, 1), (38, 1), (50, 1), (59, 1), (67, 1)] }, { coefficient := 1, powers := [(2, 1), (41, 1)] }, { coefficient := 1, powers := [(5, 1), (32, 1)] }, { coefficient := -1, powers := [(12, 1), (19, 1), (22, 1), (29, 1), (61, 1), (67, 1)] }, { coefficient := -1, powers := [(12, 1), (22, 1), (27, 1), (38, 1), (59, 1), (67, 1)] }, { coefficient := -1, powers := [(12, 1), (23, 1)] }, { coefficient := -1, powers := [(16, 1), (22, 1), (23, 1), (54, 1), (67, 1)] }],
...
#print axioms Krenn.Component25.SelectedLeafB5_6_4_3.selectedHasNoCommonZero

end Krenn.Component25.SelectedLeafB5_6_4_3
