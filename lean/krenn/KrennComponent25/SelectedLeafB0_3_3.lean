...
namespace Krenn.Component25.SelectedLeafB0_3_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "04705e4f8e5573dd4cc6b45568825ce355b443823a538a7a0ce7b9889772c87a"
...
def multipliers : Fin 20 → SparsePoly (Fin 65) := ![
  ...
  [{ coefficient := -1, powers := [(8, 1), (35, 1), (41, 1), (52, 1), (64, 1)] }, { coefficient := -1, powers := [(8, 1), (35, 1), (41, 1), (56, 1), (64, 1)] }],
  [{ coefficient := 2, powers := [(12, 1), (29, 1), (43, 1), (52, 1), (64, 1)] }, { coefficient := -1, powers := [(17, 1), (29, 1), (50, 1), (52, 1), (64, 1)] }],
...
#print axioms Krenn.Component25.SelectedLeafB0_3_3.selectedHasNoCommonZero

end Krenn.Component25.SelectedLeafB0_3_3
