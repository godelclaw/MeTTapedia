...
namespace Krenn.Component25.SelectedLeafB5_7_2_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "cc73fa197196e275a8aa4112addbf4ff3e2b3a1a5ae2f332cecaf17995baf36c"
def certificateSHA256 : String := "8ac4667856768cd683f33cd9f2119a4088626d3f86834135931c680a2edab6ba"
...
def multipliers : Fin 26 → SparsePoly (Fin 69) := ![
  ...
  [{ coefficient := -1, powers := [(0, 1), (2, 1), (41, 1), (61, 1)] }, { coefficient := -1, powers := [(2, 1), (19, 1), (50, 1), (61, 1)] }, { coefficient := -1, powers := [(2, 1), (39, 1), (41, 1), (63, 1)] }, { coefficient := 1, powers := [(2, 1), (41, 1)] }, { coefficient := 2, powers := [(3, 1), (12, 1), (27, 1), (47, 1), (59, 1)] }, { coefficient := 1, powers := [(5, 1), (32, 1)] }, { coefficient := -1, powers := [(11, 1), (22, 1), (41, 1), (63, 1)] }, { coefficient := 1, powers := [(12, 1), (23, 1)] }, { coefficient := 2, powers := [(12, 1), (27, 1), (47, 1)] }],
  [{ coefficient := -2, powers := [(0, 1), (17, 1), (45, 1), (47, 1), (50, 1)] }, { coefficient := 1, powers := [(5, 1), (60, 1)] }, { coefficient := -1, powers := [(11, 1), (41, 1), (43, 1), (63, 1)] }, { coefficient := -1, powers := [(12, 1), (48, 1)] }, { coefficient := -2, powers := [(17, 1), (24, 1), (40, 1), (47, 1), (50, 1)] }, { coefficient := -2, powers := [(17, 1), (24, 1), (45, 1), (47, 1), (50, 1)] }, { coefficient := -1, powers := [(17, 1), (39, 1), (41, 1), (63, 1)] }, { coefficient := -1, powers := [(17, 1), (47, 1), (50, 1)] }]
]
...
#print axioms Krenn.Component25.SelectedLeafB5_7_2_6.selectedHasNoCommonZero

end Krenn.Component25.SelectedLeafB5_7_2_6
