...
namespace Krenn.Component25.SelectedLeafB6_6_6_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "99c64002c369dbc0cabb12d712a43ee0865a2d909641ec12c53583f177a0d44e"
...
def multipliers : Fin 22 → SparsePoly (Fin 70) := ![
  ...
  [{ coefficient := 1, powers := [(0, 1), (17, 1), (29, 1), (50, 1), (67, 1), (69, 1)] }, { coefficient := 1, powers := [(17, 1), (24, 1), (29, 1), (50, 1), (67, 1), (69, 1)] }, { coefficient := -1, powers := [(17, 1), (50, 1)] }],
  [{ coefficient := -2, powers := [(12, 1), (29, 1), (62, 1)] }],
  [{ coefficient := -2, powers := [(17, 1), (23, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(16, 1), (23, 1), (54, 1), (69, 1)] }],
  [{ coefficient := -1, powers := [(16, 1), (54, 1)] }],
  ...
  [{ coefficient := -1, powers := [(17, 1), (29, 1), (67, 1)] }],
  ...
  [{ coefficient := 1, powers := [(2, 1), (41, 1)] }, { coefficient := 1, powers := [(5, 1), (32, 1)] }, { coefficient := -1, powers := [(12, 1), (23, 1)] }, { coefficient := -1, powers := [(16, 1), (22, 1), (23, 1), (54, 1), (69, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (29, 1), (60, 1)] }, { coefficient := -1, powers := [(12, 1), (29, 1), (48, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (17, 1), (29, 1), (47, 1), (50, 1), (67, 1)] }, { coefficient := -1, powers := [(16, 1), (23, 1), (43, 1), (54, 1)] }, { coefficient := -1, powers := [(17, 1), (24, 1), (29, 1), (47, 1), (50, 1), (67, 1)] }]
]
...
#print axioms Krenn.Component25.SelectedLeafB6_6_6_7.selectedHasNoCommonZero

end Krenn.Component25.SelectedLeafB6_6_6_7
