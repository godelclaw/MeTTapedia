...
namespace Krenn.Component25.SelectedLeafB5_6_0_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "61b8ed509ca080adb951df59571f3a3411eb88eff1dc06f008850ab30ab62efe"
def certificateSHA256 : String := "5bf3b64bf513e133e71c80f6b0957e13788e31a9ced8861d9d1a37b1c67f5101"
...
def multipliers : Fin 19 → SparsePoly (Fin 68) := ![
  [{ coefficient := -1, powers := [(21, 1), (52, 1), (67, 1)] }, { coefficient := -1, powers := [(26, 1), (40, 1), (67, 1)] }, { coefficient := -2, powers := [(26, 1), (45, 1), (67, 1)] }, { coefficient := -1, powers := [(31, 1), (37, 1), (67, 1)] }],
  ...
  [{ coefficient := -1, powers := [(3, 1), (34, 1), (45, 1), (67, 1)] }, { coefficient := 1, powers := [(20, 1), (45, 1), (67, 1)] }, { coefficient := 1, powers := [(21, 1), (24, 1), (52, 1), (67, 1)] }, { coefficient := -1, powers := [(21, 1), (67, 1)] }, { coefficient := -1, powers := [(24, 1), (31, 1), (37, 1), (67, 1)] }, { coefficient := -1, powers := [(25, 1), (52, 1), (67, 1)] }, { coefficient := 1, powers := [(26, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (3, 1), (14, 1), (28, 1), (34, 1), (45, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(21, 1), (24, 1), (52, 1), (65, 1)] }, { coefficient := 1, powers := [(24, 1), (31, 1), (37, 1), (65, 1)] }],
  ...
  [{ coefficient := 1, powers := [(1, 1), (40, 1)] }, { coefficient := 1, powers := [(2, 1), (3, 1), (14, 1), (34, 1), (45, 1), (62, 1)] }, { coefficient := -1, powers := [(3, 1), (10, 1), (29, 1), (34, 1), (45, 1), (67, 1)] }, { coefficient := 1, powers := [(4, 1), (31, 1)] }, { coefficient := -1, powers := [(7, 1), (18, 1), (29, 1), (34, 1), (45, 1), (67, 1)] }, { coefficient := 1, powers := [(7, 1), (18, 1), (34, 1), (45, 1)] }, { coefficient := 1, powers := [(10, 1), (20, 1), (29, 1), (45, 1), (67, 1)] }, { coefficient := -1, powers := [(10, 1), (20, 1), (45, 1)] }, { coefficient := -1, powers := [(10, 1), (21, 1), (24, 2), (52, 1), (65, 1)] }, { coefficient := 1, powers := [(10, 1), (21, 1), (24, 1), (29, 1), (52, 1), (67, 1)] }, { coefficient := -1, powers := [(10, 1), (21, 1), (29, 1), (67, 1)] }, { coefficient := 1, powers := [(10, 1), (24, 2), (31, 1), (37, 1), (65, 1)] }, { coefficient := -1, powers := [(10, 1), (24, 1), (29, 1), (31, 1), (37, 1), (67, 1)] }, { coefficient := -1, powers := [(10, 1), (25, 1), (29, 1), (52, 1), (67, 1)] }, { coefficient := 1, powers := [(10, 1), (25, 1), (52, 1)] }, { coefficient := 1, powers := [(10, 1), (26, 1), (29, 1), (67, 1)] }, { coefficient := -1, powers := [(10, 1), (26, 1)] }],
...
#print axioms Krenn.Component25.SelectedLeafB5_6_0_7.selectedHasNoCommonZero

end Krenn.Component25.SelectedLeafB5_6_0_7
