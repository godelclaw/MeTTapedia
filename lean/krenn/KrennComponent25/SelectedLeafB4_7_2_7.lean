...
namespace Krenn.Component25.SelectedLeafB4_7_2_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "f5651289729aedecb8d57a02beeacd5255f61efa81d8aa6a163db0944d551a09"
def certificateSHA256 : String := "4b9913640ada7649cff16160effaf08572c55cd43f03d861ebb5170d88a2328f"
...
def multipliers : Fin 33 → SparsePoly (Fin 69) := ![
  ...
  [{ coefficient := -1, powers := [(5, 1), (27, 1), (31, 1), (45, 1), (54, 1)] }, { coefficient := 1, powers := [(5, 1), (27, 1), (31, 1), (54, 1), (56, 1)] }, { coefficient := 1, powers := [(5, 1), (27, 1), (34, 1), (45, 1), (54, 1)] }],
  ...
  [{ coefficient := 1, powers := [(5, 1), (31, 1), (45, 1), (54, 1)] }, { coefficient := -1, powers := [(5, 1), (31, 1), (54, 1), (56, 1)] }, { coefficient := -1, powers := [(5, 1), (34, 1), (45, 1), (54, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (29, 1), (31, 1), (45, 1)] }, { coefficient := -1, powers := [(5, 1), (29, 1), (31, 1), (56, 1)] }, { coefficient := -1, powers := [(5, 1), (29, 1), (34, 1), (45, 1)] }],
  ...
  [{ coefficient := -1, powers := [(5, 1), (31, 1), (45, 1)] }, { coefficient := 1, powers := [(5, 1), (31, 1), (56, 1)] }, { coefficient := 1, powers := [(5, 1), (34, 1), (45, 1)] }],
  ...
  [{ coefficient := 1, powers := [(7, 1), (31, 1), (38, 1), (45, 1), (60, 1)] }, { coefficient := -1, powers := [(7, 1), (31, 1), (38, 1), (56, 1), (60, 1)] }, { coefficient := -1, powers := [(7, 1), (34, 1), (38, 1), (45, 1), (60, 1)] }],
...
#print axioms Krenn.Component25.SelectedLeafB4_7_2_7.selectedHasNoCommonZero

end Krenn.Component25.SelectedLeafB4_7_2_7
