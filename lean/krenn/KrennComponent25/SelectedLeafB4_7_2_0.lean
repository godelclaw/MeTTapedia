...
namespace Krenn.Component25.SelectedLeafB4_7_2_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "400152ca57c354729073ad61c7fdaf2fa74bb669850361959cd6cfba16869d29"
def certificateSHA256 : String := "c5c54c13287391255d1cbe865a4f01e53038f090b19c0bb2690c197307d83e78"
...
def multipliers : Fin 16 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := -1, powers := [(2, 1), (39, 1), (41, 1), (62, 1)] }, { coefficient := 1, powers := [(2, 1), (41, 1)] }, { coefficient := 1, powers := [(5, 1), (32, 1)] }, { coefficient := -1, powers := [(11, 1), (22, 1), (41, 1), (62, 1)] }, { coefficient := -1, powers := [(12, 1), (23, 1)] }],
  [{ coefficient := -1, powers := [(16, 1), (23, 1), (40, 1), (43, 1), (54, 1)] }, { coefficient := -1, powers := [(16, 1), (23, 1), (43, 1), (45, 1), (54, 1)] }, { coefficient := 2, powers := [(16, 1), (23, 1), (46, 1), (54, 1)] }, { coefficient := 2, powers := [(17, 1), (23, 1), (40, 1), (54, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (60, 1)] }, { coefficient := -1, powers := [(11, 1), (41, 1), (43, 1), (62, 1)] }, { coefficient := -1, powers := [(12, 1), (48, 1)] }, { coefficient := 1, powers := [(16, 1), (48, 1), (50, 1)] }, { coefficient := -1, powers := [(17, 1), (39, 1), (41, 1), (62, 1)] }, { coefficient := -1, powers := [(17, 1), (47, 1), (50, 1)] }]
]
...
#print axioms Krenn.Component25.SelectedLeafB4_7_2_0.selectedHasNoCommonZero

end Krenn.Component25.SelectedLeafB4_7_2_0
