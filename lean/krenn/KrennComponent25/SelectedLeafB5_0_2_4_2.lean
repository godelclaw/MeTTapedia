...
namespace Krenn.Component25.SelectedLeafB5_0_2_4_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "5e95f741c65267b3d2f53fa2ee15f81d33ec6c2c97ca368a416540033023e84b"
def certificateSHA256 : String := "a312b9ed6f0a85987ca04efc164700387d50dc65fbdf9cdc5d336b3abc60bae4"
...
def multipliers : Fin 16 → SparsePoly (Fin 66) := ![
  [{ coefficient := 1, powers := [(32, 1), (48, 1), (65, 1)] }],
  ...
  [{ coefficient := 1, powers := [(17, 1), (18, 1), (23, 1), (54, 1)] }, { coefficient := 1, powers := [(17, 1), (23, 1), (24, 1), (54, 1)] }],
...
#print axioms Krenn.Component25.SelectedLeafB5_0_2_4_2.selectedHasNoCommonZero

end Krenn.Component25.SelectedLeafB5_0_2_4_2
