...
namespace Krenn.Component25.SelectedLeafB5_2_2_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "024e85664333d77eb693f7585e124823a398e2a8ffe5cbfd39aa2ace18fdb214"
...
def multipliers : Fin 20 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := 1, powers := [(2, 1), (19, 1), (54, 1), (61, 1), (65, 1)] }, { coefficient := 2, powers := [(12, 1), (19, 1), (29, 1), (61, 1), (65, 1)] }, { coefficient := 1, powers := [(16, 1), (23, 1), (54, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(16, 1), (54, 1)] }],
  ...
  [{ coefficient := -1, powers := [(0, 1), (2, 1), (41, 1), (61, 1)] }, { coefficient := -1, powers := [(2, 1), (19, 1), (22, 1), (54, 1), (61, 1), (65, 1)] }, { coefficient := -1, powers := [(2, 1), (19, 1), (50, 1), (61, 1)] }, { coefficient := 1, powers := [(2, 1), (41, 1)] }, { coefficient := 1, powers := [(5, 1), (32, 1)] }, { coefficient := -2, powers := [(12, 1), (19, 1), (22, 1), (29, 1), (61, 1), (65, 1)] }, { coefficient := -1, powers := [(12, 1), (23, 1)] }, { coefficient := -1, powers := [(16, 1), (22, 1), (23, 1), (54, 1), (65, 1)] }],
...
#print axioms Krenn.Component25.SelectedLeafB5_2_2_1.selectedHasNoCommonZero

end Krenn.Component25.SelectedLeafB5_2_2_1
