...
namespace Krenn.Component25.SelectedLeafB5_0_2_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "e30aa5ff371cf0a6c69cd37236f0594b90775d9e2918c0651fc04321a1352e92"
...
def multipliers : Fin 31 → SparsePoly (Fin 67) := ![
  [{ coefficient := -2, powers := [(22, 1), (29, 1), (48, 1), (53, 1), (63, 1), (66, 1)] }],
  ...
  [{ coefficient := -1, powers := [(16, 1), (23, 1), (54, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(16, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (2, 1), (24, 1), (48, 1), (54, 1), (61, 1), (66, 1)] }, { coefficient := 1, powers := [(0, 1), (2, 1), (48, 1), (54, 1), (66, 1)] }, { coefficient := -1, powers := [(0, 1), (16, 1), (29, 1), (48, 1), (50, 1), (66, 1)] }, { coefficient := 2, powers := [(12, 1), (29, 1), (48, 1), (63, 1), (66, 1)] }, { coefficient := -1, powers := [(16, 1), (24, 1), (29, 1), (48, 1), (50, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (24, 1), (48, 1), (61, 1)] }, { coefficient := -1, powers := [(2, 1), (48, 1)] }],
  [{ coefficient := 2, powers := [(29, 1), (48, 1), (53, 1), (63, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(29, 1), (53, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (54, 1), (61, 1)] }, { coefficient := 1, powers := [(16, 1), (29, 1), (53, 1)] }],
  [{ coefficient := 1, powers := [(23, 1)] }],
  [{ coefficient := -2, powers := [(29, 1), (48, 1), (63, 1)] }],
  ...
  [{ coefficient := 1, powers := [(0, 1), (2, 1), (24, 1), (29, 1), (48, 1), (54, 1), (61, 1), (66, 1)] }, { coefficient := -1, powers := [(0, 1), (2, 1), (29, 1), (48, 1), (54, 1), (66, 1)] }, { coefficient := 1, powers := [(0, 1), (16, 1), (29, 2), (48, 1), (50, 1), (66, 1)] }, { coefficient := -2, powers := [(12, 1), (29, 2), (48, 1), (63, 1), (66, 1)] }, { coefficient := 1, powers := [(16, 1), (24, 1), (29, 2), (48, 1), (50, 1), (66, 1)] }, { coefficient := 2, powers := [(17, 1), (18, 1), (23, 1), (54, 1)] }, { coefficient := 2, powers := [(17, 1), (23, 1), (24, 1), (54, 1)] }],
  ...
  [{ coefficient := -1, powers := [(0, 1), (2, 1), (41, 1), (61, 1)] }, { coefficient := -1, powers := [(2, 1), (19, 1), (50, 1), (61, 1)] }, { coefficient := 1, powers := [(2, 1), (41, 1)] }, { coefficient := 1, powers := [(5, 1), (32, 1)] }, { coefficient := -1, powers := [(12, 1), (23, 1)] }, { coefficient := 1, powers := [(16, 1), (22, 1), (23, 1), (54, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (2, 1), (24, 1), (45, 1), (48, 1), (54, 1), (61, 1)] }, { coefficient := -1, powers := [(0, 1), (2, 1), (45, 1), (48, 1), (54, 1)] }, { coefficient := 1, powers := [(0, 1), (16, 1), (29, 1), (45, 1), (48, 1), (50, 1)] }, { coefficient := -2, powers := [(12, 1), (29, 1), (45, 1), (48, 1), (63, 1)] }, { coefficient := 1, powers := [(16, 1), (23, 1), (43, 1), (54, 1)] }, { coefficient := 1, powers := [(16, 1), (24, 1), (29, 1), (45, 1), (48, 1), (50, 1)] }, { coefficient := -2, powers := [(16, 1), (29, 1), (48, 1), (53, 1), (63, 1)] }]
]
...
#print axioms Krenn.Component25.SelectedLeafB5_0_2_7.selectedHasNoCommonZero

end Krenn.Component25.SelectedLeafB5_0_2_7
