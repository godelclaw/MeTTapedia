...
namespace Krenn.Component25.SelectedLeafB5_7_6_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "ebb9762f7561d8a284dcfa680c041f6dc250a03c76e0c340645ed3ea903ebf1c"
...
def multipliers : Fin 33 → SparsePoly (Fin 70) := ![
  [{ coefficient := -1, powers := [(21, 1), (52, 1), (69, 1)] }, { coefficient := -1, powers := [(21, 1), (55, 1), (56, 1), (66, 1), (69, 1)] }, { coefficient := -1, powers := [(21, 1), (56, 1), (69, 1)] }, { coefficient := -1, powers := [(25, 1), (44, 1), (56, 1), (66, 1), (69, 1)] }, { coefficient := -1, powers := [(31, 1), (37, 1), (69, 1)] }],
  ...
  [{ coefficient := -1, powers := [(21, 1), (69, 1)] }],
  ...
  [{ coefficient := 1, powers := [(21, 1), (29, 1), (69, 1)] }],
...
#print axioms Krenn.Component25.SelectedLeafB5_7_6_5.selectedHasNoCommonZero

end Krenn.Component25.SelectedLeafB5_7_6_5
