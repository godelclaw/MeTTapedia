...
namespace Krenn.Component25.SelectedLeafB4_6_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "29bf7069716b106f53bb5d9cf45cf8c3be9a14f3abb230c7a6eed9c9dff9152b"
...
def multipliers : Fin 26 → SparsePoly (Fin 67) := ![
  [{ coefficient := 2, powers := [(12, 1), (29, 1), (48, 1), (62, 1), (66, 1)] }],
  ...
  [{ coefficient := 2, powers := [(0, 1), (17, 1), (23, 1), (40, 1), (54, 1)] }, { coefficient := -2, powers := [(9, 1), (12, 1), (29, 1), (48, 1), (62, 1)] }, { coefficient := 1, powers := [(12, 1), (18, 1), (23, 1), (52, 1), (56, 1), (57, 1), (65, 1)] }, { coefficient := -1, powers := [(12, 1), (18, 1), (23, 1), (56, 1), (57, 1)] }, { coefficient := -1, powers := [(16, 1), (23, 1), (24, 1), (52, 1), (53, 1), (57, 1), (65, 1)] }, { coefficient := 1, powers := [(16, 1), (23, 1), (24, 1), (53, 1), (57, 1)] }, { coefficient := -1, powers := [(16, 1), (23, 1), (43, 1), (54, 1)] }, { coefficient := 1, powers := [(16, 1), (23, 1), (53, 1), (57, 1), (65, 1)] }, { coefficient := 2, powers := [(17, 1), (18, 1), (23, 1), (40, 1), (54, 1)] }, { coefficient := 1, powers := [(17, 1), (19, 1), (29, 1), (53, 1)] }, { coefficient := 2, powers := [(17, 1), (23, 1), (54, 1)] }]
]
...
#print axioms Krenn.Component25.SelectedLeafB4_6_7.selectedHasNoCommonZero

end Krenn.Component25.SelectedLeafB4_6_7
