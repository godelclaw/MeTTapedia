...
namespace Krenn.Component25.SelectedLeafB0_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "a401dddde6b7dede2822cce72ced9bbf76b69ae80efefcbedfb563c59c8e2412"
def certificateSHA256 : String := "4862bff1a74891a7f5b12c11f6f3fe7cf545b73fc334bc393dd8e88ae44137e5"

set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedSourceIndices : Fin 30 → Fin 662 := ![
  1,
  14,
  17,
  21,
...
def multipliers : Fin 30 → SparsePoly (Fin 63) := ![
  [{ coefficient := 1, powers := [(22, 1), (41, 1), (43, 1)] }],
  [{ coefficient := -1, powers := [(22, 1), (48, 1)] }],
  [{ coefficient := -1, powers := [(12, 1), (22, 1), (52, 1)] }],
  [{ coefficient := -1, powers := [(17, 1), (50, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (29, 1)] }],
  [{ coefficient := 1, powers := [(29, 1), (41, 1), (46, 1)] }],
  [{ coefficient := 1, powers := [(29, 1), (41, 1)] }],
  [{ coefficient := -1, powers := [(11, 1), (41, 1), (61, 1)] }, { coefficient := 1, powers := [(12, 1), (19, 1), (52, 1)] }],
  ...
  [{ coefficient := -1, powers := [(18, 1), (29, 1), (41, 1)] }],
  ...
  [{ coefficient := 1, powers := [(17, 1), (19, 1), (29, 1)] }],
  [{ coefficient := 1, powers := [(12, 1), (19, 1), (29, 1)] }],
  [{ coefficient := 1, powers := [(17, 1), (29, 1), (50, 1)] }],
  [{ coefficient := 1, powers := [(41, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(17, 1), (29, 1)] }],
  [{ coefficient := -1, powers := [(17, 1), (19, 1), (29, 1), (50, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := -1, powers := [(5, 1), (35, 1), (45, 1), (54, 1)] }, { coefficient := -1, powers := [(12, 1), (19, 1), (29, 1), (46, 1), (52, 1)] }, { coefficient := 2, powers := [(12, 1), (29, 1), (48, 1), (52, 1)] }, { coefficient := 1, powers := [(17, 1), (19, 1), (29, 1), (37, 1), (50, 1), (59, 1)] }, { coefficient := 1, powers := [(17, 1), (19, 1), (29, 1), (45, 1), (50, 1), (52, 1)] }, { coefficient := -1, powers := [(17, 1), (19, 1), (29, 1), (45, 1), (53, 1)] }, { coefficient := 1, powers := [(17, 1), (23, 1), (45, 1), (54, 1)] }, { coefficient := 1, powers := [(17, 1), (29, 1), (41, 1), (56, 1)] }, { coefficient := -1, powers := [(17, 1), (29, 1), (47, 1), (50, 1), (52, 1)] }, { coefficient := 1, powers := [(17, 1), (29, 1), (47, 1), (53, 1)] }],
  ...
  [{ coefficient := -1, powers := [(0, 1), (5, 1), (32, 1), (57, 1)] }, { coefficient := 1, powers := [(0, 1), (12, 1), (23, 1), (57, 1)] }, { coefficient := 1, powers := [(0, 1), (17, 1), (19, 1), (29, 1), (50, 1), (56, 1)] }, { coefficient := -1, powers := [(12, 1), (19, 1), (29, 1), (43, 1)] }, { coefficient := 1, powers := [(17, 1), (18, 1), (29, 1), (41, 1)] }, { coefficient := 1, powers := [(17, 1), (19, 1), (29, 1), (50, 1)] }, { coefficient := 1, powers := [(17, 1), (24, 1), (29, 1), (41, 1)] }]
]
...
#print axioms Krenn.Component25.SelectedLeafB0_5.selectedHasNoCommonZero

end Krenn.Component25.SelectedLeafB0_5
