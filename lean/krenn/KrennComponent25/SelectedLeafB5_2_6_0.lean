...
namespace Krenn.Component25.SelectedLeafB5_2_6_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "e1d6d2db3767920b776042237c210152f8c67b23c8e3546ffd9aae2e6fbccf06"
def certificateSHA256 : String := "cb4f5c7a7063b078d44f911393faf4ca9a3c61b52a251ddeaf1ac7b8c446188c"
...
def multipliers : Fin 19 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := 1, powers := [(5, 1), (36, 1), (59, 1), (60, 1)] }, { coefficient := 1, powers := [(5, 1), (60, 1)] }, { coefficient := -1, powers := [(12, 1), (48, 1)] }, { coefficient := 1, powers := [(16, 1), (36, 1), (47, 1), (60, 1)] }, { coefficient := 1, powers := [(16, 1), (48, 1), (50, 1)] }, { coefficient := -1, powers := [(17, 1), (47, 1), (50, 1)] }]
]
...
#print axioms Krenn.Component25.SelectedLeafB5_2_6_0.selectedHasNoCommonZero

end Krenn.Component25.SelectedLeafB5_2_6_0
