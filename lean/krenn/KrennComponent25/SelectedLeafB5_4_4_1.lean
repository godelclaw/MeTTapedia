...
namespace Krenn.Component25.SelectedLeafB5_4_4_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "e02199c8776ff8eac77287a0e36a215812869275b8e7d2e1f93e3697f10d0c37"
...
def multipliers : Fin 29 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := 1, powers := [(2, 1), (38, 1), (50, 1), (59, 1), (65, 1)] }, { coefficient := 1, powers := [(12, 1), (19, 1), (29, 1), (61, 1), (65, 1)] }, { coefficient := 1, powers := [(12, 1), (27, 1), (38, 1), (59, 1), (65, 1)] }, { coefficient := 1, powers := [(16, 1), (23, 1), (54, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(16, 1), (54, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (2, 1), (48, 1), (54, 1), (65, 1)] }],
  ...
  [{ coefficient := -1, powers := [(0, 1), (2, 1), (29, 1), (48, 1), (54, 1), (65, 1)] }],
  ...
  [{ coefficient := -1, powers := [(2, 1), (22, 1), (38, 1), (50, 1), (59, 1), (65, 1)] }, { coefficient := 1, powers := [(2, 1), (41, 1)] }, { coefficient := 1, powers := [(5, 1), (32, 1)] }, { coefficient := -1, powers := [(12, 1), (19, 1), (22, 1), (29, 1), (61, 1), (65, 1)] }, { coefficient := -1, powers := [(12, 1), (22, 1), (27, 1), (38, 1), (59, 1), (65, 1)] }, { coefficient := -1, powers := [(12, 1), (23, 1)] }, { coefficient := -1, powers := [(16, 1), (22, 1), (23, 1), (54, 1), (65, 1)] }],
...
#print axioms Krenn.Component25.SelectedLeafB5_4_4_1.selectedHasNoCommonZero

end Krenn.Component25.SelectedLeafB5_4_4_1
