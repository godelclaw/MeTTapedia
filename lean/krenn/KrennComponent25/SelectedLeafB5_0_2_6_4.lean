...
namespace Krenn.Component25.SelectedLeafB5_0_2_6_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "12aa51f26304aa4f397dfd9a6f092a7811b174c53b118cd51fbea2428e4a182e"
def certificateSHA256 : String := "55c9b6e2d7d5a7f007ee5308de7a1ae096746ab9c7ca1b6e8430c6d2b4a85dbb"
...
def multipliers : Fin 19 → SparsePoly (Fin 67) := ![
  ...
  [{ coefficient := 1, powers := [(16, 1), (48, 1), (54, 1)] }],
  ...
  [{ coefficient := 1, powers := [(2, 1), (36, 1), (48, 1), (54, 1)] }, { coefficient := -1, powers := [(3, 1), (16, 1), (27, 1), (48, 1), (54, 1)] }, { coefficient := -1, powers := [(6, 1), (16, 1), (22, 1), (48, 1), (54, 1)] }],
...
#print axioms Krenn.Component25.SelectedLeafB5_0_2_6_4.selectedHasNoCommonZero

end Krenn.Component25.SelectedLeafB5_0_2_6_4
