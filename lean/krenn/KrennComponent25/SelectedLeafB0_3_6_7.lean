...
namespace Krenn.Component25.SelectedLeafB0_3_6_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "9825c7fe275970682caabea9fdf161c033baa57077acb2ff01ea041a84fb0c60"
def certificateSHA256 : String := "5d3f615073a73ac3c38ff41777eaa8a9502af94e8a93876ca79c3c7b5cdbc0e4"
...
def multipliers : Fin 20 → SparsePoly (Fin 68) := ![
  [{ coefficient := 1, powers := [(21, 1), (52, 1), (55, 1), (63, 1), (67, 1)] }, { coefficient := -1, powers := [(21, 1), (52, 1), (67, 1)] }, { coefficient := -1, powers := [(21, 1), (56, 1), (67, 1)] }, { coefficient := -1, powers := [(24, 1), (26, 1), (45, 1), (65, 1), (67, 1)] }, { coefficient := 1, powers := [(25, 1), (44, 1), (52, 1), (63, 1), (67, 1)] }, { coefficient := -1, powers := [(26, 1), (40, 1), (67, 1)] }, { coefficient := -1, powers := [(26, 1), (45, 1), (67, 1)] }, { coefficient := -1, powers := [(31, 1), (37, 1), (67, 1)] }],
  [{ coefficient := 1, powers := [(19, 1), (20, 1), (45, 1), (62, 1), (65, 1)] }, { coefficient := 1, powers := [(19, 1), (21, 1), (24, 1), (52, 1), (62, 1), (65, 1)] }, { coefficient := -1, powers := [(19, 1), (25, 1), (52, 1), (62, 1), (65, 1)] }, { coefficient := -1, powers := [(19, 1), (26, 1), (45, 1), (62, 1)] }, { coefficient := -1, powers := [(19, 1), (31, 1), (37, 1), (62, 1)] }, { coefficient := 1, powers := [(20, 1), (45, 1), (47, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(4, 1), (31, 1), (67, 1)] }, { coefficient := 1, powers := [(7, 1), (34, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(20, 1), (45, 1), (62, 1), (65, 1)] }, { coefficient := -1, powers := [(21, 1), (24, 1), (52, 1), (62, 1), (65, 1)] }, { coefficient := 1, powers := [(25, 1), (52, 1), (62, 1), (65, 1)] }, { coefficient := 1, powers := [(26, 1), (45, 1), (62, 1)] }, { coefficient := 1, powers := [(31, 1), (37, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(21, 1), (67, 1)] }, { coefficient := 1, powers := [(26, 1), (67, 1)] }],
  ...
  [{ coefficient := -1, powers := [(20, 1), (24, 1), (45, 1), (65, 1)] }, { coefficient := 1, powers := [(21, 1), (29, 1), (67, 1)] }, { coefficient := -1, powers := [(26, 1), (29, 1), (67, 1)] }, { coefficient := 1, powers := [(26, 1)] }],
  ...
  [{ coefficient := 1, powers := [(4, 1), (31, 1), (40, 1)] }, { coefficient := 1, powers := [(4, 1), (31, 1), (45, 1)] }, { coefficient := -1, powers := [(7, 1), (21, 1), (59, 1)] }, { coefficient := 1, powers := [(7, 1), (26, 1), (59, 1)] }, { coefficient := -1, powers := [(7, 1), (34, 1), (40, 1)] }, { coefficient := -1, powers := [(7, 1), (34, 1), (45, 1)] }, { coefficient := -1, powers := [(10, 1), (21, 1), (52, 1), (55, 1), (63, 1)] }, { coefficient := 1, powers := [(10, 1), (21, 1), (52, 1)] }, { coefficient := 1, powers := [(10, 1), (24, 1), (26, 1), (45, 1), (65, 1)] }, { coefficient := -1, powers := [(10, 1), (25, 1), (44, 1), (52, 1), (63, 1)] }, { coefficient := 1, powers := [(10, 1), (26, 1), (40, 1)] }, { coefficient := 1, powers := [(10, 1), (26, 1), (45, 1)] }, { coefficient := 1, powers := [(10, 1), (26, 1), (56, 1)] }, { coefficient := 1, powers := [(10, 1), (31, 1), (37, 1)] }, { coefficient := -1, powers := [(14, 1), (21, 1), (52, 1)] }, { coefficient := 1, powers := [(14, 1), (26, 1), (52, 1)] }]
]
...
#print axioms Krenn.Component25.SelectedLeafB0_3_6_7.selectedHasNoCommonZero

end Krenn.Component25.SelectedLeafB0_3_6_7
