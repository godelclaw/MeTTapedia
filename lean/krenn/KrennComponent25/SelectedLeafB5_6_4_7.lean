...
namespace Krenn.Component25.SelectedLeafB5_6_4_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "76df364c6046eaac605aee979bf8e06f15ca3a7b56f2bb947a395b6cc2adb776"
def certificateSHA256 : String := "61e4a4dd396b21e2fc3d96a5ef27e0011ce7c46969c2545d7e0fb5d168405e16"
...
def multipliers : Fin 19 → SparsePoly (Fin 69) := ![
  [{ coefficient := -1, powers := [(21, 1), (52, 1), (68, 1)] }, { coefficient := -1, powers := [(26, 1), (40, 1), (68, 1)] }, { coefficient := -2, powers := [(26, 1), (45, 1), (68, 1)] }, { coefficient := -1, powers := [(31, 1), (37, 1), (68, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (3, 1), (14, 1), (34, 1), (45, 1), (62, 1), (68, 1)] }, { coefficient := 1, powers := [(7, 1), (34, 1), (68, 1)] }],
  [{ coefficient := -1, powers := [(7, 1), (34, 1), (45, 1), (68, 1)] }],
  [{ coefficient := -1, powers := [(3, 1), (34, 1), (45, 1), (68, 1)] }, { coefficient := 1, powers := [(20, 1), (45, 1), (68, 1)] }, { coefficient := 1, powers := [(21, 1), (24, 1), (52, 1), (68, 1)] }, { coefficient := -1, powers := [(21, 1), (68, 1)] }, { coefficient := -1, powers := [(24, 1), (31, 1), (37, 1), (68, 1)] }, { coefficient := -1, powers := [(25, 1), (52, 1), (68, 1)] }, { coefficient := 1, powers := [(26, 1), (68, 1)] }],
  ...
  [{ coefficient := 1, powers := [(1, 1), (40, 1)] }, { coefficient := 1, powers := [(2, 1), (3, 1), (14, 1), (34, 1), (45, 1), (62, 1)] }, { coefficient := -1, powers := [(3, 1), (10, 1), (29, 1), (34, 1), (45, 1), (68, 1)] }, { coefficient := 1, powers := [(4, 1), (31, 1)] }, { coefficient := -1, powers := [(7, 1), (18, 1), (29, 1), (34, 1), (45, 1), (68, 1)] }, { coefficient := 1, powers := [(7, 1), (18, 1), (34, 1), (45, 1)] }, { coefficient := 1, powers := [(10, 1), (20, 1), (29, 1), (45, 1), (68, 1)] }, { coefficient := -1, powers := [(10, 1), (20, 1), (45, 1)] }, { coefficient := -1, powers := [(10, 1), (21, 1), (24, 2), (52, 1), (66, 1)] }, { coefficient := 1, powers := [(10, 1), (21, 1), (24, 1), (29, 1), (52, 1), (68, 1)] }, { coefficient := -1, powers := [(10, 1), (21, 1), (29, 1), (68, 1)] }, { coefficient := 1, powers := [(10, 1), (24, 2), (31, 1), (37, 1), (66, 1)] }, { coefficient := -1, powers := [(10, 1), (24, 1), (29, 1), (31, 1), (37, 1), (68, 1)] }, { coefficient := -1, powers := [(10, 1), (25, 1), (29, 1), (52, 1), (68, 1)] }, { coefficient := 1, powers := [(10, 1), (25, 1), (52, 1)] }, { coefficient := 1, powers := [(10, 1), (26, 1), (29, 1), (68, 1)] }, { coefficient := -1, powers := [(10, 1), (26, 1)] }],
...
#print axioms Krenn.Component25.SelectedLeafB5_6_4_7.selectedHasNoCommonZero

end Krenn.Component25.SelectedLeafB5_6_4_7
