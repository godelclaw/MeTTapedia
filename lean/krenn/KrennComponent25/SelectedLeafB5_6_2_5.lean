...
namespace Krenn.Component25.SelectedLeafB5_6_2_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "e0921e8369c6fafd6986994404ffbc80e70eefe467f74b5b022fcf3caf7e486e"
def certificateSHA256 : String := "f0b7edc42285a35b68872ea50dd4a476cf71e48bac3b05815db7ef9bece202d0"
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedEquations : Fin 38 → SparsePoly (Fin 68) := ![
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def multipliers : Fin 38 → SparsePoly (Fin 68) := ![
  [{ coefficient := 2, powers := [(0, 1), (22, 1), (28, 1), (48, 1), (52, 1), (54, 1), (65, 1), (67, 1)] }, { coefficient := 2, powers := [(22, 1), (29, 1), (48, 1), (50, 1), (64, 1), (66, 1), (67, 1)] }, { coefficient := -1, powers := [(22, 1), (29, 1), (48, 1), (50, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(22, 1), (48, 1)] }],
  [{ coefficient := 2, powers := [(17, 1), (27, 1), (54, 1), (67, 1)] }, { coefficient := -1, powers := [(17, 1), (50, 1)] }],
  [{ coefficient := -2, powers := [(28, 1), (48, 1), (52, 1), (54, 1), (65, 1)] }, { coefficient := -2, powers := [(28, 1), (48, 1), (54, 1), (56, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (19, 1), (54, 1), (61, 1), (67, 1)] }, { coefficient := 1, powers := [(16, 1), (23, 1), (54, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(16, 1), (54, 1)] }],
  [{ coefficient := 2, powers := [(2, 1), (48, 1), (54, 1), (65, 1), (67, 1)] }, { coefficient := -2, powers := [(12, 1), (29, 1), (48, 1), (64, 1), (67, 1)] }, { coefficient := -2, powers := [(17, 1), (23, 1), (24, 1), (54, 1), (67, 1)] }],
  [{ coefficient := -2, powers := [(17, 1), (23, 1)] }],
  [{ coefficient := -2, powers := [(0, 1), (28, 1), (48, 1), (52, 1), (54, 1), (65, 1), (67, 1)] }, { coefficient := -2, powers := [(29, 1), (48, 1), (50, 1), (64, 1), (66, 1), (67, 1)] }, { coefficient := 1, powers := [(29, 1), (48, 1), (50, 1), (67, 1)] }],
  [{ coefficient := 2, powers := [(29, 1), (48, 1), (64, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(29, 1), (53, 1)] }],
  [{ coefficient := 1, powers := [(16, 1), (29, 1), (53, 1)] }],
  [{ coefficient := 1, powers := [(23, 1)] }],
  [{ coefficient := -2, powers := [(24, 1), (29, 1), (48, 1), (64, 1), (66, 1)] }, { coefficient := 2, powers := [(29, 1), (48, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(12, 1)] }],
  [{ coefficient := -2, powers := [(17, 1), (54, 1)] }],
  [{ coefficient := -2, powers := [(28, 1), (48, 1), (54, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(54, 1)] }],
  [{ coefficient := 2, powers := [(48, 1), (54, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(48, 1)] }],
  [{ coefficient := 1, powers := [(29, 1)] }],
  [{ coefficient := -2, powers := [(0, 1), (28, 1), (48, 1), (54, 1), (65, 1)] }, { coefficient := 2, powers := [(24, 1), (28, 1), (48, 1), (54, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(17, 1)] }],
  [{ coefficient := -1, powers := [(16, 1), (29, 1)] }],
  [{ coefficient := -2, powers := [(16, 1), (48, 1), (54, 1), (65, 1)] }],
  [{ coefficient := 2, powers := [(17, 1), (23, 1), (54, 1)] }],
  [{ coefficient := 2, powers := [(16, 1), (28, 1), (48, 1), (54, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (61, 1)] }],
  [{ coefficient := -2, powers := [(2, 1), (48, 1), (54, 1), (65, 1)] }],
  [{ coefficient := 2, powers := [(0, 1), (48, 1), (54, 1), (65, 1)] }],
  ...
  [{ coefficient := -1, powers := [(0, 1), (2, 1), (41, 1), (61, 1)] }, { coefficient := 1, powers := [(2, 1), (19, 1), (22, 1), (54, 1), (61, 1), (67, 1)] }, { coefficient := -1, powers := [(2, 1), (19, 1), (50, 1), (61, 1)] }, { coefficient := 1, powers := [(2, 1), (41, 1)] }, { coefficient := 1, powers := [(5, 1), (32, 1)] }, { coefficient := -1, powers := [(12, 1), (23, 1)] }, { coefficient := -1, powers := [(16, 1), (22, 1), (23, 1), (54, 1), (67, 1)] }],
  [{ coefficient := 2, powers := [(12, 1), (29, 1), (48, 1), (56, 1), (64, 1)] }, { coefficient := 2, powers := [(16, 1), (29, 1), (48, 1), (53, 1), (64, 1)] }],
  [{ coefficient := 2, powers := [(0, 1), (16, 1), (28, 1), (48, 1), (52, 1), (54, 1), (65, 1)] }, { coefficient := 1, powers := [(2, 1), (19, 1), (43, 1), (54, 1), (61, 1)] }, { coefficient := -2, powers := [(2, 1), (40, 1), (48, 1), (54, 1), (65, 1)] }, { coefficient := -2, powers := [(2, 1), (45, 1), (48, 1), (54, 1), (65, 1)] }, { coefficient := 2, powers := [(12, 1), (29, 1), (40, 1), (48, 1), (64, 1)] }, { coefficient := 2, powers := [(12, 1), (29, 1), (45, 1), (48, 1), (64, 1)] }, { coefficient := -1, powers := [(16, 1), (23, 1), (43, 1), (54, 1)] }, { coefficient := 2, powers := [(16, 1), (29, 1), (48, 1), (50, 1), (64, 1), (66, 1)] }, { coefficient := -1, powers := [(16, 1), (29, 1), (48, 1), (50, 1)] }, { coefficient := 2, powers := [(17, 1), (23, 1), (24, 1), (40, 1), (54, 1)] }, { coefficient := 2, powers := [(17, 1), (23, 1), (24, 1), (45, 1), (54, 1)] }, { coefficient := -2, powers := [(17, 1), (27, 1), (47, 1), (54, 1)] }]
]
...
#print axioms Krenn.Component25.SelectedLeafB5_6_2_5.selectedHasNoCommonZero

end Krenn.Component25.SelectedLeafB5_6_2_5
