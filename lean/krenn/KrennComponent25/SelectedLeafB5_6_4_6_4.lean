...
namespace Krenn.Component25.SelectedLeafB5_6_4_6_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "17e97d31b81d9a778f38a3af3a6044a71f0d862fe0cacf6b3dc2b16f749eba97"
def certificateSHA256 : String := "783263157712db406ba2c4ec57bdedd1c9eadf1220c4e14182f8087d8b6de4b6"
...
def multipliers : Fin 14 → SparsePoly (Fin 69) := ![
  ...
  [{ coefficient := -1, powers := [(3, 1), (5, 1), (35, 1), (54, 1)] }, { coefficient := 1, powers := [(3, 1), (17, 1), (23, 1), (54, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (38, 1)] }]
]
...
#print axioms Krenn.Component25.SelectedLeafB5_6_4_6_4.selectedHasNoCommonZero

end Krenn.Component25.SelectedLeafB5_6_4_6_4
