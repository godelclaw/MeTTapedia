...
namespace Krenn.Component25.SelectedLeafB5_6_6_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "75864631e5356ffe8e9e9fedb98e1d88456b5c9fc29b400536eb683983bc9e56"
...
def multipliers : Fin 38 → SparsePoly (Fin 70) := ![
  [{ coefficient := 2, powers := [(0, 1), (22, 1), (28, 1), (48, 1), (52, 1), (54, 1), (66, 1), (69, 1)] }, { coefficient := 2, powers := [(22, 1), (29, 1), (48, 1), (50, 1), (64, 1), (67, 1), (69, 1)] }, { coefficient := -1, powers := [(22, 1), (29, 1), (48, 1), (50, 1), (69, 1)] }],
  [{ coefficient := -1, powers := [(22, 1), (48, 1)] }],
  [{ coefficient := 2, powers := [(17, 1), (27, 1), (54, 1), (69, 1)] }, { coefficient := -1, powers := [(17, 1), (50, 1)] }],
  [{ coefficient := -2, powers := [(28, 1), (48, 1), (52, 1), (54, 1), (66, 1)] }, { coefficient := -2, powers := [(28, 1), (48, 1), (54, 1), (56, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (19, 1), (54, 1), (61, 1), (69, 1)] }, { coefficient := 1, powers := [(16, 1), (23, 1), (54, 1), (69, 1)] }],
  [{ coefficient := -1, powers := [(16, 1), (54, 1)] }],
  [{ coefficient := 2, powers := [(2, 1), (48, 1), (54, 1), (66, 1), (69, 1)] }, { coefficient := -2, powers := [(12, 1), (29, 1), (48, 1), (64, 1), (69, 1)] }, { coefficient := -2, powers := [(17, 1), (23, 1), (24, 1), (54, 1), (69, 1)] }],
  [{ coefficient := -2, powers := [(17, 1), (23, 1)] }],
  [{ coefficient := -2, powers := [(0, 1), (28, 1), (48, 1), (52, 1), (54, 1), (66, 1), (69, 1)] }, { coefficient := -2, powers := [(29, 1), (48, 1), (50, 1), (64, 1), (67, 1), (69, 1)] }, { coefficient := 1, powers := [(29, 1), (48, 1), (50, 1), (69, 1)] }],
  ...
  [{ coefficient := -1, powers := [(0, 1), (2, 1), (41, 1), (61, 1)] }, { coefficient := 1, powers := [(2, 1), (19, 1), (22, 1), (54, 1), (61, 1), (69, 1)] }, { coefficient := -1, powers := [(2, 1), (19, 1), (50, 1), (61, 1)] }, { coefficient := 1, powers := [(2, 1), (41, 1)] }, { coefficient := 1, powers := [(5, 1), (32, 1)] }, { coefficient := -1, powers := [(12, 1), (23, 1)] }, { coefficient := -1, powers := [(16, 1), (22, 1), (23, 1), (54, 1), (69, 1)] }],
...
#print axioms Krenn.Component25.SelectedLeafB5_6_6_7.selectedHasNoCommonZero

end Krenn.Component25.SelectedLeafB5_6_6_7
