...
namespace Krenn.Component25.SelectedLeafB5_6_6_6_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "4069d430da27c138d7b8645dab988dfca1cf67f8dc7ac183706a05087475ffc3"
...
def multipliers : Fin 16 → SparsePoly (Fin 72) := ![
  [{ coefficient := 1, powers := [(23, 1), (60, 1), (70, 1)] }, { coefficient := 1, powers := [(32, 1), (48, 1), (70, 1)] }],
  [{ coefficient := -1, powers := [(23, 1), (43, 1), (54, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(16, 1), (54, 1)] }],
  [{ coefficient := 1, powers := [(16, 1), (23, 1), (54, 1), (61, 1)] }],
  [{ coefficient := -2, powers := [(23, 1), (60, 1), (71, 1)] }, { coefficient := 1, powers := [(23, 1)] }],
  ...
  [{ coefficient := 1, powers := [(2, 1), (41, 1)] }, { coefficient := 1, powers := [(5, 1), (32, 1)] }, { coefficient := 2, powers := [(12, 1), (23, 1), (60, 1), (71, 1)] }, { coefficient := -1, powers := [(12, 1), (23, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (59, 1), (60, 1), (70, 1)] }, { coefficient := 1, powers := [(5, 1), (60, 1)] }, { coefficient := -1, powers := [(16, 1), (47, 1), (60, 1), (70, 1)] }, { coefficient := -1, powers := [(17, 1), (47, 1), (50, 1)] }],
...
#print axioms Krenn.Component25.SelectedLeafB5_6_6_6_7.selectedHasNoCommonZero

end Krenn.Component25.SelectedLeafB5_6_6_6_7
