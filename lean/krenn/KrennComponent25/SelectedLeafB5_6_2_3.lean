...
namespace Krenn.Component25.SelectedLeafB5_6_2_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "45f340f4c5df45e48f052f69f0172be43eb3dad196022c27ba93c8b81ae62363"
...
def multipliers : Fin 20 → SparsePoly (Fin 68) := ![
  ...
  [{ coefficient := 1, powers := [(2, 1), (19, 1), (54, 1), (61, 1), (67, 1)] }, { coefficient := 2, powers := [(12, 1), (19, 1), (29, 1), (61, 1), (67, 1)] }, { coefficient := 1, powers := [(16, 1), (23, 1), (54, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(16, 1), (54, 1)] }],
  ...
  [{ coefficient := -1, powers := [(0, 1), (2, 1), (41, 1), (61, 1)] }, { coefficient := -1, powers := [(2, 1), (19, 1), (22, 1), (54, 1), (61, 1), (67, 1)] }, { coefficient := -1, powers := [(2, 1), (19, 1), (50, 1), (61, 1)] }, { coefficient := 1, powers := [(2, 1), (41, 1)] }, { coefficient := 1, powers := [(5, 1), (32, 1)] }, { coefficient := -2, powers := [(12, 1), (19, 1), (22, 1), (29, 1), (61, 1), (67, 1)] }, { coefficient := -1, powers := [(12, 1), (23, 1)] }, { coefficient := -1, powers := [(16, 1), (22, 1), (23, 1), (54, 1), (67, 1)] }],
...
#print axioms Krenn.Component25.SelectedLeafB5_6_2_3.selectedHasNoCommonZero

end Krenn.Component25.SelectedLeafB5_6_2_3
