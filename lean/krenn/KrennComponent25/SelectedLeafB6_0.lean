...
namespace Krenn.Component25.SelectedLeafB6_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "6bfb620224a913209d04010912a0ce14518d9359cdbe870bc0eede3ff34e302f"
def certificateSHA256 : String := "648260cecd6eaa4cf3b2dfba7bb6d10f8b669027d71e3141fd8f7a75ed782663"

set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedSourceIndices : Fin 26 → Fin 662 := ![
  1,
  12,
  14,
  21,
...
def multipliers : Fin 26 → SparsePoly (Fin 63) := ![
  ...
  [{ coefficient := 1, powers := [(6, 1), (38, 1), (59, 1), (60, 1)] }, { coefficient := 1, powers := [(38, 1), (60, 1)] }, { coefficient := 1, powers := [(41, 1), (57, 1)] }, { coefficient := -1, powers := [(48, 1), (54, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (5, 1), (29, 1), (60, 1)] }, { coefficient := -1, powers := [(0, 1), (5, 1), (32, 1), (57, 1)] }, { coefficient := 1, powers := [(0, 1), (12, 1), (23, 1), (57, 1)] }, { coefficient := 1, powers := [(12, 1), (18, 1), (29, 1), (48, 1)] }, { coefficient := 1, powers := [(17, 1), (18, 1), (23, 1), (54, 1)] }, { coefficient := 1, powers := [(17, 1), (23, 1), (24, 1), (54, 1)] }],
...
#print axioms Krenn.Component25.SelectedLeafB6_0.selectedHasNoCommonZero

end Krenn.Component25.SelectedLeafB6_0
