...
namespace Krenn.Component25.SelectedLeafB5_2_6_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "aff3399fce0bbdbac1ba720806a6fa41ac1e7e9e7697369fa83df19cafb10545"
...
def multipliers : Fin 38 → SparsePoly (Fin 69) := ![
  [{ coefficient := 2, powers := [(0, 1), (22, 1), (28, 1), (48, 1), (52, 1), (54, 1), (65, 1), (68, 1)] }, { coefficient := 2, powers := [(22, 1), (29, 1), (48, 1), (50, 1), (63, 1), (66, 1), (68, 1)] }, { coefficient := -1, powers := [(22, 1), (29, 1), (48, 1), (50, 1), (68, 1)] }],
  [{ coefficient := -1, powers := [(22, 1), (48, 1)] }],
  [{ coefficient := 2, powers := [(17, 1), (27, 1), (54, 1), (68, 1)] }, { coefficient := -1, powers := [(17, 1), (50, 1)] }],
  [{ coefficient := -2, powers := [(28, 1), (48, 1), (52, 1), (54, 1), (65, 1)] }, { coefficient := -2, powers := [(28, 1), (48, 1), (54, 1), (56, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (19, 1), (54, 1), (61, 1), (68, 1)] }, { coefficient := 1, powers := [(16, 1), (23, 1), (54, 1), (68, 1)] }],
  [{ coefficient := -1, powers := [(16, 1), (54, 1)] }],
  [{ coefficient := 2, powers := [(2, 1), (48, 1), (54, 1), (65, 1), (68, 1)] }, { coefficient := -2, powers := [(12, 1), (29, 1), (48, 1), (63, 1), (68, 1)] }, { coefficient := -2, powers := [(17, 1), (23, 1), (24, 1), (54, 1), (68, 1)] }],
  [{ coefficient := -2, powers := [(17, 1), (23, 1)] }],
  [{ coefficient := -2, powers := [(0, 1), (28, 1), (48, 1), (52, 1), (54, 1), (65, 1), (68, 1)] }, { coefficient := -2, powers := [(29, 1), (48, 1), (50, 1), (63, 1), (66, 1), (68, 1)] }, { coefficient := 1, powers := [(29, 1), (48, 1), (50, 1), (68, 1)] }],
  [{ coefficient := 2, powers := [(29, 1), (48, 1), (63, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(29, 1), (53, 1)] }],
  [{ coefficient := 1, powers := [(16, 1), (29, 1), (53, 1)] }],
  [{ coefficient := 1, powers := [(23, 1)] }],
  [{ coefficient := -2, powers := [(24, 1), (29, 1), (48, 1), (63, 1), (66, 1)] }, { coefficient := 2, powers := [(29, 1), (48, 1), (63, 1)] }],
  ...
  [{ coefficient := -1, powers := [(0, 1), (2, 1), (41, 1), (61, 1)] }, { coefficient := 1, powers := [(2, 1), (19, 1), (22, 1), (54, 1), (61, 1), (68, 1)] }, { coefficient := -1, powers := [(2, 1), (19, 1), (50, 1), (61, 1)] }, { coefficient := 1, powers := [(2, 1), (41, 1)] }, { coefficient := 1, powers := [(5, 1), (32, 1)] }, { coefficient := -1, powers := [(12, 1), (23, 1)] }, { coefficient := -1, powers := [(16, 1), (22, 1), (23, 1), (54, 1), (68, 1)] }],
  [{ coefficient := 2, powers := [(12, 1), (29, 1), (48, 1), (56, 1), (63, 1)] }, { coefficient := 2, powers := [(16, 1), (29, 1), (48, 1), (53, 1), (63, 1)] }],
  [{ coefficient := 2, powers := [(0, 1), (16, 1), (28, 1), (48, 1), (52, 1), (54, 1), (65, 1)] }, { coefficient := 1, powers := [(2, 1), (19, 1), (43, 1), (54, 1), (61, 1)] }, { coefficient := -2, powers := [(2, 1), (40, 1), (48, 1), (54, 1), (65, 1)] }, { coefficient := -2, powers := [(2, 1), (45, 1), (48, 1), (54, 1), (65, 1)] }, { coefficient := 2, powers := [(12, 1), (29, 1), (40, 1), (48, 1), (63, 1)] }, { coefficient := 2, powers := [(12, 1), (29, 1), (45, 1), (48, 1), (63, 1)] }, { coefficient := -1, powers := [(16, 1), (23, 1), (43, 1), (54, 1)] }, { coefficient := 2, powers := [(16, 1), (29, 1), (48, 1), (50, 1), (63, 1), (66, 1)] }, { coefficient := -1, powers := [(16, 1), (29, 1), (48, 1), (50, 1)] }, { coefficient := 2, powers := [(17, 1), (23, 1), (24, 1), (40, 1), (54, 1)] }, { coefficient := 2, powers := [(17, 1), (23, 1), (24, 1), (45, 1), (54, 1)] }, { coefficient := -2, powers := [(17, 1), (27, 1), (47, 1), (54, 1)] }]
]
...
#print axioms Krenn.Component25.SelectedLeafB5_2_6_7.selectedHasNoCommonZero

end Krenn.Component25.SelectedLeafB5_2_6_7
