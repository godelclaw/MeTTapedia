...
namespace Krenn.Component25.SelectedLeafB7_0_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "38c7c1da76ac1b6018683fac9b81f93e33652155124aa15c029c9d111267c810"
...
def multipliers : Fin 32 → SparsePoly (Fin 65) := ![
  [{ coefficient := 1, powers := [(2, 1), (25, 1), (54, 1), (62, 1)] }, { coefficient := 1, powers := [(12, 1), (25, 1), (29, 1), (56, 1), (62, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(16, 1), (20, 1), (29, 1), (48, 1), (62, 1), (64, 1)] }, { coefficient := -1, powers := [(17, 1), (20, 1), (29, 1), (47, 1), (62, 1), (64, 1)] }],
  ...
  [{ coefficient := -1, powers := [(2, 1), (54, 1), (62, 1)] }, { coefficient := -1, powers := [(12, 1), (29, 1), (56, 1), (62, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(16, 1), (29, 1), (48, 1), (62, 1), (64, 1)] }, { coefficient := 1, powers := [(17, 1), (29, 1), (47, 1), (62, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (48, 1), (62, 1)] }, { coefficient := -1, powers := [(17, 1), (23, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (29, 1), (56, 1), (64, 1)] }, { coefficient := -1, powers := [(29, 1), (47, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(23, 1), (46, 1), (54, 1)] }],
  [{ coefficient := 1, powers := [(23, 1), (54, 1)] }],
  [{ coefficient := 1, powers := [(29, 1), (53, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(16, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [(12, 1), (18, 1), (48, 1)] }],
  [{ coefficient := 1, powers := [(23, 1)] }],
  [{ coefficient := 1, powers := [(18, 1), (29, 1), (48, 1)] }],
  [{ coefficient := -1, powers := [(18, 1), (23, 1), (54, 1)] }, { coefficient := -1, powers := [(19, 1), (29, 1), (53, 1), (64, 1)] }],
  ...
  [{ coefficient := 1, powers := [(29, 1), (56, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(17, 1)] }],
  [{ coefficient := 1, powers := [(29, 1), (46, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := -1, powers := [(2, 1), (38, 1), (60, 1)] }, { coefficient := 1, powers := [(2, 1), (48, 1), (54, 1)] }, { coefficient := 1, powers := [(12, 1), (29, 1), (48, 1), (56, 1), (64, 1)] }, { coefficient := 1, powers := [(16, 1), (29, 1), (48, 1), (53, 1), (64, 1)] }, { coefficient := 1, powers := [(17, 1), (23, 1), (54, 1)] }, { coefficient := -1, powers := [(17, 1), (29, 1), (47, 1), (53, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(12, 1), (18, 1), (29, 1), (48, 1)] }, { coefficient := 1, powers := [(17, 1), (18, 1), (23, 1), (54, 1)] }, { coefficient := 1, powers := [(17, 1), (19, 1), (29, 1), (53, 1), (64, 1)] }, { coefficient := 1, powers := [(17, 1), (23, 1), (24, 1), (54, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (35, 1)] }, { coefficient := -1, powers := [(16, 1), (29, 1), (46, 1), (64, 1)] }, { coefficient := -1, powers := [(17, 1), (29, 1), (56, 1), (64, 1)] }],
...
#print axioms Krenn.Component25.SelectedLeafB7_0_2.selectedHasNoCommonZero

end Krenn.Component25.SelectedLeafB7_0_2
