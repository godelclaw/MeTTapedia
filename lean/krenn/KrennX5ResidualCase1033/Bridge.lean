...
import KrennX5ResidualCase1033.Tree

namespace Krenn.X5ResidualCase1033.Bridge
...
private def c4 : Fin 6 → Fin 3 := ![2, 1, 0, 1, 1, 2]
private def c5 : Fin 6 → Fin 3 := ![2, 1, 0, 2, 2, 2]
...
private def c10 : Fin 6 → Fin 3 := ![2, 1, 0, 1, 1, 1]
private def c11 : Fin 6 → Fin 3 := ![2, 2, 0, 2, 2, 2]
...
theorem selectedRootEquations_vanish (W : WeightsN 6 3 ℂ)
    ...
    Krenn.X5ResidualCase1033.Tree.RootSelectedZero (values W) := by
  intro index
  have r0 := hEq c0
  have r1 := hEq c1
  have r2 := hEq c2
  ...
  fin_cases index
  · simp [-mul_eq_zero, Krenn.X5ResidualCase1033.Tree.rootSelectedEquations, SparsePoly.toPoly, SparseTerm.toPoly, values, entry, Matrix.cons_val_zero, Matrix.cons_val_one, Matrix.cons_val_fin_one]
...
theorem noNormalizedCase (W : WeightsN 6 3 ℂ)
  ...
  exact (Krenn.X5ResidualCase1033.Tree.case1033SelectedHasNoCommonZero (values W))
    (selectedRootEquations_vanish W hEq hcase)

#print axioms Krenn.X5ResidualCase1033.Bridge.noNormalizedCase

end Krenn.X5ResidualCase1033.Bridge
