...
namespace Krenn.X5Case821Selected

open Krenn.SparseCertificate
open MvPolynomial

def sourceSystemFileSHA256 : String := "bd85455cfb84a2c72a307a82f3f4e96da94010bc79da7355135159ec353cfd6b"
def sourceSystemSemanticSHA256 : String := "a60ac5dddb87317a46578580b441a1d62d2c03b38e3c7a88b15d3ff1450fd520"
def certificateSHA256 : String := "61e56e3951a61819914926d593fee0a0a1d3fbea7789cfd4d7dfa44aa1f3bcda"
...
def selectedEquations : Fin 17 → SparsePoly (Fin 70) := ![
  ...
  [{ coefficient := 1, powers := [(15, 1), (62, 1)] }, { coefficient := 1, powers := [(22, 1), (37, 1), (68, 1)] }, { coefficient := 1, powers := [(30, 1), (37, 1), (65, 1)] }],
...
def multipliers : Fin 17 → SparsePoly (Fin 70) := ![
  ...
  [{ coefficient := 1, powers := [(7, 1), (33, 1), (36, 1), (62, 1), (69, 1)] }, { coefficient := -1, powers := [(31, 1), (33, 1), (36, 1), (51, 1), (62, 1)] }, { coefficient := 1, powers := [(33, 1), (34, 1), (36, 1), (43, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(33, 1), (39, 1)] }],
  [{ coefficient := 1, powers := [(7, 1), (33, 1), (36, 1), (62, 1), (66, 1)] }, { coefficient := -1, powers := [(23, 1), (33, 1), (36, 1), (51, 1), (62, 1)] }, { coefficient := 1, powers := [(33, 1), (34, 1), (36, 1), (40, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(30, 1), (33, 1), (36, 1), (40, 1), (69, 1)] }, { coefficient := -1, powers := [(30, 1), (33, 1), (36, 1), (43, 1), (66, 1)] }, { coefficient := 1, powers := [(30, 1), (33, 1), (36, 1), (51, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(22, 1), (33, 1), (36, 1), (40, 1), (69, 1)] }, { coefficient := -1, powers := [(22, 1), (33, 1), (36, 1), (43, 1), (66, 1)] }, { coefficient := 1, powers := [(22, 1), (33, 1), (36, 1), (51, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(33, 1), (36, 1), (40, 1), (69, 1)] }, { coefficient := 1, powers := [(33, 1), (36, 1), (43, 1), (66, 1)] }, { coefficient := -1, powers := [(33, 1), (36, 1), (51, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(33, 1), (36, 1), (51, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(3, 1), (25, 1)] }, { coefficient := 1, powers := [(28, 1)] }],
  [{ coefficient := -1, powers := [(3, 1), (17, 1)] }, { coefficient := 1, powers := [(20, 1)] }],
  [{ coefficient := 1, powers := [(31, 1), (33, 1), (36, 1), (62, 1)] }],
...
#print axioms Krenn.X5Case821Selected.selectedHasNoCommonZero

end Krenn.X5Case821Selected
