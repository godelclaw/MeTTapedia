...
namespace Krenn.Component11.SelectedLeafB6_6_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "4522810497074246585c4e109adfaee8b23d5f975fe266dc8b0c03f756affcbd"
...
def multipliers : Fin 18 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := 1, powers := [(30, 1), (49, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(36, 1), (39, 1)] }],
  [{ coefficient := 1, powers := [(49, 1), (53, 1), (64, 1)] }],
  ...
  [{ coefficient := 1, powers := [(39, 1), (60, 1)] }, { coefficient := -1, powers := [(41, 1), (49, 1), (54, 1), (64, 1)] }, { coefficient := 1, powers := [(49, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (33, 1), (49, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (36, 1)] }, { coefficient := -1, powers := [(17, 1), (30, 1)] }],
  [{ coefficient := -1, powers := [(12, 1), (18, 1), (36, 1), (39, 1)] }, { coefficient := -1, powers := [(12, 1), (22, 1), (49, 1), (53, 1), (64, 1)] }, { coefficient := -1, powers := [(12, 1), (30, 1), (49, 1), (64, 1)] }],
...
#print axioms Krenn.Component11.SelectedLeafB6_6_4.selectedHasNoCommonZero

end Krenn.Component11.SelectedLeafB6_6_4
