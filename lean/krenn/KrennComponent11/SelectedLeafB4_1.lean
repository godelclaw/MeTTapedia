...
namespace Krenn.Component11.SelectedLeafB4_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "32c8e836b30a88b5ff601b28f10ebf00e2fe81156c4b571eeb5093390b6e0aef"
...
def multipliers : Fin 28 → SparsePoly (Fin 63) := ![
  [{ coefficient := 1, powers := [(12, 1), (23, 1), (39, 1), (59, 1), (62, 1)] }],
  ...
  [{ coefficient := -1, powers := [(36, 1), (39, 1), (42, 1), (46, 1), (62, 1)] }],
  [{ coefficient := -2, powers := [(23, 1), (25, 1)] }],
  [{ coefficient := 1, powers := [(3, 1), (8, 1), (36, 1), (42, 1), (52, 1), (59, 1), (62, 1)] }, { coefficient := -1, powers := [(3, 1), (8, 1), (36, 1), (42, 1), (59, 1), (61, 1), (62, 1)] }, { coefficient := 2, powers := [(5, 1), (25, 1), (33, 1), (47, 1), (61, 1), (62, 1)] }, { coefficient := 2, powers := [(5, 1), (33, 1), (47, 1), (53, 1), (62, 1)] }, { coefficient := 1, powers := [(8, 1), (36, 1), (42, 1), (52, 1), (62, 1)] }, { coefficient := -1, powers := [(8, 1), (36, 1), (42, 1), (61, 1), (62, 1)] }, { coefficient := -2, powers := [(12, 1), (30, 1), (49, 1), (52, 1), (62, 1)] }, { coefficient := -1, powers := [(12, 1), (33, 1), (37, 1), (39, 1), (49, 1), (52, 1), (59, 1), (62, 2)] }],
  [{ coefficient := 2, powers := [(5, 1), (25, 1), (33, 1), (61, 1), (62, 1)] }, { coefficient := 1, powers := [(12, 1), (28, 1), (39, 1), (59, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(12, 1), (39, 1), (49, 1), (59, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (36, 1), (39, 1), (42, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (18, 1), (36, 1), (42, 1), (61, 1), (62, 1)] }, { coefficient := 1, powers := [(12, 1), (36, 1), (39, 1), (62, 1)] }],
  [{ coefficient := -4, powers := [(23, 1), (54, 1)] }, { coefficient := -2, powers := [(30, 1), (42, 1)] }],
  [{ coefficient := 2, powers := [(12, 1), (30, 1), (52, 1)] }, { coefficient := 1, powers := [(12, 1), (33, 1), (37, 1), (39, 1), (52, 1), (59, 1), (62, 1)] }],
  [{ coefficient := 2, powers := [(54, 1)] }],
  [{ coefficient := 2, powers := [(49, 1)] }],
  [{ coefficient := 2, powers := [(30, 1)] }],
  [{ coefficient := 2, powers := [(17, 1)] }],
  [{ coefficient := -2, powers := [(12, 1), (30, 1)] }, { coefficient := -1, powers := [(12, 1), (33, 1), (37, 1), (39, 1), (59, 1), (62, 1)] }],
  [{ coefficient := -2, powers := [(5, 1), (25, 1), (33, 1), (61, 1)] }, { coefficient := -2, powers := [(5, 1), (33, 1), (53, 1)] }],
  [{ coefficient := 2, powers := [(23, 1)] }],
  [{ coefficient := -1, powers := [(12, 1), (39, 1), (59, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(12, 1), (36, 1), (39, 1), (42, 1), (62, 1)] }],
  ...
  [{ coefficient := 2, powers := [(5, 1), (25, 1), (33, 1), (47, 1)] }, { coefficient := 1, powers := [(8, 1), (18, 1), (36, 1), (42, 2), (56, 1), (62, 1)] }, { coefficient := -1, powers := [(8, 1), (36, 1), (42, 1)] }],
  [{ coefficient := 2, powers := [(39, 1), (60, 1)] }, { coefficient := 2, powers := [(42, 1), (57, 1)] }, { coefficient := -2, powers := [(49, 1), (54, 1)] }],
  [{ coefficient := -2, powers := [(0, 1), (5, 1), (33, 1), (57, 1)] }, { coefficient := 2, powers := [(5, 1), (24, 1), (25, 1), (33, 1), (44, 1), (61, 1)] }, { coefficient := 2, powers := [(5, 1), (24, 1), (33, 1), (44, 1), (53, 1)] }, { coefficient := -2, powers := [(5, 1), (25, 1), (33, 1), (44, 1)] }, { coefficient := -1, powers := [(12, 1), (24, 1), (36, 1), (39, 1), (42, 1), (62, 1)] }, { coefficient := 4, powers := [(17, 1), (23, 1), (24, 1), (54, 1)] }, { coefficient := 2, powers := [(17, 1), (24, 1), (30, 1), (42, 1)] }],
  [{ coefficient := -1, powers := [(3, 1), (8, 1), (24, 1), (36, 1), (42, 1), (52, 1), (59, 1)] }, { coefficient := 1, powers := [(3, 1), (8, 1), (24, 1), (36, 1), (42, 1), (59, 1), (61, 1)] }, { coefficient := -2, powers := [(5, 1), (24, 1), (25, 1), (33, 1), (47, 1), (61, 1)] }, { coefficient := -2, powers := [(5, 1), (24, 1), (33, 1), (47, 1), (53, 1)] }, { coefficient := -2, powers := [(5, 1), (25, 1), (33, 1), (44, 1), (61, 1)] }, { coefficient := 1, powers := [(8, 1), (18, 1), (36, 1), (42, 1), (56, 1)] }, { coefficient := 1, powers := [(8, 1), (18, 1), (36, 1), (42, 1), (61, 1)] }, { coefficient := -1, powers := [(8, 1), (24, 1), (36, 1), (42, 1), (52, 1)] }, { coefficient := 1, powers := [(8, 1), (24, 1), (36, 1), (42, 1), (61, 1)] }, { coefficient := 2, powers := [(12, 1), (24, 1), (30, 1), (49, 1), (52, 1)] }, { coefficient := 1, powers := [(12, 1), (24, 1), (33, 1), (37, 1), (39, 1), (49, 1), (52, 1), (59, 1), (62, 1)] }, { coefficient := -2, powers := [(12, 1), (36, 1), (39, 1)] }]
]
...
#print axioms Krenn.Component11.SelectedLeafB4_1.selectedHasNoCommonZero

end Krenn.Component11.SelectedLeafB4_1
