...
namespace Krenn.Component11.SelectedLeafB4_6_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "9533c970990482f33b167054fa52cae17aa109e24a57f63c9f9b084541a9b99c"
def certificateSHA256 : String := "fd0cc6322ffdd088da304475b170db281b8afc61d636e3c3a3debda5d554efc3"
...
def multipliers : Fin 20 → SparsePoly (Fin 65) := ![
  ...
  [{ coefficient := -2, powers := [(0, 1), (17, 1), (30, 1), (61, 1)] }, { coefficient := 1, powers := [(8, 1), (36, 1)] }, { coefficient := 1, powers := [(17, 1), (30, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (42, 1)] }, { coefficient := 1, powers := [(5, 1), (33, 1)] }, { coefficient := -1, powers := [(12, 1), (23, 1)] }]
]
...
#print axioms Krenn.Component11.SelectedLeafB4_6_2.selectedHasNoCommonZero

end Krenn.Component11.SelectedLeafB4_6_2
