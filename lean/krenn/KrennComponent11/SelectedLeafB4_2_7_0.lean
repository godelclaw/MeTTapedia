...
namespace Krenn.Component11.SelectedLeafB4_2_7_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "0d8e9b82ef5b89418e7749464003977e065188abc1b6045cbe06d395691c287e"
...
def multipliers : Fin 20 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := -2, powers := [(23, 1), (57, 1), (63, 1)] }],
  ...
  [{ coefficient := 1, powers := [(12, 1), (44, 1), (48, 1), (57, 1), (64, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(23, 1), (57, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(57, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(12, 1), (57, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(12, 1), (48, 1), (57, 1), (64, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(57, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(39, 1), (57, 1), (60, 1), (65, 1)] }, { coefficient := -1, powers := [(49, 1), (54, 1), (57, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (56, 1), (57, 1), (64, 1)] }, { coefficient := 1, powers := [(2, 1), (57, 2), (65, 1)] }, { coefficient := 1, powers := [(8, 1), (36, 1), (57, 1), (65, 1)] }],
  [{ coefficient := 2, powers := [(12, 1), (23, 1), (57, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (33, 1), (57, 1)] }, { coefficient := -1, powers := [(12, 1), (23, 1), (57, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (33, 1), (57, 1)] }, { coefficient := -1, powers := [(12, 1), (23, 1), (57, 1)] }, { coefficient := 1, powers := [(12, 1), (29, 1), (48, 1), (57, 1), (64, 1)] }, { coefficient := -1, powers := [] }],
  [{ coefficient := 2, powers := [(12, 1), (23, 1), (45, 1), (57, 1), (63, 1)] }, { coefficient := 2, powers := [(17, 1), (23, 1), (41, 1), (54, 1), (57, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (57, 1), (60, 1), (65, 1)] }, { coefficient := -1, powers := [(12, 1), (44, 1), (46, 1), (48, 1), (57, 1), (64, 1), (65, 1)] }, { coefficient := 1, powers := [(12, 1), (44, 1), (48, 1), (57, 1), (65, 1)] }, { coefficient := 1, powers := [(12, 1), (47, 1), (48, 1), (57, 1), (64, 1), (65, 1)] }, { coefficient := -1, powers := [(12, 1), (49, 1), (57, 1), (65, 1)] }]
]
...
#print axioms Krenn.Component11.SelectedLeafB4_2_7_0.selectedHasNoCommonZero

end Krenn.Component11.SelectedLeafB4_2_7_0
