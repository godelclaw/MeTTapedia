...
namespace Krenn.Component11.SelectedLeafB4_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "3be276e0dd69e278efccad0a4ea64048fc1e8466b54539dd5a0eb19de97524f3"
...
def multipliers : Fin 30 → SparsePoly (Fin 64) := ![
  ...
  [{ coefficient := 2, powers := [(30, 1), (42, 1), (51, 1), (62, 1)] }],
  [{ coefficient := 2, powers := [(5, 1), (25, 1), (33, 1), (47, 1), (61, 1), (63, 1)] }, { coefficient := 2, powers := [(5, 1), (33, 1), (47, 1), (53, 1), (63, 1)] }, { coefficient := -2, powers := [(12, 1), (30, 1), (49, 1), (52, 1), (63, 1)] }, { coefficient := -1, powers := [(12, 1), (33, 1), (37, 1), (39, 1), (49, 1), (52, 1), (59, 1), (63, 2)] }],
  [{ coefficient := 2, powers := [(5, 1), (25, 1), (33, 1), (61, 1), (63, 1)] }, { coefficient := 1, powers := [(12, 1), (28, 1), (39, 1), (59, 1), (63, 1)] }],
  [{ coefficient := -2, powers := [(25, 1), (42, 1), (51, 1), (62, 1)] }],
  ...
  [{ coefficient := -2, powers := [(30, 1), (42, 1), (62, 1)] }],
  ...
  [{ coefficient := 2, powers := [(42, 1), (62, 1)] }],
  [{ coefficient := 2, powers := [(5, 1), (33, 1)] }],
  [{ coefficient := -2, powers := [] }],
  [{ coefficient := 2, powers := [(5, 1), (25, 1), (33, 1), (47, 1)] }],
  [{ coefficient := 2, powers := [(39, 1), (60, 1)] }, { coefficient := -2, powers := [(40, 1), (42, 1), (57, 1), (62, 1)] }, { coefficient := 2, powers := [(42, 1), (57, 1)] }, { coefficient := -2, powers := [(49, 1), (54, 1)] }],
  ...
  [{ coefficient := -2, powers := [(5, 1), (24, 1), (25, 1), (33, 1), (47, 1), (61, 1)] }, { coefficient := -2, powers := [(5, 1), (24, 1), (33, 1), (47, 1), (53, 1)] }, { coefficient := -2, powers := [(5, 1), (25, 1), (33, 1), (44, 1), (61, 1)] }, { coefficient := 2, powers := [(12, 1), (24, 1), (30, 1), (49, 1), (52, 1)] }, { coefficient := 1, powers := [(12, 1), (24, 1), (33, 1), (37, 1), (39, 1), (49, 1), (52, 1), (59, 1), (63, 1)] }, { coefficient := -2, powers := [(12, 1), (36, 1), (39, 1)] }]
]
...
#print axioms Krenn.Component11.SelectedLeafB4_5.selectedHasNoCommonZero

end Krenn.Component11.SelectedLeafB4_5
