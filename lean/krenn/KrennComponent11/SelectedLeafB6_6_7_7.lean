...
namespace Krenn.Component11.SelectedLeafB6_6_7_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "f296b8ad722a30670877350b46a6f144957a1500a34b9ea3b929d0444dec7ae4"
...
def multipliers : Fin 17 → SparsePoly (Fin 71) := ![
  [{ coefficient := 1, powers := [(23, 1), (46, 1), (57, 1), (66, 1), (68, 1)] }, { coefficient := -1, powers := [(29, 1), (48, 1), (57, 1), (66, 1), (68, 1)] }, { coefficient := -1, powers := [(30, 1), (49, 1), (68, 1)] }, { coefficient := 1, powers := [(36, 1), (39, 1), (68, 1)] }],
  ...
  [{ coefficient := -1, powers := [(2, 1), (56, 1), (57, 1), (66, 1)] }, { coefficient := 1, powers := [(2, 1), (57, 1)] }, { coefficient := 1, powers := [(8, 1), (36, 1)] }, { coefficient := -1, powers := [(17, 1), (30, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (33, 1), (57, 1)] }],
  [{ coefficient := -1, powers := [(12, 1), (23, 1), (46, 1), (57, 1), (66, 1)] }, { coefficient := 1, powers := [(12, 1), (29, 1), (48, 1), (57, 1), (66, 1)] }, { coefficient := 1, powers := [(12, 1), (30, 1), (49, 1)] }, { coefficient := -1, powers := [(12, 1), (36, 1), (39, 1)] }]
]
...
#print axioms Krenn.Component11.SelectedLeafB6_6_7_7.selectedHasNoCommonZero

end Krenn.Component11.SelectedLeafB6_6_7_7
