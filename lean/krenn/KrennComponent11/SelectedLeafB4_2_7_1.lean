...
namespace Krenn.Component11.SelectedLeafB4_2_7_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "ac76469d7b5a904c9ead8a2a876e2735da115538544d0cf7af21486084597b63"
...
def multipliers : Fin 18 → SparsePoly (Fin 67) := ![
  ...
  [{ coefficient := -1, powers := [(23, 1), (57, 1), (63, 1)] }, { coefficient := -1, powers := [(29, 1), (48, 1), (57, 1), (63, 1), (64, 1)] }, { coefficient := 1, powers := [(36, 1), (39, 1), (57, 1), (63, 1), (65, 1)] }],
  ...
  [{ coefficient := 1, powers := [(12, 1), (23, 1), (57, 1)] }, { coefficient := 1, powers := [(12, 1), (29, 1), (48, 1), (57, 1), (64, 1)] }, { coefficient := -1, powers := [(12, 1), (36, 1), (39, 1), (57, 1), (65, 1)] }],
  ...
  [{ coefficient := 1, powers := [(12, 1), (23, 1), (45, 1), (57, 1), (63, 1)] }, { coefficient := 1, powers := [(12, 1), (29, 1), (45, 1), (48, 1), (57, 1), (63, 1), (64, 1)] }, { coefficient := -1, powers := [(12, 1), (30, 1), (49, 1), (52, 1), (57, 1), (65, 1)] }, { coefficient := -1, powers := [(12, 1), (36, 1), (39, 1), (45, 1), (57, 1), (63, 1), (65, 1)] }, { coefficient := 2, powers := [(17, 1), (23, 1), (41, 1), (54, 1), (57, 1), (65, 1)] }]
]
...
#print axioms Krenn.Component11.SelectedLeafB4_2_7_1.selectedHasNoCommonZero

end Krenn.Component11.SelectedLeafB4_2_7_1
