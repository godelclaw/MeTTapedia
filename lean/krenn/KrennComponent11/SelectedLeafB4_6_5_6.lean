...
namespace Krenn.Component11.SelectedLeafB4_6_5_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "f84fb893ebe7c5fe65e31401e19c20194f593aff5f6a80d5ed86f7033c9e469e"
def certificateSHA256 : String := "c43a1d13e309633e9b30e9b499ef7016c6745f8ff8b02b120826ad39f7b512a6"
...
def multipliers : Fin 20 → SparsePoly (Fin 68) := ![
  [{ coefficient := -1, powers := [(23, 1), (55, 1), (57, 1), (64, 1), (66, 1)] }, { coefficient := -1, powers := [(23, 1), (57, 2), (65, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(23, 1), (47, 1), (57, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (45, 1), (57, 1), (64, 1)] }],
  [{ coefficient := 2, powers := [(23, 1), (51, 1), (54, 1), (57, 1), (62, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(12, 1), (44, 1), (57, 1), (65, 1)] }],
  [{ coefficient := -2, powers := [(23, 1), (54, 1), (57, 1), (62, 1), (65, 1)] }],
  ...
  [{ coefficient := -1, powers := [(2, 1), (55, 1), (57, 1), (64, 1)] }, { coefficient := 1, powers := [(2, 1), (57, 2), (65, 1)] }, { coefficient := 1, powers := [(8, 1), (36, 1), (57, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (33, 1), (57, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (33, 1), (57, 1)] }, { coefficient := -1, powers := [] }],
  [{ coefficient := 1, powers := [(12, 1), (23, 1), (55, 1), (57, 1), (64, 1)] }, { coefficient := 1, powers := [(12, 1), (23, 1), (57, 2), (65, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (57, 1), (60, 1), (65, 1)] }, { coefficient := 1, powers := [(12, 1), (44, 1), (48, 1), (57, 1), (65, 1)] }, { coefficient := -1, powers := [(12, 1), (49, 1), (57, 1), (65, 1)] }]
]
...
#print axioms Krenn.Component11.SelectedLeafB4_6_5_6.selectedHasNoCommonZero

end Krenn.Component11.SelectedLeafB4_6_5_6
