...
namespace Krenn.Component11.SelectedLeafB0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "3137d58fae7a37e731cb0d1dd3f8a63f88b7df4d114a1958f62862fd97973d59"
def certificateSHA256 : String := "c57fe6fda4cac3a29d71ed870474993f75544677a5765bf8c8799cba959e695a"

set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedSourceIndices : Fin 21 → Fin 666 := ![
  6,
  15,
  16,
  184,
...
def multipliers : Fin 21 → SparsePoly (Fin 61) := ![
  ...
  [{ coefficient := 2, powers := [(19, 1), (30, 1), (52, 1)] }, { coefficient := 1, powers := [(23, 1), (24, 1), (52, 1), (53, 1)] }, { coefficient := -1, powers := [(23, 1), (25, 1), (52, 1)] }, { coefficient := -1, powers := [(23, 1), (53, 1)] }],
  ...
  [{ coefficient := 1, powers := [(5, 1), (25, 1), (33, 1), (44, 1), (52, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (33, 1)] }, { coefficient := -1, powers := [(12, 1), (23, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := -1, powers := [(5, 1), (25, 1), (33, 1), (44, 1), (46, 1), (52, 1)] }, { coefficient := 1, powers := [(5, 1), (25, 1), (33, 1), (47, 1), (52, 1)] }, { coefficient := -1, powers := [(5, 1), (33, 1), (41, 1), (57, 1)] }, { coefficient := 1, powers := [(5, 1), (33, 1), (44, 1), (46, 1), (53, 1)] }, { coefficient := -1, powers := [(5, 1), (33, 1), (47, 1), (53, 1)] }, { coefficient := -1, powers := [(8, 1), (36, 1), (42, 1), (56, 1)] }, { coefficient := -1, powers := [(12, 1), (23, 1), (25, 1), (47, 1), (52, 1)] }, { coefficient := 1, powers := [(12, 1), (23, 1), (41, 1), (57, 1)] }, { coefficient := 1, powers := [(12, 1), (23, 1), (47, 1), (53, 1)] }, { coefficient := 2, powers := [(12, 1), (30, 1), (49, 1), (52, 1)] }, { coefficient := 2, powers := [(17, 1), (23, 1), (46, 1), (54, 1)] }, { coefficient := 1, powers := [(17, 1), (30, 1), (42, 1), (56, 1)] }],
  [{ coefficient := 1, powers := [(39, 1), (60, 1)] }, { coefficient := 1, powers := [(42, 1), (57, 1)] }, { coefficient := -1, powers := [(49, 1), (54, 1)] }]
]
...
#print axioms Krenn.Component11.SelectedLeafB0.selectedHasNoCommonZero

end Krenn.Component11.SelectedLeafB0
