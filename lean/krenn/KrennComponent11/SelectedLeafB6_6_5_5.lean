...
namespace Krenn.Component11.SelectedLeafB6_6_5_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "d632561c1be50bba721183d92023cb68c6600aa9d152aad9a34d28b4d8018977"
...
def multipliers : Fin 20 → SparsePoly (Fin 69) := ![
  ...
  [{ coefficient := 1, powers := [(20, 1), (53, 1), (62, 1), (68, 1)] }],
  [{ coefficient := -1, powers := [(11, 1), (53, 1), (62, 1), (68, 1)] }],
  [{ coefficient := -1, powers := [(22, 1), (62, 1), (68, 1)] }],
  ...
  [{ coefficient := 1, powers := [(22, 1), (53, 1), (68, 1)] }],
  ...
  [{ coefficient := 1, powers := [(18, 1), (30, 1), (68, 1)] }, { coefficient := -1, powers := [(18, 1)] }],
...
#print axioms Krenn.Component11.SelectedLeafB6_6_5_5.selectedHasNoCommonZero

end Krenn.Component11.SelectedLeafB6_6_5_5
