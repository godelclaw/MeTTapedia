...
namespace Krenn.Component11.SelectedLeafB4_6_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "0ba884a2592c00ea750944d7e084fe813b0bbd3ebafdec40e1b188f90eaaeacf"
def certificateSHA256 : String := "58cb7787fef8164f517f4d10e2bab404b6d9d08498d749e18ea8c6ab860ac752"
...
def multipliers : Fin 27 → SparsePoly (Fin 65) := ![
  ...
  [{ coefficient := 2, powers := [(23, 1), (51, 1), (54, 1), (62, 1)] }, { coefficient := -2, powers := [(23, 1), (52, 1), (54, 1)] }],
  ...
  [{ coefficient := 1, powers := [(0, 1), (25, 1), (46, 1), (52, 1), (64, 1)] }, { coefficient := -1, powers := [(5, 1), (25, 1), (33, 1), (41, 1)] }, { coefficient := 1, powers := [(25, 1), (52, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (33, 1), (53, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (44, 1), (46, 1), (52, 1), (64, 1)] }, { coefficient := -1, powers := [(5, 1), (33, 1), (41, 1), (44, 1)] }, { coefficient := -1, powers := [(5, 1), (33, 1), (47, 1)] }, { coefficient := 1, powers := [(44, 1), (52, 1), (64, 1)] }],
  ...
  [{ coefficient := -1, powers := [(0, 1), (46, 1), (52, 1), (64, 1)] }, { coefficient := -1, powers := [(52, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (25, 1), (44, 1), (46, 1), (52, 1), (64, 1)] }, { coefficient := 1, powers := [(0, 1), (46, 1)] }, { coefficient := 1, powers := [(5, 1), (25, 1), (33, 1), (41, 1), (44, 1)] }, { coefficient := -1, powers := [(25, 1), (44, 1), (52, 1), (64, 1)] }, { coefficient := 1, powers := [] }],
  ...
  [{ coefficient := 1, powers := [(0, 2), (12, 1), (18, 1), (30, 1), (38, 1), (49, 1), (59, 1)] }, { coefficient := -1, powers := [(0, 2), (12, 1), (18, 1), (36, 1), (38, 1), (39, 1), (59, 1)] }, { coefficient := 1, powers := [(0, 2), (41, 1)] }, { coefficient := -1, powers := [(0, 1), (3, 1), (12, 1), (18, 1), (30, 1), (46, 1), (49, 1), (59, 1)] }, { coefficient := 1, powers := [(0, 1), (3, 1), (12, 1), (18, 1), (36, 1), (39, 1), (46, 1), (59, 1)] }, { coefficient := 1, powers := [(0, 1), (12, 1), (18, 1), (30, 1), (41, 1), (49, 1)] }, { coefficient := -1, powers := [(0, 1), (12, 1), (18, 1), (36, 1), (39, 1), (41, 1)] }, { coefficient := 1, powers := [(0, 1), (18, 1), (25, 1), (44, 1), (46, 1), (52, 1), (64, 1)] }, { coefficient := -1, powers := [(0, 1), (18, 1), (46, 1)] }, { coefficient := 1, powers := [(0, 1)] }, { coefficient := -1, powers := [(3, 1), (12, 1), (18, 1), (30, 1), (49, 1), (59, 1)] }, { coefficient := 1, powers := [(3, 1), (12, 1), (18, 1), (36, 1), (39, 1), (59, 1)] }, { coefficient := -1, powers := [(5, 1), (18, 1), (25, 1), (33, 1), (41, 1), (44, 1)] }, { coefficient := 1, powers := [(12, 1), (18, 1), (30, 1), (49, 1)] }, { coefficient := -1, powers := [(12, 1), (18, 1), (36, 1), (39, 1)] }, { coefficient := 1, powers := [(18, 1), (25, 1), (44, 1), (52, 1), (64, 1)] }, { coefficient := -1, powers := [(18, 1)] }],
...
#print axioms Krenn.Component11.SelectedLeafB4_6_1.selectedHasNoCommonZero

end Krenn.Component11.SelectedLeafB4_6_1
