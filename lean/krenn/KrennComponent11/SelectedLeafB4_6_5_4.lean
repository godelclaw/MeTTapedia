...
namespace Krenn.Component11.SelectedLeafB4_6_5_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "24b06917e8d7ab030a37c669ea77f362725b16ad944797e16aa7c69b0801a6fe"
def certificateSHA256 : String := "83e543728b0844919a12bab9811e51c3567b876477e8b80b61434ac0b597b0e6"
...
def multipliers : Fin 26 → SparsePoly (Fin 67) := ![
  ...
  [{ coefficient := -1, powers := [(4, 1), (23, 1), (35, 1), (52, 1), (57, 1), (66, 1)] }, { coefficient := -1, powers := [(7, 1), (21, 1), (23, 1), (57, 1), (59, 1), (66, 1)] }, { coefficient := -1, powers := [(7, 1), (23, 1), (32, 1), (46, 1), (57, 1), (66, 1)] }, { coefficient := -1, powers := [(7, 1), (23, 1), (35, 1), (41, 1), (57, 1), (66, 1)] }, { coefficient := -1, powers := [(11, 1), (23, 1), (35, 1), (38, 1), (57, 1), (66, 1)] }, { coefficient := 1, powers := [(15, 1), (23, 1), (35, 1), (38, 1), (57, 1), (66, 1)] }],
  ...
  [{ coefficient := -1, powers := [(4, 1), (12, 1), (35, 1), (44, 1), (52, 1)] }, { coefficient := -1, powers := [(7, 1), (12, 1), (21, 1), (44, 1), (59, 1)] }, { coefficient := -1, powers := [(7, 1), (12, 1), (32, 1), (44, 1), (46, 1)] }, { coefficient := -1, powers := [(7, 1), (12, 1), (35, 1), (41, 1), (44, 1)] }, { coefficient := -1, powers := [(11, 1), (12, 1), (35, 1), (38, 1), (44, 1)] }, { coefficient := 1, powers := [(12, 1), (15, 1), (35, 1), (38, 1), (44, 1)] }],
  ...
  [{ coefficient := 1, powers := [(4, 1), (12, 1), (35, 1), (52, 1)] }, { coefficient := 1, powers := [(7, 1), (12, 1), (21, 1), (59, 1)] }, { coefficient := 1, powers := [(7, 1), (12, 1), (32, 1), (46, 1)] }, { coefficient := 1, powers := [(7, 1), (12, 1), (35, 1), (41, 1)] }, { coefficient := 1, powers := [(11, 1), (12, 1), (35, 1), (38, 1)] }, { coefficient := -1, powers := [(12, 1), (15, 1), (35, 1), (38, 1)] }],
  ...
  [{ coefficient := 1, powers := [(2, 1), (4, 1), (35, 1), (52, 1), (57, 1)] }, { coefficient := 1, powers := [(2, 1), (7, 1), (21, 1), (57, 1), (59, 1)] }, { coefficient := 1, powers := [(2, 1), (7, 1), (32, 1), (46, 1), (57, 1)] }, { coefficient := 1, powers := [(2, 1), (7, 1), (35, 1), (41, 1), (57, 1)] }, { coefficient := 1, powers := [(2, 1), (11, 1), (35, 1), (38, 1), (57, 1)] }, { coefficient := -1, powers := [(2, 1), (15, 1), (35, 1), (38, 1), (57, 1)] }, { coefficient := 1, powers := [(4, 1), (8, 1), (35, 1), (36, 1), (52, 1)] }, { coefficient := 1, powers := [(7, 1), (8, 1), (21, 1), (36, 1), (59, 1)] }, { coefficient := 1, powers := [(7, 1), (8, 1), (32, 1), (36, 1), (46, 1)] }, { coefficient := 1, powers := [(7, 1), (8, 1), (35, 1), (36, 1), (41, 1)] }, { coefficient := 2, powers := [(7, 1), (17, 1), (30, 1), (32, 1), (46, 1)] }, { coefficient := 2, powers := [(7, 1), (17, 1), (30, 1), (35, 1), (41, 1)] }, { coefficient := 1, powers := [(8, 1), (11, 1), (35, 1), (36, 1), (38, 1)] }, { coefficient := -1, powers := [(8, 1), (15, 1), (35, 1), (36, 1), (38, 1)] }, { coefficient := 2, powers := [(11, 1), (17, 1), (30, 1), (35, 1), (38, 1)] }, { coefficient := -2, powers := [(15, 1), (17, 1), (30, 1), (35, 1), (38, 1)] }],
  [{ coefficient := 1, powers := [(4, 1), (32, 1)] }, { coefficient := 1, powers := [(11, 1), (21, 1)] }, { coefficient := -1, powers := [(15, 1), (21, 1)] }],
  [{ coefficient := 1, powers := [(4, 1), (12, 1), (23, 1), (35, 1), (52, 1), (57, 1)] }, { coefficient := 1, powers := [(7, 1), (12, 1), (21, 1), (23, 1), (57, 1), (59, 1)] }, { coefficient := 1, powers := [(7, 1), (12, 1), (23, 1), (32, 1), (46, 1), (57, 1)] }, { coefficient := 1, powers := [(7, 1), (12, 1), (23, 1), (35, 1), (41, 1), (57, 1)] }, { coefficient := 1, powers := [(11, 1), (12, 1), (23, 1), (35, 1), (38, 1), (57, 1)] }, { coefficient := -1, powers := [(12, 1), (15, 1), (23, 1), (35, 1), (38, 1), (57, 1)] }],
  [{ coefficient := 1, powers := [(4, 1), (59, 1)] }, { coefficient := 1, powers := [(11, 1), (46, 1)] }, { coefficient := -1, powers := [(15, 1), (46, 1)] }],
  [{ coefficient := 1, powers := [(4, 1), (12, 1), (35, 1), (44, 1), (48, 1), (52, 1)] }, { coefficient := -1, powers := [(4, 1), (12, 1), (35, 1), (49, 1), (52, 1)] }, { coefficient := 1, powers := [(5, 1), (7, 1), (21, 1), (59, 1), (60, 1)] }, { coefficient := 1, powers := [(5, 1), (7, 1), (32, 1), (46, 1), (60, 1)] }, { coefficient := 1, powers := [(5, 1), (7, 1), (35, 1), (41, 1), (60, 1)] }, { coefficient := 1, powers := [(5, 1), (11, 1), (35, 1), (38, 1), (60, 1)] }, { coefficient := -1, powers := [(5, 1), (15, 1), (35, 1), (38, 1), (60, 1)] }, { coefficient := 1, powers := [(7, 1), (12, 1), (21, 1), (44, 1), (48, 1), (59, 1)] }, { coefficient := -1, powers := [(7, 1), (12, 1), (21, 1), (49, 1), (59, 1)] }, { coefficient := 1, powers := [(7, 1), (12, 1), (32, 1), (44, 1), (46, 1), (48, 1)] }, { coefficient := -1, powers := [(7, 1), (12, 1), (32, 1), (46, 1), (49, 1)] }, { coefficient := 1, powers := [(7, 1), (12, 1), (35, 1), (41, 1), (44, 1), (48, 1)] }, { coefficient := -1, powers := [(7, 1), (12, 1), (35, 1), (41, 1), (49, 1)] }, { coefficient := 1, powers := [(11, 1), (12, 1), (35, 1), (38, 1), (44, 1), (48, 1)] }, { coefficient := -1, powers := [(11, 1), (12, 1), (35, 1), (38, 1), (49, 1)] }, { coefficient := -1, powers := [(12, 1), (15, 1), (35, 1), (38, 1), (44, 1), (48, 1)] }, { coefficient := 1, powers := [(12, 1), (15, 1), (35, 1), (38, 1), (49, 1)] }]
]
...
#print axioms Krenn.Component11.SelectedLeafB4_6_5_4.selectedHasNoCommonZero

end Krenn.Component11.SelectedLeafB4_6_5_4
