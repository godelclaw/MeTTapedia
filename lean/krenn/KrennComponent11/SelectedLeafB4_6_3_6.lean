...
namespace Krenn.Component11.SelectedLeafB4_6_3_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "5d8d09ed32c7fd721b31c0fe2584f4d2746ad1f491e8d294478bbaf948a2308e"
def certificateSHA256 : String := "3b7af44e5a442386cc9ba57afdc9448b6e46eab13b6085b8ae9f6b447d8407bf"
...
def multipliers : Fin 19 → SparsePoly (Fin 68) := ![
  [{ coefficient := 1, powers := [(23, 1), (46, 1), (57, 1), (64, 1), (66, 1)] }, { coefficient := -1, powers := [(23, 1), (57, 1), (66, 1)] }, { coefficient := -1, powers := [(29, 1), (48, 1), (57, 1), (64, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(23, 1), (47, 1)] }],
  [{ coefficient := 2, powers := [(23, 1), (51, 1), (54, 1), (62, 1)] }],
  ...
  [{ coefficient := -1, powers := [(12, 1), (23, 1), (46, 1), (57, 1), (64, 1)] }, { coefficient := 1, powers := [(12, 1), (23, 1), (57, 1)] }, { coefficient := 1, powers := [(12, 1), (29, 1), (48, 1), (57, 1), (64, 1)] }],
...
#print axioms Krenn.Component11.SelectedLeafB4_6_3_6.selectedHasNoCommonZero

end Krenn.Component11.SelectedLeafB4_6_3_6
