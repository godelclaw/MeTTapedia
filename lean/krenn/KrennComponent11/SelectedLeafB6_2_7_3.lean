...
namespace Krenn.Component11.SelectedLeafB6_2_7_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "f3b176804a64a4f71fe7951f3764636366ad27b6d0d3aed844ae5a1768d2f369"
...
def multipliers : Fin 18 → SparsePoly (Fin 69) := ![
  ...
  [{ coefficient := -1, powers := [(23, 1), (57, 1), (64, 1)] }, { coefficient := -1, powers := [(29, 1), (48, 1), (57, 1), (64, 1), (65, 1)] }, { coefficient := 1, powers := [(36, 1), (39, 1), (57, 1), (64, 1), (66, 1)] }],
  ...
  [{ coefficient := 1, powers := [(12, 1), (23, 1), (57, 1)] }, { coefficient := 1, powers := [(12, 1), (29, 1), (48, 1), (57, 1), (65, 1)] }, { coefficient := -1, powers := [(12, 1), (36, 1), (39, 1), (57, 1), (66, 1)] }],
  ...
  [{ coefficient := 1, powers := [(12, 1), (23, 1), (45, 1), (57, 1), (64, 1)] }, { coefficient := 1, powers := [(12, 1), (29, 1), (45, 1), (48, 1), (57, 1), (64, 1), (65, 1)] }, { coefficient := -1, powers := [(12, 1), (30, 1), (49, 1), (52, 1), (57, 1), (66, 1)] }, { coefficient := -1, powers := [(12, 1), (36, 1), (39, 1), (45, 1), (57, 1), (64, 1), (66, 1)] }, { coefficient := 2, powers := [(17, 1), (23, 1), (41, 1), (54, 1), (57, 1), (66, 1)] }]
]
...
#print axioms Krenn.Component11.SelectedLeafB6_2_7_3.selectedHasNoCommonZero

end Krenn.Component11.SelectedLeafB6_2_7_3
