...
namespace Krenn.Component11.SelectedLeafB4_6_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "1eba12195fd3977e32af4684d7d785ae2900714f471e31f0eb5a276158d1c86d"
...
def multipliers : Fin 20 → SparsePoly (Fin 64) := ![
  ...
  [{ coefficient := -1, powers := [(5, 1), (18, 1), (36, 1), (54, 1)] }, { coefficient := -1, powers := [(12, 1), (18, 1), (36, 1), (39, 1)] }, { coefficient := -1, powers := [(12, 1), (22, 1), (49, 1), (53, 1), (63, 1)] }, { coefficient := -1, powers := [(12, 1), (30, 1), (49, 1), (63, 1)] }],
...
#print axioms Krenn.Component11.SelectedLeafB4_6_0.selectedHasNoCommonZero

end Krenn.Component11.SelectedLeafB4_6_0
