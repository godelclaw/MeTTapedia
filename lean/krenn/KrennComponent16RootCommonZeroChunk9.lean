...
namespace Krenn.Component16RootCommonZero.Chunk9
...
theorem rootBlock_of_base_and_component {R : Type*} [CommRing R]
    ...
    ∀ offset : Fin 40, eval₂Hom (Int.castRingHom R) (rootValues full)
      (Krenn.Component16.Tree.rootEquations ⟨360 + offset.val, by omega⟩).toPoly = 0 := by
  ...
  · have source := base 277
    ...
    simp [Krenn.Component16.Tree.rootEquations, Krenn.Component16.Root.rootEquations, Krenn.FrozenCase0System.equations, SparsePoly.toPoly, SparseTerm.toPoly, rootValues, reconstructFull, rootCoordinate, sub_eq_add_neg] at source ⊢
    convert source using 1 <;> ac_rfl
  · have source := base 278
    rw [identified] at source
    simp [Krenn.Component16.Tree.rootEquations, Krenn.Component16.Root.rootEquations, Krenn.FrozenCase0System.equations, SparsePoly.toPoly, SparseTerm.toPoly, rootValues, reconstructFull, rootCoordinate, sub_eq_add_neg] at source ⊢
    convert source using 1 <;> ac_rfl
  · have source := base 279
    rw [identified] at source
    simp [Krenn.Component16.Tree.rootEquations, Krenn.Component16.Root.rootEquations, Krenn.FrozenCase0System.equations, SparsePoly.toPoly, SparseTerm.toPoly, rootValues, reconstructFull, rootCoordinate, sub_eq_add_neg] at source ⊢
    convert source using 1 <;> ac_rfl
...
end Krenn.Component16RootCommonZero.Chunk9
