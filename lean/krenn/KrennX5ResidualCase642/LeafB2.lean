...
namespace Krenn.X5ResidualCase642.LeafB2

open Krenn.SparseCertificate
open MvPolynomial

def sourceSystemFileSHA256 : String := "728913475f90ade61b1b399dac50c55160b4cd53fa73424d2d33da22a0bca5dd"
def sourceSystemSemanticSHA256 : String := "722166bc4851ef6b6c8b62e45521a6905df0cab6dc8d381e88aec80a18672d4d"
def certificateSHA256 : String := "f99b163cb1fcc57542c1a2be0f47fee55c553f9c9b9a422eadd932bea4f50f29"
...
def multipliers : Fin 19 → SparsePoly (Fin 71) := ![
  ...
  [{ coefficient := -1, powers := [(10, 1), (34, 1), (38, 1), (55, 1), (63, 1), (70, 1)] }],
  [{ coefficient := -1, powers := [(18, 1), (34, 1), (38, 1), (55, 1)] }],
  ...
  [{ coefficient := 1, powers := [(10, 1), (34, 1), (38, 1), (49, 1), (55, 1), (63, 1)] }],
...
#print axioms Krenn.X5ResidualCase642.LeafB2.selectedHasNoCommonZero

end Krenn.X5ResidualCase642.LeafB2
