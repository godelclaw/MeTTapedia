...
namespace Krenn.X5ResidualCase642.LeafB7

open Krenn.SparseCertificate
open MvPolynomial

def sourceSystemFileSHA256 : String := "c3e225ce67357213693362d8aad63321e4a12fc724b2618b3c04e3de1b701092"
def sourceSystemSemanticSHA256 : String := "58449f59c3bee439be1fa02c2daf703fd83c71cd6ab7938c0b7fa0287b5d936e"
def certificateSHA256 : String := "8f207beecbaf2b03c460c62e20de3166bea9a8aec366cb6012bb2c5851cb1891"
...
def multipliers : Fin 16 → SparsePoly (Fin 73) := ![
  [{ coefficient := -1, powers := [(13, 1), (32, 1), (37, 1), (61, 1), (63, 1), (70, 1)] }, { coefficient := -1, powers := [(13, 1), (32, 1), (40, 1), (57, 1), (61, 1), (70, 1)] }, { coefficient := -1, powers := [(13, 1), (32, 1), (43, 1), (54, 1), (61, 1), (70, 1)] }, { coefficient := -1, powers := [(30, 1), (32, 1), (37, 1), (63, 1)] }, { coefficient := -1, powers := [(30, 1), (32, 1), (40, 1), (57, 1)] }, { coefficient := -1, powers := [(30, 1), (32, 1), (43, 1), (54, 1)] }],
  ...
  [{ coefficient := 1, powers := [(13, 1), (32, 1), (37, 1), (45, 1), (61, 1), (63, 1)] }, { coefficient := 1, powers := [(13, 1), (32, 1), (40, 1), (45, 1), (57, 1), (61, 1)] }, { coefficient := 1, powers := [(13, 1), (32, 1), (43, 1), (45, 1), (54, 1), (61, 1)] }]
]
...
#print axioms Krenn.X5ResidualCase642.LeafB7.selectedHasNoCommonZero

end Krenn.X5ResidualCase642.LeafB7
