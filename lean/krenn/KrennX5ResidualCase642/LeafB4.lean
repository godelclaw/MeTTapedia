...
namespace Krenn.X5ResidualCase642.LeafB4

open Krenn.SparseCertificate
open MvPolynomial

def sourceSystemFileSHA256 : String := "63988ff645b8d35655ff72c611a98828178b96ad7a0d64b0d4624d81a1d28a59"
def sourceSystemSemanticSHA256 : String := "4ca08095b82ba0319f32c89254df1b15d781c01c0bfa4ab15bfb8f2eec32f3f1"
def certificateSHA256 : String := "82a23dce86f28ecc916838e95c576d8cb706b5b85ec2bceb21c7bbd1696e6d1b"
...
def multipliers : Fin 20 → SparsePoly (Fin 71) := ![
  ...
  [{ coefficient := -1, powers := [(22, 1), (32, 1), (37, 1), (45, 1), (63, 1)] }, { coefficient := -1, powers := [(22, 1), (32, 1), (40, 1), (45, 1), (57, 1)] }, { coefficient := 1, powers := [(32, 1), (34, 1), (38, 1), (43, 1), (54, 1)] }],
...
#print axioms Krenn.X5ResidualCase642.LeafB4.selectedHasNoCommonZero

end Krenn.X5ResidualCase642.LeafB4
