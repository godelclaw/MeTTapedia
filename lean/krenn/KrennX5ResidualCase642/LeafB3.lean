...
namespace Krenn.X5ResidualCase642.LeafB3

open Krenn.SparseCertificate
open MvPolynomial

def sourceSystemFileSHA256 : String := "7d70e3693779a0c134fde0793734334d370c149987b7194dbf075cd107bc036d"
def sourceSystemSemanticSHA256 : String := "5bcd37831e1b491f79397504d739694581ef8785cfe3143d0baca437215167e0"
def certificateSHA256 : String := "86d21be97807c18fcc941121d8114df7c23c6196d7840ca43308c10048f7e09f"
...
def multipliers : Fin 18 → SparsePoly (Fin 72) := ![
  ...
  [{ coefficient := -1, powers := [(0, 1), (46, 1)] }, { coefficient := 1, powers := [(2, 1), (8, 1), (46, 1)] }],
  [{ coefficient := -1, powers := [(7, 1), (32, 1), (35, 1), (48, 1), (61, 1)] }, { coefficient := -1, powers := [(7, 1), (32, 1), (38, 1), (48, 1), (55, 1)] }],
  ...
  [{ coefficient := 1, powers := [(15, 1), (32, 1), (35, 1), (61, 1)] }, { coefficient := 1, powers := [(15, 1), (32, 1), (38, 1), (55, 1)] }],
  ...
  [{ coefficient := 1, powers := [(10, 1), (34, 1), (35, 1), (49, 1), (61, 1), (63, 1)] }, { coefficient := 1, powers := [(10, 1), (34, 1), (38, 1), (49, 1), (55, 1), (63, 1)] }]
]
...
#print axioms Krenn.X5ResidualCase642.LeafB3.selectedHasNoCommonZero

end Krenn.X5ResidualCase642.LeafB3
