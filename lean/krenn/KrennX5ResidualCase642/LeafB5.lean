...
namespace Krenn.X5ResidualCase642.LeafB5

open Krenn.SparseCertificate
open MvPolynomial

def sourceSystemFileSHA256 : String := "def169bde07902af09195377786c3b819d676c60b406af0574702fd77e4be48d"
def sourceSystemSemanticSHA256 : String := "aa1da21aa31fa36d8f428e460b7c07087c82d9bd555981dd6cb7f81d516aebbb"
def certificateSHA256 : String := "fe57c8e5ceaeef218109d2515866bc60c3af1b7f14c513c2c250aac44a941d3b"
...
def multipliers : Fin 18 → SparsePoly (Fin 72) := ![
  ...
  [{ coefficient := 1, powers := [(10, 1), (34, 1), (35, 1), (49, 1), (61, 1), (63, 1)] }, { coefficient := 1, powers := [(10, 1), (34, 1), (41, 1), (49, 1), (52, 1), (63, 1)] }],
...
#print axioms Krenn.X5ResidualCase642.LeafB5.selectedHasNoCommonZero

end Krenn.X5ResidualCase642.LeafB5
