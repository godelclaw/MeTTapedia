...
/-!
Exact normalization of external minimal-prime component 58 into
zero-based Lean component row 57.  All exponent-map equalities are
rechecked by Lean below; this source is generated only for serialization.
-/

namespace Krenn.Component58Normalization
...
theorem selectedIndices_exact : componentGenerators 57 = selectedIndices := by decide
...
set_option maxRecDepth 100000 in
theorem rawComponent58_vanishes {R : Type*} [CommRing R]
...
end Krenn.Component58Normalization

#print axioms Krenn.Component58Normalization.rawComponent58_vanishes
