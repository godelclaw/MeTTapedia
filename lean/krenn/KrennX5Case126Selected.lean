...
namespace Krenn.X5Case126Selected

open Krenn.SparseCertificate
open MvPolynomial

def sourceSystemFileSHA256 : String := "ae8188c7820711b1cdf7a0770f10e90164f18ee4008fe9d7e3f90ddca584e287"
def sourceSystemSemanticSHA256 : String := "c2718f5d17258f8341a87276dc63f648351f76e29548af56ee62c63bdc22fc1c"
def certificateSHA256 : String := "30730bd5241dc9e88191a5a856105bbb5ab322a0581c2b5fb92adcfc804e391c"
...
def multipliers : Fin 16 → SparsePoly (Fin 70) := ![
  ...
  [{ coefficient := -1, powers := [(11, 1), (25, 1), (32, 1), (35, 1), (61, 1)] }, { coefficient := 1, powers := [(28, 1), (32, 1), (35, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(11, 1), (17, 1), (32, 1), (35, 1), (61, 1)] }, { coefficient := 1, powers := [(20, 1), (32, 1), (35, 1), (61, 1)] }],
...
#print axioms Krenn.X5Case126Selected.selectedHasNoCommonZero

end Krenn.X5Case126Selected
