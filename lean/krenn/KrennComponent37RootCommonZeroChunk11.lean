...
namespace Krenn.Component37RootCommonZero.Chunk11
...
theorem rootBlock_of_base_and_component {R : Type*} [CommRing R]
    ...
    ∀ offset : Fin 40, eval₂Hom (Int.castRingHom R) (rootValues full)
      (Krenn.Component37.Tree.rootEquations ⟨440 + offset.val, by omega⟩).toPoly = 0 := by
...
end Krenn.Component37RootCommonZero.Chunk11
