...
namespace Krenn.Component15.SelectedLeafB2_6_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "1c7fb0382e356b66b8c682aae157579c08c5714e88019ed38a9b0b15f0b008a0"
...
def multipliers : Fin 7 → SparsePoly (Fin 63) := ![
  [{ coefficient := 1, powers := [(23, 1), (48, 1), (57, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(40, 1), (57, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(23, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(62, 1)] }],
  [{ coefficient := -1, powers := [(37, 1), (53, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(23, 1), (40, 1), (48, 1), (62, 1)] }, { coefficient := 1, powers := [(40, 1), (49, 1), (62, 1)] }],
...
#print axioms Krenn.Component15.SelectedLeafB2_6_7.selectedHasNoCommonZero

end Krenn.Component15.SelectedLeafB2_6_7
