...
namespace Krenn.Component15.SelectedLeafB4_2_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "38a48e2d237eae2ff856b31bc74e05ef72c387e5e309980f3fc1e42efbbfae43"
def certificateSHA256 : String := "f04c053d930af907ca16457b6a6bbc8031263ae258bbd23f39fff781554b9ebe"
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedEquations : Fin 23 → SparsePoly (Fin 60) := ![
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def multipliers : Fin 23 → SparsePoly (Fin 60) := ![
  [{ coefficient := 2, powers := [(26, 1), (44, 1), (57, 1)] }],
  [{ coefficient := 2, powers := [(18, 1), (26, 1), (57, 1)] }],
  [{ coefficient := 2, powers := [(21, 1), (50, 1), (57, 1)] }],
  [{ coefficient := 2, powers := [(21, 1), (23, 1), (57, 1)] }],
  ...
  [{ coefficient := -2, powers := [(16, 1), (21, 1), (57, 1)] }],
  [{ coefficient := 1, powers := [(50, 1)] }],
  [{ coefficient := 1, powers := [(44, 1)] }],
  [{ coefficient := 2, powers := [(0, 1), (26, 1), (57, 1)] }, { coefficient := -1, powers := [(26, 1)] }],
  [{ coefficient := 2, powers := [(0, 1), (21, 1), (57, 1)] }, { coefficient := -1, powers := [(21, 1)] }],
  [{ coefficient := 1, powers := [(16, 1)] }],
  [{ coefficient := -1, powers := [(12, 1), (21, 1)] }],
  [{ coefficient := -1, powers := [(16, 1), (26, 1)] }],
  [{ coefficient := 1, powers := [(12, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := -2, powers := [(5, 1), (26, 1), (56, 1)] }, { coefficient := -2, powers := [(8, 1), (21, 1), (56, 1)] }],
  [{ coefficient := 1, powers := [(35, 1), (56, 1)] }, { coefficient := -1, powers := [(44, 1), (50, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (16, 1), (26, 1), (52, 1)] }, { coefficient := -2, powers := [(0, 1), (16, 1), (26, 1), (57, 1)] }, { coefficient := 1, powers := [(8, 1), (32, 1)] }, { coefficient := 2, powers := [(16, 1), (26, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (12, 1), (21, 1), (37, 1)] }, { coefficient := -2, powers := [(0, 1), (12, 1), (21, 1), (57, 1)] }, { coefficient := 1, powers := [(2, 1), (38, 1)] }, { coefficient := 1, powers := [(5, 1), (29, 1)] }, { coefficient := 2, powers := [(12, 1), (21, 1)] }]
]
...
#print axioms Krenn.Component15.SelectedLeafB4_2_2.selectedHasNoCommonZero

end Krenn.Component15.SelectedLeafB4_2_2
