...
namespace Krenn.Component15.SelectedLeafB6_2_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "11a08ed29a0d01ba76ac28f0786010f2ea315e7abbe68ca5b1a6e2381afd51cf"
def certificateSHA256 : String := "7247bc90429fe564cbfd498a9a3694fbcf1ab2ad8a8823f194a7b2aada1d4339"
...
def multipliers : Fin 24 → SparsePoly (Fin 62) := ![
  [{ coefficient := -1, powers := [(8, 1), (25, 1), (56, 1), (58, 1)] }, { coefficient := 1, powers := [(12, 1), (25, 1), (53, 1), (58, 1)] }],
  ...
  [{ coefficient := -1, powers := [(3, 1), (29, 1), (53, 1)] }],
  [{ coefficient := -1, powers := [(6, 1), (21, 1), (56, 1)] }],
  [{ coefficient := -1, powers := [(21, 1), (37, 1), (53, 1)] }, { coefficient := -1, powers := [(21, 1), (42, 1), (53, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (21, 1), (53, 1)] }],
  [{ coefficient := -1, powers := [(16, 1), (43, 1)] }],
  [{ coefficient := -1, powers := [(12, 1), (49, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (12, 1), (53, 1)] }, { coefficient := 1, powers := [(12, 1), (17, 1), (53, 1)] }],
  [{ coefficient := 1, powers := [(50, 1)] }],
  [{ coefficient := 1, powers := [(26, 1)] }],
  [{ coefficient := 1, powers := [(3, 1), (53, 1), (55, 1), (60, 1)] }, { coefficient := 1, powers := [(53, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (56, 1)] }, { coefficient := -1, powers := [(12, 1), (53, 1)] }],
  [{ coefficient := 1, powers := [(16, 1)] }],
  [{ coefficient := 1, powers := [(12, 1)] }],
  [{ coefficient := 1, powers := [(12, 1), (21, 1), (53, 1)] }],
  [{ coefficient := -1, powers := [(12, 1), (21, 1), (53, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := 1, powers := [(8, 1), (25, 1), (43, 1), (56, 1)] }, { coefficient := -1, powers := [(8, 1), (29, 1), (44, 1)] }, { coefficient := -1, powers := [(12, 1), (25, 1), (43, 1), (53, 1)] }, { coefficient := -1, powers := [(12, 1), (25, 1), (44, 1), (49, 1)] }, { coefficient := 1, powers := [(12, 1), (26, 1), (44, 1)] }, { coefficient := -1, powers := [(16, 1), (20, 1), (43, 1), (50, 1)] }, { coefficient := 1, powers := [(16, 1), (21, 1), (50, 1)] }],
  [{ coefficient := 1, powers := [(35, 1), (56, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (3, 1), (52, 1), (53, 1), (55, 1), (60, 1)] }, { coefficient := -1, powers := [(2, 1), (52, 1), (53, 1), (60, 1)] }, { coefficient := 1, powers := [(2, 1), (53, 1)] }, { coefficient := 1, powers := [(8, 1), (32, 1)] }, { coefficient := -1, powers := [(16, 1), (26, 1)] }],
  [{ coefficient := -1, powers := [(3, 1), (5, 1), (29, 1), (53, 1), (55, 1)] }, { coefficient := -1, powers := [(3, 1), (12, 1), (21, 1), (53, 1), (55, 1)] }, { coefficient := -1, powers := [(5, 1), (29, 1), (53, 1)] }, { coefficient := -1, powers := [(12, 1), (21, 1), (53, 1)] }]
]
...
#print axioms Krenn.Component15.SelectedLeafB6_2_3.selectedHasNoCommonZero

end Krenn.Component15.SelectedLeafB6_2_3
