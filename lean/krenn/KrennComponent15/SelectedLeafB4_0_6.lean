...
namespace Krenn.Component15.SelectedLeafB4_0_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "5b5e0211068d262600e24c9a0d526fd10bdc434091cdca71446c22e191adf3f4"
def certificateSHA256 : String := "1c1b3f0f834847cc6babad2f4e241a1e04c2550d9991c1447e49bd9b787d2639"

set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedSourceIndices : Fin 15 → Fin 595 := ![
  21,
  318,
  336,
  360,
...
def selectedEquations : Fin 15 → SparsePoly (Fin 60) := ![
  ...
  [{ coefficient := 1, powers := [(51, 1), (58, 1)] }, { coefficient := -1, powers := [] }],
...
def multipliers : Fin 15 → SparsePoly (Fin 60) := ![
  [{ coefficient := -1, powers := [(26, 1), (44, 1), (48, 1)] }, { coefficient := -1, powers := [(32, 1), (35, 1), (41, 1), (58, 1)] }],
  [{ coefficient := 1, powers := [(32, 1), (35, 1), (58, 1)] }],
  [{ coefficient := -1, powers := [(21, 1), (50, 1)] }, { coefficient := 1, powers := [(29, 1), (35, 1)] }],
  [{ coefficient := 1, powers := [(12, 1), (26, 1), (48, 1)] }],
  ...
  [{ coefficient := -1, powers := [(12, 1), (32, 1), (35, 1)] }],
...
#print axioms Krenn.Component15.SelectedLeafB4_0_6.selectedHasNoCommonZero

end Krenn.Component15.SelectedLeafB4_0_6
