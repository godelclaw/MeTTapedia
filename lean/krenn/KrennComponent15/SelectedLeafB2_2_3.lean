...
namespace Krenn.Component15.SelectedLeafB2_2_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "59c3e4e2157b9ca3ef217255eaa2188d5f44d77ac6b6040ed6be06d2b0bf459a"
...
def multipliers : Fin 7 → SparsePoly (Fin 61) := ![
  [{ coefficient := 1, powers := [(23, 1), (48, 1), (57, 1), (60, 1)] }],
  [{ coefficient := -1, powers := [(40, 1), (57, 1), (60, 1)] }],
  [{ coefficient := -1, powers := [(23, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(60, 1)] }],
  [{ coefficient := -1, powers := [(37, 1), (53, 1), (60, 1)] }],
  [{ coefficient := -1, powers := [(23, 1), (40, 1), (48, 1), (60, 1)] }, { coefficient := 1, powers := [(40, 1), (49, 1), (60, 1)] }],
...
#print axioms Krenn.Component15.SelectedLeafB2_2_3.selectedHasNoCommonZero

end Krenn.Component15.SelectedLeafB2_2_3
