...
namespace Krenn.Component15.SelectedLeafB4_7_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "d9f9a098bd2a39f3adcd50726223ef84d08af0e9e3803d3d376945e1a653a229"
...
def multipliers : Fin 16 → SparsePoly (Fin 64) := ![
  [{ coefficient := -1, powers := [(24, 1), (42, 1), (63, 1)] }, { coefficient := -1, powers := [(24, 1), (52, 1), (63, 1)] }, { coefficient := 1, powers := [(31, 1), (34, 1), (63, 1)] }],
  ...
  [{ coefficient := -1, powers := [(7, 1), (40, 1), (55, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(7, 1), (43, 1), (55, 1), (60, 1)] }],
  [{ coefficient := -1, powers := [(7, 1), (55, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(7, 1), (55, 1), (63, 1)] }],
  ...
  [{ coefficient := 1, powers := [(34, 1), (55, 1)] }, { coefficient := -1, powers := [(37, 1), (38, 1), (52, 1), (60, 1)] }, { coefficient := -1, powers := [(37, 1), (52, 1), (53, 1), (63, 1)] }, { coefficient := 1, powers := [(37, 1), (52, 1)] }, { coefficient := -1, powers := [(42, 1), (48, 1)] }],
...
#print axioms Krenn.Component15.SelectedLeafB4_7_7.selectedHasNoCommonZero

end Krenn.Component15.SelectedLeafB4_7_7
