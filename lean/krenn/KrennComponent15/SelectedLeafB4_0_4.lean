...
namespace Krenn.Component15.SelectedLeafB4_0_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "15995c9111953c9dc52decc51091e426c6e0b9a6ae82555433c635ad11729144"
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedEquations : Fin 12 → SparsePoly (Fin 59) := ![
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def multipliers : Fin 12 → SparsePoly (Fin 59) := ![
...
#print axioms Krenn.Component15.SelectedLeafB4_0_4.selectedHasNoCommonZero

end Krenn.Component15.SelectedLeafB4_0_4
