...
namespace Krenn.Component15.SelectedLeafB6_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "850b9649143a20d92a12eedc7407ac748da3f4a7dc860f48d6b3b7598be2ed82"
...
def multipliers : Fin 15 → SparsePoly (Fin 59) := ![
  ...
  [{ coefficient := -1, powers := [(5, 1), (29, 1), (40, 1), (58, 1)] }, { coefficient := 1, powers := [(12, 1), (21, 1), (40, 1), (58, 1)] }, { coefficient := 1, powers := [(12, 1), (25, 1), (44, 1), (58, 1)] }],
  [{ coefficient := -1, powers := [(16, 1), (21, 1), (58, 1)] }],
...
#print axioms Krenn.Component15.SelectedLeafB6_0.selectedHasNoCommonZero

end Krenn.Component15.SelectedLeafB6_0
