...
namespace Krenn.Component15.SelectedLeafB6_6_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "9945eb62ed1d4bba66b1067bb4ee566d52604cb8ecb27cf5fa83ae343d270082"
...
def multipliers : Fin 21 → SparsePoly (Fin 64) := ![
  ...
  [{ coefficient := 1, powers := [(21, 1), (41, 1), (53, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(25, 1), (53, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(16, 1), (43, 1)] }],
  [{ coefficient := -1, powers := [(12, 1), (49, 1)] }],
  [{ coefficient := -1, powers := [(21, 1), (53, 1), (61, 1)] }],
  ...
  [{ coefficient := -1, powers := [(18, 1), (41, 1), (46, 1), (53, 1), (61, 1)] }, { coefficient := 1, powers := [(35, 1), (56, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (51, 1), (53, 1), (61, 1)] }, { coefficient := 1, powers := [(2, 1), (53, 1)] }, { coefficient := 1, powers := [(8, 1), (32, 1)] }, { coefficient := -1, powers := [(16, 1), (26, 1)] }],
...
#print axioms Krenn.Component15.SelectedLeafB6_6_7.selectedHasNoCommonZero

end Krenn.Component15.SelectedLeafB6_6_7
