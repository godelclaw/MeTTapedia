...
namespace Krenn.Component15.SelectedLeafB2_2_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "cb8c266df0c9ec46fd18ce657f5ba13d24f8a88f3f816304ccfa7122333c7288"
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedEquations : Fin 14 → SparsePoly (Fin 60) := ![
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def multipliers : Fin 14 → SparsePoly (Fin 60) := ![
  [{ coefficient := 1, powers := [(8, 1), (29, 1), (57, 1)] }, { coefficient := -1, powers := [(12, 1), (26, 1), (57, 1)] }],
  [{ coefficient := 1, powers := [(12, 1), (25, 1), (44, 1), (57, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (32, 1), (57, 1)] }, { coefficient := 1, powers := [(16, 1), (20, 1), (43, 1), (57, 1)] }, { coefficient := -1, powers := [(16, 1), (21, 1), (57, 1)] }],
...
#print axioms Krenn.Component15.SelectedLeafB2_2_2.selectedHasNoCommonZero

end Krenn.Component15.SelectedLeafB2_2_2
