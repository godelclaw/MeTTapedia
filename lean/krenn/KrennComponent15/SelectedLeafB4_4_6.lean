...
namespace Krenn.Component15.SelectedLeafB4_4_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "812c697f5dc788a273f8b3254577c370df8aa8d4ea928a7d46358105fe5a8c3a"
def certificateSHA256 : String := "58ad2dc393a74fc2c5fe72156f95388f22c507553b26d64877e0cb1e484de641"
...
def multipliers : Fin 15 → SparsePoly (Fin 61) := ![
  [{ coefficient := -1, powers := [(26, 1), (44, 1), (48, 1)] }, { coefficient := -1, powers := [(32, 1), (35, 1), (41, 1), (59, 1)] }],
  [{ coefficient := 1, powers := [(32, 1), (35, 1), (59, 1)] }],
...
#print axioms Krenn.Component15.SelectedLeafB4_4_6.selectedHasNoCommonZero

end Krenn.Component15.SelectedLeafB4_4_6
