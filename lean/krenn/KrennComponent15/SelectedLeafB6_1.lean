...
namespace Krenn.Component15.SelectedLeafB6_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "b98953d7475d9a5587fd83de4a59ccbb3b034519cc2cadabfe3f9dcdc7abcd0b"
def certificateSHA256 : String := "792c39d56df3b381a4e7720c96656a4ea4b0e16e2f917c24a596606544926bed"

set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedSourceIndices : Fin 22 → Fin 592 := ![
  1,
  2,
  4,
  16,
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedEquations : Fin 22 → SparsePoly (Fin 60) := ![
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def multipliers : Fin 22 → SparsePoly (Fin 60) := ![
  ...
  [{ coefficient := 1, powers := [(1, 1), (32, 1), (34, 1), (38, 1)] }, { coefficient := 1, powers := [(4, 1), (24, 1), (32, 1), (38, 1)] }, { coefficient := 1, powers := [(6, 1), (11, 1), (19, 1), (32, 1), (38, 1), (48, 1)] }, { coefficient := -1, powers := [(6, 1), (21, 1), (56, 1)] }, { coefficient := 1, powers := [(7, 1), (19, 1), (32, 1), (38, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (19, 1), (32, 1), (38, 1), (48, 1), (59, 1)] }, { coefficient := -1, powers := [(8, 1), (19, 1), (32, 1), (38, 1), (52, 1), (59, 1)] }, { coefficient := -1, powers := [(8, 1), (24, 1), (32, 1), (38, 1), (42, 1), (59, 1)] }, { coefficient := -1, powers := [(8, 1), (31, 1), (32, 1), (34, 1), (38, 1), (59, 1)] }],
  ...
  [{ coefficient := 1, powers := [(35, 1), (56, 1)] }, { coefficient := 1, powers := [(38, 1), (53, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (5, 1), (29, 1), (53, 1)] }, { coefficient := 1, powers := [(1, 1), (8, 1), (32, 1), (38, 1), (52, 1)] }, { coefficient := -1, powers := [(5, 1), (23, 1), (29, 1), (40, 1)] }, { coefficient := 1, powers := [(6, 1), (8, 1), (11, 1), (31, 1), (32, 1), (38, 1), (48, 1)] }, { coefficient := 1, powers := [(7, 1), (8, 1), (31, 1), (32, 1), (38, 1)] }, { coefficient := -1, powers := [(8, 1), (11, 1), (24, 1), (32, 1), (38, 1)] }, { coefficient := -1, powers := [(16, 1), (22, 1), (29, 1), (35, 1)] }],
...
#print axioms Krenn.Component15.SelectedLeafB6_1.selectedHasNoCommonZero

end Krenn.Component15.SelectedLeafB6_1
