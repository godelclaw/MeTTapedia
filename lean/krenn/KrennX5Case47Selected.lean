...
namespace Krenn.X5Case47Selected

open Krenn.SparseCertificate
open MvPolynomial

def sourceSystemFileSHA256 : String := "9f7371a48d2141dd8212f15af8ec16c8ca0af0653d3138b802ec43a464312b33"
def sourceSystemSemanticSHA256 : String := "c5f017fc21d4432b5eecdc4e53cac09a52bd54786cd60afa190f2cc53911189e"
def certificateSHA256 : String := "3f2af182ee42625d20edaca9b7a52945123a51a80438ba50df79ace899780633"
...
def selectedEquations : Fin 21 → SparsePoly (Fin 70) := ![
  ...
  [{ coefficient := 1, powers := [(10, 1), (61, 1)] }, { coefficient := 1, powers := [(18, 1), (55, 1)] }, { coefficient := 1, powers := [(26, 1), (52, 1)] }],
...
def multipliers : Fin 21 → SparsePoly (Fin 70) := ![
  [{ coefficient := 1, powers := [(3, 1), (32, 1), (41, 1), (53, 1), (68, 1)] }, { coefficient := 1, powers := [(3, 1), (32, 1), (41, 1), (56, 1), (65, 1)] }, { coefficient := 1, powers := [(3, 1), (32, 1), (41, 1), (59, 1), (62, 1)] }, { coefficient := -1, powers := [(11, 1), (32, 1), (41, 1), (53, 1), (68, 1)] }, { coefficient := -1, powers := [(11, 1), (32, 1), (41, 1), (56, 1), (65, 1)] }, { coefficient := -1, powers := [(11, 1), (32, 1), (41, 1), (59, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(3, 1), (32, 1), (38, 1), (53, 1), (68, 1)] }, { coefficient := 1, powers := [(3, 1), (32, 1), (38, 1), (56, 1), (65, 1)] }, { coefficient := 1, powers := [(3, 1), (32, 1), (38, 1), (59, 1), (62, 1)] }, { coefficient := -1, powers := [(11, 1), (32, 1), (38, 1), (53, 1), (68, 1)] }, { coefficient := -1, powers := [(11, 1), (32, 1), (38, 1), (56, 1), (65, 1)] }, { coefficient := -1, powers := [(11, 1), (32, 1), (38, 1), (59, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (3, 1), (47, 1), (59, 1), (61, 1)] }, { coefficient := -1, powers := [(0, 1), (11, 1), (47, 1), (59, 1), (61, 1)] }, { coefficient := -1, powers := [(3, 1), (44, 1), (59, 1), (61, 1)] }, { coefficient := 1, powers := [(11, 1), (44, 1), (59, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(3, 1), (32, 1), (56, 1), (61, 1)] }, { coefficient := -1, powers := [(11, 1), (32, 1), (56, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(3, 1), (32, 1), (53, 1), (61, 1)] }, { coefficient := -1, powers := [(11, 1), (32, 1), (53, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (3, 1), (25, 1), (59, 1), (61, 1)] }, { coefficient := -1, powers := [(0, 1), (11, 1), (25, 1), (59, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (3, 1), (17, 1), (59, 1), (61, 1)] }, { coefficient := -1, powers := [(0, 1), (11, 1), (17, 1), (59, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (3, 1), (47, 1), (53, 1), (68, 1)] }, { coefficient := -1, powers := [(0, 1), (3, 1), (47, 1), (56, 1), (65, 1)] }, { coefficient := -1, powers := [(0, 1), (3, 1), (47, 1), (59, 1), (62, 1)] }, { coefficient := 1, powers := [(0, 1), (11, 1), (47, 1), (53, 1), (68, 1)] }, { coefficient := 1, powers := [(0, 1), (11, 1), (47, 1), (56, 1), (65, 1)] }, { coefficient := 1, powers := [(0, 1), (11, 1), (47, 1), (59, 1), (62, 1)] }, { coefficient := -1, powers := [(0, 1), (33, 1), (36, 1), (47, 1), (62, 1)] }, { coefficient := -1, powers := [(0, 1), (33, 1), (39, 1), (47, 1), (56, 1)] }, { coefficient := -1, powers := [(0, 1), (33, 1), (42, 1), (47, 1), (53, 1)] }],
  ...
  [{ coefficient := 1, powers := [(3, 1), (59, 1), (61, 1)] }, { coefficient := -1, powers := [(11, 1), (59, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (3, 1), (59, 1), (61, 1)] }, { coefficient := 1, powers := [(0, 1), (11, 1), (59, 1), (61, 1)] }],
...
#print axioms Krenn.X5Case47Selected.selectedHasNoCommonZero

end Krenn.X5Case47Selected
