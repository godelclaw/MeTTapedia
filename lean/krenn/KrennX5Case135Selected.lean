...
namespace Krenn.X5Case135Selected

open Krenn.SparseCertificate
open MvPolynomial

def sourceSystemFileSHA256 : String := "6fd20e07c362da065cb42aed5302b3af33cc7a295693cee08f6e54b627507d81"
def sourceSystemSemanticSHA256 : String := "289e424b2f53f80e636a1264096cf1d7305a88d4d8e0f22786b7d6aa7864f6d5"
def certificateSHA256 : String := "0126d8f754549c4e1634c59fa2ad1ece441b636a8ce7541b09d7564a16766911"
...
def multipliers : Fin 20 → SparsePoly (Fin 70) := ![
  ...
  [{ coefficient := -1, powers := [(3, 1), (13, 1), (32, 1), (41, 1), (66, 1)] }, { coefficient := -1, powers := [(13, 1), (32, 1), (41, 1)] }, { coefficient := 1, powers := [(32, 1), (35, 1)] }],
  ...
  [{ coefficient := -1, powers := [(3, 1), (32, 1), (52, 1)] }],
  [{ coefficient := 1, powers := [(11, 1), (17, 1), (32, 1), (38, 1), (56, 1)] }, { coefficient := -1, powers := [(20, 1), (32, 1), (38, 1), (56, 1)] }],
  ...
  [{ coefficient := 1, powers := [(3, 1), (32, 1), (41, 1), (66, 1)] }, { coefficient := 1, powers := [(32, 1), (41, 1)] }],
  ...
  [{ coefficient := -1, powers := [(11, 1), (17, 1), (32, 1), (38, 1), (55, 1)] }, { coefficient := 1, powers := [(20, 1), (32, 1), (38, 1), (55, 1)] }],
...
#print axioms Krenn.X5Case135Selected.selectedHasNoCommonZero

end Krenn.X5Case135Selected
