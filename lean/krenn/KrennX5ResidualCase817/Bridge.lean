...
import KrennX5ResidualCase817.Tree

namespace Krenn.X5ResidualCase817.Bridge
...
private def c2 : Fin 6 → Fin 3 := ![0, 0, 0, 1, 0, 2]
private def c3 : Fin 6 → Fin 3 := ![1, 0, 1, 0, 1, 2]
private def c4 : Fin 6 → Fin 3 := ![1, 0, 0, 1, 0, 2]
private def c5 : Fin 6 → Fin 3 := ![0, 0, 0, 0, 1, 2]
private def c6 : Fin 6 → Fin 3 := ![1, 0, 1, 1, 0, 2]
private def c7 : Fin 6 → Fin 3 := ![1, 0, 0, 0, 1, 2]
private def c8 : Fin 6 → Fin 3 := ![2, 0, 0, 0, 1, 2]
private def c9 : Fin 6 → Fin 3 := ![2, 1, 1, 2, 0, 2]
private def c10 : Fin 6 → Fin 3 := ![2, 1, 1, 0, 2, 2]
private def c11 : Fin 6 → Fin 3 := ![1, 0, 2, 0, 1, 1]
private def c12 : Fin 6 → Fin 3 := ![2, 1, 2, 1, 0, 2]
private def c13 : Fin 6 → Fin 3 := ![1, 1, 2, 1, 0, 0]
private def c14 : Fin 6 → Fin 3 := ![1, 0, 2, 1, 0, 1]
private def c15 : Fin 6 → Fin 3 := ![2, 1, 2, 0, 1, 2]
private def c16 : Fin 6 → Fin 3 := ![1, 1, 2, 0, 1, 0]
private def c17 : Fin 6 → Fin 3 := ![1, 0, 2, 1, 1, 0]
private def c18 : Fin 6 → Fin 3 := ![1, 0, 2, 0, 0, 1]
private def c19 : Fin 6 → Fin 3 := ![1, 1, 2, 0, 0, 1]
private def c20 : Fin 6 → Fin 3 := ![2, 1, 2, 2, 0, 2]
private def c21 : Fin 6 → Fin 3 := ![2, 1, 1, 0, 1, 2]
private def c22 : Fin 6 → Fin 3 := ![2, 1, 2, 0, 2, 2]
private def c23 : Fin 6 → Fin 3 := ![1, 0, 0, 1, 1, 0]
private def c24 : Fin 6 → Fin 3 := ![1, 0, 2, 1, 1, 2]
private def c25 : Fin 6 → Fin 3 := ![0, 1, 1, 0, 0, 1]
private def c26 : Fin 6 → Fin 3 := ![0, 1, 1, 2, 2, 1]
private def c27 : Fin 6 → Fin 3 := ![0, 1, 0, 1, 0, 1]
private def c28 : Fin 6 → Fin 3 := ![0, 1, 0, 2, 0, 2]
private def c29 : Fin 6 → Fin 3 := ![0, 1, 0, 0, 1, 1]
private def c30 : Fin 6 → Fin 3 := ![2, 0, 1, 0, 1, 2]
private def c31 : Fin 6 → Fin 3 := ![2, 0, 1, 1, 0, 2]
private def c32 : Fin 6 → Fin 3 := ![0, 0, 0, 0, 0, 2]
private def c33 : Fin 6 → Fin 3 := ![0, 0, 1, 1, 1, 2]
private def c34 : Fin 6 → Fin 3 := ![1, 0, 0, 0, 0, 2]
private def c35 : Fin 6 → Fin 3 := ![2, 0, 1, 1, 1, 2]
private def c36 : Fin 6 → Fin 3 := ![2, 1, 1, 1, 0, 1]
private def c37 : Fin 6 → Fin 3 := ![2, 1, 1, 0, 1, 1]
private def c38 : Fin 6 → Fin 3 := ![2, 2, 2, 2, 0, 2]
private def c39 : Fin 6 → Fin 3 := ![2, 2, 2, 0, 2, 2]
private def c40 : Fin 6 → Fin 3 := ![1, 0, 2, 0, 0, 0]
private def c41 : Fin 6 → Fin 3 := ![1, 1, 2, 1, 1, 1]
private def c42 : Fin 6 → Fin 3 := ![1, 1, 0, 0, 1, 1]
private def c43 : Fin 6 → Fin 3 := ![1, 1, 0, 1, 0, 1]
private def c44 : Fin 6 → Fin 3 := ![1, 1, 1, 0, 0, 1]
private def c45 : Fin 6 → Fin 3 := ![1, 1, 1, 2, 2, 1]
private def c46 : Fin 6 → Fin 3 := ![2, 1, 0, 1, 0, 0]
private def c47 : Fin 6 → Fin 3 := ![2, 1, 0, 0, 1, 0]
private def c48 : Fin 6 → Fin 3 := ![1, 1, 2, 2, 1, 2]
private def c49 : Fin 6 → Fin 3 := ![0, 0, 2, 0, 0, 2]
private def c50 : Fin 6 → Fin 3 := ![2, 0, 1, 0, 0, 1]
private def c51 : Fin 6 → Fin 3 := ![2, 0, 2, 0, 0, 2]
private def c52 : Fin 6 → Fin 3 := ![0, 1, 1, 2, 1, 2]
private def c53 : Fin 6 → Fin 3 := ![1, 0, 1, 0, 1, 1]
private def c54 : Fin 6 → Fin 3 := ![1, 0, 1, 1, 0, 1]
private def c55 : Fin 6 → Fin 3 := ![2, 0, 2, 2, 0, 2]
private def c56 : Fin 6 → Fin 3 := ![2, 0, 0, 0, 0, 2]
private def c57 : Fin 6 → Fin 3 := ![1, 1, 2, 2, 2, 2]
private def c58 : Fin 6 → Fin 3 := ![2, 1, 2, 2, 2, 2]
private def c59 : Fin 6 → Fin 3 := ![0, 1, 0, 0, 0, 0]
private def c60 : Fin 6 → Fin 3 := ![0, 1, 1, 1, 1, 0]
private def c61 : Fin 6 → Fin 3 := ![0, 1, 2, 2, 2, 2]
private def c62 : Fin 6 → Fin 3 := ![1, 0, 0, 0, 0, 1]
private def c63 : Fin 6 → Fin 3 := ![2, 1, 1, 1, 1, 2]
private def c64 : Fin 6 → Fin 3 := ![0, 2, 2, 2, 2, 2]
private def c65 : Fin 6 → Fin 3 := ![1, 2, 2, 2, 2, 2]
...
theorem selectedRootEquations_vanish (W : WeightsN 6 3 ℂ)
    ...
    Krenn.X5ResidualCase817.Tree.RootSelectedZero (values W) := by
  intro index
  have r0 := hEq c0
  have r1 := hEq c1
  have r2 := hEq c2
  ...
  simp [-mul_eq_zero, pm15, w, c0, c1, c2, c3, c4, c5, c6, c7, c8, c9, c10, c11, c12, c13, c14, c15, c16, c17, c18, c19, c20, c21, c22, c23, c24, c25, c26, c27, c28, c29, c30, c31, c32, c33, c34, c35, c36, c37, c38, c39, c40, c41, c42, c43, c44, c45, c46, c47, c48, c49, c50, c51, c52, c53, c54, c55, c56, c57, c58, c59, c60, c61, c62, c63, c64, c65, c66, c67, c68, c69, c70, allEqual, allEqualList, vertices, hcase.fixed_01_01, hcase.fixed_02_12, hcase.fixed_03_20, hcase.fixed_04_20, hcase.fixed_15_02, hcase.outside05, hcase.outside12, hcase.outside13, hcase.outside14, hcase.outside23, hcase.outside24, hcase.outside25, hcase.outside34, hcase.outside35, hcase.outside45] at r0 r1 r2 r3 r4 r5 r6 r7 r8 r9 r10 r11 r12 r13 r14 r15 r16 r17 r18 r19 r20 r21 r22 r23 r24 r25 r26 r27 r28 r29 r30 r31 r32 r33 r34 r35 r36 r37 r38 r39 r40 r41 r42 r43 r44 r45 r46 r47 r48 r49 r50 r51 r52 r53 r54 r55 r56 r57 r58 r59 r60 r61 r62 r63 r64 r65 r66 r67 r68 r69 r70
  fin_cases index
  · simp [-mul_eq_zero, Krenn.X5ResidualCase817.Tree.rootSelectedEquations, SparsePoly.toPoly, SparseTerm.toPoly, values, entry, Matrix.cons_val_zero, Matrix.cons_val_one, Matrix.cons_val_fin_one]
...
theorem noNormalizedCase (W : WeightsN 6 3 ℂ)
  ...
  exact (Krenn.X5ResidualCase817.Tree.case817SelectedHasNoCommonZero (values W))
    (selectedRootEquations_vanish W hEq hcase)

#print axioms Krenn.X5ResidualCase817.Bridge.noNormalizedCase

end Krenn.X5ResidualCase817.Bridge
