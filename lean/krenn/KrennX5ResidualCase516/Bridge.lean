...
import KrennX5ResidualCase516.Tree

namespace Krenn.X5ResidualCase516.Bridge
...
private def c1 : Fin 6 → Fin 3 := ![1, 1, 2, 2, 0, 2]
private def c2 : Fin 6 → Fin 3 := ![1, 1, 1, 0, 1, 2]
private def c3 : Fin 6 → Fin 3 := ![1, 1, 2, 0, 2, 2]
private def c4 : Fin 6 → Fin 3 := ![1, 1, 0, 1, 1, 2]
private def c5 : Fin 6 → Fin 3 := ![1, 1, 0, 2, 2, 2]
private def c6 : Fin 6 → Fin 3 := ![1, 1, 1, 1, 0, 1]
private def c7 : Fin 6 → Fin 3 := ![1, 1, 1, 0, 1, 1]
private def c8 : Fin 6 → Fin 3 := ![1, 2, 2, 2, 0, 2]
...
private def c13 : Fin 6 → Fin 3 := ![2, 1, 1, 1, 1, 2]
...
theorem selectedRootEquations_vanish (W : WeightsN 6 3 ℂ)
    ...
    Krenn.X5ResidualCase516.Tree.RootSelectedZero (values W) := by
  intro index
  have r0 := hEq c0
  have r1 := hEq c1
  have r2 := hEq c2
...
theorem noNormalizedCase (W : WeightsN 6 3 ℂ)
  ...
  exact (Krenn.X5ResidualCase516.Tree.case516SelectedHasNoCommonZero (values W))
    (selectedRootEquations_vanish W hEq hcase)

#print axioms Krenn.X5ResidualCase516.Bridge.noNormalizedCase

end Krenn.X5ResidualCase516.Bridge
