...
namespace Krenn.Component1.SelectedLeafB5_6_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "512d71df5c52da4212ada03c0017947167f04922edd7794130963672502af25b"
def certificateSHA256 : String := "795c4f7863b5ed3b36e80495a9da15f77d41d329e080ac9ca495742582e2d8d2"
...
def multipliers : Fin 26 → SparsePoly (Fin 63) := ![
  [{ coefficient := -2, powers := [(2, 1), (39, 1), (55, 1)] }, { coefficient := -1, powers := [(5, 1), (30, 1), (55, 1)] }],
  [{ coefficient := 2, powers := [(2, 1), (20, 1), (29, 1), (39, 1), (56, 1), (58, 1), (59, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(23, 1), (25, 1)] }],
  [{ coefficient := -1, powers := [(30, 1), (47, 1), (61, 1)] }],
  [{ coefficient := 2, powers := [(2, 1), (20, 1), (29, 1), (39, 1), (56, 1), (58, 1), (61, 1)] }, { coefficient := -2, powers := [(2, 1), (24, 1), (29, 1), (39, 1), (56, 1), (58, 1), (61, 1)] }],
  [{ coefficient := -2, powers := [(23, 1), (50, 1), (59, 1)] }],
  [{ coefficient := -1, powers := [(18, 1), (50, 1)] }],
  [{ coefficient := 2, powers := [(2, 1), (20, 1), (39, 1), (40, 1), (56, 1), (58, 1), (59, 1)] }, { coefficient := -2, powers := [(2, 1), (20, 1), (39, 1), (56, 1), (58, 1)] }, { coefficient := 2, powers := [(2, 1), (24, 1), (39, 1), (56, 1), (58, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (56, 1)] }],
  [{ coefficient := 1, powers := [(47, 1)] }],
  [{ coefficient := 1, powers := [(19, 1)] }],
  [{ coefficient := 1, powers := [(14, 1)] }],
  [{ coefficient := 2, powers := [(2, 1), (39, 1), (49, 1), (55, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (57, 1)] }],
  [{ coefficient := -2, powers := [(2, 1), (20, 1), (39, 1), (56, 1), (58, 1), (59, 1)] }],
  [{ coefficient := 1, powers := [(50, 1)] }],
  [{ coefficient := 1, powers := [(23, 1)] }],
  [{ coefficient := 2, powers := [(2, 1), (39, 1), (56, 1)] }],
  [{ coefficient := -2, powers := [(2, 1), (39, 1), (49, 1), (56, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := 1, powers := [(2, 1), (39, 1), (56, 1)] }, { coefficient := 1, powers := [(2, 1), (47, 1), (50, 1)] }],
  [{ coefficient := 2, powers := [(2, 1), (20, 1), (39, 1), (52, 1), (56, 1)] }, { coefficient := -2, powers := [(2, 1), (24, 1), (39, 1), (49, 1), (56, 1)] }],
  [{ coefficient := -2, powers := [(2, 2), (20, 1), (39, 1), (49, 1), (56, 1), (58, 1)] }, { coefficient := 2, powers := [(2, 2), (20, 1), (39, 1), (52, 1), (56, 1), (58, 1)] }, { coefficient := 2, powers := [(19, 1), (23, 1), (50, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (36, 1)] }],
  [{ coefficient := -2, powers := [(2, 1), (13, 1), (20, 1), (29, 1), (39, 1), (56, 1), (58, 1), (59, 1)] }, { coefficient := -2, powers := [(2, 1), (18, 1), (20, 1), (29, 1), (39, 1), (56, 1), (58, 1)] }, { coefficient := 2, powers := [(2, 1), (18, 1), (24, 1), (29, 1), (39, 1), (56, 1), (58, 1)] }, { coefficient := 1, powers := [(14, 1), (30, 1), (47, 1)] }],
...
#print axioms Krenn.Component1.SelectedLeafB5_6_6.selectedHasNoCommonZero

end Krenn.Component1.SelectedLeafB5_6_6
