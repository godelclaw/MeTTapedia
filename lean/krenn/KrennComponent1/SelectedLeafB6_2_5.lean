...
namespace Krenn.Component1.SelectedLeafB6_2_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "6745d87241ff5e999a5980e425908d0e5ea52890f0ca531320d587d9a4722010"
...
def multipliers : Fin 19 → SparsePoly (Fin 62) := ![
  ...
  [{ coefficient := 1, powers := [(39, 1), (56, 1)] }, { coefficient := -1, powers := [(41, 1), (47, 1), (50, 1), (59, 1)] }, { coefficient := 1, powers := [(47, 1), (50, 1)] }],
...
#print axioms Krenn.Component1.SelectedLeafB6_2_5.selectedHasNoCommonZero

end Krenn.Component1.SelectedLeafB6_2_5
