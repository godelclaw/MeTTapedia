...
namespace Krenn.Component1.SelectedLeafB7_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "e5d38f75d6550ecc8cff4f55af13a5d88702d3945e9e62978c659392f3c76dba"
def certificateSHA256 : String := "d3faccb612eb6e3e453e8a41405353604929d0565ada979477f4ba428e3a5919"
...
def multipliers : Fin 21 → SparsePoly (Fin 61) := ![
  ...
  [{ coefficient := 1, powers := [(5, 1), (25, 1), (33, 1), (60, 1)] }],
  [{ coefficient := -1, powers := [(23, 1), (25, 1)] }],
  [{ coefficient := 1, powers := [(14, 1), (23, 1), (52, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (33, 1), (45, 1), (60, 1)] }],
  ...
  [{ coefficient := 1, powers := [(5, 1), (33, 1), (40, 1), (60, 1)] }],
  ...
  [{ coefficient := 2, powers := [(0, 1), (5, 1), (30, 1), (56, 1)] }, { coefficient := -1, powers := [(0, 1), (5, 1), (33, 1), (40, 1), (53, 1), (60, 1)] }],
...
#print axioms Krenn.Component1.SelectedLeafB7_4.selectedHasNoCommonZero

end Krenn.Component1.SelectedLeafB7_4
