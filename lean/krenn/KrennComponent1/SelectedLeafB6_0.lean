...
namespace Krenn.Component1.SelectedLeafB6_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "7b3b2f5b96b134a3efffa0a087920ee00acd872400cea11d14b57bf338daf299"
def certificateSHA256 : String := "b5c07fddbb57b53c9ab692526646b98f6f7a618bcc8a82e479ec84147773c6f1"
...
def multipliers : Fin 20 → SparsePoly (Fin 59) := ![
  ...
  [{ coefficient := -1, powers := [(5, 1), (25, 1), (29, 1), (55, 1)] }, { coefficient := -2, powers := [(5, 1), (30, 1), (55, 1)] }],
  [{ coefficient := -1, powers := [(23, 1), (25, 1)] }],
  [{ coefficient := 1, powers := [(14, 1), (23, 1), (52, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (25, 1), (33, 1), (44, 1)] }],
  [{ coefficient := -2, powers := [(0, 1), (5, 1), (56, 1)] }, { coefficient := -2, powers := [(5, 1), (24, 1), (56, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (25, 1), (55, 1)] }],
  ...
  [{ coefficient := -1, powers := [(5, 1), (25, 1), (33, 1), (45, 1)] }, { coefficient := 2, powers := [(5, 1), (30, 1), (56, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := -1, powers := [(5, 1), (36, 1), (50, 1)] }, { coefficient := 1, powers := [(19, 1), (23, 1), (50, 1)] }],
  [{ coefficient := 1, powers := [(39, 1), (56, 1)] }],
  [{ coefficient := 2, powers := [(0, 1), (5, 1), (30, 1), (56, 1)] }, { coefficient := -1, powers := [(0, 1), (5, 1), (33, 1), (53, 1)] }, { coefficient := 1, powers := [(5, 1), (24, 1), (25, 1), (33, 1), (45, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (53, 1)] }, { coefficient := 1, powers := [(8, 1), (36, 1)] }, { coefficient := 1, powers := [(19, 1), (30, 1)] }]
]
...
#print axioms Krenn.Component1.SelectedLeafB6_0.selectedHasNoCommonZero

end Krenn.Component1.SelectedLeafB6_0
