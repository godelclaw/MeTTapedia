...
namespace Krenn.Component1.SelectedLeafB4_4_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "a0c9196606bbc479a6d32a11d2e5fb58024740dd721153a605ff4c014155378b"
def certificateSHA256 : String := "505a1ee0b9de83e0a5bd5abbaf69a75c1ffca73ffc03f77ef12c33764a895c0c"

set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedSourceIndices : Fin 21 → Fin 591 := ![
  3,
  25,
  26,
  36,
...
def multipliers : Fin 21 → SparsePoly (Fin 62) := ![
  ...
  [{ coefficient := -2, powers := [(23, 1), (53, 1), (59, 1)] }],
  ...
  [{ coefficient := 1, powers := [(39, 1), (56, 1)] }, { coefficient := -1, powers := [(47, 1), (50, 1), (52, 1), (60, 1)] }],
  [{ coefficient := 2, powers := [(19, 1), (23, 1), (50, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (5, 1), (30, 1), (56, 1)] }, { coefficient := -1, powers := [(14, 1), (30, 1), (47, 1), (60, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (51, 1), (53, 1), (59, 1)] }, { coefficient := 1, powers := [(2, 1), (53, 1)] }, { coefficient := 1, powers := [(8, 1), (36, 1)] }],
...
#print axioms Krenn.Component1.SelectedLeafB4_4_7.selectedHasNoCommonZero

end Krenn.Component1.SelectedLeafB4_4_7
