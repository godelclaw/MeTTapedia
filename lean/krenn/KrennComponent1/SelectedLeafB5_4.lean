...
namespace Krenn.Component1.SelectedLeafB5_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "ebe593233bc7415ba180d92056333b7fa93fad87186f8ff885a135c17879716b"
def certificateSHA256 : String := "6468784881795ffe6291916ca921e48b6bc2c862102388672b7742950ee415f9"

set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedSourceIndices : Fin 26 → Fin 588 := ![
  3,
  6,
  25,
  36,
...
def multipliers : Fin 26 → SparsePoly (Fin 60) := ![
  [{ coefficient := -2, powers := [(5, 1), (30, 1), (55, 1)] }, { coefficient := 2, powers := [(8, 1), (23, 1), (55, 1)] }],
  ...
  [{ coefficient := -2, powers := [(8, 1), (33, 1), (44, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (33, 1), (45, 1), (59, 1)] }],
  [{ coefficient := -2, powers := [(20, 1), (30, 1), (47, 1)] }],
  [{ coefficient := -2, powers := [(0, 1), (5, 1), (56, 1)] }, { coefficient := -2, powers := [(5, 1), (24, 1), (56, 1)] }, { coefficient := 2, powers := [(14, 1), (20, 1), (47, 1)] }],
  [{ coefficient := -1, powers := [(23, 1), (53, 1)] }, { coefficient := 2, powers := [(30, 1), (47, 1)] }],
  ...
  [{ coefficient := -2, powers := [(8, 1), (55, 1)] }],
  [{ coefficient := 1, powers := [(50, 1)] }],
  [{ coefficient := 1, powers := [(23, 1)] }],
  [{ coefficient := 2, powers := [(5, 1), (30, 1), (56, 1)] }, { coefficient := 2, powers := [(8, 1), (33, 1), (47, 1)] }],
  ...
  [{ coefficient := 2, powers := [(0, 1), (5, 1), (30, 1), (56, 1)] }, { coefficient := -1, powers := [(0, 1), (5, 1), (33, 1), (40, 1), (53, 1), (59, 1)] }, { coefficient := -2, powers := [(8, 1), (24, 1), (33, 1), (47, 1)] }, { coefficient := -2, powers := [(14, 1), (20, 1), (30, 1), (47, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (2, 1), (53, 1), (57, 1)] }, { coefficient := 1, powers := [(2, 1), (53, 1)] }, { coefficient := 2, powers := [(6, 1), (8, 1), (36, 1), (55, 1)] }, { coefficient := 1, powers := [(8, 1), (36, 1)] }, { coefficient := 1, powers := [(19, 1), (30, 1)] }]
]
...
#print axioms Krenn.Component1.SelectedLeafB5_4.selectedHasNoCommonZero

end Krenn.Component1.SelectedLeafB5_4
