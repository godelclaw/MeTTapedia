...
namespace Krenn.Component1.SelectedLeafB4_4_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "f5bd0a2d59d8c9f4db00fa47201422cb108a1abf5279477eb1ed7835b0d4a07e"
def certificateSHA256 : String := "ecb3452a3e101a06e449672cc37a1f42f206647e68cbfdc9c15b4a694304a333"

set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedSourceIndices : Fin 18 → Fin 591 := ![
  3,
  25,
  36,
  48,
...
def multipliers : Fin 18 → SparsePoly (Fin 60) := ![
  ...
  [{ coefficient := 2, powers := [(0, 1), (5, 1), (30, 1), (56, 1)] }],
...
#print axioms Krenn.Component1.SelectedLeafB4_4_2.selectedHasNoCommonZero

end Krenn.Component1.SelectedLeafB4_4_2
