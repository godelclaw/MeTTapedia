...
namespace Krenn.Component1.SelectedLeafB5_6_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "bc8aa39733b6fc29b4f276bc4b0d57272b13102a6e70d78ef4f63773c017ee11"
def certificateSHA256 : String := "e99433a98f952dc1c191e1cce1bb7c7aea6afde6570b2f0e988bd57cd3d31db7"

set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedSourceIndices : Fin 38 → Fin 591 := ![
  1,
  6,
  25,
  36,
...
def multipliers : Fin 38 → SparsePoly (Fin 62) := ![
  ...
  [{ coefficient := 1, powers := [(2, 1), (5, 1), (25, 1), (33, 1), (58, 1), (59, 1)] }],
  [{ coefficient := -1, powers := [(23, 1), (25, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (30, 1), (33, 1), (44, 1), (58, 1), (59, 1), (60, 1)] }, { coefficient := 1, powers := [(5, 1), (30, 1), (33, 1), (58, 1), (59, 1)] }, { coefficient := -2, powers := [(23, 1), (50, 1), (59, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (6, 1), (39, 1), (54, 1), (56, 1), (61, 1)] }, { coefficient := -1, powers := [(2, 1), (39, 1), (43, 1), (48, 1), (56, 1), (61, 1)] }, { coefficient := 1, powers := [(2, 1), (41, 1), (47, 1), (50, 1), (57, 1), (60, 1), (61, 1)] }],
  ...
  [{ coefficient := -1, powers := [(5, 1), (18, 1), (33, 1), (58, 1), (60, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (19, 1), (33, 1), (58, 1), (60, 1)] }, { coefficient := -1, powers := [(14, 1), (47, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (56, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (5, 1), (33, 1), (58, 1), (59, 1)] }],
  ...
  [{ coefficient := 1, powers := [(2, 1), (5, 1), (33, 1), (53, 1), (58, 1), (59, 1)] }, { coefficient := -1, powers := [(2, 1), (24, 1), (39, 1), (43, 1), (56, 1)] }, { coefficient := 1, powers := [(2, 1), (34, 1), (37, 1), (39, 1), (56, 1)] }],
  ...
  [{ coefficient := 1, powers := [(0, 1), (2, 1), (39, 1), (43, 1), (48, 1), (56, 1)] }, { coefficient := 1, powers := [(2, 1), (24, 1), (39, 1), (43, 1), (48, 1), (56, 1)] }, { coefficient := 1, powers := [(2, 1), (31, 1), (37, 1), (39, 1), (43, 1), (56, 1)] }, { coefficient := -1, powers := [(5, 1), (33, 1), (53, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (8, 1), (33, 1), (36, 1), (58, 1)] }, { coefficient := -1, powers := [(5, 1), (19, 1), (30, 1), (33, 1), (44, 1), (58, 1), (60, 1)] }, { coefficient := 2, powers := [(19, 1), (23, 1), (50, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (5, 1), (33, 1), (53, 1), (58, 1)] }, { coefficient := -1, powers := [(5, 1), (8, 1), (33, 1), (36, 1), (58, 1)] }, { coefficient := -1, powers := [(8, 1), (33, 1), (47, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (53, 1)] }, { coefficient := 1, powers := [(8, 1), (36, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (2, 1), (39, 1), (40, 1), (56, 1)] }, { coefficient := 1, powers := [(2, 1), (3, 1), (31, 1), (39, 1), (56, 1)] }, { coefficient := 1, powers := [(2, 1), (9, 1), (20, 1), (39, 1), (56, 1)] }, { coefficient := -1, powers := [(2, 1), (20, 1), (39, 1), (48, 1), (56, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (2, 1), (5, 1), (33, 1), (40, 1), (53, 1), (58, 1), (59, 1)] }, { coefficient := 1, powers := [(0, 1), (2, 1), (24, 1), (39, 1), (40, 1), (43, 1), (56, 1)] }, { coefficient := -1, powers := [(0, 1), (2, 1), (34, 1), (37, 1), (39, 1), (40, 1), (56, 1)] }, { coefficient := -1, powers := [(2, 1), (3, 1), (5, 1), (31, 1), (33, 1), (53, 1), (58, 1), (59, 1)] }, { coefficient := 1, powers := [(2, 1), (3, 1), (24, 1), (31, 1), (39, 1), (43, 1), (56, 1)] }, { coefficient := -1, powers := [(2, 1), (3, 1), (31, 1), (34, 1), (37, 1), (39, 1), (56, 1)] }, { coefficient := -1, powers := [(2, 1), (5, 1), (9, 1), (20, 1), (33, 1), (53, 1), (58, 1), (59, 1)] }, { coefficient := 1, powers := [(2, 1), (9, 1), (20, 1), (24, 1), (39, 1), (43, 1), (56, 1)] }, { coefficient := -1, powers := [(2, 1), (9, 1), (20, 1), (34, 1), (37, 1), (39, 1), (56, 1)] }, { coefficient := 1, powers := [(14, 1), (20, 1), (23, 1), (53, 1)] }, { coefficient := -1, powers := [(14, 1), (30, 1), (47, 1), (60, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (6, 1), (20, 1), (39, 1), (54, 1), (56, 1)] }, { coefficient := 1, powers := [(2, 1), (20, 1), (39, 1), (43, 1), (48, 1), (56, 1)] }, { coefficient := -1, powers := [(2, 1), (20, 1), (41, 1), (47, 1), (50, 1), (57, 1), (60, 1)] }]
]
...
#print axioms Krenn.Component1.SelectedLeafB5_6_1.selectedHasNoCommonZero

end Krenn.Component1.SelectedLeafB5_6_1
