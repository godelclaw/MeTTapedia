...
namespace Krenn.Component1.SelectedLeafB6_4_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "a9880715407b939113e04204dee228cf770ed4eb88321eda29a846daae56f5cb"
def certificateSHA256 : String := "440f98d9c126b857ff0b246b3f06e50034eb52daf022ccfe167ea07078b83152"
...
def multipliers : Fin 19 → SparsePoly (Fin 63) := ![
  ...
  [{ coefficient := -2, powers := [(23, 1), (53, 1), (60, 1)] }],
  [{ coefficient := -1, powers := [(30, 1), (47, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (5, 1), (56, 1)] }, { coefficient := -1, powers := [(5, 1), (24, 1), (56, 1)] }, { coefficient := 1, powers := [(14, 1), (47, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(47, 1), (52, 1), (61, 1)] }],
  ...
  [{ coefficient := 1, powers := [(39, 1), (56, 1)] }, { coefficient := -1, powers := [(47, 1), (50, 1), (52, 1), (61, 1)] }, { coefficient := 1, powers := [(47, 1), (50, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (5, 1), (30, 1), (56, 1)] }, { coefficient := -1, powers := [(14, 1), (30, 1), (47, 1), (61, 1)] }],
...
#print axioms Krenn.Component1.SelectedLeafB6_4_7.selectedHasNoCommonZero

end Krenn.Component1.SelectedLeafB6_4_7
