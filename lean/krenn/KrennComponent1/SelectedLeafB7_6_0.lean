...
namespace Krenn.Component1.SelectedLeafB7_6_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "fb72045c1b9fe986656d35fb9792dc3c9a680d72d74943536c2c4aea67211270"
def certificateSHA256 : String := "a4bbe51713b09a59816fc17ffebfc34bf2ce4965f4335cc032cf99770f652172"
...
def multipliers : Fin 17 → SparsePoly (Fin 62) := ![
  ...
  [{ coefficient := -1, powers := [(1, 1), (2, 1), (42, 1), (58, 1)] }, { coefficient := 1, powers := [(2, 1), (42, 1)] }, { coefficient := 1, powers := [(5, 1), (33, 1)] }, { coefficient := -1, powers := [(14, 1), (23, 1)] }]
]
...
#print axioms Krenn.Component1.SelectedLeafB7_6_0.selectedHasNoCommonZero

end Krenn.Component1.SelectedLeafB7_6_0
