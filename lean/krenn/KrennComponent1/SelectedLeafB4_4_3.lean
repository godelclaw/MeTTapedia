...
namespace Krenn.Component1.SelectedLeafB4_4_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "e61b57db58b23f76100217edd20c719bb2bbb28f82be8412751c3f89c0062477"
def certificateSHA256 : String := "f6e5399faf5be3404db11b784640c78a75c3e03dc201db331826db0532291cfc"

set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedSourceIndices : Fin 24 → Fin 591 := ![
  3,
  6,
  25,
  36,
...
def multipliers : Fin 24 → SparsePoly (Fin 61) := ![
  ...
  [{ coefficient := 1, powers := [(14, 1), (23, 1), (52, 1), (53, 1), (60, 1)] }],
  [{ coefficient := -1, powers := [(18, 1), (50, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (33, 1), (45, 1), (58, 1)] }],
  [{ coefficient := -1, powers := [(30, 1), (47, 1), (59, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (5, 1), (56, 1)] }, { coefficient := -1, powers := [(5, 1), (24, 1), (56, 1)] }, { coefficient := 1, powers := [(14, 1), (47, 1), (59, 1)] }],
  [{ coefficient := -1, powers := [(23, 1), (53, 1)] }],
  [{ coefficient := 1, powers := [(47, 1), (52, 1), (59, 1)] }],
  [{ coefficient := 1, powers := [(19, 1)] }],
  [{ coefficient := 1, powers := [(14, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (33, 1), (40, 1), (58, 1)] }],
  [{ coefficient := 1, powers := [(50, 1)] }],
  [{ coefficient := 1, powers := [(23, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (30, 1), (56, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := 1, powers := [(39, 1), (56, 1)] }, { coefficient := -1, powers := [(47, 1), (50, 1), (52, 1), (59, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (33, 1), (53, 1)] }, { coefficient := 2, powers := [(19, 1), (23, 1), (50, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (5, 1), (30, 1), (56, 1)] }, { coefficient := -1, powers := [(0, 1), (5, 1), (33, 1), (40, 1), (53, 1), (58, 1)] }, { coefficient := -1, powers := [(14, 1), (30, 1), (47, 1), (59, 1)] }],
...
#print axioms Krenn.Component1.SelectedLeafB4_4_3.selectedHasNoCommonZero

end Krenn.Component1.SelectedLeafB4_4_3
