...
namespace Krenn.Component1.SelectedLeafB6_6_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "5f0d8eb4cc8c6349dc04daa0ac2d78c0f3068aa6d48e04d26f665b7750fab329"
def certificateSHA256 : String := "2453c739939a464fc3158a8fc9edc4bde94ec54b98f071331ebf25cad54c35c6"
...
def multipliers : Fin 19 → SparsePoly (Fin 63) := ![
  ...
  [{ coefficient := 1, powers := [(39, 1), (56, 1)] }, { coefficient := -1, powers := [(41, 1), (47, 1), (50, 1), (60, 1)] }, { coefficient := 1, powers := [(47, 1), (50, 1)] }],
  ...
  [{ coefficient := -1, powers := [(14, 1), (30, 1), (47, 1), (60, 1)] }]
]
...
#print axioms Krenn.Component1.SelectedLeafB6_6_5.selectedHasNoCommonZero

end Krenn.Component1.SelectedLeafB6_6_5
