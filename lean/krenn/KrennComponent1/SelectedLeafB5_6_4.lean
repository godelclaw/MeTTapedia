...
namespace Krenn.Component1.SelectedLeafB5_6_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "ec13f44e8c781ccf5b5b24bcac3cf93df9c4ad24787247a05d7381520ba6169b"
def certificateSHA256 : String := "b6762b24d5bff22d5c84f62c3acd164fbb89fcd405dae4543c9cb5e52105976e"

set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedSourceIndices : Fin 25 → Fin 591 := ![
  1,
  25,
  26,
  34,
...
def multipliers : Fin 25 → SparsePoly (Fin 62) := ![
  ...
  [{ coefficient := -2, powers := [(2, 1), (24, 1), (29, 1), (39, 1), (56, 1), (58, 1), (61, 1)] }],
  [{ coefficient := -2, powers := [(23, 1), (50, 1), (59, 1)] }],
  [{ coefficient := -1, powers := [(18, 1), (50, 1)] }],
  [{ coefficient := 2, powers := [(2, 1), (24, 1), (39, 1), (56, 1), (58, 1)] }],
  ...
  [{ coefficient := -2, powers := [(2, 1), (24, 1), (39, 1), (49, 1), (56, 1)] }],
  [{ coefficient := 2, powers := [(19, 1), (23, 1), (50, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (36, 1)] }],
  [{ coefficient := 2, powers := [(2, 1), (18, 1), (24, 1), (29, 1), (39, 1), (56, 1), (58, 1)] }, { coefficient := 1, powers := [(14, 1), (30, 1), (47, 1)] }],
  [{ coefficient := -2, powers := [(2, 1), (20, 1), (39, 1), (56, 1)] }],
...
#print axioms Krenn.Component1.SelectedLeafB5_6_4.selectedHasNoCommonZero

end Krenn.Component1.SelectedLeafB5_6_4
