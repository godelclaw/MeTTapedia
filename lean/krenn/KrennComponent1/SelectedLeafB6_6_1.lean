...
namespace Krenn.Component1.SelectedLeafB6_6_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "5d6043a75f3ab3d58b5bda3406a3d57f0a02477505b6697394678c0eae5c3c76"
def certificateSHA256 : String := "41607834cb26ac41e75f6c633435ea387a056422800e0660f4dc5dfce6b7f873"
...
def multipliers : Fin 21 → SparsePoly (Fin 62) := ![
  ...
  [{ coefficient := -1, powers := [(0, 1), (5, 1), (33, 1), (40, 1), (53, 1), (59, 1)] }, { coefficient := -1, powers := [(3, 1), (5, 1), (31, 1), (33, 1), (53, 1), (59, 1)] }, { coefficient := -1, powers := [(5, 1), (9, 1), (20, 1), (33, 1), (53, 1), (59, 1)] }, { coefficient := 1, powers := [(14, 1), (20, 1), (23, 1), (53, 1)] }, { coefficient := -1, powers := [(14, 1), (30, 1), (47, 1), (60, 1)] }]
]
...
#print axioms Krenn.Component1.SelectedLeafB6_6_1.selectedHasNoCommonZero

end Krenn.Component1.SelectedLeafB6_6_1
