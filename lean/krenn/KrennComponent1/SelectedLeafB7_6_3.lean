...
namespace Krenn.Component1.SelectedLeafB7_6_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "9a456cd65d84da2efca9ec1e659928a7a518a75a721336f3659860fe870a0da3"
...
def multipliers : Fin 6 → SparsePoly (Fin 64) := ![
  [{ coefficient := 1, powers := [(25, 1), (60, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(60, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(52, 1), (60, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(60, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := 1, powers := [(0, 1), (40, 1), (52, 1), (60, 1)] }, { coefficient := 1, powers := [(3, 1), (31, 1), (52, 1), (60, 1)] }, { coefficient := 1, powers := [(9, 1), (20, 1), (52, 1), (60, 1)] }, { coefficient := 1, powers := [(9, 1), (60, 1)] }]
]
...
#print axioms Krenn.Component1.SelectedLeafB7_6_3.selectedHasNoCommonZero

end Krenn.Component1.SelectedLeafB7_6_3
