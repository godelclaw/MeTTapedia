...
namespace Krenn.Component1.SelectedLeafB4_6_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "ceba4372d8a97033b6ea71bc8fce1d41b233e213bb1b59e992b8c81a1d728502"
...
def multipliers : Fin 6 → SparsePoly (Fin 62) := ![
  [{ coefficient := 1, powers := [(25, 1), (58, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(58, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(52, 1), (58, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(58, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := 1, powers := [(0, 1), (40, 1), (52, 1), (58, 1)] }, { coefficient := 1, powers := [(3, 1), (31, 1), (52, 1), (58, 1)] }, { coefficient := 1, powers := [(9, 1), (20, 1), (52, 1), (58, 1)] }, { coefficient := 1, powers := [(9, 1), (58, 1)] }]
]
...
#print axioms Krenn.Component1.SelectedLeafB4_6_3.selectedHasNoCommonZero

end Krenn.Component1.SelectedLeafB4_6_3
