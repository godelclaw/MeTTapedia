...
namespace Krenn.Component1.SelectedLeafB4_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "833a6e208da062f0830f958f4809e7ccc3335df0064569e651a1781857d8f193"
def certificateSHA256 : String := "4a03fd123a5a99b15fc6d9ad1668d3917188c37d9d06d6ff3bedf6181b3a8e47"
...
def multipliers : Fin 21 → SparsePoly (Fin 60) := ![
  ...
  [{ coefficient := 1, powers := [(5, 1), (25, 1), (33, 1), (45, 1), (57, 1), (59, 1)] }, { coefficient := -1, powers := [(8, 1), (33, 1), (47, 1), (57, 1), (59, 1)] }, { coefficient := -1, powers := [(14, 1), (23, 1), (25, 1), (45, 1), (57, 1), (59, 1)] }],
  ...
  [{ coefficient := -1, powers := [(8, 1), (36, 1), (42, 1)] }, { coefficient := 2, powers := [(19, 1), (23, 1), (50, 1)] }],
...
#print axioms Krenn.Component1.SelectedLeafB4_5.selectedHasNoCommonZero

end Krenn.Component1.SelectedLeafB4_5
