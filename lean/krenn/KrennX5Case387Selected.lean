...
namespace Krenn.X5Case387Selected

open Krenn.SparseCertificate
open MvPolynomial

def sourceSystemFileSHA256 : String := "75a1fd9bfc7788261c9e82e0fa70ce0dc2cd211bda4d411dbf43c714ffaf30ee"
def sourceSystemSemanticSHA256 : String := "f8104aa9eacd683504362db17d4b5a3154f2097f54623b20ed68c7df77ea96bc"
...
def selectedEquations : Fin 18 → SparsePoly (Fin 70) := ![
  ...
  [{ coefficient := 1, powers := [(11, 1), (63, 1)] }, { coefficient := 1, powers := [(21, 1), (36, 1), (69, 1)] }, { coefficient := 1, powers := [(29, 1), (36, 1), (66, 1)] }],
...
#print axioms Krenn.X5Case387Selected.selectedHasNoCommonZero

end Krenn.X5Case387Selected
