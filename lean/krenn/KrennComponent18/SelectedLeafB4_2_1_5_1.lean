...
namespace Krenn.Component18.SelectedLeafB4_2_1_5_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "3b422d22440b499e26eacecae4a13bf2d796501e4b341371e27137c3ec5a05a7"
...
def selectedEquations : Fin 16 → SparsePoly (Fin 67) := ![
  ...
  [{ coefficient := 1, powers := [(60, 1), (66, 1)] }, { coefficient := -1, powers := [] }]
]

set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def multipliers : Fin 16 → SparsePoly (Fin 67) := ![
  [{ coefficient := -1, powers := [(31, 1), (49, 1), (64, 1)] }, { coefficient := -1, powers := [(34, 1), (49, 1), (57, 1), (64, 1), (66, 1)] }, { coefficient := 1, powers := [(37, 1), (40, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (26, 1)] }],
  [{ coefficient := -1, powers := [(17, 1), (49, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (37, 1), (52, 1)] }, { coefficient := 1, powers := [(18, 1), (24, 1), (52, 1)] }],
  [{ coefficient := 1, powers := [(31, 1)] }, { coefficient := 1, powers := [(34, 1), (57, 1), (66, 1)] }],
  ...
  [{ coefficient := 1, powers := [(2, 1), (57, 1)] }, { coefficient := 1, powers := [(8, 1), (37, 1)] }, { coefficient := -1, powers := [(18, 1), (31, 1)] }, { coefficient := -1, powers := [(18, 1), (34, 1), (57, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (19, 1), (37, 1), (54, 1)] }, { coefficient := 1, powers := [(18, 1), (19, 1), (24, 1), (54, 1)] }],
  [{ coefficient := 1, powers := [(13, 1), (31, 1), (49, 1)] }, { coefficient := 1, powers := [(13, 1), (34, 1), (49, 1), (57, 1), (66, 1)] }, { coefficient := -1, powers := [(13, 1), (37, 1), (40, 1)] }],
...
#print axioms Krenn.Component18.SelectedLeafB4_2_1_5_1.selectedHasNoCommonZero

end Krenn.Component18.SelectedLeafB4_2_1_5_1
