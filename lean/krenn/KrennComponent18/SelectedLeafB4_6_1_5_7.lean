...
namespace Krenn.Component18.SelectedLeafB4_6_1_5_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "6d6f41dc1f83fdc2fdda3c96d60a19217e20f695efa88bc94360ad0808a3d2f9"
...
def multipliers : Fin 10 → SparsePoly (Fin 70) := ![
  ...
  [{ coefficient := 1, powers := [(24, 1), (57, 1), (65, 1)] }, { coefficient := -1, powers := [(34, 1), (49, 1), (57, 1), (65, 1), (69, 1)] }, { coefficient := 1, powers := [(37, 1), (40, 1), (65, 1)] }, { coefficient := -1, powers := [(37, 1), (49, 1), (54, 1), (65, 1), (69, 1)] }],
...
#print axioms Krenn.Component18.SelectedLeafB4_6_1_5_7.selectedHasNoCommonZero

end Krenn.Component18.SelectedLeafB4_6_1_5_7
