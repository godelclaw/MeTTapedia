...
namespace Krenn.Component18.SelectedLeafB5_6_2_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "4003529422ae3243edc7c8ca358a7d4c3873ba8aad2c3f266e8e37d12c7c3989"
def certificateSHA256 : String := "9a0e084e74ae617c69b608011bd45aaa487783b23ba6c7b0c17814bd82ca4158"
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedEquations : Fin 58 → SparsePoly (Fin 68) := ![
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def multipliers : Fin 58 → SparsePoly (Fin 68) := ![
  ...
  [{ coefficient := 1, powers := [(20, 1), (30, 1), (45, 1), (54, 1), (61, 1)] }, { coefficient := 1, powers := [(23, 1), (49, 1), (52, 1), (54, 1)] }, { coefficient := 1, powers := [(23, 1), (49, 1), (54, 1), (56, 1)] }, { coefficient := -1, powers := [(23, 1), (49, 1), (54, 1), (61, 1)] }, { coefficient := 1, powers := [(24, 1), (25, 1), (45, 1), (46, 1), (54, 1), (61, 1)] }, { coefficient := 1, powers := [(24, 1), (25, 1), (45, 1), (54, 1), (56, 1), (61, 1)] }, { coefficient := -1, powers := [(24, 1), (25, 1), (47, 1), (52, 1), (54, 1)] }, { coefficient := -1, powers := [(24, 1), (45, 1), (54, 1), (61, 1)] }, { coefficient := 1, powers := [(25, 1), (34, 1), (40, 1), (45, 1), (46, 1), (61, 1)] }, { coefficient := 1, powers := [(25, 1), (34, 1), (40, 1), (45, 1), (56, 1), (61, 1)] }, { coefficient := -1, powers := [(25, 1), (34, 1), (40, 1), (47, 1), (52, 1)] }, { coefficient := 1, powers := [(30, 1), (49, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [(20, 1), (23, 1), (54, 1), (61, 1)] }, { coefficient := 1, powers := [(20, 1), (30, 1), (54, 1)] }, { coefficient := -1, powers := [(24, 1), (25, 1), (42, 1), (54, 1)] }, { coefficient := -1, powers := [(24, 1), (25, 1), (52, 1), (54, 1)] }, { coefficient := -1, powers := [(25, 1), (34, 1), (40, 1), (42, 1)] }, { coefficient := -1, powers := [(25, 1), (34, 1), (40, 1), (52, 1)] }],
...
#print axioms Krenn.Component18.SelectedLeafB5_6_2_5.selectedHasNoCommonZero

end Krenn.Component18.SelectedLeafB5_6_2_5
