...
namespace Krenn.Component18.SelectedLeafB4_2_1_5_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "4feb3207325899ed19496c9a6683278140fdd17f7309abeb37ec17dd9bf5f1cb"
...
def multipliers : Fin 31 → SparsePoly (Fin 68) := ![
  ...
  [{ coefficient := -1, powers := [(39, 1), (58, 1), (59, 1), (66, 1)] }, { coefficient := 1, powers := [(39, 1), (59, 1)] }, { coefficient := 1, powers := [(46, 1), (52, 1)] }],
  ...
  [{ coefficient := -1, powers := [(4, 1), (58, 1), (59, 1), (66, 1)] }, { coefficient := 1, powers := [(4, 1), (59, 1)] }, { coefficient := 1, powers := [(11, 1), (46, 1)] }, { coefficient := -1, powers := [(15, 1), (46, 1)] }],
...
#print axioms Krenn.Component18.SelectedLeafB4_2_1_5_6.selectedHasNoCommonZero

end Krenn.Component18.SelectedLeafB4_2_1_5_6
