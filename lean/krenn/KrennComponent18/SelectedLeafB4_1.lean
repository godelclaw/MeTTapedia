...
namespace Krenn.Component18.SelectedLeafB4_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "0ab468fa9c789960c73ceb827ffe07964137d4ba94f4d8e177fe8dacc8fc461b"
def certificateSHA256 : String := "f64726f4606191415dc0360b002dc2d5da33204ea364c504ac78cc8f53147b5f"
...
def multipliers : Fin 37 → SparsePoly (Fin 63) := ![
  [{ coefficient := -1, powers := [(8, 1), (24, 1), (32, 1), (43, 1), (44, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (26, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (8, 1), (19, 1), (37, 1), (43, 1), (51, 1), (62, 1)] }, { coefficient := -1, powers := [(0, 1), (8, 1), (37, 1), (43, 1), (50, 1), (62, 1)] }, { coefficient := -1, powers := [(3, 1), (8, 1), (32, 1), (37, 1), (43, 1), (62, 1)] }, { coefficient := -1, powers := [(6, 1), (8, 1), (32, 1), (37, 1), (43, 1), (62, 1)] }, { coefficient := -1, powers := [(8, 1), (9, 1), (25, 1), (37, 1), (43, 1), (62, 1)] }, { coefficient := -1, powers := [(8, 1), (19, 1), (37, 1), (43, 1), (50, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(17, 1), (49, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (8, 1), (37, 1), (43, 1), (44, 1), (51, 1), (62, 1)] }, { coefficient := 1, powers := [(3, 1), (8, 1), (37, 1), (43, 1), (58, 1), (62, 1)] }, { coefficient := -1, powers := [(5, 1), (26, 1), (34, 1), (47, 1), (52, 1), (62, 1)] }, { coefficient := 1, powers := [(5, 1), (34, 1), (47, 1), (53, 1), (62, 1)] }, { coefficient := -1, powers := [(6, 1), (8, 1), (32, 1), (34, 1), (43, 1), (44, 1), (49, 1), (52, 1), (62, 2)] }, { coefficient := -1, powers := [(8, 1), (37, 1), (43, 1), (44, 1), (50, 1), (62, 1)] }, { coefficient := 1, powers := [(13, 1), (24, 1), (26, 1), (47, 1), (52, 1), (62, 1)] }, { coefficient := -1, powers := [(13, 1), (24, 1), (47, 1), (53, 1), (62, 1)] }, { coefficient := -2, powers := [(13, 1), (31, 1), (49, 1), (52, 1), (62, 1)] }, { coefficient := 2, powers := [(17, 1), (24, 1), (47, 1), (54, 1), (62, 1)] }, { coefficient := 1, powers := [(17, 1), (31, 1), (43, 1), (47, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (8, 1), (9, 1), (30, 1), (35, 1), (43, 1), (62, 1)] }, { coefficient := 1, powers := [(0, 1), (8, 1), (29, 1), (35, 1), (43, 1), (51, 1), (62, 1)] }, { coefficient := 1, powers := [(8, 1), (9, 1), (23, 1), (35, 1), (43, 1), (62, 1)] }, { coefficient := 1, powers := [(8, 1), (9, 1), (29, 1), (35, 1), (43, 1), (62, 1)] }, { coefficient := 1, powers := [(8, 1), (19, 1), (23, 1), (43, 1), (58, 1), (62, 1)] }, { coefficient := 1, powers := [(8, 1), (19, 1), (29, 1), (43, 1), (58, 1), (62, 1)] }, { coefficient := 1, powers := [(8, 1), (23, 1), (25, 1), (43, 1), (58, 1), (62, 1)] }, { coefficient := 1, powers := [(8, 1), (23, 1), (35, 1), (43, 1), (50, 1), (62, 1)] }, { coefficient := 1, powers := [(8, 1), (25, 1), (29, 1), (43, 1), (58, 1), (62, 1)] }, { coefficient := -1, powers := [(8, 1), (29, 1), (32, 1), (43, 1), (44, 1), (62, 1)] }, { coefficient := 1, powers := [(8, 1), (29, 1), (35, 1), (43, 1), (50, 1), (62, 1)] }, { coefficient := 1, powers := [(13, 1), (31, 1), (48, 1), (62, 1)] }, { coefficient := 1, powers := [(17, 1), (24, 1), (54, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(17, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (45, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (23, 1), (43, 1), (58, 1)] }, { coefficient := -1, powers := [(8, 1), (29, 1), (43, 1), (58, 1)] }],
  [{ coefficient := 1, powers := [(6, 1), (8, 1), (32, 1), (34, 1), (43, 1), (44, 1), (52, 1), (62, 1)] }, { coefficient := 2, powers := [(13, 1), (31, 1), (52, 1)] }],
  [{ coefficient := 1, powers := [(31, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (19, 1), (37, 1), (43, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (35, 1), (43, 1), (45, 1)] }],
  [{ coefficient := 1, powers := [(18, 1)] }],
  [{ coefficient := -1, powers := [(6, 1), (8, 1), (32, 1), (34, 1), (43, 1), (44, 1), (62, 1)] }, { coefficient := -2, powers := [(13, 1), (31, 1)] }],
  ...
  [{ coefficient := 1, powers := [(8, 1), (32, 1), (43, 1), (44, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(13, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (8, 1), (19, 1), (37, 1), (43, 1), (51, 1)] }, { coefficient := 1, powers := [(3, 1), (8, 1), (32, 1), (37, 1), (43, 1)] }, { coefficient := -1, powers := [(8, 1), (9, 1), (19, 1), (37, 1), (43, 1)] }, { coefficient := -1, powers := [(8, 1), (19, 1), (37, 1), (43, 1), (50, 1)] }],
...
#print axioms Krenn.Component18.SelectedLeafB4_1.selectedHasNoCommonZero

end Krenn.Component18.SelectedLeafB4_1
