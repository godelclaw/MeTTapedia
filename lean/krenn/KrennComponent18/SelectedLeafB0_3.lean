...
namespace Krenn.Component18.SelectedLeafB0_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "ea4c1e553c33f66a60d2a9c57d20486b9883a595595235d55113fc522e8d0376"
...
def multipliers : Fin 19 → SparsePoly (Fin 63) := ![
  ...
  [{ coefficient := 1, powers := [(5, 1), (26, 1), (34, 1), (42, 1), (62, 1)] }, { coefficient := 1, powers := [(5, 1), (26, 1), (34, 1), (46, 1), (62, 1)] }, { coefficient := 1, powers := [(5, 1), (26, 1), (34, 1), (52, 1), (62, 1)] }, { coefficient := 2, powers := [(13, 1), (20, 1), (31, 1), (52, 1), (62, 1)] }, { coefficient := -1, powers := [(13, 1), (24, 1), (26, 1), (42, 1), (62, 1)] }, { coefficient := -1, powers := [(13, 1), (24, 1), (26, 1), (46, 1), (62, 1)] }, { coefficient := -1, powers := [(13, 1), (24, 1), (26, 1), (52, 1), (62, 1)] }, { coefficient := 1, powers := [(13, 1), (31, 1), (48, 1), (62, 1)] }],
...
#print axioms Krenn.Component18.SelectedLeafB0_3.selectedHasNoCommonZero

end Krenn.Component18.SelectedLeafB0_3
