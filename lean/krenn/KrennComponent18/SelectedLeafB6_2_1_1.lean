...
namespace Krenn.Component18.SelectedLeafB6_2_1_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "743dc75e22b3e38c4db54904d6b0fd07114560c7ba226188bed8bdebc2648e9e"
def certificateSHA256 : String := "72ef047a0bd6317dc6d4fad950c102b6b19c00d619b56013f16eec57c371e91f"
...
def multipliers : Fin 26 → SparsePoly (Fin 66) := ![
  [{ coefficient := -1, powers := [(24, 1), (26, 1), (57, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (21, 1), (37, 1), (57, 1), (62, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(17, 1), (49, 1), (57, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (37, 1), (57, 1), (62, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(20, 1), (34, 1), (38, 1), (52, 2), (57, 1)] }, { coefficient := -1, powers := [(34, 1), (38, 1), (48, 1), (52, 1), (57, 1)] }],
  [{ coefficient := -1, powers := [(31, 1), (49, 1), (57, 1), (64, 1)] }, { coefficient := 1, powers := [(37, 1), (40, 1), (57, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (26, 1), (34, 1), (46, 1), (52, 1), (57, 1), (64, 1)] }, { coefficient := -1, powers := [(5, 1), (34, 1), (46, 1), (53, 1), (57, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(31, 1), (57, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(18, 1), (57, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (26, 1), (34, 1), (46, 1), (57, 1), (64, 1)] }],
  ...
  [{ coefficient := 1, powers := [(5, 1), (34, 1), (46, 1), (57, 1), (64, 1)] }],
  ...
  [{ coefficient := -1, powers := [(5, 1), (37, 1), (54, 1), (57, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(40, 1), (57, 1), (60, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (57, 2), (64, 1)] }, { coefficient := 1, powers := [(8, 1), (37, 1), (57, 1), (64, 1)] }, { coefficient := -1, powers := [(18, 1), (31, 1), (57, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(13, 1), (19, 1), (31, 1), (49, 1), (57, 1), (64, 1)] }, { coefficient := -1, powers := [(13, 1), (19, 1), (37, 1), (40, 1), (57, 1), (64, 1)] }, { coefficient := -1, powers := [(17, 1), (19, 1), (20, 1), (34, 1), (38, 1), (52, 1), (57, 1)] }, { coefficient := -1, powers := [(17, 1), (19, 1), (34, 1), (38, 1), (48, 1), (57, 1)] }, { coefficient := 1, powers := [(17, 1), (20, 1), (34, 1), (38, 1), (57, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (19, 1), (34, 1), (46, 1), (57, 1)] }, { coefficient := 1, powers := [(5, 1), (34, 1), (57, 1)] }, { coefficient := -1, powers := [] }],
  [{ coefficient := -1, powers := [(3, 1), (5, 1), (34, 1), (57, 1), (59, 1), (61, 1)] }, { coefficient := 1, powers := [(5, 1), (19, 1), (34, 1), (42, 1), (57, 1), (61, 1)] }, { coefficient := 1, powers := [(5, 1), (19, 1), (34, 1), (46, 1), (57, 1), (61, 1)] }, { coefficient := -1, powers := [(5, 1), (26, 1), (34, 1), (45, 1), (46, 1), (52, 1), (57, 1), (64, 1)] }, { coefficient := 1, powers := [(5, 1), (34, 1), (45, 1), (46, 1), (53, 1), (57, 1), (64, 1)] }, { coefficient := -1, powers := [(5, 1), (34, 1), (57, 1), (61, 1)] }, { coefficient := 1, powers := [(17, 1), (20, 1), (34, 1), (38, 1), (52, 2), (57, 1)] }, { coefficient := 1, powers := [(17, 1), (24, 1), (47, 1), (54, 1), (57, 1), (64, 1)] }, { coefficient := 1, powers := [(17, 1), (34, 1), (38, 1), (48, 1), (52, 1), (57, 1)] }, { coefficient := 1, powers := [(18, 1), (24, 1), (42, 1), (54, 1), (57, 1), (64, 1)] }]
]
...
#print axioms Krenn.Component18.SelectedLeafB6_2_1_1.selectedHasNoCommonZero

end Krenn.Component18.SelectedLeafB6_2_1_1
