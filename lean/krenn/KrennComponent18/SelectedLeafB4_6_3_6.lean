...
namespace Krenn.Component18.SelectedLeafB4_6_3_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "2f4fd14f10b8b3016481b2efcf0cb0aa9f642264a9e5ef60e11f2d1068d623f4"
...
def multipliers : Fin 28 → SparsePoly (Fin 68) := ![
  [{ coefficient := 2, powers := [(24, 1), (26, 1), (45, 1), (46, 1), (66, 1)] }, { coefficient := 1, powers := [(24, 1), (46, 1), (57, 1), (64, 1), (66, 1)] }, { coefficient := -1, powers := [(24, 1), (57, 1), (66, 1)] }, { coefficient := -1, powers := [(30, 1), (48, 1), (57, 1), (64, 1), (66, 1)] }],
  ...
  [{ coefficient := -1, powers := [(18, 1), (20, 1), (45, 1), (54, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(20, 1), (54, 1)] }],
  [{ coefficient := 1, powers := [(54, 1)] }],
  [{ coefficient := 1, powers := [(49, 1)] }],
  [{ coefficient := 1, powers := [(24, 1)] }],
  [{ coefficient := 1, powers := [(13, 1)] }],
  [{ coefficient := 1, powers := [(18, 1), (20, 1), (54, 1), (65, 1)] }],
  ...
  [{ coefficient := -2, powers := [(13, 1), (24, 1), (26, 1), (45, 1), (46, 1)] }, { coefficient := -1, powers := [(13, 1), (24, 1), (46, 1), (57, 1), (64, 1)] }, { coefficient := 1, powers := [(13, 1), (24, 1), (57, 1)] }, { coefficient := 1, powers := [(13, 1), (30, 1), (48, 1), (57, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (60, 1)] }, { coefficient := 1, powers := [(13, 1), (45, 1), (48, 1)] }, { coefficient := -1, powers := [(13, 1), (49, 1)] }, { coefficient := 1, powers := [(18, 1), (20, 1), (45, 1), (46, 1), (54, 1), (65, 1)] }, { coefficient := -1, powers := [(18, 1), (20, 1), (47, 1), (54, 1), (65, 1)] }]
]
...
#print axioms Krenn.Component18.SelectedLeafB4_6_3_6.selectedHasNoCommonZero

end Krenn.Component18.SelectedLeafB4_6_3_6
