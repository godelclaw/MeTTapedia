...
namespace Krenn.Component18.SelectedLeafB5_2_6_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "c678ead535177de0f1c3eb8c715b3c9403971c541624e8e34f12a9e277162425"
def certificateSHA256 : String := "3cbc2ee5552e40caf182265f5442426b43f70445f797c29a73459724aaf6b71d"
...
def multipliers : Fin 22 → SparsePoly (Fin 67) := ![
  ...
  [{ coefficient := -1, powers := [(23, 1), (62, 1), (64, 1)] }, { coefficient := -1, powers := [(24, 1), (38, 1), (45, 1), (54, 1), (59, 1), (64, 1)] }, { coefficient := -1, powers := [(29, 1), (62, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (49, 1), (59, 1)] }, { coefficient := -1, powers := [(18, 1), (40, 1), (59, 1)] }],
  [{ coefficient := 1, powers := [(17, 1), (38, 1), (54, 1), (59, 1)] }],
  ...
  [{ coefficient := -1, powers := [(6, 1), (8, 1), (37, 1), (59, 1)] }, { coefficient := -1, powers := [(6, 1), (18, 1), (31, 1), (59, 1)] }, { coefficient := -1, powers := [(8, 1), (29, 1), (45, 1), (59, 1)] }, { coefficient := -1, powers := [(8, 1), (37, 1), (38, 1), (59, 1)] }, { coefficient := -2, powers := [(18, 1), (31, 1), (38, 1), (59, 1)] }],
  [{ coefficient := 1, powers := [(17, 1), (23, 1), (62, 1)] }, { coefficient := 1, powers := [(17, 1), (24, 1), (38, 1), (45, 1), (54, 1), (59, 1)] }, { coefficient := 1, powers := [(17, 1), (29, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (38, 1), (43, 1), (59, 1)] }, { coefficient := -1, powers := [(5, 1), (34, 1), (38, 1), (59, 1)] }, { coefficient := 1, powers := [(6, 1), (13, 1), (24, 1), (59, 1)] }, { coefficient := 1, powers := [(13, 1), (24, 1), (38, 1), (59, 1)] }],
  [{ coefficient := 1, powers := [(3, 1), (13, 1), (37, 1), (40, 1), (59, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (38, 1), (59, 1), (60, 1)] }, { coefficient := -1, powers := [(13, 1), (38, 1), (45, 1), (48, 1), (59, 1)] }]
]
...
#print axioms Krenn.Component18.SelectedLeafB5_2_6_4.selectedHasNoCommonZero

end Krenn.Component18.SelectedLeafB5_2_6_4
