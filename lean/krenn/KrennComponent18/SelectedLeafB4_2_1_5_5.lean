...
namespace Krenn.Component18.SelectedLeafB4_2_1_5_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "a8cbfd671bd5a145f9cfbe203587e4004387373c386a01e5cefdedc71764f15d"
...
def multipliers : Fin 14 → SparsePoly (Fin 68) := ![
  ...
  [{ coefficient := 1, powers := [(24, 1), (57, 1), (64, 1)] }, { coefficient := -1, powers := [(34, 1), (49, 1), (57, 1), (64, 1), (67, 1)] }, { coefficient := 1, powers := [(37, 1), (40, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (37, 1), (52, 1)] }],
  [{ coefficient := 1, powers := [(31, 1)] }, { coefficient := 1, powers := [(34, 1), (57, 1), (67, 1)] }],
  [{ coefficient := 1, powers := [(18, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (37, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := 1, powers := [(40, 1), (60, 1)] }, { coefficient := 1, powers := [(49, 1), (54, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (57, 1)] }, { coefficient := 1, powers := [(8, 1), (37, 1)] }, { coefficient := -1, powers := [(18, 1), (31, 1)] }, { coefficient := -1, powers := [(18, 1), (34, 1), (57, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (19, 1), (37, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (24, 1), (57, 1)] }, { coefficient := 1, powers := [(13, 1), (34, 1), (49, 1), (57, 1), (67, 1)] }, { coefficient := -1, powers := [(13, 1), (37, 1), (40, 1)] }],
...
#print axioms Krenn.Component18.SelectedLeafB4_2_1_5_5.selectedHasNoCommonZero

end Krenn.Component18.SelectedLeafB4_2_1_5_5
