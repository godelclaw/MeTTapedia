...
namespace Krenn.Component18.SelectedLeafB6_2_1_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "4cc6cd98db9211114e5b7251bd88ad24da50075ad49ba6524b410f9d48360583"
...
def multipliers : Fin 28 → SparsePoly (Fin 65) := ![
  ...
  [{ coefficient := -1, powers := [(13, 1), (45, 1), (57, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (57, 2), (64, 1)] }],
  ...
  [{ coefficient := 1, powers := [(2, 1), (57, 2), (64, 1)] }, { coefficient := 1, powers := [(8, 1), (37, 1), (57, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(13, 1), (19, 1), (24, 1), (57, 2), (64, 1)] }, { coefficient := -1, powers := [(17, 1), (19, 1), (20, 1), (34, 1), (38, 1), (52, 1), (57, 1)] }, { coefficient := -1, powers := [(17, 1), (19, 1), (34, 1), (38, 1), (48, 1), (57, 1)] }, { coefficient := 1, powers := [(17, 1), (20, 1), (34, 1), (38, 1), (57, 1)] }],
  ...
  [{ coefficient := 1, powers := [(5, 1), (57, 1), (60, 1), (64, 1)] }, { coefficient := 1, powers := [(13, 1), (45, 1), (48, 1), (57, 1), (64, 1)] }, { coefficient := -1, powers := [(13, 1), (49, 1), (57, 1), (64, 1)] }]
]
...
#print axioms Krenn.Component18.SelectedLeafB6_2_1_0.selectedHasNoCommonZero

end Krenn.Component18.SelectedLeafB6_2_1_0
