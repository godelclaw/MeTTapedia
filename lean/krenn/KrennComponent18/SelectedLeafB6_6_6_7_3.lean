...
namespace Krenn.Component18.SelectedLeafB6_6_6_7_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "afe7add424e487863cd7708a08c826ce384d5b7da04af05a78b270ae07db32e5"
...
def multipliers : Fin 9 → SparsePoly (Fin 72) := ![
  [{ coefficient := -1, powers := [(1, 1), (59, 1), (62, 1), (71, 1)] }],
  [{ coefficient := 1, powers := [(21, 1), (53, 1), (62, 1), (69, 1)] }],
  [{ coefficient := -1, powers := [(11, 1), (53, 1), (62, 1), (69, 1)] }],
  [{ coefficient := -1, powers := [(23, 1), (62, 1), (69, 1)] }],
  [{ coefficient := 1, powers := [(1, 1), (62, 1), (69, 1)] }],
  [{ coefficient := -1, powers := [(1, 1), (31, 1), (62, 1), (69, 1)] }, { coefficient := 1, powers := [(1, 1), (62, 1)] }],
...
#print axioms Krenn.Component18.SelectedLeafB6_6_6_7_3.selectedHasNoCommonZero

end Krenn.Component18.SelectedLeafB6_6_6_7_3
