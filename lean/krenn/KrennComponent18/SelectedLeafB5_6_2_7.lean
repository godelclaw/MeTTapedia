...
namespace Krenn.Component18.SelectedLeafB5_6_2_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "aa096ffedcfb75b67b70d9ba7250cefe8caa9cfb17e58ec013f830695513733e"
def certificateSHA256 : String := "b795b1e5c45595def6b7cc2cd17881ca5f73d6c8ddcb01fe58fae398f9c846c3"
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedEquations : Fin 61 → SparsePoly (Fin 69) := ![
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def multipliers : Fin 61 → SparsePoly (Fin 69) := ![
  ...
  [{ coefficient := -1, powers := [(3, 1), (37, 1), (40, 1), (59, 1), (66, 1)] }, { coefficient := -1, powers := [(31, 1), (49, 1), (66, 1)] }, { coefficient := 1, powers := [(37, 1), (40, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(23, 1), (40, 1), (59, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (26, 1)] }],
  [{ coefficient := 2, powers := [(0, 1), (18, 1), (24, 1), (50, 1)] }, { coefficient := 2, powers := [(6, 1), (18, 1), (24, 1), (32, 1)] }, { coefficient := 2, powers := [(9, 1), (18, 1), (24, 1), (25, 1)] }, { coefficient := 4, powers := [(18, 1), (19, 1), (24, 1), (50, 1)] }, { coefficient := 4, powers := [(18, 1), (24, 1), (25, 1), (41, 1)] }, { coefficient := 2, powers := [(18, 1), (24, 1), (41, 1), (64, 1)] }],
  ...
  [{ coefficient := 1, powers := [(20, 1), (30, 1), (45, 1), (54, 1), (61, 1)] }, { coefficient := 1, powers := [(22, 1), (25, 1), (30, 1), (49, 1), (54, 1), (61, 1), (67, 1)] }, { coefficient := 1, powers := [(23, 1), (49, 1), (52, 1), (54, 1)] }, { coefficient := 1, powers := [(23, 1), (49, 1), (54, 1), (56, 1)] }, { coefficient := -1, powers := [(23, 1), (49, 1), (54, 1), (61, 1)] }, { coefficient := 1, powers := [(24, 1), (25, 1), (45, 1), (46, 1), (54, 1), (61, 1)] }, { coefficient := 1, powers := [(24, 1), (25, 1), (45, 1), (54, 1), (56, 1), (61, 1)] }, { coefficient := -1, powers := [(24, 1), (25, 1), (47, 1), (52, 1), (54, 1)] }, { coefficient := -1, powers := [(24, 1), (45, 1), (54, 1), (61, 1)] }, { coefficient := 1, powers := [(25, 1), (34, 1), (40, 1), (45, 1), (46, 1), (61, 1)] }, { coefficient := 1, powers := [(25, 1), (34, 1), (40, 1), (45, 1), (56, 1), (61, 1)] }, { coefficient := -1, powers := [(25, 1), (34, 1), (40, 1), (47, 1), (52, 1)] }, { coefficient := 1, powers := [(30, 1), (49, 1), (54, 1)] }],
  [{ coefficient := 1, powers := [(20, 1), (22, 1), (25, 1), (30, 1), (54, 1), (61, 1), (67, 1)] }, { coefficient := -1, powers := [(20, 1), (23, 1), (54, 1), (61, 1)] }, { coefficient := 1, powers := [(20, 1), (30, 1), (54, 1)] }, { coefficient := -1, powers := [(24, 1), (25, 1), (42, 1), (54, 1)] }, { coefficient := -1, powers := [(24, 1), (25, 1), (52, 1), (54, 1)] }, { coefficient := -1, powers := [(25, 1), (34, 1), (40, 1), (42, 1)] }, { coefficient := -1, powers := [(25, 1), (34, 1), (40, 1), (52, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (22, 1), (25, 1), (30, 1), (54, 1), (61, 1), (67, 1)] }, { coefficient := 1, powers := [(19, 1), (23, 1), (54, 1), (61, 1)] }, { coefficient := -1, powers := [(19, 1), (30, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [(17, 1), (54, 1)] }],
  [{ coefficient := 1, powers := [(18, 1), (25, 1), (30, 1), (54, 1), (68, 1)] }],
  [{ coefficient := -1, powers := [(18, 1), (24, 1)] }],
  [{ coefficient := 1, powers := [(25, 1), (30, 1), (52, 1), (54, 1), (67, 1)] }, { coefficient := 1, powers := [(25, 1), (30, 1), (54, 1), (56, 1), (67, 1)] }],
  ...
  [{ coefficient := 1, powers := [(2, 1), (52, 1), (54, 1)] }, { coefficient := -1, powers := [(17, 1), (22, 1), (25, 1), (30, 1), (54, 1), (61, 1), (67, 1)] }, { coefficient := 1, powers := [(17, 1), (23, 1), (54, 1), (61, 1)] }],
  ...
  [{ coefficient := 1, powers := [(25, 1), (30, 1), (49, 1), (54, 1), (67, 1)] }],
  ...
  [{ coefficient := 1, powers := [(24, 1), (25, 1), (45, 1), (54, 1)] }, { coefficient := -1, powers := [(25, 1), (27, 1), (30, 1), (49, 1), (54, 1), (67, 1)] }, { coefficient := 1, powers := [(25, 1), (34, 1), (40, 1), (45, 1)] }],
  ...
  [{ coefficient := -2, powers := [(18, 1), (24, 1), (41, 1), (54, 1), (64, 1)] }],
  ...
  [{ coefficient := 2, powers := [(6, 1), (18, 1), (24, 1), (35, 1), (41, 1), (54, 1)] }, { coefficient := 2, powers := [(14, 1), (18, 1), (24, 1), (25, 1), (41, 1), (54, 1)] }],
  ...
  [{ coefficient := 2, powers := [(0, 1), (18, 1), (24, 1), (41, 1), (42, 1), (54, 1), (64, 1)] }, { coefficient := -2, powers := [(0, 1), (18, 1), (24, 1), (41, 1), (54, 1)] }, { coefficient := -2, powers := [(2, 1), (18, 1), (19, 1), (24, 1), (41, 1), (54, 1), (62, 1)] }, { coefficient := -2, powers := [(3, 1), (18, 1), (24, 1), (32, 1), (54, 1)] }, { coefficient := 2, powers := [(6, 1), (17, 1), (18, 1), (23, 1), (24, 1), (32, 1), (54, 1), (62, 1)] }, { coefficient := -2, powers := [(9, 1), (17, 1), (18, 1), (23, 1), (24, 1), (25, 1), (54, 1), (62, 1)] }, { coefficient := 2, powers := [(9, 1), (18, 1), (19, 1), (24, 1), (54, 1)] }, { coefficient := -2, powers := [(12, 1), (18, 1), (19, 1), (23, 1), (24, 1), (54, 1), (62, 1)] }, { coefficient := 2, powers := [(17, 1), (18, 1), (19, 1), (23, 1), (24, 1), (50, 1), (54, 1), (62, 1)] }, { coefficient := 2, powers := [(18, 1), (24, 1), (41, 1), (54, 1), (64, 1)] }],
...
#print axioms Krenn.Component18.SelectedLeafB5_6_2_7.selectedHasNoCommonZero

end Krenn.Component18.SelectedLeafB5_6_2_7
