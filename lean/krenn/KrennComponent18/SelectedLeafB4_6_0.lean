...
namespace Krenn.Component18.SelectedLeafB4_6_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "2ad648638d593ba9734a80b35c7a35ce6ee958ea96f0dee4c18fbc3c99aecaa6"
def certificateSHA256 : String := "9e7ffe1cae9d37c78fb353ff755df79fcb6daf5182337fc91c6bc178ea8a7fe6"
...
def multipliers : Fin 18 → SparsePoly (Fin 64) := ![
  ...
  [{ coefficient := -1, powers := [(5, 1), (19, 1), (37, 1), (54, 1)] }, { coefficient := -1, powers := [(8, 1), (19, 1), (24, 1), (60, 1)] }, { coefficient := 1, powers := [(13, 1), (19, 1), (31, 1), (49, 1)] }, { coefficient := -1, powers := [(13, 1), (19, 1), (37, 1), (40, 1)] }],
...
#print axioms Krenn.Component18.SelectedLeafB4_6_0.selectedHasNoCommonZero

end Krenn.Component18.SelectedLeafB4_6_0
