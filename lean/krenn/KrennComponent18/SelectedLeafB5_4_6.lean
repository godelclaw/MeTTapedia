...
namespace Krenn.Component18.SelectedLeafB5_4_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "494bb6af0a03c3007542fbda2ebe8a30db677660518aa442fe17c90e66c83303"
def certificateSHA256 : String := "9f9ba5e851ec205be9daf776de301608be2f8c46a04666520992f9c6c4f11723"
...
def multipliers : Fin 23 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := 1, powers := [(6, 1), (25, 1), (34, 1), (40, 1), (47, 1), (59, 1), (64, 1)] }, { coefficient := -1, powers := [(23, 1), (40, 1), (60, 1), (64, 1)] }, { coefficient := 2, powers := [(24, 1), (25, 1), (47, 1), (54, 1), (64, 1)] }, { coefficient := 1, powers := [(24, 1), (45, 1), (54, 1), (64, 1)] }, { coefficient := -1, powers := [(29, 1), (40, 1), (60, 1), (64, 1)] }],
  ...
  [{ coefficient := -1, powers := [(2, 1), (49, 1), (54, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := 1, powers := [(0, 1), (2, 1), (49, 1), (54, 1), (55, 1), (64, 1)] }, { coefficient := 1, powers := [(2, 1), (6, 1), (35, 1), (49, 1), (54, 1), (64, 1)] }, { coefficient := 1, powers := [(2, 1), (14, 1), (25, 1), (49, 1), (54, 1), (64, 1)] }, { coefficient := 1, powers := [(6, 1), (18, 1), (25, 1), (34, 1), (40, 1), (59, 1)] }, { coefficient := 2, powers := [(18, 1), (24, 1), (25, 1), (54, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (37, 1)] }, { coefficient := -1, powers := [(18, 1), (31, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (49, 1), (54, 1)] }, { coefficient := 1, powers := [(3, 1), (13, 1), (37, 1), (40, 1), (59, 1)] }, { coefficient := -1, powers := [(6, 1), (17, 1), (25, 1), (34, 1), (40, 1), (47, 1), (59, 1)] }, { coefficient := 1, powers := [(13, 1), (31, 1), (49, 1)] }, { coefficient := -1, powers := [(13, 1), (37, 1), (40, 1)] }, { coefficient := 1, powers := [(17, 1), (23, 1), (40, 1), (60, 1)] }, { coefficient := -2, powers := [(17, 1), (24, 1), (25, 1), (47, 1), (54, 1)] }, { coefficient := -1, powers := [(17, 1), (24, 1), (45, 1), (54, 1)] }, { coefficient := 1, powers := [(17, 1), (29, 1), (40, 1), (60, 1)] }],
...
#print axioms Krenn.Component18.SelectedLeafB5_4_6.selectedHasNoCommonZero

end Krenn.Component18.SelectedLeafB5_4_6
