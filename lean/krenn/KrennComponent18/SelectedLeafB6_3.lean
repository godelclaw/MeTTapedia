...
namespace Krenn.Component18.SelectedLeafB6_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "15ecbf90c97e373ac14d9e3b2023f4c0b4116246514c26698a901aa5f6260ed6"
...
def multipliers : Fin 37 → SparsePoly (Fin 65) := ![
  ...
  [{ coefficient := 1, powers := [(13, 1), (21, 1), (24, 1), (57, 1), (62, 1), (64, 1)] }, { coefficient := 1, powers := [(13, 1), (24, 1), (33, 1), (38, 1), (57, 1), (62, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (21, 1), (34, 1), (49, 1), (62, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(17, 1), (49, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (13, 1), (24, 1), (52, 1), (57, 1), (61, 1), (64, 1)] }, { coefficient := 1, powers := [(1, 1), (13, 1), (34, 1), (40, 1), (49, 1), (52, 1), (62, 1), (64, 2)] }, { coefficient := 1, powers := [(1, 1), (18, 1), (34, 1), (40, 1), (43, 1), (52, 1), (62, 1), (64, 2)] }, { coefficient := 1, powers := [(13, 1), (19, 1), (24, 1), (42, 1), (57, 1), (61, 1), (64, 1)] }, { coefficient := 1, powers := [(13, 1), (19, 1), (24, 1), (46, 1), (57, 1), (61, 1), (64, 1)] }, { coefficient := 1, powers := [(13, 1), (19, 1), (24, 1), (52, 1), (57, 1), (61, 1), (64, 1)] }, { coefficient := 1, powers := [(13, 1), (19, 1), (24, 1), (56, 1), (57, 1), (61, 1), (64, 1)] }, { coefficient := -2, powers := [(13, 1), (31, 1), (49, 1), (52, 1), (64, 1)] }, { coefficient := -2, powers := [(18, 1), (24, 1), (52, 1), (54, 1), (64, 1)] }, { coefficient := 1, powers := [(18, 1), (31, 1), (43, 1), (52, 2), (63, 1), (64, 1)] }, { coefficient := -1, powers := [(18, 1), (31, 1), (43, 1), (52, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(17, 1), (43, 1), (57, 1), (63, 1), (64, 1)] }, { coefficient := -1, powers := [(18, 1), (43, 1), (53, 1), (63, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(1, 1), (5, 1), (34, 1), (48, 1), (54, 1), (62, 1), (64, 2)] }, { coefficient := 1, powers := [(13, 1), (31, 1), (48, 1), (64, 1)] }, { coefficient := 1, powers := [(17, 1), (24, 1), (54, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (34, 1), (53, 1), (62, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (34, 1), (49, 1), (62, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(11, 1), (24, 1), (57, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(19, 1), (24, 1), (57, 1)] }],
  [{ coefficient := -1, powers := [(17, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (45, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (34, 1), (48, 1), (62, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (57, 1)] }],
  [{ coefficient := -1, powers := [(1, 1), (13, 1), (34, 1), (40, 1), (52, 1), (62, 1), (64, 1)] }, { coefficient := 2, powers := [(13, 1), (31, 1), (52, 1)] }],
  [{ coefficient := -1, powers := [(1, 1), (34, 1), (40, 1), (62, 1), (64, 1)] }, { coefficient := 1, powers := [(31, 1)] }],
  [{ coefficient := -1, powers := [(1, 1), (25, 1), (34, 1), (40, 1), (43, 1), (62, 1), (64, 1)] }, { coefficient := 2, powers := [(24, 1), (25, 1), (54, 1)] }, { coefficient := -1, powers := [(25, 1), (31, 1), (43, 1), (52, 1), (63, 1)] }, { coefficient := 1, powers := [(25, 1), (31, 1), (43, 1)] }, { coefficient := -1, powers := [(31, 1), (43, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(18, 1)] }],
  [{ coefficient := 1, powers := [(1, 1), (13, 1), (34, 1), (40, 1), (62, 1), (64, 1)] }, { coefficient := -2, powers := [(13, 1), (31, 1)] }],
  [{ coefficient := 1, powers := [(1, 1), (34, 1), (40, 1), (43, 1), (62, 1), (64, 1)] }, { coefficient := -2, powers := [(24, 1), (54, 1)] }, { coefficient := 1, powers := [(31, 1), (43, 1), (52, 1), (63, 1)] }, { coefficient := -1, powers := [(31, 1), (43, 1)] }],
  ...
  [{ coefficient := -1, powers := [(5, 1), (34, 1), (43, 1), (57, 1), (64, 1)] }, { coefficient := 1, powers := [(13, 1), (24, 1), (38, 1), (57, 1), (59, 1)] }, { coefficient := 1, powers := [(13, 1), (24, 1), (57, 1)] }],
  [{ coefficient := 1, powers := [(40, 1), (60, 1)] }, { coefficient := -1, powers := [(42, 1), (43, 1), (57, 1), (63, 1)] }, { coefficient := -1, powers := [(43, 1), (47, 1), (53, 1), (63, 1)] }, { coefficient := 1, powers := [(43, 1), (57, 1)] }, { coefficient := -1, powers := [(49, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (37, 1), (43, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (13, 1), (24, 1), (25, 1), (52, 1), (57, 1), (61, 1)] }, { coefficient := -1, powers := [(1, 1), (5, 1), (34, 1), (45, 1), (48, 1), (54, 1), (62, 1), (64, 1)] }, { coefficient := -1, powers := [(1, 1), (13, 1), (25, 1), (34, 1), (40, 1), (49, 1), (52, 1), (62, 1), (64, 1)] }, { coefficient := -1, powers := [(1, 1), (18, 1), (25, 1), (34, 1), (40, 1), (43, 1), (52, 1), (62, 1), (64, 1)] }, { coefficient := -1, powers := [(5, 1), (34, 1), (57, 1)] }, { coefficient := -1, powers := [(13, 1), (15, 1), (21, 1), (24, 1), (57, 1), (62, 1)] }, { coefficient := -1, powers := [(13, 1), (15, 1), (24, 1), (33, 1), (38, 1), (57, 1), (62, 1)] }, { coefficient := -1, powers := [(13, 1), (19, 1), (24, 1), (25, 1), (42, 1), (57, 1), (61, 1)] }, { coefficient := -1, powers := [(13, 1), (19, 1), (24, 1), (25, 1), (46, 1), (57, 1), (61, 1)] }, { coefficient := -1, powers := [(13, 1), (19, 1), (24, 1), (25, 1), (52, 1), (57, 1), (61, 1)] }, { coefficient := -1, powers := [(13, 1), (19, 1), (24, 1), (25, 1), (56, 1), (57, 1), (61, 1)] }, { coefficient := 2, powers := [(13, 1), (25, 1), (31, 1), (49, 1), (52, 1)] }, { coefficient := -1, powers := [(13, 1), (31, 1), (45, 1), (48, 1)] }, { coefficient := -1, powers := [(17, 1), (24, 1), (45, 1), (54, 1)] }, { coefficient := 1, powers := [(17, 1), (30, 1), (43, 1), (57, 1), (63, 1)] }, { coefficient := 2, powers := [(18, 1), (24, 1), (25, 1), (52, 1), (54, 1)] }, { coefficient := -1, powers := [(18, 1), (25, 1), (31, 1), (43, 1), (52, 2), (63, 1)] }, { coefficient := 1, powers := [(18, 1), (25, 1), (31, 1), (43, 1), (52, 1)] }, { coefficient := 1, powers := [(18, 1), (30, 1), (43, 1), (53, 1), (63, 1)] }]
]
...
#print axioms Krenn.Component18.SelectedLeafB6_3.selectedHasNoCommonZero

end Krenn.Component18.SelectedLeafB6_3
