...
namespace Krenn.Component18.SelectedLeafB5_2_3_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "f6e25b291717de4f313dea9735d629ee3aa3c8e6232229fa5c6b3982f7395fe7"
...
def multipliers : Fin 30 → SparsePoly (Fin 67) := ![
  ...
  [{ coefficient := 1, powers := [(2, 1), (19, 1), (20, 1), (52, 1), (54, 1), (61, 2)] }, { coefficient := -2, powers := [(13, 1), (24, 1), (26, 1), (52, 2), (57, 1), (65, 1)] }, { coefficient := 2, powers := [(13, 1), (24, 1), (52, 1), (53, 1), (57, 1), (65, 1)] }],
  ...
  [{ coefficient := -1, powers := [(2, 1), (19, 1), (20, 1), (54, 1), (61, 2)] }, { coefficient := 2, powers := [(13, 1), (24, 1), (26, 1), (52, 1), (57, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(24, 1), (45, 1), (54, 1)] }],
  [{ coefficient := -2, powers := [(24, 1), (54, 1)] }],
  [{ coefficient := 1, powers := [(54, 1)] }],
  [{ coefficient := 1, powers := [(49, 1)] }],
  [{ coefficient := 1, powers := [(24, 1)] }],
  [{ coefficient := -2, powers := [(13, 1), (24, 1), (52, 1), (57, 1), (65, 1)] }],
  ...
  [{ coefficient := -1, powers := [(0, 1), (2, 1), (57, 1), (61, 1)] }, { coefficient := -1, powers := [(2, 1), (26, 1), (45, 1), (61, 1)] }, { coefficient := -1, powers := [(2, 1), (56, 1), (57, 1), (64, 1)] }, { coefficient := 1, powers := [(2, 1), (57, 1)] }, { coefficient := 1, powers := [(8, 1), (37, 1)] }, { coefficient := -1, powers := [(17, 1), (30, 1), (57, 1), (64, 1)] }],
...
#print axioms Krenn.Component18.SelectedLeafB5_2_3_2.selectedHasNoCommonZero

end Krenn.Component18.SelectedLeafB5_2_3_2
