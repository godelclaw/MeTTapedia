...
namespace Krenn.Component18.SelectedLeafB4_0_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "631201dc237d86ec3a536675a75fd26c09c6684719c41c3617dc5dc8438ab7f6"
def certificateSHA256 : String := "c8886220311ecf0fcf1f279002e512a3a0341f7e412a441f0a15e3730d663583"
...
def multipliers : Fin 17 → SparsePoly (Fin 64) := ![
  ...
  [{ coefficient := -1, powers := [(31, 1), (49, 1), (62, 1)] }, { coefficient := 1, powers := [(37, 1), (40, 1), (62, 1)] }],
...
#print axioms Krenn.Component18.SelectedLeafB4_0_6.selectedHasNoCommonZero

end Krenn.Component18.SelectedLeafB4_0_6
