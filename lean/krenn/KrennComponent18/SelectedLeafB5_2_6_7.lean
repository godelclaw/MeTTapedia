...
namespace Krenn.Component18.SelectedLeafB5_2_6_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "1b290c6832dc1c82344b327e38db2b6b7f983aa08a6150e2415c191a07e89541"
def certificateSHA256 : String := "230a62b97f2bf27d2d103711698b784ed1349991a193fe5df398188082711bad"
...
def multipliers : Fin 20 → SparsePoly (Fin 69) := ![
  [{ coefficient := -1, powers := [(3, 1), (37, 1), (40, 1), (59, 1), (66, 1)] }, { coefficient := -1, powers := [(37, 1), (38, 1), (40, 1), (59, 1), (66, 1)] }],
  ...
  [{ coefficient := -1, powers := [(6, 1), (8, 1), (37, 1), (59, 1)] }, { coefficient := -1, powers := [(6, 1), (18, 1), (31, 1), (59, 1)] }, { coefficient := -1, powers := [(8, 1), (29, 1), (45, 1), (59, 1)] }, { coefficient := -1, powers := [(8, 1), (37, 1), (38, 1), (59, 1)] }, { coefficient := -1, powers := [(18, 1), (31, 1), (38, 1), (59, 1)] }],
  ...
  [{ coefficient := -1, powers := [(2, 1), (38, 1), (43, 1), (59, 1)] }, { coefficient := -1, powers := [(5, 1), (34, 1), (38, 1), (59, 1)] }, { coefficient := 1, powers := [(6, 1), (13, 1), (24, 1), (59, 1)] }],
  [{ coefficient := 1, powers := [(3, 1), (13, 1), (37, 1), (40, 1), (59, 1)] }, { coefficient := 1, powers := [(13, 1), (37, 1), (38, 1), (40, 1), (59, 1)] }]
]
...
#print axioms Krenn.Component18.SelectedLeafB5_2_6_7.selectedHasNoCommonZero

end Krenn.Component18.SelectedLeafB5_2_6_7
