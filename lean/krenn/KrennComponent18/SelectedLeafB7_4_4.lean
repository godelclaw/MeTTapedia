...
namespace Krenn.Component18.SelectedLeafB7_4_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "93356de43096e63c2991b50d237f8ecadf257f518f1a7cc093efc9c4c4c823ea"
def certificateSHA256 : String := "4da8e2498cd33847e4bd23bfbbf9436372525a96ba7e54cd7cf3069fb4beeb95"
...
def multipliers : Fin 24 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := 1, powers := [(2, 1), (21, 1), (49, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(6, 1), (25, 1), (34, 1), (40, 1), (47, 1), (59, 1), (65, 1)] }, { coefficient := -1, powers := [(23, 1), (40, 1), (60, 1), (65, 1)] }, { coefficient := 2, powers := [(24, 1), (25, 1), (47, 1), (54, 1), (65, 1)] }, { coefficient := 1, powers := [(24, 1), (45, 1), (54, 1), (65, 1)] }, { coefficient := -1, powers := [(29, 1), (40, 1), (60, 1), (65, 1)] }],
  ...
  [{ coefficient := 1, powers := [(6, 1), (18, 1), (25, 1), (34, 1), (40, 1), (59, 1)] }, { coefficient := 2, powers := [(18, 1), (24, 1), (25, 1), (54, 1)] }],
...
#print axioms Krenn.Component18.SelectedLeafB7_4_4.selectedHasNoCommonZero

end Krenn.Component18.SelectedLeafB7_4_4
