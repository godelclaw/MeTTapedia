...
namespace Krenn.Component18.SelectedLeafB3_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "1eb9b67f3bb70b91e04b5bdcd2cdc8903ef09f28b8c388f6e1b06331f8287aa1"
def certificateSHA256 : String := "155fa1d6ab642a86a3ae31e7dd21b990c3574ab2086f81d533f4306624918f53"
...
def multipliers : Fin 37 → SparsePoly (Fin 64) := ![
  [{ coefficient := 2, powers := [(20, 1), (31, 1), (52, 1)] }, { coefficient := 1, powers := [(24, 1), (25, 1), (52, 1), (53, 1)] }, { coefficient := -1, powers := [(24, 1), (26, 1), (52, 1)] }, { coefficient := 1, powers := [(31, 1), (48, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (26, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (21, 1), (49, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(17, 1), (49, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (49, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (30, 1), (34, 1), (42, 1), (57, 1), (62, 1), (63, 1)] }, { coefficient := -1, powers := [(5, 1), (30, 1), (34, 1), (46, 1), (57, 1), (62, 1), (63, 1)] }, { coefficient := -1, powers := [(13, 1), (24, 1), (30, 1), (42, 1), (57, 1), (62, 1), (63, 1)] }, { coefficient := -1, powers := [(13, 1), (24, 1), (30, 1), (46, 1), (57, 1), (62, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (45, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (37, 1)] }, { coefficient := -1, powers := [(18, 1), (24, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (16, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (24, 1), (52, 1), (53, 1)] }],
  [{ coefficient := 1, powers := [(31, 1)] }],
  [{ coefficient := 1, powers := [(13, 1), (57, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(18, 1)] }],
  [{ coefficient := 1, powers := [(13, 1), (24, 1), (53, 1)] }],
  [{ coefficient := -2, powers := [(13, 1), (31, 1)] }],
  [{ coefficient := 2, powers := [(5, 1), (30, 1), (34, 1), (57, 1), (62, 1), (63, 1)] }, { coefficient := 1, powers := [(13, 1), (24, 1), (30, 1), (57, 1), (62, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (34, 1), (57, 1), (62, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (34, 1), (57, 1), (62, 1), (63, 1)] }, { coefficient := -1, powers := [(13, 1), (24, 1), (57, 1), (62, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(49, 1)] }],
  [{ coefficient := 1, powers := [(24, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (17, 1), (19, 1), (34, 1), (57, 1), (62, 1), (63, 1)] }, { coefficient := 1, powers := [(13, 1), (17, 1), (19, 1), (24, 1), (57, 1), (62, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(13, 1), (24, 1), (26, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (17, 1), (34, 1), (57, 1), (62, 1), (63, 1)] }, { coefficient := 1, powers := [(13, 1), (17, 1), (24, 1), (57, 1), (62, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (17, 1), (34, 1), (57, 1), (62, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(13, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (17, 1), (30, 1), (34, 1), (57, 1), (62, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (17, 1), (30, 1), (34, 1), (57, 1), (62, 1), (63, 1)] }, { coefficient := -1, powers := [(13, 1), (17, 1), (24, 1), (30, 1), (57, 1), (62, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(57, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (24, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (34, 1), (57, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := 1, powers := [(5, 1), (17, 1), (30, 1), (34, 1), (46, 1), (57, 1), (62, 1), (63, 1)] }, { coefficient := 1, powers := [(5, 1), (17, 1), (30, 1), (34, 1), (52, 1), (57, 1), (62, 1), (63, 1)] }, { coefficient := -1, powers := [(5, 1), (34, 1), (39, 1), (57, 1), (59, 1), (63, 1)] }, { coefficient := -1, powers := [(5, 1), (34, 1), (42, 1), (56, 1), (57, 1), (63, 1)] }, { coefficient := -1, powers := [(5, 1), (34, 1), (46, 1), (52, 1), (57, 1), (63, 1)] }, { coefficient := -1, powers := [(5, 1), (37, 1), (46, 1), (54, 1)] }, { coefficient := 1, powers := [(13, 1), (17, 1), (24, 1), (30, 1), (52, 1), (57, 1), (62, 1), (63, 1)] }, { coefficient := -1, powers := [(13, 1), (24, 1), (26, 1), (47, 1), (52, 1)] }, { coefficient := 1, powers := [(13, 1), (24, 1), (42, 1), (57, 1)] }, { coefficient := 1, powers := [(13, 1), (24, 1), (47, 1), (53, 1)] }, { coefficient := 2, powers := [(13, 1), (31, 1), (49, 1), (52, 1)] }, { coefficient := 1, powers := [(18, 1), (24, 1), (46, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (40, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (34, 1), (46, 1), (57, 1), (63, 1)] }, { coefficient := 1, powers := [(5, 1), (34, 1), (52, 1), (57, 1), (63, 1)] }, { coefficient := 1, powers := [(13, 1), (24, 1), (52, 1), (57, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (34, 1), (57, 1)] }],
  [{ coefficient := -1, powers := [(1, 1), (2, 1), (57, 1), (61, 1)] }, { coefficient := 1, powers := [(2, 1), (56, 1), (57, 1), (63, 1)] }, { coefficient := 1, powers := [(2, 1), (57, 1)] }, { coefficient := 1, powers := [(8, 1), (37, 1)] }, { coefficient := 1, powers := [(17, 1), (30, 1), (57, 1), (63, 1)] }, { coefficient := -1, powers := [(18, 1), (31, 1)] }]
]
...
#print axioms Krenn.Component18.SelectedLeafB3_2.selectedHasNoCommonZero

end Krenn.Component18.SelectedLeafB3_2
