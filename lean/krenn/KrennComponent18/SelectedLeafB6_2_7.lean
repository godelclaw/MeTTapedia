...
namespace Krenn.Component18.SelectedLeafB6_2_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "081d5973107c48ddeb7a2df913a045f4b080649e4789906ea4a0e8ac0ac99ab9"
def certificateSHA256 : String := "41d9e77b35c658bc3a2a72292eb6bdcf6ec0271e734c98bd099aad8b0ea4a29f"

set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedSourceIndices : Fin 18 → Fin 667 := ![
  10,
  11,
  15,
  17,
...
def multipliers : Fin 18 → SparsePoly (Fin 67) := ![
  ...
  [{ coefficient := -1, powers := [(5, 1), (34, 1), (57, 1)] }, { coefficient := 1, powers := [(13, 1), (31, 1), (49, 1)] }, { coefficient := -1, powers := [(13, 1), (37, 1), (40, 1)] }, { coefficient := -1, powers := [(17, 1), (24, 1), (45, 1), (54, 1)] }]
]
...
#print axioms Krenn.Component18.SelectedLeafB6_2_7.selectedHasNoCommonZero

end Krenn.Component18.SelectedLeafB6_2_7
