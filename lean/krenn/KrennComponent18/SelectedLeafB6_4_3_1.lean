...
namespace Krenn.Component18.SelectedLeafB6_4_3_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "3d41a5eda4a4ec4a3dda686c61992ebac1b7186404a671acc01f024741c56788"
...
def multipliers : Fin 6 → SparsePoly (Fin 67) := ![
  [{ coefficient := 1, powers := [(26, 1), (52, 1), (65, 1)] }, { coefficient := -1, powers := [(53, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(26, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(65, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (57, 1), (65, 1)] }, { coefficient := -1, powers := [(25, 1), (26, 1), (45, 1), (52, 1), (65, 1)] }, { coefficient := 1, powers := [(25, 1), (45, 1), (53, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := -1, powers := [(26, 1), (47, 1), (52, 1), (65, 1)] }, { coefficient := 1, powers := [(47, 1), (53, 1), (65, 1)] }]
]
...
#print axioms Krenn.Component18.SelectedLeafB6_4_3_1.selectedHasNoCommonZero

end Krenn.Component18.SelectedLeafB6_4_3_1
