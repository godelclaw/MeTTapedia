...
namespace Krenn.Component18.SelectedLeafB5_2_6_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "93e35307d729ffcb99a56c5c9435343a7f0a9f4efeed2dc30fe714dda5464fb8"
def certificateSHA256 : String := "f12632427d227a0dc82e8dde1f97deeaaf5d7b3280422d5fd3e2c86a369efd95"
...
def multipliers : Fin 23 → SparsePoly (Fin 67) := ![
  ...
  [{ coefficient := 1, powers := [(0, 1), (13, 1), (61, 1)] }],
  ...
  [{ coefficient := 1, powers := [(0, 1), (8, 1), (37, 1), (61, 1)] }, { coefficient := -1, powers := [(2, 1), (26, 1), (45, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (17, 1), (24, 1), (45, 1), (54, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (5, 1), (34, 1), (61, 1)] }, { coefficient := -1, powers := [(0, 1), (13, 1), (24, 1), (61, 1)] }],
  ...
  [{ coefficient := 1, powers := [(0, 1), (5, 1), (60, 1), (61, 1)] }, { coefficient := 1, powers := [(0, 1), (13, 1), (45, 1), (48, 1), (61, 1)] }, { coefficient := -1, powers := [(0, 1), (13, 1), (49, 1), (61, 1)] }]
]
...
#print axioms Krenn.Component18.SelectedLeafB5_2_6_2.selectedHasNoCommonZero

end Krenn.Component18.SelectedLeafB5_2_6_2
