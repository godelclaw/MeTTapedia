...
namespace Krenn.Component18.SelectedLeafB5_6_3_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "0e7cef75b9942b94e98fdd842471569d94f810b1ed12d90207aa1727bf86b960"
def certificateSHA256 : String := "8a48a101e36168ada16d7e35fbe988c00b496b96fe6797b649516f507a29991a"
...
def multipliers : Fin 30 → SparsePoly (Fin 67) := ![
  ...
  [{ coefficient := 1, powers := [(2, 1), (19, 1), (20, 1), (52, 1), (54, 1), (61, 2)] }, { coefficient := -2, powers := [(13, 1), (24, 1), (26, 1), (52, 2), (57, 1), (66, 1)] }, { coefficient := 2, powers := [(13, 1), (24, 1), (52, 1), (53, 1), (57, 1), (66, 1)] }],
  ...
  [{ coefficient := -1, powers := [(2, 1), (19, 1), (20, 1), (54, 1), (61, 2)] }, { coefficient := 2, powers := [(13, 1), (24, 1), (26, 1), (52, 1), (57, 1), (66, 1)] }],
...
#print axioms Krenn.Component18.SelectedLeafB5_6_3_0.selectedHasNoCommonZero

end Krenn.Component18.SelectedLeafB5_6_3_0
