...
namespace Krenn.Component18.SelectedLeafB6_0_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "87567079de05aefcf06583799fd730b82bc22868e1de0fcfbe47b8f6a0a51c22"
def certificateSHA256 : String := "70a21f68f9ef7f3a154ff4a9fd0d43b03e7f590e69fb3a37b650e55809506791"
...
def multipliers : Fin 21 → SparsePoly (Fin 63) := ![
  ...
  [{ coefficient := 1, powers := [(24, 1), (26, 1), (45, 1)] }],
  ...
  [{ coefficient := -1, powers := [(24, 1), (45, 1)] }],
  ...
  [{ coefficient := 2, powers := [(18, 1), (19, 1), (24, 1), (54, 1)] }, { coefficient := 2, powers := [(18, 1), (24, 1), (25, 1), (54, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (37, 1)] }, { coefficient := -1, powers := [(18, 1), (31, 1)] }],
  [{ coefficient := 1, powers := [(13, 1), (19, 1), (31, 1), (49, 1)] }, { coefficient := -1, powers := [(13, 1), (19, 1), (37, 1), (40, 1)] }, { coefficient := -1, powers := [(13, 1), (24, 1), (26, 1), (45, 1)] }],
...
#print axioms Krenn.Component18.SelectedLeafB6_0_0.selectedHasNoCommonZero

end Krenn.Component18.SelectedLeafB6_0_0
