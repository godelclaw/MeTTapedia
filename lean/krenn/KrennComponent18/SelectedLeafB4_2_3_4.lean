...
namespace Krenn.Component18.SelectedLeafB4_2_3_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "8bd764c4fc7a2ed173fbc6a1630a4dd2755ea145eb7e9f97a08cd20a199d37d5"
def certificateSHA256 : String := "4f4365811de13e52bf5bbb62253ef54d4b7d238963d45208ae5da56ac535309f"
...
def multipliers : Fin 28 → SparsePoly (Fin 66) := ![
  [{ coefficient := 2, powers := [(24, 1), (26, 1), (45, 1), (46, 1), (65, 1)] }, { coefficient := 1, powers := [(24, 1), (46, 1), (57, 1), (63, 1), (65, 1)] }, { coefficient := -1, powers := [(24, 1), (57, 1), (65, 1)] }, { coefficient := -1, powers := [(30, 1), (48, 1), (57, 1), (63, 1), (65, 1)] }],
  ...
  [{ coefficient := -1, powers := [(18, 1), (20, 1), (45, 1), (54, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(20, 1), (54, 1)] }],
  [{ coefficient := 1, powers := [(54, 1)] }],
  [{ coefficient := 1, powers := [(49, 1)] }],
  [{ coefficient := 1, powers := [(24, 1)] }],
  [{ coefficient := 1, powers := [(13, 1)] }],
  [{ coefficient := 1, powers := [(18, 1), (20, 1), (54, 1), (64, 1)] }],
  ...
  [{ coefficient := -1, powers := [(18, 1), (20, 1), (30, 1), (54, 1)] }],
  [{ coefficient := -2, powers := [(13, 1), (24, 1), (26, 1), (45, 1), (46, 1)] }, { coefficient := -1, powers := [(13, 1), (24, 1), (46, 1), (57, 1), (63, 1)] }, { coefficient := 1, powers := [(13, 1), (24, 1), (57, 1)] }, { coefficient := 1, powers := [(13, 1), (30, 1), (48, 1), (57, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (60, 1)] }, { coefficient := 1, powers := [(13, 1), (45, 1), (48, 1)] }, { coefficient := -1, powers := [(13, 1), (49, 1)] }, { coefficient := 1, powers := [(18, 1), (20, 1), (45, 1), (46, 1), (54, 1), (64, 1)] }, { coefficient := -1, powers := [(18, 1), (20, 1), (47, 1), (54, 1), (64, 1)] }]
]
...
#print axioms Krenn.Component18.SelectedLeafB4_2_3_4.selectedHasNoCommonZero

end Krenn.Component18.SelectedLeafB4_2_3_4
