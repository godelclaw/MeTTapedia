...
namespace Krenn.Component18.SelectedLeafB4_6_1_7_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "83a4a2a9132905f576fd347a1b18c04ae524e0ca77068724ff3d1054358816ef"
...
def multipliers : Fin 14 → SparsePoly (Fin 70) := ![
  ...
  [{ coefficient := 1, powers := [(24, 1), (57, 1), (65, 1)] }, { coefficient := -1, powers := [(34, 1), (49, 1), (57, 1), (65, 1), (69, 1)] }, { coefficient := 1, powers := [(37, 1), (40, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (37, 1), (52, 1)] }],
  [{ coefficient := 1, powers := [(31, 1)] }, { coefficient := 1, powers := [(34, 1), (57, 1), (69, 1)] }],
  [{ coefficient := 1, powers := [(18, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (37, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := 1, powers := [(40, 1), (60, 1)] }, { coefficient := 1, powers := [(49, 1), (54, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (57, 1)] }, { coefficient := 1, powers := [(8, 1), (37, 1)] }, { coefficient := -1, powers := [(18, 1), (31, 1)] }, { coefficient := -1, powers := [(18, 1), (34, 1), (57, 1), (69, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (19, 1), (37, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (24, 1), (57, 1)] }, { coefficient := 1, powers := [(13, 1), (34, 1), (49, 1), (57, 1), (69, 1)] }, { coefficient := -1, powers := [(13, 1), (37, 1), (40, 1)] }],
...
#print axioms Krenn.Component18.SelectedLeafB4_6_1_7_5.selectedHasNoCommonZero

end Krenn.Component18.SelectedLeafB4_6_1_7_5
