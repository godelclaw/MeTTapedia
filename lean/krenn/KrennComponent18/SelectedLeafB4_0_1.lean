...
namespace Krenn.Component18.SelectedLeafB4_0_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "587deb4f5898e39d08b5f37fee188935eff4a297f2962215079c1933634fe447"
def certificateSHA256 : String := "0888ef3bc8d7d9ca6ea62f2d326bb2f9c50862fe1eecdcb2d04cad3a5d440ee9"
...
def multipliers : Fin 9 → SparsePoly (Fin 63) := ![
  ...
  [{ coefficient := 1, powers := [(19, 1), (53, 1), (62, 1)] }, { coefficient := -1, powers := [(26, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(26, 1), (47, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (52, 1), (62, 1)] }, { coefficient := 1, powers := [(62, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (19, 1), (52, 1), (57, 1), (62, 1)] }, { coefficient := -1, powers := [(0, 1), (57, 1), (62, 1)] }, { coefficient := 1, powers := [(19, 1), (26, 1), (45, 1), (52, 1), (62, 1)] }, { coefficient := -1, powers := [(19, 1), (45, 1), (53, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (26, 1), (47, 1), (62, 1)] }],
...
#print axioms Krenn.Component18.SelectedLeafB4_0_1.selectedHasNoCommonZero

end Krenn.Component18.SelectedLeafB4_0_1
