...
namespace Krenn.Component18.SelectedLeafB7_6_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "5bd78c3a8e1485dee3b21ec536a47cb29435a61d67b8afadeb1f00485eb9e45b"
def certificateSHA256 : String := "0e19be1af7407f72d2e127d53cb0395353c559b7fe6db130a0f5fd21c84f816a"
...
def multipliers : Fin 24 → SparsePoly (Fin 69) := ![
  ...
  [{ coefficient := -1, powers := [(24, 1), (57, 1), (66, 1)] }, { coefficient := -1, powers := [(31, 1), (49, 1), (66, 1)] }, { coefficient := 1, powers := [(37, 1), (40, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (21, 1), (49, 1), (62, 1)] }, { coefficient := 2, powers := [(18, 1), (21, 1), (24, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(20, 1), (29, 1), (38, 1), (52, 1), (53, 1), (60, 1), (66, 1)] }, { coefficient := 1, powers := [(20, 1), (29, 1), (38, 1), (53, 1), (56, 1), (60, 1), (66, 1)] }, { coefficient := -1, powers := [(20, 1), (31, 1), (38, 1), (52, 1), (60, 1), (66, 1)] }, { coefficient := -1, powers := [(20, 1), (31, 1), (38, 1), (56, 1), (60, 1), (66, 1)] }, { coefficient := -1, powers := [(23, 1), (40, 1), (60, 1), (66, 1)] }, { coefficient := 1, powers := [(24, 1), (26, 1), (38, 1), (52, 1), (60, 1), (66, 1)] }, { coefficient := 1, powers := [(24, 1), (26, 1), (38, 1), (56, 1), (60, 1), (66, 1)] }, { coefficient := -2, powers := [(24, 1), (38, 1), (53, 1), (60, 1), (66, 1)] }, { coefficient := 1, powers := [(24, 1), (45, 1), (54, 1), (66, 1)] }, { coefficient := -1, powers := [(29, 1), (40, 1), (60, 1), (66, 1)] }, { coefficient := -1, powers := [(31, 1), (38, 1), (48, 1), (60, 1), (66, 1)] }],
  ...
  [{ coefficient := -1, powers := [(2, 1), (55, 1), (57, 1), (66, 1)] }, { coefficient := 1, powers := [(2, 1), (57, 1)] }, { coefficient := 1, powers := [(8, 1), (37, 1)] }, { coefficient := -1, powers := [(18, 1), (31, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (34, 1), (57, 1)] }, { coefficient := 1, powers := [(13, 1), (31, 1), (49, 1)] }, { coefficient := -1, powers := [(13, 1), (37, 1), (40, 1)] }, { coefficient := -1, powers := [(17, 1), (20, 1), (29, 1), (38, 1), (52, 1), (53, 1), (60, 1)] }, { coefficient := -1, powers := [(17, 1), (20, 1), (29, 1), (38, 1), (53, 1), (56, 1), (60, 1)] }, { coefficient := 1, powers := [(17, 1), (20, 1), (31, 1), (38, 1), (52, 1), (60, 1)] }, { coefficient := 1, powers := [(17, 1), (20, 1), (31, 1), (38, 1), (56, 1), (60, 1)] }, { coefficient := 1, powers := [(17, 1), (23, 1), (40, 1), (60, 1)] }, { coefficient := -1, powers := [(17, 1), (24, 1), (26, 1), (38, 1), (52, 1), (60, 1)] }, { coefficient := -1, powers := [(17, 1), (24, 1), (26, 1), (38, 1), (56, 1), (60, 1)] }, { coefficient := 2, powers := [(17, 1), (24, 1), (38, 1), (53, 1), (60, 1)] }, { coefficient := -1, powers := [(17, 1), (24, 1), (45, 1), (54, 1)] }, { coefficient := 1, powers := [(17, 1), (29, 1), (40, 1), (60, 1)] }, { coefficient := 1, powers := [(17, 1), (31, 1), (38, 1), (48, 1), (60, 1)] }]
]
...
#print axioms Krenn.Component18.SelectedLeafB7_6_7.selectedHasNoCommonZero

end Krenn.Component18.SelectedLeafB7_6_7
