...
namespace Krenn.Component18.SelectedLeafB4_2_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "f17fa7992a2bd60030cc6f81f13022f30ac2adc753ff8ae4164b0d0ad406ff6f"
def certificateSHA256 : String := "5301b75fef6cfe555f410ab1aa0041ad6d6e4f4142a72f2572365f4afaf68dba"
...
def multipliers : Fin 17 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := -1, powers := [(24, 1), (57, 1), (63, 1)] }, { coefficient := -1, powers := [(31, 1), (49, 1), (63, 1)] }, { coefficient := 1, powers := [(37, 1), (40, 1), (63, 1)] }],
  [{ coefficient := 2, powers := [(18, 1), (24, 1), (63, 1)] }],
  ...
  [{ coefficient := -1, powers := [(2, 1), (55, 1), (57, 1), (63, 1)] }, { coefficient := 1, powers := [(2, 1), (57, 1)] }, { coefficient := 1, powers := [(8, 1), (37, 1)] }, { coefficient := -1, powers := [(18, 1), (31, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (34, 1), (57, 1)] }, { coefficient := 1, powers := [(13, 1), (31, 1), (49, 1)] }, { coefficient := -1, powers := [(13, 1), (37, 1), (40, 1)] }, { coefficient := -1, powers := [(17, 1), (24, 1), (45, 1), (54, 1)] }, { coefficient := 2, powers := [(18, 1), (24, 1), (54, 1)] }]
]
...
#print axioms Krenn.Component18.SelectedLeafB4_2_7.selectedHasNoCommonZero

end Krenn.Component18.SelectedLeafB4_2_7
