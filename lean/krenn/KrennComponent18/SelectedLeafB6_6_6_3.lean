...
namespace Krenn.Component18.SelectedLeafB6_6_6_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "493e59c0ea646f8b845979b41c663d81bd8fec0cb4e1f0261c63bc4c43a30384"
def certificateSHA256 : String := "22f74fd002c5099a45595b4ecdeb19018c6d7029ae5b0f834e9ecc319156cc86"
...
def multipliers : Fin 17 → SparsePoly (Fin 69) := ![
  ...
  [{ coefficient := 1, powers := [(13, 1), (31, 1), (49, 1)] }, { coefficient := -1, powers := [(13, 1), (37, 1), (40, 1)] }, { coefficient := -1, powers := [(17, 1), (24, 1), (45, 1), (54, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (43, 1)] }, { coefficient := 1, powers := [(5, 1), (34, 1)] }],
  [{ coefficient := 2, powers := [(17, 1), (24, 1), (47, 1), (54, 1)] }, { coefficient := 2, powers := [(18, 1), (24, 1), (42, 1), (54, 1)] }]
]
...
#print axioms Krenn.Component18.SelectedLeafB6_6_6_3.selectedHasNoCommonZero

end Krenn.Component18.SelectedLeafB6_6_6_3
