...
namespace Krenn.Component18.SelectedLeafB4_6_1_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "cb78eaf459a9b21c0f143b7b35dc025ad4369e304a2189a08a4b00357cb153ed"
...
def multipliers : Fin 33 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := 1, powers := [(5, 1), (26, 1), (37, 1), (46, 1), (52, 1), (54, 1), (64, 1)] }, { coefficient := -1, powers := [(5, 1), (37, 1), (46, 1), (53, 1), (54, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(18, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (26, 1), (37, 1), (46, 1), (54, 1), (64, 1)] }],
  ...
  [{ coefficient := 1, powers := [(5, 1), (37, 1), (46, 1), (54, 1), (64, 1)] }],
...
#print axioms Krenn.Component18.SelectedLeafB4_6_1_2.selectedHasNoCommonZero

end Krenn.Component18.SelectedLeafB4_6_1_2
