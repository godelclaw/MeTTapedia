...
namespace Krenn.Component18.SelectedLeafB4_0_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "3c3a68f9782b3168dbb9de9d789ab479e3693736a6411e81beaab1fba88104f2"
def certificateSHA256 : String := "74317695f7a1f995799ea4405b98ff5ab1c132ee027602f461df5d5e9daf7b25"
...
def multipliers : Fin 21 → SparsePoly (Fin 62) := ![
  ...
  [{ coefficient := 1, powers := [(24, 1), (45, 1), (54, 1), (61, 1)] }, { coefficient := 2, powers := [(24, 1), (47, 1), (54, 1)] }],
  ...
  [{ coefficient := -1, powers := [(17, 1), (24, 1), (54, 1), (61, 1)] }],
  ...
  [{ coefficient := 1, powers := [(13, 1), (19, 1), (31, 1), (49, 1)] }, { coefficient := -1, powers := [(13, 1), (19, 1), (37, 1), (40, 1)] }],
...
#print axioms Krenn.Component18.SelectedLeafB4_0_0.selectedHasNoCommonZero

end Krenn.Component18.SelectedLeafB4_0_0
