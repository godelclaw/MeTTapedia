...
namespace Krenn.Component18.SelectedLeafB7_6_2_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "521373ca814051a13c2b9a250e88fa497407302cbd7c523435e3b20ab0fd734c"
def certificateSHA256 : String := "9ab126aef75e0eb7976aa195d2e667be1c7b71debbf39ac5d990b3cc94c1ae7d"
...
def multipliers : Fin 36 → SparsePoly (Fin 69) := ![
  ...
  [{ coefficient := -1, powers := [(3, 1), (37, 1), (40, 1), (59, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(23, 1), (40, 1), (59, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (26, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (21, 1), (37, 1), (62, 1)] }, { coefficient := 1, powers := [(18, 1), (21, 1), (24, 1), (25, 1), (46, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(17, 1), (49, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (37, 1), (62, 1)] }, { coefficient := -1, powers := [(18, 1), (24, 1), (25, 1), (46, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(18, 1), (40, 1), (59, 1)] }],
  [{ coefficient := 1, powers := [(25, 1), (34, 1), (40, 1), (45, 1), (46, 1), (61, 1)] }, { coefficient := 1, powers := [(25, 1), (34, 1), (40, 1), (45, 1), (56, 1), (61, 1)] }, { coefficient := -1, powers := [(25, 1), (34, 1), (40, 1), (47, 1), (52, 1)] }],
  [{ coefficient := -1, powers := [(25, 1), (34, 1), (40, 1), (42, 1)] }, { coefficient := -1, powers := [(25, 1), (34, 1), (40, 1), (52, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (45, 1)] }],
  [{ coefficient := -1, powers := [(18, 1), (24, 1)] }],
  [{ coefficient := -1, powers := [(17, 1), (25, 1), (34, 1), (40, 1), (42, 1), (52, 1)] }, { coefficient := -1, powers := [(17, 1), (25, 1), (34, 1), (40, 1), (46, 1), (61, 1)] }, { coefficient := -1, powers := [(17, 1), (25, 1), (34, 1), (40, 1), (56, 1), (61, 1)] }],
  ...
  [{ coefficient := 1, powers := [(17, 1), (25, 1), (34, 1), (40, 1), (45, 1), (46, 1)] }, { coefficient := 1, powers := [(17, 1), (25, 1), (34, 1), (40, 1), (45, 1), (56, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (37, 1), (54, 1)] }, { coefficient := 1, powers := [(18, 1), (24, 1), (25, 1), (46, 1), (54, 1)] }],
...
#print axioms Krenn.Component18.SelectedLeafB7_6_2_6.selectedHasNoCommonZero

end Krenn.Component18.SelectedLeafB7_6_2_6
