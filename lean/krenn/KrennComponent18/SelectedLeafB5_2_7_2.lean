...
namespace Krenn.Component18.SelectedLeafB5_2_7_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "5f3c0be54d708e56c76431a301b91066ff03de491762ffc7d167c9bf3b92700d"
...
def multipliers : Fin 27 → SparsePoly (Fin 68) := ![
  ...
  [{ coefficient := -1, powers := [(3, 1), (37, 1), (40, 1), (59, 1), (64, 1)] }, { coefficient := -2, powers := [(24, 1), (57, 1), (64, 1)] }],
  ...
  [{ coefficient := -1, powers := [(2, 1), (55, 1), (57, 1), (64, 1)] }, { coefficient := 1, powers := [(2, 1), (57, 1)] }, { coefficient := 1, powers := [(8, 1), (37, 1)] }],
...
#print axioms Krenn.Component18.SelectedLeafB5_2_7_2.selectedHasNoCommonZero

end Krenn.Component18.SelectedLeafB5_2_7_2
