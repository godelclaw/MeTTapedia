...
namespace Krenn.Component18.SelectedLeafB6_0_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "d0bb78c30d8420be86530108c74929ee3a2ff92c9337eb7efad006919eb4759f"
def certificateSHA256 : String := "05e880f5586246b57810f6b881e7088e8aacd6bd4fb5a22f823d3c46e7c1d846"
...
def multipliers : Fin 19 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := 1, powers := [(24, 1), (46, 1), (57, 1), (63, 1), (64, 1)] }, { coefficient := -1, powers := [(30, 1), (48, 1), (57, 1), (63, 1), (64, 1)] }, { coefficient := -1, powers := [(31, 1), (49, 1), (63, 1)] }, { coefficient := 1, powers := [(37, 1), (40, 1), (63, 1)] }],
  [{ coefficient := 2, powers := [(24, 1), (25, 1), (47, 1), (54, 1), (63, 1)] }, { coefficient := 1, powers := [(24, 1), (45, 1), (54, 1), (63, 1)] }],
  ...
  [{ coefficient := -1, powers := [(13, 1), (24, 1), (46, 1), (57, 1), (64, 1)] }, { coefficient := 1, powers := [(13, 1), (30, 1), (48, 1), (57, 1), (64, 1)] }, { coefficient := 1, powers := [(13, 1), (31, 1), (49, 1)] }, { coefficient := -1, powers := [(13, 1), (37, 1), (40, 1)] }, { coefficient := -2, powers := [(17, 1), (24, 1), (25, 1), (47, 1), (54, 1)] }, { coefficient := -1, powers := [(17, 1), (24, 1), (45, 1), (54, 1)] }],
...
#print axioms Krenn.Component18.SelectedLeafB6_0_7.selectedHasNoCommonZero

end Krenn.Component18.SelectedLeafB6_0_7
