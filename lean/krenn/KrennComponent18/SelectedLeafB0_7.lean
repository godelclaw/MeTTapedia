...
namespace Krenn.Component18.SelectedLeafB0_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "a1600bcd985043b08353edd1350df2dba869a9a64fa81d81a12d75fbf8558665"
def certificateSHA256 : String := "d46dfaefebb7baa1ab50bc78c839df750a238bcf0d8f30b9186555d3a44ef426"
...
def multipliers : Fin 19 → SparsePoly (Fin 64) := ![
  ...
  [{ coefficient := 1, powers := [(5, 1), (26, 1), (34, 1), (42, 1), (63, 1)] }, { coefficient := 1, powers := [(5, 1), (26, 1), (34, 1), (46, 1), (63, 1)] }, { coefficient := 1, powers := [(5, 1), (26, 1), (34, 1), (52, 1), (63, 1)] }, { coefficient := 2, powers := [(13, 1), (20, 1), (31, 1), (52, 1), (63, 1)] }, { coefficient := -1, powers := [(13, 1), (24, 1), (26, 1), (42, 1), (63, 1)] }, { coefficient := -1, powers := [(13, 1), (24, 1), (26, 1), (46, 1), (63, 1)] }, { coefficient := -1, powers := [(13, 1), (24, 1), (26, 1), (52, 1), (63, 1)] }, { coefficient := 1, powers := [(13, 1), (31, 1), (48, 1), (63, 1)] }],
...
#print axioms Krenn.Component18.SelectedLeafB0_7.selectedHasNoCommonZero

end Krenn.Component18.SelectedLeafB0_7
