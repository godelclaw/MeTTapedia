...
namespace Krenn.Component18.SelectedLeafB5_2_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "47db06b8563ff36213decae45335b5a0d9e355437d1c7681d5ed6209020da949"
def certificateSHA256 : String := "f1230b00e775f6e42a02fa654957d6f287f584f851412fe3a0a42d8ee3cf0352"
...
def multipliers : Fin 30 → SparsePoly (Fin 65) := ![
  ...
  [{ coefficient := 2, powers := [(18, 1), (24, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(20, 1), (29, 1), (38, 1), (52, 1), (53, 1), (60, 1), (64, 1)] }, { coefficient := -1, powers := [(20, 1), (31, 1), (38, 1), (52, 1), (60, 1), (64, 1)] }, { coefficient := -1, powers := [(23, 1), (40, 1), (60, 1), (64, 1)] }, { coefficient := 1, powers := [(24, 1), (26, 1), (38, 1), (52, 1), (60, 1), (64, 1)] }, { coefficient := -2, powers := [(24, 1), (38, 1), (53, 1), (60, 1), (64, 1)] }, { coefficient := 1, powers := [(24, 1), (45, 1), (54, 1), (64, 1)] }, { coefficient := -1, powers := [(29, 1), (40, 1), (60, 1), (64, 1)] }, { coefficient := -1, powers := [(31, 1), (38, 1), (48, 1), (60, 1), (64, 1)] }],
  ...
  [{ coefficient := -2, powers := [(18, 1), (54, 1), (64, 1)] }],
  ...
  [{ coefficient := 1, powers := [(2, 1), (19, 1), (26, 1), (45, 1), (52, 1), (61, 1)] }, { coefficient := 1, powers := [(2, 1), (26, 1), (45, 1), (52, 1)] }, { coefficient := 1, powers := [(2, 1), (26, 1), (45, 1), (61, 1)] }, { coefficient := 1, powers := [(8, 1), (37, 1)] }, { coefficient := -1, powers := [(18, 1), (31, 1)] }],
  ...
  [{ coefficient := 1, powers := [(0, 1), (2, 1), (19, 1), (43, 1), (52, 1), (61, 1)] }, { coefficient := 1, powers := [(0, 1), (2, 1), (43, 1), (52, 1)] }, { coefficient := 1, powers := [(0, 1), (2, 1), (43, 1), (61, 1)] }, { coefficient := 1, powers := [(2, 1), (43, 1)] }, { coefficient := 1, powers := [(5, 1), (34, 1)] }]
]
...
#print axioms Krenn.Component18.SelectedLeafB5_2_4.selectedHasNoCommonZero

end Krenn.Component18.SelectedLeafB5_2_4
