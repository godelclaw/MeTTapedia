...
namespace Krenn.Component18.SelectedLeafB0_6_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "f06f6ec6fb99557e8595d92035d04a8c33db953aa2c5b7aef532b461775c59bb"
...
def multipliers : Fin 7 → SparsePoly (Fin 64) := ![
  ...
  [{ coefficient := -1, powers := [(26, 1), (39, 1), (45, 1), (59, 1), (63, 1)] }, { coefficient := -1, powers := [(26, 1), (45, 1), (46, 1), (52, 1), (63, 1)] }, { coefficient := 1, powers := [(26, 1), (47, 1), (52, 1), (63, 1)] }, { coefficient := -1, powers := [(42, 1), (57, 1), (63, 1)] }, { coefficient := 1, powers := [(45, 1), (46, 1), (53, 1), (63, 1)] }, { coefficient := -1, powers := [(47, 1), (53, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (26, 1), (42, 1), (45, 1), (63, 1)] }, { coefficient := -1, powers := [(26, 1), (45, 1), (63, 1)] }],
...
#print axioms Krenn.Component18.SelectedLeafB0_6_1.selectedHasNoCommonZero

end Krenn.Component18.SelectedLeafB0_6_1
