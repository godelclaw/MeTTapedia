...
namespace Krenn.Component18.SelectedLeafB1_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "78c7ccba495396cbdbe8ef90c7cca77a223a897b16f1ad03db93da02a157fae2"
...
def multipliers : Fin 21 → SparsePoly (Fin 64) := ![
  ...
  [{ coefficient := -1, powers := [(2, 1), (40, 1), (42, 1), (60, 1), (63, 1)] }, { coefficient := -1, powers := [(2, 1), (40, 1), (46, 1), (60, 1), (63, 1)] }],
...
#print axioms Krenn.Component18.SelectedLeafB1_3.selectedHasNoCommonZero

end Krenn.Component18.SelectedLeafB1_3
