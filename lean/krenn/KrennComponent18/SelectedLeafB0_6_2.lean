...
namespace Krenn.Component18.SelectedLeafB0_6_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "66ab12b5fd98756bf6697988a9aa34edb84c7652f2c00bdcf13d6568ba9865fb"
def certificateSHA256 : String := "37285bd2e1a40c4f3911b42cc5b497b6e5d4b0b63eebe0c42c7ef230c3b5d1e1"
...
def multipliers : Fin 16 → SparsePoly (Fin 64) := ![
  [{ coefficient := 2, powers := [(20, 1), (31, 1), (52, 1)] }, { coefficient := 1, powers := [(31, 1), (48, 1)] }],
  ...
  [{ coefficient := -1, powers := [(5, 1), (37, 1), (46, 1), (54, 1)] }, { coefficient := 2, powers := [(13, 1), (31, 1), (49, 1), (52, 1)] }, { coefficient := 1, powers := [(18, 1), (24, 1), (46, 1), (54, 1)] }],
...
#print axioms Krenn.Component18.SelectedLeafB0_6_2.selectedHasNoCommonZero

end Krenn.Component18.SelectedLeafB0_6_2
