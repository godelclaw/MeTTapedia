...
namespace Krenn.Component18.SelectedLeafB5_2_2_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "510cb3e3bbd5948aeb55d7dae5e9523958f1dcc87c3b1cc6ae95e114e0f258f8"
def certificateSHA256 : String := "e7a8a2553d2abcce73bf375bdfdd104c50b565659d2e0e7259550ab3b7aebb68"

set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedSourceIndices : Fin 57 → Fin 670 := ![
  0,
  1,
  5,
  7,
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedEquations : Fin 57 → SparsePoly (Fin 67) := ![
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def multipliers : Fin 57 → SparsePoly (Fin 67) := ![
  ...
  [{ coefficient := -1, powers := [(18, 1), (24, 1), (25, 1), (54, 1), (66, 1)] }],
...
#print axioms Krenn.Component18.SelectedLeafB5_2_2_5.selectedHasNoCommonZero

end Krenn.Component18.SelectedLeafB5_2_2_5
