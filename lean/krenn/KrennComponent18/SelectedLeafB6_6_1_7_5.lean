...
namespace Krenn.Component18.SelectedLeafB6_6_1_7_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "65a60d5fc27141670d3a94a715c116818fc0a35cc782c5c24093a1d9c99154af"
...
def multipliers : Fin 14 → SparsePoly (Fin 71) := ![
  ...
  [{ coefficient := 1, powers := [(24, 1), (57, 1), (66, 1)] }, { coefficient := -1, powers := [(34, 1), (49, 1), (57, 1), (66, 1), (70, 1)] }, { coefficient := 1, powers := [(37, 1), (40, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (37, 1), (52, 1)] }],
  [{ coefficient := 1, powers := [(31, 1)] }, { coefficient := 1, powers := [(34, 1), (57, 1), (70, 1)] }],
  [{ coefficient := 1, powers := [(18, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (37, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := 1, powers := [(40, 1), (60, 1)] }, { coefficient := 1, powers := [(49, 1), (54, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (57, 1)] }, { coefficient := 1, powers := [(8, 1), (37, 1)] }, { coefficient := -1, powers := [(18, 1), (31, 1)] }, { coefficient := -1, powers := [(18, 1), (34, 1), (57, 1), (70, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (19, 1), (37, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (24, 1), (57, 1)] }, { coefficient := 1, powers := [(13, 1), (34, 1), (49, 1), (57, 1), (70, 1)] }, { coefficient := -1, powers := [(13, 1), (37, 1), (40, 1)] }],
...
#print axioms Krenn.Component18.SelectedLeafB6_6_1_7_5.selectedHasNoCommonZero

end Krenn.Component18.SelectedLeafB6_6_1_7_5
