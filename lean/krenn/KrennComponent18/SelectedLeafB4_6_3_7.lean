...
namespace Krenn.Component18.SelectedLeafB4_6_3_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "11cc7a352e2aa3e0605a610dc095a0fd05ff14a0c9b6183a9efcd8bedc32dca8"
...
def multipliers : Fin 27 → SparsePoly (Fin 69) := ![
  [{ coefficient := 2, powers := [(24, 1), (26, 1), (45, 1), (46, 1), (66, 1)] }, { coefficient := 1, powers := [(24, 1), (46, 1), (57, 1), (64, 1), (66, 1)] }, { coefficient := -1, powers := [(30, 1), (48, 1), (57, 1), (64, 1), (66, 1)] }, { coefficient := -1, powers := [(31, 1), (49, 1), (66, 1)] }, { coefficient := 1, powers := [(37, 1), (40, 1), (66, 1)] }],
  ...
  [{ coefficient := -2, powers := [(13, 1), (24, 1), (26, 1), (45, 1), (46, 1)] }, { coefficient := -1, powers := [(13, 1), (24, 1), (46, 1), (57, 1), (64, 1)] }, { coefficient := 1, powers := [(13, 1), (30, 1), (48, 1), (57, 1), (64, 1)] }, { coefficient := 1, powers := [(13, 1), (31, 1), (49, 1)] }, { coefficient := -1, powers := [(13, 1), (37, 1), (40, 1)] }]
]
...
#print axioms Krenn.Component18.SelectedLeafB4_6_3_7.selectedHasNoCommonZero

end Krenn.Component18.SelectedLeafB4_6_3_7
