...
namespace Krenn.Component18.SelectedLeafB4_2_1_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "0c7531c904ec9e3b8e440cfeffbc7e6e70fd80883b6a962122b4f15366da04e5"
def certificateSHA256 : String := "160aec30088fb9caeab7fdf8827e95218a5d52037bc7b2cde610a6759b94bc7b"
...
def multipliers : Fin 33 → SparsePoly (Fin 65) := ![
  [{ coefficient := 1, powers := [(5, 1), (22, 1), (57, 1), (59, 1)] }, { coefficient := 1, powers := [(5, 1), (27, 1), (52, 1), (57, 1), (59, 1)] }, { coefficient := -1, powers := [(5, 1), (28, 1), (57, 1), (59, 1)] }, { coefficient := 1, powers := [(5, 1), (33, 1), (46, 1), (57, 1)] }, { coefficient := 1, powers := [(5, 1), (36, 1), (42, 1), (57, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (26, 1)] }],
  [{ coefficient := -1, powers := [(17, 1), (49, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (11, 1), (36, 1), (57, 1)] }],
  [{ coefficient := -1, powers := [(20, 1), (37, 1), (38, 1), (52, 2), (54, 1)] }, { coefficient := -1, powers := [(37, 1), (38, 1), (48, 1), (52, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (45, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (57, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (26, 1), (37, 1), (46, 1), (52, 1), (54, 1), (63, 1)] }, { coefficient := -1, powers := [(5, 1), (37, 1), (46, 1), (53, 1), (54, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(18, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (26, 1), (37, 1), (46, 1), (54, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(20, 1), (37, 1), (38, 1), (52, 1), (54, 1)] }, { coefficient := 1, powers := [(37, 1), (38, 1), (48, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (54, 1)] }],
  [{ coefficient := 1, powers := [(49, 1)] }],
  [{ coefficient := -1, powers := [(37, 1), (38, 1), (54, 1)] }],
  [{ coefficient := 1, powers := [(24, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (37, 1), (46, 1), (54, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (22, 1), (34, 1), (52, 1), (57, 1)] }, { coefficient := 1, powers := [(5, 1), (27, 1), (34, 1), (52, 2), (57, 1)] }, { coefficient := -1, powers := [(5, 1), (28, 1), (34, 1), (42, 1), (57, 1)] }, { coefficient := -1, powers := [(5, 1), (28, 1), (34, 1), (46, 1), (57, 1)] }, { coefficient := -1, powers := [(5, 1), (28, 1), (34, 1), (52, 1), (57, 1)] }, { coefficient := -1, powers := [(5, 1), (34, 1), (36, 1), (39, 1), (57, 1)] }],
  [{ coefficient := 1, powers := [(13, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (19, 1), (37, 1), (54, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (34, 1), (52, 1), (57, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (27, 1), (34, 1), (52, 1), (57, 1)] }, { coefficient := 1, powers := [(5, 1), (28, 1), (34, 1), (57, 1)] }],
  ...
  [{ coefficient := 1, powers := [(1, 1), (5, 1), (34, 1), (42, 1), (57, 1)] }, { coefficient := 1, powers := [(4, 1), (5, 1), (33, 1), (34, 1), (57, 1)] }, { coefficient := 1, powers := [(5, 1), (11, 1), (22, 1), (34, 1), (57, 1)] }, { coefficient := 1, powers := [(5, 1), (11, 1), (27, 1), (34, 1), (52, 1), (57, 1)] }, { coefficient := -1, powers := [(5, 1), (11, 1), (28, 1), (34, 1), (57, 1)] }, { coefficient := -1, powers := [(5, 1), (15, 1), (22, 1), (34, 1), (57, 1)] }, { coefficient := 1, powers := [(13, 1), (19, 1), (24, 1), (57, 1)] }, { coefficient := -1, powers := [(17, 1), (19, 1), (20, 1), (37, 1), (38, 1), (52, 1), (54, 1)] }, { coefficient := -1, powers := [(17, 1), (19, 1), (37, 1), (38, 1), (48, 1), (54, 1)] }, { coefficient := 1, powers := [(17, 1), (20, 1), (37, 1), (38, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (19, 1), (37, 1), (46, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [(3, 1), (5, 1), (37, 1), (54, 1), (59, 1), (61, 1)] }, { coefficient := 1, powers := [(4, 1), (5, 1), (22, 1), (34, 1), (52, 1), (57, 1), (59, 1)] }, { coefficient := -1, powers := [(4, 1), (5, 1), (27, 1), (34, 1), (52, 2), (57, 1), (59, 1)] }, { coefficient := 1, powers := [(4, 1), (5, 1), (28, 1), (34, 1), (42, 1), (57, 1), (59, 1)] }, { coefficient := 1, powers := [(4, 1), (5, 1), (28, 1), (34, 1), (46, 1), (57, 1), (59, 1)] }, { coefficient := 1, powers := [(4, 1), (5, 1), (28, 1), (34, 1), (52, 1), (57, 1), (59, 1)] }, { coefficient := 1, powers := [(4, 1), (5, 1), (34, 1), (36, 1), (39, 1), (57, 1), (59, 1)] }, { coefficient := 1, powers := [(5, 1), (11, 1), (22, 1), (34, 1), (46, 1), (52, 1), (57, 1)] }, { coefficient := -1, powers := [(5, 1), (11, 1), (27, 1), (34, 1), (46, 1), (52, 2), (57, 1)] }, { coefficient := 1, powers := [(5, 1), (11, 1), (28, 1), (34, 1), (42, 1), (46, 1), (57, 1)] }, { coefficient := 1, powers := [(5, 1), (11, 1), (28, 1), (34, 1), (46, 2), (57, 1)] }, { coefficient := 1, powers := [(5, 1), (11, 1), (28, 1), (34, 1), (46, 1), (52, 1), (57, 1)] }, { coefficient := 1, powers := [(5, 1), (11, 1), (34, 1), (36, 1), (39, 1), (46, 1), (57, 1)] }, { coefficient := 1, powers := [(5, 1), (15, 1), (22, 1), (34, 1), (42, 1), (52, 1), (57, 1)] }, { coefficient := -1, powers := [(5, 1), (15, 1), (27, 1), (34, 1), (42, 1), (52, 2), (57, 1)] }, { coefficient := 1, powers := [(5, 1), (15, 1), (28, 1), (34, 1), (42, 2), (57, 1)] }, { coefficient := 1, powers := [(5, 1), (15, 1), (28, 1), (34, 1), (42, 1), (46, 1), (57, 1)] }, { coefficient := 1, powers := [(5, 1), (15, 1), (28, 1), (34, 1), (42, 1), (52, 1), (57, 1)] }, { coefficient := 1, powers := [(5, 1), (15, 1), (34, 1), (36, 1), (39, 1), (42, 1), (57, 1)] }, { coefficient := 1, powers := [(5, 1), (19, 1), (37, 1), (42, 1), (54, 1), (61, 1)] }, { coefficient := 1, powers := [(5, 1), (19, 1), (37, 1), (46, 1), (54, 1), (61, 1)] }, { coefficient := -1, powers := [(5, 1), (26, 1), (37, 1), (45, 1), (46, 1), (52, 1), (54, 1), (63, 1)] }, { coefficient := 1, powers := [(5, 1), (37, 1), (45, 1), (46, 1), (53, 1), (54, 1), (63, 1)] }, { coefficient := -1, powers := [(5, 1), (37, 1), (54, 1), (61, 1)] }, { coefficient := 1, powers := [(17, 1), (20, 1), (37, 1), (38, 1), (52, 2), (54, 1)] }, { coefficient := 1, powers := [(17, 1), (24, 1), (47, 1), (54, 1)] }, { coefficient := 1, powers := [(17, 1), (37, 1), (38, 1), (48, 1), (52, 1), (54, 1)] }, { coefficient := 1, powers := [(18, 1), (24, 1), (42, 1), (54, 1)] }],
...
#print axioms Krenn.Component18.SelectedLeafB4_2_1_2.selectedHasNoCommonZero

end Krenn.Component18.SelectedLeafB4_2_1_2
