...
namespace Krenn.X5ResidualCase131.LeafB6

open Krenn.SparseCertificate
open MvPolynomial

def sourceSystemFileSHA256 : String := "8e6502e85e10fcc78d7fa6cdd740cf79280a80f77e07095cd88bb6da06223299"
def sourceSystemSemanticSHA256 : String := "7c9b3c551a86a53529f69ab2d207740bf50ec6bed3c1bf551eb82cb622c8d8a9"
def certificateSHA256 : String := "753d888be9adeee5710d9b8158cc0103c80eb1f92a2f43190207c707f0c20476"
...
def multipliers : Fin 22 → SparsePoly (Fin 72) := ![
  [{ coefficient := -1, powers := [(15, 1), (43, 1), (49, 1), (71, 1)] }],
  [{ coefficient := 1, powers := [(37, 1), (69, 1), (71, 1)] }, { coefficient := 1, powers := [(43, 1), (60, 1), (71, 1)] }],
  [{ coefficient := -1, powers := [(15, 1), (40, 1), (49, 1), (70, 1)] }],
  [{ coefficient := 1, powers := [(37, 1), (66, 1), (70, 1)] }, { coefficient := 1, powers := [(40, 1), (60, 1), (70, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (24, 1), (34, 1), (37, 1), (63, 1)] }, { coefficient := -1, powers := [(0, 1), (24, 1), (34, 1), (40, 1), (57, 1)] }, { coefficient := -1, powers := [(0, 1), (24, 1), (34, 1), (43, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (16, 1), (34, 1), (37, 1), (63, 1)] }, { coefficient := -1, powers := [(0, 1), (16, 1), (34, 1), (40, 1), (57, 1)] }, { coefficient := -1, powers := [(0, 1), (16, 1), (34, 1), (43, 1), (54, 1)] }],
  [{ coefficient := 1, powers := [(15, 1), (43, 1), (71, 1)] }],
  [{ coefficient := 1, powers := [(15, 1), (40, 1), (70, 1)] }],
  ...
  [{ coefficient := -1, powers := [(15, 1), (40, 1), (69, 1)] }, { coefficient := -1, powers := [(31, 1), (37, 1), (66, 1)] }, { coefficient := -1, powers := [(31, 1), (40, 1), (60, 1)] }],
  [{ coefficient := -1, powers := [(15, 1), (43, 1), (66, 1)] }, { coefficient := -1, powers := [(23, 1), (37, 1), (69, 1)] }, { coefficient := -1, powers := [(23, 1), (43, 1), (60, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (8, 1), (34, 1), (37, 1), (47, 1), (63, 1)] }, { coefficient := -1, powers := [(0, 1), (8, 1), (34, 1), (40, 1), (47, 1), (57, 1)] }, { coefficient := -1, powers := [(0, 1), (8, 1), (34, 1), (43, 1), (47, 1), (54, 1)] }]
]
...
#print axioms Krenn.X5ResidualCase131.LeafB6.selectedHasNoCommonZero

end Krenn.X5ResidualCase131.LeafB6
