...
namespace Krenn.X5ResidualCase316.LeafB3

open Krenn.SparseCertificate
open MvPolynomial

def sourceSystemFileSHA256 : String := "69471a1c0d06d5c35530f96a8f4b02b8577327497224304de4c066b753f0570c"
def sourceSystemSemanticSHA256 : String := "2ceee609aae6dedb553c7409d4d78b57083009a866da10489983a8364d7b818b"
...
def multipliers : Fin 34 → SparsePoly (Fin 72) := ![
  ...
  [{ coefficient := 1, powers := [(7, 1), (28, 1), (32, 1), (36, 1), (60, 1), (63, 1)] }, { coefficient := -1, powers := [(15, 1), (28, 1), (32, 1), (36, 1), (43, 1), (66, 1)] }, { coefficient := 1, powers := [(15, 1), (28, 1), (32, 1), (36, 1), (51, 1), (63, 1)] }],
  ...
  [{ coefficient := -1, powers := [(3, 1), (7, 1), (25, 1), (60, 1), (63, 1)] }, { coefficient := -1, powers := [(3, 1), (15, 1), (25, 1), (51, 1), (63, 1)] }, { coefficient := -1, powers := [(3, 1), (25, 1), (34, 1), (37, 1), (63, 1)] }, { coefficient := -1, powers := [(3, 1), (25, 1), (34, 1), (40, 1), (57, 1)] }, { coefficient := -1, powers := [(3, 1), (25, 1), (34, 1), (43, 1), (54, 1)] }, { coefficient := 1, powers := [(7, 1), (28, 1), (60, 1), (63, 1)] }, { coefficient := 1, powers := [(15, 1), (28, 1), (51, 1), (63, 1)] }, { coefficient := 1, powers := [(28, 1), (34, 1), (37, 1), (63, 1)] }, { coefficient := 1, powers := [(28, 1), (34, 1), (40, 1), (57, 1)] }, { coefficient := 1, powers := [(28, 1), (34, 1), (43, 1), (54, 1)] }],
...
#print axioms Krenn.X5ResidualCase316.LeafB3.selectedHasNoCommonZero

end Krenn.X5ResidualCase316.LeafB3
