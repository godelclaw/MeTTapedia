...
namespace Krenn.Component59.SelectedLeafB4_3_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "67ccabfcd50c706c7652fe39edd5331f19267c7c66a04fd903ac6f093b72afbb"
...
def multipliers : Fin 23 → SparsePoly (Fin 62) := ![
  [{ coefficient := -1, powers := [(38, 1), (43, 1), (59, 1)] }, { coefficient := -1, powers := [(45, 1), (50, 1), (59, 1)] }],
  ...
  [{ coefficient := -1, powers := [(12, 1), (45, 1), (59, 1)] }],
  [{ coefficient := 2, powers := [(5, 1), (57, 1)] }],
  [{ coefficient := 1, powers := [(26, 1), (50, 1)] }],
  [{ coefficient := 1, powers := [(51, 1)] }],
  [{ coefficient := 1, powers := [(37, 1), (45, 1), (59, 1)] }],
  [{ coefficient := -1, powers := [(22, 1)] }],
  [{ coefficient := 1, powers := [(26, 1), (45, 1), (59, 1)] }],
  ...
  [{ coefficient := 2, powers := [(3, 1), (35, 1), (56, 1), (57, 1)] }, { coefficient := 1, powers := [(35, 1), (57, 1)] }, { coefficient := -1, powers := [(37, 1), (45, 1), (51, 1), (59, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (29, 1), (45, 1)] }, { coefficient := -1, powers := [(8, 1), (32, 1), (38, 1)] }, { coefficient := -1, powers := [(17, 1), (26, 1), (38, 1)] }],
  [{ coefficient := 2, powers := [(0, 1), (8, 1), (22, 1), (57, 1)] }, { coefficient := -1, powers := [(12, 1), (18, 1), (26, 1), (45, 1)] }, { coefficient := -1, powers := [(12, 1), (26, 1), (45, 1), (59, 1)] }],
...
#print axioms Krenn.Component59.SelectedLeafB4_3_4.selectedHasNoCommonZero

end Krenn.Component59.SelectedLeafB4_3_4
