...
namespace Krenn.Component59.SelectedLeafB4_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "e0b04704e01a8e851b6526dc044997bd341e4d387de7f4a1310e59774198327d"
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedEquations : Fin 17 → SparsePoly (Fin 59) := ![
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def multipliers : Fin 17 → SparsePoly (Fin 59) := ![
...
#print axioms Krenn.Component59.SelectedLeafB4_0.selectedHasNoCommonZero

end Krenn.Component59.SelectedLeafB4_0
