...
namespace Krenn.Component59.SelectedLeafB4_3_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "89ce4ac4d2cf52178d8bb8fc7b0e18cfc7669df3f39d06eda628e6dcd57792c6"
def certificateSHA256 : String := "3a97e5f58a2ffa3860fa0ed69d88edf321e70e3841c02c35892c023a59d78a85"

set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedSourceIndices : Fin 28 → Fin 620 := ![
  7,
  16,
  20,
  26,
...
def selectedEquations : Fin 28 → SparsePoly (Fin 63) := ![
  ...
  [{ coefficient := 1, powers := [(0, 1), (40, 1), (50, 1)] }, { coefficient := 1, powers := [(3, 1), (57, 1)] }, { coefficient := 1, powers := [(18, 1), (40, 1), (50, 1)] }, { coefficient := 1, powers := [(40, 1), (47, 1)] }],
...
def multipliers : Fin 28 → SparsePoly (Fin 63) := ![
  ...
  [{ coefficient := 1, powers := [(24, 1), (49, 1), (53, 1), (62, 1)] }, { coefficient := -1, powers := [(25, 1), (53, 1), (62, 1)] }, { coefficient := 1, powers := [(31, 1), (34, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (24, 1), (49, 2), (60, 1)] }, { coefficient := 2, powers := [(19, 1), (25, 1), (37, 1), (60, 1)] }, { coefficient := 1, powers := [(19, 1), (25, 1), (42, 1), (60, 1)] }, { coefficient := 1, powers := [(19, 1), (25, 1), (49, 1), (60, 1)] }, { coefficient := 1, powers := [(19, 1), (31, 1), (34, 1), (60, 1)] }, { coefficient := -1, powers := [(20, 1), (37, 1), (44, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(7, 1), (17, 1), (22, 1), (24, 1), (49, 1), (51, 1), (56, 1), (58, 1), (62, 1)] }, { coefficient := -1, powers := [(7, 1), (17, 1), (22, 1), (25, 1), (51, 1), (56, 1), (58, 1), (62, 1)] }, { coefficient := 1, powers := [(7, 1), (17, 1), (22, 1), (28, 1), (42, 1), (51, 1), (58, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(7, 1), (56, 1), (62, 1)] }, { coefficient := -1, powers := [(14, 1), (49, 1), (62, 1)] }, { coefficient := -1, powers := [(14, 1), (53, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (7, 1), (23, 1), (24, 1), (49, 1), (50, 1), (56, 2)] }, { coefficient := 1, powers := [(5, 1), (7, 1), (23, 1), (25, 1), (50, 1), (56, 2)] }, { coefficient := -1, powers := [(5, 1), (7, 1), (23, 1), (28, 1), (42, 1), (50, 1), (56, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (7, 1), (24, 1), (40, 1), (49, 1), (56, 2)] }, { coefficient := -1, powers := [(5, 1), (7, 1), (25, 1), (40, 1), (56, 2)] }, { coefficient := 1, powers := [(5, 1), (7, 1), (28, 1), (40, 1), (42, 1), (56, 1)] }, { coefficient := -1, powers := [(7, 1), (17, 1), (24, 1), (44, 1), (49, 1), (56, 1)] }, { coefficient := 1, powers := [(7, 1), (17, 1), (25, 1), (44, 1), (56, 1)] }, { coefficient := -1, powers := [(7, 1), (17, 1), (28, 1), (42, 1), (44, 1)] }],
  ...
  [{ coefficient := 1, powers := [(5, 1), (7, 1), (24, 1), (49, 1), (56, 1), (57, 1)] }, { coefficient := -1, powers := [(5, 1), (7, 1), (25, 1), (56, 1), (57, 1)] }, { coefficient := 1, powers := [(5, 1), (7, 1), (28, 1), (42, 1), (57, 1)] }],
  [{ coefficient := 1, powers := [(24, 1), (49, 2), (60, 1)] }, { coefficient := -2, powers := [(25, 1), (37, 1), (60, 1)] }, { coefficient := -1, powers := [(25, 1), (42, 1), (60, 1)] }, { coefficient := -1, powers := [(25, 1), (49, 1), (60, 1)] }, { coefficient := -1, powers := [(31, 1), (34, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (7, 1), (24, 1), (26, 1), (49, 1), (50, 1), (56, 2)] }, { coefficient := -1, powers := [(5, 1), (7, 1), (25, 1), (26, 1), (50, 1), (56, 2)] }, { coefficient := 1, powers := [(5, 1), (7, 1), (26, 1), (28, 1), (42, 1), (50, 1), (56, 1)] }],
  ...
  [{ coefficient := -1, powers := [(5, 1), (7, 1), (24, 1), (26, 1), (49, 1), (56, 2)] }, { coefficient := 1, powers := [(5, 1), (7, 1), (25, 1), (26, 1), (56, 2)] }, { coefficient := -1, powers := [(5, 1), (7, 1), (26, 1), (28, 1), (42, 1), (56, 1)] }],
  ...
  [{ coefficient := 1, powers := [(34, 1), (56, 1)] }, { coefficient := -1, powers := [(37, 1), (38, 1), (53, 1), (60, 1)] }, { coefficient := -1, powers := [(37, 1), (44, 1), (50, 1), (60, 1)] }, { coefficient := -1, powers := [(37, 1), (53, 1), (54, 1), (62, 1)] }, { coefficient := 1, powers := [(37, 1), (53, 1)] }],
  ...
  [{ coefficient := -1, powers := [(4, 1), (28, 1), (53, 1)] }, { coefficient := -1, powers := [(7, 1), (17, 1), (18, 1), (22, 1), (24, 1), (49, 1), (51, 1), (56, 1), (58, 1)] }, { coefficient := 1, powers := [(7, 1), (17, 1), (18, 1), (22, 1), (25, 1), (51, 1), (56, 1), (58, 1)] }, { coefficient := -1, powers := [(7, 1), (17, 1), (18, 1), (22, 1), (28, 1), (42, 1), (51, 1), (58, 1)] }, { coefficient := -1, powers := [(7, 1), (21, 1), (56, 1)] }, { coefficient := -1, powers := [(10, 1), (21, 1), (53, 1)] }, { coefficient := -1, powers := [(10, 1), (24, 1), (49, 1), (53, 1)] }, { coefficient := 1, powers := [(10, 1), (25, 1), (53, 1)] }, { coefficient := -1, powers := [(10, 1), (31, 1), (34, 1)] }, { coefficient := 1, powers := [(14, 1), (21, 1), (49, 1)] }, { coefficient := 1, powers := [(14, 1), (21, 1), (53, 1)] }]
]
...
#print axioms Krenn.Component59.SelectedLeafB4_3_3.selectedHasNoCommonZero

end Krenn.Component59.SelectedLeafB4_3_3
