...
namespace Krenn.Component59.SelectedLeafB4_3_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "b47cd2251aaaeb8ed54a2eb56b444e6ee20af819b8b3b40103fa0e25fdbec18d"
...
def multipliers : Fin 28 → SparsePoly (Fin 64) := ![
  ...
  [{ coefficient := 1, powers := [(34, 1), (56, 1)] }, { coefficient := -1, powers := [(37, 1), (38, 1), (53, 1), (60, 1)] }, { coefficient := -1, powers := [(37, 1), (44, 1), (50, 1), (60, 1)] }, { coefficient := -1, powers := [(37, 1), (53, 1), (54, 1), (63, 1)] }, { coefficient := 1, powers := [(37, 1), (53, 1)] }],
...
#print axioms Krenn.Component59.SelectedLeafB4_3_7.selectedHasNoCommonZero

end Krenn.Component59.SelectedLeafB4_3_7
