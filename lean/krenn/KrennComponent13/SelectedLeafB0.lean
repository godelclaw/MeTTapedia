...
namespace Krenn.Component13.SelectedLeafB0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "5f90b0b29040945ac72762926663c3b06a28c408009a3d64a00571f9cf966f83"
def certificateSHA256 : String := "4b8ce8124bff49011b643bdd4596485d168ba02e0f864e44c021530440184096"
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedEquations : Fin 16 → SparsePoly (Fin 58) := ![
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def multipliers : Fin 16 → SparsePoly (Fin 58) := ![
...
#print axioms Krenn.Component13.SelectedLeafB0.selectedHasNoCommonZero

end Krenn.Component13.SelectedLeafB0
