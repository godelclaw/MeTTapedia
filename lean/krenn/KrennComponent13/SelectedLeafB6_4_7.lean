...
namespace Krenn.Component13.SelectedLeafB6_4_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "18b8af1bb2e065d10270f750e91c1599be360208d8e4b954fe34ebfd06f8978b"
...
def multipliers : Fin 5 → SparsePoly (Fin 64) := ![
  [{ coefficient := 1, powers := [(0, 1), (50, 1), (63, 1)] }, { coefficient := 1, powers := [(18, 1), (50, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(63, 1)] }],
  [{ coefficient := -1, powers := [(50, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (41, 1), (50, 1), (63, 1)] }, { coefficient := -1, powers := [(0, 1), (54, 1), (63, 1)] }, { coefficient := -1, powers := [(18, 1), (41, 1), (50, 1), (63, 1)] }],
...
#print axioms Krenn.Component13.SelectedLeafB6_4_7.selectedHasNoCommonZero

end Krenn.Component13.SelectedLeafB6_4_7
