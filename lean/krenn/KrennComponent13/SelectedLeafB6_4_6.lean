...
namespace Krenn.Component13.SelectedLeafB6_4_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "98420a04c22b08c49d8ae5a79649edf218f64e6a0b8d67eef692c9c4bddcbc82"
def certificateSHA256 : String := "143e22dc15c3b89ba81c1aa7eb2b4f5ba18b97e879f271d64ec206ebf2830027"

set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedSourceIndices : Fin 21 → Fin 614 := ![
  7,
  17,
  19,
  155,
...
def multipliers : Fin 21 → SparsePoly (Fin 63) := ![
  [{ coefficient := 1, powers := [(12, 1), (24, 1), (27, 1), (59, 1)] }],
  [{ coefficient := -1, powers := [(26, 1), (51, 1)] }],
  [{ coefficient := -1, powers := [(21, 1), (45, 1)] }],
  [{ coefficient := -1, powers := [(12, 1), (27, 1), (59, 1)] }],
  ...
  [{ coefficient := 1, powers := [(12, 1), (27, 1), (45, 1)] }],
  [{ coefficient := 1, powers := [(36, 1), (57, 1)] }, { coefficient := -1, powers := [(45, 1), (51, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (12, 1), (22, 1), (41, 1), (50, 1)] }, { coefficient := -1, powers := [(12, 1), (18, 1), (22, 1), (41, 1), (50, 1)] }, { coefficient := 1, powers := [(12, 1), (18, 1), (27, 1), (45, 1)] }, { coefficient := 1, powers := [(17, 1), (22, 1), (23, 1), (51, 1)] }, { coefficient := -1, powers := [(17, 1), (23, 1), (30, 1), (36, 1)] }],
...
#print axioms Krenn.Component13.SelectedLeafB6_4_6.selectedHasNoCommonZero

end Krenn.Component13.SelectedLeafB6_4_6
