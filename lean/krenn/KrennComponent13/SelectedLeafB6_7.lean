...
namespace Krenn.Component13.SelectedLeafB6_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "abde3cee5029b2747edafcdd9c45767964edcaaf5f3078c5b732ca661d582291"
def certificateSHA256 : String := "79de5e95c520315f020ad0924ef5715c7663c02d571db835b506bd19bf24fe56"
...
def multipliers : Fin 32 → SparsePoly (Fin 63) := ![
  ...
  [{ coefficient := -1, powers := [(5, 1), (19, 1), (33, 1), (59, 1)] }],
  ...
  [{ coefficient := 1, powers := [(17, 1), (30, 1), (36, 1), (38, 1), (47, 1), (62, 1)] }],
  ...
  [{ coefficient := -1, powers := [(5, 1), (43, 1), (57, 1), (60, 1), (61, 1)] }],
  ...
  [{ coefficient := 1, powers := [(30, 1), (36, 1), (38, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(22, 1)] }],
  [{ coefficient := 1, powers := [(12, 1), (22, 1), (53, 1)] }],
  [{ coefficient := -1, powers := [(17, 1), (30, 1), (36, 1), (38, 1), (62, 1)] }],
  ...
  [{ coefficient := -1, powers := [(5, 1), (30, 1), (37, 1), (54, 1), (60, 1)] }, { coefficient := -1, powers := [(5, 1), (33, 1), (51, 1)] }, { coefficient := -1, powers := [(12, 1), (26, 1), (45, 1), (50, 1)] }, { coefficient := 1, powers := [(12, 1), (27, 1), (45, 1)] }],
  [{ coefficient := 1, powers := [(36, 1), (57, 1)] }, { coefficient := -1, powers := [(38, 1), (39, 1), (54, 1), (61, 1)] }, { coefficient := 1, powers := [(39, 1), (54, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (27, 1), (43, 1), (57, 1), (61, 1)] }, { coefficient := -1, powers := [(5, 1), (30, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (27, 1), (57, 1)] }, { coefficient := -1, powers := [(8, 1), (33, 1), (39, 1)] }, { coefficient := -1, powers := [(17, 1), (23, 1), (30, 1), (36, 1), (38, 1)] }, { coefficient := -1, powers := [(17, 1), (27, 1), (39, 1)] }, { coefficient := -1, powers := [(17, 1), (30, 1), (36, 1)] }],
  [{ coefficient := 1, powers := [(17, 1), (23, 1), (30, 1), (36, 1), (38, 1)] }]
]
...
#print axioms Krenn.Component13.SelectedLeafB6_7.selectedHasNoCommonZero

end Krenn.Component13.SelectedLeafB6_7
