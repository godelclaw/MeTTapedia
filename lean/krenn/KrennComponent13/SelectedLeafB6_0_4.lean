...
namespace Krenn.Component13.SelectedLeafB6_0_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "7b840cb50e2628d6caa019608360483e1c538b4477415d0cb838d968f13e9d9c"
def certificateSHA256 : String := "e527a271357d9ec5bb9cf519354692442b7ce6a0210056465b4cf09ff193cf2f"
...
def multipliers : Fin 15 → SparsePoly (Fin 61) := ![
  ...
  [{ coefficient := 1, powers := [(12, 1), (18, 1), (27, 1), (45, 1)] }, { coefficient := -1, powers := [(12, 1), (18, 1), (33, 1), (36, 1)] }],
...
#print axioms Krenn.Component13.SelectedLeafB6_0_4.selectedHasNoCommonZero

end Krenn.Component13.SelectedLeafB6_0_4
