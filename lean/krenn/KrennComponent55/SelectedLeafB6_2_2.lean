...
namespace Krenn.Component55.SelectedLeafB6_2_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "8fcfcbb1bcadfeb876577d21d632915161b83bc31cf3505ccaccba0494ea9c4c"
def certificateSHA256 : String := "15585dff28538b6befec0df49fa64fc08d63d3c00aedfa1a4bacc5ef4a665d01"
...
def multipliers : Fin 18 → SparsePoly (Fin 62) := ![
  ...
  [{ coefficient := 1, powers := [(6, 1), (38, 1), (56, 1), (57, 1)] }, { coefficient := -1, powers := [(6, 1), (46, 1), (51, 1), (56, 1)] }, { coefficient := 1, powers := [(38, 1), (57, 1)] }, { coefficient := -1, powers := [(46, 1), (51, 1)] }],
...
#print axioms Krenn.Component55.SelectedLeafB6_2_2.selectedHasNoCommonZero

end Krenn.Component55.SelectedLeafB6_2_2
