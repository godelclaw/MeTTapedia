...
namespace Krenn.Component55.SelectedLeafB4_2_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "80d814f7e70fcf7e83cafc92a7462faf9385b5a9ea99f9408286c3f156805cec"
...
def multipliers : Fin 28 → SparsePoly (Fin 62) := ![
  ...
  [{ coefficient := -1, powers := [(24, 1), (54, 1), (60, 1)] }],
  ...
  [{ coefficient := 1, powers := [(54, 1), (60, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := 1, powers := [(6, 1), (38, 1), (56, 1), (57, 1)] }, { coefficient := 1, powers := [(38, 1), (57, 1)] }, { coefficient := -2, powers := [(40, 1), (46, 1), (51, 1), (59, 1)] }, { coefficient := 1, powers := [(46, 1), (51, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (35, 1), (51, 1)] }, { coefficient := -1, powers := [(8, 1), (32, 1), (46, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (52, 1), (54, 1), (60, 1)] }, { coefficient := 1, powers := [(2, 1), (54, 1)] }, { coefficient := 1, powers := [(8, 1), (35, 1)] }],
...
#print axioms Krenn.Component55.SelectedLeafB4_2_5.selectedHasNoCommonZero

end Krenn.Component55.SelectedLeafB4_2_5
