...
namespace Krenn.Component55.SelectedLeafB4_2_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "482b82d5107717c49cb5dae4ab678093fbdc6d35fb344c9d15606cc9a0d577da"
def certificateSHA256 : String := "3f0ea1534cd8684dc665deabfbc74a45ff4f227b5f220af1a3f032527545d01f"
...
def multipliers : Fin 18 → SparsePoly (Fin 61) := ![
  ...
  [{ coefficient := 2, powers := [(3, 1), (18, 1), (32, 1), (46, 1)] }],
  ...
  [{ coefficient := 2, powers := [(3, 1), (46, 1), (56, 1)] }, { coefficient := 1, powers := [(46, 1)] }],
  [{ coefficient := 1, powers := [(6, 1), (29, 1), (57, 1)] }, { coefficient := -1, powers := [(6, 1), (35, 1), (51, 1)] }],
  [{ coefficient := -2, powers := [(3, 1), (32, 1), (46, 1)] }],
  ...
  [{ coefficient := -2, powers := [(3, 1), (46, 1), (51, 1), (56, 1)] }, { coefficient := 1, powers := [(6, 1), (38, 1), (56, 1), (57, 1)] }, { coefficient := -1, powers := [(6, 1), (46, 1), (51, 1), (56, 1)] }, { coefficient := 1, powers := [(38, 1), (57, 1)] }, { coefficient := -1, powers := [(46, 1), (51, 1)] }],
...
#print axioms Krenn.Component55.SelectedLeafB4_2_2.selectedHasNoCommonZero

end Krenn.Component55.SelectedLeafB4_2_2
