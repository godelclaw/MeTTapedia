...
namespace Krenn.Component55.SelectedLeafB4_2_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "391a4dd51b80f0f0ea7c40665e4e241d6f566efd44b16489501b453bf05a576d"
...
def multipliers : Fin 18 → SparsePoly (Fin 63) := ![
  ...
  [{ coefficient := -1, powers := [(24, 1), (54, 1), (60, 1)] }, { coefficient := -2, powers := [(29, 1), (46, 1), (60, 1)] }],
  ...
  [{ coefficient := 1, powers := [(0, 1), (19, 1), (29, 1), (53, 1)] }, { coefficient := -1, powers := [(2, 1), (52, 1), (54, 1), (60, 1)] }, { coefficient := 1, powers := [(2, 1), (54, 1)] }, { coefficient := 1, powers := [(8, 1), (35, 1)] }, { coefficient := -1, powers := [(19, 1), (25, 1), (29, 1), (53, 1)] }],
...
#print axioms Krenn.Component55.SelectedLeafB4_2_7.selectedHasNoCommonZero

end Krenn.Component55.SelectedLeafB4_2_7
