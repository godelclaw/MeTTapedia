...
namespace Krenn.Component55.SelectedLeafB6_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "3e4f4eea70222732b8c80f062d7900e9b7747f35b50f43afb230b942f0269e2d"
def certificateSHA256 : String := "35869a6440271fac3301825360b23281dc71fa5f34507e5306d81823bd8f126b"
...
def multipliers : Fin 23 → SparsePoly (Fin 62) := ![
  ...
  [{ coefficient := 2, powers := [(5, 1), (57, 1), (60, 1), (61, 1)] }],
  [{ coefficient := -2, powers := [(5, 1), (44, 1), (57, 1), (60, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (51, 1), (60, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (29, 1), (53, 1)] }],
  [{ coefficient := -1, powers := [(6, 1), (18, 1), (29, 1), (57, 1)] }],
  [{ coefficient := 2, powers := [(5, 1), (57, 1), (61, 1)] }],
  ...
  [{ coefficient := 1, powers := [(6, 1), (38, 1), (56, 1), (57, 1)] }, { coefficient := 1, powers := [(38, 1), (57, 1)] }, { coefficient := -1, powers := [(39, 1), (46, 1), (51, 1), (60, 1)] }],
  [{ coefficient := 2, powers := [(5, 1), (29, 1), (44, 1), (57, 1), (61, 1)] }, { coefficient := -1, powers := [(5, 1), (32, 1), (54, 1)] }, { coefficient := -1, powers := [(5, 1), (35, 1), (51, 1)] }],
...
#print axioms Krenn.Component55.SelectedLeafB6_6.selectedHasNoCommonZero

end Krenn.Component55.SelectedLeafB6_6
