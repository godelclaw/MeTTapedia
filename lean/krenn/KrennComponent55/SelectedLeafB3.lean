...
namespace Krenn.Component55.SelectedLeafB3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "da1d020ea190ebebf7ab5d2528c1e17cd0206a15b95225df51932f3a75bb0de4"
...
def multipliers : Fin 30 → SparsePoly (Fin 60) := ![
  [{ coefficient := 1, powers := [(2, 1), (6, 1), (30, 1), (38, 1), (57, 1), (59, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (20, 1), (41, 1), (54, 1), (59, 1)] }, { coefficient := -1, powers := [(5, 1), (20, 1), (32, 1), (54, 1), (59, 1)] }, { coefficient := 1, powers := [(5, 1), (20, 1), (35, 1), (51, 1), (59, 1)] }, { coefficient := 1, powers := [(8, 1), (21, 1), (35, 1), (48, 1), (59, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (26, 1), (41, 1), (59, 1)] }, { coefficient := -1, powers := [(5, 1), (26, 1), (32, 1), (59, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (3, 1), (33, 1), (38, 1), (57, 1), (59, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (25, 1), (46, 1), (51, 1), (59, 1)] }, { coefficient := 1, powers := [(8, 1), (25, 1), (32, 1), (46, 1), (59, 1)] }],
...
#print axioms Krenn.Component55.SelectedLeafB3.selectedHasNoCommonZero

end Krenn.Component55.SelectedLeafB3
