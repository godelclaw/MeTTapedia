...
namespace Krenn.Component55.SelectedLeafB6_2_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "950a982e68a9eebfb1eb22dabe66e4f098a3909e2710bba9adc2301b47c279ed"
def certificateSHA256 : String := "e3acc888e56628d9d78e787ce6afdbed32448927556da2579c26bac6b199a25a"
...
def multipliers : Fin 18 → SparsePoly (Fin 64) := ![
  [{ coefficient := 2, powers := [(17, 1), (46, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (54, 1), (61, 1)] }, { coefficient := -2, powers := [(29, 1), (46, 1), (61, 1)] }],
  ...
  [{ coefficient := 2, powers := [(46, 1), (52, 1), (61, 1)] }, { coefficient := -1, powers := [(46, 1)] }],
  ...
  [{ coefficient := 1, powers := [(6, 1), (38, 1), (56, 1), (57, 1)] }, { coefficient := -1, powers := [(6, 1), (46, 1), (51, 1), (56, 1)] }, { coefficient := 1, powers := [(38, 1), (57, 1)] }, { coefficient := -2, powers := [(46, 1), (51, 1), (52, 1), (61, 1)] }, { coefficient := 1, powers := [(46, 1), (51, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (19, 1), (29, 1), (53, 1)] }, { coefficient := -1, powers := [(2, 1), (52, 1), (54, 1), (61, 1)] }, { coefficient := 1, powers := [(2, 1), (54, 1)] }, { coefficient := 1, powers := [(8, 1), (35, 1)] }, { coefficient := -1, powers := [(19, 1), (25, 1), (29, 1), (53, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (32, 1), (54, 1)] }, { coefficient := -2, powers := [(8, 1), (32, 1), (46, 1)] }]
]
...
#print axioms Krenn.Component55.SelectedLeafB6_2_7.selectedHasNoCommonZero

end Krenn.Component55.SelectedLeafB6_2_7
