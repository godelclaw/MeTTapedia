...
namespace Krenn.Component55.SelectedLeafB1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "8feea3ce7c714e283a2048ecf8e92cf74693229e63c22a49b7b12840b17a4605"
def certificateSHA256 : String := "256b0f42da8365db59b262028aaf6dc2ea663a14bb3f29abdfdce45c83fce4d9"

set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedSourceIndices : Fin 30 → Fin 587 := ![
  0,
  1,
  2,
  3,
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedEquations : Fin 30 → SparsePoly (Fin 59) := ![
  ...
  [{ coefficient := 1, powers := [(0, 1), (44, 1), (50, 1)] }, { coefficient := 1, powers := [(44, 1), (48, 1)] }, { coefficient := 1, powers := [(48, 1), (53, 1)] }, { coefficient := 1, powers := [(50, 1)] }],
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def multipliers : Fin 30 → SparsePoly (Fin 59) := ![
  [{ coefficient := 1, powers := [(2, 1), (6, 1), (30, 1), (38, 1), (57, 1), (58, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (20, 1), (41, 1), (54, 1), (58, 1)] }, { coefficient := -1, powers := [(5, 1), (20, 1), (32, 1), (54, 1), (58, 1)] }, { coefficient := 1, powers := [(5, 1), (20, 1), (35, 1), (51, 1), (58, 1)] }, { coefficient := 1, powers := [(8, 1), (21, 1), (35, 1), (48, 1), (58, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (26, 1), (41, 1), (58, 1)] }, { coefficient := -1, powers := [(5, 1), (26, 1), (32, 1), (58, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (3, 1), (33, 1), (38, 1), (57, 1), (58, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (25, 1), (46, 1), (51, 1), (58, 1)] }, { coefficient := 1, powers := [(8, 1), (25, 1), (32, 1), (46, 1), (58, 1)] }],
  ...
  [{ coefficient := 1, powers := [(2, 1), (41, 1), (44, 1)] }, { coefficient := 1, powers := [(5, 1), (32, 1), (44, 1)] }],
  [{ coefficient := 1, powers := [(6, 1), (18, 1), (29, 1), (57, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (41, 1), (43, 1)] }, { coefficient := -1, powers := [(5, 1), (32, 1), (43, 1)] }, { coefficient := 1, powers := [(6, 1), (18, 1), (24, 1), (57, 1)] }],
  ...
  [{ coefficient := 1, powers := [(2, 1), (25, 1), (38, 1), (57, 1)] }],
  [{ coefficient := -1, powers := [(6, 1), (29, 1), (57, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (20, 1), (38, 1), (57, 1)] }],
  [{ coefficient := -1, powers := [(6, 1), (24, 1), (57, 1)] }],
  ...
  [{ coefficient := 1, powers := [(2, 1), (36, 1), (38, 1), (55, 1), (57, 1)] }, { coefficient := 1, powers := [(2, 1), (38, 1), (39, 1), (52, 1), (57, 1)] }, { coefficient := 1, powers := [(2, 1), (38, 1), (42, 1), (47, 1), (57, 1)] }, { coefficient := -1, powers := [(2, 1), (40, 1), (41, 1), (54, 1)] }, { coefficient := -1, powers := [(5, 1), (29, 1), (44, 1), (57, 1)] }, { coefficient := -1, powers := [(5, 1), (32, 1), (40, 1), (54, 1)] }, { coefficient := 1, powers := [(8, 1), (21, 1), (35, 1), (44, 1), (50, 1)] }, { coefficient := -1, powers := [(8, 1), (35, 1), (41, 1), (53, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (3, 1), (33, 1), (38, 1), (47, 1), (57, 1)] }, { coefficient := -1, powers := [(2, 1), (6, 1), (30, 1), (38, 1), (42, 1), (57, 1)] }, { coefficient := 1, powers := [(2, 1), (20, 1), (41, 1), (44, 1), (54, 1)] }, { coefficient := -1, powers := [(2, 1), (25, 1), (46, 1), (49, 1), (51, 1)] }, { coefficient := 1, powers := [(2, 1), (26, 1), (41, 1), (45, 1)] }, { coefficient := 1, powers := [(5, 1), (20, 1), (32, 1), (44, 1), (54, 1)] }, { coefficient := -1, powers := [(5, 1), (20, 1), (35, 1), (44, 1), (51, 1)] }, { coefficient := 1, powers := [(5, 1), (26, 1), (32, 1), (45, 1)] }, { coefficient := -1, powers := [(8, 1), (21, 1), (35, 1), (44, 1), (48, 1)] }, { coefficient := -1, powers := [(8, 1), (25, 1), (32, 1), (46, 1), (49, 1)] }]
]
...
#print axioms Krenn.Component55.SelectedLeafB1.selectedHasNoCommonZero

end Krenn.Component55.SelectedLeafB1
