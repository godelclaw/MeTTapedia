...
namespace Krenn.Component55.SelectedLeafB4_2_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "a7adc35da79b393a594c735287ae35bf6b21e508ef32def60c6661a718b70434"
def certificateSHA256 : String := "6bf1118cf9e5cd8989e42012a9f60aee87635454fecb41d5487cc1dfb090c44d"

set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedSourceIndices : Fin 27 → Fin 593 := ![
  24,
  25,
  31,
  223,
...
def selectedEquations : Fin 27 → SparsePoly (Fin 61) := ![
  ...
  [{ coefficient := 1, powers := [(0, 1), (45, 1), (48, 1)] }, { coefficient := 1, powers := [(6, 1), (57, 1)] }, { coefficient := 1, powers := [(25, 1), (45, 1), (48, 1)] }, { coefficient := 1, powers := [(43, 1), (48, 1)] }],
...
def multipliers : Fin 27 → SparsePoly (Fin 61) := ![
  [{ coefficient := 1, powers := [(45, 1), (51, 1), (59, 1)] }],
  [{ coefficient := -1, powers := [(46, 1), (50, 1), (59, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (20, 1), (45, 1), (56, 1)] }, { coefficient := 1, powers := [(8, 1), (43, 1), (56, 1)] }],
  [{ coefficient := 1, powers := [(29, 1), (46, 1), (50, 1)] }],
  [{ coefficient := -1, powers := [(29, 1), (48, 1)] }],
  [{ coefficient := 1, powers := [(19, 1), (29, 1), (48, 1)] }],
  [{ coefficient := 1, powers := [(19, 1), (51, 1), (59, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (46, 1), (59, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (57, 1)] }],
  [{ coefficient := 1, powers := [(29, 1), (46, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (24, 1), (45, 1), (56, 1)] }],
  [{ coefficient := 1, powers := [(40, 1), (51, 1), (59, 1)] }],
  [{ coefficient := 1, powers := [(40, 1), (46, 1), (59, 1)] }],
  [{ coefficient := -1, powers := [(25, 1), (29, 1), (46, 1)] }, { coefficient := 1, powers := [(29, 1), (46, 1), (59, 1)] }],
  ...
  [{ coefficient := 1, powers := [(38, 1), (57, 1)] }, { coefficient := -2, powers := [(40, 1), (46, 1), (51, 1), (59, 1)] }, { coefficient := 1, powers := [(46, 1), (51, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (35, 1), (51, 1)] }, { coefficient := -1, powers := [(8, 1), (32, 1), (46, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (35, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (19, 1), (29, 1), (41, 1)] }, { coefficient := 1, powers := [(13, 1), (20, 1), (29, 1), (46, 1)] }, { coefficient := 1, powers := [(13, 1), (25, 1), (29, 1), (46, 1)] }, { coefficient := -1, powers := [(13, 1), (29, 1), (46, 1), (59, 1)] }, { coefficient := -1, powers := [(19, 1), (24, 1), (51, 1), (59, 1)] }],
...
#print axioms Krenn.Component55.SelectedLeafB4_2_4.selectedHasNoCommonZero

end Krenn.Component55.SelectedLeafB4_2_4
