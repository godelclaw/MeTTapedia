...
namespace Krenn.Component24RootCommonZero.Chunk4
...
theorem rootBlock_of_base_and_component {R : Type*} [CommRing R]
    ...
    ∀ offset : Fin 40, eval₂Hom (Int.castRingHom R) (rootValues full)
      (Krenn.Component24.Tree.rootEquations ⟨160 + offset.val, by omega⟩).toPoly = 0 := by
...
end Krenn.Component24RootCommonZero.Chunk4
