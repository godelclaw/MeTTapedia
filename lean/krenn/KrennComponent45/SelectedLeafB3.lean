...
namespace Krenn.Component45.SelectedLeafB3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "3c947f3f6cf75b2df1ecd86bf329e10f5b07f0915c21a336958cf17e8706017e"
...
def multipliers : Fin 22 → SparsePoly (Fin 59) := ![
  [{ coefficient := 1, powers := [(2, 1), (6, 1), (31, 1), (39, 1), (56, 1), (58, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (3, 1), (34, 1), (39, 1), (56, 1), (58, 1)] }],
...
#print axioms Krenn.Component45.SelectedLeafB3.selectedHasNoCommonZero

end Krenn.Component45.SelectedLeafB3
