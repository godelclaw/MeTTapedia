...
namespace Krenn.Component45.SelectedLeafB7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "3ba62d20697ac9f4add3e96b93798ee8e8caffa55a2ccf9f93352cf9e6cd9bcf"
def certificateSHA256 : String := "4a4c177e3e83926ae1541bcaca81581d9a1e4dab4f3f2e94a6394b771ba12063"

set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedSourceIndices : Fin 41 → Fin 563 := ![
  0,
  1,
  2,
  4,
...
def selectedEquations : Fin 41 → SparsePoly (Fin 60) := ![
  ...
  [{ coefficient := 1, powers := [(1, 1), (39, 1), (56, 1)] }, { coefficient := 1, powers := [(1, 1), (42, 1), (53, 1)] }, { coefficient := 1, powers := [(1, 1), (46, 1), (50, 1)] }],
...
def multipliers : Fin 41 → SparsePoly (Fin 60) := ![
  [{ coefficient := -1, powers := [(0, 1), (5, 1), (9, 1), (33, 1), (53, 1), (59, 1)] }, { coefficient := 1, powers := [(0, 1), (5, 1), (33, 1), (40, 1), (53, 1), (59, 1)] }, { coefficient := 1, powers := [(5, 1), (6, 1), (31, 1), (33, 1), (53, 1), (59, 1)] }, { coefficient := 1, powers := [(5, 1), (9, 1), (20, 1), (36, 1), (50, 1), (59, 1)] }, { coefficient := -1, powers := [(5, 1), (9, 1), (25, 1), (33, 1), (53, 1), (59, 1)] }, { coefficient := -1, powers := [(5, 1), (20, 1), (36, 1), (40, 1), (50, 1), (59, 1)] }, { coefficient := 1, powers := [(5, 1), (25, 1), (33, 1), (40, 1), (53, 1), (59, 1)] }, { coefficient := 1, powers := [(5, 1), (31, 1), (33, 1), (37, 1), (53, 1), (59, 1)] }],
  [{ coefficient := 1, powers := [(3, 1), (5, 1), (33, 1), (34, 1), (53, 1), (59, 1)] }],
  ...
  [{ coefficient := -1, powers := [(0, 1), (2, 1), (18, 1), (46, 1), (59, 1)] }, { coefficient := -1, powers := [(19, 1), (21, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (9, 1), (36, 1), (43, 1)] }, { coefficient := 1, powers := [(5, 1), (36, 1), (40, 1), (43, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (2, 1), (46, 1), (50, 1), (59, 1)] }],
  ...
  [{ coefficient := -1, powers := [(0, 1), (2, 1), (39, 1), (56, 1), (57, 1), (59, 1)] }, { coefficient := 1, powers := [(2, 1), (39, 1), (56, 1), (59, 1)] }, { coefficient := 1, powers := [(8, 1), (33, 1), (46, 1), (59, 1)] }, { coefficient := 1, powers := [(8, 1), (36, 1), (42, 1), (59, 1)] }],
  ...
  [{ coefficient := 1, powers := [(0, 1), (2, 1), (57, 1), (58, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (5, 1), (33, 1), (53, 1), (59, 1)] }],
  ...
  [{ coefficient := -1, powers := [(0, 1), (2, 1), (37, 1), (39, 1), (55, 1), (56, 1), (57, 1)] }, { coefficient := 1, powers := [(0, 1), (2, 1), (46, 1), (48, 1), (50, 1)] }, { coefficient := 1, powers := [(2, 1), (37, 1), (39, 1), (55, 1), (56, 1)] }, { coefficient := -1, powers := [(2, 1), (42, 1), (53, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (2, 1), (39, 1), (56, 1), (57, 1)] }, { coefficient := -1, powers := [(0, 1), (2, 1), (42, 1), (53, 1), (57, 1)] }, { coefficient := -1, powers := [(0, 1), (2, 1), (46, 1), (50, 1), (57, 1)] }],
...
#print axioms Krenn.Component45.SelectedLeafB7.selectedHasNoCommonZero

end Krenn.Component45.SelectedLeafB7
