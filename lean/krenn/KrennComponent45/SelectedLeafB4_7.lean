...
namespace Krenn.Component45.SelectedLeafB4_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "1d4df4415a0385597e3382252b0301fc7e988512801b1f837cc799db910f6a27"
def certificateSHA256 : String := "d7f167a6509f2d0fedeef31e91673a724155df36d1453ac4956957858d018eb1"
...
def multipliers : Fin 19 → SparsePoly (Fin 61) := ![
  ...
  [{ coefficient := -1, powers := [(21, 1), (30, 1), (49, 1), (58, 1)] }, { coefficient := -1, powers := [(24, 1), (50, 1), (58, 1)] }, { coefficient := -2, powers := [(30, 1), (42, 1), (58, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (33, 1), (46, 1), (57, 1), (60, 1)] }, { coefficient := 1, powers := [(13, 1), (30, 1), (46, 1), (57, 1), (60, 1)] }],
...
#print axioms Krenn.Component45.SelectedLeafB4_7.selectedHasNoCommonZero

end Krenn.Component45.SelectedLeafB4_7
