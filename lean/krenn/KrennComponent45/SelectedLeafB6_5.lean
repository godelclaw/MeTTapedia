...
namespace Krenn.Component45.SelectedLeafB6_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "3419f80ee62e610ee94b5f7840ff1d44aa585e44c8b9ca3054e09fe386a3d241"
...
def multipliers : Fin 18 → SparsePoly (Fin 61) := ![
  [{ coefficient := -1, powers := [(21, 1), (30, 1), (49, 1), (59, 1)] }, { coefficient := 1, powers := [(24, 1), (26, 1), (49, 1), (59, 1)] }, { coefficient := -2, powers := [(24, 1), (50, 1), (59, 1)] }, { coefficient := -2, powers := [(30, 1), (42, 1), (59, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (26, 1), (33, 1), (45, 1), (57, 1), (60, 1)] }, { coefficient := -1, powers := [(8, 1), (33, 1), (46, 1), (57, 1), (60, 1)] }, { coefficient := -1, powers := [(13, 1), (24, 1), (26, 1), (45, 1), (57, 1), (60, 1)] }, { coefficient := 1, powers := [(13, 1), (30, 1), (46, 1), (57, 1), (60, 1)] }],
...
#print axioms Krenn.Component45.SelectedLeafB6_5.selectedHasNoCommonZero

end Krenn.Component45.SelectedLeafB6_5
