...
namespace Krenn.Component45.SelectedLeafB4_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "18008fef38c2bed828674680afbc06c8efab877636a84ae8e5d648a4c62e6312"
def certificateSHA256 : String := "ddc4caaa3179eea69baed2dce707cd6c79d3f4271673b3951bc680b9f56c42c8"

set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedSourceIndices : Fin 19 → Fin 566 := ![
  2,
  4,
  6,
  33,
...
def multipliers : Fin 19 → SparsePoly (Fin 60) := ![
  ...
  [{ coefficient := 1, powers := [(5, 1), (26, 1), (33, 1), (58, 1)] }],
  ...
  [{ coefficient := 1, powers := [(39, 1), (56, 1)] }, { coefficient := -1, powers := [(46, 1), (50, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (33, 1), (53, 1)] }, { coefficient := 1, powers := [(19, 1), (24, 1), (50, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (19, 1), (30, 1), (52, 1)] }, { coefficient := 1, powers := [(2, 1), (53, 1)] }, { coefficient := 1, powers := [(8, 1), (36, 1)] }]
]
...
#print axioms Krenn.Component45.SelectedLeafB4_6.selectedHasNoCommonZero

end Krenn.Component45.SelectedLeafB4_6
