...
namespace Krenn.Component10.SelectedLeafB4_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "550d8d7608eadf239101bd7108b23e8d8e49c2133e92c30a4f9742f49d0cef0d"
...
def multipliers : Fin 40 → SparsePoly (Fin 63) := ![
  [{ coefficient := 2, powers := [(5, 1), (7, 1), (21, 1), (23, 1), (53, 1), (58, 2), (62, 1)] }, { coefficient := 2, powers := [(5, 1), (7, 1), (23, 1), (31, 1), (45, 1), (53, 1), (58, 1), (62, 1)] }, { coefficient := -2, powers := [(8, 1), (23, 1), (58, 1)] }],
  [{ coefficient := -2, powers := [(5, 1), (21, 1), (48, 1), (53, 1), (58, 1), (62, 1)] }, { coefficient := -2, powers := [(5, 1), (31, 1), (45, 1), (48, 1), (53, 1), (62, 1)] }],
  [{ coefficient := -2, powers := [(5, 1), (21, 1), (35, 1), (53, 1), (55, 1), (62, 1)] }, { coefficient := -2, powers := [(5, 1), (34, 1), (35, 1), (37, 1), (53, 1), (62, 1)] }],
  [{ coefficient := 2, powers := [(5, 1), (27, 1), (31, 1), (51, 2), (53, 1), (62, 1)] }, { coefficient := 2, powers := [(5, 1), (27, 1), (31, 1), (51, 1), (53, 1), (55, 1), (62, 1)] }, { coefficient := 2, powers := [(5, 1), (27, 1), (34, 1), (51, 2), (53, 1), (62, 1)] }],
  [{ coefficient := -2, powers := [(5, 1), (11, 1), (35, 1), (51, 1)] }],
  [{ coefficient := -2, powers := [(17, 1), (48, 1)] }],
  [{ coefficient := 2, powers := [(3, 1), (8, 1), (23, 1), (58, 1), (59, 1), (60, 1), (62, 1)] }, { coefficient := 1, powers := [(3, 1), (8, 1), (35, 1), (41, 1), (51, 1), (58, 1), (62, 1)] }, { coefficient := -2, powers := [(3, 1), (8, 1), (35, 1), (41, 1), (58, 1), (60, 1), (62, 1)] }, { coefficient := -2, powers := [(5, 1), (7, 1), (21, 1), (27, 1), (47, 1), (53, 1), (58, 1), (59, 1), (60, 1), (62, 2)] }, { coefficient := -2, powers := [(5, 1), (7, 1), (27, 1), (31, 1), (45, 1), (47, 1), (53, 1), (59, 1), (60, 1), (62, 2)] }, { coefficient := 2, powers := [(5, 1), (32, 1), (46, 1), (52, 1), (62, 1)] }, { coefficient := -1, powers := [(6, 1), (8, 1), (35, 1), (41, 1), (51, 1), (58, 1), (62, 1)] }, { coefficient := 1, powers := [(6, 1), (8, 1), (35, 1), (41, 1), (58, 1), (60, 1), (62, 1)] }, { coefficient := 2, powers := [(8, 1), (19, 1), (27, 1), (47, 1), (59, 1), (60, 2), (62, 1)] }, { coefficient := 2, powers := [(8, 1), (23, 1), (36, 1), (58, 1), (59, 1), (60, 1), (62, 1)] }, { coefficient := 2, powers := [(8, 1), (23, 1), (59, 1), (60, 1), (62, 1)] }, { coefficient := 4, powers := [(8, 1), (27, 1), (47, 1), (59, 1), (60, 1), (62, 1)] }, { coefficient := 1, powers := [(8, 1), (35, 1), (36, 1), (41, 1), (51, 1), (58, 1), (62, 1)] }, { coefficient := -1, powers := [(8, 1), (35, 1), (36, 1), (41, 1), (58, 1), (60, 1), (62, 1)] }, { coefficient := 1, powers := [(8, 1), (35, 1), (41, 1), (51, 1), (62, 1)] }, { coefficient := -1, powers := [(8, 1), (35, 1), (41, 1), (60, 1), (62, 1)] }, { coefficient := -2, powers := [(12, 1), (27, 1), (48, 1), (52, 1), (60, 1), (62, 1)] }, { coefficient := 2, powers := [(12, 1), (29, 1), (48, 1), (60, 1), (62, 1)] }],
  [{ coefficient := 2, powers := [(4, 1), (5, 1), (35, 1), (53, 1), (58, 1), (62, 1)] }, { coefficient := -2, powers := [(5, 1), (15, 1), (35, 1), (45, 1), (53, 1), (62, 1)] }],
  [{ coefficient := -2, powers := [(5, 1), (16, 1), (21, 1), (53, 1), (58, 1), (62, 1)] }, { coefficient := -2, powers := [(5, 1), (16, 1), (31, 1), (45, 1), (53, 1), (62, 1)] }, { coefficient := -2, powers := [(5, 1), (16, 1), (31, 1), (51, 1), (53, 1), (62, 1)] }, { coefficient := -2, powers := [(5, 1), (16, 1), (31, 1), (53, 1), (55, 1), (62, 1)] }, { coefficient := -2, powers := [(5, 1), (16, 1), (34, 1), (51, 1), (53, 1), (62, 1)] }, { coefficient := -2, powers := [(5, 1), (19, 1), (52, 1), (59, 1), (62, 1)] }, { coefficient := 2, powers := [(5, 1), (24, 1), (52, 1), (59, 1), (62, 1)] }],
  [{ coefficient := 2, powers := [(5, 1), (7, 1), (21, 1), (27, 1), (53, 1), (58, 1), (59, 1), (60, 1), (62, 1)] }, { coefficient := 2, powers := [(5, 1), (7, 1), (27, 1), (31, 1), (45, 1), (53, 1), (59, 1), (60, 1), (62, 1)] }, { coefficient := -2, powers := [(8, 1), (19, 1), (27, 1), (59, 1), (60, 2)] }, { coefficient := -4, powers := [(8, 1), (27, 1), (59, 1), (60, 1)] }],
  ...
  [{ coefficient := -2, powers := [(5, 1), (7, 1), (21, 1), (53, 1), (58, 1), (59, 1), (62, 1)] }, { coefficient := -2, powers := [(5, 1), (7, 1), (31, 1), (45, 1), (53, 1), (59, 1), (62, 1)] }, { coefficient := 2, powers := [(8, 1), (19, 1), (59, 1), (60, 1)] }, { coefficient := 4, powers := [(8, 1), (59, 1)] }],
  ...
  [{ coefficient := 2, powers := [(5, 1), (21, 1), (53, 1), (58, 1), (62, 1)] }, { coefficient := 2, powers := [(5, 1), (31, 1), (45, 1), (53, 1), (62, 1)] }],
  ...
  [{ coefficient := 1, powers := [(3, 1), (8, 1), (35, 1), (41, 1), (58, 1)] }, { coefficient := -2, powers := [(5, 1), (7, 1), (21, 1), (27, 1), (47, 1), (53, 1), (58, 1), (59, 1), (62, 1)] }, { coefficient := -2, powers := [(5, 1), (7, 1), (27, 1), (31, 1), (45, 1), (47, 1), (53, 1), (59, 1), (62, 1)] }, { coefficient := 2, powers := [(8, 1), (19, 1), (27, 1), (47, 1), (59, 1), (60, 1)] }, { coefficient := 1, powers := [(8, 1), (19, 1), (35, 1), (41, 2), (55, 1), (62, 1)] }, { coefficient := 2, powers := [(8, 1), (23, 1), (59, 1)] }, { coefficient := 4, powers := [(8, 1), (27, 1), (47, 1), (59, 1)] }, { coefficient := -1, powers := [(8, 1), (35, 1), (41, 1)] }, { coefficient := -2, powers := [(12, 1), (27, 1), (48, 1), (52, 1)] }, { coefficient := 2, powers := [(12, 1), (29, 1), (48, 1)] }],
...
#print axioms Krenn.Component10.SelectedLeafB4_5.selectedHasNoCommonZero

end Krenn.Component10.SelectedLeafB4_5
