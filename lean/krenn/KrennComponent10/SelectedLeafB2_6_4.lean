...
namespace Krenn.Component10.SelectedLeafB2_6_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "0ccbad4a55862c01f7ec64532176850cc36cd402cd47c9ebe711c5511bfd414d"
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedEquations : Fin 12 → SparsePoly (Fin 64) := ![
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def multipliers : Fin 12 → SparsePoly (Fin 64) := ![
...
#print axioms Krenn.Component10.SelectedLeafB2_6_4.selectedHasNoCommonZero

end Krenn.Component10.SelectedLeafB2_6_4
