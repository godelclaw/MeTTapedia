...
namespace Krenn.Component10.SelectedLeafB2_2_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "185522221ea1872aea045e2eb55fdd84b05370a67fbddc2ace38c09398bebde8"
...
def multipliers : Fin 4 → SparsePoly (Fin 65) := ![
  ...
  [{ coefficient := -1, powers := [(40, 1), (56, 1), (64, 1)] }, { coefficient := 1, powers := [(43, 1), (45, 1), (52, 1), (64, 1)] }, { coefficient := -1, powers := [(46, 1), (52, 1), (64, 1)] }],
...
#print axioms Krenn.Component10.SelectedLeafB2_2_7.selectedHasNoCommonZero

end Krenn.Component10.SelectedLeafB2_2_7
