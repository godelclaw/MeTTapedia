...
namespace Krenn.Component10.SelectedLeafB0_2_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "133542bd45189acb95f30390240eb8b117a9e7854c8882ce7f736f085cb87384"
def certificateSHA256 : String := "67eb928552ac809e93d7f076611faff9063412277e5fdabb66586cb98553639c"
...
def multipliers : Fin 17 → SparsePoly (Fin 63) := ![
  ...
  [{ coefficient := 1, powers := [(12, 1), (29, 1), (48, 1), (51, 1)] }, { coefficient := 2, powers := [(18, 1), (23, 1), (45, 1), (53, 1)] }],
...
#print axioms Krenn.Component10.SelectedLeafB0_2_6.selectedHasNoCommonZero

end Krenn.Component10.SelectedLeafB0_2_6
