...
namespace Krenn.Component10.SelectedLeafB0_2_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "c8f0f06d64633da28acd4b642e31f032bee5e49b1645beb503155bf1dcacafb2"
def certificateSHA256 : String := "4c7d70f4c7400311af2b6fea1583ee665055014cd6870d3256569c886577af2f"

set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedSourceIndices : Fin 12 → Fin 644 := ![
  197,
  202,
  284,
  349,
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedEquations : Fin 12 → SparsePoly (Fin 62) := ![
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def multipliers : Fin 12 → SparsePoly (Fin 62) := ![
  ...
  [{ coefficient := -1, powers := [(5, 1), (35, 1), (45, 1), (53, 1)] }, { coefficient := -1, powers := [(8, 1), (32, 1), (48, 1), (51, 1)] }, { coefficient := 1, powers := [(18, 1), (23, 1), (45, 1), (53, 1)] }],
  ...
  [{ coefficient := -1, powers := [(12, 1), (19, 1), (35, 1), (38, 1)] }],
...
#print axioms Krenn.Component10.SelectedLeafB0_2_4.selectedHasNoCommonZero

end Krenn.Component10.SelectedLeafB0_2_4
