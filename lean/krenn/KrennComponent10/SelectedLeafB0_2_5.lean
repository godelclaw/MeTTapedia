...
namespace Krenn.Component10.SelectedLeafB0_2_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "d3532427af53a6353e41042372f0c59006a8e5a9306a06f154532f5425c13169"
...
def multipliers : Fin 4 → SparsePoly (Fin 63) := ![
  ...
  [{ coefficient := -1, powers := [(40, 1), (56, 1), (62, 1)] }, { coefficient := 1, powers := [(43, 1), (45, 1), (52, 1), (62, 1)] }, { coefficient := -1, powers := [(46, 1), (52, 1), (62, 1)] }],
...
#print axioms Krenn.Component10.SelectedLeafB0_2_5.selectedHasNoCommonZero

end Krenn.Component10.SelectedLeafB0_2_5
