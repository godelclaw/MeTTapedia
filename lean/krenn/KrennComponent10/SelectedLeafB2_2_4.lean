...
namespace Krenn.Component10.SelectedLeafB2_2_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "f87f632a37fbeeb31a98b6a3713aa0714348b66fc663e8e8e699ab6cf8dcc3e0"
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedEquations : Fin 12 → SparsePoly (Fin 63) := ![
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def multipliers : Fin 12 → SparsePoly (Fin 63) := ![
...
#print axioms Krenn.Component10.SelectedLeafB2_2_4.selectedHasNoCommonZero

end Krenn.Component10.SelectedLeafB2_2_4
