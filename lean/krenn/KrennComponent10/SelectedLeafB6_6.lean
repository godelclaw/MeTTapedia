...
namespace Krenn.Component10.SelectedLeafB6_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "f1e17325086790ebf660a6aeceb121f3ca74982cc706f32e0c2c57ced10f9036"
def certificateSHA256 : String := "5588d8f5424cf3b32a3dba46d31e100ef91b9ff18267103fba8799371cde58c0"
...
def multipliers : Fin 27 → SparsePoly (Fin 64) := ![
  ...
  [{ coefficient := -1, powers := [(5, 1), (20, 1), (35, 1), (61, 1)] }, { coefficient := 1, powers := [(18, 1), (20, 1), (23, 1), (61, 1)] }],
  ...
  [{ coefficient := -1, powers := [(12, 1), (23, 1), (43, 1), (55, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (35, 1), (61, 1)] }, { coefficient := -1, powers := [(18, 1), (23, 1), (61, 1)] }],
  ...
  [{ coefficient := 1, powers := [(12, 1), (23, 1), (55, 1)] }],
  [{ coefficient := -1, powers := [(3, 1), (32, 1), (60, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(48, 1)] }],
  [{ coefficient := 1, powers := [(12, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := -2, powers := [(5, 1), (29, 1), (59, 1)] }, { coefficient := -1, powers := [(5, 1), (32, 1), (39, 1), (56, 1), (62, 1)] }],
  ...
  [{ coefficient := -2, powers := [(0, 1), (18, 1), (29, 1), (60, 1)] }, { coefficient := 1, powers := [(2, 1), (56, 1)] }, { coefficient := 1, powers := [(8, 1), (35, 1)] }, { coefficient := 1, powers := [(18, 1), (29, 1)] }]
]
...
#print axioms Krenn.Component10.SelectedLeafB6_6.selectedHasNoCommonZero

end Krenn.Component10.SelectedLeafB6_6
