...
namespace Krenn.Component36.SelectedLeafB6_6_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "a68043c02a8d26b9f7dee3f81bef82e3360bfed310b51c0ad1f189927e0b6d1f"
...
def multipliers : Fin 21 → SparsePoly (Fin 69) := ![
  [{ coefficient := -1, powers := [(13, 1), (28, 1), (58, 1), (63, 1), (67, 1)] }, { coefficient := 1, powers := [(13, 1), (29, 1), (43, 1), (63, 1)] }, { coefficient := -1, powers := [(18, 1), (29, 1), (50, 1), (63, 1)] }],
  [{ coefficient := -2, powers := [(13, 1), (29, 1), (63, 1)] }],
  [{ coefficient := -2, powers := [(18, 1), (23, 1), (63, 1)] }],
  [{ coefficient := 2, powers := [(23, 1), (44, 1), (58, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(23, 1), (46, 1)] }],
  [{ coefficient := -1, powers := [(29, 1), (53, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (43, 1)] }],
  [{ coefficient := -2, powers := [(23, 1), (58, 1), (66, 1)] }],
  ...
  [{ coefficient := 1, powers := [(13, 1), (28, 1), (47, 1), (58, 1), (67, 1)] }, { coefficient := -1, powers := [(13, 1), (29, 1), (43, 1), (47, 1)] }, { coefficient := 2, powers := [(13, 1), (29, 1), (48, 1)] }, { coefficient := 2, powers := [(18, 1), (23, 1), (55, 1)] }, { coefficient := 1, powers := [(18, 1), (29, 1), (47, 1), (50, 1)] }],
  [{ coefficient := 1, powers := [(38, 1), (61, 1)] }, { coefficient := -1, powers := [(41, 1), (57, 1), (58, 1), (67, 1)] }, { coefficient := 1, powers := [(41, 1), (58, 1)] }, { coefficient := -1, powers := [(47, 1), (53, 1), (58, 1), (67, 1)] }, { coefficient := -1, powers := [(48, 1), (55, 1)] }],
...
#print axioms Krenn.Component36.SelectedLeafB6_6_7.selectedHasNoCommonZero

end Krenn.Component36.SelectedLeafB6_6_7
