...
namespace Krenn.Component36.SelectedLeafB4_7_6_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "147ec7ad4b31ff75de178a136af47fdbd9c49191a2ba4a273d7980f386750e9b"
...
def multipliers : Fin 18 → SparsePoly (Fin 69) := ![
  ...
  [{ coefficient := 1, powers := [(35, 1), (38, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(23, 1), (55, 1)] }, { coefficient := -1, powers := [(28, 1), (41, 1), (54, 1), (64, 1)] }, { coefficient := 1, powers := [(29, 1), (41, 1), (52, 1), (64, 1)] }, { coefficient := 1, powers := [(32, 1), (38, 1)] }],
  ...
  [{ coefficient := -1, powers := [(13, 1), (29, 1), (48, 1), (52, 1)] }, { coefficient := -1, powers := [(13, 1), (35, 1), (38, 1), (44, 1), (66, 1)] }, { coefficient := 1, powers := [(18, 1), (23, 1), (40, 1), (55, 1)] }, { coefficient := 1, powers := [(18, 1), (28, 1), (40, 1), (41, 1), (54, 1), (64, 1)] }, { coefficient := -1, powers := [(18, 1), (29, 1), (40, 1), (41, 1), (52, 1), (64, 1)] }, { coefficient := -1, powers := [(18, 1), (32, 1), (38, 1), (40, 1)] }]
]
...
#print axioms Krenn.Component36.SelectedLeafB4_7_6_1.selectedHasNoCommonZero

end Krenn.Component36.SelectedLeafB4_7_6_1
