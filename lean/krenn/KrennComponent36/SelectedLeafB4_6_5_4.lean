...
namespace Krenn.Component36.SelectedLeafB4_6_5_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "b56352fae22a46361f8dcb548c119ca20d9f43c97c6c854722071b23ce5975c4"
...
def multipliers : Fin 28 → SparsePoly (Fin 68) := ![
  ...
  [{ coefficient := -1, powers := [(11, 1), (23, 1), (34, 1), (37, 1), (58, 1), (67, 1)] }, { coefficient := 1, powers := [(16, 1), (23, 1), (34, 1), (37, 1), (58, 1), (67, 1)] }],
  ...
  [{ coefficient := 1, powers := [(4, 1), (31, 1)] }, { coefficient := -1, powers := [(11, 1), (21, 1), (24, 1), (67, 1)] }, { coefficient := 1, powers := [(11, 1), (21, 1)] }, { coefficient := -1, powers := [(16, 1), (21, 1)] }],
...
#print axioms Krenn.Component36.SelectedLeafB4_6_5_4.selectedHasNoCommonZero

end Krenn.Component36.SelectedLeafB4_6_5_4
