...
namespace Krenn.Component36.SelectedLeafB4_3_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "0870170813ca8ec03f8ee9ba53f256315a2704eb5dfedd0f6621d45bccd6bd70"
def certificateSHA256 : String := "a5def694cdd8d229bc4d71a9e088a92469dbc70ac0491ab239f683e461e531a6"
...
def multipliers : Fin 27 → SparsePoly (Fin 68) := ![
  [{ coefficient := 1, powers := [(11, 1), (29, 1), (37, 1), (61, 1)] }, { coefficient := 1, powers := [(11, 1), (32, 1), (37, 1), (58, 1)] }, { coefficient := -1, powers := [(16, 1), (29, 1), (37, 1), (61, 1)] }, { coefficient := -1, powers := [(16, 1), (32, 1), (37, 1), (58, 1)] }],
  [{ coefficient := -1, powers := [(11, 1), (23, 1), (34, 1), (37, 1), (46, 1)] }, { coefficient := 1, powers := [(16, 1), (23, 1), (34, 1), (37, 1), (46, 1)] }],
  [{ coefficient := -1, powers := [(11, 1), (23, 1), (34, 1), (37, 1), (45, 1), (55, 1)] }, { coefficient := 1, powers := [(16, 1), (23, 1), (34, 1), (37, 1), (45, 1), (55, 1)] }],
  [{ coefficient := -1, powers := [(7, 1), (43, 1), (60, 1), (67, 1)] }, { coefficient := 1, powers := [(16, 1), (43, 1), (52, 1), (67, 1)] }, { coefficient := 1, powers := [(16, 1), (43, 1), (57, 1), (67, 1)] }, { coefficient := -1, powers := [(17, 1), (57, 1), (67, 1)] }],
  [{ coefficient := 1, powers := [(7, 1), (50, 1), (60, 1), (64, 1)] }, { coefficient := 1, powers := [(11, 1), (45, 1), (50, 1), (64, 1)] }, { coefficient := 1, powers := [(11, 1), (50, 1), (57, 1), (64, 1)] }, { coefficient := -1, powers := [(12, 1), (40, 1), (64, 1)] }, { coefficient := 2, powers := [(16, 1), (40, 1), (50, 1), (64, 1)] }, { coefficient := 1, powers := [(16, 1), (45, 1), (50, 1), (64, 1)] }, { coefficient := 1, powers := [(16, 1), (50, 1), (52, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(11, 1), (34, 1), (37, 1), (47, 1), (55, 1)] }, { coefficient := -1, powers := [(16, 1), (34, 1), (37, 1), (47, 1), (55, 1)] }],
  [{ coefficient := -1, powers := [(11, 1), (18, 1), (34, 1), (37, 1), (47, 1)] }, { coefficient := 1, powers := [(16, 1), (18, 1), (34, 1), (37, 1), (47, 1)] }],
  [{ coefficient := -1, powers := [(7, 1), (60, 1), (64, 1)] }, { coefficient := -1, powers := [(11, 1), (45, 1), (64, 1)] }, { coefficient := -1, powers := [(11, 1), (57, 1), (64, 1)] }, { coefficient := -2, powers := [(16, 1), (40, 1), (64, 1)] }, { coefficient := -1, powers := [(16, 1), (45, 1), (64, 1)] }, { coefficient := -1, powers := [(16, 1), (52, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(7, 1), (60, 1), (67, 1)] }, { coefficient := -1, powers := [(16, 1), (52, 1), (67, 1)] }, { coefficient := -1, powers := [(16, 1), (57, 1), (67, 1)] }],
  [{ coefficient := 1, powers := [(11, 1), (18, 1), (23, 1), (34, 1), (37, 1), (45, 1)] }, { coefficient := -1, powers := [(16, 1), (18, 1), (23, 1), (34, 1), (37, 1), (45, 1)] }],
  [{ coefficient := 1, powers := [(52, 1)] }],
  [{ coefficient := 1, powers := [(45, 1)] }],
  [{ coefficient := 1, powers := [(11, 1), (34, 1), (37, 1), (48, 1)] }, { coefficient := -1, powers := [(16, 1), (34, 1), (37, 1), (48, 1)] }],
  [{ coefficient := -1, powers := [(11, 1), (18, 1), (23, 1), (34, 1), (37, 1)] }, { coefficient := 1, powers := [(16, 1), (18, 1), (23, 1), (34, 1), (37, 1)] }],
  ...
  [{ coefficient := 1, powers := [(37, 1), (60, 1)] }, { coefficient := -1, powers := [(40, 1), (41, 1), (57, 1), (64, 1)] }, { coefficient := -1, powers := [(40, 1), (47, 1), (53, 1), (64, 1)] }, { coefficient := -1, powers := [(40, 1), (57, 1), (58, 1), (67, 1)] }, { coefficient := 1, powers := [(40, 1), (57, 1)] }, { coefficient := -1, powers := [(45, 1), (52, 1)] }, { coefficient := -1, powers := [(46, 1), (54, 1), (57, 1), (67, 1)] }],
  [{ coefficient := 1, powers := [(11, 1), (34, 1), (37, 1), (38, 1), (61, 1)] }, { coefficient := 1, powers := [(11, 1), (34, 1), (37, 1), (41, 1), (58, 1)] }, { coefficient := -1, powers := [(11, 1), (34, 1), (37, 1), (43, 1), (47, 1), (55, 1)] }, { coefficient := -1, powers := [(16, 1), (34, 1), (37, 1), (38, 1), (61, 1)] }, { coefficient := -1, powers := [(16, 1), (34, 1), (37, 1), (41, 1), (58, 1)] }, { coefficient := 1, powers := [(16, 1), (34, 1), (37, 1), (43, 1), (47, 1), (55, 1)] }],
...
#print axioms Krenn.Component36.SelectedLeafB4_3_7.selectedHasNoCommonZero

end Krenn.Component36.SelectedLeafB4_3_7
