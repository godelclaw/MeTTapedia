...
namespace Krenn.Component36.SelectedLeafB4_2_1_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "87b25062c7d3087521b93f247333fa2d6379a66989ae93e690380295f7875ced"
...
def multipliers : Fin 27 → SparsePoly (Fin 67) := ![
  ...
  [{ coefficient := -1, powers := [(3, 1), (16, 1), (23, 1), (26, 1), (45, 1), (58, 1), (60, 1), (65, 1)] }, { coefficient := -1, powers := [(3, 1), (16, 1), (23, 1), (34, 1), (45, 1), (52, 1), (58, 1), (65, 1)] }, { coefficient := -1, powers := [(4, 1), (23, 1), (26, 1), (58, 1), (60, 1), (65, 1)] }, { coefficient := -1, powers := [(7, 1), (23, 1), (34, 1), (40, 1), (58, 1), (65, 1)] }, { coefficient := -1, powers := [(11, 1), (23, 1), (34, 1), (37, 1), (58, 1), (65, 1)] }, { coefficient := 1, powers := [(16, 1), (23, 1), (34, 1), (37, 1), (58, 1), (65, 1)] }],
  ...
  [{ coefficient := 2, powers := [(16, 1), (43, 1), (52, 1), (64, 1)] }, { coefficient := -1, powers := [(16, 1), (43, 1), (64, 1), (65, 1)] }],
  ...
  [{ coefficient := -2, powers := [(16, 1), (52, 1), (64, 1)] }, { coefficient := 1, powers := [(16, 1), (64, 1), (65, 1)] }],
  ...
  [{ coefficient := 1, powers := [(21, 1), (24, 1), (65, 1)] }],
  ...
  [{ coefficient := 1, powers := [(3, 1), (16, 1), (31, 1), (45, 1)] }, { coefficient := 1, powers := [(4, 1), (31, 1)] }, { coefficient := -1, powers := [(11, 1), (21, 1), (24, 1), (65, 1)] }, { coefficient := 1, powers := [(11, 1), (21, 1)] }, { coefficient := -1, powers := [(16, 1), (21, 1)] }],
  [{ coefficient := 2, powers := [(16, 1), (21, 1), (52, 1)] }, { coefficient := -1, powers := [(16, 1), (21, 1), (65, 1)] }],
...
#print axioms Krenn.Component36.SelectedLeafB4_2_1_6.selectedHasNoCommonZero

end Krenn.Component36.SelectedLeafB4_2_1_6
