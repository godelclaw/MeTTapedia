...
namespace Krenn.Component36.SelectedLeafB2_6_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "73d62ebca8e0d73d4750d87e4de6e70fae6539bb7d8fad311298ef6188b4dee0"
...
def multipliers : Fin 7 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := 1, powers := [(25, 1), (43, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(25, 1), (37, 1), (43, 1), (60, 1), (65, 1)] }, { coefficient := -1, powers := [(25, 1), (40, 1), (43, 1), (57, 1), (65, 1)] }, { coefficient := -1, powers := [(25, 1), (43, 1), (45, 1), (52, 1), (65, 1)] }, { coefficient := 1, powers := [(25, 1), (46, 1), (52, 1), (65, 1)] }, { coefficient := -1, powers := [(40, 1), (58, 1), (65, 1)] }, { coefficient := 1, powers := [(43, 1), (45, 1), (54, 1), (65, 1)] }, { coefficient := -1, powers := [(46, 1), (54, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(25, 1), (43, 1), (65, 1)] }],
...
#print axioms Krenn.Component36.SelectedLeafB2_6_1.selectedHasNoCommonZero

end Krenn.Component36.SelectedLeafB2_6_1
