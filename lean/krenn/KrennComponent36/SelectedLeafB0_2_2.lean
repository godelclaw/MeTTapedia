...
namespace Krenn.Component36.SelectedLeafB0_2_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "7d8540e16dd363a9a8d5782437cb90f321c85f3be36d054d237cf3630958aa3b"
def certificateSHA256 : String := "8d80f45f15d8b5667b39375fded2bc8c7bebfe353f8dc66a561fd6dc78d6f025"
...
def multipliers : Fin 22 → SparsePoly (Fin 64) := ![
  ...
  [{ coefficient := 1, powers := [(38, 1), (61, 1)] }, { coefficient := 1, powers := [(41, 1), (58, 1)] }, { coefficient := -1, powers := [(43, 1), (47, 1), (55, 1)] }, { coefficient := -1, powers := [(48, 1), (50, 1), (54, 1)] }, { coefficient := -1, powers := [(48, 1), (55, 1)] }],
...
#print axioms Krenn.Component36.SelectedLeafB0_2_2.selectedHasNoCommonZero

end Krenn.Component36.SelectedLeafB0_2_2
