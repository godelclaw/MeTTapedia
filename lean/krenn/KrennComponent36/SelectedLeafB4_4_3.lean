...
namespace Krenn.Component36.SelectedLeafB4_4_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "75dc11d2191f849c8d9e3b501e85d181dc9b9da01903b80540218d68f124143d"
def certificateSHA256 : String := "285302c77a9a639f364ecc3019f991f304658c4ad0f50ab6ff93a824c6d649ed"
...
def multipliers : Fin 39 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := -1, powers := [(7, 1), (43, 1), (60, 1), (65, 1)] }, { coefficient := -1, powers := [(17, 1), (57, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(7, 1), (26, 1), (48, 1), (54, 1), (60, 1)] }],
  [{ coefficient := -1, powers := [(26, 1), (45, 1), (46, 1), (54, 1), (65, 1)] }, { coefficient := -1, powers := [(26, 1), (46, 1), (54, 1), (57, 1), (65, 1)] }, { coefficient := 1, powers := [(34, 1), (37, 1), (46, 1), (54, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(26, 1), (45, 1), (46, 1), (65, 1)] }, { coefficient := 1, powers := [(26, 1), (46, 1), (57, 1), (65, 1)] }, { coefficient := -1, powers := [(34, 1), (37, 1), (46, 1), (65, 1)] }],
  ...
  [{ coefficient := 1, powers := [(26, 1), (45, 1), (54, 1), (65, 1)] }, { coefficient := 1, powers := [(26, 1), (54, 1), (57, 1), (65, 1)] }, { coefficient := -1, powers := [(34, 1), (37, 1), (54, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(16, 1), (26, 1), (52, 1), (54, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(7, 1), (26, 1), (29, 1), (60, 1)] }, { coefficient := 1, powers := [(16, 1), (29, 1), (31, 1), (37, 1)] }],
  [{ coefficient := 1, powers := [(16, 1), (23, 1), (31, 1), (37, 1)] }],
  [{ coefficient := 1, powers := [(25, 1), (26, 1), (46, 1), (52, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (26, 1), (46, 1), (52, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(26, 1), (45, 1), (65, 1)] }, { coefficient := -1, powers := [(26, 1), (57, 1), (65, 1)] }, { coefficient := 1, powers := [(34, 1), (37, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(7, 1), (13, 1), (26, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(57, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(26, 1)] }],
  [{ coefficient := -1, powers := [(16, 1), (26, 1), (52, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := 1, powers := [(7, 1), (26, 1), (60, 1)] }, { coefficient := -1, powers := [(16, 1), (31, 1), (37, 1)] }],
  [{ coefficient := 1, powers := [(37, 1), (60, 1)] }, { coefficient := -1, powers := [(40, 1), (57, 1), (58, 1), (65, 1)] }, { coefficient := 1, powers := [(40, 1), (57, 1)] }, { coefficient := -1, powers := [(45, 1), (52, 1)] }, { coefficient := -1, powers := [(46, 1), (54, 1), (57, 1), (65, 1)] }],
  ...
  [{ coefficient := 1, powers := [(0, 1), (16, 1), (26, 1), (52, 1), (58, 1), (65, 1)] }, { coefficient := 1, powers := [(7, 1), (18, 1), (24, 1), (26, 1), (32, 1), (38, 1), (60, 1)] }, { coefficient := 1, powers := [(7, 1), (34, 1)] }, { coefficient := 1, powers := [(16, 1), (18, 1), (23, 1), (24, 1), (31, 1), (37, 1), (55, 1)] }, { coefficient := -1, powers := [(16, 1), (18, 1), (24, 1), (31, 1), (32, 1), (37, 1), (38, 1)] }, { coefficient := -1, powers := [(16, 1), (18, 1), (24, 1), (32, 1), (34, 1), (37, 1), (38, 1)] }, { coefficient := -1, powers := [(16, 1), (24, 1), (26, 1), (43, 1), (52, 1), (54, 1), (65, 1)] }, { coefficient := 1, powers := [(16, 1), (25, 1), (26, 1), (43, 1), (52, 1), (65, 1)] }, { coefficient := -1, powers := [(17, 1), (24, 1), (26, 1), (45, 1), (54, 1), (65, 1)] }, { coefficient := -1, powers := [(17, 1), (24, 1), (26, 1), (54, 1), (57, 1), (65, 1)] }, { coefficient := 1, powers := [(17, 1), (24, 1), (34, 1), (37, 1), (54, 1), (65, 1)] }, { coefficient := 1, powers := [(17, 1), (25, 1), (26, 1), (45, 1), (65, 1)] }, { coefficient := 1, powers := [(17, 1), (25, 1), (26, 1), (57, 1), (65, 1)] }, { coefficient := -1, powers := [(17, 1), (25, 1), (34, 1), (37, 1), (65, 1)] }],
...
#print axioms Krenn.Component36.SelectedLeafB4_4_3.selectedHasNoCommonZero

end Krenn.Component36.SelectedLeafB4_4_3
