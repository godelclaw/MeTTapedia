...
namespace Krenn.Component36.SelectedLeafB1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "2318154abde1cfd166793a6d38082bb8e1cab494d4d0687eb9e661fd472c6986"
def certificateSHA256 : String := "41f7101bae09df516b402f3b10f4132085478a87e50b9e2f268a213631aa1829"

set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedSourceIndices : Fin 34 → Fin 666 := ![
  5,
  7,
  9,
  10,
...
def multipliers : Fin 34 → SparsePoly (Fin 63) := ![
  [{ coefficient := 1, powers := [(2, 1), (20, 1), (50, 1), (58, 1), (62, 1)] }, { coefficient := -1, powers := [(4, 1), (5, 1), (32, 1), (34, 1), (58, 1), (62, 1)] }, { coefficient := -1, powers := [(5, 1), (7, 1), (32, 1), (34, 1), (58, 1), (62, 1)] }, { coefficient := -1, powers := [(5, 1), (11, 1), (21, 1), (32, 1), (58, 1), (62, 1)] }, { coefficient := -1, powers := [(5, 1), (16, 1), (26, 1), (32, 1), (58, 1), (62, 1)] }, { coefficient := 1, powers := [(13, 1), (19, 1), (35, 1), (38, 1), (62, 1)] }, { coefficient := -1, powers := [(18, 1), (19, 1), (23, 1), (55, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(4, 1), (5, 1), (32, 1), (34, 1), (58, 1), (62, 1)] }, { coefficient := -1, powers := [(5, 1), (7, 1), (32, 1), (34, 1), (58, 1), (62, 1)] }, { coefficient := 1, powers := [(8, 1), (24, 1), (32, 1), (48, 1), (62, 1)] }, { coefficient := 1, powers := [(18, 1), (24, 1), (32, 1), (38, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(4, 1), (32, 1), (52, 1), (58, 1)] }, { coefficient := -1, powers := [(7, 1), (32, 1), (57, 1), (58, 1)] }, { coefficient := 1, powers := [(11, 1), (32, 1), (37, 1), (58, 1)] }, { coefficient := -1, powers := [(16, 1), (32, 1), (37, 1), (58, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (27, 1), (50, 1), (58, 1), (62, 1)] }, { coefficient := -1, powers := [(4, 1), (21, 1), (32, 1), (58, 1)] }, { coefficient := -1, powers := [(27, 1), (36, 1), (54, 1), (61, 1)] }, { coefficient := 1, powers := [(29, 1), (36, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(23, 1), (36, 1), (61, 1)] }, { coefficient := -1, powers := [(35, 1), (36, 1), (41, 1)] }],
  [{ coefficient := -1, powers := [(23, 1), (46, 1)] }],
  [{ coefficient := -1, powers := [(29, 1), (53, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (50, 1), (58, 1), (62, 1)] }, { coefficient := 1, powers := [(36, 1), (54, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (35, 1), (38, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (32, 1), (38, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (35, 1), (41, 1), (62, 1)] }, { coefficient := 1, powers := [(38, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(35, 1), (38, 1)] }],
  [{ coefficient := 1, powers := [(32, 1), (38, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (32, 1), (52, 1)] }],
  [{ coefficient := 1, powers := [(18, 1), (23, 1), (45, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (32, 1), (40, 1), (58, 1)] }, { coefficient := -1, powers := [(5, 1), (32, 1), (52, 1), (58, 1)] }, { coefficient := -1, powers := [(5, 1), (32, 1), (57, 1), (58, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (32, 1), (45, 1), (58, 1)] }],
  ...
  [{ coefficient := -1, powers := [(2, 1), (20, 1), (58, 1)] }],
  [{ coefficient := -1, powers := [(36, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (21, 1), (32, 1), (58, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (16, 1), (32, 1), (58, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (58, 1)] }],
  [{ coefficient := 1, powers := [(4, 1), (5, 1), (32, 1), (34, 1), (58, 1)] }, { coefficient := 1, powers := [(5, 1), (7, 1), (32, 1), (34, 1), (58, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (32, 1), (58, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := 1, powers := [(2, 1), (20, 1), (45, 1), (53, 1), (58, 1)] }, { coefficient := -1, powers := [(2, 1), (41, 1), (57, 1), (58, 1)] }, { coefficient := -1, powers := [(2, 1), (47, 1), (53, 1), (58, 1)] }, { coefficient := -1, powers := [(4, 1), (5, 1), (32, 1), (34, 1), (37, 1), (58, 1), (60, 1)] }, { coefficient := -1, powers := [(4, 1), (5, 1), (32, 1), (34, 1), (40, 1), (57, 1), (58, 1)] }, { coefficient := -1, powers := [(4, 1), (5, 1), (32, 1), (34, 1), (45, 1), (52, 1), (58, 1)] }, { coefficient := -1, powers := [(5, 1), (7, 1), (32, 1), (34, 1), (37, 1), (58, 1), (60, 1)] }, { coefficient := -1, powers := [(5, 1), (7, 1), (32, 1), (34, 1), (40, 1), (57, 1), (58, 1)] }, { coefficient := -1, powers := [(5, 1), (7, 1), (32, 1), (34, 1), (45, 1), (52, 1), (58, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (32, 1), (37, 1), (58, 1), (60, 1)] }, { coefficient := 1, powers := [(5, 1), (32, 1), (40, 1), (45, 1), (58, 1)] }, { coefficient := 1, powers := [(5, 1), (32, 1), (40, 1), (57, 1), (58, 1)] }, { coefficient := 1, powers := [(5, 1), (32, 1), (45, 1), (52, 1), (58, 1)] }, { coefficient := 1, powers := [(5, 1), (32, 1), (45, 1), (57, 1), (58, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (20, 1), (45, 1), (50, 1), (58, 1)] }, { coefficient := 1, powers := [(2, 1), (47, 1), (50, 1), (58, 1)] }, { coefficient := 1, powers := [(4, 1), (5, 1), (32, 1), (34, 1), (45, 1), (58, 1)] }, { coefficient := -1, powers := [(4, 1), (5, 1), (32, 1), (34, 1), (52, 1), (58, 1)] }, { coefficient := 1, powers := [(5, 1), (7, 1), (32, 1), (34, 1), (45, 1), (58, 1)] }, { coefficient := 1, powers := [(5, 1), (7, 1), (32, 1), (34, 1), (52, 1), (58, 1)] }, { coefficient := 1, powers := [(5, 1), (11, 1), (21, 1), (32, 1), (45, 1), (58, 1)] }, { coefficient := 1, powers := [(5, 1), (16, 1), (26, 1), (32, 1), (45, 1), (58, 1)] }, { coefficient := -1, powers := [(8, 1), (24, 1), (32, 1), (48, 1), (52, 1)] }, { coefficient := -1, powers := [(8, 1), (35, 1), (36, 1), (41, 1), (60, 1)] }, { coefficient := -1, powers := [(8, 1), (35, 1), (41, 1)] }, { coefficient := -1, powers := [(13, 1), (19, 1), (35, 1), (38, 1), (45, 1)] }, { coefficient := 1, powers := [(18, 1), (19, 1), (23, 1), (45, 1), (55, 1)] }, { coefficient := -1, powers := [(18, 1), (24, 1), (32, 1), (38, 1), (52, 1)] }]
]
...
#print axioms Krenn.Component36.SelectedLeafB1.selectedHasNoCommonZero

end Krenn.Component36.SelectedLeafB1
