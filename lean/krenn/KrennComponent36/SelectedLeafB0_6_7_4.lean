...
namespace Krenn.Component36.SelectedLeafB0_6_7_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "5713465c12ccb704ccfe70bd749914f319f634e76e25a262c3a95a0050d7c501"
def certificateSHA256 : String := "177b5c52d91f775807213462cbeaeacdd0d7e08a3d4eb87bcf3a845953f988a6"
...
def multipliers : Fin 19 → SparsePoly (Fin 68) := ![
  ...
  [{ coefficient := 2, powers := [(23, 1), (51, 1), (55, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(23, 1), (58, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (43, 1)] }],
  [{ coefficient := -2, powers := [(23, 1), (55, 1), (62, 1)] }],
...
#print axioms Krenn.Component36.SelectedLeafB0_6_7_4.selectedHasNoCommonZero

end Krenn.Component36.SelectedLeafB0_6_7_4
