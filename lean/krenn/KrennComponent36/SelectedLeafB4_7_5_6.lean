...
namespace Krenn.Component36.SelectedLeafB4_7_5_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "92102345debe7906b8aea002c6324ef94dbb4b97282cdc40aab6f46fab7caaf0"
...
def multipliers : Fin 4 → SparsePoly (Fin 70) := ![
  [{ coefficient := -1, powers := [(50, 1), (65, 1), (69, 1)] }],
  [{ coefficient := 1, powers := [(65, 1), (69, 1)] }],
  [{ coefficient := -1, powers := [(26, 1), (69, 1)] }],
...
#print axioms Krenn.Component36.SelectedLeafB4_7_5_6.selectedHasNoCommonZero

end Krenn.Component36.SelectedLeafB4_7_5_6
