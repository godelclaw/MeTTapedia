...
namespace Krenn.Component36.SelectedLeafB4_6_7_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "e1d88b054bd73337725ca6f6221f37a0337d5b003e6d840057fbc757445d4d73"
...
def multipliers : Fin 35 → SparsePoly (Fin 69) := ![
  ...
  [{ coefficient := 1, powers := [(11, 1), (43, 1), (52, 1), (67, 1)] }, { coefficient := 2, powers := [(11, 1), (43, 1), (57, 1), (67, 1)] }, { coefficient := -1, powers := [(17, 1), (57, 1), (67, 1)] }],
  ...
  [{ coefficient := -1, powers := [(11, 1), (52, 1), (67, 1)] }, { coefficient := -2, powers := [(11, 1), (57, 1), (67, 1)] }],
  ...
  [{ coefficient := 1, powers := [(37, 1), (60, 1)] }, { coefficient := -1, powers := [(39, 1), (40, 1), (57, 1), (63, 1)] }, { coefficient := -1, powers := [(40, 1), (51, 1), (63, 1)] }, { coefficient := -1, powers := [(40, 1), (57, 1), (58, 1), (67, 1)] }, { coefficient := 1, powers := [(40, 1), (57, 1)] }, { coefficient := -1, powers := [(45, 1), (52, 1)] }, { coefficient := -1, powers := [(46, 1), (54, 1), (57, 1), (67, 1)] }],
...
#print axioms Krenn.Component36.SelectedLeafB4_6_7_1.selectedHasNoCommonZero

end Krenn.Component36.SelectedLeafB4_6_7_1
