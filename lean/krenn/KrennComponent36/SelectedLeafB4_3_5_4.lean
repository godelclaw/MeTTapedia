...
namespace Krenn.Component36.SelectedLeafB4_3_5_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "f58846a0652961115e209f7d78e8aa2149f732d48e849730e8831977f5110125"
def certificateSHA256 : String := "3cf0199e273553dff444bb7e7583de6416347294017c1a2d87c49d6652bbf814"
...
def multipliers : Fin 21 → SparsePoly (Fin 68) := ![
  [{ coefficient := -1, powers := [(23, 1), (56, 1), (58, 1), (65, 1), (67, 1)] }, { coefficient := -1, powers := [(23, 1), (58, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(23, 1), (46, 1)] }],
  [{ coefficient := -2, powers := [(23, 1), (45, 1), (55, 1)] }],
  [{ coefficient := -1, powers := [(20, 1), (44, 1), (58, 1), (65, 1)] }],
  ...
  [{ coefficient := 1, powers := [(38, 1), (61, 1)] }, { coefficient := -1, powers := [(40, 1), (41, 1), (58, 1), (63, 1)] }, { coefficient := -1, powers := [(41, 1), (46, 1), (54, 1), (63, 1)] }, { coefficient := -1, powers := [(41, 1), (56, 1), (58, 1), (65, 1)] }, { coefficient := 1, powers := [(41, 1), (58, 1)] }, { coefficient := -1, powers := [(48, 1), (55, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (35, 1), (41, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (32, 1), (58, 1)] }],
  [{ coefficient := 1, powers := [(13, 1), (23, 1), (56, 1), (58, 1), (65, 1)] }, { coefficient := 1, powers := [(13, 1), (23, 1), (58, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (61, 1)] }, { coefficient := 1, powers := [(13, 1), (43, 1), (47, 1)] }, { coefficient := -1, powers := [(13, 1), (48, 1)] }, { coefficient := 1, powers := [(18, 1), (41, 1), (45, 1), (63, 1)] }, { coefficient := -1, powers := [(18, 1), (47, 1), (50, 1)] }]
]
...
#print axioms Krenn.Component36.SelectedLeafB4_3_5_4.selectedHasNoCommonZero

end Krenn.Component36.SelectedLeafB4_3_5_4
