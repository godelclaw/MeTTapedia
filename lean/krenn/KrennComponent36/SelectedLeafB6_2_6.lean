...
namespace Krenn.Component36.SelectedLeafB6_2_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "930e0b170faf671ca424a72919071aac2817651308d72edd96aa62206a557e0b"
def certificateSHA256 : String := "a867b00abafb9eb0e1ad47e0a71f7110161b3c80d5296f3a6286fcbf62f52f44"
...
def multipliers : Fin 17 → SparsePoly (Fin 67) := ![
  ...
  [{ coefficient := -1, powers := [(13, 1), (29, 1), (43, 1), (47, 1)] }, { coefficient := 2, powers := [(13, 1), (29, 1), (48, 1)] }, { coefficient := 2, powers := [(18, 1), (23, 1), (55, 1)] }, { coefficient := 1, powers := [(18, 1), (29, 1), (47, 1), (50, 1)] }],
...
#print axioms Krenn.Component36.SelectedLeafB6_2_6.selectedHasNoCommonZero

end Krenn.Component36.SelectedLeafB6_2_6
