...
namespace Krenn.Component36.SelectedLeafB4_3_5_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "ee06b62f857e7a39ca084db0a1e709b7e82aefea81a49bc87db4563c8cd0a3a9"
...
def multipliers : Fin 9 → SparsePoly (Fin 67) := ![
  ...
  [{ coefficient := -1, powers := [(0, 1), (41, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(20, 1), (40, 1), (53, 1), (64, 1)] }, { coefficient := -1, powers := [(20, 1), (45, 1), (53, 1), (64, 1)] }, { coefficient := -1, powers := [(41, 1), (45, 1), (64, 1)] }, { coefficient := 1, powers := [(47, 1), (53, 1), (64, 1)] }]
]
...
#print axioms Krenn.Component36.SelectedLeafB4_3_5_0.selectedHasNoCommonZero

end Krenn.Component36.SelectedLeafB4_3_5_0
