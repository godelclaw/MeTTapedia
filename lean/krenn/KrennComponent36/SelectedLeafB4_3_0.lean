...
namespace Krenn.Component36.SelectedLeafB4_3_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "89ead19ffe3b1cb9ef2d93e028a292ce84e08061bde05d3c3d1f2ce6f4172534"
def certificateSHA256 : String := "3ee0857bfcc54d360f375a5cf23abe010c4ac4708377a8642d670dca60a734e9"
...
def multipliers : Fin 36 → SparsePoly (Fin 65) := ![
  [{ coefficient := 1, powers := [(7, 1), (21, 1), (29, 1), (61, 1)] }, { coefficient := 1, powers := [(7, 1), (21, 1), (35, 1), (55, 1)] }],
  ...
  [{ coefficient := -1, powers := [(7, 1), (21, 1), (23, 1), (45, 1), (55, 1), (60, 1)] }],
  [{ coefficient := -1, powers := [(11, 1), (29, 1), (34, 1), (37, 1), (53, 1)] }, { coefficient := 1, powers := [(16, 1), (29, 1), (34, 1), (37, 1), (53, 1)] }],
  [{ coefficient := 1, powers := [(7, 1), (50, 1), (60, 1), (64, 1)] }, { coefficient := 1, powers := [(11, 1), (45, 1), (50, 1), (64, 1)] }, { coefficient := -1, powers := [(12, 1), (40, 1), (64, 1)] }, { coefficient := 2, powers := [(16, 1), (40, 1), (50, 1), (64, 1)] }, { coefficient := 1, powers := [(16, 1), (45, 1), (50, 1), (64, 1)] }, { coefficient := 1, powers := [(16, 1), (50, 1), (52, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(7, 1), (21, 1), (47, 1), (55, 1), (60, 1)] }],
  [{ coefficient := -1, powers := [(21, 1), (47, 1), (52, 1), (53, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(7, 1), (18, 1), (21, 1), (47, 1), (60, 1)] }],
  [{ coefficient := -1, powers := [(7, 1), (60, 1), (64, 1)] }, { coefficient := -1, powers := [(11, 1), (45, 1), (64, 1)] }, { coefficient := -2, powers := [(16, 1), (40, 1), (64, 1)] }, { coefficient := -1, powers := [(16, 1), (45, 1), (64, 1)] }, { coefficient := -1, powers := [(16, 1), (52, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(11, 1), (18, 1), (32, 1), (37, 1)] }, { coefficient := -1, powers := [(16, 1), (18, 1), (32, 1), (37, 1)] }],
  [{ coefficient := 1, powers := [(21, 1), (52, 1), (53, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(7, 1), (21, 1), (35, 1), (38, 1), (60, 1)] }, { coefficient := -1, powers := [(11, 1), (29, 1), (34, 1), (37, 1), (48, 1)] }, { coefficient := 1, powers := [(16, 1), (29, 1), (34, 1), (37, 1), (48, 1)] }],
  [{ coefficient := 1, powers := [(7, 1), (18, 1), (21, 1), (23, 1), (45, 1), (60, 1)] }],
  ...
  [{ coefficient := -1, powers := [(7, 1), (18, 1), (21, 1), (23, 1), (60, 1)] }],
  ...
  [{ coefficient := 1, powers := [(21, 1), (47, 1), (52, 1), (64, 1)] }],
  ...
  [{ coefficient := -1, powers := [(21, 1), (52, 1), (64, 1)] }],
  ...
  [{ coefficient := 1, powers := [(37, 1), (60, 1)] }, { coefficient := -1, powers := [(40, 1), (41, 1), (57, 1), (64, 1)] }, { coefficient := -1, powers := [(40, 1), (47, 1), (53, 1), (64, 1)] }, { coefficient := 1, powers := [(40, 1), (57, 1)] }, { coefficient := -1, powers := [(45, 1), (52, 1)] }],
  [{ coefficient := 1, powers := [(7, 1), (21, 1), (38, 1), (60, 1), (61, 1)] }, { coefficient := 1, powers := [(7, 1), (21, 1), (41, 1), (58, 1), (60, 1)] }, { coefficient := -1, powers := [(7, 1), (21, 1), (43, 1), (47, 1), (55, 1), (60, 1)] }, { coefficient := 1, powers := [(11, 1), (34, 1), (37, 1), (38, 1), (61, 1)] }, { coefficient := 1, powers := [(11, 1), (34, 1), (37, 1), (41, 1), (58, 1)] }, { coefficient := -1, powers := [(16, 1), (34, 1), (37, 1), (38, 1), (61, 1)] }, { coefficient := -1, powers := [(16, 1), (34, 1), (37, 1), (41, 1), (58, 1)] }],
  [{ coefficient := 1, powers := [(7, 1), (26, 1), (60, 1)] }, { coefficient := -1, powers := [(7, 1), (34, 1), (40, 1)] }, { coefficient := 1, powers := [(11, 1), (26, 1), (45, 1)] }, { coefficient := 1, powers := [(16, 1), (21, 1), (52, 1)] }, { coefficient := 1, powers := [(16, 1), (26, 1), (40, 1)] }, { coefficient := 1, powers := [(16, 1), (26, 1), (45, 1)] }, { coefficient := 1, powers := [(16, 1), (26, 1), (52, 1)] }],
  [{ coefficient := 1, powers := [(4, 1), (31, 1)] }, { coefficient := -1, powers := [(7, 1), (13, 1), (19, 1), (21, 1), (35, 1), (38, 1), (60, 1)] }, { coefficient := 1, powers := [(11, 1), (13, 1), (19, 1), (29, 1), (34, 1), (37, 1), (48, 1)] }, { coefficient := 1, powers := [(11, 1), (21, 1)] }, { coefficient := -1, powers := [(11, 1), (26, 1)] }, { coefficient := -1, powers := [(12, 1), (19, 1), (21, 1), (47, 1), (52, 1), (64, 1)] }, { coefficient := 1, powers := [(12, 1), (20, 1), (21, 1), (52, 1), (64, 1)] }, { coefficient := -1, powers := [(13, 1), (16, 1), (19, 1), (29, 1), (34, 1), (37, 1), (48, 1)] }, { coefficient := -1, powers := [(16, 1), (21, 1)] }],
...
#print axioms Krenn.Component36.SelectedLeafB4_3_0.selectedHasNoCommonZero

end Krenn.Component36.SelectedLeafB4_3_0
