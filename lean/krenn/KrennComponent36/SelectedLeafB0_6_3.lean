...
namespace Krenn.Component36.SelectedLeafB0_6_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "39c84220e2ef72a1c42004d5de738696935819a14b4ece1450f73d96c726dc16"
def certificateSHA256 : String := "d0af0c6393a07a2b21a561e0e611fc95495faac9a47e20a0604d8147b43d4f72"

set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedSourceIndices : Fin 38 → Fin 672 := ![
  9,
  10,
  15,
  18,
...
def multipliers : Fin 38 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := 2, powers := [(3, 1), (16, 1), (26, 1), (29, 1), (45, 1), (61, 1)] }, { coefficient := 1, powers := [(3, 1), (16, 1), (26, 1), (32, 1), (45, 1), (58, 1)] }, { coefficient := -2, powers := [(4, 1), (21, 1), (29, 1), (61, 1)] }, { coefficient := -1, powers := [(4, 1), (21, 1), (32, 1), (58, 1)] }, { coefficient := -1, powers := [(6, 1), (35, 1), (55, 1)] }],
  [{ coefficient := 1, powers := [(23, 1), (40, 1), (43, 1)] }],
  [{ coefficient := -1, powers := [(23, 1), (45, 1), (55, 1)] }, { coefficient := -1, powers := [(23, 1), (53, 1), (54, 1)] }, { coefficient := -1, powers := [(27, 1), (47, 1), (51, 1), (55, 1), (62, 1)] }, { coefficient := -1, powers := [(29, 1), (47, 1), (53, 1)] }],
  [{ coefficient := 1, powers := [(29, 1), (53, 1)] }],
  [{ coefficient := 2, powers := [(5, 1), (11, 1), (29, 1), (43, 1), (45, 1), (61, 1), (65, 1)] }, { coefficient := 1, powers := [(5, 1), (11, 1), (32, 1), (43, 1), (45, 1), (58, 1), (65, 1)] }],
  [{ coefficient := -2, powers := [(5, 1), (16, 1), (29, 1), (40, 1), (45, 1), (61, 1), (65, 1)] }, { coefficient := -2, powers := [(5, 1), (16, 1), (29, 1), (45, 2), (61, 1), (65, 1)] }, { coefficient := -2, powers := [(5, 1), (16, 1), (29, 1), (45, 1), (52, 1), (61, 1), (65, 1)] }, { coefficient := -1, powers := [(5, 1), (16, 1), (32, 1), (40, 1), (45, 1), (58, 1), (65, 1)] }, { coefficient := -1, powers := [(5, 1), (16, 1), (32, 1), (45, 2), (58, 1), (65, 1)] }, { coefficient := -1, powers := [(5, 1), (16, 1), (32, 1), (45, 1), (52, 1), (58, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(47, 1), (55, 1)] }],
  [{ coefficient := 1, powers := [(23, 1), (54, 1)] }, { coefficient := 1, powers := [(29, 1), (47, 1)] }],
  [{ coefficient := -1, powers := [(18, 1), (47, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (43, 1)] }],
  [{ coefficient := 1, powers := [(27, 1), (47, 1), (55, 1), (62, 1)] }],
  [{ coefficient := -2, powers := [(5, 1), (11, 1), (29, 1), (45, 1), (61, 1), (65, 1)] }, { coefficient := -1, powers := [(5, 1), (11, 1), (32, 1), (45, 1), (58, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(18, 1), (23, 1), (45, 1)] }],
  [{ coefficient := 2, powers := [(5, 1), (29, 1), (45, 1), (61, 1)] }, { coefficient := 1, powers := [(5, 1), (32, 1), (45, 1), (58, 1)] }],
  [{ coefficient := 2, powers := [(5, 1), (29, 1), (45, 1), (61, 1)] }, { coefficient := 1, powers := [(5, 1), (32, 1), (45, 1), (58, 1)] }],
  [{ coefficient := 1, powers := [(6, 1), (55, 1), (60, 1)] }, { coefficient := 1, powers := [(55, 1)] }],
  ...
  [{ coefficient := -1, powers := [(6, 1), (48, 1), (55, 1), (60, 1)] }, { coefficient := 1, powers := [(38, 1), (61, 1)] }, { coefficient := 1, powers := [(41, 1), (58, 1)] }, { coefficient := -1, powers := [(43, 1), (47, 1), (55, 1)] }, { coefficient := -1, powers := [(48, 1), (55, 1)] }],
  [{ coefficient := -1, powers := [(18, 1), (27, 1), (47, 1), (55, 1)] }],
...
#print axioms Krenn.Component36.SelectedLeafB0_6_3.selectedHasNoCommonZero

end Krenn.Component36.SelectedLeafB0_6_3
