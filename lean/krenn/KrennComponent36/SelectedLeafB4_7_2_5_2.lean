...
namespace Krenn.Component36.SelectedLeafB4_7_2_5_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "7d322999f16fd3c430f9e404f0c5c89527a690d0ca7e0027102ad417f3fc825f"
def certificateSHA256 : String := "e22281989c030291aa0cd549e1d840f9174b2ce5e14ebfcd5a0d6c4f63e4105d"
...
def multipliers : Fin 15 → SparsePoly (Fin 70) := ![
  [{ coefficient := 1, powers := [(35, 1), (41, 1), (69, 1)] }],
  ...
  [{ coefficient := 1, powers := [(5, 1), (29, 1)] }, { coefficient := 2, powers := [(8, 1), (23, 1)] }]
]
...
#print axioms Krenn.Component36.SelectedLeafB4_7_2_5_2.selectedHasNoCommonZero

end Krenn.Component36.SelectedLeafB4_7_2_5_2
