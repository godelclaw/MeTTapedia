...
namespace Krenn.Component36.SelectedLeafB4_0_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "ad18981ce21468d4b836d39d1c858a2fca19b9e2b7a3a40898aaf998d6f625e8"
def certificateSHA256 : String := "5b91cfd541a2070b147bb515ed291616c20cc249427316dab6db332c7cbb8672"
...
def multipliers : Fin 30 → SparsePoly (Fin 64) := ![
  ...
  [{ coefficient := -1, powers := [(7, 1), (43, 1), (60, 1), (63, 1)] }, { coefficient := -1, powers := [(11, 1), (43, 1), (52, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(26, 1), (45, 1), (46, 1), (54, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(26, 1), (45, 1), (46, 1), (63, 1)] }],
  ...
  [{ coefficient := 1, powers := [(7, 1), (60, 1), (63, 1)] }, { coefficient := 1, powers := [(11, 1), (52, 1), (63, 1)] }],
  ...
  [{ coefficient := -1, powers := [(26, 1), (45, 1), (54, 1), (63, 1)] }],
...
#print axioms Krenn.Component36.SelectedLeafB4_0_1.selectedHasNoCommonZero

end Krenn.Component36.SelectedLeafB4_0_1
