...
namespace Krenn.Component36.SelectedLeafB0_2_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "705e86c4f3a3a93e893036873dbba603f382d7988b9d196724954e03c21e8cfa"
...
def multipliers : Fin 8 → SparsePoly (Fin 64) := ![
  [{ coefficient := 1, powers := [(25, 1), (52, 1), (63, 1)] }, { coefficient := -1, powers := [(54, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(43, 1), (52, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(25, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(25, 1), (43, 1), (52, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(63, 1)] }],
  [{ coefficient := 1, powers := [(25, 1), (46, 1), (52, 1), (63, 1)] }, { coefficient := -1, powers := [(40, 1), (58, 1), (63, 1)] }, { coefficient := -1, powers := [(46, 1), (54, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(19, 1), (25, 1), (43, 1), (52, 1), (63, 1)] }],
...
#print axioms Krenn.Component36.SelectedLeafB0_2_1.selectedHasNoCommonZero

end Krenn.Component36.SelectedLeafB0_2_1
