...
namespace Krenn.Component36.SelectedLeafB2_6_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "80050e9d4fa53a17ad4534e829f5d6479097f872b52aeeaa2129d189ba23b3d6"
...
def multipliers : Fin 24 → SparsePoly (Fin 67) := ![
  [{ coefficient := -1, powers := [(13, 1), (28, 1), (58, 1), (62, 1), (65, 1)] }, { coefficient := 1, powers := [(13, 1), (29, 1), (43, 1), (58, 1), (62, 1), (66, 1)] }, { coefficient := -1, powers := [(18, 1), (29, 1), (50, 1), (58, 1), (62, 1), (66, 1)] }],
  [{ coefficient := 2, powers := [(13, 1), (25, 1), (28, 1), (62, 1)] }, { coefficient := -2, powers := [(13, 1), (29, 1), (58, 1), (62, 1), (66, 1)] }],
  [{ coefficient := 2, powers := [(13, 1), (23, 1), (43, 1), (62, 1)] }],
  [{ coefficient := -2, powers := [(18, 1), (23, 1), (58, 1), (62, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(23, 1), (46, 1), (58, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(29, 1), (53, 1), (58, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (43, 1), (58, 1), (66, 1)] }],
  ...
  [{ coefficient := -2, powers := [(13, 1), (23, 1), (43, 1), (54, 1)] }, { coefficient := -2, powers := [(13, 1), (25, 1), (28, 1), (48, 1)] }, { coefficient := 1, powers := [(13, 1), (28, 1), (47, 1), (58, 1), (65, 1)] }, { coefficient := -1, powers := [(13, 1), (29, 1), (43, 1), (47, 1), (58, 1), (66, 1)] }, { coefficient := 2, powers := [(13, 1), (29, 1), (48, 1), (58, 1), (66, 1)] }, { coefficient := 2, powers := [(18, 1), (23, 1), (55, 1), (58, 1), (66, 1)] }, { coefficient := 1, powers := [(18, 1), (29, 1), (47, 1), (50, 1), (58, 1), (66, 1)] }],
  ...
  [{ coefficient := 1, powers := [(8, 1), (35, 1), (58, 1), (66, 1)] }, { coefficient := -1, powers := [(18, 1), (29, 1), (58, 1), (66, 1)] }],
...
#print axioms Krenn.Component36.SelectedLeafB2_6_3.selectedHasNoCommonZero

end Krenn.Component36.SelectedLeafB2_6_3
