...
namespace Krenn.Component36.SelectedLeafB4_6_3_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "c4227eed6ecbf5fd07188feb06687ae5e20a40d242e07ba377d00bdc67792e6e"
def certificateSHA256 : String := "c9214050b962fa2be5c07921089fefbdfa64d91bcc66bc6a3707ed6286dab000"

set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedSourceIndices : Fin 35 → Fin 675 := ![
  9,
  12,
  15,
  19,
...
def multipliers : Fin 35 → SparsePoly (Fin 68) := ![
  [{ coefficient := -1, powers := [(11, 1), (35, 1), (37, 1), (55, 1)] }],
  [{ coefficient := 1, powers := [(11, 1), (32, 1), (37, 1), (48, 1)] }],
  [{ coefficient := 1, powers := [(11, 1), (23, 1), (31, 1), (37, 1), (46, 1)] }],
  [{ coefficient := 1, powers := [(11, 1), (29, 1), (31, 1), (37, 1), (53, 1)] }],
  [{ coefficient := 1, powers := [(11, 1), (43, 1), (52, 1), (66, 1)] }, { coefficient := 2, powers := [(11, 1), (43, 1), (57, 1), (66, 1)] }, { coefficient := -1, powers := [(17, 1), (57, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(11, 1), (13, 1), (35, 1), (37, 1)] }, { coefficient := 1, powers := [(11, 1), (18, 1), (32, 1), (37, 1)] }],
  [{ coefficient := 1, powers := [(11, 1), (23, 1), (31, 1), (37, 1), (55, 1)] }, { coefficient := -1, powers := [(11, 1), (31, 1), (32, 1), (37, 1), (38, 1)] }, { coefficient := -1, powers := [(11, 1), (32, 1), (34, 1), (37, 1), (38, 1)] }],
  [{ coefficient := -1, powers := [(11, 1), (52, 1), (66, 1)] }, { coefficient := -2, powers := [(11, 1), (57, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(11, 1), (13, 1), (29, 1), (31, 1), (37, 1), (52, 1)] }],
  [{ coefficient := 1, powers := [(52, 1)] }],
  [{ coefficient := 1, powers := [(45, 1)] }],
  [{ coefficient := -1, powers := [(11, 1), (31, 1), (37, 1), (55, 1)] }],
  [{ coefficient := -1, powers := [(11, 1), (31, 1), (37, 1), (48, 1)] }],
  [{ coefficient := 1, powers := [(16, 1), (21, 1), (67, 1)] }],
  [{ coefficient := 1, powers := [(11, 1), (13, 1), (29, 1), (31, 1), (37, 1)] }],
  [{ coefficient := -1, powers := [(11, 1), (32, 1), (37, 1)] }],
  [{ coefficient := 1, powers := [(11, 1), (35, 1), (37, 1)] }],
  [{ coefficient := -1, powers := [(11, 1), (29, 1), (31, 1), (37, 1)] }],
  [{ coefficient := -1, powers := [(11, 1), (23, 1), (31, 1), (37, 1)] }],
  [{ coefficient := -1, powers := [(21, 1), (40, 1)] }, { coefficient := -1, powers := [(21, 1), (45, 1)] }, { coefficient := -2, powers := [(21, 1), (52, 1)] }, { coefficient := -1, powers := [(21, 1), (57, 1)] }, { coefficient := -1, powers := [(34, 1), (37, 1)] }],
  ...
  [{ coefficient := 1, powers := [(11, 1), (31, 1), (37, 1)] }],
  [{ coefficient := 1, powers := [(37, 1), (60, 1)] }, { coefficient := -1, powers := [(39, 1), (40, 1), (57, 1), (63, 1)] }, { coefficient := -1, powers := [(40, 1), (51, 1), (63, 1)] }, { coefficient := -1, powers := [(40, 1), (57, 1), (58, 1), (66, 1)] }, { coefficient := 1, powers := [(40, 1), (57, 1)] }, { coefficient := -1, powers := [(45, 1), (52, 1)] }, { coefficient := -1, powers := [(46, 1), (54, 1), (57, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(11, 1), (31, 1), (37, 1), (38, 1), (61, 1)] }, { coefficient := -1, powers := [(11, 1), (31, 1), (37, 1), (41, 1), (58, 1)] }, { coefficient := 1, powers := [(11, 1), (31, 1), (37, 1), (48, 1), (55, 1)] }],
  [{ coefficient := -1, powers := [(7, 1), (34, 1), (40, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (11, 1), (31, 1), (35, 1), (37, 1)] }, { coefficient := -1, powers := [(8, 1), (11, 1), (34, 1), (35, 1), (37, 1)] }],
  [{ coefficient := -1, powers := [(4, 1), (31, 1), (57, 1)] }, { coefficient := 1, powers := [(11, 1), (21, 1), (52, 1)] }, { coefficient := 1, powers := [(11, 1), (21, 1), (57, 1)] }],
  [{ coefficient := 1, powers := [(4, 1), (21, 1), (40, 1), (60, 1)] }, { coefficient := 1, powers := [(4, 1), (21, 1), (45, 1), (60, 1)] }, { coefficient := 2, powers := [(4, 1), (21, 1), (52, 1), (60, 1)] }, { coefficient := 1, powers := [(4, 1), (21, 1), (57, 1), (60, 1)] }, { coefficient := 1, powers := [(4, 1), (34, 1), (37, 1), (60, 1)] }, { coefficient := 1, powers := [(11, 1), (13, 1), (29, 1), (31, 1), (37, 1), (48, 1), (52, 1)] }, { coefficient := -1, powers := [(11, 1), (18, 1), (23, 1), (31, 1), (37, 1), (40, 1), (55, 1)] }, { coefficient := 1, powers := [(11, 1), (18, 1), (31, 1), (32, 1), (37, 1), (38, 1), (40, 1)] }, { coefficient := 1, powers := [(11, 1), (18, 1), (32, 1), (34, 1), (37, 1), (38, 1), (40, 1)] }, { coefficient := 1, powers := [(11, 1), (21, 1), (40, 1), (45, 1)] }, { coefficient := 1, powers := [(11, 1), (21, 1), (45, 2)] }, { coefficient := 2, powers := [(11, 1), (21, 1), (45, 1), (52, 1)] }, { coefficient := 1, powers := [(11, 1), (21, 1), (45, 1), (57, 1)] }, { coefficient := 1, powers := [(11, 1), (34, 1), (37, 1), (45, 1)] }, { coefficient := 1, powers := [(16, 1), (21, 1), (40, 2)] }, { coefficient := 1, powers := [(16, 1), (21, 1), (40, 1), (45, 1)] }, { coefficient := 2, powers := [(16, 1), (21, 1), (40, 1), (52, 1)] }, { coefficient := 1, powers := [(16, 1), (21, 1), (40, 1), (57, 1)] }, { coefficient := 1, powers := [(16, 1), (34, 1), (37, 1), (40, 1)] }],
  [{ coefficient := 1, powers := [(4, 1), (60, 1)] }, { coefficient := -1, powers := [(10, 1), (40, 1), (63, 1)] }, { coefficient := -1, powers := [(11, 1), (40, 1)] }, { coefficient := -1, powers := [(11, 1), (45, 1)] }, { coefficient := -1, powers := [(16, 1), (39, 1), (40, 1), (63, 1)] }, { coefficient := -1, powers := [(16, 1), (45, 1)] }],
  [{ coefficient := -1, powers := [(7, 1), (21, 1), (60, 1)] }, { coefficient := -1, powers := [(11, 1), (21, 1), (57, 1)] }, { coefficient := -1, powers := [(16, 1), (21, 1), (40, 1)] }, { coefficient := -1, powers := [(16, 1), (21, 1), (45, 1)] }, { coefficient := -1, powers := [(16, 1), (21, 1), (52, 1)] }]
]
...
#print axioms Krenn.Component36.SelectedLeafB4_6_3_1.selectedHasNoCommonZero

end Krenn.Component36.SelectedLeafB4_6_3_1
