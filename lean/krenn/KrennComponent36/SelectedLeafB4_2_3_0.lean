...
namespace Krenn.Component36.SelectedLeafB4_2_3_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "da391eef186f6af91dadf3b5409b3b4a8ca730323a44b64813bb533b6d3428fb"
def certificateSHA256 : String := "297b8f6d311a58db48284f2ca21ee225c66bebf5089ad03684d8c0a9722363a9"
...
def selectedEquations : Fin 23 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := 1, powers := [(28, 1), (43, 1), (54, 1)] }, { coefficient := 1, powers := [(28, 1), (58, 1)] }, { coefficient := 1, powers := [(29, 1), (40, 1), (43, 1)] }, { coefficient := 1, powers := [(29, 1), (46, 1)] }],
...
def multipliers : Fin 23 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := -2, powers := [(23, 1), (58, 1)] }, { coefficient := -1, powers := [(28, 1), (47, 1), (58, 1), (64, 1)] }],
  [{ coefficient := -2, powers := [(23, 1), (55, 1)] }],
  [{ coefficient := -2, powers := [(13, 1), (23, 1), (25, 1), (52, 2), (58, 1), (65, 1)] }, { coefficient := 2, powers := [(13, 1), (23, 1), (52, 1), (54, 1), (58, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(55, 1)] }],
  [{ coefficient := 1, powers := [(48, 1)] }],
  [{ coefficient := 2, powers := [(13, 1), (19, 1), (58, 1)] }],
  [{ coefficient := 1, powers := [(13, 1), (19, 1), (43, 1), (47, 1), (58, 1), (65, 1)] }],
  [{ coefficient := 2, powers := [(13, 1), (23, 1), (25, 1), (52, 1), (58, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(23, 1)] }],
  [{ coefficient := 1, powers := [(18, 1)] }],
  [{ coefficient := -2, powers := [(13, 1), (23, 1), (52, 1), (58, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(13, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (19, 1), (47, 1), (58, 1), (65, 1)] }],
  ...
  [{ coefficient := 2, powers := [(13, 1), (19, 1), (23, 1), (52, 1), (58, 1)] }, { coefficient := 1, powers := [(13, 1), (19, 1), (28, 1), (47, 1), (58, 1)] }],
  [{ coefficient := 2, powers := [(13, 1), (23, 1), (25, 1), (43, 1), (52, 2), (58, 1), (65, 1)] }, { coefficient := -2, powers := [(13, 1), (23, 1), (43, 1), (52, 1), (54, 1), (58, 1), (65, 1)] }, { coefficient := 2, powers := [(18, 1), (23, 1), (40, 1), (55, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (61, 1)] }, { coefficient := -1, powers := [(13, 1), (19, 1), (43, 1), (45, 1), (47, 1), (58, 1), (65, 1)] }, { coefficient := 1, powers := [(13, 1), (19, 1), (46, 1), (47, 1), (58, 1), (65, 1)] }, { coefficient := 1, powers := [(13, 1), (43, 1), (47, 1)] }, { coefficient := -1, powers := [(13, 1), (48, 1)] }, { coefficient := -1, powers := [(18, 1), (47, 1), (50, 1)] }]
]
...
#print axioms Krenn.Component36.SelectedLeafB4_2_3_0.selectedHasNoCommonZero

end Krenn.Component36.SelectedLeafB4_2_3_0
