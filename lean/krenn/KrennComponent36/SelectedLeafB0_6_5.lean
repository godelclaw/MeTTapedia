...
namespace Krenn.Component36.SelectedLeafB0_6_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "5c2a69895d9059215e3146d386f09557dffbbbce7816be1221dbf81d253d0083"
...
def multipliers : Fin 8 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := 1, powers := [(43, 1), (52, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(25, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(25, 1), (43, 1), (52, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(65, 1)] }],
  [{ coefficient := 1, powers := [(25, 1), (46, 1), (52, 1), (65, 1)] }, { coefficient := -1, powers := [(40, 1), (58, 1), (65, 1)] }, { coefficient := -1, powers := [(46, 1), (54, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(19, 1), (25, 1), (43, 1), (52, 1), (65, 1)] }],
...
#print axioms Krenn.Component36.SelectedLeafB0_6_5.selectedHasNoCommonZero

end Krenn.Component36.SelectedLeafB0_6_5
