...
namespace Krenn.Component36.SelectedLeafB4_2_5_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "d36cee55316f206aafca4e3419cd1d469b4af38ffaa12765493b64259f9e3154"
def certificateSHA256 : String := "8f9ecfd9318bc6b94a05ca8900e2c34526bdf69fe0ea36f963f7f83a5b73264a"
...
def multipliers : Fin 26 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := -1, powers := [(7, 1), (23, 1), (34, 1), (40, 1), (46, 1)] }, { coefficient := -1, powers := [(11, 1), (23, 1), (34, 1), (37, 1), (46, 1)] }],
  [{ coefficient := -1, powers := [(7, 1), (43, 1), (60, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(7, 1), (13, 1), (34, 1), (40, 1), (43, 1)] }, { coefficient := -1, powers := [(11, 1), (13, 1), (34, 1), (37, 1), (43, 1)] }],
  [{ coefficient := -1, powers := [(7, 1), (23, 1), (34, 1), (40, 1), (58, 1)] }, { coefficient := -1, powers := [(11, 1), (23, 1), (34, 1), (37, 1), (58, 1)] }],
  [{ coefficient := -2, powers := [(7, 1), (23, 1), (34, 1), (40, 1), (55, 1)] }, { coefficient := -2, powers := [(11, 1), (23, 1), (34, 1), (37, 1), (55, 1)] }],
  [{ coefficient := 1, powers := [(7, 1), (60, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(52, 1)] }],
  [{ coefficient := 1, powers := [(45, 1)] }],
  [{ coefficient := 1, powers := [(7, 1), (34, 1), (40, 1), (55, 1)] }, { coefficient := 1, powers := [(11, 1), (34, 1), (37, 1), (55, 1)] }],
  [{ coefficient := 1, powers := [(7, 1), (34, 1), (40, 1), (48, 1)] }, { coefficient := 1, powers := [(11, 1), (34, 1), (37, 1), (48, 1)] }],
  [{ coefficient := 1, powers := [(7, 1), (23, 1), (34, 1), (40, 1)] }, { coefficient := 1, powers := [(11, 1), (23, 1), (34, 1), (37, 1)] }],
  [{ coefficient := 1, powers := [(7, 1), (18, 1), (34, 1), (40, 1)] }, { coefficient := 1, powers := [(11, 1), (18, 1), (34, 1), (37, 1)] }],
  [{ coefficient := -1, powers := [(21, 1), (52, 1)] }, { coefficient := -1, powers := [(34, 1), (37, 1)] }],
  [{ coefficient := 1, powers := [(7, 1), (13, 1), (34, 1), (40, 1)] }, { coefficient := 1, powers := [(11, 1), (13, 1), (34, 1), (37, 1)] }],
  [{ coefficient := 1, powers := [(16, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := -1, powers := [(7, 1), (34, 1), (40, 1)] }, { coefficient := -1, powers := [(11, 1), (34, 1), (37, 1)] }],
  [{ coefficient := 1, powers := [(37, 1), (60, 1)] }, { coefficient := 1, powers := [(40, 1), (57, 1)] }, { coefficient := -1, powers := [(45, 1), (52, 1)] }],
  [{ coefficient := 1, powers := [(7, 1), (34, 1), (38, 1), (40, 1), (61, 1)] }, { coefficient := 1, powers := [(7, 1), (34, 1), (40, 1), (41, 1), (58, 1)] }, { coefficient := -1, powers := [(7, 1), (34, 1), (40, 1), (48, 1), (55, 1)] }, { coefficient := 1, powers := [(11, 1), (34, 1), (37, 1), (38, 1), (61, 1)] }, { coefficient := 1, powers := [(11, 1), (34, 1), (37, 1), (41, 1), (58, 1)] }, { coefficient := -1, powers := [(11, 1), (34, 1), (37, 1), (48, 1), (55, 1)] }],
  [{ coefficient := 1, powers := [(7, 1), (8, 1), (34, 1), (35, 1), (40, 1)] }, { coefficient := 1, powers := [(8, 1), (11, 1), (34, 1), (35, 1), (37, 1)] }],
  [{ coefficient := 1, powers := [(4, 1), (31, 1)] }, { coefficient := 1, powers := [(7, 1), (13, 1), (19, 1), (23, 1), (34, 1), (40, 1), (58, 1)] }, { coefficient := 1, powers := [(11, 1), (13, 1), (19, 1), (23, 1), (34, 1), (37, 1), (58, 1)] }, { coefficient := 1, powers := [(11, 1), (21, 1)] }, { coefficient := -1, powers := [(16, 1), (21, 1)] }],
  [{ coefficient := -1, powers := [(7, 1), (21, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(4, 1), (21, 1), (52, 1), (60, 1)] }, { coefficient := 1, powers := [(4, 1), (34, 1), (37, 1), (60, 1)] }, { coefficient := 2, powers := [(7, 1), (18, 1), (23, 1), (34, 1), (40, 2), (55, 1)] }, { coefficient := 2, powers := [(11, 1), (18, 1), (23, 1), (34, 1), (37, 1), (40, 1), (55, 1)] }, { coefficient := 1, powers := [(11, 1), (21, 1), (45, 1), (52, 1)] }, { coefficient := 1, powers := [(11, 1), (34, 1), (37, 1), (45, 1)] }, { coefficient := 1, powers := [(16, 1), (21, 1), (40, 1), (52, 1)] }, { coefficient := 1, powers := [(16, 1), (34, 1), (37, 1), (40, 1)] }],
  [{ coefficient := 1, powers := [(4, 1), (60, 1)] }, { coefficient := -1, powers := [(16, 1), (45, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (7, 1), (34, 1), (40, 1), (61, 1)] }, { coefficient := 1, powers := [(5, 1), (11, 1), (34, 1), (37, 1), (61, 1)] }, { coefficient := 1, powers := [(7, 1), (13, 1), (34, 1), (40, 1), (43, 1), (47, 1)] }, { coefficient := -1, powers := [(7, 1), (13, 1), (34, 1), (40, 1), (48, 1)] }, { coefficient := -1, powers := [(7, 1), (18, 1), (34, 1), (40, 1), (47, 1), (50, 1)] }, { coefficient := 1, powers := [(11, 1), (13, 1), (34, 1), (37, 1), (43, 1), (47, 1)] }, { coefficient := -1, powers := [(11, 1), (13, 1), (34, 1), (37, 1), (48, 1)] }, { coefficient := -1, powers := [(11, 1), (18, 1), (34, 1), (37, 1), (47, 1), (50, 1)] }]
]
...
#print axioms Krenn.Component36.SelectedLeafB4_2_5_0.selectedHasNoCommonZero

end Krenn.Component36.SelectedLeafB4_2_5_0
