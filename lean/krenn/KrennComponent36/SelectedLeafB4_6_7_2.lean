...
namespace Krenn.Component36.SelectedLeafB4_6_7_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "f68eec7c1af5200c12f2dabd5a7028c6b3d3f08e7faf4dcaec264c24b4f8bd82"
...
def multipliers : Fin 18 → SparsePoly (Fin 69) := ![
  [{ coefficient := -1, powers := [(23, 1), (46, 1), (57, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(23, 1), (45, 1), (58, 1), (66, 1), (68, 1)] }, { coefficient := -1, powers := [(23, 1), (57, 1), (58, 1), (66, 1), (68, 1)] }, { coefficient := -1, powers := [(28, 1), (47, 1), (58, 1), (66, 1), (68, 1)] }],
  [{ coefficient := -1, powers := [(23, 1), (58, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (43, 1), (57, 1), (66, 1)] }],
  [{ coefficient := -2, powers := [(23, 1), (55, 1), (57, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(55, 1), (57, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(48, 1), (57, 1), (66, 1)] }],
  ...
  [{ coefficient := 1, powers := [(38, 1), (57, 1), (61, 1), (66, 1)] }, { coefficient := -1, powers := [(47, 1), (53, 1), (58, 1), (66, 1)] }, { coefficient := -1, powers := [(48, 1), (55, 1), (57, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (35, 1), (57, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := 2, powers := [(18, 1), (23, 1), (40, 1), (55, 1), (57, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (23, 1), (45, 1), (58, 1), (66, 1)] }, { coefficient := 1, powers := [(13, 1), (23, 1), (57, 1), (58, 1), (66, 1)] }, { coefficient := 1, powers := [(13, 1), (28, 1), (47, 1), (58, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (57, 1), (61, 1), (66, 1)] }, { coefficient := 1, powers := [(13, 1), (43, 1), (47, 1), (57, 1), (66, 1)] }, { coefficient := -1, powers := [(13, 1), (48, 1), (57, 1), (66, 1)] }, { coefficient := -1, powers := [(18, 1), (47, 1), (50, 1), (57, 1), (66, 1)] }]
]
...
#print axioms Krenn.Component36.SelectedLeafB4_6_7_2.selectedHasNoCommonZero

end Krenn.Component36.SelectedLeafB4_6_7_2
