...
namespace Krenn.Component36.SelectedLeafB4_2_1_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "ecddbfa3fb4add009f0021f2493c96f0802c6f0c4114eb8f67fb7f84cb6b173c"
...
def multipliers : Fin 26 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := -1, powers := [(7, 1), (23, 1), (34, 1), (40, 1), (58, 1), (65, 1)] }, { coefficient := -1, powers := [(11, 1), (23, 1), (34, 1), (37, 1), (58, 1), (65, 1)] }, { coefficient := 1, powers := [(16, 1), (23, 1), (34, 1), (37, 1), (58, 1), (65, 1)] }],
  ...
  [{ coefficient := 1, powers := [(4, 1), (31, 1)] }, { coefficient := -1, powers := [(11, 1), (21, 1), (24, 1), (65, 1)] }, { coefficient := 1, powers := [(11, 1), (21, 1)] }, { coefficient := -1, powers := [(16, 1), (21, 1)] }],
...
#print axioms Krenn.Component36.SelectedLeafB4_2_1_4.selectedHasNoCommonZero

end Krenn.Component36.SelectedLeafB4_2_1_4
