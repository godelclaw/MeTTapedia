...
namespace Krenn.Component36.SelectedLeafB4_6_5_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "712790d63366743ba4f080297e5f8057c76f822de8a40c29b5a598e724c370a0"
...
def multipliers : Fin 28 → SparsePoly (Fin 69) := ![
  ...
  [{ coefficient := 1, powers := [(7, 1), (26, 1), (29, 1), (48, 1), (60, 1), (67, 1)] }, { coefficient := -1, powers := [(7, 1), (26, 1), (35, 1), (38, 1), (60, 1), (67, 1)] }, { coefficient := -1, powers := [(7, 1), (29, 1), (31, 1), (45, 1), (48, 1), (67, 1)] }, { coefficient := -1, powers := [(7, 1), (29, 1), (34, 1), (40, 1), (48, 1), (67, 1)] }, { coefficient := 1, powers := [(7, 1), (31, 1), (35, 1), (38, 1), (45, 1), (67, 1)] }, { coefficient := 1, powers := [(7, 1), (34, 1), (35, 1), (38, 1), (40, 1), (67, 1)] }, { coefficient := -1, powers := [(11, 1), (29, 1), (34, 1), (37, 1), (48, 1), (67, 1)] }, { coefficient := 1, powers := [(11, 1), (34, 1), (35, 1), (37, 1), (38, 1), (67, 1)] }],
...
#print axioms Krenn.Component36.SelectedLeafB4_6_5_3.selectedHasNoCommonZero

end Krenn.Component36.SelectedLeafB4_6_5_3
