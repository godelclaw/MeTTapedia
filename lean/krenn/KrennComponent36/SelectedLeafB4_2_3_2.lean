...
namespace Krenn.Component36.SelectedLeafB4_2_3_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "b8c85a2f2d4c6d799f86def8fc2232f5313568cfaf08f414a2293621fa3f6483"
...
def multipliers : Fin 18 → SparsePoly (Fin 67) := ![
  ...
  [{ coefficient := 1, powers := [(23, 1), (45, 1), (58, 1), (64, 1), (66, 1)] }, { coefficient := -1, powers := [(23, 1), (57, 1), (58, 1), (64, 1), (66, 1)] }, { coefficient := -1, powers := [(28, 1), (47, 1), (58, 1), (64, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(23, 1), (58, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (43, 1), (57, 1), (64, 1)] }],
  [{ coefficient := -2, powers := [(23, 1), (55, 1), (57, 1), (64, 1)] }],
  ...
  [{ coefficient := 2, powers := [(18, 1), (23, 1), (40, 1), (55, 1), (57, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (23, 1), (45, 1), (58, 1), (64, 1)] }, { coefficient := 1, powers := [(13, 1), (23, 1), (57, 1), (58, 1), (64, 1)] }, { coefficient := 1, powers := [(13, 1), (28, 1), (47, 1), (58, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (57, 1), (61, 1), (64, 1)] }, { coefficient := 1, powers := [(13, 1), (43, 1), (47, 1), (57, 1), (64, 1)] }, { coefficient := -1, powers := [(13, 1), (48, 1), (57, 1), (64, 1)] }, { coefficient := -1, powers := [(18, 1), (47, 1), (50, 1), (57, 1), (64, 1)] }]
]
...
#print axioms Krenn.Component36.SelectedLeafB4_2_3_2.selectedHasNoCommonZero

end Krenn.Component36.SelectedLeafB4_2_3_2
