...
namespace Krenn.Component36.SelectedLeafB6_7_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "614faf8f685bc029a15382583989cf1c26d8902f524c8db6bad4fd966b4955bd"
def certificateSHA256 : String := "5394a21e091e0d6e8a0926b3c6480531cde0ffcbfb94c2cf13a637d7c7340569"
...
def multipliers : Fin 26 → SparsePoly (Fin 69) := ![
  ...
  [{ coefficient := 1, powers := [(13, 1), (29, 1), (48, 1)] }, { coefficient := 2, powers := [(18, 1), (23, 1), (55, 1)] }, { coefficient := 1, powers := [(18, 1), (28, 1), (41, 1), (54, 1), (65, 1)] }, { coefficient := 1, powers := [(18, 1), (29, 1), (47, 1), (50, 1)] }],
  [{ coefficient := 1, powers := [(38, 1), (61, 1)] }, { coefficient := -1, powers := [(40, 1), (41, 1), (58, 1), (65, 1)] }, { coefficient := -1, powers := [(41, 1), (46, 1), (54, 1), (65, 1)] }, { coefficient := -1, powers := [(41, 1), (56, 1), (58, 1), (67, 1)] }, { coefficient := 1, powers := [(41, 1), (58, 1)] }, { coefficient := -1, powers := [(48, 1), (55, 1)] }],
  ...
  [{ coefficient := -1, powers := [(13, 1), (19, 1), (35, 1), (38, 1)] }]
]
...
#print axioms Krenn.Component36.SelectedLeafB6_7_5.selectedHasNoCommonZero

end Krenn.Component36.SelectedLeafB6_7_5
