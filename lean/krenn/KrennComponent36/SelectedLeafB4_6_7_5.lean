...
namespace Krenn.Component36.SelectedLeafB4_6_7_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "198b2ecb653a6213effea0923e632218fb7c90f470a3e2e44e7c17b0a2a8b1ab"
def certificateSHA256 : String := "fc3a74907844a6c8afe4c12e0141d16c79112a286c338713e389d12c8082ddbb"
...
def multipliers : Fin 17 → SparsePoly (Fin 70) := ![
  [{ coefficient := 1, powers := [(23, 1), (45, 1), (58, 1), (66, 1), (68, 1)] }, { coefficient := -1, powers := [(28, 1), (47, 1), (58, 1), (66, 1), (68, 1)] }, { coefficient := -1, powers := [(29, 1), (48, 1), (68, 1)] }, { coefficient := 1, powers := [(35, 1), (38, 1), (68, 1)] }],
  [{ coefficient := -1, powers := [(23, 1), (46, 1)] }],
  [{ coefficient := 1, powers := [(23, 1), (51, 1), (55, 1), (63, 1)] }, { coefficient := -1, powers := [(32, 1), (38, 1), (51, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(29, 1), (53, 1)] }],
  [{ coefficient := -1, powers := [(23, 1), (58, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(23, 1), (55, 1), (63, 1)] }, { coefficient := 1, powers := [(32, 1), (38, 1), (63, 1)] }],
  ...
  [{ coefficient := 1, powers := [(18, 1), (23, 1), (55, 1)] }, { coefficient := -1, powers := [(18, 1), (32, 1), (38, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (35, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (32, 1), (58, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (23, 1), (45, 1), (58, 1), (66, 1)] }, { coefficient := 1, powers := [(13, 1), (28, 1), (47, 1), (58, 1), (66, 1)] }, { coefficient := 1, powers := [(13, 1), (29, 1), (48, 1)] }, { coefficient := -1, powers := [(13, 1), (35, 1), (38, 1)] }]
]
...
#print axioms Krenn.Component36.SelectedLeafB4_6_7_5.selectedHasNoCommonZero

end Krenn.Component36.SelectedLeafB4_6_7_5
