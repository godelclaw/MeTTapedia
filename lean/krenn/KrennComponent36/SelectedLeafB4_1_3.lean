...
namespace Krenn.Component36.SelectedLeafB4_1_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "458f8fd5f9ef2f6e7ed3fbdbe92979fa38853793f6781612db24dbdd482393fa"
def certificateSHA256 : String := "a613763a6c7683ee30c1523c57010269c07a1616cef62f30c6b799287d2e299d"
...
def multipliers : Fin 32 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := 1, powers := [(16, 1), (29, 1), (34, 1), (37, 1), (48, 1), (52, 1)] }],
  [{ coefficient := 1, powers := [(16, 1), (23, 1), (34, 1), (37, 1), (46, 1)] }],
  [{ coefficient := 1, powers := [(16, 1), (29, 1), (34, 1), (37, 1), (53, 1)] }],
  [{ coefficient := -1, powers := [(7, 1), (43, 1), (60, 1), (65, 1)] }, { coefficient := 1, powers := [(16, 1), (43, 1), (52, 1), (65, 1)] }, { coefficient := 1, powers := [(16, 1), (43, 1), (57, 1), (65, 1)] }, { coefficient := -1, powers := [(17, 1), (57, 1), (65, 1)] }],
  ...
  [{ coefficient := 1, powers := [(34, 1), (37, 1), (46, 1), (54, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(34, 1), (37, 1), (46, 1), (65, 1)] }],
  ...
  [{ coefficient := 1, powers := [(7, 1), (60, 1), (65, 1)] }, { coefficient := -1, powers := [(16, 1), (52, 1), (65, 1)] }, { coefficient := -1, powers := [(16, 1), (57, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (16, 1), (29, 1), (34, 1), (37, 1), (52, 1)] }],
  [{ coefficient := 1, powers := [(52, 1)] }],
  [{ coefficient := 1, powers := [(45, 1)] }],
  [{ coefficient := -1, powers := [(16, 1), (34, 1), (37, 1), (55, 1)] }],
  [{ coefficient := -1, powers := [(16, 1), (34, 1), (37, 1), (48, 1)] }],
  [{ coefficient := 1, powers := [(13, 1), (16, 1), (29, 1), (34, 1), (37, 1)] }],
  [{ coefficient := -1, powers := [(16, 1), (35, 1), (37, 1)] }],
  [{ coefficient := -1, powers := [(34, 1), (37, 1), (54, 1), (65, 1)] }],
  ...
  [{ coefficient := 1, powers := [(7, 1), (34, 1)] }, { coefficient := -1, powers := [(16, 1), (18, 1), (23, 1), (24, 1), (34, 1), (37, 1), (55, 1)] }, { coefficient := 1, powers := [(16, 1), (18, 1), (24, 1), (32, 1), (34, 1), (37, 1), (38, 1)] }, { coefficient := -1, powers := [(16, 1), (26, 1)] }, { coefficient := 1, powers := [(17, 1), (24, 1), (34, 1), (37, 1), (54, 1), (65, 1)] }, { coefficient := -1, powers := [(17, 1), (25, 1), (34, 1), (37, 1), (65, 1)] }],
...
#print axioms Krenn.Component36.SelectedLeafB4_1_3.selectedHasNoCommonZero

end Krenn.Component36.SelectedLeafB4_1_3
