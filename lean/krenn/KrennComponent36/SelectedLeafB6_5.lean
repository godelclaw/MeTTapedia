...
namespace Krenn.Component36.SelectedLeafB6_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "ab9fb6a28ef544c5527c7f7ed29d4040c0f96691d5281022a41964eceb4fe9e7"
...
def multipliers : Fin 42 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := 1, powers := [(7, 1), (50, 1), (60, 1), (65, 1)] }, { coefficient := 1, powers := [(11, 1), (50, 1), (57, 1), (65, 1)] }, { coefficient := 1, powers := [(16, 1), (45, 1), (50, 1), (65, 1)] }, { coefficient := 1, powers := [(16, 1), (50, 1), (52, 1), (65, 1)] }],
  ...
  [{ coefficient := -1, powers := [(7, 1), (60, 1), (65, 1)] }, { coefficient := -1, powers := [(11, 1), (57, 1), (65, 1)] }, { coefficient := -1, powers := [(16, 1), (45, 1), (65, 1)] }, { coefficient := -1, powers := [(16, 1), (52, 1), (65, 1)] }],
...
#print axioms Krenn.Component36.SelectedLeafB6_5.selectedHasNoCommonZero

end Krenn.Component36.SelectedLeafB6_5
