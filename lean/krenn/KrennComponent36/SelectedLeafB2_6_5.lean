...
namespace Krenn.Component36.SelectedLeafB2_6_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "381d8bc92d16658e5e042717b21d00258f26b7be2b2b87674cb6ad3c7144a7b9"
...
def multipliers : Fin 7 → SparsePoly (Fin 67) := ![
  ...
  [{ coefficient := 1, powers := [(25, 1), (43, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(25, 1), (37, 1), (43, 1), (60, 1), (66, 1)] }, { coefficient := -1, powers := [(25, 1), (40, 1), (43, 1), (57, 1), (66, 1)] }, { coefficient := -1, powers := [(25, 1), (43, 1), (45, 1), (52, 1), (66, 1)] }, { coefficient := 1, powers := [(25, 1), (46, 1), (52, 1), (66, 1)] }, { coefficient := -1, powers := [(40, 1), (58, 1), (66, 1)] }, { coefficient := 1, powers := [(43, 1), (45, 1), (54, 1), (66, 1)] }, { coefficient := -1, powers := [(46, 1), (54, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(25, 1), (43, 1), (66, 1)] }],
...
#print axioms Krenn.Component36.SelectedLeafB2_6_5.selectedHasNoCommonZero

end Krenn.Component36.SelectedLeafB2_6_5
