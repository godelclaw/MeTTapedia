...
namespace Krenn.Component36.SelectedLeafB4_4_6_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "2eff96e5623af6711e35efc521510af343b64251f9dd27a068a709a16f8b7a83"
def certificateSHA256 : String := "c27963d0acf5985f467180e3544a814d1a6b494d977bc0d38d197964d6279f20"

set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedSourceIndices : Fin 14 → Fin 675 := ![
  15,
  16,
  19,
  272,
...
def multipliers : Fin 14 → SparsePoly (Fin 68) := ![
  ...
  [{ coefficient := -1, powers := [(29, 1), (48, 1), (66, 1)] }, { coefficient := 1, powers := [(35, 1), (38, 1), (66, 1)] }],
  ...
  [{ coefficient := 1, powers := [(18, 1), (23, 1), (40, 1), (55, 1)] }, { coefficient := -1, powers := [(18, 1), (32, 1), (38, 1), (40, 1)] }],
...
#print axioms Krenn.Component36.SelectedLeafB4_4_6_3.selectedHasNoCommonZero

end Krenn.Component36.SelectedLeafB4_4_6_3
