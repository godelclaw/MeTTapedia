...
namespace Krenn.Component36.SelectedLeafB6_2_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "f3ea5802d680edfbd191e1b4a3a76c7808d517abafae31e762d4254eb81377b8"
...
def multipliers : Fin 21 → SparsePoly (Fin 67) := ![
  [{ coefficient := -2, powers := [(8, 1), (27, 1), (61, 1), (63, 1)] }, { coefficient := -1, powers := [(13, 1), (28, 1), (58, 1), (63, 1), (65, 1)] }, { coefficient := 1, powers := [(13, 1), (29, 1), (43, 1), (58, 1), (63, 1), (66, 1)] }, { coefficient := -1, powers := [(18, 1), (29, 1), (50, 1), (58, 1), (63, 1), (66, 1)] }],
  [{ coefficient := -2, powers := [(13, 1), (29, 1), (58, 1), (63, 1), (66, 1)] }],
  [{ coefficient := -2, powers := [(18, 1), (23, 1), (58, 1), (63, 1), (66, 1)] }, { coefficient := 2, powers := [(18, 1), (23, 1), (63, 1)] }],
  [{ coefficient := -2, powers := [(6, 1), (23, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(23, 1), (46, 1), (58, 1), (66, 1)] }, { coefficient := 2, powers := [(23, 1), (46, 1)] }],
  ...
  [{ coefficient := 1, powers := [(23, 1), (58, 1), (66, 1)] }, { coefficient := -2, powers := [(23, 1)] }],
  ...
  [{ coefficient := 2, powers := [(8, 1), (27, 1), (47, 1), (61, 1)] }, { coefficient := 1, powers := [(13, 1), (28, 1), (47, 1), (58, 1), (65, 1)] }, { coefficient := -1, powers := [(13, 1), (29, 1), (43, 1), (47, 1), (58, 1), (66, 1)] }, { coefficient := 2, powers := [(13, 1), (29, 1), (48, 1), (58, 1), (66, 1)] }, { coefficient := 2, powers := [(18, 1), (23, 1), (55, 1), (58, 1), (66, 1)] }, { coefficient := -2, powers := [(18, 1), (23, 1), (55, 1)] }, { coefficient := 1, powers := [(18, 1), (29, 1), (47, 1), (50, 1), (58, 1), (66, 1)] }],
...
#print axioms Krenn.Component36.SelectedLeafB6_2_3.selectedHasNoCommonZero

end Krenn.Component36.SelectedLeafB6_2_3
