...
namespace Krenn.Component36.SelectedLeafB4_6_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "a7f47fc3d60f2e1c7ff3bcb09f1d4624d490d3d1c06483ab3a5fb36301fd981d"
def certificateSHA256 : String := "8c66b96dd4f903fec2c6bdd9a6bb78bc8ceec232e416fb549874e30a3e291f62"
...
def multipliers : Fin 19 → SparsePoly (Fin 67) := ![
  [{ coefficient := 2, powers := [(29, 1), (44, 1), (48, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(23, 1), (46, 1)] }],
  [{ coefficient := 1, powers := [(23, 1), (51, 1), (55, 1), (63, 1)] }, { coefficient := -1, powers := [(29, 1), (47, 1), (53, 1)] }, { coefficient := -1, powers := [(32, 1), (38, 1), (51, 1), (63, 1)] }],
  ...
  [{ coefficient := 2, powers := [(13, 1), (29, 1), (48, 1)] }],
...
#print axioms Krenn.Component36.SelectedLeafB4_6_6.selectedHasNoCommonZero

end Krenn.Component36.SelectedLeafB4_6_6
