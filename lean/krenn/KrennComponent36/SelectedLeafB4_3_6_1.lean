...
namespace Krenn.Component36.SelectedLeafB4_3_6_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "141df6105a7bd8e6d60fd98992d821952b1c29bd878b437839e6acbbaac6f66f"
def certificateSHA256 : String := "44e48e60cc081cfca3a835db4491597672d80bb1138f45aefb0d0399d9f5f526"
...
def multipliers : Fin 18 → SparsePoly (Fin 68) := ![
  ...
  [{ coefficient := 1, powers := [(35, 1), (38, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(23, 1), (55, 1)] }, { coefficient := -1, powers := [(28, 1), (41, 1), (54, 1), (63, 1)] }, { coefficient := 1, powers := [(29, 1), (41, 1), (52, 1), (63, 1)] }, { coefficient := 1, powers := [(32, 1), (38, 1)] }],
  ...
  [{ coefficient := 1, powers := [(38, 1), (61, 1)] }, { coefficient := -1, powers := [(40, 1), (41, 1), (58, 1), (63, 1)] }, { coefficient := -1, powers := [(41, 1), (46, 1), (54, 1), (63, 1)] }, { coefficient := 1, powers := [(41, 1), (58, 1)] }, { coefficient := -1, powers := [(48, 1), (55, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (35, 1), (41, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (35, 1), (38, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (32, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (29, 1), (48, 1), (52, 1)] }, { coefficient := -1, powers := [(13, 1), (35, 1), (38, 1), (44, 1), (65, 1)] }, { coefficient := 1, powers := [(18, 1), (23, 1), (40, 1), (55, 1)] }, { coefficient := 1, powers := [(18, 1), (28, 1), (40, 1), (41, 1), (54, 1), (63, 1)] }, { coefficient := -1, powers := [(18, 1), (29, 1), (40, 1), (41, 1), (52, 1), (63, 1)] }, { coefficient := -1, powers := [(18, 1), (32, 1), (38, 1), (40, 1)] }]
]
...
#print axioms Krenn.Component36.SelectedLeafB4_3_6_1.selectedHasNoCommonZero

end Krenn.Component36.SelectedLeafB4_3_6_1
