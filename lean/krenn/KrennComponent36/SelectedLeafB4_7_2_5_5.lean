...
namespace Krenn.Component36.SelectedLeafB4_7_2_5_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "c73512be863faa57b30981af495d7a3d317c4f6aebdbdff86aa8e8ca83eb2770"
...
def multipliers : Fin 5 → SparsePoly (Fin 71) := ![
  [{ coefficient := -1, powers := [(50, 1), (65, 1), (67, 1)] }],
  [{ coefficient := 1, powers := [(65, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := 1, powers := [(6, 1), (20, 1), (50, 1), (65, 1), (67, 1)] }]
]
...
#print axioms Krenn.Component36.SelectedLeafB4_7_2_5_5.selectedHasNoCommonZero

end Krenn.Component36.SelectedLeafB4_7_2_5_5
