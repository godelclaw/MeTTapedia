...
namespace Krenn.Component36.SelectedLeafB4_2_5_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "e52cc8b3bdead8dcaf23df435cccf9c6ef1aed22599bce1411c814056c0f90e4"
...
def multipliers : Fin 23 → SparsePoly (Fin 69) := ![
  ...
  [{ coefficient := 1, powers := [(3, 1), (29, 1), (48, 1), (60, 1), (66, 1)] }, { coefficient := -1, powers := [(3, 1), (35, 1), (38, 1), (60, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(3, 1), (23, 1), (46, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(3, 1), (29, 1), (53, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(27, 1), (54, 1), (64, 1), (67, 1), (68, 1)] }, { coefficient := -1, powers := [(29, 1), (64, 1), (67, 1), (68, 1)] }],
  [{ coefficient := 1, powers := [(3, 1), (18, 1), (29, 1), (50, 1), (60, 1), (67, 1)] }],
  [{ coefficient := 1, powers := [(64, 1), (68, 1)] }],
  [{ coefficient := 1, powers := [(3, 1), (55, 1), (60, 1)] }],
  [{ coefficient := -1, powers := [(3, 1), (48, 1), (60, 1)] }],
  [{ coefficient := -1, powers := [(54, 1), (64, 1), (68, 1)] }],
  ...
  [{ coefficient := 1, powers := [(22, 1), (54, 1), (68, 1)] }],
  [{ coefficient := 1, powers := [(19, 1), (29, 1), (68, 1)] }, { coefficient := -1, powers := [(19, 1)] }],
  [{ coefficient := -1, powers := [(3, 1), (13, 1), (29, 1), (48, 1), (60, 1)] }, { coefficient := 1, powers := [(3, 1), (13, 1), (35, 1), (38, 1), (60, 1)] }],
  [{ coefficient := -1, powers := [(3, 1), (18, 1), (29, 1), (47, 1), (50, 1), (60, 1)] }, { coefficient := -1, powers := [(27, 1), (42, 1), (54, 1), (64, 1), (68, 1)] }, { coefficient := 1, powers := [(29, 1), (42, 1), (64, 1), (68, 1)] }],
...
#print axioms Krenn.Component36.SelectedLeafB4_2_5_7.selectedHasNoCommonZero

end Krenn.Component36.SelectedLeafB4_2_5_7
