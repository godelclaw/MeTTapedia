...
namespace Krenn.Component36.SelectedLeafB2_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "750074978af4c8978dbc676cfdca771283e48b49df404d7ab3d6028ca9bd93fd"
...
def multipliers : Fin 10 → SparsePoly (Fin 64) := ![
  [{ coefficient := -1, powers := [(24, 1), (45, 1), (50, 1), (62, 1), (63, 1)] }, { coefficient := -1, powers := [(50, 1), (62, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(20, 1), (45, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(45, 1), (50, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(20, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(20, 1), (45, 1), (50, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(63, 1)] }],
  [{ coefficient := 1, powers := [(20, 1), (45, 1), (53, 1), (63, 1)] }, { coefficient := -1, powers := [(41, 1), (57, 1), (63, 1)] }, { coefficient := -1, powers := [(45, 1), (47, 1), (50, 1), (63, 1)] }, { coefficient := -1, powers := [(47, 1), (53, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(24, 1), (45, 1), (47, 1), (50, 1), (63, 1)] }, { coefficient := 1, powers := [(47, 1), (50, 1), (63, 1)] }],
...
#print axioms Krenn.Component36.SelectedLeafB2_1.selectedHasNoCommonZero

end Krenn.Component36.SelectedLeafB2_1
