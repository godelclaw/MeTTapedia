...
namespace Krenn.Component36.SelectedLeafB4_7_6_5_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "9910d7c3d747ab339d5af16a75acc1e5b3dcb3dc34fa1024670baf73bc531630"
def certificateSHA256 : String := "3338514360101516a2099eeaeb53cd7922794f75eb954bace60fadc7b76ea554"

set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedSourceIndices : Fin 15 → Fin 678 := ![
  10,
  13,
  14,
  15,
...
def multipliers : Fin 15 → SparsePoly (Fin 72) := ![
  [{ coefficient := 1, powers := [(29, 1), (61, 1), (70, 1)] }],
  [{ coefficient := 2, powers := [(23, 1), (61, 1), (70, 1)] }, { coefficient := 1, powers := [(35, 1), (41, 1), (70, 1)] }],
  [{ coefficient := 1, powers := [(35, 1), (38, 1), (68, 1)] }],
  ...
  [{ coefficient := 1, powers := [(5, 1), (32, 1)] }, { coefficient := 2, powers := [(13, 1), (23, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (35, 1), (38, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (29, 1), (61, 1)] }, { coefficient := -2, powers := [(8, 1), (23, 1), (61, 1)] }, { coefficient := -1, powers := [(8, 1), (35, 1), (41, 1)] }]
]
...
#print axioms Krenn.Component36.SelectedLeafB4_7_6_5_3.selectedHasNoCommonZero

end Krenn.Component36.SelectedLeafB4_7_6_5_3
