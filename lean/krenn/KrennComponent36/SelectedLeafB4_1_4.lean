...
namespace Krenn.Component36.SelectedLeafB4_1_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "27024ea055c38968120d1a73627b973c1f1b549aabf41c1ff14d86fd8f7566f3"
...
def multipliers : Fin 9 → SparsePoly (Fin 65) := ![
  ...
  [{ coefficient := -1, powers := [(20, 1), (63, 1)] }, { coefficient := 1, powers := [(24, 1), (47, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(45, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(20, 1), (53, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (45, 1), (63, 1)] }, { coefficient := 1, powers := [(63, 1)] }],
  [{ coefficient := -1, powers := [(20, 1), (24, 1), (53, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := 1, powers := [(0, 1), (24, 1), (41, 1), (45, 1), (63, 1)] }, { coefficient := -1, powers := [(0, 1), (41, 1), (63, 1)] }, { coefficient := 1, powers := [(20, 1), (24, 1), (45, 1), (50, 1), (63, 1)] }, { coefficient := -1, powers := [(24, 1), (47, 1), (50, 1), (63, 1)] }]
]
...
#print axioms Krenn.Component36.SelectedLeafB4_1_4.selectedHasNoCommonZero

end Krenn.Component36.SelectedLeafB4_1_4
