...
namespace Krenn.Component36.SelectedLeafB4_6_7_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "c4cba0de5a07de9b108b880a9aaaeb3e281be65d1f46c86a96e7f8153d9426c6"
...
def multipliers : Fin 19 → SparsePoly (Fin 70) := ![
  [{ coefficient := 1, powers := [(23, 1), (45, 1), (58, 1), (66, 1), (68, 1)] }, { coefficient := -1, powers := [(23, 1), (58, 1), (68, 1)] }, { coefficient := -1, powers := [(28, 1), (47, 1), (58, 1), (66, 1), (68, 1)] }],
  ...
  [{ coefficient := -1, powers := [(13, 1), (23, 1), (45, 1), (58, 1), (66, 1)] }, { coefficient := 1, powers := [(13, 1), (23, 1), (58, 1)] }, { coefficient := 1, powers := [(13, 1), (28, 1), (47, 1), (58, 1), (66, 1)] }],
...
#print axioms Krenn.Component36.SelectedLeafB4_6_7_6.selectedHasNoCommonZero

end Krenn.Component36.SelectedLeafB4_6_7_6
