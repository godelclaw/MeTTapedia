...
namespace Krenn.Component36.SelectedLeafB4_3_1_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "01dab5a9db74a163486e73242e68e9d0e4603a45d7442e7129b233242c6e96ec"
def certificateSHA256 : String := "8272cb9e338410ab001ae981caa47fa38b23035e18e621d11b73df49e4b587c1"
...
def multipliers : Fin 22 → SparsePoly (Fin 67) := ![
  [{ coefficient := 2, powers := [(16, 1), (43, 1), (52, 1), (58, 1), (65, 2)] }, { coefficient := -1, powers := [(16, 1), (43, 1), (58, 1), (65, 2), (66, 1)] }],
  [{ coefficient := -1, powers := [(34, 1), (37, 1), (47, 1), (53, 1), (58, 1), (64, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(34, 1), (37, 1), (53, 1), (58, 1), (64, 1), (65, 1)] }],
  [{ coefficient := -2, powers := [(16, 1), (52, 1), (58, 1), (65, 2)] }, { coefficient := 1, powers := [(16, 1), (58, 1), (65, 2), (66, 1)] }],
  ...
  [{ coefficient := 1, powers := [(4, 1), (31, 1), (58, 1), (65, 1)] }, { coefficient := -1, powers := [(11, 1), (21, 1), (24, 1), (58, 1), (65, 1), (66, 1)] }, { coefficient := 1, powers := [(11, 1), (21, 1), (58, 1), (65, 1)] }, { coefficient := -1, powers := [(12, 1), (19, 1), (34, 1), (37, 1), (47, 1), (58, 1), (64, 1), (65, 1)] }, { coefficient := 1, powers := [(12, 1), (20, 1), (34, 1), (37, 1), (58, 1), (64, 1), (65, 1)] }, { coefficient := -1, powers := [(16, 1), (21, 1), (58, 1), (65, 1)] }, { coefficient := -1, powers := [(17, 1), (21, 1), (25, 1), (52, 1), (65, 1)] }, { coefficient := 1, powers := [(17, 1), (21, 1), (54, 1), (65, 1)] }],
  [{ coefficient := 2, powers := [(16, 1), (21, 1), (52, 1), (58, 1), (65, 1)] }, { coefficient := -1, powers := [(16, 1), (21, 1), (58, 1), (65, 1), (66, 1)] }, { coefficient := -1, powers := [] }],
  [{ coefficient := -1, powers := [(7, 1), (21, 1), (58, 1), (60, 1), (65, 1)] }, { coefficient := -1, powers := [(16, 1), (21, 1), (52, 1), (58, 1), (65, 1)] }],
...
#print axioms Krenn.Component36.SelectedLeafB4_3_1_4.selectedHasNoCommonZero

end Krenn.Component36.SelectedLeafB4_3_1_4
