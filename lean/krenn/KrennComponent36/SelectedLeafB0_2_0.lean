...
namespace Krenn.Component36.SelectedLeafB0_2_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "715ffc5e8d52baaed05d3e819836eb1bad0e724059c99c009c7a1fd320378a17"
def certificateSHA256 : String := "7b0530d0e5e6cae95ff0803af92bef14ab788b97e513b78f9343d56bc44074de"
...
def selectedEquations : Fin 21 → SparsePoly (Fin 63) := ![
  ...
  [{ coefficient := 1, powers := [(2, 1), (46, 1)] }, { coefficient := 1, powers := [(18, 1), (27, 1), (40, 1)] }, { coefficient := 1, powers := [(18, 1), (28, 1)] }],
...
def multipliers : Fin 21 → SparsePoly (Fin 63) := ![
  ...
  [{ coefficient := -2, powers := [(27, 1), (52, 1), (55, 1)] }, { coefficient := -1, powers := [(29, 1), (53, 1)] }],
  ...
  [{ coefficient := -2, powers := [(23, 1), (55, 1)] }, { coefficient := -2, powers := [(27, 1), (47, 1), (55, 1)] }],
  [{ coefficient := 2, powers := [(24, 1), (47, 1), (55, 1)] }],
  ...
  [{ coefficient := 2, powers := [(18, 1), (27, 1), (55, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := -2, powers := [(18, 1), (27, 1), (47, 1), (52, 1), (55, 1)] }],
  [{ coefficient := -2, powers := [(24, 1), (46, 1), (47, 1), (55, 1)] }, { coefficient := 1, powers := [(38, 1), (61, 1)] }, { coefficient := 1, powers := [(41, 1), (58, 1)] }, { coefficient := -1, powers := [(43, 1), (47, 1), (55, 1)] }, { coefficient := -1, powers := [(48, 1), (55, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (35, 1)] }, { coefficient := -1, powers := [(18, 1), (29, 1)] }],
  [{ coefficient := 1, powers := [(13, 1), (19, 1), (29, 1), (48, 1)] }, { coefficient := -1, powers := [(13, 1), (19, 1), (35, 1), (38, 1)] }, { coefficient := -2, powers := [(18, 1), (20, 1), (27, 1), (55, 1)] }, { coefficient := 2, powers := [(18, 1), (23, 1), (24, 1), (55, 1)] }],
...
#print axioms Krenn.Component36.SelectedLeafB0_2_0.selectedHasNoCommonZero

end Krenn.Component36.SelectedLeafB0_2_0
