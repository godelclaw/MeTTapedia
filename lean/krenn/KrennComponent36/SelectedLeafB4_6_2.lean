...
namespace Krenn.Component36.SelectedLeafB4_6_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "bcc8fd5e21959754e98f5b9ebed3418c48f0271fe0e1342c5e766fa88e4d1bbe"
def certificateSHA256 : String := "3c3a11cae566258779dbf70e918b59eaa1c8529188b313cbebc96a568422b729"
...
def multipliers : Fin 19 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := 2, powers := [(13, 1), (29, 1), (52, 1)] }],
  ...
  [{ coefficient := 1, powers := [(38, 1), (61, 1)] }, { coefficient := 1, powers := [(41, 1), (58, 1)] }, { coefficient := -1, powers := [(48, 1), (50, 1), (54, 1)] }, { coefficient := -1, powers := [(48, 1), (55, 1)] }],
...
#print axioms Krenn.Component36.SelectedLeafB4_6_2.selectedHasNoCommonZero

end Krenn.Component36.SelectedLeafB4_6_2
