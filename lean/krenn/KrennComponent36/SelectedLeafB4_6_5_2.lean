...
namespace Krenn.Component36.SelectedLeafB4_6_5_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "6a3ef3290a9c9833a74708b0b90932c354cb58deb1f2e505b016ece9b977ffb5"
...
def multipliers : Fin 30 → SparsePoly (Fin 68) := ![
  ...
  [{ coefficient := 1, powers := [(7, 1), (23, 1), (26, 1), (58, 1), (60, 1), (67, 1)] }, { coefficient := -1, powers := [(7, 1), (23, 1), (31, 1), (45, 1), (58, 1), (67, 1)] }, { coefficient := -1, powers := [(7, 1), (23, 1), (34, 1), (40, 1), (58, 1), (67, 1)] }, { coefficient := -1, powers := [(11, 1), (23, 1), (34, 1), (37, 1), (58, 1), (67, 1)] }],
...
#print axioms Krenn.Component36.SelectedLeafB4_6_5_2.selectedHasNoCommonZero

end Krenn.Component36.SelectedLeafB4_6_5_2
