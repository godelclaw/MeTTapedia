...
namespace Krenn.Component36.SelectedLeafB4_3_5_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "7dbf11a5a1bb3d86bfadeee6c61bb9514d951d72f9dd53926f4a54e053f0705e"
...
def multipliers : Fin 23 → SparsePoly (Fin 69) := ![
  [{ coefficient := 1, powers := [(16, 1), (40, 1), (43, 1), (58, 1), (66, 2)] }, { coefficient := 1, powers := [(16, 1), (43, 1), (45, 1), (58, 1), (66, 2)] }, { coefficient := 2, powers := [(16, 1), (43, 1), (52, 1), (58, 1), (66, 2)] }],
  [{ coefficient := -1, powers := [(34, 1), (37, 1), (47, 1), (53, 1), (58, 1), (64, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(34, 1), (37, 1), (53, 1), (58, 1), (64, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(16, 1), (40, 1), (58, 1), (66, 2)] }, { coefficient := -1, powers := [(16, 1), (45, 1), (58, 1), (66, 2)] }, { coefficient := -2, powers := [(16, 1), (52, 1), (58, 1), (66, 2)] }],
  [{ coefficient := 1, powers := [(52, 1), (58, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(25, 1), (46, 1), (52, 1), (66, 1)] }, { coefficient := 1, powers := [(45, 1), (58, 1), (66, 1)] }, { coefficient := -1, powers := [(46, 1), (54, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(25, 1), (34, 1), (37, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(16, 1), (21, 1), (58, 1), (66, 1), (68, 1)] }],
  [{ coefficient := 1, powers := [(34, 1), (37, 1), (47, 1), (58, 1), (64, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(21, 1), (58, 1), (66, 1), (68, 1)] }],
  [{ coefficient := 1, powers := [(34, 1), (37, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(34, 1), (37, 1), (58, 1), (64, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(40, 1), (58, 1), (64, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(21, 1), (29, 1), (58, 1), (66, 1), (68, 1)] }],
  [{ coefficient := 1, powers := [(16, 1), (58, 1), (66, 1)] }, { coefficient := 1, powers := [(17, 1), (25, 1), (52, 1), (66, 1)] }, { coefficient := -1, powers := [(17, 1), (54, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(25, 1), (52, 1), (66, 1)] }, { coefficient := 1, powers := [(54, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(58, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(37, 1), (58, 1), (60, 1), (66, 1)] }, { coefficient := -1, powers := [(40, 1), (41, 1), (57, 1), (58, 1), (64, 1), (66, 1)] }, { coefficient := -1, powers := [(40, 1), (47, 1), (53, 1), (58, 1), (64, 1), (66, 1)] }, { coefficient := 1, powers := [(40, 1), (57, 1), (58, 1), (66, 1)] }, { coefficient := -1, powers := [(45, 1), (52, 1), (58, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(7, 1), (34, 1), (40, 1), (58, 1), (66, 1)] }, { coefficient := 1, powers := [(16, 1), (34, 1), (37, 1), (58, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(4, 1), (31, 1), (58, 1), (66, 1)] }, { coefficient := -1, powers := [(11, 1), (21, 1), (29, 1), (58, 1), (66, 1), (68, 1)] }, { coefficient := 1, powers := [(11, 1), (21, 1), (58, 1), (66, 1)] }, { coefficient := -1, powers := [(12, 1), (19, 1), (34, 1), (37, 1), (47, 1), (58, 1), (64, 1), (66, 1)] }, { coefficient := 1, powers := [(12, 1), (20, 1), (34, 1), (37, 1), (58, 1), (64, 1), (66, 1)] }, { coefficient := -1, powers := [(16, 1), (21, 1), (58, 1), (66, 1)] }, { coefficient := -1, powers := [(17, 1), (21, 1), (25, 1), (52, 1), (66, 1)] }, { coefficient := 1, powers := [(17, 1), (21, 1), (54, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(16, 1), (21, 1), (40, 1), (58, 1), (66, 1)] }, { coefficient := 1, powers := [(16, 1), (21, 1), (45, 1), (58, 1), (66, 1)] }, { coefficient := 2, powers := [(16, 1), (21, 1), (52, 1), (58, 1), (66, 1)] }, { coefficient := -1, powers := [] }],
  [{ coefficient := 1, powers := [(4, 1), (58, 1), (60, 1), (66, 1)] }, { coefficient := -1, powers := [(12, 1), (40, 1), (47, 1), (58, 1), (64, 1), (66, 1)] }, { coefficient := -1, powers := [(16, 1), (40, 1), (41, 1), (58, 1), (64, 1), (66, 1)] }, { coefficient := -1, powers := [(16, 1), (45, 1), (58, 1), (66, 1)] }, { coefficient := -1, powers := [(17, 1), (25, 1), (45, 1), (52, 1), (66, 1)] }, { coefficient := 1, powers := [(17, 1), (45, 1), (54, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(7, 1), (21, 1), (58, 1), (60, 1), (66, 1)] }, { coefficient := -1, powers := [(16, 1), (21, 1), (40, 1), (58, 1), (66, 1)] }, { coefficient := -1, powers := [(16, 1), (21, 1), (45, 1), (58, 1), (66, 1)] }, { coefficient := -1, powers := [(16, 1), (21, 1), (52, 1), (58, 1), (66, 1)] }]
]
...
#print axioms Krenn.Component36.SelectedLeafB4_3_5_5.selectedHasNoCommonZero

end Krenn.Component36.SelectedLeafB4_3_5_5
