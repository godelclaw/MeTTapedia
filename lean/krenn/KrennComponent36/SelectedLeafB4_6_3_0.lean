...
namespace Krenn.Component36.SelectedLeafB4_6_3_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "adf6f6ae1d1546879dfa05676c00fb5c4b28d4d9366fe0a52cdd29d389890a7b"
...
def multipliers : Fin 20 → SparsePoly (Fin 67) := ![
  [{ coefficient := -1, powers := [(7, 1), (43, 1), (60, 1), (66, 1)] }, { coefficient := -1, powers := [(17, 1), (57, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(34, 1), (37, 1), (52, 1)] }],
  [{ coefficient := 1, powers := [(7, 1), (60, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(11, 1), (25, 1), (34, 1), (37, 1), (45, 1), (52, 1), (66, 1)] }, { coefficient := -1, powers := [(11, 1), (34, 1), (37, 1), (45, 1), (54, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(19, 1), (37, 1), (60, 1)] }, { coefficient := 1, powers := [(52, 1)] }],
  [{ coefficient := 1, powers := [(45, 1)] }],
  [{ coefficient := -1, powers := [(11, 1), (25, 1), (34, 1), (37, 1), (45, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(11, 1), (34, 1), (37, 1), (45, 1), (66, 1)] }],
  ...
  [{ coefficient := -1, powers := [(19, 1), (37, 1), (45, 1), (60, 1)] }, { coefficient := 1, powers := [(37, 1), (60, 1)] }, { coefficient := -1, powers := [(39, 1), (40, 1), (57, 1), (63, 1)] }, { coefficient := -1, powers := [(40, 1), (51, 1), (63, 1)] }, { coefficient := -1, powers := [(40, 1), (57, 1), (58, 1), (66, 1)] }, { coefficient := 1, powers := [(40, 1), (57, 1)] }, { coefficient := -1, powers := [(45, 1), (52, 1)] }, { coefficient := -1, powers := [(46, 1), (54, 1), (57, 1), (66, 1)] }],
...
#print axioms Krenn.Component36.SelectedLeafB4_6_3_0.selectedHasNoCommonZero

end Krenn.Component36.SelectedLeafB4_6_3_0
