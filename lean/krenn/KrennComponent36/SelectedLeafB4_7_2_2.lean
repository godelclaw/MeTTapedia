...
namespace Krenn.Component36.SelectedLeafB4_7_2_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "5c0fa3e64ac1a432870e8a81a50260114c283f1c3ca4d8d01e2e21e5c8a8a4a7"
...
def multipliers : Fin 16 → SparsePoly (Fin 68) := ![
  ...
  [{ coefficient := -1, powers := [(13, 1), (40, 1), (43, 1), (64, 1)] }],
  [{ coefficient := -2, powers := [(23, 1), (40, 1), (55, 1), (64, 1)] }],
  ...
  [{ coefficient := 1, powers := [(5, 1), (32, 1), (40, 1), (64, 1)] }, { coefficient := -1, powers := [(13, 1), (23, 1), (40, 1), (64, 1)] }],
  [{ coefficient := 2, powers := [(18, 1), (23, 1), (40, 2), (55, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (40, 1), (61, 1), (64, 1)] }, { coefficient := 1, powers := [(13, 1), (40, 1), (43, 1), (47, 1), (64, 1)] }, { coefficient := -1, powers := [(13, 1), (40, 1), (48, 1), (64, 1)] }, { coefficient := -1, powers := [(18, 1), (40, 1), (47, 1), (50, 1), (64, 1)] }, { coefficient := 1, powers := [(18, 1), (41, 1), (45, 1), (64, 1)] }]
]
...
#print axioms Krenn.Component36.SelectedLeafB4_7_2_2.selectedHasNoCommonZero

end Krenn.Component36.SelectedLeafB4_7_2_2
