...
namespace Krenn.Component36.SelectedLeafB6_2_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "7750e57af61b94b03272e80714c18cd0a751bad41d1c640dc6da4160cdb92a86"
def certificateSHA256 : String := "3161dbc2b4a85e2294144daa0a935e33c9e87c20a7de74c631796b2dc898f916"
...
def multipliers : Fin 17 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := 1, powers := [(13, 1), (29, 1), (48, 1)] }, { coefficient := 2, powers := [(18, 1), (23, 1), (55, 1)] }, { coefficient := 1, powers := [(18, 1), (29, 1), (47, 1), (50, 1)] }],
...
#print axioms Krenn.Component36.SelectedLeafB6_2_4.selectedHasNoCommonZero

end Krenn.Component36.SelectedLeafB6_2_4
