...
namespace Krenn.Component36.SelectedLeafB4_4_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "c5b84a122ee46fef03b7749770d845e2b12a3c784bca95310a2783e3ba1dba92"
def certificateSHA256 : String := "b615dc660ed121a5ffb40103e98f679f7a2d226b7426a7e3aafb2fb58b776825"
...
def multipliers : Fin 29 → SparsePoly (Fin 67) := ![
  ...
  [{ coefficient := 1, powers := [(22, 1), (43, 1), (44, 1), (47, 1), (54, 1), (64, 1)] }, { coefficient := -1, powers := [(22, 1), (44, 1), (48, 1), (54, 1), (64, 1)] }, { coefficient := 1, powers := [(23, 1), (44, 1), (58, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(23, 1), (46, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (11, 1), (29, 1), (43, 1), (45, 1), (61, 1), (66, 1)] }, { coefficient := 1, powers := [(5, 1), (11, 1), (32, 1), (43, 1), (45, 1), (58, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (43, 1)] }],
  [{ coefficient := -1, powers := [(22, 1), (43, 1), (47, 1), (54, 1), (64, 1)] }, { coefficient := 1, powers := [(22, 1), (48, 1), (54, 1), (64, 1)] }, { coefficient := -1, powers := [(23, 1), (58, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(23, 1), (55, 1)] }, { coefficient := 1, powers := [(32, 1), (38, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (11, 1), (29, 1), (45, 1), (61, 1), (66, 1)] }, { coefficient := -1, powers := [(5, 1), (11, 1), (32, 1), (45, 1), (58, 1), (66, 1)] }],
...
#print axioms Krenn.Component36.SelectedLeafB4_4_7.selectedHasNoCommonZero

end Krenn.Component36.SelectedLeafB4_4_7
