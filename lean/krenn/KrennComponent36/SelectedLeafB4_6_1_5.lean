...
namespace Krenn.Component36.SelectedLeafB4_6_1_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "819f5ff5f96ae2a6d95ebf2ff979b5ba8d18eea214923598f0a229e1c9cca044"
...
def multipliers : Fin 29 → SparsePoly (Fin 68) := ![
  ...
  [{ coefficient := -1, powers := [(11, 1), (29, 1), (34, 1), (37, 1), (48, 1), (66, 1)] }, { coefficient := 1, powers := [(11, 1), (34, 1), (35, 1), (37, 1), (38, 1), (66, 1)] }, { coefficient := 1, powers := [(16, 1), (29, 1), (34, 1), (37, 1), (48, 1), (66, 1)] }, { coefficient := -1, powers := [(16, 1), (34, 1), (35, 1), (37, 1), (38, 1), (66, 1)] }],
  ...
  [{ coefficient := 1, powers := [(4, 1), (31, 1)] }, { coefficient := -1, powers := [(11, 1), (21, 1), (29, 1), (67, 1)] }, { coefficient := 1, powers := [(11, 1), (21, 1)] }, { coefficient := -1, powers := [(16, 1), (21, 1)] }],
...
#print axioms Krenn.Component36.SelectedLeafB4_6_1_5.selectedHasNoCommonZero

end Krenn.Component36.SelectedLeafB4_6_1_5
