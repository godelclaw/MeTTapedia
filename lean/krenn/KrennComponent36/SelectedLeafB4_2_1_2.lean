...
namespace Krenn.Component36.SelectedLeafB4_2_1_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "da18a4c35aa679f39a2454c6010a2f48ca7407dcdb1360147e93e118418590e5"
...
def multipliers : Fin 30 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := 1, powers := [(7, 1), (23, 1), (26, 1), (58, 1), (60, 1), (65, 1)] }, { coefficient := -1, powers := [(7, 1), (23, 1), (31, 1), (45, 1), (58, 1), (65, 1)] }, { coefficient := -1, powers := [(7, 1), (23, 1), (34, 1), (40, 1), (58, 1), (65, 1)] }, { coefficient := -1, powers := [(11, 1), (23, 1), (34, 1), (37, 1), (58, 1), (65, 1)] }],
...
#print axioms Krenn.Component36.SelectedLeafB4_2_1_2.selectedHasNoCommonZero

end Krenn.Component36.SelectedLeafB4_2_1_2
