...
namespace Krenn.Component36.SelectedLeafB0_3_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "91910555fe4dcfabe3f41c38b00ee58466536352d8e1ca386c0695858099e2af"
def certificateSHA256 : String := "db71d98bcf94830c66d472a327d59397208bead47e5d0d2c839e097e6af474a4"
...
def selectedEquations : Fin 39 → SparsePoly (Fin 64) := ![
  ...
  [{ coefficient := 1, powers := [(13, 1), (24, 1), (46, 1)] }, { coefficient := 1, powers := [(18, 1), (50, 1)] }],
...
def multipliers : Fin 39 → SparsePoly (Fin 64) := ![
  [{ coefficient := 2, powers := [(7, 1), (21, 1), (35, 1), (55, 1)] }],
  [{ coefficient := 1, powers := [(11, 1), (32, 1), (37, 1), (48, 1)] }, { coefficient := -1, powers := [(16, 1), (32, 1), (37, 1), (48, 1)] }],
  [{ coefficient := 1, powers := [(7, 1), (21, 1), (35, 1), (41, 1)] }],
  [{ coefficient := -1, powers := [(7, 1), (21, 1), (29, 1), (46, 1), (47, 1), (60, 1)] }],
  [{ coefficient := -1, powers := [(7, 1), (21, 1), (23, 1), (46, 1), (60, 1)] }, { coefficient := -1, powers := [(11, 1), (23, 1), (34, 1), (37, 1), (46, 1)] }, { coefficient := 1, powers := [(16, 1), (23, 1), (34, 1), (37, 1), (46, 1)] }],
  [{ coefficient := -1, powers := [(11, 1), (29, 1), (34, 1), (37, 1), (53, 1)] }, { coefficient := 1, powers := [(16, 1), (29, 1), (34, 1), (37, 1), (53, 1)] }],
  [{ coefficient := 1, powers := [(7, 1), (50, 1), (60, 1), (63, 1)] }, { coefficient := 1, powers := [(11, 1), (45, 1), (50, 1), (63, 1)] }, { coefficient := 1, powers := [(12, 1), (45, 1), (63, 1)] }, { coefficient := 1, powers := [(12, 1), (52, 1), (63, 1)] }, { coefficient := -1, powers := [(16, 1), (45, 1), (50, 1), (63, 1)] }, { coefficient := -1, powers := [(16, 1), (50, 1), (52, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(7, 1), (21, 1), (47, 1), (55, 1), (60, 1)] }],
  [{ coefficient := -1, powers := [(21, 1), (47, 1), (52, 1), (53, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(7, 1), (18, 1), (21, 1), (47, 1), (60, 1)] }],
  [{ coefficient := -1, powers := [(7, 1), (60, 1), (63, 1)] }, { coefficient := -1, powers := [(11, 1), (45, 1), (63, 1)] }, { coefficient := 1, powers := [(16, 1), (45, 1), (63, 1)] }, { coefficient := 1, powers := [(16, 1), (52, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(11, 1), (18, 1), (32, 1), (37, 1)] }, { coefficient := -1, powers := [(16, 1), (18, 1), (32, 1), (37, 1)] }],
  [{ coefficient := 1, powers := [(21, 1), (52, 1), (53, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(7, 1), (21, 1), (29, 1), (48, 1), (60, 1)] }, { coefficient := 1, powers := [(7, 1), (21, 1), (35, 1), (38, 1), (60, 1)] }, { coefficient := -1, powers := [(11, 1), (29, 1), (34, 1), (37, 1), (48, 1)] }, { coefficient := 1, powers := [(16, 1), (29, 1), (34, 1), (37, 1), (48, 1)] }],
  [{ coefficient := 1, powers := [(7, 1), (21, 1), (29, 1), (47, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(52, 1)] }],
  [{ coefficient := 1, powers := [(45, 1)] }],
  [{ coefficient := -1, powers := [(7, 1), (21, 1), (55, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(7, 1), (21, 1), (48, 1), (60, 1)] }, { coefficient := 1, powers := [(11, 1), (34, 1), (37, 1), (48, 1)] }, { coefficient := -1, powers := [(16, 1), (34, 1), (37, 1), (48, 1)] }],
  ...
  [{ coefficient := 1, powers := [(21, 1), (47, 1), (52, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(7, 1), (21, 1), (29, 1), (60, 1)] }, { coefficient := 1, powers := [(11, 1), (29, 1), (34, 1), (37, 1)] }, { coefficient := -1, powers := [(16, 1), (29, 1), (34, 1), (37, 1)] }],
  [{ coefficient := 1, powers := [(7, 1), (21, 1), (23, 1), (60, 1)] }, { coefficient := 1, powers := [(11, 1), (23, 1), (34, 1), (37, 1)] }, { coefficient := -1, powers := [(16, 1), (23, 1), (34, 1), (37, 1)] }],
  [{ coefficient := 1, powers := [(7, 1), (18, 1), (21, 1), (60, 1)] }],
  [{ coefficient := -1, powers := [(21, 1), (52, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(45, 1), (63, 1)] }, { coefficient := -1, powers := [(52, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(26, 1)] }],
  [{ coefficient := 1, powers := [(16, 1)] }],
  [{ coefficient := -1, powers := [(7, 1), (18, 1), (21, 1), (29, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(7, 1), (34, 1)] }, { coefficient := -1, powers := [(16, 1), (26, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := -1, powers := [(7, 1), (21, 1), (60, 1)] }, { coefficient := -1, powers := [(11, 1), (34, 1), (37, 1)] }, { coefficient := 1, powers := [(16, 1), (34, 1), (37, 1)] }],
  [{ coefficient := 1, powers := [(7, 1), (18, 1), (21, 1), (29, 1), (41, 1), (57, 1), (60, 1)] }, { coefficient := 1, powers := [(7, 1), (18, 1), (21, 1), (29, 1), (47, 1), (53, 1), (60, 1)] }, { coefficient := -1, powers := [(7, 1), (34, 1), (37, 1), (60, 1)] }, { coefficient := -1, powers := [(7, 1), (34, 1), (40, 1), (57, 1)] }, { coefficient := -1, powers := [(7, 1), (34, 1), (45, 1), (52, 1)] }, { coefficient := 1, powers := [(16, 1), (26, 1), (37, 1), (60, 1)] }, { coefficient := 1, powers := [(16, 1), (26, 1), (40, 1), (57, 1)] }, { coefficient := 1, powers := [(16, 1), (26, 1), (45, 1), (52, 1)] }],
  [{ coefficient := 1, powers := [(37, 1), (60, 1)] }, { coefficient := 1, powers := [(40, 1), (57, 1)] }, { coefficient := 1, powers := [(41, 1), (45, 1), (57, 1), (63, 1)] }, { coefficient := 1, powers := [(41, 1), (52, 1), (57, 1), (63, 1)] }, { coefficient := 1, powers := [(45, 1), (47, 1), (53, 1), (63, 1)] }, { coefficient := -1, powers := [(45, 1), (52, 1)] }, { coefficient := 1, powers := [(47, 1), (52, 1), (53, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(7, 1), (21, 1), (38, 1), (60, 1), (61, 1)] }, { coefficient := 1, powers := [(7, 1), (21, 1), (41, 1), (58, 1), (60, 1)] }, { coefficient := -1, powers := [(7, 1), (21, 1), (43, 1), (47, 1), (55, 1), (60, 1)] }, { coefficient := 1, powers := [(7, 1), (21, 1), (48, 1), (55, 1), (60, 1)] }, { coefficient := 1, powers := [(11, 1), (34, 1), (37, 1), (38, 1), (61, 1)] }, { coefficient := 1, powers := [(11, 1), (34, 1), (37, 1), (41, 1), (58, 1)] }, { coefficient := -1, powers := [(16, 1), (34, 1), (37, 1), (38, 1), (61, 1)] }, { coefficient := -1, powers := [(16, 1), (34, 1), (37, 1), (41, 1), (58, 1)] }],
  [{ coefficient := 1, powers := [(7, 1), (26, 1), (60, 1)] }, { coefficient := 1, powers := [(7, 1), (34, 1), (45, 1)] }, { coefficient := 1, powers := [(7, 1), (34, 1), (52, 1)] }, { coefficient := 1, powers := [(11, 1), (26, 1), (45, 1)] }, { coefficient := 1, powers := [(16, 1), (21, 1), (52, 1)] }],
  [{ coefficient := 1, powers := [(4, 1), (31, 1)] }, { coefficient := 1, powers := [(7, 1), (13, 1), (19, 1), (21, 1), (29, 1), (48, 1), (60, 1)] }, { coefficient := -1, powers := [(7, 1), (13, 1), (19, 1), (21, 1), (35, 1), (38, 1), (60, 1)] }, { coefficient := 1, powers := [(7, 1), (18, 1), (20, 1), (21, 1), (29, 1), (50, 1), (60, 1)] }, { coefficient := -1, powers := [(7, 1), (34, 1)] }, { coefficient := 1, powers := [(11, 1), (13, 1), (19, 1), (29, 1), (34, 1), (37, 1), (48, 1)] }, { coefficient := 1, powers := [(11, 1), (21, 1)] }, { coefficient := -1, powers := [(11, 1), (26, 1)] }, { coefficient := -1, powers := [(12, 1), (19, 1), (21, 1), (47, 1), (52, 1), (63, 1)] }, { coefficient := 1, powers := [(12, 1), (20, 1), (21, 1), (52, 1), (63, 1)] }, { coefficient := -1, powers := [(13, 1), (16, 1), (19, 1), (29, 1), (34, 1), (37, 1), (48, 1)] }, { coefficient := -1, powers := [(16, 1), (21, 1)] }, { coefficient := 1, powers := [(16, 1), (26, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (7, 1), (21, 1), (32, 1), (60, 1)] }, { coefficient := 1, powers := [(5, 1), (11, 1), (31, 1), (32, 1), (37, 1)] }, { coefficient := 1, powers := [(5, 1), (11, 1), (32, 1), (34, 1), (37, 1)] }, { coefficient := -1, powers := [(5, 1), (16, 1), (31, 1), (32, 1), (37, 1)] }, { coefficient := -1, powers := [(5, 1), (16, 1), (32, 1), (34, 1), (37, 1)] }]
]
...
#print axioms Krenn.Component36.SelectedLeafB0_3_0.selectedHasNoCommonZero

end Krenn.Component36.SelectedLeafB0_3_0
