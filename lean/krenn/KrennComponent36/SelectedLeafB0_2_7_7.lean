...
namespace Krenn.Component36.SelectedLeafB0_2_7_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "581712b54beeb540368838c7d52dde38a02bf2a149ada529777a463a865c3da6"
...
def multipliers : Fin 7 → SparsePoly (Fin 69) := ![
  [{ coefficient := 1, powers := [(25, 1), (40, 1), (65, 1), (67, 1)] }, { coefficient := 1, powers := [(25, 1), (45, 1), (65, 1), (67, 1)] }, { coefficient := 1, powers := [(25, 1), (52, 1), (65, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(43, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(25, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(65, 1)] }],
  [{ coefficient := 1, powers := [(25, 1), (46, 1), (52, 1), (65, 1)] }, { coefficient := -1, powers := [(40, 1), (58, 1), (65, 1)] }, { coefficient := 1, powers := [(43, 1), (45, 1), (54, 1), (65, 1)] }, { coefficient := -1, powers := [(46, 1), (54, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := -1, powers := [(25, 1), (40, 1), (43, 1), (65, 1)] }, { coefficient := -1, powers := [(25, 1), (43, 1), (45, 1), (65, 1)] }, { coefficient := -1, powers := [(25, 1), (43, 1), (52, 1), (65, 1)] }]
]
...
#print axioms Krenn.Component36.SelectedLeafB0_2_7_7.selectedHasNoCommonZero

end Krenn.Component36.SelectedLeafB0_2_7_7
