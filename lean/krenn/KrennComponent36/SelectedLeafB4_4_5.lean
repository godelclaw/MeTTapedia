...
namespace Krenn.Component36.SelectedLeafB4_4_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "a11aec3ac9d4304ffc874c190530dd759f15e9da88ed7c7748f59934ea42ac49"
...
def multipliers : Fin 30 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := -1, powers := [(7, 1), (43, 1), (60, 1), (65, 1)] }, { coefficient := -1, powers := [(11, 1), (43, 1), (52, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(26, 1), (45, 1), (46, 1), (54, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(26, 1), (45, 1), (46, 1), (65, 1)] }],
  ...
  [{ coefficient := 1, powers := [(7, 1), (60, 1), (65, 1)] }, { coefficient := 1, powers := [(11, 1), (52, 1), (65, 1)] }],
  ...
  [{ coefficient := -1, powers := [(26, 1), (45, 1), (54, 1), (65, 1)] }],
  ...
  [{ coefficient := 1, powers := [(26, 1), (45, 1), (65, 1)] }],
...
#print axioms Krenn.Component36.SelectedLeafB4_4_5.selectedHasNoCommonZero

end Krenn.Component36.SelectedLeafB4_4_5
