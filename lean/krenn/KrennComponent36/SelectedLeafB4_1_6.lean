...
namespace Krenn.Component36.SelectedLeafB4_1_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "a20149c13e011cac71aa0355f3a153bf6e21ecf79dd21e38b22fa2493a03900a"
...
def multipliers : Fin 24 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := 1, powers := [(22, 1), (43, 1), (44, 1), (47, 1), (54, 1), (64, 1)] }, { coefficient := -2, powers := [(22, 1), (44, 1), (48, 1), (54, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(23, 1), (46, 1)] }],
  [{ coefficient := -1, powers := [(29, 1), (53, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (43, 1)] }],
  [{ coefficient := -1, powers := [(22, 1), (43, 1), (47, 1), (54, 1), (64, 1)] }, { coefficient := 2, powers := [(22, 1), (48, 1), (54, 1), (64, 1)] }],
...
#print axioms Krenn.Component36.SelectedLeafB4_1_6.selectedHasNoCommonZero

end Krenn.Component36.SelectedLeafB4_1_6
