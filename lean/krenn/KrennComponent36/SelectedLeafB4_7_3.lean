...
namespace Krenn.Component36.SelectedLeafB4_7_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "6f5234756ca3c2ea5dadf47d7c69d0573f307e4567f5f231a69e846b7cb03db6"
def certificateSHA256 : String := "3926f0f3b7931471562db4d4ed3174fd3a638f01e05b7c1772caac269d120f9a"
...
def multipliers : Fin 29 → SparsePoly (Fin 68) := ![
  ...
  [{ coefficient := -1, powers := [(11, 1), (29, 1), (34, 1), (37, 1), (48, 1), (52, 1)] }, { coefficient := 1, powers := [(16, 1), (29, 1), (34, 1), (37, 1), (48, 1), (52, 1)] }],
  ...
  [{ coefficient := 1, powers := [(11, 1), (13, 1), (29, 1), (34, 1), (37, 1), (52, 1)] }, { coefficient := -1, powers := [(13, 1), (16, 1), (29, 1), (34, 1), (37, 1), (52, 1)] }],
  [{ coefficient := 1, powers := [(52, 1)] }],
  [{ coefficient := 1, powers := [(45, 1)] }],
  [{ coefficient := 1, powers := [(11, 1), (34, 1), (37, 1), (48, 1)] }, { coefficient := -1, powers := [(16, 1), (34, 1), (37, 1), (48, 1)] }],
  [{ coefficient := -1, powers := [(11, 1), (13, 1), (29, 1), (34, 1), (37, 1)] }, { coefficient := 1, powers := [(13, 1), (16, 1), (29, 1), (34, 1), (37, 1)] }],
  ...
  [{ coefficient := 1, powers := [(37, 1), (60, 1)] }, { coefficient := -1, powers := [(40, 1), (41, 1), (57, 1), (65, 1)] }, { coefficient := -1, powers := [(40, 1), (47, 1), (53, 1), (65, 1)] }, { coefficient := -1, powers := [(40, 1), (57, 1), (58, 1), (67, 1)] }, { coefficient := 1, powers := [(40, 1), (57, 1)] }, { coefficient := -1, powers := [(45, 1), (52, 1)] }, { coefficient := -1, powers := [(46, 1), (54, 1), (57, 1), (67, 1)] }],
...
#print axioms Krenn.Component36.SelectedLeafB4_7_3.selectedHasNoCommonZero

end Krenn.Component36.SelectedLeafB4_7_3
