...
namespace Krenn.Component36.SelectedLeafB4_7_2_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "31570951d2a4ca0043e67bbe68914208ca691ace6641bd747da8cdb42df8e342"
...
def multipliers : Fin 16 → SparsePoly (Fin 69) := ![
  [{ coefficient := -1, powers := [(23, 1), (40, 1), (46, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(29, 1), (40, 1), (48, 1), (64, 1), (67, 1)] }, { coefficient := 1, powers := [(35, 1), (38, 1), (40, 1), (64, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(29, 1), (40, 1), (53, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(29, 1), (41, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(23, 1), (40, 1), (55, 1), (64, 1)] }, { coefficient := -1, powers := [(28, 1), (41, 1), (54, 1), (64, 1)] }, { coefficient := 1, powers := [(29, 1), (41, 1), (52, 1), (64, 1)] }, { coefficient := 1, powers := [(32, 1), (38, 1), (40, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(40, 1), (55, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(40, 1), (48, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(29, 1), (40, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(23, 1), (40, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(41, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(40, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(38, 1), (40, 1), (61, 1), (64, 1)] }, { coefficient := -1, powers := [(40, 1), (48, 1), (55, 1), (64, 1)] }, { coefficient := -1, powers := [(41, 1), (46, 1), (54, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := 1, powers := [(5, 1), (32, 1), (40, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(18, 1), (23, 1), (40, 2), (55, 1), (64, 1)] }, { coefficient := 1, powers := [(18, 1), (28, 1), (40, 1), (41, 1), (54, 1), (64, 1)] }, { coefficient := -1, powers := [(18, 1), (29, 1), (40, 1), (41, 1), (52, 1), (64, 1)] }, { coefficient := -1, powers := [(18, 1), (32, 1), (38, 1), (40, 2), (64, 1)] }],
  [{ coefficient := 1, powers := [(13, 1), (29, 1), (40, 1), (48, 1), (64, 1)] }, { coefficient := -1, powers := [(13, 1), (35, 1), (38, 1), (40, 1), (64, 1)] }]
]
...
#print axioms Krenn.Component36.SelectedLeafB4_7_2_3.selectedHasNoCommonZero

end Krenn.Component36.SelectedLeafB4_7_2_3
