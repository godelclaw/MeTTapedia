...
namespace Krenn.Component36.SelectedLeafB4_1_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "9575f343dd2534985c8b4c4f9e43d7605d96116cb111fc3e8c4db04869a98e47"
...
def multipliers : Fin 9 → SparsePoly (Fin 65) := ![
  ...
  [{ coefficient := 1, powers := [(19, 1), (54, 1), (64, 1)] }, { coefficient := -1, powers := [(25, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(25, 1), (46, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (52, 1), (64, 1)] }, { coefficient := 1, powers := [(64, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (19, 1), (52, 1), (58, 1), (64, 1)] }, { coefficient := -1, powers := [(0, 1), (58, 1), (64, 1)] }, { coefficient := 1, powers := [(19, 1), (25, 1), (43, 1), (52, 1), (64, 1)] }, { coefficient := -1, powers := [(19, 1), (43, 1), (54, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (25, 1), (46, 1), (64, 1)] }],
...
#print axioms Krenn.Component36.SelectedLeafB4_1_1.selectedHasNoCommonZero

end Krenn.Component36.SelectedLeafB4_1_1
