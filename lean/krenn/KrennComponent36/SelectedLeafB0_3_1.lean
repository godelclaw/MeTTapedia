...
namespace Krenn.Component36.SelectedLeafB0_3_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "c0a9bae186e546f1dad5346a1fae8672bcb0430296d2e7dde414afbe4b30b0b1"
def certificateSHA256 : String := "3f7785b5d437b4a2c10d2d434f3b0bd495b6dfb8b5cdef69de3fc2e32c6aff4a"
...
def multipliers : Fin 36 → SparsePoly (Fin 65) := ![
  [{ coefficient := 1, powers := [(11, 1), (32, 1), (37, 1), (58, 1)] }, { coefficient := 1, powers := [(11, 1), (35, 1), (37, 1), (55, 1)] }],
  [{ coefficient := -1, powers := [(11, 1), (29, 1), (34, 1), (37, 1), (46, 1), (47, 1)] }],
  [{ coefficient := -1, powers := [(11, 1), (23, 1), (34, 1), (37, 1), (46, 1)] }],
  [{ coefficient := -1, powers := [(7, 1), (43, 1), (60, 1), (64, 1)] }, { coefficient := 1, powers := [(16, 1), (43, 1), (52, 1), (64, 1)] }],
  ...
  [{ coefficient := 1, powers := [(11, 1), (34, 1), (37, 1), (47, 1), (55, 1)] }],
  [{ coefficient := -1, powers := [(34, 1), (37, 1), (47, 1), (53, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(11, 1), (18, 1), (34, 1), (37, 1), (47, 1)] }],
  ...
  [{ coefficient := 1, powers := [(34, 1), (37, 1), (53, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(11, 1), (29, 1), (34, 1), (37, 1), (48, 1)] }],
  [{ coefficient := 1, powers := [(11, 1), (29, 1), (34, 1), (37, 1), (47, 1)] }],
  [{ coefficient := 1, powers := [(7, 1), (60, 1), (64, 1)] }, { coefficient := -1, powers := [(16, 1), (52, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(52, 1)] }],
  [{ coefficient := 1, powers := [(45, 1)] }],
  [{ coefficient := -1, powers := [(11, 1), (34, 1), (37, 1), (55, 1)] }],
  [{ coefficient := 1, powers := [(11, 1), (34, 1), (37, 1), (48, 1)] }],
  [{ coefficient := 1, powers := [(11, 1), (35, 1), (37, 1)] }],
  [{ coefficient := 1, powers := [(34, 1), (37, 1), (47, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(11, 1), (29, 1), (34, 1), (37, 1)] }],
  [{ coefficient := 1, powers := [(11, 1), (23, 1), (34, 1), (37, 1)] }],
  [{ coefficient := 1, powers := [(11, 1), (18, 1), (34, 1), (37, 1)] }],
  [{ coefficient := -1, powers := [(34, 1), (37, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(45, 1), (63, 1)] }, { coefficient := -1, powers := [(52, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(26, 1)] }],
  [{ coefficient := 1, powers := [(16, 1)] }],
  [{ coefficient := -1, powers := [(11, 1), (18, 1), (29, 1), (34, 1), (37, 1)] }],
  [{ coefficient := 1, powers := [(7, 1), (34, 1)] }, { coefficient := -1, powers := [(16, 1), (26, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := -1, powers := [(11, 1), (34, 1), (37, 1)] }],
  [{ coefficient := -1, powers := [(7, 1), (34, 1), (37, 1), (60, 1)] }, { coefficient := -1, powers := [(7, 1), (34, 1), (40, 1), (57, 1)] }, { coefficient := -1, powers := [(7, 1), (34, 1), (45, 1), (52, 1)] }, { coefficient := 1, powers := [(11, 1), (18, 1), (29, 1), (34, 1), (37, 1), (41, 1), (57, 1)] }, { coefficient := 1, powers := [(11, 1), (18, 1), (29, 1), (34, 1), (37, 1), (47, 1), (53, 1)] }, { coefficient := 1, powers := [(16, 1), (26, 1), (37, 1), (60, 1)] }, { coefficient := 1, powers := [(16, 1), (26, 1), (40, 1), (57, 1)] }, { coefficient := 1, powers := [(16, 1), (26, 1), (45, 1), (52, 1)] }],
  ...
  [{ coefficient := 1, powers := [(11, 1), (34, 1), (37, 1), (38, 1), (61, 1)] }, { coefficient := 1, powers := [(11, 1), (34, 1), (37, 1), (41, 1), (58, 1)] }, { coefficient := -1, powers := [(11, 1), (34, 1), (37, 1), (43, 1), (47, 1), (55, 1)] }, { coefficient := 1, powers := [(11, 1), (34, 1), (37, 1), (48, 1), (55, 1)] }],
  [{ coefficient := 1, powers := [(7, 1), (26, 1), (60, 1)] }, { coefficient := 1, powers := [(7, 1), (34, 1), (45, 1)] }, { coefficient := 1, powers := [(7, 1), (34, 1), (52, 1)] }, { coefficient := 1, powers := [(11, 1), (26, 1), (45, 1)] }, { coefficient := 1, powers := [(16, 1), (34, 1), (37, 1)] }],
  [{ coefficient := 1, powers := [(4, 1), (31, 1)] }, { coefficient := -1, powers := [(7, 1), (34, 1)] }, { coefficient := 1, powers := [(11, 1), (13, 1), (19, 1), (29, 1), (34, 1), (37, 1), (48, 1)] }, { coefficient := 1, powers := [(11, 1), (18, 1), (20, 1), (29, 1), (34, 1), (37, 1), (50, 1)] }, { coefficient := 1, powers := [(11, 1), (21, 1)] }, { coefficient := -1, powers := [(11, 1), (26, 1)] }, { coefficient := -1, powers := [(12, 1), (19, 1), (34, 1), (37, 1), (47, 1), (63, 1)] }, { coefficient := 1, powers := [(12, 1), (20, 1), (34, 1), (37, 1), (63, 1)] }, { coefficient := -1, powers := [(16, 1), (21, 1)] }, { coefficient := 1, powers := [(16, 1), (26, 1)] }],
  [{ coefficient := -1, powers := [(7, 1), (21, 1), (60, 1)] }, { coefficient := 1, powers := [(16, 1), (21, 1), (52, 1)] }]
]
...
#print axioms Krenn.Component36.SelectedLeafB0_3_1.selectedHasNoCommonZero

end Krenn.Component36.SelectedLeafB0_3_1
