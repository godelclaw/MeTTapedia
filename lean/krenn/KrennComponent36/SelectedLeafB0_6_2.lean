...
namespace Krenn.Component36.SelectedLeafB0_6_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "6d6d23aeafedbfa9f66543c165aba2a9c18afb7c50b9455dee638b6aea0bac00"
def certificateSHA256 : String := "3fcd5256e3de905d403fe5ad6b07f4f6d2788ec492500fd1a1342f34c6ad2d63"
...
def multipliers : Fin 19 → SparsePoly (Fin 65) := ![
  ...
  [{ coefficient := 1, powers := [(23, 1), (51, 1), (55, 1), (62, 1)] }, { coefficient := -1, powers := [(32, 1), (38, 1), (51, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(29, 1), (53, 1)] }],
  [{ coefficient := 1, powers := [(48, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [(23, 1), (55, 1), (62, 1)] }, { coefficient := 1, powers := [(32, 1), (38, 1), (62, 1)] }],
...
#print axioms Krenn.Component36.SelectedLeafB0_6_2.selectedHasNoCommonZero

end Krenn.Component36.SelectedLeafB0_6_2
