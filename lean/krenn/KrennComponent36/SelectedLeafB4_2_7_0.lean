...
namespace Krenn.Component36.SelectedLeafB4_2_7_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "3f627ed2485d45a15a78c058746018936da8877de91a1caa350c5319d240c28e"
def certificateSHA256 : String := "34f4ab2ac56673e83d1183d27636e0cf86be8aaba84a78f101ce66e0004f3313"
...
def multipliers : Fin 20 → SparsePoly (Fin 67) := ![
  ...
  [{ coefficient := 1, powers := [(5, 1), (32, 1), (58, 1)] }, { coefficient := -1, powers := [(13, 1), (23, 1), (58, 1)] }, { coefficient := 1, powers := [(13, 1), (28, 1), (47, 1), (58, 1), (65, 1)] }, { coefficient := -1, powers := [] }],
  [{ coefficient := 2, powers := [(13, 1), (23, 1), (44, 1), (58, 1), (64, 1)] }, { coefficient := 2, powers := [(18, 1), (23, 1), (40, 1), (55, 1), (58, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (58, 1), (61, 1), (66, 1)] }, { coefficient := -1, powers := [(13, 1), (43, 1), (45, 1), (47, 1), (58, 1), (65, 1), (66, 1)] }, { coefficient := 1, powers := [(13, 1), (43, 1), (47, 1), (58, 1), (66, 1)] }, { coefficient := 1, powers := [(13, 1), (46, 1), (47, 1), (58, 1), (65, 1), (66, 1)] }, { coefficient := -1, powers := [(13, 1), (48, 1), (58, 1), (66, 1)] }, { coefficient := -1, powers := [(18, 1), (47, 1), (50, 1), (58, 1), (66, 1)] }]
]
...
#print axioms Krenn.Component36.SelectedLeafB4_2_7_0.selectedHasNoCommonZero

end Krenn.Component36.SelectedLeafB4_2_7_0
