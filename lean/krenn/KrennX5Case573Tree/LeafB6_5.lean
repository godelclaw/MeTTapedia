...
namespace Krenn.X5Case573Tree.LeafB6_5

open Krenn.SparseCertificate
open MvPolynomial

def sourceSystemFileSHA256 : String := "49de08600bffc75eb3b638be44fb84d7093fcdc85fa68de4f23e10dd98d3bbb2"
def sourceSystemSemanticSHA256 : String := "e68ac6b7c750aefb835e00159bd7c7985b48aaa94b869418a0553a94cd8884e6"
def certificateSHA256 : String := "2b9cda89241a41737d4544674d211d7e78394a7904c5814d6cc77e2fbce00054"
def sourceEquationCount : Nat := 681

set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedIndices : Fin 33 → Fin 681 := ![
  0,
  9,
  18,
  21,
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedEquations : Fin 33 → SparsePoly (Fin 74) := ![
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def multipliers : Fin 33 → SparsePoly (Fin 74) := ![
  [{ coefficient := -1, powers := [(0, 1), (3, 1), (32, 1), (35, 1), (59, 1), (61, 1), (70, 1)] }, { coefficient := 1, powers := [(3, 1), (32, 1), (35, 1), (59, 1), (61, 1)] }, { coefficient := -1, powers := [(6, 1), (8, 1), (27, 1), (28, 1), (35, 1), (58, 1), (59, 1), (61, 1), (72, 1)] }, { coefficient := 1, powers := [(6, 1), (24, 1), (28, 1), (35, 1), (58, 1), (59, 1), (61, 1), (72, 1)] }, { coefficient := -1, powers := [(8, 1), (13, 1), (27, 1), (28, 1), (35, 1), (47, 1), (59, 1), (61, 1), (72, 1)] }, { coefficient := -1, powers := [(11, 1), (32, 1), (35, 1), (48, 1), (61, 1)] }, { coefficient := 1, powers := [(13, 1), (24, 1), (28, 1), (35, 1), (47, 1), (59, 1), (61, 1), (72, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (47, 1), (55, 1), (73, 1)] }, { coefficient := -1, powers := [(44, 1), (55, 1), (73, 1)] }],
  [{ coefficient := 1, powers := [(34, 1), (41, 1), (47, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (34, 1), (41, 1), (47, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (19, 1), (34, 1), (41, 1)] }, { coefficient := -1, powers := [(8, 1), (22, 1), (27, 1), (28, 1), (35, 1), (59, 1), (61, 1), (72, 1)] }, { coefficient := 1, powers := [(16, 1), (34, 1), (41, 1)] }, { coefficient := 1, powers := [(22, 1), (24, 1), (28, 1), (35, 1), (59, 1), (61, 1), (72, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (20, 1), (28, 1), (35, 1), (59, 1), (61, 1), (72, 1)] }, { coefficient := -1, powers := [(17, 1), (28, 1), (35, 1), (59, 1), (61, 1), (72, 1)] }],
  [{ coefficient := -1, powers := [(17, 1), (28, 1), (32, 1), (35, 1), (36, 1), (61, 1), (72, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (55, 1), (73, 1)] }],
  [{ coefficient := 1, powers := [(28, 1), (32, 1), (35, 1), (36, 1), (61, 1), (72, 1)] }],
  [{ coefficient := 1, powers := [(32, 1), (41, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (47, 1)] }, { coefficient := 1, powers := [(2, 1), (8, 1), (47, 1)] }],
  [{ coefficient := -1, powers := [(3, 1), (32, 1), (35, 1), (45, 1), (61, 1), (70, 1)] }, { coefficient := -1, powers := [(33, 1), (35, 1), (47, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(32, 1), (35, 1), (48, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (27, 1)] }, { coefficient := 1, powers := [(24, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (19, 1)] }, { coefficient := 1, powers := [(16, 1)] }],
  [{ coefficient := 1, powers := [(20, 1), (32, 1), (35, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(11, 1), (32, 1), (35, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(55, 1), (73, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (34, 1), (41, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (28, 1), (35, 1), (59, 1), (61, 1), (72, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (27, 1), (28, 1), (35, 1), (59, 1), (61, 1), (72, 1)] }, { coefficient := -1, powers := [(24, 1), (28, 1), (35, 1), (59, 1), (61, 1), (72, 1)] }],
  [{ coefficient := 1, powers := [(28, 1), (35, 1), (59, 1), (61, 1), (72, 1)] }],
  [{ coefficient := -1, powers := [(34, 1), (41, 1)] }],
  [{ coefficient := 1, powers := [(3, 1), (32, 1), (35, 1), (61, 1), (70, 1)] }],
  [{ coefficient := 1, powers := [(0, 1)] }, { coefficient := -1, powers := [(2, 1), (8, 1)] }],
  [{ coefficient := 1, powers := [(33, 1), (35, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(8, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := -1, powers := [(32, 1), (35, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(3, 1), (32, 1), (35, 1), (53, 1), (61, 1), (68, 1)] }],
  [{ coefficient := -1, powers := [(28, 1), (32, 1), (35, 1), (36, 1), (61, 1), (65, 1)] }, { coefficient := -1, powers := [(28, 1), (32, 1), (35, 1), (39, 1), (59, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (3, 1), (32, 1), (35, 1), (61, 1), (65, 1), (70, 1)] }, { coefficient := 1, powers := [(3, 1), (32, 1), (35, 1), (61, 1), (65, 1)] }, { coefficient := -1, powers := [(20, 1), (32, 1), (35, 1), (48, 1), (61, 1)] }],
...
#print axioms Krenn.X5Case573Tree.LeafB6_5.selectedHasNoCommonZero

end Krenn.X5Case573Tree.LeafB6_5
