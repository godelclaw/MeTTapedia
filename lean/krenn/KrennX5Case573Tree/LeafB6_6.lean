...
namespace Krenn.X5Case573Tree.LeafB6_6

open Krenn.SparseCertificate
open MvPolynomial

def sourceSystemFileSHA256 : String := "06510a9b74e224a16bfd30cd38f884572b2cd4f7972af5f5f64a7fa96314849f"
def sourceSystemSemanticSHA256 : String := "6d051abc3b25490af2411c4b0e6e336ceea450ae83a47782077a98c4e85b6a0b"
def certificateSHA256 : String := "bb30169b6c2ce285ecf2647fb3da4037f9084efa0b0be722941c06a63b4b48a7"
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedEquations : Fin 20 → SparsePoly (Fin 74) := ![
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def multipliers : Fin 20 → SparsePoly (Fin 74) := ![
  ...
  [{ coefficient := -1, powers := [(0, 1), (19, 1), (55, 1), (66, 1), (73, 1)] }],
  ...
  [{ coefficient := 1, powers := [(0, 1), (55, 1), (66, 1), (73, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (55, 1), (64, 1), (73, 1)] }, { coefficient := 1, powers := [(32, 1), (35, 1), (61, 1), (73, 1)] }],
...
#print axioms Krenn.X5Case573Tree.LeafB6_6.selectedHasNoCommonZero

end Krenn.X5Case573Tree.LeafB6_6
