...
namespace Krenn.X5Case573Tree.LeafB7_5

open Krenn.SparseCertificate
open MvPolynomial

def sourceSystemFileSHA256 : String := "8c396d7ada82a45012e42915cf04007bdde9deb4bda1b5317a48ba4428e77401"
def sourceSystemSemanticSHA256 : String := "3a1f6c74e4cefab747733596fd29b3f7984c2c5ab5f833464b7fe833509eb720"
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedEquations : Fin 33 → SparsePoly (Fin 75) := ![
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def multipliers : Fin 33 → SparsePoly (Fin 75) := ![
  [{ coefficient := -1, powers := [(0, 1), (3, 1), (32, 1), (35, 1), (59, 1), (61, 1), (70, 1)] }, { coefficient := 1, powers := [(3, 1), (32, 1), (35, 1), (59, 1), (61, 1)] }, { coefficient := -1, powers := [(6, 1), (8, 1), (27, 1), (28, 1), (35, 1), (58, 1), (59, 1), (61, 1), (73, 1)] }, { coefficient := 1, powers := [(6, 1), (24, 1), (28, 1), (35, 1), (58, 1), (59, 1), (61, 1), (73, 1)] }, { coefficient := -1, powers := [(8, 1), (13, 1), (27, 1), (28, 1), (35, 1), (47, 1), (59, 1), (61, 1), (73, 1)] }, { coefficient := -1, powers := [(11, 1), (32, 1), (35, 1), (48, 1), (61, 1)] }, { coefficient := 1, powers := [(13, 1), (24, 1), (28, 1), (35, 1), (47, 1), (59, 1), (61, 1), (73, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (47, 1), (55, 1), (74, 1)] }, { coefficient := -1, powers := [(44, 1), (55, 1), (74, 1)] }],
  [{ coefficient := 1, powers := [(34, 1), (41, 1), (47, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (34, 1), (41, 1), (47, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (19, 1), (34, 1), (41, 1)] }, { coefficient := -1, powers := [(8, 1), (22, 1), (27, 1), (28, 1), (35, 1), (59, 1), (61, 1), (73, 1)] }, { coefficient := 1, powers := [(16, 1), (34, 1), (41, 1)] }, { coefficient := 1, powers := [(22, 1), (24, 1), (28, 1), (35, 1), (59, 1), (61, 1), (73, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (20, 1), (28, 1), (35, 1), (59, 1), (61, 1), (73, 1)] }, { coefficient := -1, powers := [(17, 1), (28, 1), (35, 1), (59, 1), (61, 1), (73, 1)] }],
  [{ coefficient := -1, powers := [(17, 1), (28, 1), (32, 1), (35, 1), (36, 1), (61, 1), (73, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (55, 1), (74, 1)] }],
  [{ coefficient := 1, powers := [(28, 1), (32, 1), (35, 1), (36, 1), (61, 1), (73, 1)] }],
  ...
  [{ coefficient := -1, powers := [(8, 1), (28, 1), (35, 1), (59, 1), (61, 1), (73, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (27, 1), (28, 1), (35, 1), (59, 1), (61, 1), (73, 1)] }, { coefficient := -1, powers := [(24, 1), (28, 1), (35, 1), (59, 1), (61, 1), (73, 1)] }],
  [{ coefficient := 1, powers := [(28, 1), (35, 1), (59, 1), (61, 1), (73, 1)] }],
...
#print axioms Krenn.X5Case573Tree.LeafB7_5.selectedHasNoCommonZero

end Krenn.X5Case573Tree.LeafB7_5
