...
namespace Krenn.X5Case573Tree.LeafB7_3

open Krenn.SparseCertificate
open MvPolynomial

def sourceSystemFileSHA256 : String := "8d78fe5e114104755e26d8d23c7990769d3aa09e5ab802612740bb2939e49b20"
def sourceSystemSemanticSHA256 : String := "519f58d34053217361b497df9545a7abdca5e9969113f23edf87cc9aba6617f1"
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedEquations : Fin 14 → SparsePoly (Fin 75) := ![
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def multipliers : Fin 14 → SparsePoly (Fin 75) := ![
...
#print axioms Krenn.X5Case573Tree.LeafB7_3.selectedHasNoCommonZero

end Krenn.X5Case573Tree.LeafB7_3
