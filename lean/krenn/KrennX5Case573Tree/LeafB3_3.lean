...
namespace Krenn.X5Case573Tree.LeafB3_3

open Krenn.SparseCertificate
open MvPolynomial

def sourceSystemFileSHA256 : String := "275f22539f007b6e6a2be9b06f58b8cafef7c7271bbc4f3d96012d2d890e265c"
def sourceSystemSemanticSHA256 : String := "741b0762f485d2c8cc96880332880b4595d3d3a8f1105dc341dc40cd169bdd62"
def certificateSHA256 : String := "5149919cb67bb0d265792d097a7c5e2b31c8fe484bd8ea31f721304a2b45b803"
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedEquations : Fin 15 → SparsePoly (Fin 74) := ![
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def multipliers : Fin 15 → SparsePoly (Fin 74) := ![
  ...
  [{ coefficient := 1, powers := [(52, 1), (67, 1)] }, { coefficient := 1, powers := [(58, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (64, 1)] }, { coefficient := -1, powers := [(19, 1), (32, 1), (35, 1)] }, { coefficient := 1, powers := [(32, 1), (38, 1)] }]
]
...
#print axioms Krenn.X5Case573Tree.LeafB3_3.selectedHasNoCommonZero

end Krenn.X5Case573Tree.LeafB3_3
