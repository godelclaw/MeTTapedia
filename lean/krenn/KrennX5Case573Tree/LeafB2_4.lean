...
namespace Krenn.X5Case573Tree.LeafB2_4

open Krenn.SparseCertificate
open MvPolynomial

def sourceSystemFileSHA256 : String := "38449a8f11e9c324c753968e2f5b5b10acb5d49cb7fab3740a5b9106efe9823f"
def sourceSystemSemanticSHA256 : String := "3999746e145cffcd0bbd221bf6dad67e693631cd516a7a5da9d60d2e24f47b22"
...
def multipliers : Fin 25 → SparsePoly (Fin 72) := ![
  ...
  [{ coefficient := -1, powers := [(28, 1), (32, 1), (35, 1), (53, 1), (61, 1), (71, 1)] }, { coefficient := -1, powers := [(28, 1), (32, 1), (38, 1), (53, 1), (55, 1), (71, 1)] }],
...
#print axioms Krenn.X5Case573Tree.LeafB2_4.selectedHasNoCommonZero

end Krenn.X5Case573Tree.LeafB2_4
