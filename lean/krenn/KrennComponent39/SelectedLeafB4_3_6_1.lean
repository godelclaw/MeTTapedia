...
namespace Krenn.Component39.SelectedLeafB4_3_6_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "7132bc5bc7705d1ad4e83cf0ef07cf363dcbcc94d1bcdcd25443a323bbd80b7b"
...
def multipliers : Fin 21 → SparsePoly (Fin 67) := ![
  ...
  [{ coefficient := -1, powers := [(28, 1), (40, 1), (62, 1)] }],
  ...
  [{ coefficient := 1, powers := [(22, 1), (24, 1), (52, 1)] }, { coefficient := -1, powers := [(22, 1), (54, 1)] }, { coefficient := -1, powers := [(27, 1), (40, 1), (53, 1), (62, 1)] }, { coefficient := 1, powers := [(28, 1), (40, 1), (51, 1), (62, 1)] }, { coefficient := 1, powers := [(31, 1), (37, 1)] }],
  ...
  [{ coefficient := 1, powers := [(37, 1), (60, 1)] }, { coefficient := -1, powers := [(39, 1), (40, 1), (57, 1), (62, 1)] }, { coefficient := -1, powers := [(40, 1), (45, 1), (53, 1), (62, 1)] }, { coefficient := 1, powers := [(40, 1), (57, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (34, 1), (40, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (31, 1)] }, { coefficient := -1, powers := [(12, 1), (22, 1)] }, { coefficient := -1, powers := [(16, 1), (27, 1), (40, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (31, 1), (47, 1), (51, 1)] }, { coefficient := 1, powers := [(12, 1), (28, 1), (42, 1), (46, 1), (51, 1)] }, { coefficient := -1, powers := [(12, 1), (28, 1), (47, 1), (51, 1)] }, { coefficient := -1, powers := [(16, 1), (22, 1), (24, 1), (45, 1), (52, 1)] }, { coefficient := -1, powers := [(16, 1), (22, 1), (39, 1), (42, 1), (54, 1)] }, { coefficient := -1, powers := [(16, 1), (22, 1), (42, 1), (44, 1), (54, 1)] }, { coefficient := 1, powers := [(16, 1), (22, 1), (45, 1), (54, 1)] }, { coefficient := 1, powers := [(16, 1), (27, 1), (40, 1), (45, 1), (53, 1), (62, 1)] }, { coefficient := -1, powers := [(16, 1), (28, 1), (40, 1), (45, 1), (51, 1), (62, 1)] }, { coefficient := 1, powers := [(16, 1), (28, 1), (47, 1), (52, 1)] }, { coefficient := -1, powers := [(16, 1), (31, 1), (37, 1), (45, 1)] }, { coefficient := -1, powers := [(17, 1), (22, 1), (24, 1), (39, 1), (52, 1)] }, { coefficient := 1, powers := [(17, 1), (22, 1), (39, 1), (54, 1)] }, { coefficient := 1, powers := [(17, 1), (27, 1), (39, 1), (40, 1), (53, 1), (62, 1)] }, { coefficient := -1, powers := [(17, 1), (28, 1), (39, 1), (40, 1), (51, 1), (62, 1)] }, { coefficient := -1, powers := [(17, 1), (31, 1), (37, 1), (39, 1)] }]
]
...
#print axioms Krenn.Component39.SelectedLeafB4_3_6_1.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB4_3_6_1
