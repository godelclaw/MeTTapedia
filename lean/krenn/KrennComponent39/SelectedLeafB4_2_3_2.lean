...
namespace Krenn.Component39.SelectedLeafB4_2_3_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "f1f62ef3a62eb9a8931c432492794e1a1b7a32cadd416b73f811dba78e6f2184"
...
def multipliers : Fin 38 → SparsePoly (Fin 66) := ![
  [{ coefficient := 1, powers := [(8, 1), (22, 1), (24, 1), (25, 1), (44, 1), (60, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(22, 1), (51, 1), (57, 1), (63, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(22, 1), (42, 1), (54, 1), (65, 1)] }, { coefficient := -1, powers := [(22, 1), (52, 1), (57, 1), (63, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (10, 1), (22, 1), (42, 1), (44, 1), (60, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (10, 1), (22, 1), (33, 1), (39, 1), (49, 1), (61, 1), (65, 1)] }],
  ...
  [{ coefficient := -1, powers := [(8, 1), (22, 1), (25, 1), (44, 1), (60, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (10, 1), (22, 1), (44, 1), (60, 1), (64, 1)] }],
  ...
  [{ coefficient := -1, powers := [(8, 1), (10, 1), (22, 1), (33, 1), (39, 1), (42, 1), (49, 1), (61, 1)] }, { coefficient := -1, powers := [(12, 1), (22, 1), (51, 1), (57, 1), (63, 1)] }, { coefficient := -1, powers := [(16, 1), (22, 1), (42, 1), (54, 1)] }, { coefficient := 1, powers := [(16, 1), (22, 1), (52, 1), (57, 1), (63, 1)] }],
...
#print axioms Krenn.Component39.SelectedLeafB4_2_3_2.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB4_2_3_2
