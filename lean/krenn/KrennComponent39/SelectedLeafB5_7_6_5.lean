...
namespace Krenn.Component39.SelectedLeafB5_7_6_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "7ef8decd8a1bea0b90d57185bc175e13c59b23290c48096c546854cc1a0ee1ed"
...
def multipliers : Fin 21 → SparsePoly (Fin 70) := ![
  [{ coefficient := -1, powers := [(18, 1), (19, 1), (33, 1), (36, 1), (39, 1), (65, 1)] }, { coefficient := -1, powers := [(18, 1), (19, 1), (33, 1), (36, 1), (44, 1), (65, 1)] }, { coefficient := 1, powers := [(19, 1), (20, 1), (39, 1), (65, 1)] }, { coefficient := 1, powers := [(19, 1), (20, 1), (44, 1), (65, 1)] }, { coefficient := 2, powers := [(19, 1), (20, 1), (51, 1), (65, 1)] }, { coefficient := 1, powers := [(19, 1), (20, 1), (56, 1), (65, 1)] }, { coefficient := 1, powers := [(19, 1), (33, 1), (36, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(10, 1), (26, 1), (56, 1), (69, 1)] }],
  [{ coefficient := 1, powers := [(20, 1), (53, 1), (56, 1), (69, 1)] }],
  [{ coefficient := -1, powers := [(20, 1), (56, 1), (69, 1)] }],
  [{ coefficient := 1, powers := [(18, 1), (33, 1), (36, 1), (39, 1), (65, 1)] }, { coefficient := 1, powers := [(18, 1), (33, 1), (36, 1), (44, 1), (65, 1)] }, { coefficient := -1, powers := [(20, 1), (39, 1), (65, 1)] }, { coefficient := -1, powers := [(20, 1), (44, 1), (65, 1)] }, { coefficient := -2, powers := [(20, 1), (51, 1), (65, 1)] }, { coefficient := -1, powers := [(20, 1), (56, 1), (65, 1)] }, { coefficient := -1, powers := [(33, 1), (36, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(51, 1)] }],
  [{ coefficient := 1, powers := [(44, 1)] }],
  [{ coefficient := -1, powers := [(14, 1), (18, 1), (33, 1), (36, 1), (69, 1)] }, { coefficient := 1, powers := [(14, 1), (20, 1), (69, 1)] }],
  [{ coefficient := 1, powers := [(39, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(56, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(18, 1), (33, 1), (36, 1), (69, 1)] }, { coefficient := -1, powers := [(20, 1), (69, 1)] }],
  [{ coefficient := 1, powers := [(33, 1), (36, 1)] }],
  [{ coefficient := -1, powers := [(18, 1), (28, 1), (33, 1), (36, 1), (69, 1)] }, { coefficient := 1, powers := [(20, 1), (28, 1), (69, 1)] }],
...
#print axioms Krenn.Component39.SelectedLeafB5_7_6_5.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB5_7_6_5
