...
namespace Krenn.Component39.SelectedLeafB5_0_2_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "2a8a0a3db61e15eb12733bbef6f693983ac131d38341c747685b4b1065fa0662"
def certificateSHA256 : String := "603fe455801cbf0c11b937bae03b8fe208170be412e9f2bcfd79a50a687d357d"
...
def multipliers : Fin 53 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := 1, powers := [(2, 1), (14, 1), (27, 1), (37, 1), (60, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(34, 1), (37, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(26, 1), (45, 1), (46, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (28, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (27, 1), (42, 1), (54, 1), (61, 1)] }, { coefficient := -1, powers := [(24, 1), (27, 1), (47, 1), (49, 1), (61, 1)] }, { coefficient := -1, powers := [(26, 1), (45, 1), (46, 1), (54, 1)] }, { coefficient := -1, powers := [(31, 1), (37, 1), (42, 1), (61, 1)] }, { coefficient := -1, powers := [(31, 1), (37, 1), (45, 1)] }, { coefficient := -1, powers := [(34, 1), (37, 1), (49, 1), (61, 1)] }, { coefficient := -1, powers := [(34, 1), (37, 1), (49, 1), (64, 1)] }],
  ...
  [{ coefficient := 1, powers := [(8, 1), (19, 1), (31, 1), (42, 1), (65, 1)] }],
  ...
  [{ coefficient := -1, powers := [(2, 1), (20, 1), (37, 1), (60, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(16, 1), (19, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (19, 1), (31, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (31, 1), (47, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (20, 1), (28, 1), (37, 1), (60, 1), (65, 1)] }],
  ...
  [{ coefficient := 1, powers := [(2, 1), (40, 1)] }, { coefficient := -1, powers := [(2, 1), (46, 1), (49, 1)] }, { coefficient := 1, powers := [(5, 1), (31, 1)] }, { coefficient := 1, powers := [(8, 1), (19, 1), (27, 1), (31, 1), (65, 1)] }, { coefficient := 1, powers := [(12, 1), (22, 1)] }, { coefficient := 1, powers := [(12, 1), (26, 1), (46, 1)] }, { coefficient := -1, powers := [(16, 1), (26, 1), (46, 1), (49, 1)] }],
...
#print axioms Krenn.Component39.SelectedLeafB5_0_2_5.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB5_0_2_5
