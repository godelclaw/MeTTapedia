...
namespace Krenn.Component39.SelectedLeafB5_2_3_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "c5b868d7e7e868db966a47e1dbc5195674e877073fac9aa203c3cdf9d4990520"
...
def multipliers : Fin 42 → SparsePoly (Fin 67) := ![
  ...
  [{ coefficient := -1, powers := [(2, 1), (52, 1), (57, 1), (64, 1), (66, 1)] }],
  ...
  [{ coefficient := 1, powers := [(2, 1), (46, 1), (52, 1), (57, 1), (64, 1)] }, { coefficient := 1, powers := [(2, 1), (47, 1), (54, 1)] }, { coefficient := -1, powers := [(8, 1), (10, 1), (22, 1), (33, 1), (39, 1), (42, 1), (49, 1), (61, 1)] }, { coefficient := -1, powers := [(12, 1), (22, 1), (51, 1), (57, 1), (64, 1)] }, { coefficient := -1, powers := [(16, 1), (22, 1), (42, 1), (54, 1)] }, { coefficient := 1, powers := [(16, 1), (22, 1), (52, 1), (57, 1), (64, 1)] }],
...
#print axioms Krenn.Component39.SelectedLeafB5_2_3_2.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB5_2_3_2
