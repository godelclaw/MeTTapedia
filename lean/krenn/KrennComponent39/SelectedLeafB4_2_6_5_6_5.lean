...
namespace Krenn.Component39.SelectedLeafB4_2_6_5_6_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "9dcb8a148e70610270b29d4c22a703c96c525ae3792fe1778596060976e8fd80"
def certificateSHA256 : String := "423eeebf6b19d93f87afb66b6d71e078b8661fe0af1f26b0ddd633dad2b2c000"
...
def selectedEquations : Fin 16 → SparsePoly (Fin 71) := ![
  ...
  [{ coefficient := 1, powers := [(3, 1), (69, 1)] }, { coefficient := -1, powers := [] }]
]
...
def multipliers : Fin 16 → SparsePoly (Fin 71) := ![
  ...
  [{ coefficient := -1, powers := [(5, 1), (42, 1), (69, 1)] }, { coefficient := -1, powers := [(16, 1), (47, 1)] }, { coefficient := -1, powers := [(17, 1), (46, 1)] }],
  [{ coefficient := 1, powers := [(47, 1)] }],
  [{ coefficient := 1, powers := [(17, 1)] }],
  [{ coefficient := 1, powers := [(46, 1)] }],
  [{ coefficient := -1, powers := [(42, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (69, 1)] }],
  [{ coefficient := 1, powers := [(16, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := 1, powers := [(37, 1), (60, 1)] }, { coefficient := 1, powers := [(40, 1), (57, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (34, 1)] }],
  [{ coefficient := -1, powers := [(3, 1), (5, 1), (31, 1), (69, 1)] }, { coefficient := -1, powers := [(5, 1), (21, 1), (49, 1), (69, 1)] }, { coefficient := 1, powers := [(5, 1), (31, 1)] }, { coefficient := -1, powers := [(12, 1), (21, 1), (46, 1)] }, { coefficient := 1, powers := [(12, 1), (22, 1)] }, { coefficient := -1, powers := [(16, 1), (22, 1), (49, 1)] }],
  [{ coefficient := -1, powers := [(12, 1), (34, 1), (37, 1)] }, { coefficient := 1, powers := [(16, 1), (34, 1), (37, 1), (49, 1)] }],
  [{ coefficient := -1, powers := [(3, 1), (5, 1), (28, 1), (69, 1)] }, { coefficient := 1, powers := [(5, 1), (28, 1)] }, { coefficient := -1, powers := [(8, 1), (21, 1), (46, 1)] }, { coefficient := 1, powers := [(8, 1), (22, 1)] }],
...
#print axioms Krenn.Component39.SelectedLeafB4_2_6_5_6_5.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB4_2_6_5_6_5
