...
namespace Krenn.Component39.SelectedLeafB1_6_7_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "99e51092f49dc352a9810762bd2a8196a244a689fcf035f4fd8d3324851dd3ed"
...
def multipliers : Fin 7 → SparsePoly (Fin 68) := ![
  [{ coefficient := 1, powers := [(24, 1), (39, 1), (66, 1), (67, 1)] }, { coefficient := 1, powers := [(24, 1), (44, 1), (66, 1), (67, 1)] }, { coefficient := 1, powers := [(24, 1), (51, 1), (66, 1), (67, 1)] }],
...
#print axioms Krenn.Component39.SelectedLeafB1_6_7_2.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB1_6_7_2
