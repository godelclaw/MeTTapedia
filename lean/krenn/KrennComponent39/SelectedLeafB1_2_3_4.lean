...
namespace Krenn.Component39.SelectedLeafB1_2_3_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "6b444ff1c23106e5fb3745cd0a0239e5e35cfb659d045557249996590d63090d"
...
def multipliers : Fin 12 → SparsePoly (Fin 66) := ![
  [{ coefficient := 1, powers := [(16, 1), (24, 1), (42, 2), (61, 1), (64, 2)] }],
  [{ coefficient := 1, powers := [(24, 1), (42, 1), (61, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(42, 1), (61, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(21, 1), (42, 1), (61, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(21, 1), (24, 1), (42, 1), (61, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(16, 1), (24, 1), (42, 1), (61, 1), (64, 2)] }],
  [{ coefficient := 1, powers := [(64, 1)] }],
  [{ coefficient := 1, powers := [(24, 1), (45, 1), (51, 1), (64, 1)] }, { coefficient := -1, powers := [(39, 1), (57, 1), (64, 1)] }, { coefficient := -1, powers := [(45, 1), (53, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (42, 1), (51, 1), (64, 1)] }, { coefficient := 1, powers := [(42, 1), (53, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(16, 1), (24, 1), (27, 1), (42, 1), (61, 1), (64, 1)] }, { coefficient := -1, powers := [] }],
  [{ coefficient := -1, powers := [(16, 1), (24, 1), (42, 2), (44, 1), (61, 1), (64, 2)] }, { coefficient := 1, powers := [(16, 1), (24, 1), (42, 1), (45, 1), (61, 1), (64, 2)] }, { coefficient := 1, powers := [(16, 1), (42, 1), (61, 1), (64, 1)] }]
]
...
#print axioms Krenn.Component39.SelectedLeafB1_2_3_4.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB1_2_3_4
