...
namespace Krenn.Component39.SelectedLeafB0_2_3_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "e8160e30e89457e441d57d782e50f67965d68ddb04b636f981e81c00f86c1f69"
...
def multipliers : Fin 7 → SparsePoly (Fin 65) := ![
  [{ coefficient := 1, powers := [(24, 1), (39, 1), (63, 1), (64, 1)] }, { coefficient := 1, powers := [(24, 1), (44, 1), (63, 1), (64, 1)] }, { coefficient := 1, powers := [(24, 1), (51, 1), (63, 1), (64, 1)] }],
...
#print axioms Krenn.Component39.SelectedLeafB0_2_3_2.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB0_2_3_2
