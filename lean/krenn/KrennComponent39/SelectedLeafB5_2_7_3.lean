...
namespace Krenn.Component39.SelectedLeafB5_2_7_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "462add1c28c7e8220a877534dfce88e5370132cae2e25708a5e1a381efe10d59"
...
def multipliers : Fin 29 → SparsePoly (Fin 69) := ![
  [{ coefficient := 1, powers := [(22, 1), (51, 1), (57, 1), (65, 1), (67, 1)] }, { coefficient := 1, powers := [(22, 1), (57, 1), (67, 1)] }, { coefficient := 1, powers := [(34, 1), (37, 1), (67, 1)] }],
  [{ coefficient := 1, powers := [(22, 1), (42, 1), (54, 1), (67, 1)] }, { coefficient := -1, powers := [(22, 1), (52, 1), (57, 1), (65, 1), (67, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (8, 1), (26, 1), (60, 1), (61, 1), (67, 1)] }, { coefficient := -1, powers := [(0, 1), (8, 1), (27, 1), (60, 1), (67, 1)] }, { coefficient := -1, powers := [(2, 1), (52, 1), (57, 1), (65, 1), (67, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (31, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(16, 1), (54, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (8, 1), (27, 1), (60, 1), (68, 1)] }],
  [{ coefficient := -1, powers := [(28, 1), (52, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (49, 1), (53, 1), (61, 1)] }, { coefficient := -1, powers := [(2, 1), (54, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(12, 1), (57, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (8, 1), (22, 1), (60, 1), (68, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (8, 1), (60, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(31, 1), (37, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (22, 1), (24, 1), (51, 1), (60, 1), (66, 1)] }, { coefficient := -1, powers := [(8, 1), (22, 1), (53, 1), (60, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(54, 1)] }],
  [{ coefficient := 1, powers := [(28, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (22, 1), (24, 1), (60, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (49, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (8, 1), (22, 1), (60, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (22, 1), (60, 1), (66, 1)] }],
  ...
  [{ coefficient := -1, powers := [(0, 1), (8, 1), (22, 1), (39, 1), (60, 1), (61, 1)] }, { coefficient := -1, powers := [(0, 1), (8, 1), (22, 1), (44, 1), (60, 1), (61, 1)] }, { coefficient := -1, powers := [(2, 1), (47, 1), (49, 1), (53, 1), (61, 1)] }, { coefficient := 1, powers := [(2, 1), (47, 1), (54, 1), (61, 1)] }, { coefficient := -1, powers := [(8, 1), (22, 1), (24, 1), (39, 1), (42, 1), (51, 1), (60, 1), (66, 1)] }, { coefficient := -1, powers := [(8, 1), (22, 1), (24, 1), (45, 1), (51, 1), (60, 1), (66, 1)] }, { coefficient := 1, powers := [(8, 1), (22, 1), (39, 1), (42, 1), (53, 1), (60, 1), (66, 1)] }, { coefficient := 1, powers := [(8, 1), (22, 1), (45, 1), (53, 1), (60, 1), (66, 1)] }, { coefficient := 1, powers := [(16, 1), (28, 1), (47, 1), (52, 1)] }, { coefficient := -1, powers := [(16, 1), (31, 1), (37, 1), (45, 1)] }, { coefficient := -1, powers := [(17, 1), (31, 1), (37, 1), (39, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (8, 1), (26, 1), (46, 1), (60, 1), (61, 1)] }, { coefficient := 1, powers := [(0, 1), (8, 1), (27, 1), (46, 1), (60, 1)] }, { coefficient := 1, powers := [(2, 1), (46, 1), (52, 1), (57, 1), (65, 1)] }, { coefficient := -1, powers := [(8, 1), (31, 1), (47, 1)] }, { coefficient := -1, powers := [(12, 1), (22, 1), (51, 1), (57, 1), (65, 1)] }, { coefficient := -1, powers := [(12, 1), (22, 1), (57, 1)] }, { coefficient := -1, powers := [(12, 1), (34, 1), (37, 1)] }, { coefficient := -1, powers := [(16, 1), (22, 1), (42, 1), (54, 1)] }, { coefficient := 1, powers := [(16, 1), (22, 1), (52, 1), (57, 1), (65, 1)] }],
...
#print axioms Krenn.Component39.SelectedLeafB5_2_7_3.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB5_2_7_3
