...
namespace Krenn.Component39.SelectedLeafB1_6_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "ba533c88e5ac11a8ba0ce02f13b801b4196b5cc027c3bbb0cc7dd08714082aab"
...
def multipliers : Fin 7 → SparsePoly (Fin 65) := ![
  ...
  [{ coefficient := 1, powers := [(24, 1), (42, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (36, 1), (42, 1), (59, 1), (64, 1)] }, { coefficient := -1, powers := [(24, 1), (39, 1), (42, 1), (56, 1), (64, 1)] }, { coefficient := -1, powers := [(24, 1), (42, 1), (44, 1), (51, 1), (64, 1)] }, { coefficient := 1, powers := [(24, 1), (45, 1), (51, 1), (64, 1)] }, { coefficient := -1, powers := [(39, 1), (57, 1), (64, 1)] }, { coefficient := 1, powers := [(42, 1), (44, 1), (53, 1), (64, 1)] }, { coefficient := -1, powers := [(45, 1), (53, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (42, 1), (64, 1)] }],
...
#print axioms Krenn.Component39.SelectedLeafB1_6_1.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB1_6_1
