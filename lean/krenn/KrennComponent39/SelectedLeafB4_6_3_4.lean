...
namespace Krenn.Component39.SelectedLeafB4_6_3_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "d1ba7a2a3ffa9055c5e37343df905521f8e8f553820bb9f7a4efc947f7308d08"
def certificateSHA256 : String := "3edcd6f43cc5b142663a13aabf0cb87efda2e73cbe6f4c95c73d3083dddd9798"

set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedSourceIndices : Fin 45 → Fin 673 := ![
  23,
  26,
  180,
  181,
...
def multipliers : Fin 45 → SparsePoly (Fin 67) := ![
  ...
  [{ coefficient := -2, powers := [(10, 1), (17, 1), (22, 1), (42, 1), (54, 1), (56, 1), (65, 1)] }],
  [{ coefficient := -2, powers := [(22, 1), (57, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(22, 1), (45, 1)] }],
  [{ coefficient := -1, powers := [(22, 1), (42, 1), (54, 1), (61, 1)] }, { coefficient := 1, powers := [(22, 1), (49, 1), (57, 1), (61, 1)] }, { coefficient := 2, powers := [(22, 1), (49, 1), (57, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(26, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [(16, 1), (47, 1)] }],
  [{ coefficient := -1, powers := [(12, 1), (42, 1)] }],
  [{ coefficient := 2, powers := [(10, 1), (17, 1), (22, 1), (54, 1), (56, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(16, 1), (22, 1), (54, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(16, 1), (22, 1), (57, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(16, 1), (22, 1), (45, 1)] }],
  [{ coefficient := -2, powers := [(17, 1), (22, 1), (51, 1), (54, 1)] }],
  [{ coefficient := -2, powers := [(17, 1), (22, 1), (44, 1), (54, 1)] }],
  [{ coefficient := -2, powers := [(7, 1), (22, 1), (33, 1), (54, 1)] }, { coefficient := 1, powers := [(19, 1), (26, 1), (54, 1)] }],
  [{ coefficient := 1, powers := [(12, 1), (42, 1), (46, 1), (57, 1), (64, 1), (65, 1)] }, { coefficient := 1, powers := [(16, 1), (19, 1), (42, 1), (52, 1), (57, 1), (64, 1), (65, 1)] }, { coefficient := -1, powers := [(17, 1), (19, 1), (42, 1), (54, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(19, 1), (52, 1), (57, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [(52, 1), (57, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(54, 1)] }],
  [{ coefficient := 1, powers := [(47, 1)] }],
  [{ coefficient := 1, powers := [(26, 1), (52, 1), (57, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(22, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (26, 1), (52, 1), (57, 1), (64, 1)] }],
  ...
  [{ coefficient := -2, powers := [(17, 1), (22, 1), (54, 1), (56, 1), (65, 1)] }],
  [{ coefficient := 2, powers := [(10, 1), (22, 1), (54, 1)] }, { coefficient := -2, powers := [(14, 1), (22, 1), (54, 1)] }],
  [{ coefficient := 1, powers := [(12, 1)] }],
  [{ coefficient := -1, powers := [(12, 1), (46, 1), (57, 1), (64, 1), (65, 1)] }, { coefficient := -1, powers := [(16, 1), (19, 1), (52, 1), (57, 1), (64, 1), (65, 1)] }, { coefficient := 1, powers := [(17, 1), (19, 1), (54, 1), (65, 1)] }],
  [{ coefficient := -2, powers := [(10, 1), (17, 1), (22, 1), (54, 1)] }],
  [{ coefficient := 1, powers := [(57, 1), (64, 1)] }],
  [{ coefficient := 2, powers := [(17, 1), (22, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := -1, powers := [(16, 1), (22, 1), (42, 1), (54, 1)] }, { coefficient := 1, powers := [(16, 1), (22, 1), (49, 1), (57, 1)] }],
  [{ coefficient := -2, powers := [(16, 1), (22, 1), (38, 1), (45, 1), (54, 1), (56, 1), (62, 1)] }, { coefficient := -2, powers := [(16, 1), (22, 1), (45, 1), (50, 1), (54, 1), (62, 1)] }, { coefficient := -2, powers := [(17, 1), (22, 1), (36, 1), (54, 1), (59, 1)] }, { coefficient := -2, powers := [(17, 1), (22, 1), (38, 1), (51, 1), (54, 1), (56, 1), (62, 1)] }, { coefficient := 2, powers := [(17, 1), (22, 1), (39, 1), (54, 1), (56, 1), (57, 1), (65, 1)] }, { coefficient := -2, powers := [(17, 1), (22, 1), (39, 1), (54, 1), (56, 1)] }, { coefficient := 2, powers := [(17, 1), (22, 1), (44, 1), (51, 1), (54, 1)] }, { coefficient := 2, powers := [(17, 1), (22, 1), (45, 1), (53, 1), (54, 1), (56, 1), (65, 1)] }, { coefficient := -2, powers := [(17, 1), (22, 1), (50, 1), (51, 1), (54, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (44, 1), (52, 1), (57, 1), (64, 1)] }, { coefficient := 1, powers := [(19, 1), (45, 1), (54, 1)] }, { coefficient := 1, powers := [(37, 1), (60, 1)] }, { coefficient := -1, powers := [(40, 1), (56, 1), (57, 1), (64, 1)] }, { coefficient := 1, powers := [(40, 1), (57, 1)] }, { coefficient := -1, powers := [(47, 1), (54, 1)] }],
  ...
  [{ coefficient := 2, powers := [(4, 1), (17, 1), (22, 1), (30, 1), (54, 1), (56, 1)] }, { coefficient := 1, powers := [(12, 1), (27, 1), (46, 1), (57, 1), (64, 1)] }, { coefficient := 1, powers := [(16, 1), (19, 1), (27, 1), (52, 1), (57, 1), (64, 1)] }, { coefficient := -1, powers := [(17, 1), (19, 1), (27, 1), (54, 1)] }],
  [{ coefficient := 2, powers := [(12, 1), (22, 1), (57, 1)] }, { coefficient := -2, powers := [(16, 1), (22, 1), (49, 1), (57, 1)] }],
  ...
  [{ coefficient := 1, powers := [(5, 1), (60, 1)] }, { coefficient := -1, powers := [(12, 1), (42, 1), (44, 1), (46, 1), (57, 1), (64, 1), (65, 1)] }, { coefficient := 1, powers := [(12, 1), (42, 1), (46, 1)] }, { coefficient := 1, powers := [(12, 1), (45, 1), (46, 1), (57, 1), (64, 1), (65, 1)] }, { coefficient := -1, powers := [(12, 1), (47, 1)] }, { coefficient := -1, powers := [(16, 1), (19, 1), (42, 1), (44, 1), (52, 1), (57, 1), (64, 1), (65, 1)] }, { coefficient := 1, powers := [(16, 1), (19, 1), (45, 1), (52, 1), (57, 1), (64, 1), (65, 1)] }, { coefficient := 1, powers := [(16, 1), (47, 1), (49, 1)] }, { coefficient := 1, powers := [(17, 1), (19, 1), (42, 1), (44, 1), (54, 1), (65, 1)] }, { coefficient := -1, powers := [(17, 1), (19, 1), (45, 1), (54, 1), (65, 1)] }, { coefficient := -1, powers := [(17, 1), (46, 1), (49, 1)] }]
]
...
#print axioms Krenn.Component39.SelectedLeafB4_6_3_4.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB4_6_3_4
