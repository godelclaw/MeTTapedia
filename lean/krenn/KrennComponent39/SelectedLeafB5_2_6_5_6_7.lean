...
namespace Krenn.Component39.SelectedLeafB5_2_6_5_6_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "db1370158d8633910643bc917110c7765a7870630d7c84c9bc8d81f429cc8132"
...
def multipliers : Fin 16 → SparsePoly (Fin 73) := ![
  [{ coefficient := -1, powers := [(5, 1), (26, 1), (54, 1), (71, 1)] }, { coefficient := -1, powers := [(12, 1), (26, 1), (37, 1), (71, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (54, 1), (71, 1)] }, { coefficient := 1, powers := [(12, 1), (37, 1), (71, 1)] }],
...
#print axioms Krenn.Component39.SelectedLeafB5_2_6_5_6_7.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB5_2_6_5_6_7
