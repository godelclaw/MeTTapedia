...
namespace Krenn.Component39.SelectedLeafB5_2_6_5_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "54cb9d8b0527ef622c26a4de7f82cb2a7def3d079ddedc31a0de0ea8d48289c1"
...
def multipliers : Fin 22 → SparsePoly (Fin 71) := ![
  ...
  [{ coefficient := 1, powers := [(30, 1), (32, 1), (36, 1), (64, 1), (67, 1), (68, 1)] }, { coefficient := -1, powers := [(33, 1), (39, 1), (67, 1), (68, 1)] }],
  [{ coefficient := 1, powers := [(33, 1), (51, 1), (66, 1), (70, 1)] }],
  [{ coefficient := 1, powers := [(23, 1), (30, 1), (36, 1), (64, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(18, 1), (33, 1), (51, 1), (66, 1), (70, 1)] }, { coefficient := 1, powers := [(30, 1), (56, 1), (70, 1)] }, { coefficient := 1, powers := [(33, 1), (39, 1), (70, 1)] }],
  [{ coefficient := -1, powers := [(20, 1), (51, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(18, 1), (51, 1), (66, 1)] }, { coefficient := 1, powers := [(51, 1)] }],
  [{ coefficient := 1, powers := [(44, 1)] }, { coefficient := -1, powers := [(56, 1)] }],
  [{ coefficient := -1, powers := [(30, 1), (36, 1), (64, 1)] }],
  ...
  [{ coefficient := -1, powers := [(18, 1), (44, 1), (51, 1), (66, 1)] }, { coefficient := -1, powers := [(36, 1), (59, 1), (60, 1), (70, 1)] }, { coefficient := 1, powers := [(36, 1), (59, 1)] }, { coefficient := 1, powers := [(39, 1), (56, 1)] }, { coefficient := -1, powers := [(44, 1), (51, 1)] }, { coefficient := -1, powers := [(45, 1), (52, 1), (59, 1), (70, 1)] }, { coefficient := 1, powers := [(51, 1), (56, 1)] }],
  ...
  [{ coefficient := -1, powers := [(4, 1), (30, 1), (32, 1), (36, 1), (64, 1)] }, { coefficient := 1, powers := [(4, 1), (33, 1), (39, 1)] }, { coefficient := -1, powers := [(10, 1), (23, 1), (30, 1), (36, 1), (43, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(4, 1), (28, 1), (30, 1), (32, 1), (36, 1), (64, 1), (67, 1)] }, { coefficient := 1, powers := [(4, 1), (28, 1), (33, 1), (39, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (14, 1), (30, 1), (36, 1), (61, 1)] }, { coefficient := 1, powers := [(4, 1), (18, 1), (33, 1), (51, 1), (66, 1)] }, { coefficient := -1, powers := [(4, 1), (30, 1), (56, 1)] }, { coefficient := -1, powers := [(4, 1), (33, 1), (39, 1)] }, { coefficient := -1, powers := [(7, 1), (20, 1), (59, 1)] }, { coefficient := -1, powers := [(7, 1), (30, 1), (56, 1)] }, { coefficient := -1, powers := [(7, 1), (33, 1), (39, 1)] }]
]
...
#print axioms Krenn.Component39.SelectedLeafB5_2_6_5_7.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB5_2_6_5_7
