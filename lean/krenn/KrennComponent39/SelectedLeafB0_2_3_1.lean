...
namespace Krenn.Component39.SelectedLeafB0_2_3_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "2b08f1af9d63f406aa807aa1ebff03971f9eaa5eb573d30d56087167c5bb1dbe"
...
def multipliers : Fin 7 → SparsePoly (Fin 65) := ![
  [{ coefficient := 1, powers := [(24, 1), (39, 1), (63, 1)] }, { coefficient := 1, powers := [(24, 1), (44, 1), (63, 1)] }, { coefficient := 1, powers := [(24, 1), (51, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(42, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(63, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (39, 1), (45, 1), (63, 1)] }, { coefficient := -1, powers := [(24, 1), (44, 1), (45, 1), (63, 1)] }, { coefficient := -1, powers := [(39, 1), (57, 1), (63, 1)] }, { coefficient := 1, powers := [(42, 1), (44, 1), (53, 1), (63, 1)] }, { coefficient := -1, powers := [(45, 1), (53, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := -1, powers := [(24, 1), (39, 2), (42, 1), (63, 1)] }, { coefficient := -1, powers := [(24, 1), (39, 1), (42, 1), (44, 1), (63, 1)] }, { coefficient := -1, powers := [(24, 1), (39, 1), (42, 1), (51, 1), (63, 1)] }, { coefficient := -1, powers := [(24, 1), (39, 1), (45, 1), (63, 1)] }, { coefficient := -1, powers := [(24, 1), (44, 1), (45, 1), (63, 1)] }, { coefficient := -1, powers := [(24, 1), (45, 1), (51, 1), (63, 1)] }]
]
...
#print axioms Krenn.Component39.SelectedLeafB0_2_3_1.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB0_2_3_1
