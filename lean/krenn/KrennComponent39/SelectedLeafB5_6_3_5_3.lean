...
namespace Krenn.Component39.SelectedLeafB5_6_3_5_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "82e297ba517756bbce3a67504802d3749186e16859a83629b5fd1876e39f6f96"
def certificateSHA256 : String := "4231f21c61add9cc6bc2bdd06725262726e0c04f73febe7463c1710ef6e3beb6"
...
def multipliers : Fin 23 → SparsePoly (Fin 71) := ![
  [{ coefficient := -1, powers := [(20, 1), (24, 1), (44, 1), (66, 1)] }, { coefficient := -1, powers := [(24, 1), (33, 1), (36, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(10, 1), (42, 1), (56, 1), (66, 1)] }, { coefficient := -1, powers := [(14, 1), (39, 1), (42, 1), (66, 1)] }, { coefficient := 1, powers := [(14, 1), (42, 1), (44, 1), (66, 1)] }, { coefficient := 1, powers := [(14, 1), (42, 1), (51, 1), (66, 1)] }, { coefficient := 1, powers := [(14, 1), (42, 1), (56, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(20, 1), (59, 1), (70, 1)] }, { coefficient := 1, powers := [(30, 1), (56, 1), (70, 1)] }, { coefficient := 1, powers := [(33, 1), (39, 1), (70, 1)] }],
  [{ coefficient := 1, powers := [(20, 1), (44, 1), (66, 1)] }, { coefficient := 1, powers := [(33, 1), (36, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(10, 1), (56, 1), (66, 1)] }, { coefficient := 1, powers := [(14, 1), (39, 1), (66, 1)] }, { coefficient := -1, powers := [(14, 1), (44, 1), (66, 1)] }, { coefficient := -1, powers := [(14, 1), (51, 1), (66, 1)] }, { coefficient := -1, powers := [(14, 1), (56, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(39, 1)] }, { coefficient := 1, powers := [(51, 1)] }],
  [{ coefficient := 1, powers := [(44, 1)] }, { coefficient := -1, powers := [(56, 1)] }],
  [{ coefficient := 1, powers := [(14, 1), (20, 1), (68, 1)] }],
  ...
  [{ coefficient := 1, powers := [(20, 1), (28, 1), (68, 1)] }, { coefficient := -1, powers := [(20, 1)] }],
  ...
  [{ coefficient := -1, powers := [(10, 1), (20, 1), (44, 1)] }, { coefficient := -1, powers := [(10, 1), (20, 1), (56, 1)] }, { coefficient := -1, powers := [(10, 1), (33, 1), (36, 1)] }, { coefficient := -1, powers := [(14, 1), (20, 1), (39, 1)] }, { coefficient := 1, powers := [(14, 1), (20, 1), (44, 1)] }, { coefficient := 1, powers := [(14, 1), (20, 1), (51, 1)] }, { coefficient := 1, powers := [(14, 1), (20, 1), (56, 1)] }],
  ...
  [{ coefficient := -1, powers := [(4, 1), (20, 1), (59, 1)] }, { coefficient := -1, powers := [(4, 1), (30, 1), (56, 1)] }, { coefficient := -1, powers := [(4, 1), (33, 1), (39, 1)] }, { coefficient := -1, powers := [(7, 1), (20, 1), (59, 1)] }, { coefficient := -1, powers := [(7, 1), (30, 1), (56, 1)] }, { coefficient := -1, powers := [(7, 1), (33, 1), (39, 1)] }]
]
...
#print axioms Krenn.Component39.SelectedLeafB5_6_3_5_3.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB5_6_3_5_3
