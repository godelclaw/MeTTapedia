...
namespace Krenn.Component39.SelectedLeafB4_6_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "4f7fcca600aa6bf325187190daa2c6bcd58e9dacf7071c2ebf1231b6a90e325c"
...
def multipliers : Fin 38 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := -1, powers := [(5, 1), (7, 1), (31, 1), (42, 1), (57, 1), (59, 1), (65, 1)] }, { coefficient := -1, powers := [(5, 1), (7, 1), (34, 1), (42, 1), (54, 1), (59, 1), (65, 1)] }],
  ...
  [{ coefficient := 1, powers := [(5, 1), (7, 1), (31, 1), (57, 1), (59, 1), (65, 1)] }, { coefficient := 1, powers := [(5, 1), (7, 1), (34, 1), (54, 1), (59, 1), (65, 1)] }],
...
#print axioms Krenn.Component39.SelectedLeafB4_6_5.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB4_6_5
