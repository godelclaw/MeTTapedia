...
namespace Krenn.Component39.SelectedLeafB4_6_6_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "787a428100ddd23339ab99a006e9ae8792b3a0e3e5550d26a8e309e983f5f03d"
def certificateSHA256 : String := "ba6901cdc3d8dcc768173b2774fd19d60094440f96d36f3e326b2612a8debce8"
...
def multipliers : Fin 31 → SparsePoly (Fin 67) := ![
  ...
  [{ coefficient := -2, powers := [(16, 1), (22, 1), (38, 1), (45, 1), (54, 1), (56, 1), (62, 1)] }, { coefficient := -2, powers := [(16, 1), (22, 1), (45, 1), (50, 1), (54, 1), (62, 1)] }, { coefficient := -2, powers := [(17, 1), (22, 1), (36, 1), (54, 1), (59, 1)] }, { coefficient := -2, powers := [(17, 1), (22, 1), (38, 1), (51, 1), (54, 1), (56, 1), (62, 1)] }, { coefficient := 2, powers := [(17, 1), (22, 1), (39, 1), (54, 1), (55, 1), (56, 1), (64, 1)] }, { coefficient := -2, powers := [(17, 1), (22, 1), (39, 1), (54, 1), (56, 1)] }, { coefficient := 2, powers := [(17, 1), (22, 1), (43, 1), (54, 1), (56, 1), (64, 1)] }, { coefficient := 2, powers := [(17, 1), (22, 1), (44, 1), (51, 1), (54, 1)] }, { coefficient := -2, powers := [(17, 1), (22, 1), (50, 1), (51, 1), (54, 1), (62, 1)] }],
  ...
  [{ coefficient := 1, powers := [(5, 1), (60, 1)] }, { coefficient := 1, powers := [(12, 1), (42, 1), (46, 1)] }, { coefficient := -1, powers := [(12, 1), (47, 1)] }, { coefficient := -1, powers := [(17, 1), (46, 1), (49, 1)] }]
]
...
#print axioms Krenn.Component39.SelectedLeafB4_6_6_4.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB4_6_6_4
