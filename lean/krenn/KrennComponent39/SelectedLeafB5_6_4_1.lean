...
namespace Krenn.Component39.SelectedLeafB5_6_4_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "16187aced6af58893b811eadc304856f80f229a8654e257010ae8a4ba4103c8f"
def certificateSHA256 : String := "7c8d0c13e969f3fa360f3365f056a741cec65f33e49b1d7cdbc257052388e210"
...
def multipliers : Fin 21 → SparsePoly (Fin 67) := ![
  ...
  [{ coefficient := 1, powers := [(2, 1), (10, 1), (33, 1), (35, 1), (39, 1), (62, 1)] }, { coefficient := 1, powers := [(4, 1), (30, 1)] }, { coefficient := -1, powers := [(10, 1), (16, 1), (21, 1), (33, 1), (35, 1), (44, 1), (62, 1)] }, { coefficient := -1, powers := [(10, 1), (20, 1), (28, 1), (66, 1)] }, { coefficient := 1, powers := [(10, 1), (20, 1)] }, { coefficient := -1, powers := [(14, 1), (20, 1)] }],
...
#print axioms Krenn.Component39.SelectedLeafB5_6_4_1.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB5_6_4_1
