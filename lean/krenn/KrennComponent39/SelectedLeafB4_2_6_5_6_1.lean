...
namespace Krenn.Component39.SelectedLeafB4_2_6_5_6_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "8643c44eaa8c557f97d7b675c60bd924b23ad968eb239bc55b2001d1d8e79150"
...
def multipliers : Fin 12 → SparsePoly (Fin 70) := ![
  ...
  [{ coefficient := 1, powers := [(36, 1), (59, 1)] }, { coefficient := 1, powers := [(39, 1), (44, 1), (55, 1), (63, 1)] }, { coefficient := 1, powers := [(39, 1), (44, 1)] }, { coefficient := 1, powers := [(39, 1), (56, 1)] }, { coefficient := 1, powers := [(43, 1), (44, 1), (63, 1)] }, { coefficient := 1, powers := [(44, 1), (51, 1)] }, { coefficient := 1, powers := [(44, 1), (56, 1)] }],
  [{ coefficient := 1, powers := [(10, 1), (20, 1), (44, 1)] }],
  [{ coefficient := 1, powers := [(4, 1), (59, 1)] }, { coefficient := -1, powers := [(14, 1), (44, 1)] }],
  [{ coefficient := -1, powers := [(20, 1), (59, 1)] }, { coefficient := 1, powers := [(30, 1), (44, 1), (55, 1), (63, 1)] }, { coefficient := 1, powers := [(30, 1), (56, 1)] }, { coefficient := 1, powers := [(33, 1), (39, 1)] }, { coefficient := 2, powers := [(33, 1), (51, 1)] }, { coefficient := 1, powers := [(33, 1), (56, 1)] }],
...
#print axioms Krenn.Component39.SelectedLeafB4_2_6_5_6_1.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB4_2_6_5_6_1
