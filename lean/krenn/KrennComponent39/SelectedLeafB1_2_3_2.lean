...
namespace Krenn.Component39.SelectedLeafB1_2_3_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "249f3a78ea8b4a2e31e93ee4bb1fd304f6c4f3a7e3a6f02a8c9135766e2215ec"
...
def multipliers : Fin 7 → SparsePoly (Fin 66) := ![
  [{ coefficient := 1, powers := [(24, 1), (39, 1), (64, 1), (65, 1)] }, { coefficient := 1, powers := [(24, 1), (44, 1), (64, 1), (65, 1)] }, { coefficient := 1, powers := [(24, 1), (51, 1), (64, 1), (65, 1)] }],
...
#print axioms Krenn.Component39.SelectedLeafB1_2_3_2.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB1_2_3_2
