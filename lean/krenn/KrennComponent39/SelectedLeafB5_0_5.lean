...
namespace Krenn.Component39.SelectedLeafB5_0_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "19dca05766067aef7e4f7d1e02df665197430b02fcc7c42a4dda8ec0c727eb1c"
...
def multipliers : Fin 9 → SparsePoly (Fin 65) := ![
  ...
  [{ coefficient := 1, powers := [(18, 1), (53, 1), (64, 1)] }, { coefficient := -1, powers := [(24, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(24, 1), (45, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(18, 1), (51, 1), (64, 1)] }, { coefficient := 1, powers := [(64, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (18, 1), (51, 1), (57, 1), (64, 1)] }, { coefficient := -1, powers := [(0, 1), (57, 1), (64, 1)] }, { coefficient := 1, powers := [(18, 1), (24, 1), (42, 1), (51, 1), (64, 1)] }, { coefficient := -1, powers := [(18, 1), (42, 1), (53, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(18, 1), (24, 1), (45, 1), (64, 1)] }],
...
#print axioms Krenn.Component39.SelectedLeafB5_0_5.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB5_0_5
