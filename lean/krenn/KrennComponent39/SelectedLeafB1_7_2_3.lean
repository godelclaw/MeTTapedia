...
namespace Krenn.Component39.SelectedLeafB1_7_2_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "8da4c8a05763ad44d3f12cc853e1999e847f21c7fcc1b73ee73b40ff21fc816c"
...
def multipliers : Fin 9 → SparsePoly (Fin 68) := ![
  ...
  [{ coefficient := 1, powers := [(19, 1), (44, 1), (64, 1)] }, { coefficient := 1, powers := [(19, 1), (56, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(56, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(64, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (44, 2), (49, 1), (64, 1)] }, { coefficient := -1, powers := [(19, 1), (44, 1), (49, 1), (56, 1), (64, 1)] }, { coefficient := 1, powers := [(19, 1), (44, 1), (52, 1), (64, 1)] }, { coefficient := -1, powers := [(40, 1), (56, 1), (64, 1)] }, { coefficient := 1, powers := [(46, 1), (49, 1), (56, 1), (64, 1)] }, { coefficient := -1, powers := [(46, 1), (52, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := -1, powers := [(19, 1), (44, 2), (49, 1), (64, 1)] }, { coefficient := -1, powers := [(19, 1), (44, 1), (49, 1), (56, 1), (64, 1)] }, { coefficient := 1, powers := [(40, 1), (56, 1), (64, 1)] }, { coefficient := 1, powers := [(46, 1), (49, 1), (56, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(46, 1), (49, 1), (64, 1)] }]
]
...
#print axioms Krenn.Component39.SelectedLeafB1_7_2_3.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB1_7_2_3
