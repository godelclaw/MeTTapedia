...
namespace Krenn.Component39.SelectedLeafB5_6_4_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "78e18fbfc976dcc0e4b498143f488c20ee3e69c4dbfc169819e3bfa95b819bf1"
def certificateSHA256 : String := "4d29580f5c6b1d1954b9f7bfefd825781c25da3ad94c914fb4421ce1e9e6586e"
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedEquations : Fin 54 → SparsePoly (Fin 68) := ![
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def multipliers : Fin 54 → SparsePoly (Fin 68) := ![
  ...
  [{ coefficient := -1, powers := [(22, 1), (42, 1), (54, 1), (61, 1)] }, { coefficient := -2, powers := [(24, 1), (26, 1), (47, 1), (52, 1), (61, 1)] }, { coefficient := 2, powers := [(24, 1), (27, 1), (47, 1), (49, 1), (61, 1)] }, { coefficient := 2, powers := [(24, 1), (27, 1), (47, 1), (52, 1)] }, { coefficient := -2, powers := [(26, 1), (47, 1), (51, 1), (54, 1)] }, { coefficient := 1, powers := [(28, 1), (47, 1), (52, 1)] }, { coefficient := 1, powers := [(31, 1), (37, 1), (42, 1), (61, 1)] }, { coefficient := -1, powers := [(34, 1), (37, 1), (52, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (12, 1), (19, 1), (24, 1), (61, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(16, 1), (47, 1)] }, { coefficient := 1, powers := [(17, 1), (19, 1), (44, 1)] }, { coefficient := -1, powers := [(17, 1), (46, 1)] }],
  [{ coefficient := -1, powers := [(16, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (16, 1), (19, 1), (24, 1), (42, 1), (61, 1), (62, 1)] }, { coefficient := -1, powers := [(16, 1), (17, 1), (19, 1), (28, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(17, 1), (19, 1), (28, 1), (67, 1)] }, { coefficient := -1, powers := [(17, 1), (19, 1)] }],
  [{ coefficient := -2, powers := [(24, 1), (26, 1), (47, 1), (61, 1)] }, { coefficient := 2, powers := [(24, 1), (27, 1), (47, 1)] }, { coefficient := 1, powers := [(28, 1), (47, 1)] }, { coefficient := -1, powers := [(34, 1), (37, 1)] }],
  [{ coefficient := -1, powers := [(28, 1), (52, 1)] }],
  [{ coefficient := 1, powers := [(16, 1), (22, 1), (54, 1), (61, 1)] }, { coefficient := -1, powers := [(16, 1), (31, 1), (37, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (24, 1), (44, 1), (49, 1), (61, 1)] }, { coefficient := 1, powers := [(16, 1), (28, 1), (52, 1)] }],
  ...
  [{ coefficient := 1, powers := [(2, 1), (19, 1), (24, 1), (26, 1), (42, 1), (61, 1), (62, 1)] }, { coefficient := 1, powers := [(17, 1), (19, 1), (26, 1), (28, 1), (62, 1)] }, { coefficient := 2, powers := [(23, 1), (24, 1), (26, 1), (47, 1), (61, 1)] }, { coefficient := -2, powers := [(23, 1), (24, 1), (27, 1), (47, 1)] }, { coefficient := -1, powers := [(23, 1), (28, 1), (47, 1)] }, { coefficient := 1, powers := [(23, 1), (34, 1), (37, 1)] }],
  ...
  [{ coefficient := -2, powers := [(2, 1), (47, 1)] }, { coefficient := 1, powers := [(17, 1), (21, 1), (46, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (19, 1), (24, 1), (61, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (19, 1), (24, 1), (42, 1), (61, 1), (62, 1)] }, { coefficient := -1, powers := [(17, 1), (19, 1), (28, 1), (62, 1)] }],
  [{ coefficient := 2, powers := [(24, 1), (26, 1), (47, 1), (61, 1)] }, { coefficient := -2, powers := [(24, 1), (27, 1), (47, 1)] }, { coefficient := -1, powers := [(28, 1), (47, 1)] }, { coefficient := 1, powers := [(34, 1), (37, 1)] }],
  ...
  [{ coefficient := -1, powers := [(17, 1), (21, 1), (44, 1)] }],
  ...
  [{ coefficient := -1, powers := [(2, 1), (37, 1), (60, 1)] }, { coefficient := -1, powers := [(2, 1), (47, 1), (54, 1)] }, { coefficient := -1, powers := [(16, 1), (22, 1), (42, 1), (54, 1)] }, { coefficient := 2, powers := [(16, 1), (24, 1), (27, 1), (47, 1), (49, 1)] }, { coefficient := -2, powers := [(16, 1), (26, 1), (47, 1), (54, 1)] }, { coefficient := 1, powers := [(16, 1), (31, 1), (37, 1), (42, 1)] }],
  ...
  [{ coefficient := 1, powers := [(2, 1), (19, 1), (24, 1), (42, 1), (44, 1), (49, 1), (61, 1)] }, { coefficient := 1, powers := [(2, 1), (19, 1), (24, 1), (42, 1), (52, 1), (61, 1)] }, { coefficient := 1, powers := [(17, 1), (19, 1), (28, 1), (44, 1), (49, 1)] }],
  [{ coefficient := -2, powers := [(7, 1), (16, 1), (22, 1), (33, 1), (45, 1), (54, 1)] }, { coefficient := -2, powers := [(7, 1), (17, 1), (22, 1), (33, 1), (51, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (24, 1), (42, 1), (61, 1)] }, { coefficient := 1, powers := [(8, 1), (34, 1)] }, { coefficient := 1, powers := [(17, 1), (21, 1), (24, 1), (44, 1)] }, { coefficient := -1, powers := [(17, 1), (28, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (12, 1), (19, 1), (24, 1), (26, 1), (42, 1), (61, 1), (62, 1)] }, { coefficient := 1, powers := [(2, 1), (18, 1), (19, 1), (42, 1), (49, 1), (53, 1), (61, 1)] }, { coefficient := -2, powers := [(4, 1), (17, 1), (22, 1), (30, 1), (54, 1)] }, { coefficient := -1, powers := [(12, 1), (17, 1), (19, 1), (26, 1), (28, 1), (62, 1)] }, { coefficient := -2, powers := [(12, 1), (18, 1), (24, 1), (26, 1), (47, 1), (61, 1)] }, { coefficient := 2, powers := [(12, 1), (18, 1), (24, 1), (27, 1), (47, 1)] }, { coefficient := 1, powers := [(12, 1), (18, 1), (28, 1), (47, 1)] }, { coefficient := -1, powers := [(12, 1), (18, 1), (34, 1), (37, 1)] }, { coefficient := -2, powers := [(12, 1), (23, 1), (24, 1), (26, 1), (47, 1), (61, 1)] }, { coefficient := 2, powers := [(12, 1), (23, 1), (24, 1), (27, 1), (47, 1)] }, { coefficient := 1, powers := [(12, 1), (23, 1), (28, 1), (47, 1)] }, { coefficient := -1, powers := [(12, 1), (23, 1), (34, 1), (37, 1)] }, { coefficient := -2, powers := [(16, 1), (18, 1), (26, 1), (47, 1), (54, 1)] }, { coefficient := -2, powers := [(16, 1), (23, 1), (26, 1), (47, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (2, 1), (40, 1), (61, 1)] }, { coefficient := 1, powers := [(2, 1), (18, 1), (19, 1), (49, 1), (51, 1), (61, 1)] }, { coefficient := -1, powers := [(2, 1), (18, 1), (19, 1), (52, 1), (61, 1)] }, { coefficient := -1, powers := [(2, 1), (19, 1), (49, 1), (61, 1)] }, { coefficient := 1, powers := [(2, 1), (40, 1)] }, { coefficient := 1, powers := [(5, 1), (31, 1)] }],
  ...
  [{ coefficient := -1, powers := [(17, 1), (19, 1), (27, 1), (54, 1)] }, { coefficient := -1, powers := [(17, 1), (19, 1), (28, 1), (44, 1), (49, 1)] }]
]
...
#print axioms Krenn.Component39.SelectedLeafB5_6_4_5.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB5_6_4_5
