...
namespace Krenn.Component39.SelectedLeafB4_5_2_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "70add797e1c2a25f53d09e83d1816d08eb97ab0225ceb9d6c4c39c63350a0675"
...
def multipliers : Fin 7 → SparsePoly (Fin 67) := ![
  [{ coefficient := -1, powers := [(19, 1), (63, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(49, 1), (63, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(63, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(19, 1), (49, 1), (63, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (23, 1), (49, 1), (63, 1), (65, 1)] }],
...
#print axioms Krenn.Component39.SelectedLeafB4_5_2_5.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB4_5_2_5
