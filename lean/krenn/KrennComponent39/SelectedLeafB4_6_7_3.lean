...
namespace Krenn.Component39.SelectedLeafB4_6_7_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "06aa80ab465e8288a60eb9e7f3584c2d4a96caea3500f654e7ee1fd731143814"
...
def multipliers : Fin 18 → SparsePoly (Fin 69) := ![
  ...
  [{ coefficient := 1, powers := [(37, 1), (60, 1)] }, { coefficient := -1, powers := [(40, 1), (56, 1), (57, 1), (65, 1)] }, { coefficient := 1, powers := [(40, 1), (57, 1)] }, { coefficient := -1, powers := [(46, 1), (52, 1), (57, 1), (65, 1)] }],
  ...
  [{ coefficient := -1, powers := [(8, 1), (31, 1), (47, 1)] }, { coefficient := -1, powers := [(12, 1), (22, 1), (51, 1), (57, 1), (65, 1)] }, { coefficient := -1, powers := [(12, 1), (34, 1), (37, 1)] }, { coefficient := -1, powers := [(16, 1), (22, 1), (42, 1), (54, 1)] }, { coefficient := 1, powers := [(16, 1), (22, 1), (52, 1), (57, 1), (65, 1)] }]
]
...
#print axioms Krenn.Component39.SelectedLeafB4_6_7_3.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB4_6_7_3
