...
namespace Krenn.Component39.SelectedLeafB4_2_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "d4f091c0979bc4cab317ed92ccfe8d005f71ba62bf3afafa2fe77374c063ac68"
...
def multipliers : Fin 38 → SparsePoly (Fin 64) := ![
  ...
  [{ coefficient := -1, powers := [(5, 1), (7, 1), (31, 1), (42, 1), (57, 1), (59, 1), (63, 1)] }, { coefficient := -1, powers := [(5, 1), (7, 1), (34, 1), (42, 1), (54, 1), (59, 1), (63, 1)] }],
  ...
  [{ coefficient := 1, powers := [(5, 1), (7, 1), (31, 1), (57, 1), (59, 1), (63, 1)] }, { coefficient := 1, powers := [(5, 1), (7, 1), (34, 1), (54, 1), (59, 1), (63, 1)] }],
...
#print axioms Krenn.Component39.SelectedLeafB4_2_1.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB4_2_1
