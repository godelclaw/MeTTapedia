...
namespace Krenn.Component39.SelectedLeafB5_7_2_5_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "bfdc98786d2cf31b2ebe1a8558a8cd62724d5c0b1bc456b134a07dd6c048e8a6"
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedEquations : Fin 27 → SparsePoly (Fin 72) := ![
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def multipliers : Fin 27 → SparsePoly (Fin 72) := ![
  ...
  [{ coefficient := -1, powers := [(33, 1), (36, 1), (59, 1), (71, 1)] }],
  [{ coefficient := 1, powers := [(18, 1), (33, 1), (36, 1), (59, 1), (71, 1)] }, { coefficient := -1, powers := [(20, 1), (59, 1), (71, 1)] }, { coefficient := 1, powers := [(30, 1), (56, 1), (71, 1)] }, { coefficient := 1, powers := [(33, 1), (39, 1), (71, 1)] }],
  ...
  [{ coefficient := -1, powers := [(36, 1), (58, 1), (59, 1), (69, 1)] }, { coefficient := 1, powers := [(36, 1), (59, 1)] }, { coefficient := 1, powers := [(39, 1), (44, 1)] }, { coefficient := 1, powers := [(39, 1), (56, 1)] }, { coefficient := -1, powers := [(43, 1), (50, 1), (59, 1), (69, 1)] }, { coefficient := -1, powers := [(44, 1), (51, 1)] }, { coefficient := 1, powers := [(51, 1), (56, 1)] }],
  ...
  [{ coefficient := -1, powers := [(4, 1), (58, 1), (59, 1), (69, 1)] }, { coefficient := 1, powers := [(4, 1), (59, 1)] }, { coefficient := 1, powers := [(10, 1), (56, 1)] }, { coefficient := -1, powers := [(14, 1), (44, 1)] }],
...
#print axioms Krenn.Component39.SelectedLeafB5_7_2_5_7.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB5_7_2_5_7
