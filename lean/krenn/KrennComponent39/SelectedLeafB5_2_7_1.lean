...
namespace Krenn.Component39.SelectedLeafB5_2_7_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "b0a78692f0fbd963978085a94d58a58c4f37b459efc897162bbb7e8effaa8ed1"
...
def multipliers : Fin 23 → SparsePoly (Fin 68) := ![
  [{ coefficient := -1, powers := [(20, 1), (24, 1), (35, 1), (56, 1), (59, 1), (66, 1)] }, { coefficient := -1, powers := [(24, 1), (30, 1), (35, 1), (44, 1), (56, 1), (66, 1)] }, { coefficient := -1, powers := [(24, 1), (30, 1), (35, 1), (56, 2), (66, 1)] }, { coefficient := -1, powers := [(24, 1), (33, 1), (35, 1), (39, 1), (44, 1), (66, 1)] }, { coefficient := -2, powers := [(24, 1), (33, 1), (35, 1), (39, 1), (56, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(10, 1), (35, 1), (42, 1), (56, 1), (59, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(20, 1), (35, 1), (56, 1), (59, 1), (66, 1)] }, { coefficient := 1, powers := [(30, 1), (35, 1), (44, 1), (56, 1), (66, 1)] }, { coefficient := 1, powers := [(30, 1), (35, 1), (56, 2), (66, 1)] }, { coefficient := 1, powers := [(33, 1), (35, 1), (39, 1), (44, 1), (66, 1)] }, { coefficient := 2, powers := [(33, 1), (35, 1), (39, 1), (56, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(10, 1), (35, 1), (56, 1), (59, 1), (66, 1)] }],
  ...
  [{ coefficient := -1, powers := [(14, 1), (20, 1), (35, 1), (59, 1), (67, 1)] }],
  ...
  [{ coefficient := -1, powers := [(20, 1), (28, 1), (35, 1), (59, 1), (67, 1)] }, { coefficient := -1, powers := [(30, 1), (35, 1), (56, 1)] }, { coefficient := -1, powers := [(33, 1), (35, 1), (39, 1)] }],
...
#print axioms Krenn.Component39.SelectedLeafB5_2_7_1.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB5_2_7_1
