...
namespace Krenn.Component39.SelectedLeafB1_7_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "f8f2a111388e16f2e8c4d83a1607ccfb2e86c3caef220ebc6fbb07faf3128cc7"
def certificateSHA256 : String := "e580c85c9433b95ac157cac66d1ddf3acbf7a8f7ded259c6c42eec8b1804f439"
...
def multipliers : Fin 20 → SparsePoly (Fin 67) := ![
  ...
  [{ coefficient := -1, powers := [(7, 1), (42, 1), (59, 1), (66, 1)] }, { coefficient := 1, powers := [(14, 1), (42, 1), (51, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(7, 1), (49, 1), (59, 1), (64, 1)] }, { coefficient := 1, powers := [(10, 1), (44, 1), (49, 1), (64, 1)] }, { coefficient := -1, powers := [(14, 1), (44, 1), (49, 1), (64, 1)] }, { coefficient := -1, powers := [(14, 1), (49, 1), (51, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(7, 1), (59, 1), (64, 1)] }, { coefficient := -1, powers := [(10, 1), (44, 1), (64, 1)] }, { coefficient := 1, powers := [(14, 1), (44, 1), (64, 1)] }, { coefficient := 1, powers := [(14, 1), (51, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(33, 1), (36, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(33, 1), (36, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(7, 1), (59, 1), (66, 1)] }, { coefficient := -1, powers := [(14, 1), (51, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(51, 1)] }],
  [{ coefficient := 1, powers := [(44, 1)] }],
  [{ coefficient := -1, powers := [(44, 1), (64, 1)] }, { coefficient := -1, powers := [(51, 1), (64, 1)] }],
  ...
  [{ coefficient := 1, powers := [(36, 1), (59, 1)] }, { coefficient := 1, powers := [(39, 1), (56, 1)] }, { coefficient := 1, powers := [(40, 1), (44, 1), (56, 1), (64, 1)] }, { coefficient := 1, powers := [(40, 1), (51, 1), (56, 1), (64, 1)] }, { coefficient := 1, powers := [(44, 1), (46, 1), (52, 1), (64, 1)] }, { coefficient := -1, powers := [(44, 1), (51, 1)] }, { coefficient := 1, powers := [(46, 1), (51, 1), (52, 1), (64, 1)] }],
...
#print axioms Krenn.Component39.SelectedLeafB1_7_5.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB1_7_5
