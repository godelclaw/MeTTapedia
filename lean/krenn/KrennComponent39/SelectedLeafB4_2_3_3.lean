...
namespace Krenn.Component39.SelectedLeafB4_2_3_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "7f9747a48509f98db3c2d321d818c822e087f85da88bafd0316d6cd91a19cba8"
def certificateSHA256 : String := "738dd0b3c607d71d07d074b4a2ef882e206879521791e894c211b75ac8ae58a0"
...
def multipliers : Fin 27 → SparsePoly (Fin 67) := ![
  [{ coefficient := 1, powers := [(22, 1), (51, 1), (57, 1), (63, 1), (65, 1)] }, { coefficient := 1, powers := [(22, 1), (57, 1), (65, 1)] }, { coefficient := 1, powers := [(34, 1), (37, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(22, 1), (42, 1), (54, 1), (65, 1)] }, { coefficient := -1, powers := [(22, 1), (52, 1), (57, 1), (63, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (8, 1), (26, 1), (60, 1), (61, 1), (65, 1)] }, { coefficient := -1, powers := [(0, 1), (8, 1), (27, 1), (60, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (31, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(16, 1), (54, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (8, 1), (27, 1), (60, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(28, 1), (52, 1)] }],
  [{ coefficient := -1, powers := [(12, 1), (57, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (8, 1), (22, 1), (60, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (8, 1), (60, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(31, 1), (37, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (22, 1), (24, 1), (51, 1), (60, 1), (64, 1)] }, { coefficient := -1, powers := [(8, 1), (22, 1), (53, 1), (60, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(54, 1)] }],
  [{ coefficient := 1, powers := [(28, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (22, 1), (24, 1), (60, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (8, 1), (22, 1), (60, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (22, 1), (60, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(57, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := -1, powers := [(0, 1), (8, 1), (22, 1), (44, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(37, 1), (60, 1)] }, { coefficient := -1, powers := [(40, 1), (56, 1), (57, 1), (63, 1)] }, { coefficient := 1, powers := [(40, 1), (57, 1)] }, { coefficient := -1, powers := [(46, 1), (52, 1), (57, 1), (63, 1)] }],
  ...
  [{ coefficient := -1, powers := [(0, 1), (8, 1), (22, 1), (39, 1), (60, 1), (61, 1)] }, { coefficient := -1, powers := [(0, 1), (8, 1), (22, 1), (44, 1), (60, 1), (61, 1)] }, { coefficient := -1, powers := [(8, 1), (22, 1), (24, 1), (39, 1), (42, 1), (51, 1), (60, 1), (64, 1)] }, { coefficient := -1, powers := [(8, 1), (22, 1), (24, 1), (45, 1), (51, 1), (60, 1), (64, 1)] }, { coefficient := 1, powers := [(8, 1), (22, 1), (39, 1), (42, 1), (53, 1), (60, 1), (64, 1)] }, { coefficient := 1, powers := [(8, 1), (22, 1), (45, 1), (53, 1), (60, 1), (64, 1)] }, { coefficient := 1, powers := [(16, 1), (28, 1), (47, 1), (52, 1)] }, { coefficient := -1, powers := [(16, 1), (31, 1), (37, 1), (45, 1)] }, { coefficient := -1, powers := [(17, 1), (31, 1), (37, 1), (39, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (8, 1), (26, 1), (46, 1), (60, 1), (61, 1)] }, { coefficient := 1, powers := [(0, 1), (8, 1), (27, 1), (46, 1), (60, 1)] }, { coefficient := -1, powers := [(8, 1), (31, 1), (47, 1)] }, { coefficient := -1, powers := [(12, 1), (22, 1), (51, 1), (57, 1), (63, 1)] }, { coefficient := -1, powers := [(12, 1), (22, 1), (57, 1)] }, { coefficient := -1, powers := [(12, 1), (34, 1), (37, 1)] }, { coefficient := -1, powers := [(16, 1), (22, 1), (42, 1), (54, 1)] }, { coefficient := 1, powers := [(16, 1), (22, 1), (52, 1), (57, 1), (63, 1)] }],
...
#print axioms Krenn.Component39.SelectedLeafB4_2_3_3.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB4_2_3_3
