...
namespace Krenn.Component39.SelectedLeafB1_2_7_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "c7b83b217747ccfdba15f004464ddac89c8dde1ac92a9565f35a22ed60ea277a"
...
def multipliers : Fin 7 → SparsePoly (Fin 69) := ![
  [{ coefficient := 1, powers := [(24, 1), (39, 1), (65, 1), (67, 1)] }, { coefficient := 1, powers := [(24, 1), (44, 1), (65, 1), (67, 1)] }, { coefficient := 1, powers := [(24, 1), (51, 1), (65, 1), (67, 1)] }],
...
#print axioms Krenn.Component39.SelectedLeafB1_2_7_7.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB1_2_7_7
