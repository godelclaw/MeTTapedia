...
namespace Krenn.Component39.SelectedLeafB1_3_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "640f6d25a6f5b15476a4d8a000c2ef2a53d2d15e5d3a81ca3e1b55848c84a813"
...
def multipliers : Fin 20 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := 1, powers := [(36, 1), (59, 1)] }, { coefficient := -1, powers := [(39, 1), (56, 1), (57, 1), (65, 1)] }, { coefficient := 1, powers := [(39, 1), (56, 1)] }, { coefficient := 1, powers := [(40, 1), (44, 1), (56, 1), (63, 1)] }, { coefficient := 1, powers := [(40, 1), (51, 1), (56, 1), (63, 1)] }, { coefficient := 1, powers := [(40, 1), (56, 2), (63, 1)] }, { coefficient := 1, powers := [(44, 1), (46, 1), (52, 1), (63, 1)] }, { coefficient := -1, powers := [(44, 1), (51, 1)] }, { coefficient := -1, powers := [(45, 1), (53, 1), (56, 1), (65, 1)] }, { coefficient := 1, powers := [(46, 1), (51, 1), (52, 1), (63, 1)] }, { coefficient := 1, powers := [(46, 1), (52, 1), (56, 1), (63, 1)] }],
...
#print axioms Krenn.Component39.SelectedLeafB1_3_3.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB1_3_3
