...
namespace Krenn.Component39.SelectedLeafB4_3_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "f95583dcfd7fa021afe8706b9c9c950d54287055821ee8be6f54efaad2b47f00"
...
def multipliers : Fin 18 → SparsePoly (Fin 65) := ![
  ...
  [{ coefficient := 1, powers := [(7, 1), (49, 1), (59, 1), (63, 1)] }, { coefficient := 1, powers := [(10, 1), (44, 1), (49, 1), (63, 1)] }, { coefficient := 2, powers := [(14, 1), (39, 1), (49, 1), (63, 1)] }, { coefficient := 1, powers := [(14, 1), (44, 1), (49, 1), (63, 1)] }, { coefficient := 1, powers := [(14, 1), (49, 1), (51, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(7, 1), (59, 1), (63, 1)] }, { coefficient := -1, powers := [(10, 1), (44, 1), (63, 1)] }, { coefficient := -2, powers := [(14, 1), (39, 1), (63, 1)] }, { coefficient := -1, powers := [(14, 1), (44, 1), (63, 1)] }, { coefficient := -1, powers := [(14, 1), (51, 1), (63, 1)] }],
...
#print axioms Krenn.Component39.SelectedLeafB4_3_1.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB4_3_1
