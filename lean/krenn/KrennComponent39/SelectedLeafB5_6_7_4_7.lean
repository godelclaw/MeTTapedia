...
namespace Krenn.Component39.SelectedLeafB5_6_7_4_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "65c5fb61c47b6e20ff3fdc6f5f7bf53a8f67720b4b14814777b7a7cf74ba5f42"
...
def multipliers : Fin 22 → SparsePoly (Fin 72) := ![
  ...
  [{ coefficient := 1, powers := [(0, 1), (33, 1), (45, 1), (61, 1), (71, 1)] }],
  [{ coefficient := -1, powers := [(7, 1), (42, 1), (59, 1), (67, 1)] }, { coefficient := -1, powers := [(10, 1), (42, 1), (56, 1), (67, 1)] }, { coefficient := -1, powers := [(14, 1), (39, 1), (42, 1), (67, 1)] }, { coefficient := 1, powers := [(14, 1), (42, 1), (51, 1), (67, 1)] }, { coefficient := 1, powers := [(14, 1), (42, 1), (56, 1), (67, 1)] }],
  [{ coefficient := 1, powers := [(30, 1), (56, 1), (71, 1)] }, { coefficient := 1, powers := [(33, 1), (39, 1), (71, 1)] }],
  [{ coefficient := -1, powers := [(14, 1), (21, 1), (33, 1), (61, 1), (62, 1), (71, 1)] }, { coefficient := -1, powers := [(14, 1), (26, 1), (33, 1), (61, 1), (62, 1), (71, 1)] }],
  [{ coefficient := 1, powers := [(12, 1), (14, 1), (33, 1), (61, 1), (62, 1), (71, 1)] }],
  [{ coefficient := 1, powers := [(14, 1), (17, 1), (33, 1), (61, 1), (62, 1), (71, 1)] }],
  [{ coefficient := 1, powers := [(33, 1), (36, 1), (67, 1)] }],
  [{ coefficient := 1, powers := [(7, 1), (59, 1), (67, 1)] }, { coefficient := 1, powers := [(10, 1), (56, 1), (67, 1)] }, { coefficient := 1, powers := [(14, 1), (39, 1), (67, 1)] }, { coefficient := -1, powers := [(14, 1), (51, 1), (67, 1)] }, { coefficient := -1, powers := [(14, 1), (56, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(39, 1)] }, { coefficient := 1, powers := [(51, 1)] }],
  [{ coefficient := 1, powers := [(44, 1)] }, { coefficient := -1, powers := [(56, 1)] }],
  [{ coefficient := 1, powers := [(14, 1), (33, 1), (61, 1), (62, 1), (71, 1)] }],
  [{ coefficient := 1, powers := [(14, 1), (33, 1), (61, 1), (62, 1), (71, 1)] }],
  [{ coefficient := -1, powers := [(14, 1), (33, 1), (61, 1), (71, 1)] }],
  ...
  [{ coefficient := -1, powers := [(14, 1), (33, 1), (42, 1), (52, 1), (61, 1), (71, 1)] }, { coefficient := -1, powers := [(14, 1), (33, 1), (45, 1), (49, 1), (61, 1), (71, 1)] }],
...
#print axioms Krenn.Component39.SelectedLeafB5_6_7_4_7.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB5_6_7_4_7
