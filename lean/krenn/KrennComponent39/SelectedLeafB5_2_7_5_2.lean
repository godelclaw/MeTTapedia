...
namespace Krenn.Component39.SelectedLeafB5_2_7_5_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "6c8270f5ad5e81fd463e387d3aa6d88abe2e8861f4522c79dfae06ac5b9e5df3"
def certificateSHA256 : String := "db527884f1c0a92c86ac2621bca716592d70a477bdd94ac72a3feef353bae1f9"
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedEquations : Fin 62 → SparsePoly (Fin 70) := ![
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def multipliers : Fin 62 → SparsePoly (Fin 70) := ![
  ...
  [{ coefficient := 1, powers := [(5, 1), (20, 1), (24, 1), (34, 1), (54, 1), (56, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (10, 1), (34, 1), (42, 1), (54, 1), (56, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(22, 1), (57, 1), (67, 1)] }, { coefficient := -1, powers := [(27, 1), (46, 1), (57, 1), (65, 1), (67, 1)] }, { coefficient := 1, powers := [(34, 1), (37, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(22, 1), (45, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (19, 1), (26, 1), (53, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (21, 1), (31, 1), (47, 1), (51, 1), (62, 1)] }, { coefficient := -1, powers := [(8, 1), (21, 1), (31, 1), (47, 1), (56, 1), (62, 1)] }, { coefficient := -1, powers := [(8, 1), (27, 1), (31, 1), (47, 1), (62, 1)] }, { coefficient := -1, powers := [(17, 1), (21, 1), (31, 1), (37, 1), (51, 1), (62, 1)] }, { coefficient := -1, powers := [(17, 1), (21, 1), (31, 1), (37, 1), (56, 1), (62, 1)] }, { coefficient := -1, powers := [(17, 1), (27, 1), (31, 1), (37, 1), (62, 1)] }, { coefficient := -1, powers := [(22, 1), (42, 1), (54, 1), (61, 1)] }, { coefficient := 1, powers := [(22, 1), (49, 1), (57, 1), (67, 1)] }, { coefficient := 1, powers := [(27, 1), (46, 1), (49, 1), (57, 1), (65, 1), (67, 1)] }, { coefficient := -1, powers := [(28, 1), (47, 1), (49, 1), (61, 1)] }, { coefficient := -1, powers := [(34, 1), (37, 1), (49, 1), (61, 1)] }, { coefficient := -1, powers := [(34, 1), (37, 1), (49, 1), (67, 1)] }],
  [{ coefficient := 1, powers := [(31, 1), (37, 1), (65, 1), (67, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (54, 1), (57, 1), (59, 1), (65, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (45, 1), (57, 1), (59, 1), (65, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (17, 1), (19, 1), (53, 1), (62, 1)] }, { coefficient := 1, powers := [(5, 1), (57, 1), (59, 1), (65, 1)] }, { coefficient := 1, powers := [(16, 1), (46, 1), (57, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (20, 1), (34, 1), (54, 1), (56, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(31, 1), (37, 1), (51, 1), (65, 1), (67, 1)] }, { coefficient := -1, powers := [(31, 1), (37, 1), (56, 1), (65, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(28, 1), (52, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (10, 1), (34, 1), (54, 1), (56, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (19, 1), (31, 1), (43, 1), (51, 1), (64, 1)] }, { coefficient := 1, powers := [(8, 1), (19, 1), (31, 1), (51, 1), (67, 1)] }, { coefficient := 1, powers := [(8, 1), (24, 1), (31, 1), (47, 1), (51, 1), (66, 1), (67, 1)] }, { coefficient := 1, powers := [(16, 1), (22, 1), (54, 1), (61, 1)] }, { coefficient := 1, powers := [(17, 1), (24, 1), (31, 1), (37, 1), (51, 1), (66, 1), (67, 1)] }, { coefficient := -1, powers := [(17, 1), (31, 1), (37, 1), (53, 1), (66, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (44, 1), (49, 1), (53, 1)] }, { coefficient := -1, powers := [(8, 1), (31, 1), (42, 1), (53, 1), (66, 1), (67, 1)] }, { coefficient := -1, powers := [(8, 1), (31, 1), (51, 1)] }, { coefficient := 1, powers := [(16, 1), (28, 1), (52, 1)] }],
  ...
  [{ coefficient := 1, powers := [(5, 1), (14, 1), (20, 1), (34, 1), (54, 1), (68, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (19, 1), (31, 1), (43, 1), (64, 1)] }, { coefficient := -1, powers := [(8, 1), (19, 1), (31, 1), (67, 1)] }, { coefficient := -1, powers := [(8, 1), (24, 1), (31, 1), (47, 1), (66, 1), (67, 1)] }, { coefficient := 1, powers := [(8, 1), (31, 1), (47, 1), (53, 1), (66, 1)] }, { coefficient := -1, powers := [(17, 1), (24, 1), (31, 1), (37, 1), (66, 1), (67, 1)] }, { coefficient := 1, powers := [(17, 1), (31, 1), (37, 1), (53, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (42, 1), (46, 1), (53, 1)] }, { coefficient := 1, powers := [(2, 1), (47, 1), (53, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (49, 1), (53, 1)] }, { coefficient := 1, powers := [(2, 1), (54, 1)] }, { coefficient := 1, powers := [(8, 1), (31, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (19, 1), (53, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(31, 1), (37, 1), (42, 1), (65, 1), (67, 1)] }],
  [{ coefficient := 1, powers := [(31, 1), (37, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (57, 1), (59, 1), (65, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (31, 1), (42, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(52, 1), (57, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (18, 1), (31, 1), (47, 1), (62, 1)] }, { coefficient := 1, powers := [(8, 1), (23, 1), (31, 1), (47, 1), (62, 1)] }, { coefficient := 1, powers := [(17, 1), (18, 1), (31, 1), (37, 1), (62, 1)] }, { coefficient := 1, powers := [(17, 1), (23, 1), (31, 1), (37, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(28, 1)] }],
  [{ coefficient := 1, powers := [(22, 1)] }],
  [{ coefficient := 1, powers := [(23, 1), (31, 1), (37, 1), (42, 1), (65, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (31, 1), (42, 1), (51, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (31, 1), (47, 1), (51, 1), (66, 1)] }, { coefficient := -1, powers := [(17, 1), (31, 1), (37, 1), (51, 1), (66, 1)] }, { coefficient := 1, powers := [(17, 1), (31, 1), (37, 1), (66, 1), (67, 1)] }],
  ...
  [{ coefficient := 1, powers := [(2, 1), (49, 1), (51, 1)] }, { coefficient := 1, powers := [(8, 1), (31, 1), (42, 1), (66, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (20, 1), (34, 1), (54, 1), (68, 1)] }],
  [{ coefficient := 1, powers := [(4, 1), (34, 1), (54, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (20, 1), (28, 1), (34, 1), (54, 1), (68, 1)] }],
  ...
  [{ coefficient := -1, powers := [(2, 1), (19, 1), (45, 1), (49, 1), (53, 1)] }, { coefficient := -1, powers := [(8, 1), (18, 1), (31, 1), (47, 1), (51, 1)] }, { coefficient := -1, powers := [(8, 1), (23, 1), (31, 1), (47, 1), (51, 1)] }, { coefficient := -1, powers := [(17, 1), (18, 1), (31, 1), (37, 1), (51, 1)] }, { coefficient := -1, powers := [(17, 1), (23, 1), (31, 1), (37, 1), (51, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (2, 1), (51, 1), (57, 1)] }, { coefficient := -1, powers := [(2, 1), (23, 1), (42, 1), (44, 1), (53, 1)] }, { coefficient := 1, powers := [(2, 1), (23, 1), (45, 1), (53, 1)] }, { coefficient := 1, powers := [(2, 1), (24, 1), (42, 1), (51, 1)] }, { coefficient := -1, powers := [(2, 1), (56, 1), (57, 1), (65, 1)] }, { coefficient := 1, powers := [(2, 1), (57, 1)] }, { coefficient := 1, powers := [(8, 1), (34, 1)] }, { coefficient := -1, powers := [(16, 1), (27, 1), (57, 1), (65, 1)] }, { coefficient := 1, powers := [(16, 1), (28, 1), (42, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (19, 1), (31, 1), (42, 1), (51, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (31, 1), (57, 1)] }, { coefficient := -1, powers := [(12, 1), (22, 1), (57, 1)] }, { coefficient := 1, powers := [(17, 1), (18, 1), (31, 1), (37, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (27, 1), (49, 1), (57, 1), (59, 1), (65, 1)] }, { coefficient := 1, powers := [(8, 1), (18, 1), (31, 1), (47, 1), (51, 1)] }, { coefficient := -1, powers := [(8, 1), (19, 1), (31, 1), (42, 1), (67, 1)] }, { coefficient := 1, powers := [(17, 1), (18, 1), (31, 1), (37, 1), (51, 1)] }, { coefficient := -1, powers := [(17, 1), (18, 1), (31, 1), (37, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (19, 1), (31, 1), (42, 1), (51, 1)] }, { coefficient := -1, powers := [(8, 1), (24, 1), (31, 1), (42, 1), (47, 1), (51, 1), (66, 1)] }, { coefficient := 1, powers := [(8, 1), (31, 1), (42, 1), (47, 1), (53, 1), (66, 1)] }, { coefficient := 1, powers := [(12, 1), (22, 1), (57, 1)] }, { coefficient := 1, powers := [(12, 1), (27, 1), (46, 1), (57, 1), (65, 1)] }, { coefficient := -1, powers := [(12, 1), (34, 1), (37, 1)] }, { coefficient := -1, powers := [(16, 1), (22, 1), (49, 1), (57, 1)] }, { coefficient := -1, powers := [(16, 1), (27, 1), (46, 1), (49, 1), (57, 1), (65, 1)] }, { coefficient := 1, powers := [(16, 1), (34, 1), (37, 1), (49, 1)] }, { coefficient := -1, powers := [(17, 1), (24, 1), (31, 1), (37, 1), (42, 1), (51, 1), (66, 1)] }, { coefficient := 1, powers := [(17, 1), (31, 1), (37, 1), (42, 1), (53, 1), (66, 1)] }],
...
#print axioms Krenn.Component39.SelectedLeafB5_2_7_5_2.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB5_2_7_5_2
