...
namespace Krenn.Component39.SelectedLeafB4_5_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "f873ee8cda7a92110fbae2e550e9a84f943511472f2dff8e3ef39845babcc55c"
...
def multipliers : Fin 9 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := -1, powers := [(19, 1), (63, 1)] }, { coefficient := 1, powers := [(23, 1), (46, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(44, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(19, 1), (52, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(23, 1), (44, 1), (63, 1)] }, { coefficient := 1, powers := [(63, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (23, 1), (52, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := 1, powers := [(0, 1), (23, 1), (40, 1), (44, 1), (63, 1)] }, { coefficient := -1, powers := [(0, 1), (40, 1), (63, 1)] }, { coefficient := 1, powers := [(19, 1), (23, 1), (44, 1), (49, 1), (63, 1)] }, { coefficient := -1, powers := [(23, 1), (46, 1), (49, 1), (63, 1)] }]
]
...
#print axioms Krenn.Component39.SelectedLeafB4_5_5.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB4_5_5
