...
namespace Krenn.Component39.SelectedLeafB5_3_6_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "f4794185ced2f6a450bc77505be37e5457252e8732e1ce503e17c9e71ad9408c"
def certificateSHA256 : String := "f45dffc6bdf1dda9a0421d5856c3845a950cdabf77e35f6dfe61d40caf705db2"
...
def multipliers : Fin 26 → SparsePoly (Fin 68) := ![
  ...
  [{ coefficient := -1, powers := [(2, 1), (39, 1), (40, 1), (51, 1), (53, 1), (63, 1)] }, { coefficient := 1, powers := [(2, 1), (40, 1), (53, 1), (61, 1)] }, { coefficient := -1, powers := [(12, 1), (28, 1), (46, 1), (51, 1)] }],
  ...
  [{ coefficient := 1, powers := [(2, 1), (39, 1), (40, 1), (53, 1), (63, 1)] }, { coefficient := 1, powers := [(12, 1), (28, 1), (46, 1)] }],
  ...
  [{ coefficient := 1, powers := [(2, 1), (40, 1), (51, 1), (53, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(54, 1)] }],
  [{ coefficient := 1, powers := [(28, 1)] }],
  [{ coefficient := 1, powers := [(22, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (40, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (40, 1), (53, 1), (63, 1)] }],
...
#print axioms Krenn.Component39.SelectedLeafB5_3_6_1.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB5_3_6_1
