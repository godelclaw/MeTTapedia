...
namespace Krenn.Component39.SelectedLeafB5_6_6_5_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "4e5d67aaf15c7925eca8a16a861bd1be9c55d8163abd90d0fb19ce14548cbaa2"
def certificateSHA256 : String := "2edf31d1e0c5a060a44a8cd7641a9f4d9f6a67a57cc04ac8a6728fba816a54c7"
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedEquations : Fin 42 → SparsePoly (Fin 71) := ![
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def multipliers : Fin 42 → SparsePoly (Fin 71) := ![
  [{ coefficient := -1, powers := [(7, 1), (22, 1), (54, 1), (59, 1)] }, { coefficient := 1, powers := [(10, 1), (22, 1), (54, 1), (56, 1)] }, { coefficient := 1, powers := [(14, 1), (22, 1), (51, 1), (54, 1)] }],
  [{ coefficient := 1, powers := [(34, 1), (37, 1), (67, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (19, 1), (26, 1), (53, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(22, 1), (42, 1), (54, 1), (61, 1)] }, { coefficient := -1, powers := [(34, 1), (37, 1), (49, 1), (67, 1)] }],
  ...
  [{ coefficient := -1, powers := [(17, 1), (22, 1), (51, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [(17, 1), (22, 1), (44, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [(7, 1), (22, 1), (33, 1), (54, 1)] }],
  ...
  [{ coefficient := 1, powers := [(16, 1), (22, 1), (45, 1), (54, 1), (63, 1)] }, { coefficient := 1, powers := [(17, 1), (22, 1), (51, 1), (54, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(17, 1), (22, 1), (54, 1), (56, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(10, 1), (22, 1), (54, 1)] }, { coefficient := -1, powers := [(14, 1), (22, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [(10, 1), (17, 1), (22, 1), (54, 1)] }],
  ...
  [{ coefficient := -1, powers := [(16, 1), (22, 1), (38, 1), (45, 1), (54, 1), (56, 1), (63, 1)] }, { coefficient := -1, powers := [(16, 1), (22, 1), (45, 1), (50, 1), (54, 1), (63, 1)] }, { coefficient := -1, powers := [(17, 1), (22, 1), (36, 1), (54, 1), (59, 1)] }, { coefficient := -1, powers := [(17, 1), (22, 1), (38, 1), (51, 1), (54, 1), (56, 1), (63, 1)] }, { coefficient := 1, powers := [(17, 1), (22, 1), (39, 1), (54, 1), (55, 1), (56, 1), (65, 1)] }, { coefficient := -1, powers := [(17, 1), (22, 1), (39, 1), (54, 1), (56, 1)] }, { coefficient := 1, powers := [(17, 1), (22, 1), (43, 1), (54, 1), (56, 1), (65, 1)] }, { coefficient := 1, powers := [(17, 1), (22, 1), (44, 1), (51, 1), (54, 1)] }, { coefficient := -1, powers := [(17, 1), (22, 1), (50, 1), (51, 1), (54, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (19, 1), (45, 1), (49, 1), (53, 1)] }],
  [{ coefficient := -1, powers := [(7, 1), (16, 1), (22, 1), (33, 1), (45, 1), (54, 1)] }, { coefficient := -1, powers := [(7, 1), (17, 1), (22, 1), (33, 1), (51, 1), (54, 1)] }],
  ...
  [{ coefficient := 1, powers := [(4, 1), (17, 1), (22, 1), (30, 1), (54, 1), (56, 1)] }, { coefficient := 1, powers := [(10, 1), (17, 1), (20, 1), (22, 1), (54, 1), (56, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (2, 1), (40, 1), (51, 1)] }, { coefficient := -1, powers := [(2, 1), (19, 1), (49, 1), (51, 1)] }, { coefficient := 1, powers := [(2, 1), (19, 1), (52, 1)] }, { coefficient := 1, powers := [(2, 1), (40, 1)] }, { coefficient := 1, powers := [(5, 1), (31, 1)] }, { coefficient := -1, powers := [(12, 1), (21, 1), (46, 1)] }, { coefficient := 1, powers := [(12, 1), (22, 1)] }, { coefficient := -1, powers := [(16, 1), (22, 1), (49, 1)] }],
  [{ coefficient := -1, powers := [(12, 1), (34, 1), (37, 1)] }, { coefficient := 1, powers := [(16, 1), (34, 1), (37, 1), (49, 1)] }],
  [{ coefficient := -1, powers := [(4, 1), (17, 1), (22, 1), (54, 1), (59, 1)] }, { coefficient := -1, powers := [(10, 1), (16, 1), (22, 1), (45, 1), (54, 1)] }, { coefficient := 1, powers := [(10, 1), (17, 1), (22, 1), (44, 1), (54, 1)] }, { coefficient := -1, powers := [(14, 1), (16, 1), (22, 1), (38, 1), (45, 1), (54, 1), (63, 1)] }, { coefficient := 1, powers := [(14, 1), (16, 1), (22, 1), (45, 1), (54, 1)] }, { coefficient := -1, powers := [(14, 1), (17, 1), (22, 1), (38, 1), (51, 1), (54, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (2, 1), (37, 1), (51, 1)] }, { coefficient := 1, powers := [(2, 1), (6, 1), (46, 1), (53, 1)] }, { coefficient := 1, powers := [(2, 1), (37, 1)] }, { coefficient := 1, powers := [(5, 1), (28, 1)] }, { coefficient := -1, powers := [(8, 1), (21, 1), (46, 1)] }, { coefficient := 1, powers := [(8, 1), (22, 1)] }]
]
...
#print axioms Krenn.Component39.SelectedLeafB5_6_6_5_6.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB5_6_6_5_6
