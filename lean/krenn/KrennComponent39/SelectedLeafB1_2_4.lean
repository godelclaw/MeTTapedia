...
namespace Krenn.Component39.SelectedLeafB1_2_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "154699a192fc9310859759ed9137890e895dfb4f32436ac5de0e6ebb7de02be7"
...
def multipliers : Fin 15 → SparsePoly (Fin 64) := ![
  [{ coefficient := 1, powers := [(27, 1), (51, 1), (61, 1), (62, 1)] }],
  [{ coefficient := 2, powers := [(27, 1), (61, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(61, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(61, 1), (62, 1)] }],
  [{ coefficient := -2, powers := [(23, 1), (27, 1), (61, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(16, 1), (23, 1), (61, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(16, 1), (61, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(16, 1), (61, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(16, 1), (27, 1), (61, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(16, 1), (27, 1), (61, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(62, 1)] }],
  [{ coefficient := 1, powers := [(16, 1), (27, 1), (44, 1), (61, 1), (62, 1)] }, { coefficient := 1, powers := [(16, 1), (27, 1), (51, 1), (61, 1), (62, 1)] }, { coefficient := -1, powers := [(36, 1), (59, 1), (62, 1)] }, { coefficient := -1, powers := [(39, 1), (56, 1), (62, 1)] }, { coefficient := -1, powers := [(44, 1), (51, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(44, 1), (62, 1)] }, { coefficient := 1, powers := [(51, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := 1, powers := [(16, 1), (18, 1), (27, 1), (61, 1), (62, 1)] }, { coefficient := 1, powers := [(16, 1), (23, 1), (27, 1), (61, 1), (62, 1)] }, { coefficient := -1, powers := [(62, 1)] }]
]
...
#print axioms Krenn.Component39.SelectedLeafB1_2_4.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB1_2_4
