...
namespace Krenn.Component39.SelectedLeafB1_6_7_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "5eb37c582cef03dd5c8dbf0185c1d6de3f9b94671c1e19d6a86223baac039f2d"
...
def multipliers : Fin 12 → SparsePoly (Fin 68) := ![
  [{ coefficient := 1, powers := [(16, 1), (24, 1), (42, 2), (61, 1), (66, 2)] }],
  [{ coefficient := 1, powers := [(24, 1), (42, 1), (61, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(42, 1), (61, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(21, 1), (42, 1), (61, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(21, 1), (24, 1), (42, 1), (61, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(16, 1), (24, 1), (42, 1), (61, 1), (66, 2)] }],
  [{ coefficient := 1, powers := [(66, 1)] }],
  [{ coefficient := 1, powers := [(24, 1), (45, 1), (51, 1), (66, 1)] }, { coefficient := -1, powers := [(39, 1), (57, 1), (66, 1)] }, { coefficient := -1, powers := [(45, 1), (53, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (42, 1), (51, 1), (66, 1)] }, { coefficient := 1, powers := [(42, 1), (53, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(16, 1), (24, 1), (27, 1), (42, 1), (61, 1), (66, 1)] }, { coefficient := -1, powers := [] }],
  [{ coefficient := -1, powers := [(16, 1), (24, 1), (42, 2), (44, 1), (61, 1), (66, 2)] }, { coefficient := 1, powers := [(16, 1), (24, 1), (42, 1), (45, 1), (61, 1), (66, 2)] }, { coefficient := 1, powers := [(16, 1), (42, 1), (61, 1), (66, 1)] }]
]
...
#print axioms Krenn.Component39.SelectedLeafB1_6_7_4.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB1_6_7_4
