...
namespace Krenn.Component39.SelectedLeafB5_2_0_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "f45def8a8477eb7316e66cf329d32172463f694b5a95a00e840718ff61dfd661"
...
def multipliers : Fin 13 → SparsePoly (Fin 65) := ![
  [{ coefficient := 1, powers := [(0, 1), (21, 1), (36, 1), (59, 1), (62, 1), (63, 1), (64, 1)] }, { coefficient := 1, powers := [(0, 1), (21, 1), (44, 1), (51, 1), (62, 1), (63, 1), (64, 1)] }, { coefficient := 1, powers := [(0, 1), (21, 1), (51, 1), (61, 1), (62, 1), (63, 1), (64, 1)] }, { coefficient := -1, powers := [(0, 1), (26, 1), (35, 1), (51, 2), (59, 1), (62, 1), (63, 1), (64, 1)] }, { coefficient := 1, powers := [(0, 1), (26, 1), (36, 1), (59, 1), (62, 1), (63, 1), (64, 1)] }, { coefficient := -1, powers := [(0, 1), (26, 1), (51, 1), (61, 1), (62, 1), (63, 1), (64, 1)] }, { coefficient := 1, powers := [(0, 1), (27, 1), (35, 1), (51, 1), (59, 1), (62, 1), (63, 1), (64, 1)] }, { coefficient := 1, powers := [(0, 1), (27, 1), (44, 1), (62, 1), (63, 1), (64, 1)] }, { coefficient := 2, powers := [(0, 1), (27, 1), (61, 1), (62, 1), (63, 1), (64, 1)] }],
...
#print axioms Krenn.Component39.SelectedLeafB5_2_0_2.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB5_2_0_2
