...
namespace Krenn.Component39.SelectedLeafB5_2_6_5_2_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "dde170ca3f2f9adb7a14ebe585aa146627741579bd9fec34d077a126f52d473a"
...
def multipliers : Fin 15 → SparsePoly (Fin 71) := ![
  ...
  [{ coefficient := 1, powers := [(2, 1), (40, 1)] }, { coefficient := -1, powers := [(3, 1), (5, 1), (31, 1), (69, 1)] }, { coefficient := -1, powers := [(5, 1), (21, 1), (49, 1), (69, 1)] }, { coefficient := 1, powers := [(5, 1), (31, 1)] }, { coefficient := -1, powers := [(12, 1), (21, 1), (46, 1)] }, { coefficient := 1, powers := [(12, 1), (22, 1)] }, { coefficient := -1, powers := [(16, 1), (22, 1), (49, 1)] }],
  [{ coefficient := -1, powers := [(12, 1), (34, 1), (37, 1)] }, { coefficient := 1, powers := [(16, 1), (34, 1), (37, 1), (49, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (37, 1)] }, { coefficient := -1, powers := [(3, 1), (5, 1), (28, 1), (69, 1)] }, { coefficient := 1, powers := [(5, 1), (28, 1)] }, { coefficient := -1, powers := [(8, 1), (21, 1), (46, 1)] }, { coefficient := 1, powers := [(8, 1), (22, 1)] }],
...
#print axioms Krenn.Component39.SelectedLeafB5_2_6_5_2_5.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB5_2_6_5_2_5
