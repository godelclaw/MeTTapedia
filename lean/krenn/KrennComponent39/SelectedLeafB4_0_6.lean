...
namespace Krenn.Component39.SelectedLeafB4_0_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "f1da22eb41bb269c3955940cfd03eebf3aad48457a3e59e16de67306c8144a5a"
def certificateSHA256 : String := "4ce6aaecd33618cd23f305f896dbd7c74902185cf9f92627fcb8d338e16872fc"
...
def multipliers : Fin 38 → SparsePoly (Fin 64) := ![
  ...
  [{ coefficient := 1, powers := [(4, 1), (28, 1), (44, 1), (60, 1), (62, 1)] }],
  ...
  [{ coefficient := -1, powers := [(5, 1), (28, 1), (44, 1), (60, 1), (62, 1)] }],
  ...
  [{ coefficient := 1, powers := [(5, 1), (28, 1), (36, 1), (59, 1), (60, 1)] }, { coefficient := 1, powers := [(5, 1), (28, 1), (39, 1), (44, 1), (55, 1), (60, 1), (62, 1)] }, { coefficient := 1, powers := [(5, 1), (28, 1), (39, 1), (56, 1), (60, 1)] }, { coefficient := 1, powers := [(5, 1), (28, 1), (43, 1), (44, 1), (60, 1), (62, 1)] }, { coefficient := 1, powers := [(5, 1), (28, 1), (44, 1), (51, 1), (60, 1)] }, { coefficient := 1, powers := [(5, 1), (28, 1), (44, 1), (56, 1), (60, 1)] }, { coefficient := -1, powers := [(8, 1), (31, 1), (36, 1), (42, 1), (46, 1), (59, 1)] }, { coefficient := 1, powers := [(8, 1), (31, 1), (36, 1), (47, 1), (59, 1)] }, { coefficient := -1, powers := [(8, 1), (31, 1), (39, 1), (42, 1), (46, 1), (56, 1)] }, { coefficient := 1, powers := [(8, 1), (31, 1), (39, 1), (47, 1), (56, 1)] }],
...
#print axioms Krenn.Component39.SelectedLeafB4_0_6.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB4_0_6
