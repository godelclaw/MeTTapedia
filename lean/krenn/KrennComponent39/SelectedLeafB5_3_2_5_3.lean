...
namespace Krenn.Component39.SelectedLeafB5_3_2_5_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "f19dec439e484971a43cb14d4d26b16c68bc701d61f16ca20ef9b248a220d685"
...
def multipliers : Fin 26 → SparsePoly (Fin 70) := ![
  ...
  [{ coefficient := 1, powers := [(16, 1), (18, 1), (33, 1), (36, 1), (51, 1), (62, 1)] }, { coefficient := 1, powers := [(16, 1), (18, 1), (33, 1), (36, 1), (56, 1), (62, 1)] }, { coefficient := 1, powers := [(20, 1), (44, 1), (53, 1), (67, 1)] }],
  ...
  [{ coefficient := -1, powers := [(4, 1), (59, 1), (60, 1), (69, 1)] }, { coefficient := 1, powers := [(4, 1), (59, 1)] }, { coefficient := 1, powers := [(10, 1), (56, 1)] }, { coefficient := -1, powers := [(14, 1), (44, 1)] }],
...
#print axioms Krenn.Component39.SelectedLeafB5_3_2_5_3.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB5_3_2_5_3
