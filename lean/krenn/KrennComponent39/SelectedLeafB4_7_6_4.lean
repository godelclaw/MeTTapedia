...
namespace Krenn.Component39.SelectedLeafB4_7_6_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "decedf7a65c1e3d2e2855e4c0ac13c50bb8c0372359bd037b2e95b137c04b560"
def certificateSHA256 : String := "49dd8531d98ffc2bd0bdcaef0b1a0d79c31c96f614fdaf4bea0aa18963780a76"
...
def multipliers : Fin 34 → SparsePoly (Fin 68) := ![
  ...
  [{ coefficient := -2, powers := [(16, 1), (22, 1), (38, 1), (45, 1), (54, 1), (56, 1), (62, 1)] }, { coefficient := -2, powers := [(16, 1), (22, 1), (45, 1), (50, 1), (54, 1), (62, 1)] }, { coefficient := -2, powers := [(17, 1), (22, 1), (36, 1), (54, 1), (59, 1)] }, { coefficient := -2, powers := [(17, 1), (22, 1), (38, 1), (51, 1), (54, 1), (56, 1), (62, 1)] }, { coefficient := 2, powers := [(17, 1), (22, 1), (39, 1), (54, 1), (55, 1), (56, 1), (65, 1)] }, { coefficient := -2, powers := [(17, 1), (22, 1), (39, 1), (54, 1), (56, 1)] }, { coefficient := 2, powers := [(17, 1), (22, 1), (43, 1), (54, 1), (56, 1), (65, 1)] }, { coefficient := 2, powers := [(17, 1), (22, 1), (44, 1), (51, 1), (54, 1)] }, { coefficient := -2, powers := [(17, 1), (22, 1), (50, 1), (51, 1), (54, 1), (62, 1)] }],
  ...
  [{ coefficient := 1, powers := [(5, 1), (31, 1)] }, { coefficient := -1, powers := [(12, 1), (22, 1)] }, { coefficient := 1, powers := [(16, 1), (22, 1), (49, 1)] }, { coefficient := -1, powers := [(16, 1), (27, 1), (40, 1), (63, 1)] }],
...
#print axioms Krenn.Component39.SelectedLeafB4_7_6_4.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB4_7_6_4
