...
namespace Krenn.Component39.SelectedLeafB4_2_6_5_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "cdd779cf23ab266000b7a0ad6a43f4030517d6d3a7426ae85decdea7c9f8df46"
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedEquations : Fin 57 → SparsePoly (Fin 69) := ![
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def multipliers : Fin 57 → SparsePoly (Fin 69) := ![
  ...
  [{ coefficient := -1, powers := [(16, 1), (31, 1), (33, 1), (37, 1), (45, 1), (68, 1)] }, { coefficient := 1, powers := [(17, 1), (30, 1), (31, 1), (37, 1), (56, 1), (68, 1)] }, { coefficient := -1, powers := [(17, 1), (31, 1), (33, 1), (37, 1), (51, 1), (68, 1)] }],
...
#print axioms Krenn.Component39.SelectedLeafB4_2_6_5_5.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB4_2_6_5_5
