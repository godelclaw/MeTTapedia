...
namespace Krenn.Component39.SelectedLeafB6_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "4eddb6a48507a109bb52511746e596b383b3933c168cbdb88b255c8001958fac"
def certificateSHA256 : String := "d66dcf07bf5b7825c3839681986278b8ea0bb50a197e5051ffd240913368ad3b"
...
def multipliers : Fin 19 → SparsePoly (Fin 63) := ![
  [{ coefficient := -1, powers := [(5, 1), (31, 1), (53, 1), (62, 1)] }, { coefficient := 1, powers := [(12, 1), (22, 1), (53, 1), (62, 1)] }, { coefficient := 1, powers := [(12, 1), (28, 1), (46, 1), (62, 1)] }],
...
#print axioms Krenn.Component39.SelectedLeafB6_0.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB6_0
