...
namespace Krenn.Component39.SelectedLeafB4_7_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "45259695f4077d02992680e38928fbcf0fa166824c9450c18d8f85f6abe2bb42"
...
def multipliers : Fin 18 → SparsePoly (Fin 68) := ![
  ...
  [{ coefficient := 1, powers := [(7, 1), (49, 1), (59, 1), (64, 1)] }, { coefficient := 1, powers := [(10, 1), (44, 1), (49, 1), (64, 1)] }, { coefficient := 1, powers := [(10, 1), (49, 1), (56, 1), (64, 1)] }, { coefficient := 2, powers := [(14, 1), (39, 1), (49, 1), (64, 1)] }, { coefficient := 1, powers := [(14, 1), (44, 1), (49, 1), (64, 1)] }, { coefficient := 1, powers := [(14, 1), (49, 1), (51, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(7, 1), (59, 1), (64, 1)] }, { coefficient := -1, powers := [(10, 1), (44, 1), (64, 1)] }, { coefficient := -1, powers := [(10, 1), (56, 1), (64, 1)] }, { coefficient := -2, powers := [(14, 1), (39, 1), (64, 1)] }, { coefficient := -1, powers := [(14, 1), (44, 1), (64, 1)] }, { coefficient := -1, powers := [(14, 1), (51, 1), (64, 1)] }],
  ...
  [{ coefficient := 1, powers := [(36, 1), (59, 1)] }, { coefficient := -1, powers := [(39, 1), (40, 1), (56, 1), (64, 1)] }, { coefficient := -1, powers := [(39, 1), (46, 1), (52, 1), (64, 1)] }, { coefficient := -1, powers := [(39, 1), (56, 1), (57, 1), (67, 1)] }, { coefficient := 1, powers := [(39, 1), (56, 1)] }, { coefficient := -1, powers := [(44, 1), (51, 1)] }, { coefficient := -1, powers := [(45, 1), (53, 1), (56, 1), (67, 1)] }],
...
#print axioms Krenn.Component39.SelectedLeafB4_7_7.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB4_7_7
