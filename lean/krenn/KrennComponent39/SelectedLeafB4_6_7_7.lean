...
namespace Krenn.Component39.SelectedLeafB4_6_7_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "d92b86bf2b9f23972d5d633acce275738781d417efc9e5838c581bb3ebcc2caa"
...
def multipliers : Fin 22 → SparsePoly (Fin 70) := ![
  ...
  [{ coefficient := -1, powers := [(21, 1), (25, 1), (44, 1), (53, 1), (62, 1), (69, 1)] }, { coefficient := -1, powers := [(21, 1), (25, 1), (53, 1), (62, 1), (67, 1), (69, 1)] }, { coefficient := 1, powers := [(21, 1), (33, 1), (36, 1), (53, 1), (62, 1), (69, 1)] }],
  ...
  [{ coefficient := 1, powers := [(25, 1), (44, 1), (53, 1), (62, 1), (69, 1)] }, { coefficient := 1, powers := [(25, 1), (53, 1), (62, 1), (67, 1), (69, 1)] }, { coefficient := -1, powers := [(33, 1), (36, 1), (53, 1), (62, 1), (69, 1)] }],
  ...
  [{ coefficient := -1, powers := [(27, 1), (53, 1), (62, 1), (69, 1)] }, { coefficient := -1, powers := [(28, 1), (44, 1), (62, 1), (69, 1)] }],
  ...
  [{ coefficient := 1, powers := [(27, 1), (38, 1), (53, 1), (56, 1), (62, 1), (69, 1)] }, { coefficient := 1, powers := [(27, 1), (50, 1), (53, 1), (62, 1), (69, 1)] }, { coefficient := 1, powers := [(28, 1), (36, 1), (59, 1), (69, 1)] }, { coefficient := 1, powers := [(28, 1), (38, 1), (44, 1), (56, 1), (62, 1), (69, 1)] }, { coefficient := -1, powers := [(28, 1), (39, 1), (56, 1), (57, 1), (66, 1), (69, 1)] }, { coefficient := 1, powers := [(28, 1), (39, 1), (56, 1), (69, 1)] }, { coefficient := 1, powers := [(28, 1), (44, 1), (50, 1), (62, 1), (69, 1)] }, { coefficient := -1, powers := [(28, 1), (44, 1), (51, 1), (69, 1)] }, { coefficient := -1, powers := [(28, 1), (45, 1), (53, 1), (56, 1), (66, 1), (69, 1)] }],
...
#print axioms Krenn.Component39.SelectedLeafB4_6_7_7.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB4_6_7_7
