...
namespace Krenn.Component39.SelectedLeafB1_2_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "0b823f4e03b7db82d1cb8de4dbbc8bf04e33c5d2ae9ab93f41ecd321c0e16409"
def certificateSHA256 : String := "c26a359023f5f3ee99ab35e6ba2c08f7837c4336835b7cfc33b6d8386d64c26e"
...
def multipliers : Fin 7 → SparsePoly (Fin 64) := ![
  ...
  [{ coefficient := 1, powers := [(24, 1), (42, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (36, 1), (42, 1), (59, 1), (63, 1)] }, { coefficient := -1, powers := [(24, 1), (39, 1), (42, 1), (56, 1), (63, 1)] }, { coefficient := -1, powers := [(24, 1), (42, 1), (44, 1), (51, 1), (63, 1)] }, { coefficient := 1, powers := [(24, 1), (45, 1), (51, 1), (63, 1)] }, { coefficient := -1, powers := [(39, 1), (57, 1), (63, 1)] }, { coefficient := 1, powers := [(42, 1), (44, 1), (53, 1), (63, 1)] }, { coefficient := -1, powers := [(45, 1), (53, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (42, 1), (63, 1)] }],
...
#print axioms Krenn.Component39.SelectedLeafB1_2_1.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB1_2_1
