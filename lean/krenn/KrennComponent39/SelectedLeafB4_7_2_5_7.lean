...
namespace Krenn.Component39.SelectedLeafB4_7_2_5_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "219db96acd46153e71b13b68b5aaf831418d4714c64ca510ac8b25e32f33958a"
def certificateSHA256 : String := "58e3e86828b89607964838cd0b94ba8c62e92bb817fc1e1c1d26c39bb388a591"

set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedSourceIndices : Fin 36 → Fin 676 := ![
  10,
  11,
  19,
  23,
...
def multipliers : Fin 36 → SparsePoly (Fin 71) := ![
  ...
  [{ coefficient := 1, powers := [(10, 1), (16, 1), (19, 1), (20, 1), (22, 1), (33, 1), (36, 1), (45, 1), (54, 1), (64, 1)] }, { coefficient := 1, powers := [(10, 1), (16, 1), (19, 1), (20, 1), (28, 1), (33, 1), (36, 1), (40, 1), (45, 1), (64, 1)] }, { coefficient := 1, powers := [(10, 1), (17, 1), (19, 1), (20, 1), (22, 1), (33, 1), (36, 1), (51, 1), (54, 1), (64, 1)] }, { coefficient := 1, powers := [(10, 1), (17, 1), (19, 1), (20, 1), (28, 1), (33, 1), (36, 1), (40, 1), (51, 1), (64, 1)] }, { coefficient := 2, powers := [(19, 1), (20, 1), (51, 1), (64, 1)] }, { coefficient := 1, powers := [(19, 1), (20, 1), (56, 1), (64, 1)] }, { coefficient := 1, powers := [(19, 1), (33, 1), (36, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(7, 1), (10, 1), (22, 1), (33, 1), (36, 1), (54, 1), (59, 1)] }, { coefficient := 1, powers := [(7, 1), (10, 1), (28, 1), (33, 1), (36, 1), (40, 1), (59, 1)] }, { coefficient := -1, powers := [(10, 1), (14, 1), (22, 1), (33, 1), (36, 1), (51, 1), (54, 1)] }, { coefficient := -1, powers := [(10, 1), (14, 1), (28, 1), (33, 1), (36, 1), (40, 1), (51, 1)] }],
  [{ coefficient := -1, powers := [(10, 1), (26, 1), (44, 1), (67, 1)] }],
  [{ coefficient := 1, powers := [(10, 1), (22, 1), (36, 1), (60, 1), (62, 1)] }, { coefficient := 1, powers := [(10, 1), (31, 1), (36, 1), (47, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(10, 1), (16, 1), (22, 1), (33, 2), (36, 1), (45, 1), (54, 1), (70, 1)] }, { coefficient := -1, powers := [(10, 1), (16, 1), (28, 1), (33, 2), (36, 1), (40, 1), (45, 1), (70, 1)] }, { coefficient := 1, powers := [(10, 1), (17, 1), (22, 1), (30, 1), (33, 1), (36, 1), (54, 1), (56, 1), (70, 1)] }, { coefficient := -1, powers := [(10, 1), (17, 1), (22, 1), (33, 2), (36, 1), (51, 1), (54, 1), (70, 1)] }, { coefficient := 1, powers := [(10, 1), (17, 1), (28, 1), (30, 1), (33, 1), (36, 1), (40, 1), (56, 1), (70, 1)] }, { coefficient := -1, powers := [(10, 1), (17, 1), (28, 1), (33, 2), (36, 1), (40, 1), (51, 1), (70, 1)] }, { coefficient := -1, powers := [(20, 1), (59, 1), (70, 1)] }, { coefficient := 1, powers := [(30, 1), (56, 1), (70, 1)] }, { coefficient := 1, powers := [(33, 1), (39, 1), (70, 1)] }],
  [{ coefficient := 1, powers := [(20, 1), (44, 1), (53, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(20, 1), (44, 1), (67, 1)] }],
  [{ coefficient := 1, powers := [(10, 1), (28, 1), (33, 1), (36, 1), (47, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(10, 1), (28, 1), (33, 1), (36, 1), (47, 1), (49, 1), (61, 1)] }, { coefficient := -1, powers := [(10, 1), (28, 1), (33, 1), (36, 1), (47, 1), (49, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(10, 1), (17, 1), (31, 1), (36, 1)] }],
  [{ coefficient := -1, powers := [(10, 1), (16, 1), (20, 1), (22, 1), (33, 1), (36, 1), (45, 1), (54, 1), (64, 1)] }, { coefficient := -1, powers := [(10, 1), (16, 1), (20, 1), (28, 1), (33, 1), (36, 1), (40, 1), (45, 1), (64, 1)] }, { coefficient := -1, powers := [(10, 1), (17, 1), (20, 1), (22, 1), (33, 1), (36, 1), (51, 1), (54, 1), (64, 1)] }, { coefficient := -1, powers := [(10, 1), (17, 1), (20, 1), (28, 1), (33, 1), (36, 1), (40, 1), (51, 1), (64, 1)] }, { coefficient := -2, powers := [(20, 1), (51, 1), (64, 1)] }, { coefficient := -1, powers := [(20, 1), (56, 1), (64, 1)] }, { coefficient := -1, powers := [(33, 1), (36, 1), (64, 1)] }],
  ...
  [{ coefficient := -1, powers := [(10, 1), (16, 1), (22, 1), (33, 1), (36, 1), (44, 1), (45, 1), (54, 1)] }, { coefficient := -1, powers := [(10, 1), (16, 1), (28, 1), (33, 1), (36, 1), (40, 1), (44, 1), (45, 1)] }, { coefficient := 1, powers := [(10, 1), (17, 1), (22, 1), (33, 1), (36, 2), (54, 1), (59, 1)] }, { coefficient := 1, powers := [(10, 1), (17, 1), (22, 1), (33, 1), (36, 1), (39, 1), (54, 1), (56, 1)] }, { coefficient := -2, powers := [(10, 1), (17, 1), (22, 1), (33, 1), (36, 1), (44, 1), (51, 1), (54, 1)] }, { coefficient := 1, powers := [(10, 1), (17, 1), (22, 1), (33, 1), (36, 1), (51, 1), (54, 1), (56, 1)] }, { coefficient := 1, powers := [(10, 1), (17, 1), (28, 1), (33, 1), (36, 2), (40, 1), (59, 1)] }, { coefficient := 1, powers := [(10, 1), (17, 1), (28, 1), (33, 1), (36, 1), (39, 1), (40, 1), (56, 1)] }, { coefficient := -2, powers := [(10, 1), (17, 1), (28, 1), (33, 1), (36, 1), (40, 1), (44, 1), (51, 1)] }, { coefficient := 1, powers := [(10, 1), (17, 1), (28, 1), (33, 1), (36, 1), (40, 1), (51, 1), (56, 1)] }, { coefficient := -1, powers := [(36, 1), (58, 1), (59, 1), (68, 1)] }, { coefficient := 1, powers := [(36, 1), (59, 1)] }, { coefficient := 1, powers := [(39, 1), (44, 1)] }, { coefficient := 1, powers := [(39, 1), (56, 1)] }, { coefficient := -1, powers := [(43, 1), (50, 1), (59, 1), (68, 1)] }, { coefficient := -1, powers := [(44, 1), (51, 1)] }, { coefficient := 1, powers := [(51, 1), (56, 1)] }],
  [{ coefficient := 1, powers := [(10, 1), (33, 1), (36, 1), (37, 1), (60, 1)] }, { coefficient := 1, powers := [(10, 1), (33, 1), (36, 1), (40, 1), (57, 1)] }, { coefficient := 1, powers := [(10, 1), (33, 1), (36, 1), (47, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (10, 1), (22, 1), (33, 1), (36, 1), (60, 1)] }, { coefficient := -1, powers := [(8, 1), (10, 1), (31, 1), (33, 1), (36, 1), (47, 1)] }],
...
#print axioms Krenn.Component39.SelectedLeafB4_7_2_5_7.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB4_7_2_5_7
