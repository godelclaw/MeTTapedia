...
namespace Krenn.Component39.SelectedLeafB5_6_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "b81abbb998a4b745f799b27f85eed41172797fd4473ba1247c94f6def8a7f79d"
...
def multipliers : Fin 23 → SparsePoly (Fin 67) := ![
  [{ coefficient := 1, powers := [(23, 1), (27, 1), (42, 1), (44, 1), (53, 1), (62, 1), (66, 1)] }, { coefficient := -1, powers := [(23, 1), (27, 1), (51, 1), (57, 1), (62, 1), (66, 1)] }, { coefficient := 1, powers := [(23, 1), (27, 1), (51, 1), (62, 1)] }, { coefficient := 1, powers := [(27, 1), (51, 1), (62, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(23, 1), (27, 1), (53, 1), (62, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(16, 1), (23, 1), (27, 1), (44, 1), (53, 1), (62, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(16, 1), (23, 1), (42, 1), (62, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(23, 1), (53, 1), (62, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(23, 1), (27, 1), (51, 1), (62, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (27, 1), (62, 1)] }, { coefficient := -1, powers := [(23, 1), (27, 1), (57, 1), (62, 1), (66, 1)] }, { coefficient := 1, powers := [(23, 1), (27, 1), (62, 1)] }, { coefficient := 2, powers := [(27, 1), (62, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(62, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(23, 1), (57, 1), (62, 1), (66, 1)] }, { coefficient := -1, powers := [(23, 1), (62, 1)] }, { coefficient := -1, powers := [(62, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (23, 1), (27, 1), (62, 1)] }, { coefficient := 1, powers := [(23, 2), (27, 1), (57, 1), (62, 1), (66, 1)] }, { coefficient := -1, powers := [(23, 2), (27, 1), (62, 1)] }, { coefficient := -1, powers := [(23, 1), (24, 1), (27, 1), (42, 1), (62, 1), (66, 1)] }, { coefficient := -2, powers := [(23, 1), (27, 1), (62, 1), (64, 1)] }, { coefficient := 1, powers := [(23, 1), (28, 1), (42, 1), (62, 1), (66, 1)] }],
  [{ coefficient := 2, powers := [(0, 1), (16, 1), (62, 1), (64, 1)] }, { coefficient := 1, powers := [(16, 1), (23, 1), (62, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(16, 1), (23, 1), (27, 1), (42, 1), (62, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(23, 1), (51, 1), (62, 1), (66, 1)] }],
  ...
  [{ coefficient := 1, powers := [(0, 1), (2, 1), (39, 1), (62, 1), (64, 1)] }, { coefficient := -1, powers := [(0, 1), (16, 1), (23, 1), (27, 1), (62, 1)] }, { coefficient := -1, powers := [(0, 1), (16, 1), (27, 1), (62, 1), (64, 1)] }, { coefficient := -1, powers := [(0, 1), (39, 1), (64, 1)] }, { coefficient := 1, powers := [(16, 1), (18, 1), (23, 1), (27, 1), (62, 1)] }, { coefficient := 1, powers := [(16, 1), (18, 1), (27, 1), (62, 1), (64, 1)] }, { coefficient := -1, powers := [(16, 1), (21, 1), (23, 1), (57, 1), (62, 1), (66, 1)] }, { coefficient := -1, powers := [(16, 1), (23, 2), (27, 1), (57, 1), (62, 1), (66, 1)] }, { coefficient := 1, powers := [(16, 1), (23, 2), (27, 1), (62, 1)] }, { coefficient := 1, powers := [(16, 1), (23, 1), (24, 1), (27, 1), (42, 1), (62, 1), (66, 1)] }, { coefficient := 1, powers := [(16, 1), (23, 1), (27, 1), (62, 1), (64, 1)] }, { coefficient := -1, powers := [(16, 1), (23, 1), (28, 1), (42, 1), (62, 1), (66, 1)] }, { coefficient := -1, powers := [(64, 1)] }],
...
#print axioms Krenn.Component39.SelectedLeafB5_6_5.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB5_6_5
