...
namespace Krenn.Component39.SelectedLeafB4_3_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "7389427dda85ef9050e70d757889a46e6744228eee776f4437da871b590015ec"
...
def multipliers : Fin 18 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := 1, powers := [(7, 1), (49, 1), (59, 1), (63, 1)] }, { coefficient := 1, powers := [(10, 1), (44, 1), (49, 1), (63, 1)] }, { coefficient := 1, powers := [(10, 1), (49, 1), (56, 1), (63, 1)] }, { coefficient := 2, powers := [(14, 1), (39, 1), (49, 1), (63, 1)] }, { coefficient := 1, powers := [(14, 1), (44, 1), (49, 1), (63, 1)] }, { coefficient := 1, powers := [(14, 1), (49, 1), (51, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(7, 1), (59, 1), (63, 1)] }, { coefficient := -1, powers := [(10, 1), (44, 1), (63, 1)] }, { coefficient := -1, powers := [(10, 1), (56, 1), (63, 1)] }, { coefficient := -2, powers := [(14, 1), (39, 1), (63, 1)] }, { coefficient := -1, powers := [(14, 1), (44, 1), (63, 1)] }, { coefficient := -1, powers := [(14, 1), (51, 1), (63, 1)] }],
  ...
  [{ coefficient := 1, powers := [(36, 1), (59, 1)] }, { coefficient := -1, powers := [(39, 1), (40, 1), (56, 1), (63, 1)] }, { coefficient := -1, powers := [(39, 1), (46, 1), (52, 1), (63, 1)] }, { coefficient := -1, powers := [(39, 1), (56, 1), (57, 1), (65, 1)] }, { coefficient := 1, powers := [(39, 1), (56, 1)] }, { coefficient := -1, powers := [(44, 1), (51, 1)] }, { coefficient := -1, powers := [(45, 1), (53, 1), (56, 1), (65, 1)] }],
...
#print axioms Krenn.Component39.SelectedLeafB4_3_3.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB4_3_3
