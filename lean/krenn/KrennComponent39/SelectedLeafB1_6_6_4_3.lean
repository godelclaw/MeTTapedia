...
namespace Krenn.Component39.SelectedLeafB1_6_6_4_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "a1b1fca90ad50a7e06df15aa6db90b37e83f2a980b57c3f64ea007b79da0a427"
def certificateSHA256 : String := "dbe64ed08cd37b1c997c16a8267e5900aa3594aa13c743abedfb500fa6782300"
...
def multipliers : Fin 30 → SparsePoly (Fin 69) := ![
  [{ coefficient := 1, powers := [(33, 1), (36, 1), (59, 1), (68, 1)] }],
  [{ coefficient := -1, powers := [(33, 1), (36, 1), (59, 1), (68, 1)] }],
  [{ coefficient := 1, powers := [(18, 1), (33, 1), (36, 1), (59, 1), (68, 1)] }, { coefficient := -1, powers := [(20, 1), (59, 1), (68, 1)] }, { coefficient := -1, powers := [(23, 1), (33, 1), (36, 1), (59, 1), (68, 1)] }, { coefficient := 1, powers := [(30, 1), (56, 1), (68, 1)] }, { coefficient := -1, powers := [(33, 1), (44, 1), (68, 1)] }, { coefficient := 1, powers := [(33, 1), (51, 1), (68, 1)] }],
  ...
  [{ coefficient := -1, powers := [(36, 1), (59, 1), (60, 1), (68, 1)] }, { coefficient := 1, powers := [(36, 1), (59, 1)] }, { coefficient := 2, powers := [(38, 1), (51, 1), (56, 1), (62, 1)] }, { coefficient := 1, powers := [(38, 1), (56, 2), (62, 1)] }, { coefficient := 1, powers := [(39, 1), (56, 1)] }, { coefficient := -1, powers := [(44, 2)] }, { coefficient := -1, powers := [(45, 1), (52, 1), (59, 1), (68, 1)] }, { coefficient := 2, powers := [(50, 1), (51, 1), (62, 1)] }, { coefficient := 1, powers := [(50, 1), (56, 1), (62, 1)] }, { coefficient := 1, powers := [(51, 1), (56, 1)] }],
  ...
  [{ coefficient := -1, powers := [(4, 1), (59, 1), (60, 1), (68, 1)] }, { coefficient := 1, powers := [(4, 1), (59, 1)] }, { coefficient := 1, powers := [(10, 1), (56, 1)] }, { coefficient := 2, powers := [(14, 1), (38, 1), (51, 1), (62, 1)] }, { coefficient := 1, powers := [(14, 1), (38, 1), (56, 1), (62, 1)] }, { coefficient := -1, powers := [(14, 1), (44, 1)] }],
  [{ coefficient := -1, powers := [(4, 1), (18, 1), (33, 1), (36, 1), (59, 1)] }, { coefficient := 1, powers := [(4, 1), (20, 1), (59, 1)] }, { coefficient := -1, powers := [(4, 1), (30, 1), (56, 1)] }, { coefficient := 1, powers := [(4, 1), (33, 1), (44, 1)] }, { coefficient := -1, powers := [(4, 1), (33, 1), (51, 1)] }, { coefficient := 1, powers := [(7, 1), (23, 1), (33, 1), (36, 1), (59, 1)] }, { coefficient := -1, powers := [(7, 1), (30, 1), (56, 1)] }, { coefficient := 1, powers := [(7, 1), (33, 1), (44, 1)] }, { coefficient := -1, powers := [(7, 1), (33, 1), (51, 1)] }]
]
...
#print axioms Krenn.Component39.SelectedLeafB1_6_6_4_3.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB1_6_6_4_3
