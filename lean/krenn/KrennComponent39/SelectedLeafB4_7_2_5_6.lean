...
namespace Krenn.Component39.SelectedLeafB4_7_2_5_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "4e08b10548871ee2ae7ad8ff2c184d86d08032c9673ee4892e33b1a598fc37e7"
...
def multipliers : Fin 22 → SparsePoly (Fin 70) := ![
  ...
  [{ coefficient := -1, powers := [(36, 1), (58, 1), (59, 1), (68, 1)] }, { coefficient := 1, powers := [(36, 1), (59, 1)] }, { coefficient := -1, powers := [(38, 1), (39, 1), (56, 1), (62, 1)] }, { coefficient := -1, powers := [(39, 1), (50, 1), (62, 1)] }, { coefficient := 1, powers := [(39, 1), (56, 1)] }, { coefficient := -1, powers := [(43, 1), (50, 1), (59, 1), (68, 1)] }, { coefficient := -1, powers := [(44, 1), (51, 1)] }],
  ...
  [{ coefficient := -1, powers := [(4, 1), (58, 1), (59, 1), (68, 1)] }, { coefficient := 1, powers := [(4, 1), (59, 1)] }, { coefficient := -1, powers := [(14, 1), (38, 1), (39, 1), (62, 1)] }, { coefficient := -1, powers := [(14, 1), (44, 1)] }],
...
#print axioms Krenn.Component39.SelectedLeafB4_7_2_5_6.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB4_7_2_5_6
