...
namespace Krenn.Component39.SelectedLeafB0_3_2_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "74a79160119696fafe59f063bca7264d3028e285d7fe0020a318cc72dd17b3dc"
def certificateSHA256 : String := "7744159680eec0c499fb82d23d7b39bde67bfeb177c9b49af128192f699e1697"
...
def multipliers : Fin 25 → SparsePoly (Fin 65) := ![
  ...
  [{ coefficient := 1, powers := [(17, 1), (22, 1), (24, 1), (64, 1)] }],
  ...
  [{ coefficient := 1, powers := [(17, 1), (22, 1), (24, 1)] }],
  [{ coefficient := 1, powers := [(17, 1), (27, 1)] }],
  [{ coefficient := 1, powers := [(12, 1)] }],
  [{ coefficient := -1, powers := [(17, 1), (24, 1)] }],
  [{ coefficient := 1, powers := [(40, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := 1, powers := [(17, 1), (22, 1), (23, 1), (44, 1), (54, 1), (64, 1)] }, { coefficient := -1, powers := [(17, 1), (22, 1), (24, 1), (44, 1), (49, 1), (64, 1)] }, { coefficient := -1, powers := [(17, 1), (22, 1), (24, 1), (44, 1), (52, 1)] }, { coefficient := 1, powers := [(17, 1), (22, 1), (44, 1), (54, 1)] }, { coefficient := -1, powers := [(17, 1), (27, 1), (46, 1), (54, 1)] }],
  [{ coefficient := 1, powers := [(19, 1), (45, 1), (54, 1)] }, { coefficient := 1, powers := [(37, 1), (60, 1)] }, { coefficient := -1, powers := [(39, 1), (40, 1), (57, 1), (61, 1)] }, { coefficient := -1, powers := [(40, 1), (45, 1), (53, 1), (61, 1)] }, { coefficient := 1, powers := [(40, 1), (57, 1)] }, { coefficient := -1, powers := [(47, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (34, 1), (40, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (31, 1)] }, { coefficient := -1, powers := [(12, 1), (22, 1), (23, 1), (64, 1)] }, { coefficient := -1, powers := [(16, 1), (27, 1), (40, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (22, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (60, 1)] }, { coefficient := 1, powers := [(12, 1), (42, 1), (46, 1)] }, { coefficient := -1, powers := [(12, 1), (47, 1)] }, { coefficient := -1, powers := [(16, 1), (40, 1), (45, 1), (61, 1)] }, { coefficient := 1, powers := [(16, 1), (47, 1), (49, 1)] }, { coefficient := 1, powers := [(17, 1), (40, 1), (44, 1), (61, 1)] }, { coefficient := -1, powers := [(17, 1), (46, 1), (49, 1)] }]
]
...
#print axioms Krenn.Component39.SelectedLeafB0_3_2_4.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB0_3_2_4
