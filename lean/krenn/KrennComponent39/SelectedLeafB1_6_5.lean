...
namespace Krenn.Component39.SelectedLeafB1_6_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "80c0aeec542ea6e820bd73fd044779e35309e0b30dadce10664725b35988b103"
...
def multipliers : Fin 7 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := 1, powers := [(24, 1), (42, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (36, 1), (42, 1), (59, 1), (65, 1)] }, { coefficient := -1, powers := [(24, 1), (39, 1), (42, 1), (56, 1), (65, 1)] }, { coefficient := -1, powers := [(24, 1), (42, 1), (44, 1), (51, 1), (65, 1)] }, { coefficient := 1, powers := [(24, 1), (45, 1), (51, 1), (65, 1)] }, { coefficient := -1, powers := [(39, 1), (57, 1), (65, 1)] }, { coefficient := 1, powers := [(42, 1), (44, 1), (53, 1), (65, 1)] }, { coefficient := -1, powers := [(45, 1), (53, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (42, 1), (65, 1)] }],
...
#print axioms Krenn.Component39.SelectedLeafB1_6_5.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB1_6_5
