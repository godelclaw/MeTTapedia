...
namespace Krenn.Component39.SelectedLeafB5_5_2_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "d2ef98cef8ae90ac2754f3907568bc44c28e4e9a374ea65714ad87174ea137d5"
...
def multipliers : Fin 7 → SparsePoly (Fin 67) := ![
  [{ coefficient := -1, powers := [(19, 1), (64, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(49, 1), (64, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(64, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(19, 1), (49, 1), (64, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (23, 1), (49, 1), (64, 1), (66, 1)] }],
...
#print axioms Krenn.Component39.SelectedLeafB5_5_2_4.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB5_5_2_4
