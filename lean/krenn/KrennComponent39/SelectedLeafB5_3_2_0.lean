...
namespace Krenn.Component39.SelectedLeafB5_3_2_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "ac32aee7b5f648d97bddca4a6e423527aff650b03e5032cf1df34c78bcc10dc5"
...
def multipliers : Fin 29 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := -1, powers := [(2, 1), (39, 1), (40, 1), (51, 1), (53, 1), (63, 1)] }, { coefficient := 1, powers := [(2, 1), (40, 1), (53, 1), (61, 1)] }],
  ...
  [{ coefficient := 1, powers := [(2, 1), (39, 1), (40, 1), (53, 1), (63, 1)] }],
  ...
  [{ coefficient := -1, powers := [(2, 1), (40, 1), (42, 1), (53, 1), (61, 1)] }, { coefficient := -1, powers := [(2, 1), (40, 1), (45, 1), (51, 1), (53, 1), (63, 1)] }, { coefficient := -1, powers := [(2, 1), (47, 1), (49, 1), (53, 1), (61, 1)] }, { coefficient := -1, powers := [(2, 1), (47, 1), (51, 1), (54, 1)] }, { coefficient := 1, powers := [(2, 1), (47, 1), (54, 1), (61, 1)] }, { coefficient := -1, powers := [(16, 1), (22, 1), (39, 1), (42, 1), (54, 1)] }, { coefficient := -1, powers := [(16, 1), (22, 1), (42, 1), (44, 1), (54, 1)] }, { coefficient := 1, powers := [(16, 1), (22, 1), (45, 1), (54, 1)] }, { coefficient := 2, powers := [(17, 1), (22, 1), (39, 1), (54, 1)] }],
...
#print axioms Krenn.Component39.SelectedLeafB5_3_2_0.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB5_3_2_0
