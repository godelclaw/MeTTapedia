...
namespace Krenn.Component39.SelectedLeafB1_6_2_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "2c969bbe3d0201561df80c2b43e966564b6c6fb5c71abdfc089900db8bbde9e2"
...
def multipliers : Fin 29 → SparsePoly (Fin 67) := ![
  ...
  [{ coefficient := -1, powers := [(3, 1), (19, 1), (25, 1), (34, 1), (51, 1), (54, 1), (66, 2)] }, { coefficient := -1, powers := [(3, 1), (19, 1), (25, 1), (34, 1), (54, 1), (56, 1), (66, 2)] }, { coefficient := -1, powers := [(3, 1), (25, 1), (34, 1), (46, 1), (54, 1), (66, 2)] }, { coefficient := 1, powers := [(3, 1), (34, 1), (46, 1), (54, 1), (66, 1)] }, { coefficient := -1, powers := [(5, 1), (21, 1), (34, 1), (54, 1), (61, 1), (66, 1)] }, { coefficient := -1, powers := [(5, 1), (26, 1), (34, 1), (54, 1), (61, 1), (66, 1)] }, { coefficient := -1, powers := [(21, 1), (37, 1), (60, 1), (66, 1)] }, { coefficient := 1, powers := [(22, 1), (24, 1), (35, 1), (51, 1), (60, 1), (66, 1)] }, { coefficient := 1, powers := [(22, 1), (24, 1), (35, 1), (56, 1), (60, 1), (66, 1)] }, { coefficient := -1, powers := [(22, 1), (35, 1), (53, 1), (60, 1), (66, 1)] }, { coefficient := -1, powers := [(22, 1), (42, 1), (54, 1), (66, 1)] }, { coefficient := -1, powers := [(26, 1), (37, 1), (60, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (21, 1), (54, 1), (59, 1), (66, 1)] }, { coefficient := 1, powers := [(5, 1), (26, 1), (54, 1), (59, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (35, 1), (53, 1), (60, 1), (66, 1)] }],
  ...
  [{ coefficient := 1, powers := [(5, 1), (25, 1), (34, 1), (51, 1), (54, 1), (66, 1)] }, { coefficient := -1, powers := [(5, 1), (34, 1), (51, 1), (54, 1)] }],
  ...
  [{ coefficient := -1, powers := [(2, 1), (35, 1), (46, 1), (53, 1), (60, 1)] }, { coefficient := -1, powers := [(2, 1), (47, 1), (54, 1)] }, { coefficient := 1, powers := [(3, 1), (16, 1), (19, 1), (25, 1), (34, 1), (51, 1), (54, 1), (66, 1)] }, { coefficient := 1, powers := [(3, 1), (16, 1), (19, 1), (25, 1), (34, 1), (54, 1), (56, 1), (66, 1)] }, { coefficient := 1, powers := [(3, 1), (16, 1), (25, 1), (34, 1), (46, 1), (54, 1), (66, 1)] }, { coefficient := 1, powers := [(5, 1), (16, 1), (21, 1), (34, 1), (54, 1), (61, 1)] }, { coefficient := 1, powers := [(5, 1), (16, 1), (26, 1), (34, 1), (54, 1), (61, 1)] }, { coefficient := 1, powers := [(5, 1), (18, 1), (34, 1), (51, 1), (54, 1)] }, { coefficient := 1, powers := [(5, 1), (18, 1), (34, 1), (54, 1), (56, 1)] }, { coefficient := -1, powers := [(5, 1), (21, 1), (42, 1), (54, 1), (59, 1)] }, { coefficient := -1, powers := [(5, 1), (26, 1), (42, 1), (54, 1), (59, 1)] }, { coefficient := 1, powers := [(12, 1), (22, 1), (24, 1), (45, 1)] }, { coefficient := 1, powers := [(16, 1), (21, 1), (37, 1), (60, 1)] }, { coefficient := -1, powers := [(16, 1), (22, 1), (24, 1), (35, 1), (51, 1), (60, 1)] }, { coefficient := -1, powers := [(16, 1), (22, 1), (24, 1), (35, 1), (56, 1), (60, 1)] }, { coefficient := 1, powers := [(16, 1), (22, 1), (35, 1), (53, 1), (60, 1)] }, { coefficient := 1, powers := [(16, 1), (22, 1), (42, 1), (54, 1)] }, { coefficient := 1, powers := [(16, 1), (26, 1), (37, 1), (60, 1)] }],
...
#print axioms Krenn.Component39.SelectedLeafB1_6_2_6.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB1_6_2_6
