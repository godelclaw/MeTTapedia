...
namespace Krenn.Component39.SelectedLeafB5_6_7_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "a82945d526cf57148a00455b454313e55344afab3db513272ffe545bf7dbecc1"
...
def multipliers : Fin 22 → SparsePoly (Fin 70) := ![
  [{ coefficient := 1, powers := [(22, 1), (51, 1), (57, 1), (66, 1), (68, 1)] }, { coefficient := 1, powers := [(34, 1), (37, 1), (68, 1)] }],
  ...
  [{ coefficient := 1, powers := [(8, 1), (31, 1), (68, 1)] }],
  ...
  [{ coefficient := 1, powers := [(2, 1), (46, 1), (52, 1), (57, 1), (66, 1)] }, { coefficient := -1, powers := [(8, 1), (31, 1), (47, 1)] }, { coefficient := -1, powers := [(12, 1), (22, 1), (51, 1), (57, 1), (66, 1)] }, { coefficient := -1, powers := [(12, 1), (34, 1), (37, 1)] }, { coefficient := -1, powers := [(16, 1), (22, 1), (42, 1), (54, 1)] }, { coefficient := 1, powers := [(16, 1), (22, 1), (52, 1), (57, 1), (66, 1)] }]
]
...
#print axioms Krenn.Component39.SelectedLeafB5_6_7_3.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB5_6_7_3
