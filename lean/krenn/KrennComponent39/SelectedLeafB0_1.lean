...
namespace Krenn.Component39.SelectedLeafB0_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "0f24a94e83156858228dc50af19d4214de9874d2eedb9d2eab227a3bfe8607b0"
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedEquations : Fin 8 → SparsePoly (Fin 62) := ![
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def multipliers : Fin 8 → SparsePoly (Fin 62) := ![
  [{ coefficient := 1, powers := [(19, 1), (44, 1), (61, 1)] }, { coefficient := -1, powers := [(46, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(44, 1), (49, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (44, 1), (49, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(61, 1)] }],
  [{ coefficient := 1, powers := [(19, 1), (44, 1), (52, 1), (61, 1)] }, { coefficient := -1, powers := [(40, 1), (56, 1), (61, 1)] }, { coefficient := -1, powers := [(46, 1), (52, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(19, 1), (23, 1), (44, 1), (49, 1), (61, 1)] }],
...
#print axioms Krenn.Component39.SelectedLeafB0_1.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB0_1
