...
namespace Krenn.Component39.SelectedLeafB5_3_2_4_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "165b450e857ecd0c32a5f1fd3bd132683e393d91e9cf9f8860c71beca8af1e55"
def certificateSHA256 : String := "75a2df7e81c359b21d1a3b2caa78bc1b38877c097eab0b865dec715fe21f9af8"
...
def multipliers : Fin 24 → SparsePoly (Fin 69) := ![
  [{ coefficient := -1, powers := [(2, 1), (18, 1), (19, 1), (33, 1), (36, 1), (51, 1), (62, 1), (64, 1)] }, { coefficient := -1, powers := [(18, 1), (19, 1), (33, 1), (36, 1), (39, 1), (64, 1)] }, { coefficient := 2, powers := [(19, 1), (20, 1), (51, 1), (64, 1)] }, { coefficient := 1, powers := [(19, 1), (20, 1), (56, 1), (64, 1)] }, { coefficient := 1, powers := [(19, 1), (33, 1), (36, 1), (64, 1)] }],
  ...
  [{ coefficient := 1, powers := [(18, 1), (33, 1), (36, 1), (59, 1), (68, 1)] }, { coefficient := -1, powers := [(20, 1), (59, 1), (68, 1)] }, { coefficient := 1, powers := [(30, 1), (56, 1), (68, 1)] }, { coefficient := 1, powers := [(33, 1), (39, 1), (68, 1)] }],
  [{ coefficient := -1, powers := [(16, 1), (18, 1), (27, 1), (33, 1), (36, 1), (62, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(16, 1), (18, 1), (33, 1), (36, 1), (51, 1), (62, 1)] }, { coefficient := 1, powers := [(16, 1), (18, 1), (33, 1), (36, 1), (56, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(14, 1), (18, 1), (27, 1), (33, 1), (36, 1), (62, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (18, 1), (33, 1), (36, 1), (51, 1), (62, 1), (64, 1)] }, { coefficient := 1, powers := [(18, 1), (33, 1), (36, 1), (39, 1), (64, 1)] }, { coefficient := -2, powers := [(20, 1), (51, 1), (64, 1)] }, { coefficient := -1, powers := [(20, 1), (56, 1), (64, 1)] }, { coefficient := -1, powers := [(33, 1), (36, 1), (64, 1)] }],
  ...
  [{ coefficient := -1, powers := [(36, 1), (59, 1), (60, 1), (68, 1)] }, { coefficient := 1, powers := [(36, 1), (59, 1)] }, { coefficient := 1, powers := [(39, 1), (44, 1)] }, { coefficient := 1, powers := [(39, 1), (56, 1)] }, { coefficient := -1, powers := [(44, 1), (51, 1)] }, { coefficient := -1, powers := [(45, 1), (52, 1), (59, 1), (68, 1)] }, { coefficient := 1, powers := [(51, 1), (56, 1)] }],
  ...
  [{ coefficient := -1, powers := [(4, 1), (59, 1), (60, 1), (68, 1)] }, { coefficient := 1, powers := [(4, 1), (59, 1)] }, { coefficient := 1, powers := [(10, 1), (56, 1)] }, { coefficient := -1, powers := [(14, 1), (44, 1)] }],
...
#print axioms Krenn.Component39.SelectedLeafB5_3_2_4_3.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB5_3_2_4_3
