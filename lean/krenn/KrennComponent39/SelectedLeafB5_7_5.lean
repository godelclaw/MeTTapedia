...
namespace Krenn.Component39.SelectedLeafB5_7_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "203aa68ebbb7cfc01982833a64bd48dbc14405e6c62326793e051f4bf680b290"
...
def multipliers : Fin 18 → SparsePoly (Fin 68) := ![
  ...
  [{ coefficient := -1, powers := [(7, 1), (42, 1), (59, 1), (67, 1)] }, { coefficient := 1, powers := [(14, 1), (42, 1), (51, 1), (67, 1)] }],
  [{ coefficient := 1, powers := [(7, 1), (49, 1), (59, 1), (65, 1)] }, { coefficient := 1, powers := [(10, 1), (44, 1), (49, 1), (65, 1)] }, { coefficient := 2, powers := [(14, 1), (39, 1), (49, 1), (65, 1)] }, { coefficient := 1, powers := [(14, 1), (44, 1), (49, 1), (65, 1)] }, { coefficient := 1, powers := [(14, 1), (49, 1), (51, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(7, 1), (59, 1), (65, 1)] }, { coefficient := -1, powers := [(10, 1), (44, 1), (65, 1)] }, { coefficient := -2, powers := [(14, 1), (39, 1), (65, 1)] }, { coefficient := -1, powers := [(14, 1), (44, 1), (65, 1)] }, { coefficient := -1, powers := [(14, 1), (51, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(33, 1), (36, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(33, 1), (36, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(7, 1), (59, 1), (67, 1)] }, { coefficient := -1, powers := [(14, 1), (51, 1), (67, 1)] }],
  ...
  [{ coefficient := 1, powers := [(36, 1), (59, 1)] }, { coefficient := -1, powers := [(39, 1), (40, 1), (56, 1), (65, 1)] }, { coefficient := -1, powers := [(39, 1), (46, 1), (52, 1), (65, 1)] }, { coefficient := 1, powers := [(39, 1), (56, 1)] }, { coefficient := -1, powers := [(44, 1), (51, 1)] }],
...
#print axioms Krenn.Component39.SelectedLeafB5_7_5.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB5_7_5
