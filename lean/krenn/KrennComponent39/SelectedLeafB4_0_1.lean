...
namespace Krenn.Component39.SelectedLeafB4_0_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "7688af2d1d18c7852dd8b4e9223e60dfaf3fdab6f329869ecafda963c74f2514"
...
def multipliers : Fin 9 → SparsePoly (Fin 63) := ![
  ...
  [{ coefficient := 1, powers := [(18, 1), (53, 1), (62, 1)] }, { coefficient := -1, powers := [(24, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(24, 1), (45, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(18, 1), (51, 1), (62, 1)] }, { coefficient := 1, powers := [(62, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (18, 1), (51, 1), (57, 1), (62, 1)] }, { coefficient := -1, powers := [(0, 1), (57, 1), (62, 1)] }, { coefficient := 1, powers := [(18, 1), (24, 1), (42, 1), (51, 1), (62, 1)] }, { coefficient := -1, powers := [(18, 1), (42, 1), (53, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(18, 1), (24, 1), (45, 1), (62, 1)] }],
...
#print axioms Krenn.Component39.SelectedLeafB4_0_1.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB4_0_1
