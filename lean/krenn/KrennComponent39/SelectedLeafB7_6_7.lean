...
namespace Krenn.Component39.SelectedLeafB7_6_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "c49a6994a3844006b0ac893c66c06d774731bcc94f05ec33de8f499013feb121"
...
def multipliers : Fin 5 → SparsePoly (Fin 69) := ![
  [{ coefficient := -1, powers := [(24, 1), (50, 1), (62, 1), (64, 1), (68, 1)] }],
  [{ coefficient := 1, powers := [(62, 1), (64, 1), (68, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := -1, powers := [(1, 1), (57, 1), (62, 1), (68, 1)] }],
...
#print axioms Krenn.Component39.SelectedLeafB7_6_7.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB7_6_7
