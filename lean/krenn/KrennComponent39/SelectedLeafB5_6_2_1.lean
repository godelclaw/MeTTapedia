...
namespace Krenn.Component39.SelectedLeafB5_6_2_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "4d77033a68f0db827b9f7d3a12032a8899da30791340e02f7f9f9f0e079335db"
def certificateSHA256 : String := "b99a19612c721d3bc3b49ec3ed2bf726ae1d3d6762bed8976bcd59dc5a43e245"
...
def multipliers : Fin 22 → SparsePoly (Fin 67) := ![
  ...
  [{ coefficient := -1, powers := [(2, 1), (47, 1), (49, 1), (53, 1), (61, 1)] }, { coefficient := 1, powers := [(2, 1), (47, 1), (54, 1), (61, 1)] }, { coefficient := 1, powers := [(8, 1), (31, 1), (47, 1), (51, 1)] }, { coefficient := 1, powers := [(12, 1), (28, 1), (42, 1), (46, 1), (51, 1)] }, { coefficient := -1, powers := [(12, 1), (28, 1), (47, 1), (51, 1)] }, { coefficient := -1, powers := [(16, 1), (22, 1), (39, 1), (42, 1), (54, 1)] }, { coefficient := -1, powers := [(16, 1), (22, 1), (42, 1), (44, 1), (54, 1)] }, { coefficient := 1, powers := [(16, 1), (28, 1), (47, 1), (52, 1)] }, { coefficient := -1, powers := [(16, 1), (31, 1), (37, 1), (45, 1)] }, { coefficient := 1, powers := [(17, 1), (22, 1), (39, 1), (54, 1)] }, { coefficient := -1, powers := [(17, 1), (31, 1), (37, 1), (39, 1)] }]
]
...
#print axioms Krenn.Component39.SelectedLeafB5_6_2_1.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB5_6_2_1
