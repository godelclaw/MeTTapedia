...
namespace Krenn.Component39.SelectedLeafB5_0_6_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "31bf749cd6ec1f0df2de9097baae2dcf22e547c24028b82126aad927d28b63f1"
def certificateSHA256 : String := "e77b4fdbf132f12fa3808d6a4866ec389e0e5fbdf8455562a7ab86297d2846c9"
...
def multipliers : Fin 23 → SparsePoly (Fin 67) := ![
  [{ coefficient := -1, powers := [(10, 1), (21, 1), (33, 1), (36, 1), (62, 1), (65, 1)] }, { coefficient := -1, powers := [(10, 1), (26, 1), (33, 1), (35, 1), (44, 1), (51, 1), (62, 1), (65, 1)] }, { coefficient := -1, powers := [(10, 1), (26, 1), (33, 1), (36, 1), (62, 1), (65, 1)] }, { coefficient := -1, powers := [(10, 1), (27, 1), (33, 1), (35, 1), (51, 1), (62, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(20, 1), (51, 1), (56, 1)] }, { coefficient := 1, powers := [(25, 1), (44, 1), (51, 1)] }],
  [{ coefficient := 1, powers := [(51, 1)] }],
  [{ coefficient := 1, powers := [(44, 1)] }],
  [{ coefficient := 1, powers := [(14, 1), (18, 1), (20, 1), (56, 1), (66, 1)] }, { coefficient := 1, powers := [(14, 1), (18, 1), (25, 1), (44, 1), (66, 1)] }, { coefficient := 1, powers := [(14, 1), (20, 1), (66, 1)] }, { coefficient := -1, powers := [(14, 1), (25, 1), (66, 1)] }],
  ...
  [{ coefficient := -1, powers := [(18, 1), (20, 1), (56, 1), (66, 1)] }, { coefficient := -1, powers := [(18, 1), (25, 1), (44, 1), (66, 1)] }, { coefficient := -1, powers := [(20, 1), (66, 1)] }, { coefficient := 1, powers := [(25, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(20, 1), (56, 1)] }, { coefficient := -1, powers := [(25, 1), (44, 1)] }],
  [{ coefficient := 1, powers := [(18, 1), (20, 1), (28, 1), (56, 1), (66, 1)] }, { coefficient := 1, powers := [(18, 1), (25, 1), (28, 1), (44, 1), (66, 1)] }, { coefficient := 1, powers := [(20, 1), (28, 1), (66, 1)] }, { coefficient := -1, powers := [(25, 1), (28, 1), (66, 1)] }, { coefficient := 1, powers := [(25, 1)] }],
  ...
  [{ coefficient := 1, powers := [(2, 1), (10, 1), (33, 1), (35, 1), (56, 1), (62, 1)] }, { coefficient := 1, powers := [(7, 1), (33, 1)] }, { coefficient := -1, powers := [(10, 1), (16, 1), (26, 1), (33, 1), (35, 1), (51, 1), (62, 1)] }, { coefficient := -1, powers := [(14, 1), (18, 1), (20, 1), (28, 1), (56, 1), (66, 1)] }, { coefficient := -1, powers := [(14, 1), (18, 1), (25, 1), (28, 1), (44, 1), (66, 1)] }, { coefficient := -1, powers := [(14, 1), (20, 1), (28, 1), (66, 1)] }, { coefficient := 1, powers := [(14, 1), (25, 1), (28, 1), (66, 1)] }, { coefficient := -1, powers := [(14, 1), (25, 1)] }],
...
#print axioms Krenn.Component39.SelectedLeafB5_0_6_3.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB5_0_6_3
