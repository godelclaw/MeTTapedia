...
namespace Krenn.Component39.SelectedLeafB5_2_0_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "eea5142101a4bb714226d4f65aba6b261b38cd2de1b12d99b77775150fa5734a"
...
def multipliers : Fin 22 → SparsePoly (Fin 67) := ![
  ...
  [{ coefficient := -1, powers := [(0, 1), (28, 1), (47, 1), (52, 1), (65, 1)] }, { coefficient := -1, powers := [(19, 1), (28, 1), (42, 1), (52, 1), (65, 1)] }, { coefficient := 1, powers := [(22, 1), (42, 1), (54, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (19, 1), (54, 1), (61, 1), (65, 1)] }],
  [{ coefficient := 2, powers := [(17, 1), (23, 1), (27, 1), (54, 1), (65, 1)] }, { coefficient := -1, powers := [(17, 1), (28, 1), (49, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (2, 1), (54, 1), (61, 1), (65, 1)] }, { coefficient := -1, powers := [(2, 1), (24, 1), (49, 1), (61, 1), (65, 1)] }, { coefficient := 1, powers := [(8, 1), (31, 1), (65, 1)] }],
...
#print axioms Krenn.Component39.SelectedLeafB5_2_0_7.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB5_2_0_7
