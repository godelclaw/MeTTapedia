...
namespace Krenn.Component39.SelectedLeafB0_3_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "33b41ebd98ef2430a849c47aeb089ffe0215d82beed53a1f7625eed2959b8d71"
def certificateSHA256 : String := "c039d0017c36433e9cff762f41766273b937fd35f3f836f9c63a95b5da1d32fc"
...
def multipliers : Fin 20 → SparsePoly (Fin 65) := ![
  ...
  [{ coefficient := 1, powers := [(19, 1), (33, 1), (36, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(7, 1), (42, 1), (59, 1), (64, 1)] }, { coefficient := 1, powers := [(14, 1), (42, 1), (51, 1), (64, 1)] }, { coefficient := 1, powers := [(14, 1), (42, 1), (56, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(7, 1), (49, 1), (59, 1), (62, 1)] }, { coefficient := 1, powers := [(10, 1), (44, 1), (49, 1), (62, 1)] }, { coefficient := 1, powers := [(10, 1), (49, 1), (56, 1), (62, 1)] }, { coefficient := -1, powers := [(14, 1), (44, 1), (49, 1), (62, 1)] }, { coefficient := -1, powers := [(14, 1), (49, 1), (51, 1), (62, 1)] }, { coefficient := -2, powers := [(14, 1), (49, 1), (56, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(7, 1), (59, 1), (62, 1)] }, { coefficient := -1, powers := [(10, 1), (44, 1), (62, 1)] }, { coefficient := -1, powers := [(10, 1), (56, 1), (62, 1)] }, { coefficient := 1, powers := [(14, 1), (44, 1), (62, 1)] }, { coefficient := 1, powers := [(14, 1), (51, 1), (62, 1)] }, { coefficient := 2, powers := [(14, 1), (56, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(33, 1), (36, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(33, 1), (36, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(7, 1), (59, 1), (64, 1)] }, { coefficient := -1, powers := [(14, 1), (51, 1), (64, 1)] }, { coefficient := -1, powers := [(14, 1), (56, 1), (64, 1)] }],
  ...
  [{ coefficient := 1, powers := [(36, 1), (59, 1)] }, { coefficient := -1, powers := [(39, 1), (56, 1), (57, 1), (64, 1)] }, { coefficient := 1, powers := [(39, 1), (56, 1)] }, { coefficient := 1, powers := [(40, 1), (44, 1), (56, 1), (62, 1)] }, { coefficient := 1, powers := [(40, 1), (51, 1), (56, 1), (62, 1)] }, { coefficient := 1, powers := [(40, 1), (56, 2), (62, 1)] }, { coefficient := 1, powers := [(44, 1), (46, 1), (52, 1), (62, 1)] }, { coefficient := -1, powers := [(44, 1), (51, 1)] }, { coefficient := -1, powers := [(45, 1), (53, 1), (56, 1), (64, 1)] }, { coefficient := 1, powers := [(46, 1), (51, 1), (52, 1), (62, 1)] }, { coefficient := 1, powers := [(46, 1), (52, 1), (56, 1), (62, 1)] }],
...
#print axioms Krenn.Component39.SelectedLeafB0_3_3.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB0_3_3
