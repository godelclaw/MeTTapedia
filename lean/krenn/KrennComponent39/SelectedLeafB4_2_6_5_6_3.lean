...
namespace Krenn.Component39.SelectedLeafB4_2_6_5_6_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "9baba93c4a86854cf3bc61c8f50c63205446f9d7dd71ed4c487380649b61cc24"
def certificateSHA256 : String := "5b4bc8f29750f6fe828e0b9b93bb4dcb205c248958b338ea8af61492a990bea8"
...
def selectedEquations : Fin 17 → SparsePoly (Fin 71) := ![
  ...
  [{ coefficient := 1, powers := [(4, 1), (69, 1)] }, { coefficient := -1, powers := [] }]
]

set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def multipliers : Fin 17 → SparsePoly (Fin 71) := ![
  [{ coefficient := -1, powers := [(5, 1), (26, 1), (54, 1), (69, 1)] }, { coefficient := -1, powers := [(12, 1), (26, 1), (37, 1), (69, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (54, 1), (69, 1)] }, { coefficient := 1, powers := [(12, 1), (37, 1), (69, 1)] }],
...
#print axioms Krenn.Component39.SelectedLeafB4_2_6_5_6_3.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB4_2_6_5_6_3
