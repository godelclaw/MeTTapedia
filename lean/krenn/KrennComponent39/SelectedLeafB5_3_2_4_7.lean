...
namespace Krenn.Component39.SelectedLeafB5_3_2_4_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "d7910f50435a07cc6cce1594f582113b3aa1c5782344f3918feca555bc0a4e60"
...
def multipliers : Fin 25 → SparsePoly (Fin 70) := ![
  ...
  [{ coefficient := 1, powers := [(18, 1), (33, 1), (36, 1), (59, 1), (69, 1)] }, { coefficient := -1, powers := [(20, 1), (59, 1), (69, 1)] }, { coefficient := 1, powers := [(30, 1), (56, 1), (69, 1)] }, { coefficient := 1, powers := [(33, 1), (39, 1), (69, 1)] }],
  ...
  [{ coefficient := -1, powers := [(36, 1), (58, 1), (59, 1), (67, 1)] }, { coefficient := 1, powers := [(36, 1), (59, 1)] }, { coefficient := 1, powers := [(39, 1), (44, 1)] }, { coefficient := 1, powers := [(39, 1), (56, 1)] }, { coefficient := -1, powers := [(43, 1), (50, 1), (59, 1), (67, 1)] }, { coefficient := -1, powers := [(44, 1), (51, 1)] }, { coefficient := 1, powers := [(51, 1), (56, 1)] }],
  ...
  [{ coefficient := -1, powers := [(4, 1), (58, 1), (59, 1), (67, 1)] }, { coefficient := 1, powers := [(4, 1), (59, 1)] }, { coefficient := 1, powers := [(10, 1), (56, 1)] }, { coefficient := -1, powers := [(14, 1), (44, 1)] }],
...
#print axioms Krenn.Component39.SelectedLeafB5_3_2_4_7.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB5_3_2_4_7
