...
namespace Krenn.Component39.SelectedLeafB1_3_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "19b507144767af7a85be447b4b1d7464583aaf4912986020f888139ffbfcb2e3"
...
def multipliers : Fin 20 → SparsePoly (Fin 67) := ![
  ...
  [{ coefficient := 1, powers := [(7, 1), (49, 1), (59, 1), (63, 1)] }, { coefficient := 1, powers := [(10, 1), (44, 1), (49, 1), (63, 1)] }, { coefficient := 1, powers := [(10, 1), (49, 1), (56, 1), (63, 1)] }, { coefficient := -1, powers := [(14, 1), (44, 1), (49, 1), (63, 1)] }, { coefficient := -1, powers := [(14, 1), (49, 1), (51, 1), (63, 1)] }, { coefficient := -2, powers := [(14, 1), (49, 1), (56, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(7, 1), (59, 1), (63, 1)] }, { coefficient := -1, powers := [(10, 1), (44, 1), (63, 1)] }, { coefficient := -1, powers := [(10, 1), (56, 1), (63, 1)] }, { coefficient := 1, powers := [(14, 1), (44, 1), (63, 1)] }, { coefficient := 1, powers := [(14, 1), (51, 1), (63, 1)] }, { coefficient := 2, powers := [(14, 1), (56, 1), (63, 1)] }],
  ...
  [{ coefficient := 1, powers := [(36, 1), (59, 1)] }, { coefficient := -1, powers := [(39, 1), (56, 1), (57, 1), (66, 1)] }, { coefficient := 1, powers := [(39, 1), (56, 1)] }, { coefficient := 1, powers := [(40, 1), (44, 1), (56, 1), (63, 1)] }, { coefficient := 1, powers := [(40, 1), (51, 1), (56, 1), (63, 1)] }, { coefficient := 1, powers := [(40, 1), (56, 2), (63, 1)] }, { coefficient := 1, powers := [(44, 1), (46, 1), (52, 1), (63, 1)] }, { coefficient := -1, powers := [(44, 1), (51, 1)] }, { coefficient := -1, powers := [(45, 1), (53, 1), (56, 1), (66, 1)] }, { coefficient := 1, powers := [(46, 1), (51, 1), (52, 1), (63, 1)] }, { coefficient := 1, powers := [(46, 1), (52, 1), (56, 1), (63, 1)] }],
...
#print axioms Krenn.Component39.SelectedLeafB1_3_7.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB1_3_7
