...
namespace Krenn.Component39.SelectedLeafB4_3_2_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "cb9756ed7ec37210c327cc56774733d472f70fa73003347704b40417d1b20997"
...
def multipliers : Fin 27 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := 1, powers := [(37, 1), (60, 1)] }, { coefficient := -1, powers := [(40, 1), (45, 1), (53, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (34, 1), (40, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (39, 1), (40, 1), (62, 1)] }, { coefficient := 1, powers := [(2, 1), (40, 1)] }, { coefficient := 1, powers := [(5, 1), (31, 1)] }, { coefficient := -1, powers := [(16, 1), (27, 1), (40, 1), (62, 1)] }],
...
#print axioms Krenn.Component39.SelectedLeafB4_3_2_4.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB4_3_2_4
