...
namespace Krenn.Component39.SelectedLeafB5_0_2_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "24930ae45106449e163ab1bf96e79a608e3df31630b24a2c38344a46c6b5635a"
def certificateSHA256 : String := "d7a4154db7e467ac5e0e8c42934013b1983eaeafd33ae142a7a122d117a4d651"
...
def multipliers : Fin 22 → SparsePoly (Fin 64) := ![
  ...
  [{ coefficient := -1, powers := [(2, 1), (47, 1), (49, 1), (53, 1), (61, 1)] }, { coefficient := -1, powers := [(2, 1), (47, 1), (51, 1), (54, 1)] }, { coefficient := 1, powers := [(2, 1), (47, 1), (54, 1), (61, 1)] }, { coefficient := -1, powers := [(16, 1), (22, 1), (39, 1), (42, 1), (54, 1)] }, { coefficient := -1, powers := [(16, 1), (22, 1), (42, 1), (44, 1), (54, 1)] }, { coefficient := 1, powers := [(16, 1), (22, 1), (45, 1), (54, 1)] }, { coefficient := 2, powers := [(17, 1), (22, 1), (39, 1), (54, 1)] }],
...
#print axioms Krenn.Component39.SelectedLeafB5_0_2_0.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB5_0_2_0
