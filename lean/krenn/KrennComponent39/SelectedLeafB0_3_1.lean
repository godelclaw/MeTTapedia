...
namespace Krenn.Component39.SelectedLeafB0_3_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "f77d1ef72bd2ace0973e1e5960ac8aa7563f990091ef2e13139b8f03ecf39106"
...
def multipliers : Fin 20 → SparsePoly (Fin 64) := ![
  [{ coefficient := -1, powers := [(24, 1), (33, 1), (36, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(19, 1), (33, 1), (36, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(7, 1), (42, 1), (59, 1), (63, 1)] }, { coefficient := 1, powers := [(14, 1), (42, 1), (51, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(7, 1), (49, 1), (59, 1), (62, 1)] }, { coefficient := 1, powers := [(10, 1), (44, 1), (49, 1), (62, 1)] }, { coefficient := -1, powers := [(14, 1), (44, 1), (49, 1), (62, 1)] }, { coefficient := -1, powers := [(14, 1), (49, 1), (51, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(7, 1), (59, 1), (62, 1)] }, { coefficient := -1, powers := [(10, 1), (44, 1), (62, 1)] }, { coefficient := 1, powers := [(14, 1), (44, 1), (62, 1)] }, { coefficient := 1, powers := [(14, 1), (51, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(33, 1), (36, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(33, 1), (36, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(7, 1), (59, 1), (63, 1)] }, { coefficient := -1, powers := [(14, 1), (51, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(51, 1)] }],
  [{ coefficient := 1, powers := [(44, 1)] }],
  [{ coefficient := -1, powers := [(44, 1), (62, 1)] }, { coefficient := -1, powers := [(51, 1), (62, 1)] }],
  ...
  [{ coefficient := 1, powers := [(36, 1), (59, 1)] }, { coefficient := 1, powers := [(39, 1), (56, 1)] }, { coefficient := 1, powers := [(40, 1), (44, 1), (56, 1), (62, 1)] }, { coefficient := 1, powers := [(40, 1), (51, 1), (56, 1), (62, 1)] }, { coefficient := 1, powers := [(44, 1), (46, 1), (52, 1), (62, 1)] }, { coefficient := -1, powers := [(44, 1), (51, 1)] }, { coefficient := 1, powers := [(46, 1), (51, 1), (52, 1), (62, 1)] }],
...
#print axioms Krenn.Component39.SelectedLeafB0_3_1.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB0_3_1
