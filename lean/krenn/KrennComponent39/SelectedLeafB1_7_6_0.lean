...
namespace Krenn.Component39.SelectedLeafB1_7_6_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "dd9ae5ad720b6de7087257e57b080e3d9b192b16a867088d6b27a7d136e609fb"
...
def multipliers : Fin 7 → SparsePoly (Fin 67) := ![
  [{ coefficient := 1, powers := [(19, 1), (44, 1), (64, 1)] }, { coefficient := 1, powers := [(19, 1), (56, 1), (64, 1)] }, { coefficient := -1, powers := [(46, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(56, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(64, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (44, 2), (49, 1), (64, 1)] }, { coefficient := -1, powers := [(19, 1), (44, 1), (49, 1), (56, 1), (64, 1)] }, { coefficient := 1, powers := [(19, 1), (44, 1), (52, 1), (64, 1)] }, { coefficient := -1, powers := [(40, 1), (56, 1), (64, 1)] }, { coefficient := 1, powers := [(44, 1), (46, 1), (49, 1), (64, 1)] }, { coefficient := 1, powers := [(46, 1), (49, 1), (56, 1), (64, 1)] }, { coefficient := -1, powers := [(46, 1), (52, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := -1, powers := [(19, 1), (44, 2), (49, 1), (64, 1)] }, { coefficient := -1, powers := [(19, 1), (44, 1), (49, 1), (56, 1), (64, 1)] }, { coefficient := 1, powers := [(40, 1), (56, 1), (64, 1)] }, { coefficient := 1, powers := [(44, 1), (46, 1), (49, 1), (64, 1)] }, { coefficient := 1, powers := [(46, 1), (49, 1), (56, 1), (64, 1)] }]
]
...
#print axioms Krenn.Component39.SelectedLeafB1_7_6_0.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB1_7_6_0
