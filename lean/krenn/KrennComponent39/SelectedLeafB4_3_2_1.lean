...
namespace Krenn.Component39.SelectedLeafB4_3_2_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "69e5a68f7c9a176a6da0f0e3db8b27811148883bca219907dcfe5ad9951cd9be"
...
def multipliers : Fin 22 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := -1, powers := [(22, 1), (54, 1)] }, { coefficient := -1, powers := [(27, 1), (40, 1), (53, 1), (62, 1)] }, { coefficient := 1, powers := [(28, 1), (40, 1), (51, 1), (62, 1)] }, { coefficient := 1, powers := [(31, 1), (37, 1)] }],
...
#print axioms Krenn.Component39.SelectedLeafB4_3_2_1.selectedHasNoCommonZero

end Krenn.Component39.SelectedLeafB4_3_2_1
