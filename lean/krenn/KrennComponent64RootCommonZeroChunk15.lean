...
namespace Krenn.Component64RootCommonZero.Chunk15
...
theorem rootBlock_of_base_and_component {R : Type*} [CommRing R]
    ...
    ∀ offset : Fin 35, eval₂Hom (Int.castRingHom R) (rootValues full)
      (Krenn.Component64.Tree.rootEquations ⟨600 + offset.val, by omega⟩).toPoly = 0 := by
...
end Krenn.Component64RootCommonZero.Chunk15
