...
namespace Krenn.Component53.SelectedLeafB4_4_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "cb49ee1800ab8b6532f822d6e4c4c64bcdbca6216099482bbeca2807ece97e1b"
def certificateSHA256 : String := "a84f7e17d3a5e7addef039109eab9a24be896acc9f4497b8e00ad77bbdd36f89"
...
def multipliers : Fin 25 → SparsePoly (Fin 64) := ![
  ...
  [{ coefficient := 1, powers := [(5, 1), (34, 1), (47, 1), (53, 1), (63, 1)] }, { coefficient := -1, powers := [(5, 1), (37, 1), (54, 1), (61, 1), (63, 1)] }, { coefficient := 1, powers := [(20, 1), (25, 1), (26, 1), (52, 1), (57, 1), (61, 1), (63, 1)] }, { coefficient := -1, powers := [(21, 1), (25, 1), (27, 1), (52, 1), (61, 1), (63, 1)] }, { coefficient := 1, powers := [(21, 1), (25, 1), (54, 1), (61, 1), (63, 1)] }],
...
#print axioms Krenn.Component53.SelectedLeafB4_4_1.selectedHasNoCommonZero

end Krenn.Component53.SelectedLeafB4_4_1
