...
namespace Krenn.Component53.SelectedLeafB7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "67db4edd579335f835fc839baa6ed87767215b32a524a54f2292b869d0b45d12"
def certificateSHA256 : String := "02439bbf92230dd392159994203d9e6a01503ed1449f5713c27ad475f056873e"

set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedSourceIndices : Fin 31 → Fin 640 := ![
  2,
  4,
  5,
  8,
...
def selectedEquations : Fin 31 → SparsePoly (Fin 64) := ![
  ...
  [{ coefficient := 1, powers := [(28, 1), (43, 1), (53, 1)] }],
  [{ coefficient := 1, powers := [(28, 1), (48, 1), (53, 1)] }],
  ...
  [{ coefficient := 1, powers := [(1, 1), (40, 1), (60, 1)] }, { coefficient := 1, powers := [(1, 1), (43, 1), (57, 1)] }, { coefficient := 1, powers := [(1, 1), (48, 1), (54, 1)] }, { coefficient := 1, powers := [(12, 1), (28, 1), (48, 1), (53, 1)] }, { coefficient := 1, powers := [(18, 1), (28, 1), (43, 1), (53, 1)] }],
...
def multipliers : Fin 31 → SparsePoly (Fin 64) := ![
  ...
  [{ coefficient := -2, powers := [(8, 1), (25, 1), (59, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (28, 1), (54, 1), (62, 1)] }, { coefficient := -1, powers := [(8, 1), (28, 1), (34, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(25, 1), (46, 1), (57, 1)] }, { coefficient := -1, powers := [(25, 1), (56, 1), (57, 1)] }],
  [{ coefficient := -1, powers := [(14, 1), (25, 1), (56, 1)] }],
  [{ coefficient := 1, powers := [(21, 1), (30, 1)] }],
  [{ coefficient := 1, powers := [(20, 1), (27, 1), (43, 1)] }],
  [{ coefficient := -1, powers := [(27, 1), (43, 1), (56, 1)] }, { coefficient := 1, powers := [(43, 1), (53, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (18, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (12, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (54, 1), (62, 1)] }, { coefficient := 1, powers := [(8, 1), (34, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(20, 1), (27, 1), (43, 1), (51, 1)] }],
  [{ coefficient := 1, powers := [(25, 1), (27, 1)] }],
  [{ coefficient := -1, powers := [(25, 1), (52, 1), (57, 1)] }],
  [{ coefficient := -1, powers := [(21, 1), (27, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (34, 1), (57, 1), (63, 1)] }, { coefficient := 1, powers := [(8, 1), (37, 1), (43, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (60, 1)] }],
  [{ coefficient := 2, powers := [(8, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(54, 1)] }],
  [{ coefficient := 1, powers := [(25, 1), (26, 1), (57, 1)] }],
  [{ coefficient := 1, powers := [(21, 1)] }],
  [{ coefficient := 1, powers := [(14, 1)] }],
  [{ coefficient := 1, powers := [(25, 1), (57, 1)] }],
  [{ coefficient := -1, powers := [(37, 1), (38, 1), (43, 1)] }],
  [{ coefficient := -1, powers := [(25, 1)] }],
  [{ coefficient := 1, powers := [(27, 1), (37, 1), (38, 1), (43, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := -1, powers := [(2, 1), (40, 1), (60, 1)] }, { coefficient := -1, powers := [(2, 1), (43, 1), (57, 1)] }, { coefficient := -1, powers := [(8, 1), (34, 1), (48, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (34, 1), (38, 1), (57, 1), (59, 1)] }, { coefficient := -1, powers := [(5, 1), (34, 1), (57, 1)] }, { coefficient := -1, powers := [(8, 1), (37, 1), (38, 1), (43, 1), (59, 1)] }, { coefficient := -1, powers := [(8, 1), (37, 1), (43, 1)] }]
]
...
#print axioms Krenn.Component53.SelectedLeafB7.selectedHasNoCommonZero

end Krenn.Component53.SelectedLeafB7
