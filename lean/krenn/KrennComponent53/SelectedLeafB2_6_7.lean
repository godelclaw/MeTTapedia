...
namespace Krenn.Component53.SelectedLeafB2_6_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "52eedbbccedd5f2f1844afd9369f3f1b9f97854bc566436bc41d233139b239fb"
...
def multipliers : Fin 4 → SparsePoly (Fin 67) := ![
  ...
  [{ coefficient := 1, powers := [(27, 1), (47, 1), (51, 1), (66, 1)] }, { coefficient := -1, powers := [(42, 1), (57, 1), (66, 1)] }, { coefficient := -1, powers := [(47, 1), (53, 1), (66, 1)] }],
...
#print axioms Krenn.Component53.SelectedLeafB2_6_7.selectedHasNoCommonZero

end Krenn.Component53.SelectedLeafB2_6_7
