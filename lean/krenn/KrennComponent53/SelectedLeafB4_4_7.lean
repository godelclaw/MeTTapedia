...
namespace Krenn.Component53.SelectedLeafB4_4_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "8552a67dd1bb560935e6e1b06e9ea766c13f86abab4c431ab4ee0bbb4b77749c"
def certificateSHA256 : String := "127adb3d0a7d2c1c9af81f6d3a4449b05d1e22f56cd0966cb915b330003da222"
...
def multipliers : Fin 26 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := 1, powers := [(5, 1), (34, 1), (47, 1), (53, 1), (65, 1)] }, { coefficient := -1, powers := [(5, 1), (37, 1), (54, 1), (61, 1), (65, 1)] }, { coefficient := 1, powers := [(14, 1), (25, 1), (56, 1), (57, 1), (65, 1)] }, { coefficient := 1, powers := [(20, 1), (25, 1), (26, 1), (52, 1), (57, 1), (61, 1), (65, 1)] }, { coefficient := -1, powers := [(21, 1), (25, 1), (27, 1), (52, 1), (61, 1), (65, 1)] }, { coefficient := 1, powers := [(21, 1), (25, 1), (54, 1), (61, 1), (65, 1)] }],
  ...
  [{ coefficient := -1, powers := [(48, 1), (53, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(48, 1), (52, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(25, 1), (27, 1)] }],
  [{ coefficient := 1, powers := [(25, 1), (52, 1), (57, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(48, 1), (56, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(31, 1), (48, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(21, 1)] }],
  [{ coefficient := 1, powers := [(14, 1)] }],
  [{ coefficient := 1, powers := [(14, 1), (48, 1), (64, 1)] }],
  ...
  [{ coefficient := 1, powers := [(40, 1), (60, 1)] }, { coefficient := -1, powers := [(48, 1), (54, 1), (56, 1), (64, 1)] }, { coefficient := 1, powers := [(48, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (5, 1), (34, 1), (57, 1)] }, { coefficient := -1, powers := [(14, 1), (31, 1), (48, 1), (64, 1)] }],
...
#print axioms Krenn.Component53.SelectedLeafB4_4_7.selectedHasNoCommonZero

end Krenn.Component53.SelectedLeafB4_4_7
