...
namespace Krenn.Component53.SelectedLeafB0_2_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "f3a1c04589e3aab2103df10a1ed70dfce833256def4d1fc607db0f456396e68c"
...
def multipliers : Fin 4 → SparsePoly (Fin 63) := ![
  [{ coefficient := -1, powers := [(27, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(62, 1)] }],
  [{ coefficient := 1, powers := [(27, 1), (47, 1), (51, 1), (62, 1)] }, { coefficient := -1, powers := [(42, 1), (57, 1), (62, 1)] }, { coefficient := -1, powers := [(47, 1), (53, 1), (62, 1)] }],
...
#print axioms Krenn.Component53.SelectedLeafB0_2_1.selectedHasNoCommonZero

end Krenn.Component53.SelectedLeafB0_2_1
