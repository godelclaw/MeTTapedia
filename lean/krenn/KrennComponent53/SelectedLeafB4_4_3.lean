...
namespace Krenn.Component53.SelectedLeafB4_4_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "6a08aaadf240b85a52f1235c21b175c000373297a3764ebb4d0bc25d6d9eaa20"
...
def multipliers : Fin 26 → SparsePoly (Fin 65) := ![
  ...
  [{ coefficient := 1, powers := [(5, 1), (34, 1), (47, 1), (53, 1), (64, 1)] }, { coefficient := -1, powers := [(5, 1), (37, 1), (54, 1), (61, 1), (64, 1)] }, { coefficient := 1, powers := [(14, 1), (25, 1), (56, 1), (57, 1), (64, 1)] }, { coefficient := 1, powers := [(20, 1), (25, 1), (26, 1), (52, 1), (57, 1), (61, 1), (64, 1)] }, { coefficient := -1, powers := [(21, 1), (25, 1), (27, 1), (52, 1), (61, 1), (64, 1)] }, { coefficient := 1, powers := [(21, 1), (25, 1), (54, 1), (61, 1), (64, 1)] }],
  ...
  [{ coefficient := -1, powers := [(48, 1), (53, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(48, 1), (52, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(25, 1), (27, 1)] }],
  [{ coefficient := 1, powers := [(25, 1), (52, 1), (57, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(48, 1), (56, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(31, 1), (48, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(21, 1)] }],
  [{ coefficient := 1, powers := [(14, 1)] }],
  [{ coefficient := 1, powers := [(14, 1), (48, 1), (63, 1)] }],
  ...
  [{ coefficient := 1, powers := [(40, 1), (60, 1)] }, { coefficient := -1, powers := [(48, 1), (54, 1), (56, 1), (63, 1)] }, { coefficient := 1, powers := [(48, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (5, 1), (34, 1), (57, 1)] }, { coefficient := -1, powers := [(14, 1), (31, 1), (48, 1), (63, 1)] }],
...
#print axioms Krenn.Component53.SelectedLeafB4_4_3.selectedHasNoCommonZero

end Krenn.Component53.SelectedLeafB4_4_3
