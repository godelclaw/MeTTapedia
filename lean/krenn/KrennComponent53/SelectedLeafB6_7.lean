...
namespace Krenn.Component53.SelectedLeafB6_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "14755f1d0bae55a8136ed766ca0a59468a050ae3bcf42fa7005b5291e26e8f2a"
...
def multipliers : Fin 25 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := -2, powers := [(5, 1), (25, 1), (54, 1), (59, 1), (65, 1)] }, { coefficient := -2, powers := [(8, 1), (25, 1), (59, 1)] }],
  [{ coefficient := -2, powers := [(31, 1), (43, 1), (47, 1), (64, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(3, 1), (5, 1), (34, 1), (51, 1), (57, 1), (59, 1), (65, 1)] }, { coefficient := -1, powers := [(3, 1), (5, 1), (34, 1), (57, 1), (59, 1), (61, 1), (65, 1)] }, { coefficient := 1, powers := [(5, 1), (34, 1), (51, 1), (57, 1), (65, 1)] }, { coefficient := -1, powers := [(5, 1), (34, 1), (57, 1), (61, 1), (65, 1)] }, { coefficient := -2, powers := [(8, 1), (34, 1), (48, 1), (61, 1), (65, 1)] }, { coefficient := -2, powers := [(14, 1), (25, 1), (48, 1), (54, 1), (61, 1), (65, 2)] }, { coefficient := -2, powers := [(21, 1), (31, 1), (43, 1), (51, 1), (65, 1)] }],
  [{ coefficient := 2, powers := [(8, 1), (34, 1), (61, 1)] }, { coefficient := 2, powers := [(14, 1), (25, 1), (54, 1), (61, 1), (65, 1)] }],
  [{ coefficient := -2, powers := [(43, 1), (53, 1), (64, 1)] }],
  [{ coefficient := -2, powers := [(43, 1), (57, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (22, 1), (34, 1), (57, 1), (61, 1), (65, 1)] }],
  [{ coefficient := 2, powers := [(5, 1), (60, 1)] }],
  [{ coefficient := 2, powers := [(5, 1), (54, 1), (60, 1), (65, 1)] }, { coefficient := 2, powers := [(8, 1), (60, 1)] }],
  [{ coefficient := 2, powers := [(43, 1), (54, 1), (65, 1)] }],
  [{ coefficient := -2, powers := [(25, 1), (54, 1), (65, 1)] }],
  ...
  [{ coefficient := 1, powers := [(5, 1), (22, 1), (34, 1), (43, 1), (56, 1), (57, 1), (65, 1)] }, { coefficient := -1, powers := [(5, 1), (34, 1), (57, 1)] }, { coefficient := -2, powers := [(8, 1), (34, 1), (48, 1)] }, { coefficient := -2, powers := [(14, 1), (25, 1), (48, 1), (54, 1), (65, 1)] }],
  [{ coefficient := 2, powers := [(40, 1), (60, 1)] }, { coefficient := -2, powers := [(42, 1), (43, 1), (57, 1), (64, 1)] }, { coefficient := -2, powers := [(43, 1), (48, 1), (54, 1), (65, 1)] }, { coefficient := 2, powers := [(43, 1), (51, 1), (57, 1), (64, 1)] }, { coefficient := 2, powers := [(43, 1), (57, 1)] }, { coefficient := 2, powers := [(48, 1), (54, 1)] }],
  [{ coefficient := -2, powers := [(8, 1), (37, 1), (43, 1)] }, { coefficient := -2, powers := [(21, 1), (31, 1), (43, 1)] }],
  [{ coefficient := -1, powers := [(3, 1), (5, 1), (26, 1), (34, 1), (51, 1), (57, 1), (59, 1)] }, { coefficient := 1, powers := [(3, 1), (5, 1), (26, 1), (34, 1), (57, 1), (59, 1), (61, 1)] }, { coefficient := 1, powers := [(5, 1), (22, 1), (34, 1), (56, 1), (57, 1)] }, { coefficient := 1, powers := [(5, 1), (22, 1), (34, 1), (57, 1), (61, 1)] }, { coefficient := -1, powers := [(5, 1), (26, 1), (34, 1), (51, 1), (57, 1)] }, { coefficient := 1, powers := [(5, 1), (26, 1), (34, 1), (57, 1), (61, 1)] }, { coefficient := -2, powers := [(5, 1), (37, 1), (54, 1)] }, { coefficient := 2, powers := [(8, 1), (26, 1), (34, 1), (48, 1), (61, 1)] }, { coefficient := 2, powers := [(14, 1), (25, 1), (26, 1), (48, 1), (54, 1), (61, 1), (65, 1)] }, { coefficient := 2, powers := [(20, 1), (31, 1), (43, 1), (47, 1), (64, 1)] }, { coefficient := 2, powers := [(21, 1), (26, 1), (31, 1), (43, 1), (51, 1)] }]
]
...
#print axioms Krenn.Component53.SelectedLeafB6_7.selectedHasNoCommonZero

end Krenn.Component53.SelectedLeafB6_7
