...
namespace Krenn.Component53.SelectedLeafB6_4_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "25f98fe3c5e4b4cf4e1f2525eaa3ac071356012dfd8d28f23c342c9b9b002eae"
...
def multipliers : Fin 24 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := 1, powers := [(5, 1), (34, 1), (47, 1), (53, 1), (65, 1)] }, { coefficient := -1, powers := [(5, 1), (37, 1), (54, 1), (61, 1), (65, 1)] }, { coefficient := 1, powers := [(20, 1), (25, 1), (26, 1), (52, 1), (57, 1), (61, 1), (65, 1)] }, { coefficient := -1, powers := [(21, 1), (25, 1), (27, 1), (52, 1), (61, 1), (65, 1)] }, { coefficient := 1, powers := [(21, 1), (25, 1), (54, 1), (61, 1), (65, 1)] }],
...
#print axioms Krenn.Component53.SelectedLeafB6_4_5.selectedHasNoCommonZero

end Krenn.Component53.SelectedLeafB6_4_5
