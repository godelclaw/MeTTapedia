...
namespace Krenn.Component39RootCommonZero.Chunk15
...
theorem rootBlock_of_base_and_component {R : Type*} [CommRing R]
    ...
    ∀ offset : Fin 40, eval₂Hom (Int.castRingHom R) (rootValues full)
      (Krenn.Component39.Tree.rootEquations ⟨600 + offset.val, by omega⟩).toPoly = 0 := by
...
end Krenn.Component39RootCommonZero.Chunk15
