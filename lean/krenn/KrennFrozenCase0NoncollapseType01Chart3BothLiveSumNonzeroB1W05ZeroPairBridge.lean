...
import KrennFrozenCase0NoncollapseType01Chart3BothLiveSumNonzeroB1W05B0Certificate

/-!
Semantic reflection of the strict B1 `w_05` branch-zero certificate.

The frozen discovery leaf also set `w_05_00 = 0`, but its selected
identity never uses that branch equation.  This bridge therefore proves the
strictly stronger fact that the two equations `w_05_02 = 0` and
`w_05_22 = 0` alone refute the chart-3 B1 geometry.  In particular it
covers both the historical b0 and b4 leaves of the external `w_05` split.
-/

namespace Krenn.FrozenCase0NoncollapseType01Chart3BothLiveSumNonzeroB1W05ZeroPairBridge
...
def selectedSourceIndex : Fin 12 → Fin 747 := ![
  380, 604, 231, 605, 660, 644, 663, 349, 488, 735, 336, 746
]
...
theorem refutes_chart3_b1_w05_02_w05_22_zero
  ...
  apply Krenn.FrozenCase0NoncollapseType01Chart3BothLiveSumNonzeroB1W05B0Certificate.selectedHasNoCommonZero (leafValues values)
  intro index
  fin_cases index
  · simp [Krenn.FrozenCase0NoncollapseType01Chart3BothLiveSumNonzeroB1W05B0Certificate.selectedEquations, leafValues, selectedSourceIndex, sourceValue, Krenn.FrozenCase0System.equations, SparsePoly.toPoly, SparseTerm.toPoly, slotDeterminant, slotA1, slotB1, slotA2, slotB2, factorL, factorGa, factorGb, h23, h12, h13, h13_10, h13_12, h12_10, h12_12, h25_12, h25_21, h25_22, h34_12, h34_20, h34_21, h34_22, h05_02, h05_22] at source0 ⊢ <;> ring_nf at source0 ⊢ <;> exact source0
  · simp [Krenn.FrozenCase0NoncollapseType01Chart3BothLiveSumNonzeroB1W05B0Certificate.selectedEquations, leafValues, selectedSourceIndex, sourceValue, Krenn.FrozenCase0System.equations, SparsePoly.toPoly, SparseTerm.toPoly, slotDeterminant, slotA1, slotB1, slotA2, slotB2, factorL, factorGa, factorGb, h23, h12, h13, h13_10, h13_12, h12_10, h12_12, h25_12, h25_21, h25_22, h34_12, h34_20, h34_21, h34_22, h05_02, h05_22] at source1 ⊢ <;> ring_nf at source1 ⊢ <;> exact source1
  · simp [Krenn.FrozenCase0NoncollapseType01Chart3BothLiveSumNonzeroB1W05B0Certificate.selectedEquations, leafValues, selectedSourceIndex, sourceValue, Krenn.FrozenCase0System.equations, SparsePoly.toPoly, SparseTerm.toPoly, slotDeterminant, slotA1, slotB1, slotA2, slotB2, factorL, factorGa, factorGb, h23, h12, h13, h13_10, h13_12, h12_10, h12_12, h25_12, h25_21, h25_22, h34_12, h34_20, h34_21, h34_22, h05_02, h05_22] at source2 ⊢ <;> ring_nf at source2 ⊢ <;> exact source2
  ...
  · simp [Krenn.FrozenCase0NoncollapseType01Chart3BothLiveSumNonzeroB1W05B0Certificate.selectedEquations, leafValues, SparsePoly.toPoly, SparseTerm.toPoly,
      mul_inv_cancel₀ h24, inv_mul_cancel₀ h24]
  · simp [Krenn.FrozenCase0NoncollapseType01Chart3BothLiveSumNonzeroB1W05B0Certificate.selectedEquations, leafValues, SparsePoly.toPoly, SparseTerm.toPoly,
      mul_inv_cancel₀ h25, inv_mul_cancel₀ h25]
  · simp [Krenn.FrozenCase0NoncollapseType01Chart3BothLiveSumNonzeroB1W05B0Certificate.selectedEquations, leafValues, SparsePoly.toPoly, SparseTerm.toPoly, h12_10]
  · simp [Krenn.FrozenCase0NoncollapseType01Chart3BothLiveSumNonzeroB1W05B0Certificate.selectedEquations, leafValues, SparsePoly.toPoly, SparseTerm.toPoly, h12_12]
  · simp [Krenn.FrozenCase0NoncollapseType01Chart3BothLiveSumNonzeroB1W05B0Certificate.selectedEquations, leafValues, SparsePoly.toPoly, SparseTerm.toPoly,
      mul_inv_cancel₀ h01, inv_mul_cancel₀ h01]
  · simp [Krenn.FrozenCase0NoncollapseType01Chart3BothLiveSumNonzeroB1W05B0Certificate.selectedEquations, leafValues, SparsePoly.toPoly, SparseTerm.toPoly, h34_12]
  · simp [Krenn.FrozenCase0NoncollapseType01Chart3BothLiveSumNonzeroB1W05B0Certificate.selectedEquations, leafValues, SparsePoly.toPoly, SparseTerm.toPoly, h05_02]
  · simp [Krenn.FrozenCase0NoncollapseType01Chart3BothLiveSumNonzeroB1W05B0Certificate.selectedEquations, leafValues, SparsePoly.toPoly, SparseTerm.toPoly, h05_22]

#print axioms Krenn.FrozenCase0NoncollapseType01Chart3BothLiveSumNonzeroB1W05ZeroPairBridge.refutes_chart3_b1_w05_02_w05_22_zero

end Krenn.FrozenCase0NoncollapseType01Chart3BothLiveSumNonzeroB1W05ZeroPairBridge
