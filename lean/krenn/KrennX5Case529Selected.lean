...
namespace Krenn.X5Case529Selected

open Krenn.SparseCertificate
open MvPolynomial

def sourceSystemFileSHA256 : String := "36e9328162fe0c6380891905b0e9b709e0fff4abc023b798cf14339eca51fc4d"
def sourceSystemSemanticSHA256 : String := "b8a5bf6cb20bd2361537551f94411148d972b012549ea81a072b5da3f90fe673"
def certificateSHA256 : String := "b9a1b2883cd0be45bc82cbd6261426b0927d8ef7b3ba47d671f8414a0f3ec383"
...
def selectedEquations : Fin 20 → SparsePoly (Fin 70) := ![
  ...
  [{ coefficient := 1, powers := [(3, 1), (54, 1), (68, 1)] }, { coefficient := 1, powers := [(28, 1), (47, 1), (54, 1)] }, { coefficient := 1, powers := [(33, 1), (42, 1), (54, 1)] }],
...
def multipliers : Fin 20 → SparsePoly (Fin 70) := ![
  [{ coefficient := -1, powers := [(22, 1), (33, 1), (37, 1), (48, 1), (63, 1)] }, { coefficient := -1, powers := [(22, 1), (33, 1), (40, 1), (48, 1), (57, 1)] }, { coefficient := 1, powers := [(33, 1), (34, 1), (39, 1), (43, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [(14, 1), (33, 1), (37, 1), (48, 1), (63, 1)] }, { coefficient := -1, powers := [(14, 1), (33, 1), (40, 1), (48, 1), (57, 1)] }, { coefficient := 1, powers := [(33, 1), (34, 1), (36, 1), (43, 1), (54, 1)] }],
...
#print axioms Krenn.X5Case529Selected.selectedHasNoCommonZero

end Krenn.X5Case529Selected
