...
namespace Krenn.X5Case28Selected

open Krenn.SparseCertificate
open MvPolynomial

def sourceSystemFileSHA256 : String := "ea91bd4174ccd3084bfd3fbf0b731174cedfce4ee5f6e8280b24be4dbf6f158c"
def sourceSystemSemanticSHA256 : String := "f2bf58654bb612f2bdad2e75b73e9c8acc7d753b95995a42a11162236b394690"
def certificateSHA256 : String := "d55e179fa468c59881fbffdc845dc153f999ff23105e3a3e391b500a002d0f4c"
...
def multipliers : Fin 19 → SparsePoly (Fin 70) := ![
  [{ coefficient := -1, powers := [(0, 1), (7, 1), (21, 1), (26, 1), (49, 1), (54, 1), (67, 1)] }, { coefficient := 1, powers := [(0, 1), (64, 1)] }, { coefficient := -1, powers := [(7, 1), (21, 1), (24, 1), (26, 1), (44, 1), (49, 1), (54, 1)] }, { coefficient := -1, powers := [(7, 1), (21, 1), (26, 1), (32, 1), (41, 1), (49, 1), (54, 1)] }, { coefficient := 1, powers := [(32, 1), (38, 1)] }],
  ...
  [{ coefficient := -1, powers := [(0, 1), (7, 1), (13, 1), (26, 1), (49, 1), (54, 1), (67, 1)] }, { coefficient := 1, powers := [(0, 1), (58, 1)] }, { coefficient := -1, powers := [(7, 1), (13, 1), (24, 1), (26, 1), (44, 1), (49, 1), (54, 1)] }, { coefficient := -1, powers := [(7, 1), (13, 1), (26, 1), (32, 1), (41, 1), (49, 1), (54, 1)] }, { coefficient := 1, powers := [(32, 1), (35, 1)] }],
...
#print axioms Krenn.X5Case28Selected.selectedHasNoCommonZero

end Krenn.X5Case28Selected
