...
import KrennFrozenCase0NoncollapseType01Chart3BothLiveSumNonzeroB1W05B7Certificate

/-!
Semantic reflection of the strict B1 `w_05` B7 certificate.

Although historical branch B7 records all three W05 coordinates as live, its
selected certificate does not use the `w_05_00` inverse.  This bridge therefore
proves the stronger two-coordinate statement and simultaneously covers the
historical B3 and B7 leaves.
-/

namespace Krenn.FrozenCase0NoncollapseType01Chart3BothLiveSumNonzeroB1W05Live02Live22Bridge
...
def selectedSourceIndex : Fin 17 → Fin 747 := ![
  394, 362, 182, 32, 40, 605, 556, 645, 162,
  644, 745, 175, 354, 488, 743, 336, 746
]
...
theorem refutes_chart3_b1_w05_02_w05_22_live
  ...
  · simp [Krenn.FrozenCase0NoncollapseType01Chart3BothLiveSumNonzeroB1W05B7Certificate.selectedEquations, leafValues, selectedSourceIndex, sourceValue, Krenn.FrozenCase0System.equations, SparsePoly.toPoly, SparseTerm.toPoly, slotDeterminant, slotA1, slotB1, slotA2, slotB2, factorL, factorGa, factorGb, h23, h12, h13, h13_10, h13_12, h12_10, h12_12, h25_12, h25_21, h25_22, h34_12, h34_20, h34_21, h34_22, h05_02, h05_22] at source4 ⊢
  ...
  · simp [Krenn.FrozenCase0NoncollapseType01Chart3BothLiveSumNonzeroB1W05B7Certificate.selectedEquations, leafValues, selectedSourceIndex, sourceValue, Krenn.FrozenCase0System.equations, SparsePoly.toPoly, SparseTerm.toPoly, slotDeterminant, slotA1, slotB1, slotA2, slotB2, factorL, factorGa, factorGb, h23, h12, h13, h13_10, h13_12, h12_10, h12_12, h25_12, h25_21, h25_22, h34_12, h34_20, h34_21, h34_22, h05_02, h05_22] at source8 ⊢
  ...
  · simp [Krenn.FrozenCase0NoncollapseType01Chart3BothLiveSumNonzeroB1W05B7Certificate.selectedEquations, leafValues, selectedSourceIndex, sourceValue, Krenn.FrozenCase0System.equations, SparsePoly.toPoly, SparseTerm.toPoly, slotDeterminant, slotA1, slotB1, slotA2, slotB2, factorL, factorGa, factorGb, h23, h12, h13, h13_10, h13_12, h12_10, h12_12, h25_12, h25_21, h25_22, h34_12, h34_20, h34_21, h34_22, h05_02, h05_22] at source12 ⊢ <;> ring_nf at source12 ⊢ <;> exact source12
  · simp [Krenn.FrozenCase0NoncollapseType01Chart3BothLiveSumNonzeroB1W05B7Certificate.selectedEquations, leafValues, selectedSourceIndex, sourceValue, Krenn.FrozenCase0System.equations, SparsePoly.toPoly, SparseTerm.toPoly, slotDeterminant, slotA1, slotB1, slotA2, slotB2, factorL, factorGa, factorGb, h23, h12, h13, h13_10, h13_12, h12_10, h12_12, h25_12, h25_21, h25_22, h34_12, h34_20, h34_21, h34_22, h05_02, h05_22] at source13 ⊢ <;> ring_nf at source13 ⊢ <;> exact source13
  · simp [Krenn.FrozenCase0NoncollapseType01Chart3BothLiveSumNonzeroB1W05B7Certificate.selectedEquations, leafValues, selectedSourceIndex, sourceValue, Krenn.FrozenCase0System.equations, SparsePoly.toPoly, SparseTerm.toPoly, slotDeterminant, slotA1, slotB1, slotA2, slotB2, factorL, factorGa, factorGb, h23, h12, h13, h13_10, h13_12, h12_10, h12_12, h25_12, h25_21, h25_22, h34_12, h34_20, h34_21, h34_22, h05_02, h05_22] at source14 ⊢ <;> ring_nf at source14 ⊢ <;> exact source14
  · simp [Krenn.FrozenCase0NoncollapseType01Chart3BothLiveSumNonzeroB1W05B7Certificate.selectedEquations, leafValues, selectedSourceIndex, sourceValue, Krenn.FrozenCase0System.equations, SparsePoly.toPoly, SparseTerm.toPoly, slotDeterminant, slotA1, slotB1, slotA2, slotB2, factorL, factorGa, factorGb, h23, h12, h13, h13_10, h13_12, h12_10, h12_12, h25_12, h25_21, h25_22, h34_12, h34_20, h34_21, h34_22, h05_02, h05_22] at source15 ⊢ <;> ring_nf at source15 ⊢ <;> exact source15
  · simp [Krenn.FrozenCase0NoncollapseType01Chart3BothLiveSumNonzeroB1W05B7Certificate.selectedEquations, leafValues, selectedSourceIndex, sourceValue, Krenn.FrozenCase0System.equations, SparsePoly.toPoly, SparseTerm.toPoly, slotDeterminant, slotA1, slotB1, slotA2, slotB2, factorL, factorGa, factorGb, h23, h12, h13, h13_10, h13_12, h12_10, h12_12, h25_12, h25_21, h25_22, h34_12, h34_20, h34_21, h34_22, h05_02, h05_22] at source16 ⊢ <;> ring_nf at source16 ⊢ <;> exact source16
  · simp [Krenn.FrozenCase0NoncollapseType01Chart3BothLiveSumNonzeroB1W05B7Certificate.selectedEquations, leafValues, SparsePoly.toPoly, SparseTerm.toPoly,
      mul_inv_cancel₀ hdet, inv_mul_cancel₀ hdet]
  · simp [Krenn.FrozenCase0NoncollapseType01Chart3BothLiveSumNonzeroB1W05B7Certificate.selectedEquations, leafValues, SparsePoly.toPoly, SparseTerm.toPoly,
      mul_inv_cancel₀ h25, inv_mul_cancel₀ h25]
  · simp [Krenn.FrozenCase0NoncollapseType01Chart3BothLiveSumNonzeroB1W05B7Certificate.selectedEquations,
  ...
  · simp [Krenn.FrozenCase0NoncollapseType01Chart3BothLiveSumNonzeroB1W05B7Certificate.selectedEquations, leafValues, SparsePoly.toPoly, SparseTerm.toPoly, h12_10]
  · simp [Krenn.FrozenCase0NoncollapseType01Chart3BothLiveSumNonzeroB1W05B7Certificate.selectedEquations, leafValues, SparsePoly.toPoly, SparseTerm.toPoly, h12_12]
  · simp [Krenn.FrozenCase0NoncollapseType01Chart3BothLiveSumNonzeroB1W05B7Certificate.selectedEquations, leafValues, SparsePoly.toPoly, SparseTerm.toPoly,
      mul_inv_cancel₀ h01, inv_mul_cancel₀ h01]
  · simp [Krenn.FrozenCase0NoncollapseType01Chart3BothLiveSumNonzeroB1W05B7Certificate.selectedEquations, leafValues, SparsePoly.toPoly, SparseTerm.toPoly, h34_12]
  · simp [Krenn.FrozenCase0NoncollapseType01Chart3BothLiveSumNonzeroB1W05B7Certificate.selectedEquations, leafValues, SparsePoly.toPoly, SparseTerm.toPoly,
      mul_inv_cancel₀ h05_02, inv_mul_cancel₀ h05_02]
  · simp [Krenn.FrozenCase0NoncollapseType01Chart3BothLiveSumNonzeroB1W05B7Certificate.selectedEquations, leafValues, SparsePoly.toPoly, SparseTerm.toPoly,
      mul_inv_cancel₀ h05_22, inv_mul_cancel₀ h05_22]

#print axioms Krenn.FrozenCase0NoncollapseType01Chart3BothLiveSumNonzeroB1W05Live02Live22Bridge.refutes_chart3_b1_w05_02_w05_22_live

end Krenn.FrozenCase0NoncollapseType01Chart3BothLiveSumNonzeroB1W05Live02Live22Bridge
