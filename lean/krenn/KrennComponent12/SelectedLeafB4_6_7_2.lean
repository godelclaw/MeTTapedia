...
namespace Krenn.Component12.SelectedLeafB4_6_7_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "7b88d67623939d3f766be0c2cbb850155928f16625539eb965ee91d19fa5ace6"
def certificateSHA256 : String := "4ee4a6653494a19d465d02af9fbf53767f974d0ea3dd84298c4c55bbd8cf5a68"
...
def multipliers : Fin 25 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := -1, powers := [(5, 1), (11, 1), (20, 1), (31, 1), (54, 1), (55, 1)] }, { coefficient := 1, powers := [(8, 1), (26, 1), (46, 1), (58, 1)] }],
...
#print axioms Krenn.Component12.SelectedLeafB4_6_7_2.selectedHasNoCommonZero

end Krenn.Component12.SelectedLeafB4_6_7_2
