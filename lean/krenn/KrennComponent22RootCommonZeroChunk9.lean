...
namespace Krenn.Component22RootCommonZero.Chunk9
...
theorem rootBlock_of_base_and_component {R : Type*} [CommRing R]
    ...
    ∀ offset : Fin 40, eval₂Hom (Int.castRingHom R) (rootValues full)
      (Krenn.Component22.Tree.rootEquations ⟨360 + offset.val, by omega⟩).toPoly = 0 := by
...
end Krenn.Component22RootCommonZero.Chunk9
