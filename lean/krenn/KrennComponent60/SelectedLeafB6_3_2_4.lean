...
namespace Krenn.Component60.SelectedLeafB6_3_2_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "a3ccc87795f2cd2675f823638629852bdc989594382f9ac1fae788d8155b5143"
def certificateSHA256 : String := "b480932e116539ede73108a0338a7d2abedc0e8acf13c41bb0fd1dc5a6f620ca"
...
def multipliers : Fin 17 → SparsePoly (Fin 67) := ![
  ...
  [{ coefficient := 1, powers := [(6, 1), (38, 1), (59, 1), (60, 1)] }, { coefficient := 1, powers := [(6, 1), (47, 1), (53, 1), (60, 1)] }, { coefficient := 1, powers := [(38, 1), (60, 1)] }, { coefficient := -1, powers := [(40, 1), (41, 1), (57, 1), (63, 1)] }, { coefficient := -1, powers := [(41, 1), (46, 1), (53, 1), (63, 1)] }, { coefficient := 1, powers := [(41, 1), (57, 1)] }, { coefficient := -1, powers := [(48, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (35, 1), (41, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (32, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (6, 1), (59, 1), (60, 1)] }, { coefficient := 1, powers := [(5, 1), (60, 1)] }, { coefficient := -1, powers := [(11, 1), (19, 1), (27, 1), (47, 1), (62, 1)] }, { coefficient := -1, powers := [(12, 1), (48, 1)] }, { coefficient := -1, powers := [(18, 1), (41, 1), (46, 1), (63, 1)] }, { coefficient := -1, powers := [(19, 1), (40, 1), (41, 1), (63, 1)] }, { coefficient := -1, powers := [(19, 1), (47, 1), (50, 1)] }]
]
...
#print axioms Krenn.Component60.SelectedLeafB6_3_2_4.selectedHasNoCommonZero

end Krenn.Component60.SelectedLeafB6_3_2_4
