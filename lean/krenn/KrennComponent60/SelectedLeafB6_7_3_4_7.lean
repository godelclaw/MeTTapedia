...
namespace Krenn.Component60.SelectedLeafB6_7_3_4_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "283c6322dd223500c0935a7eacaf4d50a8c4121483ae6b4206f840819ac9e439"
def certificateSHA256 : String := "f151082a3f631324db374542af5502d33cfbdcc089c505f4740a67874646e19c"
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedEquations : Fin 17 → SparsePoly (Fin 72) := ![
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def multipliers : Fin 17 → SparsePoly (Fin 72) := ![
  [{ coefficient := -1, powers := [(20, 1), (32, 1), (56, 1), (57, 1), (69, 1)] }, { coefficient := 1, powers := [(32, 1), (57, 1), (69, 1)] }],
  ...
  [{ coefficient := -1, powers := [(20, 1), (41, 1), (56, 1), (57, 1)] }, { coefficient := -1, powers := [(20, 1), (47, 1), (52, 1), (57, 1)] }, { coefficient := 1, powers := [(38, 1), (60, 1)] }, { coefficient := -1, powers := [(39, 1), (41, 1), (57, 1), (63, 1)] }, { coefficient := 1, powers := [(41, 1), (57, 1)] }, { coefficient := -1, powers := [(48, 1), (54, 1)] }],
  ...
  [{ coefficient := 1, powers := [(5, 1), (20, 1), (32, 1), (56, 1), (57, 1)] }, { coefficient := -1, powers := [(5, 1), (32, 1), (57, 1)] }]
]
...
#print axioms Krenn.Component60.SelectedLeafB6_7_3_4_7.selectedHasNoCommonZero

end Krenn.Component60.SelectedLeafB6_7_3_4_7
