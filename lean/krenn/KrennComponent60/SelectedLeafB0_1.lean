...
namespace Krenn.Component60.SelectedLeafB0_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "0a49e0a26bff9eef657e198d4cdec8bb8f91cddb912c13a301b3a2213fbbd0d8"
...
def multipliers : Fin 7 → SparsePoly (Fin 62) := ![
  ...
  [{ coefficient := 1, powers := [(21, 1), (50, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(21, 1), (37, 1), (50, 1), (59, 1), (61, 1)] }, { coefficient := -1, powers := [(21, 1), (45, 1), (50, 1), (51, 1), (61, 1)] }, { coefficient := 1, powers := [(21, 1), (45, 1), (52, 1), (61, 1)] }, { coefficient := -1, powers := [(41, 1), (56, 1), (61, 1)] }, { coefficient := 1, powers := [(47, 1), (50, 1), (51, 1), (61, 1)] }, { coefficient := -1, powers := [(47, 1), (52, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (21, 1), (50, 1), (56, 1), (61, 1)] }, { coefficient := -1, powers := [(21, 1), (50, 1), (61, 1)] }],
...
#print axioms Krenn.Component60.SelectedLeafB0_1.selectedHasNoCommonZero

end Krenn.Component60.SelectedLeafB0_1
