...
namespace Krenn.Component60.SelectedLeafB3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "42a5b7c8277d013fcfdcca0d8de25aedd2cd4a477b3f6f4886e66ddb367864b5"
...
def multipliers : Fin 34 → SparsePoly (Fin 63) := ![
  [{ coefficient := 2, powers := [(2, 1), (26, 1), (41, 1), (43, 1), (62, 1)] }, { coefficient := 2, powers := [(5, 1), (20, 1), (35, 1), (54, 1), (62, 1)] }, { coefficient := 2, powers := [(5, 1), (26, 1), (32, 1), (43, 1), (62, 1)] }, { coefficient := 2, powers := [(8, 1), (21, 1), (35, 1), (50, 1), (62, 1)] }, { coefficient := 2, powers := [(8, 1), (25, 1), (35, 1), (47, 1), (50, 1), (62, 1)] }],
  [{ coefficient := -2, powers := [(2, 1), (26, 1), (41, 1), (62, 1)] }, { coefficient := -2, powers := [(5, 1), (26, 1), (32, 1), (62, 1)] }],
  [{ coefficient := -2, powers := [(2, 1), (20, 1), (38, 1), (60, 1), (62, 1)] }, { coefficient := 2, powers := [(2, 1), (25, 1), (48, 1), (54, 1), (62, 1)] }, { coefficient := 2, powers := [(8, 1), (25, 1), (32, 1), (48, 1), (62, 1)] }],
  [{ coefficient := -2, powers := [(12, 1), (53, 1)] }],
  [{ coefficient := -2, powers := [(19, 1), (47, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (3, 1), (53, 1), (60, 1), (62, 1)] }, { coefficient := -1, powers := [(2, 1), (20, 1), (36, 1), (53, 1), (56, 1), (60, 1), (62, 1)] }, { coefficient := -2, powers := [(2, 1), (25, 1), (36, 1), (53, 1), (56, 1), (60, 1), (62, 1)] }, { coefficient := 2, powers := [(2, 1), (26, 1), (36, 1), (56, 1), (60, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (3, 1), (47, 1), (60, 1), (62, 1)] }, { coefficient := -1, powers := [(2, 1), (20, 1), (36, 1), (47, 1), (56, 1), (60, 1), (62, 1)] }, { coefficient := 2, powers := [(2, 1), (21, 1), (36, 1), (56, 1), (60, 1), (62, 1)] }, { coefficient := 2, powers := [(2, 1), (25, 1), (36, 1), (47, 1), (56, 1), (60, 1), (62, 1)] }],
  [{ coefficient := 2, powers := [(2, 1), (24, 1), (36, 1), (53, 1), (56, 1), (60, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (3, 1), (18, 1), (60, 1), (62, 1)] }, { coefficient := -1, powers := [(2, 1), (18, 1), (20, 1), (36, 1), (56, 1), (60, 1), (62, 1)] }],
  [{ coefficient := -2, powers := [(2, 1), (20, 1), (38, 1), (56, 1), (60, 1), (62, 1)] }, { coefficient := 2, powers := [(5, 1), (29, 1), (60, 1), (62, 1)] }, { coefficient := 2, powers := [(8, 1), (24, 1), (60, 1), (62, 1)] }],
  ...
  [{ coefficient := -2, powers := [(2, 1), (29, 1), (36, 1), (56, 1), (60, 1), (62, 1)] }],
  [{ coefficient := -2, powers := [(2, 1), (24, 1), (36, 1), (56, 1), (60, 1), (62, 1)] }],
  [{ coefficient := 2, powers := [(2, 1), (3, 1), (29, 1), (60, 1), (62, 1)] }, { coefficient := -2, powers := [(2, 1), (20, 1), (29, 1), (36, 1), (56, 1), (60, 1), (62, 1)] }, { coefficient := 2, powers := [(2, 1), (25, 1), (29, 1), (36, 1), (56, 1), (60, 1), (62, 1)] }, { coefficient := -2, powers := [(29, 1), (36, 1), (60, 1)] }],
  [{ coefficient := 2, powers := [(2, 1), (3, 1), (24, 1), (60, 1), (62, 1)] }, { coefficient := -2, powers := [(24, 1), (36, 1), (60, 1)] }],
  [{ coefficient := -2, powers := [(2, 1), (3, 1), (24, 1), (26, 1), (60, 1), (62, 1)] }, { coefficient := 2, powers := [(24, 1), (26, 1), (36, 1), (60, 1)] }],
  [{ coefficient := 2, powers := [(19, 1)] }],
  [{ coefficient := -2, powers := [(2, 2), (36, 1), (56, 1), (60, 1), (62, 1)] }],
  [{ coefficient := -2, powers := [(8, 1), (21, 1), (35, 1)] }],
  [{ coefficient := -2, powers := [(2, 1), (3, 1), (18, 1), (24, 1), (60, 1), (62, 1)] }, { coefficient := -2, powers := [(2, 1), (41, 1), (43, 1)] }, { coefficient := -2, powers := [(5, 1), (32, 1), (43, 1)] }, { coefficient := 2, powers := [(18, 1), (24, 1), (36, 1), (60, 1)] }],
  [{ coefficient := -2, powers := [(2, 1), (3, 1), (18, 1), (29, 1), (60, 1), (62, 1)] }, { coefficient := 2, powers := [(2, 1), (18, 1), (20, 1), (29, 1), (36, 1), (56, 1), (60, 1), (62, 1)] }, { coefficient := -2, powers := [(2, 1), (18, 1), (25, 1), (29, 1), (36, 1), (56, 1), (60, 1), (62, 1)] }, { coefficient := 2, powers := [(18, 1), (29, 1), (36, 1), (60, 1)] }],
  ...
  [{ coefficient := -2, powers := [(2, 1), (3, 1), (60, 1), (62, 1)] }, { coefficient := 2, powers := [(2, 1), (20, 1), (36, 1), (56, 1), (60, 1), (62, 1)] }],
  [{ coefficient := 2, powers := [(2, 1), (3, 1), (18, 1), (24, 1), (26, 1), (60, 1), (62, 1)] }, { coefficient := -2, powers := [(18, 1), (24, 1), (26, 1), (36, 1), (60, 1)] }],
  [{ coefficient := -2, powers := [] }],
  [{ coefficient := 2, powers := [(2, 2), (36, 1), (38, 1), (56, 1), (59, 1), (60, 1), (62, 1)] }, { coefficient := 2, powers := [(2, 2), (36, 1), (47, 1), (53, 1), (56, 1), (60, 1), (62, 1)] }, { coefficient := -2, powers := [(2, 1), (3, 1), (18, 1), (24, 1), (26, 1), (37, 1), (59, 1), (60, 1), (62, 1)] }, { coefficient := -2, powers := [(2, 1), (3, 1), (18, 1), (24, 1), (26, 1), (40, 1), (56, 1), (60, 1), (62, 1)] }, { coefficient := -2, powers := [(2, 1), (3, 1), (18, 1), (24, 1), (26, 1), (45, 1), (51, 1), (60, 1), (62, 1)] }, { coefficient := 2, powers := [(2, 1), (3, 1), (18, 1), (24, 1), (45, 1), (53, 1), (60, 1), (62, 1)] }, { coefficient := 2, powers := [(2, 1), (3, 1), (18, 1), (29, 1), (47, 1), (51, 1), (60, 1), (62, 1)] }, { coefficient := -2, powers := [(2, 1), (18, 1), (20, 1), (29, 1), (36, 1), (47, 1), (51, 1), (56, 1), (60, 1), (62, 1)] }, { coefficient := 2, powers := [(2, 1), (18, 1), (25, 1), (29, 1), (36, 1), (47, 1), (51, 1), (56, 1), (60, 1), (62, 1)] }, { coefficient := -2, powers := [(2, 1), (38, 1), (51, 1), (60, 1)] }, { coefficient := -2, powers := [(2, 1), (40, 1), (41, 1), (57, 1)] }, { coefficient := 2, powers := [(2, 1), (41, 1), (43, 1), (45, 1), (53, 1)] }, { coefficient := -2, powers := [(2, 1), (41, 1), (46, 1), (53, 1)] }, { coefficient := -2, powers := [(5, 1), (32, 1), (40, 1), (57, 1)] }, { coefficient := 2, powers := [(5, 1), (32, 1), (43, 1), (45, 1), (53, 1)] }, { coefficient := -2, powers := [(5, 1), (32, 1), (46, 1), (53, 1)] }, { coefficient := 2, powers := [(8, 1), (21, 1), (35, 1), (45, 1), (52, 1)] }, { coefficient := -2, powers := [(8, 1), (35, 1), (41, 1), (56, 1)] }, { coefficient := 2, powers := [(8, 1), (35, 1), (45, 1), (47, 1), (50, 1)] }, { coefficient := -2, powers := [(8, 1), (35, 1), (47, 1), (52, 1)] }, { coefficient := 2, powers := [(18, 1), (24, 1), (26, 1), (36, 1), (37, 1), (59, 1), (60, 1)] }, { coefficient := 2, powers := [(18, 1), (24, 1), (26, 1), (36, 1), (40, 1), (56, 1), (60, 1)] }, { coefficient := 2, powers := [(18, 1), (24, 1), (26, 1), (36, 1), (45, 1), (51, 1), (60, 1)] }, { coefficient := -2, powers := [(18, 1), (24, 1), (36, 1), (45, 1), (53, 1), (60, 1)] }, { coefficient := -2, powers := [(18, 1), (29, 1), (36, 1), (47, 1), (51, 1), (60, 1)] }],
...
#print axioms Krenn.Component60.SelectedLeafB3.selectedHasNoCommonZero

end Krenn.Component60.SelectedLeafB3
