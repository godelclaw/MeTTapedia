...
namespace Krenn.Component60.SelectedLeafB4_2_1_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "b8022472e8b63cf97857b30076179dabf5c161b864e6543b6b8f984c6ea90855"
...
def multipliers : Fin 31 → SparsePoly (Fin 65) := ![
  ...
  [{ coefficient := 1, powers := [(5, 1), (26, 1), (35, 1), (51, 1), (64, 1)] }, { coefficient := -1, powers := [(5, 1), (29, 1), (43, 1), (59, 1), (64, 1)] }, { coefficient := 1, powers := [(5, 1), (43, 1), (59, 1)] }, { coefficient := 1, powers := [(8, 1), (20, 2), (24, 1), (46, 1), (59, 1), (61, 1), (64, 1)] }, { coefficient := -1, powers := [(8, 1), (20, 1), (24, 1), (43, 1), (59, 1), (61, 1), (64, 1)] }, { coefficient := -1, powers := [(19, 1), (47, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (8, 1), (20, 1), (24, 1), (60, 1), (61, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (32, 1), (57, 1), (64, 1)] }],
  ...
  [{ coefficient := -1, powers := [(5, 1), (29, 1), (32, 1), (57, 1), (64, 1)] }, { coefficient := 1, powers := [(5, 1), (32, 1), (57, 1)] }, { coefficient := 1, powers := [(5, 1), (35, 1), (54, 1)] }],
  ...
  [{ coefficient := 1, powers := [(5, 1), (20, 1), (29, 1), (32, 1), (57, 1), (64, 1)] }, { coefficient := -1, powers := [(5, 1), (20, 1), (32, 1), (57, 1)] }, { coefficient := -1, powers := [(5, 1), (20, 1), (35, 1), (54, 1)] }],
...
#print axioms Krenn.Component60.SelectedLeafB4_2_1_1.selectedHasNoCommonZero

end Krenn.Component60.SelectedLeafB4_2_1_1
