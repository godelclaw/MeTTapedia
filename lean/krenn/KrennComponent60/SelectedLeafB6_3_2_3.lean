...
namespace Krenn.Component60.SelectedLeafB6_3_2_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "49e91af0a3cf5eaf981cb428b755019fdb58d856c88147e3b25271371923e814"
...
def multipliers : Fin 21 → SparsePoly (Fin 68) := ![
  ...
  [{ coefficient := -2, powers := [(24, 1), (54, 1)] }, { coefficient := 1, powers := [(29, 1), (41, 1), (51, 1), (63, 1)] }, { coefficient := -1, powers := [(29, 1), (41, 1)] }],
  ...
  [{ coefficient := -2, powers := [(12, 1), (29, 1), (48, 1), (51, 1)] }, { coefficient := 1, powers := [(18, 1), (24, 1), (46, 1), (54, 1)] }, { coefficient := -1, powers := [(18, 1), (29, 1), (41, 1), (46, 1), (51, 1), (63, 1)] }, { coefficient := 1, powers := [(18, 1), (29, 1), (41, 1), (46, 1)] }, { coefficient := 1, powers := [(18, 1), (29, 1), (48, 1), (52, 1)] }, { coefficient := 2, powers := [(19, 1), (24, 1), (40, 1), (54, 1)] }, { coefficient := -1, powers := [(19, 1), (29, 1), (40, 1), (41, 1), (51, 1), (63, 1)] }, { coefficient := 1, powers := [(19, 1), (29, 1), (40, 1), (41, 1)] }]
]
...
#print axioms Krenn.Component60.SelectedLeafB6_3_2_3.selectedHasNoCommonZero

end Krenn.Component60.SelectedLeafB6_3_2_3
