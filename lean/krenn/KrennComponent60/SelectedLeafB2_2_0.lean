...
namespace Krenn.Component60.SelectedLeafB2_2_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "0640e246b0ec205050af0b6a45824d64975e59542a82925ee5bd1f6843e996ea"
def certificateSHA256 : String := "c03b14d6fa93f4e705758c6c5610953d0f0b35135bbd26cb7fd33692f9ad5426"
...
def multipliers : Fin 29 → SparsePoly (Fin 63) := ![
  ...
  [{ coefficient := -1, powers := [(3, 1), (18, 1), (29, 1), (60, 1)] }, { coefficient := 1, powers := [(12, 1), (29, 1), (43, 1)] }],
  [{ coefficient := 1, powers := [(12, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (24, 1), (60, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (29, 1)] }],
  [{ coefficient := -1, powers := [(3, 1), (60, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := 1, powers := [(3, 1), (18, 1), (29, 1), (47, 1), (51, 1), (60, 1)] }, { coefficient := -1, powers := [(8, 1), (24, 1), (51, 1), (60, 1)] }, { coefficient := -1, powers := [(12, 1), (29, 1), (43, 1), (47, 1), (51, 1)] }, { coefficient := 1, powers := [(12, 1), (29, 1), (48, 1), (51, 1)] }],
  ...
  [{ coefficient := 1, powers := [(0, 1), (19, 1), (29, 1), (56, 1)] }, { coefficient := 1, powers := [(2, 1), (57, 1)] }, { coefficient := 1, powers := [(8, 1), (35, 1)] }],
  [{ coefficient := 1, powers := [(12, 1), (20, 1), (29, 1), (48, 1)] }, { coefficient := -1, powers := [(12, 1), (21, 1), (29, 1), (43, 1)] }, { coefficient := 1, powers := [(12, 1), (25, 1), (29, 1), (48, 1)] }, { coefficient := -1, powers := [(19, 1), (20, 1), (29, 1), (47, 1), (50, 1)] }, { coefficient := 1, powers := [(19, 1), (21, 1), (29, 1), (50, 1)] }, { coefficient := 1, powers := [(19, 1), (24, 1), (25, 1), (54, 1)] }],
...
#print axioms Krenn.Component60.SelectedLeafB2_2_0.selectedHasNoCommonZero

end Krenn.Component60.SelectedLeafB2_2_0
