...
namespace Krenn.Component60.SelectedLeafB4_3_7_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "1ae5c476f328f724a08afe7c3482c73d525bd1ff7c70ddd43ba56fde19823a46"
def certificateSHA256 : String := "3c99ed089641f3b0b35393c801d694670da374e409bd58213161e26615bfe82c"
...
def multipliers : Fin 25 → SparsePoly (Fin 68) := ![
  ...
  [{ coefficient := 1, powers := [(0, 1), (8, 1), (60, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(52, 1), (57, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (8, 1), (51, 1), (60, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (20, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(3, 1), (18, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(54, 1)] }],
  [{ coefficient := 1, powers := [(48, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (57, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (50, 1), (55, 1), (57, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (54, 1)] }],
  [{ coefficient := 1, powers := [(19, 1)] }],
  [{ coefficient := 1, powers := [(24, 1), (50, 1), (57, 1), (64, 1)] }],
  ...
  [{ coefficient := 1, powers := [(3, 1), (38, 1), (59, 1), (60, 1)] }, { coefficient := 1, powers := [(3, 1), (47, 1), (53, 1), (60, 1)] }, { coefficient := 1, powers := [(38, 1), (60, 1)] }, { coefficient := -1, powers := [(40, 1), (41, 1), (57, 1), (62, 1)] }, { coefficient := -1, powers := [(41, 1), (46, 1), (53, 1), (62, 1)] }, { coefficient := -1, powers := [(41, 1), (56, 1), (57, 1), (65, 1)] }, { coefficient := 1, powers := [(41, 1), (57, 1)] }, { coefficient := -1, powers := [(48, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (35, 1), (41, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (8, 1), (24, 1), (51, 1), (60, 1)] }, { coefficient := 1, powers := [(12, 1), (24, 1), (57, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (32, 1), (57, 1)] }, { coefficient := -1, powers := [(12, 1), (24, 1), (57, 1)] }],
  [{ coefficient := 1, powers := [(12, 1), (24, 1), (44, 1), (57, 1), (64, 1)] }, { coefficient := -1, powers := [(17, 1), (24, 1), (40, 1), (50, 1), (57, 1), (64, 1)] }, { coefficient := 1, powers := [(18, 1), (24, 1), (40, 1), (50, 1), (55, 1), (57, 1), (64, 1)] }, { coefficient := -1, powers := [(18, 1), (24, 1), (44, 1), (50, 1), (57, 1), (64, 1)] }, { coefficient := 1, powers := [(18, 1), (24, 1), (45, 1), (50, 1), (55, 1), (57, 1), (64, 1)] }, { coefficient := 1, powers := [(18, 1), (24, 1), (46, 1), (54, 1)] }, { coefficient := 1, powers := [(19, 1), (24, 1), (40, 1), (54, 1)] }],
  [{ coefficient := 1, powers := [(3, 1), (5, 1), (59, 1), (60, 1)] }, { coefficient := 1, powers := [(5, 1), (60, 1)] }, { coefficient := -1, powers := [(12, 1), (48, 1)] }, { coefficient := -1, powers := [(18, 1), (41, 1), (46, 1), (62, 1)] }, { coefficient := -1, powers := [(19, 1), (40, 1), (41, 1), (62, 1)] }, { coefficient := -1, powers := [(19, 1), (47, 1), (50, 1)] }]
]
...
#print axioms Krenn.Component60.SelectedLeafB4_3_7_2.selectedHasNoCommonZero

end Krenn.Component60.SelectedLeafB4_3_7_2
