...
namespace Krenn.Component60.SelectedLeafB6_3_7_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "7c494289dd751670d21e623c762c926db02e34eec769b47e809c407c53bb3d87"
...
def multipliers : Fin 25 → SparsePoly (Fin 69) := ![
  ...
  [{ coefficient := 2, powers := [(24, 1), (26, 1), (43, 1), (45, 1), (68, 1)] }, { coefficient := -2, powers := [(24, 1), (57, 1), (68, 1)] }],
  [{ coefficient := -2, powers := [(24, 1), (43, 1), (45, 1)] }, { coefficient := -1, powers := [(24, 1), (46, 1)] }],
  [{ coefficient := -2, powers := [(24, 1), (26, 1), (43, 1), (45, 1), (50, 1), (61, 1)] }, { coefficient := -2, powers := [(24, 1), (26, 1), (43, 1), (45, 1), (50, 1), (68, 1)] }, { coefficient := 2, powers := [(24, 1), (43, 1), (45, 1), (54, 1)] }, { coefficient := -1, powers := [(24, 1), (43, 1), (54, 1), (61, 1)] }, { coefficient := 1, powers := [(24, 1), (50, 1), (57, 1), (61, 1)] }, { coefficient := 2, powers := [(24, 1), (50, 1), (57, 1), (68, 1)] }],
...
#print axioms Krenn.Component60.SelectedLeafB6_3_7_4.selectedHasNoCommonZero

end Krenn.Component60.SelectedLeafB6_3_7_4
