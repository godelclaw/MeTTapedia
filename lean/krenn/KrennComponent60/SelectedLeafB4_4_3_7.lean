...
namespace Krenn.Component60.SelectedLeafB4_4_3_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "8209bf0736cb924e3aa5aa2cca64510cfcd5455503c74acc76ecf2c6bf1ad75a"
...
def multipliers : Fin 21 → SparsePoly (Fin 68) := ![
  ...
  [{ coefficient := -1, powers := [(12, 1), (20, 1), (24, 1), (56, 1), (57, 1), (63, 1), (67, 1)] }, { coefficient := -2, powers := [(12, 1), (20, 1), (29, 1), (48, 1), (56, 1), (63, 1), (67, 1)] }, { coefficient := 1, powers := [(12, 1), (24, 1), (57, 1), (63, 1), (67, 1)] }],
  ...
  [{ coefficient := 1, powers := [(12, 1), (20, 1), (24, 1), (29, 1), (56, 1), (57, 1), (63, 1), (67, 1)] }, { coefficient := 2, powers := [(12, 1), (20, 1), (29, 2), (48, 1), (56, 1), (63, 1), (67, 1)] }, { coefficient := -1, powers := [(12, 1), (24, 1), (29, 1), (57, 1), (63, 1), (67, 1)] }],
...
#print axioms Krenn.Component60.SelectedLeafB4_4_3_7.selectedHasNoCommonZero

end Krenn.Component60.SelectedLeafB4_4_3_7
