...
namespace Krenn.Component60.SelectedLeafB6_7_3_6_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "780241f6fa71633bbbca49f6a9658ac3762aa4a065177f690fe128f3d8e0d809"
def certificateSHA256 : String := "26196338ccb903dd5c5f0f00ac4a1c16b066b01cf9cfefc56e92fd0abe8b5ddf"

set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedSourceIndices : Fin 8 → Fin 671 := ![
  72,
  152,
  211,
  582,
...
def multipliers : Fin 8 → SparsePoly (Fin 72) := ![
  [{ coefficient := 1, powers := [(26, 1), (63, 1), (67, 1), (69, 1)] }],
  [{ coefficient := 1, powers := [(26, 1), (56, 1), (63, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(63, 1), (67, 1)] }],
  [{ coefficient := 1, powers := [(63, 1)] }],
  [{ coefficient := -1, powers := [(56, 1), (63, 1), (67, 1)] }],
  ...
  [{ coefficient := -1, powers := [(9, 1), (26, 1), (46, 1), (63, 1), (67, 1)] }]
]
...
#print axioms Krenn.Component60.SelectedLeafB6_7_3_6_3.selectedHasNoCommonZero

end Krenn.Component60.SelectedLeafB6_7_3_6_3
