...
namespace Krenn.Component60.SelectedLeafB4_4_3_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "3bae91471238fae164d80307918a30bc09e8dbf9376ccc4173413854891ff0cd"
def certificateSHA256 : String := "22892dc87b9f567fe8a536bf4e5cf9b028bd35a55ce81a1d450b49732524bd99"
...
def multipliers : Fin 41 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := -1, powers := [(23, 1), (51, 1), (62, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(4, 1), (31, 1), (46, 1), (62, 1), (64, 1)] }, { coefficient := -1, powers := [(4, 1), (34, 1), (46, 1), (62, 1), (64, 1)] }, { coefficient := 1, powers := [(7, 1), (31, 1), (46, 1), (62, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(23, 1), (46, 1), (51, 1), (62, 1), (64, 1)] }, { coefficient := -2, powers := [(23, 1), (46, 1), (56, 1), (62, 1), (64, 1)] }, { coefficient := -1, powers := [(23, 1), (46, 1), (62, 1), (64, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(23, 1), (45, 1), (62, 1)] }, { coefficient := -1, powers := [(27, 1), (37, 1), (59, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(15, 1), (23, 1), (43, 1), (45, 1), (56, 1), (62, 1), (64, 1)] }, { coefficient := -1, powers := [(15, 1), (23, 1), (46, 1), (51, 1), (62, 1), (64, 1)] }, { coefficient := 2, powers := [(15, 1), (23, 1), (46, 1), (56, 1), (62, 1), (64, 1)] }, { coefficient := 1, powers := [(15, 1), (23, 1), (46, 1), (62, 1), (64, 1), (65, 1)] }, { coefficient := 1, powers := [(43, 1), (56, 1), (62, 1), (64, 1)] }],
  ...
  [{ coefficient := 1, powers := [(4, 1), (31, 1), (45, 1), (62, 1), (64, 1)] }, { coefficient := 1, powers := [(4, 1), (34, 1), (45, 1), (62, 1), (64, 1)] }, { coefficient := -1, powers := [(7, 1), (31, 1), (45, 1), (62, 1), (64, 1)] }, { coefficient := 1, powers := [(15, 1), (23, 1), (51, 1), (62, 1), (64, 1)] }, { coefficient := -2, powers := [(15, 1), (23, 1), (56, 1), (62, 1), (64, 1)] }, { coefficient := -1, powers := [(15, 1), (23, 1), (62, 1), (64, 1), (65, 1)] }],
  ...
  [{ coefficient := 1, powers := [(9, 1), (23, 1), (62, 1), (65, 1)] }, { coefficient := -1, powers := [(23, 1), (49, 1), (62, 1), (65, 1)] }],
  ...
  [{ coefficient := -1, powers := [(9, 1), (23, 1), (25, 1), (62, 1), (65, 1)] }, { coefficient := -1, powers := [(9, 1), (27, 1), (56, 1), (62, 1)] }, { coefficient := 1, powers := [(23, 1), (25, 1), (49, 1), (62, 1), (65, 1)] }],
  ...
  [{ coefficient := -1, powers := [(1, 1), (9, 1), (56, 1), (62, 1)] }, { coefficient := -1, powers := [(7, 1), (9, 1), (34, 1), (62, 1)] }, { coefficient := 1, powers := [(9, 1), (16, 1), (23, 1), (25, 1), (53, 1), (56, 1), (62, 1), (64, 1)] }, { coefficient := -1, powers := [(9, 1), (16, 1), (23, 1), (26, 1), (56, 1), (62, 1), (64, 1)] }, { coefficient := 1, powers := [(9, 1), (16, 1), (25, 1), (27, 1), (53, 1), (56, 2), (62, 1), (64, 1)] }, { coefficient := -1, powers := [(9, 1), (16, 1), (26, 1), (27, 1), (56, 2), (62, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (4, 1), (9, 1), (34, 1), (51, 1), (57, 1), (62, 1)] }, { coefficient := -1, powers := [(4, 1), (8, 1), (9, 1), (34, 1), (35, 1), (51, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (15, 1), (23, 1), (39, 1), (45, 1), (56, 1), (62, 1)] }, { coefficient := 1, powers := [(0, 1), (39, 1), (56, 1), (62, 1)] }, { coefficient := -1, powers := [(3, 1), (15, 1), (23, 1), (30, 1), (45, 1), (56, 1), (62, 1)] }, { coefficient := 1, powers := [(3, 1), (30, 1), (56, 1), (62, 1)] }, { coefficient := -1, powers := [(4, 1), (9, 1), (31, 1), (45, 1), (62, 1)] }, { coefficient := -1, powers := [(4, 1), (9, 1), (34, 1), (45, 1), (62, 1)] }, { coefficient := 1, powers := [(4, 1), (23, 1), (30, 1), (51, 1), (62, 1)] }, { coefficient := 1, powers := [(7, 1), (9, 1), (31, 1), (45, 1), (62, 1)] }, { coefficient := -1, powers := [(9, 1), (10, 1), (23, 1), (56, 1), (62, 1)] }, { coefficient := -1, powers := [(9, 1), (10, 1), (27, 1), (56, 2), (62, 1)] }, { coefficient := -1, powers := [(9, 1), (15, 1), (20, 1), (23, 1), (45, 1), (56, 1), (62, 1)] }, { coefficient := -1, powers := [(9, 1), (15, 1), (23, 1), (51, 1), (62, 1)] }, { coefficient := 2, powers := [(9, 1), (15, 1), (23, 1), (56, 1), (62, 1)] }, { coefficient := 1, powers := [(9, 1), (15, 1), (23, 1), (62, 1), (65, 1)] }, { coefficient := 1, powers := [(9, 1), (20, 1), (56, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(7, 1), (9, 1), (23, 1), (59, 1), (62, 1)] }, { coefficient := -1, powers := [(7, 1), (23, 1), (49, 1), (59, 1), (62, 1)] }, { coefficient := 1, powers := [(9, 1), (10, 1), (23, 1), (56, 1), (62, 1)] }, { coefficient := 1, powers := [(9, 1), (15, 1), (23, 1), (51, 1), (62, 1)] }, { coefficient := -1, powers := [(15, 1), (23, 1), (49, 1), (51, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(4, 1), (9, 1), (59, 1), (62, 1)] }, { coefficient := -1, powers := [(4, 1), (30, 1), (40, 1), (62, 1)] }, { coefficient := -1, powers := [(4, 1), (30, 1), (45, 1), (62, 1)] }],
...
#print axioms Krenn.Component60.SelectedLeafB4_4_3_4.selectedHasNoCommonZero

end Krenn.Component60.SelectedLeafB4_4_3_4
