...
namespace Krenn.Component60.SelectedLeafB6_7_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "6eecb1c90d9f9f13b23f1f9837dd09352a53e31ea3ef6b9e30eada7cae7a7545"
def certificateSHA256 : String := "bda71a3075ff30b82db63213bbe2f062b2dfb4f1916a994e2b97e545b9e9ac8c"
...
def multipliers : Fin 21 → SparsePoly (Fin 66) := ![
  [{ coefficient := -2, powers := [(25, 1), (29, 1), (48, 1), (52, 1), (63, 1)] }],
  ...
  [{ coefficient := 1, powers := [(38, 1), (60, 1)] }, { coefficient := -1, powers := [(40, 1), (41, 1), (57, 1), (64, 1)] }, { coefficient := -1, powers := [(41, 1), (46, 1), (53, 1), (64, 1)] }, { coefficient := 1, powers := [(41, 1), (57, 1)] }, { coefficient := -1, powers := [(48, 1), (54, 1)] }],
  [{ coefficient := 2, powers := [(18, 1), (25, 1), (29, 1), (48, 1), (52, 1)] }, { coefficient := 1, powers := [(19, 1), (21, 1), (29, 1), (52, 1)] }, { coefficient := -1, powers := [(19, 1), (24, 1), (26, 1), (52, 1)] }, { coefficient := 2, powers := [(19, 1), (24, 1), (54, 1)] }, { coefficient := -1, powers := [(19, 1), (29, 1), (41, 1), (51, 1), (64, 1)] }, { coefficient := 1, powers := [(19, 1), (29, 1), (41, 1)] }],
...
#print axioms Krenn.Component60.SelectedLeafB6_7_0.selectedHasNoCommonZero

end Krenn.Component60.SelectedLeafB6_7_0
