...
namespace Krenn.Component60.SelectedLeafB4_1_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "5fc49d562808d2dc6c6acd388643832dd5238380a4c3f88d79cd9ec6bea48ce3"
...
def multipliers : Fin 11 → SparsePoly (Fin 65) := ![
  [{ coefficient := -1, powers := [(21, 1), (46, 1), (53, 1), (62, 1), (64, 1)] }, { coefficient := 1, powers := [(26, 1), (46, 1), (47, 1), (62, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(21, 1), (46, 1), (62, 1), (64, 1)] }, { coefficient := -1, powers := [(25, 1), (46, 1), (47, 1), (62, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(53, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(46, 1), (50, 1), (53, 1), (62, 1), (64, 1)] }, { coefficient := 1, powers := [(46, 1), (54, 1), (62, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(26, 1), (45, 1), (46, 1), (62, 1), (64, 1)] }, { coefficient := 1, powers := [(46, 1), (53, 1), (62, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(25, 1), (45, 1), (46, 1), (62, 1), (64, 1)] }, { coefficient := -1, powers := [(46, 1), (62, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(21, 1), (46, 1), (50, 1), (53, 1), (62, 1), (64, 1)] }, { coefficient := -1, powers := [(21, 1), (46, 1), (54, 1), (62, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(64, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (57, 1), (64, 1)] }, { coefficient := -1, powers := [(21, 1), (25, 1), (46, 1), (50, 1), (53, 1), (62, 1), (64, 1)] }, { coefficient := 1, powers := [(21, 1), (25, 1), (46, 1), (54, 1), (62, 1), (64, 1)] }, { coefficient := 1, powers := [(25, 1), (43, 1), (53, 1), (64, 1)] }, { coefficient := -1, powers := [(26, 1), (43, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(25, 1), (46, 1), (53, 1), (64, 1)] }, { coefficient := 1, powers := [(26, 1), (46, 1), (64, 1)] }],
...
#print axioms Krenn.Component60.SelectedLeafB4_1_3.selectedHasNoCommonZero

end Krenn.Component60.SelectedLeafB4_1_3
