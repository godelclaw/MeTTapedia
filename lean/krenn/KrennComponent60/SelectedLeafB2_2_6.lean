...
namespace Krenn.Component60.SelectedLeafB2_2_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "eb53b938b8ff9a1d245fa2031ad7cd6577de97e74ec2c2bda65a223dc59f9100"
def certificateSHA256 : String := "bba533518d8fbcf90d911c1a7a0ba5dd3e773d7dbf46102f4d26312c11b4ab67"
...
def multipliers : Fin 32 → SparsePoly (Fin 65) := ![
  ...
  [{ coefficient := -2, powers := [(19, 1), (54, 1), (63, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(21, 1), (43, 1), (52, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (46, 1)] }],
  [{ coefficient := 2, powers := [(19, 1), (51, 1), (54, 1), (63, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(24, 1), (54, 1)] }],
  [{ coefficient := -2, powers := [(19, 1), (54, 1), (64, 1)] }],
  [{ coefficient := 2, powers := [(12, 1), (16, 1), (22, 1), (61, 1)] }, { coefficient := 1, powers := [(19, 1), (50, 1)] }],
  ...
  [{ coefficient := -2, powers := [(19, 1), (24, 1), (51, 1), (54, 1), (64, 1)] }],
...
#print axioms Krenn.Component60.SelectedLeafB2_2_6.selectedHasNoCommonZero

end Krenn.Component60.SelectedLeafB2_2_6
