...
namespace Krenn.Component60.SelectedLeafB4_3_2_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "f3ff90dc6c23de9a830fbdb609b8f0831bed303181b136c09a73343b4bfe528e"
def certificateSHA256 : String := "49d3d780c30041878ad59e5c21fd6b353abec86f9a73d94b7b531ff23a920c1d"
...
def multipliers : Fin 21 → SparsePoly (Fin 67) := ![
  ...
  [{ coefficient := -2, powers := [(12, 1), (29, 1), (48, 1), (51, 1)] }, { coefficient := 1, powers := [(18, 1), (24, 1), (46, 1), (54, 1)] }, { coefficient := -1, powers := [(18, 1), (29, 1), (41, 1), (46, 1), (51, 1), (62, 1)] }, { coefficient := 1, powers := [(18, 1), (29, 1), (41, 1), (46, 1)] }, { coefficient := 1, powers := [(18, 1), (29, 1), (48, 1), (52, 1)] }, { coefficient := 2, powers := [(19, 1), (24, 1), (40, 1), (54, 1)] }, { coefficient := -1, powers := [(19, 1), (29, 1), (40, 1), (41, 1), (51, 1), (62, 1)] }, { coefficient := 1, powers := [(19, 1), (29, 1), (40, 1), (41, 1)] }]
]
...
#print axioms Krenn.Component60.SelectedLeafB4_3_2_3.selectedHasNoCommonZero

end Krenn.Component60.SelectedLeafB4_3_2_3
