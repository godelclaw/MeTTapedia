...
namespace Krenn.Component60.SelectedLeafB6_5_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "4794ccd9efeb6db1337773ef1937f53d31f5fceb526a67663256f3043737ab64"
def certificateSHA256 : String := "6c1a31d6a6e9ef8243d56fbeb0668a699eae35a2b9d3d95a188cc81d79da981f"
...
def multipliers : Fin 24 → SparsePoly (Fin 68) := ![
  ...
  [{ coefficient := 1, powers := [(12, 1), (20, 1), (57, 1), (65, 1)] }, { coefficient := -1, powers := [(12, 1), (57, 1), (65, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(20, 1), (52, 1), (57, 1)] }, { coefficient := -1, powers := [(52, 1), (57, 1), (66, 1)] }],
  [{ coefficient := -2, powers := [(12, 1), (48, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (26, 1)] }],
  [{ coefficient := -1, powers := [(12, 1), (20, 1), (51, 1), (57, 1), (65, 1)] }, { coefficient := 1, powers := [(12, 1), (51, 1), (57, 1), (65, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(12, 1), (20, 1), (57, 1)] }, { coefficient := -1, powers := [(12, 1), (57, 1), (66, 1)] }],
  ...
  [{ coefficient := -1, powers := [(20, 1), (47, 1), (52, 1), (57, 1)] }, { coefficient := 1, powers := [(38, 1), (60, 1)] }, { coefficient := -1, powers := [(39, 1), (41, 1), (57, 1), (63, 1)] }, { coefficient := -1, powers := [(41, 1), (56, 1), (57, 1), (66, 1)] }, { coefficient := 1, powers := [(41, 1), (57, 1)] }, { coefficient := -1, powers := [(48, 1), (54, 1)] }],
  ...
  [{ coefficient := 1, powers := [(12, 1), (20, 1), (24, 1), (51, 1), (57, 1)] }, { coefficient := -1, powers := [(12, 1), (24, 1), (51, 1), (57, 1), (66, 1)] }],
...
#print axioms Krenn.Component60.SelectedLeafB6_5_7.selectedHasNoCommonZero

end Krenn.Component60.SelectedLeafB6_5_7
