...
namespace Krenn.Component60.SelectedLeafB6_3_7_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "3a526332a340432489797f462d2907231748fa56ff5c1c83e0f7c2599a76ae87"
...
def multipliers : Fin 30 → SparsePoly (Fin 69) := ![
  ...
  [{ coefficient := 1, powers := [(17, 1), (24, 1), (57, 1), (65, 1), (68, 1)] }, { coefficient := -1, powers := [(19, 1), (47, 1)] }],
  [{ coefficient := -1, powers := [(52, 1), (57, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (8, 1), (24, 1), (60, 1), (68, 1)] }],
  ...
  [{ coefficient := -1, powers := [(24, 1), (54, 1)] }, { coefficient := 1, powers := [(29, 1), (41, 1), (51, 1), (63, 1)] }, { coefficient := -1, powers := [(29, 1), (41, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (24, 1), (26, 1), (51, 1), (60, 1), (67, 1)] }, { coefficient := -1, powers := [(8, 1), (24, 1), (53, 1), (60, 1), (67, 1)] }],
  [{ coefficient := 1, powers := [(29, 1)] }],
  [{ coefficient := 1, powers := [(19, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (24, 1), (26, 1), (60, 1), (67, 1)] }],
  [{ coefficient := 1, powers := [(12, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (24, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(41, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(57, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (24, 1), (60, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := 1, powers := [(38, 1), (60, 1)] }, { coefficient := -1, powers := [(40, 1), (41, 1), (57, 1), (63, 1)] }, { coefficient := -1, powers := [(41, 1), (46, 1), (53, 1), (63, 1)] }, { coefficient := -1, powers := [(41, 1), (56, 1), (57, 1), (66, 1)] }, { coefficient := 1, powers := [(41, 1), (57, 1)] }, { coefficient := -1, powers := [(48, 1), (54, 1)] }],
  ...
  [{ coefficient := -1, powers := [(8, 1), (24, 1), (26, 1), (40, 1), (43, 1), (51, 1), (60, 1), (67, 1)] }, { coefficient := -1, powers := [(8, 1), (24, 1), (26, 1), (46, 1), (51, 1), (60, 1), (67, 1)] }, { coefficient := 1, powers := [(8, 1), (24, 1), (40, 1), (43, 1), (53, 1), (60, 1), (67, 1)] }, { coefficient := -1, powers := [(8, 1), (24, 1), (40, 1), (60, 1)] }, { coefficient := -1, powers := [(8, 1), (24, 1), (45, 1), (60, 1)] }, { coefficient := 1, powers := [(8, 1), (24, 1), (46, 1), (53, 1), (60, 1), (67, 1)] }, { coefficient := 1, powers := [(12, 1), (24, 1), (44, 1), (57, 1), (65, 1)] }, { coefficient := -2, powers := [(12, 1), (29, 1), (48, 1), (51, 1)] }, { coefficient := 1, powers := [(18, 1), (24, 1), (46, 1), (54, 1)] }, { coefficient := -1, powers := [(18, 1), (29, 1), (41, 1), (46, 1), (51, 1), (63, 1)] }, { coefficient := 1, powers := [(18, 1), (29, 1), (41, 1), (46, 1)] }, { coefficient := 1, powers := [(18, 1), (29, 1), (48, 1), (52, 1)] }, { coefficient := 1, powers := [(19, 1), (24, 1), (40, 1), (54, 1)] }, { coefficient := -1, powers := [(19, 1), (29, 1), (40, 1), (41, 1), (51, 1), (63, 1)] }, { coefficient := 1, powers := [(19, 1), (29, 1), (40, 1), (41, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (8, 1), (24, 1), (40, 1), (60, 1)] }, { coefficient := 1, powers := [(0, 1), (8, 1), (24, 1), (45, 1), (60, 1)] }, { coefficient := -1, powers := [(17, 1), (24, 1), (50, 1), (57, 1), (65, 1)] }]
]
...
#print axioms Krenn.Component60.SelectedLeafB6_3_7_1.selectedHasNoCommonZero

end Krenn.Component60.SelectedLeafB6_3_7_1
