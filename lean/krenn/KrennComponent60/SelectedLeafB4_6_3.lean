...
namespace Krenn.Component60.SelectedLeafB4_6_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "f1c1b0ff8d9ed7647f84b518a5c88557858a95dabc19ac6588322062936cd57d"
def certificateSHA256 : String := "e0b8f4fbc8a9b89ba6610e83bccc226e1df706bdcf18daa954cfabd8916bf5b3"
...
def multipliers : Fin 33 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := 2, powers := [(7, 1), (12, 1), (24, 1), (34, 1), (40, 1), (57, 1)] }, { coefficient := 2, powers := [(12, 1), (15, 1), (24, 1), (28, 1), (40, 1), (57, 1)] }, { coefficient := 2, powers := [(12, 1), (29, 1), (48, 1)] }, { coefficient := 1, powers := [(19, 1), (21, 1), (29, 1), (52, 1)] }, { coefficient := -1, powers := [(19, 1), (24, 1), (26, 1), (52, 1)] }, { coefficient := 2, powers := [(19, 1), (24, 1), (54, 1)] }],
...
#print axioms Krenn.Component60.SelectedLeafB4_6_3.selectedHasNoCommonZero

end Krenn.Component60.SelectedLeafB4_6_3
