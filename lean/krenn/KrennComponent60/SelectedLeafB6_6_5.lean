...
namespace Krenn.Component60.SelectedLeafB6_6_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "74dadb6424abf3611f7d14ea374a533154a830d27ea82a968ce2aeac698290da"
...
def multipliers : Fin 8 → SparsePoly (Fin 67) := ![
  [{ coefficient := 1, powers := [(43, 1), (63, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(26, 1), (63, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(63, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(26, 1), (43, 1), (63, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(63, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := -1, powers := [(0, 1), (39, 1), (63, 1)] }, { coefficient := -1, powers := [(3, 1), (30, 1), (63, 1)] }, { coefficient := -1, powers := [(9, 1), (20, 1), (63, 1)] }, { coefficient := 1, powers := [(9, 1), (26, 1), (43, 1), (63, 1), (66, 1)] }],
...
#print axioms Krenn.Component60.SelectedLeafB6_6_5.selectedHasNoCommonZero

end Krenn.Component60.SelectedLeafB6_6_5
