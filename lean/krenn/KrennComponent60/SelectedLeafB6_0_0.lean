...
namespace Krenn.Component60.SelectedLeafB6_0_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "47e93dc93cbdbe2d4d867dbe1e8f22bb5cd1b881c2fb093ea08155918af56d99"
def certificateSHA256 : String := "92f60f7310a1e8d0094fcf6befda02bcb22e8824a96c4c6a2465b5ab50e08e12"
...
def multipliers : Fin 28 → SparsePoly (Fin 63) := ![
  ...
  [{ coefficient := 1, powers := [(24, 1), (43, 1), (54, 1), (61, 1)] }, { coefficient := 2, powers := [(24, 1), (46, 1), (54, 1)] }, { coefficient := 1, powers := [(29, 1), (48, 1), (50, 1), (61, 1)] }, { coefficient := 2, powers := [(29, 1), (48, 1), (52, 1)] }],
  ...
  [{ coefficient := 1, powers := [(19, 1), (20, 1), (24, 1), (54, 1)] }, { coefficient := 2, powers := [(19, 1), (24, 1), (25, 1), (54, 1)] }],
  ...
  [{ coefficient := 2, powers := [(12, 1), (20, 1), (29, 1), (48, 1)] }, { coefficient := 2, powers := [(12, 1), (25, 1), (29, 1), (48, 1)] }],
...
#print axioms Krenn.Component60.SelectedLeafB6_0_0.selectedHasNoCommonZero

end Krenn.Component60.SelectedLeafB6_0_0
