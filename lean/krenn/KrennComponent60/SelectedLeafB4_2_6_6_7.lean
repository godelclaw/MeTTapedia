...
namespace Krenn.Component60.SelectedLeafB4_2_6_6_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "b27bcbd71077b2070e719838d7e7539bb6e1e64fefcc868b077257944db5bbcf"
...
def multipliers : Fin 14 → SparsePoly (Fin 70) := ![
  [{ coefficient := 1, powers := [(35, 1), (54, 1), (67, 1)] }],
  ...
  [{ coefficient := -1, powers := [(38, 1), (59, 1), (60, 1), (68, 1)] }, { coefficient := 1, powers := [(38, 1), (60, 1)] }, { coefficient := -1, powers := [(47, 1), (53, 1), (60, 1), (68, 1)] }],
...
#print axioms Krenn.Component60.SelectedLeafB4_2_6_6_7.selectedHasNoCommonZero

end Krenn.Component60.SelectedLeafB4_2_6_6_7
