...
namespace Krenn.Component60.SelectedLeafB4_2_1_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "6129aa327dc19474fe117ee062c6aa8a57cb47b066c420b5b47a06eb4e1a8924"
...
def multipliers : Fin 24 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := 1, powers := [(5, 1), (26, 1), (35, 1), (51, 1), (65, 1)] }, { coefficient := 1, powers := [(5, 1), (43, 1), (59, 1)] }, { coefficient := 1, powers := [(19, 1), (24, 1), (26, 1), (51, 1), (65, 1)] }, { coefficient := -1, powers := [(19, 1), (47, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (25, 1), (52, 1), (57, 1), (65, 1)] }, { coefficient := 1, powers := [(24, 1), (46, 1), (54, 1), (62, 1), (65, 1)] }, { coefficient := -1, powers := [(25, 1), (29, 1), (48, 1), (52, 1), (65, 1)] }],
  ...
  [{ coefficient := 1, powers := [(5, 1), (32, 1), (57, 1), (65, 1)] }, { coefficient := 1, powers := [(5, 1), (60, 1)] }],
  ...
  [{ coefficient := 1, powers := [(24, 1), (25, 1), (52, 1), (53, 1), (57, 1), (65, 1)] }, { coefficient := -1, powers := [(24, 1), (46, 1), (53, 1), (54, 1), (62, 1), (65, 1)] }, { coefficient := 1, powers := [(25, 1), (29, 1), (48, 1), (52, 1), (53, 1), (65, 1)] }, { coefficient := 1, powers := [(38, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(19, 1), (24, 1), (54, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (57, 1)] }, { coefficient := 1, powers := [(8, 1), (35, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (20, 1), (29, 1), (32, 1), (57, 1), (65, 1)] }, { coefficient := -1, powers := [(5, 1), (20, 1), (32, 1), (57, 1)] }, { coefficient := -1, powers := [(5, 1), (20, 1), (35, 1), (54, 1)] }, { coefficient := 1, powers := [(12, 1), (20, 1), (24, 1), (57, 1)] }, { coefficient := 1, powers := [(12, 1), (20, 1), (29, 1), (48, 1)] }, { coefficient := -1, powers := [(19, 1), (24, 1), (54, 1), (62, 1)] }],
...
#print axioms Krenn.Component60.SelectedLeafB4_2_1_5.selectedHasNoCommonZero

end Krenn.Component60.SelectedLeafB4_2_1_5
