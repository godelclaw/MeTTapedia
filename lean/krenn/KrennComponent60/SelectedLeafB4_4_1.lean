...
namespace Krenn.Component60.SelectedLeafB4_4_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "aa786f59c0720d3ff858f44d1be6c30e17b1318a7547efb75d55e3352fcd53ee"
...
def multipliers : Fin 8 → SparsePoly (Fin 64) := ![
  ...
  [{ coefficient := 1, powers := [(26, 1), (62, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(62, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(26, 1), (43, 1), (62, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(62, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := -1, powers := [(0, 1), (39, 1), (62, 1)] }, { coefficient := -1, powers := [(3, 1), (30, 1), (62, 1)] }, { coefficient := -1, powers := [(9, 1), (20, 1), (62, 1)] }, { coefficient := 1, powers := [(9, 1), (26, 1), (43, 1), (62, 1), (63, 1)] }],
...
#print axioms Krenn.Component60.SelectedLeafB4_4_1.selectedHasNoCommonZero

end Krenn.Component60.SelectedLeafB4_4_1
