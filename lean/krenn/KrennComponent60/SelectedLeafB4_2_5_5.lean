...
namespace Krenn.Component60.SelectedLeafB4_2_5_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "6fbca7707dec73cc4835433ea107c8983676e6d16b6c67db5fec7954b7d4c378"
...
def multipliers : Fin 24 → SparsePoly (Fin 67) := ![
  ...
  [{ coefficient := 1, powers := [(5, 1), (26, 1), (35, 1), (51, 1), (66, 1)] }, { coefficient := 1, powers := [(5, 1), (43, 1), (59, 1)] }, { coefficient := 1, powers := [(19, 1), (24, 1), (26, 1), (51, 1), (66, 1)] }, { coefficient := -1, powers := [(19, 1), (47, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (25, 1), (52, 1), (57, 1), (66, 1)] }, { coefficient := 1, powers := [(24, 1), (46, 1), (54, 1), (62, 1), (66, 1)] }, { coefficient := -1, powers := [(25, 1), (29, 1), (48, 1), (52, 1), (66, 1)] }],
  ...
  [{ coefficient := 1, powers := [(5, 1), (32, 1), (57, 1), (66, 1)] }, { coefficient := 1, powers := [(5, 1), (60, 1)] }],
  ...
  [{ coefficient := -1, powers := [(5, 1), (29, 1), (32, 1), (57, 1), (66, 1)] }, { coefficient := 1, powers := [(5, 1), (32, 1), (57, 1)] }, { coefficient := 1, powers := [(5, 1), (35, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := 1, powers := [(24, 1), (25, 1), (52, 1), (53, 1), (57, 1), (66, 1)] }, { coefficient := -1, powers := [(24, 1), (46, 1), (53, 1), (54, 1), (62, 1), (66, 1)] }, { coefficient := 1, powers := [(25, 1), (29, 1), (48, 1), (52, 1), (53, 1), (66, 1)] }, { coefficient := 1, powers := [(38, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(19, 1), (24, 1), (54, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (57, 1)] }, { coefficient := 1, powers := [(8, 1), (35, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (20, 1), (29, 1), (32, 1), (57, 1), (66, 1)] }, { coefficient := -1, powers := [(5, 1), (20, 1), (32, 1), (57, 1)] }, { coefficient := -1, powers := [(5, 1), (20, 1), (35, 1), (54, 1)] }, { coefficient := 1, powers := [(12, 1), (20, 1), (24, 1), (57, 1)] }, { coefficient := 1, powers := [(12, 1), (20, 1), (29, 1), (48, 1)] }, { coefficient := -1, powers := [(19, 1), (24, 1), (54, 1), (62, 1)] }],
...
#print axioms Krenn.Component60.SelectedLeafB4_2_5_5.selectedHasNoCommonZero

end Krenn.Component60.SelectedLeafB4_2_5_5
