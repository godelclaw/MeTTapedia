...
namespace Krenn.Component60.SelectedLeafB6_3_7_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "52331aa2176b7fa11b0cc1a634ab26ecfb5cef5c04f623d5761979986e7bb974"
def certificateSHA256 : String := "e899f56e0eb7fcdfd4e20ad9ef9afb954e2ede1b94b1c5942e2e23aa4f55b8f4"
...
def multipliers : Fin 22 → SparsePoly (Fin 69) := ![
  ...
  [{ coefficient := 1, powers := [(8, 1), (60, 1), (65, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(52, 1), (57, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (51, 1), (60, 1), (65, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (60, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(54, 1)] }],
  [{ coefficient := 1, powers := [(48, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (57, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (50, 1), (55, 1), (57, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (54, 1)] }],
  [{ coefficient := 1, powers := [(19, 1)] }],
  [{ coefficient := 1, powers := [(24, 1), (50, 1), (57, 1), (65, 1)] }],
  ...
  [{ coefficient := 1, powers := [(8, 1), (24, 1), (51, 1), (60, 1), (66, 1)] }, { coefficient := 1, powers := [(12, 1), (24, 1), (57, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (32, 1), (57, 1)] }, { coefficient := -1, powers := [(8, 1), (24, 1), (60, 1)] }, { coefficient := -1, powers := [(12, 1), (24, 1), (57, 1)] }],
  [{ coefficient := 1, powers := [(12, 1), (24, 1), (44, 1), (57, 1), (65, 1)] }, { coefficient := -1, powers := [(17, 1), (24, 1), (40, 1), (50, 1), (57, 1), (65, 1)] }, { coefficient := 1, powers := [(18, 1), (24, 1), (40, 1), (50, 1), (55, 1), (57, 1), (65, 1)] }, { coefficient := -1, powers := [(18, 1), (24, 1), (44, 1), (50, 1), (57, 1), (65, 1)] }, { coefficient := 1, powers := [(18, 1), (24, 1), (45, 1), (50, 1), (55, 1), (57, 1), (65, 1)] }, { coefficient := 1, powers := [(18, 1), (24, 1), (46, 1), (54, 1)] }, { coefficient := 1, powers := [(19, 1), (24, 1), (40, 1), (54, 1)] }],
...
#print axioms Krenn.Component60.SelectedLeafB6_3_7_2.selectedHasNoCommonZero

end Krenn.Component60.SelectedLeafB6_3_7_2
