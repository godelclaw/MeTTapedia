...
namespace Krenn.Component60.SelectedLeafB4_1_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "c7019a9a5c5d0edab0a2e85343a85c6f1efe077d8b2f162c8b3a94ceb6a82ee9"
...
def multipliers : Fin 11 → SparsePoly (Fin 66) := ![
  [{ coefficient := -1, powers := [(21, 1), (46, 1), (53, 1), (62, 1), (65, 1)] }, { coefficient := 1, powers := [(26, 1), (46, 1), (47, 1), (62, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(21, 1), (46, 1), (62, 1), (65, 1)] }, { coefficient := -1, powers := [(25, 1), (46, 1), (47, 1), (62, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(53, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(46, 1), (50, 1), (53, 1), (62, 1), (65, 1)] }, { coefficient := 1, powers := [(46, 1), (54, 1), (62, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(26, 1), (45, 1), (46, 1), (62, 1), (65, 1)] }, { coefficient := 1, powers := [(46, 1), (53, 1), (62, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(25, 1), (45, 1), (46, 1), (62, 1), (65, 1)] }, { coefficient := -1, powers := [(46, 1), (62, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(21, 1), (46, 1), (50, 1), (53, 1), (62, 1), (65, 1)] }, { coefficient := -1, powers := [(21, 1), (46, 1), (54, 1), (62, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(65, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (57, 1), (65, 1)] }, { coefficient := -1, powers := [(21, 1), (25, 1), (46, 1), (50, 1), (53, 1), (62, 1), (65, 1)] }, { coefficient := 1, powers := [(21, 1), (25, 1), (46, 1), (54, 1), (62, 1), (65, 1)] }, { coefficient := 1, powers := [(25, 1), (43, 1), (53, 1), (65, 1)] }, { coefficient := -1, powers := [(26, 1), (43, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(25, 1), (46, 1), (53, 1), (65, 1)] }, { coefficient := 1, powers := [(26, 1), (46, 1), (65, 1)] }],
...
#print axioms Krenn.Component60.SelectedLeafB4_1_7.selectedHasNoCommonZero

end Krenn.Component60.SelectedLeafB4_1_7
