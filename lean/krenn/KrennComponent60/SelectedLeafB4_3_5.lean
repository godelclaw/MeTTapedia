...
namespace Krenn.Component60.SelectedLeafB4_3_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "01735edc43032fb440c611e3748558ead6acd39f9f9e9d87c3852edb17047b7c"
def certificateSHA256 : String := "f082069ab18ae39f62fa97baefb908df39b82504c7f90e07d32a7ef7e838d2c3"
...
def multipliers : Fin 32 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := 1, powers := [(50, 1), (55, 1), (57, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(41, 1), (46, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(12, 1), (57, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (24, 1), (50, 1), (57, 1), (61, 1), (64, 1)] }, { coefficient := -1, powers := [(13, 1), (24, 1), (52, 1), (57, 1), (64, 1)] }, { coefficient := 1, powers := [(29, 1), (48, 1), (50, 1), (61, 1)] }, { coefficient := 1, powers := [(29, 1), (48, 1), (52, 1)] }],
  ...
  [{ coefficient := -1, powers := [(13, 1), (24, 1), (57, 1), (64, 1)] }, { coefficient := 1, powers := [(29, 1), (48, 1)] }],
  [{ coefficient := 1, powers := [(13, 1), (18, 1), (24, 1), (57, 1), (61, 1), (64, 1)] }, { coefficient := -1, powers := [(18, 1), (29, 1), (48, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(54, 1)] }],
  [{ coefficient := 1, powers := [(48, 1)] }],
  [{ coefficient := 1, powers := [(13, 1), (24, 1), (25, 1), (57, 1), (64, 1)] }, { coefficient := -1, powers := [(25, 1), (29, 1), (48, 1)] }],
  [{ coefficient := 1, powers := [(24, 1), (25, 1), (54, 1)] }, { coefficient := 1, powers := [(25, 1), (29, 1), (41, 1)] }, { coefficient := 1, powers := [(25, 1), (29, 1), (47, 1), (50, 1)] }],
  [{ coefficient := -1, powers := [(50, 1), (57, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(13, 1), (24, 1), (57, 1), (64, 1)] }, { coefficient := -1, powers := [(29, 1), (48, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (54, 1)] }, { coefficient := -1, powers := [(29, 1), (41, 1)] }, { coefficient := -1, powers := [(29, 1), (47, 1), (50, 1)] }],
  [{ coefficient := 1, powers := [(19, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (29, 1), (51, 1)] }],
  [{ coefficient := 1, powers := [(19, 1), (29, 1), (50, 1)] }],
  ...
  [{ coefficient := -1, powers := [(13, 1), (18, 1), (24, 1), (50, 1), (57, 1), (64, 1)] }, { coefficient := 1, powers := [(18, 1), (29, 1), (48, 1), (50, 1)] }],
  [{ coefficient := 1, powers := [(3, 1), (38, 1), (59, 1), (60, 1)] }, { coefficient := 1, powers := [(3, 1), (47, 1), (53, 1), (60, 1)] }, { coefficient := 1, powers := [(38, 1), (60, 1)] }, { coefficient := -1, powers := [(40, 1), (41, 1), (57, 1), (62, 1)] }, { coefficient := -1, powers := [(41, 1), (55, 1), (57, 1), (64, 1)] }, { coefficient := 1, powers := [(41, 1), (57, 1)] }, { coefficient := -1, powers := [(47, 1), (50, 1), (55, 1), (57, 1), (64, 1)] }, { coefficient := -1, powers := [(48, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (35, 1), (41, 1)] }, { coefficient := -1, powers := [(19, 1), (29, 1), (41, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (32, 1), (57, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (8, 1), (24, 1), (60, 1)] }, { coefficient := -1, powers := [(12, 1), (13, 1), (20, 1), (24, 1), (57, 1), (64, 1)] }, { coefficient := -1, powers := [(12, 1), (13, 1), (24, 1), (25, 1), (57, 1), (64, 1)] }, { coefficient := 1, powers := [(12, 1), (20, 1), (29, 1), (48, 1)] }, { coefficient := 1, powers := [(12, 1), (25, 1), (29, 1), (48, 1)] }, { coefficient := -1, powers := [(19, 1), (21, 1), (29, 1), (50, 1)] }, { coefficient := 1, powers := [(19, 1), (24, 1), (25, 1), (54, 1)] }]
]
...
#print axioms Krenn.Component60.SelectedLeafB4_3_5.selectedHasNoCommonZero

end Krenn.Component60.SelectedLeafB4_3_5
