...
namespace Krenn.Component60.SelectedLeafB4_4_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "c25971be96c054daf419f3e8c477c215b5e331657f2abd9c0fc329d4ecbf0989"
...
def multipliers : Fin 8 → SparsePoly (Fin 65) := ![
  [{ coefficient := 1, powers := [(43, 1), (62, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(26, 1), (62, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(62, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(26, 1), (43, 1), (62, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(62, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := -1, powers := [(0, 1), (39, 1), (62, 1)] }, { coefficient := -1, powers := [(3, 1), (30, 1), (62, 1)] }, { coefficient := -1, powers := [(9, 1), (20, 1), (62, 1)] }, { coefficient := 1, powers := [(9, 1), (26, 1), (43, 1), (62, 1), (64, 1)] }],
...
#print axioms Krenn.Component60.SelectedLeafB4_4_5.selectedHasNoCommonZero

end Krenn.Component60.SelectedLeafB4_4_5
