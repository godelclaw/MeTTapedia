...
namespace Krenn.Component60.SelectedLeafB2_2_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "104465bbe789a201f7167062e9ff559a872b07b6c1a5e30878992d3c33410698"
...
def multipliers : Fin 8 → SparsePoly (Fin 64) := ![
  [{ coefficient := 1, powers := [(26, 1), (51, 1), (63, 1)] }, { coefficient := -1, powers := [(53, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(43, 1), (51, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(26, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(26, 1), (43, 1), (51, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(63, 1)] }],
  [{ coefficient := 1, powers := [(26, 1), (46, 1), (51, 1), (63, 1)] }, { coefficient := -1, powers := [(40, 1), (57, 1), (63, 1)] }, { coefficient := -1, powers := [(46, 1), (53, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(20, 1), (26, 1), (43, 1), (51, 1), (63, 1)] }],
...
#print axioms Krenn.Component60.SelectedLeafB2_2_1.selectedHasNoCommonZero

end Krenn.Component60.SelectedLeafB2_2_1
