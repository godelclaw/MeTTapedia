...
namespace Krenn.Component60.SelectedLeafB4_2_2_4_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "019dc03b54b48d7e3230d33f04d7bde22add73e27db2b0c8b70d2399aa207405"
...
def multipliers : Fin 14 → SparsePoly (Fin 68) := ![
  [{ coefficient := 1, powers := [(35, 1), (54, 1), (65, 1)] }],
  ...
  [{ coefficient := -1, powers := [(38, 1), (59, 1), (60, 1), (66, 1)] }, { coefficient := 1, powers := [(38, 1), (60, 1)] }, { coefficient := -1, powers := [(47, 1), (53, 1), (60, 1), (66, 1)] }],
...
#print axioms Krenn.Component60.SelectedLeafB4_2_2_4_7.selectedHasNoCommonZero

end Krenn.Component60.SelectedLeafB4_2_2_4_7
