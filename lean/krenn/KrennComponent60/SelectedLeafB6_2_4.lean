...
namespace Krenn.Component60.SelectedLeafB6_2_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "1ba96de26b0c9fe8497568f921ea677fc144523ab8b2d03c5a59a1c700fc5069"
def certificateSHA256 : String := "d99854148594cd02cd8b411fab52d207604197e4d24dcef4433dc427c6d6f83c"
...
def multipliers : Fin 33 → SparsePoly (Fin 65) := ![
  ...
  [{ coefficient := -1, powers := [(24, 1), (43, 1), (54, 1), (61, 1)] }, { coefficient := 1, powers := [(29, 1), (48, 1), (52, 1)] }],
  [{ coefficient := -2, powers := [(19, 1), (25, 1), (54, 1)] }],
  [{ coefficient := 1, powers := [(12, 1), (16, 1), (22, 1), (62, 1)] }],
  ...
  [{ coefficient := -1, powers := [(18, 1), (24, 1), (43, 1), (54, 1)] }],
  ...
  [{ coefficient := 1, powers := [(12, 1), (20, 1), (29, 1), (48, 1)] }, { coefficient := 1, powers := [(12, 1), (25, 1), (29, 1), (48, 1)] }, { coefficient := 2, powers := [(19, 1), (24, 1), (25, 1), (54, 1)] }],
...
#print axioms Krenn.Component60.SelectedLeafB6_2_4.selectedHasNoCommonZero

end Krenn.Component60.SelectedLeafB6_2_4
