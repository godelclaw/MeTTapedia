...
namespace Krenn.Component60.SelectedLeafB6_7_3_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "e78595a6cf9afa7c85a7596f2e4acb0a9375675db9237798063f5c27952759a1"
...
def multipliers : Fin 34 → SparsePoly (Fin 70) := ![
  ...
  [{ coefficient := 2, powers := [(0, 1), (12, 1), (24, 1), (49, 1), (57, 1), (69, 1)] }, { coefficient := 2, powers := [(12, 1), (20, 1), (24, 1), (49, 1), (57, 1), (69, 1)] }, { coefficient := 2, powers := [(12, 1), (24, 1), (30, 1), (36, 1), (57, 1), (69, 1)] }],
  ...
  [{ coefficient := -2, powers := [(6, 1), (12, 1), (24, 1), (33, 1), (57, 1), (69, 1)] }],
...
#print axioms Krenn.Component60.SelectedLeafB6_7_3_3.selectedHasNoCommonZero

end Krenn.Component60.SelectedLeafB6_7_3_3
