...
namespace Krenn.Component60.SelectedLeafB4_7_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "9e0a9f912cbfaa039076d9c5e1f143d8c53fe9c8845fa22ede68524639a9e291"
...
def multipliers : Fin 21 → SparsePoly (Fin 65) := ![
  ...
  [{ coefficient := -1, powers := [(21, 1), (29, 1), (52, 1), (62, 1)] }, { coefficient := 1, powers := [(24, 1), (26, 1), (52, 1), (62, 1)] }, { coefficient := -2, powers := [(24, 1), (54, 1), (62, 1)] }, { coefficient := 1, powers := [(29, 1), (41, 1), (51, 1), (62, 1), (63, 1)] }, { coefficient := -1, powers := [(29, 1), (41, 1), (62, 1)] }],
  ...
  [{ coefficient := 2, powers := [(18, 1), (25, 1), (29, 1), (48, 1), (52, 1)] }, { coefficient := 1, powers := [(19, 1), (21, 1), (29, 1), (52, 1)] }, { coefficient := -1, powers := [(19, 1), (24, 1), (26, 1), (52, 1)] }, { coefficient := 2, powers := [(19, 1), (24, 1), (54, 1)] }, { coefficient := -1, powers := [(19, 1), (29, 1), (41, 1), (51, 1), (63, 1)] }, { coefficient := 1, powers := [(19, 1), (29, 1), (41, 1)] }],
...
#print axioms Krenn.Component60.SelectedLeafB4_7_0.selectedHasNoCommonZero

end Krenn.Component60.SelectedLeafB4_7_0
