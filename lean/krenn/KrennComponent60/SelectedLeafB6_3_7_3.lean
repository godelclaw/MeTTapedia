...
namespace Krenn.Component60.SelectedLeafB6_3_7_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "ba7af53d8ec8916104d7e21c867a8529a5a76d43e369e4df48ddff6a92c4ce1c"
...
def multipliers : Fin 30 → SparsePoly (Fin 70) := ![
  ...
  [{ coefficient := 1, powers := [(17, 1), (24, 1), (57, 1), (65, 1), (69, 1)] }, { coefficient := -1, powers := [(19, 1), (47, 1)] }],
  [{ coefficient := -1, powers := [(52, 1), (57, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (8, 1), (24, 1), (60, 1), (69, 1)] }],
...
#print axioms Krenn.Component60.SelectedLeafB6_3_7_3.selectedHasNoCommonZero

end Krenn.Component60.SelectedLeafB6_3_7_3
