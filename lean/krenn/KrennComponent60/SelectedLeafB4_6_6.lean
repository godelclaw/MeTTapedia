...
namespace Krenn.Component60.SelectedLeafB4_6_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "cef710937bb1b3adbb4af447970bd6fa654be6ab7f282da33857c12420949252"
def certificateSHA256 : String := "9db71a2560cbf835bbadeaa97ef54654481c9b76aff267256d29becd8d5f9778"
...
def multipliers : Fin 21 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := -1, powers := [(8, 1), (48, 1), (59, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (60, 1), (62, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (60, 1), (64, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (60, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (60, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (13, 1), (60, 1), (64, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (9, 1), (60, 1), (62, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(12, 1), (48, 1)] }],
  [{ coefficient := 1, powers := [(54, 1)] }],
  [{ coefficient := 1, powers := [(3, 1), (48, 1), (59, 1)] }, { coefficient := 1, powers := [(48, 1)] }],
  [{ coefficient := 1, powers := [(12, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := -1, powers := [(3, 1), (48, 1), (54, 1), (59, 1)] }, { coefficient := 1, powers := [(38, 1), (60, 1)] }, { coefficient := 1, powers := [(41, 1), (57, 1)] }, { coefficient := -1, powers := [(48, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (29, 1), (60, 1)] }, { coefficient := -1, powers := [(19, 1), (32, 1), (38, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (9, 1), (29, 1), (60, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (35, 1)] }, { coefficient := 1, powers := [(19, 1), (29, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (24, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(3, 1), (8, 1), (32, 1), (48, 1), (59, 1)] }, { coefficient := 1, powers := [(8, 1), (13, 1), (24, 1), (60, 1), (64, 1)] }],
...
#print axioms Krenn.Component60.SelectedLeafB4_6_6.selectedHasNoCommonZero

end Krenn.Component60.SelectedLeafB4_6_6
