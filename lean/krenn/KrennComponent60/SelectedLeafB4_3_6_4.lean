...
namespace Krenn.Component60.SelectedLeafB4_3_6_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "75c92b4c326b83661dba63bd2a46ab343f8dd7f1f7742d67029e6e11ce4fd30c"
def certificateSHA256 : String := "86a29211143f5f570e3234d40b2a2ee179324af14379571553e787324ed17e8a"
...
def multipliers : Fin 23 → SparsePoly (Fin 67) := ![
  ...
  [{ coefficient := 2, powers := [(24, 1), (26, 1), (43, 1), (45, 1), (66, 1)] }],
  [{ coefficient := -2, powers := [(24, 1), (43, 1), (45, 1)] }, { coefficient := -1, powers := [(24, 1), (46, 1)] }],
  [{ coefficient := -2, powers := [(24, 1), (26, 1), (43, 1), (45, 1), (50, 1), (61, 1)] }, { coefficient := -2, powers := [(24, 1), (26, 1), (43, 1), (45, 1), (50, 1), (66, 1)] }, { coefficient := 2, powers := [(24, 1), (43, 1), (45, 1), (54, 1)] }, { coefficient := -1, powers := [(24, 1), (43, 1), (54, 1), (61, 1)] }],
  [{ coefficient := -2, powers := [(24, 1), (45, 1), (54, 1)] }],
  [{ coefficient := 1, powers := [(18, 1), (24, 1), (54, 1), (61, 1)] }],
  [{ coefficient := 2, powers := [(18, 1), (24, 1), (26, 1), (43, 1), (45, 1), (61, 1)] }],
  ...
  [{ coefficient := -2, powers := [(18, 1), (24, 1), (26, 1), (43, 1), (45, 1), (50, 1)] }, { coefficient := -1, powers := [(18, 1), (24, 1), (43, 1), (54, 1)] }],
  ...
  [{ coefficient := -2, powers := [(12, 1), (24, 1), (26, 1), (43, 1), (45, 1)] }, { coefficient := 2, powers := [(18, 1), (24, 1), (26, 1), (43, 1), (45, 1), (50, 1)] }],
...
#print axioms Krenn.Component60.SelectedLeafB4_3_6_4.selectedHasNoCommonZero

end Krenn.Component60.SelectedLeafB4_3_6_4
