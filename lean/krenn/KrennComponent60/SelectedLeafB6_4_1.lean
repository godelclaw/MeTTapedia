...
namespace Krenn.Component60.SelectedLeafB6_4_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "be1f56ab17ab67e5aa66fcf66aa2a37e8111604e62fbb78f7f03054745f94f6c"
...
def multipliers : Fin 8 → SparsePoly (Fin 65) := ![
  [{ coefficient := 1, powers := [(43, 1), (63, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(26, 1), (63, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(63, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(26, 1), (43, 1), (63, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(63, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := -1, powers := [(0, 1), (39, 1), (63, 1)] }, { coefficient := -1, powers := [(3, 1), (30, 1), (63, 1)] }, { coefficient := -1, powers := [(9, 1), (20, 1), (63, 1)] }, { coefficient := 1, powers := [(9, 1), (26, 1), (43, 1), (63, 1), (64, 1)] }],
...
#print axioms Krenn.Component60.SelectedLeafB6_4_1.selectedHasNoCommonZero

end Krenn.Component60.SelectedLeafB6_4_1
