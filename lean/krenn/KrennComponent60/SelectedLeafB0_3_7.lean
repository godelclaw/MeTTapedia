...
namespace Krenn.Component60.SelectedLeafB0_3_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "6b6e136ebc4bbc1ea56ecb72e0026b57dd2c2644c029b2fd048fb0f8b37bbedf"
def certificateSHA256 : String := "261df655db5a987aaa105a7613102c3e86af74a7950326e5094feb13bd6385ee"
...
def multipliers : Fin 29 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := -2, powers := [(19, 1), (21, 1), (45, 1)] }, { coefficient := -2, powers := [(19, 1), (25, 1), (45, 1), (47, 1)] }, { coefficient := -1, powers := [(19, 1), (47, 1)] }],
  [{ coefficient := -2, powers := [(12, 1), (21, 1), (53, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (60, 1), (63, 1), (64, 1)] }, { coefficient := -1, powers := [(12, 1), (57, 1), (63, 1), (64, 1)] }, { coefficient := -1, powers := [(19, 1), (54, 1), (63, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(50, 1), (55, 1), (57, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(21, 1), (43, 1), (52, 1)] }, { coefficient := -1, powers := [(41, 1), (46, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (51, 1), (60, 1), (63, 1), (64, 1)] }, { coefficient := 1, powers := [(12, 1), (51, 1), (57, 1), (63, 1), (64, 1)] }, { coefficient := 1, powers := [(19, 1), (51, 1), (54, 1), (63, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (60, 1), (64, 1)] }, { coefficient := -1, powers := [(12, 1), (57, 1), (64, 1)] }, { coefficient := -1, powers := [(19, 1), (54, 1), (64, 1)] }],
  ...
  [{ coefficient := 2, powers := [(12, 1), (29, 1), (48, 1), (51, 1)] }, { coefficient := -1, powers := [(18, 1), (29, 1), (48, 1), (52, 1)] }, { coefficient := -2, powers := [(19, 1), (21, 1), (29, 1), (45, 1), (52, 1)] }, { coefficient := 2, powers := [(19, 1), (29, 1), (41, 1), (56, 1)] }, { coefficient := -2, powers := [(19, 1), (29, 1), (45, 1), (47, 1), (50, 1)] }, { coefficient := 2, powers := [(19, 1), (29, 1), (47, 1), (52, 1)] }],
  [{ coefficient := 1, powers := [(21, 1), (43, 1), (52, 1), (53, 1)] }, { coefficient := 1, powers := [(38, 1), (60, 1)] }, { coefficient := -1, powers := [(40, 1), (41, 1), (57, 1), (61, 1)] }, { coefficient := -1, powers := [(41, 1), (55, 1), (57, 1), (63, 1)] }, { coefficient := 1, powers := [(41, 1), (57, 1)] }, { coefficient := -1, powers := [(47, 1), (50, 1), (55, 1), (57, 1), (63, 1)] }, { coefficient := -1, powers := [(48, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (35, 1), (41, 1)] }, { coefficient := -1, powers := [(19, 1), (29, 1), (41, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (32, 1), (57, 1)] }, { coefficient := 1, powers := [(8, 1), (24, 1), (51, 1), (60, 1), (64, 1)] }, { coefficient := -1, powers := [(12, 1), (24, 1), (51, 1), (57, 1), (64, 1)] }, { coefficient := -1, powers := [(12, 1), (24, 1), (57, 1)] }, { coefficient := -1, powers := [(19, 1), (24, 1), (51, 1), (54, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (24, 1), (60, 1)] }, { coefficient := 1, powers := [(12, 1), (24, 1), (57, 1)] }, { coefficient := 1, powers := [(19, 1), (24, 1), (54, 1)] }]
]
...
#print axioms Krenn.Component60.SelectedLeafB0_3_7.selectedHasNoCommonZero

end Krenn.Component60.SelectedLeafB0_3_7
