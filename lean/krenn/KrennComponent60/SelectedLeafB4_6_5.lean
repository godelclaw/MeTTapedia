...
namespace Krenn.Component60.SelectedLeafB4_6_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "3d5d212bec3f2801c6d7f6a285785a6ac861ed35ad9226989f781932f4227e93"
...
def multipliers : Fin 8 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := 1, powers := [(26, 1), (62, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(62, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(26, 1), (43, 1), (62, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(62, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := -1, powers := [(0, 1), (39, 1), (62, 1)] }, { coefficient := -1, powers := [(3, 1), (30, 1), (62, 1)] }, { coefficient := -1, powers := [(9, 1), (20, 1), (62, 1)] }, { coefficient := 1, powers := [(9, 1), (26, 1), (43, 1), (62, 1), (65, 1)] }],
...
#print axioms Krenn.Component60.SelectedLeafB4_6_5.selectedHasNoCommonZero

end Krenn.Component60.SelectedLeafB4_6_5
