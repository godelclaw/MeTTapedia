...
namespace Krenn.Component60.SelectedLeafB6_3_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "dfe2da8ce645482f69e3173d59509be8e58d6bef25c7973bb8db927ac584a759"
def certificateSHA256 : String := "5919b5d68e68a1510acaaee945ea1a884028cc24be3539ae08a03e6cccbff2ec"
...
def multipliers : Fin 40 → SparsePoly (Fin 65) := ![
  [{ coefficient := -1, powers := [(0, 1), (14, 1), (19, 1), (22, 2), (29, 1), (41, 1), (62, 2)] }, { coefficient := -1, powers := [(0, 1), (19, 1), (22, 1), (29, 1), (41, 1), (42, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (29, 1), (41, 1), (42, 1)] }, { coefficient := 2, powers := [(13, 1), (20, 1), (29, 1), (41, 1)] }, { coefficient := 1, powers := [(25, 1), (29, 1), (41, 1), (42, 1)] }, { coefficient := 1, powers := [(29, 1), (33, 1), (36, 1), (41, 1)] }],
  [{ coefficient := -1, powers := [(12, 1), (53, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (47, 1)] }],
  [{ coefficient := -1, powers := [(41, 1), (46, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(29, 1), (48, 1), (50, 1), (61, 1)] }, { coefficient := 1, powers := [(29, 1), (48, 1), (52, 1)] }],
  ...
  [{ coefficient := 1, powers := [(0, 1), (14, 1), (19, 1), (22, 1), (29, 1), (41, 1), (62, 2)] }, { coefficient := 1, powers := [(0, 1), (19, 1), (29, 1), (41, 1), (42, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(54, 1)] }],
  [{ coefficient := 1, powers := [(48, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (25, 1), (29, 1), (41, 1)] }],
  [{ coefficient := -1, powers := [(25, 1), (29, 1), (48, 1)] }],
  [{ coefficient := 1, powers := [(24, 1), (25, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [(29, 1), (48, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (29, 1), (41, 1)] }, { coefficient := -1, powers := [(20, 1), (29, 1), (41, 1), (44, 1)] }, { coefficient := 1, powers := [(29, 1), (41, 1), (42, 1)] }],
  [{ coefficient := 1, powers := [(19, 1)] }],
  [{ coefficient := 1, powers := [(12, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (24, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(19, 1), (25, 1), (29, 1), (41, 1), (42, 1)] }, { coefficient := -1, powers := [(19, 1), (29, 1), (33, 1), (36, 1), (41, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (19, 1), (29, 1), (41, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(41, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (29, 1), (41, 1), (49, 1)] }],
  [{ coefficient := 1, powers := [(19, 1), (20, 1), (29, 1), (41, 1), (44, 1)] }, { coefficient := -1, powers := [(19, 1), (29, 1), (41, 1), (42, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (20, 1), (29, 1), (41, 1)] }],
  [{ coefficient := -1, powers := [(3, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(19, 1), (29, 1), (41, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := 1, powers := [(18, 1), (29, 1), (48, 1), (50, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (14, 1), (19, 1), (22, 1), (29, 1), (41, 1), (49, 1), (62, 1)] }, { coefficient := 1, powers := [(0, 1), (19, 1), (29, 1), (36, 1), (41, 1), (58, 1)] }],
  ...
  [{ coefficient := 1, powers := [(0, 1), (1, 1), (19, 1), (29, 1), (41, 1), (55, 1), (62, 1)] }, { coefficient := -1, powers := [(0, 1), (14, 1), (15, 1), (19, 1), (22, 1), (27, 1), (29, 1), (41, 1), (62, 2)] }, { coefficient := 1, powers := [(0, 1), (14, 1), (19, 1), (27, 1), (29, 1), (41, 1), (62, 1)] }, { coefficient := -1, powers := [(0, 1), (15, 1), (19, 1), (27, 1), (29, 1), (41, 1), (42, 1), (62, 1)] }, { coefficient := -1, powers := [(0, 1), (19, 1), (25, 1), (29, 1), (41, 1), (42, 1), (56, 1)] }, { coefficient := 1, powers := [(0, 1), (19, 1), (29, 1), (33, 1), (36, 1), (41, 1), (56, 1)] }, { coefficient := -1, powers := [(0, 1), (19, 1), (29, 1), (41, 1), (55, 1)] }, { coefficient := -1, powers := [(6, 1), (19, 1), (29, 1), (33, 1), (41, 1)] }, { coefficient := 1, powers := [(13, 1), (19, 1), (25, 1), (29, 1), (41, 1)] }, { coefficient := -1, powers := [(19, 1), (25, 1), (29, 1), (41, 1), (42, 1)] }, { coefficient := 1, powers := [(19, 1), (29, 1), (33, 1), (36, 1), (41, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (35, 1), (41, 1)] }, { coefficient := -1, powers := [(19, 1), (29, 1), (41, 1)] }],
  [{ coefficient := -1, powers := [(3, 1), (19, 1), (29, 1), (30, 1), (41, 1)] }, { coefficient := 1, powers := [(19, 1), (20, 1), (29, 1), (41, 1), (49, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (8, 1), (24, 1), (60, 1)] }, { coefficient := -1, powers := [(3, 1), (19, 1), (25, 1), (29, 1), (30, 1), (41, 1), (42, 1)] }, { coefficient := 1, powers := [(3, 1), (19, 1), (29, 1), (30, 1), (33, 1), (36, 1), (41, 1)] }, { coefficient := -1, powers := [(9, 1), (19, 1), (20, 1), (25, 1), (29, 1), (41, 1), (42, 1)] }, { coefficient := 1, powers := [(9, 1), (19, 1), (20, 1), (29, 1), (33, 1), (36, 1), (41, 1)] }, { coefficient := 1, powers := [(12, 1), (20, 1), (29, 1), (48, 1)] }, { coefficient := 1, powers := [(12, 1), (25, 1), (29, 1), (48, 1)] }, { coefficient := 1, powers := [(19, 1), (24, 1), (25, 1), (54, 1)] }],
...
#print axioms Krenn.Component60.SelectedLeafB6_3_0.selectedHasNoCommonZero

end Krenn.Component60.SelectedLeafB6_3_0
