...
namespace Krenn.Component60.SelectedLeafB4_2_5_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "6e9d448a16cd184820aafa7a01a9ea1fcced702dfffbd34a64b6c3376c78b9f5"
def certificateSHA256 : String := "e3a2bcab804a50b5168690f91702d6668df3abb1f84e7357703d64f4bfc49ffe"
...
def multipliers : Fin 29 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := 1, powers := [(38, 1), (60, 1)] }, { coefficient := -1, powers := [(47, 1), (50, 1), (55, 1), (57, 1), (63, 1)] }, { coefficient := -1, powers := [(48, 1), (54, 1)] }],
...
#print axioms Krenn.Component60.SelectedLeafB4_2_5_2.selectedHasNoCommonZero

end Krenn.Component60.SelectedLeafB4_2_5_2
