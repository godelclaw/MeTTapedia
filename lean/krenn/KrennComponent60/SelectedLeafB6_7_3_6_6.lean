...
namespace Krenn.Component60.SelectedLeafB6_7_3_6_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "1ca24bb19ff3c0a952edcfcaf072e63b62fe9dddd4b129487604c984074785d2"
def certificateSHA256 : String := "e6e1115a5d03048b761718c527b19d32756455bea1616bfada89a544d19a30b2"
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedEquations : Fin 14 → SparsePoly (Fin 72) := ![
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def multipliers : Fin 14 → SparsePoly (Fin 72) := ![
  [{ coefficient := 1, powers := [(32, 1), (57, 1), (70, 1)] }],
  ...
  [{ coefficient := 1, powers := [(38, 1), (60, 1)] }, { coefficient := -1, powers := [(39, 1), (41, 1), (57, 1), (63, 1)] }, { coefficient := 1, powers := [(41, 1), (57, 1)] }, { coefficient := -1, powers := [(48, 1), (54, 1)] }],
...
#print axioms Krenn.Component60.SelectedLeafB6_7_3_6_6.selectedHasNoCommonZero

end Krenn.Component60.SelectedLeafB6_7_3_6_6
