...
namespace Krenn.Component60.SelectedLeafB4_3_3_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "e1aa0e674ea04509b041ec7e35a436b5bc513d11aac6cecc1353aeb83657dd16"
def certificateSHA256 : String := "4cdd93e0bba81bc3523230353e27dc0ee76b61a8233be9061694b66f7a27824d"
...
def multipliers : Fin 35 → SparsePoly (Fin 68) := ![
  ...
  [{ coefficient := 2, powers := [(0, 1), (12, 1), (24, 1), (49, 1), (57, 1), (67, 1)] }, { coefficient := 2, powers := [(12, 1), (20, 1), (24, 1), (49, 1), (57, 1), (67, 1)] }, { coefficient := 2, powers := [(12, 1), (24, 1), (30, 1), (36, 1), (57, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (47, 1)] }],
  [{ coefficient := -1, powers := [(52, 1), (57, 1), (64, 1)] }],
  [{ coefficient := -2, powers := [(12, 1), (24, 1), (33, 1), (36, 1), (57, 1), (67, 1)] }],
  ...
  [{ coefficient := -2, powers := [(24, 1), (54, 1)] }, { coefficient := 1, powers := [(29, 1), (41, 1), (51, 1), (62, 1)] }, { coefficient := -1, powers := [(29, 1), (41, 1)] }],
  ...
  [{ coefficient := 1, powers := [(38, 1), (60, 1)] }, { coefficient := -1, powers := [(40, 1), (41, 1), (57, 1), (62, 1)] }, { coefficient := -1, powers := [(41, 1), (46, 1), (53, 1), (62, 1)] }, { coefficient := -1, powers := [(41, 1), (56, 1), (57, 1), (64, 1)] }, { coefficient := 1, powers := [(41, 1), (57, 1)] }, { coefficient := -1, powers := [(48, 1), (54, 1)] }],
  [{ coefficient := -2, powers := [(0, 1), (12, 1), (24, 1), (55, 1), (57, 1)] }, { coefficient := -2, powers := [(6, 1), (12, 1), (24, 1), (33, 1), (57, 1)] }, { coefficient := 2, powers := [(12, 1), (24, 1), (29, 1), (33, 1), (36, 1), (57, 1), (67, 1)] }],
  ...
  [{ coefficient := -2, powers := [(3, 1), (12, 1), (24, 1), (57, 1), (58, 1)] }, { coefficient := -2, powers := [(12, 1), (13, 1), (24, 1), (39, 1), (57, 1)] }, { coefficient := 2, powers := [(12, 1), (24, 1), (39, 1), (42, 1), (57, 1)] }, { coefficient := 2, powers := [(12, 1), (24, 1), (42, 1), (49, 1), (57, 1)] }, { coefficient := -2, powers := [(12, 1), (29, 1), (48, 1), (51, 1)] }, { coefficient := 1, powers := [(18, 1), (24, 1), (46, 1), (54, 1)] }, { coefficient := -1, powers := [(18, 1), (29, 1), (41, 1), (46, 1), (51, 1), (62, 1)] }, { coefficient := 1, powers := [(18, 1), (29, 1), (41, 1), (46, 1)] }, { coefficient := 1, powers := [(18, 1), (29, 1), (48, 1), (52, 1)] }, { coefficient := 2, powers := [(19, 1), (24, 1), (40, 1), (54, 1)] }, { coefficient := -1, powers := [(19, 1), (29, 1), (40, 1), (41, 1), (51, 1), (62, 1)] }, { coefficient := 1, powers := [(19, 1), (29, 1), (40, 1), (41, 1)] }],
...
#print axioms Krenn.Component60.SelectedLeafB4_3_3_3.selectedHasNoCommonZero

end Krenn.Component60.SelectedLeafB4_3_3_3
