...
namespace Krenn.Component60.SelectedLeafB2_6_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "67d37a89c706bf9d640959e82395bc8db046b9164895eda93015aa41dae549d1"
def certificateSHA256 : String := "c0ac82cca009f49d2123e66397a70fab3f1e956b4571593b9eea672732d184b5"

set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedSourceIndices : Fin 25 → Fin 665 := ![
  16,
  20,
  22,
  25,
...
def multipliers : Fin 25 → SparsePoly (Fin 67) := ![
  [{ coefficient := -1, powers := [(24, 1), (50, 1), (57, 1), (62, 1), (64, 1)] }],
  ...
  [{ coefficient := -2, powers := [(12, 1), (57, 1), (64, 1), (65, 1)] }],
  [{ coefficient := -2, powers := [(12, 1), (48, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (26, 1)] }],
  [{ coefficient := 2, powers := [(12, 1), (51, 1), (57, 1), (64, 1), (65, 1)] }],
  ...
  [{ coefficient := -1, powers := [(21, 1), (44, 1), (50, 1), (57, 1), (64, 1)] }, { coefficient := 1, powers := [(38, 1), (60, 1)] }, { coefficient := -1, powers := [(48, 1), (54, 1)] }],
  [{ coefficient := 2, powers := [(12, 1), (29, 1), (48, 1)] }, { coefficient := 1, powers := [(17, 1), (24, 1), (50, 1), (57, 1), (64, 1)] }, { coefficient := 1, powers := [(19, 1), (21, 1), (29, 1), (52, 1)] }, { coefficient := -1, powers := [(19, 1), (24, 1), (26, 1), (52, 1)] }, { coefficient := 2, powers := [(19, 1), (24, 1), (54, 1)] }],
  [{ coefficient := -2, powers := [(9, 1), (12, 1), (29, 1), (48, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (55, 1), (57, 1), (64, 1)] }, { coefficient := 1, powers := [(2, 1), (57, 1)] }, { coefficient := 1, powers := [(8, 1), (35, 1)] }, { coefficient := -1, powers := [(19, 1), (29, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (32, 1), (57, 1)] }, { coefficient := -2, powers := [(12, 1), (24, 1), (51, 1), (57, 1), (65, 1)] }, { coefficient := -1, powers := [(12, 1), (24, 1), (57, 1)] }],
...
#print axioms Krenn.Component60.SelectedLeafB2_6_7.selectedHasNoCommonZero

end Krenn.Component60.SelectedLeafB2_6_7
