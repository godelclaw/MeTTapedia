...
namespace Krenn.Component60.SelectedLeafB4_3_6_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "a170d400ef79d8d9de41f74f811ca6d8be879d583525357128d18f1a6d2a7cff"
...
def multipliers : Fin 6 → SparsePoly (Fin 68) := ![
  [{ coefficient := 1, powers := [(20, 1), (47, 1), (63, 1), (66, 1), (67, 1)] }, { coefficient := -1, powers := [(21, 1), (63, 1), (66, 1), (67, 1)] }],
  [{ coefficient := -1, powers := [(47, 1), (63, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(63, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(25, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := -1, powers := [(20, 1), (47, 1), (50, 1), (63, 1), (66, 1)] }, { coefficient := 1, powers := [(21, 1), (50, 1), (63, 1), (66, 1)] }]
]
...
#print axioms Krenn.Component60.SelectedLeafB4_3_6_5.selectedHasNoCommonZero

end Krenn.Component60.SelectedLeafB4_3_6_5
