...
namespace Krenn.Component60.SelectedLeafB6_7_3_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "3bace3b0511782d525fa3159e2d117e23b93a85eb67e670c0194fd6d58a9a357"
def certificateSHA256 : String := "c3bce3efa2b88e91ddc87e64aeaf2b37343dd5deadac5662e34ab23ba446ed06"
...
def multipliers : Fin 34 → SparsePoly (Fin 69) := ![
  [{ coefficient := -1, powers := [(21, 1), (29, 1), (52, 1), (63, 1)] }, { coefficient := 1, powers := [(24, 1), (26, 1), (52, 1), (63, 1)] }, { coefficient := -2, powers := [(24, 1), (54, 1), (63, 1)] }, { coefficient := 1, powers := [(29, 1), (41, 1), (51, 1), (63, 1), (64, 1)] }, { coefficient := -1, powers := [(29, 1), (41, 1), (63, 1)] }],
  ...
  [{ coefficient := 2, powers := [(0, 1), (12, 1), (24, 1), (49, 1), (57, 1), (68, 1)] }, { coefficient := 2, powers := [(12, 1), (20, 1), (24, 1), (49, 1), (57, 1), (68, 1)] }, { coefficient := 2, powers := [(12, 1), (24, 1), (30, 1), (36, 1), (57, 1), (68, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (47, 1)] }],
  [{ coefficient := 2, powers := [(6, 1), (12, 1), (33, 1), (57, 1), (66, 1)] }, { coefficient := -2, powers := [(12, 1), (33, 1), (36, 1), (57, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(52, 1), (57, 1), (66, 1)] }],
  [{ coefficient := -2, powers := [(6, 1), (12, 1), (24, 1), (33, 1), (57, 1), (68, 1)] }],
  ...
  [{ coefficient := -1, powers := [(29, 1), (41, 1), (64, 1)] }],
  ...
  [{ coefficient := 1, powers := [(38, 1), (60, 1)] }, { coefficient := -1, powers := [(40, 1), (41, 1), (57, 1), (64, 1)] }, { coefficient := -1, powers := [(41, 1), (46, 1), (53, 1), (64, 1)] }, { coefficient := -1, powers := [(41, 1), (56, 1), (57, 1), (66, 1)] }, { coefficient := 1, powers := [(41, 1), (57, 1)] }, { coefficient := -1, powers := [(48, 1), (54, 1)] }],
  [{ coefficient := 1, powers := [(19, 1), (21, 1), (29, 1), (52, 1)] }, { coefficient := -1, powers := [(19, 1), (24, 1), (26, 1), (52, 1)] }, { coefficient := 2, powers := [(19, 1), (24, 1), (54, 1)] }, { coefficient := -1, powers := [(19, 1), (29, 1), (41, 1), (51, 1), (64, 1)] }, { coefficient := 1, powers := [(19, 1), (29, 1), (41, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (35, 1), (41, 1)] }],
  [{ coefficient := -2, powers := [(0, 1), (9, 1), (12, 1), (24, 1), (36, 1), (57, 1), (59, 1)] }, { coefficient := -2, powers := [(0, 1), (12, 1), (24, 1), (39, 1), (57, 1)] }, { coefficient := -2, powers := [(3, 1), (12, 1), (24, 1), (30, 1), (57, 1)] }, { coefficient := 2, powers := [(12, 1), (20, 1), (24, 1), (49, 1), (57, 1)] }, { coefficient := 2, powers := [(12, 1), (24, 1), (30, 1), (36, 1), (57, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (32, 1), (57, 1)] }, { coefficient := -2, powers := [(6, 1), (9, 1), (12, 1), (24, 1), (33, 1), (57, 1)] }, { coefficient := 2, powers := [(9, 1), (12, 1), (24, 1), (33, 1), (36, 1), (57, 1)] }, { coefficient := -1, powers := [(12, 1), (24, 1), (57, 1)] }],
  [{ coefficient := -2, powers := [(3, 1), (12, 1), (24, 1), (57, 1), (58, 1)] }, { coefficient := -2, powers := [(12, 1), (13, 1), (24, 1), (39, 1), (57, 1)] }, { coefficient := 2, powers := [(12, 1), (24, 1), (39, 1), (42, 1), (57, 1)] }, { coefficient := 2, powers := [(12, 1), (24, 1), (42, 1), (49, 1), (57, 1)] }, { coefficient := -2, powers := [(12, 1), (29, 1), (48, 1), (51, 1)] }],
  [{ coefficient := -2, powers := [(0, 1), (12, 1), (24, 1), (42, 1), (49, 1), (57, 1)] }, { coefficient := 2, powers := [(6, 1), (9, 1), (12, 1), (24, 1), (33, 1), (57, 1)] }, { coefficient := 2, powers := [(6, 1), (12, 1), (24, 1), (33, 1), (39, 1), (57, 1)] }, { coefficient := -2, powers := [(12, 1), (20, 1), (24, 1), (42, 1), (49, 1), (57, 1)] }, { coefficient := -2, powers := [(12, 1), (24, 1), (30, 1), (36, 1), (42, 1), (57, 1)] }]
]
...
#print axioms Krenn.Component60.SelectedLeafB6_7_3_1.selectedHasNoCommonZero

end Krenn.Component60.SelectedLeafB6_7_3_1
