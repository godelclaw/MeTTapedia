...
namespace Krenn.Component60.SelectedLeafB2_2_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "1405c7ae4c10854ed6970470f9d8552ad630dc144601663bd25289ddbfc7c9d0"
def certificateSHA256 : String := "1fbc2150150b1ac204e28593f3216a61d7ab7f643609f683ad85f979d0616c48"
...
def multipliers : Fin 30 → SparsePoly (Fin 64) := ![
  ...
  [{ coefficient := -2, powers := [(19, 1), (27, 1), (47, 1), (61, 1)] }],
  [{ coefficient := 2, powers := [(19, 1), (22, 1), (54, 1), (61, 1)] }],
  ...
  [{ coefficient := 2, powers := [(11, 1), (19, 1), (27, 1), (61, 1)] }, { coefficient := 2, powers := [(12, 1), (16, 1), (22, 1), (61, 1)] }, { coefficient := 1, powers := [(19, 1), (50, 1)] }],
  ...
  [{ coefficient := -2, powers := [(19, 1), (24, 1), (61, 1)] }],
  ...
  [{ coefficient := -1, powers := [(18, 1), (29, 1), (48, 1), (52, 1)] }, { coefficient := 1, powers := [(19, 1), (24, 1), (51, 1), (54, 1)] }],
  [{ coefficient := 2, powers := [(12, 1), (29, 1), (48, 1)] }, { coefficient := 2, powers := [(19, 1), (24, 1), (54, 1)] }],
  [{ coefficient := 1, powers := [(21, 1), (43, 1), (52, 1), (53, 1)] }, { coefficient := 1, powers := [(38, 1), (60, 1)] }, { coefficient := -1, powers := [(48, 1), (54, 1)] }],
...
#print axioms Krenn.Component60.SelectedLeafB2_2_2.selectedHasNoCommonZero

end Krenn.Component60.SelectedLeafB2_2_2
