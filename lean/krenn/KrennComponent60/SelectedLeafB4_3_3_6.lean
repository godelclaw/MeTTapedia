...
namespace Krenn.Component60.SelectedLeafB4_3_3_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "da786621df73422259ae2a48777c882869ace39e437260ca561410ba3161d6de"
def certificateSHA256 : String := "15a1f53acd635c5026c92d1a650b6bfdb4e130c48fb104e1795cec416c18ab91"
...
def multipliers : Fin 25 → SparsePoly (Fin 68) := ![
  ...
  [{ coefficient := 1, powers := [(24, 1), (26, 1), (43, 1), (45, 1), (66, 1)] }, { coefficient := -1, powers := [(24, 1), (57, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (43, 1), (45, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (26, 1), (43, 1), (45, 1), (50, 1), (61, 1)] }, { coefficient := -1, powers := [(24, 1), (26, 1), (43, 1), (45, 1), (50, 1), (66, 1)] }, { coefficient := 1, powers := [(24, 1), (43, 1), (45, 1), (54, 1)] }, { coefficient := 1, powers := [(24, 1), (50, 1), (57, 1), (61, 1)] }, { coefficient := 1, powers := [(24, 1), (50, 1), (57, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(6, 1), (18, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (60, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (45, 1), (54, 1)] }],
  [{ coefficient := 1, powers := [(18, 1), (24, 1), (26, 1), (43, 1), (45, 1), (61, 1)] }, { coefficient := -1, powers := [(18, 1), (24, 1), (57, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(19, 1), (24, 1), (45, 1)] }],
  ...
  [{ coefficient := -1, powers := [(18, 1), (24, 1), (26, 1), (43, 1), (45, 1), (50, 1)] }, { coefficient := 1, powers := [(18, 1), (24, 1), (50, 1), (57, 1)] }],
  [{ coefficient := 1, powers := [(6, 1), (38, 1), (59, 1), (60, 1)] }, { coefficient := 1, powers := [(6, 1), (47, 1), (53, 1), (60, 1)] }, { coefficient := 1, powers := [(38, 1), (60, 1)] }, { coefficient := -1, powers := [(40, 1), (41, 1), (57, 1), (62, 1)] }, { coefficient := -1, powers := [(41, 1), (46, 1), (53, 1), (62, 1)] }, { coefficient := -1, powers := [(41, 1), (56, 1), (57, 1), (64, 1)] }, { coefficient := 1, powers := [(41, 1), (57, 1)] }, { coefficient := -1, powers := [(48, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (35, 1), (41, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (32, 1), (57, 1)] }, { coefficient := -1, powers := [(12, 1), (24, 1), (57, 1)] }],
  [{ coefficient := -1, powers := [(12, 1), (24, 1), (26, 1), (43, 1), (45, 1)] }, { coefficient := 1, powers := [(12, 1), (24, 1), (57, 1)] }, { coefficient := 1, powers := [(18, 1), (24, 1), (26, 1), (43, 1), (45, 1), (50, 1)] }, { coefficient := -1, powers := [(18, 1), (24, 1), (50, 1), (57, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (6, 1), (59, 1), (60, 1)] }, { coefficient := 1, powers := [(5, 1), (60, 1)] }, { coefficient := -1, powers := [(12, 1), (48, 1)] }, { coefficient := -1, powers := [(18, 1), (41, 1), (46, 1), (62, 1)] }, { coefficient := -1, powers := [(19, 1), (40, 1), (41, 1), (62, 1)] }, { coefficient := -1, powers := [(19, 1), (47, 1), (50, 1)] }]
]
...
#print axioms Krenn.Component60.SelectedLeafB4_3_3_6.selectedHasNoCommonZero

end Krenn.Component60.SelectedLeafB4_3_3_6
