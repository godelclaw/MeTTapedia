...
namespace Krenn.Component60.SelectedLeafB4_3_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "99014edf09750d9270198a94dcc1bafe44ee312f8d53ed4a8f80f62c21d3d908"
def certificateSHA256 : String := "5dd4f8be294502847807ddcf5b9187abaa8941541b746f400e464a1726b8c8b7"
...
def multipliers : Fin 30 → SparsePoly (Fin 65) := ![
  ...
  [{ coefficient := -1, powers := [(29, 1), (43, 1), (47, 1), (50, 1), (61, 1)] }, { coefficient := -1, powers := [(29, 1), (43, 1), (47, 1), (52, 1)] }, { coefficient := 2, powers := [(29, 1), (48, 1), (50, 1), (61, 1)] }, { coefficient := 1, powers := [(29, 1), (48, 1), (52, 1)] }],
  ...
  [{ coefficient := -1, powers := [(29, 1), (43, 1), (47, 1)] }, { coefficient := 2, powers := [(29, 1), (48, 1)] }],
  [{ coefficient := 1, powers := [(29, 1), (52, 1)] }],
  [{ coefficient := 1, powers := [(18, 1), (29, 1), (43, 1), (47, 1), (61, 1)] }, { coefficient := -2, powers := [(18, 1), (29, 1), (48, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(54, 1)] }],
  [{ coefficient := 1, powers := [(48, 1)] }],
  [{ coefficient := 1, powers := [(25, 1), (29, 1), (43, 1), (47, 1)] }, { coefficient := -2, powers := [(25, 1), (29, 1), (48, 1)] }],
  ...
  [{ coefficient := -1, powers := [(18, 1), (29, 1), (43, 1), (47, 1), (50, 1)] }, { coefficient := 2, powers := [(18, 1), (29, 1), (48, 1), (50, 1)] }],
  [{ coefficient := 1, powers := [(3, 1), (38, 1), (59, 1), (60, 1)] }, { coefficient := 1, powers := [(3, 1), (47, 1), (53, 1), (60, 1)] }, { coefficient := 1, powers := [(38, 1), (60, 1)] }, { coefficient := -1, powers := [(40, 1), (41, 1), (57, 1), (62, 1)] }, { coefficient := 1, powers := [(41, 1), (57, 1)] }, { coefficient := -1, powers := [(48, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (35, 1), (41, 1)] }, { coefficient := -1, powers := [(19, 1), (29, 1), (41, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (8, 1), (24, 1), (60, 1)] }, { coefficient := 1, powers := [(0, 1), (19, 1), (29, 1), (41, 1)] }, { coefficient := -1, powers := [(12, 1), (20, 1), (29, 1), (43, 1), (47, 1)] }, { coefficient := 1, powers := [(12, 1), (20, 1), (29, 1), (48, 1)] }, { coefficient := -1, powers := [(12, 1), (25, 1), (29, 1), (43, 1), (47, 1)] }, { coefficient := 2, powers := [(12, 1), (25, 1), (29, 1), (48, 1)] }, { coefficient := -1, powers := [(19, 1), (20, 1), (29, 1), (47, 1), (50, 1)] }, { coefficient := 1, powers := [(19, 1), (21, 1), (29, 1), (50, 1)] }, { coefficient := 1, powers := [(19, 1), (24, 1), (25, 1), (54, 1)] }],
...
#print axioms Krenn.Component60.SelectedLeafB4_3_4.selectedHasNoCommonZero

end Krenn.Component60.SelectedLeafB4_3_4
