...
namespace Krenn.Component60.SelectedLeafB6_5_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "895a846f89475fbebe994a9f13cee806e8e913bcac9aa12d3835ed62f35ccfd1"
def certificateSHA256 : String := "3d2ab8eca4f7457fedbf2710d96db58409505195e181ed200318176511321094"
...
def multipliers : Fin 28 → SparsePoly (Fin 67) := ![
  ...
  [{ coefficient := -2, powers := [(12, 1), (25, 1), (46, 1)] }],
  ...
  [{ coefficient := -2, powers := [(12, 1), (24, 1), (26, 1), (46, 1)] }],
  [{ coefficient := 1, powers := [(38, 1), (60, 1)] }, { coefficient := -1, powers := [(39, 1), (41, 1), (57, 1), (63, 1)] }, { coefficient := -1, powers := [(41, 1), (56, 1), (57, 1), (65, 1)] }, { coefficient := 1, powers := [(41, 1), (57, 1)] }, { coefficient := -1, powers := [(48, 1), (54, 1)] }],
  ...
  [{ coefficient := 2, powers := [(0, 1), (12, 1), (24, 1), (57, 1)] }, { coefficient := -2, powers := [(12, 1), (24, 1), (25, 1), (43, 1), (53, 1)] }, { coefficient := 2, powers := [(12, 1), (24, 1), (26, 1), (43, 1)] }, { coefficient := -2, powers := [(12, 1), (25, 1), (29, 1), (43, 1), (47, 1)] }],
...
#print axioms Krenn.Component60.SelectedLeafB6_5_3.selectedHasNoCommonZero

end Krenn.Component60.SelectedLeafB6_5_3
