...
namespace Krenn.Component60.SelectedLeafB0_3_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "3de71589d2323bb487a04da3216d33fdf80ff3aad661d04333df76c9fea2f36f"
def certificateSHA256 : String := "379f5ff62fde22da142a0f18a1424bdd43913cbe21123a3a6e8cfc799cae2eb4"
...
def multipliers : Fin 32 → SparsePoly (Fin 63) := ![
  ...
  [{ coefficient := 1, powers := [(3, 1), (18, 1), (29, 1), (47, 1), (51, 1), (60, 1)] }, { coefficient := -1, powers := [(8, 1), (24, 1), (51, 1), (60, 1)] }, { coefficient := -1, powers := [(12, 1), (29, 1), (43, 1), (47, 1), (51, 1)] }, { coefficient := 1, powers := [(12, 1), (29, 1), (48, 1), (51, 1)] }, { coefficient := -1, powers := [(19, 1), (21, 1), (29, 1), (45, 1), (52, 1)] }, { coefficient := 2, powers := [(19, 1), (29, 1), (41, 1), (56, 1)] }, { coefficient := 1, powers := [(19, 1), (29, 1), (47, 1), (52, 1)] }],
...
#print axioms Krenn.Component60.SelectedLeafB0_3_0.selectedHasNoCommonZero

end Krenn.Component60.SelectedLeafB0_3_0
