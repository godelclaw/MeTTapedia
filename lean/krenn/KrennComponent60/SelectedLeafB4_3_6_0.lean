...
namespace Krenn.Component60.SelectedLeafB4_3_6_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "55c74d42e5bca289cc8f26d808b1e23539a4b35ee74f35f0b01ecc52a78635ca"
def certificateSHA256 : String := "e0622ef6af5e274706473efb017409ed43e139d5378b86a08532b18c88889679"
...
def multipliers : Fin 15 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := 1, powers := [(24, 1), (26, 1), (52, 1)] }, { coefficient := -2, powers := [(24, 1), (54, 1)] }],
  ...
  [{ coefficient := -1, powers := [(18, 1), (24, 1), (26, 1), (46, 1), (52, 1)] }, { coefficient := 2, powers := [(18, 1), (24, 1), (46, 1), (54, 1)] }, { coefficient := -1, powers := [(19, 1), (24, 1), (26, 1), (40, 1), (52, 1)] }, { coefficient := 2, powers := [(19, 1), (24, 1), (40, 1), (54, 1)] }],
...
#print axioms Krenn.Component60.SelectedLeafB4_3_6_0.selectedHasNoCommonZero

end Krenn.Component60.SelectedLeafB4_3_6_0
