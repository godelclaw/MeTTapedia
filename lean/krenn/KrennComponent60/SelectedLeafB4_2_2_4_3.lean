...
namespace Krenn.Component60.SelectedLeafB4_2_2_4_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "f00c899531f42993d7cb0a7baf338c2fabfe4a0dfeadfa04b35f570de59fb904"
def certificateSHA256 : String := "1e3d67ce8b7739cdee7d9426cadc90fa5ac8a6d306d820a1541f83c3d6bb58b9"
...
def selectedEquations : Fin 22 → SparsePoly (Fin 67) := ![
  ...
  [{ coefficient := 1, powers := [(59, 1), (65, 1)] }, { coefficient := -1, powers := [] }]
]
...
def multipliers : Fin 22 → SparsePoly (Fin 67) := ![
  ...
  [{ coefficient := 1, powers := [(24, 1), (26, 1), (43, 1), (45, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (43, 1), (45, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (26, 1), (43, 1), (45, 1), (50, 1), (61, 1)] }, { coefficient := -1, powers := [(24, 1), (26, 1), (43, 1), (45, 1), (50, 1), (64, 1)] }, { coefficient := 1, powers := [(24, 1), (43, 1), (45, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [(18, 1), (60, 1), (65, 1)] }],
  ...
  [{ coefficient := 1, powers := [(60, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := -1, powers := [(18, 1), (24, 1), (26, 1), (43, 1), (45, 1), (50, 1)] }],
  [{ coefficient := -1, powers := [(38, 1), (59, 1), (60, 1), (65, 1)] }, { coefficient := 1, powers := [(38, 1), (60, 1)] }, { coefficient := -1, powers := [(47, 1), (53, 1), (60, 1), (65, 1)] }, { coefficient := -1, powers := [(48, 1), (54, 1)] }],
  ...
  [{ coefficient := -1, powers := [(5, 1), (59, 1), (60, 1), (65, 1)] }, { coefficient := 1, powers := [(5, 1), (60, 1)] }, { coefficient := -1, powers := [(12, 1), (48, 1)] }, { coefficient := -1, powers := [(19, 1), (47, 1), (50, 1)] }],
...
#print axioms Krenn.Component60.SelectedLeafB4_2_2_4_3.selectedHasNoCommonZero

end Krenn.Component60.SelectedLeafB4_2_2_4_3
