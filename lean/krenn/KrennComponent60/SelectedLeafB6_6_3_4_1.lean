...
namespace Krenn.Component60.SelectedLeafB6_6_3_4_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "306da2f8ce758935f5f155da4fedc578ff6edf0030d023e0b28fcdbb8b90c7b2"
def certificateSHA256 : String := "92a042a8f821b76210437480a7ebb31239ca27f489a93bfa74ff126831d87350"
...
def multipliers : Fin 17 → SparsePoly (Fin 69) := ![
  [{ coefficient := -1, powers := [(24, 1), (54, 1), (56, 1), (63, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(12, 1), (53, 1), (56, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(52, 1), (57, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(12, 1), (57, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (56, 1), (60, 1), (65, 1)] }, { coefficient := 1, powers := [(12, 1), (51, 1), (57, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(54, 1), (56, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(48, 1), (56, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(19, 1), (56, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(12, 1), (56, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(57, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(56, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(38, 1), (56, 1), (60, 1), (65, 1)] }, { coefficient := -1, powers := [(48, 1), (54, 1), (56, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(19, 1), (24, 1), (54, 1), (56, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (35, 1), (56, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := 1, powers := [(5, 1), (56, 1), (60, 1), (65, 1)] }, { coefficient := -1, powers := [(12, 1), (48, 1), (56, 1), (65, 1)] }, { coefficient := -1, powers := [(19, 1), (47, 1), (50, 1), (56, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(6, 1), (8, 1), (24, 1), (56, 1), (60, 1), (65, 1)] }, { coefficient := -1, powers := [(6, 1), (12, 1), (24, 1), (51, 1), (57, 1), (65, 1)] }]
]
...
#print axioms Krenn.Component60.SelectedLeafB6_6_3_4_1.selectedHasNoCommonZero

end Krenn.Component60.SelectedLeafB6_6_3_4_1
