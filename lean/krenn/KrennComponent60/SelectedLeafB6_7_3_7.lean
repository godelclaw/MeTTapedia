...
namespace Krenn.Component60.SelectedLeafB6_7_3_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "86caa291f9997b3c25662389e93539a05075d653a88bdb197eac7c6d48594173"
...
def multipliers : Fin 27 → SparsePoly (Fin 71) := ![
  ...
  [{ coefficient := -2, powers := [(12, 1), (24, 1), (57, 1), (63, 1), (70, 1)] }, { coefficient := -2, powers := [(12, 1), (29, 1), (48, 1), (63, 1), (70, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (26, 1)] }],
  [{ coefficient := -2, powers := [(12, 1), (24, 1), (26, 1), (43, 1), (70, 1)] }],
  [{ coefficient := 2, powers := [(12, 1), (24, 1), (63, 1)] }],
  [{ coefficient := 2, powers := [(12, 1), (24, 1), (26, 1), (70, 1)] }],
...
#print axioms Krenn.Component60.SelectedLeafB6_7_3_7.selectedHasNoCommonZero

end Krenn.Component60.SelectedLeafB6_7_3_7
