...
namespace Krenn.Component60.SelectedLeafB4_3_6_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "ca143abab6dd19eb1cbc6b52ce11483183dbc312532e5cc9cf98dd34bf7de258"
def certificateSHA256 : String := "bd952351067f7c55322acaa137410625a7b55f6bdcbea6e7fcb03adb0e1c9961"
...
def multipliers : Fin 23 → SparsePoly (Fin 67) := ![
  ...
  [{ coefficient := -1, powers := [(8, 1), (51, 1), (60, 1), (64, 1), (65, 1)] }],
  ...
  [{ coefficient := 1, powers := [(38, 1), (60, 1)] }, { coefficient := -1, powers := [(40, 1), (41, 1), (57, 1), (62, 1)] }, { coefficient := -1, powers := [(41, 1), (46, 1), (53, 1), (62, 1)] }, { coefficient := 1, powers := [(41, 1), (57, 1)] }, { coefficient := -1, powers := [(48, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (35, 1), (41, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (24, 1), (51, 1), (60, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (24, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (32, 1)] }],
  [{ coefficient := -2, powers := [(12, 1), (29, 1), (48, 1), (51, 1)] }, { coefficient := 1, powers := [(18, 1), (24, 1), (46, 1), (54, 1)] }, { coefficient := -1, powers := [(18, 1), (29, 1), (41, 1), (46, 1), (51, 1), (62, 1)] }, { coefficient := 1, powers := [(18, 1), (29, 1), (41, 1), (46, 1)] }, { coefficient := 1, powers := [(18, 1), (29, 1), (48, 1), (52, 1)] }, { coefficient := 1, powers := [(19, 1), (24, 1), (40, 1), (54, 1)] }, { coefficient := -1, powers := [(19, 1), (29, 1), (40, 1), (41, 1), (51, 1), (62, 1)] }, { coefficient := 1, powers := [(19, 1), (29, 1), (40, 1), (41, 1)] }]
]
...
#print axioms Krenn.Component60.SelectedLeafB4_3_6_1.selectedHasNoCommonZero

end Krenn.Component60.SelectedLeafB4_3_6_1
