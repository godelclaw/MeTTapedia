...
namespace Krenn.Component60.SelectedLeafB6_4_6_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "1b889a53d0faa927692715ad80788105fe97231226c1fd6c05ef93c2e824baa8"
def certificateSHA256 : String := "0062311c5ff24fef876b7a4f9d961d6c29cdf5a8a2b6cad433b03443001f3385"
...
def multipliers : Fin 20 → SparsePoly (Fin 69) := ![
  ...
  [{ coefficient := -2, powers := [(12, 1), (20, 1), (29, 1), (48, 1), (68, 1)] }],
  ...
  [{ coefficient := 2, powers := [(12, 1), (20, 1), (29, 2), (48, 1), (68, 1)] }],
  ...
  [{ coefficient := 2, powers := [(12, 1), (20, 1), (29, 1), (45, 1), (48, 1)] }]
]
...
#print axioms Krenn.Component60.SelectedLeafB6_4_6_7.selectedHasNoCommonZero

end Krenn.Component60.SelectedLeafB6_4_6_7
