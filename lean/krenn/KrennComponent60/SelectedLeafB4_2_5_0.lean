...
namespace Krenn.Component60.SelectedLeafB4_2_5_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "5a1d88e41700554d2c6cd900c33047cdb089aea39d1f01dd7e3ed1d76dd6747c"
def certificateSHA256 : String := "62b776a6aa308863164e1315d3d21319325abda71453dd6c4db79185557c6515"
...
def multipliers : Fin 29 → SparsePoly (Fin 65) := ![
  ...
  [{ coefficient := -1, powers := [(13, 1), (50, 1), (57, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(12, 1), (57, 1), (63, 1)] }, { coefficient := 1, powers := [(18, 1), (50, 1), (57, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (24, 1), (52, 1), (57, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (24, 1), (26, 1), (40, 1), (51, 1), (60, 1), (64, 1)] }, { coefficient := -1, powers := [(8, 1), (24, 1), (40, 1), (53, 1), (60, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (24, 1), (40, 1), (43, 1), (59, 1)] }],
  [{ coefficient := 1, powers := [(54, 1)] }],
  [{ coefficient := 1, powers := [(48, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (24, 1), (26, 1), (40, 1), (60, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(50, 1), (57, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(13, 1), (24, 1), (57, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (54, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (24, 1), (26, 1), (51, 1), (60, 1), (64, 1)] }, { coefficient := -1, powers := [(8, 1), (24, 1), (53, 1), (60, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(19, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (24, 1), (40, 1), (60, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (24, 1), (26, 1), (60, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(12, 1)] }],
  [{ coefficient := 1, powers := [(57, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (24, 1), (40, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (24, 1), (40, 1), (59, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (24, 1), (60, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := 1, powers := [(13, 1), (47, 1), (50, 1), (57, 1), (63, 1)] }, { coefficient := 1, powers := [(38, 1), (60, 1)] }, { coefficient := -1, powers := [(48, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (55, 1), (57, 1), (63, 1)] }, { coefficient := 1, powers := [(2, 1), (57, 1)] }, { coefficient := 1, powers := [(8, 1), (35, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (32, 1), (57, 1)] }],
  [{ coefficient := -1, powers := [(12, 1), (13, 1), (20, 1), (24, 1), (57, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (8, 1), (24, 1), (40, 1), (60, 1)] }, { coefficient := -1, powers := [(8, 1), (20, 1), (24, 1), (40, 1), (60, 1)] }, { coefficient := -1, powers := [(8, 1), (24, 1), (60, 1)] }],
  [{ coefficient := -2, powers := [(8, 1), (24, 1), (26, 1), (40, 1), (43, 1), (51, 1), (60, 1), (64, 1)] }, { coefficient := -1, powers := [(8, 1), (24, 1), (26, 1), (46, 1), (51, 1), (60, 1), (64, 1)] }, { coefficient := 2, powers := [(8, 1), (24, 1), (40, 1), (43, 1), (53, 1), (60, 1), (64, 1)] }, { coefficient := 1, powers := [(8, 1), (24, 1), (40, 1), (60, 1)] }, { coefficient := 1, powers := [(8, 1), (24, 1), (46, 1), (53, 1), (60, 1), (64, 1)] }, { coefficient := 1, powers := [(13, 1), (18, 1), (24, 1), (52, 1), (57, 1), (63, 1)] }, { coefficient := 1, powers := [(18, 1), (24, 1), (46, 1), (54, 1)] }, { coefficient := 1, powers := [(19, 1), (24, 1), (40, 1), (54, 1)] }],
...
#print axioms Krenn.Component60.SelectedLeafB4_2_5_0.selectedHasNoCommonZero

end Krenn.Component60.SelectedLeafB4_2_5_0
