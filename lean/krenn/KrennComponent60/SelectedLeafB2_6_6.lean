...
namespace Krenn.Component60.SelectedLeafB2_6_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "43c8e3c2b6290d0b54ec2c426de9b6a3dd74d3914f0d8f5d8bb4615cbb74c5c3"
def certificateSHA256 : String := "949e7d737198509e92fee7f3ac95da80e876683bbecf10bc6d62f5765ff3a2e5"
...
def multipliers : Fin 19 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := -2, powers := [(5, 1), (45, 1), (60, 1), (62, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (26, 1)] }],
  [{ coefficient := 2, powers := [(5, 1), (60, 1), (63, 1)] }],
  ...
  [{ coefficient := 2, powers := [(5, 1), (29, 1), (45, 1), (60, 1), (63, 1)] }, { coefficient := -1, powers := [(19, 1), (21, 1), (29, 1), (52, 1)] }, { coefficient := -1, powers := [(19, 1), (24, 1), (26, 1), (52, 1)] }, { coefficient := 2, powers := [(19, 1), (24, 1), (54, 1)] }],
  [{ coefficient := -2, powers := [(5, 1), (29, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (35, 1)] }, { coefficient := 1, powers := [(19, 1), (29, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (41, 1)] }, { coefficient := 1, powers := [(5, 1), (32, 1)] }, { coefficient := -1, powers := [(12, 1), (24, 1)] }]
]
...
#print axioms Krenn.Component60.SelectedLeafB2_6_6.selectedHasNoCommonZero

end Krenn.Component60.SelectedLeafB2_6_6
