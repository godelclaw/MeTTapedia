...
namespace Krenn.Component60.SelectedLeafB6_2_6_6_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "45f9efd6b863a2f5703b462b6e741225ce272eeea5521e69e1c9d8743b12c9c2"
def certificateSHA256 : String := "610e5c4ec3b7f8a11b60c3e42ea1645cc87cad72ae61830c9238eb0ba1cd63db"
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedEquations : Fin 12 → SparsePoly (Fin 69) := ![
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def multipliers : Fin 12 → SparsePoly (Fin 69) := ![
  [{ coefficient := -1, powers := [(12, 1), (53, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (60, 1)] }, { coefficient := -1, powers := [(19, 1), (54, 1)] }],
  ...
  [{ coefficient := -1, powers := [(6, 1), (8, 1), (24, 1), (60, 1)] }, { coefficient := 1, powers := [(6, 1), (19, 1), (24, 1), (54, 1)] }]
]
...
#print axioms Krenn.Component60.SelectedLeafB6_2_6_6_1.selectedHasNoCommonZero

end Krenn.Component60.SelectedLeafB6_2_6_6_1
