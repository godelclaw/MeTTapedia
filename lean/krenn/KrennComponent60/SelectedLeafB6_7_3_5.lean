...
namespace Krenn.Component60.SelectedLeafB6_7_3_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "002f3c9f5133fcc6dda01f2cbf1b959504633b3d0fc1e0a4423fb33201acdb8a"
def certificateSHA256 : String := "3b6246128749c1e65aac884965d53f083ebcaa30ffda58e4d4f96ac0be0d735c"
...
def multipliers : Fin 27 → SparsePoly (Fin 70) := ![
  [{ coefficient := 2, powers := [(12, 1), (29, 1), (63, 1)] }],
  ...
  [{ coefficient := -2, powers := [(12, 1), (24, 1), (43, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(52, 1), (57, 1), (66, 1)] }],
  [{ coefficient := 2, powers := [(12, 1), (24, 1), (43, 1), (45, 1), (63, 1)] }, { coefficient := -2, powers := [(12, 1), (24, 1), (46, 1), (63, 1)] }],
  [{ coefficient := -2, powers := [(12, 1), (24, 1), (57, 1), (63, 1), (69, 1)] }, { coefficient := -2, powers := [(12, 1), (29, 1), (48, 1), (63, 1), (69, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (26, 1)] }],
  [{ coefficient := -2, powers := [(12, 1), (24, 1), (26, 1), (43, 1), (69, 1)] }],
  [{ coefficient := 2, powers := [(12, 1), (24, 1), (63, 1)] }],
  [{ coefficient := 2, powers := [(12, 1), (24, 1), (26, 1), (69, 1)] }],
  ...
  [{ coefficient := -2, powers := [(12, 1), (24, 1), (26, 1), (43, 1), (45, 1)] }, { coefficient := 2, powers := [(12, 1), (24, 1), (26, 1), (46, 1)] }, { coefficient := 2, powers := [(12, 1), (24, 1), (57, 1)] }, { coefficient := 2, powers := [(12, 1), (29, 1), (48, 1)] }, { coefficient := 1, powers := [(19, 1), (21, 1), (29, 1), (52, 1)] }, { coefficient := -1, powers := [(19, 1), (24, 1), (26, 1), (52, 1)] }, { coefficient := 2, powers := [(19, 1), (24, 1), (54, 1)] }, { coefficient := -1, powers := [(19, 1), (29, 1), (41, 1), (51, 1), (64, 1)] }, { coefficient := 1, powers := [(19, 1), (29, 1), (41, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (35, 1), (41, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (32, 1), (57, 1)] }, { coefficient := -1, powers := [(12, 1), (24, 1), (57, 1)] }],
  [{ coefficient := 2, powers := [(9, 1), (12, 1), (24, 1), (57, 1), (63, 1)] }, { coefficient := 2, powers := [(9, 1), (12, 1), (29, 1), (48, 1), (63, 1)] }, { coefficient := 2, powers := [(12, 1), (24, 1), (26, 1), (43, 1), (45, 1)] }, { coefficient := -2, powers := [(12, 1), (24, 1), (26, 1), (46, 1)] }, { coefficient := 2, powers := [(12, 1), (24, 1), (39, 1), (57, 1), (63, 1)] }, { coefficient := 2, powers := [(12, 1), (29, 1), (39, 1), (48, 1), (63, 1)] }]
]
...
#print axioms Krenn.Component60.SelectedLeafB6_7_3_5.selectedHasNoCommonZero

end Krenn.Component60.SelectedLeafB6_7_3_5
