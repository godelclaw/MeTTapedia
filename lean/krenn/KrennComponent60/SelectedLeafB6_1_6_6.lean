...
namespace Krenn.Component60.SelectedLeafB6_1_6_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "b8afc859fb266c13bb284515e9238d3a450aab4b64df41ec225b9c663b508f9f"
...
def multipliers : Fin 7 → SparsePoly (Fin 68) := ![
  ...
  [{ coefficient := -1, powers := [(50, 1), (63, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(63, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(21, 1), (50, 1), (63, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(21, 1), (25, 1), (50, 1), (63, 1), (66, 1)] }],
...
#print axioms Krenn.Component60.SelectedLeafB6_1_6_6.selectedHasNoCommonZero

end Krenn.Component60.SelectedLeafB6_1_6_6
