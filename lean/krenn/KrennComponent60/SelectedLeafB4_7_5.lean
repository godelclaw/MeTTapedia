...
namespace Krenn.Component60.SelectedLeafB4_7_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "faefaabafa1157c2bd94ed1a3dbcbad5f2eecac221af8cd1ed66771e646681ce"
...
def multipliers : Fin 8 → SparsePoly (Fin 67) := ![
  [{ coefficient := 1, powers := [(43, 1), (62, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(26, 1), (62, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(62, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(26, 1), (43, 1), (62, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(62, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := -1, powers := [(0, 1), (39, 1), (62, 1)] }, { coefficient := -1, powers := [(3, 1), (30, 1), (62, 1)] }, { coefficient := -1, powers := [(9, 1), (20, 1), (62, 1)] }, { coefficient := 1, powers := [(9, 1), (26, 1), (43, 1), (62, 1), (66, 1)] }],
...
#print axioms Krenn.Component60.SelectedLeafB4_7_5.selectedHasNoCommonZero

end Krenn.Component60.SelectedLeafB4_7_5
