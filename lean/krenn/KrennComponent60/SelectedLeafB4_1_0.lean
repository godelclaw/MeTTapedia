...
namespace Krenn.Component60.SelectedLeafB4_1_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "0b83ddfcbbfbdf4ef04144900f46bdc45d7e4d489a8c36ef5ce6e23f89f7cb24"
...
def multipliers : Fin 9 → SparsePoly (Fin 63) := ![
  ...
  [{ coefficient := -1, powers := [(21, 1), (62, 1)] }, { coefficient := 1, powers := [(25, 1), (47, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(45, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(21, 1), (52, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(25, 1), (45, 1), (62, 1)] }, { coefficient := 1, powers := [(62, 1)] }],
  [{ coefficient := -1, powers := [(21, 1), (25, 1), (52, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := 1, powers := [(0, 1), (25, 1), (41, 1), (45, 1), (62, 1)] }, { coefficient := -1, powers := [(0, 1), (41, 1), (62, 1)] }, { coefficient := 1, powers := [(21, 1), (25, 1), (45, 1), (50, 1), (62, 1)] }, { coefficient := -1, powers := [(25, 1), (47, 1), (50, 1), (62, 1)] }]
]
...
#print axioms Krenn.Component60.SelectedLeafB4_1_0.selectedHasNoCommonZero

end Krenn.Component60.SelectedLeafB4_1_0
