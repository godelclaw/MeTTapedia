...
namespace Krenn.Component60.SelectedLeafB6_0_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "c62a8bc7127bad894ce6e7adbb5fc55b9287ca6da60c2fbd94c74b2d9b82ab93"
def certificateSHA256 : String := "321b0015c49d1f342987c038a7dd53e3a241730c4285aa8431c3688017d66078"
...
def multipliers : Fin 31 → SparsePoly (Fin 64) := ![
  ...
  [{ coefficient := 1, powers := [(24, 1), (46, 1), (54, 1)] }, { coefficient := 1, powers := [(29, 1), (48, 1), (52, 1)] }],
  [{ coefficient := 1, powers := [(11, 1), (19, 1), (27, 1), (62, 1)] }, { coefficient := 1, powers := [(12, 1), (16, 1), (22, 1), (62, 1)] }],
  ...
  [{ coefficient := 1, powers := [(12, 1), (29, 1), (48, 1)] }, { coefficient := 1, powers := [(19, 1), (24, 1), (54, 1)] }],
  [{ coefficient := 1, powers := [(38, 1), (60, 1)] }, { coefficient := -1, powers := [(48, 1), (54, 1)] }],
  [{ coefficient := 1, powers := [(19, 1), (24, 1), (25, 1), (54, 1)] }],
  ...
  [{ coefficient := 1, powers := [(12, 1), (20, 1), (29, 1), (48, 1)] }, { coefficient := 1, powers := [(12, 1), (25, 1), (29, 1), (48, 1)] }],
...
#print axioms Krenn.Component60.SelectedLeafB6_0_4.selectedHasNoCommonZero

end Krenn.Component60.SelectedLeafB6_0_4
