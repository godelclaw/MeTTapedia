...
namespace Krenn.Component60.SelectedLeafB4_2_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "d3574a9fbd34a127af4804b8b1d85353ee820b524d3b96a08a5583f920cd6897"
def certificateSHA256 : String := "32d0311e609c53cdff295c8837104aead796dbc0c7a119f2d55899994d60ed35"
...
def multipliers : Fin 37 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := 2, powers := [(12, 1), (20, 1), (57, 1), (63, 1)] }],
  ...
  [{ coefficient := -2, powers := [(12, 1), (20, 1), (51, 1), (57, 1), (63, 1)] }],
...
#print axioms Krenn.Component60.SelectedLeafB4_2_7.selectedHasNoCommonZero

end Krenn.Component60.SelectedLeafB4_2_7
