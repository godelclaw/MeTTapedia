...
namespace Krenn.X5Case306Selected

open Krenn.SparseCertificate
open MvPolynomial

def sourceSystemFileSHA256 : String := "28f51176c041ab9ede17fac9e4db3ea53dc0379e0739835058c7a64952ad8b70"
def sourceSystemSemanticSHA256 : String := "c2946817abf5ffcb360e5cd57c8c41b3b5fb0549a4929ae34037be1ab2624a4b"
def certificateSHA256 : String := "a553b6fe52dbd69d0d736c6c0b25b042c3201bcc87f40784eb4ee5c2f062df22"
...
def selectedEquations : Fin 21 → SparsePoly (Fin 70) := ![
  ...
  [{ coefficient := 1, powers := [(9, 1), (38, 1), (68, 1)] }, { coefficient := 1, powers := [(16, 1), (56, 1)] }, { coefficient := 1, powers := [(25, 1), (38, 1), (59, 1)] }],
  [{ coefficient := 1, powers := [(9, 1), (42, 1), (64, 1)] }, { coefficient := 1, powers := [(16, 1), (46, 1), (56, 1)] }, { coefficient := 1, powers := [(25, 1), (36, 1), (64, 1)] }, { coefficient := 1, powers := [(56, 1), (64, 1)] }],
...
def multipliers : Fin 21 → SparsePoly (Fin 70) := ![
  [{ coefficient := -1, powers := [(24, 1), (33, 1), (39, 1), (44, 1), (56, 1)] }, { coefficient := 1, powers := [(32, 1), (33, 1), (39, 1), (41, 1), (56, 1)] }],
  [{ coefficient := 1, powers := [(33, 1), (42, 1)] }],
  [{ coefficient := -1, powers := [(8, 1), (33, 1), (39, 1), (44, 1), (56, 1)] }, { coefficient := 1, powers := [(32, 1), (33, 1), (35, 1), (39, 1), (56, 1)] }],
  [{ coefficient := 1, powers := [(33, 1), (36, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (25, 1), (33, 1), (39, 1), (55, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (25, 1), (33, 1), (39, 1), (46, 1), (55, 1)] }, { coefficient := -1, powers := [(25, 1), (33, 1), (35, 1), (39, 1), (67, 1)] }, { coefficient := -1, powers := [(25, 1), (33, 1), (39, 1), (41, 1), (58, 1)] }, { coefficient := 1, powers := [(25, 1), (33, 1), (39, 1), (44, 1), (55, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (9, 1), (33, 1), (39, 1), (46, 1), (55, 1)] }, { coefficient := -1, powers := [(9, 1), (33, 1), (35, 1), (39, 1), (67, 1)] }, { coefficient := -1, powers := [(9, 1), (33, 1), (39, 1), (41, 1), (58, 1)] }, { coefficient := 1, powers := [(9, 1), (33, 1), (39, 1), (44, 1), (55, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (9, 1), (33, 1), (39, 1), (55, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (33, 1), (39, 1), (46, 1), (56, 1)] }, { coefficient := 1, powers := [(33, 1), (39, 1), (44, 1), (56, 1)] }],
  [{ coefficient := 1, powers := [(24, 1), (33, 1), (39, 1), (56, 1)] }],
  ...
  [{ coefficient := 1, powers := [(33, 1), (39, 1), (55, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (33, 1), (39, 1), (46, 1), (55, 1)] }, { coefficient := 1, powers := [(33, 1), (35, 1), (39, 1), (67, 1)] }, { coefficient := 1, powers := [(33, 1), (39, 1), (41, 1), (58, 1)] }, { coefficient := -1, powers := [(33, 1), (39, 1), (44, 1), (55, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (33, 1), (39, 1), (55, 1)] }],
...
#print axioms Krenn.X5Case306Selected.selectedHasNoCommonZero

end Krenn.X5Case306Selected
