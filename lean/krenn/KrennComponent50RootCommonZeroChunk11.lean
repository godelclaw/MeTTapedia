...
namespace Krenn.Component50RootCommonZero.Chunk11
...
theorem rootBlock_of_base_and_component {R : Type*} [CommRing R]
    ...
    ∀ offset : Fin 40, eval₂Hom (Int.castRingHom R) (rootValues full)
      (Krenn.Component50.Tree.rootEquations ⟨440 + offset.val, by omega⟩).toPoly = 0 := by
...
end Krenn.Component50RootCommonZero.Chunk11
