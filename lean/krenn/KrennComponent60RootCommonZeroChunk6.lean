...
namespace Krenn.Component60RootCommonZero.Chunk6
...
theorem rootBlock_of_base_and_component {R : Type*} [CommRing R]
    ...
    ∀ offset : Fin 40, eval₂Hom (Int.castRingHom R) (rootValues full)
      (Krenn.Component60.Tree.rootEquations ⟨240 + offset.val, by omega⟩).toPoly = 0 := by
  ...
  · have source := rawZero 2
    rw [identified] at source
    simp [Krenn.Component60.Tree.rootEquations, Krenn.Component60.Root.rootEquations, rawGeneratorEval, rawPositive, rawNegative, rawValues, rawCoordinate, monomial_add, monomial_single_one, SparsePoly.toPoly, SparseTerm.toPoly, rootValues, reconstructFull, rootCoordinate, sub_eq_add_neg] at source ⊢
    convert source using 1 <;> ac_rfl
...
end Krenn.Component60RootCommonZero.Chunk6
