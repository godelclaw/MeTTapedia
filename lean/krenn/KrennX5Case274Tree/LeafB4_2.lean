...
namespace Krenn.X5Case274Tree.LeafB4_2

open Krenn.SparseCertificate
open MvPolynomial

def sourceSystemFileSHA256 : String := "c74c247bb9bc6b8b66de58ca197f98b88d01444d8cd9bb088ff738f32fffca92"
def sourceSystemSemanticSHA256 : String := "35b50e0dae5f00153c8da7f2d2a0829617bfd39786698a507981d5cb5162b96f"
def certificateSHA256 : String := "e16d52c53a956345f8a4e074455288a95b8d47b4e39e0ea68aa366619671c010"
...
def multipliers : Fin 17 → SparsePoly (Fin 72) := ![
  ...
  [{ coefficient := -1, powers := [(0, 1), (16, 1), (33, 1), (36, 1), (47, 1), (62, 1)] }, { coefficient := -1, powers := [(0, 1), (16, 1), (33, 1), (39, 1), (47, 1), (56, 1)] }, { coefficient := -1, powers := [(18, 1), (32, 1), (36, 1), (45, 1), (62, 1)] }, { coefficient := -1, powers := [(18, 1), (32, 1), (39, 1), (45, 1), (56, 1)] }]
]
...
#print axioms Krenn.X5Case274Tree.LeafB4_2.selectedHasNoCommonZero

end Krenn.X5Case274Tree.LeafB4_2
