...
namespace Krenn.X5Case274Tree.LeafB7_6

open Krenn.SparseCertificate
open MvPolynomial

def sourceSystemFileSHA256 : String := "a13736d665bc99919d01e62b440faca9ad54e560931466441e2a54053ed2f1d5"
def sourceSystemSemanticSHA256 : String := "1171e72c6c195d90d69f182bc15a972e9b8cff71c7d491621841ebdc80011ed8"
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedEquations : Fin 18 → SparsePoly (Fin 75) := ![
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def multipliers : Fin 18 → SparsePoly (Fin 75) := ![
...
#print axioms Krenn.X5Case274Tree.LeafB7_6.selectedHasNoCommonZero

end Krenn.X5Case274Tree.LeafB7_6
