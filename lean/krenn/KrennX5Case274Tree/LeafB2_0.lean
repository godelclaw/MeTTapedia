...
namespace Krenn.X5Case274Tree.LeafB2_0

open Krenn.SparseCertificate
open MvPolynomial

def sourceSystemFileSHA256 : String := "12ecc7d05bfc9136b1a9a44e9e24b0dd1e8c33813351ee3906644ce39d11092b"
def sourceSystemSemanticSHA256 : String := "f8f57dd28ab899577145cbabe05bf81efb111810ae2d79e804950f1d114a887e"
def certificateSHA256 : String := "14b9c76051b06eb544ffc0fea931f449f58c18b61be678da8a869ef2e021899d"
...
def multipliers : Fin 16 → SparsePoly (Fin 71) := ![
  ...
  [{ coefficient := 1, powers := [(33, 1), (36, 1), (52, 1), (62, 1), (67, 1)] }, { coefficient := 1, powers := [(33, 1), (36, 1), (58, 1), (61, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (33, 1), (36, 1), (62, 1), (64, 1)] }, { coefficient := -1, powers := [(18, 1), (32, 1), (36, 1), (45, 1), (62, 1)] }],
...
#print axioms Krenn.X5Case274Tree.LeafB2_0.selectedHasNoCommonZero

end Krenn.X5Case274Tree.LeafB2_0
