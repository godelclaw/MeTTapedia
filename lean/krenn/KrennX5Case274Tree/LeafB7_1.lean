...
namespace Krenn.X5Case274Tree.LeafB7_1

open Krenn.SparseCertificate
open MvPolynomial

def sourceSystemFileSHA256 : String := "8a6f042bf66ed718c642298fa60b785fd58e6e3c41b66ee0423ebfa175baf215"
def sourceSystemSemanticSHA256 : String := "252ade1c15e1c7a349548a8a410a9c07a5b198010151931707be3daffc761fd5"
def certificateSHA256 : String := "48ddeec84f61278a1ae0b292ff61e37f4e1c72ebab5634e4fe7bacf55580345f"
...
def multipliers : Fin 18 → SparsePoly (Fin 74) := ![
  ...
  [{ coefficient := -1, powers := [(0, 1), (16, 1), (33, 1), (36, 1), (47, 1), (62, 1)] }, { coefficient := -1, powers := [(18, 1), (32, 1), (36, 1), (45, 1), (62, 1)] }],
...
#print axioms Krenn.X5Case274Tree.LeafB7_1.selectedHasNoCommonZero

end Krenn.X5Case274Tree.LeafB7_1
