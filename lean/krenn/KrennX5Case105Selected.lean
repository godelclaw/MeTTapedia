...
namespace Krenn.X5Case105Selected

open Krenn.SparseCertificate
open MvPolynomial

def sourceSystemFileSHA256 : String := "7371b8eed32319ea33b90ebcd895dbf6ed263b47d69d9718a2f6a372e5da1431"
def sourceSystemSemanticSHA256 : String := "26a4eac0e4fd4dd1813ee21209b72f0634df003c6be8064599120ed23c1c457d"
def certificateSHA256 : String := "6b2781f4208b900863ee00e5de36c063918c3c8adf0c36b4ce436b29d2f62206"
...
def selectedEquations : Fin 32 → SparsePoly (Fin 70) := ![
  ...
  [{ coefficient := 1, powers := [(10, 1), (43, 1), (64, 1)] }, { coefficient := 1, powers := [(29, 1), (49, 1), (52, 1)] }, { coefficient := 1, powers := [(43, 1), (58, 1)] }],
...
def multipliers : Fin 32 → SparsePoly (Fin 70) := ![
  ...
  [{ coefficient := 1, powers := [(7, 1), (10, 1), (26, 1), (32, 1), (36, 1), (38, 1), (60, 1), (66, 1)] }, { coefficient := -1, powers := [(7, 1), (10, 1), (32, 1), (38, 1), (54, 1), (69, 1)] }, { coefficient := -1, powers := [(8, 1), (44, 1)] }, { coefficient := 1, powers := [(10, 1), (26, 1), (32, 1), (34, 1), (36, 1), (37, 1), (38, 1), (66, 1)] }, { coefficient := -1, powers := [(10, 1), (32, 1), (34, 1), (38, 1), (43, 1), (54, 1)] }, { coefficient := 1, powers := [(32, 1), (35, 1)] }],
  ...
  [{ coefficient := -1, powers := [(10, 1), (24, 1), (34, 1), (38, 1), (54, 1)] }],
  ...
  [{ coefficient := -1, powers := [(24, 1), (29, 1), (34, 1), (38, 1), (54, 1)] }],
  ...
  [{ coefficient := -1, powers := [(0, 1), (47, 1)] }, { coefficient := 1, powers := [(2, 1), (16, 1), (47, 1)] }, { coefficient := 1, powers := [(44, 1)] }],
...
#print axioms Krenn.X5Case105Selected.selectedHasNoCommonZero

end Krenn.X5Case105Selected
