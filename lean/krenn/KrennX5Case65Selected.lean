...
namespace Krenn.X5Case65Selected

open Krenn.SparseCertificate
open MvPolynomial

def sourceSystemFileSHA256 : String := "1e2ed26d14e8f9be915fd5c2b51163fff2912a20597ec815862347abed122876"
def sourceSystemSemanticSHA256 : String := "00f951e0a98520facc647e30147bf0d98a891e2f7ce9c0f46fe21290c1dd75ab"
def certificateSHA256 : String := "5cecd376e6de47b1f8a26fab78cd159d80fbf910bcb7c43c50b174f53ea96370"
...
def multipliers : Fin 17 → SparsePoly (Fin 70) := ![
  ...
  [{ coefficient := -1, powers := [(0, 1), (34, 1), (37, 1), (47, 1), (63, 1)] }, { coefficient := 1, powers := [(5, 1), (24, 1), (34, 1), (37, 1), (47, 1), (63, 1)] }],
...
#print axioms Krenn.X5Case65Selected.selectedHasNoCommonZero

end Krenn.X5Case65Selected
