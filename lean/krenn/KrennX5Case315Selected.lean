...
namespace Krenn.X5Case315Selected

open Krenn.SparseCertificate
open MvPolynomial

def sourceSystemFileSHA256 : String := "7374c60deef5e4e972b3bd3b1ddd02f6e4715cc833b54b5a45cf55731fea540b"
def sourceSystemSemanticSHA256 : String := "87c4b5c8f563798ecf81911f96acff18be272be77affe8d2322f2fdf912f2a9f"
...
def selectedEquations : Fin 18 → SparsePoly (Fin 70) := ![
  ...
  [{ coefficient := 1, powers := [(11, 1), (63, 1)] }, { coefficient := 1, powers := [(20, 1), (36, 1), (69, 1)] }, { coefficient := 1, powers := [(29, 1), (36, 1), (66, 1)] }],
...
#print axioms Krenn.X5Case315Selected.selectedHasNoCommonZero

end Krenn.X5Case315Selected
