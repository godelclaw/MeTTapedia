...
namespace Krenn.Component51.SelectedLeafB7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "2203b21b3f1fe7b62b14efddc0303e90eb25a7fcb12570295b1d5e4864d44923"
...
def multipliers : Fin 42 → SparsePoly (Fin 62) := ![
  ...
  [{ coefficient := 2, powers := [(2, 1), (27, 1), (45, 1), (55, 1), (61, 1)] }, { coefficient := -2, powers := [(23, 1), (43, 1), (55, 1)] }, { coefficient := -2, powers := [(23, 1), (54, 1), (55, 1)] }],
  [{ coefficient := -2, powers := [(13, 1), (23, 1), (54, 1)] }],
  [{ coefficient := -2, powers := [(2, 1), (39, 1), (55, 1)] }, { coefficient := -2, powers := [(2, 1), (43, 1), (55, 1)] }],
  [{ coefficient := 2, powers := [(0, 1), (8, 1), (18, 1), (31, 1), (61, 1)] }],
  ...
  [{ coefficient := -2, powers := [(0, 1), (2, 1), (40, 1), (55, 1), (61, 1)] }],
  [{ coefficient := -2, powers := [(0, 1), (2, 1), (50, 1), (55, 1), (61, 1)] }, { coefficient := 2, powers := [(6, 1), (51, 1), (58, 1)] }, { coefficient := 1, powers := [(35, 1), (51, 1), (58, 1)] }],
  [{ coefficient := -2, powers := [(0, 1), (8, 1), (31, 1), (46, 1), (61, 1)] }],
  [{ coefficient := -2, powers := [(2, 1), (24, 1), (45, 1), (55, 1), (61, 1)] }],
  ...
  [{ coefficient := 2, powers := [(0, 1), (2, 1), (18, 1), (55, 1), (61, 1)] }],
  [{ coefficient := 2, powers := [(6, 1), (18, 1), (58, 1)] }, { coefficient := -1, powers := [(18, 1), (35, 1), (58, 1)] }],
  [{ coefficient := 2, powers := [(0, 1), (8, 1), (31, 1), (59, 1)] }],
  [{ coefficient := 2, powers := [(2, 1), (3, 1), (5, 1), (31, 1), (40, 1), (55, 2), (57, 1), (61, 1)] }, { coefficient := 2, powers := [(2, 1), (5, 1), (31, 1), (35, 1), (40, 1), (55, 2), (57, 1), (61, 1)] }, { coefficient := 2, powers := [(5, 1), (31, 1), (55, 1), (61, 1)] }, { coefficient := 2, powers := [(8, 1), (34, 1), (40, 1), (61, 1)] }, { coefficient := 2, powers := [(37, 1), (58, 1)] }],
...
#print axioms Krenn.Component51.SelectedLeafB7.selectedHasNoCommonZero

end Krenn.Component51.SelectedLeafB7
