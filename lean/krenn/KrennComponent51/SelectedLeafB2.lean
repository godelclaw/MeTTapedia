...
namespace Krenn.Component51.SelectedLeafB2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "7a080640ecf3727b5b2c6068ae8b43a3ed164fbc0e86cfef7b874515a32d2ac0"
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedEquations : Fin 13 → SparsePoly (Fin 60) := ![
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def multipliers : Fin 13 → SparsePoly (Fin 60) := ![
...
#print axioms Krenn.Component51.SelectedLeafB2.selectedHasNoCommonZero

end Krenn.Component51.SelectedLeafB2
