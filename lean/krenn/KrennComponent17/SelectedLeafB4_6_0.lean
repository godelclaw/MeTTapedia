...
namespace Krenn.Component17.SelectedLeafB4_6_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "27fe96be20339cfe58d0105e606f10a7baf47edb38596b0e6b6c5dab9d0b7fb2"
def certificateSHA256 : String := "48587d913453b2fa1e9b9c798d10edcbafac38f29becfe98d32e57d33422b0b2"
...
def multipliers : Fin 31 → SparsePoly (Fin 62) := ![
  ...
  [{ coefficient := 1, powers := [(3, 1), (15, 1), (23, 1), (25, 1), (50, 2), (58, 1)] }, { coefficient := -1, powers := [(3, 1), (15, 1), (23, 1), (50, 1), (51, 1), (58, 1)] }, { coefficient := -1, powers := [(7, 1), (23, 1), (25, 1), (50, 1), (58, 1)] }, { coefficient := 1, powers := [(7, 1), (23, 1), (51, 1), (58, 1)] }],
  ...
  [{ coefficient := 1, powers := [(1, 1), (8, 1), (23, 1), (40, 1), (58, 1)] }, { coefficient := 1, powers := [(3, 1), (8, 1), (15, 1), (23, 1), (31, 1), (50, 1), (58, 1)] }, { coefficient := 1, powers := [(3, 1), (15, 1), (17, 1), (23, 1), (25, 1), (26, 1), (50, 1), (58, 1)] }, { coefficient := 1, powers := [(4, 1), (8, 1), (23, 1), (31, 1), (58, 1)] }, { coefficient := -1, powers := [(5, 1), (19, 1), (35, 1), (52, 1)] }, { coefficient := -1, powers := [(7, 1), (17, 1), (23, 1), (25, 1), (26, 1), (58, 1)] }, { coefficient := -1, powers := [(8, 1), (11, 1), (23, 1), (26, 1), (58, 1)] }, { coefficient := 1, powers := [(13, 1), (19, 1), (29, 1), (47, 1)] }, { coefficient := -1, powers := [(13, 1), (19, 1), (35, 1), (38, 1)] }],
...
#print axioms Krenn.Component17.SelectedLeafB4_6_0.selectedHasNoCommonZero

end Krenn.Component17.SelectedLeafB4_6_0
