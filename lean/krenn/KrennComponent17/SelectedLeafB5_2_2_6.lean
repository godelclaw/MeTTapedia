...
namespace Krenn.Component17.SelectedLeafB5_2_2_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "be74e69ecaf51f08b959701393c7b3820a85205608454e6291818e8f776178e5"
def certificateSHA256 : String := "89c2df7e836eba559d59379803095ccf473252ce74f796f529c236817485d5f8"
...
def multipliers : Fin 19 → SparsePoly (Fin 65) := ![
  ...
  [{ coefficient := -1, powers := [(2, 1), (52, 1), (64, 1)] }, { coefficient := -1, powers := [(17, 1), (27, 1), (52, 1), (64, 1)] }],
...
#print axioms Krenn.Component17.SelectedLeafB5_2_2_6.selectedHasNoCommonZero

end Krenn.Component17.SelectedLeafB5_2_2_6
