...
namespace Krenn.Component17.SelectedLeafB4_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "b955132640567aa73918649178b826cd2a3f0de12e14765e208643b731858c80"
def certificateSHA256 : String := "aa5d281d6fdf1bc07d5e633bca495e0463c40597adffb8d33d9149e603c928a9"

set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedSourceIndices : Fin 44 → Fin 608 := ![
  5,
  6,
  7,
  9,
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedEquations : Fin 44 → SparsePoly (Fin 61) := ![
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def multipliers : Fin 44 → SparsePoly (Fin 61) := ![
  ...
  [{ coefficient := 1, powers := [(13, 1), (23, 1), (38, 1), (57, 1), (60, 1)] }],
  ...
  [{ coefficient := -1, powers := [(35, 1), (38, 1), (41, 1), (44, 1), (60, 1)] }],
  [{ coefficient := -2, powers := [(5, 1), (34, 1), (35, 1), (37, 1), (52, 1), (60, 1)] }, { coefficient := -2, powers := [(8, 1), (21, 1), (23, 1), (50, 1), (58, 1), (60, 1)] }, { coefficient := -2, powers := [(8, 1), (21, 1), (23, 1), (54, 1), (58, 1), (60, 1)] }, { coefficient := -2, powers := [(8, 1), (21, 1), (35, 1), (41, 1), (50, 1), (60, 1)] }, { coefficient := -2, powers := [(8, 1), (21, 1), (35, 1), (41, 1), (54, 1), (60, 1)] }, { coefficient := -2, powers := [(8, 1), (23, 1), (34, 1), (37, 1), (58, 1), (60, 1)] }, { coefficient := -2, powers := [(8, 1), (34, 1), (35, 1), (37, 1), (41, 1), (60, 1)] }],
  ...
  [{ coefficient := 1, powers := [(3, 1), (5, 1), (29, 1), (50, 1), (57, 1), (58, 1), (60, 1)] }, { coefficient := -1, powers := [(3, 1), (5, 1), (29, 1), (57, 1), (58, 1), (59, 1), (60, 1)] }, { coefficient := -2, powers := [(3, 1), (7, 1), (17, 1), (21, 1), (35, 1), (46, 1), (50, 1), (52, 1), (57, 1), (60, 1)] }, { coefficient := -2, powers := [(3, 1), (7, 1), (17, 1), (21, 1), (35, 1), (46, 1), (52, 1), (54, 1), (57, 1), (60, 1)] }, { coefficient := 2, powers := [(5, 1), (25, 1), (32, 1), (45, 1), (59, 1), (60, 1)] }, { coefficient := 1, powers := [(5, 1), (29, 1), (50, 1), (58, 1), (60, 1)] }, { coefficient := -1, powers := [(5, 1), (29, 1), (58, 1), (59, 1), (60, 1)] }, { coefficient := 2, powers := [(5, 1), (32, 1), (45, 1), (51, 1), (60, 1)] }, { coefficient := 2, powers := [(13, 1), (23, 1), (25, 1), (45, 1), (59, 1), (60, 1)] }, { coefficient := 2, powers := [(13, 1), (23, 1), (45, 1), (51, 1), (60, 1)] }, { coefficient := -1, powers := [(13, 1), (32, 1), (36, 1), (38, 1), (47, 1), (50, 1), (57, 1), (60, 2)] }],
  [{ coefficient := 2, powers := [(4, 1), (8, 1), (23, 1), (57, 1), (58, 1), (60, 1)] }, { coefficient := 2, powers := [(4, 1), (8, 1), (35, 1), (41, 1), (57, 1), (60, 1)] }, { coefficient := -2, powers := [(5, 1), (15, 1), (35, 1), (44, 1), (52, 1), (60, 1)] }, { coefficient := -2, powers := [(8, 1), (11, 1), (23, 1), (44, 1), (58, 1), (60, 1)] }, { coefficient := -2, powers := [(8, 1), (11, 1), (35, 1), (41, 1), (44, 1), (60, 1)] }, { coefficient := -2, powers := [(8, 1), (15, 1), (23, 1), (44, 1), (58, 1), (60, 1)] }, { coefficient := -2, powers := [(8, 1), (15, 1), (35, 1), (41, 1), (44, 1), (60, 1)] }],
  [{ coefficient := -2, powers := [(4, 1), (17, 1), (35, 1), (52, 1)] }],
  [{ coefficient := 2, powers := [(5, 1), (25, 1), (32, 1), (59, 1), (60, 1)] }, { coefficient := 2, powers := [(13, 1), (23, 1), (25, 1), (59, 1), (60, 1)] }, { coefficient := 1, powers := [(13, 1), (27, 1), (38, 1), (57, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(13, 1), (38, 1), (47, 1), (57, 1), (60, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (35, 1), (38, 1), (41, 1), (60, 1)] }],
  [{ coefficient := 2, powers := [(3, 1), (7, 1), (21, 1), (35, 1), (46, 1), (50, 1), (52, 1), (57, 1)] }, { coefficient := 2, powers := [(3, 1), (7, 1), (21, 1), (35, 1), (46, 1), (52, 1), (54, 1), (57, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (19, 1), (29, 1), (58, 1), (59, 1), (60, 1)] }, { coefficient := 1, powers := [(13, 1), (35, 1), (38, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(13, 1), (32, 1), (36, 1), (38, 1), (50, 1), (57, 1), (60, 1)] }],
  ...
  [{ coefficient := -1, powers := [(13, 1), (32, 1), (36, 1), (38, 1), (57, 1), (60, 1)] }],
  ...
  [{ coefficient := -1, powers := [(13, 1), (38, 1), (57, 1), (60, 1)] }],
  ...
  [{ coefficient := 1, powers := [(13, 1), (35, 1), (38, 1), (41, 1), (60, 1)] }],
  ...
  [{ coefficient := 1, powers := [(5, 1), (19, 1), (29, 1), (41, 1), (54, 1), (58, 1), (60, 1)] }, { coefficient := 2, powers := [(5, 1), (25, 1), (32, 1), (45, 1)] }, { coefficient := -1, powers := [(5, 1), (29, 1), (58, 1)] }, { coefficient := 2, powers := [(13, 1), (23, 1), (25, 1), (45, 1)] }],
  [{ coefficient := 2, powers := [(5, 1), (35, 1), (37, 1), (52, 1), (57, 1)] }, { coefficient := 2, powers := [(5, 1), (35, 1), (44, 1), (52, 1), (54, 1)] }, { coefficient := 2, powers := [(8, 1), (23, 1), (37, 1), (57, 1), (58, 1)] }, { coefficient := -2, powers := [(8, 1), (23, 1), (44, 1), (50, 1), (58, 1)] }, { coefficient := 2, powers := [(8, 1), (35, 1), (37, 1), (41, 1), (57, 1)] }, { coefficient := -2, powers := [(8, 1), (35, 1), (41, 1), (44, 1), (50, 1)] }],
  [{ coefficient := 2, powers := [(38, 1), (58, 1)] }, { coefficient := 2, powers := [(41, 1), (55, 1)] }],
  [{ coefficient := -2, powers := [(0, 1), (5, 1), (32, 1), (55, 1)] }, { coefficient := -2, powers := [(0, 1), (13, 1), (23, 1), (55, 1)] }, { coefficient := 2, powers := [(1, 1), (5, 1), (35, 1), (52, 1), (54, 1)] }, { coefficient := 2, powers := [(1, 1), (8, 1), (23, 1), (54, 1), (58, 1)] }, { coefficient := 2, powers := [(1, 1), (8, 1), (35, 1), (41, 1), (54, 1)] }, { coefficient := 2, powers := [(5, 1), (7, 1), (34, 1), (35, 1), (52, 1)] }, { coefficient := 2, powers := [(5, 1), (24, 1), (25, 1), (32, 1), (43, 1), (59, 1)] }, { coefficient := 2, powers := [(5, 1), (24, 1), (32, 1), (43, 1), (51, 1)] }, { coefficient := -2, powers := [(5, 1), (25, 1), (32, 1), (43, 1)] }, { coefficient := -2, powers := [(8, 1), (11, 1), (23, 1), (26, 1), (58, 1)] }, { coefficient := -2, powers := [(8, 1), (11, 1), (26, 1), (35, 1), (41, 1)] }, { coefficient := 2, powers := [(13, 1), (23, 1), (24, 1), (25, 1), (43, 1), (59, 1)] }, { coefficient := 2, powers := [(13, 1), (23, 1), (24, 1), (43, 1), (51, 1)] }, { coefficient := -2, powers := [(13, 1), (23, 1), (25, 1), (43, 1)] }, { coefficient := -1, powers := [(13, 1), (24, 1), (35, 1), (38, 1), (41, 1), (60, 1)] }],
  [{ coefficient := -1, powers := [(3, 1), (5, 1), (24, 1), (29, 1), (50, 1), (57, 1), (58, 1)] }, { coefficient := 1, powers := [(3, 1), (5, 1), (24, 1), (29, 1), (57, 1), (58, 1), (59, 1)] }, { coefficient := 2, powers := [(3, 1), (7, 1), (17, 1), (21, 1), (24, 1), (35, 1), (46, 1), (50, 1), (52, 1), (57, 1)] }, { coefficient := 2, powers := [(3, 1), (7, 1), (17, 1), (21, 1), (24, 1), (35, 1), (46, 1), (52, 1), (54, 1), (57, 1)] }, { coefficient := -2, powers := [(4, 1), (8, 1), (23, 1), (26, 1), (57, 1), (58, 1)] }, { coefficient := -2, powers := [(4, 1), (8, 1), (26, 1), (35, 1), (41, 1), (57, 1)] }, { coefficient := 2, powers := [(5, 1), (15, 1), (26, 1), (35, 1), (44, 1), (52, 1)] }, { coefficient := 2, powers := [(5, 1), (15, 1), (34, 1), (35, 1), (37, 1), (52, 1)] }, { coefficient := 1, powers := [(5, 1), (19, 1), (29, 1), (54, 1), (58, 1)] }, { coefficient := 1, powers := [(5, 1), (19, 1), (29, 1), (58, 1), (59, 1)] }, { coefficient := -2, powers := [(5, 1), (24, 1), (25, 1), (32, 1), (45, 1), (59, 1)] }, { coefficient := -1, powers := [(5, 1), (24, 1), (29, 1), (50, 1), (58, 1)] }, { coefficient := 1, powers := [(5, 1), (24, 1), (29, 1), (58, 1), (59, 1)] }, { coefficient := -2, powers := [(5, 1), (24, 1), (32, 1), (45, 1), (51, 1)] }, { coefficient := -2, powers := [(5, 1), (25, 1), (32, 1), (43, 1), (59, 1)] }, { coefficient := 2, powers := [(8, 1), (11, 1), (23, 1), (26, 1), (44, 1), (58, 1)] }, { coefficient := 2, powers := [(8, 1), (11, 1), (26, 1), (35, 1), (41, 1), (44, 1)] }, { coefficient := 2, powers := [(8, 1), (15, 1), (21, 1), (23, 1), (50, 1), (58, 1)] }, { coefficient := 2, powers := [(8, 1), (15, 1), (21, 1), (23, 1), (54, 1), (58, 1)] }, { coefficient := 2, powers := [(8, 1), (15, 1), (21, 1), (35, 1), (41, 1), (50, 1)] }, { coefficient := 2, powers := [(8, 1), (15, 1), (21, 1), (35, 1), (41, 1), (54, 1)] }, { coefficient := 2, powers := [(8, 1), (15, 1), (23, 1), (26, 1), (44, 1), (58, 1)] }, { coefficient := 2, powers := [(8, 1), (15, 1), (23, 1), (34, 1), (37, 1), (58, 1)] }, { coefficient := 2, powers := [(8, 1), (15, 1), (26, 1), (35, 1), (41, 1), (44, 1)] }, { coefficient := 2, powers := [(8, 1), (15, 1), (34, 1), (35, 1), (37, 1), (41, 1)] }, { coefficient := -2, powers := [(13, 1), (23, 1), (24, 1), (25, 1), (45, 1), (59, 1)] }, { coefficient := -2, powers := [(13, 1), (23, 1), (24, 1), (45, 1), (51, 1)] }, { coefficient := -2, powers := [(13, 1), (23, 1), (25, 1), (43, 1), (59, 1)] }, { coefficient := 1, powers := [(13, 1), (24, 1), (32, 1), (36, 1), (38, 1), (47, 1), (50, 1), (57, 1), (60, 1)] }, { coefficient := -2, powers := [(13, 1), (35, 1), (38, 1)] }]
]
...
#print axioms Krenn.Component17.SelectedLeafB4_1.selectedHasNoCommonZero

end Krenn.Component17.SelectedLeafB4_1
