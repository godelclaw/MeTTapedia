...
namespace Krenn.Component17.SelectedLeafB4_2_3_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "6b5f00b9704101cce0fbcdd185cb4f5957e0056ee72a333febacd9296b55fef0"
def certificateSHA256 : String := "6f2598463bae87d6e34b1c3cd445cb79eb0df0b26ff0094d0bab6b3d4940be45"

set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedSourceIndices : Fin 28 → Fin 614 := ![
  7,
  8,
  14,
  18,
...
def multipliers : Fin 28 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := -1, powers := [(5, 1), (21, 1), (26, 1), (31, 1), (54, 1), (55, 1), (64, 2)] }, { coefficient := 1, powers := [(5, 1), (21, 1), (26, 1), (55, 1), (57, 1), (64, 1)] }, { coefficient := -1, powers := [(5, 1), (26, 2), (44, 1), (55, 1), (57, 1), (61, 1), (64, 1)] }, { coefficient := 1, powers := [(5, 1), (26, 1), (34, 1), (40, 1), (55, 1), (64, 1)] }, { coefficient := -1, powers := [(5, 1), (26, 1), (34, 1), (44, 1), (50, 1), (55, 1), (61, 1), (64, 1)] }, { coefficient := -1, powers := [(5, 1), (26, 1), (34, 1), (44, 1), (55, 1), (64, 1)] }, { coefficient := 1, powers := [(5, 1), (26, 1), (44, 1), (55, 1), (57, 1), (61, 1)] }],
  [{ coefficient := 2, powers := [(23, 1), (55, 1), (63, 1)] }, { coefficient := 1, powers := [(35, 1), (38, 1), (63, 1)] }],
  ...
  [{ coefficient := 1, powers := [(5, 1), (11, 1), (26, 1), (34, 1), (55, 1), (64, 1)] }, { coefficient := -1, powers := [(5, 1), (15, 1), (26, 2), (55, 1), (57, 1), (61, 1), (64, 1)] }, { coefficient := -1, powers := [(5, 1), (15, 1), (26, 1), (31, 1), (55, 1), (64, 1)] }, { coefficient := -1, powers := [(5, 1), (15, 1), (26, 1), (34, 1), (50, 1), (55, 1), (61, 1), (64, 1)] }, { coefficient := -2, powers := [(5, 1), (15, 1), (26, 1), (34, 1), (55, 1), (64, 1)] }, { coefficient := 1, powers := [(5, 1), (15, 1), (26, 1), (55, 1), (57, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (26, 1), (32, 1), (54, 1), (55, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (21, 1), (26, 1), (32, 1), (54, 1), (55, 1), (64, 2)] }],
  [{ coefficient := 1, powers := [(29, 1)] }],
  [{ coefficient := 1, powers := [(18, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (15, 1), (26, 1), (32, 1), (55, 1), (65, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (26, 2), (55, 1), (57, 1), (61, 1), (64, 1)] }, { coefficient := 1, powers := [(5, 1), (26, 1), (31, 1), (55, 1), (64, 1)] }, { coefficient := 1, powers := [(5, 1), (26, 1), (34, 1), (50, 1), (55, 1), (61, 1), (64, 1)] }, { coefficient := 1, powers := [(5, 1), (26, 1), (34, 1), (55, 1), (64, 1)] }, { coefficient := -1, powers := [(5, 1), (26, 1), (55, 1), (57, 1), (61, 1)] }],
  [{ coefficient := 2, powers := [(8, 1), (58, 1)] }],
  [{ coefficient := 1, powers := [(52, 1)] }],
  [{ coefficient := -1, powers := [(23, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (26, 1), (32, 1), (55, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (26, 1), (29, 1), (32, 1), (55, 1), (65, 1)] }, { coefficient := 1, powers := [(5, 1), (26, 1), (32, 1), (55, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (15, 1), (26, 1), (32, 1), (55, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (26, 1), (32, 1), (55, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := -1, powers := [(5, 1), (21, 1), (26, 1), (32, 1), (50, 1), (54, 1), (55, 1), (64, 2)] }, { coefficient := 1, powers := [(5, 1), (26, 1), (32, 1), (37, 1), (55, 1), (57, 1), (64, 1)] }, { coefficient := 1, powers := [(5, 1), (26, 1), (32, 1), (40, 1), (54, 1), (55, 1), (64, 1)] }, { coefficient := 1, powers := [(5, 1), (26, 1), (32, 1), (44, 1), (50, 1), (55, 1), (64, 1)] }, { coefficient := 1, powers := [(5, 1), (26, 1), (32, 1), (44, 1), (54, 1), (55, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(38, 1), (58, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (55, 1)] }, { coefficient := 1, powers := [(8, 1), (35, 1)] }, { coefficient := -1, powers := [(18, 1), (29, 1)] }],
  [{ coefficient := -1, powers := [(4, 1), (5, 1), (26, 2), (32, 1), (55, 1), (57, 1), (64, 1)] }, { coefficient := -1, powers := [(4, 1), (5, 1), (26, 1), (32, 1), (34, 1), (50, 1), (55, 1), (64, 1)] }, { coefficient := 1, powers := [(4, 1), (5, 1), (26, 1), (32, 1), (55, 1), (57, 1)] }],
  [{ coefficient := -2, powers := [(13, 1), (23, 1), (55, 1)] }, { coefficient := -1, powers := [(13, 1), (35, 1), (38, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (11, 1), (21, 1), (26, 1), (32, 1), (54, 1), (55, 1), (64, 1)] }, { coefficient := 1, powers := [(5, 1), (11, 1), (26, 1), (32, 1), (44, 1), (55, 1)] }, { coefficient := -1, powers := [(5, 1), (15, 1), (26, 1), (32, 1), (44, 1), (55, 1)] }, { coefficient := -1, powers := [(5, 1), (32, 1), (55, 1)] }, { coefficient := 2, powers := [(8, 1), (27, 1), (46, 1), (58, 1)] }, { coefficient := -1, powers := [(8, 1), (32, 1), (47, 1)] }, { coefficient := 1, powers := [(17, 1), (27, 1), (47, 1), (52, 1)] }],
...
#print axioms Krenn.Component17.SelectedLeafB4_2_3_7.selectedHasNoCommonZero

end Krenn.Component17.SelectedLeafB4_2_3_7
