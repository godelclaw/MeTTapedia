...
namespace Krenn.Component17.SelectedLeafB4_2_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "5749733e5ec840d4e21b7edecae3e5b859af3a4e6acd7fb19d21d72de3d91e65"
def certificateSHA256 : String := "df71cdc692065145a54824eec0302abd79b2a4a69babe5d8fb700e6db7610277"

set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedSourceIndices : Fin 35 → Fin 611 := ![
  6,
  9,
  18,
  25,
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedEquations : Fin 35 → SparsePoly (Fin 62) := ![
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def multipliers : Fin 35 → SparsePoly (Fin 62) := ![
  [{ coefficient := 1, powers := [(7, 1), (32, 1), (40, 1), (55, 1)] }, { coefficient := 1, powers := [(11, 1), (32, 1), (37, 1), (55, 1)] }, { coefficient := -1, powers := [(15, 1), (32, 1), (37, 1), (55, 1)] }],
  [{ coefficient := -2, powers := [(6, 1), (15, 1), (23, 1), (50, 2), (58, 1)] }, { coefficient := 2, powers := [(7, 1), (23, 1), (40, 1), (58, 1)] }, { coefficient := 2, powers := [(7, 1), (23, 1), (44, 1), (58, 1)] }, { coefficient := -2, powers := [(11, 1), (23, 1), (37, 1), (58, 1)] }, { coefficient := 2, powers := [(15, 1), (23, 1), (36, 1), (44, 1), (50, 2), (58, 1), (60, 1)] }, { coefficient := -2, powers := [(15, 1), (23, 1), (36, 1), (50, 2), (58, 1)] }, { coefficient := 2, powers := [(15, 1), (23, 1), (37, 1), (58, 1)] }],
  [{ coefficient := 1, powers := [(23, 1), (25, 1)] }],
  [{ coefficient := 2, powers := [(3, 1), (15, 1), (23, 1), (25, 1), (50, 2), (58, 1)] }, { coefficient := -2, powers := [(3, 1), (15, 1), (23, 1), (50, 1), (51, 1), (58, 1)] }, { coefficient := -1, powers := [(3, 1), (15, 1), (32, 1), (44, 1), (46, 1), (55, 1)] }, { coefficient := -1, powers := [(4, 1), (32, 1), (46, 1), (55, 1)] }, { coefficient := -2, powers := [(7, 1), (23, 1), (25, 1), (50, 1), (58, 1)] }, { coefficient := 2, powers := [(7, 1), (23, 1), (51, 1), (58, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (7, 1), (32, 1), (43, 1), (55, 1), (57, 1), (61, 1)] }, { coefficient := -2, powers := [(7, 1), (17, 1), (23, 1), (58, 1)] }, { coefficient := 2, powers := [(8, 1), (11, 1), (23, 1), (43, 1), (50, 1), (58, 1), (61, 1)] }, { coefficient := -2, powers := [(8, 1), (15, 1), (23, 1), (36, 1), (43, 1), (50, 2), (57, 1), (58, 1), (60, 1), (61, 1)] }, { coefficient := 2, powers := [(15, 1), (17, 1), (23, 1), (36, 1), (50, 2), (58, 1), (60, 1)] }],
  [{ coefficient := -1, powers := [(17, 1), (47, 1)] }],
  [{ coefficient := 1, powers := [(18, 1), (20, 1)] }],
  [{ coefficient := -1, powers := [(27, 1), (52, 1)] }],
  [{ coefficient := 2, powers := [(23, 1), (55, 1)] }, { coefficient := -1, powers := [(29, 1), (47, 1)] }, { coefficient := 1, powers := [(35, 1), (38, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (7, 1), (32, 1), (55, 1), (57, 1), (61, 1)] }, { coefficient := -2, powers := [(8, 1), (11, 1), (23, 1), (50, 1), (58, 1), (61, 1)] }, { coefficient := 2, powers := [(8, 1), (15, 1), (23, 1), (36, 1), (50, 2), (57, 1), (58, 1), (60, 1), (61, 1)] }],
  [{ coefficient := 2, powers := [(8, 1), (23, 1), (50, 1), (58, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (32, 1), (44, 1), (55, 1)] }, { coefficient := -2, powers := [(8, 1), (23, 1), (40, 1), (58, 1)] }, { coefficient := -2, powers := [(8, 1), (23, 1), (44, 1), (58, 1)] }],
  ...
  [{ coefficient := 2, powers := [(8, 1), (15, 1), (23, 1), (50, 2), (58, 1)] }],
  [{ coefficient := 2, powers := [(3, 1), (15, 1), (23, 1), (26, 1), (50, 1), (58, 1)] }, { coefficient := -2, powers := [(7, 1), (23, 1), (26, 1), (58, 1)] }],
  [{ coefficient := -1, powers := [(23, 1)] }],
  [{ coefficient := -2, powers := [(3, 1), (15, 1), (23, 1), (25, 1), (26, 1), (50, 1), (58, 1)] }, { coefficient := 2, powers := [(7, 1), (23, 1), (25, 1), (26, 1), (58, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (15, 1), (32, 1), (44, 1), (55, 1)] }, { coefficient := -2, powers := [(8, 1), (15, 1), (23, 1), (50, 1), (58, 1)] }],
  [{ coefficient := 1, powers := [(3, 1), (15, 1), (32, 1), (44, 1), (55, 1)] }, { coefficient := 1, powers := [(4, 1), (32, 1), (55, 1)] }],
  [{ coefficient := 2, powers := [(7, 1), (23, 1), (58, 1)] }, { coefficient := -2, powers := [(15, 1), (23, 1), (36, 1), (50, 2), (58, 1), (60, 1)] }],
  [{ coefficient := 2, powers := [(8, 1), (23, 1), (26, 1), (58, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (15, 1), (32, 1), (55, 1)] }, { coefficient := 2, powers := [(8, 1), (11, 1), (23, 1), (58, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (32, 1), (55, 1)] }, { coefficient := -2, powers := [(8, 1), (23, 1), (58, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := 1, powers := [(5, 1), (32, 1), (37, 1), (55, 1), (57, 1)] }, { coefficient := 2, powers := [(8, 1), (23, 1), (37, 1), (57, 1), (58, 1)] }, { coefficient := 2, powers := [(8, 1), (23, 1), (40, 1), (50, 1), (58, 1)] }, { coefficient := 2, powers := [(8, 1), (23, 1), (44, 1), (50, 1), (58, 1)] }],
  [{ coefficient := 1, powers := [(20, 1), (45, 1), (52, 1)] }, { coefficient := 1, powers := [(38, 1), (58, 1)] }, { coefficient := -1, powers := [(47, 1), (52, 1)] }],
  [{ coefficient := 2, powers := [(8, 1), (15, 1), (23, 1), (34, 1), (36, 1), (50, 2), (58, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (55, 1)] }, { coefficient := 1, powers := [(8, 1), (35, 1)] }, { coefficient := -1, powers := [(18, 1), (29, 1)] }],
  [{ coefficient := 1, powers := [(1, 1), (5, 1), (32, 1), (40, 1), (55, 1)] }, { coefficient := 2, powers := [(1, 1), (8, 1), (23, 1), (40, 1), (58, 1)] }, { coefficient := 2, powers := [(3, 1), (8, 1), (15, 1), (23, 1), (31, 1), (50, 1), (58, 1)] }, { coefficient := 2, powers := [(3, 1), (15, 1), (17, 1), (23, 1), (25, 1), (26, 1), (50, 1), (58, 1)] }, { coefficient := 2, powers := [(4, 1), (8, 1), (23, 1), (31, 1), (58, 1)] }, { coefficient := 1, powers := [(5, 1), (11, 1), (21, 1), (32, 1), (55, 1)] }, { coefficient := -1, powers := [(5, 1), (15, 1), (21, 1), (32, 1), (55, 1)] }, { coefficient := -2, powers := [(7, 1), (17, 1), (23, 1), (25, 1), (26, 1), (58, 1)] }, { coefficient := -2, powers := [(8, 1), (11, 1), (23, 1), (26, 1), (58, 1)] }, { coefficient := -2, powers := [(13, 1), (19, 1), (23, 1), (55, 1)] }, { coefficient := 1, powers := [(13, 1), (19, 1), (29, 1), (47, 1)] }, { coefficient := -1, powers := [(13, 1), (19, 1), (35, 1), (38, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (7, 1), (21, 1), (32, 1), (55, 1), (57, 1)] }, { coefficient := 2, powers := [(8, 1), (11, 1), (21, 1), (23, 1), (50, 1), (58, 1)] }, { coefficient := -2, powers := [(8, 1), (15, 1), (21, 1), (23, 1), (36, 1), (50, 2), (57, 1), (58, 1), (60, 1)] }]
]
...
#print axioms Krenn.Component17.SelectedLeafB4_2_1.selectedHasNoCommonZero

end Krenn.Component17.SelectedLeafB4_2_1
