...
namespace Krenn.Component17.SelectedLeafB4_2_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "99604ee530a9af35413dda2edb5272842dba45a1678aae54279075b135c5108a"
def certificateSHA256 : String := "23874ffbd7f0ea13eab9f5dafee2abbbcbd3d78c11208d4e6eb1ba3af6b4c0e6"
...
def multipliers : Fin 17 → SparsePoly (Fin 63) := ![
  ...
  [{ coefficient := -1, powers := [(23, 1), (55, 1), (61, 1)] }, { coefficient := -1, powers := [(29, 1), (47, 1), (61, 1)] }, { coefficient := 1, powers := [(35, 1), (38, 1), (61, 1)] }],
  [{ coefficient := 2, powers := [(18, 1), (23, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(23, 1), (43, 1), (52, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(17, 1), (47, 1)] }],
  [{ coefficient := -2, powers := [(18, 1), (52, 1), (61, 1)] }],
  ...
  [{ coefficient := -1, powers := [(2, 1), (53, 1), (55, 1), (61, 1)] }, { coefficient := 1, powers := [(2, 1), (55, 1)] }, { coefficient := 1, powers := [(8, 1), (35, 1)] }, { coefficient := -1, powers := [(18, 1), (29, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (32, 1), (55, 1)] }, { coefficient := 1, powers := [(13, 1), (29, 1), (47, 1)] }, { coefficient := -1, powers := [(13, 1), (35, 1), (38, 1)] }, { coefficient := -1, powers := [(17, 1), (23, 1), (43, 1), (52, 1)] }, { coefficient := 2, powers := [(18, 1), (23, 1), (52, 1)] }]
]
...
#print axioms Krenn.Component17.SelectedLeafB4_2_5.selectedHasNoCommonZero

end Krenn.Component17.SelectedLeafB4_2_5
