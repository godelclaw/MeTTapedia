...
namespace Krenn.Component17.SelectedLeafB4_2_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "81cf0074e3e2fcaf87e35a1d452fcf7194c48d9695869b1bed6bcfa2e4eea752"
def certificateSHA256 : String := "6517814eca1513057cb8b73a2ac12b3a90f11a647c34ab939f629b80418810fb"

set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedSourceIndices : Fin 23 → Fin 611 := ![
  14,
  17,
  18,
  32,
...
def multipliers : Fin 23 → SparsePoly (Fin 62) := ![
  ...
  [{ coefficient := 2, powers := [(20, 1), (29, 1), (59, 1)] }, { coefficient := -1, powers := [(23, 1), (51, 1)] }],
  [{ coefficient := -1, powers := [(23, 1), (25, 1)] }],
  [{ coefficient := -1, powers := [(17, 1), (47, 1)] }],
  [{ coefficient := 1, powers := [(18, 1), (20, 1)] }],
  [{ coefficient := 2, powers := [(17, 1), (23, 1), (43, 1), (59, 1)] }, { coefficient := -2, powers := [(18, 1), (23, 1), (59, 1)] }],
  [{ coefficient := -1, powers := [(27, 1), (52, 1)] }],
  [{ coefficient := 2, powers := [(23, 1), (52, 1), (59, 1)] }],
  [{ coefficient := -2, powers := [(17, 1), (23, 1), (52, 1), (59, 1)] }],
  ...
  [{ coefficient := -2, powers := [(5, 1), (29, 1), (58, 1)] }, { coefficient := 2, powers := [(18, 1), (23, 1), (52, 1)] }],
...
#print axioms Krenn.Component17.SelectedLeafB4_2_2.selectedHasNoCommonZero

end Krenn.Component17.SelectedLeafB4_2_2
