...
namespace Krenn.Component17.SelectedLeafB5_2_3_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "8ecef2a3f2c2aa09840bb2edba694aff6618f7f3c6d0008d05cc2ed5586741a3"
def certificateSHA256 : String := "a2321d3aa9abf1a77bef6f01a39a1911a523f355482b61ec95914a4ccbba14fb"
...
def multipliers : Fin 30 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := 1, powers := [(23, 1), (55, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(23, 1), (25, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (7, 1), (32, 1), (43, 1), (55, 1), (57, 1), (63, 1)] }, { coefficient := -1, powers := [(5, 1), (11, 1), (32, 1), (43, 1), (54, 1), (55, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(17, 1), (47, 1)] }],
  [{ coefficient := -1, powers := [(3, 1), (15, 1), (17, 1), (32, 1), (44, 1), (55, 1)] }, { coefficient := -1, powers := [(4, 1), (17, 1), (32, 1), (55, 1)] }, { coefficient := -2, powers := [(8, 1), (27, 1), (58, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (52, 1), (65, 1)] }, { coefficient := -1, powers := [(17, 1), (27, 1), (52, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (43, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (7, 1), (32, 1), (55, 1), (57, 1), (63, 1)] }, { coefficient := 1, powers := [(5, 1), (11, 1), (32, 1), (54, 1), (55, 1), (63, 1)] }],
  ...
  [{ coefficient := 1, powers := [(2, 1), (38, 1), (58, 1), (65, 1)] }, { coefficient := -1, powers := [(5, 1), (15, 1), (32, 1), (44, 1), (55, 1)] }],
  ...
  [{ coefficient := -1, powers := [(2, 1), (38, 1), (58, 1)] }, { coefficient := 1, powers := [(2, 1), (47, 1), (52, 1)] }, { coefficient := 2, powers := [(8, 1), (27, 1), (46, 1), (58, 1)] }, { coefficient := 1, powers := [(17, 1), (27, 1), (47, 1), (52, 1)] }],
...
#print axioms Krenn.Component17.SelectedLeafB5_2_3_6.selectedHasNoCommonZero

end Krenn.Component17.SelectedLeafB5_2_3_6
