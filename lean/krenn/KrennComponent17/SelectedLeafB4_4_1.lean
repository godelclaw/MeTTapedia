...
namespace Krenn.Component17.SelectedLeafB4_4_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "d6d9d3383db725f506f3448e4f82f986c94a1320bb2f168853975624d66c9854"
def certificateSHA256 : String := "0364d016dd178189dabb6f469072344a02b7d5be1571afd7daee6b9db9d7cfbf"
...
def multipliers : Fin 31 → SparsePoly (Fin 62) := ![
  ...
  [{ coefficient := -1, powers := [(5, 1), (7, 1), (32, 1), (43, 1), (55, 1), (57, 1), (61, 1)] }],
  ...
  [{ coefficient := 1, powers := [(5, 1), (7, 1), (32, 1), (55, 1), (57, 1), (61, 1)] }],
...
#print axioms Krenn.Component17.SelectedLeafB4_4_1.selectedHasNoCommonZero

end Krenn.Component17.SelectedLeafB4_4_1
