...
namespace Krenn.Component17.SelectedLeafB1_6_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "1d9c4eb53833c90c6f47510b1ba0a7b3c801399c8418fde0f1639d172eaee11c"
def certificateSHA256 : String := "0a7bf94fff4ebb4f637d48a6193e704d5727955479eeb664ace90830e4dcf288"
...
def multipliers : Fin 17 → SparsePoly (Fin 65) := ![
  ...
  [{ coefficient := 1, powers := [(23, 1), (36, 1), (55, 1), (57, 1), (62, 1)] }, { coefficient := 1, powers := [(29, 1), (36, 1), (47, 1), (57, 1), (62, 1)] }],
  ...
  [{ coefficient := -1, powers := [(36, 1), (55, 1), (57, 1), (62, 1)] }],
  ...
  [{ coefficient := 1, powers := [(2, 1), (36, 1), (53, 1), (55, 1), (57, 1), (62, 1)] }, { coefficient := -1, powers := [(2, 1), (36, 1), (55, 1), (57, 1)] }, { coefficient := -1, powers := [(8, 1), (35, 1), (36, 1), (57, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (32, 1), (36, 1), (55, 1), (57, 1)] }, { coefficient := -1, powers := [(13, 1), (29, 1), (36, 1), (47, 1), (57, 1)] }, { coefficient := 1, powers := [(17, 1), (22, 1), (59, 1)] }, { coefficient := 1, powers := [(17, 1), (27, 1), (59, 1)] }]
]
...
#print axioms Krenn.Component17.SelectedLeafB1_6_7.selectedHasNoCommonZero

end Krenn.Component17.SelectedLeafB1_6_7
