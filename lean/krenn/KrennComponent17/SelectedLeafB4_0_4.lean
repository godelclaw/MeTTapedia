...
namespace Krenn.Component17.SelectedLeafB4_0_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "f98d89f6c509e60ac6e4298b01462a9b0925a801ef2a2925b0a70a39b0113df0"
def certificateSHA256 : String := "96f627a5826cdd02d8b2c7a7c3644f05c3dfe5750bee8cedb87f09ccf7907a67"
...
def multipliers : Fin 27 → SparsePoly (Fin 61) := ![
  ...
  [{ coefficient := -1, powers := [(29, 1), (47, 1), (60, 1)] }, { coefficient := 1, powers := [(35, 1), (38, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(4, 1), (23, 1), (25, 1), (26, 1), (50, 1), (58, 1), (60, 1)] }, { coefficient := -1, powers := [(4, 1), (23, 1), (26, 1), (51, 1), (58, 1), (60, 1)] }],
...
#print axioms Krenn.Component17.SelectedLeafB4_0_4.selectedHasNoCommonZero

end Krenn.Component17.SelectedLeafB4_0_4
