...
namespace Krenn.Component17.SelectedLeafB5_2_2_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "09e910db79b58d4885eea564b1870cb2b46e30160adce805ff46f8802e84d77f"
...
def multipliers : Fin 19 → SparsePoly (Fin 64) := ![
  ...
  [{ coefficient := -1, powers := [(13, 1), (29, 1), (43, 1), (63, 1)] }],
  ...
  [{ coefficient := -1, powers := [(0, 1), (2, 1), (41, 1), (59, 1)] }, { coefficient := 1, powers := [(2, 1), (41, 1)] }, { coefficient := 1, powers := [(5, 1), (32, 1)] }, { coefficient := -1, powers := [(13, 1), (23, 1), (29, 1), (63, 1)] }],
...
#print axioms Krenn.Component17.SelectedLeafB5_2_2_1.selectedHasNoCommonZero

end Krenn.Component17.SelectedLeafB5_2_2_1
