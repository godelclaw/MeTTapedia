...
namespace Krenn.Component17.SelectedLeafB3_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "2dafc8364e0e8e6892018c1ecbdedd9d4a6c261bd92e90addd135af4d5c00bf2"
def certificateSHA256 : String := "b6f20a6f0c5c150f5cb49cea7837fb3dc68966da08969b296da59f7a350dbffc"
...
def multipliers : Fin 26 → SparsePoly (Fin 63) := ![
  ...
  [{ coefficient := 1, powers := [(5, 1), (24, 1), (32, 1), (40, 1), (43, 1), (59, 1)] }, { coefficient := 1, powers := [(5, 1), (24, 1), (32, 1), (43, 1), (44, 1), (59, 1)] }, { coefficient := 1, powers := [(5, 1), (32, 1), (43, 1), (59, 1)] }, { coefficient := -1, powers := [(13, 1), (23, 1), (43, 1), (59, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (47, 1), (59, 1)] }, { coefficient := -1, powers := [(5, 1), (27, 1), (43, 1), (57, 1), (59, 1)] }, { coefficient := -1, powers := [(5, 1), (35, 1), (36, 1), (57, 1), (59, 1)] }, { coefficient := 1, powers := [(5, 1), (35, 1), (59, 1)] }, { coefficient := -1, powers := [(18, 1), (23, 1), (59, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (29, 1), (57, 1)] }],
  [{ coefficient := -1, powers := [(23, 1), (25, 1)] }],
  [{ coefficient := -1, powers := [(17, 1), (47, 1)] }],
  [{ coefficient := 1, powers := [(13, 1), (23, 1), (43, 1), (59, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (23, 1), (59, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (32, 1), (40, 1), (51, 1)] }, { coefficient := -1, powers := [(5, 1), (32, 1), (44, 1), (51, 1)] }],
  ...
  [{ coefficient := 1, powers := [(5, 1), (32, 1), (40, 1)] }, { coefficient := 1, powers := [(5, 1), (32, 1), (44, 1)] }],
  ...
  [{ coefficient := 1, powers := [(5, 1), (19, 1), (32, 1), (37, 1), (55, 1), (57, 1)] }, { coefficient := 1, powers := [(5, 1), (19, 1), (32, 1), (40, 1), (54, 1), (55, 1)] }, { coefficient := 1, powers := [(5, 1), (19, 1), (32, 1), (44, 1), (50, 1), (55, 1)] }, { coefficient := 1, powers := [(5, 1), (32, 1), (43, 1), (44, 1), (51, 1)] }, { coefficient := -1, powers := [(5, 1), (32, 1), (50, 1), (55, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (38, 1), (58, 1)] }, { coefficient := -1, powers := [(5, 1), (24, 1), (32, 1), (40, 1), (43, 1), (51, 1)] }, { coefficient := -1, powers := [(5, 1), (24, 1), (32, 1), (43, 1), (44, 1), (51, 1)] }, { coefficient := 1, powers := [(5, 1), (27, 1), (43, 1), (52, 1), (57, 1)] }, { coefficient := -1, powers := [(5, 1), (32, 1), (43, 1), (51, 1)] }, { coefficient := 1, powers := [(5, 1), (35, 1), (36, 1), (52, 1), (57, 1)] }, { coefficient := -1, powers := [(5, 1), (35, 1), (52, 1)] }, { coefficient := 1, powers := [(13, 1), (23, 1), (39, 1), (55, 1), (61, 1)] }, { coefficient := 1, powers := [(13, 1), (23, 1), (43, 1), (51, 1)] }, { coefficient := 2, powers := [(13, 1), (29, 1), (47, 1)] }, { coefficient := 1, powers := [(18, 1), (23, 1), (52, 1)] }],
...
#print axioms Krenn.Component17.SelectedLeafB3_6.selectedHasNoCommonZero

end Krenn.Component17.SelectedLeafB3_6
