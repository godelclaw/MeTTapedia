...
namespace Krenn.Component17.SelectedLeafB4_6_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "1c96839dda7dfb75b10aab160bae514c3388ff26e5aa0a52cacdbff2633997f2"
def certificateSHA256 : String := "a87c49b7648b5c204548c3e89c072e78006803ff2cce2946a0b74d7401a8c72e"
...
def multipliers : Fin 36 → SparsePoly (Fin 63) := ![
  ...
  [{ coefficient := -2, powers := [(6, 1), (15, 1), (23, 1), (50, 2), (58, 1)] }, { coefficient := 2, powers := [(7, 1), (23, 1), (40, 1), (58, 1)] }, { coefficient := 2, powers := [(7, 1), (23, 1), (44, 1), (58, 1)] }, { coefficient := -2, powers := [(11, 1), (23, 1), (37, 1), (58, 1)] }, { coefficient := -2, powers := [(15, 1), (23, 1), (36, 1), (50, 2), (58, 1)] }, { coefficient := 2, powers := [(15, 1), (23, 1), (37, 1), (58, 1)] }],
  ...
  [{ coefficient := -1, powers := [(5, 1), (7, 1), (32, 1), (43, 1), (55, 1), (57, 1), (62, 1)] }, { coefficient := -2, powers := [(7, 1), (17, 1), (23, 1), (58, 1)] }, { coefficient := 2, powers := [(8, 1), (11, 1), (23, 1), (43, 1), (50, 1), (58, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(17, 1), (47, 1)] }],
  [{ coefficient := 1, powers := [(18, 1), (20, 1)] }],
  [{ coefficient := -2, powers := [(15, 1), (23, 1), (36, 1), (50, 2), (58, 1), (60, 1)] }],
  ...
  [{ coefficient := 1, powers := [(5, 1), (7, 1), (32, 1), (55, 1), (57, 1), (62, 1)] }, { coefficient := -2, powers := [(8, 1), (11, 1), (23, 1), (50, 1), (58, 1), (62, 1)] }],
  ...
  [{ coefficient := 2, powers := [(7, 1), (23, 1), (58, 1)] }],
  ...
  [{ coefficient := -1, powers := [(5, 1), (7, 1), (21, 1), (32, 1), (55, 1), (57, 1)] }, { coefficient := 2, powers := [(8, 1), (11, 1), (21, 1), (23, 1), (50, 1), (58, 1)] }]
]
...
#print axioms Krenn.Component17.SelectedLeafB4_6_1.selectedHasNoCommonZero

end Krenn.Component17.SelectedLeafB4_6_1
