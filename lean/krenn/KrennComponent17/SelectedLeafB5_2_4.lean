...
namespace Krenn.Component17.SelectedLeafB5_2_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "c733922fa86b5494edccdb00a712a0f782635ce7e4492601ac0110ba714b1ec6"
...
def multipliers : Fin 20 → SparsePoly (Fin 63) := ![
  ...
  [{ coefficient := -1, powers := [(2, 1), (22, 1), (38, 1), (58, 1), (60, 1), (62, 1)] }, { coefficient := -1, powers := [(2, 1), (27, 1), (38, 1), (58, 1), (60, 1), (62, 1)] }, { coefficient := -1, powers := [(8, 1), (22, 1), (23, 1), (58, 1), (60, 1), (62, 1)] }, { coefficient := -1, powers := [(8, 1), (23, 1), (27, 1), (58, 1), (60, 1), (62, 1)] }],
...
#print axioms Krenn.Component17.SelectedLeafB5_2_4.selectedHasNoCommonZero

end Krenn.Component17.SelectedLeafB5_2_4
