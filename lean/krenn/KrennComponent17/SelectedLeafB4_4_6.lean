...
namespace Krenn.Component17.SelectedLeafB4_4_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "f84395ee325305165e12ed91a866cf8b6af406dcadd5f664c0a40d2eade55bd7"
def certificateSHA256 : String := "67f9dce39d2a7248d8babb650b0a7cdd0c5ee70488f729e0f67a64ce8f32c5d9"
...
def multipliers : Fin 17 → SparsePoly (Fin 63) := ![
  ...
  [{ coefficient := 2, powers := [(23, 1), (24, 1), (45, 1), (52, 1), (61, 1)] }, { coefficient := 1, powers := [(23, 1), (43, 1), (52, 1), (61, 1)] }],
  ...
  [{ coefficient := 1, powers := [(13, 1), (29, 1), (47, 1)] }, { coefficient := -1, powers := [(13, 1), (35, 1), (38, 1)] }, { coefficient := -2, powers := [(17, 1), (23, 1), (24, 1), (45, 1), (52, 1)] }, { coefficient := -1, powers := [(17, 1), (23, 1), (43, 1), (52, 1)] }],
...
#print axioms Krenn.Component17.SelectedLeafB4_4_6.selectedHasNoCommonZero

end Krenn.Component17.SelectedLeafB4_4_6
