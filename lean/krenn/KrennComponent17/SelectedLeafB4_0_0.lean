...
namespace Krenn.Component17.SelectedLeafB4_0_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "6aa259f809ff24715ef9aedf4cea307236b6d8bafa709921363e3fa204c34e45"
def certificateSHA256 : String := "e6daa49e7a652a298e4ae2e469bf19d7b2e579e2db2248c43363d1e0990c786b"

set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedSourceIndices : Fin 21 → Fin 611 := ![
  18,
  32,
  202,
  206,
...
def multipliers : Fin 21 → SparsePoly (Fin 60) := ![
  ...
  [{ coefficient := 2, powers := [(18, 1), (19, 1), (23, 1), (52, 1)] }, { coefficient := 2, powers := [(18, 1), (23, 1), (24, 1), (52, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (35, 1)] }, { coefficient := -1, powers := [(18, 1), (29, 1)] }],
  [{ coefficient := 1, powers := [(13, 1), (19, 1), (29, 1), (47, 1)] }, { coefficient := -1, powers := [(13, 1), (19, 1), (35, 1), (38, 1)] }, { coefficient := -1, powers := [(13, 1), (23, 1), (25, 1), (43, 1)] }],
...
#print axioms Krenn.Component17.SelectedLeafB4_0_0.selectedHasNoCommonZero

end Krenn.Component17.SelectedLeafB4_0_0
