...
namespace Krenn.Component17.SelectedLeafB4_2_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "1c949111ae5276ec946209a7cab20fe3664a280ccd30b3be7283c9babe532914"
def certificateSHA256 : String := "b51dadcf8c3036a8d8b8bdc05730a7b73278b288ca3b37c1ae61989a5eb034d9"
...
def multipliers : Fin 31 → SparsePoly (Fin 61) := ![
  ...
  [{ coefficient := 1, powers := [(15, 1), (23, 1), (25, 1), (36, 1), (50, 3), (58, 1), (60, 1)] }],
  ...
  [{ coefficient := 1, powers := [(1, 1), (8, 1), (23, 1), (40, 1), (58, 1)] }, { coefficient := 1, powers := [(3, 1), (8, 1), (15, 1), (23, 1), (31, 1), (50, 1), (58, 1)] }, { coefficient := 1, powers := [(3, 1), (15, 1), (17, 1), (23, 1), (25, 1), (26, 1), (50, 1), (58, 1)] }, { coefficient := 1, powers := [(4, 1), (8, 1), (23, 1), (31, 1), (58, 1)] }, { coefficient := -1, powers := [(5, 1), (19, 1), (35, 1), (52, 1)] }, { coefficient := -1, powers := [(7, 1), (17, 1), (23, 1), (25, 1), (26, 1), (58, 1)] }, { coefficient := -1, powers := [(8, 1), (11, 1), (23, 1), (26, 1), (58, 1)] }, { coefficient := 1, powers := [(13, 1), (19, 1), (29, 1), (47, 1)] }, { coefficient := -1, powers := [(13, 1), (19, 1), (35, 1), (38, 1)] }, { coefficient := 1, powers := [(15, 1), (17, 1), (21, 1), (23, 1), (25, 1), (36, 1), (50, 2), (58, 1), (60, 1)] }],
...
#print axioms Krenn.Component17.SelectedLeafB4_2_0.selectedHasNoCommonZero

end Krenn.Component17.SelectedLeafB4_2_0
