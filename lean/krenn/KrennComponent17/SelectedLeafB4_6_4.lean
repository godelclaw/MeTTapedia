...
namespace Krenn.Component17.SelectedLeafB4_6_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "a238d90d55b1e36ace390ff6fc365883e34ffa627e37662a3434f0d78f604e1a"
def certificateSHA256 : String := "1177d8009b7e9bdcc41321dadffffc1a2a0b08695900fb70299454323a8b827d"
...
def multipliers : Fin 32 → SparsePoly (Fin 63) := ![
  ...
  [{ coefficient := -1, powers := [(6, 1), (15, 1), (23, 1), (50, 2), (58, 1)] }, { coefficient := 1, powers := [(7, 1), (23, 1), (40, 1), (58, 1)] }, { coefficient := 1, powers := [(7, 1), (23, 1), (44, 1), (58, 1)] }, { coefficient := -1, powers := [(11, 1), (23, 1), (37, 1), (58, 1)] }, { coefficient := -1, powers := [(15, 1), (23, 1), (36, 1), (50, 2), (58, 1)] }, { coefficient := 1, powers := [(15, 1), (23, 1), (37, 1), (58, 1)] }],
  [{ coefficient := -1, powers := [(29, 1), (47, 1), (62, 1)] }, { coefficient := 1, powers := [(35, 1), (38, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(3, 1), (15, 1), (23, 1), (25, 1), (26, 1), (50, 2), (58, 1), (62, 1)] }, { coefficient := -1, powers := [(3, 1), (15, 1), (23, 1), (26, 1), (50, 1), (51, 1), (58, 1), (62, 1)] }, { coefficient := -1, powers := [(7, 1), (23, 1), (25, 1), (26, 1), (50, 1), (58, 1), (62, 1)] }, { coefficient := 1, powers := [(7, 1), (23, 1), (26, 1), (51, 1), (58, 1), (62, 1)] }],
  ...
  [{ coefficient := -1, powers := [(15, 1), (23, 1), (36, 1), (50, 2), (58, 1), (60, 1)] }],
  ...
  [{ coefficient := 1, powers := [(3, 1), (15, 1), (23, 1), (26, 1), (50, 1), (58, 1)] }, { coefficient := -1, powers := [(7, 1), (23, 1), (26, 1), (58, 1)] }],
  [{ coefficient := -1, powers := [(3, 1), (15, 1), (23, 1), (25, 1), (26, 1), (50, 1), (58, 1)] }, { coefficient := 1, powers := [(7, 1), (23, 1), (25, 1), (26, 1), (58, 1)] }],
  ...
  [{ coefficient := -1, powers := [(3, 1), (15, 1), (17, 1), (23, 1), (25, 1), (26, 1), (50, 2), (58, 1)] }, { coefficient := 1, powers := [(3, 1), (15, 1), (17, 1), (23, 1), (26, 1), (50, 1), (51, 1), (58, 1)] }, { coefficient := 1, powers := [(7, 1), (17, 1), (23, 1), (25, 1), (26, 1), (50, 1), (58, 1)] }, { coefficient := -1, powers := [(7, 1), (17, 1), (23, 1), (26, 1), (51, 1), (58, 1)] }, { coefficient := 1, powers := [(13, 1), (29, 1), (47, 1)] }, { coefficient := -1, powers := [(13, 1), (35, 1), (38, 1)] }],
  [{ coefficient := 1, powers := [(1, 1), (8, 1), (23, 1), (40, 1), (58, 1)] }, { coefficient := 1, powers := [(3, 1), (8, 1), (15, 1), (23, 1), (31, 1), (50, 1), (58, 1)] }, { coefficient := 1, powers := [(3, 1), (15, 1), (17, 1), (23, 1), (25, 1), (26, 1), (50, 1), (58, 1)] }, { coefficient := 1, powers := [(4, 1), (8, 1), (23, 1), (31, 1), (58, 1)] }, { coefficient := -1, powers := [(5, 1), (19, 1), (35, 1), (52, 1)] }, { coefficient := -1, powers := [(7, 1), (17, 1), (23, 1), (25, 1), (26, 1), (58, 1)] }, { coefficient := -1, powers := [(8, 1), (11, 1), (23, 1), (26, 1), (58, 1)] }],
...
#print axioms Krenn.Component17.SelectedLeafB4_6_4.selectedHasNoCommonZero

end Krenn.Component17.SelectedLeafB4_6_4
