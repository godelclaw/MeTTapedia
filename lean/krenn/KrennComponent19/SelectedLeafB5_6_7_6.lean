...
namespace Krenn.Component19.SelectedLeafB5_6_7_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "a6ad0091bcc9eb94252b073d42bf6a376b02d473fbaa87d133210811f91b6390"
def certificateSHA256 : String := "8608f60e077062d63a85e6cad27310b7031176224ea0dfb084b5d8b492cbb534"
...
def multipliers : Fin 25 → SparsePoly (Fin 71) := ![
  [{ coefficient := 1, powers := [(14, 1), (25, 1), (58, 1), (66, 1), (69, 1)] }, { coefficient := -1, powers := [(25, 1), (58, 1), (69, 1)] }],
  ...
  [{ coefficient := -1, powers := [(13, 1), (14, 1), (25, 1), (58, 1), (66, 1)] }, { coefficient := 1, powers := [(13, 1), (25, 1), (58, 1)] }],
...
#print axioms Krenn.Component19.SelectedLeafB5_6_7_6.selectedHasNoCommonZero

end Krenn.Component19.SelectedLeafB5_6_7_6
