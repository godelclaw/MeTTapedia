...
namespace Krenn.Component19.SelectedLeafB5_2_1_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "77c7d1ba112839c5758946b60c8f35b4bd353956738e1c0f91f8c9bd6085584b"
def certificateSHA256 : String := "c491bb09c838863c5e17e1a68164eb4fc4c75abddbeb2ae626857e14395e7618"
...
def multipliers : Fin 24 → SparsePoly (Fin 68) := ![
  ...
  [{ coefficient := -1, powers := [(19, 1), (50, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (46, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (55, 1), (62, 1)] }, { coefficient := -1, powers := [(13, 1), (32, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(25, 1), (58, 1)] }, { coefficient := -1, powers := [(32, 1), (50, 1)] }, { coefficient := 1, powers := [(38, 1), (39, 1), (41, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(32, 1)] }],
  [{ coefficient := 1, powers := [(20, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (24, 1), (35, 1), (58, 1), (63, 1)] }, { coefficient := -1, powers := [(5, 1), (30, 1), (35, 1), (58, 1), (63, 1)] }, { coefficient := -1, powers := [(24, 1), (41, 1), (61, 1)] }, { coefficient := -1, powers := [(30, 1), (41, 1), (61, 1)] }],
  [{ coefficient := -2, powers := [(25, 1), (55, 1)] }, { coefficient := 1, powers := [(35, 1), (39, 1), (41, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(55, 1)] }],
  [{ coefficient := 1, powers := [(50, 1)] }],
  [{ coefficient := 1, powers := [(25, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (35, 1), (58, 1), (63, 1)] }, { coefficient := 1, powers := [(41, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(41, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(13, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := 1, powers := [(2, 1), (50, 1), (55, 1)] }, { coefficient := 1, powers := [(13, 1), (32, 1), (50, 1)] }],
  ...
  [{ coefficient := 1, powers := [(13, 1), (21, 1), (25, 1), (58, 1)] }, { coefficient := 1, powers := [(13, 1), (21, 1), (32, 1), (50, 1)] }, { coefficient := -1, powers := [(13, 1), (21, 1), (38, 1), (39, 1), (41, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (50, 1), (55, 1), (62, 1)] }, { coefficient := 1, powers := [(5, 1), (19, 1), (24, 1), (35, 1), (43, 1), (58, 1), (63, 1)] }, { coefficient := 1, powers := [(5, 1), (19, 1), (24, 1), (35, 1), (48, 1), (58, 1), (63, 1)] }, { coefficient := 1, powers := [(5, 1), (19, 1), (30, 1), (35, 1), (43, 1), (58, 1), (63, 1)] }, { coefficient := 1, powers := [(5, 1), (19, 1), (30, 1), (35, 1), (48, 1), (58, 1), (63, 1)] }, { coefficient := 1, powers := [(13, 1), (32, 1), (50, 1), (62, 1)] }, { coefficient := 1, powers := [(19, 1), (24, 1), (41, 1), (43, 1), (61, 1)] }, { coefficient := 1, powers := [(19, 1), (24, 1), (41, 1), (48, 1), (61, 1)] }, { coefficient := 2, powers := [(19, 1), (25, 1), (49, 1), (55, 1)] }, { coefficient := 1, powers := [(19, 1), (30, 1), (41, 1), (43, 1), (61, 1)] }, { coefficient := 1, powers := [(19, 1), (30, 1), (41, 1), (48, 1), (61, 1)] }, { coefficient := -1, powers := [(19, 1), (35, 1), (39, 1), (41, 1), (49, 1), (60, 1)] }, { coefficient := 2, powers := [(20, 1), (25, 1), (43, 1), (55, 1)] }, { coefficient := -1, powers := [(20, 1), (35, 1), (39, 1), (41, 1), (43, 1), (60, 1)] }]
]
...
#print axioms Krenn.Component19.SelectedLeafB5_2_1_3.selectedHasNoCommonZero

end Krenn.Component19.SelectedLeafB5_2_1_3
