...
namespace Krenn.Component19.SelectedLeafB5_6_7_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "eec33d5a3baab298858024012208b1ee020230f2bdcc4b5115ee3a640559ad94"
...
def multipliers : Fin 30 → SparsePoly (Fin 70) := ![
  [{ coefficient := 1, powers := [(14, 1), (25, 1), (58, 1), (66, 1), (69, 1)] }, { coefficient := -1, powers := [(25, 1), (58, 1), (69, 1)] }, { coefficient := -2, powers := [(27, 1), (30, 1), (48, 1), (50, 1), (69, 1)] }],
  ...
  [{ coefficient := -2, powers := [(19, 1), (21, 1), (46, 1), (50, 1), (55, 1), (68, 1)] }],
  ...
  [{ coefficient := 2, powers := [(19, 1), (21, 1), (50, 1), (55, 1), (68, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := -1, powers := [(2, 1), (41, 1), (61, 1)] }, { coefficient := -1, powers := [(2, 1), (50, 1), (55, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (2, 1), (58, 1), (62, 1)] }, { coefficient := -1, powers := [(2, 1), (27, 1), (46, 1), (62, 1)] }, { coefficient := -1, powers := [(2, 1), (56, 1), (58, 1), (66, 1)] }, { coefficient := 1, powers := [(2, 1), (58, 1)] }, { coefficient := 1, powers := [(8, 1), (38, 1)] }, { coefficient := -1, powers := [(18, 1), (30, 1), (58, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (35, 1), (58, 1)] }],
  [{ coefficient := -2, powers := [(19, 1), (21, 1), (31, 1), (50, 1), (55, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (14, 1), (25, 1), (58, 1), (66, 1)] }, { coefficient := 1, powers := [(13, 1), (25, 1), (58, 1)] }, { coefficient := 2, powers := [(13, 1), (27, 1), (30, 1), (48, 1), (50, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (61, 1)] }, { coefficient := -1, powers := [(13, 1), (50, 1)] }, { coefficient := 2, powers := [(19, 1), (21, 1), (46, 1), (48, 1), (50, 1), (55, 1), (68, 1)] }, { coefficient := -2, powers := [(19, 1), (21, 1), (49, 1), (50, 1), (55, 1), (68, 1)] }]
]
...
#print axioms Krenn.Component19.SelectedLeafB5_6_7_4.selectedHasNoCommonZero

end Krenn.Component19.SelectedLeafB5_6_7_4
