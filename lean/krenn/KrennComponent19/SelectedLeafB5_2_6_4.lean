...
namespace Krenn.Component19.SelectedLeafB5_2_6_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "3f922294fffcfa39954a8439efdbcc9a692092d62fe27334e6229a141241a3ef"
...
def multipliers : Fin 39 → SparsePoly (Fin 68) := ![
  ...
  [{ coefficient := 1, powers := [(2, 1), (21, 1), (53, 1), (55, 1), (67, 1)] }, { coefficient := 1, powers := [(2, 1), (21, 1), (55, 1), (62, 1), (67, 1)] }],
  ...
  [{ coefficient := -1, powers := [(2, 1), (21, 1), (55, 1), (67, 1)] }],
  ...
  [{ coefficient := 1, powers := [(2, 1), (21, 1), (41, 1), (53, 1), (61, 1)] }, { coefficient := 1, powers := [(2, 1), (21, 1), (41, 1), (57, 1), (61, 1)] }, { coefficient := 1, powers := [(2, 1), (21, 1), (48, 1), (50, 1), (55, 1)] }, { coefficient := 1, powers := [(2, 1), (21, 1), (50, 1), (53, 1), (55, 1)] }, { coefficient := 1, powers := [(2, 1), (21, 1), (50, 1), (55, 1), (57, 1)] }, { coefficient := -1, powers := [(2, 1), (21, 1), (50, 1), (55, 1), (67, 1)] }],
...
#print axioms Krenn.Component19.SelectedLeafB5_2_6_4.selectedHasNoCommonZero

end Krenn.Component19.SelectedLeafB5_2_6_4
