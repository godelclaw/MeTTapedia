...
namespace Krenn.Component19.SelectedLeafB5_6_6_5_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "a9908e08707bc3dc41f9a34699a1545ed67bc768f8c0599b2c9b275734060201"
def certificateSHA256 : String := "8e66d106c59eca28769c9855485f362e70a014b43f9329bdf2da42fca7e674db"

set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedSourceIndices : Fin 13 → Fin 678 := ![
  2,
  7,
  20,
  22,
...
def multipliers : Fin 13 → SparsePoly (Fin 71) := ![
  [{ coefficient := 1, powers := [(38, 1), (55, 1), (70, 1)] }],
  [{ coefficient := -1, powers := [(32, 1), (50, 1), (68, 1)] }],
  ...
  [{ coefficient := -1, powers := [(5, 1), (38, 1), (55, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (41, 1)] }, { coefficient := 1, powers := [(5, 1), (32, 1)] }, { coefficient := 1, powers := [(8, 1), (25, 1)] }]
]
...
#print axioms Krenn.Component19.SelectedLeafB5_6_6_5_2.selectedHasNoCommonZero

end Krenn.Component19.SelectedLeafB5_6_6_5_2
