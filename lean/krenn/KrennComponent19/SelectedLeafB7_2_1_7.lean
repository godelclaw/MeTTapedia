...
namespace Krenn.Component19.SelectedLeafB7_2_1_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "dcee37e8ceae013f698ff7ac5faad17051da3670fbda08d40d0e1fd72d8e8518"
def certificateSHA256 : String := "b46c65bf5ce39181f93dffe5419800f13907f470eb76e68407ad61b0990d2cb1"
...
def multipliers : Fin 29 → SparsePoly (Fin 70) := ![
  [{ coefficient := 1, powers := [(3, 1), (32, 1), (61, 1)] }, { coefficient := -1, powers := [(3, 1), (35, 1), (58, 1)] }, { coefficient := -2, powers := [(3, 1), (38, 1), (55, 1)] }],
  [{ coefficient := 1, powers := [(3, 1), (25, 1), (58, 1), (60, 1), (67, 1)] }, { coefficient := 1, powers := [(3, 1), (32, 1), (50, 1), (60, 1), (67, 1)] }],
  ...
  [{ coefficient := -1, powers := [(2, 1), (3, 1), (55, 1), (60, 1), (68, 1)] }, { coefficient := 1, powers := [(3, 1), (13, 1), (32, 1), (60, 1), (68, 1)] }],
  [{ coefficient := 1, powers := [(22, 1), (54, 1), (63, 1), (69, 1)] }],
  [{ coefficient := -1, powers := [(11, 1), (54, 1), (63, 1), (69, 1)] }],
  [{ coefficient := 1, powers := [(3, 1), (19, 1), (27, 1), (61, 1)] }],
  [{ coefficient := -1, powers := [(24, 1), (63, 1), (69, 1)] }],
  ...
  [{ coefficient := 1, powers := [(24, 1), (54, 1), (69, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (3, 1), (58, 1), (60, 1)] }, { coefficient := -1, powers := [(3, 1), (8, 1), (38, 1), (60, 1)] }, { coefficient := 1, powers := [(3, 1), (20, 1), (32, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(21, 1), (32, 1), (69, 1)] }, { coefficient := -1, powers := [(21, 1)] }],
  [{ coefficient := -1, powers := [(3, 1), (13, 1), (25, 1), (58, 1), (60, 1)] }, { coefficient := -1, powers := [(3, 1), (13, 1), (32, 1), (50, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (3, 1), (50, 1), (55, 1), (60, 1)] }, { coefficient := -1, powers := [(3, 1), (13, 1), (32, 1), (50, 1), (60, 1)] }],
...
#print axioms Krenn.Component19.SelectedLeafB7_2_1_7.selectedHasNoCommonZero

end Krenn.Component19.SelectedLeafB7_2_1_7
