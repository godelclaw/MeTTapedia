...
namespace Krenn.Component19.SelectedLeafB5_6_7_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "bd639e5edeb2dec442a7b3b86b77f0230d55d5364d0adc3e38904ee944b6ebf7"
def certificateSHA256 : String := "00354d79a5c1105d9076b41b21f9c54e0e4826c63217cdef98f80621bf896bac"
...
def multipliers : Fin 22 → SparsePoly (Fin 70) := ![
  ...
  [{ coefficient := -1, powers := [(0, 1), (2, 1), (58, 1), (62, 1)] }, { coefficient := -1, powers := [(2, 1), (27, 1), (46, 1), (62, 1)] }, { coefficient := -1, powers := [(2, 1), (57, 1), (58, 1), (67, 1)] }, { coefficient := 1, powers := [(2, 1), (58, 1)] }, { coefficient := 1, powers := [(8, 1), (38, 1)] }, { coefficient := -1, powers := [(19, 1), (31, 1), (58, 1), (67, 1)] }],
  [{ coefficient := 2, powers := [(13, 1), (25, 1), (58, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (35, 1), (58, 1)] }, { coefficient := -1, powers := [(13, 1), (25, 1), (58, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (21, 1), (50, 1), (55, 1), (62, 2)] }, { coefficient := 1, powers := [(2, 1), (50, 1), (55, 1), (62, 1)] }, { coefficient := 2, powers := [(13, 1), (25, 1), (47, 1), (58, 1), (66, 1)] }, { coefficient := 2, powers := [(19, 1), (25, 1), (49, 1), (55, 1)] }, { coefficient := 2, powers := [(20, 1), (25, 1), (43, 1), (55, 1)] }],
...
#print axioms Krenn.Component19.SelectedLeafB5_6_7_2.selectedHasNoCommonZero

end Krenn.Component19.SelectedLeafB5_6_7_2
