...
namespace Krenn.Component19.SelectedLeafB7_6_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "902a788955d34e77a5cb648c17b1a012db13c6f81a96a732174bf4fd84c17850"
def certificateSHA256 : String := "046c1db44091a9fb90393d08fb66fe119cf4db07ab1c946b7a9f3999e33eb301"
...
def multipliers : Fin 28 → SparsePoly (Fin 69) := ![
  ...
  [{ coefficient := -2, powers := [(0, 1), (53, 1), (58, 1), (67, 1)] }, { coefficient := -2, powers := [(21, 1), (53, 1), (58, 1), (67, 1)] }, { coefficient := -2, powers := [(21, 1), (58, 1)] }, { coefficient := -1, powers := [(58, 1), (67, 1)] }],
  ...
  [{ coefficient := 2, powers := [(0, 1), (2, 1), (53, 1), (57, 1), (58, 1), (67, 1)] }, { coefficient := -1, powers := [(0, 1), (2, 1), (58, 1), (62, 1)] }, { coefficient := 2, powers := [(0, 1), (19, 1), (31, 1), (53, 1), (58, 1), (67, 1)] }, { coefficient := 2, powers := [(2, 1), (21, 1), (53, 1), (57, 1), (58, 1), (67, 1)] }, { coefficient := 2, powers := [(2, 1), (21, 1), (57, 1), (58, 1)] }, { coefficient := -1, powers := [(2, 1), (27, 1), (46, 1), (62, 1)] }, { coefficient := 1, powers := [(2, 1), (57, 1), (58, 1), (67, 1)] }, { coefficient := 1, powers := [(2, 1), (58, 1)] }, { coefficient := 1, powers := [(8, 1), (38, 1)] }, { coefficient := 2, powers := [(19, 1), (21, 1), (31, 1), (53, 1), (58, 1), (67, 1)] }, { coefficient := 2, powers := [(19, 1), (21, 1), (31, 1), (58, 1)] }, { coefficient := 1, powers := [(19, 1), (31, 1), (58, 1), (67, 1)] }, { coefficient := -1, powers := [(20, 1), (32, 1)] }],
...
#print axioms Krenn.Component19.SelectedLeafB7_6_3.selectedHasNoCommonZero

end Krenn.Component19.SelectedLeafB7_6_3
