...
namespace Krenn.Component19.SelectedLeafB4_6_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "357854df036a357152fed01d74841de9a02afbee08d3492f70eb9399cf9fe788"
...
def multipliers : Fin 24 → SparsePoly (Fin 68) := ![
  [{ coefficient := 2, powers := [(25, 1), (47, 1), (58, 1), (65, 1)] }, { coefficient := 2, powers := [(32, 1), (47, 1), (50, 1), (65, 1)] }],
  ...
  [{ coefficient := -2, powers := [(25, 1), (58, 1), (65, 1)] }, { coefficient := -2, powers := [(32, 1), (50, 1), (65, 1)] }],
...
#print axioms Krenn.Component19.SelectedLeafB4_6_7.selectedHasNoCommonZero

end Krenn.Component19.SelectedLeafB4_6_7
