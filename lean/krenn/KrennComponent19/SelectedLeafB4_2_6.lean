...
namespace Krenn.Component19.SelectedLeafB4_2_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "12019360ba15d426c519785e58be6b0ac6fdc52c402d31c647b4a9100253e1fd"
...
def multipliers : Fin 25 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := -2, powers := [(24, 1), (47, 1), (50, 1), (54, 1), (64, 1)] }],
  ...
  [{ coefficient := 2, powers := [(24, 1), (50, 1), (54, 1), (64, 1)] }],
...
#print axioms Krenn.Component19.SelectedLeafB4_2_6.selectedHasNoCommonZero

end Krenn.Component19.SelectedLeafB4_2_6
