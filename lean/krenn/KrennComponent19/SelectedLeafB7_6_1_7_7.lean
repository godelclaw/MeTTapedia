...
namespace Krenn.Component19.SelectedLeafB7_6_1_7_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "34d4b08c274da57a50bcccb748084d397c752b9a9364eda1db216dadd0cdc50c"
...
def multipliers : Fin 21 → SparsePoly (Fin 74) := ![
  [{ coefficient := 1, powers := [(0, 1), (35, 1), (58, 1), (62, 1), (72, 1)] }, { coefficient := 2, powers := [(0, 1), (38, 1), (55, 1), (62, 1), (72, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (25, 1), (58, 1), (62, 1), (68, 1)] }, { coefficient := -1, powers := [(0, 1), (32, 1), (50, 1), (62, 1), (68, 1)] }],
  ...
  [{ coefficient := 1, powers := [(0, 1), (2, 1), (55, 1), (62, 1), (69, 1)] }, { coefficient := -1, powers := [(0, 1), (13, 1), (32, 1), (62, 1), (69, 1)] }, { coefficient := 1, powers := [(2, 1), (21, 1), (55, 1), (62, 1), (69, 1)] }],
...
#print axioms Krenn.Component19.SelectedLeafB7_6_1_7_7.selectedHasNoCommonZero

end Krenn.Component19.SelectedLeafB7_6_1_7_7
