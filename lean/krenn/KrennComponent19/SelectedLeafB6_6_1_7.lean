...
namespace Krenn.Component19.SelectedLeafB6_6_1_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "0a151f4078471aa04b1b2f201a3c90a0ce667bb00b30b7de5f201e4448ddb353"
def certificateSHA256 : String := "56217e5e606b02f78da190226011d505dc58eda2243b29608a15fa7057663b67"
...
def multipliers : Fin 26 → SparsePoly (Fin 70) := ![
  ...
  [{ coefficient := 1, powers := [(3, 1), (13, 1), (32, 1), (60, 1), (68, 1)] }],
  ...
  [{ coefficient := -1, powers := [(3, 1), (13, 1), (32, 1), (50, 1), (60, 1)] }],
...
#print axioms Krenn.Component19.SelectedLeafB6_6_1_7.selectedHasNoCommonZero

end Krenn.Component19.SelectedLeafB6_6_1_7
