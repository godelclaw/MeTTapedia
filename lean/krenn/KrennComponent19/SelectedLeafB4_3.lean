...
namespace Krenn.Component19.SelectedLeafB4_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "13c7c187ccaf81224ebeb839989c6a980860fe98cede5e2668a305b2678cb4e7"
...
def multipliers : Fin 40 → SparsePoly (Fin 65) := ![
  ...
  [{ coefficient := 2, powers := [(6, 1), (13, 1), (21, 1), (25, 1), (34, 1), (43, 1), (48, 1), (53, 1), (58, 1), (64, 1)] }, { coefficient := 2, powers := [(13, 1), (21, 1), (25, 1), (34, 1), (40, 1), (43, 1), (58, 1), (64, 1)] }, { coefficient := -2, powers := [(13, 1), (22, 1), (25, 1), (43, 1), (48, 1), (58, 1), (64, 1)] }, { coefficient := 2, powers := [(13, 1), (23, 1), (25, 1), (43, 1), (58, 1), (64, 1)] }, { coefficient := 2, powers := [(13, 1), (23, 1), (25, 1), (53, 1), (58, 1), (64, 1)] }, { coefficient := 2, powers := [(13, 1), (25, 1), (28, 1), (43, 1), (53, 1), (58, 1), (64, 1)] }, { coefficient := -2, powers := [(13, 1), (25, 1), (34, 1), (40, 1), (58, 1), (64, 1)] }],
  [{ coefficient := -4, powers := [(21, 1), (25, 1), (49, 1), (55, 1), (64, 1)] }, { coefficient := -2, powers := [(21, 1), (32, 1), (43, 1), (44, 1), (49, 1), (63, 1), (64, 1)] }, { coefficient := -2, powers := [(21, 1), (32, 1), (44, 1), (49, 1), (64, 1)] }, { coefficient := -2, powers := [(32, 1), (44, 1), (49, 1), (63, 1), (64, 1)] }],
  [{ coefficient := -2, powers := [(30, 1), (55, 1)] }],
  [{ coefficient := -2, powers := [(19, 1), (50, 1)] }],
  [{ coefficient := -2, powers := [(13, 1), (46, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (5, 1), (35, 1), (53, 2), (58, 1), (64, 1)] }, { coefficient := -1, powers := [(0, 1), (5, 1), (35, 1), (53, 1), (57, 1), (58, 1), (64, 1)] }, { coefficient := -1, powers := [(5, 1), (21, 1), (35, 1), (53, 2), (58, 1), (64, 1)] }, { coefficient := -2, powers := [(5, 1), (21, 1), (35, 1), (53, 1), (57, 1), (58, 1), (64, 1)] }, { coefficient := -1, powers := [(5, 1), (21, 1), (35, 1), (57, 2), (58, 1), (64, 1)] }, { coefficient := -4, powers := [(13, 1), (32, 1), (50, 1), (53, 1), (64, 1)] }, { coefficient := 4, powers := [(20, 1), (25, 1), (43, 1), (55, 1), (64, 1)] }, { coefficient := 2, powers := [(20, 1), (32, 1), (43, 2), (44, 1), (63, 1), (64, 1)] }, { coefficient := 2, powers := [(20, 1), (32, 1), (43, 1), (44, 1), (64, 1)] }],
  [{ coefficient := -2, powers := [(4, 1), (13, 1), (25, 1), (58, 1), (60, 1), (64, 1)] }, { coefficient := 2, powers := [(11, 1), (13, 1), (25, 1), (43, 1), (58, 1), (64, 1)] }, { coefficient := 2, powers := [(11, 1), (13, 1), (25, 1), (48, 1), (58, 1), (64, 1)] }],
  [{ coefficient := -2, powers := [(19, 1), (44, 1), (58, 1), (63, 1), (64, 1)] }, { coefficient := -2, powers := [(20, 1), (44, 1), (54, 1), (63, 1), (64, 1)] }],
  [{ coefficient := 4, powers := [(13, 1), (32, 1), (53, 1)] }],
  [{ coefficient := 4, powers := [(25, 1), (49, 1), (55, 1)] }, { coefficient := 2, powers := [(32, 1), (43, 1), (44, 1), (49, 1), (63, 1)] }, { coefficient := 2, powers := [(32, 1), (44, 1), (49, 1)] }],
  ...
  [{ coefficient := -2, powers := [(13, 1), (25, 1), (43, 1), (58, 1), (64, 1)] }],
  ...
  [{ coefficient := -4, powers := [(25, 1), (55, 1)] }, { coefficient := -2, powers := [(32, 1), (43, 1), (44, 1), (63, 1)] }, { coefficient := -2, powers := [(32, 1), (44, 1)] }],
  ...
  [{ coefficient := 2, powers := [(44, 1), (63, 1)] }],
  [{ coefficient := 2, powers := [(13, 1), (25, 1), (58, 1)] }],
  [{ coefficient := -2, powers := [] }],
  [{ coefficient := -2, powers := [(13, 1), (25, 1), (40, 1), (58, 1), (60, 1)] }, { coefficient := 2, powers := [(13, 1), (25, 1), (43, 1), (44, 1), (57, 1), (58, 1), (64, 1)] }, { coefficient := -2, powers := [(13, 1), (25, 1), (43, 1), (57, 1), (58, 1)] }, { coefficient := 2, powers := [(13, 1), (25, 1), (48, 1), (53, 1), (58, 1)] }],
  [{ coefficient := 2, powers := [(41, 1), (61, 1)] }, { coefficient := -2, powers := [(43, 1), (44, 1), (58, 1), (63, 1)] }, { coefficient := -2, powers := [(44, 1), (49, 1), (54, 1), (63, 1)] }, { coefficient := 2, powers := [(44, 1), (58, 1)] }, { coefficient := -2, powers := [(50, 1), (55, 1)] }],
  [{ coefficient := -2, powers := [(8, 1), (38, 1), (44, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (5, 1), (26, 1), (35, 1), (53, 2), (58, 1)] }, { coefficient := 1, powers := [(0, 1), (5, 1), (26, 1), (35, 1), (53, 1), (57, 1), (58, 1)] }, { coefficient := -1, powers := [(0, 1), (5, 1), (35, 1), (57, 1), (58, 1)] }, { coefficient := 2, powers := [(4, 1), (13, 1), (25, 1), (29, 1), (58, 1), (60, 1)] }, { coefficient := 1, powers := [(5, 1), (21, 1), (26, 1), (35, 1), (53, 2), (58, 1)] }, { coefficient := 2, powers := [(5, 1), (21, 1), (26, 1), (35, 1), (53, 1), (57, 1), (58, 1)] }, { coefficient := 1, powers := [(5, 1), (21, 1), (26, 1), (35, 1), (57, 2), (58, 1)] }, { coefficient := -1, powers := [(5, 1), (35, 1), (58, 1)] }, { coefficient := -2, powers := [(6, 1), (13, 1), (16, 1), (21, 1), (25, 1), (34, 1), (43, 1), (48, 1), (53, 1), (58, 1)] }, { coefficient := 2, powers := [(7, 1), (13, 1), (25, 1), (37, 1), (43, 1), (58, 1)] }, { coefficient := -2, powers := [(11, 1), (13, 1), (25, 1), (29, 1), (43, 1), (58, 1)] }, { coefficient := -2, powers := [(11, 1), (13, 1), (25, 1), (29, 1), (48, 1), (58, 1)] }, { coefficient := -2, powers := [(13, 1), (16, 1), (21, 1), (25, 1), (34, 1), (40, 1), (43, 1), (58, 1)] }, { coefficient := 2, powers := [(13, 1), (16, 1), (22, 1), (25, 1), (43, 1), (48, 1), (58, 1)] }, { coefficient := -2, powers := [(13, 1), (16, 1), (23, 1), (25, 1), (43, 1), (58, 1)] }, { coefficient := -2, powers := [(13, 1), (16, 1), (23, 1), (25, 1), (53, 1), (58, 1)] }, { coefficient := -2, powers := [(13, 1), (16, 1), (25, 1), (28, 1), (43, 1), (53, 1), (58, 1)] }, { coefficient := 2, powers := [(13, 1), (16, 1), (25, 1), (29, 1), (43, 1), (58, 1)] }, { coefficient := 2, powers := [(13, 1), (16, 1), (25, 1), (34, 1), (40, 1), (58, 1)] }, { coefficient := 4, powers := [(13, 1), (26, 1), (32, 1), (50, 1), (53, 1)] }, { coefficient := 4, powers := [(19, 1), (21, 1), (25, 1), (49, 1), (55, 1)] }, { coefficient := 2, powers := [(19, 1), (21, 1), (32, 1), (43, 1), (44, 1), (49, 1), (63, 1)] }, { coefficient := 2, powers := [(19, 1), (21, 1), (32, 1), (44, 1), (49, 1)] }, { coefficient := 2, powers := [(19, 1), (31, 1), (44, 1), (58, 1), (63, 1)] }, { coefficient := 2, powers := [(19, 1), (32, 1), (44, 1), (49, 1), (63, 1)] }, { coefficient := -4, powers := [(20, 1), (25, 1), (26, 1), (43, 1), (55, 1)] }, { coefficient := -2, powers := [(20, 1), (26, 1), (32, 1), (43, 2), (44, 1), (63, 1)] }, { coefficient := -2, powers := [(20, 1), (26, 1), (32, 1), (43, 1), (44, 1)] }, { coefficient := 2, powers := [(20, 1), (31, 1), (44, 1), (54, 1), (63, 1)] }]
]
...
#print axioms Krenn.Component19.SelectedLeafB4_3.selectedHasNoCommonZero

end Krenn.Component19.SelectedLeafB4_3
