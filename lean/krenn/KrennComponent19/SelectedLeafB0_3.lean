...
namespace Krenn.Component19.SelectedLeafB0_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "9fd1614c8ae8bac332eb4f052fcb4cb3593de099481910edd5c4e9590fb627f6"
...
def multipliers : Fin 20 → SparsePoly (Fin 64) := ![
  ...
  [{ coefficient := -1, powers := [(5, 1), (27, 1), (35, 1), (43, 1), (63, 1)] }, { coefficient := -1, powers := [(5, 1), (35, 1), (54, 1), (63, 1)] }, { coefficient := 1, powers := [(13, 1), (25, 1), (27, 1), (43, 1), (63, 1)] }, { coefficient := 1, powers := [(13, 1), (25, 1), (54, 1), (63, 1)] }],
...
#print axioms Krenn.Component19.SelectedLeafB0_3.selectedHasNoCommonZero

end Krenn.Component19.SelectedLeafB0_3
