...
namespace Krenn.Component19.SelectedLeafB5_2_7_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "ef3e8f2b24331b77846509f860cf60c64907dc679729f294a59eab0a451f43c8"
def certificateSHA256 : String := "440716d0f01750da4b2094bcb950ec60324ab80c8ab3d37498b2de38551ca152"
...
def multipliers : Fin 28 → SparsePoly (Fin 71) := ![
  [{ coefficient := 1, powers := [(14, 1), (25, 1), (58, 1), (65, 1), (68, 1)] }, { coefficient := -1, powers := [(25, 1), (58, 1), (68, 1)] }, { coefficient := -1, powers := [(32, 1), (50, 1), (68, 1)] }],
  ...
  [{ coefficient := -1, powers := [(0, 1), (2, 1), (58, 1), (62, 1)] }, { coefficient := -1, powers := [(2, 1), (27, 1), (46, 1), (62, 1)] }, { coefficient := -1, powers := [(2, 1), (56, 1), (58, 1), (65, 1)] }, { coefficient := 1, powers := [(2, 1), (58, 1)] }, { coefficient := 1, powers := [(8, 1), (38, 1)] }, { coefficient := -1, powers := [(18, 1), (30, 1), (58, 1), (65, 1)] }, { coefficient := -1, powers := [(20, 1), (32, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (35, 1), (58, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (14, 1), (25, 1), (58, 1), (65, 1)] }, { coefficient := 1, powers := [(13, 1), (25, 1), (58, 1)] }, { coefficient := 1, powers := [(13, 1), (32, 1), (50, 1)] }],
...
#print axioms Krenn.Component19.SelectedLeafB5_2_7_7.selectedHasNoCommonZero

end Krenn.Component19.SelectedLeafB5_2_7_7
