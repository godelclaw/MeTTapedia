...
namespace Krenn.Component19.SelectedLeafB7_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "d6e8b841fad9d4ed34fd8039bcf6d2f781d0675896c8faa8a0fe7b15ebae8b7b"
...
def selectedEquations : Fin 35 → SparsePoly (Fin 67) := ![
  ...
  [{ coefficient := 1, powers := [(44, 1), (66, 1)] }, { coefficient := -1, powers := [] }]
]
...
def multipliers : Fin 35 → SparsePoly (Fin 67) := ![
  ...
  [{ coefficient := 1, powers := [(2, 1), (24, 1), (44, 1), (58, 1), (64, 1), (66, 1)] }, { coefficient := 1, powers := [(2, 1), (30, 1), (44, 1), (58, 1), (64, 1), (66, 1)] }, { coefficient := -1, powers := [(5, 1), (24, 1), (35, 1), (58, 1), (64, 1), (66, 1)] }, { coefficient := -1, powers := [(5, 1), (30, 1), (35, 1), (58, 1), (64, 1), (66, 1)] }, { coefficient := 1, powers := [(13, 1), (24, 1), (25, 1), (58, 1), (64, 1), (66, 1)] }, { coefficient := 1, powers := [(13, 1), (25, 1), (30, 1), (58, 1), (64, 1), (66, 1)] }, { coefficient := -2, powers := [(21, 1), (25, 1), (49, 1), (55, 1), (66, 1)] }, { coefficient := -1, powers := [(21, 1), (32, 1), (43, 1), (44, 1), (49, 1), (65, 1), (66, 1)] }, { coefficient := -1, powers := [(21, 1), (32, 1), (44, 1), (49, 1), (66, 1)] }, { coefficient := 1, powers := [(30, 1), (44, 1), (49, 1), (54, 1), (65, 1), (66, 1)] }, { coefficient := -1, powers := [(32, 1), (44, 1), (49, 1), (65, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(30, 1), (55, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (50, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (46, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (13, 1), (25, 1), (53, 1), (58, 1), (62, 1), (66, 1)] }, { coefficient := 1, powers := [(2, 1), (39, 1), (50, 1), (55, 1), (60, 1), (62, 1), (66, 1)] }, { coefficient := -1, powers := [(2, 1), (50, 1), (53, 1), (55, 1), (66, 1)] }, { coefficient := 1, powers := [(2, 1), (50, 1), (55, 1), (62, 1), (66, 1)] }, { coefficient := 1, powers := [(13, 1), (21, 1), (25, 1), (43, 1), (58, 1), (62, 1), (66, 1)] }, { coefficient := 1, powers := [(13, 1), (21, 1), (25, 1), (48, 1), (58, 1), (62, 1), (66, 1)] }, { coefficient := 1, powers := [(13, 1), (21, 1), (25, 1), (53, 1), (58, 1), (62, 1), (66, 1)] }, { coefficient := 1, powers := [(13, 1), (21, 1), (25, 1), (57, 1), (58, 1), (62, 1), (66, 1)] }, { coefficient := -2, powers := [(13, 1), (32, 1), (50, 1), (53, 1), (66, 1)] }, { coefficient := 2, powers := [(20, 1), (25, 1), (43, 1), (55, 1), (66, 1)] }, { coefficient := 1, powers := [(20, 1), (32, 1), (43, 2), (44, 1), (65, 1), (66, 1)] }, { coefficient := 1, powers := [(20, 1), (32, 1), (43, 1), (44, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(20, 1), (43, 1), (44, 1), (54, 1), (65, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (44, 1), (58, 1), (65, 1), (66, 1)] }],
  ...
  [{ coefficient := 2, powers := [(25, 1), (49, 1), (55, 1)] }, { coefficient := 1, powers := [(32, 1), (43, 1), (44, 1), (49, 1), (65, 1)] }, { coefficient := 1, powers := [(32, 1), (44, 1), (49, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (55, 1)] }, { coefficient := -2, powers := [(13, 1), (32, 1)] }],
  [{ coefficient := -1, powers := [(25, 1), (58, 1)] }],
  [{ coefficient := 1, powers := [(32, 1)] }],
  [{ coefficient := 1, powers := [(20, 1)] }],
  [{ coefficient := -2, powers := [(25, 1), (55, 1)] }, { coefficient := -1, powers := [(32, 1), (43, 1), (44, 1), (65, 1)] }, { coefficient := -1, powers := [(32, 1), (44, 1)] }],
  [{ coefficient := -1, powers := [(44, 1), (54, 1), (65, 1)] }],
  ...
  [{ coefficient := -1, powers := [(0, 1), (13, 1), (25, 1), (26, 1), (53, 1), (58, 1), (62, 1)] }, { coefficient := -1, powers := [(2, 1), (19, 1), (24, 1), (44, 1), (58, 1), (64, 1)] }, { coefficient := -1, powers := [(2, 1), (19, 1), (30, 1), (44, 1), (58, 1), (64, 1)] }, { coefficient := -1, powers := [(2, 1), (26, 1), (39, 1), (50, 1), (55, 1), (60, 1), (62, 1)] }, { coefficient := 1, powers := [(2, 1), (26, 1), (50, 1), (53, 1), (55, 1)] }, { coefficient := -1, powers := [(2, 1), (26, 1), (50, 1), (55, 1), (62, 1)] }, { coefficient := 1, powers := [(5, 1), (19, 1), (24, 1), (35, 1), (58, 1), (64, 1)] }, { coefficient := 1, powers := [(5, 1), (19, 1), (30, 1), (35, 1), (58, 1), (64, 1)] }, { coefficient := -1, powers := [(13, 1), (19, 1), (24, 1), (25, 1), (58, 1), (64, 1)] }, { coefficient := -1, powers := [(13, 1), (19, 1), (25, 1), (30, 1), (58, 1), (64, 1)] }, { coefficient := -1, powers := [(13, 1), (21, 1), (25, 1), (26, 1), (43, 1), (58, 1), (62, 1)] }, { coefficient := -1, powers := [(13, 1), (21, 1), (25, 1), (26, 1), (48, 1), (58, 1), (62, 1)] }, { coefficient := -1, powers := [(13, 1), (21, 1), (25, 1), (26, 1), (53, 1), (58, 1), (62, 1)] }, { coefficient := -1, powers := [(13, 1), (21, 1), (25, 1), (26, 1), (57, 1), (58, 1), (62, 1)] }, { coefficient := 2, powers := [(13, 1), (26, 1), (32, 1), (50, 1), (53, 1)] }, { coefficient := 2, powers := [(19, 1), (21, 1), (25, 1), (49, 1), (55, 1)] }, { coefficient := 1, powers := [(19, 1), (21, 1), (32, 1), (43, 1), (44, 1), (49, 1), (65, 1)] }, { coefficient := 1, powers := [(19, 1), (21, 1), (32, 1), (44, 1), (49, 1)] }, { coefficient := -1, powers := [(19, 1), (30, 1), (44, 1), (49, 1), (54, 1), (65, 1)] }, { coefficient := 1, powers := [(19, 1), (31, 1), (44, 1), (58, 1), (65, 1)] }, { coefficient := 1, powers := [(19, 1), (32, 1), (44, 1), (49, 1), (65, 1)] }, { coefficient := -2, powers := [(20, 1), (25, 1), (26, 1), (43, 1), (55, 1)] }, { coefficient := -1, powers := [(20, 1), (26, 1), (32, 1), (43, 2), (44, 1), (65, 1)] }, { coefficient := -1, powers := [(20, 1), (26, 1), (32, 1), (43, 1), (44, 1)] }, { coefficient := -1, powers := [(20, 1), (30, 1), (43, 1), (44, 1), (54, 1), (65, 1)] }]
]
...
#print axioms Krenn.Component19.SelectedLeafB7_3.selectedHasNoCommonZero

end Krenn.Component19.SelectedLeafB7_3
