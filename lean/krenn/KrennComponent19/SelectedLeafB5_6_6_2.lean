...
namespace Krenn.Component19.SelectedLeafB5_6_6_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "73b4712ec988f34e52e3d8bed1e0538c2d2dd57e4ef95769da9c52ba7471667a"
def certificateSHA256 : String := "b0fbbeb1fde696399718662128613eabdb669e988ae0cf8412e71b33d1994741"
...
def multipliers : Fin 19 → SparsePoly (Fin 69) := ![
  ...
  [{ coefficient := -1, powers := [(0, 1), (2, 1), (55, 1), (62, 2)] }, { coefficient := 1, powers := [(2, 1), (21, 1), (55, 1), (62, 2)] }],
  ...
  [{ coefficient := 1, powers := [(0, 1), (2, 1), (50, 1), (55, 1), (62, 1)] }, { coefficient := -1, powers := [(2, 1), (21, 1), (50, 1), (55, 1), (62, 1)] }, { coefficient := -1, powers := [] }],
  [{ coefficient := 1, powers := [(0, 1), (8, 1), (38, 1), (62, 1)] }, { coefficient := -1, powers := [(2, 1), (27, 1), (46, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (5, 1), (35, 1), (62, 1)] }, { coefficient := -1, powers := [(0, 1), (13, 1), (25, 1), (62, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (2, 1), (50, 1), (55, 1), (62, 2)] }, { coefficient := 2, powers := [(0, 1), (19, 1), (25, 1), (49, 1), (55, 1), (62, 1)] }, { coefficient := 2, powers := [(0, 1), (20, 1), (25, 1), (43, 1), (55, 1), (62, 1)] }, { coefficient := -1, powers := [(2, 1), (21, 1), (50, 1), (55, 1), (62, 2)] }],
  [{ coefficient := 1, powers := [(0, 1), (5, 1), (61, 1), (62, 1)] }, { coefficient := -1, powers := [(0, 1), (13, 1), (50, 1), (62, 1)] }]
]
...
#print axioms Krenn.Component19.SelectedLeafB5_6_6_2.selectedHasNoCommonZero

end Krenn.Component19.SelectedLeafB5_6_6_2
