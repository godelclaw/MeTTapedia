...
namespace Krenn.Component19.SelectedLeafB5_2_3_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "1db2c0709752e7533971ff678af826366e3466881ab8b38256980e881b9cf377"
...
def multipliers : Fin 28 → SparsePoly (Fin 70) := ![
  [{ coefficient := 1, powers := [(25, 1), (53, 1), (58, 1), (65, 1), (67, 1)] }, { coefficient := -1, powers := [(25, 1), (58, 1), (67, 1)] }, { coefficient := -1, powers := [(32, 1), (50, 1), (67, 1)] }],
  ...
  [{ coefficient := -1, powers := [(13, 1), (25, 1), (53, 1), (58, 1), (65, 1)] }, { coefficient := 1, powers := [(13, 1), (25, 1), (58, 1)] }, { coefficient := 1, powers := [(13, 1), (32, 1), (50, 1)] }],
...
#print axioms Krenn.Component19.SelectedLeafB5_2_3_7.selectedHasNoCommonZero

end Krenn.Component19.SelectedLeafB5_2_3_7
