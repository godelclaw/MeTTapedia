...
namespace Krenn.Component19.SelectedLeafB6_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "44b5eceef31598baca7555779f9479ccb01de4e7b9c9ccc774c3d95bfb550438"
def certificateSHA256 : String := "44e97429e10ad6191bdfd00732b9be3cd37365f6b168ded2ebdc5d5be232539d"
...
def multipliers : Fin 29 → SparsePoly (Fin 65) := ![
  [{ coefficient := -1, powers := [(0, 1), (35, 1), (39, 1), (49, 1), (54, 1)] }, { coefficient := -1, powers := [(3, 1), (26, 1), (35, 1), (49, 1), (54, 1)] }, { coefficient := 1, powers := [(3, 1), (27, 1), (35, 1), (49, 1)] }, { coefficient := -1, powers := [(6, 1), (21, 1), (35, 1), (49, 1), (54, 1)] }],
  [{ coefficient := 2, powers := [(13, 1), (28, 1), (32, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(25, 1), (26, 1), (48, 1), (54, 1)] }, { coefficient := 1, powers := [(25, 1), (27, 1), (48, 1)] }],
  ...
  [{ coefficient := 1, powers := [(13, 1), (25, 1), (48, 1), (54, 1)] }],
  [{ coefficient := 1, powers := [(32, 1)] }],
  [{ coefficient := 1, powers := [(20, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (35, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (35, 1), (49, 1)] }],
  [{ coefficient := 1, powers := [(55, 1)] }],
  [{ coefficient := 1, powers := [(50, 1)] }],
  [{ coefficient := 1, powers := [(25, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (25, 1), (48, 1)] }],
  [{ coefficient := 1, powers := [(13, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (35, 1), (49, 1), (54, 1)] }],
  ...
  [{ coefficient := -1, powers := [(0, 1), (5, 1), (35, 1), (58, 1)] }, { coefficient := 1, powers := [(5, 1), (26, 1), (35, 1), (46, 1), (54, 1)] }, { coefficient := -1, powers := [(5, 1), (27, 1), (35, 1), (46, 1)] }],
...
#print axioms Krenn.Component19.SelectedLeafB6_4.selectedHasNoCommonZero

end Krenn.Component19.SelectedLeafB6_4
