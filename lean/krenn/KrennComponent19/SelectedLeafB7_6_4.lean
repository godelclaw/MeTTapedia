...
namespace Krenn.Component19.SelectedLeafB7_6_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "4387d3fb930fe1a30dae229c2dd6a6886402e2ef8dafd53aad160ac818c137e0"
def certificateSHA256 : String := "cff619063d37db24ba1c3c57da1976b16a013b9f34d759d92577d3f79a236aab"
...
def multipliers : Fin 23 → SparsePoly (Fin 68) := ![
  ...
  [{ coefficient := -2, powers := [(32, 1), (50, 1)] }],
  ...
  [{ coefficient := 2, powers := [(13, 1), (21, 1), (32, 1), (50, 1)] }, { coefficient := 2, powers := [(20, 1), (25, 1), (26, 1), (55, 1)] }],
...
#print axioms Krenn.Component19.SelectedLeafB7_6_4.selectedHasNoCommonZero

end Krenn.Component19.SelectedLeafB7_6_4
