...
namespace Krenn.Component19.SelectedLeafB7_6_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "54b2e08af278e2b97f7073212764c991369439fb0503810f534560a0b2be8413"
...
def multipliers : Fin 24 → SparsePoly (Fin 70) := ![
  ...
  [{ coefficient := 2, powers := [(25, 1), (47, 1), (58, 1), (67, 1)] }],
  ...
  [{ coefficient := -1, powers := [(0, 1), (2, 1), (58, 1), (62, 1)] }, { coefficient := -1, powers := [(2, 1), (27, 1), (46, 1), (62, 1)] }, { coefficient := -1, powers := [(2, 1), (57, 1), (58, 1), (68, 1)] }, { coefficient := 1, powers := [(2, 1), (58, 1)] }, { coefficient := 1, powers := [(8, 1), (38, 1)] }, { coefficient := -1, powers := [(19, 1), (31, 1), (58, 1), (68, 1)] }, { coefficient := -1, powers := [(20, 1), (32, 1)] }],
...
#print axioms Krenn.Component19.SelectedLeafB7_6_7.selectedHasNoCommonZero

end Krenn.Component19.SelectedLeafB7_6_7
