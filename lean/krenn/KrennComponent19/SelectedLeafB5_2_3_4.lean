...
namespace Krenn.Component19.SelectedLeafB5_2_3_4

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "c0a866fab4d15ebe4b76a49e3d206bb1f827f6118e5f67749370167a023c3d0e"
...
def multipliers : Fin 30 → SparsePoly (Fin 68) := ![
  [{ coefficient := 1, powers := [(25, 1), (53, 1), (58, 1), (65, 1), (67, 1)] }, { coefficient := -1, powers := [(25, 1), (58, 1), (67, 1)] }, { coefficient := -2, powers := [(27, 1), (30, 1), (48, 1), (50, 1), (67, 1)] }],
  ...
  [{ coefficient := -2, powers := [(19, 1), (21, 1), (46, 1), (50, 1), (55, 1), (66, 1)] }],
  ...
  [{ coefficient := 2, powers := [(19, 1), (21, 1), (50, 1), (55, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := -1, powers := [(2, 1), (41, 1), (61, 1)] }, { coefficient := -1, powers := [(2, 1), (50, 1), (55, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (2, 1), (58, 1), (62, 1)] }, { coefficient := -1, powers := [(2, 1), (27, 1), (46, 1), (62, 1)] }, { coefficient := -1, powers := [(2, 1), (57, 1), (58, 1), (65, 1)] }, { coefficient := 1, powers := [(2, 1), (58, 1)] }, { coefficient := 1, powers := [(8, 1), (38, 1)] }, { coefficient := -1, powers := [(19, 1), (31, 1), (58, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (35, 1), (58, 1)] }],
  [{ coefficient := -2, powers := [(19, 1), (21, 1), (31, 1), (50, 1), (55, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (25, 1), (53, 1), (58, 1), (65, 1)] }, { coefficient := 1, powers := [(13, 1), (25, 1), (58, 1)] }, { coefficient := 2, powers := [(13, 1), (27, 1), (30, 1), (48, 1), (50, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (61, 1)] }, { coefficient := -1, powers := [(13, 1), (50, 1)] }, { coefficient := 2, powers := [(19, 1), (21, 1), (46, 1), (48, 1), (50, 1), (55, 1), (66, 1)] }, { coefficient := -2, powers := [(19, 1), (21, 1), (49, 1), (50, 1), (55, 1), (66, 1)] }]
]
...
#print axioms Krenn.Component19.SelectedLeafB5_2_3_4.selectedHasNoCommonZero

end Krenn.Component19.SelectedLeafB5_2_3_4
