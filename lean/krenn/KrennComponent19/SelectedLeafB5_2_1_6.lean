...
namespace Krenn.Component19.SelectedLeafB5_2_1_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "987cb83a2ac16e415287dacb4fdfe1f3faa452b1d6eaa997a058acbc9ab0a51f"
...
def multipliers : Fin 32 → SparsePoly (Fin 68) := ![
  ...
  [{ coefficient := 1, powers := [(3, 1), (25, 1), (58, 1), (60, 1), (66, 1)] }],
  ...
  [{ coefficient := -1, powers := [(2, 1), (3, 1), (55, 1), (60, 1), (67, 1)] }],
  ...
  [{ coefficient := 1, powers := [(0, 1), (53, 1), (63, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(3, 1), (13, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (19, 1), (63, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(27, 1), (46, 1), (53, 1), (65, 1)] }, { coefficient := 1, powers := [] }],
  [{ coefficient := 1, powers := [(3, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (53, 1), (58, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (3, 1), (58, 1), (60, 1)] }, { coefficient := -1, powers := [(3, 1), (8, 1), (38, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (19, 1), (24, 1), (58, 1), (63, 1), (65, 1)] }, { coefficient := 1, powers := [(21, 1), (27, 1), (46, 1), (53, 1), (65, 1)] }, { coefficient := -1, powers := [(21, 1)] }],
  ...
  [{ coefficient := -1, powers := [(0, 1), (19, 1), (43, 1), (46, 1), (63, 1), (65, 1)] }, { coefficient := -1, powers := [(0, 1), (19, 1), (46, 1), (53, 1), (63, 1), (65, 1)] }, { coefficient := -1, powers := [(0, 1), (19, 1), (49, 1), (63, 1), (65, 1)] }, { coefficient := 1, powers := [(3, 1), (13, 1), (50, 1), (60, 1)] }]
]
...
#print axioms Krenn.Component19.SelectedLeafB5_2_1_6.selectedHasNoCommonZero

end Krenn.Component19.SelectedLeafB5_2_1_6
