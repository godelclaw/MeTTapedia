...
namespace Krenn.Component19.SelectedLeafB4_4_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "dc3d4453fd01b100ba5bd719f630520f286118052663e3c030576733629a7f65"
def certificateSHA256 : String := "8aca48192641e8fc035f12c3e7b0331f3c64093aaf4bc8d57ca4f0565fd43afb"
...
def multipliers : Fin 26 → SparsePoly (Fin 66) := ![
  [{ coefficient := 2, powers := [(32, 1), (50, 1), (62, 1)] }],
  [{ coefficient := -2, powers := [(25, 1), (26, 1), (54, 1)] }, { coefficient := 1, powers := [(25, 1), (27, 1)] }],
  ...
  [{ coefficient := -2, powers := [(25, 1), (55, 1)] }],
  [{ coefficient := 2, powers := [(13, 1), (25, 1), (54, 1)] }],
  ...
  [{ coefficient := 2, powers := [(13, 1), (32, 1), (50, 1)] }, { coefficient := 2, powers := [(19, 1), (25, 1), (46, 1), (55, 1)] }],
  [{ coefficient := 1, powers := [(41, 1), (61, 1)] }, { coefficient := -1, powers := [(50, 1), (55, 1)] }],
  [{ coefficient := 2, powers := [(0, 1), (13, 1), (25, 1), (58, 1)] }, { coefficient := -2, powers := [(13, 1), (25, 1), (26, 1), (46, 1), (54, 1)] }, { coefficient := 2, powers := [(13, 1), (25, 1), (27, 1), (46, 1)] }, { coefficient := 2, powers := [(20, 1), (21, 1), (25, 1), (55, 1)] }, { coefficient := 2, powers := [(20, 1), (25, 1), (26, 1), (55, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (57, 1), (58, 1), (64, 1)] }, { coefficient := 1, powers := [(2, 1), (58, 1)] }, { coefficient := 1, powers := [(8, 1), (38, 1)] }, { coefficient := -1, powers := [(19, 1), (31, 1), (58, 1), (64, 1)] }, { coefficient := -1, powers := [(20, 1), (32, 1)] }],
...
#print axioms Krenn.Component19.SelectedLeafB4_4_3.selectedHasNoCommonZero

end Krenn.Component19.SelectedLeafB4_4_3
