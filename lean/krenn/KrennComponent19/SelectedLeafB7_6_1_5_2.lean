...
namespace Krenn.Component19.SelectedLeafB7_6_1_5_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "9a4e65c5bd4fdc046c9da0ba4196b4fa2597c0b46c6749ee560efc39ddad4d40"
def certificateSHA256 : String := "6e321e3e63c0a1a927810445ad2f2c6c7d79e754e1d56985bcf0e1392e757598"

set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedSourceIndices : Fin 12 → Fin 678 := ![
  2,
  7,
  20,
  22,
...
def multipliers : Fin 12 → SparsePoly (Fin 71) := ![
  [{ coefficient := 1, powers := [(35, 1), (58, 1), (70, 1)] }, { coefficient := 1, powers := [(38, 1), (55, 1), (70, 1)] }],
...
#print axioms Krenn.Component19.SelectedLeafB7_6_1_5_2.selectedHasNoCommonZero

end Krenn.Component19.SelectedLeafB7_6_1_5_2
