...
namespace Krenn.Component19.SelectedLeafB2_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "45a40cc1dc48d2d3bac05b6078b8acee8e07931853058c1b8c42a542637117c7"
def certificateSHA256 : String := "e5f283cf1920caf2ea24e6850d296566bfa0cbd3791a7c9818406e4f8038a51d"
...
def multipliers : Fin 20 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := -1, powers := [(5, 1), (27, 1), (35, 1), (43, 1), (65, 1)] }, { coefficient := -1, powers := [(5, 1), (35, 1), (54, 1), (65, 1)] }, { coefficient := 1, powers := [(13, 1), (25, 1), (27, 1), (43, 1), (65, 1)] }, { coefficient := 1, powers := [(13, 1), (25, 1), (54, 1), (65, 1)] }],
...
#print axioms Krenn.Component19.SelectedLeafB2_7.selectedHasNoCommonZero

end Krenn.Component19.SelectedLeafB2_7
