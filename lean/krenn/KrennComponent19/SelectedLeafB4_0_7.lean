...
namespace Krenn.Component19.SelectedLeafB4_0_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "21c4bc5d6dcf212c3dc85a9fbb3ae30395923665e661fc3b594c802a0bccc080"
def certificateSHA256 : String := "db1f23f57a7b78e4d8d4d6fb922c4de71e4f35f730c9245131bd993d81f5a4b5"
...
def multipliers : Fin 25 → SparsePoly (Fin 66) := ![
  [{ coefficient := 2, powers := [(25, 1), (47, 1), (58, 1), (63, 1)] }, { coefficient := 2, powers := [(32, 1), (47, 1), (50, 1), (63, 1)] }],
  ...
  [{ coefficient := -2, powers := [(25, 1), (58, 1), (63, 1)] }, { coefficient := -2, powers := [(32, 1), (50, 1), (63, 1)] }],
  ...
  [{ coefficient := 2, powers := [(13, 1), (25, 1), (58, 1)] }, { coefficient := 2, powers := [(13, 1), (32, 1), (50, 1)] }],
...
#print axioms Krenn.Component19.SelectedLeafB4_0_7.selectedHasNoCommonZero

end Krenn.Component19.SelectedLeafB4_0_7
