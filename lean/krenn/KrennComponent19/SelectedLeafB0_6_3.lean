...
namespace Krenn.Component19.SelectedLeafB0_6_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "78093abe79aef186527bfb4618b4f50f2b3bccc395a8b8d3d3744ac656929abb"
def certificateSHA256 : String := "da4063cf91f4c1880bc3a4287041927978bc72cd8f49f03d061d9a7aa5c36ecc"
...
def multipliers : Fin 23 → SparsePoly (Fin 66) := ![
  [{ coefficient := 2, powers := [(25, 1), (27, 1), (43, 2), (64, 1)] }, { coefficient := 2, powers := [(25, 1), (43, 1), (54, 1), (64, 1)] }],
  [{ coefficient := 2, powers := [(25, 1), (27, 1), (43, 1), (64, 1)] }, { coefficient := -1, powers := [(25, 1), (27, 1), (57, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(30, 1), (55, 1), (57, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (50, 1), (57, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (46, 1), (57, 1), (64, 1)] }],
  [{ coefficient := -2, powers := [(25, 1), (58, 1), (64, 1)] }],
  [{ coefficient := -2, powers := [(13, 1), (58, 1), (64, 1)] }],
  [{ coefficient := -2, powers := [(20, 1), (25, 1), (57, 1), (64, 1)] }],
  [{ coefficient := -2, powers := [(13, 1), (32, 1), (57, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(32, 1), (57, 1), (64, 1)] }],
  ...
  [{ coefficient := -2, powers := [(13, 1), (25, 1), (43, 1), (64, 1)] }],
  [{ coefficient := 2, powers := [(13, 1), (25, 1), (58, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(57, 1), (64, 1)] }],
  [{ coefficient := -2, powers := [(13, 1), (25, 1), (40, 1), (58, 1), (60, 1), (64, 1)] }, { coefficient := 2, powers := [(13, 1), (25, 1), (43, 2), (58, 1), (64, 1)] }, { coefficient := 2, powers := [(13, 1), (25, 1), (43, 1), (49, 1), (54, 1), (64, 1)] }, { coefficient := -2, powers := [(13, 1), (25, 1), (43, 1), (57, 1), (58, 1), (64, 1)] }, { coefficient := -2, powers := [(13, 1), (25, 1), (48, 1), (53, 1), (58, 1), (64, 1)] }, { coefficient := 2, powers := [(13, 1), (32, 1), (50, 1), (53, 1), (57, 1), (64, 1)] }, { coefficient := 2, powers := [(20, 1), (25, 1), (48, 1), (55, 1), (57, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(41, 1), (57, 1), (61, 1), (64, 1)] }, { coefficient := -1, powers := [(50, 1), (55, 1), (57, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (38, 1), (57, 1), (64, 1)] }, { coefficient := -1, powers := [(19, 1), (31, 1), (58, 1), (64, 1)] }, { coefficient := -1, powers := [(20, 1), (32, 1), (57, 1), (64, 1)] }],
...
#print axioms Krenn.Component19.SelectedLeafB0_6_3.selectedHasNoCommonZero

end Krenn.Component19.SelectedLeafB0_6_3
