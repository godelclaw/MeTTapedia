...
namespace Krenn.Component19.SelectedLeafB3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "5a92fd4ac69282d93da6931103b0889a631697815e943e1c6d3cec6eb032dc4d"
...
def multipliers : Fin 30 → SparsePoly (Fin 64) := ![
  ...
  [{ coefficient := -1, powers := [(21, 1), (31, 1), (43, 1), (63, 1)] }, { coefficient := -1, powers := [(21, 1), (31, 1), (48, 1), (63, 1)] }, { coefficient := 1, powers := [(24, 1), (43, 1), (63, 1)] }, { coefficient := 1, powers := [(24, 1), (48, 1), (63, 1)] }, { coefficient := -1, powers := [(31, 1), (63, 1)] }],
  ...
  [{ coefficient := 1, powers := [(21, 1), (31, 1), (63, 1)] }, { coefficient := -1, powers := [(24, 1), (63, 1)] }, { coefficient := 1, powers := [(26, 1), (31, 1), (63, 1)] }, { coefficient := -1, powers := [(30, 1), (63, 1)] }],
  ...
  [{ coefficient := -1, powers := [(21, 1), (24, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(19, 1), (21, 2), (63, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (25, 1), (39, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(63, 1)] }],
  [{ coefficient := -1, powers := [(39, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(19, 1), (21, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(19, 1), (26, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (39, 1), (60, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (26, 1), (31, 1), (63, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (21, 1), (31, 1), (63, 1)] }],
  [{ coefficient := 1, powers := [(13, 1), (25, 1), (39, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(39, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (39, 1), (44, 1), (57, 1), (58, 1), (60, 1)] }, { coefficient := -1, powers := [(2, 1), (39, 1), (48, 1), (50, 1), (55, 1), (60, 1)] }, { coefficient := 1, powers := [(8, 1), (38, 1), (39, 1), (44, 1), (57, 1), (60, 1)] }, { coefficient := -1, powers := [(13, 1), (25, 1), (39, 1), (43, 1), (58, 1), (60, 1)] }, { coefficient := -1, powers := [(13, 1), (25, 1), (39, 1), (49, 1), (54, 1), (60, 1)] }, { coefficient := -2, powers := [(13, 1), (32, 1), (39, 1), (50, 1), (53, 1), (60, 1)] }, { coefficient := 1, powers := [(19, 1), (21, 1), (31, 1), (53, 1), (63, 1)] }, { coefficient := 1, powers := [(19, 1), (25, 1), (39, 1), (48, 1), (54, 1), (61, 1)] }, { coefficient := 1, powers := [(19, 1), (26, 1), (31, 1), (48, 1), (63, 1)] }, { coefficient := -2, powers := [(20, 1), (25, 1), (39, 1), (48, 1), (55, 1), (60, 1)] }, { coefficient := -1, powers := [(20, 1), (32, 1), (39, 1), (44, 1), (57, 1), (60, 1)] }],
...
#print axioms Krenn.Component19.SelectedLeafB3.selectedHasNoCommonZero

end Krenn.Component19.SelectedLeafB3
