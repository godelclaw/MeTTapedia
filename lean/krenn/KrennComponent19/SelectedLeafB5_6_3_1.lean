...
namespace Krenn.Component19.SelectedLeafB5_6_3_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "aa850aa42bbb6d4673f08ae13570462f4f90b5e684cdfe096114678b47500d78"
...
def multipliers : Fin 31 → SparsePoly (Fin 69) := ![
  ...
  [{ coefficient := -1, powers := [(19, 1), (50, 1)] }],
  [{ coefficient := 1, powers := [(13, 1), (31, 1), (58, 1), (65, 1), (68, 1)] }, { coefficient := -1, powers := [(13, 1), (46, 1)] }],
  ...
  [{ coefficient := -1, powers := [(13, 1), (25, 1), (58, 1), (65, 1), (68, 1)] }],
...
#print axioms Krenn.Component19.SelectedLeafB5_6_3_1.selectedHasNoCommonZero

end Krenn.Component19.SelectedLeafB5_6_3_1
