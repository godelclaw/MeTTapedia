...
namespace Krenn.Component19.SelectedLeafB5_6_3_5_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "34352dc70f5eee4a0d764679051bacf66123335655774f13ed7b98b77bce8298"
...
def multipliers : Fin 18 → SparsePoly (Fin 72) := ![
  [{ coefficient := 1, powers := [(0, 1), (35, 1), (58, 1), (62, 1), (70, 1)] }, { coefficient := 2, powers := [(0, 1), (38, 1), (55, 1), (62, 1), (70, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (25, 1), (58, 1), (62, 1), (68, 1)] }, { coefficient := -2, powers := [(0, 1), (32, 1), (50, 1), (62, 1), (68, 1)] }],
...
#print axioms Krenn.Component19.SelectedLeafB5_6_3_5_3.selectedHasNoCommonZero

end Krenn.Component19.SelectedLeafB5_6_3_5_3
