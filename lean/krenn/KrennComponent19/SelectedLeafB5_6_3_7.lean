...
namespace Krenn.Component19.SelectedLeafB5_6_3_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "b723529d7f5d27dcd1437039fae2f17d6bb2b33786c5de3e8f0228f7e7d18f40"
def certificateSHA256 : String := "5119d4fab296910d387201f763033ed489dd4e185442745e53e795d7f8710aca"
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedEquations : Fin 28 → SparsePoly (Fin 71) := ![
  ...
  [{ coefficient := 1, powers := [(32, 1), (70, 1)] }, { coefficient := -1, powers := [] }]
]

set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def multipliers : Fin 28 → SparsePoly (Fin 71) := ![
  [{ coefficient := 1, powers := [(25, 1), (53, 1), (58, 1), (66, 1), (68, 1)] }, { coefficient := -1, powers := [(25, 1), (58, 1), (68, 1)] }, { coefficient := -1, powers := [(32, 1), (50, 1), (68, 1)] }],
  [{ coefficient := -1, powers := [(25, 1), (27, 1)] }],
  [{ coefficient := -1, powers := [(30, 1), (55, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (50, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (46, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (21, 1), (55, 1), (62, 1), (69, 1)] }, { coefficient := -1, powers := [(2, 1), (55, 1), (69, 1)] }, { coefficient := -1, powers := [(13, 1), (32, 1), (69, 1)] }],
  [{ coefficient := 2, powers := [(20, 1), (25, 1), (26, 1), (54, 1), (70, 1)] }],
  ...
  [{ coefficient := -2, powers := [(20, 1), (25, 1), (26, 1), (55, 1), (70, 1)] }],
  ...
  [{ coefficient := -1, powers := [(13, 1), (25, 1), (53, 1), (58, 1), (66, 1)] }, { coefficient := 1, powers := [(13, 1), (25, 1), (58, 1)] }, { coefficient := 1, powers := [(13, 1), (32, 1), (50, 1)] }],
...
#print axioms Krenn.Component19.SelectedLeafB5_6_3_7.selectedHasNoCommonZero

end Krenn.Component19.SelectedLeafB5_6_3_7
