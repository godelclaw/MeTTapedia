...
namespace Krenn.Component19.SelectedLeafB5_2_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "ea3cdfb30fa2d138902998f0b1d9941fda00b385f6f8c8d6fc827cc92ca55ba6"
def certificateSHA256 : String := "18294be267ba94cd66c26924f0a973901ce332a6dcde03975a2c935e8bbd5aeb"
...
def multipliers : Fin 25 → SparsePoly (Fin 67) := ![
  ...
  [{ coefficient := 1, powers := [(14, 1), (25, 1), (58, 1), (65, 1)] }, { coefficient := -1, powers := [(25, 1), (58, 1)] }, { coefficient := -2, powers := [(32, 1), (50, 1)] }],
  ...
  [{ coefficient := 2, powers := [(0, 1), (2, 1), (21, 1), (53, 1), (58, 1), (62, 1)] }, { coefficient := 2, powers := [(0, 1), (2, 1), (53, 1), (58, 1)] }, { coefficient := 1, powers := [(0, 1), (2, 1), (58, 1), (62, 1)] }, { coefficient := 2, powers := [(2, 1), (21, 1), (27, 1), (46, 1), (53, 1), (62, 1)] }, { coefficient := 2, powers := [(2, 1), (27, 1), (46, 1), (53, 1)] }, { coefficient := 1, powers := [(2, 1), (27, 1), (46, 1), (62, 1)] }, { coefficient := -1, powers := [(2, 1), (56, 1), (58, 1), (65, 1)] }, { coefficient := 1, powers := [(2, 1), (58, 1)] }, { coefficient := 1, powers := [(8, 1), (38, 1)] }, { coefficient := -1, powers := [(18, 1), (30, 1), (58, 1), (65, 1)] }, { coefficient := -1, powers := [(20, 1), (32, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (35, 1), (58, 1)] }],
  [{ coefficient := -2, powers := [(2, 1), (21, 1), (41, 1), (61, 1)] }, { coefficient := -1, powers := [(13, 1), (14, 1), (21, 1), (25, 1), (58, 1), (65, 1)] }, { coefficient := 1, powers := [(13, 1), (21, 1), (25, 1), (58, 1)] }, { coefficient := 2, powers := [(13, 1), (21, 1), (32, 1), (50, 1)] }, { coefficient := 2, powers := [(20, 1), (25, 1), (26, 1), (55, 1)] }]
]
...
#print axioms Krenn.Component19.SelectedLeafB5_2_5.selectedHasNoCommonZero

end Krenn.Component19.SelectedLeafB5_2_5
