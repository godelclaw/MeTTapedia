...
namespace Krenn.Component19.SelectedLeafB4_2_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "32406b1c958fa00c218b9cef3f59697bce33254b1a33e01ae6bfe0f6fe449ed7"
...
def multipliers : Fin 30 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := -2, powers := [(0, 1), (53, 1), (58, 1), (64, 1)] }, { coefficient := -2, powers := [(21, 1), (53, 1), (58, 1), (64, 1)] }, { coefficient := -2, powers := [(21, 1), (58, 1)] }, { coefficient := -1, powers := [(58, 1), (64, 1)] }],
  ...
  [{ coefficient := 2, powers := [(0, 1), (2, 1), (53, 1), (57, 1), (58, 1), (64, 1)] }, { coefficient := 2, powers := [(0, 1), (19, 1), (31, 1), (53, 1), (58, 1), (64, 1)] }, { coefficient := 2, powers := [(2, 1), (21, 1), (53, 1), (57, 1), (58, 1), (64, 1)] }, { coefficient := 2, powers := [(2, 1), (21, 1), (57, 1), (58, 1)] }, { coefficient := 1, powers := [(2, 1), (57, 1), (58, 1), (64, 1)] }, { coefficient := 1, powers := [(2, 1), (58, 1)] }, { coefficient := 1, powers := [(8, 1), (38, 1)] }, { coefficient := 2, powers := [(19, 1), (21, 1), (31, 1), (53, 1), (58, 1), (64, 1)] }, { coefficient := 2, powers := [(19, 1), (21, 1), (31, 1), (58, 1)] }, { coefficient := 1, powers := [(19, 1), (31, 1), (58, 1), (64, 1)] }, { coefficient := -1, powers := [(20, 1), (32, 1)] }],
...
#print axioms Krenn.Component19.SelectedLeafB4_2_3.selectedHasNoCommonZero

end Krenn.Component19.SelectedLeafB4_2_3
