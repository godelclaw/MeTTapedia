...
namespace Krenn.Component19.SelectedLeafB7_6_1_7_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "9111dd4ac52d62caa3ce932dcda7300672b84fadd61603daba57f34087f13032"
def certificateSHA256 : String := "0c0a16f43eceee84635c6c00dff90b125fb967d338129570f86fbde827b0cf47"
...
def multipliers : Fin 15 → SparsePoly (Fin 72) := ![
  [{ coefficient := 1, powers := [(35, 1), (58, 1), (71, 1)] }, { coefficient := 1, powers := [(38, 1), (55, 1), (71, 1)] }],
  [{ coefficient := -1, powers := [(32, 1), (50, 1), (68, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (50, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (46, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (32, 1), (69, 1)] }],
  ...
  [{ coefficient := 1, powers := [(13, 1), (32, 1), (50, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (35, 1), (58, 1)] }, { coefficient := -1, powers := [(5, 1), (38, 1), (55, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (41, 1)] }, { coefficient := 1, powers := [(8, 1), (25, 1)] }]
]
...
#print axioms Krenn.Component19.SelectedLeafB7_6_1_7_2.selectedHasNoCommonZero

end Krenn.Component19.SelectedLeafB7_6_1_7_2
