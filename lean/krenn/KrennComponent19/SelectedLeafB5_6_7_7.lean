...
namespace Krenn.Component19.SelectedLeafB5_6_7_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "35c98c7d0a48d47fcda717e6fe9fdb0cd4bcf07b791f6237096d47eca4800397"
...
def selectedEquations : Fin 28 → SparsePoly (Fin 72) := ![
  ...
  [{ coefficient := 1, powers := [(32, 1), (71, 1)] }, { coefficient := -1, powers := [] }]
]

set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def multipliers : Fin 28 → SparsePoly (Fin 72) := ![
  [{ coefficient := 1, powers := [(14, 1), (25, 1), (58, 1), (66, 1), (69, 1)] }, { coefficient := -1, powers := [(25, 1), (58, 1), (69, 1)] }, { coefficient := -1, powers := [(32, 1), (50, 1), (69, 1)] }],
  [{ coefficient := -1, powers := [(25, 1), (27, 1)] }],
  [{ coefficient := -1, powers := [(30, 1), (55, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (50, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (46, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (21, 1), (55, 1), (62, 1), (70, 1)] }, { coefficient := -1, powers := [(2, 1), (55, 1), (70, 1)] }, { coefficient := -1, powers := [(13, 1), (32, 1), (70, 1)] }],
  [{ coefficient := 2, powers := [(20, 1), (25, 1), (26, 1), (54, 1), (71, 1)] }],
  ...
  [{ coefficient := -2, powers := [(20, 1), (25, 1), (26, 1), (55, 1), (71, 1)] }],
  ...
  [{ coefficient := -1, powers := [(13, 1), (14, 1), (25, 1), (58, 1), (66, 1)] }, { coefficient := 1, powers := [(13, 1), (25, 1), (58, 1)] }, { coefficient := 1, powers := [(13, 1), (32, 1), (50, 1)] }],
...
#print axioms Krenn.Component19.SelectedLeafB5_6_7_7.selectedHasNoCommonZero

end Krenn.Component19.SelectedLeafB5_6_7_7
