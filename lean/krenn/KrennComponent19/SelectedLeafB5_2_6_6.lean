...
namespace Krenn.Component19.SelectedLeafB5_2_6_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "4115d0c831345cd3449777f91772bf25d056e3f1bf64a207a4218dbb3cf9c502"
def certificateSHA256 : String := "46bb74709674789929a2fdaedfa51569a1ccf76fef4d27839c55b51e624fe50d"
...
def multipliers : Fin 21 → SparsePoly (Fin 69) := ![
  ...
  [{ coefficient := -1, powers := [(0, 1), (2, 1), (58, 1), (62, 1)] }, { coefficient := -1, powers := [(2, 1), (27, 1), (46, 1), (62, 1)] }, { coefficient := 1, powers := [(2, 1), (58, 1)] }, { coefficient := 1, powers := [(8, 1), (38, 1)] }],
...
#print axioms Krenn.Component19.SelectedLeafB5_2_6_6.selectedHasNoCommonZero

end Krenn.Component19.SelectedLeafB5_2_6_6
