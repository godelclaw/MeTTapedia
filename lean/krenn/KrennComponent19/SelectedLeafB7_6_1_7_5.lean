...
namespace Krenn.Component19.SelectedLeafB7_6_1_7_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "fa446a9f46b62d7da9ca613ee9f2c40f9f7e5e0b8536201dccb223b21fc9c92a"
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def selectedEquations : Fin 4 → SparsePoly (Fin 73) := ![
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 5000000 in
def multipliers : Fin 4 → SparsePoly (Fin 73) := ![
  [{ coefficient := 1, powers := [(64, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := -1, powers := [(2, 1), (39, 1), (64, 1)] }, { coefficient := 1, powers := [(3, 1), (19, 1), (30, 1), (64, 1)] }, { coefficient := 1, powers := [(6, 1), (19, 1), (24, 1), (64, 1)] }]
]
...
#print axioms Krenn.Component19.SelectedLeafB7_6_1_7_5.selectedHasNoCommonZero

end Krenn.Component19.SelectedLeafB7_6_1_7_5
