...
namespace Krenn.Component19.SelectedLeafB4_2_7

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "10525830b2e6902178d6200db92934c57317e39d0e3cabeef1142c5474146900"
def certificateSHA256 : String := "63a8be4508599410b735cbc3ee0eae320d1210eb140ab72f0a4845e75f9653d0"
...
def multipliers : Fin 24 → SparsePoly (Fin 67) := ![
  [{ coefficient := 2, powers := [(25, 1), (47, 1), (58, 1), (64, 1)] }, { coefficient := 2, powers := [(32, 1), (47, 1), (50, 1), (64, 1)] }],
  ...
  [{ coefficient := -2, powers := [(25, 1), (58, 1), (64, 1)] }, { coefficient := -2, powers := [(32, 1), (50, 1), (64, 1)] }],
  ...
  [{ coefficient := -1, powers := [(2, 1), (57, 1), (58, 1), (65, 1)] }, { coefficient := 1, powers := [(2, 1), (58, 1)] }, { coefficient := 1, powers := [(8, 1), (38, 1)] }, { coefficient := -1, powers := [(19, 1), (31, 1), (58, 1), (65, 1)] }, { coefficient := -1, powers := [(20, 1), (32, 1)] }],
...
#print axioms Krenn.Component19.SelectedLeafB4_2_7.selectedHasNoCommonZero

end Krenn.Component19.SelectedLeafB4_2_7
