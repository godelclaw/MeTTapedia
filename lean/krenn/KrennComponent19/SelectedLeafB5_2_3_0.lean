...
namespace Krenn.Component19.SelectedLeafB5_2_3_0

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "e16069ca395585ab5b2c6eed2bc62b14539e916842eed04a08e20bbc2858aac5"
...
def multipliers : Fin 26 → SparsePoly (Fin 67) := ![
  ...
  [{ coefficient := -2, powers := [(13, 1), (25, 1), (27, 1), (53, 2), (58, 1), (66, 1)] }, { coefficient := 2, powers := [(13, 1), (25, 1), (53, 1), (54, 1), (58, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(20, 1)] }],
  [{ coefficient := 2, powers := [(13, 1), (25, 1), (27, 1), (53, 1), (58, 1), (66, 1)] }],
  [{ coefficient := -2, powers := [(25, 1), (55, 1)] }],
  [{ coefficient := 1, powers := [(55, 1)] }],
  [{ coefficient := 1, powers := [(50, 1)] }],
  [{ coefficient := 1, powers := [(25, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (62, 1)] }],
  [{ coefficient := -2, powers := [(13, 1), (25, 1), (53, 1), (58, 1), (66, 1)] }],
  ...
  [{ coefficient := -1, powers := [(2, 1), (21, 1), (50, 1), (55, 1), (62, 2)] }, { coefficient := 1, powers := [(2, 1), (50, 1), (55, 1), (62, 1)] }, { coefficient := 2, powers := [(13, 1), (25, 1), (27, 1), (46, 1), (53, 2), (58, 1), (66, 1)] }, { coefficient := -2, powers := [(13, 1), (25, 1), (46, 1), (53, 1), (54, 1), (58, 1), (66, 1)] }, { coefficient := 2, powers := [(19, 1), (25, 1), (49, 1), (55, 1)] }, { coefficient := 2, powers := [(20, 1), (25, 1), (43, 1), (55, 1)] }],
...
#print axioms Krenn.Component19.SelectedLeafB5_2_3_0.selectedHasNoCommonZero

end Krenn.Component19.SelectedLeafB5_2_3_0
