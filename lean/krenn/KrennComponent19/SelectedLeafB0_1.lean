...
namespace Krenn.Component19.SelectedLeafB0_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "12ce1e2d09293d07effa6d35790eef11935013728077fc4aa78dc920849ccc89"
def certificateSHA256 : String := "e076650fadaf9fc768e4811b8a9136758066a94e94f461eb9ad86eb32684c7d7"
...
def selectedEquations : Fin 21 → SparsePoly (Fin 63) := ![
  ...
  [{ coefficient := 1, powers := [(44, 1), (62, 1)] }, { coefficient := -1, powers := [] }]
]
...
def multipliers : Fin 21 → SparsePoly (Fin 63) := ![
  ...
  [{ coefficient := -1, powers := [(5, 1), (35, 1), (49, 1), (62, 1)] }, { coefficient := 1, powers := [(13, 1), (25, 1), (49, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (35, 1), (54, 1), (62, 1)] }, { coefficient := 1, powers := [(13, 1), (25, 1), (54, 1), (62, 1)] }],
...
#print axioms Krenn.Component19.SelectedLeafB0_1.selectedHasNoCommonZero

end Krenn.Component19.SelectedLeafB0_1
