...
namespace Krenn.Component19.SelectedLeafB4_4_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "051fedf93c254e133fc47b1765d2c9e17667a867d80e3e70d36d9463a18c1230"
def certificateSHA256 : String := "b3e331d6e47bcfc18d20ab89d18009f0a137a14cb2e6b4bfff302ab6c2f40681"
...
def multipliers : Fin 25 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := 1, powers := [(14, 1), (25, 1), (58, 1), (64, 1)] }, { coefficient := -1, powers := [(25, 1), (58, 1)] }, { coefficient := -2, powers := [(32, 1), (50, 1)] }],
  ...
  [{ coefficient := -1, powers := [(2, 1), (56, 1), (58, 1), (64, 1)] }, { coefficient := 1, powers := [(2, 1), (58, 1)] }, { coefficient := 1, powers := [(8, 1), (38, 1)] }, { coefficient := -1, powers := [(18, 1), (30, 1), (58, 1), (64, 1)] }, { coefficient := -1, powers := [(20, 1), (32, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (35, 1), (58, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (14, 1), (21, 1), (25, 1), (58, 1), (64, 1)] }, { coefficient := 1, powers := [(13, 1), (21, 1), (25, 1), (58, 1)] }, { coefficient := 2, powers := [(13, 1), (21, 1), (32, 1), (50, 1)] }]
]
...
#print axioms Krenn.Component19.SelectedLeafB4_4_5.selectedHasNoCommonZero

end Krenn.Component19.SelectedLeafB4_4_5
