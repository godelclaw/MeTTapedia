...
namespace Krenn.Component19.SelectedLeafB4_4_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "aaba1116738f9346bc6786a02520f1644983b4fa89bc1076ad4e10bc4c5459f6"
def certificateSHA256 : String := "e88c21c88eb981ebe628982d20d892b561b2944fdf34901dc62a3ca6f23af0d3"
...
def multipliers : Fin 25 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := -2, powers := [(8, 1), (35, 1), (48, 1)] }],
  ...
  [{ coefficient := 2, powers := [(8, 1), (35, 1), (50, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := 2, powers := [(19, 1), (25, 1), (46, 1), (55, 1)] }],
  [{ coefficient := 1, powers := [(41, 1), (61, 1)] }, { coefficient := 1, powers := [(50, 1), (55, 1)] }],
  [{ coefficient := -2, powers := [(8, 1), (26, 1), (35, 1), (50, 1)] }, { coefficient := 2, powers := [(20, 1), (21, 1), (25, 1), (55, 1)] }, { coefficient := 2, powers := [(20, 1), (25, 1), (26, 1), (55, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (58, 1)] }, { coefficient := 2, powers := [(6, 1), (8, 1), (38, 1), (60, 1)] }, { coefficient := 2, powers := [(8, 1), (30, 1), (46, 1), (60, 1)] }, { coefficient := 1, powers := [(8, 1), (38, 1)] }, { coefficient := -1, powers := [(20, 1), (32, 1)] }],
...
#print axioms Krenn.Component19.SelectedLeafB4_4_6.selectedHasNoCommonZero

end Krenn.Component19.SelectedLeafB4_4_6
