...
namespace Krenn.Component19.SelectedLeafB5_2_3_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "1a6d73fec595b7f974c4396c501e41e182f9a07431ca7f74964818c00b3c10f7"
...
def multipliers : Fin 31 → SparsePoly (Fin 68) := ![
  ...
  [{ coefficient := -1, powers := [(19, 1), (50, 1)] }],
  [{ coefficient := 1, powers := [(13, 1), (31, 1), (58, 1), (64, 1), (67, 1)] }, { coefficient := -1, powers := [(13, 1), (46, 1)] }],
  ...
  [{ coefficient := -1, powers := [(13, 1), (25, 1), (58, 1), (64, 1), (67, 1)] }],
...
#print axioms Krenn.Component19.SelectedLeafB5_2_3_1.selectedHasNoCommonZero

end Krenn.Component19.SelectedLeafB5_2_3_1
