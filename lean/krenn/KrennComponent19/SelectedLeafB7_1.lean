...
namespace Krenn.Component19.SelectedLeafB7_1

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "7f52a156e2e700a6bf388db962940b4974062fea5798471076278cb8974f57f1"
...
def multipliers : Fin 27 → SparsePoly (Fin 66) := ![
  ...
  [{ coefficient := -1, powers := [(8, 1), (24, 1), (38, 1), (44, 1), (64, 1), (65, 1)] }, { coefficient := -1, powers := [(8, 1), (30, 1), (38, 1), (44, 1), (64, 1), (65, 1)] }, { coefficient := -2, powers := [(21, 1), (25, 1), (49, 1), (55, 1), (65, 1)] }, { coefficient := -1, powers := [(21, 1), (32, 1), (44, 1), (49, 1), (65, 1)] }, { coefficient := -1, powers := [(24, 1), (41, 1), (61, 1), (65, 1)] }, { coefficient := -1, powers := [(25, 1), (39, 1), (54, 1), (61, 1), (65, 1)] }, { coefficient := -1, powers := [(30, 1), (41, 1), (61, 1), (65, 1)] }, { coefficient := 1, powers := [(38, 1), (39, 1), (44, 1), (54, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(30, 1), (55, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (50, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (46, 1)] }, { coefficient := 1, powers := [(19, 1), (39, 1), (61, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (44, 1), (49, 1), (54, 1), (65, 1)] }, { coefficient := -1, powers := [(2, 1), (50, 1), (53, 1), (55, 1), (65, 1)] }, { coefficient := 1, powers := [(5, 1), (35, 1), (49, 1), (54, 1), (65, 1)] }, { coefficient := -1, powers := [(13, 1), (25, 1), (49, 1), (54, 1), (65, 1)] }, { coefficient := -2, powers := [(13, 1), (32, 1), (50, 1), (53, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (44, 1), (49, 1), (65, 1)] }, { coefficient := -1, powers := [(5, 1), (35, 1), (49, 1), (65, 1)] }, { coefficient := 1, powers := [(13, 1), (25, 1), (49, 1), (65, 1)] }, { coefficient := -1, powers := [(19, 1), (25, 1), (39, 1), (48, 1), (61, 1), (65, 1)] }, { coefficient := 1, powers := [(19, 1), (38, 1), (39, 1), (44, 1), (48, 1), (65, 1)] }],
...
#print axioms Krenn.Component19.SelectedLeafB7_1.selectedHasNoCommonZero

end Krenn.Component19.SelectedLeafB7_1
