...
namespace Krenn.Component19.SelectedLeafB7_2_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "7f8b0b30620036159f183f143a9ddade2bb58fc73dcb1172529f06e8cb556cbe"
...
def multipliers : Fin 28 → SparsePoly (Fin 68) := ![
  ...
  [{ coefficient := -2, powers := [(0, 1), (53, 1), (58, 1), (66, 1)] }, { coefficient := -2, powers := [(21, 1), (53, 1), (58, 1), (66, 1)] }, { coefficient := -2, powers := [(21, 1), (58, 1)] }, { coefficient := -1, powers := [(58, 1), (66, 1)] }],
  ...
  [{ coefficient := 2, powers := [(0, 1), (2, 1), (53, 1), (57, 1), (58, 1), (66, 1)] }, { coefficient := -1, powers := [(0, 1), (2, 1), (58, 1), (62, 1)] }, { coefficient := 2, powers := [(0, 1), (19, 1), (31, 1), (53, 1), (58, 1), (66, 1)] }, { coefficient := 2, powers := [(2, 1), (21, 1), (53, 1), (57, 1), (58, 1), (66, 1)] }, { coefficient := 2, powers := [(2, 1), (21, 1), (57, 1), (58, 1)] }, { coefficient := -1, powers := [(2, 1), (27, 1), (46, 1), (62, 1)] }, { coefficient := 1, powers := [(2, 1), (57, 1), (58, 1), (66, 1)] }, { coefficient := 1, powers := [(2, 1), (58, 1)] }, { coefficient := 1, powers := [(8, 1), (38, 1)] }, { coefficient := 2, powers := [(19, 1), (21, 1), (31, 1), (53, 1), (58, 1), (66, 1)] }, { coefficient := 2, powers := [(19, 1), (21, 1), (31, 1), (58, 1)] }, { coefficient := 1, powers := [(19, 1), (31, 1), (58, 1), (66, 1)] }, { coefficient := -1, powers := [(20, 1), (32, 1)] }],
...
#print axioms Krenn.Component19.SelectedLeafB7_2_3.selectedHasNoCommonZero

end Krenn.Component19.SelectedLeafB7_2_3
