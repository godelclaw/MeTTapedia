...
namespace Krenn.Component19.SelectedLeafB4_0_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "f2a7af9e0498b4f0637553f5488f5c2c59e0a4a4acb703ab736ac2bc98e5426b"
def certificateSHA256 : String := "34d6cd4786604ba3b4ad48eb8b315c9644e9b4f7b5778cbeed1cc3b708ed97b4"
...
def multipliers : Fin 26 → SparsePoly (Fin 65) := ![
  ...
  [{ coefficient := -1, powers := [(2, 1), (57, 1), (58, 1), (63, 1)] }, { coefficient := 1, powers := [(2, 1), (58, 1)] }, { coefficient := 1, powers := [(8, 1), (38, 1)] }, { coefficient := -1, powers := [(19, 1), (31, 1), (58, 1), (63, 1)] }, { coefficient := -1, powers := [(20, 1), (32, 1)] }],
...
#print axioms Krenn.Component19.SelectedLeafB4_0_3.selectedHasNoCommonZero

end Krenn.Component19.SelectedLeafB4_0_3
