...
namespace Krenn.Component19.SelectedLeafB5_6_1_6

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "bdd33448ea2cc66912c989964cac6c58dac4c5691d458ed3f80ed6ed4dbcdb88"
...
def multipliers : Fin 32 → SparsePoly (Fin 69) := ![
  ...
  [{ coefficient := -1, powers := [(0, 1), (54, 1), (63, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(46, 1), (53, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(3, 1), (55, 1), (60, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (58, 1), (63, 1), (66, 1)] }],
  ...
  [{ coefficient := 1, powers := [(0, 1), (53, 1), (63, 1), (66, 1)] }],
  [{ coefficient := -1, powers := [(3, 1), (13, 1), (60, 1)] }],
  [{ coefficient := 1, powers := [(0, 1), (19, 1), (63, 1), (66, 1)] }],
  ...
  [{ coefficient := 1, powers := [(0, 1), (19, 1), (24, 1), (58, 1), (63, 1), (66, 1)] }, { coefficient := 1, powers := [(21, 1), (27, 1), (46, 1), (53, 1), (66, 1)] }, { coefficient := -1, powers := [(21, 1)] }],
  ...
  [{ coefficient := -1, powers := [(0, 1), (19, 1), (43, 1), (46, 1), (63, 1), (66, 1)] }, { coefficient := -1, powers := [(0, 1), (19, 1), (46, 1), (53, 1), (63, 1), (66, 1)] }, { coefficient := -1, powers := [(0, 1), (19, 1), (49, 1), (63, 1), (66, 1)] }, { coefficient := 1, powers := [(3, 1), (13, 1), (50, 1), (60, 1)] }]
]
...
#print axioms Krenn.Component19.SelectedLeafB5_6_1_6.selectedHasNoCommonZero

end Krenn.Component19.SelectedLeafB5_6_1_6
