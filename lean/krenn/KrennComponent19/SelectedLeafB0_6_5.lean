...
namespace Krenn.Component19.SelectedLeafB0_6_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "5069232b467a639678aefc5f1179765c514f34a68eae72c8d10fa9021f7a8402"
def certificateSHA256 : String := "caeed2e920c16074a491727a697da44fb4eccbc19bdd758c909f540b257fc97e"
...
def multipliers : Fin 21 → SparsePoly (Fin 66) := ![
  [{ coefficient := -1, powers := [(25, 1), (27, 1), (56, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(30, 1), (55, 1), (56, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (50, 1), (56, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (46, 1), (56, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (58, 1), (64, 1)] }],
  [{ coefficient := -2, powers := [(20, 1), (25, 1), (56, 1), (64, 1)] }],
  [{ coefficient := -2, powers := [(13, 1), (32, 1), (56, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(14, 1), (25, 1), (58, 1), (64, 1)] }, { coefficient := -1, powers := [(25, 1), (56, 1), (58, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(32, 1), (56, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(20, 1), (56, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(55, 1), (56, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(50, 1), (56, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(25, 1), (56, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(58, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(13, 1), (56, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [(56, 1), (64, 1)] }],
  [{ coefficient := 2, powers := [(13, 1), (32, 1), (50, 1), (53, 1), (56, 1), (64, 1)] }, { coefficient := 2, powers := [(20, 1), (25, 1), (48, 1), (55, 1), (56, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(41, 1), (56, 1), (61, 1), (64, 1)] }, { coefficient := -1, powers := [(50, 1), (55, 1), (56, 1), (64, 1)] }],
  [{ coefficient := 1, powers := [(8, 1), (38, 1), (56, 1), (64, 1)] }, { coefficient := -1, powers := [(18, 1), (30, 1), (58, 1), (64, 1)] }, { coefficient := -1, powers := [(20, 1), (32, 1), (56, 1), (64, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := -1, powers := [(13, 1), (14, 1), (21, 1), (25, 1), (58, 1), (64, 1)] }, { coefficient := 1, powers := [(13, 1), (21, 1), (25, 1), (56, 1), (58, 1), (64, 1)] }]
]
...
#print axioms Krenn.Component19.SelectedLeafB0_6_5.selectedHasNoCommonZero

end Krenn.Component19.SelectedLeafB0_6_5
