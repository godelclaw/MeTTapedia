...
namespace Krenn.Component19.SelectedLeafB6_2_5

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "ba2a5d8c6f14343390154f84c1fccf66573d1d3ff9b0a71292f7e6734bb0c0a1"
def certificateSHA256 : String := "c26227d6593875bbfe4aff8dac2bd01b8a4f8fd847506fe7821cf5e82d103652"
...
def multipliers : Fin 21 → SparsePoly (Fin 67) := ![
  ...
  [{ coefficient := -1, powers := [(2, 1), (56, 1), (58, 1), (65, 1)] }, { coefficient := 1, powers := [(2, 1), (58, 1)] }, { coefficient := 1, powers := [(8, 1), (38, 1)] }, { coefficient := -1, powers := [(18, 1), (30, 1), (58, 1), (65, 1)] }, { coefficient := -1, powers := [(20, 1), (32, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (35, 1), (58, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (14, 1), (21, 1), (25, 1), (58, 1), (65, 1)] }, { coefficient := 1, powers := [(13, 1), (21, 1), (25, 1), (58, 1)] }, { coefficient := 2, powers := [(13, 1), (21, 1), (32, 1), (50, 1)] }, { coefficient := 2, powers := [(20, 1), (25, 1), (26, 1), (55, 1)] }]
]
...
#print axioms Krenn.Component19.SelectedLeafB6_2_5.selectedHasNoCommonZero

end Krenn.Component19.SelectedLeafB6_2_5
