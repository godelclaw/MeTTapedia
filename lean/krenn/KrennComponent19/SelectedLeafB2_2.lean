...
namespace Krenn.Component19.SelectedLeafB2_2

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "047b757c2c9af9016eabaf83806bbabc7b962b3fa7c90e290b90a49c8692f864"
def certificateSHA256 : String := "c4b117f2a0e64805ef990c7268bdca823e5201b66c98ee6116fd4b3939b148a5"
...
def multipliers : Fin 24 → SparsePoly (Fin 64) := ![
  ...
  [{ coefficient := 1, powers := [(25, 1), (27, 1), (43, 1)] }, { coefficient := 1, powers := [(25, 1), (54, 1)] }],
  [{ coefficient := -1, powers := [(30, 1), (55, 1)] }],
  [{ coefficient := -1, powers := [(19, 1), (50, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (46, 1)] }],
  [{ coefficient := -2, powers := [(20, 1), (25, 1)] }],
  [{ coefficient := -2, powers := [(13, 1), (32, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (35, 1), (43, 1), (54, 1)] }, { coefficient := -1, powers := [(5, 1), (35, 1), (48, 1), (54, 1)] }],
  [{ coefficient := 1, powers := [(32, 1)] }],
  [{ coefficient := 1, powers := [(20, 1)] }],
  [{ coefficient := 1, powers := [(55, 1)] }],
  [{ coefficient := 1, powers := [(50, 1)] }],
  [{ coefficient := 1, powers := [(25, 1)] }],
  [{ coefficient := 1, powers := [(5, 1), (35, 1), (43, 1)] }, { coefficient := 1, powers := [(5, 1), (35, 1), (48, 1)] }],
  ...
  [{ coefficient := 1, powers := [(5, 1), (21, 1), (35, 1), (40, 1), (58, 1), (60, 1)] }, { coefficient := 1, powers := [(5, 1), (21, 1), (35, 1), (43, 1), (57, 1), (58, 1)] }, { coefficient := 1, powers := [(5, 1), (21, 1), (35, 1), (48, 1), (53, 1), (58, 1)] }, { coefficient := -1, powers := [(5, 1), (35, 1), (53, 1), (58, 1)] }, { coefficient := 1, powers := [(13, 1), (25, 1), (43, 1), (58, 1)] }, { coefficient := 1, powers := [(13, 1), (25, 1), (49, 1), (54, 1)] }, { coefficient := 2, powers := [(13, 1), (32, 1), (50, 1), (53, 1)] }, { coefficient := 2, powers := [(20, 1), (25, 1), (48, 1), (55, 1)] }],
...
#print axioms Krenn.Component19.SelectedLeafB2_2.selectedHasNoCommonZero

end Krenn.Component19.SelectedLeafB2_2
