...
namespace Krenn.Component19.SelectedLeafB5_6_3_3

open Krenn.SparseCertificate
open MvPolynomial

def systemSHA256 : String := "9858f9ccfaf04d134fac11637ea9474df92f883446c1b78ef007487a974f2518"
...
def multipliers : Fin 31 → SparsePoly (Fin 70) := ![
  ...
  [{ coefficient := -1, powers := [(19, 1), (50, 1)] }],
  [{ coefficient := 1, powers := [(13, 1), (31, 1), (58, 1), (65, 1), (69, 1)] }, { coefficient := -1, powers := [(13, 1), (46, 1)] }],
  ...
  [{ coefficient := -1, powers := [(13, 1), (58, 1), (62, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [(25, 1), (58, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (25, 1), (27, 1), (53, 2), (58, 1), (67, 1)] }, { coefficient := 1, powers := [(13, 1), (25, 1), (53, 1), (54, 1), (58, 1), (67, 1)] }],
  [{ coefficient := 1, powers := [(32, 1)] }],
  [{ coefficient := 1, powers := [(20, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (25, 1), (58, 1), (65, 1), (69, 1)] }],
  [{ coefficient := 1, powers := [(13, 1), (25, 1), (27, 1), (53, 1), (58, 1), (67, 1)] }],
  [{ coefficient := -2, powers := [(25, 1), (55, 1)] }],
  [{ coefficient := 1, powers := [(55, 1)] }],
  [{ coefficient := 1, powers := [(50, 1)] }],
  [{ coefficient := 1, powers := [(25, 1)] }],
  [{ coefficient := 1, powers := [(2, 1), (62, 1)] }],
  [{ coefficient := -1, powers := [(13, 1), (25, 1), (53, 1), (58, 1), (67, 1)] }],
  [{ coefficient := 1, powers := [(58, 1), (66, 1)] }],
  [{ coefficient := 1, powers := [(13, 1)] }],
  [{ coefficient := 1, powers := [(13, 1), (25, 1), (58, 1), (62, 1), (65, 1)] }],
  [{ coefficient := -1, powers := [] }],
  [{ coefficient := -1, powers := [(2, 1), (21, 1), (50, 1), (55, 1), (62, 1)] }, { coefficient := -1, powers := [(2, 1), (41, 1), (61, 1)] }, { coefficient := 1, powers := [(2, 1), (50, 1), (55, 1)] }, { coefficient := -1, powers := [(13, 1), (25, 1), (48, 1), (58, 1), (65, 1)] }, { coefficient := 2, powers := [(13, 1), (32, 1), (50, 1)] }],
  [{ coefficient := 1, powers := [(13, 1), (25, 1), (58, 1)] }],
  [{ coefficient := -1, powers := [(0, 1), (2, 1), (58, 1), (62, 1)] }, { coefficient := -1, powers := [(2, 1), (27, 1), (46, 1), (62, 1)] }, { coefficient := -1, powers := [(2, 1), (57, 1), (58, 1), (66, 1)] }, { coefficient := 1, powers := [(2, 1), (58, 1)] }, { coefficient := 1, powers := [(8, 1), (38, 1)] }, { coefficient := -1, powers := [(19, 1), (31, 1), (58, 1), (66, 1)] }, { coefficient := -1, powers := [(20, 1), (32, 1)] }],
  [{ coefficient := -1, powers := [(5, 1), (35, 1), (58, 1)] }, { coefficient := -1, powers := [(13, 1), (25, 1), (58, 1)] }],
  [{ coefficient := 1, powers := [(13, 1), (21, 1), (25, 1), (53, 1), (58, 1)] }],
  [{ coefficient := -1, powers := [(2, 1), (21, 1), (50, 1), (55, 1), (62, 2)] }, { coefficient := 1, powers := [(2, 1), (50, 1), (55, 1), (62, 1)] }, { coefficient := 1, powers := [(13, 1), (25, 1), (27, 1), (46, 1), (53, 2), (58, 1), (67, 1)] }, { coefficient := -1, powers := [(13, 1), (25, 1), (43, 1), (58, 1), (62, 1), (65, 1)] }, { coefficient := -1, powers := [(13, 1), (25, 1), (46, 1), (53, 1), (54, 1), (58, 1), (67, 1)] }, { coefficient := -1, powers := [(13, 1), (25, 1), (48, 1), (58, 1), (62, 1), (65, 1)] }, { coefficient := 2, powers := [(13, 1), (32, 1), (50, 1), (62, 1)] }, { coefficient := 2, powers := [(19, 1), (25, 1), (49, 1), (55, 1)] }, { coefficient := 2, powers := [(20, 1), (25, 1), (43, 1), (55, 1)] }],
  [{ coefficient := 1, powers := [(13, 1), (25, 1), (43, 1), (58, 1), (65, 1)] }, { coefficient := 1, powers := [(13, 1), (25, 1), (48, 1), (58, 1), (65, 1)] }]
]
...
#print axioms Krenn.Component19.SelectedLeafB5_6_3_3.selectedHasNoCommonZero

end Krenn.Component19.SelectedLeafB5_6_3_3
