...
namespace Krenn.Component48RootCommonZero.Chunk7
...
theorem rootBlock_of_base_and_component {R : Type*} [CommRing R]
    ...
    ∀ offset : Fin 40, eval₂Hom (Int.castRingHom R) (rootValues full)
      (Krenn.Component48.Tree.rootEquations ⟨280 + offset.val, by omega⟩).toPoly = 0 := by
  ...
  · have source := rawZero 2
    rw [identified] at source
    simp [Krenn.Component48.Tree.rootEquations, Krenn.Component48.Root.rootEquations, rawGeneratorEval, rawPositive, rawNegative, rawValues, rawCoordinate, monomial_add, monomial_single_one, SparsePoly.toPoly, SparseTerm.toPoly, rootValues, reconstructFull, rootCoordinate, sub_eq_add_neg] at source ⊢
    convert source using 1 <;> ac_rfl
...
end Krenn.Component48RootCommonZero.Chunk7
