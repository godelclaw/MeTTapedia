...
namespace Krenn.Component18RootCommonZero.Chunk1
...
theorem rootBlock_of_base_and_component {R : Type*} [CommRing R]
    ...
    ∀ offset : Fin 40, eval₂Hom (Int.castRingHom R) (rootValues full)
      (Krenn.Component18.Tree.rootEquations ⟨40 + offset.val, by omega⟩).toPoly = 0 := by
...
end Krenn.Component18RootCommonZero.Chunk1
