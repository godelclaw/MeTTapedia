...
**Source**: Complete Lean 4 proof (15,021 lines, zero sorries) at `lean/ramsey36/`

**Plan**: the phase ledger below supersedes the original local planning note.

## Phase 1: COMPLETE ✅ (2025-12-18)

**Deliverables**:
- ✅ Workspace set up at `megalodon/ramsey36/`
...
- Full plan: the phase ledger in this README
