...
select one relation quotient and exact block convention, with any choice not
fixed by v14 labeled as a repair.  It must then supply the actual dimension-16
lattice Wilson representatives, quotient basis, and dual jets, prove their
uniform conditioning, and establish the fluctuation and weighted
cumulant/tree/KP estimates in the same norm on the same Wilson family.
...
\begin{itemize}[leftmargin=1.5em]
  ...
  \item resolving F.4's on-shell versus O.9's off-shell relation policy and
    fixing the exact block quotient before supplying the dimension-16 lattice
    Wilson representatives, quotient basis, dual jets, and uniform
    matrix-conditioning estimates needed to transfer the norm-one
    Wilson-polynomial realization to a repaired extraction operator.
