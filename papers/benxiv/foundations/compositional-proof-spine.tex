...
Identifying each \emph{complete} primal fundamental cut with the dual
path plus its extra edge, and thus proving its width is at most $2h+1$,
is still the next lemma.  Long nested cyclic shores, the global supply
