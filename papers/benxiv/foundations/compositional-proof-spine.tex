...
present assignment satisfies only the eight consecutive constraints.  Nor
does this yet give a compatible chain of matching-overlap states: the absent
Tait-colour class used to complete each deletion colouring to a perfect
matching must still be synchronized along the path.  That colour-gauge
condition is the exact remaining adapter.
\end{proof}
