...
must also be matched.  Adding this data to the repeated profile is a
possible next construction, not a theorem claimed here.  A smaller map
preserving designated holes and the target minimality class, and the
source-facing global supply, remain open.  The fixed ledger is unchanged
at $57/100$.
