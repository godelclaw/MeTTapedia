...
at the repaired site.  The remaining two-dimensional task is therefore
sharper: either force branching or boundary-reaching witnesses with enough
geometric coherence to support a strict replacement, or turn this anchored
agreement trade---equivalently, the arc-consistent no-section obstruction of
Corollary~\ref{cor:arc-consistent-no-section-residue}---into a finite
holonomy/support obstruction that supplies such a replacement.  A coherent
atlas is already impossible by
