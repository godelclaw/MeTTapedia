...
The depth-three form of the carrier-stack horn is now physical as well as
...
face-side comparison gap for a nested pair.  It does not yet prove that the
containment is strict, nor choose a long coherent family of such shores; those
are the next M1 obligations needed by cumulative state descent.

At depth four the next local obligation is also checked.  The outermost and
...
incident-edge shores.  The remaining assembly task is to package this local
strictness uniformly along a sufficiently long connected cut family and feed
that family to the cumulative exact-state repetition theorem.
\end{proof}
