...
\Sverified{Mettapedia.GraphTheory.FourColor.GoertzelV24OrderedMeshColoringAtlas.exists_disagreement_in_any_nine_row_intervals}
...
any nine distinct intervals between successive branch columns, and choose
once and for all the proper deletion colouring supplied by minimality at
every global mesh step.  Then two of the nine selected interval colourings
have false common-restriction agreement bit.
\end{corollary}
