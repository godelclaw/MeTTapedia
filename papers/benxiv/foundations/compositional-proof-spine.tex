...
Lemma~\ref{lem:exact-five-cut-cyclic-boundary}.  The remaining physical work is
to prove the two displayed implications by planar Kempe-chain separation and
smaller-side surgery, prove that minimality supplies a primary class on each
shore, and instantiate the existing exact-support splice.  No finite
