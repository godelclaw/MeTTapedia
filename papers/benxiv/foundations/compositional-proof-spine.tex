...
constructs a saturated vertex-side boundary and complementary connected edge
shores for one three-interface segment.
The remaining source adapter must compose rails over arbitrary length, prove
the required noncollision uniformly, choose the successive component sides
consistently so that the resulting edge shores are strictly nested, establish
nonempty majority cores on both sides from the protected inner and outer
cycle material, and then provide the roots and uniform width bounds consumed by
