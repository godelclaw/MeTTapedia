...
Proposition~\ref{prop:fixed-mesh-width-factorization} is the sole
route-specific high-width assertion.  The second is the conventional
wall/grid-to-branchwidth implication, expressed on the exact injective mesh
carrier consumed here.  Neither premise entails the other without the
quantitative size condition in the converse, and neither is concealed in a
