...
without losing the target: supported perfect matchings may be changed along
sets closed under two matchings, and the shared matching exchange theorem
proves that such a change remains graph-supported.  Thus a matching-based
proof of the boxed assertion below must show that, in a least counterexample
containing a fixed ordered mesh, alternating exchanges either complete one
supported matching to an exact triple or yield a strict support-preserving
replacement.  Merely finding many perfect matchings, without this completion
or replacement conclusion, does not discharge the zero-target condition.
