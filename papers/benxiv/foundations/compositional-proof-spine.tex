...
$s_i$, let $R_i$ be the relation consisting of the two concrete proper orbit
representatives which realise $s_i$.  A clockwise cell state has shared
...
counterexample.  It nevertheless rules out treating planarity, bridgeless
cubicity, bare ordered-mesh geometry, or literal pairwise agreement as a
reason to assume a global section.  A wall argument must either control these
finite relational holonomies using the minimal-counterexample hypothesis or
derive a target-specific consequence from a fixed-point-free one.
