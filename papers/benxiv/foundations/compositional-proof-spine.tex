...
This proposition closes the logical terminal-acceptance projection, but not
the remaining realization adapter.  One must still prove that the uniform
profiles counted by the corrected Seed count and the cumulative states reached
by the literal serial transition describe the same physical terminal
realizations.  Nor has the filtered finite set above yet been emitted as an
optimized executable certificate.
