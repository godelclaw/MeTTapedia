...
spanning forest.  Consequently the desired v23 spanning inclusion is not
refuted by Proposition~\ref{prop:v23-annihilator-gap}, but its printed proof
does not establish it.  It cannot presently serve as the missing high-width
M1 theorem; a corrected need-based generator theorem would have to prove the
actual route discrepancies lie in the generated subspace and then connect
those algebraic moves to a strict physical replacement.
