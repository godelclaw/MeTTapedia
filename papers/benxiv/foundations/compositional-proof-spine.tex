...
compatible, or that the replacement remains a spherical bridgeless cubic
map.  Those are exactly the adapters which must be constructed next.
...
package in the present types is a simultaneous laminar choice along each
root path, the strict-material accounting between comparable cuts, and the
resulting ordered \texttt{OpenTangleData}.  Those remain a construction,
not a citation.
