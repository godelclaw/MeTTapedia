...
accounting, and provide the nodewise connected edge shores, nonempty majority
sides, and middle-set bounds.  Lemma~\ref{lem:connected-shore-literal-node}
then supplies the roots, literal width, and two-port fields.  The theorem does
\emph{not} assert that an arbitrary branch decomposition already supplies the
connected edge-shore tree.
