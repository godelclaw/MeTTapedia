...
This supplies concrete coverage, colourability and primal-topology
components for the base work, not the completed base reflection.
Spherical admissibility still needs a filter with proved coverage, and the resulting
bad-state audit must actually succeed. No spherical filter, optimized
closure, explicit global reduction threshold, or successful finite-base
audit is asserted here. No full structural or topological envelope has
been enumerated. The fixed obligation ledger remains $57/100$.
