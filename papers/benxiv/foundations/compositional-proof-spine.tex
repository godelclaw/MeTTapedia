...
meshes does not imply absence of permissive meshes, so that result does
not discharge the ordered supplier stated here.
...
absence, but its mesh has not been upgraded to an ordered rectangular one.
...
permissive-mesh exclusion, and its decomposition supplier remains open.
