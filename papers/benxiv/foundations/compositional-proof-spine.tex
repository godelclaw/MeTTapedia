...
Proposition~\ref{prop:target-forced-cut-chain} (for example via both branches
of Proposition~\ref{prop:global-corridor-alternative}, or by a direct
target-sensitive construction); the exact
