...
This lemma is only the logical propagation heart of Birkhoff's short
five-cycle theorem.  The remaining physical work is to define the $P/Q$
boundary classes for the two shores, prove the two displayed implications by
planar Kempe-chain separation, and show that an overlap glues the shores.  No
finite boundary-word certificate is used or licensed by the lemma.
