...
which residual edge changes at each cycle vertex, but do not yet pair the
third-edge excursions when they return to the cycle or compute the resulting
change in the number of odd residual components.
