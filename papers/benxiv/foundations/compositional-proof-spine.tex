...
Proposition~\ref{prop:exact-closure-gate}. An enumerated accepting array and
its source-realization biconditional are still owed alongside $I$, $E$ and
the reachability replays. No closure count is supplied, and this is not the
Lift/Seed accepting array, which remains the cap-composed predicate.
...
The construction does not bound the maximum frontier of its chosen sweep,
and does not identify raw, cumulative-support and Nerode closures with one
another. An enumerated accepting array with its source-facing semantics and
the exact closure certificates remain to be supplied. D2b and the earned
ledger therefore remain open and $57/100$, respectively.
