...
Construct the ranked forest and its $|F|-1$ edge count from the actual
dual distance function; prove the full fundamental-cut width bound; then
extract enough cyclic nested shores to feed the existing node constructor.
Until those steps are proved, this is a gated long-face construction with
its generic parity and tree-complement lemmas, not a global supply theorem.
