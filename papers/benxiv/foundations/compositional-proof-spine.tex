...
annotation.  Taking $Q$ to be the exact typed seam-and-support state leaves
only the construction of that state and the physical local splice.
...
\Sverified{Mettapedia.GraphTheory.FourColor.RotationSystem.no_wellFormed_digonPatchData_of_minimal}
