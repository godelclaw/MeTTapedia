...
This lemma closes the carrier-coherence problem, not the wall theorem.  What
remains is now intrinsically two-dimensional: prove that the relational
returns of neighbouring cells cancel after the displayed reversal transport,
...
counterexample.  No equality of opposite-shore supports, flatness, or
fixed-wall exclusion is inferred merely from sharing the physical sites.
