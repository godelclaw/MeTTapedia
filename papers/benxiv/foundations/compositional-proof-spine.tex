...
changes exactly one coordinate by valid-pair Tait Kempe switches, makes its
common-core restriction agree with a second coordinate, and leaves the other
eight coordinates fixed.  This is a finite state system.
...
therefore exact: either force branching or boundary-reaching witnesses with
enough geometric coherence to support a strict replacement, or rule out (or
convert into a replacement) the periodic strict-repair cycles of
Corollary~\ref{cor:periodic-tait-repair-residue}.  A coherent atlas is already
impossible by Lemma~\ref{lem:global-common-core-colouring-atlas}.  No
monotonicity of the naive number of disagreeing pairs is assumed; the
periodic horn records precisely why such monotonicity cannot simply be
postulated.
