...
one as a receipt.  To promote it to a cyclic edge-cut realization, the deep
nest must still supply a cycle in the complementary filled side; the selected
side already contains the return separator itself.  That opposite-cycle
statement is the remaining nested-layer geometry.
\end{proof}
