...
the remaining adapter must choose proper distinguished alternating components
for a common residual-defect minimizer and then use the mesh geometry to force
a strict compositional descent.
\end{proof}
