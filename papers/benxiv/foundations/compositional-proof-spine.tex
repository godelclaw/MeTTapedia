...
observations have fibres of size two.  This computation has not yet been
reflected into the kernel, so it is evidence rather than a formal
counterexample.  It nevertheless rules out treating planarity,
bridgeless cubicity, or the bare ordered-mesh axioms as a reason to assume
orbit separation.  A wall argument must either control these fibres using the
minimal-counterexample hypothesis or carry enough additional finite
transition data to compose them.
