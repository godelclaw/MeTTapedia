...
components.  The remaining geometric obligation is to show that a canonical
return component at one selected site has an anchor, or an unavoidable
intersection, outside $P$ which forces it to be the distinguished return
component at the other selected site.  No such identification is inferred
merely from the $45$-edge disagreement bound.
\end{proof}
