...
interior vertices.  A repaired theorem may therefore impose a positive-depth
or route-realizability hypothesis, but that would be a new statement needing
a new proof.  The v23 theorem as written cannot serve as the missing
high-width M1 theorem.  A corrected need-based generator theorem would have
to prove that the actual route discrepancies lie in its generated subspace
and then connect those algebraic moves to a strict physical replacement.
