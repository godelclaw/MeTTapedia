...
by replacement: zero Count and seam orientation.  The supplier must still
construct a coordinate equivalence for each majority shore and supply the two
disc-side hypotheses for the replacement piece.  Those are geometric
existence/packaging obligations; no further Count semantics or hidden
orientation choice remains.
