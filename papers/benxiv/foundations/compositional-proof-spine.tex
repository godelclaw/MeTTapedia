...
sharpens the periodic horn again: the defect either propagates to the two
partner sites or leaves a witness in one named five-edge deletion footprint.
The remaining two-dimensional task is therefore to show that repeated
propagation reaches the branching or boundary horn, or that the accumulated
bounded footprints define an exact support-preserving replacement.  The
