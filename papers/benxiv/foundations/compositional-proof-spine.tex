...
the union of the nine deletion footprints, a set of at most (45) edges.
\end{corollary}
...
not yet prove wall exclusion: the remaining adapter must turn two
same-colour matchings with a bounded disagreement carrier into compatible
alternating-component receipts, and then use the mesh geometry to force a
strict compositional descent.
\end{proof}
