...
nonempty proper majority core.  The internal-support premise is load-bearing:
...
the separation hypotheses uniformly, and show that the canonically oriented
shores obtained from successive right endpoints are strictly nested.  It must
also transport these open source-trail shores to the closed ambient cubic map,
fix the roots and uniform width bounds, and identify their ordered Count states
with those consumed by
