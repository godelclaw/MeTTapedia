...
step, not D2b in full. A complete bridge from every finite evaluator
letter and its persistent-port coordinates to this constructor,
initialization and iterated decoding, and the required fixed-point
certificate remain to be sealed. The empty initial boundary state is
