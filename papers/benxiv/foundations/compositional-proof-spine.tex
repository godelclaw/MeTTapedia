...
general: it is the reference-matching attachment frontier (together with a
finite carrier-pairing boundary term).  This is the exact object the
external-exit/same-turn-chord horn must consume.
\end{proof}
