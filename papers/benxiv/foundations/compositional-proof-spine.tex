...
decomposition must yield nested connected literal shores and an ordered
seam-state identification preserving the retained first-return order.  The
natural edge-flip then supplies reversal on the complementary shore.  The cap
face count, cap sphericity, one-hub property, and orientation reversal are no
longer open.
