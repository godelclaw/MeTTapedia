...
\texttt{HubFacesDistinct} for every finite boundary set.  To regard the hub
as a single combinatorial-map vertex, its rotation \(\rho_T\) must also be a
single cycle.  That extra assertion comes from the boundary being one simple
noose; it is not a consequence of inverse first return alone.
