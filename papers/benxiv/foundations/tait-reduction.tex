...
Lemma~\ref{lem:planar-spherical-presentation}.  The componentwise wrapper is
now checked by Lemma~\ref{lem:components}.  No legacy \texttt{IsPlanar}
premise is used.
...
Theorem~\ref{thm:tait-reduction} are checked, including the least-counterexample
wrapper of Theorem~\ref{thm:spherical-headline-from-no-minimal}.  The only classical boundary
