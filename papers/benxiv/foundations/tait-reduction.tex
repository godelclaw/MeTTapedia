...
Theorem~\ref{thm:tait-reduction}.  The controlling formal statement must use
...
repository currently has no correct abstract-planarity predicate or
machine-checked constructor implementing this representation theorem.  The
ordinary argument above fixes the intended bridge exactly; it must not be
replaced by the refuted legacy predicate of
Proposition~\ref{prop:weak-planarity-refuted}.
\end{proof}
