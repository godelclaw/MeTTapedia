...
\paragraph{Two-shear test of the integrated sign.}
A simpler candidate tests whether spatial integration restores a good
sign. Let
\[
...
The sign-pairing passage to the actual spatial integral, its cosine
moments, and differentiation through the crossing set remain to be
checked. This test redirects the next estimate toward a paid diffusion
budget or a corrected alignment energy; it does not close the global
regularity argument.
