...
closes the finite adaptive-cover existence and aggregation problem.  It does
not yet provide the scale-uniform smooth Fourier cutoffs and buffered
frequency margins required to splice this adaptive partition into the
periodic multiplier transfer, nor does it control the small-gap time branch.
...
\texttt{PancakeAdaptiveStrainCover} modules), each with a regression companion where
