...
the Fourier tail of a genuine spatial cutoff and the remaining smooth
...
cutoff-specific Fourier decay/truncation theorem and the subsequent smooth
sector-projector collar remain at this junction.
...
localization-stability modules), each with a regression companion where
