...
inverse-kernel $L^1$ bound.  Its commutator with the original smooth sector
projector, space--time treatment of the small-gap branch, and
...
$L^1$ bound for the assembled inverse kernel.  What remains at this junction
is to compare this enlarged multiplier with the original smooth sector
projector; this is a genuine projector commutator or collar estimate, not a
support-coverage question.
...
inverse-kernel $L^1$ bound.  The projector commutator remains.
...
\texttt{PancakeBufferedAnnularMultiplier} modules), each with a regression companion where
