...
\[
 ...
 \qquad \tfrac34-\rho_\parallel\leq|v_3|
       \leq2+\rho_\parallel.
\]
What remains at this junction is to construct the annular kernel uniformly on
that buffered box and bound its mismatch with the original smooth projector.
...
mode.  The buffered multiplier construction and projector commutator remain.
