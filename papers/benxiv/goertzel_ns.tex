...
with an explicit small frozen-top-gap alternative.  Space--time aggregation
of those two branches and conversion from this $L^2$ control to the
scale-local endpoint budget remain open.  The
...
selection through eigenvalue collisions and a sign-invariant
line-projector theorem now controls the frozen-to-varying-frame error by
$4\varepsilon/\mathrm{threshold}$ times the full $L^2$ energy, with the
ordinary frozen top-gap band returned as the alternative.  The remaining
steps are aggregation of that alternative over space and time, conversion of
the transverse $L^2$ estimate to the required scale-local endpoint budget,
and identification and assembly of this concrete finite-sector identity into
