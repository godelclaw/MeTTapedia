...
variation --- a quantity with known dynamical handles (the vorticity
direction equation), unlike the raw strain.

\emph{Exact unproven boundary.}  (i) The field-level transfer:
realizing the split and the coherent interface for actual
Littlewood--Paley Navier--Stokes data from the mode-level kinematics
(a quantitative coherent/misaligned decomposition of real vorticity
fields).  (ii) The misalignment budget itself: dynamical,
...
dynamical, time-integrated control of the vorticity-direction misalignment
share, strong enough to cover the gap band identified above.
