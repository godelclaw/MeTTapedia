...
frame.  The frozen-to-spatially-varying frame passage and the conversion from
this $L^2$ control to the scale-local endpoint budget remain open.  The
...
selection through eigenvalue collisions, a quantitative frozen-to-varying
frame estimate for the new transverse-energy bridge, and identification of
the concrete finite-sector split with the actual Littlewood--Paley time
functionals.
...
selection through eigenvalue collisions, control of the
frozen-to-varying-frame error, conversion of the transverse $L^2$ estimate to
the required scale-local endpoint budget, and identification and assembly of
this concrete finite-sector identity into
...
with the actual scale-local Littlewood--Paley time functionals, control the
passage from the frozen-frame $L^2$ transverse estimate to the spatially
varying frame and the endpoint scale budget, and
prove a dynamical,
