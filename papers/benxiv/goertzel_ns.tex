...
at its zeros.  Space--time aggregation of the small-gap and coercive branches
and conversion from this $L^2$/defect control to the scale-local endpoint
budget remain open.  The
...
by the integrated top Rayleigh defect.  The remaining steps are aggregation
of the small-gap/coercive dichotomy over space and time, conversion of this
$L^2$/defect estimate to the required scale-local endpoint budget, and
identification and assembly of this concrete finite-sector identity into
