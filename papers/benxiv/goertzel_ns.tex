...
Their coefficient-level identification is now checked below; real-field
material-path assembly and a uniform estimate of their signed combination
remain required. Moreover each
...
real material paths remains a separate bridge. A moving multiplier would
