...
proved smaller than $\delta^2$.  Thus the remaining localization task is no
longer construction of Fourier-compatible adaptive weights; it is the
scale-uniform bookkeeping that absorbs these quantified tails into buffered
frequency margins and boundary-transfer estimates.  The small-gap time
...
\texttt{PancakeAdaptiveFourierPartition} modules), each with a regression companion where
