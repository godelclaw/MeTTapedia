...
two subsequent modules above.  The remaining field-transfer pieces are finite
oriented chart/rotation assembly and control of the variable-frame remainder.
...
periodized coefficient formula, and its uniform $C/N$ mass bound are now
proved as well.  The remaining steps are finite chart/rotation transference
and a
...
enough to cover the gap band identified above.  It must also finish the
 finite oriented-chart/rotation assembly of the
