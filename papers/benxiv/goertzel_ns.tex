...
analytic step is therefore a quantitative truncation/tail estimate (followed
by the smooth sector-projector collar), not another support-coverage lemma.
...
spatial cell cutoff and the smooth projector collar remain.
...
\texttt{PancakeLocalizedBufferedTransfer} modules), each with a regression companion where
