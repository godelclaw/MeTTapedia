...
and identity conditioning. Its actual Wilson fourth-jet coordinate vector is
`(6,0,0,0)`; the O(4)-invariant function subspace is proper, and this
pure-fourth polynomial gives a nonzero Lorentz-breaking quotient class. The
attempted fixed-width extension through
