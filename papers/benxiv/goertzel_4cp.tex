...
\texttt{oneEdgeBetween} or \texttt{opposite}.  This is a genuine finite local
fragment of flag L1, and it removes a false global hypothesis from the local
construction.  It is not the whole local classification, a construction of
simple rails, or the required long separated crosscut pair.
