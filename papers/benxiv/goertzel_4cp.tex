...
The packaging itself is now literal and machine-checked in
...
cellulation is postulated at C--3.  Equally importantly, this theorem does not
promote its two hypotheses into source geometry: C--4 must derive both from
the corridor-selected facial cap pair before the formation pillar is closed.

The first of those two hypotheses has now been reduced to a quantitative
selection condition rather than left as an opaque topological assumption.
...
greater than two---satisfy 	exttt{RemoteBoundaryFacesSeparated}.  What remains
is genuinely source-facing: select the two oriented facial cap walks far
enough apart along the corridor and prove connectivity of their simultaneous
retained complement.  Neither conclusion is inferred merely from having two
graph-theoretically disjoint pentagons.
