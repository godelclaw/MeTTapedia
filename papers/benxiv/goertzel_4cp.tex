...
boundaries.  This makes the literal selected-rung geometry admissible to a
future transversal construction.  It is deliberately not that construction:
the module neither produces the long source path nor a separated pair of
paths.
