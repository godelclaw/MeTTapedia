...
behind a choice or a cardinality count.  What remains is genuinely inter-spoke geometry: proving that the five
individual stub-side orbits coalesce into the required cap collar, and then
doing this compatibly for two caps.
...
order.  This still is not an opened-hole theorem: the remaining transfer to
the retained first-return order requires the planar-bond hypotheses, notably
connectedness of both induced sides.  Those are now the exact global
formation obligations rather than a missing local collar calculation.
...
five consecutive cap-edge surgeries compose to one collar orbit, nor that the
edge-deletion rotation is the already constructed literal slit rotation; those
are the remaining C-2 comparison and composition obligations.
