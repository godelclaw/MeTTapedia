...
Thus all three crossed primal edges are incident with the same ambient vertex;
the dual triangle is the link of one primal vertex, rather than an arbitrary
separating triangle.  This is the closed-map bounded-interaction classification
needed by the source.  It does
