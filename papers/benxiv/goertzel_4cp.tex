...
Thus the generic transport of the L1 corridor is complete.  The remaining
source theorem is narrower and geometric: under the actual cap/collar deletion,
prove that the selected Cell--3 corridor faces are wholly retained (and identify
the resulting opening with the source instance).  The constructor deliberately
does not assume that source-specific fact.
