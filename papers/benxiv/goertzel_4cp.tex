...
preservation for untouched faces.  It does not yet prove that two distinct
ambient faces remain distinct after deletion, transport a shared primal edge
between two faces, or establish the source-specific avoidance condition for
the three Cell--3 faces.  Those are the next local bridge statements.
