...
faces is pulled back to a shared ambient edge occurrence.  Thus an untouched
face is transported as an actual finite orbit
...
retention criterion under the actual closed-map-to-annulus formation, then use
the transported ribbon boundary to turn the existing primal radial witness into
the two separated facial-dual crosscuts.  These generic theorems remove one
formation gap; they do not themselves construct the crosscut pair or assert
that a flank face cut by the opening is wholly retained.
