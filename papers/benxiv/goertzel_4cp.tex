...
deliberately does not yet assert that the two rails are mutually disjoint:
that is the next finite collision classification, followed by remote append
separation and the end caps.
