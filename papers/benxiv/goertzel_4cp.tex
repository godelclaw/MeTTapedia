...
transversals.  In particular, the downstream rail API assumes
\texttt{PairwiseUniqueSharedInteriorEdges}, while this source instance does
not yet derive it.  Nor is the result a pair of separated transverse crosscuts
or a splice.
