...
at most two and with combined length exactly two.  Mutual support separation,
lengthwise assembly, and end-cap attachment remain open; these are local
formation facts, not yet a global annular crosscut pair. \\
\bottomrule
\end{tabular}
\end{center}
