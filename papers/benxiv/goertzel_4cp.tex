...
non-interference, not yet the claim that the two cycles are distinct.
...
all five outer stubs in another actual face orbit.  The result deliberately
does not yet assert that those two orbits differ; proving their distinctness
is the remaining local collar-separation step before the C--3 cellulation.
