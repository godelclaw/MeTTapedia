...
cap faces.  Its oriented refinement records the further fact the old cap
record omitted: the named \texttt{Fin 5} cycle edges really follow the facial
order, rather than merely forming the same edge set in some unspecified
order.  This completes the \emph{facial-cap datum}, not the surgery.  The
next theorem must construct the two opened collar orbits and prove that all
