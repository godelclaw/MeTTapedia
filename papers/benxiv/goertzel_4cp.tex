...
cap faces.  This completes the \emph{facial-cap datum}, not the surgery:
the next theorem must calculate the two degree-one-stub collar orbits and
their cyclic spoke orders.  Treating the graph-level opening as an annulus
before that calculation would still be precisely the unproved picture
argument this formalisation is avoiding.  This is a constraint on that
laboratory, not a claim that the Cell--3 source corridor is obtained by
selecting two such caps: Addendum~V supplies the laboratory tangle, whereas
Addendum~XXVII requires its own simple transversal or layer-boundary
construction.
...
five-step orbit theorem or an assertion that the stubs already form either
named hole face.
