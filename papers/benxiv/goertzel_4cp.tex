...
bounded neighboring gaps remain a finite local obligation.  A literal
...
then returns the next outgoing flanks together with the exhaustive local
shape certificate.  Thus a later induction cannot forget which of the three
literal cases generated its paths.  Lengthwise simplicity and end-cap
