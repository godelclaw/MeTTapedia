...
that the complete ambient and open dart cycles are equivalent.  Thus an
untouched face is transported as an actual finite orbit, not merely identified
by a matching cardinality or assumed through a wrapper.  What remains is
source-specific: prove that the Cell--3 flank faces satisfy the retention
criterion, transport their shared primal boundary edges, and use the resulting
