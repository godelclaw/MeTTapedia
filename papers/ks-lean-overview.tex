...
export lake build Mettapedia.ProbabilityTheory.KnuthSkilling
\end{lstlisting}

For the FOI reviewer entrypoint only:
\begin{lstlisting}[language=bash]
export lake build Mettapedia.ProbabilityTheory.KnuthSkilling.FoundationsOfInference
\end{lstlisting}

For memory-intensive grid/induction files (e.g. ThetaPrime.lean):
\begin{lstlisting}[language=bash]
export lake build Mettapedia.ProbabilityTheory.KnuthSkilling.Additive.Proofs.GridInduction.Main
\end{lstlisting}
